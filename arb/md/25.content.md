...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); Love (ID: `keyterm:Love`); Strength (ID: `keyterm:Strength`); يَهوذَا (ID: `group:Judah`); Mighty One (ID: `keyterm:MightyOne`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Appointed Feast (ID: `keyterm:AppointedFeast`); إِسْرَائِيلَ (ID: `person:Israel`); Work (ID: `keyterm:Work`); Deceit (ID: `keyterm:Deceit`); Defilement (ID: `keyterm:Defilement`); To Sin (ID: `keyterm:Sin`); Train (ID: `realia:Train`); House (ID: `realia:House`); Yoke (ID: `realia:Yoke`); Winepress (ID: `realia:Winepress`); Net (ID: `realia:Net`); Flock (ID: `fauna:Flock`); Deer (ID: `fauna:Deer`); Casting Net (ID: `realia:CastingNet`); Grass (ID: `flora:Grass`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); Defilement (ID: `keyterm:Defilement`); To Sin (ID: `keyterm:Sin`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Appointed Feast (ID: `keyterm:AppointedFeast`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Horn (ID: `keyterm:Horn`); Sheep (ID: `fauna:Lamb`); Utterance (ID: `keyterm:Utterance`); Instruction (ID: `keyterm:Instruction`); Passion (ID: `keyterm:Ardour`); To Dishonor (ID: `keyterm:Dishonor`); Sabbath (ID: `keyterm:Sabbath`); Gentiles (ID: `group:Gentile`); Have a Vision (ID: `keyterm:HaveAVision`); Sackcloth (ID: `realia:Sackcloth`); Tent (ID: `realia:Tent`); House (ID: `realia:House`); Bow (ID: `realia:Bow`); Measuring Reed (ID: `realia:MeasuringReed`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Grain (ID: `flora:Grain`); Vine (ID: `flora:Vine`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Horn (ID: `keyterm:Horn`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); Tent (ID: `realia:Tent`); Sheep (ID: `fauna:Lamb`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** Appointed Feast (ID: `keyterm:AppointedFeast`); ٱلرَّبِّ (ID: `deity:Lord`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Fear (ID: `keyterm:Fear`); Peace (ID: `keyterm:IntactState`); Rebel (ID: `keyterm:Rebel`); Hope (ID: `keyterm:Hope`); Salvation (ID: `keyterm:Salvation`); Forgive (ID: `keyterm:Forgive`); Redeem (ID: `keyterm:Redeem`); Complete (ID: `keyterm:Complete`); To Sin (ID: `keyterm:Sin`); Arrow (ID: `keyterm:Arrow`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Wormwood (ID: `flora:Wormwood`); Pit (ID: `realia:Pit`); Arrow (ID: `realia:Arrow`); Yoke (ID: `realia:Yoke`); Bow (ID: `realia:Bow`); Lion (ID: `fauna:Lion`); Bitter Herbs (ID: `flora:Chicory`); Hewn Stone (ID: `realia:HewnStone`); Bear (ID: `fauna:Bear`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`); أَدومَ (ID: `place:Edom`); عوصًا (ID: `place:Uz`); Defile (ID: `keyterm:Stain`); Believe In (ID: `keyterm:BelieveIn`); سَدومَ (ID: `place:Sodom`); Appoint (ID: `keyterm:Appoint`); Punishment (ID: `keyterm:Punishment`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Defilement (ID: `keyterm:Defilement`); Complete (ID: `keyterm:Complete`); Anointed (ID: `keyterm:Anointed`); Jackal (ID: `fauna:Jackal`); Ostrich (ID: `fauna:Ostrich`); Clay Jar (ID: `realia:ClayJar`); Purple Cloth (ID: `realia:PurpleCloth`); Vulture (ID: `fauna:Vulture`)
...
* **Associated ACAI Concepts:** Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); To Sin (ID: `keyterm:Sin`); أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); أَدومَ (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); أورشَلِيمَ (ID: `place:Jerusalem`); مِصْرَ (ID: `place:Egypt`); Round Dance (ID: `keyterm:RoundDance`); Assyria (ID: `place:Assyria`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Passion (ID: `keyterm:Ardour`); To Cause to Possess (ID: `keyterm:Possess`); Woe (ID: `keyterm:Woe`); Hand-Mill (ID: `realia:Hand-mill`); Crown (ID: `realia:Crown`); House (ID: `realia:House`); Jackal (ID: `fauna:Jackal`); Money (ID: `realia:Money`)
