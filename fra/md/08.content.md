...
* **Associated ACAI Concepts:** Éphrata (ID: `person:Ephrathah`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); Naomi (ID: `person:Naomi`); Kiljon (ID: `person:Chilion`); Juda (ID: `group:Judah`); Élimélec (ID: `person:Elimelech`); Bethléhem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Machlon (ID: `person:Mahlon`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); Léa (ID: `person:Leah`); Bethléhem (ID: `place:Bethlehem`); Israël (ID: `person:Israel`); Rachel (ID: `person:Rachel`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); Tamar (ID: `person:Tamar`); Perets (ID: `person:Perez`); Juda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Hetsron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Obed (ID: `person:Obed`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Boaz (ID: `person:Boaz`); Nahshon (ID: `person:Nahshon`); Perets (ID: `person:Perez`); David (ID: `person:David`); Isaï (ID: `person:Jesse`)
