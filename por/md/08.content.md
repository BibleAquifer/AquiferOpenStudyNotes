...
* **Associated ACAI Concepts:** Quiliom (ID: `person:Chilion`); Efrata (ID: `person:Ephrathah`); Noemi (ID: `person:Naomi`); Ephrathites (ID: `group:Ephrathah`); Belém (ID: `place:Bethlehem`); Judá (ID: `group:Judah`); Malom (ID: `person:Mahlon`); Moabe (ID: `place:Moab`); Judá (ID: `person:Judah.4`); Elimeleque (ID: `person:Elimelech`)
...
* **Associated ACAI Concepts:** Moabe (ID: `place:Moab`); SENHOR (ID: `deity:Lord`); Appoint (ID: `keyterm:Appoint`)
...
* **Associated ACAI Concepts:** kindness (ID: `keyterm:Kindness`); bless (ID: `keyterm:Bless`); Noemi (ID: `person:Naomi`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); to cause to possess (ID: `keyterm:Possess`); Moabe (ID: `place:Moab`); Boaz (ID: `person:Boaz`)
...
* **Associated ACAI Concepts:** Moabe (ID: `place:Moab`); Rute (ID: `person:Ruth`); Malom (ID: `person:Mahlon`); to cause to possess (ID: `keyterm:Possess`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Belém (ID: `place:Bethlehem`); Elders (ID: `group:GenericElders`); SENHOR (ID: `deity:Lord`); Raquel (ID: `person:Rachel`); Lia (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); Boaz (ID: `person:Boaz`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Hezrom (ID: `person:Hezron.2`); Salmom (ID: `person:Salmon`); Aminadabe (ID: `person:Amminadab`); Obede (ID: `person:Obed`); Ram (ID: `person:Ram`); Naassom (ID: `person:Nahshon`); Perez (ID: `person:Perez`); Davi (ID: `person:David`); Boaz (ID: `person:Boaz`); Jessé (ID: `person:Jesse`)
