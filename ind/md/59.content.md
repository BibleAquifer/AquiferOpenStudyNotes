...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); Yakobus (ID: `person:James.3`)
...
* **Associated ACAI Concepts:** berbahagialah (ID: `keyterm:Happy`); tahan uji (ID: `keyterm:Approved`); janji (ID: `keyterm:Promise`); kasihi (ID: `keyterm:Love`); kehidupan (ID: `keyterm:Life`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); berbahagialah (ID: `keyterm:Happy`); mencobai (ID: `keyterm:PutToTheTest`); kekasih (ID: `keyterm:Beloved`); sia, sia (ID: `keyterm:Worthless`); suci (ID: `keyterm:Clean`); tahan uji (ID: `keyterm:Approved`); kebenaran (ID: `keyterm:Truth`); tidak dicemarkan (ID: `keyterm:Undefiled`); tak bernoda (ID: `keyterm:AboveCriticism`); janji (ID: `keyterm:Promise`); yang baik (ID: `keyterm:Good`); berbuat dosa (ID: `keyterm:Sin`); A Person (ID: `person:GenericPerson`); kehidupan (ID: `keyterm:Life`); hukum (ID: `keyterm:Law`); hati (ID: `keyterm:Heart`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); tidak dapat dicobai (ID: `keyterm:NotTempted`); kasihi (ID: `keyterm:Love`); keahlian (ID: `keyterm:Ability`); keselamatan (ID: `keyterm:Salvation`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** sia, sia (ID: `keyterm:Worthless`); suci (ID: `keyterm:Clean`); tidak dicemarkan (ID: `keyterm:Undefiled`); Tuhan (ID: `deity:Lord`); tak bernoda (ID: `keyterm:AboveCriticism`); hati (ID: `keyterm:Heart`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); tonton bulu atau muka (ID: `keyterm:Partiality`); kemuliaan (ID: `keyterm:Glory`); bimbang (ID: `keyterm:Discern`); percaya (ID: `keyterm:Believe`); Yesus (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); Footstool (ID: `realia:Footstool`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** janji (ID: `keyterm:Promise`); Tuhan (ID: `deity:Lord`); kerajaan (ID: `keyterm:Kingdom`); kasihi (ID: `keyterm:Love`); kekasih (ID: `keyterm:Beloved`); percaya (ID: `keyterm:Believe`); orang pilihan (ID: `keyterm:Chosen`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); tersandung (ID: `keyterm:Stumble`); tonton bulu atau muka (ID: `keyterm:Partiality`); penghakiman (ID: `keyterm:Judgment`); pengadilan (ID: `keyterm:CourtCase`); kasihi (ID: `keyterm:Love`); memutuskan (ID: `keyterm:Decided`); belas kasihan (ID: `keyterm:Mercy`); berbuat dosa (ID: `keyterm:Sin`); persundalan (ID: `keyterm:Fornication`); kitab suci (ID: `keyterm:Scripture`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); A Person (ID: `person:GenericPerson`); tubuh (ID: `keyterm:Body.3`); Tuhan (ID: `deity:Lord`); Abraham (ID: `person:Abraham`); sia, sia (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); An Angel (ID: `deity:Angel`); Ishak (ID: `person:Isaac`); hampa (ID: `keyterm:Empty`); roh (ID: `keyterm:Spirit.2`); Demons (ID: `deity:Demons`); menggenapi (ID: `keyterm:Happen`); memperdamaikan (ID: `keyterm:Peace`); kitab suci (ID: `keyterm:Scripture`); keselamatan (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); sia, sia (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); An Angel (ID: `deity:Angel`); Ishak (ID: `person:Isaac`); tubuh (ID: `keyterm:Body.3`); Tuhan (ID: `deity:Lord`); hampa (ID: `keyterm:Empty`); menggenapi (ID: `keyterm:Happen`); roh (ID: `keyterm:Spirit.2`); kitab suci (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Tuhan (ID: `deity:Lord`); percaya (ID: `keyterm:Believe`); menggenapi (ID: `keyterm:Happen`); Abraham (ID: `person:Abraham`); kitab suci (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** neraka (ID: `keyterm:Gehenna`); Hell (ID: `place:Hell`); tubuh (ID: `keyterm:Body.3`); lalim (ID: `keyterm:UnjustDeed`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); tidak setia (ID: `keyterm:Unfaithful`); persahabatan (ID: `keyterm:Friendship`); ingin (ID: `keyterm:LongFor`); membersihkan (ID: `keyterm:Cleanse.2`); Roh (ID: `deity:HolySpirit`); kebaikan (ID: `keyterm:Favor`); Cause of Joy (ID: `keyterm:CauseOfJoy`); murni (ID: `keyterm:Pure`); roh (ID: `keyterm:Spirit.2`); kitab suci (ID: `keyterm:Scripture`); hati (ID: `keyterm:Heart`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** roh (ID: `keyterm:Spirit.2`); kitab suci (ID: `keyterm:Scripture`); ingin (ID: `keyterm:LongFor`); Roh (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** membersihkan (ID: `keyterm:Cleanse.2`); hati (ID: `keyterm:Heart`); Tuhan (ID: `deity:Lord`); murni (ID: `keyterm:Pure`)
...
* **Associated ACAI Concepts:** bersaksi (ID: `keyterm:BearWitness`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); menentang (ID: `keyterm:Condemn`); tubuh (ID: `keyterm:Body.3`); Tuhan (ID: `deity:Lord`); hati (ID: `keyterm:Heart`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); Tuhan (ID: `deity:Lord`); nama (ID: `keyterm:Name`); diurapi (ID: `keyterm:Anointed`); jemaat (ID: `keyterm:Church`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); Tuhan (ID: `deity:Lord`); mengampuni (ID: `keyterm:Forgive`); percaya (ID: `keyterm:Believe`); berbuat dosa (ID: `keyterm:Sin`); keselamatan (ID: `keyterm:Salvation`)
