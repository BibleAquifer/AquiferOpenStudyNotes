...
* **Associated ACAI Concepts:** Bigtá (ID: `person:Bigtha`); Carcas (ID: `person:Carkas`); Meumã (ID: `person:Mehuman`); Zetar (ID: `person:Zethar`); Abagta (ID: `person:Abagtha`); Bizta (ID: `person:Biztha`); Harbona (ID: `person:Harbona`); Assuero (ID: `person:Ahasuerus`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Vasti (ID: `person:Vashti`); Pérsia (ID: `place:Persia`); Persians (ID: `group:Persia`); Medã (ID: `person:Medan`); Medes (ID: `group:Mede`); Assuero (ID: `person:Ahasuerus`)
...
* **Associated ACAI Concepts:** Nabucodonozor (ID: `person:Nebuchadnezzar`); Jeoaquim (ID: `person:Jehoiachin`); Judá (ID: `group:Judah`); Babilônia (ID: `place:Babylon`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Assuero (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); Agagites (ID: `group:Agag`); Hamedata (ID: `person:Hammedatha`); Agague (ID: `person:Agag.2`); Money (ID: `realia:Money`); Servants (ID: `group:GenericServants`); Susã (ID: `place:Susa`); lot (ID: `keyterm:Lot`); Scroll (ID: `realia:Scroll`); Talent (ID: `realia:Talent`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Agague (ID: `person:Agag.2`); Agagites (ID: `group:Agag`); Jews (ID: `group:Jews`); Hamedata (ID: `person:Hammedatha`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Zeres (ID: `person:Zeresh`); love (ID: `keyterm:Love`); A Group of People (ID: `group:GenericGroup`); Ester (ID: `person:Esther`); Jews (ID: `group:Jews`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Zeres (ID: `person:Zeresh`); A Group of People (ID: `group:GenericGroup`); Jews (ID: `group:Jews`); Mordecai (ID: `person:Mordecai.2`); love (ID: `keyterm:Love`); Hamã (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Ester (ID: `person:Esther`); Jews (ID: `group:Jews`); Mordecai (ID: `person:Mordecai.2`); Assuero (ID: `person:Ahasuerus`); Hamã (ID: `person:Haman`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Agagites (ID: `group:Agag`); Ester (ID: `person:Esther`); Hamã (ID: `person:Haman`); Jews (ID: `group:Jews`); Agague (ID: `person:Agag.2`); beg for mercy (ID: `keyterm:BegForMercy`)
...
* **Associated ACAI Concepts:** Hamedata (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Hamã (ID: `person:Haman`); Jews (ID: `group:Jews`); favor (ID: `keyterm:Favor`); Agague (ID: `person:Agag.2`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Porata (ID: `person:Poratha`); Aridata (ID: `person:Aridatha`); Vaizata (ID: `person:Vaizatha`); Adalia (ID: `person:Adalia`); Parsandata (ID: `person:Parshandatha`); Arisai (ID: `person:Arisai`); Dalfom (ID: `person:Dalphon`); Aspata (ID: `person:Aspatha`); Aridai (ID: `person:Aridai`); Farmasta (ID: `person:Parmashta`); Jews (ID: `group:Jews`); Hamedata (ID: `person:Hammedatha`); Hamã (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Jews (ID: `group:Jews`); Ester (ID: `person:Esther`); Susã (ID: `place:Susa`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Lot (ID: `realia:Lot`); Hamedata (ID: `person:Hammedatha`); Hamã (ID: `person:Haman`); Agagites (ID: `group:Agag`); Mordecai (ID: `person:Mordecai.2`); lot (ID: `keyterm:Lot`); Agague (ID: `person:Agag.2`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Assuero (ID: `person:Ahasuerus`); Pérsia (ID: `place:Persia`); Mordecai (ID: `person:Mordecai.2`); Media (ID: `place:Media`)
