...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); SENHOR (ID: `deity:Lord`); defilement (ID: `keyterm:Defilement`); To Sin (ID: `keyterm:Sin`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Mighty One (ID: `keyterm:MightyOne`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); horn (ID: `keyterm:Horn`); Jerusalém (ID: `place:Jerusalem`); Sheep (ID: `fauna:Lamb`); Tent (ID: `realia:Tent`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** sabbath (ID: `keyterm:Sabbath`); SENHOR (ID: `deity:Lord`); appointed feast (ID: `keyterm:AppointedFeast`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); appointed feast (ID: `keyterm:AppointedFeast`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`); Edom (ID: `place:Edom`); Uz (ID: `place:Uz`); stain (ID: `keyterm:Stain`); defilement (ID: `keyterm:Defilement`); be kindly disposed (ID: `keyterm:KindlyDisposed`); Complete (ID: `keyterm:Complete`); Appoint (ID: `keyterm:Appoint`); Punishment (ID: `keyterm:Punishment`); Believe In (ID: `keyterm:BelieveIn`); anointed (ID: `keyterm:Anointed`); Sodoma (ID: `place:Sodom`); Jackal (ID: `fauna:Jackal`); Ostrich (ID: `fauna:Ostrich`); Vulture (ID: `fauna:Vulture`); Purple Cloth (ID: `realia:PurpleCloth`); Clay Jar (ID: `realia:ClayJar`)
...
* **Associated ACAI Concepts:** Edom (ID: `place:Edom`); Uz (ID: `place:Uz`); Appoint (ID: `keyterm:Appoint`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); Complete (ID: `keyterm:Complete`)
...
* **Associated ACAI Concepts:** Appoint (ID: `keyterm:Appoint`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); Edom (ID: `place:Edom`); Complete (ID: `keyterm:Complete`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Jerusalém (ID: `place:Jerusalem`); to cause to possess (ID: `keyterm:Possess`); Judá (ID: `person:Judah.4`); Egito (ID: `place:Egypt`); Judá (ID: `group:Judah`); round dance (ID: `keyterm:RoundDance`); Assyria (ID: `place:Assyria`); ardour (ID: `keyterm:Ardour`); Woe (ID: `keyterm:Woe`); House (ID: `realia:House`); Hand-Mill (ID: `realia:Hand-mill`); Crown (ID: `realia:Crown`); Money (ID: `realia:Money`); Jackal (ID: `fauna:Jackal`)
