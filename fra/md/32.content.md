...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); craindre (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); faire un voeu (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); Ninive (ID: `place:Nineveh`); Joppa (ID: `place:Joppa`); Amitthaï (ID: `person:Amittai`); Hebrews (ID: `group:Hebrews`); tuerie (ID: `keyterm:Slaughtering`); louange (ID: `keyterm:Praise`); bonté (ID: `keyterm:Kindness`); exempt (ID: `keyterm:Exempt`); destin (ID: `keyterm:Lot`); aide (ID: `keyterm:Salvation`); Tarsis (ID: `place:Tarshish`); parole du seigneur (ID: `keyterm:WordOfTheLord`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** faire un voeu (ID: `keyterm:Vow`); craindre (ID: `keyterm:Fear`); Éternel (ID: `deity:Lord`); tuerie (ID: `keyterm:Slaughtering`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Hell (ID: `place:Hell`); louange (ID: `keyterm:Praise`); faire un voeu (ID: `keyterm:Vow`); bonté (ID: `keyterm:Kindness`); aide (ID: `keyterm:Salvation`); Jonas (ID: `person:Jonah.2`); Cattails (ID: `flora:Cattails`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** louange (ID: `keyterm:Praise`); faire un voeu (ID: `keyterm:Vow`); bonté (ID: `keyterm:Kindness`); Éternel (ID: `deity:Lord`); aide (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Jonas (ID: `person:Jonah.2`); Ninive (ID: `place:Nineveh`); Éternel (ID: `deity:Lord`); parole du seigneur (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** Ninive (ID: `place:Nineveh`); Throne (ID: `realia:Throne`); Clothing (ID: `realia:Clothing`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** Cattle (ID: `fauna:Bull`); Ninive (ID: `place:Nineveh`); Éternel (ID: `deity:Lord`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** Tarsis (ID: `place:Tarshish`); bienveillant (ID: `keyterm:Generous`); bonté (ID: `keyterm:Kindness`); Éternel (ID: `deity:Lord`); miséricordieux (ID: `keyterm:Compassionate`)
