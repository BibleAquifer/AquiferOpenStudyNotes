...
* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Blood (ID: `keyterm:Blood`); Be a Disciple (ID: `keyterm:Disciple`); Covenant (ID: `keyterm:Covenant`); यहोवा (ID: `deity:Lord`); Forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); यीशु (ID: `person:Jesus.2`); Bless (ID: `keyterm:Bless`); Kingdom (ID: `keyterm:Kingdom`); Vine (ID: `flora:Vine`)
