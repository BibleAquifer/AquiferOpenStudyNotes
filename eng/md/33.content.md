...
* **Associated ACAI Concepts:** Moresheth (ID: `place:Moresheth`); Micah (ID: `person:Micah.6`); Judah (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Jerusalem (ID: `place:Jerusalem`); Samaria (ID: `place:Samaria`); LORD (ID: `deity:Lord`); Tribe of Judah (ID: `group:Judah`); Hezekiah (ID: `person:Hezekiah`); Jotham (ID: `person:Jotham.2`); Ahaz (ID: `person:Ahaz`); Have a Vision (ID: `keyterm:HaveAVision`)
...
* **Associated ACAI Concepts:** Samaria (ID: `place:Samaria`); LORD (ID: `deity:Lord`); Judah (ID: `person:Judah.4`); Jerusalem (ID: `place:Jerusalem`); Rebel (ID: `keyterm:Rebel`); Tribe of Judah (ID: `group:Judah`); Israel (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); Vine (ID: `flora:Vine`); Stone Pine (ID: `flora:Pine`); Foundation (ID: `realia:Foundation`); Image (ID: `realia:Image`); High Place (ID: `realia:HighPlace`); Graven Image (ID: `realia:GravenImage`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Jerusalem (ID: `place:Jerusalem`); Samaria (ID: `place:Samaria`); Rebel (ID: `keyterm:Rebel`); Tribe of Judah (ID: `group:Judah`); To Sin (ID: `keyterm:Sin`); Judah (ID: `person:Judah.4`); Beth-ezel (ID: `place:Beth-ezel`); Zaanan (ID: `place:Zaanan`); Moresheth-gath (ID: `place:Moresheth-gath`); Prophets (ID: `group:GenericProphets`); Achzib (ID: `place:Achzib`); Shaphir (ID: `place:Shaphir`); Maroth (ID: `place:Maroth`); Vine (ID: `flora:Vine`); House (ID: `realia:House`); Glory (ID: `keyterm:Glory`); Woe (ID: `keyterm:Woe.2`); Lot (ID: `keyterm:Lot`); Gath (ID: `place:Gath`); To Cause to Possess (ID: `keyterm:Possess`); Ophrah (ID: `place:Ophrah`); Lachish (ID: `place:Lachish`); Mischief (ID: `keyterm:Mischief`); Mareshah (ID: `place:Mareshah`); Dispossess (ID: `keyterm:Dispossess`); Adullam (ID: `place:Adullam`); Defilement (ID: `keyterm:Defilement`); Safety (ID: `keyterm:Safety`); Proverb (ID: `keyterm:Saying`); Horse (ID: `fauna:Horse`); High Place (ID: `realia:HighPlace`); Graven Image (ID: `realia:GravenImage`); Stone Pine (ID: `flora:Pine`); Cloak (ID: `realia:Cloak`); Ostrich (ID: `fauna:Ostrich`); Flock (ID: `fauna:Flock`); Foundation (ID: `realia:Foundation`); Image (ID: `realia:Image`); Jackal (ID: `fauna:Jackal`); Owl (ID: `fauna:Owl`); Sheepfold (ID: `realia:Sheepfold`); Vulture (ID: `fauna:Vulture`); Goat (ID: `fauna:Goat`); Chariot (ID: `realia:Chariot`); Bed (ID: `realia:Bed`); Wine (ID: `realia:Wine`); Rope (ID: `realia:Rope`)

## Micah 1:3 (id: 22307)

*T**read on the high places* suggests a theophany, which is an appearance of God. This God is behind the upcoming historical events affecting Samaria (see Deuteronomy 33:29; Psalm 108:13; Amos 4:13). God rules over nations and nature. People also believed the Canaanite god Baal acted in this way. Descriptions like this highlight that the Lord, not Baal, is truly in control.
...
* **Associated ACAI Concepts:** Judah (ID: `person:Judah.4`); Jerusalem (ID: `place:Jerusalem`); Samaria (ID: `place:Samaria`); Rebel (ID: `keyterm:Rebel`); Tribe of Judah (ID: `group:Judah`); Israel (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); Stone Pine (ID: `flora:Pine`); High Place (ID: `realia:HighPlace`)
...
* **Associated ACAI Concepts:** Samaria (ID: `place:Samaria`); Vine (ID: `flora:Vine`); Foundation (ID: `realia:Foundation`); Image (ID: `realia:Image`); Graven Image (ID: `realia:GravenImage`)

## Micah 1:8–16 (id: 22311)

* In response to the Lord’s predicted judgment, Micah walked barefoot and naked to show mourning (see Isaiah 20:2; Lamentations 2:10; Ezekiel 24:17). This act vividly showed what would happen to Samaria (Israel) and Jerusalem (Judah). They would lose their wealth, power, and population.
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Beth-ezel (ID: `place:Beth-ezel`); Zaanan (ID: `place:Zaanan`); Moresheth-gath (ID: `place:Moresheth-gath`); Achzib (ID: `place:Achzib`); Shaphir (ID: `place:Shaphir`); Maroth (ID: `place:Maroth`); LORD (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); Gath (ID: `place:Gath`); Rebel (ID: `keyterm:Rebel`); Tribe of Judah (ID: `group:Judah`); To Sin (ID: `keyterm:Sin`); Ophrah (ID: `place:Ophrah`); Lachish (ID: `place:Lachish`); Mareshah (ID: `place:Mareshah`); Judah (ID: `person:Judah.4`); Dispossess (ID: `keyterm:Dispossess`); Adullam (ID: `place:Adullam`); Horse (ID: `fauna:Horse`); Ostrich (ID: `fauna:Ostrich`); Jackal (ID: `fauna:Jackal`); Owl (ID: `fauna:Owl`); Vulture (ID: `fauna:Vulture`); House (ID: `realia:House`); Chariot (ID: `realia:Chariot`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Jerusalem (ID: `place:Jerusalem`); Beth-ezel (ID: `place:Beth-ezel`); Zaanan (ID: `place:Zaanan`); Moresheth-gath (ID: `place:Moresheth-gath`); Achzib (ID: `place:Achzib`); Shaphir (ID: `place:Shaphir`); Maroth (ID: `place:Maroth`); LORD (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); Gath (ID: `place:Gath`); Rebel (ID: `keyterm:Rebel`); To Sin (ID: `keyterm:Sin`); Ophrah (ID: `place:Ophrah`); Lachish (ID: `place:Lachish`); Mareshah (ID: `place:Mareshah`); Dispossess (ID: `keyterm:Dispossess`); Adullam (ID: `place:Adullam`); Horse (ID: `fauna:Horse`); House (ID: `realia:House`); Chariot (ID: `realia:Chariot`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Rebel (ID: `keyterm:Rebel`); Lachish (ID: `place:Lachish`); Israel (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); Adullam (ID: `place:Adullam`); Israel (ID: `person:Israel`); Glory (ID: `keyterm:Glory`); Mareshah (ID: `place:Mareshah`)
...
* **Associated ACAI Concepts:** Prophets (ID: `group:GenericProphets`); LORD (ID: `deity:Lord`); Defilement (ID: `keyterm:Defilement`); Israel (ID: `person:Israel`); Safety (ID: `keyterm:Safety`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Jerusalem (ID: `place:Jerusalem`); Practice Divination (ID: `keyterm:PracticeDivination`); Sheep (ID: `fauna:Lamb`); House (ID: `realia:House`); Assyria (ID: `place:Assyria`); Peace (ID: `keyterm:IntactState`); Assyrians (ID: `group:Assyria`); Bethlehem (ID: `place:Bethlehem`); Incantations (ID: `keyterm:Incantations`); Sword (ID: `realia:Sword`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`); Holy (ID: `keyterm:Holy`); Strength (ID: `keyterm:Strength`); Set Apart for God (ID: `keyterm:Proscribe`); Rebel (ID: `keyterm:Rebel`); The Way (ID: `keyterm:TheWay`); Tribe of Judah (ID: `group:Judah`); Gentiles (ID: `group:Gentile`); Asherah (ID: `deity:Asherah`); Nimrod (ID: `person:Nimrod`); To Sin (ID: `keyterm:Sin`); Redeem (ID: `keyterm:Redeem`); Perceive (ID: `keyterm:Perceive`); Instruction (ID: `keyterm:Instruction`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Babylon (ID: `place:Babylon`); Love (ID: `keyterm:Love`); Tower of Eder (ID: `place:TowerOfEder`); Judah (ID: `person:Judah.4`); Counsel (ID: `keyterm:Counsel`); Under Siege (ID: `keyterm:StateOfBeingUnderSiege`); Horn (ID: `keyterm:Horn`); Pruning Knife (ID: `realia:PruningKnife`); Sheaf (ID: `realia:Sheaf`); Horse (ID: `fauna:Horse`); Money (ID: `realia:Money`); Spear (ID: `realia:Spear`); Graven Image (ID: `realia:GravenImage`); Vine (ID: `flora:Vine`); Rod (ID: `realia:Rod`); Sacred Pillar (ID: `realia:SacredPillar`); Grass (ID: `flora:Grass`); Mattock (ID: `realia:Mattock`); Staff (ID: `realia:Staff`); Sacred Pole (ID: `realia:SacredPole`); Threshing Floor (ID: `realia:ThreshingFloor`); Chariot (ID: `realia:Chariot`); Cooking Pot (ID: `realia:CookingPot`); Fig (ID: `flora:Fig`); Lion (ID: `fauna:Lion`)
...
* **Associated ACAI Concepts:** Rebel (ID: `keyterm:Rebel`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Strength (ID: `keyterm:Strength`); To Sin (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Practice Divination (ID: `keyterm:PracticeDivination`); Money (ID: `realia:Money`); Sandalwood (ID: `flora:Sandalwood`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); House (ID: `realia:House`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Jerusalem (ID: `place:Jerusalem`); The Way (ID: `keyterm:TheWay`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`)

## Micah 4:1–5 (id: 22333)

Micah's prophecy shifts from deep despair to a burst of hope as he describes the future rise of Mount Zion in Jerusalem. God's plan to bless all nations (Genesis 12:3) through Abraham's descendants will come true when people from all nations gather at the Lord's house to worship. There:
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); House (ID: `realia:House`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Jerusalem (ID: `place:Jerusalem`); The Way (ID: `keyterm:TheWay`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); Pruning Knife (ID: `realia:PruningKnife`); Mattock (ID: `realia:Mattock`); Vine (ID: `flora:Vine`); Fig (ID: `flora:Fig`); Sword (ID: `realia:Sword`); Spear (ID: `realia:Spear`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Sheaf (ID: `realia:Sheaf`); Counsel (ID: `keyterm:Counsel`); Set Apart for God (ID: `keyterm:Proscribe`); Perceive (ID: `keyterm:Perceive`); Horn (ID: `keyterm:Horn`); Sheep (ID: `fauna:Lamb`); Threshing Floor (ID: `realia:ThreshingFloor`)
...
*the land of Nimrod*: Nimrod was a powerful early ruler. He helped establish the first cities of what later became the Assyrian and Babylonian civilizations (Genesis 10:8–11).
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Incantations (ID: `keyterm:Incantations`); Gentiles (ID: `group:Gentile`); Asherah (ID: `deity:Asherah`); Goat (ID: `fauna:Goat`); Chariot (ID: `realia:Chariot`); Sacred Pillar (ID: `realia:SacredPillar`); Sacred Pole (ID: `realia:SacredPole`); Horse (ID: `fauna:Horse`); Flock (ID: `fauna:Flock`); Grass (ID: `flora:Grass`); Sandalwood (ID: `flora:Sandalwood`); Graven Image (ID: `realia:GravenImage`); Lion (ID: `fauna:Lion`)
...
* **Associated ACAI Concepts:** Incantations (ID: `keyterm:Incantations`); LORD (ID: `deity:Lord`); Asherah (ID: `deity:Asherah`); Chariot (ID: `realia:Chariot`); Sacred Pillar (ID: `realia:SacredPillar`); Sacred Pole (ID: `realia:SacredPole`); Horse (ID: `fauna:Horse`); Graven Image (ID: `realia:GravenImage`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Deceit (ID: `keyterm:Deceit`); To Sin (ID: `keyterm:Sin`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Miriam (ID: `person:Miriam`); Balaam (ID: `person:Balaam`); Kindness (ID: `keyterm:Kindness`); Sound Wisdom (ID: `keyterm:SoundWisdom`); Gilgal (ID: `place:Gilgal.2`); Ahab (ID: `person:Ahab`); Balak (ID: `person:Balak`); Rebel (ID: `keyterm:Rebel`); Moses (ID: `person:Moses`); Redeem (ID: `keyterm:Redeem`); Offering (ID: `keyterm:Offering`); Israel (ID: `person:Israel`); Shittim (ID: `place:Shittim`); Omri (ID: `person:Omri`); Love (ID: `keyterm:Love`); Egypt (ID: `place:Egypt`); Beor (ID: `person:Beor.2`); Aaron (ID: `person:Aaron`); Moab (ID: `place:Moab`); Balance (ID: `realia:Balance`); Sheep (ID: `fauna:Lamb`); Barley (ID: `flora:Barley`); Vine (ID: `flora:Vine`); Cattle (ID: `fauna:Bull`); Foundation (ID: `realia:Foundation`); Must (ID: `realia:Must`); Olive Tree (ID: `flora:OliveTree`); Ephah (ID: `realia:Ephah`); Bag (ID: `realia:Bag`); House (ID: `realia:House`); Molten Image (ID: `realia:MoltenImage`); Mule (ID: `fauna:Mule`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Gilgal (ID: `place:Gilgal.2`); Balak (ID: `person:Balak`); LORD (ID: `deity:Lord`); Beor (ID: `person:Beor.2`); Miriam (ID: `person:Miriam`); Moses (ID: `person:Moses`); Balaam (ID: `person:Balaam`); Moab (ID: `place:Moab`); Shittim (ID: `place:Shittim`); Aaron (ID: `person:Aaron`); Egypt (ID: `place:Egypt`); Redeem (ID: `keyterm:Redeem`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); To Sin (ID: `keyterm:Sin`); Offering (ID: `keyterm:Offering`); Molten Image (ID: `realia:MoltenImage`); Anointing Oil (ID: `realia:AnointingOil`); Cattle (ID: `fauna:Bull`); Olive Oil (ID: `realia:OliveOil`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Deceit (ID: `keyterm:Deceit`); Ahab (ID: `person:Ahab`); LORD (ID: `deity:Lord`); Omri (ID: `person:Omri`); To Sin (ID: `keyterm:Sin`); Sound Wisdom (ID: `keyterm:SoundWisdom`); Balance (ID: `realia:Balance`); Bag (ID: `realia:Bag`); Vine (ID: `flora:Vine`); Anointing Oil (ID: `realia:AnointingOil`); Mule (ID: `fauna:Mule`); Olive Oil (ID: `realia:OliveOil`); Ephah (ID: `realia:Ephah`); Must (ID: `realia:Must`); Wine (ID: `realia:Wine`); Olive Tree (ID: `flora:OliveTree`); Barley (ID: `flora:Barley`); House (ID: `realia:House`)
...
*I am striking you severely*: This phrase introduces the curses God promised to bring upon the disobedient and rebellious people of Israel (see Deuteronomy 28:15–68).

* **Associated Passages:** Micah 6:13-16

* **Associated ACAI Concepts:** Ahab (ID: `person:Ahab`); Omri (ID: `person:Omri`); To Sin (ID: `keyterm:Sin`); Vine (ID: `flora:Vine`); Anointing Oil (ID: `realia:AnointingOil`); Mule (ID: `fauna:Mule`); Olive Oil (ID: `realia:OliveOil`); Must (ID: `realia:Must`); Wine (ID: `realia:Wine`); Olive Tree (ID: `flora:OliveTree`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Gilead (ID: `place:Gilead`); To Cause to Possess (ID: `keyterm:Possess`); Bashan (ID: `place:Bashan`); Goat (ID: `fauna:Goat`); Staff (ID: `realia:Staff`); Rod (ID: `realia:Rod`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Sandalwood (ID: `flora:Sandalwood`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); To Cause to Possess (ID: `keyterm:Possess`); Passion (ID: `keyterm:Ardour`); Abraham (ID: `person:Abraham`); Gilead (ID: `place:Gilead`); Bashan (ID: `place:Bashan`); Rebel (ID: `keyterm:Rebel`); Fear (ID: `keyterm:Fear`); To Sin (ID: `keyterm:Sin`); Swear (ID: `keyterm:Swear`); Truth (ID: `keyterm:Truth`); Israel (ID: `person:Israel`); Egypt (ID: `place:Egypt`); Forgive (ID: `keyterm:Forgive`); Sheep (ID: `fauna:Lamb`); Rod (ID: `realia:Rod`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`); Staff (ID: `realia:Staff`); Goat (ID: `fauna:Goat`); Snake (ID: `fauna:Snake`)
...
* **Associated ACAI Concepts:** Kindness (ID: `keyterm:Kindness`); Passion (ID: `keyterm:Ardour`); Swear (ID: `keyterm:Swear`); To Cause to Possess (ID: `keyterm:Possess`); LORD (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); Abraham (ID: `person:Abraham`); Truth (ID: `keyterm:Truth`); Israel (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); Forgive (ID: `keyterm:Forgive`)
