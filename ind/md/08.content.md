...
* **Associated ACAI Concepts:** Efrata (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Ephrathites (ID: `group:Ephrathah`); Mahlon (ID: `person:Chilion`); Moab (ID: `place:Moab`); Mahlon (ID: `person:Mahlon`); Betlehem (ID: `place:Bethlehem`); Elimelekh (ID: `person:Elimelech`); Yehuda (ID: `person:Judah.4`); Yehuda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Rut (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); Betlehem (ID: `place:Bethlehem`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Rut (ID: `person:Ruth`); kebaikan (ID: `keyterm:Favor`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elders (ID: `group:GenericElders`); Tuhan (ID: `deity:Lord`); Betlehem (ID: `place:Bethlehem`); Rahel (ID: `person:Rachel`); Lea (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Israel (ID: `person:Israel`); Tuhan (ID: `deity:Lord`); Naomi (ID: `person:Naomi`); memberkati (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); memperanakkan (ID: `person:Salmon`); Obed (ID: `person:Obed`); Aminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Daud (ID: `person:David`); Isai (ID: `person:Jesse`); Peres (ID: `person:Perez`); Nahason (ID: `person:Nahshon`); Boas (ID: `person:Boaz`)
