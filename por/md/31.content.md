...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); lot (ID: `keyterm:Lot`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`); dispossess (ID: `keyterm:Dispossess`); José (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`); José (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** dispossess (ID: `keyterm:Dispossess`); Neguebe (ID: `place:Negeb`); Benjamim (ID: `person:Benjamin`); Canaã (ID: `place:Canaan`); Monte de Esaú (ID: `place:EsauMount`); Benjamim (ID: `group:Benjamin`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Sardes (ID: `place:Sardis`); Filístia (ID: `place:Philistine`); Gileade (ID: `place:Gilead`); Sefalá (ID: `place:Shephelah`); Sarepta (ID: `place:Zarephath`); Efraim (ID: `person:Ephraim`); Filisteu (ID: `group:Philistine`); cananeu (ID: `group:Canaan`); Efraim (ID: `group:Ephraim`); Samaria (ID: `place:Samaria`)
...
* **Associated ACAI Concepts:** Monte de Esaú (ID: `place:EsauMount`); Jerusalém (ID: `place:Jerusalem`); dispossess (ID: `keyterm:Dispossess`); Neguebe (ID: `place:Negeb`); Canaã (ID: `place:Canaan`); Israel (ID: `person:Israel`); Sefalá (ID: `place:Shephelah`); Benjamim (ID: `group:Benjamin`); Sarepta (ID: `place:Zarephath`); Filisteu (ID: `group:Philistine`); cananeu (ID: `group:Canaan`); Benjamim (ID: `person:Benjamin`); Filístia (ID: `place:Philistine`); SENHOR (ID: `deity:Lord`); Samaria (ID: `place:Samaria`); Sardes (ID: `place:Sardis`); Gileade (ID: `place:Gilead`); Efraim (ID: `person:Ephraim`); Efraim (ID: `group:Ephraim`)
...
* **Associated ACAI Concepts:** Canaã (ID: `place:Canaan`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Sardes (ID: `place:Sardis`); Sarepta (ID: `place:Zarephath`); cananeu (ID: `group:Canaan`); dispossess (ID: `keyterm:Dispossess`); Neguebe (ID: `place:Negeb`)
