...
* **Associated ACAI Concepts:** Clean (ID: `keyterm:Clean`); Worthless (ID: `keyterm:Worthless`); Undefiled (ID: `keyterm:Undefiled`); Above Criticism (ID: `keyterm:AboveCriticism`); ٱلرَّبِّ (ID: `deity:Lord`); Heart (ID: `keyterm:Heart`); Ability (ID: `keyterm:Ability`)
## يعقوب 2: 1 (id: 705137)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); Partiality (ID: `keyterm:Partiality`); Believe (ID: `keyterm:Believe`); Discern (ID: `keyterm:Discern`); Glory (ID: `keyterm:Glory`); يَسوع (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`); Footstool (ID: `realia:Footstool`)
## يعقوب 2: 2 (id: 705144)
...
* **Associated ACAI Concepts:** Chosen (ID: `keyterm:Chosen`); Believe (ID: `keyterm:Believe`); Promise (ID: `keyterm:Promise`); Beloved (ID: `keyterm:Beloved`); Kingdom (ID: `keyterm:Kingdom`); ٱلرَّبِّ (ID: `deity:Lord`); Love (ID: `keyterm:Love`); Ability (ID: `keyterm:Ability`)
## يعقوب 2: 7 (id: 705147)
...
* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); ٱلرَّبِّ (ID: `deity:Lord`); Body (ID: `keyterm:Body.3`); إِبْرَاهِيمَ (ID: `person:Abraham`); A Person (ID: `person:GenericPerson`); Useless (ID: `keyterm:Idle`); رَاحَاب (ID: `person:Rahab`); To Cause to Happen (ID: `keyterm:Happen`); إِسْحَاق (ID: `person:Isaac`); Make Peace (ID: `keyterm:Peace`); Salvation (ID: `keyterm:Salvation`); Empty (ID: `keyterm:Empty`); Written (ID: `keyterm:Scripture`); Demons (ID: `deity:Demons`); Spirit (ID: `keyterm:Spirit.2`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** Be (Or Show Oneself) Just (ID: `keyterm:Just`); Believe (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`); ٱلرَّبِّ (ID: `deity:Lord`); Written (ID: `keyterm:Scripture`); إِبْرَاهِيمَ (ID: `person:Abraham`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Be Unfaithful (ID: `keyterm:Unfaithful`); Friendship (ID: `keyterm:Friendship`); Pure (ID: `keyterm:Pure`); To Cleanse (ID: `keyterm:Cleanse.2`); Long For (ID: `keyterm:LongFor`); Favor (ID: `keyterm:Favor`); Ability (ID: `keyterm:Ability`); Heart (ID: `keyterm:Heart`); Written (ID: `keyterm:Scripture`); Cause of Joy (ID: `keyterm:CauseOfJoy`); ٱلرّوحِ (ID: `deity:HolySpirit`); Spirit (ID: `keyterm:Spirit.2`)
## يعقوب 4: 5 (id: 705172)
...
* **Associated ACAI Concepts:** To Cleanse (ID: `keyterm:Cleanse.2`); Heart (ID: `keyterm:Heart`); ٱلرَّبِّ (ID: `deity:Lord`); Pure (ID: `keyterm:Pure`)
...
* **Associated ACAI Concepts:** Be (Or Show Oneself) Just (ID: `keyterm:Just`); ٱلرَّبِّ (ID: `deity:Lord`); Condemn (ID: `keyterm:Condemn`); Body (ID: `keyterm:Body.3`); Heart (ID: `keyterm:Heart`); Bear Witness (ID: `keyterm:BearWitness`); Clothing (ID: `realia:Clothing`)
## يعقوب 5: 2 (id: 705184)
...
* **Associated ACAI Concepts:** Anointed (ID: `keyterm:Anointed`); Name (ID: `keyterm:Name`); ٱلرَّبِّ (ID: `deity:Lord`); Pray (ID: `keyterm:Pray`); Church (ID: `keyterm:Church`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); Believe (ID: `keyterm:Believe`); Forgive (ID: `keyterm:Forgive`); ٱلرَّبِّ (ID: `deity:Lord`); Pray (ID: `keyterm:Pray`); Salvation (ID: `keyterm:Salvation`)
