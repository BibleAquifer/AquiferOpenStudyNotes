...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Intention (ID: `keyterm:Intention`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vine (ID: `flora:Vine`); To Sin (ID: `keyterm:Sin`); إِسْرَائِيلَ (ID: `person:Israel`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Sandalwood (ID: `flora:Sandalwood`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Sandalwood (ID: `flora:Sandalwood`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vow (ID: `keyterm:Vow`); House (ID: `realia:House`); Slaughtering (ID: `keyterm:Slaughtering`); A Man (ID: `person:GenericMale`); Strength (ID: `keyterm:Strength`); An Angel (ID: `deity:Angel`); Passion (ID: `keyterm:Ardour`); Fear (ID: `keyterm:Fear`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** Stupid (ID: `keyterm:Stupid`); Ability (ID: `keyterm:Ability`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); Intention (ID: `keyterm:Intention`); To Sin (ID: `keyterm:Sin`); To Act Wickedly (ID: `keyterm:ActWickedly`); To Cause to Possess (ID: `keyterm:Possess`); Fear (ID: `keyterm:Fear`); Brier (ID: `flora:Brier`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Cooking Pot (ID: `realia:CookingPot`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); ٱلرَّبِّ (ID: `deity:Lord`); Fishnet (ID: `realia:Fishnet`); Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`)
...
* **Associated ACAI Concepts:** Intention (ID: `keyterm:Intention`); Hell (ID: `place:Hell`); ٱلرَّبِّ (ID: `deity:Lord`); Love (ID: `keyterm:Love`); Ability (ID: `keyterm:Ability`); Strength (ID: `keyterm:Strength`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); ٱلرَّبِّ (ID: `deity:Lord`); Caper (ID: `flora:Caper`); Clay Jar (ID: `realia:ClayJar`); Bird (ID: `fauna:Bird`); Rope (ID: `realia:Rope`); Money (ID: `realia:Money`); Locust (ID: `fauna:Locust`); Pit (ID: `realia:Pit`); Almond (ID: `flora:Almond`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Intention (ID: `keyterm:Intention`); Straightness (ID: `keyterm:Straightness`); Truth (ID: `keyterm:Truth`); Proverb (ID: `keyterm:Saying`); Fear (ID: `keyterm:Fear`); Goad (ID: `realia:Goad`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Scroll (ID: `realia:Scroll`); Nail (ID: `realia:Nail`)
