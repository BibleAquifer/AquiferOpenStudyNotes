...
* **Associated ACAI Concepts:** lot (ID: `keyterm:Lot`); Judá (ID: `group:Judah`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Edomites (ID: `group:Edom`); dispossess (ID: `keyterm:Dispossess`); José (ID: `person:Joseph.10`); Jerusalém (ID: `place:Jerusalem`); Edom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** dispossess (ID: `keyterm:Dispossess`); Neguebe (ID: `place:Negeb`); Gileade (ID: `place:Gilead`); Sarepta (ID: `place:Zarephath`); Filístia (ID: `place:Philistine`); Monte de Esaú (ID: `place:EsauMount`); Samaria (ID: `place:Samaria`); Sefalá (ID: `place:Shephelah`); Benjamim (ID: `group:Benjamin`); Filisteu (ID: `group:Philistine`); Efraim (ID: `group:Ephraim`); Sardes (ID: `place:Sardis`); Benjamim (ID: `person:Benjamin`); Efraim (ID: `person:Ephraim`); Canaã (ID: `place:Canaan`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); cananeu (ID: `group:Canaan`)
...
* **Associated ACAI Concepts:** Monte de Esaú (ID: `place:EsauMount`); dispossess (ID: `keyterm:Dispossess`); Neguebe (ID: `place:Negeb`); Jerusalém (ID: `place:Jerusalem`); Sarepta (ID: `place:Zarephath`); Filístia (ID: `place:Philistine`); Filisteu (ID: `group:Philistine`); cananeu (ID: `group:Canaan`); Efraim (ID: `group:Ephraim`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Gileade (ID: `place:Gilead`); Benjamim (ID: `group:Benjamin`); Canaã (ID: `place:Canaan`); Samaria (ID: `place:Samaria`); Sefalá (ID: `place:Shephelah`); Sardes (ID: `place:Sardis`); Benjamim (ID: `person:Benjamin`); Efraim (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** Sarepta (ID: `place:Zarephath`); dispossess (ID: `keyterm:Dispossess`); Sardes (ID: `place:Sardis`); Canaã (ID: `place:Canaan`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Neguebe (ID: `place:Negeb`); cananeu (ID: `group:Canaan`)
