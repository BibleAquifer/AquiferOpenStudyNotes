...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); Fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); Vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); يَافَا (ID: `place:Joppa`); أَمِتَّايَ (ID: `person:Amittai`); نِينَوَى (ID: `place:Nineveh`); Kindness (ID: `keyterm:Kindness`); Salvation (ID: `keyterm:Salvation`); تَرْشِيشَ (ID: `place:Tarshish`); Hebrews (ID: `group:Hebrews`); Exempt (ID: `keyterm:Exempt`); Praise (ID: `keyterm:Praise`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Slaughtering (ID: `keyterm:Slaughtering`); Lot (ID: `keyterm:Lot`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Hell (ID: `place:Hell`); Salvation (ID: `keyterm:Salvation`); Praise (ID: `keyterm:Praise`); يونَانَ (ID: `person:Jonah.2`); Kindness (ID: `keyterm:Kindness`); Vow (ID: `keyterm:Vow`); Cattails (ID: `flora:Cattails`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Salvation (ID: `keyterm:Salvation`); Praise (ID: `keyterm:Praise`); Kindness (ID: `keyterm:Kindness`); Vow (ID: `keyterm:Vow`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); نِينَوَى (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Compassionate (ID: `keyterm:Compassionate`); Believe In (ID: `keyterm:BelieveIn`); تَرْشِيشَ (ID: `place:Tarshish`); Kindness (ID: `keyterm:Kindness`); Generous (ID: `keyterm:Generous`); Clothing (ID: `realia:Clothing`); Goat (ID: `fauna:Goat`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Compassionate (ID: `keyterm:Compassionate`); ٱلرَّبِّ (ID: `deity:Lord`); تَرْشِيشَ (ID: `place:Tarshish`); Kindness (ID: `keyterm:Kindness`); Generous (ID: `keyterm:Generous`)
