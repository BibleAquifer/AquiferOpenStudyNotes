...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Tessalônica (ID: `place:Thessalonica`); Thessalonians (ID: `group:Thessalonica`); igreja (ID: `keyterm:Church`); Silas (ID: `person:Silas`); Timóteo (ID: `person:Timothy`); fazer a paz (ID: `keyterm:Peace`); favor (ID: `keyterm:Favor`); Paulo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); be (or show oneself) just (ID: `keyterm:Just`); céu (ID: `keyterm:Heaven`); Glory (ID: `keyterm:Glory`); ser glorificado (ID: `keyterm:Glorified`); An Angel (ID: `deity:Angel`); boa notícia (ID: `keyterm:GoodNews`); reino (ID: `keyterm:Kingdom`); tribunal de justiça (ID: `keyterm:CourtCase`); testemunhar (ID: `keyterm:BearWitness`); igreja (ID: `keyterm:Church`); juízo (ID: `keyterm:Judgment`); dever (ID: `keyterm:Ought`); love (ID: `keyterm:Love`); holy (ID: `keyterm:Holy`); fazer justiça (ID: `keyterm:GrantJustice`); Ability (ID: `keyterm:Ability`); para a eternidade (ID: `keyterm:Always`)
...
* **Associated ACAI Concepts:** be (or show oneself) just (ID: `keyterm:Just`); juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`); reino (ID: `keyterm:Kingdom`); tribunal de justiça (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** testemunhar (ID: `keyterm:BearWitness`); ser glorificado (ID: `keyterm:Glorified`); crer (ID: `keyterm:Believe`); holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** To Cause to Happen (ID: `keyterm:Happen`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); To Cause to Happen (ID: `keyterm:Happen`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); Ability (ID: `keyterm:Ability`); Name (ID: `keyterm:Name`); favor (ID: `keyterm:Favor`); ser glorificado (ID: `keyterm:Glorified`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Name (ID: `keyterm:Name`); ser glorificado (ID: `keyterm:Glorified`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Spirit (ID: `keyterm:Spirit.2`); Truth (ID: `keyterm:Truth`); crer (ID: `keyterm:Believe`); Satanás (ID: `deity:Satan`); decidir (ID: `keyterm:Decided`); example (ID: `keyterm:Example`); salvation (ID: `keyterm:Salvation`); rogar (ID: `keyterm:AskFor`); Ability (ID: `keyterm:Ability`); injustiça (ID: `keyterm:UnjustDeed`); objeto de culto (ID: `keyterm:ObjectOfWorship`); maravilha (ID: `keyterm:Portent`); love (ID: `keyterm:Love`); wipe (out), destroy (ID: `keyterm:Destroy`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); hope (ID: `keyterm:Hope`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); para a eternidade (ID: `keyterm:Always`); favor (ID: `keyterm:Favor`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); orar (ID: `keyterm:Pray`); SENHOR (ID: `deity:Lord`); Faithfulness (ID: `keyterm:Faithfulness`); Glory (ID: `keyterm:Glory`); livrar (ID: `keyterm:Deliver`); love (ID: `keyterm:Love`); persuadir (ID: `keyterm:Persuade`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); andar (ID: `keyterm:Live.3`); tradição (ID: `keyterm:Teaching`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); andar (ID: `keyterm:Live.3`); Ability (ID: `keyterm:Ability`); rogar (ID: `keyterm:AskFor`); Name (ID: `keyterm:Name`); autoridade (ID: `keyterm:Authority.2`); tradição (ID: `keyterm:Teaching`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`)
