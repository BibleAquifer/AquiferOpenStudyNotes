...
* **Associated ACAI Concepts:** Ephrathites (ID: `group:Ephrathah`); Efrata (ID: `person:Ephrathah`); Noemi (ID: `person:Naomi`); Quiliom (ID: `person:Chilion`); Moabe (ID: `place:Moab`); Judá (ID: `group:Judah`); Elimeleque (ID: `person:Elimelech`); Judá (ID: `person:Judah.4`); Belém (ID: `place:Bethlehem`); Malom (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Noemi (ID: `person:Naomi`); Rute (ID: `person:Ruth`); Belém (ID: `place:Bethlehem`); Moabe (ID: `place:Moab`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); Moabe (ID: `place:Moab`); Noemi (ID: `person:Naomi`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** Barley (ID: `flora:Barley`); House (ID: `realia:House`); Sickle (ID: `realia:Sickle`)
...
* **Associated ACAI Concepts:** kindness (ID: `keyterm:Kindness`); SENHOR (ID: `deity:Lord`); Noemi (ID: `person:Naomi`); bless (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Raquel (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); SENHOR (ID: `deity:Lord`); Lia (ID: `person:Leah`); Belém (ID: `place:Bethlehem`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Perez (ID: `person:Perez`); Tamar (ID: `person:Tamar`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Noemi (ID: `person:Naomi`); bless (ID: `keyterm:Bless`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Salmom (ID: `person:Salmon`); Hezrom (ID: `person:Hezron.2`); Aminadabe (ID: `person:Amminadab`); Obede (ID: `person:Obed`); Ram (ID: `person:Ram`); Perez (ID: `person:Perez`); Boaz (ID: `person:Boaz`); Jessé (ID: `person:Jesse`); Davi (ID: `person:David`); Naassom (ID: `person:Nahshon`)
