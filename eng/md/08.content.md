...
* **Associated ACAI Concepts:** Ephrathites (ID: `group:Ephrathah`); Chilion (ID: `person:Chilion`); Ephrathah (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`)
## Ruth 1:4 (id: 25792)
...
* **Associated ACAI Concepts:** Salmon (ID: `person:Salmon`); Hezron (ID: `person:Hezron.2`); Ram (ID: `person:Ram`)
