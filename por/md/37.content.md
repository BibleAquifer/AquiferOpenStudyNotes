...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Ageu (ID: `person:Haggai`); Sealtiel (ID: `person:Shealtiel.2`); Josué (ID: `person:Joshua.5`); Dario (ID: `person:Darius.2`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Zorobabel (ID: `person:Zerubbabel.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Ageu (ID: `person:Haggai`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); Dario (ID: `person:Darius.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); An Angel (ID: `deity:Angel`); fear (ID: `keyterm:Fear`); Bag (ID: `realia:Bag`); Must (ID: `realia:Must`); Anointing Oil (ID: `realia:AnointingOil`); Vine (ID: `flora:Vine`); Olive Oil (ID: `realia:OliveOil`); Grain (ID: `flora:Grain`); Mule (ID: `fauna:Mule`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); SENHOR (ID: `deity:Lord`); Jeozadaque (ID: `person:Jehozadak`); Ageu (ID: `person:Haggai`); Sealtiel (ID: `person:Shealtiel.2`); Josué (ID: `person:Joshua.5`); fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Zorobabel (ID: `person:Zerubbabel.2`); Sealtiel (ID: `person:Shealtiel.2`); Josué (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Ageu (ID: `person:Haggai`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Sealtiel (ID: `person:Shealtiel.2`); Egito (ID: `place:Egypt`); peace (ID: `keyterm:IntactState`); Word of the Lord (ID: `keyterm:WordOfTheLord`); fear (ID: `keyterm:Fear`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); SENHOR (ID: `deity:Lord`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Ageu (ID: `person:Haggai`); Sealtiel (ID: `person:Shealtiel.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Horse (ID: `fauna:Horse`); Sword (ID: `realia:Sword`); Chariot (ID: `realia:Chariot`)
