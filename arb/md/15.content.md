...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); ٱلرَّبِّ (ID: `deity:Lord`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`); إِرْمِيَا (ID: `person:Jeremiah.6`); Word of the Lord (ID: `keyterm:WordOfTheLord`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `person:Benjamin`); بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `group:Levi`); Money (ID: `realia:Money`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath`); كورَشَ (ID: `person:Cyrus`); يَهوذَا (ID: `group:Judah`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `person:Judah.4`); زَربَّابِل (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); سلَيْمَانَ (ID: `person:Solomon`); لَّاوِي (ID: `group:Levi`); حَشوم (ID: `person:Hashum`); سِيعَهَا (ID: `person:Siaha`); أَدَّان (ID: `place:Addan`); Meunim (ID: `group:Meunim`); يَشوعَ (ID: `person:Jeshua.3`); يوآب (ID: `person:Joab.3`); مرْدَخَاي (ID: `person:Mordecai`); نَبو (ID: `place:Nebo.2`); حَزَقِيَّا (ID: `person:Hezekiah.2`); نَحَمْيَا (ID: `person:Nehemiah`); آرَحَ (ID: `person:Arah.2`); نَصِيحَ (ID: `person:Neziah`); يَشوعَ (ID: `person:Jeshua`); فِي (ID: `person:Uzza.2`); حَبَايَا (ID: `person:Habaiah`); طَلْمون (ID: `person:Talmon`); Beth-azmaveth (ID: `place:Beth-azmaveth`); سَلْمَايَ (ID: `person:Shalmai`); مِسْفَار (ID: `person:Mispar`); لِدَلَايَا (ID: `person:Delaiah.3`); دَرْقونَ (ID: `person:Darkon`); أَسْنَةَ (ID: `person:Asnah`); عَادِينَ (ID: `person:Adin`); بِلْشَان (ID: `person:Bilshan`)
...
* **Associated ACAI Concepts:** بَعْنَةَ (ID: `person:Baanah.3`); نَحَمْيَا (ID: `person:Nehemiah`); بِغْوَايَ (ID: `person:Bigvai`); رَحوم (ID: `person:Rehum`); سَرَايَا (ID: `person:Seraiah.6`); رَعْلَايَا (ID: `person:Reelaiah`); بِلْشَان (ID: `person:Bilshan`); مِسْفَار (ID: `person:Mispar`); مرْدَخَاي (ID: `person:Mordecai`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** بَانِيَ (ID: `person:Bani`); عَرْجَدَ (ID: `person:Azgad`); زَكَّايَ (ID: `person:Zaccai.2`); حَشوم (ID: `person:Hashum`); عِيلَامَ (ID: `person:Elam`); بَابَايَ (ID: `person:Bebai`); يَشوعَ (ID: `person:Jeshua.3`); بِغْوَايَ (ID: `person:Bigvai.2`); يوآب (ID: `person:Joab.3`); حَزَقِيَّا (ID: `person:Hezekiah.2`); آطِيرَ (ID: `person:Ater`); آرَحَ (ID: `person:Arah.2`); شَفَطْيَا (ID: `person:Shephatiah.6`); أَدونِيقَامَ (ID: `person:Adonikam`); بِيصَايَ (ID: `person:Bezai`); يورَةَ (ID: `person:Jorah`); فَرْعوشَ (ID: `person:Parosh`); زَتّو (ID: `person:Zattu.2`); Pahath-moab (ID: `person:Pahath-moab`); عَادِينَ (ID: `person:Adin`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); سَنَاءَةَ (ID: `place:Senaah`); نَبو (ID: `place:Nebo.2`); حَادِيدَ (ID: `place:Hadid`); Beth-azmaveth (ID: `place:Beth-azmaveth`); حَارِيمَ (ID: `person:Harim.2`); مَغْبِيشَ (ID: `place:Magbish`); وَلودَ (ID: `place:Lod`); عَنَاثوثَ (ID: `place:Anathoth`); Ramah (ID: `place:Ramah.2`); عِيلَامَ (ID: `person:Elam`); لَحْمٍ (ID: `place:Bethlehem`); Kiriath-jearim (ID: `place:Kiriath-jearim`); Bethel (ID: `place:Bethel`); مِنْ (ID: `place:Geba`); مِخْمَاسَ (ID: `place:Michmash`); ٱلْكَفِيرَة (ID: `place:Chephirah`); بَئِيروت (ID: `place:Beeroth`); أَرِيحَا (ID: `place:Jericho`); أونوَ (ID: `place:Ono`); عَايٍ (ID: `place:Ai`)
...
* **Associated ACAI Concepts:** لِإِيمِيرَ (ID: `person:Immer.2`); حَطِيطَا (ID: `person:Hatita`); حَارِيمَ (ID: `person:Harim`); طَلْمون (ID: `person:Talmon`); يَدَايَا (ID: `person:Jedaiah.4`); يَشوعَ (ID: `person:Jeshua.4`); يَشوعَ (ID: `person:Jeshua`); آطِيرَ (ID: `person:Ater.2`); هودَوْيَا (ID: `person:Hodaviah.4`); شوبَايَ (ID: `person:Shobai`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); لَّاوِي (ID: `person:Levi.3`); شَلّوم (ID: `person:Shallum.8`); فَشْحور (ID: `person:Pashhur`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** حَطِيطَا (ID: `person:Hatita`); طَلْمون (ID: `person:Talmon`); آطِيرَ (ID: `person:Ater.2`); شوبَايَ (ID: `person:Shobai`); شَلّوم (ID: `person:Shallum.8`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** حَجَابَةَ (ID: `person:Hagabah`); حَاجَابَ (ID: `person:Hagab`); بَصْلوتَ (ID: `person:Bazluth`); سِيعَهَا (ID: `person:Siaha`); صِيحَا (ID: `person:Ziha`); لَبَانَةَ (ID: `person:Lebanah`); Meunim (ID: `group:Meunim`); بِيسَايَ (ID: `person:Besai`); ثَامَحَ (ID: `person:Temah`); فَاسِيحَ (ID: `person:Paseah.2`); حَانَان (ID: `person:Hanan.4`); بَقْبوقَ (ID: `person:Bakbuk`); حَقوفَا (ID: `person:Hakupha`); حَطِيفَا (ID: `person:Hatipha`); نَصِيحَ (ID: `person:Neziah`); جَاحَرَ (ID: `person:Gahar`); رَآيَا (ID: `person:Reaiah.3`); حَرْشَا (ID: `person:Harsha`); فِي (ID: `person:Uzza.2`); قِيروسَ (ID: `person:Keros`); جَدِّيلَ (ID: `person:Giddel`); جَزَّامَ (ID: `person:Gazzam`); حَسوفَا (ID: `person:Hasupha`); Nephushesim (ID: `group:Nephushesim`); عَقّوب (ID: `person:Akkub.3`); بَرْقوسَ (ID: `person:Barkos`); سَلْمَايَ (ID: `person:Shalmai`); حَرْحورَ (ID: `person:Harhur`); رَصِينَ (ID: `person:Rezin.2`); طَبَاعوتَ (ID: `person:Tabbaoth`); مَحِيدَا (ID: `person:Mehida`); فَادونَ (ID: `person:Padon`); سِيسَرَا (ID: `person:Sisera.2`); أَسْنَةَ (ID: `person:Asnah`); نَقودَا (ID: `person:Nekoda`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); شَفَطْيَا (ID: `person:Shephatiah.7`); حَطِّيلَ (ID: `person:Hattil`); دَرْقونَ (ID: `person:Darkon`); سَوْطَايَ (ID: `person:Sotai`); فَرودَا (ID: `person:Peruda`); يَعْلَةَ (ID: `person:Jaalah`); آمِي (ID: `person:Ami`); جَدِّيلَ (ID: `person:Giddel.2`); سوفَرَثَ (ID: `person:Sophereth`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`)
...
* **Associated ACAI Concepts:** طوبِيَّا (ID: `person:Tobiah`); Tel-melah (ID: `place:Tel-melah`); لِدَلَايَا (ID: `person:Delaiah.3`); نَقودَا (ID: `person:Nekoda.2`); أَدَّان (ID: `place:Addan`); كَروب (ID: `place:Cherub`); Tel-harsha (ID: `place:Tel-harsha`); لِإِيمِيرَ (ID: `place:Immer`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** حَبَايَا (ID: `person:Habaiah`); هَقّوصَ (ID: `person:Hakkoz.2`); بَرْزِلَّايَ (ID: `person:Barzillai.3`); جِلْعَادَ (ID: `place:Gilead`); Priesthood (ID: `keyterm:Priesthood`); Defile (ID: `keyterm:Stain`); Gileadites (ID: `group:Gilead`); بَرْزِلَّايَ (ID: `person:Barzillai`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); Strength (ID: `keyterm:Strength`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); Tunic (ID: `realia:Tunic`); House (ID: `realia:House`); Mina (ID: `realia:Mina`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); يَشوع (ID: `person:Joshua.5`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); يَشوعَ (ID: `person:Jeshua.4`); Esarhaddon (ID: `person:Esarhaddon`); هودَوْيَا (ID: `person:Hodaviah.4`); حِينَادَادَ (ID: `person:Henadad`); Relatives (ID: `group:Relatives`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); Kindness (ID: `keyterm:Kindness`); لبْنَانَ (ID: `place:Lebanon`); Sidonians (ID: `group:Sidon`); بَنْيَامِينَ (ID: `group:Benjamin`); Tyrians (ID: `group:Tyre`); Holy (ID: `keyterm:Holy`); هودِيَّا (ID: `person:Hodiah.2`); موسَى (ID: `person:Moses`); New Moon Festival (ID: `keyterm:NewMoonFestival`); صورَ (ID: `place:Tyre`); Terror (ID: `keyterm:Terror`); دَاودَ (ID: `person:David`); Assyria (ID: `place:Assyria`); يَافَا (ID: `place:Joppa`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Instruction (ID: `keyterm:Instruction`); Appointed Feast (ID: `keyterm:AppointedFeast`); Counsel (ID: `keyterm:Counsel`); بَنْيَامِينَ (ID: `person:Benjamin`); صِيْدونَ (ID: `place:Sidon`); دَارِيوسَ (ID: `person:Darius.2`); آسَاف (ID: `person:Asaph.2`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Trumpet (ID: `realia:Trumpet`); Money (ID: `realia:Money`); Cedar (ID: `flora:Cedar`); Olive Oil (ID: `realia:OliveOil`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); موسَى (ID: `person:Moses`); Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); إِسْرَائِيلَ (ID: `person:Israel`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); Terror (ID: `keyterm:Terror`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** يَافَا (ID: `place:Joppa`); كورَشَ (ID: `person:Cyrus`); لبْنَانَ (ID: `place:Lebanon`); Sidonians (ID: `group:Sidon`); صِيْدونَ (ID: `place:Sidon`); فَارِسَ (ID: `place:Persia`); صورَ (ID: `place:Tyre`); Tyrians (ID: `group:Tyre`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Cedar (ID: `flora:Cedar`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `group:Levi`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Kindness (ID: `keyterm:Kindness`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); آسَاف (ID: `person:Asaph.2`); دَاودَ (ID: `person:David`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); يَشوع (ID: `person:Joshua.5`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); إِسْرَائِيلَ (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْفرَاتِ (ID: `place:Euphrates`); رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); ٱلسَّامِرَةِ (ID: `place:Samaria`); فَارِسَ (ID: `place:Persia`); Jews (ID: `group:Jews`); أَرَكَ (ID: `place:Erech`); مِثْرَدَاث (ID: `person:Mithredath.2`); أسْنَفَّر (ID: `person:Osnappar`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); بِشْلَام (ID: `person:Bishlam`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); Babylonians (ID: `group:Babylon`); طَبْئِيل (ID: `person:Tabeel`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); يَهوذَا (ID: `person:Judah.4`); عِيلَامَ (ID: `place:Elam`); بَابِلَ (ID: `place:Babylon`); يَهوذَا (ID: `group:Judah`); فِي (ID: `place:Susa`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** طَبْئِيل (ID: `person:Tabeel`); بِشْلَام (ID: `person:Bishlam`); مِثْرَدَاث (ID: `person:Mithredath.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Babylonians (ID: `group:Babylon`); رَحوم (ID: `person:Rehum.2`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); شِمْشَاي (ID: `person:Shimshai`); أَرَكَ (ID: `place:Erech`); بَابِلَ (ID: `place:Babylon`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); فَارِسَ (ID: `place:Persia`); فِي (ID: `place:Susa`); عِيلَامَ (ID: `place:Elam`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Jews (ID: `group:Jews`); رَحوم (ID: `person:Rehum.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); شِمْشَاي (ID: `person:Shimshai`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); دَارِيوسَ (ID: `person:Darius.2`); Shethar-bozenai (ID: `person:Shethar-bozenai`); زَكَرِيَّا (ID: `person:Zechariah.17`); يَدّو (ID: `person:Iddo.6`); حَجَّيِ (ID: `person:Haggai`); تَتْنَاي (ID: `person:Tattenai`); يَشوع (ID: `person:Joshua.5`); ٱلْفرَاتِ (ID: `place:Euphrates`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَهوذَا (ID: `person:Judah.4`); فَارِسَ (ID: `place:Persia`); زَربَّابِل (ID: `person:Zerubbabel.2`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** زَكَرِيَّا (ID: `person:Zechariah.17`); يَدّو (ID: `person:Iddo.6`); حَجَّيِ (ID: `person:Haggai`); أورشَلِيمَ (ID: `place:Jerusalem`); Jews (ID: `group:Jews`); يَهوذَا (ID: `person:Judah.4`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); بَابِلَ (ID: `place:Babylon`); أورشَلِيمَ (ID: `place:Jerusalem`); كورَشَ (ID: `person:Cyrus`); دَارِيوسَ (ID: `person:Darius.2`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); زَربَّابِل (ID: `person:Zerubbabel.2`); Shethar-bozenai (ID: `person:Shethar-bozenai`); تَتْنَاي (ID: `person:Tattenai`); Chaldeans (ID: `group:Chaldea`); ٱلْفرَاتِ (ID: `place:Euphrates`); يَهوذَا (ID: `person:Judah.4`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); إِسْرَائِيلَ (ID: `person:Israel`); Foundation (ID: `realia:Foundation`); Hewn Stone (ID: `realia:HewnStone`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); بَابِلَ (ID: `place:Babylon`); كورَشَ (ID: `person:Cyrus`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); زَربَّابِل (ID: `person:Zerubbabel.2`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); أورشَلِيمَ (ID: `place:Jerusalem`); Cubit (ID: `realia:Cubit`); Foundation (ID: `realia:Foundation`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Gentiles (ID: `group:Gentile`); ٱلرَّبِّ (ID: `deity:Lord`); Defilement (ID: `keyterm:Defilement`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** سَرَايَا (ID: `person:Seraiah.2`); عَزَرْيَا (ID: `person:Azariah.7`); عَزْرَا (ID: `person:Ezra`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فَارِسَ (ID: `place:Persia`); حِلْقِيَّا (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); عَزَرْيَا (ID: `person:Azariah.7`); لِمَرَايوثَ (ID: `person:Meraioth`); أَخِيطوبَ (ID: `person:Ahitub.3`); عَزَرْيَا (ID: `person:Azariah.6`); بقِّي (ID: `person:Bukki.2`); شَلّوم (ID: `person:Shallum.7`); أَمَرْيَا (ID: `person:Amariah.2`); زَرَحْيَا (ID: `person:Zerahiah`); صَادوق (ID: `person:Zadok.4`); سَرَايَا (ID: `person:Seraiah.2`); أَبِيشوعَ (ID: `person:Abishua`); عزِّي (ID: `person:Uzzi`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فِينَحَاس (ID: `person:Phinehas`); هَارون (ID: `person:Aaron`); فَارِسَ (ID: `place:Persia`); حِلْقِيَّا (ID: `person:Hilkiah.2`); أَلِعَازَار (ID: `person:Eleazar.2`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); بَابِلَ (ID: `place:Babylon`); موسَى (ID: `person:Moses`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Decree (ID: `keyterm:Decree`); عَزْرَا (ID: `person:Ezra`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); عَزْرَا (ID: `person:Ezra`); Anointing Oil (ID: `realia:AnointingOil`); Talent (ID: `realia:Talent`); Olive Oil (ID: `realia:OliveOil`); Wheat (ID: `flora:Wheat`); Money (ID: `realia:Money`); Kor (ID: `realia:Kor`)
...
* **Associated ACAI Concepts:** يوحَانَانَ (ID: `person:Johanan.8`); عَرْجَدَ (ID: `person:Azgad`); يوشَفْيَا (ID: `person:Josiphiah`); Gershom (ID: `person:Gershom.2`); عِيلَامَ (ID: `person:Elam`); شِمْعِيَا (ID: `person:Shemaiah.14`); بَابَايَ (ID: `person:Bebai`); عَابِد (ID: `person:Ebed.2`); زَكَرِيَّا (ID: `person:Zechariah.19`); بِغْوَايَ (ID: `person:Bigvai.2`); شَكَنْيَا (ID: `person:Shecaniah.6`); شَكَنْيَا (ID: `person:Shecaniah.5`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); عوتَاي (ID: `person:Uthai.2`); عوبَدْيَا (ID: `person:Obadiah.10`); مِيخَائِيلَ (ID: `person:Michael.10`); فَرْعوشَ (ID: `person:Parosh.2`); دَانِيآل (ID: `person:Daniel.2`); أَدونِيقَامَ (ID: `person:Adonikam`); يونَاثَانَ (ID: `person:Jonathan.9`); شَفَطْيَا (ID: `person:Shephatiah.6`); عَثَلْيَا (ID: `person:Athaliah.3`); يَحِيئِيل (ID: `person:Jehiel.7`); حَطّوش (ID: `person:Hattush.2`); زَكَرِيَّا (ID: `person:Zechariah.18`); زَكّور (ID: `person:Zaccur.5`); أَلِيفَلَط (ID: `person:Eliphelet.5`); Pahath-moab (ID: `person:Pahath-moab`); يِشْعِيَا (ID: `person:Jeshaiah.4`); يَعِيئِيل (ID: `person:Jeuel.3`); هِقَّاطَانَ (ID: `person:Hakkatan`); يوآب (ID: `person:Joab.4`); يَحْزِيئِيل (ID: `person:Jahaziel.5`); زَبَدْيَا (ID: `person:Zebadiah.8`); بَابَايَ (ID: `person:Bebai.2`); عَادِينَ (ID: `person:Adin`); زَرَحْيَا (ID: `person:Zerahiah.2`); شَلومِيَةَ (ID: `person:Shelomith.4`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فِينَحَاس (ID: `person:Phinehas`); دَاودَ (ID: `person:David`); بَابِلَ (ID: `place:Babylon`); إِيثَامَارَ (ID: `person:Ithamar`)
...
* **Associated ACAI Concepts:** زَكَرِيَّا (ID: `person:Zechariah.20`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); يَارِيبَ (ID: `person:Jarib.2`); يويَارِيبَ (ID: `person:Joiarib.2`); شِمْعِيَا (ID: `person:Shemaiah.15`); يَدّو (ID: `person:Iddo`); أَلِيعَزَرَ (ID: `person:Eliezer.8`); ٱلْمسَمَّى (ID: `place:Casiphia`); أَرِيئِيلَ (ID: `person:Ariel`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); مَشلَّام (ID: `person:Meshullam.9`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); نَاثَان (ID: `person:Nathan.5`); ٱلرَّبِّ (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); لَّاوِي (ID: `person:Levi.3`); إِسْرَائِيلَ (ID: `person:Israel`); Insight (ID: `keyterm:Insight`); ٱلرَّبِّ (ID: `deity:Lord`); مَحْلِي (ID: `person:Mahli`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** دَاودَ (ID: `person:David`); Work (ID: `keyterm:Work`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); كَنْعَان (ID: `place:Canaan`); موآبَ (ID: `place:Moab`); Jebusites (ID: `group:Jebusites`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Be Unfaithful (ID: `keyterm:Unfaithful`); Egyptians (ID: `group:Egypt`); مِصْرَ (ID: `place:Egypt`); حِثًّا (ID: `person:Heth`); Canaanites (ID: `group:Canaan`); Ammonites (ID: `group:Ammon`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); Amorites (ID: `group:Amorites`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Passion (ID: `keyterm:Ardour`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); Offering (ID: `keyterm:Offering`); عِيلَامَ (ID: `person:Elam`); Counsel (ID: `keyterm:Counsel`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); حَشوم (ID: `person:Hashum`); بَنَايَا (ID: `person:Benaiah.10`); عزِّيَّا (ID: `person:Uzziah.4`); إِيلِيَّا (ID: `person:Elijah.3`); يِشِّيَّا (ID: `person:Isshijah`); أَلْيَاشِيب (ID: `person:Eliashib.5`); نْيَا (ID: `person:Vaniah`); زَبَاي (ID: `person:Zabbai`); أورِي (ID: `person:Uri.3`); زَكَرِيَّا (ID: `person:Zechariah.21`); أَلِيفَلَط (ID: `person:Eliphelet.6`); يَهونَاثَان (ID: `person:Jehohanan.4`); ٱلْعَمْرَامِيِّينَ (ID: `person:Amram.2`); أَلِيعَزَرَ (ID: `person:Eliezer.10`); زَبَدْيَا (ID: `person:Zebadiah.9`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); Kindness (ID: `keyterm:Kindness`); Defilement (ID: `keyterm:Defilement`); Dispossess (ID: `keyterm:Dispossess`); أورشَلِيمَ (ID: `place:Jerusalem`); To Cause to Possess (ID: `keyterm:Possess`); فَارِسَ (ID: `place:Persia`); Peace (ID: `keyterm:IntactState`); Plea for Mercy (ID: `keyterm:Supplication`); إِسْرَائِيلَ (ID: `person:Israel`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); Kindness (ID: `keyterm:Kindness`); أورشَلِيمَ (ID: `place:Jerusalem`); فَارِسَ (ID: `place:Persia`); Plea for Mercy (ID: `keyterm:Supplication`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); ٱلرَّبِّ (ID: `deity:Lord`); Repent (ID: `keyterm:Repent`); إِسْرَائِيلَ (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَحِيئِيل (ID: `person:Jehiel.8`); شَكَنْيَا (ID: `person:Shecaniah.7`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); عِيلَامَ (ID: `person:Elam`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); Swear (ID: `keyterm:Swear`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `person:Benjamin`); بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يونَاثَانَ (ID: `person:Jonathan.10`); يَحْزِيَا (ID: `person:Jahzeiah`); مَشلَّام (ID: `person:Meshullam.10`); عَسَائِيل (ID: `person:Asahel.4`); شَبْتَاي (ID: `person:Shabbethai`); تِقْوَةَ (ID: `person:Tikvah.2`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`)
