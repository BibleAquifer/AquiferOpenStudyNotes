...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Arquipo (ID: `person:Archippus`); Filemom (ID: `person:Philemon`); Áfia (ID: `person:Apphia`); favor (ID: `keyterm:Favor`); fazer a paz (ID: `keyterm:Peace`); Paulo (ID: `person:Paul`); amado (ID: `keyterm:Beloved`); Timóteo (ID: `person:Timothy`); SENHOR (ID: `deity:Lord`); igreja (ID: `keyterm:Church`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); holy (ID: `keyterm:Holy`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`); orar (ID: `keyterm:Pray`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Good (ID: `keyterm:Good`); comunhão (ID: `keyterm:Fellowship`); compaixão (ID: `keyterm:Affection`); rogar (ID: `keyterm:AskFor`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Lucas (ID: `person:Luke`); Epafras (ID: `person:Epaphras`); Demas (ID: `person:Demas`); Marcos (ID: `person:Mark`); favor (ID: `keyterm:Favor`); em cristo (ID: `keyterm:InChrist`); Spirit (ID: `keyterm:Spirit.2`); Aristarco (ID: `person:Aristarchus`)
