...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Jeremias (ID: `person:Jeremiah.6`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `group:Benjamin`); Levi (ID: `person:Levi.3`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `group:Levi`); Benjamim (ID: `person:Benjamin`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Pérsia (ID: `place:Persia`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Zorobabel (ID: `person:Zerubbabel.2`); Ciro (ID: `person:Cyrus`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Jerusalém (ID: `place:Jerusalem`); Salomão (ID: `person:Solomon`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Acube (ID: `person:Akkub.3`); Senaa (ID: `place:Senaah`); Bezai (ID: `person:Bezai`); Harim (ID: `person:Harim`); Hasufa (ID: `person:Hasupha`); Jesua (ID: `person:Jeshua`); Sisera (ID: `person:Sisera.2`); Darcom (ID: `person:Darkon`); Hodavias (ID: `person:Hodaviah.4`); Jedaías (ID: `person:Jedaiah.4`); Salmai (ID: `person:Shalmai`); Imer (ID: `place:Immer`); Tabaote (ID: `person:Tabbaoth`); Meunim (ID: `group:Meunim`); Talmom (ID: `person:Talmon`); Baana (ID: `person:Baanah.3`); Delaías (ID: `person:Delaiah.3`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Netofa (ID: `place:Netophah`); Barcos (ID: `person:Barkos`); Adã (ID: `place:Addan`); Sephatias (ID: `person:Shephatiah.6`); Barzillai (ID: `person:Barzillai.3`); Hadide (ID: `place:Hadid`)
...
* **Associated ACAI Concepts:** Reum (ID: `person:Rehum`); Mispar (ID: `person:Mispar`); Seraias (ID: `person:Seraiah.6`); Bigvai (ID: `person:Bigvai`); Reelaías (ID: `person:Reelaiah`); Baana (ID: `person:Baanah.3`); Bilsã (ID: `person:Bilshan`); Neemias (ID: `person:Nehemiah`); Mordecai (ID: `person:Mordecai`); Zorobabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`); Josué (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** Bani (ID: `person:Bani`); Zatu (ID: `person:Zattu.2`); Jesua (ID: `person:Jeshua.3`); Parós (ID: `person:Parosh`); Bezai (ID: `person:Bezai`); Elam (ID: `person:Elam`); Bigvai (ID: `person:Bigvai.2`); Ater (ID: `person:Ater`); Joabe (ID: `person:Joab.3`); Adonicão (ID: `person:Adonikam`); Jora (ID: `person:Jorah`); Ará (ID: `person:Arah.2`); Ezequias (ID: `person:Hezekiah.2`); Bebai (ID: `person:Bebai`); Zacai (ID: `person:Zaccai.2`); Adim (ID: `person:Adin`); Paate-Moabe (ID: `person:Pahath-moab`); Asgade (ID: `person:Azgad`); Hasum (ID: `person:Hashum`); Sephatias (ID: `person:Shephatiah.6`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Senaa (ID: `place:Senaah`); Magbis (ID: `place:Magbish`); Harim (ID: `person:Harim.2`); Nebo (ID: `place:Nebo.2`); Netofa (ID: `place:Netophah`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Hadide (ID: `place:Hadid`); Ramah (ID: `place:Ramah.2`); Jericó (ID: `place:Jericho`); Elam (ID: `person:Elam`); Ai (ID: `place:Ai`); Anatote (ID: `place:Anathoth`); Cefira (ID: `place:Chephirah`); Ono (ID: `place:Ono`); Micmás (ID: `place:Michmash`); Betel (ID: `place:Bethel`); Belém (ID: `place:Bethlehem`); Beerote (ID: `place:Beeroth`); Lode (ID: `place:Lod`); Quiriate-Jearim (ID: `place:Kiriath-jearim`); Geba (ID: `place:Geba`)
...
* **Associated ACAI Concepts:** Hatita (ID: `person:Hatita`); Jesua (ID: `person:Jeshua`); Harim (ID: `person:Harim`); Talmom (ID: `person:Talmon`); Hodavias (ID: `person:Hodaviah.4`); Jedaías (ID: `person:Jedaiah.4`); Imer (ID: `person:Immer.2`); Ater (ID: `person:Ater.2`); Sobai (ID: `person:Shobai`); Jesua (ID: `person:Jeshua.4`); Salum (ID: `person:Shallum.8`); Levi (ID: `person:Levi.3`); Acube (ID: `person:Akkub.2`); Asafe (ID: `person:Asaph.2`); Pasur (ID: `person:Pashhur`); Levi (ID: `group:Levi`); Cadmiel (ID: `person:Kadmiel`)
...
* **Associated ACAI Concepts:** Acube (ID: `person:Akkub.3`); Harsa (ID: `person:Harsha`); Harur (ID: `person:Harhur`); Sia (ID: `person:Siaha`); Meída (ID: `person:Mehida`); Asná (ID: `person:Asnah`); Hasufa (ID: `person:Hasupha`); Hagabe (ID: `person:Hagab`); Zia (ID: `person:Ziha`); Hanã (ID: `person:Hanan.4`); Gidel (ID: `person:Giddel`); Gazão (ID: `person:Gazzam`); Sisera (ID: `person:Sisera.2`); Hagaba (ID: `person:Hagabah`); Reaías (ID: `person:Reaiah.3`); Salmai (ID: `person:Shalmai`); Hatifa (ID: `person:Hatipha`); Nephushesim (ID: `group:Nephushesim`); Besai (ID: `person:Besai`); Rezim (ID: `person:Rezin.2`); Tabaote (ID: `person:Tabbaoth`); Queros (ID: `person:Keros`); Meunim (ID: `group:Meunim`); Padom (ID: `person:Padon`); Nesias (ID: `person:Neziah`); Temá (ID: `person:Temah`); Bazlite (ID: `person:Bazluth`); Necoda (ID: `person:Nekoda`); Barcos (ID: `person:Barkos`); Baquebuque (ID: `person:Bakbuk`); Hacufa (ID: `person:Hakupha`); Uza (ID: `person:Uzza.2`); Lebana (ID: `person:Lebanah`); Gaar (ID: `person:Gahar`); Paseia (ID: `person:Paseah.2`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Hatil (ID: `person:Hattil`); Gidel (ID: `person:Giddel.2`); Darcom (ID: `person:Darkon`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Ami (ID: `person:Ami`); Jaala (ID: `person:Jaalah`); Soferete (ID: `person:Sophereth`); Sephatias (ID: `person:Shephatiah.7`); Peruda (ID: `person:Peruda`); Sotai (ID: `person:Sotai`)
...
* **Associated ACAI Concepts:** Imer (ID: `place:Immer`); Tel-Harsa (ID: `place:Tel-harsha`); Adã (ID: `place:Addan`); Tel-Melá (ID: `place:Tel-melah`); Querube (ID: `place:Cherub`); Necoda (ID: `person:Nekoda.2`); Delaías (ID: `person:Delaiah.3`); Tobias (ID: `person:Tobiah`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Barzillai (ID: `person:Barzillai.3`); Hacoz (ID: `person:Hakkoz.2`); Habaiah (ID: `person:Habaiah`); Barzillai (ID: `person:Barzillai`); stain (ID: `keyterm:Stain`); Gileadites (ID: `group:Gilead`); priesthood (ID: `keyterm:Priesthood`); Gileade (ID: `place:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); strength (ID: `keyterm:Strength`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); Tunic (ID: `realia:Tunic`); Mina (ID: `realia:Mina`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Josué (ID: `person:Joshua.5`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Sealtiel (ID: `person:Shealtiel.2`); Jeozadaque (ID: `person:Jehozadak`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Hodavias (ID: `person:Hodaviah.4`); Henadade (ID: `person:Henadad`); Esar-Hadom (ID: `person:Esarhaddon`); Relatives (ID: `group:Relatives`); Cadmiel (ID: `person:Kadmiel`); Jesua (ID: `person:Jeshua.4`); Dario (ID: `person:Darius.2`); Jope (ID: `place:Joppa`); Tiro (ID: `place:Tyre`); Libano (ID: `place:Lebanon`); Instruction (ID: `keyterm:Instruction`); Benjamim (ID: `person:Benjamin`); Benjamim (ID: `group:Benjamin`); Asafe (ID: `person:Asaph.2`); holy (ID: `keyterm:Holy`); Sidom (ID: `place:Sidon`); kindness (ID: `keyterm:Kindness`); Hodias (ID: `person:Hodiah.2`); Moisés (ID: `person:Moses`); Davi (ID: `person:David`); terror (ID: `keyterm:Terror`); appointed feast (ID: `keyterm:AppointedFeast`); Tyrians (ID: `group:Tyre`); Assyria (ID: `place:Assyria`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); counsel (ID: `keyterm:Counsel`); Sidonians (ID: `group:Sidon`); new moon festival (ID: `keyterm:NewMoonFestival`); Cedar (ID: `flora:Cedar`); Trumpet (ID: `realia:Trumpet`); Craftsman (ID: `realia:Craftsman`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Sealtiel (ID: `person:Shealtiel.2`); offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Moisés (ID: `person:Moses`); Instruction (ID: `keyterm:Instruction`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); terror (ID: `keyterm:Terror`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Pérsia (ID: `place:Persia`); Jope (ID: `place:Joppa`); Sidom (ID: `place:Sidon`); Tiro (ID: `place:Tyre`); Sidonians (ID: `group:Sidon`); Tyrians (ID: `group:Tyre`); Libano (ID: `place:Lebanon`); Ciro (ID: `person:Cyrus`); Craftsman (ID: `realia:Craftsman`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); SENHOR (ID: `deity:Lord`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Jerusalém (ID: `place:Jerusalem`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `group:Levi`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Levi (ID: `person:Levi.3`); Asafe (ID: `person:Asaph.2`); kindness (ID: `keyterm:Kindness`); Davi (ID: `person:David`); Levi (ID: `group:Levi`); Trumpet (ID: `realia:Trumpet`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `group:Benjamin`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Israel (ID: `person:Israel`); Benjamim (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Pérsia (ID: `place:Persia`); SENHOR (ID: `deity:Lord`); Josué (ID: `person:Joshua.5`); Israel (ID: `person:Israel`); Zorobabel (ID: `person:Zerubbabel.2`); Ciro (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Samaria (ID: `place:Samaria`); Pérsia (ID: `place:Persia`); Mitredate (ID: `person:Mithredath.2`); Assuero (ID: `person:Ahasuerus`); Ereque (ID: `place:Erech`); Tabeel (ID: `person:Tabeel`); Babylonians (ID: `group:Babylon`); Bislão (ID: `person:Bishlam`); Dinaítas (ID: `person:Dinaite`); Osnapar (ID: `person:Osnappar`); Judá (ID: `group:Judah`); Elamites (ID: `group:Elam`); Elam (ID: `place:Elam`); Persians (ID: `group:Persia`); Susã (ID: `place:Susa`); Babilônia (ID: `place:Babylon`); Judá (ID: `person:Judah.4`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Dinaítas (ID: `person:Dinaite`); Reum (ID: `person:Rehum.2`); Ereque (ID: `place:Erech`); Babylonians (ID: `group:Babylon`); Sinsai (ID: `person:Shimshai`); Pérsia (ID: `place:Persia`); Elamites (ID: `group:Elam`); Elam (ID: `place:Elam`); Persians (ID: `group:Persia`); Susã (ID: `place:Susa`); Babilônia (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Jews (ID: `group:Jews`); Reum (ID: `person:Rehum.2`); Artaxerxes (ID: `person:Artaxerxes.2`); Samaria (ID: `place:Samaria`); Sinsai (ID: `person:Shimshai`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); Dario (ID: `person:Darius.2`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Tattenai (ID: `person:Tattenai`); Ido (ID: `person:Iddo.6`); Ageu (ID: `person:Haggai`); Zacarias (ID: `person:Zechariah.17`); Pérsia (ID: `place:Persia`); Jeozadaque (ID: `person:Jehozadak`); Rio Eufrates (ID: `place:Euphrates`); Judá (ID: `person:Judah.4`); Zorobabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`); Sealtiel (ID: `person:Shealtiel.2`); Josué (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** Ido (ID: `person:Iddo.6`); Ageu (ID: `person:Haggai`); Zacarias (ID: `person:Zechariah.17`); Jews (ID: `group:Jews`); Judá (ID: `person:Judah.4`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Jerusalém (ID: `place:Jerusalem`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Babilônia (ID: `place:Babylon`); Jerusalém (ID: `place:Jerusalem`); Ciro (ID: `person:Cyrus`); Dario (ID: `person:Darius.2`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Zorobabel (ID: `person:Zerubbabel.2`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Tattenai (ID: `person:Tattenai`); Chaldeans (ID: `group:Chaldea`); Judá (ID: `person:Judah.4`); Rio Eufrates (ID: `place:Euphrates`); Israel (ID: `person:Israel`); Caldéia (ID: `place:Chaldea`); Money (ID: `realia:Money`); Foundation (ID: `realia:Foundation`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** Nabucodonozor (ID: `person:Nebuchadnezzar`); Chaldeans (ID: `group:Chaldea`); Babilônia (ID: `place:Babylon`); Caldéia (ID: `place:Chaldea`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); Moisés (ID: `person:Moses`); Levi (ID: `group:Levi`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Azarias (ID: `person:Azariah.7`); Seraias (ID: `person:Seraiah.2`); Pérsia (ID: `place:Persia`); Hilquias (ID: `person:Hilkiah.2`); Artaxerxes (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Zadoque (ID: `person:Zadok.4`); Buqui (ID: `person:Bukki.2`); Aitube (ID: `person:Ahitub.3`); Uzi (ID: `person:Uzzi`); Amarias (ID: `person:Amariah.2`); Salum (ID: `person:Shallum.7`); Zeraías (ID: `person:Zerahiah`); Meraiote (ID: `person:Meraioth`); Abisua (ID: `person:Abishua`); Seraias (ID: `person:Seraiah.2`); Azarias (ID: `person:Azariah.6`); Azarias (ID: `person:Azariah.7`); Hilquias (ID: `person:Hilkiah.2`); Arão (ID: `person:Aaron`); Artaxerxes (ID: `person:Artaxerxes`); Eleazar (ID: `person:Eleazar.2`); Pérsia (ID: `place:Persia`); Fineias (ID: `person:Phinehas`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); SENHOR (ID: `deity:Lord`); Babilônia (ID: `place:Babylon`); Israel (ID: `person:Israel`); Moisés (ID: `person:Moses`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); decree (ID: `keyterm:Decree`); Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); Ezra (ID: `person:Ezra`); Artaxerxes (ID: `person:Artaxerxes`); Israel (ID: `person:Israel`); Rio Eufrates (ID: `place:Euphrates`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); decree (ID: `keyterm:Decree`); SENHOR (ID: `deity:Lord`); Babilônia (ID: `place:Babylon`); Judá (ID: `person:Judah.4`); Altar (ID: `realia:Altar`); Sheep (ID: `fauna:Lamb`); Temple Altar (ID: `realia:TempleAltar`); Anointing Oil (ID: `realia:AnointingOil`); Stone Altar (ID: `realia:StoneAltar`); Talent (ID: `realia:Talent`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Olive Oil (ID: `realia:OliveOil`); Wheat (ID: `flora:Wheat`); Kor (ID: `realia:Kor`)
...
* **Associated ACAI Concepts:** Artaxerxes (ID: `person:Artaxerxes`); Rio Eufrates (ID: `place:Euphrates`); Ezra (ID: `person:Ezra`); Talent (ID: `realia:Talent`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Wheat (ID: `flora:Wheat`); Anointing Oil (ID: `realia:AnointingOil`); Kor (ID: `realia:Kor`)
...
* **Associated ACAI Concepts:** Atalia (ID: `person:Athaliah.3`); Jônatas (ID: `person:Jonathan.9`); Obadias (ID: `person:Obadiah.10`); Jeiel (ID: `person:Jehiel.7`); Secanias (ID: `person:Shecaniah.6`); Elam (ID: `person:Elam`); Hatus (ID: `person:Hattush.2`); Ebede (ID: `person:Ebed.2`); Bigvai (ID: `person:Bigvai.2`); Jaaziel (ID: `person:Jahaziel.5`); Adonicão (ID: `person:Adonikam`); Secanias (ID: `person:Shecaniah.5`); Zacarias (ID: `person:Zechariah.19`); Utai (ID: `person:Uthai.2`); Elioenai (ID: `person:Eliehoenai.2`); Gérson (ID: `person:Gershom.2`); Semaías (ID: `person:Shemaiah.14`); Zacur (ID: `person:Zaccur.5`); Bebai (ID: `person:Bebai`); Elifelete (ID: `person:Eliphelet.5`); Joabe (ID: `person:Joab.4`); Zacarias (ID: `person:Zechariah.18`); Hacatã (ID: `person:Hakkatan`); Jeuel (ID: `person:Jeuel.3`); Josifias (ID: `person:Josiphiah`); Jesaías (ID: `person:Jeshaiah.4`); Paate-Moabe (ID: `person:Pahath-moab`); Adim (ID: `person:Adin`); Asgade (ID: `person:Azgad`); Zabadias (ID: `person:Zebadiah.8`); Bebai (ID: `person:Bebai.2`); Miguel (ID: `person:Michael.10`); Daniel (ID: `person:Daniel.2`); Selomite (ID: `person:Shelomith.4`); Parós (ID: `person:Parosh.2`); Joanã (ID: `person:Johanan.8`); Zeraías (ID: `person:Zerahiah.2`); Sephatias (ID: `person:Shephatiah.6`); Artaxerxes (ID: `person:Artaxerxes`); Babilônia (ID: `place:Babylon`); Davi (ID: `person:David`); Fineias (ID: `person:Phinehas`); Itamar (ID: `person:Ithamar`)
...
* **Associated ACAI Concepts:** Natã (ID: `person:Nathan.5`); Ariel (ID: `person:Ariel`); Eliezer (ID: `person:Eliezer.8`); Mesulão (ID: `person:Meshullam.9`); Zacarias (ID: `person:Zechariah.20`); Casifia (ID: `place:Casiphia`); Elnatã (ID: `person:Elnathan.3`); Ido (ID: `person:Iddo`); Jaribe (ID: `person:Jarib.2`); Joiaribe (ID: `person:Joiarib.2`); Elnatã (ID: `person:Elnathan.4`); Semaías (ID: `person:Shemaiah.15`); Elnatã (ID: `person:Elnathan.2`); SENHOR (ID: `deity:Lord`); perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); Levi (ID: `person:Levi.3`); SENHOR (ID: `deity:Lord`); Mali (ID: `person:Mahli`); Insight (ID: `keyterm:Insight`); Israel (ID: `person:Israel`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); Davi (ID: `person:David`); Levi (ID: `group:Levi`); work (ID: `keyterm:Work`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); Moabe (ID: `place:Moab`); Levi (ID: `person:Levi.3`); Egyptians (ID: `group:Egypt`); Amom (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Amorites (ID: `group:Amorites`); Jebusites (ID: `group:Jebusites`); cananeu (ID: `group:Canaan`); Egito (ID: `place:Egypt`); be unfaithful (ID: `keyterm:Unfaithful`); Hete (ID: `person:Heth`); Israel (ID: `person:Israel`); Canaã (ID: `place:Canaan`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); House (ID: `realia:House`); Harim (ID: `person:Harim`); Elam (ID: `person:Elam`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); offering (ID: `keyterm:Offering`); counsel (ID: `keyterm:Counsel`); Bedias (ID: `person:Bedeiah`); Judá (ID: `person:Judah.5`); Jeremote (ID: `person:Jeremoth.4`); Matanias (ID: `person:Mattaniah.5`); Joel (ID: `person:Joel.12`); Jezias (ID: `person:Izziah`); Matenai (ID: `person:Mattenai`); Simei (ID: `person:Shimei.15`); Zabade (ID: `person:Zabad.5`); Adna (ID: `person:Adna`); Bani (ID: `person:Bani.6`); Amrão (ID: `person:Amram.2`); Elifelete (ID: `person:Eliphelet.6`); Zabade (ID: `person:Zabad.7`); Elias (ID: `person:Elijah.3`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); Pérsia (ID: `place:Persia`); supplication (ID: `keyterm:Supplication`); kindness (ID: `keyterm:Kindness`); peace (ID: `keyterm:IntactState`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); defilement (ID: `keyterm:Defilement`); to cause to possess (ID: `keyterm:Possess`); dispossess (ID: `keyterm:Dispossess`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** Jeiel (ID: `person:Jehiel.8`); Secanias (ID: `person:Shecaniah.7`); SENHOR (ID: `deity:Lord`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Israel (ID: `person:Israel`); Elam (ID: `person:Elam`)
...
* **Associated ACAI Concepts:** swear (ID: `keyterm:Swear`); Levi (ID: `person:Levi.3`); Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `group:Benjamin`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `person:Benjamin`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jazeías (ID: `person:Jahzeiah`); Jônatas (ID: `person:Jonathan.10`); Mesulão (ID: `person:Meshullam.10`); Asael (ID: `person:Asahel.4`); Sabetai (ID: `person:Shabbethai`); Ticva (ID: `person:Tikvah.2`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`)
