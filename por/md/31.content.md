...
* **Associated ACAI Concepts:** Edom (ID: `place:Edom`); Understanding (ID: `keyterm:Understanding`); Monte de Esaú (ID: `place:EsauMount`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); lot (ID: `keyterm:Lot`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); José (ID: `person:Joseph.10`); dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`); Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); José (ID: `person:Joseph.10`); SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** dispossess (ID: `keyterm:Dispossess`); Neguebe (ID: `place:Negeb`); Efraim (ID: `group:Ephraim`); Samaria (ID: `place:Samaria`); Gileade (ID: `place:Gilead`); Canaã (ID: `place:Canaan`); Sefalá (ID: `place:Shephelah`); Israel (ID: `person:Israel`); Filisteu (ID: `group:Philistine`); Sarepta (ID: `place:Zarephath`); Sardes (ID: `place:Sardis`); cananeu (ID: `group:Canaan`); Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `person:Benjamin`); Monte de Esaú (ID: `place:EsauMount`); Filístia (ID: `place:Philistine`); Benjamim (ID: `group:Benjamin`); Efraim (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** Monte de Esaú (ID: `place:EsauMount`); Jerusalém (ID: `place:Jerusalem`); Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Canaã (ID: `place:Canaan`); Benjamim (ID: `person:Benjamin`); SENHOR (ID: `deity:Lord`); Samaria (ID: `place:Samaria`); Gileade (ID: `place:Gilead`); Sefalá (ID: `place:Shephelah`); Israel (ID: `person:Israel`); Benjamim (ID: `group:Benjamin`); Efraim (ID: `person:Ephraim`); cananeu (ID: `group:Canaan`); Sardes (ID: `place:Sardis`); Filístia (ID: `place:Philistine`); Efraim (ID: `group:Ephraim`); Filisteu (ID: `group:Philistine`); Sarepta (ID: `place:Zarephath`)
...
* **Associated ACAI Concepts:** Canaã (ID: `place:Canaan`); cananeu (ID: `group:Canaan`); Israel (ID: `person:Israel`); Sarepta (ID: `place:Zarephath`); Sardes (ID: `place:Sardis`); dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`); Neguebe (ID: `place:Negeb`)
