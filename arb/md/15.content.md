...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`); إِرْمِيَا (ID: `person:Jeremiah.6`); إِسْرَائِيلَ (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); بَنْيَامِينَ (ID: `person:Benjamin`); لَّاوِي (ID: `group:Levi`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `group:Judah`); لَّاوِي (ID: `person:Levi.3`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); كورَشَ (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath`); فَارِسَ (ID: `place:Persia`); كورَشَ (ID: `person:Cyrus`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); لَّاوِي (ID: `person:Levi.3`); سلَيْمَانَ (ID: `person:Solomon`); لَّاوِي (ID: `group:Levi`); أورشَلِيمَ (ID: `place:Jerusalem`); حَرْحورَ (ID: `person:Harhur`); شَفَطْيَا (ID: `person:Shephatiah.6`); حَزَقِيَّا (ID: `person:Hezekiah.2`); حَرْشَا (ID: `person:Harsha`); عَرْجَدَ (ID: `person:Azgad`); حَطِيطَا (ID: `person:Hatita`); بَعْنَةَ (ID: `person:Baanah.3`); زَكَّايَ (ID: `person:Zaccai.2`); سِيسَرَا (ID: `person:Sisera.2`); حَطِيفَا (ID: `person:Hatipha`); Beth-azmaveth (ID: `place:Beth-azmaveth`); حَارِيمَ (ID: `person:Harim.2`); نَبو (ID: `place:Nebo.2`); حَادِيدَ (ID: `place:Hadid`); نَصِيحَ (ID: `person:Neziah`); سوفَرَثَ (ID: `person:Sophereth`); يَشوعَ (ID: `person:Jeshua.3`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); Meunim (ID: `group:Meunim`); نَقودَا (ID: `person:Nekoda`); رَصِينَ (ID: `person:Rezin.2`); لِإِيمِيرَ (ID: `place:Immer`); يورَةَ (ID: `person:Jorah`); حَارِيمَ (ID: `person:Harim`)
...
* **Associated ACAI Concepts:** بَعْنَةَ (ID: `person:Baanah.3`); بِلْشَان (ID: `person:Bilshan`); سَرَايَا (ID: `person:Seraiah.6`); مِسْفَار (ID: `person:Mispar`); بِغْوَايَ (ID: `person:Bigvai`); رَحوم (ID: `person:Rehum`); رَعْلَايَا (ID: `person:Reelaiah`); نَحَمْيَا (ID: `person:Nehemiah`); مرْدَخَاي (ID: `person:Mordecai`); إِسْرَائِيلَ (ID: `person:Israel`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** آرَحَ (ID: `person:Arah.2`); شَفَطْيَا (ID: `person:Shephatiah.6`); حَزَقِيَّا (ID: `person:Hezekiah.2`); يورَةَ (ID: `person:Jorah`); عَرْجَدَ (ID: `person:Azgad`); زَكَّايَ (ID: `person:Zaccai.2`); بَانِيَ (ID: `person:Bani`); عِيلَامَ (ID: `person:Elam`); زَتّو (ID: `person:Zattu.2`); بِيصَايَ (ID: `person:Bezai`); حَشوم (ID: `person:Hashum`); Pahath-moab (ID: `person:Pahath-moab`); بِغْوَايَ (ID: `person:Bigvai.2`); آطِيرَ (ID: `person:Ater`); بَابَايَ (ID: `person:Bebai`); عَادِينَ (ID: `person:Adin`); فَرْعوشَ (ID: `person:Parosh`); أَدونِيقَامَ (ID: `person:Adonikam`); يَشوعَ (ID: `person:Jeshua.3`); يوآب (ID: `person:Joab.3`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** مَغْبِيشَ (ID: `place:Magbish`); Beth-azmaveth (ID: `place:Beth-azmaveth`); حَارِيمَ (ID: `person:Harim.2`); نَبو (ID: `place:Nebo.2`); حَادِيدَ (ID: `place:Hadid`); سَنَاءَةَ (ID: `place:Senaah`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); عَايٍ (ID: `place:Ai`); Bethel (ID: `place:Bethel`); مِخْمَاسَ (ID: `place:Michmash`); بَئِيروت (ID: `place:Beeroth`); ٱلْكَفِيرَة (ID: `place:Chephirah`); Ramah (ID: `place:Ramah.2`); عِيلَامَ (ID: `person:Elam`); لَحْمٍ (ID: `place:Bethlehem`); عَنَاثوثَ (ID: `place:Anathoth`); أونوَ (ID: `place:Ono`); مِنْ (ID: `place:Geba`); أَرِيحَا (ID: `place:Jericho`); وَلودَ (ID: `place:Lod`); Kiriath-jearim (ID: `place:Kiriath-jearim`)
...
* **Associated ACAI Concepts:** حَطِيطَا (ID: `person:Hatita`); يَدَايَا (ID: `person:Jedaiah.4`); طَلْمون (ID: `person:Talmon`); شوبَايَ (ID: `person:Shobai`); يَشوعَ (ID: `person:Jeshua`); يَشوعَ (ID: `person:Jeshua.4`); هودَوْيَا (ID: `person:Hodaviah.4`); آطِيرَ (ID: `person:Ater.2`); لِإِيمِيرَ (ID: `person:Immer.2`); حَارِيمَ (ID: `person:Harim`); عَقّوب (ID: `person:Akkub.2`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); لَّاوِي (ID: `group:Levi`); فَشْحور (ID: `person:Pashhur`); لَّاوِي (ID: `person:Levi.3`); آسَاف (ID: `person:Asaph.2`); شَلّوم (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** حَطِيطَا (ID: `person:Hatita`); طَلْمون (ID: `person:Talmon`); آطِيرَ (ID: `person:Ater.2`); شوبَايَ (ID: `person:Shobai`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`); شَلّوم (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** نَقودَا (ID: `person:Nekoda`); Nephushesim (ID: `group:Nephushesim`); عَقّوب (ID: `person:Akkub.3`); حَرْحورَ (ID: `person:Harhur`); بَرْقوسَ (ID: `person:Barkos`); رَصِينَ (ID: `person:Rezin.2`); فِي (ID: `person:Uzza.2`); بَقْبوقَ (ID: `person:Bakbuk`); حَرْشَا (ID: `person:Harsha`); سَلْمَايَ (ID: `person:Shalmai`); حَاجَابَ (ID: `person:Hagab`); حَقوفَا (ID: `person:Hakupha`); مَحِيدَا (ID: `person:Mehida`); قِيروسَ (ID: `person:Keros`); جَاحَرَ (ID: `person:Gahar`); جَزَّامَ (ID: `person:Gazzam`); سِيسَرَا (ID: `person:Sisera.2`); أَسْنَةَ (ID: `person:Asnah`); حَطِيفَا (ID: `person:Hatipha`); بَصْلوتَ (ID: `person:Bazluth`); سِيعَهَا (ID: `person:Siaha`); حَانَان (ID: `person:Hanan.4`); فَاسِيحَ (ID: `person:Paseah.2`); فَادونَ (ID: `person:Padon`); لَبَانَةَ (ID: `person:Lebanah`); صِيحَا (ID: `person:Ziha`); طَبَاعوتَ (ID: `person:Tabbaoth`); رَآيَا (ID: `person:Reaiah.3`); نَصِيحَ (ID: `person:Neziah`); بِيسَايَ (ID: `person:Besai`); جَدِّيلَ (ID: `person:Giddel`); حَجَابَةَ (ID: `person:Hagabah`); ثَامَحَ (ID: `person:Temah`); حَسوفَا (ID: `person:Hasupha`); Meunim (ID: `group:Meunim`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); شَفَطْيَا (ID: `person:Shephatiah.7`); فَرودَا (ID: `person:Peruda`); حَطِّيلَ (ID: `person:Hattil`); سوفَرَثَ (ID: `person:Sophereth`); جَدِّيلَ (ID: `person:Giddel.2`); يَعْلَةَ (ID: `person:Jaalah`); آمِي (ID: `person:Ami`); سَوْطَايَ (ID: `person:Sotai`); دَرْقونَ (ID: `person:Darkon`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`)
...
* **Associated ACAI Concepts:** Tel-harsha (ID: `place:Tel-harsha`); نَقودَا (ID: `person:Nekoda.2`); لِدَلَايَا (ID: `person:Delaiah.3`); أَدَّان (ID: `place:Addan`); Tel-melah (ID: `place:Tel-melah`); لِإِيمِيرَ (ID: `place:Immer`); كَروب (ID: `place:Cherub`); طوبِيَّا (ID: `person:Tobiah`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** هَقّوصَ (ID: `person:Hakkoz.2`); بَرْزِلَّايَ (ID: `person:Barzillai.3`); حَبَايَا (ID: `person:Habaiah`); جِلْعَادَ (ID: `place:Gilead`); بَرْزِلَّايَ (ID: `person:Barzillai`); Priesthood (ID: `keyterm:Priesthood`); Defile (ID: `keyterm:Stain`); Gileadites (ID: `group:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); Strength (ID: `keyterm:Strength`); House (ID: `realia:House`); Tunic (ID: `realia:Tunic`); Money (ID: `realia:Money`); Mina (ID: `realia:Mina`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); يَشوع (ID: `person:Joshua.5`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); هودَوْيَا (ID: `person:Hodaviah.4`); حِينَادَادَ (ID: `person:Henadad`); يَشوعَ (ID: `person:Jeshua.4`); Relatives (ID: `group:Relatives`); Esarhaddon (ID: `person:Esarhaddon`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); Sidonians (ID: `group:Sidon`); Kindness (ID: `keyterm:Kindness`); بَنْيَامِينَ (ID: `group:Benjamin`); لبْنَانَ (ID: `place:Lebanon`); Instruction (ID: `keyterm:Instruction`); هودِيَّا (ID: `person:Hodiah.2`); موسَى (ID: `person:Moses`); New Moon Festival (ID: `keyterm:NewMoonFestival`); بَنْيَامِينَ (ID: `person:Benjamin`); Assyria (ID: `place:Assyria`); Terror (ID: `keyterm:Terror`); صِيْدونَ (ID: `place:Sidon`); صورَ (ID: `place:Tyre`); Holy (ID: `keyterm:Holy`); Counsel (ID: `keyterm:Counsel`); آسَاف (ID: `person:Asaph.2`); Tyrians (ID: `group:Tyre`); يَافَا (ID: `place:Joppa`); Appointed Feast (ID: `keyterm:AppointedFeast`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); دَارِيوسَ (ID: `person:Darius.2`); دَاودَ (ID: `person:David`); Money (ID: `realia:Money`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); Cedar (ID: `flora:Cedar`); Craftsman (ID: `realia:Craftsman`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Terror (ID: `keyterm:Terror`); Offering (ID: `keyterm:Offering`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Tyrians (ID: `group:Tyre`); يَافَا (ID: `place:Joppa`); Sidonians (ID: `group:Sidon`); صِيْدونَ (ID: `place:Sidon`); لبْنَانَ (ID: `place:Lebanon`); فَارِسَ (ID: `place:Persia`); صورَ (ID: `place:Tyre`); كورَشَ (ID: `person:Cyrus`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `group:Levi`); أورشَلِيمَ (ID: `place:Jerusalem`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `person:Levi.3`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Kindness (ID: `keyterm:Kindness`); لَّاوِي (ID: `group:Levi`); دَاودَ (ID: `person:David`); آسَاف (ID: `person:Asaph.2`); لَّاوِي (ID: `person:Levi.3`); House (ID: `realia:House`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); بَنْيَامِينَ (ID: `person:Benjamin`); بَنْيَامِينَ (ID: `group:Benjamin`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); ٱلرَّبِّ (ID: `deity:Lord`); فَارِسَ (ID: `place:Persia`); إِسْرَائِيلَ (ID: `person:Israel`); يَشوع (ID: `person:Joshua.5`); كورَشَ (ID: `person:Cyrus`); زَربَّابِل (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); فَارِسَ (ID: `place:Persia`); ٱلسَّامِرَةِ (ID: `place:Samaria`); أسْنَفَّر (ID: `person:Osnappar`); Babylonians (ID: `group:Babylon`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); طَبْئِيل (ID: `person:Tabeel`); أَرَكَ (ID: `place:Erech`); مِثْرَدَاث (ID: `person:Mithredath.2`); بِشْلَام (ID: `person:Bishlam`); Persians (ID: `group:Persia`); بَابِلَ (ID: `place:Babylon`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); فِي (ID: `place:Susa`); Elamites (ID: `group:Elam`); عِيلَامَ (ID: `place:Elam`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Babylonians (ID: `group:Babylon`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); رَحوم (ID: `person:Rehum.2`); أَرَكَ (ID: `place:Erech`); شِمْشَاي (ID: `person:Shimshai`); فِي (ID: `place:Susa`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); بَابِلَ (ID: `place:Babylon`); فَارِسَ (ID: `place:Persia`); عِيلَامَ (ID: `place:Elam`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); رَحوم (ID: `person:Rehum.2`); Jews (ID: `group:Jews`); شِمْشَاي (ID: `person:Shimshai`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); دَارِيوسَ (ID: `person:Darius.2`); Jews (ID: `group:Jews`); زَكَرِيَّا (ID: `person:Zechariah.17`); Shethar-bozenai (ID: `person:Shethar-bozenai`); تَتْنَاي (ID: `person:Tattenai`); يَدّو (ID: `person:Iddo.6`); حَجَّيِ (ID: `person:Haggai`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); ٱلْفرَاتِ (ID: `place:Euphrates`); يَهوذَا (ID: `person:Judah.4`); زَربَّابِل (ID: `person:Zerubbabel.2`); فَارِسَ (ID: `place:Persia`); إِسْرَائِيلَ (ID: `person:Israel`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`)
...
* **Associated ACAI Concepts:** زَكَرِيَّا (ID: `person:Zechariah.17`); يَدّو (ID: `person:Iddo.6`); حَجَّيِ (ID: `person:Haggai`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); Jews (ID: `group:Jews`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); أورشَلِيمَ (ID: `place:Jerusalem`); بَابِلَ (ID: `place:Babylon`); كورَشَ (ID: `person:Cyrus`); دَارِيوسَ (ID: `person:Darius.2`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); زَربَّابِل (ID: `person:Zerubbabel.2`); Shethar-bozenai (ID: `person:Shethar-bozenai`); تَتْنَاي (ID: `person:Tattenai`); ٱلْفرَاتِ (ID: `place:Euphrates`); Chaldeans (ID: `group:Chaldea`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); يَهوذَا (ID: `person:Judah.4`); Money (ID: `realia:Money`); Foundation (ID: `realia:Foundation`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** Chaldeans (ID: `group:Chaldea`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); بَابِلَ (ID: `place:Babylon`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** عَزَرْيَا (ID: `person:Azariah.7`); سَرَايَا (ID: `person:Seraiah.2`); عَزْرَا (ID: `person:Ezra`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فَارِسَ (ID: `place:Persia`); حِلْقِيَّا (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); صَادوق (ID: `person:Zadok.4`); عَزَرْيَا (ID: `person:Azariah.6`); لِمَرَايوثَ (ID: `person:Meraioth`); عزِّي (ID: `person:Uzzi`); زَرَحْيَا (ID: `person:Zerahiah`); سَرَايَا (ID: `person:Seraiah.2`); أَمَرْيَا (ID: `person:Amariah.2`); أَبِيشوعَ (ID: `person:Abishua`); أَخِيطوبَ (ID: `person:Ahitub.3`); شَلّوم (ID: `person:Shallum.7`); عَزَرْيَا (ID: `person:Azariah.7`); بقِّي (ID: `person:Bukki.2`); هَارون (ID: `person:Aaron`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); أَلِعَازَار (ID: `person:Eleazar.2`); حِلْقِيَّا (ID: `person:Hilkiah.2`); فَارِسَ (ID: `place:Persia`); فِينَحَاس (ID: `person:Phinehas`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); موسَى (ID: `person:Moses`); ٱلرَّبِّ (ID: `deity:Lord`); بَابِلَ (ID: `place:Babylon`); إِسْرَائِيلَ (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); عَزْرَا (ID: `person:Ezra`); Wheat (ID: `flora:Wheat`); Money (ID: `realia:Money`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`); Kor (ID: `realia:Kor`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** شَفَطْيَا (ID: `person:Shephatiah.6`); يوحَانَانَ (ID: `person:Johanan.8`); يونَاثَانَ (ID: `person:Jonathan.9`); عَابِد (ID: `person:Ebed.2`); بَابَايَ (ID: `person:Bebai.2`); عَرْجَدَ (ID: `person:Azgad`); مِيخَائِيلَ (ID: `person:Michael.10`); هِقَّاطَانَ (ID: `person:Hakkatan`); زَكَرِيَّا (ID: `person:Zechariah.19`); عَثَلْيَا (ID: `person:Athaliah.3`); زَكّور (ID: `person:Zaccur.5`); عِيلَامَ (ID: `person:Elam`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); شَلومِيَةَ (ID: `person:Shelomith.4`); يوآب (ID: `person:Joab.4`); يِشْعِيَا (ID: `person:Jeshaiah.4`); Pahath-moab (ID: `person:Pahath-moab`); Gershom (ID: `person:Gershom.2`); زَرَحْيَا (ID: `person:Zerahiah.2`); بِغْوَايَ (ID: `person:Bigvai.2`); حَطّوش (ID: `person:Hattush.2`); يَعِيئِيل (ID: `person:Jeuel.3`); يوشَفْيَا (ID: `person:Josiphiah`); شَكَنْيَا (ID: `person:Shecaniah.5`); زَبَدْيَا (ID: `person:Zebadiah.8`); يَحِيئِيل (ID: `person:Jehiel.7`); بَابَايَ (ID: `person:Bebai`); عوبَدْيَا (ID: `person:Obadiah.10`); عَادِينَ (ID: `person:Adin`); أَدونِيقَامَ (ID: `person:Adonikam`); فَرْعوشَ (ID: `person:Parosh.2`); عوتَاي (ID: `person:Uthai.2`); يَحْزِيئِيل (ID: `person:Jahaziel.5`); شَكَنْيَا (ID: `person:Shecaniah.6`); شِمْعِيَا (ID: `person:Shemaiah.14`); أَلِيفَلَط (ID: `person:Eliphelet.5`); زَكَرِيَّا (ID: `person:Zechariah.18`); دَانِيآل (ID: `person:Daniel.2`); بَابِلَ (ID: `place:Babylon`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); إِيثَامَارَ (ID: `person:Ithamar`); دَاودَ (ID: `person:David`); فِينَحَاس (ID: `person:Phinehas`)
...
* **Associated ACAI Concepts:** نَاثَان (ID: `person:Nathan.5`); ٱلْمسَمَّى (ID: `place:Casiphia`); شِمْعِيَا (ID: `person:Shemaiah.15`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); زَكَرِيَّا (ID: `person:Zechariah.20`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); يَارِيبَ (ID: `person:Jarib.2`); أَلِيعَزَرَ (ID: `person:Eliezer.8`); يويَارِيبَ (ID: `person:Joiarib.2`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); يَدّو (ID: `person:Iddo`); مَشلَّام (ID: `person:Meshullam.9`); أَرِيئِيلَ (ID: `person:Ariel`); ٱلرَّبِّ (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); ٱلرَّبِّ (ID: `deity:Lord`); Insight (ID: `keyterm:Insight`); مَحْلِي (ID: `person:Mahli`); لَّاوِي (ID: `group:Levi`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Work (ID: `keyterm:Work`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); دَاودَ (ID: `person:David`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); Jebusites (ID: `group:Jebusites`); Egyptians (ID: `group:Egypt`); كَنْعَان (ID: `place:Canaan`); Amorites (ID: `group:Amorites`); Be Unfaithful (ID: `keyterm:Unfaithful`); Canaanites (ID: `group:Canaan`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); حِثًّا (ID: `person:Heth`); لَّاوِي (ID: `group:Levi`); Ammonites (ID: `group:Ammon`); إِسْرَائِيلَ (ID: `person:Israel`); موآبَ (ID: `place:Moab`); مِصْرَ (ID: `place:Egypt`); لَّاوِي (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Passion (ID: `keyterm:Ardour`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); يَهوذَا (ID: `person:Judah.4`); Counsel (ID: `keyterm:Counsel`); Offering (ID: `keyterm:Offering`); يَهوذَا (ID: `group:Judah`); عِيلَامَ (ID: `person:Elam`); يوصَادَاقَ (ID: `person:Jozadak.2`); يَهوذَا (ID: `place:Judea`); شَبْتَاي (ID: `person:Shabbethai`); يوئِيل (ID: `person:Joel.12`); شَلّوم (ID: `person:Shallum.11`); أَلِيوعِينَاي (ID: `person:Elioenai.4`); شِمْعون (ID: `person:Shimeon`); ويَرِيمَاي (ID: `person:Jeremai`); تِقْوَةَ (ID: `person:Tikvah.2`); مَلْكِيَّا (ID: `person:Malchijah.5`); شِمْعِيَا (ID: `person:Shemaiah.16`); شِمْعِي (ID: `person:Shimei.16`); مَلّوخ (ID: `person:Malluch.2`); مَنَسَّى (ID: `person:Manasseh.4`); يَاشوب (ID: `person:Jashub.2`)
...
* **Associated ACAI Concepts:** Be Unfaithful (ID: `keyterm:Unfaithful`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); Defilement (ID: `keyterm:Defilement`); To Cause to Possess (ID: `keyterm:Possess`); Plea for Mercy (ID: `keyterm:Supplication`); Peace (ID: `keyterm:IntactState`); Kindness (ID: `keyterm:Kindness`); أورشَلِيمَ (ID: `place:Jerusalem`); Dispossess (ID: `keyterm:Dispossess`); فَارِسَ (ID: `place:Persia`); إِسْرَائِيلَ (ID: `person:Israel`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); Plea for Mercy (ID: `keyterm:Supplication`); Kindness (ID: `keyterm:Kindness`); أورشَلِيمَ (ID: `place:Jerusalem`); فَارِسَ (ID: `place:Persia`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Repent (ID: `keyterm:Repent`); عَزْرَا (ID: `person:Ezra`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَحِيئِيل (ID: `person:Jehiel.8`); شَكَنْيَا (ID: `person:Shecaniah.7`); ٱلرَّبِّ (ID: `deity:Lord`); عِيلَامَ (ID: `person:Elam`); إِسْرَائِيلَ (ID: `person:Israel`); Be Unfaithful (ID: `keyterm:Unfaithful`); عَزْرَا (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** Swear (ID: `keyterm:Swear`); لَّاوِي (ID: `group:Levi`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `person:Levi.3`); عَزْرَا (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); بَنْيَامِينَ (ID: `person:Benjamin`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَبْتَاي (ID: `person:Shabbethai`); يونَاثَانَ (ID: `person:Jonathan.10`); مَشلَّام (ID: `person:Meshullam.10`); عَسَائِيل (ID: `person:Asahel.4`); يَحْزِيَا (ID: `person:Jahzeiah`); تِقْوَةَ (ID: `person:Tikvah.2`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`)
