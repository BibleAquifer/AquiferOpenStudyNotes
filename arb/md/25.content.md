...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); Rebel (ID: `keyterm:Rebel`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Strength (ID: `keyterm:Strength`); Love (ID: `keyterm:Love`); إِسْرَائِيلَ (ID: `person:Israel`); Deceit (ID: `keyterm:Deceit`); Defilement (ID: `keyterm:Defilement`); Appointed Feast (ID: `keyterm:AppointedFeast`); Mighty One (ID: `keyterm:MightyOne`); Work (ID: `keyterm:Work`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); To Sin (ID: `keyterm:Sin`); Train (ID: `realia:Train`); Deer (ID: `fauna:Deer`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Net (ID: `realia:Net`); Yoke (ID: `realia:Yoke`); Casting Net (ID: `realia:CastingNet`); Grass (ID: `flora:Grass`); Winepress (ID: `realia:Winepress`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); أورشَلِيمَ (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); ٱلرَّبِّ (ID: `deity:Lord`); Defilement (ID: `keyterm:Defilement`)
...
* **Associated ACAI Concepts:** Mighty One (ID: `keyterm:MightyOne`); يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Appointed Feast (ID: `keyterm:AppointedFeast`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Horn (ID: `keyterm:Horn`); Sheep (ID: `fauna:Lamb`); To Dishonor (ID: `keyterm:Dishonor`); Passion (ID: `keyterm:Ardour`); Have a Vision (ID: `keyterm:HaveAVision`); Sabbath (ID: `keyterm:Sabbath`); Instruction (ID: `keyterm:Instruction`); Utterance (ID: `keyterm:Utterance`); Gentiles (ID: `group:Gentile`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Wine (ID: `realia:Wine`); Sackcloth (ID: `realia:Sackcloth`); Tent (ID: `realia:Tent`); Measuring Reed (ID: `realia:MeasuringReed`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Bow (ID: `realia:Bow`); Grain (ID: `flora:Grain`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Sabbath (ID: `keyterm:Sabbath`); Appointed Feast (ID: `keyterm:AppointedFeast`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Appointed Feast (ID: `keyterm:AppointedFeast`); House (ID: `realia:House`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Hope (ID: `keyterm:Hope`); Fear (ID: `keyterm:Fear`); Redeem (ID: `keyterm:Redeem`); Rebel (ID: `keyterm:Rebel`); Forgive (ID: `keyterm:Forgive`); Salvation (ID: `keyterm:Salvation`); Arrow (ID: `keyterm:Arrow`); Complete (ID: `keyterm:Complete`); To Sin (ID: `keyterm:Sin`); Peace (ID: `keyterm:IntactState`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Wormwood (ID: `flora:Wormwood`); Arrow (ID: `realia:Arrow`); Pit (ID: `realia:Pit`); Bear (ID: `fauna:Bear`); Yoke (ID: `realia:Yoke`); Hewn Stone (ID: `realia:HewnStone`); Bird (ID: `fauna:Bird`); Lion (ID: `fauna:Lion`); Bow (ID: `realia:Bow`); Bitter Herbs (ID: `flora:Chicory`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); ٱلرَّبِّ (ID: `deity:Lord`); أَدومَ (ID: `place:Edom`); To Sin (ID: `keyterm:Sin`); Defile (ID: `keyterm:Stain`); عوصًا (ID: `place:Uz`); Appoint (ID: `keyterm:Appoint`); Defilement (ID: `keyterm:Defilement`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); سَدومَ (ID: `place:Sodom`); Complete (ID: `keyterm:Complete`); Punishment (ID: `keyterm:Punishment`); Anointed (ID: `keyterm:Anointed`); Believe In (ID: `keyterm:BelieveIn`); Jackal (ID: `fauna:Jackal`); Ostrich (ID: `fauna:Ostrich`); Purple Cloth (ID: `realia:PurpleCloth`); Clay Jar (ID: `realia:ClayJar`); Vulture (ID: `fauna:Vulture`)
...
* **Associated ACAI Concepts:** أَدومَ (ID: `place:Edom`); عوصًا (ID: `place:Uz`); أورشَلِيمَ (ID: `place:Jerusalem`); Complete (ID: `keyterm:Complete`); To Sin (ID: `keyterm:Sin`); Appoint (ID: `keyterm:Appoint`); Passion (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Complete (ID: `keyterm:Complete`); To Sin (ID: `keyterm:Sin`); Appoint (ID: `keyterm:Appoint`); أَدومَ (ID: `place:Edom`); Passion (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); Woe (ID: `keyterm:Woe`); To Cause to Possess (ID: `keyterm:Possess`); Assyria (ID: `place:Assyria`); Round Dance (ID: `keyterm:RoundDance`); يَهوذَا (ID: `group:Judah`); مِصْرَ (ID: `place:Egypt`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`); Jackal (ID: `fauna:Jackal`); Hand-Mill (ID: `realia:Hand-mill`); Crown (ID: `realia:Crown`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe`); To Sin (ID: `keyterm:Sin`); Round Dance (ID: `keyterm:RoundDance`); Hand-Mill (ID: `realia:Hand-mill`); Crown (ID: `realia:Crown`)
