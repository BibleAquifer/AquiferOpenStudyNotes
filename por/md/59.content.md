...
* **Associated ACAI Concepts:** bem, aventurado (ID: `keyterm:Happy`); aprovado (ID: `keyterm:Approved`); promessa (ID: `keyterm:Promise`); love (ID: `keyterm:Love`); Life (ID: `keyterm:Life`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); tentar (ID: `keyterm:PutToTheTest`); bem, aventurado (ID: `keyterm:Happy`); amado (ID: `keyterm:Beloved`); limpo (ID: `keyterm:Clean`); aprovado (ID: `keyterm:Approved`); inútil (ID: `keyterm:Worthless`); Truth (ID: `keyterm:Truth`); que não pode ser tentado (ID: `keyterm:NotTempted`); coração (ID: `keyterm:Heart`); salvation (ID: `keyterm:Salvation`); A Person (ID: `person:GenericPerson`); sem mancha (ID: `keyterm:AboveCriticism`); sem mancha (ID: `keyterm:Undefiled`); Ability (ID: `keyterm:Ability`); To Sin (ID: `keyterm:Sin`); be (or show oneself) just (ID: `keyterm:Just`); promessa (ID: `keyterm:Promise`); lei (ID: `keyterm:Law`); Good (ID: `keyterm:Good`); Life (ID: `keyterm:Life`); love (ID: `keyterm:Love`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** limpo (ID: `keyterm:Clean`); inútil (ID: `keyterm:Worthless`); sem mancha (ID: `keyterm:AboveCriticism`); coração (ID: `keyterm:Heart`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); sem mancha (ID: `keyterm:Undefiled`)
...
* **Associated ACAI Concepts:** promessa (ID: `keyterm:Promise`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); escolhido (ID: `keyterm:Chosen`); amado (ID: `keyterm:Beloved`); reino (ID: `keyterm:Kingdom`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); juízo (ID: `keyterm:Judgment`); favoritismo (ID: `keyterm:Partiality`); tropeçar (ID: `keyterm:Stumble`); tribunal de justiça (ID: `keyterm:CourtCase`); escritura (ID: `keyterm:Scripture`); To Sin (ID: `keyterm:Sin`); love (ID: `keyterm:Love`); misericórdia (ID: `keyterm:Mercy`); decidir (ID: `keyterm:Decided`); fornication (ID: `keyterm:Fornication`); inclemente (ID: `keyterm:Merciless`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); Abraão (ID: `person:Abraham`); SENHOR (ID: `deity:Lord`); A Person (ID: `person:GenericPerson`); corpo (ID: `keyterm:Body.3`); inútil (ID: `keyterm:Idle`); Raabe (ID: `person:Rahab`); Spirit (ID: `keyterm:Spirit.2`); An Angel (ID: `deity:Angel`); escritura (ID: `keyterm:Scripture`); Isaque (ID: `person:Isaac`); fazer a paz (ID: `keyterm:Peace`); salvation (ID: `keyterm:Salvation`); vazio (ID: `keyterm:Empty`); To Cause to Happen (ID: `keyterm:Happen`); Demons (ID: `deity:Demons`)
...
* **Associated ACAI Concepts:** Abraão (ID: `person:Abraham`); escritura (ID: `keyterm:Scripture`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`); be (or show oneself) just (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** Hell (ID: `place:Hell`); Ability (ID: `keyterm:Ability`); geena (ID: `keyterm:Gehenna`); corpo (ID: `keyterm:Body.3`); injustiça (ID: `keyterm:UnjustDeed`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); amizade (ID: `keyterm:Friendship`); be unfaithful (ID: `keyterm:Unfaithful`); Spirit (ID: `keyterm:Spirit.2`); coração (ID: `keyterm:Heart`); escritura (ID: `keyterm:Scripture`); Ability (ID: `keyterm:Ability`); favor (ID: `keyterm:Favor`); Holy Spirit (ID: `deity:HolySpirit`); desejar (ID: `keyterm:LongFor`); To Cleanse (ID: `keyterm:Cleanse.2`); pure (ID: `keyterm:Pure`); Cause of Joy (ID: `keyterm:CauseOfJoy`)
...
* **Associated ACAI Concepts:** Spirit (ID: `keyterm:Spirit.2`); Holy Spirit (ID: `deity:HolySpirit`); escritura (ID: `keyterm:Scripture`); desejar (ID: `keyterm:LongFor`)
...
* **Associated ACAI Concepts:** decidir (ID: `keyterm:Decided`); legislador (ID: `keyterm:Lawgiver`); lei (ID: `keyterm:Law`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** coração (ID: `keyterm:Heart`); testemunhar (ID: `keyterm:BearWitness`); SENHOR (ID: `deity:Lord`); condenar (ID: `keyterm:Condemn`); corpo (ID: `keyterm:Body.3`); be (or show oneself) just (ID: `keyterm:Just`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Compassionate (ID: `keyterm:Compassionate`); Jó (ID: `person:Job`); SENHOR (ID: `deity:Lord`); mui compassivo (ID: `keyterm:FullOfCompassion`); considerar feliz (ID: `keyterm:RegardAsHappy`)
...
* **Associated Articles:** Tiago (ID: `639553@TyndaleStudyNotes`)

* **Associated ACAI Concepts:** anointed (ID: `keyterm:Anointed`); SENHOR (ID: `deity:Lord`); Name (ID: `keyterm:Name`); orar (ID: `keyterm:Pray`); igreja (ID: `keyterm:Church`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); salvation (ID: `keyterm:Salvation`); orar (ID: `keyterm:Pray`)
