...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); escolhido (ID: `keyterm:Chosen`); misericórdia (ID: `keyterm:Mercy`); favor (ID: `keyterm:Favor`); SENHOR (ID: `deity:Lord`); fazer a paz (ID: `keyterm:Peace`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`)
...
* **Associated ACAI Concepts:** misericórdia (ID: `keyterm:Mercy`); favor (ID: `keyterm:Favor`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); fazer a paz (ID: `keyterm:Peace`); Jesus (ID: `person:Jesus.2`); Truth (ID: `keyterm:Truth`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); SENHOR (ID: `deity:Lord`); andar (ID: `keyterm:Live.3`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); compartilhar (ID: `keyterm:Share`); corpo (ID: `keyterm:Body.3`); Ability (ID: `keyterm:Ability`); Truth (ID: `keyterm:Truth`); House (ID: `realia:House`)
