...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Zealous (ID: `keyterm:Zealous.3`); strength (ID: `keyterm:Strength`); Carmelo (ID: `place:Carmel`); Basã (ID: `place:Bashan`); Libano (ID: `place:Lebanon`); pronounce innocent (ID: `keyterm:PronounceInnocent`); The Way (ID: `keyterm:TheWay`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Zealous (ID: `keyterm:Zealous.3`); strength (ID: `keyterm:Strength`); Carmelo (ID: `place:Carmel`); Basã (ID: `place:Bashan`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Libano (ID: `place:Lebanon`); pronounce innocent (ID: `keyterm:PronounceInnocent`); wickedness (ID: `keyterm:Wickedness`); The Way (ID: `keyterm:TheWay`); Strong Drink (ID: `realia:StrongDrink`); Brier (ID: `flora:Brier`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); The Way (ID: `keyterm:TheWay`); strength (ID: `keyterm:Strength`); pronounce innocent (ID: `keyterm:PronounceInnocent`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); wickedness (ID: `keyterm:Wickedness`); Strong Drink (ID: `realia:StrongDrink`); Brier (ID: `flora:Brier`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** make a vow (ID: `keyterm:Vow`); Judá (ID: `group:Judah`); peace (ID: `keyterm:IntactState`); wickedness (ID: `keyterm:Wickedness`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); SENHOR (ID: `deity:Lord`); Grass (ID: `flora:Grass`); Flock (ID: `fauna:Flock`); Chariot (ID: `realia:Chariot`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Líbia (ID: `place:Libya`); Pute (ID: `place:Put`); Egito (ID: `place:Egypt`); Cush (ID: `place:Cush.2`); lot (ID: `keyterm:Lot`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`)
