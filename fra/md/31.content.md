...
* **Associated ACAI Concepts:** alliance (ID: `keyterm:Covenant`); Édom (ID: `group:Edom`); comprehension (ID: `keyterm:Understanding`); état intact (ID: `keyterm:IntactState`); Édom (ID: `place:Edom`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `person:Judah.4`); destin (ID: `keyterm:Lot`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Édom (ID: `group:Edom`); déposséder (ID: `keyterm:Dispossess`); Jérusalem (ID: `place:Jerusalem`); Joseph (ID: `person:Joseph.10`); Édom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** Édom (ID: `group:Edom`); Joseph (ID: `person:Joseph.10`); Éternel (ID: `deity:Lord`); Édom (ID: `place:Edom`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Negev (ID: `place:Negeb`); déposséder (ID: `keyterm:Dispossess`); Philistins (ID: `group:Philistine`); Éphraïm (ID: `group:Ephraim`); Canaan (ID: `place:Canaan`); Samarie (ID: `place:Samaria`); Jérusalem (ID: `place:Jerusalem`); Benjamin (ID: `person:Benjamin`); Galaad (ID: `place:Gilead`); Shephelah (ID: `place:Shephelah`); montagne d'Ésaü (ID: `place:EsauMount`); Philistia (ID: `place:Philistine`); Benjamin (ID: `group:Benjamin`); Sarepta (ID: `place:Zarephath`); Canaan (ID: `group:Canaan`); Sardes (ID: `place:Sardis`); Éphraïm (ID: `person:Ephraim`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Negev (ID: `place:Negeb`); déposséder (ID: `keyterm:Dispossess`); montagne d'Ésaü (ID: `place:EsauMount`); Samarie (ID: `place:Samaria`); Shephelah (ID: `place:Shephelah`); Benjamin (ID: `group:Benjamin`); Sarepta (ID: `place:Zarephath`); Sardes (ID: `place:Sardis`); Éphraïm (ID: `person:Ephraim`); Israël (ID: `person:Israel`); Canaan (ID: `place:Canaan`); Philistins (ID: `group:Philistine`); Éphraïm (ID: `group:Ephraim`); Galaad (ID: `place:Gilead`); Philistia (ID: `place:Philistine`); Éternel (ID: `deity:Lord`); Canaan (ID: `group:Canaan`); Benjamin (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** Canaan (ID: `place:Canaan`); Negev (ID: `place:Negeb`); déposséder (ID: `keyterm:Dispossess`); Jérusalem (ID: `place:Jerusalem`); Sarepta (ID: `place:Zarephath`); Canaan (ID: `group:Canaan`); Sardes (ID: `place:Sardis`); Israël (ID: `person:Israel`)
