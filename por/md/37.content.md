...
* **Associated ACAI Concepts:** Ageu (ID: `person:Haggai`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Dario (ID: `person:Darius.2`); Josué (ID: `person:Joshua.5`); SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Ageu (ID: `person:Haggai`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Dario (ID: `person:Darius.2`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); An Angel (ID: `deity:Angel`); fear (ID: `keyterm:Fear`); Olive Tree (ID: `flora:OliveTree`); Must (ID: `realia:Must`); Bag (ID: `realia:Bag`); Vine (ID: `flora:Vine`); Grain (ID: `flora:Grain`); Mule (ID: `fauna:Mule`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); SENHOR (ID: `deity:Lord`); Ageu (ID: `person:Haggai`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Josué (ID: `person:Joshua.5`); fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Ageu (ID: `person:Haggai`); Judá (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Egito (ID: `place:Egypt`); Sealtiel (ID: `person:Shealtiel.2`); fear (ID: `keyterm:Fear`); peace (ID: `keyterm:IntactState`); Judá (ID: `person:Judah.4`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); SENHOR (ID: `deity:Lord`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Ageu (ID: `person:Haggai`); Judá (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Sealtiel (ID: `person:Shealtiel.2`); Judá (ID: `person:Judah.4`); Sword (ID: `realia:Sword`); Horse (ID: `fauna:Horse`); Chariot (ID: `realia:Chariot`)
