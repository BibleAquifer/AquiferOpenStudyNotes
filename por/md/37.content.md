...
* **Associated ACAI Concepts:** Dario (ID: `person:Darius.2`); Ageu (ID: `person:Haggai`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Ageu (ID: `person:Haggai`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Sealtiel (ID: `person:Shealtiel.2`); Josué (ID: `person:Joshua.5`); Dario (ID: `person:Darius.2`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); fear (ID: `keyterm:Fear`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); An Angel (ID: `deity:Angel`); Olive Tree (ID: `flora:OliveTree`); Mule (ID: `fauna:Mule`); Anointing Oil (ID: `realia:AnointingOil`); Grain (ID: `flora:Grain`); Olive Oil (ID: `realia:OliveOil`); Must (ID: `realia:Must`); Vine (ID: `flora:Vine`); Bag (ID: `realia:Bag`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); fear (ID: `keyterm:Fear`); Ageu (ID: `person:Haggai`); Jeozadaque (ID: `person:Jehozadak`); SENHOR (ID: `deity:Lord`); Sealtiel (ID: `person:Shealtiel.2`); Josué (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Sealtiel (ID: `person:Shealtiel.2`); Josué (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Ageu (ID: `person:Haggai`); Judá (ID: `group:Judah`); fear (ID: `keyterm:Fear`); Egito (ID: `place:Egypt`); Judá (ID: `person:Judah.4`); Sealtiel (ID: `person:Shealtiel.2`); peace (ID: `keyterm:IntactState`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Ageu (ID: `person:Haggai`); Judá (ID: `person:Judah.4`); Sealtiel (ID: `person:Shealtiel.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Horse (ID: `fauna:Horse`); Chariot (ID: `realia:Chariot`); Sword (ID: `realia:Sword`)
