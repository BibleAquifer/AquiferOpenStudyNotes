...
* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Blood (ID: `keyterm:Blood`); Forgive (ID: `keyterm:Forgive`); यीशु (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Bless (ID: `keyterm:Bless`); Kingdom (ID: `keyterm:Kingdom`); यहोवा (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); To Sin (ID: `keyterm:Sin`); Vine (ID: `flora:Vine`)
