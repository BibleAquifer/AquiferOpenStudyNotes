...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Jerusalem (ID: `place:Jerusalem`); Intention (ID: `keyterm:Intention`); LORD (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vine (ID: `flora:Vine`); Israel (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Cattle (ID: `fauna:Bull`); Flock (ID: `fauna:Flock`); Money (ID: `realia:Money`); Wine (ID: `realia:Wine`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); Vine (ID: `flora:Vine`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Flock (ID: `fauna:Flock`); Money (ID: `realia:Money`); Wine (ID: `realia:Wine`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Cattle (ID: `fauna:Bull`); Vine (ID: `flora:Vine`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Flock (ID: `fauna:Flock`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vow (ID: `keyterm:Vow`); House (ID: `realia:House`); A Man (ID: `person:GenericMale`); Slaughtering (ID: `keyterm:Slaughtering`); An Angel (ID: `deity:Angel`); Strength (ID: `keyterm:Strength`); Passion (ID: `keyterm:Ardour`); Fear (ID: `keyterm:Fear`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** Stupid (ID: `keyterm:Stupid`); Ability (ID: `keyterm:Ability`); LORD (ID: `deity:Lord`); House (ID: `realia:House`); Intention (ID: `keyterm:Intention`); To Act Wickedly (ID: `keyterm:ActWickedly`); To Cause to Possess (ID: `keyterm:Possess`); To Sin (ID: `keyterm:Sin`); Fear (ID: `keyterm:Fear`); Anointing Oil (ID: `realia:AnointingOil`); Cooking Pot (ID: `realia:CookingPot`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Strength (ID: `keyterm:Strength`); Love (ID: `keyterm:Love`); Intention (ID: `keyterm:Intention`); Hell (ID: `place:Hell`); Anointing Oil (ID: `realia:AnointingOil`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); LORD (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Caper (ID: `flora:Caper`); Bird (ID: `fauna:Bird`); Pit (ID: `realia:Pit`); Money (ID: `realia:Money`); Rope (ID: `realia:Rope`); Almond (ID: `flora:Almond`); Clay Jar (ID: `realia:ClayJar`); Locust (ID: `fauna:Locust`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); Fear (ID: `keyterm:Fear`); Intention (ID: `keyterm:Intention`); Proverb (ID: `keyterm:Saying`); Straightness (ID: `keyterm:Straightness`); Goad (ID: `realia:Goad`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Scroll (ID: `realia:Scroll`); Nail (ID: `realia:Nail`); Goat (ID: `fauna:Goat`)
