...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Hell (ID: `place:Hell`); make a vow (ID: `keyterm:Vow`); praise (ID: `keyterm:Praise`); kindness (ID: `keyterm:Kindness`); salvation (ID: `keyterm:Salvation`); Jonas (ID: `person:Jonah.2`); Cattails (ID: `flora:Cattails`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** make a vow (ID: `keyterm:Vow`); SENHOR (ID: `deity:Lord`); praise (ID: `keyterm:Praise`); kindness (ID: `keyterm:Kindness`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Nínive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Sackcloth (ID: `realia:Sackcloth`); Cattle (ID: `fauna:Bull`); Word of the Lord (ID: `keyterm:WordOfTheLord`); gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`); Believe In (ID: `keyterm:BelieveIn`); Compassionate (ID: `keyterm:Compassionate`); kindness (ID: `keyterm:Kindness`); Clothing (ID: `realia:Clothing`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Worm (ID: `fauna:Maggot`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Cattle (ID: `fauna:Bull`); Nínive (ID: `place:Nineveh`); SENHOR (ID: `deity:Lord`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`); Compassionate (ID: `keyterm:Compassionate`); kindness (ID: `keyterm:Kindness`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** gracious (ID: `keyterm:Generous`); SENHOR (ID: `deity:Lord`); Társis (ID: `place:Tarshish`); Compassionate (ID: `keyterm:Compassionate`); kindness (ID: `keyterm:Kindness`)
