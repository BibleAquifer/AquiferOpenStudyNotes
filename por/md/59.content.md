...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); bem, aventurado (ID: `keyterm:Happy`); tentar (ID: `keyterm:PutToTheTest`); amado (ID: `keyterm:Beloved`); limpo (ID: `keyterm:Clean`); aprovado (ID: `keyterm:Approved`); inútil (ID: `keyterm:Worthless`); To Sin (ID: `keyterm:Sin`); coração (ID: `keyterm:Heart`); sem mancha (ID: `keyterm:Undefiled`); Truth (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); A Person (ID: `person:GenericPerson`); salvation (ID: `keyterm:Salvation`); love (ID: `keyterm:Love`); promessa (ID: `keyterm:Promise`); lei (ID: `keyterm:Law`); be (or show oneself) just (ID: `keyterm:Just`); sem mancha (ID: `keyterm:AboveCriticism`); Life (ID: `keyterm:Life`); Good (ID: `keyterm:Good`); que não pode ser tentado (ID: `keyterm:NotTempted`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); favoritismo (ID: `keyterm:Partiality`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); distinguir (ID: `keyterm:Discern`); Glory (ID: `keyterm:Glory`); Seal (ID: `realia:Seal`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** reino (ID: `keyterm:Kingdom`); love (ID: `keyterm:Love`); promessa (ID: `keyterm:Promise`); escolhido (ID: `keyterm:Chosen`); amado (ID: `keyterm:Beloved`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); lei (ID: `keyterm:Law`); escritura (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); juízo (ID: `keyterm:Judgment`); favoritismo (ID: `keyterm:Partiality`); tropeçar (ID: `keyterm:Stumble`); love (ID: `keyterm:Love`); To Sin (ID: `keyterm:Sin`); escritura (ID: `keyterm:Scripture`); fornication (ID: `keyterm:Fornication`); tribunal de justiça (ID: `keyterm:CourtCase`); misericórdia (ID: `keyterm:Mercy`); decidir (ID: `keyterm:Decided`); inclemente (ID: `keyterm:Merciless`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); Abraão (ID: `person:Abraham`); inútil (ID: `keyterm:Idle`); Raabe (ID: `person:Rahab`); To Cause to Happen (ID: `keyterm:Happen`); Spirit (ID: `keyterm:Spirit.2`); An Angel (ID: `deity:Angel`); Isaque (ID: `person:Isaac`); vazio (ID: `keyterm:Empty`); SENHOR (ID: `deity:Lord`); escritura (ID: `keyterm:Scripture`); corpo (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** To Cause to Happen (ID: `keyterm:Happen`); Abraão (ID: `person:Abraham`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); be (or show oneself) just (ID: `keyterm:Just`); escritura (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** injustiça (ID: `keyterm:UnjustDeed`); geena (ID: `keyterm:Gehenna`); corpo (ID: `keyterm:Body.3`); Hell (ID: `place:Hell`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); amizade (ID: `keyterm:Friendship`); be unfaithful (ID: `keyterm:Unfaithful`); desejar (ID: `keyterm:LongFor`); Spirit (ID: `keyterm:Spirit.2`); favor (ID: `keyterm:Favor`); Cause of Joy (ID: `keyterm:CauseOfJoy`); pure (ID: `keyterm:Pure`); coração (ID: `keyterm:Heart`); To Cleanse (ID: `keyterm:Cleanse.2`); Holy Spirit (ID: `deity:HolySpirit`); escritura (ID: `keyterm:Scripture`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** coração (ID: `keyterm:Heart`); condenar (ID: `keyterm:Condemn`); SENHOR (ID: `deity:Lord`); testemunhar (ID: `keyterm:BearWitness`); be (or show oneself) just (ID: `keyterm:Just`); corpo (ID: `keyterm:Body.3`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Jó (ID: `person:Job`); Compassionate (ID: `keyterm:Compassionate`); mui compassivo (ID: `keyterm:FullOfCompassion`); SENHOR (ID: `deity:Lord`); considerar feliz (ID: `keyterm:RegardAsHappy`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); igreja (ID: `keyterm:Church`); anointed (ID: `keyterm:Anointed`); SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); salvation (ID: `keyterm:Salvation`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); forgive (ID: `keyterm:Forgive`)
