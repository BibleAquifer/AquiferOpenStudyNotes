...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jonah (ID: `person:Jonah.2`); Fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); Vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); Nineveh (ID: `place:Nineveh`); Joppa (ID: `place:Joppa`); Amittai (ID: `person:Amittai`); Lot (ID: `keyterm:Lot`); Tarshish (ID: `place:Tarshish`); Hebrews (ID: `group:Hebrews`); Salvation (ID: `keyterm:Salvation`); Slaughtering (ID: `keyterm:Slaughtering`); Praise (ID: `keyterm:Praise`); Exempt (ID: `keyterm:Exempt`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Kindness (ID: `keyterm:Kindness`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** Vow (ID: `keyterm:Vow`); Slaughtering (ID: `keyterm:Slaughtering`); Fear (ID: `keyterm:Fear`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jonah (ID: `person:Jonah.2`); Nineveh (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Sackcloth (ID: `realia:Sackcloth`); Cattle (ID: `fauna:Bull`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Compassionate (ID: `keyterm:Compassionate`); Tarshish (ID: `place:Tarshish`); Generous (ID: `keyterm:Generous`); Kindness (ID: `keyterm:Kindness`); Believe In (ID: `keyterm:BelieveIn`); Clothing (ID: `realia:Clothing`); Worm (ID: `fauna:Maggot`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Compassionate (ID: `keyterm:Compassionate`); Tarshish (ID: `place:Tarshish`); Generous (ID: `keyterm:Generous`); Kindness (ID: `keyterm:Kindness`); LORD (ID: `deity:Lord`)
