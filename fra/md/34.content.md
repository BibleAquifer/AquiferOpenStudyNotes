...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Carmel (ID: `place:Carmel`); Liban (ID: `place:Lebanon`); chemin (ID: `keyterm:TheWay`); zélé (ID: `keyterm:Zealous.3`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Basan (ID: `place:Bashan`); force (ID: `keyterm:Strength`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Carmel (ID: `place:Carmel`); Liban (ID: `place:Lebanon`); chemin (ID: `keyterm:TheWay`); zélé (ID: `keyterm:Zealous.3`); se réfugier (ID: `keyterm:SeekfindRefuge`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Basan (ID: `place:Bashan`); méchanceté (ID: `keyterm:Wickedness`); force (ID: `keyterm:Strength`); Strong Drink (ID: `realia:StrongDrink`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); Éternel (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Flock (ID: `fauna:Flock`); Chariot (ID: `realia:Chariot`); Grass (ID: `flora:Grass`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Libya (ID: `place:Libya`); Égypte (ID: `place:Egypt`); Cush (ID: `place:Cush.2`); Puth (ID: `place:Put`); destin (ID: `keyterm:Lot`)
