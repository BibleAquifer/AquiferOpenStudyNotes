...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); Hell (ID: `place:Hell`); make a vow (ID: `keyterm:Vow`); Jope (ID: `place:Joppa`); Nínive (ID: `place:Nineveh`); Amittai (ID: `person:Amittai`); exempt (ID: `keyterm:Exempt`); Hebrews (ID: `group:Hebrews`); salvation (ID: `keyterm:Salvation`); kindness (ID: `keyterm:Kindness`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Társis (ID: `place:Tarshish`); lot (ID: `keyterm:Lot`); slaughtering (ID: `keyterm:Slaughtering`); praise (ID: `keyterm:Praise`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Hell (ID: `place:Hell`); praise (ID: `keyterm:Praise`); salvation (ID: `keyterm:Salvation`); make a vow (ID: `keyterm:Vow`); Jonas (ID: `person:Jonah.2`); kindness (ID: `keyterm:Kindness`); Fish (ID: `fauna:Fish`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); praise (ID: `keyterm:Praise`); salvation (ID: `keyterm:Salvation`); make a vow (ID: `keyterm:Vow`); kindness (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Nínive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Compassionate (ID: `keyterm:Compassionate`); gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`); Believe In (ID: `keyterm:BelieveIn`); kindness (ID: `keyterm:Kindness`); Clothing (ID: `realia:Clothing`); Goat (ID: `fauna:Goat`); Worm (ID: `fauna:Maggot`); Flock (ID: `fauna:Flock`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Compassionate (ID: `keyterm:Compassionate`); gracious (ID: `keyterm:Generous`); SENHOR (ID: `deity:Lord`); Társis (ID: `place:Tarshish`); kindness (ID: `keyterm:Kindness`)
