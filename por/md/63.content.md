...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); escolhido (ID: `keyterm:Chosen`); misericórdia (ID: `keyterm:Mercy`); SENHOR (ID: `deity:Lord`); fazer a paz (ID: `keyterm:Peace`); favor (ID: `keyterm:Favor`); para a eternidade (ID: `keyterm:Always`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** misericórdia (ID: `keyterm:Mercy`); love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); SENHOR (ID: `deity:Lord`); fazer a paz (ID: `keyterm:Peace`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); rogar (ID: `keyterm:AskFor`); Truth (ID: `keyterm:Truth`); compartilhar (ID: `keyterm:Share`); corpo (ID: `keyterm:Body.3`); House (ID: `realia:House`)
