...
* **Associated ACAI Concepts:** Ephrathites (ID: `group:Ephrathah`); Efrata (ID: `person:Ephrathah`); Quiliom (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Judá (ID: `group:Judah`); Malom (ID: `person:Mahlon`); Elimeleque (ID: `person:Elimelech`); Belém (ID: `place:Bethlehem`); Judá (ID: `person:Judah.4`); Moabe (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** kindness (ID: `keyterm:Kindness`); SENHOR (ID: `deity:Lord`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Belém (ID: `place:Bethlehem`); Moabe (ID: `place:Moab`); Rute (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Moabe (ID: `place:Moab`); Rute (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** bless (ID: `keyterm:Bless`); kindness (ID: `keyterm:Kindness`); SENHOR (ID: `deity:Lord`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); Boaz (ID: `person:Boaz`); Moabe (ID: `place:Moab`); to cause to possess (ID: `keyterm:Possess`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Malom (ID: `person:Mahlon`); to cause to possess (ID: `keyterm:Possess`); Moabe (ID: `place:Moab`); Rute (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Lia (ID: `person:Leah`); Belém (ID: `place:Bethlehem`); Raquel (ID: `person:Rachel`); SENHOR (ID: `deity:Lord`); Elders (ID: `group:GenericElders`)
...
* **Associated ACAI Concepts:** Tamar (ID: `person:Tamar`); Judá (ID: `group:Judah`); Perez (ID: `person:Perez`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Hezrom (ID: `person:Hezron.2`); Salmom (ID: `person:Salmon`); Aminadabe (ID: `person:Amminadab`); Obede (ID: `person:Obed`); Ram (ID: `person:Ram`); Boaz (ID: `person:Boaz`); Jessé (ID: `person:Jesse`); Perez (ID: `person:Perez`); Naassom (ID: `person:Nahshon`); Davi (ID: `person:David`)
