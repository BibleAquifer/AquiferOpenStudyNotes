...
* **Associated ACAI Concepts:** exortar (ID: `keyterm:Encourage`); livrar (ID: `keyterm:Deliver`); rogar (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** Veil (ID: `realia:Veil`); em cristo (ID: `keyterm:InChrist`); reconciliar (ID: `keyterm:Reconcile`); letra (ID: `keyterm:Letter`); Corinthians (ID: `group:Corinth`); Ink (ID: `realia:Ink`); Tent (ID: `realia:Tent`); sem hipocrisia (ID: `keyterm:Unhypocritical`); Make Alive (ID: `keyterm:Alive`); desejar (ID: `keyterm:LongFor`); vazio (ID: `keyterm:Empty`); servir (ID: `keyterm:Serve`); coração (ID: `keyterm:Heart`); corpo (ID: `keyterm:Body.3`); Life (ID: `keyterm:Life`); Holy Spirit (ID: `deity:HolySpirit`); Glory (ID: `keyterm:Glory`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Veil (ID: `realia:Veil`); letra (ID: `keyterm:Letter`); Make Alive (ID: `keyterm:Alive`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** reconciliar (ID: `keyterm:Reconcile`); Corinthians (ID: `group:Corinth`); em cristo (ID: `keyterm:InChrist`); sem hipocrisia (ID: `keyterm:Unhypocritical`); vazio (ID: `keyterm:Empty`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** sem hipocrisia (ID: `keyterm:Unhypocritical`)
...
* **Associated ACAI Concepts:** arrepender, se (ID: `keyterm:Repent`); zelo (ID: `keyterm:Extremely`); pure (ID: `keyterm:Pure`)
...
* **Associated ACAI Concepts:** empenho (ID: `keyterm:Eagerness`); igreja (ID: `keyterm:Church`); favor (ID: `keyterm:Favor`); servir (ID: `keyterm:Serve`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Aretas (ID: `person:Aretas`); Eva (ID: `person:Eve`); discernir (ID: `keyterm:Interpret`); Snake (ID: `fauna:Snake`); Fortress (ID: `realia:Fortress`); corpo (ID: `keyterm:Body.3`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`)
