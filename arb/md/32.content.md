...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); Fear (ID: `keyterm:Fear`); Fish (ID: `fauna:Fish`); Ship (ID: `realia:Ship`); Vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); نِينَوَى (ID: `place:Nineveh`); يَافَا (ID: `place:Joppa`); أَمِتَّايَ (ID: `person:Amittai`); Kindness (ID: `keyterm:Kindness`); Praise (ID: `keyterm:Praise`); تَرْشِيشَ (ID: `place:Tarshish`); Salvation (ID: `keyterm:Salvation`); Exempt (ID: `keyterm:Exempt`); Slaughtering (ID: `keyterm:Slaughtering`); Lot (ID: `keyterm:Lot`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Hebrews (ID: `group:Hebrews`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Hell (ID: `place:Hell`); يونَانَ (ID: `person:Jonah.2`); Vow (ID: `keyterm:Vow`); Salvation (ID: `keyterm:Salvation`); Praise (ID: `keyterm:Praise`); Kindness (ID: `keyterm:Kindness`); Cattails (ID: `flora:Cattails`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** Vow (ID: `keyterm:Vow`); ٱلرَّبِّ (ID: `deity:Lord`); Salvation (ID: `keyterm:Salvation`); Kindness (ID: `keyterm:Kindness`); Praise (ID: `keyterm:Praise`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); نِينَوَى (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Believe In (ID: `keyterm:BelieveIn`); Compassionate (ID: `keyterm:Compassionate`); Generous (ID: `keyterm:Generous`); تَرْشِيشَ (ID: `place:Tarshish`); Kindness (ID: `keyterm:Kindness`); Clothing (ID: `realia:Clothing`); Worm (ID: `fauna:Maggot`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Cattle (ID: `fauna:Bull`); ٱلرَّبِّ (ID: `deity:Lord`); نِينَوَى (ID: `place:Nineveh`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); Compassionate (ID: `keyterm:Compassionate`); Generous (ID: `keyterm:Generous`); تَرْشِيشَ (ID: `place:Tarshish`); Kindness (ID: `keyterm:Kindness`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Compassionate (ID: `keyterm:Compassionate`); Generous (ID: `keyterm:Generous`); ٱلرَّبِّ (ID: `deity:Lord`); تَرْشِيشَ (ID: `place:Tarshish`); Kindness (ID: `keyterm:Kindness`)
