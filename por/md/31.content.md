...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); lot (ID: `keyterm:Lot`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`); José (ID: `person:Joseph.10`); Jerusalém (ID: `place:Jerusalem`); dispossess (ID: `keyterm:Dispossess`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`); SENHOR (ID: `deity:Lord`); José (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** dispossess (ID: `keyterm:Dispossess`); Neguebe (ID: `place:Negeb`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Filístia (ID: `place:Philistine`); Benjamim (ID: `group:Benjamin`); cananeu (ID: `group:Canaan`); Sefalá (ID: `place:Shephelah`); Sarepta (ID: `place:Zarephath`); Canaã (ID: `place:Canaan`); Filisteu (ID: `group:Philistine`); Sardes (ID: `place:Sardis`); Efraim (ID: `group:Ephraim`); Gileade (ID: `place:Gilead`); Monte de Esaú (ID: `place:EsauMount`); Efraim (ID: `person:Ephraim`); Samaria (ID: `place:Samaria`); Benjamim (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Monte de Esaú (ID: `place:EsauMount`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Efraim (ID: `person:Ephraim`); Filístia (ID: `place:Philistine`); Sefalá (ID: `place:Shephelah`); Benjamim (ID: `group:Benjamin`); Sardes (ID: `place:Sardis`); Canaã (ID: `place:Canaan`); Filisteu (ID: `group:Philistine`); SENHOR (ID: `deity:Lord`); Benjamim (ID: `person:Benjamin`); Sarepta (ID: `place:Zarephath`); Efraim (ID: `group:Ephraim`); Gileade (ID: `place:Gilead`); cananeu (ID: `group:Canaan`); Samaria (ID: `place:Samaria`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); dispossess (ID: `keyterm:Dispossess`); Sarepta (ID: `place:Zarephath`); Sardes (ID: `place:Sardis`); Neguebe (ID: `place:Negeb`); cananeu (ID: `group:Canaan`); Canaã (ID: `place:Canaan`); Jerusalém (ID: `place:Jerusalem`)
