...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); chemin (ID: `keyterm:TheWay`); Basan (ID: `place:Bashan`); Liban (ID: `place:Lebanon`); Carmel (ID: `place:Carmel`); force (ID: `keyterm:Strength`); zélé (ID: `keyterm:Zealous.3`); déclarer innocent (ID: `keyterm:PronounceInnocent`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); chemin (ID: `keyterm:TheWay`); méchanceté (ID: `keyterm:Wickedness`); se réfugier (ID: `keyterm:SeekfindRefuge`); Basan (ID: `place:Bashan`); Liban (ID: `place:Lebanon`); Carmel (ID: `place:Carmel`); force (ID: `keyterm:Strength`); zélé (ID: `keyterm:Zealous.3`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Strong Drink (ID: `realia:StrongDrink`); Brier (ID: `flora:Brier`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** méchanceté (ID: `keyterm:Wickedness`); faire un voeu (ID: `keyterm:Vow`); état intact (ID: `keyterm:IntactState`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Puth (ID: `place:Put`); destin (ID: `keyterm:Lot`); Libya (ID: `place:Libya`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Cush (ID: `place:Cush.2`); Égypte (ID: `place:Egypt`)
