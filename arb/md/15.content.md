...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); ٱلرَّبِّ (ID: `deity:Lord`); فَارِسَ (ID: `place:Persia`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`); إِسْرَائِيلَ (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); إِرْمِيَا (ID: `person:Jeremiah.6`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); أورشَلِيمَ (ID: `place:Jerusalem`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `person:Benjamin`); بَنْيَامِينَ (ID: `group:Benjamin`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); لَّاوِي (ID: `group:Levi`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); لَّاوِي (ID: `person:Levi.3`); House (ID: `realia:House`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); زَربَّابِل (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); لَّاوِي (ID: `group:Levi`); أورشَلِيمَ (ID: `place:Jerusalem`); سلَيْمَانَ (ID: `person:Solomon`); لَّاوِي (ID: `person:Levi.3`); يورَةَ (ID: `person:Jorah`); زَكَّايَ (ID: `person:Zaccai.2`); يَدَايَا (ID: `person:Jedaiah.4`); جَدِّيلَ (ID: `person:Giddel.2`); فَادونَ (ID: `person:Padon`); حَجَابَةَ (ID: `person:Hagabah`); شوبَايَ (ID: `person:Shobai`); صِيحَا (ID: `person:Ziha`); مِسْفَار (ID: `person:Mispar`); رَآيَا (ID: `person:Reaiah.3`); أَدَّان (ID: `place:Addan`); حَادِيدَ (ID: `place:Hadid`); حَرْحورَ (ID: `person:Harhur`); دَرْقونَ (ID: `person:Darkon`); شَفَطْيَا (ID: `person:Shephatiah.6`); يَشوعَ (ID: `person:Jeshua.3`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); Tel-melah (ID: `place:Tel-melah`); حَزَقِيَّا (ID: `person:Hezekiah.2`); بَعْنَةَ (ID: `person:Baanah.3`); رَحوم (ID: `person:Rehum`); لَبَانَةَ (ID: `person:Lebanah`); بَابَايَ (ID: `person:Bebai`); ثَامَحَ (ID: `person:Temah`)
...
* **Associated ACAI Concepts:** بِغْوَايَ (ID: `person:Bigvai`); مرْدَخَاي (ID: `person:Mordecai`); مِسْفَار (ID: `person:Mispar`); نَحَمْيَا (ID: `person:Nehemiah`); رَحوم (ID: `person:Rehum`); سَرَايَا (ID: `person:Seraiah.6`); رَعْلَايَا (ID: `person:Reelaiah`); بِلْشَان (ID: `person:Bilshan`); بَعْنَةَ (ID: `person:Baanah.3`); إِسْرَائِيلَ (ID: `person:Israel`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** يورَةَ (ID: `person:Jorah`); زَكَّايَ (ID: `person:Zaccai.2`); عِيلَامَ (ID: `person:Elam`); آطِيرَ (ID: `person:Ater`); بِغْوَايَ (ID: `person:Bigvai.2`); أَدونِيقَامَ (ID: `person:Adonikam`); يوآب (ID: `person:Joab.3`); عَرْجَدَ (ID: `person:Azgad`); شَفَطْيَا (ID: `person:Shephatiah.6`); بِيصَايَ (ID: `person:Bezai`); يَشوعَ (ID: `person:Jeshua.3`); بَانِيَ (ID: `person:Bani`); فَرْعوشَ (ID: `person:Parosh`); حَزَقِيَّا (ID: `person:Hezekiah.2`); زَتّو (ID: `person:Zattu.2`); حَشوم (ID: `person:Hashum`); بَابَايَ (ID: `person:Bebai`); Pahath-moab (ID: `person:Pahath-moab`); آرَحَ (ID: `person:Arah.2`); عَادِينَ (ID: `person:Adin`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Beth-azmaveth (ID: `place:Beth-azmaveth`); حَارِيمَ (ID: `person:Harim.2`); حَادِيدَ (ID: `place:Hadid`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); نَبو (ID: `place:Nebo.2`); مَغْبِيشَ (ID: `place:Magbish`); سَنَاءَةَ (ID: `place:Senaah`); عِيلَامَ (ID: `person:Elam`); وَلودَ (ID: `place:Lod`); عَايٍ (ID: `place:Ai`); عَنَاثوثَ (ID: `place:Anathoth`); مِخْمَاسَ (ID: `place:Michmash`); Bethel (ID: `place:Bethel`); أونوَ (ID: `place:Ono`); أَرِيحَا (ID: `place:Jericho`); ٱلْكَفِيرَة (ID: `place:Chephirah`); بَئِيروت (ID: `place:Beeroth`); مِنْ (ID: `place:Geba`); Kiriath-jearim (ID: `place:Kiriath-jearim`); لَحْمٍ (ID: `place:Bethlehem`); Ramah (ID: `place:Ramah.2`)
...
* **Associated ACAI Concepts:** شوبَايَ (ID: `person:Shobai`); يَشوعَ (ID: `person:Jeshua.4`); حَارِيمَ (ID: `person:Harim`); يَدَايَا (ID: `person:Jedaiah.4`); يَشوعَ (ID: `person:Jeshua`); حَطِيطَا (ID: `person:Hatita`); طَلْمون (ID: `person:Talmon`); آطِيرَ (ID: `person:Ater.2`); هودَوْيَا (ID: `person:Hodaviah.4`); لِإِيمِيرَ (ID: `person:Immer.2`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`); لَّاوِي (ID: `group:Levi`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); شَلّوم (ID: `person:Shallum.8`); فَشْحور (ID: `person:Pashhur`); لَّاوِي (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** شوبَايَ (ID: `person:Shobai`); حَطِيطَا (ID: `person:Hatita`); طَلْمون (ID: `person:Talmon`); آطِيرَ (ID: `person:Ater.2`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`); شَلّوم (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** فَاسِيحَ (ID: `person:Paseah.2`); عَقّوب (ID: `person:Akkub.3`); نَقودَا (ID: `person:Nekoda`); نَصِيحَ (ID: `person:Neziah`); قِيروسَ (ID: `person:Keros`); سِيسَرَا (ID: `person:Sisera.2`); فَادونَ (ID: `person:Padon`); حَجَابَةَ (ID: `person:Hagabah`); صِيحَا (ID: `person:Ziha`); حَاجَابَ (ID: `person:Hagab`); حَطِيفَا (ID: `person:Hatipha`); سِيعَهَا (ID: `person:Siaha`); فِي (ID: `person:Uzza.2`); رَآيَا (ID: `person:Reaiah.3`); جَاحَرَ (ID: `person:Gahar`); جَزَّامَ (ID: `person:Gazzam`); حَرْحورَ (ID: `person:Harhur`); حَانَان (ID: `person:Hanan.4`); بِيسَايَ (ID: `person:Besai`); حَسوفَا (ID: `person:Hasupha`); بَقْبوقَ (ID: `person:Bakbuk`); مَحِيدَا (ID: `person:Mehida`); حَرْشَا (ID: `person:Harsha`); سَلْمَايَ (ID: `person:Shalmai`); Meunim (ID: `group:Meunim`); Nephushesim (ID: `group:Nephushesim`); لَبَانَةَ (ID: `person:Lebanah`); جَدِّيلَ (ID: `person:Giddel`); أَسْنَةَ (ID: `person:Asnah`); بَرْقوسَ (ID: `person:Barkos`); ثَامَحَ (ID: `person:Temah`); طَبَاعوتَ (ID: `person:Tabbaoth`); حَقوفَا (ID: `person:Hakupha`); رَصِينَ (ID: `person:Rezin.2`); بَصْلوتَ (ID: `person:Bazluth`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); فَرودَا (ID: `person:Peruda`); آمِي (ID: `person:Ami`); دَرْقونَ (ID: `person:Darkon`); شَفَطْيَا (ID: `person:Shephatiah.7`); سوفَرَثَ (ID: `person:Sophereth`); جَدِّيلَ (ID: `person:Giddel.2`); حَطِّيلَ (ID: `person:Hattil`); يَعْلَةَ (ID: `person:Jaalah`); سَوْطَايَ (ID: `person:Sotai`)
...
* **Associated ACAI Concepts:** طوبِيَّا (ID: `person:Tobiah`); كَروب (ID: `place:Cherub`); أَدَّان (ID: `place:Addan`); Tel-melah (ID: `place:Tel-melah`); Tel-harsha (ID: `place:Tel-harsha`); نَقودَا (ID: `person:Nekoda.2`); لِدَلَايَا (ID: `person:Delaiah.3`); لِإِيمِيرَ (ID: `place:Immer`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** حَبَايَا (ID: `person:Habaiah`); بَرْزِلَّايَ (ID: `person:Barzillai.3`); هَقّوصَ (ID: `person:Hakkoz.2`); Defile (ID: `keyterm:Stain`); جِلْعَادَ (ID: `place:Gilead`); بَرْزِلَّايَ (ID: `person:Barzillai`); Gileadites (ID: `group:Gilead`); Priesthood (ID: `keyterm:Priesthood`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); أورشَلِيمَ (ID: `place:Jerusalem`); Strength (ID: `keyterm:Strength`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); Mina (ID: `realia:Mina`); Tunic (ID: `realia:Tunic`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); يَشوع (ID: `person:Joshua.5`); فَارِسَ (ID: `place:Persia`); كورَشَ (ID: `person:Cyrus`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Esarhaddon (ID: `person:Esarhaddon`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); Relatives (ID: `group:Relatives`); هودَوْيَا (ID: `person:Hodaviah.4`); يَشوعَ (ID: `person:Jeshua.4`); حِينَادَادَ (ID: `person:Henadad`); موسَى (ID: `person:Moses`); لبْنَانَ (ID: `place:Lebanon`); Sidonians (ID: `group:Sidon`); بَنْيَامِينَ (ID: `group:Benjamin`); Kindness (ID: `keyterm:Kindness`); دَارِيوسَ (ID: `person:Darius.2`); صورَ (ID: `place:Tyre`); Instruction (ID: `keyterm:Instruction`); Appointed Feast (ID: `keyterm:AppointedFeast`); بَنْيَامِينَ (ID: `person:Benjamin`); Counsel (ID: `keyterm:Counsel`); Terror (ID: `keyterm:Terror`); New Moon Festival (ID: `keyterm:NewMoonFestival`); هودِيَّا (ID: `person:Hodiah.2`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); يَافَا (ID: `place:Joppa`); صِيْدونَ (ID: `place:Sidon`); Holy (ID: `keyterm:Holy`); Assyria (ID: `place:Assyria`); آسَاف (ID: `person:Asaph.2`); Tyrians (ID: `group:Tyre`); دَاودَ (ID: `person:David`); Cymbals (ID: `realia:Cymbals`); Cedar (ID: `flora:Cedar`); Craftsman (ID: `realia:Craftsman`); Money (ID: `realia:Money`); Trumpet (ID: `realia:Trumpet`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); Offering (ID: `keyterm:Offering`); موسَى (ID: `person:Moses`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); Terror (ID: `keyterm:Terror`); ٱلرَّبِّ (ID: `deity:Lord`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Appointed Feast (ID: `keyterm:AppointedFeast`); Holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); لبْنَانَ (ID: `place:Lebanon`); Tyrians (ID: `group:Tyre`); صورَ (ID: `place:Tyre`); يَافَا (ID: `place:Joppa`); صِيْدونَ (ID: `place:Sidon`); Sidonians (ID: `group:Sidon`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Money (ID: `realia:Money`); Cedar (ID: `flora:Cedar`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); يَشوع (ID: `person:Joshua.5`); لَّاوِي (ID: `group:Levi`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `person:Levi.3`); زَربَّابِل (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); آسَاف (ID: `person:Asaph.2`); لَّاوِي (ID: `group:Levi`); دَاودَ (ID: `person:David`); لَّاوِي (ID: `person:Levi.3`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `person:Benjamin`); بَنْيَامِينَ (ID: `group:Benjamin`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); كورَشَ (ID: `person:Cyrus`); إِسْرَائِيلَ (ID: `person:Israel`); فَارِسَ (ID: `place:Persia`); يَشوع (ID: `person:Joshua.5`); ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْفرَاتِ (ID: `place:Euphrates`); رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); فَارِسَ (ID: `place:Persia`); ٱلسَّامِرَةِ (ID: `place:Samaria`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); طَبْئِيل (ID: `person:Tabeel`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); مِثْرَدَاث (ID: `person:Mithredath.2`); بِشْلَام (ID: `person:Bishlam`); أسْنَفَّر (ID: `person:Osnappar`); Babylonians (ID: `group:Babylon`); أَرَكَ (ID: `place:Erech`); عِيلَامَ (ID: `place:Elam`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Elamites (ID: `group:Elam`); فِي (ID: `place:Susa`); Persians (ID: `group:Persia`); بَابِلَ (ID: `place:Babylon`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath.2`); بِشْلَام (ID: `person:Bishlam`); طَبْئِيل (ID: `person:Tabeel`); فَارِسَ (ID: `place:Persia`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`)
...
* **Associated ACAI Concepts:** ٱلدِّينِيِّينَ (ID: `person:Dinaite`); Babylonians (ID: `group:Babylon`); أَرَكَ (ID: `place:Erech`); شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); عِيلَامَ (ID: `place:Elam`); فِي (ID: `place:Susa`); فَارِسَ (ID: `place:Persia`); Persians (ID: `group:Persia`); بَابِلَ (ID: `place:Babylon`); Elamites (ID: `group:Elam`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); Jews (ID: `group:Jews`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); دَارِيوسَ (ID: `person:Darius.2`); تَتْنَاي (ID: `person:Tattenai`); حَجَّيِ (ID: `person:Haggai`); يَدّو (ID: `person:Iddo.6`); زَكَرِيَّا (ID: `person:Zechariah.17`); Shethar-bozenai (ID: `person:Shethar-bozenai`); يَهوصَادِقَ (ID: `person:Jehozadak`); إِسْرَائِيلَ (ID: `person:Israel`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَشوع (ID: `person:Joshua.5`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `person:Judah.4`); ٱلْفرَاتِ (ID: `place:Euphrates`); زَربَّابِل (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); أورشَلِيمَ (ID: `place:Jerusalem`); بَابِلَ (ID: `place:Babylon`); كورَشَ (ID: `person:Cyrus`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); دَارِيوسَ (ID: `person:Darius.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); تَتْنَاي (ID: `person:Tattenai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Chaldeans (ID: `group:Chaldea`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); يَهوذَا (ID: `person:Judah.4`); ٱلْفرَاتِ (ID: `place:Euphrates`); Foundation (ID: `realia:Foundation`); Hewn Stone (ID: `realia:HewnStone`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); كورَشَ (ID: `person:Cyrus`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); بَابِلَ (ID: `place:Babylon`); زَربَّابِل (ID: `person:Zerubbabel.2`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Defilement (ID: `keyterm:Defilement`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Gentiles (ID: `group:Gentile`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); أَخِيطوبَ (ID: `person:Ahitub.3`); أَمَرْيَا (ID: `person:Amariah.2`); عزِّي (ID: `person:Uzzi`); صَادوق (ID: `person:Zadok.4`); زَرَحْيَا (ID: `person:Zerahiah`); شَلّوم (ID: `person:Shallum.7`); أَبِيشوعَ (ID: `person:Abishua`); لِمَرَايوثَ (ID: `person:Meraioth`); سَرَايَا (ID: `person:Seraiah.2`); بقِّي (ID: `person:Bukki.2`); عَزَرْيَا (ID: `person:Azariah.7`); عَزَرْيَا (ID: `person:Azariah.6`); فَارِسَ (ID: `place:Persia`); هَارون (ID: `person:Aaron`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فِينَحَاس (ID: `person:Phinehas`); حِلْقِيَّا (ID: `person:Hilkiah.2`); أَلِعَازَار (ID: `person:Eleazar.2`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); موسَى (ID: `person:Moses`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); بَابِلَ (ID: `place:Babylon`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); عَزْرَا (ID: `person:Ezra`); Decree (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); عَزْرَا (ID: `person:Ezra`); ٱلْفرَاتِ (ID: `place:Euphrates`); Olive Oil (ID: `realia:OliveOil`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Kor (ID: `realia:Kor`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** زَكَرِيَّا (ID: `person:Zechariah.18`); دَانِيآل (ID: `person:Daniel.2`); شِمْعِيَا (ID: `person:Shemaiah.14`); زَكَرِيَّا (ID: `person:Zechariah.19`); عِيلَامَ (ID: `person:Elam`); هِقَّاطَانَ (ID: `person:Hakkatan`); مِيخَائِيلَ (ID: `person:Michael.10`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); بِغْوَايَ (ID: `person:Bigvai.2`); أَلِيفَلَط (ID: `person:Eliphelet.5`); يوآب (ID: `person:Joab.4`); فَرْعوشَ (ID: `person:Parosh.2`); Gershom (ID: `person:Gershom.2`); عوتَاي (ID: `person:Uthai.2`); شَكَنْيَا (ID: `person:Shecaniah.6`); زَرَحْيَا (ID: `person:Zerahiah.2`); أَدونِيقَامَ (ID: `person:Adonikam`); عَرْجَدَ (ID: `person:Azgad`); يَعِيئِيل (ID: `person:Jeuel.3`); زَبَدْيَا (ID: `person:Zebadiah.8`); يَحْزِيئِيل (ID: `person:Jahaziel.5`); شَفَطْيَا (ID: `person:Shephatiah.6`); بَابَايَ (ID: `person:Bebai.2`); عَثَلْيَا (ID: `person:Athaliah.3`); يِشْعِيَا (ID: `person:Jeshaiah.4`); يوشَفْيَا (ID: `person:Josiphiah`); يَحِيئِيل (ID: `person:Jehiel.7`); حَطّوش (ID: `person:Hattush.2`); شَكَنْيَا (ID: `person:Shecaniah.5`); بَابَايَ (ID: `person:Bebai`); Pahath-moab (ID: `person:Pahath-moab`); زَكّور (ID: `person:Zaccur.5`); يونَاثَانَ (ID: `person:Jonathan.9`); شَلومِيَةَ (ID: `person:Shelomith.4`); يوحَانَانَ (ID: `person:Johanan.8`); عوبَدْيَا (ID: `person:Obadiah.10`); عَابِد (ID: `person:Ebed.2`); عَادِينَ (ID: `person:Adin`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فِينَحَاس (ID: `person:Phinehas`); بَابِلَ (ID: `place:Babylon`); دَاودَ (ID: `person:David`); إِيثَامَارَ (ID: `person:Ithamar`)
...
* **Associated ACAI Concepts:** أَرِيئِيلَ (ID: `person:Ariel`); أَلِيعَزَرَ (ID: `person:Eliezer.8`); مَشلَّام (ID: `person:Meshullam.9`); ٱلْمسَمَّى (ID: `place:Casiphia`); يَدّو (ID: `person:Iddo`); شِمْعِيَا (ID: `person:Shemaiah.15`); يويَارِيبَ (ID: `person:Joiarib.2`); نَاثَان (ID: `person:Nathan.5`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); يَارِيبَ (ID: `person:Jarib.2`); زَكَرِيَّا (ID: `person:Zechariah.20`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); ٱلرَّبِّ (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); Insight (ID: `keyterm:Insight`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `group:Levi`); ٱلرَّبِّ (ID: `deity:Lord`); مَحْلِي (ID: `person:Mahli`); لَّاوِي (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** دَاودَ (ID: `person:David`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Work (ID: `keyterm:Work`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); كَنْعَان (ID: `place:Canaan`); Be Unfaithful (ID: `keyterm:Unfaithful`); إِسْرَائِيلَ (ID: `person:Israel`); Ammonites (ID: `group:Ammon`); Jebusites (ID: `group:Jebusites`); لَّاوِي (ID: `group:Levi`); مِصْرَ (ID: `place:Egypt`); موآبَ (ID: `place:Moab`); Canaanites (ID: `group:Canaan`); Egyptians (ID: `group:Egypt`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); Amorites (ID: `group:Amorites`); لَّاوِي (ID: `person:Levi.3`); حِثًّا (ID: `person:Heth`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); عِيلَامَ (ID: `person:Elam`); يَهوذَا (ID: `group:Judah`); Offering (ID: `keyterm:Offering`); يَهوذَا (ID: `person:Judah.4`); Counsel (ID: `keyterm:Counsel`); يوئِيل (ID: `person:Joel.12`); Hittites (ID: `group:Hittite`); يَرِيموت (ID: `person:Jeremoth.3`); عَثْلَاي (ID: `person:Athlai`); زَبَاي (ID: `person:Zabbai`); أَلِيوعِينَاي (ID: `person:Elioenai.4`); يَهونَاثَان (ID: `person:Jehohanan.4`); بَانِيَ (ID: `person:Bani.5`); مَنَسَّى (ID: `person:Manasseh.3`); أَلِيوعِينَاي (ID: `person:Elioenai.5`); مَشلَّام (ID: `person:Meshullam.11`); ٱلْعَمْرَامِيِّينَ (ID: `person:Amram.2`); عَبْدِي (ID: `person:Abdi.3`); شِمْعِي (ID: `person:Shimei.17`); يوصَادَاقَ (ID: `person:Jozadak.2`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); To Cause to Possess (ID: `keyterm:Possess`); Peace (ID: `keyterm:IntactState`); Kindness (ID: `keyterm:Kindness`); فَارِسَ (ID: `place:Persia`); Dispossess (ID: `keyterm:Dispossess`); Plea for Mercy (ID: `keyterm:Supplication`); Defilement (ID: `keyterm:Defilement`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); أورشَلِيمَ (ID: `place:Jerusalem`); Kindness (ID: `keyterm:Kindness`); فَارِسَ (ID: `place:Persia`); Plea for Mercy (ID: `keyterm:Supplication`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** يَحِيئِيل (ID: `person:Jehiel.8`); شَكَنْيَا (ID: `person:Shecaniah.7`); Be Unfaithful (ID: `keyterm:Unfaithful`); إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); ٱلرَّبِّ (ID: `deity:Lord`); عَزْرَا (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); Counsel (ID: `keyterm:Counsel`); Covenant (ID: `keyterm:Covenant`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `group:Levi`); عَزْرَا (ID: `person:Ezra`); لَّاوِي (ID: `person:Levi.3`); Swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `person:Benjamin`); بَنْيَامِينَ (ID: `group:Benjamin`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَحْزِيَا (ID: `person:Jahzeiah`); يونَاثَانَ (ID: `person:Jonathan.10`); عَسَائِيل (ID: `person:Asahel.4`); تِقْوَةَ (ID: `person:Tikvah.2`); شَبْتَاي (ID: `person:Shabbethai`); مَشلَّام (ID: `person:Meshullam.10`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`)
