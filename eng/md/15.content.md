...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Cyrus (ID: `person:Cyrus`); Persia (ID: `place:Persia`); Tribe of Judah (ID: `group:Judah`); Jerusalem (ID: `place:Jerusalem`); Judah (ID: `person:Judah.4`); House (ID: `realia:House`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Jeremiah (ID: `person:Jeremiah.6`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Cyrus (ID: `person:Cyrus`); Tribe of Judah (ID: `group:Judah`); Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Judah (ID: `person:Judah.4`); Persia (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Tribe of Judah (ID: `group:Judah`); Israel (ID: `person:Israel`); Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Judah (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); Benjamin (ID: `person:Benjamin`); Tribe of Judah (ID: `group:Judah`); Tribe of Benjamin (ID: `group:Benjamin`); Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Judah (ID: `person:Judah.4`); Tribe of Levi (ID: `group:Levi`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Cyrus (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mithredath (ID: `person:Mithredath`); Tribe of Judah (ID: `group:Judah`); Zerubbabel (ID: `person:Zerubbabel.2`); Judah (ID: `person:Judah.4`); Persia (ID: `place:Persia`); Cyrus (ID: `person:Cyrus`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Solomon (ID: `person:Solomon`); Jerusalem (ID: `place:Jerusalem`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); Bebai (ID: `person:Bebai`); Hakkoz (ID: `person:Hakkoz.2`); Parosh (ID: `person:Parosh`); Bakbuk (ID: `person:Bakbuk`); Nephushesim (ID: `group:Nephushesim`); Nekoda (ID: `person:Nekoda.2`); Keros (ID: `person:Keros`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); Shalmai (ID: `person:Shalmai`); Siaha (ID: `person:Siaha`); Jeshua (ID: `person:Jeshua.3`); Tel-melah (ID: `place:Tel-melah`); Bilshan (ID: `person:Bilshan`); Bazluth (ID: `person:Bazluth`); Netophah (ID: `place:Netophah`); Jaalah (ID: `person:Jaalah`); Rehum (ID: `person:Rehum`); Bigvai (ID: `person:Bigvai`); Mispar (ID: `person:Mispar`); Bigvai (ID: `person:Bigvai.2`); Shephatiah (ID: `person:Shephatiah.7`); Harim (ID: `person:Harim`); Hanan (ID: `person:Hanan.4`); Reelaiah (ID: `person:Reelaiah`)
...
* **Associated ACAI Concepts:** Rehum (ID: `person:Rehum`); Bilshan (ID: `person:Bilshan`); Reelaiah (ID: `person:Reelaiah`); Mordecai (ID: `person:Mordecai`); Bigvai (ID: `person:Bigvai`); Mispar (ID: `person:Mispar`); Seraiah (ID: `person:Seraiah.6`); Nehemiah (ID: `person:Nehemiah`); Baanah (ID: `person:Baanah.3`); Joshua (ID: `person:Joshua.5`); Zerubbabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Hashum (ID: `person:Hashum`); Bebai (ID: `person:Bebai`); Parosh (ID: `person:Parosh`); Zattu (ID: `person:Zattu.2`); Arah (ID: `person:Arah.2`); Hezekiah (ID: `person:Hezekiah.2`); Elam (ID: `person:Elam`); Adin (ID: `person:Adin`); Joab (ID: `person:Joab.3`); Jeshua (ID: `person:Jeshua.3`); Bani (ID: `person:Bani`); Zaccai (ID: `person:Zaccai.2`); Ater (ID: `person:Ater`); Jorah (ID: `person:Jorah`); Shephatiah (ID: `person:Shephatiah.6`); Azgad (ID: `person:Azgad`); Adonikam (ID: `person:Adonikam`); Bigvai (ID: `person:Bigvai.2`); Bezai (ID: `person:Bezai`); Pahath-moab (ID: `person:Pahath-moab`); Gibeon (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Beth-azmaveth (ID: `place:Beth-azmaveth`); Hadid (ID: `place:Hadid`); Magbish (ID: `place:Magbish`); Nebo (ID: `place:Nebo.2`); Netophah (ID: `place:Netophah`); Harim (ID: `person:Harim.2`); Senaah (ID: `place:Senaah`); Lod (ID: `place:Lod`); Geba (ID: `place:Geba`); Ono (ID: `place:Ono`); Elam (ID: `person:Elam`); Kiriath-jearim (ID: `place:Kiriath-jearim`); Jericho (ID: `place:Jericho`); Chephirah (ID: `place:Chephirah`); Michmash (ID: `place:Michmash`); Beeroth (ID: `place:Beeroth`); Ai (ID: `place:Ai`); Anathoth (ID: `place:Anathoth`); Ramah (ID: `place:Ramah.2`); Bethlehem (ID: `place:Bethlehem`); Bethel (ID: `place:Bethel`)
...
* **Associated ACAI Concepts:** Immer (ID: `person:Immer.2`); Talmon (ID: `person:Talmon`); Harim (ID: `person:Harim`); Hodaviah (ID: `person:Hodaviah.4`); Jeshua (ID: `person:Jeshua`); Shobai (ID: `person:Shobai`); Jeshua (ID: `person:Jeshua.4`); Ater (ID: `person:Ater.2`); Hatita (ID: `person:Hatita`); Jedaiah (ID: `person:Jedaiah.4`); Pashhur (ID: `person:Pashhur`); Levi (ID: `person:Levi.3`); Kadmiel (ID: `person:Kadmiel`); Tribe of Levi (ID: `group:Levi`); Shallum (ID: `person:Shallum.8`); Akkub (ID: `person:Akkub.2`); Asaph (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** Talmon (ID: `person:Talmon`); Shobai (ID: `person:Shobai`); Ater (ID: `person:Ater.2`); Hatita (ID: `person:Hatita`); Asaph (ID: `person:Asaph.2`); Akkub (ID: `person:Akkub.2`); Shallum (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** Tabbaoth (ID: `person:Tabbaoth`); Rezin (ID: `person:Rezin.2`); Lebanah (ID: `person:Lebanah`); Nekoda (ID: `person:Nekoda`); Bakbuk (ID: `person:Bakbuk`); Meunim (ID: `group:Meunim`); Sisera (ID: `person:Sisera.2`); Nephushesim (ID: `group:Nephushesim`); Barkos (ID: `person:Barkos`); Padon (ID: `person:Padon`); Besai (ID: `person:Besai`); Keros (ID: `person:Keros`); Harhur (ID: `person:Harhur`); Gahar (ID: `person:Gahar`); Reaiah (ID: `person:Reaiah.3`); Ziha (ID: `person:Ziha`); Mehida (ID: `person:Mehida`); Shalmai (ID: `person:Shalmai`); Siaha (ID: `person:Siaha`); Hasupha (ID: `person:Hasupha`); Giddel (ID: `person:Giddel`); Harsha (ID: `person:Harsha`); Neziah (ID: `person:Neziah`); Hatipha (ID: `person:Hatipha`); Hakupha (ID: `person:Hakupha`); Bazluth (ID: `person:Bazluth`); Gazzam (ID: `person:Gazzam`); Hagabah (ID: `person:Hagabah`); Asnah (ID: `person:Asnah`); Temah (ID: `person:Temah`); Paseah (ID: `person:Paseah.2`); Akkub (ID: `person:Akkub.3`); Uzza (ID: `person:Uzza.2`); Hagab (ID: `person:Hagab`); Hanan (ID: `person:Hanan.4`)
...
* **Associated ACAI Concepts:** Solomon (ID: `person:Solomon`); Sotai (ID: `person:Sotai`); Hattil (ID: `person:Hattil`); Peruda (ID: `person:Peruda`); Shephatiah (ID: `person:Shephatiah.7`); Ami (ID: `person:Ami`); Sophereth (ID: `person:Sophereth`); Darkon (ID: `person:Darkon`); Giddel (ID: `person:Giddel.2`); Jaalah (ID: `person:Jaalah`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`)
...
* **Associated ACAI Concepts:** Tel-melah (ID: `place:Tel-melah`); Addan (ID: `place:Addan`); Delaiah (ID: `person:Delaiah.3`); Tobiah (ID: `person:Tobiah`); Cherub (ID: `place:Cherub`); Nekoda (ID: `person:Nekoda.2`); Tel-harsha (ID: `place:Tel-harsha`); Immer (ID: `place:Immer`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Habaiah (ID: `person:Habaiah`); Hakkoz (ID: `person:Hakkoz.2`); Barzillai (ID: `person:Barzillai.3`); Barzillai (ID: `person:Barzillai`); Gilead (ID: `place:Gilead`); Defile (ID: `keyterm:Stain`); Priesthood (ID: `keyterm:Priesthood`); Gileadites (ID: `group:Gilead`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zerubbabel (ID: `person:Zerubbabel.2`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); Joshua (ID: `person:Joshua.5`); Persia (ID: `place:Persia`); Cyrus (ID: `person:Cyrus`); Shealtiel (ID: `person:Shealtiel.2`); Jehozadak (ID: `person:Jehozadak`); Jerusalem (ID: `place:Jerusalem`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Relatives (ID: `group:Relatives`); Hodaviah (ID: `person:Hodaviah.4`); Esarhaddon (ID: `person:Esarhaddon`); Kadmiel (ID: `person:Kadmiel`); Jeshua (ID: `person:Jeshua.4`); Henadad (ID: `person:Henadad`); Joppa (ID: `place:Joppa`); Tyre (ID: `place:Tyre`); Kindness (ID: `keyterm:Kindness`); Appointed Feast (ID: `keyterm:AppointedFeast`); Lebanon (ID: `place:Lebanon`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Assyria (ID: `place:Assyria`); Instruction (ID: `keyterm:Instruction`); Sidonians (ID: `group:Sidon`); Counsel (ID: `keyterm:Counsel`); Sidon (ID: `place:Sidon`); Darius (ID: `person:Darius.2`); Terror (ID: `keyterm:Terror`); Asaph (ID: `person:Asaph.2`); Moses (ID: `person:Moses`); David (ID: `person:David`); Hodiah (ID: `person:Hodiah.2`); Holy (ID: `keyterm:Holy`); Benjamin (ID: `person:Benjamin`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Tyrians (ID: `group:Tyre`); Tribe of Benjamin (ID: `group:Benjamin`); Trumpet (ID: `realia:Trumpet`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Cymbals (ID: `realia:Cymbals`); Craftsman (ID: `realia:Craftsman`)
...
* **Associated ACAI Concepts:** Joshua (ID: `person:Joshua.5`); Shealtiel (ID: `person:Shealtiel.2`); Jehozadak (ID: `person:Jehozadak`); Zerubbabel (ID: `person:Zerubbabel.2`); Offering (ID: `keyterm:Offering`); Moses (ID: `person:Moses`); Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** Sidonians (ID: `group:Sidon`); Joppa (ID: `place:Joppa`); Tyre (ID: `place:Tyre`); Lebanon (ID: `place:Lebanon`); Tyrians (ID: `group:Tyre`); Persia (ID: `place:Persia`); Sidon (ID: `place:Sidon`); Cyrus (ID: `person:Cyrus`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Craftsman (ID: `realia:Craftsman`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Joshua (ID: `person:Joshua.5`); Shealtiel (ID: `person:Shealtiel.2`); Levi (ID: `person:Levi.3`); Jehozadak (ID: `person:Jehozadak`); Zerubbabel (ID: `person:Zerubbabel.2`); Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Tribe of Levi (ID: `group:Levi`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); Kindness (ID: `keyterm:Kindness`); Tribe of Levi (ID: `group:Levi`); David (ID: `person:David`); Asaph (ID: `person:Asaph.2`); Trumpet (ID: `realia:Trumpet`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** Benjamin (ID: `person:Benjamin`); Tribe of Judah (ID: `group:Judah`); Israel (ID: `person:Israel`); Tribe of Benjamin (ID: `group:Benjamin`); LORD (ID: `deity:Lord`); Judah (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Joshua (ID: `person:Joshua.5`); Zerubbabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Persia (ID: `place:Persia`); Cyrus (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Euphrates River (ID: `place:Euphrates`); Jerusalem (ID: `place:Jerusalem`); Shimshai (ID: `person:Shimshai`); Rehum (ID: `person:Rehum.2`); Artaxerxes (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Persia (ID: `place:Persia`); Samaria (ID: `place:Samaria`); Bishlam (ID: `person:Bishlam`); Babylonians (ID: `group:Babylon`); Ahasuerus (ID: `person:Ahasuerus`); Osnappar (ID: `person:Osnappar`); Mithredath (ID: `person:Mithredath.2`); Tabeel (ID: `person:Tabeel`); Dinaite (ID: `person:Dinaite`); Erech (ID: `place:Erech`); Elamites (ID: `group:Elam`); Elam (ID: `place:Elam`); Persians (ID: `group:Persia`); Susa (ID: `place:Susa`); Tribe of Judah (ID: `group:Judah`); Babylon (ID: `place:Babylon`); Judah (ID: `person:Judah.4`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Babylonians (ID: `group:Babylon`); Rehum (ID: `person:Rehum.2`); Shimshai (ID: `person:Shimshai`); Dinaite (ID: `person:Dinaite`); Erech (ID: `place:Erech`); Elamites (ID: `group:Elam`); Babylon (ID: `place:Babylon`); Susa (ID: `place:Susa`); Persians (ID: `group:Persia`); Persia (ID: `place:Persia`); Elam (ID: `place:Elam`)
...
* **Associated ACAI Concepts:** Euphrates River (ID: `place:Euphrates`); Jerusalem (ID: `place:Jerusalem`); Samaria (ID: `place:Samaria`); Rehum (ID: `person:Rehum.2`); Jews (ID: `group:Jews`); Shimshai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Rehum (ID: `person:Rehum.2`); Shimshai (ID: `person:Shimshai`); Jews (ID: `group:Jews`); Jerusalem (ID: `place:Jerusalem`); Artaxerxes (ID: `person:Artaxerxes.2`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); Darius (ID: `person:Darius.2`); Iddo (ID: `person:Iddo.6`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Zechariah (ID: `person:Zechariah.17`); Haggai (ID: `person:Haggai`); Tattenai (ID: `person:Tattenai`); Joshua (ID: `person:Joshua.5`); Shealtiel (ID: `person:Shealtiel.2`); Jehozadak (ID: `person:Jehozadak`); Zerubbabel (ID: `person:Zerubbabel.2`); Euphrates River (ID: `place:Euphrates`); Israel (ID: `person:Israel`); Judah (ID: `person:Judah.4`); Persia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Iddo (ID: `person:Iddo.6`); Zechariah (ID: `person:Zechariah.17`); Haggai (ID: `person:Haggai`); Jews (ID: `group:Jews`); Israel (ID: `person:Israel`); Jerusalem (ID: `place:Jerusalem`); Judah (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Joshua (ID: `person:Joshua.5`); Shealtiel (ID: `person:Shealtiel.2`); Jehozadak (ID: `person:Jehozadak`); Zerubbabel (ID: `person:Zerubbabel.2`); Jerusalem (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Babylon (ID: `place:Babylon`); Jerusalem (ID: `place:Jerusalem`); Cyrus (ID: `person:Cyrus`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Zerubbabel (ID: `person:Zerubbabel.2`); Darius (ID: `person:Darius.2`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Tattenai (ID: `person:Tattenai`); Chaldea (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); Israel (ID: `person:Israel`); Euphrates River (ID: `place:Euphrates`); Judah (ID: `person:Judah.4`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Zerubbabel (ID: `person:Zerubbabel.2`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Babylon (ID: `place:Babylon`); Cyrus (ID: `person:Cyrus`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Seraiah (ID: `person:Seraiah.2`); Ezra (ID: `person:Ezra`); Azariah (ID: `person:Azariah.7`); Artaxerxes (ID: `person:Artaxerxes`); Hilkiah (ID: `person:Hilkiah.2`); Persia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Ahitub (ID: `person:Ahitub.3`); Azariah (ID: `person:Azariah.7`); Meraioth (ID: `person:Meraioth`); Seraiah (ID: `person:Seraiah.2`); Bukki (ID: `person:Bukki.2`); Uzzi (ID: `person:Uzzi`); Abishua (ID: `person:Abishua`); Azariah (ID: `person:Azariah.6`); Shallum (ID: `person:Shallum.7`); Amariah (ID: `person:Amariah.2`); Zerahiah (ID: `person:Zerahiah`); Zadok (ID: `person:Zadok.4`); Phinehas (ID: `person:Phinehas`); Hilkiah (ID: `person:Hilkiah.2`); Aaron (ID: `person:Aaron`); Persia (ID: `place:Persia`); Artaxerxes (ID: `person:Artaxerxes`); Eleazar (ID: `person:Eleazar.2`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Moses (ID: `person:Moses`); Babylon (ID: `place:Babylon`); Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Decree (ID: `keyterm:Decree`); Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); Artaxerxes (ID: `person:Artaxerxes`); Euphrates River (ID: `place:Euphrates`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); Decree (ID: `keyterm:Decree`); Babylon (ID: `place:Babylon`); LORD (ID: `deity:Lord`); Judah (ID: `person:Judah.4`); Wheat (ID: `flora:Wheat`); Altar (ID: `realia:Altar`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Talent (ID: `realia:Talent`); Kor (ID: `realia:Kor`); Stone Altar (ID: `realia:StoneAltar`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Artaxerxes (ID: `person:Artaxerxes`); Ezra (ID: `person:Ezra`); Euphrates River (ID: `place:Euphrates`); Money (ID: `realia:Money`); Kor (ID: `realia:Kor`); Wheat (ID: `flora:Wheat`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Hakkatan (ID: `person:Hakkatan`); Athaliah (ID: `person:Athaliah.3`); Bebai (ID: `person:Bebai`); Uthai (ID: `person:Uthai.2`); Michael (ID: `person:Michael.10`); Eliehoenai (ID: `person:Eliehoenai.2`); Jehiel (ID: `person:Jehiel.7`); Daniel (ID: `person:Daniel.2`); Jeuel (ID: `person:Jeuel.3`); Joab (ID: `person:Joab.4`); Jonathan (ID: `person:Jonathan.9`); Obadiah (ID: `person:Obadiah.10`); Elam (ID: `person:Elam`); Shecaniah (ID: `person:Shecaniah.5`); Adin (ID: `person:Adin`); Bebai (ID: `person:Bebai.2`); Johanan (ID: `person:Johanan.8`); Zerahiah (ID: `person:Zerahiah.2`); Josiphiah (ID: `person:Josiphiah`); Zaccur (ID: `person:Zaccur.5`); Shecaniah (ID: `person:Shecaniah.6`); Zechariah (ID: `person:Zechariah.18`); Ebed (ID: `person:Ebed.2`); Zebadiah (ID: `person:Zebadiah.8`); Jahaziel (ID: `person:Jahaziel.5`); Jeshaiah (ID: `person:Jeshaiah.4`); Zechariah (ID: `person:Zechariah.19`); Shephatiah (ID: `person:Shephatiah.6`); Parosh (ID: `person:Parosh.2`); Azgad (ID: `person:Azgad`); Shelomith (ID: `person:Shelomith.4`); Adonikam (ID: `person:Adonikam`); Gershom (ID: `person:Gershom.2`); Bigvai (ID: `person:Bigvai.2`); Hattush (ID: `person:Hattush.2`); Pahath-moab (ID: `person:Pahath-moab`); Shemaiah (ID: `person:Shemaiah.14`); Eliphelet (ID: `person:Eliphelet.5`); Phinehas (ID: `person:Phinehas`); Ithamar (ID: `person:Ithamar`); Artaxerxes (ID: `person:Artaxerxes`); David (ID: `person:David`); Babylon (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** Jarib (ID: `person:Jarib.2`); Zechariah (ID: `person:Zechariah.20`); Shemaiah (ID: `person:Shemaiah.15`); Joiarib (ID: `person:Joiarib.2`); Elnathan (ID: `person:Elnathan.2`); Casiphia (ID: `place:Casiphia`); Meshullam (ID: `person:Meshullam.9`); Nathan (ID: `person:Nathan.5`); Ariel (ID: `person:Ariel`); Iddo (ID: `person:Iddo`); Elnathan (ID: `person:Elnathan.4`); Eliezer (ID: `person:Eliezer.8`); Elnathan (ID: `person:Elnathan.3`); Perceive (ID: `keyterm:Perceive`); LORD (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Sherebiah (ID: `person:Sherebiah`); Levi (ID: `person:Levi.3`); Insight (ID: `keyterm:Insight`); Israel (ID: `person:Israel`); Mahli (ID: `person:Mahli`); LORD (ID: `deity:Lord`); Tribe of Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Tribe of Levi (ID: `group:Levi`); Work (ID: `keyterm:Work`); Levi (ID: `person:Levi.3`); David (ID: `person:David`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); Levi (ID: `person:Levi.3`); Ammon (ID: `place:Ammon`); Egypt (ID: `place:Egypt`); Tribe of Levi (ID: `group:Levi`); Canaan (ID: `place:Canaan`); Ammonites (ID: `group:Ammon`); Israel (ID: `person:Israel`); Heth (ID: `person:Heth`); Moab (ID: `place:Moab`); Amorites (ID: `group:Amorites`); Be Unfaithful (ID: `keyterm:Unfaithful`); Jebusites (ID: `group:Jebusites`); Canaanites (ID: `group:Canaan`); Egyptians (ID: `group:Egypt`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); Passion (ID: `keyterm:Ardour`); Jerusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Harim (ID: `person:Harim`); Elam (ID: `person:Elam`); Offering (ID: `keyterm:Offering`); Tribe of Judah (ID: `group:Judah`); Counsel (ID: `keyterm:Counsel`); Judah (ID: `person:Judah.4`); Benaiah (ID: `person:Benaiah.8`); Jaddai (ID: `person:Jaddai`); Joel (ID: `person:Joel.12`); Parosh (ID: `person:Parosh`); Shimei (ID: `person:Shimei.15`); Jozabad (ID: `person:Jozabad.7`); Eliashib (ID: `person:Eliashib.5`); Jehohanan (ID: `person:Jehohanan.4`); Mattattah (ID: `person:Mattattah`); Machnadebai (ID: `person:Machnadebai`); Ishmael (ID: `person:Ishmael.6`); Shallum (ID: `person:Shallum.10`); Aziza (ID: `person:Aziza`); Malluch (ID: `person:Malluch.3`); Shemariah (ID: `person:Shemariah.4`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); Judea (ID: `place:Judea`); Kindness (ID: `keyterm:Kindness`); To Cause to Possess (ID: `keyterm:Possess`); Peace (ID: `keyterm:IntactState`); Defilement (ID: `keyterm:Defilement`); Plea for Mercy (ID: `keyterm:Supplication`); Israel (ID: `person:Israel`); Jerusalem (ID: `place:Jerusalem`); Persia (ID: `place:Persia`); Dispossess (ID: `keyterm:Dispossess`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Judea (ID: `place:Judea`); Persia (ID: `place:Persia`); Kindness (ID: `keyterm:Kindness`); Plea for Mercy (ID: `keyterm:Supplication`); Jerusalem (ID: `place:Jerusalem`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** Shecaniah (ID: `person:Shecaniah.7`); Jehiel (ID: `person:Jehiel.8`); Elam (ID: `person:Elam`); Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); Be Unfaithful (ID: `keyterm:Unfaithful`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); Ezra (ID: `person:Ezra`); Tribe of Levi (ID: `group:Levi`); Israel (ID: `person:Israel`); Swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** Benjamin (ID: `person:Benjamin`); Tribe of Judah (ID: `group:Judah`); Tribe of Benjamin (ID: `group:Benjamin`); Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Judah (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Tikvah (ID: `person:Tikvah.2`); Asahel (ID: `person:Asahel.4`); Shabbethai (ID: `person:Shabbethai`); Meshullam (ID: `person:Meshullam.10`); Jahzeiah (ID: `person:Jahzeiah`); Jonathan (ID: `person:Jonathan.10`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`)
