...
* **Associated ACAI Concepts:** mischief (ID: `keyterm:Mischief`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Casting Net (ID: `realia:CastingNet`); pure (ID: `keyterm:Pure`); holy (ID: `keyterm:Holy`); SENHOR (ID: `deity:Lord`); Fortification (ID: `realia:Fortification`); Harpoon (ID: `realia:Harpoon`); Monitor (ID: `fauna:Iguana`); Lizard (ID: `fauna:Lizard`); Fish (ID: `fauna:Fish`); Chameleon (ID: `fauna:Chameleon`)
...
* **Associated ACAI Concepts:** Hell (ID: `place:Hell`); SENHOR (ID: `deity:Lord`); Tablet (ID: `realia:Tablet`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); literally: nought (ID: `keyterm:Idol`); Be Disgraced (ID: `keyterm:Disgraced`); saying (ID: `keyterm:Saying`); Hell (ID: `place:Hell`); Libano (ID: `place:Lebanon`); lean on (ID: `keyterm:LeanOn`); Money (ID: `realia:Money`); Tablet (ID: `realia:Tablet`); Image (ID: `realia:Image`); Molten Image (ID: `realia:MoltenImage`); Graven Image (ID: `realia:GravenImage`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Beam (ID: `realia:Beam`)
...
* **Associated ACAI Concepts:** Be Disgraced (ID: `keyterm:Disgraced`); Glory (ID: `keyterm:Glory`); SENHOR (ID: `deity:Lord`); Woe (ID: `keyterm:Woe.2`); Libano (ID: `place:Lebanon`)
...
* **Associated ACAI Concepts:** literally: nought (ID: `keyterm:Idol`); Woe (ID: `keyterm:Woe.2`); SENHOR (ID: `deity:Lord`); lean on (ID: `keyterm:LeanOn`); Money (ID: `realia:Money`); Image (ID: `realia:Image`); Molten Image (ID: `realia:MoltenImage`); Graven Image (ID: `realia:GravenImage`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); Monte Paran (ID: `place:ParanMount`); Habacuque (ID: `person:Habakkuk`); Temã (ID: `place:Teman`); Cusã (ID: `place:Cushan`); anointed (ID: `keyterm:Anointed`); mischief (ID: `keyterm:Mischief`); majesty (ID: `keyterm:Majesty`); arrow (ID: `keyterm:Arrow`); fear (ID: `keyterm:Fear`); holy (ID: `keyterm:Holy`); Midiã (ID: `place:Midian`); Oath (ID: `keyterm:Oath`); Deer (ID: `fauna:Deer`); Bow (ID: `realia:Bow`); Flock (ID: `fauna:Flock`); Sheepfold (ID: `realia:Sheepfold`); Tent (ID: `realia:Tent`); Vine (ID: `flora:Vine`); Chariot (ID: `realia:Chariot`); Olive Tree (ID: `flora:OliveTree`); Fig (ID: `flora:Fig`); Goat (ID: `fauna:Goat`); Spear (ID: `realia:Spear`); Cattle (ID: `fauna:Bull`); Foundation (ID: `realia:Foundation`); Animal Pen (ID: `realia:AnimalPen`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); Monte Paran (ID: `place:ParanMount`); Temã (ID: `place:Teman`); Cusã (ID: `place:Cushan`); anointed (ID: `keyterm:Anointed`); mischief (ID: `keyterm:Mischief`); majesty (ID: `keyterm:Majesty`); SENHOR (ID: `deity:Lord`); arrow (ID: `keyterm:Arrow`); holy (ID: `keyterm:Holy`); Midiã (ID: `place:Midian`); Oath (ID: `keyterm:Oath`); Bow (ID: `realia:Bow`); Tent (ID: `realia:Tent`); Chariot (ID: `realia:Chariot`); Spear (ID: `realia:Spear`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); arrow (ID: `keyterm:Arrow`); Oath (ID: `keyterm:Oath`); anointed (ID: `keyterm:Anointed`); SENHOR (ID: `deity:Lord`); Bow (ID: `realia:Bow`); Chariot (ID: `realia:Chariot`); Foundation (ID: `realia:Foundation`); Spear (ID: `realia:Spear`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); salvation (ID: `keyterm:Salvation`); Flock (ID: `fauna:Flock`); Fig (ID: `flora:Fig`); Animal Pen (ID: `realia:AnimalPen`); Sheepfold (ID: `realia:Sheepfold`); Goat (ID: `fauna:Goat`); Olive Tree (ID: `flora:OliveTree`); Cattle (ID: `fauna:Bull`); Vine (ID: `flora:Vine`)
