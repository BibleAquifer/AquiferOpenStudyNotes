...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); bien, aimé (ID: `keyterm:Beloved`); vérité (ID: `keyterm:Truth`); Éternel (ID: `deity:Lord`); église (ID: `keyterm:Church`); fidelité (ID: `keyterm:Faithfulness`); sois obligé (ID: `keyterm:Ought`); nom (ID: `keyterm:Name`); témoigner (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** église (ID: `keyterm:Church`); Diotrèphe (ID: `person:Diotrephes`); Démétrius (ID: `person:Demetrius`); le bien (ID: `keyterm:Good`); bien, aimé (ID: `keyterm:Beloved`); vrai (ID: `keyterm:True`); Éternel (ID: `deity:Lord`); vérité (ID: `keyterm:Truth`); faire du bien (ID: `keyterm:DoGood`); témoigner (ID: `keyterm:BearWitness`)
