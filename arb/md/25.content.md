...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); Strength (ID: `keyterm:Strength`); Love (ID: `keyterm:Love`); يَهوذَا (ID: `person:Judah.4`); إِسْرَائِيلَ (ID: `person:Israel`); Defilement (ID: `keyterm:Defilement`); Appointed Feast (ID: `keyterm:AppointedFeast`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Mighty One (ID: `keyterm:MightyOne`); To Sin (ID: `keyterm:Sin`); Work (ID: `keyterm:Work`); Deceit (ID: `keyterm:Deceit`); Train (ID: `realia:Train`); Winepress (ID: `realia:Winepress`); Grass (ID: `flora:Grass`); Yoke (ID: `realia:Yoke`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Casting Net (ID: `realia:CastingNet`); Net (ID: `realia:Net`); Deer (ID: `fauna:Deer`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); To Sin (ID: `keyterm:Sin`); Defilement (ID: `keyterm:Defilement`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Rebel (ID: `keyterm:Rebel`); ٱلرَّبِّ (ID: `deity:Lord`); Strength (ID: `keyterm:Strength`); Yoke (ID: `realia:Yoke`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Appointed Feast (ID: `keyterm:AppointedFeast`); يَهوذَا (ID: `group:Judah`); Horn (ID: `keyterm:Horn`); يَهوذَا (ID: `person:Judah.4`); Sheep (ID: `fauna:Lamb`); Utterance (ID: `keyterm:Utterance`); To Dishonor (ID: `keyterm:Dishonor`); Instruction (ID: `keyterm:Instruction`); Sabbath (ID: `keyterm:Sabbath`); Gentiles (ID: `group:Gentile`); Have a Vision (ID: `keyterm:HaveAVision`); Passion (ID: `keyterm:Ardour`); Altar (ID: `realia:Altar`); Sackcloth (ID: `realia:Sackcloth`); House (ID: `realia:House`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Bow (ID: `realia:Bow`); Tent (ID: `realia:Tent`); Stone Altar (ID: `realia:StoneAltar`); Measuring Reed (ID: `realia:MeasuringReed`); Grain (ID: `flora:Grain`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Appointed Feast (ID: `keyterm:AppointedFeast`); ٱلرَّبِّ (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); House (ID: `realia:House`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Arrow (ID: `realia:Arrow`); Wormwood (ID: `flora:Wormwood`); Peace (ID: `keyterm:IntactState`); Complete (ID: `keyterm:Complete`); Kindness (ID: `keyterm:Kindness`); Arrow (ID: `keyterm:Arrow`); Bear (ID: `fauna:Bear`); Hewn Stone (ID: `realia:HewnStone`); Bow (ID: `realia:Bow`); Bitter Herbs (ID: `flora:Chicory`); Lion (ID: `fauna:Lion`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Complete (ID: `keyterm:Complete`); Hope (ID: `keyterm:Hope`); Salvation (ID: `keyterm:Salvation`); Peace (ID: `keyterm:IntactState`); Fear (ID: `keyterm:Fear`); Rebel (ID: `keyterm:Rebel`); Forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); Redeem (ID: `keyterm:Redeem`); Arrow (ID: `keyterm:Arrow`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Arrow (ID: `realia:Arrow`); Wormwood (ID: `flora:Wormwood`); Pit (ID: `realia:Pit`); Bear (ID: `fauna:Bear`); Bird (ID: `fauna:Bird`); Hewn Stone (ID: `realia:HewnStone`); Yoke (ID: `realia:Yoke`); Lion (ID: `fauna:Lion`); Bow (ID: `realia:Bow`); Bitter Herbs (ID: `flora:Chicory`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); أَدومَ (ID: `place:Edom`); To Sin (ID: `keyterm:Sin`); عوصًا (ID: `place:Uz`); Defile (ID: `keyterm:Stain`); Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); Defilement (ID: `keyterm:Defilement`); Punishment (ID: `keyterm:Punishment`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Anointed (ID: `keyterm:Anointed`); Believe In (ID: `keyterm:BelieveIn`); سَدومَ (ID: `place:Sodom`); Ostrich (ID: `fauna:Ostrich`); Jackal (ID: `fauna:Jackal`); Purple Cloth (ID: `realia:PurpleCloth`); Vulture (ID: `fauna:Vulture`); Clay Jar (ID: `realia:ClayJar`)
...
* **Associated ACAI Concepts:** أَدومَ (ID: `place:Edom`); عوصًا (ID: `place:Uz`); Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); To Sin (ID: `keyterm:Sin`); Passion (ID: `keyterm:Ardour`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); أَدومَ (ID: `place:Edom`); To Sin (ID: `keyterm:Sin`); Passion (ID: `keyterm:Ardour`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); أورشَلِيمَ (ID: `place:Jerusalem`); Woe (ID: `keyterm:Woe`); Round Dance (ID: `keyterm:RoundDance`); يَهوذَا (ID: `person:Judah.4`); To Cause to Possess (ID: `keyterm:Possess`); يَهوذَا (ID: `group:Judah`); Passion (ID: `keyterm:Ardour`); مِصْرَ (ID: `place:Egypt`); Assyria (ID: `place:Assyria`); Hand-Mill (ID: `realia:Hand-mill`); Crown (ID: `realia:Crown`); Jackal (ID: `fauna:Jackal`); House (ID: `realia:House`); Money (ID: `realia:Money`)
