...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Áfia (ID: `person:Apphia`); Arquipo (ID: `person:Archippus`); Filemom (ID: `person:Philemon`); Paulo (ID: `person:Paul`); fazer a paz (ID: `keyterm:Peace`); amado (ID: `keyterm:Beloved`); favor (ID: `keyterm:Favor`); Timóteo (ID: `person:Timothy`); SENHOR (ID: `deity:Lord`); igreja (ID: `keyterm:Church`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** holy (ID: `keyterm:Holy`); Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`); orar (ID: `keyterm:Pray`); comunhão (ID: `keyterm:Fellowship`); rogar (ID: `keyterm:AskFor`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); compaixão (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Paulo (ID: `person:Paul`); love (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`); em cristo (ID: `keyterm:InChrist`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Lucas (ID: `person:Luke`); Demas (ID: `person:Demas`); Epafras (ID: `person:Epaphras`); favor (ID: `keyterm:Favor`); em cristo (ID: `keyterm:InChrist`); Spirit (ID: `keyterm:Spirit.2`); Marcos (ID: `person:Mark`); Aristarco (ID: `person:Aristarchus`)
