...
* **Associated ACAI Concepts:** tahan uji (ID: `keyterm:Approved`); berbahagialah (ID: `keyterm:Happy`); janji (ID: `keyterm:Promise`); kehidupan (ID: `keyterm:Life`); kasihi (ID: `keyterm:Love`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); mencobai (ID: `keyterm:PutToTheTest`); berbahagialah (ID: `keyterm:Happy`); kekasih (ID: `keyterm:Beloved`); tahan uji (ID: `keyterm:Approved`); suci (ID: `keyterm:Clean`); sia, sia (ID: `keyterm:Worthless`); tidak dapat dicobai (ID: `keyterm:NotTempted`); kehidupan (ID: `keyterm:Life`); kebenaran (ID: `keyterm:Truth`); janji (ID: `keyterm:Promise`); yang baik (ID: `keyterm:Good`); tidak dicemarkan (ID: `keyterm:Undefiled`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); keselamatan (ID: `keyterm:Salvation`); kasihi (ID: `keyterm:Love`); hukum (ID: `keyterm:Law`); A Person (ID: `person:GenericPerson`); tak bernoda (ID: `keyterm:AboveCriticism`); berbuat dosa (ID: `keyterm:Sin`); hati (ID: `keyterm:Heart`); keahlian (ID: `keyterm:Ability`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** suci (ID: `keyterm:Clean`); sia, sia (ID: `keyterm:Worthless`); hati (ID: `keyterm:Heart`); Tuhan (ID: `deity:Lord`); keahlian (ID: `keyterm:Ability`); tak bernoda (ID: `keyterm:AboveCriticism`); tidak dicemarkan (ID: `keyterm:Undefiled`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); tonton bulu atau muka (ID: `keyterm:Partiality`); Yesus (ID: `person:Jesus.2`); bimbang (ID: `keyterm:Discern`); kemuliaan (ID: `keyterm:Glory`); percaya (ID: `keyterm:Believe`); Synagogue (ID: `realia:Synagogue`); Footstool (ID: `realia:Footstool`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** janji (ID: `keyterm:Promise`); Tuhan (ID: `deity:Lord`); keahlian (ID: `keyterm:Ability`); kerajaan (ID: `keyterm:Kingdom`); orang pilihan (ID: `keyterm:Chosen`); kasihi (ID: `keyterm:Love`); kekasih (ID: `keyterm:Beloved`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); penghakiman (ID: `keyterm:Judgment`); tonton bulu atau muka (ID: `keyterm:Partiality`); tersandung (ID: `keyterm:Stumble`); memutuskan (ID: `keyterm:Decided`); kitab suci (ID: `keyterm:Scripture`); berbuat dosa (ID: `keyterm:Sin`); belas kasihan (ID: `keyterm:Mercy`); persundalan (ID: `keyterm:Fornication`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`); kasihi (ID: `keyterm:Love`); pengadilan (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Tuhan (ID: `deity:Lord`); Abraham (ID: `person:Abraham`); A Person (ID: `person:GenericPerson`); tubuh (ID: `keyterm:Body.3`); Rahab (ID: `person:Rahab`); sia, sia (ID: `keyterm:Idle`); menggenapi (ID: `keyterm:Happen`); kitab suci (ID: `keyterm:Scripture`); keselamatan (ID: `keyterm:Salvation`); Demons (ID: `deity:Demons`); memperdamaikan (ID: `keyterm:Peace`); Ishak (ID: `person:Isaac`); An Angel (ID: `deity:Angel`); roh (ID: `keyterm:Spirit.2`); hampa (ID: `keyterm:Empty`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); Rahab (ID: `person:Rahab`); sia, sia (ID: `keyterm:Idle`); tubuh (ID: `keyterm:Body.3`); menggenapi (ID: `keyterm:Happen`); kitab suci (ID: `keyterm:Scripture`); Tuhan (ID: `deity:Lord`); Ishak (ID: `person:Isaac`); An Angel (ID: `deity:Angel`); roh (ID: `keyterm:Spirit.2`); hampa (ID: `keyterm:Empty`)
...
* **Associated ACAI Concepts:** menggenapi (ID: `keyterm:Happen`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kitab suci (ID: `keyterm:Scripture`); Tuhan (ID: `deity:Lord`); Abraham (ID: `person:Abraham`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** neraka (ID: `keyterm:Gehenna`); keahlian (ID: `keyterm:Ability`); lalim (ID: `keyterm:UnjustDeed`); Hell (ID: `place:Hell`); tubuh (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); tidak setia (ID: `keyterm:Unfaithful`); persahabatan (ID: `keyterm:Friendship`); ingin (ID: `keyterm:LongFor`); kitab suci (ID: `keyterm:Scripture`); keahlian (ID: `keyterm:Ability`); hati (ID: `keyterm:Heart`); murni (ID: `keyterm:Pure`); kebaikan (ID: `keyterm:Favor`); roh (ID: `keyterm:Spirit.2`); Cause of Joy (ID: `keyterm:CauseOfJoy`); membersihkan (ID: `keyterm:Cleanse.2`); Roh (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** ingin (ID: `keyterm:LongFor`); roh (ID: `keyterm:Spirit.2`); kitab suci (ID: `keyterm:Scripture`); Roh (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** bersaksi (ID: `keyterm:BearWitness`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); hati (ID: `keyterm:Heart`); Tuhan (ID: `deity:Lord`); tubuh (ID: `keyterm:Body.3`); menentang (ID: `keyterm:Condemn`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** penyayang (ID: `keyterm:Compassionate`); Ayub (ID: `person:Job`); Tuhan (ID: `deity:Lord`); menyebut berbahagia (ID: `keyterm:RegardAsHappy`); penuh belas kasihan (ID: `keyterm:FullOfCompassion`)
...
* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); jemaat (ID: `keyterm:Church`); diurapi (ID: `keyterm:Anointed`); Tuhan (ID: `deity:Lord`); nama (ID: `keyterm:Name`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); berbuat dosa (ID: `keyterm:Sin`); mengampuni (ID: `keyterm:Forgive`); Tuhan (ID: `deity:Lord`); keselamatan (ID: `keyterm:Salvation`); percaya (ID: `keyterm:Believe`)
