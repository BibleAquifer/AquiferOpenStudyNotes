...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); Fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); Vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); نِينَوَى (ID: `place:Nineveh`); أَمِتَّايَ (ID: `person:Amittai`); يَافَا (ID: `place:Joppa`); Praise (ID: `keyterm:Praise`); Kindness (ID: `keyterm:Kindness`); Exempt (ID: `keyterm:Exempt`); تَرْشِيشَ (ID: `place:Tarshish`); Slaughtering (ID: `keyterm:Slaughtering`); Salvation (ID: `keyterm:Salvation`); Lot (ID: `keyterm:Lot`); Hebrews (ID: `group:Hebrews`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Hell (ID: `place:Hell`); Vow (ID: `keyterm:Vow`); Praise (ID: `keyterm:Praise`); Kindness (ID: `keyterm:Kindness`); يونَانَ (ID: `person:Jonah.2`); Salvation (ID: `keyterm:Salvation`); Cattails (ID: `flora:Cattails`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** Vow (ID: `keyterm:Vow`); ٱلرَّبِّ (ID: `deity:Lord`); Praise (ID: `keyterm:Praise`); Kindness (ID: `keyterm:Kindness`); Salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); نِينَوَى (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Compassionate (ID: `keyterm:Compassionate`); Kindness (ID: `keyterm:Kindness`); Generous (ID: `keyterm:Generous`); تَرْشِيشَ (ID: `place:Tarshish`); Believe In (ID: `keyterm:BelieveIn`); Clothing (ID: `realia:Clothing`); Flock (ID: `fauna:Flock`); Throne (ID: `realia:Throne`); Goat (ID: `fauna:Goat`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); Compassionate (ID: `keyterm:Compassionate`); Kindness (ID: `keyterm:Kindness`); Generous (ID: `keyterm:Generous`); تَرْشِيشَ (ID: `place:Tarshish`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Compassionate (ID: `keyterm:Compassionate`); Kindness (ID: `keyterm:Kindness`); Generous (ID: `keyterm:Generous`); تَرْشِيشَ (ID: `place:Tarshish`)
