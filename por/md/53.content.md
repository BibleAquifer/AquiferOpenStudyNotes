...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Tessalônica (ID: `place:Thessalonica`); fazer a paz (ID: `keyterm:Peace`); Paulo (ID: `person:Paul`); Thessalonians (ID: `group:Thessalonica`); igreja (ID: `keyterm:Church`); favor (ID: `keyterm:Favor`); Silas (ID: `person:Silas`); Timóteo (ID: `person:Timothy`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); be (or show oneself) just (ID: `keyterm:Just`); Glory (ID: `keyterm:Glory`); igreja (ID: `keyterm:Church`); céu (ID: `keyterm:Heaven`); dever (ID: `keyterm:Ought`); testemunhar (ID: `keyterm:BearWitness`); tribunal de justiça (ID: `keyterm:CourtCase`); An Angel (ID: `deity:Angel`); fazer justiça (ID: `keyterm:GrantJustice`); holy (ID: `keyterm:Holy`); Ability (ID: `keyterm:Ability`); reino (ID: `keyterm:Kingdom`); love (ID: `keyterm:Love`); boa notícia (ID: `keyterm:GoodNews`); juízo (ID: `keyterm:Judgment`); ser glorificado (ID: `keyterm:Glorified`); para a eternidade (ID: `keyterm:Always`)
...
* **Associated ACAI Concepts:** reino (ID: `keyterm:Kingdom`); juízo (ID: `keyterm:Judgment`); tribunal de justiça (ID: `keyterm:CourtCase`); be (or show oneself) just (ID: `keyterm:Just`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** To Cause to Happen (ID: `keyterm:Happen`); crer (ID: `keyterm:Believe`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Name (ID: `keyterm:Name`); ser glorificado (ID: `keyterm:Glorified`); favor (ID: `keyterm:Favor`); To Cause to Happen (ID: `keyterm:Happen`); crer (ID: `keyterm:Believe`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); ser glorificado (ID: `keyterm:Glorified`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); Truth (ID: `keyterm:Truth`); Spirit (ID: `keyterm:Spirit.2`); SENHOR (ID: `deity:Lord`); example (ID: `keyterm:Example`); salvation (ID: `keyterm:Salvation`); decidir (ID: `keyterm:Decided`); Satanás (ID: `deity:Satan`); rogar (ID: `keyterm:AskFor`); love (ID: `keyterm:Love`); objeto de culto (ID: `keyterm:ObjectOfWorship`); maravilha (ID: `keyterm:Portent`); Ability (ID: `keyterm:Ability`); wipe (out), destroy (ID: `keyterm:Destroy`); injustiça (ID: `keyterm:UnjustDeed`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** example (ID: `keyterm:Example`); Ability (ID: `keyterm:Ability`); maravilha (ID: `keyterm:Portent`); Satanás (ID: `deity:Satan`)
...
* **Associated ACAI Concepts:** hope (ID: `keyterm:Hope`); rogar (ID: `keyterm:AskFor`); love (ID: `keyterm:Love`); favor (ID: `keyterm:Favor`); para a eternidade (ID: `keyterm:Always`); Good (ID: `keyterm:Good`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); persuadir (ID: `keyterm:Persuade`); livrar (ID: `keyterm:Deliver`); Glory (ID: `keyterm:Glory`); love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`); orar (ID: `keyterm:Pray`); Faithfulness (ID: `keyterm:Faithfulness`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); autoridade (ID: `keyterm:Authority.2`); Name (ID: `keyterm:Name`); rogar (ID: `keyterm:AskFor`); tradição (ID: `keyterm:Teaching`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); Ability (ID: `keyterm:Ability`)
