...
* **Associated ACAI Concepts:** Peace (ID: `keyterm:IntactState`); Covenant (ID: `keyterm:Covenant`); أَدومَ (ID: `place:Edom`); Understanding (ID: `keyterm:Understanding`); Edomites (ID: `group:Edom`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Lot (ID: `keyterm:Lot`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); يوسف (ID: `person:Joseph.10`); أَدومَ (ID: `place:Edom`); Dispossess (ID: `keyterm:Dispossess`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** يوسف (ID: `person:Joseph.10`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); أَدومَ (ID: `place:Edom`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); ٱلْجَنوبِ (ID: `place:Negeb`); ٱلسَّهْلِ (ID: `place:Shephelah`); بَنْيَامِينَ (ID: `group:Benjamin`); أورشَلِيمَ (ID: `place:Jerusalem`); فِلِشْتِيم (ID: `group:Philistine`); ٱلسَّامِرَةِ (ID: `place:Samaria`); إِسْرَائِيلَ (ID: `person:Israel`); Canaanites (ID: `group:Canaan`); بَنْيَامِينَ (ID: `person:Benjamin`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); سَارْدِسَ (ID: `place:Sardis`); إِلَى (ID: `place:Zarephath`); جِلْعَادَ (ID: `place:Gilead`); كَنْعَان (ID: `place:Canaan`); أَفْرَايِمَ (ID: `group:Ephraim`); عِيسو (ID: `place:EsauMount`); أَفْرَايِمَ (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْجَنوبِ (ID: `place:Negeb`); عِيسو (ID: `place:EsauMount`); بَنْيَامِينَ (ID: `group:Benjamin`); فِلِشْتِيم (ID: `group:Philistine`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلسَّامِرَةِ (ID: `place:Samaria`); ٱلسَّهْلِ (ID: `place:Shephelah`); جِلْعَادَ (ID: `place:Gilead`); كَنْعَان (ID: `place:Canaan`); أَفْرَايِمَ (ID: `person:Ephraim`); ٱلرَّبِّ (ID: `deity:Lord`); Canaanites (ID: `group:Canaan`); بَنْيَامِينَ (ID: `person:Benjamin`); سَارْدِسَ (ID: `place:Sardis`); إِلَى (ID: `place:Zarephath`); أَفْرَايِمَ (ID: `group:Ephraim`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Canaanites (ID: `group:Canaan`); سَارْدِسَ (ID: `place:Sardis`); إِلَى (ID: `place:Zarephath`); Dispossess (ID: `keyterm:Dispossess`); كَنْعَان (ID: `place:Canaan`); ٱلْجَنوبِ (ID: `place:Negeb`)
