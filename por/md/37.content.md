...
* **Associated ACAI Concepts:** Ageu (ID: `person:Haggai`); Dario (ID: `person:Darius.2`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Ageu (ID: `person:Haggai`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Sealtiel (ID: `person:Shealtiel.2`); Dario (ID: `person:Darius.2`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Olive Tree (ID: `flora:OliveTree`); Mule (ID: `fauna:Mule`); Grain (ID: `flora:Grain`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Must (ID: `realia:Must`); Vine (ID: `flora:Vine`); Bag (ID: `realia:Bag`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Ageu (ID: `person:Haggai`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Ageu (ID: `person:Haggai`); peace (ID: `keyterm:IntactState`); fear (ID: `keyterm:Fear`); Judá (ID: `person:Judah.4`); Egito (ID: `place:Egypt`); Judá (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Sealtiel (ID: `person:Shealtiel.2`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Ageu (ID: `person:Haggai`); Sealtiel (ID: `person:Shealtiel.2`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`); Sword (ID: `realia:Sword`)
