...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); make a vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); Nínive (ID: `place:Nineveh`); Amittai (ID: `person:Amittai`); Jope (ID: `place:Joppa`); praise (ID: `keyterm:Praise`); kindness (ID: `keyterm:Kindness`); exempt (ID: `keyterm:Exempt`); Társis (ID: `place:Tarshish`); slaughtering (ID: `keyterm:Slaughtering`); salvation (ID: `keyterm:Salvation`); lot (ID: `keyterm:Lot`); Hebrews (ID: `group:Hebrews`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Hell (ID: `place:Hell`); make a vow (ID: `keyterm:Vow`); praise (ID: `keyterm:Praise`); kindness (ID: `keyterm:Kindness`); Jonas (ID: `person:Jonah.2`); salvation (ID: `keyterm:Salvation`); Cattails (ID: `flora:Cattails`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Nínive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Compassionate (ID: `keyterm:Compassionate`); kindness (ID: `keyterm:Kindness`); gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`); Believe In (ID: `keyterm:BelieveIn`); Clothing (ID: `realia:Clothing`); Flock (ID: `fauna:Flock`); Throne (ID: `realia:Throne`); Goat (ID: `fauna:Goat`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); Compassionate (ID: `keyterm:Compassionate`); kindness (ID: `keyterm:Kindness`); gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Compassionate (ID: `keyterm:Compassionate`); kindness (ID: `keyterm:Kindness`); gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`)
