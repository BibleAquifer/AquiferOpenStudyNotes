...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); Strength (ID: `keyterm:Strength`); يَهوذَا (ID: `group:Judah`); Love (ID: `keyterm:Love`); Mighty One (ID: `keyterm:MightyOne`); Work (ID: `keyterm:Work`); Defilement (ID: `keyterm:Defilement`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); إِسْرَائِيلَ (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); Appointed Feast (ID: `keyterm:AppointedFeast`); Deceit (ID: `keyterm:Deceit`); Train (ID: `realia:Train`); House (ID: `realia:House`); Winepress (ID: `realia:Winepress`); Yoke (ID: `realia:Yoke`); Grass (ID: `flora:Grass`); Deer (ID: `fauna:Deer`); Flock (ID: `fauna:Flock`); Net (ID: `realia:Net`); Goat (ID: `fauna:Goat`); Casting Net (ID: `realia:CastingNet`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); Defilement (ID: `keyterm:Defilement`); To Sin (ID: `keyterm:Sin`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Appointed Feast (ID: `keyterm:AppointedFeast`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Horn (ID: `keyterm:Horn`); Sheep (ID: `fauna:Lamb`); Instruction (ID: `keyterm:Instruction`); To Dishonor (ID: `keyterm:Dishonor`); Have a Vision (ID: `keyterm:HaveAVision`); Passion (ID: `keyterm:Ardour`); Sabbath (ID: `keyterm:Sabbath`); Gentiles (ID: `group:Gentile`); Utterance (ID: `keyterm:Utterance`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Grain (ID: `flora:Grain`); Altar (ID: `realia:Altar`); Tent (ID: `realia:Tent`); Wine (ID: `realia:Wine`); Bow (ID: `realia:Bow`); Vine (ID: `flora:Vine`); Sackcloth (ID: `realia:Sackcloth`); Measuring Reed (ID: `realia:MeasuringReed`)
...
* **Associated ACAI Concepts:** Horn (ID: `keyterm:Horn`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); Bow (ID: `realia:Bow`); Sheep (ID: `fauna:Lamb`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Appointed Feast (ID: `keyterm:AppointedFeast`); Sabbath (ID: `keyterm:Sabbath`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Gentiles (ID: `group:Gentile`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Wormwood (ID: `flora:Wormwood`); Arrow (ID: `realia:Arrow`); Kindness (ID: `keyterm:Kindness`); Peace (ID: `keyterm:IntactState`); Complete (ID: `keyterm:Complete`); Arrow (ID: `keyterm:Arrow`); Bow (ID: `realia:Bow`); Lion (ID: `fauna:Lion`); Hewn Stone (ID: `realia:HewnStone`); Bear (ID: `fauna:Bear`); Bitter Herbs (ID: `flora:Chicory`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Redeem (ID: `keyterm:Redeem`); Fear (ID: `keyterm:Fear`); Rebel (ID: `keyterm:Rebel`); Peace (ID: `keyterm:IntactState`); Arrow (ID: `keyterm:Arrow`); To Sin (ID: `keyterm:Sin`); Forgive (ID: `keyterm:Forgive`); Hope (ID: `keyterm:Hope`); Salvation (ID: `keyterm:Salvation`); Complete (ID: `keyterm:Complete`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Pit (ID: `realia:Pit`); Arrow (ID: `realia:Arrow`); Wormwood (ID: `flora:Wormwood`); Yoke (ID: `realia:Yoke`); Bitter Herbs (ID: `flora:Chicory`); Lion (ID: `fauna:Lion`); Hewn Stone (ID: `realia:HewnStone`); Bear (ID: `fauna:Bear`); Bow (ID: `realia:Bow`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`); أَدومَ (ID: `place:Edom`); عوصًا (ID: `place:Uz`); Defile (ID: `keyterm:Stain`); Punishment (ID: `keyterm:Punishment`); Defilement (ID: `keyterm:Defilement`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Appoint (ID: `keyterm:Appoint`); Anointed (ID: `keyterm:Anointed`); سَدومَ (ID: `place:Sodom`); Believe In (ID: `keyterm:BelieveIn`); Complete (ID: `keyterm:Complete`); Jackal (ID: `fauna:Jackal`); Ostrich (ID: `fauna:Ostrich`); Clay Jar (ID: `realia:ClayJar`); Purple Cloth (ID: `realia:PurpleCloth`); Vulture (ID: `fauna:Vulture`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); Passion (ID: `keyterm:Ardour`); أورشَلِيمَ (ID: `place:Jerusalem`); أَدومَ (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); أورشَلِيمَ (ID: `place:Jerusalem`); مِصْرَ (ID: `place:Egypt`); Woe (ID: `keyterm:Woe`); To Cause to Possess (ID: `keyterm:Possess`); Round Dance (ID: `keyterm:RoundDance`); Assyria (ID: `place:Assyria`); يَهوذَا (ID: `group:Judah`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`); Jackal (ID: `fauna:Jackal`); Hand-Mill (ID: `realia:Hand-mill`); Money (ID: `realia:Money`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); Woe (ID: `keyterm:Woe`); Round Dance (ID: `keyterm:RoundDance`); Hand-Mill (ID: `realia:Hand-mill`); Crown (ID: `realia:Crown`)
