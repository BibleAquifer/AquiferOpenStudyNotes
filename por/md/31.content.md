...
* **Associated ACAI Concepts:** lot (ID: `keyterm:Lot`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Edomites (ID: `group:Edom`); Jerusalém (ID: `place:Jerusalem`); dispossess (ID: `keyterm:Dispossess`); Edom (ID: `place:Edom`); José (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Edomites (ID: `group:Edom`); Israel (ID: `person:Israel`); Edom (ID: `place:Edom`); José (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** dispossess (ID: `keyterm:Dispossess`); Neguebe (ID: `place:Negeb`); cananeu (ID: `group:Canaan`); Sardes (ID: `place:Sardis`); Gileade (ID: `place:Gilead`); Canaã (ID: `place:Canaan`); Sefalá (ID: `place:Shephelah`); Jerusalém (ID: `place:Jerusalem`); Sarepta (ID: `place:Zarephath`); Benjamim (ID: `group:Benjamin`); Filístia (ID: `place:Philistine`); Samaria (ID: `place:Samaria`); Filisteu (ID: `group:Philistine`); Israel (ID: `person:Israel`); Efraim (ID: `group:Ephraim`); Efraim (ID: `person:Ephraim`); Monte de Esaú (ID: `place:EsauMount`); Benjamim (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); dispossess (ID: `keyterm:Dispossess`); Neguebe (ID: `place:Negeb`); Monte de Esaú (ID: `place:EsauMount`); Benjamim (ID: `group:Benjamin`); Samaria (ID: `place:Samaria`); Canaã (ID: `place:Canaan`); Efraim (ID: `group:Ephraim`); cananeu (ID: `group:Canaan`); SENHOR (ID: `deity:Lord`); Gileade (ID: `place:Gilead`); Sefalá (ID: `place:Shephelah`); Sarepta (ID: `place:Zarephath`); Efraim (ID: `person:Ephraim`); Filístia (ID: `place:Philistine`); Filisteu (ID: `group:Philistine`); Israel (ID: `person:Israel`); Benjamim (ID: `person:Benjamin`); Sardes (ID: `place:Sardis`)
...
* **Associated ACAI Concepts:** cananeu (ID: `group:Canaan`); Sardes (ID: `place:Sardis`); Jerusalém (ID: `place:Jerusalem`); Sarepta (ID: `place:Zarephath`); dispossess (ID: `keyterm:Dispossess`); Israel (ID: `person:Israel`); Canaã (ID: `place:Canaan`); Neguebe (ID: `place:Negeb`)
