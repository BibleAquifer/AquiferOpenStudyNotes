...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); fear (ID: `keyterm:Fear`); offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); peace (ID: `keyterm:IntactState`); stain (ID: `keyterm:Stain`); utter a curse (ID: `keyterm:Curse`); Priests (ID: `group:GenericPriests`); Levi (ID: `person:Levi.3`); Glory (ID: `keyterm:Glory`); Levi (ID: `group:Levi`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); fairness (ID: `keyterm:Fairness`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); be kindly disposed (ID: `keyterm:KindlyDisposed`); An Angel (ID: `deity:Angel`); Truth (ID: `keyterm:Truth`); bless (ID: `keyterm:Bless`); make a vow (ID: `keyterm:Vow`); ardour (ID: `keyterm:Ardour`); pure (ID: `keyterm:Pure`); Gentiles (ID: `group:Gentile`); The Way (ID: `keyterm:TheWay`); evil intention (ID: `keyterm:Intention`); profane, dishonor (ID: `keyterm:Dishonor`); rogar (ID: `keyterm:AskFor`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** stain (ID: `keyterm:Stain`); SENHOR (ID: `deity:Lord`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); profane, dishonor (ID: `keyterm:Dishonor`); Covenant (ID: `keyterm:Covenant`); love (ID: `keyterm:Love`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); delight (ID: `keyterm:Delight`); Judá (ID: `group:Judah`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); love (ID: `keyterm:Love`); profane, dishonor (ID: `keyterm:Dishonor`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); pure (ID: `keyterm:Pure`); fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Levi (ID: `group:Levi`); swear (ID: `keyterm:Swear`); Levi (ID: `person:Levi.3`); A Group of People (ID: `group:GenericGroup`); Covenant (ID: `keyterm:Covenant`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); bless (ID: `keyterm:Bless`); decree (ID: `keyterm:Decree`); utter a curse (ID: `keyterm:Curse`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Sorghum (ID: `flora:Sorghum`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); be enticed to serve (ID: `keyterm:EnticedToServe`); fear (ID: `keyterm:Fear`); Scroll (ID: `realia:Scroll`); Cattle (ID: `fauna:Bull`); Molten Image (ID: `realia:MoltenImage`); Animal Pen (ID: `realia:AnimalPen`)
...
* **Associated ACAI Concepts:** something devoted to god (ID: `keyterm:SomethingDevotedToGod`); Israel (ID: `person:Israel`); fear (ID: `keyterm:Fear`); Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Monte Sinai (ID: `place:SinaiMount`); Elias (ID: `person:Elijah`); decree (ID: `keyterm:Decree`)
