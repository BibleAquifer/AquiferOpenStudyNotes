...
* **Associated ACAI Concepts:** Abagta (ID: `person:Abagtha`); Bigtá (ID: `person:Bigtha`); Harbona (ID: `person:Harbona`); Meumã (ID: `person:Mehuman`); Bizta (ID: `person:Biztha`); Zetar (ID: `person:Zethar`); Carcas (ID: `person:Carkas`); Assuero (ID: `person:Ahasuerus`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Vasti (ID: `person:Vashti`); Medã (ID: `person:Medan`); Persians (ID: `group:Persia`); Assuero (ID: `person:Ahasuerus`); Pérsia (ID: `place:Persia`); Medes (ID: `group:Mede`)
...
* **Associated ACAI Concepts:** Babilônia (ID: `place:Babylon`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); Jeoaquim (ID: `person:Jehoiachin`); Nabucodonozor (ID: `person:Nebuchadnezzar`)
...
* **Associated ACAI Concepts:** Ester (ID: `person:Esther`); kindness (ID: `keyterm:Kindness`); favor (ID: `keyterm:Favor`); Vasti (ID: `person:Vashti`); love (ID: `keyterm:Love`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Assuero (ID: `person:Ahasuerus`); Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Hamedata (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Agague (ID: `person:Agag.2`); Money (ID: `realia:Money`); Susã (ID: `place:Susa`); Servants (ID: `group:GenericServants`); lot (ID: `keyterm:Lot`); Talent (ID: `realia:Talent`); Scroll (ID: `realia:Scroll`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Hamã (ID: `person:Haman`); Assuero (ID: `person:Ahasuerus`); Mordecai (ID: `person:Mordecai.2`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Zeres (ID: `person:Zeresh`); love (ID: `keyterm:Love`); Jews (ID: `group:Jews`); Ester (ID: `person:Esther`); A Group of People (ID: `group:GenericGroup`); Glory (ID: `keyterm:Glory`); Cubit (ID: `realia:Cubit`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Zeres (ID: `person:Zeresh`); love (ID: `keyterm:Love`); Mordecai (ID: `person:Mordecai.2`); Hamã (ID: `person:Haman`); A Group of People (ID: `group:GenericGroup`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Zeres (ID: `person:Zeresh`); love (ID: `keyterm:Love`); Jews (ID: `group:Jews`); Mordecai (ID: `person:Mordecai.2`); Hamã (ID: `person:Haman`); A Group of People (ID: `group:GenericGroup`)
...
* **Associated ACAI Concepts:** Agague (ID: `person:Agag.2`); Jews (ID: `group:Jews`); Agagites (ID: `group:Agag`); Ester (ID: `person:Esther`); beg for mercy (ID: `keyterm:BegForMercy`); Hamã (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Hamedata (ID: `person:Hammedatha`); favor (ID: `keyterm:Favor`); Agague (ID: `person:Agag.2`); Jews (ID: `group:Jews`); Agagites (ID: `group:Agag`); Hamã (ID: `person:Haman`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Adalia (ID: `person:Adalia`); Dalfom (ID: `person:Dalphon`); Aspata (ID: `person:Aspatha`); Aridata (ID: `person:Aridatha`); Parsandata (ID: `person:Parshandatha`); Arisai (ID: `person:Arisai`); Vaizata (ID: `person:Vaizatha`); Porata (ID: `person:Poratha`); Aridai (ID: `person:Aridai`); Farmasta (ID: `person:Parmashta`); Jews (ID: `group:Jews`); Hamedata (ID: `person:Hammedatha`); Hamã (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Lot (ID: `realia:Lot`); Hamedata (ID: `person:Hammedatha`); Agague (ID: `person:Agag.2`); Agagites (ID: `group:Agag`); Mordecai (ID: `person:Mordecai.2`); Hamã (ID: `person:Haman`); lot (ID: `keyterm:Lot`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Ester (ID: `person:Esther`); Mordecai (ID: `person:Mordecai.2`); Scroll (ID: `realia:Scroll`); Abiail (ID: `person:Abihail.5`); Assuero (ID: `person:Ahasuerus`); Truth (ID: `keyterm:Truth`); peace (ID: `keyterm:IntactState`)
...
* **Associated ACAI Concepts:** Pérsia (ID: `place:Persia`); Assuero (ID: `person:Ahasuerus`); Mordecai (ID: `person:Mordecai.2`); Media (ID: `place:Media`)
