...
* **Associated ACAI Concepts:** Édom (ID: `group:Edom`); Édom (ID: `place:Edom`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); aimer (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Édom (ID: `place:Edom`); laissiez en possession (ID: `keyterm:Possess`); Édom (ID: `group:Edom`); Jackal (ID: `fauna:Jackal`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); craindre (ID: `keyterm:Fear`); alliance (ID: `keyterm:Covenant`); offrande (ID: `keyterm:Offering`); Priests (ID: `group:GenericPriests`); souiller (ID: `keyterm:Stain`); Lévi (ID: `group:Levi`); gloire (ID: `keyterm:Glory`); Lévi (ID: `person:Levi.3`); pleurer (ID: `keyterm:Curse`); état intact (ID: `keyterm:IntactState`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); niveau (ID: `keyterm:Fairness`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); la connaissance (ID: `keyterm:Intention`); agir avec bonté (ID: `keyterm:KindlyDisposed`); prier (ID: `keyterm:AskFor`); sans saleté (ID: `keyterm:Pure`); profaner, déshonorer (ID: `keyterm:Dishonor`); chemin (ID: `keyterm:TheWay`); nation; peuple (ID: `group:Gentile`); ardeur (ID: `keyterm:Ardour`); faire un voeu (ID: `keyterm:Vow`); benir (ID: `keyterm:Bless`); An Angel (ID: `deity:Angel`); vérité (ID: `keyterm:Truth`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); souiller (ID: `keyterm:Stain`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); souiller (ID: `keyterm:Stain`); profaner, déshonorer (ID: `keyterm:Dishonor`)
...
* **Associated ACAI Concepts:** pleurer (ID: `keyterm:Curse`); craindre (ID: `keyterm:Fear`); Éternel (ID: `deity:Lord`); faire un voeu (ID: `keyterm:Vow`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** gloire (ID: `keyterm:Glory`); benir (ID: `keyterm:Bless`); pleurer (ID: `keyterm:Curse`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Lévi (ID: `person:Levi.3`); Éternel (ID: `deity:Lord`); Lévi (ID: `group:Levi`); alliance (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); alliance (ID: `keyterm:Covenant`); profaner, déshonorer (ID: `keyterm:Dishonor`); offrande (ID: `keyterm:Offering`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `person:Judah.4`); délice (ID: `keyterm:Delight`); aimer (ID: `keyterm:Love`); Juda (ID: `group:Judah`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); profaner, déshonorer (ID: `keyterm:Dishonor`); Israël (ID: `person:Israel`); Juda (ID: `person:Judah.4`); Éternel (ID: `deity:Lord`); aimer (ID: `keyterm:Love`); Juda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); offrande (ID: `keyterm:Offering`); alliance (ID: `keyterm:Covenant`); Jérusalem (ID: `place:Jerusalem`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`); A Group of People (ID: `group:GenericGroup`); sans saleté (ID: `keyterm:Pure`); craindre (ID: `keyterm:Fear`); Juda (ID: `person:Judah.4`); An Angel (ID: `deity:Angel`); Juda (ID: `group:Judah`); jurer (ID: `keyterm:Swear`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); pleurer (ID: `keyterm:Curse`); benir (ID: `keyterm:Bless`); Israël (ID: `person:Israel`); limite (ID: `keyterm:Decree`); offrande (ID: `keyterm:Offering`); Wheat (ID: `flora:Wheat`); Vine (ID: `flora:Vine`); Sorghum (ID: `flora:Sorghum`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); être attiré à servir (ID: `keyterm:EnticedToServe`); craindre (ID: `keyterm:Fear`); Animal Pen (ID: `realia:AnimalPen`); Molten Image (ID: `realia:MoltenImage`); Scroll (ID: `realia:Scroll`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** limite (ID: `keyterm:Decree`); Israël (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); Moïse (ID: `person:Moses`); montagne de Sinaï (ID: `place:SinaiMount`)
...
* **Associated ACAI Concepts:** objet qui doit être détruit (ID: `keyterm:SomethingDevotedToGod`); limite (ID: `keyterm:Decree`); craindre (ID: `keyterm:Fear`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); Élie (ID: `person:Elijah`); Moïse (ID: `person:Moses`); montagne de Sinaï (ID: `place:SinaiMount`)
...
* **Associated ACAI Concepts:** Élie (ID: `person:Elijah`); objet qui doit être détruit (ID: `keyterm:SomethingDevotedToGod`); craindre (ID: `keyterm:Fear`); Éternel (ID: `deity:Lord`)
