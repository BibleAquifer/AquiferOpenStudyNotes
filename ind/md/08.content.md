...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); Ephrathites (ID: `group:Ephrathah`); Mahlon (ID: `person:Chilion`); Efrata (ID: `person:Ephrathah`); Moab (ID: `place:Moab`); Elimelekh (ID: `person:Elimelech`); Betlehem (ID: `place:Bethlehem`); Yehuda (ID: `group:Judah`); Mahlon (ID: `person:Mahlon`); Yehuda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** memberkati (ID: `keyterm:Bless`); Naomi (ID: `person:Naomi`); Tuhan (ID: `deity:Lord`); kebaikan (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** Rut (ID: `person:Ruth`); menyebabkan memiliki (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); Boas (ID: `person:Boaz`)
...
* **Associated ACAI Concepts:** Rahel (ID: `person:Rachel`); Lea (ID: `person:Leah`); Betlehem (ID: `place:Bethlehem`); Tuhan (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Tamar (ID: `person:Tamar`); Yehuda (ID: `group:Judah`); Tuhan (ID: `deity:Lord`); Peres (ID: `person:Perez`); Yehuda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); memberkati (ID: `keyterm:Bless`); Naomi (ID: `person:Naomi`); Tuhan (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); memperanakkan (ID: `person:Salmon`); Obed (ID: `person:Obed`); Aminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Nahason (ID: `person:Nahshon`); Daud (ID: `person:David`); Boas (ID: `person:Boaz`); Isai (ID: `person:Jesse`); Peres (ID: `person:Perez`)
