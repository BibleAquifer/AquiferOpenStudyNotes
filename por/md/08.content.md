...
* **Associated ACAI Concepts:** Ephrathites (ID: `group:Ephrathah`); Quiliom (ID: `person:Chilion`); Efrata (ID: `person:Ephrathah`); Noemi (ID: `person:Naomi`); Elimeleque (ID: `person:Elimelech`); Belém (ID: `place:Bethlehem`); Moabe (ID: `place:Moab`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Malom (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); Moabe (ID: `place:Moab`); Boaz (ID: `person:Boaz`); to cause to possess (ID: `keyterm:Possess`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); Moabe (ID: `place:Moab`); to cause to possess (ID: `keyterm:Possess`); Malom (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Elders (ID: `group:GenericElders`); Belém (ID: `place:Bethlehem`); SENHOR (ID: `deity:Lord`); Lia (ID: `person:Leah`); Raquel (ID: `person:Rachel`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Perez (ID: `person:Perez`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Tamar (ID: `person:Tamar`)
...
* **Associated ACAI Concepts:** Hezrom (ID: `person:Hezron.2`); Salmom (ID: `person:Salmon`); Obede (ID: `person:Obed`); Aminadabe (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Davi (ID: `person:David`); Jessé (ID: `person:Jesse`); Naassom (ID: `person:Nahshon`); Boaz (ID: `person:Boaz`); Perez (ID: `person:Perez`)
