...
* **Associated ACAI Concepts:** Efrata (ID: `person:Ephrathah`); Mahlon (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Ephrathites (ID: `group:Ephrathah`); Betlehem (ID: `place:Bethlehem`); Yehuda (ID: `person:Judah.4`); Moab (ID: `place:Moab`); Yehuda (ID: `group:Judah`); Elimelekh (ID: `person:Elimelech`); Mahlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); memberkati (ID: `keyterm:Bless`); kebaikan (ID: `keyterm:Kindness`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Rut (ID: `person:Ruth`); Boas (ID: `person:Boaz`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); menyebabkan memiliki (ID: `keyterm:Possess`)
...
* **Associated ACAI Concepts:** Lea (ID: `person:Leah`); Betlehem (ID: `place:Bethlehem`); Israel (ID: `person:Israel`); Tuhan (ID: `deity:Lord`); Rahel (ID: `person:Rachel`); Elders (ID: `group:GenericElders`)
...
* **Associated ACAI Concepts:** Peres (ID: `person:Perez`); Yehuda (ID: `person:Judah.4`); Tamar (ID: `person:Tamar`); Yehuda (ID: `group:Judah`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); memperanakkan (ID: `person:Salmon`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Nahason (ID: `person:Nahshon`); Peres (ID: `person:Perez`); Boas (ID: `person:Boaz`); Daud (ID: `person:David`); Isai (ID: `person:Jesse`)
