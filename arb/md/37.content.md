...
* **Associated ACAI Concepts:** دَارِيوسَ (ID: `person:Darius.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); حَجَّيِ (ID: `person:Haggai`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); زَربَّابِل (ID: `person:Zerubbabel.2`)

## حجّي 1: 1–15 (id: 752089)

تدعو الرسالة الأولى سكان أورشليم إلى التركيز على استعادة العبادة الصحيحة لله.

* **Associated Passages:** حجي 1:1-15

* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); حَجَّيِ (ID: `person:Haggai`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَشوع (ID: `person:Joshua.5`); دَارِيوسَ (ID: `person:Darius.2`); يَهوذَا (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); يَهوذَا (ID: `group:Judah`); An Angel (ID: `deity:Angel`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Fear (ID: `keyterm:Fear`); Must (ID: `realia:Must`); Olive Tree (ID: `flora:OliveTree`); Olive Oil (ID: `realia:OliveOil`); Grain (ID: `flora:Grain`); Vine (ID: `flora:Vine`); Anointing Oil (ID: `realia:AnointingOil`); Bag (ID: `realia:Bag`); Mule (ID: `fauna:Mule`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); Fear (ID: `keyterm:Fear`); ٱلرَّبِّ (ID: `deity:Lord`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); حَجَّيِ (ID: `person:Haggai`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated Passages:** حجي 2:1-9

* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); حَجَّيِ (ID: `person:Haggai`); مِصْرَ (ID: `place:Egypt`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Fear (ID: `keyterm:Fear`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Peace (ID: `keyterm:IntactState`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** Peace (ID: `keyterm:IntactState`); ٱلرَّبِّ (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`)
...
* **Associated Passages:** حجي 2:20-23

* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); حَجَّيِ (ID: `person:Haggai`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `person:Judah.4`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); ٱلرَّبِّ (ID: `deity:Lord`)
