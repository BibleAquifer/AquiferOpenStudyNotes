...
* **Associated ACAI Concepts:** Efrata (ID: `person:Ephrathah`); Ephrathites (ID: `group:Ephrathah`); Quiliom (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Malom (ID: `person:Mahlon`); Moabe (ID: `place:Moab`); Elimeleque (ID: `person:Elimelech`); Belém (ID: `place:Bethlehem`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); to cause to possess (ID: `keyterm:Possess`); Moabe (ID: `place:Moab`); Malom (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Raquel (ID: `person:Rachel`); Lia (ID: `person:Leah`); Belém (ID: `place:Bethlehem`); Israel (ID: `person:Israel`); Elders (ID: `group:GenericElders`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Tamar (ID: `person:Tamar`); Perez (ID: `person:Perez`)
...
* **Associated ACAI Concepts:** Salmom (ID: `person:Salmon`); Hezrom (ID: `person:Hezron.2`); Aminadabe (ID: `person:Amminadab`); Obede (ID: `person:Obed`); Ram (ID: `person:Ram`); Boaz (ID: `person:Boaz`); Davi (ID: `person:David`); Naassom (ID: `person:Nahshon`); Jessé (ID: `person:Jesse`); Perez (ID: `person:Perez`)
