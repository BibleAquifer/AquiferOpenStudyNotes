...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); amado (ID: `keyterm:Beloved`); andar (ID: `keyterm:Live.3`); Gaio (ID: `person:Gaius.4`); Cause of Joy (ID: `keyterm:CauseOfJoy`); orar (ID: `keyterm:Pray`); testemunhar (ID: `keyterm:BearWitness`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** amado (ID: `keyterm:Beloved`); dever (ID: `keyterm:Ought`); SENHOR (ID: `deity:Lord`); Faithfulness (ID: `keyterm:Faithfulness`); igreja (ID: `keyterm:Church`); Name (ID: `keyterm:Name`); Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); testemunhar (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** igreja (ID: `keyterm:Church`); Diótrefes (ID: `person:Diotrephes`); Demétrio (ID: `person:Demetrius`); amado (ID: `keyterm:Beloved`); SENHOR (ID: `deity:Lord`); verdadeiro (ID: `keyterm:True`); Truth (ID: `keyterm:Truth`); Good (ID: `keyterm:Good`); Do Good (ID: `keyterm:DoGood`); testemunhar (ID: `keyterm:BearWitness`)
