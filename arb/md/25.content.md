...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); Love (ID: `keyterm:Love`); يَهوذَا (ID: `group:Judah`); Strength (ID: `keyterm:Strength`); Deceit (ID: `keyterm:Deceit`); Appointed Feast (ID: `keyterm:AppointedFeast`); Defilement (ID: `keyterm:Defilement`); To Sin (ID: `keyterm:Sin`); Work (ID: `keyterm:Work`); إِسْرَائِيلَ (ID: `person:Israel`); Mighty One (ID: `keyterm:MightyOne`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Train (ID: `realia:Train`); Goat (ID: `fauna:Goat`); Deer (ID: `fauna:Deer`); Winepress (ID: `realia:Winepress`); Yoke (ID: `realia:Yoke`); Net (ID: `realia:Net`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Grass (ID: `flora:Grass`); Casting Net (ID: `realia:CastingNet`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); To Sin (ID: `keyterm:Sin`); Defilement (ID: `keyterm:Defilement`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Rebel (ID: `keyterm:Rebel`); Strength (ID: `keyterm:Strength`); ٱلرَّبِّ (ID: `deity:Lord`); Yoke (ID: `realia:Yoke`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Mighty One (ID: `keyterm:MightyOne`); ٱلرَّبِّ (ID: `deity:Lord`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Appointed Feast (ID: `keyterm:AppointedFeast`); يَهوذَا (ID: `person:Judah.4`); Horn (ID: `keyterm:Horn`); يَهوذَا (ID: `group:Judah`); Sheep (ID: `fauna:Lamb`); Passion (ID: `keyterm:Ardour`); Gentiles (ID: `group:Gentile`); Sabbath (ID: `keyterm:Sabbath`); Instruction (ID: `keyterm:Instruction`); Have a Vision (ID: `keyterm:HaveAVision`); To Dishonor (ID: `keyterm:Dishonor`); Utterance (ID: `keyterm:Utterance`); Sackcloth (ID: `realia:Sackcloth`); Measuring Reed (ID: `realia:MeasuringReed`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); House (ID: `realia:House`); Grain (ID: `flora:Grain`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Tent (ID: `realia:Tent`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** Horn (ID: `keyterm:Horn`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); Sheep (ID: `fauna:Lamb`); Tent (ID: `realia:Tent`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** Appointed Feast (ID: `keyterm:AppointedFeast`); ٱلرَّبِّ (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); House (ID: `realia:House`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Arrow (ID: `realia:Arrow`); Wormwood (ID: `flora:Wormwood`); Peace (ID: `keyterm:IntactState`); Arrow (ID: `keyterm:Arrow`); Kindness (ID: `keyterm:Kindness`); Complete (ID: `keyterm:Complete`); Lion (ID: `fauna:Lion`); Bear (ID: `fauna:Bear`); Hewn Stone (ID: `realia:HewnStone`); Bow (ID: `realia:Bow`); Bitter Herbs (ID: `flora:Chicory`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Redeem (ID: `keyterm:Redeem`); To Sin (ID: `keyterm:Sin`); Forgive (ID: `keyterm:Forgive`); Fear (ID: `keyterm:Fear`); Arrow (ID: `keyterm:Arrow`); Rebel (ID: `keyterm:Rebel`); Peace (ID: `keyterm:IntactState`); Complete (ID: `keyterm:Complete`); Salvation (ID: `keyterm:Salvation`); Hope (ID: `keyterm:Hope`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Wormwood (ID: `flora:Wormwood`); Arrow (ID: `realia:Arrow`); Pit (ID: `realia:Pit`); Bear (ID: `fauna:Bear`); Bird (ID: `fauna:Bird`); Yoke (ID: `realia:Yoke`); Hewn Stone (ID: `realia:HewnStone`); Bow (ID: `realia:Bow`); Bitter Herbs (ID: `flora:Chicory`); Lion (ID: `fauna:Lion`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); ٱلرَّبِّ (ID: `deity:Lord`); أَدومَ (ID: `place:Edom`); To Sin (ID: `keyterm:Sin`); عوصًا (ID: `place:Uz`); Defile (ID: `keyterm:Stain`); Punishment (ID: `keyterm:Punishment`); Appoint (ID: `keyterm:Appoint`); سَدومَ (ID: `place:Sodom`); Defilement (ID: `keyterm:Defilement`); Believe In (ID: `keyterm:BelieveIn`); Anointed (ID: `keyterm:Anointed`); Complete (ID: `keyterm:Complete`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Jackal (ID: `fauna:Jackal`); Ostrich (ID: `fauna:Ostrich`); Purple Cloth (ID: `realia:PurpleCloth`); Vulture (ID: `fauna:Vulture`); Clay Jar (ID: `realia:ClayJar`)
...
* **Associated ACAI Concepts:** أَدومَ (ID: `place:Edom`); To Sin (ID: `keyterm:Sin`); Appoint (ID: `keyterm:Appoint`); Passion (ID: `keyterm:Ardour`); Complete (ID: `keyterm:Complete`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); أورشَلِيمَ (ID: `place:Jerusalem`); Assyria (ID: `place:Assyria`); Woe (ID: `keyterm:Woe`); مِصْرَ (ID: `place:Egypt`); Round Dance (ID: `keyterm:RoundDance`); يَهوذَا (ID: `person:Judah.4`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `group:Judah`); To Cause to Possess (ID: `keyterm:Possess`); House (ID: `realia:House`); Money (ID: `realia:Money`); Crown (ID: `realia:Crown`); Hand-Mill (ID: `realia:Hand-mill`); Jackal (ID: `fauna:Jackal`)
