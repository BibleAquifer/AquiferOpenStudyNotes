...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Judas (ID: `person:Jude`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Tiago (ID: `person:James.3`); misericórdia (ID: `keyterm:Mercy`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** amado (ID: `keyterm:Beloved`); comum (ID: `keyterm:InCommon`); empenho (ID: `keyterm:Eagerness`); holy (ID: `keyterm:Holy`); salvation (ID: `keyterm:Salvation`); rogar (ID: `keyterm:AskFor`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); amado (ID: `keyterm:Beloved`); Jesus (ID: `person:Jesus.2`); empenho (ID: `keyterm:Eagerness`); comum (ID: `keyterm:InCommon`); holy (ID: `keyterm:Holy`); salvation (ID: `keyterm:Salvation`); juízo (ID: `keyterm:Judgment`); rogar (ID: `keyterm:AskFor`); crer (ID: `keyterm:Believe`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** corpo (ID: `keyterm:Body.3`); tribunal de justiça (ID: `keyterm:CourtCase`); juízo (ID: `keyterm:Judgment`); para a eternidade (ID: `keyterm:Always`); blasfemar (ID: `keyterm:Blaspheme`); SENHOR (ID: `deity:Lord`); Corá (ID: `person:Korah.3`); defilement (ID: `keyterm:Defilement`); An Angel (ID: `deity:Angel`); ágape (ID: `keyterm:FellowshipMeal`); crer (ID: `keyterm:Believe`); Moisés (ID: `person:Moses`); Adão (ID: `person:Adam`); Disaster (ID: `keyterm:Disaster`); Miguel (ID: `person:Michael.11`); To Command (ID: `keyterm:Command`); fogo eterno (ID: `keyterm:EternalFire`); speak (ID: `keyterm:Speak`); Sodoma (ID: `place:Sodom`); Gomorra (ID: `place:Gomorrah`); Balaão (ID: `person:Balaam`); holy (ID: `keyterm:Holy`); Enoque (ID: `person:Enoch.2`); salvation (ID: `keyterm:Salvation`); distinguir (ID: `keyterm:Discern`); Caim (ID: `person:Cain`); Egito (ID: `place:Egypt`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); Flock (ID: `fauna:Flock`); Chain (ID: `realia:Chain`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** corpo (ID: `keyterm:Body.3`); Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`); Miguel (ID: `person:Michael.11`); tribunal de justiça (ID: `keyterm:CourtCase`); To Command (ID: `keyterm:Command`); juízo (ID: `keyterm:Judgment`); distinguir (ID: `keyterm:Discern`); blasfemar (ID: `keyterm:Blaspheme`)
...
* **Associated ACAI Concepts:** Corá (ID: `person:Korah.3`); Caim (ID: `person:Cain`); Balaão (ID: `person:Balaam`); Disaster (ID: `keyterm:Disaster`)
...
* **Associated ACAI Concepts:** Adão (ID: `person:Adam`); Enoque (ID: `person:Enoch.2`); SENHOR (ID: `deity:Lord`); tribunal de justiça (ID: `keyterm:CourtCase`); speak (ID: `keyterm:Speak`); juízo (ID: `keyterm:Judgment`); holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** misericórdia (ID: `keyterm:Mercy`); Holy Spirit (ID: `deity:HolySpirit`); amado (ID: `keyterm:Beloved`); Jesus (ID: `person:Jesus.2`); corpo (ID: `keyterm:Body.3`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); fear (ID: `keyterm:Fear`); Life (ID: `keyterm:Life`); crer (ID: `keyterm:Believe`); para a eternidade (ID: `keyterm:Always`); natural (ID: `keyterm:Natural`); palavra (ID: `keyterm:Word`); orar (ID: `keyterm:Pray`); holy (ID: `keyterm:Holy`); salvation (ID: `keyterm:Salvation`); distinguir (ID: `keyterm:Discern`); causar divisões (ID: `keyterm:CreatingDivisions`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** amado (ID: `keyterm:Beloved`); crer (ID: `keyterm:Believe`); holy (ID: `keyterm:Holy`); orar (ID: `keyterm:Pray`); Holy Spirit (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** misericórdia (ID: `keyterm:Mercy`); corpo (ID: `keyterm:Body.3`); salvation (ID: `keyterm:Salvation`); fear (ID: `keyterm:Fear`); distinguir (ID: `keyterm:Discern`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** corpo (ID: `keyterm:Body.3`); salvation (ID: `keyterm:Salvation`); fear (ID: `keyterm:Fear`); misericórdia (ID: `keyterm:Mercy`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); irrepreensível (ID: `keyterm:Unblemished`); surely! (ID: `keyterm:Surely`); autoridade (ID: `keyterm:Authority.2`); para a eternidade (ID: `keyterm:Always`); salvador (ID: `keyterm:Savior`); Ability (ID: `keyterm:Ability`)
