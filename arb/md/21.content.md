...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); أورشَلِيمَ (ID: `place:Jerusalem`); Intention (ID: `keyterm:Intention`); Stupid (ID: `keyterm:Stupid`); ٱلرَّبِّ (ID: `deity:Lord`); Vine (ID: `flora:Vine`); To Sin (ID: `keyterm:Sin`); إِسْرَائِيلَ (ID: `person:Israel`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`); Wine (ID: `realia:Wine`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); Vine (ID: `flora:Vine`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`); Wine (ID: `realia:Wine`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vow (ID: `keyterm:Vow`); House (ID: `realia:House`); Strength (ID: `keyterm:Strength`); An Angel (ID: `deity:Angel`); Passion (ID: `keyterm:Ardour`); Fear (ID: `keyterm:Fear`); A Man (ID: `person:GenericMale`); Slaughtering (ID: `keyterm:Slaughtering`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** Stupid (ID: `keyterm:Stupid`); Ability (ID: `keyterm:Ability`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); To Act Wickedly (ID: `keyterm:ActWickedly`); To Cause to Possess (ID: `keyterm:Possess`); Intention (ID: `keyterm:Intention`); To Sin (ID: `keyterm:Sin`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Cooking Pot (ID: `realia:CookingPot`); Brier (ID: `flora:Brier`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Strength (ID: `keyterm:Strength`); Hell (ID: `place:Hell`); ٱلرَّبِّ (ID: `deity:Lord`); Love (ID: `keyterm:Love`); Intention (ID: `keyterm:Intention`); Ability (ID: `keyterm:Ability`); Anointing Oil (ID: `realia:AnointingOil`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); ٱلرَّبِّ (ID: `deity:Lord`); Caper (ID: `flora:Caper`); Bird (ID: `fauna:Bird`); Rope (ID: `realia:Rope`); Clay Jar (ID: `realia:ClayJar`); Almond (ID: `flora:Almond`); Locust (ID: `fauna:Locust`); Pit (ID: `realia:Pit`); Money (ID: `realia:Money`)
