...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Timóteo (ID: `person:Timothy`); favor (ID: `keyterm:Favor`); fazer a paz (ID: `keyterm:Peace`); Paulo (ID: `person:Paul`); crer (ID: `keyterm:Believe`); misericórdia (ID: `keyterm:Mercy`); salvador (ID: `keyterm:Savior`); hope (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** Timóteo (ID: `person:Timothy`); Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`); fazer a paz (ID: `keyterm:Peace`); crer (ID: `keyterm:Believe`); misericórdia (ID: `keyterm:Mercy`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); lei (ID: `keyterm:Law`); SENHOR (ID: `deity:Lord`); opposite of holy: profane (ID: `keyterm:Profane`); sem lei (ID: `keyterm:Lawless`); bem, aventurado (ID: `keyterm:Happy`); Glory (ID: `keyterm:Glory`); consciência (ID: `keyterm:Conscience`); palavreado vazio (ID: `keyterm:EmptyTalk`); boa notícia (ID: `keyterm:GoodNews`); sem hipocrisia (ID: `keyterm:Unhypocritical`); coração (ID: `keyterm:Heart`); limpo (ID: `keyterm:Clean`); rogar (ID: `keyterm:AskFor`); Macedônia (ID: `place:Macedonia`); be (or show oneself) just (ID: `keyterm:Just`); corretamente (ID: `keyterm:Lawfully`); Good (ID: `keyterm:Good`); love (ID: `keyterm:Love`); Éfeso (ID: `place:Ephesus`)
...
* **Associated ACAI Concepts:** Good (ID: `keyterm:Good`); love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`); consciência (ID: `keyterm:Conscience`); sem hipocrisia (ID: `keyterm:Unhypocritical`); coração (ID: `keyterm:Heart`); limpo (ID: `keyterm:Clean`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); sem lei (ID: `keyterm:Lawless`); opposite of holy: profane (ID: `keyterm:Profane`); be (or show oneself) just (ID: `keyterm:Just`); corretamente (ID: `keyterm:Lawfully`); crer (ID: `keyterm:Believe`); palavreado vazio (ID: `keyterm:EmptyTalk`); bem, aventurado (ID: `keyterm:Happy`); boa notícia (ID: `keyterm:GoodNews`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); bem, aventurado (ID: `keyterm:Happy`); boa notícia (ID: `keyterm:GoodNews`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); favor (ID: `keyterm:Favor`); Faithfulness (ID: `keyterm:Faithfulness`); crer (ID: `keyterm:Believe`); misericórdia (ID: `keyterm:Mercy`); para a eternidade (ID: `keyterm:Always`); imortal (ID: `keyterm:Imperishable`); surely! (ID: `keyterm:Surely`); Life (ID: `keyterm:Life`); servir (ID: `keyterm:Serve`); não crer (ID: `keyterm:Disbelieve`); love (ID: `keyterm:Love`); blasfemo (ID: `keyterm:Blasphemous`); salvation (ID: `keyterm:Salvation`); SENHOR (ID: `deity:Lord`); em cristo (ID: `keyterm:InChrist`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** Alexandre (ID: `person:Alexander.4`); consciência (ID: `keyterm:Conscience`); Himeneu (ID: `person:Hymenaeus`); Good (ID: `keyterm:Good`); crer (ID: `keyterm:Believe`); Satanás (ID: `deity:Satan`); blasfemar (ID: `keyterm:Blaspheme`); Timóteo (ID: `person:Timothy`)
...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); SENHOR (ID: `deity:Lord`); Daily Life (ID: `keyterm:DailyLife`); Jesus (ID: `person:Jesus.2`); testemunhar (ID: `keyterm:BearWitness`); Life (ID: `keyterm:Life`); resgate (ID: `keyterm:Ransom`); tranquilo (ID: `keyterm:Tranquil`); crer (ID: `keyterm:Believe`); salvador (ID: `keyterm:Savior`); salvation (ID: `keyterm:Salvation`); Gentiles (ID: `group:Gentile`); rogar (ID: `keyterm:AskFor`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** Adão (ID: `person:Adam`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); orar (ID: `keyterm:Pray`); Truth (ID: `keyterm:Truth`); SENHOR (ID: `deity:Lord`); Daily Life (ID: `keyterm:DailyLife`); piedade (ID: `keyterm:GodlyReverence`); resgate (ID: `keyterm:Ransom`); Eva (ID: `person:Eve`); testemunhar (ID: `keyterm:BearWitness`); consecration (ID: `keyterm:Consecration.2`); salvador (ID: `keyterm:Savior`); rogar (ID: `keyterm:AskFor`); Life (ID: `keyterm:Life`); Good (ID: `keyterm:Good`); tranquilo (ID: `keyterm:Tranquil`); love (ID: `keyterm:Love`); promessa (ID: `keyterm:Promise`); Jesus (ID: `person:Jesus.2`); holy (ID: `keyterm:Holy`); autoridade (ID: `keyterm:Authority.2`); Gentiles (ID: `group:Gentile`); Gold Jewelry (ID: `realia:GoldJewelry`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); Faithfulness (ID: `keyterm:Faithfulness`); testemunhar (ID: `keyterm:BearWitness`); Adão (ID: `person:Adam`); servir (ID: `keyterm:Serve`); salvation (ID: `keyterm:Salvation`); orar (ID: `keyterm:Pray`); Jesus (ID: `person:Jesus.2`); Truth (ID: `keyterm:Truth`); irrepreensível (ID: `keyterm:WithoutReproach`); Daily Life (ID: `keyterm:DailyLife`); compreensivo (ID: `keyterm:Gentle`); que não ama o dinheiro (ID: `keyterm:NotALoverOfMoney`); igreja (ID: `keyterm:Church`); piedade (ID: `keyterm:GodlyReverence`); resgate (ID: `keyterm:Ransom`); Eva (ID: `person:Eve`); (literalmente (ID: `keyterm:DoubleTongued`); consciência (ID: `keyterm:Conscience`); consecration (ID: `keyterm:Consecration.2`); em cristo (ID: `keyterm:InChrist`); rogar (ID: `keyterm:AskFor`); limpo (ID: `keyterm:Clean`); salvador (ID: `keyterm:Savior`); irrepreensível (ID: `keyterm:BeyondReproach`); Life (ID: `keyterm:Life`); discernir (ID: `keyterm:Interpret`); Good (ID: `keyterm:Good`); tranquilo (ID: `keyterm:Tranquil`); love (ID: `keyterm:Love`); promessa (ID: `keyterm:Promise`); holy (ID: `keyterm:Holy`); juízo (ID: `keyterm:Judgment`); ofício (ID: `keyterm:PositionOfResponsibility`); autoridade (ID: `keyterm:Authority.2`); Gentiles (ID: `group:Gentile`); Wine (ID: `realia:Wine`); Gold Jewelry (ID: `realia:GoldJewelry`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Adão (ID: `person:Adam`); autoridade (ID: `keyterm:Authority.2`); love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`); Eva (ID: `person:Eve`); salvation (ID: `keyterm:Salvation`); consecration (ID: `keyterm:Consecration.2`)
...
* **Associated ACAI Concepts:** consecration (ID: `keyterm:Consecration.2`); salvation (ID: `keyterm:Salvation`); love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** Faithfulness (ID: `keyterm:Faithfulness`); servir (ID: `keyterm:Serve`); crer (ID: `keyterm:Believe`); irrepreensível (ID: `keyterm:WithoutReproach`); compreensivo (ID: `keyterm:Gentle`); que não ama o dinheiro (ID: `keyterm:NotALoverOfMoney`); igreja (ID: `keyterm:Church`); testemunhar (ID: `keyterm:BearWitness`); (literalmente (ID: `keyterm:DoubleTongued`); consciência (ID: `keyterm:Conscience`); em cristo (ID: `keyterm:InChrist`); limpo (ID: `keyterm:Clean`); irrepreensível (ID: `keyterm:BeyondReproach`); discernir (ID: `keyterm:Interpret`); Jesus (ID: `person:Jesus.2`); juízo (ID: `keyterm:Judgment`); ofício (ID: `keyterm:PositionOfResponsibility`); SENHOR (ID: `deity:Lord`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** servir (ID: `keyterm:Serve`); crer (ID: `keyterm:Believe`); irrepreensível (ID: `keyterm:WithoutReproach`); Jesus (ID: `person:Jesus.2`); discernir (ID: `keyterm:Interpret`); Faithfulness (ID: `keyterm:Faithfulness`); (literalmente (ID: `keyterm:DoubleTongued`); consciência (ID: `keyterm:Conscience`); em cristo (ID: `keyterm:InChrist`); limpo (ID: `keyterm:Clean`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Faithfulness (ID: `keyterm:Faithfulness`); crer (ID: `keyterm:Believe`); Life (ID: `keyterm:Life`); Truth (ID: `keyterm:Truth`); Holy Spirit (ID: `deity:HolySpirit`); hope (ID: `keyterm:Hope`); conduta (ID: `keyterm:Behavior`); igreja (ID: `keyterm:Church`); hipocrisia (ID: `keyterm:Hypocrisy`); opposite of holy: profane (ID: `keyterm:Profane`); pureza (ID: `keyterm:WithoutMoralDefect`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); consciência (ID: `keyterm:Conscience`); consecration (ID: `keyterm:Consecration.2`); rogar (ID: `keyterm:AskFor`); salvador (ID: `keyterm:Savior`); be (or show oneself) just (ID: `keyterm:Just`); love (ID: `keyterm:Love`); proclamar (ID: `keyterm:Proclaim`); salvation (ID: `keyterm:Salvation`); intercessão (ID: `keyterm:Intercession`); corpo (ID: `keyterm:Body.3`); Demons (ID: `deity:Demons`); promessa (ID: `keyterm:Promise`); Jesus (ID: `person:Jesus.2`); Spirit (ID: `keyterm:Spirit.2`); favor (ID: `keyterm:Favor`); An Angel (ID: `deity:Angel`); Capital (ID: `realia:Capital`)
...
* **Associated ACAI Concepts:** conduta (ID: `keyterm:Behavior`); igreja (ID: `keyterm:Church`); Life (ID: `keyterm:Life`); Truth (ID: `keyterm:Truth`); SENHOR (ID: `deity:Lord`); Capital (ID: `realia:Capital`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); be (or show oneself) just (ID: `keyterm:Just`); Spirit (ID: `keyterm:Spirit.2`); crer (ID: `keyterm:Believe`); proclamar (ID: `keyterm:Proclaim`); Glory (ID: `keyterm:Glory`); An Angel (ID: `deity:Angel`); Holy Spirit (ID: `deity:HolySpirit`); corpo (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Demons (ID: `deity:Demons`); hipocrisia (ID: `keyterm:Hypocrisy`); Faithfulness (ID: `keyterm:Faithfulness`); intercessão (ID: `keyterm:Intercession`); crer (ID: `keyterm:Believe`); consciência (ID: `keyterm:Conscience`); Truth (ID: `keyterm:Truth`); consecration (ID: `keyterm:Consecration.2`); Holy Spirit (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** Faithfulness (ID: `keyterm:Faithfulness`); Life (ID: `keyterm:Life`); crer (ID: `keyterm:Believe`); promessa (ID: `keyterm:Promise`); Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); favor (ID: `keyterm:Favor`); opposite of holy: profane (ID: `keyterm:Profane`); love (ID: `keyterm:Love`); pureza (ID: `keyterm:WithoutMoralDefect`); salvation (ID: `keyterm:Salvation`); SENHOR (ID: `deity:Lord`); salvador (ID: `keyterm:Savior`); hope (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Faithfulness (ID: `keyterm:Faithfulness`); rogar (ID: `keyterm:AskFor`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); juízo (ID: `keyterm:Judgment`); inútil (ID: `keyterm:Idle`); igreja (ID: `keyterm:Church`); pureza (ID: `keyterm:WithoutMoralDefect`); Satanás (ID: `deity:Satan`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); testemunhar (ID: `keyterm:BearWitness`); pure (ID: `keyterm:Pure`); blasfemar (ID: `keyterm:Blaspheme`); servir como escravo (ID: `keyterm:Serve.2`); testemunhar solenemente (ID: `keyterm:Declare`); fear (ID: `keyterm:Fear`); irrepreensível (ID: `keyterm:BeyondReproach`); escolhido (ID: `keyterm:Chosen`); Life (ID: `keyterm:Life`); Good (ID: `keyterm:Good`); Name (ID: `keyterm:Name`); amado (ID: `keyterm:Beloved`); tribunal de justiça (ID: `keyterm:CourtCase`); be unfaithful (ID: `keyterm:Unfaithful`); compartilhar (ID: `keyterm:Share`); orar (ID: `keyterm:Pray`); holy (ID: `keyterm:Holy`); preconceito (ID: `keyterm:Discrimination`); An Angel (ID: `deity:Angel`); witness (ID: `keyterm:Witness`); escritura (ID: `keyterm:Scripture`); hope (ID: `keyterm:Hope`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Yoke (ID: `realia:Yoke`); Grain (ID: `flora:Grain`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); inútil (ID: `keyterm:Idle`); irrepreensível (ID: `keyterm:BeyondReproach`); igreja (ID: `keyterm:Church`); Jesus (ID: `person:Jesus.2`); holy (ID: `keyterm:Holy`); testemunhar (ID: `keyterm:BearWitness`); Life (ID: `keyterm:Life`); Good (ID: `keyterm:Good`); Faithfulness (ID: `keyterm:Faithfulness`); juízo (ID: `keyterm:Judgment`); Satanás (ID: `deity:Satan`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); be unfaithful (ID: `keyterm:Unfaithful`); orar (ID: `keyterm:Pray`); hope (ID: `keyterm:Hope`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** juízo (ID: `keyterm:Judgment`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** inútil (ID: `keyterm:Idle`); Jesus (ID: `person:Jesus.2`); juízo (ID: `keyterm:Judgment`); crer (ID: `keyterm:Believe`); Satanás (ID: `deity:Satan`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); Jesus (ID: `person:Jesus.2`); escolhido (ID: `keyterm:Chosen`); pure (ID: `keyterm:Pure`); tribunal de justiça (ID: `keyterm:CourtCase`); juízo (ID: `keyterm:Judgment`); compartilhar (ID: `keyterm:Share`); preconceito (ID: `keyterm:Discrimination`); An Angel (ID: `deity:Angel`); witness (ID: `keyterm:Witness`); testemunhar solenemente (ID: `keyterm:Declare`); escritura (ID: `keyterm:Scripture`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Wine (ID: `realia:Wine`); Grain (ID: `flora:Grain`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); escolhido (ID: `keyterm:Chosen`); To Sin (ID: `keyterm:Sin`); preconceito (ID: `keyterm:Discrimination`); An Angel (ID: `deity:Angel`); witness (ID: `keyterm:Witness`); testemunhar solenemente (ID: `keyterm:Declare`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); escolhido (ID: `keyterm:Chosen`); preconceito (ID: `keyterm:Discrimination`); An Angel (ID: `deity:Angel`); testemunhar solenemente (ID: `keyterm:Declare`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); Bring In (ID: `keyterm:BringIn`); tentar (ID: `keyterm:PutToTheTest`); Faithfulness (ID: `keyterm:Faithfulness`); crer (ID: `keyterm:Believe`); amado (ID: `keyterm:Beloved`); Truth (ID: `keyterm:Truth`); blasfemar (ID: `keyterm:Blaspheme`); servir como escravo (ID: `keyterm:Serve.2`); rogar (ID: `keyterm:AskFor`); amor ao dinheiro (ID: `keyterm:LoveOfMoney`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); para a eternidade (ID: `keyterm:Always`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); Make Alive (ID: `keyterm:Alive`); Foolish (ID: `keyterm:Foolish`); Do Good (ID: `keyterm:DoGood`); tentar (ID: `keyterm:PutToTheTest`); Faithfulness (ID: `keyterm:Faithfulness`); opposite of holy: profane (ID: `keyterm:Profane`); bem, aventurado (ID: `keyterm:Happy`); surely! (ID: `keyterm:Surely`); testemunhar (ID: `keyterm:BearWitness`); blasfemar (ID: `keyterm:Blaspheme`); servir como escravo (ID: `keyterm:Serve.2`); Commandment (ID: `keyterm:Commandment`); rogar (ID: `keyterm:AskFor`); irrepreensível (ID: `keyterm:BeyondReproach`); be (or show oneself) just (ID: `keyterm:Just`); Bring In (ID: `keyterm:BringIn`); sem mancha (ID: `keyterm:AboveCriticism`); love (ID: `keyterm:Love`); amado (ID: `keyterm:Beloved`); Pilatos (ID: `person:Pilate`); amor ao dinheiro (ID: `keyterm:LoveOfMoney`); Timóteo (ID: `person:Timothy`); promessa (ID: `keyterm:Promise`); favor (ID: `keyterm:Favor`); generoso (ID: `keyterm:WillingToShare`); Truth (ID: `keyterm:Truth`); witness (ID: `keyterm:Witness`); hope (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); para a eternidade (ID: `keyterm:Always`); Make Alive (ID: `keyterm:Alive`); irrepreensível (ID: `keyterm:BeyondReproach`); be (or show oneself) just (ID: `keyterm:Just`); surely! (ID: `keyterm:Surely`); testemunhar (ID: `keyterm:BearWitness`); Life (ID: `keyterm:Life`); sem mancha (ID: `keyterm:AboveCriticism`); love (ID: `keyterm:Love`); Pilatos (ID: `person:Pilate`); bem, aventurado (ID: `keyterm:Happy`); witness (ID: `keyterm:Witness`); Commandment (ID: `keyterm:Commandment`)
...
* **Associated ACAI Concepts:** irrepreensível (ID: `keyterm:BeyondReproach`); Jesus (ID: `person:Jesus.2`); Commandment (ID: `keyterm:Commandment`); sem mancha (ID: `keyterm:AboveCriticism`)
...
* **Associated ACAI Concepts:** Do Good (ID: `keyterm:DoGood`); Ability (ID: `keyterm:Ability`); generoso (ID: `keyterm:WillingToShare`); para a eternidade (ID: `keyterm:Always`); SENHOR (ID: `deity:Lord`); hope (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** Do Good (ID: `keyterm:DoGood`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); generoso (ID: `keyterm:WillingToShare`); para a eternidade (ID: `keyterm:Always`); SENHOR (ID: `deity:Lord`); hope (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** Foolish (ID: `keyterm:Foolish`); promessa (ID: `keyterm:Promise`); favor (ID: `keyterm:Favor`); opposite of holy: profane (ID: `keyterm:Profane`); crer (ID: `keyterm:Believe`); Timóteo (ID: `person:Timothy`)
