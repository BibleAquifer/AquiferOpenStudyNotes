...
* **Associated ACAI Concepts:** Edom (ID: `place:Edom`); SENHOR (ID: `deity:Lord`); Understanding (ID: `keyterm:Understanding`); Monte de Esaú (ID: `place:EsauMount`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); lot (ID: `keyterm:Lot`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Edom (ID: `place:Edom`); dispossess (ID: `keyterm:Dispossess`); Edomites (ID: `group:Edom`); Jerusalém (ID: `place:Jerusalem`); José (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`); SENHOR (ID: `deity:Lord`); José (ID: `person:Joseph.10`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Sarepta (ID: `place:Zarephath`); Monte de Esaú (ID: `place:EsauMount`); Filístia (ID: `place:Philistine`); Samaria (ID: `place:Samaria`); Sefalá (ID: `place:Shephelah`); Benjamim (ID: `group:Benjamin`); Canaã (ID: `place:Canaan`); Jerusalém (ID: `place:Jerusalem`); cananeu (ID: `group:Canaan`); Benjamim (ID: `person:Benjamin`); Filisteu (ID: `group:Philistine`); Sardes (ID: `place:Sardis`); Gileade (ID: `place:Gilead`); Efraim (ID: `person:Ephraim`); Efraim (ID: `group:Ephraim`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Monte de Esaú (ID: `place:EsauMount`); Jerusalém (ID: `place:Jerusalem`); Sefalá (ID: `place:Shephelah`); Filisteu (ID: `group:Philistine`); Benjamim (ID: `group:Benjamin`); Canaã (ID: `place:Canaan`); cananeu (ID: `group:Canaan`); Benjamim (ID: `person:Benjamin`); Sarepta (ID: `place:Zarephath`); Gileade (ID: `place:Gilead`); Efraim (ID: `person:Ephraim`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Sardes (ID: `place:Sardis`); Filístia (ID: `place:Philistine`); Samaria (ID: `place:Samaria`); Efraim (ID: `group:Ephraim`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Canaã (ID: `place:Canaan`); Jerusalém (ID: `place:Jerusalem`); cananeu (ID: `group:Canaan`); Sardes (ID: `place:Sardis`); Sarepta (ID: `place:Zarephath`); Israel (ID: `person:Israel`)
