...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Holy (ID: `keyterm:Holy`); Believe (ID: `keyterm:Believe`); يَسوع (ID: `person:Jesus.2`); Pray (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); ٱلرَّبِّ (ID: `deity:Lord`); Ask for (ID: `keyterm:AskFor`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Affection (ID: `keyterm:Affection`); Fellowship (ID: `keyterm:Fellowship`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Ask for (ID: `keyterm:AskFor`); بولسَ (ID: `person:Paul`); Love (ID: `keyterm:Love`); In Christ (ID: `keyterm:InChrist`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); لوقَا (ID: `person:Luke`); أَبَفْرَاسَ (ID: `person:Epaphras`); دِيمَاس (ID: `person:Demas`); مَرْقسَ (ID: `person:Mark`); أَرِسْتَرْخسَ (ID: `person:Aristarchus`); Favor (ID: `keyterm:Favor`); In Christ (ID: `keyterm:InChrist`); Spirit (ID: `keyterm:Spirit.2`)
