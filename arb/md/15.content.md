...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`); إِرْمِيَا (ID: `person:Jeremiah.6`); Word of the Lord (ID: `keyterm:WordOfTheLord`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `group:Judah`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `group:Benjamin`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `person:Benjamin`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `group:Judah`); زَربَّابِل (ID: `person:Zerubbabel.2`); كورَشَ (ID: `person:Cyrus`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `group:Levi`); سلَيْمَانَ (ID: `person:Solomon`); لَّاوِي (ID: `person:Levi.3`); بِيسَايَ (ID: `person:Besai`); لَبَانَةَ (ID: `person:Lebanah`); نَصِيحَ (ID: `person:Neziah`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); ثَامَحَ (ID: `person:Temah`); بِغْوَايَ (ID: `person:Bigvai.2`); أَسْنَةَ (ID: `person:Asnah`); Tel-melah (ID: `place:Tel-melah`); رَعْلَايَا (ID: `person:Reelaiah`); دَرْقونَ (ID: `person:Darkon`); بَانِيَ (ID: `person:Bani`); حَسوفَا (ID: `person:Hasupha`); جَزَّامَ (ID: `person:Gazzam`); طَبَاعوتَ (ID: `person:Tabbaoth`); عَرْجَدَ (ID: `person:Azgad`); حَرْشَا (ID: `person:Harsha`); آرَحَ (ID: `person:Arah.2`); آطِيرَ (ID: `person:Ater`); Tel-harsha (ID: `place:Tel-harsha`); جَدِّيلَ (ID: `person:Giddel`); حَقوفَا (ID: `person:Hakupha`); مَغْبِيشَ (ID: `place:Magbish`); فَرْعوشَ (ID: `person:Parosh`); Nephushesim (ID: `group:Nephushesim`)
...
* **Associated ACAI Concepts:** بِلْشَان (ID: `person:Bilshan`); مرْدَخَاي (ID: `person:Mordecai`); بِغْوَايَ (ID: `person:Bigvai`); سَرَايَا (ID: `person:Seraiah.6`); بَعْنَةَ (ID: `person:Baanah.3`); رَعْلَايَا (ID: `person:Reelaiah`); مِسْفَار (ID: `person:Mispar`); نَحَمْيَا (ID: `person:Nehemiah`); رَحوم (ID: `person:Rehum`); زَربَّابِل (ID: `person:Zerubbabel.2`); إِسْرَائِيلَ (ID: `person:Israel`); يَشوع (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** فَرْعوشَ (ID: `person:Parosh`); زَتّو (ID: `person:Zattu.2`); يوآب (ID: `person:Joab.3`); يورَةَ (ID: `person:Jorah`); عَادِينَ (ID: `person:Adin`); بَابَايَ (ID: `person:Bebai`); بِغْوَايَ (ID: `person:Bigvai.2`); بِيصَايَ (ID: `person:Bezai`); بَانِيَ (ID: `person:Bani`); حَشوم (ID: `person:Hashum`); أَدونِيقَامَ (ID: `person:Adonikam`); شَفَطْيَا (ID: `person:Shephatiah.6`); عَرْجَدَ (ID: `person:Azgad`); عِيلَامَ (ID: `person:Elam`); Pahath-moab (ID: `person:Pahath-moab`); زَكَّايَ (ID: `person:Zaccai.2`); يَشوعَ (ID: `person:Jeshua.3`); حَزَقِيَّا (ID: `person:Hezekiah.2`); آرَحَ (ID: `person:Arah.2`); آطِيرَ (ID: `person:Ater`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** مَغْبِيشَ (ID: `place:Magbish`); حَادِيدَ (ID: `place:Hadid`); سَنَاءَةَ (ID: `place:Senaah`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); حَارِيمَ (ID: `person:Harim.2`); نَبو (ID: `place:Nebo.2`); Beth-azmaveth (ID: `place:Beth-azmaveth`); بَئِيروت (ID: `place:Beeroth`); أونوَ (ID: `place:Ono`); وَلودَ (ID: `place:Lod`); أَرِيحَا (ID: `place:Jericho`); عَايٍ (ID: `place:Ai`); مِنْ (ID: `place:Geba`); لَحْمٍ (ID: `place:Bethlehem`); Ramah (ID: `place:Ramah.2`); Kiriath-jearim (ID: `place:Kiriath-jearim`); عَنَاثوثَ (ID: `place:Anathoth`); ٱلْكَفِيرَة (ID: `place:Chephirah`); عِيلَامَ (ID: `person:Elam`); Bethel (ID: `place:Bethel`); مِخْمَاسَ (ID: `place:Michmash`)
...
* **Associated ACAI Concepts:** لِإِيمِيرَ (ID: `person:Immer.2`); هودَوْيَا (ID: `person:Hodaviah.4`); يَشوعَ (ID: `person:Jeshua`); طَلْمون (ID: `person:Talmon`); يَدَايَا (ID: `person:Jedaiah.4`); آطِيرَ (ID: `person:Ater.2`); يَشوعَ (ID: `person:Jeshua.4`); حَارِيمَ (ID: `person:Harim`); شوبَايَ (ID: `person:Shobai`); حَطِيطَا (ID: `person:Hatita`); لَّاوِي (ID: `person:Levi.3`); شَلّوم (ID: `person:Shallum.8`); لَّاوِي (ID: `group:Levi`); فَشْحور (ID: `person:Pashhur`); عَقّوب (ID: `person:Akkub.2`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); آسَاف (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** طَلْمون (ID: `person:Talmon`); آطِيرَ (ID: `person:Ater.2`); شوبَايَ (ID: `person:Shobai`); حَطِيطَا (ID: `person:Hatita`); شَلّوم (ID: `person:Shallum.8`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** حَقوفَا (ID: `person:Hakupha`); جَدِّيلَ (ID: `person:Giddel`); فَاسِيحَ (ID: `person:Paseah.2`); Meunim (ID: `group:Meunim`); بِيسَايَ (ID: `person:Besai`); لَبَانَةَ (ID: `person:Lebanah`); Nephushesim (ID: `group:Nephushesim`); نَقودَا (ID: `person:Nekoda`); نَصِيحَ (ID: `person:Neziah`); عَقّوب (ID: `person:Akkub.3`); حَاجَابَ (ID: `person:Hagab`); سَلْمَايَ (ID: `person:Shalmai`); بَقْبوقَ (ID: `person:Bakbuk`); بَصْلوتَ (ID: `person:Bazluth`); سِيسَرَا (ID: `person:Sisera.2`); بَرْقوسَ (ID: `person:Barkos`); رَصِينَ (ID: `person:Rezin.2`); حَانَان (ID: `person:Hanan.4`); ثَامَحَ (ID: `person:Temah`); فَادونَ (ID: `person:Padon`); أَسْنَةَ (ID: `person:Asnah`); صِيحَا (ID: `person:Ziha`); حَرْحورَ (ID: `person:Harhur`); سِيعَهَا (ID: `person:Siaha`); حَطِيفَا (ID: `person:Hatipha`); فِي (ID: `person:Uzza.2`); حَسوفَا (ID: `person:Hasupha`); رَآيَا (ID: `person:Reaiah.3`); قِيروسَ (ID: `person:Keros`); جَزَّامَ (ID: `person:Gazzam`); طَبَاعوتَ (ID: `person:Tabbaoth`); مَحِيدَا (ID: `person:Mehida`); حَجَابَةَ (ID: `person:Hagabah`); حَرْشَا (ID: `person:Harsha`); جَاحَرَ (ID: `person:Gahar`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); جَدِّيلَ (ID: `person:Giddel.2`); آمِي (ID: `person:Ami`); سوفَرَثَ (ID: `person:Sophereth`); فَرودَا (ID: `person:Peruda`); سَوْطَايَ (ID: `person:Sotai`); شَفَطْيَا (ID: `person:Shephatiah.7`); دَرْقونَ (ID: `person:Darkon`); حَطِّيلَ (ID: `person:Hattil`); يَعْلَةَ (ID: `person:Jaalah`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`)
...
* **Associated ACAI Concepts:** Tel-harsha (ID: `place:Tel-harsha`); نَقودَا (ID: `person:Nekoda.2`); لِإِيمِيرَ (ID: `place:Immer`); Tel-melah (ID: `place:Tel-melah`); كَروب (ID: `place:Cherub`); لِدَلَايَا (ID: `person:Delaiah.3`); أَدَّان (ID: `place:Addan`); طوبِيَّا (ID: `person:Tobiah`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** حَبَايَا (ID: `person:Habaiah`); بَرْزِلَّايَ (ID: `person:Barzillai.3`); هَقّوصَ (ID: `person:Hakkoz.2`); جِلْعَادَ (ID: `place:Gilead`); Gileadites (ID: `group:Gilead`); بَرْزِلَّايَ (ID: `person:Barzillai`); Priesthood (ID: `keyterm:Priesthood`); Defile (ID: `keyterm:Stain`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); يَشوع (ID: `person:Joshua.5`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); يَشوعَ (ID: `person:Jeshua.4`); Esarhaddon (ID: `person:Esarhaddon`); حِينَادَادَ (ID: `person:Henadad`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); Relatives (ID: `group:Relatives`); هودَوْيَا (ID: `person:Hodaviah.4`); Tyrians (ID: `group:Tyre`); Instruction (ID: `keyterm:Instruction`); هودِيَّا (ID: `person:Hodiah.2`); Terror (ID: `keyterm:Terror`); دَارِيوسَ (ID: `person:Darius.2`); صورَ (ID: `place:Tyre`); Holy (ID: `keyterm:Holy`); صِيْدونَ (ID: `place:Sidon`); Kindness (ID: `keyterm:Kindness`); موسَى (ID: `person:Moses`); دَاودَ (ID: `person:David`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Sidonians (ID: `group:Sidon`); بَنْيَامِينَ (ID: `group:Benjamin`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Assyria (ID: `place:Assyria`); Counsel (ID: `keyterm:Counsel`); Appointed Feast (ID: `keyterm:AppointedFeast`); يَافَا (ID: `place:Joppa`); بَنْيَامِينَ (ID: `person:Benjamin`); لبْنَانَ (ID: `place:Lebanon`); آسَاف (ID: `person:Asaph.2`); Cedar (ID: `flora:Cedar`); Cymbals (ID: `realia:Cymbals`); Craftsman (ID: `realia:Craftsman`); Anointing Oil (ID: `realia:AnointingOil`); Trumpet (ID: `realia:Trumpet`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); Instruction (ID: `keyterm:Instruction`); موسَى (ID: `person:Moses`); Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); Terror (ID: `keyterm:Terror`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** فَارِسَ (ID: `place:Persia`); Tyrians (ID: `group:Tyre`); صِيْدونَ (ID: `place:Sidon`); يَافَا (ID: `place:Joppa`); كورَشَ (ID: `person:Cyrus`); لبْنَانَ (ID: `place:Lebanon`); Sidonians (ID: `group:Sidon`); صورَ (ID: `place:Tyre`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); يَشوع (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `person:Levi.3`); Kindness (ID: `keyterm:Kindness`); لَّاوِي (ID: `group:Levi`); دَاودَ (ID: `person:David`); آسَاف (ID: `person:Asaph.2`); House (ID: `realia:House`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `group:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `person:Benjamin`); يَهوذَا (ID: `group:Judah`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); فَارِسَ (ID: `place:Persia`); ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); كورَشَ (ID: `person:Cyrus`); إِسْرَائِيلَ (ID: `person:Israel`); يَشوع (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); فَارِسَ (ID: `place:Persia`); ٱلسَّامِرَةِ (ID: `place:Samaria`); أسْنَفَّر (ID: `person:Osnappar`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); مِثْرَدَاث (ID: `person:Mithredath.2`); Babylonians (ID: `group:Babylon`); أَرَكَ (ID: `place:Erech`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); طَبْئِيل (ID: `person:Tabeel`); بِشْلَام (ID: `person:Bishlam`); يَهوذَا (ID: `person:Judah.4`); عِيلَامَ (ID: `place:Elam`); يَهوذَا (ID: `group:Judah`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); فِي (ID: `place:Susa`); بَابِلَ (ID: `place:Babylon`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** أَرَكَ (ID: `place:Erech`); رَحوم (ID: `person:Rehum.2`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); شِمْشَاي (ID: `person:Shimshai`); Babylonians (ID: `group:Babylon`); فَارِسَ (ID: `place:Persia`); Persians (ID: `group:Persia`); فِي (ID: `place:Susa`); Elamites (ID: `group:Elam`); بَابِلَ (ID: `place:Babylon`); عِيلَامَ (ID: `place:Elam`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلسَّامِرَةِ (ID: `place:Samaria`); رَحوم (ID: `person:Rehum.2`); Jews (ID: `group:Jews`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); دَارِيوسَ (ID: `person:Darius.2`); تَتْنَاي (ID: `person:Tattenai`); حَجَّيِ (ID: `person:Haggai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); زَكَرِيَّا (ID: `person:Zechariah.17`); يَدّو (ID: `person:Iddo.6`); فَارِسَ (ID: `place:Persia`); ٱلْفرَاتِ (ID: `place:Euphrates`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); يَشوع (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** حَجَّيِ (ID: `person:Haggai`); يَدّو (ID: `person:Iddo.6`); زَكَرِيَّا (ID: `person:Zechariah.17`); Jews (ID: `group:Jews`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); أورشَلِيمَ (ID: `place:Jerusalem`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَشوع (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); أورشَلِيمَ (ID: `place:Jerusalem`); بَابِلَ (ID: `place:Babylon`); كورَشَ (ID: `person:Cyrus`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); دَارِيوسَ (ID: `person:Darius.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); تَتْنَاي (ID: `person:Tattenai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); ٱلْفرَاتِ (ID: `place:Euphrates`); Chaldeans (ID: `group:Chaldea`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); Money (ID: `realia:Money`); Foundation (ID: `realia:Foundation`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); أورشَلِيمَ (ID: `place:Jerusalem`); Foundation (ID: `realia:Foundation`); House (ID: `realia:House`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** عَزَرْيَا (ID: `person:Azariah.7`); سَرَايَا (ID: `person:Seraiah.2`); عَزْرَا (ID: `person:Ezra`); حِلْقِيَّا (ID: `person:Hilkiah.2`); فَارِسَ (ID: `place:Persia`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); زَرَحْيَا (ID: `person:Zerahiah`); صَادوق (ID: `person:Zadok.4`); عَزَرْيَا (ID: `person:Azariah.7`); أَمَرْيَا (ID: `person:Amariah.2`); لِمَرَايوثَ (ID: `person:Meraioth`); بقِّي (ID: `person:Bukki.2`); أَخِيطوبَ (ID: `person:Ahitub.3`); أَبِيشوعَ (ID: `person:Abishua`); شَلّوم (ID: `person:Shallum.7`); سَرَايَا (ID: `person:Seraiah.2`); عزِّي (ID: `person:Uzzi`); عَزَرْيَا (ID: `person:Azariah.6`); حِلْقِيَّا (ID: `person:Hilkiah.2`); فِينَحَاس (ID: `person:Phinehas`); هَارون (ID: `person:Aaron`); أَلِعَازَار (ID: `person:Eleazar.2`); فَارِسَ (ID: `place:Persia`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** Decree (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`); ٱلرَّبِّ (ID: `deity:Lord`); عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); عَزْرَا (ID: `person:Ezra`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`); Wheat (ID: `flora:Wheat`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Kor (ID: `realia:Kor`)
...
* **Associated ACAI Concepts:** يَحْزِيئِيل (ID: `person:Jahaziel.5`); زَرَحْيَا (ID: `person:Zerahiah.2`); هِقَّاطَانَ (ID: `person:Hakkatan`); يونَاثَانَ (ID: `person:Jonathan.9`); أَلِيفَلَط (ID: `person:Eliphelet.5`); يَعِيئِيل (ID: `person:Jeuel.3`); عوبَدْيَا (ID: `person:Obadiah.10`); فَرْعوشَ (ID: `person:Parosh.2`); بَابَايَ (ID: `person:Bebai.2`); عَثَلْيَا (ID: `person:Athaliah.3`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); عَابِد (ID: `person:Ebed.2`); عَادِينَ (ID: `person:Adin`); زَكَرِيَّا (ID: `person:Zechariah.18`); حَطّوش (ID: `person:Hattush.2`); Gershom (ID: `person:Gershom.2`); يَحِيئِيل (ID: `person:Jehiel.7`); بَابَايَ (ID: `person:Bebai`); بِغْوَايَ (ID: `person:Bigvai.2`); يوشَفْيَا (ID: `person:Josiphiah`); زَكّور (ID: `person:Zaccur.5`); يوحَانَانَ (ID: `person:Johanan.8`); يِشْعِيَا (ID: `person:Jeshaiah.4`); شَكَنْيَا (ID: `person:Shecaniah.5`); يوآب (ID: `person:Joab.4`); دَانِيآل (ID: `person:Daniel.2`); أَدونِيقَامَ (ID: `person:Adonikam`); عوتَاي (ID: `person:Uthai.2`); شِمْعِيَا (ID: `person:Shemaiah.14`); شَلومِيَةَ (ID: `person:Shelomith.4`); عَرْجَدَ (ID: `person:Azgad`); عِيلَامَ (ID: `person:Elam`); شَفَطْيَا (ID: `person:Shephatiah.6`); مِيخَائِيلَ (ID: `person:Michael.10`); زَكَرِيَّا (ID: `person:Zechariah.19`); Pahath-moab (ID: `person:Pahath-moab`); شَكَنْيَا (ID: `person:Shecaniah.6`); زَبَدْيَا (ID: `person:Zebadiah.8`); فِينَحَاس (ID: `person:Phinehas`); إِيثَامَارَ (ID: `person:Ithamar`); دَاودَ (ID: `person:David`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); بَابِلَ (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** أَرِيئِيلَ (ID: `person:Ariel`); أَلِيعَزَرَ (ID: `person:Eliezer.8`); زَكَرِيَّا (ID: `person:Zechariah.20`); يَارِيبَ (ID: `person:Jarib.2`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); مَشلَّام (ID: `person:Meshullam.9`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); يَدّو (ID: `person:Iddo`); نَاثَان (ID: `person:Nathan.5`); ٱلْمسَمَّى (ID: `place:Casiphia`); شِمْعِيَا (ID: `person:Shemaiah.15`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); يويَارِيبَ (ID: `person:Joiarib.2`); Perceive (ID: `keyterm:Perceive`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); مَحْلِي (ID: `person:Mahli`); Insight (ID: `keyterm:Insight`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); دَاودَ (ID: `person:David`); Work (ID: `keyterm:Work`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); مِصْرَ (ID: `place:Egypt`); لَّاوِي (ID: `person:Levi.3`); Canaanites (ID: `group:Canaan`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); لَّاوِي (ID: `group:Levi`); Be Unfaithful (ID: `keyterm:Unfaithful`); موآبَ (ID: `place:Moab`); إِسْرَائِيلَ (ID: `person:Israel`); كَنْعَان (ID: `place:Canaan`); Amorites (ID: `group:Amorites`); Egyptians (ID: `group:Egypt`); Ammonites (ID: `group:Ammon`); Jebusites (ID: `group:Jebusites`); حِثًّا (ID: `person:Heth`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); Offering (ID: `keyterm:Offering`); يَهوذَا (ID: `person:Judah.4`); Counsel (ID: `keyterm:Counsel`); يَهوذَا (ID: `group:Judah`); عِيلَامَ (ID: `person:Elam`); أَلِيفَلَط (ID: `person:Eliphelet.6`); يِشِّيَّا (ID: `person:Isshijah`); كَلَال (ID: `person:Chelal`); بَنّويَ (ID: `person:Binnui.4`); شِمْعِيَا (ID: `person:Shemaiah.16`); نَثَنْئِيل (ID: `person:Nethanel.8`); شِمْعِيَا (ID: `person:Shemaiah.17`); شِمْعون (ID: `person:Shimeon`); شَلَمْيَا (ID: `person:Shelemiah.3`); يَرِيموت (ID: `person:Jeremoth.4`); زَابَادَ (ID: `person:Zabad.5`); يَهونَاثَان (ID: `person:Jehohanan.4`); فَتَحْيَا (ID: `person:Pethahiah.2`); مِيَّامِين (ID: `person:Mijamin.2`); مَعْسِيَّا (ID: `person:Maaseiah.8`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); فَارِسَ (ID: `place:Persia`); Defilement (ID: `keyterm:Defilement`); Plea for Mercy (ID: `keyterm:Supplication`); Kindness (ID: `keyterm:Kindness`); Dispossess (ID: `keyterm:Dispossess`); Peace (ID: `keyterm:IntactState`); To Cause to Possess (ID: `keyterm:Possess`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); فَارِسَ (ID: `place:Persia`); Kindness (ID: `keyterm:Kindness`); Plea for Mercy (ID: `keyterm:Supplication`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** يَحِيئِيل (ID: `person:Jehiel.8`); شَكَنْيَا (ID: `person:Shecaniah.7`); عِيلَامَ (ID: `person:Elam`); ٱلرَّبِّ (ID: `deity:Lord`); عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); Be Unfaithful (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** Swear (ID: `keyterm:Swear`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `group:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `person:Benjamin`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** تِقْوَةَ (ID: `person:Tikvah.2`); شَبْتَاي (ID: `person:Shabbethai`); يونَاثَانَ (ID: `person:Jonathan.10`); عَسَائِيل (ID: `person:Asahel.4`); مَشلَّام (ID: `person:Meshullam.10`); يَحْزِيَا (ID: `person:Jahzeiah`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`)
