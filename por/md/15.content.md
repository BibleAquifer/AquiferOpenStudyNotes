...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`); Pérsia (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); Money (ID: `realia:Money`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `group:Benjamin`); Judá (ID: `group:Judah`); Benjamim (ID: `person:Benjamin`); Levi (ID: `person:Levi.3`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`); Levi (ID: `group:Levi`); Money (ID: `realia:Money`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Ciro (ID: `person:Cyrus`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Pérsia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Salomão (ID: `person:Solomon`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Tel-Melá (ID: `place:Tel-melah`); Necoda (ID: `person:Nekoda.2`); Ater (ID: `person:Ater.2`); Imer (ID: `person:Immer.2`); Reaías (ID: `person:Reaiah.3`); Querube (ID: `place:Cherub`); Gidel (ID: `person:Giddel.2`); Baana (ID: `person:Baanah.3`); Delaías (ID: `person:Delaiah.3`); Zacai (ID: `person:Zaccai.2`); Gazão (ID: `person:Gazzam`); Sotai (ID: `person:Sotai`); Reum (ID: `person:Rehum`); Adim (ID: `person:Adin`); Temá (ID: `person:Temah`); Habaiah (ID: `person:Habaiah`); Nebo (ID: `place:Nebo.2`); Ará (ID: `person:Arah.2`); Mispar (ID: `person:Mispar`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Hacufa (ID: `person:Hakupha`); Lebana (ID: `person:Lebanah`); Queros (ID: `person:Keros`); Ezequias (ID: `person:Hezekiah.2`)
...
* **Associated ACAI Concepts:** Bilsã (ID: `person:Bilshan`); Mispar (ID: `person:Mispar`); Reelaías (ID: `person:Reelaiah`); Seraias (ID: `person:Seraiah.6`); Reum (ID: `person:Rehum`); Bigvai (ID: `person:Bigvai`); Baana (ID: `person:Baanah.3`); Neemias (ID: `person:Nehemiah`); Mordecai (ID: `person:Mordecai`); Zorobabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`); Josué (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** Zatu (ID: `person:Zattu.2`); Sephatias (ID: `person:Shephatiah.6`); Ater (ID: `person:Ater`); Jora (ID: `person:Jorah`); Joabe (ID: `person:Joab.3`); Adonicão (ID: `person:Adonikam`); Bigvai (ID: `person:Bigvai.2`); Parós (ID: `person:Parosh`); Jesua (ID: `person:Jeshua.3`); Zacai (ID: `person:Zaccai.2`); Bezai (ID: `person:Bezai`); Hasum (ID: `person:Hashum`); Adim (ID: `person:Adin`); Bani (ID: `person:Bani`); Ará (ID: `person:Arah.2`); Asgade (ID: `person:Azgad`); Paate-Moabe (ID: `person:Pahath-moab`); Elam (ID: `person:Elam`); Ezequias (ID: `person:Hezekiah.2`); Bebai (ID: `person:Bebai`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Magbis (ID: `place:Magbish`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Senaa (ID: `place:Senaah`); Harim (ID: `person:Harim.2`); Hadide (ID: `place:Hadid`); Netofa (ID: `place:Netophah`); Nebo (ID: `place:Nebo.2`); Cefira (ID: `place:Chephirah`); Geba (ID: `place:Geba`); Anatote (ID: `place:Anathoth`); Ai (ID: `place:Ai`); Belém (ID: `place:Bethlehem`); Quiriate-Jearim (ID: `place:Kiriath-jearim`); Jericó (ID: `place:Jericho`); Lode (ID: `place:Lod`); Betel (ID: `place:Bethel`); Elam (ID: `person:Elam`); Micmás (ID: `place:Michmash`); Beerote (ID: `place:Beeroth`); Ono (ID: `place:Ono`); Ramah (ID: `place:Ramah.2`)
...
* **Associated ACAI Concepts:** Harim (ID: `person:Harim`); Jesua (ID: `person:Jeshua`); Jedaías (ID: `person:Jedaiah.4`); Sobai (ID: `person:Shobai`); Jesua (ID: `person:Jeshua.4`); Ater (ID: `person:Ater.2`); Imer (ID: `person:Immer.2`); Hatita (ID: `person:Hatita`); Talmom (ID: `person:Talmon`); Hodavias (ID: `person:Hodaviah.4`); Acube (ID: `person:Akkub.2`); Cadmiel (ID: `person:Kadmiel`); Asafe (ID: `person:Asaph.2`); Levi (ID: `person:Levi.3`); Salum (ID: `person:Shallum.8`); Pasur (ID: `person:Pashhur`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Sobai (ID: `person:Shobai`); Ater (ID: `person:Ater.2`); Hatita (ID: `person:Hatita`); Talmom (ID: `person:Talmon`); Acube (ID: `person:Akkub.2`); Asafe (ID: `person:Asaph.2`); Salum (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** Hatifa (ID: `person:Hatipha`); Harur (ID: `person:Harhur`); Asná (ID: `person:Asnah`); Nesias (ID: `person:Neziah`); Reaías (ID: `person:Reaiah.3`); Tabaote (ID: `person:Tabbaoth`); Gaar (ID: `person:Gahar`); Uza (ID: `person:Uzza.2`); Sisera (ID: `person:Sisera.2`); Sia (ID: `person:Siaha`); Hasufa (ID: `person:Hasupha`); Rezim (ID: `person:Rezin.2`); Barcos (ID: `person:Barkos`); Hagaba (ID: `person:Hagabah`); Zia (ID: `person:Ziha`); Baquebuque (ID: `person:Bakbuk`); Meída (ID: `person:Mehida`); Gazão (ID: `person:Gazzam`); Harsa (ID: `person:Harsha`); Salmai (ID: `person:Shalmai`); Hanã (ID: `person:Hanan.4`); Meunim (ID: `group:Meunim`); Temá (ID: `person:Temah`); Nephushesim (ID: `group:Nephushesim`); Hacufa (ID: `person:Hakupha`); Paseia (ID: `person:Paseah.2`); Lebana (ID: `person:Lebanah`); Hagabe (ID: `person:Hagab`); Queros (ID: `person:Keros`); Necoda (ID: `person:Nekoda`); Bazlite (ID: `person:Bazluth`); Besai (ID: `person:Besai`); Gidel (ID: `person:Giddel`); Padom (ID: `person:Padon`); Acube (ID: `person:Akkub.3`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Sotai (ID: `person:Sotai`); Ami (ID: `person:Ami`); Gidel (ID: `person:Giddel.2`); Hatil (ID: `person:Hattil`); Soferete (ID: `person:Sophereth`); Sephatias (ID: `person:Shephatiah.7`); Jaala (ID: `person:Jaalah`); Peruda (ID: `person:Peruda`); Darcom (ID: `person:Darkon`)
...
* **Associated ACAI Concepts:** Querube (ID: `place:Cherub`); Delaías (ID: `person:Delaiah.3`); Adã (ID: `place:Addan`); Tel-Melá (ID: `place:Tel-melah`); Necoda (ID: `person:Nekoda.2`); Imer (ID: `place:Immer`); Tel-Harsa (ID: `place:Tel-harsha`); Tobias (ID: `person:Tobiah`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Hacoz (ID: `person:Hakkoz.2`); Habaiah (ID: `person:Habaiah`); Barzillai (ID: `person:Barzillai.3`); Barzillai (ID: `person:Barzillai`); stain (ID: `keyterm:Stain`); priesthood (ID: `keyterm:Priesthood`); Gileade (ID: `place:Gilead`); Gileadites (ID: `group:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); Jerusalém (ID: `place:Jerusalem`); strength (ID: `keyterm:Strength`); SENHOR (ID: `deity:Lord`); Tunic (ID: `realia:Tunic`); House (ID: `realia:House`); Money (ID: `realia:Money`); Mina (ID: `realia:Mina`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Josué (ID: `person:Joshua.5`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Henadade (ID: `person:Henadad`); Jesua (ID: `person:Jeshua.4`); Esar-Hadom (ID: `person:Esarhaddon`); Cadmiel (ID: `person:Kadmiel`); Relatives (ID: `group:Relatives`); Hodavias (ID: `person:Hodaviah.4`); new moon festival (ID: `keyterm:NewMoonFestival`); Jope (ID: `place:Joppa`); Sidonians (ID: `group:Sidon`); Asafe (ID: `person:Asaph.2`); Assyria (ID: `place:Assyria`); terror (ID: `keyterm:Terror`); counsel (ID: `keyterm:Counsel`); Sidom (ID: `place:Sidon`); Benjamim (ID: `group:Benjamin`); Benjamim (ID: `person:Benjamin`); Instruction (ID: `keyterm:Instruction`); Davi (ID: `person:David`); Libano (ID: `place:Lebanon`); Tyrians (ID: `group:Tyre`); kindness (ID: `keyterm:Kindness`); holy (ID: `keyterm:Holy`); appointed feast (ID: `keyterm:AppointedFeast`); Dario (ID: `person:Darius.2`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); Tiro (ID: `place:Tyre`); Hodias (ID: `person:Hodiah.2`); Moisés (ID: `person:Moses`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Cymbals (ID: `realia:Cymbals`); Trumpet (ID: `realia:Trumpet`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); Moisés (ID: `person:Moses`); offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** terror (ID: `keyterm:Terror`); offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); new moon festival (ID: `keyterm:NewMoonFestival`); holy (ID: `keyterm:Holy`); appointed feast (ID: `keyterm:AppointedFeast`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Tyrians (ID: `group:Tyre`); Sidom (ID: `place:Sidon`); Sidonians (ID: `group:Sidon`); Tiro (ID: `place:Tyre`); Jope (ID: `place:Joppa`); Pérsia (ID: `place:Persia`); Libano (ID: `place:Lebanon`); Cedar (ID: `flora:Cedar`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Jerusalém (ID: `place:Jerusalem`); Josué (ID: `person:Joshua.5`); Levi (ID: `person:Levi.3`); Jeozadaque (ID: `person:Jehozadak`); SENHOR (ID: `deity:Lord`); Sealtiel (ID: `person:Shealtiel.2`); Levi (ID: `group:Levi`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); kindness (ID: `keyterm:Kindness`); Asafe (ID: `person:Asaph.2`); Levi (ID: `person:Levi.3`); Davi (ID: `person:David`); Levi (ID: `group:Levi`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Benjamim (ID: `group:Benjamin`); Judá (ID: `group:Judah`); Benjamim (ID: `person:Benjamin`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Ciro (ID: `person:Cyrus`); Zorobabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`); Josué (ID: `person:Joshua.5`); SENHOR (ID: `deity:Lord`); Pérsia (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Dario (ID: `person:Darius.2`); counsel (ID: `keyterm:Counsel`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Pérsia (ID: `place:Persia`); Jews (ID: `group:Jews`); Samaria (ID: `place:Samaria`); Osnapar (ID: `person:Osnappar`); Ereque (ID: `place:Erech`); Bislão (ID: `person:Bishlam`); Assuero (ID: `person:Ahasuerus`); Mitredate (ID: `person:Mithredath.2`); Tabeel (ID: `person:Tabeel`); Dinaítas (ID: `person:Dinaite`); Babylonians (ID: `group:Babylon`); Susã (ID: `place:Susa`); Elamites (ID: `group:Elam`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Babilônia (ID: `place:Babylon`); Elam (ID: `place:Elam`); Persians (ID: `group:Persia`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Dinaítas (ID: `person:Dinaite`); Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Ereque (ID: `place:Erech`); Babylonians (ID: `group:Babylon`); Susã (ID: `place:Susa`); Persians (ID: `group:Persia`); Babilônia (ID: `place:Babylon`); Elamites (ID: `group:Elam`); Pérsia (ID: `place:Persia`); Elam (ID: `place:Elam`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Artaxerxes (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Samaria (ID: `place:Samaria`); Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Dario (ID: `person:Darius.2`); Jews (ID: `group:Jews`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Tattenai (ID: `person:Tattenai`); Ido (ID: `person:Iddo.6`); Zacarias (ID: `person:Zechariah.17`); Ageu (ID: `person:Haggai`); Rio Eufrates (ID: `place:Euphrates`); Zorobabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Judá (ID: `person:Judah.4`); Pérsia (ID: `place:Persia`); Sealtiel (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** Ido (ID: `person:Iddo.6`); Zacarias (ID: `person:Zechariah.17`); Ageu (ID: `person:Haggai`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Jews (ID: `group:Jews`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Jerusalém (ID: `place:Jerusalem`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Jerusalém (ID: `place:Jerusalem`); Babilônia (ID: `place:Babylon`); Ciro (ID: `person:Cyrus`); Dario (ID: `person:Darius.2`); Zorobabel (ID: `person:Zerubbabel.2`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Tattenai (ID: `person:Tattenai`); Rio Eufrates (ID: `place:Euphrates`); Chaldeans (ID: `group:Chaldea`); Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); Caldéia (ID: `place:Chaldea`); Foundation (ID: `realia:Foundation`); Hewn Stone (ID: `realia:HewnStone`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Ciro (ID: `person:Cyrus`); Zorobabel (ID: `person:Zerubbabel.2`); Babilônia (ID: `place:Babylon`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); defilement (ID: `keyterm:Defilement`); Gentiles (ID: `group:Gentile`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Amarias (ID: `person:Amariah.2`); Buqui (ID: `person:Bukki.2`); Azarias (ID: `person:Azariah.6`); Azarias (ID: `person:Azariah.7`); Meraiote (ID: `person:Meraioth`); Salum (ID: `person:Shallum.7`); Seraias (ID: `person:Seraiah.2`); Zeraías (ID: `person:Zerahiah`); Abisua (ID: `person:Abishua`); Zadoque (ID: `person:Zadok.4`); Uzi (ID: `person:Uzzi`); Aitube (ID: `person:Ahitub.3`); Artaxerxes (ID: `person:Artaxerxes`); Arão (ID: `person:Aaron`); Pérsia (ID: `place:Persia`); Eleazar (ID: `person:Eleazar.2`); Hilquias (ID: `person:Hilkiah.2`); Fineias (ID: `person:Phinehas`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); Babilônia (ID: `place:Babylon`); Instruction (ID: `keyterm:Instruction`); Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Artaxerxes (ID: `person:Artaxerxes`); Ezra (ID: `person:Ezra`); Wheat (ID: `flora:Wheat`); Kor (ID: `realia:Kor`); Olive Oil (ID: `realia:OliveOil`); Talent (ID: `realia:Talent`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Bebai (ID: `person:Bebai.2`); Ebede (ID: `person:Ebed.2`); Hacatã (ID: `person:Hakkatan`); Sephatias (ID: `person:Shephatiah.6`); Daniel (ID: `person:Daniel.2`); Semaías (ID: `person:Shemaiah.14`); Gérson (ID: `person:Gershom.2`); Josifias (ID: `person:Josiphiah`); Adonicão (ID: `person:Adonikam`); Bigvai (ID: `person:Bigvai.2`); Zacur (ID: `person:Zaccur.5`); Zeraías (ID: `person:Zerahiah.2`); Joabe (ID: `person:Joab.4`); Hatus (ID: `person:Hattush.2`); Parós (ID: `person:Parosh.2`); Zabadias (ID: `person:Zebadiah.8`); Obadias (ID: `person:Obadiah.10`); Zacarias (ID: `person:Zechariah.18`); Secanias (ID: `person:Shecaniah.6`); Selomite (ID: `person:Shelomith.4`); Jaaziel (ID: `person:Jahaziel.5`); Elioenai (ID: `person:Eliehoenai.2`); Joanã (ID: `person:Johanan.8`); Jônatas (ID: `person:Jonathan.9`); Miguel (ID: `person:Michael.10`); Jesaías (ID: `person:Jeshaiah.4`); Secanias (ID: `person:Shecaniah.5`); Adim (ID: `person:Adin`); Zacarias (ID: `person:Zechariah.19`); Jeiel (ID: `person:Jehiel.7`); Asgade (ID: `person:Azgad`); Paate-Moabe (ID: `person:Pahath-moab`); Elam (ID: `person:Elam`); Utai (ID: `person:Uthai.2`); Jeuel (ID: `person:Jeuel.3`); Elifelete (ID: `person:Eliphelet.5`); Atalia (ID: `person:Athaliah.3`); Bebai (ID: `person:Bebai`); Artaxerxes (ID: `person:Artaxerxes`); Babilônia (ID: `place:Babylon`); Davi (ID: `person:David`); Itamar (ID: `person:Ithamar`); Fineias (ID: `person:Phinehas`)
...
* **Associated ACAI Concepts:** Ariel (ID: `person:Ariel`); Elnatã (ID: `person:Elnathan.3`); Ido (ID: `person:Iddo`); Eliezer (ID: `person:Eliezer.8`); Elnatã (ID: `person:Elnathan.4`); Natã (ID: `person:Nathan.5`); Joiaribe (ID: `person:Joiarib.2`); Semaías (ID: `person:Shemaiah.15`); Zacarias (ID: `person:Zechariah.20`); Elnatã (ID: `person:Elnathan.2`); Jaribe (ID: `person:Jarib.2`); Casifia (ID: `place:Casiphia`); Mesulão (ID: `person:Meshullam.9`); perceive (ID: `keyterm:Perceive`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); Mali (ID: `person:Mahli`); Israel (ID: `person:Israel`); Levi (ID: `person:Levi.3`); SENHOR (ID: `deity:Lord`); Levi (ID: `group:Levi`); Insight (ID: `keyterm:Insight`)
...
* **Associated ACAI Concepts:** Davi (ID: `person:David`); Levi (ID: `person:Levi.3`); work (ID: `keyterm:Work`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); be unfaithful (ID: `keyterm:Unfaithful`); Egito (ID: `place:Egypt`); cananeu (ID: `group:Canaan`); Jebusites (ID: `group:Jebusites`); Israel (ID: `person:Israel`); Amom (ID: `place:Ammon`); Egyptians (ID: `group:Egypt`); Levi (ID: `person:Levi.3`); Moabe (ID: `place:Moab`); Ammonites (ID: `group:Ammon`); Canaã (ID: `place:Canaan`); Hete (ID: `person:Heth`); Levi (ID: `group:Levi`); Amorites (ID: `group:Amorites`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Harim (ID: `person:Harim`); counsel (ID: `keyterm:Counsel`); Elam (ID: `person:Elam`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); offering (ID: `keyterm:Offering`); Amarias (ID: `person:Amariah.6`); Joanã (ID: `person:Jehohanan.4`); Eliasibe (ID: `person:Eliashib.4`); Maaséias (ID: `person:Maaseiah.7`); Semaías (ID: `person:Shemaiah.16`); Gedalias (ID: `person:Gedaliah`); Elias (ID: `person:Elijah.4`); Uri (ID: `person:Uri.3`); Abdi (ID: `person:Abdi.3`); Semaías (ID: `person:Shemaiah.17`); Macnadbai (ID: `person:Machnadebai`); Kelaiah (ID: `person:Kelaiah`); Uzias (ID: `person:Uzziah.4`); Jaasai (ID: `person:Jaasu`); Salum (ID: `person:Shallum.11`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); dispossess (ID: `keyterm:Dispossess`); Israel (ID: `person:Israel`); peace (ID: `keyterm:IntactState`); Jerusalém (ID: `place:Jerusalem`); kindness (ID: `keyterm:Kindness`); defilement (ID: `keyterm:Defilement`); Pérsia (ID: `place:Persia`); to cause to possess (ID: `keyterm:Possess`); supplication (ID: `keyterm:Supplication`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); Jerusalém (ID: `place:Jerusalem`); kindness (ID: `keyterm:Kindness`); Pérsia (ID: `place:Persia`); supplication (ID: `keyterm:Supplication`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** Jeiel (ID: `person:Jehiel.8`); Secanias (ID: `person:Shecaniah.7`); be unfaithful (ID: `keyterm:Unfaithful`); Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Ezra (ID: `person:Ezra`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** counsel (ID: `keyterm:Counsel`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); swear (ID: `keyterm:Swear`); Levi (ID: `person:Levi.3`); Ezra (ID: `person:Ezra`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Ticva (ID: `person:Tikvah.2`); Mesulão (ID: `person:Meshullam.10`); Jônatas (ID: `person:Jonathan.10`); Jazeías (ID: `person:Jahzeiah`); Asael (ID: `person:Asahel.4`); Sabetai (ID: `person:Shabbethai`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`)
