...
* **Associated ACAI Concepts:** حَجَّيِ (ID: `person:Haggai`); دَارِيوسَ (ID: `person:Darius.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); زَربَّابِل (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); حَجَّيِ (ID: `person:Haggai`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); دَارِيوسَ (ID: `person:Darius.2`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Olive Tree (ID: `flora:OliveTree`); Mule (ID: `fauna:Mule`); Grain (ID: `flora:Grain`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Must (ID: `realia:Must`); Vine (ID: `flora:Vine`); Bag (ID: `realia:Bag`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); حَجَّيِ (ID: `person:Haggai`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); حَجَّيِ (ID: `person:Haggai`); Peace (ID: `keyterm:IntactState`); Fear (ID: `keyterm:Fear`); يَهوذَا (ID: `person:Judah.4`); مِصْرَ (ID: `place:Egypt`); يَهوذَا (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); حَجَّيِ (ID: `person:Haggai`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`); Sword (ID: `realia:Sword`)
