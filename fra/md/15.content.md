...
* **Associated ACAI Concepts:** Cyrus (ID: `person:Cyrus`); Éternel (ID: `deity:Lord`); Perse (ID: `place:Persia`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); House (ID: `realia:House`); Israël (ID: `person:Israel`); parole du seigneur (ID: `keyterm:WordOfTheLord`); Jérémie (ID: `person:Jeremiah.6`)
...
* **Associated ACAI Concepts:** Cyrus (ID: `person:Cyrus`); Jérusalem (ID: `place:Jerusalem`); Perse (ID: `place:Persia`); Juda (ID: `group:Judah`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `group:Judah`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** offrande (ID: `keyterm:Offering`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Benjamin (ID: `person:Benjamin`); Benjamin (ID: `group:Benjamin`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `group:Judah`); Lévi (ID: `group:Levi`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); Lévi (ID: `person:Levi.3`); House (ID: `realia:House`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Mithredath (ID: `person:Mithredath`); Cyrus (ID: `person:Cyrus`); Perse (ID: `place:Persia`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Money (ID: `realia:Money`); Babylone (ID: `place:Babylon`); Jérusalem (ID: `place:Jerusalem`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Élam (ID: `person:Elam`); Lévi (ID: `group:Levi`); Jérusalem (ID: `place:Jerusalem`); Salomon (ID: `person:Solomon`); Lévi (ID: `person:Levi.3`); Jora (ID: `person:Jorah`); Zaccaï (ID: `person:Zaccai.2`); Yedaya (ID: `person:Jedaiah.4`); Guiddel (ID: `person:Giddel.2`); Padon (ID: `person:Padon`); Hagaba (ID: `person:Hagabah`); Schobaï (ID: `person:Shobai`); Tsicha (ID: `person:Ziha`); Mispar (ID: `person:Mispar`); Reaja (ID: `person:Reaiah.3`); Addan (ID: `place:Addan`); Hadid (ID: `place:Hadid`); Harhur (ID: `person:Harhur`); Darkon (ID: `person:Darkon`); Shefatya (ID: `person:Shephatiah.6`); Josué (ID: `person:Jeshua.3`); Nethopha (ID: `place:Netophah`); Thel-Mélach (ID: `place:Tel-melah`); Ézéchias (ID: `person:Hezekiah.2`); Baana (ID: `person:Baanah.3`); Rehum (ID: `person:Rehum`); Lebana (ID: `person:Lebanah`); Bébaï (ID: `person:Bebai`); Thamach (ID: `person:Temah`)
...
* **Associated ACAI Concepts:** Bigvaï (ID: `person:Bigvai`); Mardochée (ID: `person:Mordecai`); Mispar (ID: `person:Mispar`); Néhémie (ID: `person:Nehemiah`); Rehum (ID: `person:Rehum`); Seraja (ID: `person:Seraiah.6`); Reélaja (ID: `person:Reelaiah`); Bilschan (ID: `person:Bilshan`); Baana (ID: `person:Baanah.3`); Israël (ID: `person:Israel`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Jora (ID: `person:Jorah`); Zaccaï (ID: `person:Zaccai.2`); Élam (ID: `person:Elam`); Ather (ID: `person:Ater`); Bigvaï (ID: `person:Bigvai.2`); Adonikam (ID: `person:Adonikam`); Joab (ID: `person:Joab.3`); Azgad (ID: `person:Azgad`); Shefatya (ID: `person:Shephatiah.6`); Betsaï (ID: `person:Bezai`); Josué (ID: `person:Jeshua.3`); Bani (ID: `person:Bani`); Pareosch (ID: `person:Parosh`); Ézéchias (ID: `person:Hezekiah.2`); Zatthu (ID: `person:Zattu.2`); Haschum (ID: `person:Hashum`); Bébaï (ID: `person:Bebai`); Pachath-Moab (ID: `person:Pahath-moab`); Arach (ID: `person:Arah.2`); Adin (ID: `person:Adin`); Gabaon (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Beth-azmaveth (ID: `place:Beth-azmaveth`); Harim (ID: `person:Harim.2`); Hadid (ID: `place:Hadid`); Nethopha (ID: `place:Netophah`); Nebo (ID: `place:Nebo.2`); Magbisch (ID: `place:Magbish`); Senaa (ID: `place:Senaah`); Élam (ID: `person:Elam`); Lod (ID: `place:Lod`); Aï (ID: `place:Ai`); Anathoth (ID: `place:Anathoth`); Micmasch (ID: `place:Michmash`); Bethel (ID: `place:Bethel`); Ono (ID: `place:Ono`); Jéricho (ID: `place:Jericho`); Kephira (ID: `place:Chephirah`); Beéroth (ID: `place:Beeroth`); Guéba (ID: `place:Geba`); Kirjath-Jearim (ID: `place:Kiriath-jearim`); Bethléhem (ID: `place:Bethlehem`); Ramah (ID: `place:Ramah.2`)
...
* **Associated ACAI Concepts:** Schobaï (ID: `person:Shobai`); Josué (ID: `person:Jeshua.4`); Harim (ID: `person:Harim`); Yedaya (ID: `person:Jedaiah.4`); Josué (ID: `person:Jeshua`); Hathitha (ID: `person:Hatita`); Thalmon (ID: `person:Talmon`); Ather (ID: `person:Ater.2`); Hodavia (ID: `person:Hodaviah.4`); Immer (ID: `person:Immer.2`); Akkub (ID: `person:Akkub.2`); Asaph (ID: `person:Asaph.2`); Lévi (ID: `group:Levi`); Kadmiel (ID: `person:Kadmiel`); Schallum (ID: `person:Shallum.8`); Paschhur (ID: `person:Pashhur`); Lévi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Schobaï (ID: `person:Shobai`); Hathitha (ID: `person:Hatita`); Thalmon (ID: `person:Talmon`); Ather (ID: `person:Ater.2`); Akkub (ID: `person:Akkub.2`); Asaph (ID: `person:Asaph.2`); Schallum (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** Paséach (ID: `person:Paseah.2`); Akkub (ID: `person:Akkub.3`); Nekoda (ID: `person:Nekoda`); Netsiach (ID: `person:Neziah`); Kéros (ID: `person:Keros`); Sisera (ID: `person:Sisera.2`); Padon (ID: `person:Padon`); Hagaba (ID: `person:Hagabah`); Tsicha (ID: `person:Ziha`); Hagab (ID: `person:Hagab`); Hathipha (ID: `person:Hatipha`); Siaha (ID: `person:Siaha`); Uzza (ID: `person:Uzza.2`); Reaja (ID: `person:Reaiah.3`); Gachar (ID: `person:Gahar`); Gazzam (ID: `person:Gazzam`); Harhur (ID: `person:Harhur`); Hanan (ID: `person:Hanan.4`); Bésaï (ID: `person:Besai`); Hasupha (ID: `person:Hasupha`); Bakbuk (ID: `person:Bakbuk`); Mehida (ID: `person:Mehida`); Harscha (ID: `person:Harsha`); Shalmai (ID: `person:Shalmai`); Meunim (ID: `group:Meunim`); Nephushesim (ID: `group:Nephushesim`); Lebana (ID: `person:Lebanah`); Guiddel (ID: `person:Giddel`); Asna (ID: `person:Asnah`); Barkos (ID: `person:Barkos`); Thamach (ID: `person:Temah`); Thabbaoth (ID: `person:Tabbaoth`); Hakupha (ID: `person:Hakupha`); Retsin (ID: `person:Rezin.2`); Batsluth (ID: `person:Bazluth`)
...
* **Associated ACAI Concepts:** Salomon (ID: `person:Solomon`); Pokéreth-Hatsebaïm (ID: `person:Pochereth-hazzebaim`); Peruda (ID: `person:Peruda`); Ami (ID: `person:Ami`); Darkon (ID: `person:Darkon`); Shephatiah (ID: `person:Shephatiah.7`); Sophéreth (ID: `person:Sophereth`); Guiddel (ID: `person:Giddel.2`); Hatthil (ID: `person:Hattil`); Jaala (ID: `person:Jaalah`); Sothaï (ID: `person:Sotai`)
...
* **Associated ACAI Concepts:** Tobija (ID: `person:Tobiah`); Cherub (ID: `place:Cherub`); Addan (ID: `place:Addan`); Thel-Mélach (ID: `place:Tel-melah`); Thel-Harscha (ID: `place:Tel-harsha`); Nekoda (ID: `person:Nekoda.2`); Delaja (ID: `person:Delaiah.3`); Immer (ID: `place:Immer`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Habaja (ID: `person:Habaiah`); Barzillaï (ID: `person:Barzillai.3`); Hakkots (ID: `person:Hakkoz.2`); souiller (ID: `keyterm:Stain`); Galaad (ID: `place:Gilead`); Barzillaï (ID: `person:Barzillai`); Galaadite (ID: `group:Gilead`); sacerdoce (ID: `keyterm:Priesthood`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); Jérusalem (ID: `place:Jerusalem`); force (ID: `keyterm:Strength`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`); Mina (ID: `realia:Mina`); Tunic (ID: `realia:Tunic`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); offrande (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); Josué (ID: `person:Joshua.5`); Perse (ID: `place:Persia`); Cyrus (ID: `person:Cyrus`); Jehozadak (ID: `person:Jehozadak`); Schealthiel (ID: `person:Shealtiel.2`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Asarhaddôn (ID: `person:Esarhaddon`); Kadmiel (ID: `person:Kadmiel`); Relatives (ID: `group:Relatives`); Hodavia (ID: `person:Hodaviah.4`); Josué (ID: `person:Jeshua.4`); Hénadad (ID: `person:Henadad`); Moïse (ID: `person:Moses`); Liban (ID: `place:Lebanon`); Sidonien (ID: `group:Sidon`); Benjamin (ID: `group:Benjamin`); bonté (ID: `keyterm:Kindness`); Darius (ID: `person:Darius.2`); Tyr (ID: `place:Tyre`); Instruction (ID: `keyterm:Instruction`); fête déterminée (ID: `keyterm:AppointedFeast`); Benjamin (ID: `person:Benjamin`); avis (ID: `keyterm:Counsel`); terreur (ID: `keyterm:Terror`); néoménies (ID: `keyterm:NewMoonFestival`); Hodija (ID: `person:Hodiah.2`); fourré (ID: `keyterm:FeastOfTabernacles`); Joppa (ID: `place:Joppa`); Sidon (ID: `place:Sidon`); saint (ID: `keyterm:Holy`); Assyria (ID: `place:Assyria`); Asaph (ID: `person:Asaph.2`); Tyrien (ID: `group:Tyre`); David (ID: `person:David`); Cymbals (ID: `realia:Cymbals`); Cedar (ID: `flora:Cedar`); Craftsman (ID: `realia:Craftsman`); Money (ID: `realia:Money`); Trumpet (ID: `realia:Trumpet`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Jehozadak (ID: `person:Jehozadak`); Schealthiel (ID: `person:Shealtiel.2`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); offrande (ID: `keyterm:Offering`); Moïse (ID: `person:Moses`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** offrande (ID: `keyterm:Offering`); terreur (ID: `keyterm:Terror`); Éternel (ID: `deity:Lord`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** offrande (ID: `keyterm:Offering`); Éternel (ID: `deity:Lord`); néoménies (ID: `keyterm:NewMoonFestival`); fête déterminée (ID: `keyterm:AppointedFeast`); saint (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** Cyrus (ID: `person:Cyrus`); Perse (ID: `place:Persia`); Liban (ID: `place:Lebanon`); Tyrien (ID: `group:Tyre`); Tyr (ID: `place:Tyre`); Joppa (ID: `place:Joppa`); Sidon (ID: `place:Sidon`); Sidonien (ID: `group:Sidon`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Money (ID: `realia:Money`); Cedar (ID: `flora:Cedar`)
...
* **Associated ACAI Concepts:** Jehozadak (ID: `person:Jehozadak`); Schealthiel (ID: `person:Shealtiel.2`); Jérusalem (ID: `place:Jerusalem`); Josué (ID: `person:Joshua.5`); Lévi (ID: `group:Levi`); Éternel (ID: `deity:Lord`); Lévi (ID: `person:Levi.3`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); bonté (ID: `keyterm:Kindness`); Asaph (ID: `person:Asaph.2`); Lévi (ID: `group:Levi`); David (ID: `person:David`); Lévi (ID: `person:Levi.3`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** Benjamin (ID: `person:Benjamin`); Benjamin (ID: `group:Benjamin`); Israël (ID: `person:Israel`); Juda (ID: `group:Judah`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Cyrus (ID: `person:Cyrus`); Israël (ID: `person:Israel`); Perse (ID: `place:Persia`); Josué (ID: `person:Joshua.5`); Éternel (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Euphrate (ID: `place:Euphrates`); Rehum (ID: `person:Rehum.2`); Schimschaï (ID: `person:Shimshai`); Artaxerxès (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Perse (ID: `place:Persia`); Samarie (ID: `place:Samaria`); Assuérus (ID: `person:Ahasuerus`); Thabeel (ID: `person:Tabeel`); Dinaite (ID: `person:Dinaite`); Mithredath (ID: `person:Mithredath.2`); Bischlam (ID: `person:Bishlam`); Osnappar (ID: `person:Osnappar`); Babylonien (ID: `group:Babylon`); Érec (ID: `place:Erech`); Élam (ID: `place:Elam`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Almôn-Divlataïm (ID: `group:Elam`); Suse (ID: `place:Susa`); Perse (ID: `group:Persia`); Babylone (ID: `place:Babylon`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Mithredath (ID: `person:Mithredath.2`); Bischlam (ID: `person:Bishlam`); Thabeel (ID: `person:Tabeel`); Perse (ID: `place:Persia`); Artaxerxès (ID: `person:Artaxerxes.2`)
...
* **Associated ACAI Concepts:** Dinaite (ID: `person:Dinaite`); Babylonien (ID: `group:Babylon`); Érec (ID: `place:Erech`); Schimschaï (ID: `person:Shimshai`); Rehum (ID: `person:Rehum.2`); Élam (ID: `place:Elam`); Suse (ID: `place:Susa`); Perse (ID: `place:Persia`); Perse (ID: `group:Persia`); Babylone (ID: `place:Babylon`); Almôn-Divlataïm (ID: `group:Elam`)
...
* **Associated ACAI Concepts:** Euphrate (ID: `place:Euphrates`); Jérusalem (ID: `place:Jerusalem`); Jews (ID: `group:Jews`); Artaxerxès (ID: `person:Artaxerxes.2`); Schimschaï (ID: `person:Shimshai`); Rehum (ID: `person:Rehum.2`); Samarie (ID: `place:Samaria`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); Darius (ID: `person:Darius.2`); Thathnaï (ID: `person:Tattenai`); Aggée (ID: `person:Haggai`); Iddo (ID: `person:Iddo.6`); Zacharie (ID: `person:Zechariah.17`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Jehozadak (ID: `person:Jehozadak`); Israël (ID: `person:Israel`); Schealthiel (ID: `person:Shealtiel.2`); Josué (ID: `person:Joshua.5`); Perse (ID: `place:Persia`); Juda (ID: `person:Judah.4`); Euphrate (ID: `place:Euphrates`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Jehozadak (ID: `person:Jehozadak`); Schealthiel (ID: `person:Shealtiel.2`); Jérusalem (ID: `place:Jerusalem`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Jérusalem (ID: `place:Jerusalem`); Babylone (ID: `place:Babylon`); Cyrus (ID: `person:Cyrus`); Nebucadnetsar (ID: `person:Nebuchadnezzar`); Darius (ID: `person:Darius.2`); Zorobabel (ID: `person:Zerubbabel.2`); Thathnaï (ID: `person:Tattenai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Chaldéens (ID: `group:Chaldea`); Israël (ID: `person:Israel`); Chaldée (ID: `place:Chaldea`); Juda (ID: `person:Judah.4`); Euphrate (ID: `place:Euphrates`); Foundation (ID: `realia:Foundation`); Hewn Stone (ID: `realia:HewnStone`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Nebucadnetsar (ID: `person:Nebuchadnezzar`); Babylone (ID: `place:Babylon`); Chaldée (ID: `place:Chaldea`); Chaldéens (ID: `group:Chaldea`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** offrande (ID: `keyterm:Offering`); Israël (ID: `person:Israel`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Moïse (ID: `person:Moses`); Jérusalem (ID: `place:Jerusalem`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Lévi (ID: `person:Levi.3`); sacrifice de la pâque (ID: `keyterm:Passover`); Lévi (ID: `group:Levi`); sans saleté (ID: `keyterm:Pure`)
...
* **Associated ACAI Concepts:** pollution (ID: `keyterm:Defilement`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); nation; peuple (ID: `group:Gentile`)
...
* **Associated ACAI Concepts:** Esdras (ID: `person:Ezra`); Achithub (ID: `person:Ahitub.3`); Amaria (ID: `person:Amariah.2`); Uzzi (ID: `person:Uzzi`); Tsadok (ID: `person:Zadok.4`); Zerachja (ID: `person:Zerahiah`); Schallum (ID: `person:Shallum.7`); Abischua (ID: `person:Abishua`); Merajoth (ID: `person:Meraioth`); Seraja (ID: `person:Seraiah.2`); Bukki (ID: `person:Bukki.2`); Azaria (ID: `person:Azariah.7`); Azaria (ID: `person:Azariah.6`); Perse (ID: `place:Persia`); Aaron (ID: `person:Aaron`); Artaxerxès (ID: `person:Artaxerxes`); Phinées (ID: `person:Phinehas`); Hilkija (ID: `person:Hilkiah.2`); Éléazar (ID: `person:Eleazar.2`)
...
* **Associated ACAI Concepts:** Esdras (ID: `person:Ezra`); Moïse (ID: `person:Moses`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); Babylone (ID: `place:Babylon`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); Esdras (ID: `person:Ezra`); limite (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Artaxerxès (ID: `person:Artaxerxes`); Esdras (ID: `person:Ezra`); Euphrate (ID: `place:Euphrates`); Olive Oil (ID: `realia:OliveOil`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Kor (ID: `realia:Kor`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** Zacharie (ID: `person:Zechariah.18`); Daniel (ID: `person:Daniel.2`); Schemaeja (ID: `person:Shemaiah.14`); Zacharie (ID: `person:Zechariah.19`); Élam (ID: `person:Elam`); Hakkathan (ID: `person:Hakkatan`); Micaël (ID: `person:Michael.10`); Éljoénaï (ID: `person:Eliehoenai.2`); Bigvaï (ID: `person:Bigvai.2`); Éliphéleth (ID: `person:Eliphelet.5`); Joab (ID: `person:Joab.4`); Pareosch (ID: `person:Parosh.2`); Guershom (ID: `person:Gershom.2`); Uthaï (ID: `person:Uthai.2`); Schecania (ID: `person:Shecaniah.6`); Zerachja (ID: `person:Zerahiah.2`); Adonikam (ID: `person:Adonikam`); Azgad (ID: `person:Azgad`); Yeïel (ID: `person:Jeuel.3`); Zevadya (ID: `person:Zebadiah.8`); Jachaziel (ID: `person:Jahaziel.5`); Shefatya (ID: `person:Shephatiah.6`); Bébaï (ID: `person:Bebai.2`); Athalie (ID: `person:Athaliah.3`); Ésaïe (ID: `person:Jeshaiah.4`); Josiphia (ID: `person:Josiphiah`); Jehiel (ID: `person:Jehiel.7`); Hatthusch (ID: `person:Hattush.2`); Schecania (ID: `person:Shecaniah.5`); Bébaï (ID: `person:Bebai`); Pachath-Moab (ID: `person:Pahath-moab`); Zaccur (ID: `person:Zaccur.5`); Jonathan (ID: `person:Jonathan.9`); Schelomith (ID: `person:Shelomith.4`); Jochanan (ID: `person:Johanan.8`); Abdias (ID: `person:Obadiah.10`); Ébed (ID: `person:Ebed.2`); Adin (ID: `person:Adin`); Artaxerxès (ID: `person:Artaxerxes`); Phinées (ID: `person:Phinehas`); Babylone (ID: `place:Babylon`); David (ID: `person:David`); Ithamar (ID: `person:Ithamar`)
...
* **Associated ACAI Concepts:** Ariel (ID: `person:Ariel`); Éliézer (ID: `person:Eliezer.8`); Meschullam (ID: `person:Meshullam.9`); Casiphia (ID: `place:Casiphia`); Iddo (ID: `person:Iddo`); Schemaeja (ID: `person:Shemaiah.15`); Jojarib (ID: `person:Joiarib.2`); Nathan (ID: `person:Nathan.5`); Elnathan (ID: `person:Elnathan.2`); Jarib (ID: `person:Jarib.2`); Zacharie (ID: `person:Zechariah.20`); Elnathan (ID: `person:Elnathan.3`); Elnathan (ID: `person:Elnathan.4`); Éternel (ID: `deity:Lord`); percevoir (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Schérébia (ID: `person:Sherebiah`); discernement (ID: `keyterm:Insight`); Israël (ID: `person:Israel`); Lévi (ID: `group:Levi`); Éternel (ID: `deity:Lord`); Machli (ID: `person:Mahli`); Lévi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** David (ID: `person:David`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`); travil (ID: `keyterm:Work`)
...
* **Associated ACAI Concepts:** Hittite (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); Canaan (ID: `place:Canaan`); être infidèle (ID: `keyterm:Unfaithful`); Israël (ID: `person:Israel`); Amos (ID: `group:Ammon`); Jébusiens (ID: `group:Jebusites`); Lévi (ID: `group:Levi`); Égypte (ID: `place:Egypt`); Moab (ID: `place:Moab`); Canaan (ID: `group:Canaan`); Mitsraïm (ID: `group:Egypt`); Ammon (ID: `place:Ammon`); Amorites (ID: `group:Amorites`); Lévi (ID: `person:Levi.3`); Heth (ID: `person:Heth`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Esdras (ID: `person:Ezra`); être infidèle (ID: `keyterm:Unfaithful`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); Jérusalem (ID: `place:Jerusalem`); ardeur (ID: `keyterm:Ardour`); House (ID: `realia:House`); Harim (ID: `person:Harim`); Élam (ID: `person:Elam`); Juda (ID: `group:Judah`); offrande (ID: `keyterm:Offering`); Juda (ID: `person:Judah.4`); avis (ID: `keyterm:Counsel`); Joël (ID: `person:Joel.12`); Hittite (ID: `group:Hittite`); Yerémoth (ID: `person:Jeremoth.3`); Athlaï (ID: `person:Athlai`); Zabbaï (ID: `person:Zabbai`); Éljoénaï (ID: `person:Elioenai.4`); Jochanan (ID: `person:Jehohanan.4`); Bani (ID: `person:Bani.5`); Manassé (ID: `person:Manasseh.3`); Éljoénaï (ID: `person:Elioenai.5`); Meschullam (ID: `person:Meshullam.11`); Amram (ID: `person:Amram.2`); Abdi (ID: `person:Abdi.3`); Schimeï (ID: `person:Shimei.17`); Jotsadak (ID: `person:Jozadak.2`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); ardeur (ID: `keyterm:Ardour`); Judée (ID: `place:Judea`); Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`); laissiez en possession (ID: `keyterm:Possess`); état intact (ID: `keyterm:IntactState`); bonté (ID: `keyterm:Kindness`); Perse (ID: `place:Persia`); déposséder (ID: `keyterm:Dispossess`); supplication (ID: `keyterm:Supplication`); pollution (ID: `keyterm:Defilement`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Judée (ID: `place:Judea`); Jérusalem (ID: `place:Jerusalem`); bonté (ID: `keyterm:Kindness`); Perse (ID: `place:Persia`); supplication (ID: `keyterm:Supplication`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** état intact (ID: `keyterm:IntactState`); déposséder (ID: `keyterm:Dispossess`); pollution (ID: `keyterm:Defilement`); laissiez en possession (ID: `keyterm:Possess`)
...
* **Associated ACAI Concepts:** Jehiel (ID: `person:Jehiel.8`); Schecania (ID: `person:Shecaniah.7`); être infidèle (ID: `keyterm:Unfaithful`); Israël (ID: `person:Israel`); Élam (ID: `person:Elam`); Éternel (ID: `deity:Lord`); Esdras (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); avis (ID: `keyterm:Counsel`); alliance (ID: `keyterm:Covenant`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Lévi (ID: `group:Levi`); Esdras (ID: `person:Ezra`); Lévi (ID: `person:Levi.3`); jurer (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** Benjamin (ID: `person:Benjamin`); Benjamin (ID: `group:Benjamin`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `group:Judah`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jachzia (ID: `person:Jahzeiah`); Jonathan (ID: `person:Jonathan.10`); Asaël (ID: `person:Asahel.4`); Thikva (ID: `person:Tikvah.2`); Shabbethai (ID: `person:Shabbethai`); Meschullam (ID: `person:Meshullam.10`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`)
