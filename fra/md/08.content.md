...
* **Associated ACAI Concepts:** Èfratite; d'Èfrata (ID: `group:Ephrathah`); Éphrata (ID: `person:Ephrathah`); Kiljon (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Élimélec (ID: `person:Elimelech`); Juda (ID: `group:Judah`); Machlon (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Bethléhem (ID: `place:Bethlehem`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); Bethléhem (ID: `place:Bethlehem`); Naomi (ID: `person:Naomi`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); bonté (ID: `keyterm:Kindness`); benir (ID: `keyterm:Bless`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Rachel (ID: `person:Rachel`); Éternel (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); Israël (ID: `person:Israel`); Bethléhem (ID: `place:Bethlehem`); Léa (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Éternel (ID: `deity:Lord`); benir (ID: `keyterm:Bless`); Israël (ID: `person:Israel`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Hetsron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Amminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Isaï (ID: `person:Jesse`); Nahshon (ID: `person:Nahshon`); Boaz (ID: `person:Boaz`); David (ID: `person:David`); Perets (ID: `person:Perez`)
