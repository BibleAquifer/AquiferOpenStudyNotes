...
* **Associated ACAI Concepts:** Gedalias (ID: `person:Gedaliah.3`); Sofonias (ID: `person:Zephaniah.3`); Cusi (ID: `person:Cushi`); Ezequias (ID: `person:Hezekiah.4`); Amarias (ID: `person:Amariah.9`); Amon (ID: `person:Amon.3`); Josias (ID: `person:Josiah`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Appoint (ID: `keyterm:Appoint`); Jerusalém (ID: `place:Jerusalem`); slaughtering (ID: `keyterm:Slaughtering`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Money (ID: `realia:Money`); Sofonias (ID: `person:Zephaniah.3`); Cusi (ID: `person:Cushi`); Amarias (ID: `person:Amariah.9`); Segundo distrito (ID: `place:SecondQuarter`); Fish Gate (ID: `place:FishGate`); Gedalias (ID: `person:Gedaliah.3`); Ezequias (ID: `person:Hezekiah.4`); The Hollow (ID: `place:Mortar`); Amon (ID: `person:Amon.3`); ardour (ID: `keyterm:Ardour`); Baal (ID: `deity:Baal`); Deceit (ID: `keyterm:Deceit`); poor (ID: `keyterm:Poor`); Men (ID: `group:GenericMales`); Moleque (ID: `deity:Molech`); decree (ID: `keyterm:Decree`); holy (ID: `keyterm:Holy`); To Sin (ID: `keyterm:Sin`); Josias (ID: `person:Josiah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); swear (ID: `keyterm:Swear`); Lamp (ID: `realia:Lamp`); Rams Horn (ID: `realia:RamsHorn`); Fish (ID: `fauna:Fish`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Baal (ID: `deity:Baal`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Baal (ID: `deity:Baal`); Moleque (ID: `deity:Molech`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Appoint (ID: `keyterm:Appoint`); slaughtering (ID: `keyterm:Slaughtering`); House (ID: `realia:House`); Money (ID: `realia:Money`); Wine (ID: `realia:Wine`); The Hollow (ID: `place:Mortar`); Fish Gate (ID: `place:FishGate`); Segundo distrito (ID: `place:SecondQuarter`); holy (ID: `keyterm:Holy`); Jerusalém (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); ardour (ID: `keyterm:Ardour`); Deceit (ID: `keyterm:Deceit`); Men (ID: `group:GenericMales`); Lamp (ID: `realia:Lamp`); Vine (ID: `flora:Vine`); Rams Horn (ID: `realia:RamsHorn`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); fear (ID: `keyterm:Fear`); Jerusalém (ID: `place:Jerusalem`); Woe (ID: `keyterm:Woe.2`); Appoint (ID: `keyterm:Appoint`); Ammonites (ID: `group:Ammon`); Moabe (ID: `place:Moab`); Amom (ID: `place:Ammon`); Asquelom (ID: `place:Ashkelon`); Cush (ID: `place:Cush.2`); stain (ID: `keyterm:Stain`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); offering (ID: `keyterm:Offering`); Ecrom (ID: `place:Ekron`); Canaã (ID: `place:Canaan`); profane, dishonor (ID: `keyterm:Dishonor`); Nínive (ID: `place:Nineveh`); Asdode (ID: `place:Ashdod`); ardour (ID: `keyterm:Ardour`); Deceit (ID: `keyterm:Deceit`); Cherethites (ID: `group:Cherethite`); lean on (ID: `keyterm:LeanOn`); Judá (ID: `group:Judah`); Filisteu (ID: `group:Philistine`); rebel (ID: `keyterm:Rebel`); Gaza (ID: `place:Gaza`); Judá (ID: `person:Judah.4`); Instruction (ID: `keyterm:Instruction`); appointed feast (ID: `keyterm:AppointedFeast`); be enticed to serve (ID: `keyterm:EnticedToServe`); Gomorra (ID: `place:Gomorrah`); Sodoma (ID: `place:Sodom`); Filístia (ID: `place:Philistine`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); love (ID: `keyterm:Love`); Assyria (ID: `place:Assyria`); Safety (ID: `keyterm:Safety`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Cushites (ID: `group:Cush`); Owl (ID: `fauna:Owl.3`); House (ID: `realia:House`); Capital (ID: `realia:Capital`); Window (ID: `realia:Window`); Crow (ID: `fauna:Crow`); Lion (ID: `fauna:Lion`); Nettle (ID: `flora:Nettle`); Wolf (ID: `fauna:Wolf`); Sheep (ID: `fauna:Lamb`); Jackdaw (ID: `fauna:Jackdaw`); Doorstep (ID: `realia:Doorstep`); Sword (ID: `realia:Sword`); Sheepfold (ID: `realia:Sheepfold`)
...
* **Associated ACAI Concepts:** Canaã (ID: `place:Canaan`); Filístia (ID: `place:Philistine`); SENHOR (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Filisteu (ID: `group:Philistine`); Woe (ID: `keyterm:Woe.2`); Cherethites (ID: `group:Cherethite`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Asquelom (ID: `place:Ashkelon`); Appoint (ID: `keyterm:Appoint`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Gomorra (ID: `place:Gomorrah`); Israel (ID: `person:Israel`); Sodoma (ID: `place:Sodom`); Ammonites (ID: `group:Ammon`); SENHOR (ID: `deity:Lord`); Moabe (ID: `place:Moab`); Amom (ID: `place:Ammon`); Nettle (ID: `flora:Nettle`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); stain (ID: `keyterm:Stain`); lean on (ID: `keyterm:LeanOn`); profane, dishonor (ID: `keyterm:Dishonor`); fear (ID: `keyterm:Fear`); Appoint (ID: `keyterm:Appoint`); Woe (ID: `keyterm:Woe.2`); ardour (ID: `keyterm:Ardour`); Instruction (ID: `keyterm:Instruction`); Lion (ID: `fauna:Lion`); Wolf (ID: `fauna:Wolf`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Israel (ID: `person:Israel`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); rebel (ID: `keyterm:Rebel`); Cush (ID: `place:Cush.2`); Deceit (ID: `keyterm:Deceit`); be enticed to serve (ID: `keyterm:EnticedToServe`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); fear (ID: `keyterm:Fear`); offering (ID: `keyterm:Offering`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); rebel (ID: `keyterm:Rebel`); Cush (ID: `place:Cush.2`); love (ID: `keyterm:Love`); Deceit (ID: `keyterm:Deceit`); appointed feast (ID: `keyterm:AppointedFeast`); be enticed to serve (ID: `keyterm:EnticedToServe`)
