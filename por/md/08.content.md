...
* **Associated ACAI Concepts:** Efrata (ID: `person:Ephrathah`); Quiliom (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Ephrathites (ID: `group:Ephrathah`); Belém (ID: `place:Bethlehem`); Judá (ID: `person:Judah.4`); Moabe (ID: `place:Moab`); Judá (ID: `group:Judah`); Elimeleque (ID: `person:Elimelech`); Malom (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Belém (ID: `place:Bethlehem`); Moabe (ID: `place:Moab`); Noemi (ID: `person:Naomi`); Rute (ID: `person:Ruth`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); bless (ID: `keyterm:Bless`); kindness (ID: `keyterm:Kindness`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); Boaz (ID: `person:Boaz`); Moabe (ID: `place:Moab`); Noemi (ID: `person:Naomi`); to cause to possess (ID: `keyterm:Possess`)
...
* **Associated ACAI Concepts:** Moabe (ID: `place:Moab`); to cause to possess (ID: `keyterm:Possess`); Rute (ID: `person:Ruth`); Malom (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Lia (ID: `person:Leah`); Belém (ID: `place:Bethlehem`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Raquel (ID: `person:Rachel`); Elders (ID: `group:GenericElders`)
...
* **Associated ACAI Concepts:** Perez (ID: `person:Perez`); Judá (ID: `person:Judah.4`); Tamar (ID: `person:Tamar`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Hezrom (ID: `person:Hezron.2`); Salmom (ID: `person:Salmon`); Aminadabe (ID: `person:Amminadab`); Obede (ID: `person:Obed`); Ram (ID: `person:Ram`); Naassom (ID: `person:Nahshon`); Perez (ID: `person:Perez`); Boaz (ID: `person:Boaz`); Davi (ID: `person:David`); Jessé (ID: `person:Jesse`)
