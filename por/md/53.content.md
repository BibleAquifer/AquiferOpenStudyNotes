...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Tessalônica (ID: `place:Thessalonica`); Thessalonians (ID: `group:Thessalonica`); igreja (ID: `keyterm:Church`); fazer a paz (ID: `keyterm:Peace`); Silas (ID: `person:Silas`); Timóteo (ID: `person:Timothy`); favor (ID: `keyterm:Favor`); Paulo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); reino (ID: `keyterm:Kingdom`); ser glorificado (ID: `keyterm:Glorified`); Glory (ID: `keyterm:Glory`); An Angel (ID: `deity:Angel`); para a eternidade (ID: `keyterm:Always`); fazer justiça (ID: `keyterm:GrantJustice`); Ability (ID: `keyterm:Ability`); holy (ID: `keyterm:Holy`); céu (ID: `keyterm:Heaven`); juízo (ID: `keyterm:Judgment`); igreja (ID: `keyterm:Church`); love (ID: `keyterm:Love`); tribunal de justiça (ID: `keyterm:CourtCase`); boa notícia (ID: `keyterm:GoodNews`); testemunhar (ID: `keyterm:BearWitness`); dever (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** tribunal de justiça (ID: `keyterm:CourtCase`); reino (ID: `keyterm:Kingdom`); be (or show oneself) just (ID: `keyterm:Just`); SENHOR (ID: `deity:Lord`); juízo (ID: `keyterm:Judgment`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`); orar (ID: `keyterm:Pray`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Good (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`); orar (ID: `keyterm:Pray`); Ability (ID: `keyterm:Ability`); ser glorificado (ID: `keyterm:Glorified`); Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`); Good (ID: `keyterm:Good`); Name (ID: `keyterm:Name`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ser glorificado (ID: `keyterm:Glorified`); Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`); Name (ID: `keyterm:Name`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); Spirit (ID: `keyterm:Spirit.2`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); rogar (ID: `keyterm:AskFor`); Satanás (ID: `deity:Satan`); wipe (out), destroy (ID: `keyterm:Destroy`); Ability (ID: `keyterm:Ability`); objeto de culto (ID: `keyterm:ObjectOfWorship`); decidir (ID: `keyterm:Decided`); maravilha (ID: `keyterm:Portent`); injustiça (ID: `keyterm:UnjustDeed`); love (ID: `keyterm:Love`); salvation (ID: `keyterm:Salvation`); example (ID: `keyterm:Example`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** rogar (ID: `keyterm:AskFor`); hope (ID: `keyterm:Hope`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`); para a eternidade (ID: `keyterm:Always`); Good (ID: `keyterm:Good`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); crer (ID: `keyterm:Believe`); orar (ID: `keyterm:Pray`); persuadir (ID: `keyterm:Persuade`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); livrar (ID: `keyterm:Deliver`); Faithfulness (ID: `keyterm:Faithfulness`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); tradição (ID: `keyterm:Teaching`); Jesus (ID: `person:Jesus.2`); andar (ID: `keyterm:Live.3`)
...
* **Associated ACAI Concepts:** andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); Ability (ID: `keyterm:Ability`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); autoridade (ID: `keyterm:Authority.2`); tradição (ID: `keyterm:Teaching`); Name (ID: `keyterm:Name`)
