...
* *sheepherders* (Hebrew *noqed*): This word appears only one other time in the Old Testament, describing the king of Moab as a *sheep breeder* (2 Kings 3:4). Amos uses a different Hebrew word for his job in Amos 7:14 (*boqer*, meaning “herdsman”; see Amos Book Introduction, “The Prophet Amos”). Amos was not a professional prophet serving the court or temple.
...
* **Associated ACAI Concepts:** Have a Vision (ID: `keyterm:HaveAVision`); Amos (ID: `person:Amos.3`); Tekoa (ID: `place:Tekoa`); Tribe of Judah (ID: `group:Judah`); Israel (ID: `person:Israel`); Uzziah (ID: `person:Uzziah`); Joash (ID: `person:Joash.4`); Jeroboam (ID: `person:Jeroboam.2`); Judah (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Carmel (ID: `place:Carmel`); Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* *they threshed*: Threshing grain was the process of separating the grain heads from their husks. People did this by pulling wooden sledges with sharp edges over the cut grain (Isaiah 41:15; see Micah 4:13). This image helps explain how harsh and violent the actions of the people of Damascus were.

* **Associated Passages:** Amos 1:3

* **Associated ACAI Concepts:** Damascus (ID: `place:Damascus`); Gilead (ID: `place:Gilead`); LORD (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); Grain (ID: `flora:Grain`); Threshing-Sledge (ID: `realia:Threshing-sledge`)
...
* **Associated ACAI Concepts:** Damascus (ID: `place:Damascus`); LORD (ID: `deity:Lord`); Beth-eden (ID: `place:Beth-eden`); Kir (ID: `place:Kir`); Valley of Aven (ID: `place:AvenValley`); Hazael (ID: `person:Hazael`); Gilead (ID: `place:Gilead`); Ben-hadad (ID: `person:Ben-hadad.3`); Rebel (ID: `keyterm:Rebel`); Grain (ID: `flora:Grain`); House (ID: `realia:House`); Threshing-Sledge (ID: `realia:Threshing-sledge`); Staff (ID: `realia:Staff`); Rod (ID: `realia:Rod`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); Edom (ID: `place:Edom`); Tribe of Judah (ID: `group:Judah`); Israel (ID: `person:Israel`); Nazirites (ID: `group:Nazirite`); Gilead (ID: `place:Gilead`); Amorites (ID: `group:Amorites`); Damascus (ID: `place:Damascus`); Gaza (ID: `place:Gaza`); Judah (ID: `person:Judah.4`); Tyre (ID: `place:Tyre`); Ammon (ID: `place:Ammon`); Moab (ID: `place:Moab`); Valley of Aven (ID: `place:AvenValley`); Hazael (ID: `person:Hazael`); Kir (ID: `place:Kir`); Beth-eden (ID: `place:Beth-eden`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Staff (ID: `realia:Staff`); Vine (ID: `flora:Vine`); Rod (ID: `realia:Rod`); Ashdod (ID: `place:Ashdod`); Bozrah (ID: `place:Bozrah.2`); Teman (ID: `place:Teman`); Ammonites (ID: `group:Ammon`); Philistines (ID: `group:Philistine`); Strength (ID: `keyterm:Strength`); Philistia (ID: `place:Philistine`); Speak as a Prophet (ID: `keyterm:Speak`); To Dishonor (ID: `keyterm:Dishonor`); Kiriathaim (ID: `place:Kiriathaim`); Ashkelon (ID: `place:Ashkelon`); Dispossess (ID: `keyterm:Dispossess`); Ben-hadad (ID: `person:Ben-hadad.3`); Egypt (ID: `place:Egypt`); Covenant (ID: `keyterm:Covenant`); Poor (ID: `keyterm:Poor`); Ekron (ID: `place:Ekron`); Jerusalem (ID: `place:Jerusalem`); Decree (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`); Oak (ID: `flora:Oak`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Threshing-Sledge (ID: `realia:Threshing-sledge`); Temple Altar (ID: `realia:TempleAltar`); Wagon (ID: `realia:Wagon`); Horse (ID: `fauna:Horse`); Altar (ID: `realia:Altar`); Grain (ID: `flora:Grain`); Rams Horn (ID: `realia:RamsHorn`); Bow (ID: `realia:Bow`); Stone Altar (ID: `realia:StoneAltar`); Sheaf (ID: `realia:Sheaf`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Rebel (ID: `keyterm:Rebel`); LORD (ID: `deity:Lord`); Gaza (ID: `place:Gaza`); Edom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** Philistines (ID: `group:Philistine`); Philistia (ID: `place:Philistine`); Ashdod (ID: `place:Ashdod`); Ekron (ID: `place:Ekron`); Ashkelon (ID: `place:Ashkelon`); LORD (ID: `deity:Lord`); Staff (ID: `realia:Staff`); Rod (ID: `realia:Rod`)
...
* **Associated ACAI Concepts:** Covenant (ID: `keyterm:Covenant`); Tyre (ID: `place:Tyre`); Edom (ID: `place:Edom`); LORD (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`)
...
When Babylon destroyed the major cities of Teman and Bozrah, Edom lost its ability to continue fighting. Babylon conquered Edom shortly after Judah in 553 BC (see Jeremiah 27; 49:7–22; see also study note on Obadiah 1:18).

* **Associated Passages:** Amos 1:12
* **Associated Articles:** Obadiah 1:18 (ID: `23040@AquiferOpenStudyNotes`)
...
* **Associated ACAI Concepts:** Ammonites (ID: `group:Ammon`); Ammon (ID: `place:Ammon`); Gilead (ID: `place:Gilead`); LORD (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Moab (ID: `place:Moab`); Rebel (ID: `keyterm:Rebel`); Edom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** Decree (ID: `keyterm:Decree`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Instruction (ID: `keyterm:Instruction`); LORD (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`)
...
* **Associated ACAI Concepts:** Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Decree (ID: `keyterm:Decree`); Jerusalem (ID: `place:Jerusalem`); Instruction (ID: `keyterm:Instruction`); LORD (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Nazirites (ID: `group:Nazirite`); Amorites (ID: `group:Amorites`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Rebel (ID: `keyterm:Rebel`); Strength (ID: `keyterm:Strength`); Speak as a Prophet (ID: `keyterm:Speak`); To Dishonor (ID: `keyterm:Dishonor`); Dispossess (ID: `keyterm:Dispossess`); Egypt (ID: `place:Egypt`); Poor (ID: `keyterm:Poor`); Oak (ID: `flora:Oak`); House (ID: `realia:House`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Wagon (ID: `realia:Wagon`); Horse (ID: `fauna:Horse`); Altar (ID: `realia:Altar`); Bow (ID: `realia:Bow`); Stone Altar (ID: `realia:StoneAltar`); Sheaf (ID: `realia:Sheaf`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); House (ID: `realia:House`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Wine (ID: `realia:Wine`); Altar (ID: `realia:Altar`); Vine (ID: `flora:Vine`)
...
Besides priests, God gave prophets to share his word and will (Deuteronomy 18:15–19) and holy men called Nazirites, who were dedicated to the Lord by vows that included avoiding fermented drinks (Numbers 6:1–21). Israel showed disrespect for God by telling both the Nazirites and the prophets to ignore and violate God’s calling (see Amos 7:12–13).

* **Associated Passages:** Amos 2:11-12

* **Associated ACAI Concepts:** Nazirites (ID: `group:Nazirite`); Israel (ID: `person:Israel`); Speak as a Prophet (ID: `keyterm:Speak`); LORD (ID: `deity:Lord`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Egypt (ID: `place:Egypt`); Israel (ID: `person:Israel`); Passion (ID: `keyterm:Ardour`); Appoint (ID: `keyterm:Appoint`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Bethel (ID: `place:Bethel`); Rebel (ID: `keyterm:Rebel`); Samaria (ID: `place:Samaria`); Egypt (ID: `place:Egypt`); Gilgal (ID: `place:Gilgal.2`); Appoint (ID: `keyterm:Appoint`); Love (ID: `keyterm:Love`); Vine (ID: `flora:Vine`); Joseph (ID: `person:Joseph.10`); Lion (ID: `fauna:Lion`); Lamentation (ID: `keyterm:Lamentation`); Harmon (ID: `place:Harmon`); Ashdod (ID: `place:Ashdod`); House (ID: `realia:House`); Swear (ID: `keyterm:Swear`); Speak as a Prophet (ID: `keyterm:Speak`); Mischief (ID: `keyterm:Mischief`); Sodom (ID: `place:Sodom`); Innocence (ID: `keyterm:Innocence`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Beersheba (ID: `place:Beersheba`); To Sin (ID: `keyterm:Sin`); Gomorrah (ID: `place:Gomorrah`); Fear (ID: `keyterm:Fear`); Praise (ID: `keyterm:Praise`); Bashan (ID: `place:Bashan`); Slaughtering (ID: `keyterm:Slaughtering`); Passion (ID: `keyterm:Ardour`); Complete (ID: `keyterm:Complete`); Offering (ID: `keyterm:Offering`); Have Insight (ID: `keyterm:HaveInsight`); Horns of Altar (ID: `realia:HornsOfAltar`); Olive Tree (ID: `flora:OliveTree`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Wine (ID: `realia:Wine`); Horse (ID: `fauna:Horse`); Altar (ID: `realia:Altar`); Goat (ID: `fauna:Goat`); Hewn Stone (ID: `realia:HewnStone`); Fishhook (ID: `realia:Fishhook`); Grain (ID: `flora:Grain`); Cattle (ID: `fauna:Bull`); Bed (ID: `realia:Bed`); Rams Horn (ID: `realia:RamsHorn`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Trap (ID: `realia:Trap`); Fig (ID: `flora:Fig`); Wormwood (ID: `flora:Wormwood`); Stone Altar (ID: `realia:StoneAltar`); Sandalwood (ID: `flora:Sandalwood`); Bird (ID: `fauna:Bird`); Locust (ID: `fauna:Locust`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Trap (ID: `realia:Trap`); Sandalwood (ID: `flora:Sandalwood`); Lion (ID: `fauna:Lion`); Bird (ID: `fauna:Bird`); Rams Horn (ID: `realia:RamsHorn`)
...
* **Associated ACAI Concepts:** Samaria (ID: `place:Samaria`); Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); Lion (ID: `fauna:Lion`); Goat (ID: `fauna:Goat`); Bed (ID: `realia:Bed`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Horns of Altar (ID: `realia:HornsOfAltar`); Israel (ID: `person:Israel`); Bethel (ID: `place:Bethel`); Appoint (ID: `keyterm:Appoint`); Rebel (ID: `keyterm:Rebel`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Harmon (ID: `place:Harmon`); Bashan (ID: `place:Bashan`); Samaria (ID: `place:Samaria`); Swear (ID: `keyterm:Swear`); Fishhook (ID: `realia:Fishhook`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Bethel (ID: `place:Bethel`); Gilgal (ID: `place:Gilgal.2`); Rebel (ID: `keyterm:Rebel`); Slaughtering (ID: `keyterm:Slaughtering`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Bethel (ID: `place:Bethel`); Gilgal (ID: `place:Gilgal.2`); Slaughtering (ID: `keyterm:Slaughtering`); Praise (ID: `keyterm:Praise`); Offering (ID: `keyterm:Offering`); LORD (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); Love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Praise (ID: `keyterm:Praise`); Offering (ID: `keyterm:Offering`); LORD (ID: `deity:Lord`); Love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Egypt (ID: `place:Egypt`); Gomorrah (ID: `place:Gomorrah`); Sodom (ID: `place:Sodom`); Innocence (ID: `keyterm:Innocence`); Olive Tree (ID: `flora:OliveTree`); Grain (ID: `flora:Grain`); Fig (ID: `flora:Fig`); Horse (ID: `fauna:Horse`); Locust (ID: `fauna:Locust`); Vine (ID: `flora:Vine`)
...
* **Associated Articles:** Amos 4:4 (ID: `9724@AquiferOpenStudyNotes`)

* **Associated ACAI Concepts:** Mischief (ID: `keyterm:Mischief`); Beersheba (ID: `place:Beersheba`); Bethel (ID: `place:Bethel`); Gilgal (ID: `place:Gilgal.2`)
...
* **Associated Articles:** Amos 5:15 (ID: `9732@AquiferOpenStudyNotes`)
...
* **Associated ACAI Concepts:** Wine (ID: `realia:Wine`); Hewn Stone (ID: `realia:HewnStone`); House (ID: `realia:House`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); House (ID: `realia:House`); Woe (ID: `keyterm:Woe.2`); Hamath (ID: `place:Hamath`); Offering (ID: `keyterm:Offering`); Cattle (ID: `fauna:Bull`); Lyre (ID: `realia:Lyre`); Brook of the Arabah (ID: `place:BrookOfTheArabah`); Calneh (ID: `place:Calneh`); Lo-debar (ID: `place:Lo-debar`); Kiyyun (ID: `deity:Kiyyun`); Sikkuth (ID: `deity:Sikkuth`); Swear (ID: `keyterm:Swear`); Philistines (ID: `group:Philistine`); Philistia (ID: `place:Philistine`); David (ID: `person:David`); Ashteroth-karnaim (ID: `place:Ashteroth-karnaim`); Damascus (ID: `place:Damascus`); Samaria (ID: `place:Samaria`); Joseph (ID: `person:Joseph.10`); Trust (ID: `keyterm:LeanOn`); Slaughtering (ID: `keyterm:Slaughtering`); Jerusalem (ID: `place:Jerusalem`); Smear (ID: `keyterm:Smear`); Gath (ID: `place:Gath`); Molten Image (ID: `realia:MoltenImage`); Horse (ID: `fauna:Horse`); Wine (ID: `realia:Wine`); Goat (ID: `fauna:Goat`); Vine (ID: `flora:Vine`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Bed (ID: `realia:Bed`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Wormwood (ID: `flora:Wormwood`); Lion (ID: `fauna:Lion`); Mattock (ID: `realia:Mattock`); Snake (ID: `fauna:Snake`); Image (ID: `realia:Image`); Bear (ID: `fauna:Bear`); Animal Pen (ID: `realia:AnimalPen`)
...
* **Associated ACAI Concepts:** Samaria (ID: `place:Samaria`); Israel (ID: `person:Israel`); Woe (ID: `keyterm:Woe.2`); Jerusalem (ID: `place:Jerusalem`); Trust (ID: `keyterm:LeanOn`)
...
* **Associated ACAI Concepts:** Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`); Animal Pen (ID: `realia:AnimalPen`); Molten Image (ID: `realia:MoltenImage`); Bed (ID: `realia:Bed`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Joseph (ID: `person:Joseph.10`); David (ID: `person:David`); Smear (ID: `keyterm:Smear`); Lyre (ID: `realia:Lyre`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated Articles:** Amos 5:6 (ID: `9748@AquiferOpenStudyNotes`)
...
* **Associated Articles:** Amos 8:7 (ID: `9786@AquiferOpenStudyNotes`)
...
* **Associated Articles:** Amos 2:1 (ID: `9688@AquiferOpenStudyNotes`)
...
* **Associated ACAI Concepts:** Cattle (ID: `fauna:Bull`); Wormwood (ID: `flora:Wormwood`); Mattock (ID: `realia:Mattock`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Horse (ID: `fauna:Horse`)

## Amos 6:13 (id: 9752)

Lo\-debar and Karnaim were areas that Jeroboam II took back from the Arameans (see 2 Kings 14:25–28). Amos uses wordplay with their names (see Berean Stand Bible textual notes). 
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Amos (ID: `person:Amos.3`); Speak as a Prophet (ID: `keyterm:Speak`); Amaziah (ID: `person:Amaziah.4`); Jeroboam (ID: `person:Jeroboam.2`); Egypt (ID: `place:Egypt`); Isaac (ID: `person:Isaac`); Swear (ID: `keyterm:Swear`); Nile River (ID: `place:Nile`); Word of the Lord (ID: `keyterm:WordOfTheLord`); To Sin (ID: `keyterm:Sin`); Bethel (ID: `place:Bethel`); Plumb Line (ID: `realia:PlumbLine`); Basket (ID: `realia:Basket`); Lamentation (ID: `keyterm:Lamentation`); Tribe of Judah (ID: `group:Judah`); Forgive (ID: `keyterm:Forgive`); Philistines (ID: `group:Philistine`); Syrians (ID: `group:Syria`); Crete (ID: `place:Crete`); Philistia (ID: `place:Philistine`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Cushites (ID: `group:Cush`); Kir (ID: `place:Kir`); Cush (ID: `place:Cush.2`); Beersheba (ID: `place:Beersheba`); Samaria (ID: `place:Samaria`); Carmel (ID: `place:Carmel`); Hell (ID: `place:Hell`); Tribe of Dan (ID: `group:Dan`); Deceit (ID: `keyterm:Deceit`); Judah (ID: `person:Judah.4`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Defilement (ID: `keyterm:Defilement`); Sabbath (ID: `keyterm:Sabbath`); Dan (ID: `place:Dan`); Sieve (ID: `realia:Sieve`); Floor (ID: `realia:Floor`); Doorstep (ID: `realia:Doorstep`); Capital (ID: `realia:Capital`); House (ID: `realia:House`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Ephah (ID: `realia:Ephah`); Altar (ID: `realia:Altar`); Goat (ID: `fauna:Goat`); Shekel (ID: `realia:Shekel`); Stone Pine (ID: `flora:Pine`); Flock (ID: `fauna:Flock`); Sycomore Fig (ID: `flora:SycomoreFig`); High Place (ID: `realia:HighPlace`); Rope (ID: `realia:Rope`); Fig (ID: `flora:Fig`); Snake (ID: `fauna:Snake`); Stone Altar (ID: `realia:StoneAltar`); Balance (ID: `realia:Balance`); Sackcloth (ID: `realia:Sackcloth`); Grass (ID: `flora:Grass`); Money (ID: `realia:Money`); Locust (ID: `fauna:Locust`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Amos (ID: `person:Amos.3`); Speak as a Prophet (ID: `keyterm:Speak`); Amaziah (ID: `person:Amaziah.4`); LORD (ID: `deity:Lord`); Jeroboam (ID: `person:Jeroboam.2`); Bethel (ID: `place:Bethel`); Tribe of Judah (ID: `group:Judah`); Isaac (ID: `person:Isaac`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judah (ID: `person:Judah.4`); Defilement (ID: `keyterm:Defilement`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sycomore Fig (ID: `flora:SycomoreFig`); Rope (ID: `realia:Rope`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** Amaziah (ID: `person:Amaziah.4`); Tribe of Judah (ID: `group:Judah`); Speak as a Prophet (ID: `keyterm:Speak`); Amos (ID: `person:Amos.3`); Judah (ID: `person:Judah.4`)
...
* **Associated Articles:** Amos 7:9 (ID: `9778@AquiferOpenStudyNotes`)

* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Speak as a Prophet (ID: `keyterm:Speak`); Isaac (ID: `person:Isaac`); Word of the Lord (ID: `keyterm:WordOfTheLord`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Defilement (ID: `keyterm:Defilement`); Israel (ID: `person:Israel`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); LORD (ID: `deity:Lord`); Rope (ID: `realia:Rope`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Swear (ID: `keyterm:Swear`); Lamentation (ID: `keyterm:Lamentation`); Israel (ID: `person:Israel`); Nile River (ID: `place:Nile`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Samaria (ID: `place:Samaria`); Beersheba (ID: `place:Beersheba`); Egypt (ID: `place:Egypt`); Tribe of Dan (ID: `group:Dan`); Deceit (ID: `keyterm:Deceit`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Sabbath (ID: `keyterm:Sabbath`); Dan (ID: `place:Dan`); Ephah (ID: `realia:Ephah`); Shekel (ID: `realia:Shekel`); Balance (ID: `realia:Balance`); Sackcloth (ID: `realia:Sackcloth`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** New Moon Festival (ID: `keyterm:NewMoonFestival`); Deceit (ID: `keyterm:Deceit`); Sabbath (ID: `keyterm:Sabbath`); Shekel (ID: `realia:Shekel`); Ephah (ID: `realia:Ephah`); Balance (ID: `realia:Balance`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Samaria (ID: `place:Samaria`); Beersheba (ID: `place:Beersheba`); Tribe of Dan (ID: `group:Dan`); Dan (ID: `place:Dan`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** Samaria (ID: `place:Samaria`); Beersheba (ID: `place:Beersheba`); Tribe of Dan (ID: `group:Dan`); Dan (ID: `place:Dan`); Swear (ID: `keyterm:Swear`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Doorstep (ID: `realia:Doorstep`); Capital (ID: `realia:Capital`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`)
...
* *the serpent*: In the ancient Near East, people saw the sea as a symbol of chaos, often opposing the national god (compare Psalms 74:14; 89:10; 104:26). The biblical text does not treat the sea monster as a god. Leviathan, also called Rahab, is shown as a creature under the Lord’s authority (Psalm 89:9–10). God commands and judges this creature, showing his power over it (Isaiah 27:1).
...
* **Associated ACAI Concepts:** Cushites (ID: `group:Cush`); Kir (ID: `place:Kir`); Philistines (ID: `group:Philistine`); Cush (ID: `place:Cush.2`); Egypt (ID: `place:Egypt`); Crete (ID: `place:Crete`); Israel (ID: `person:Israel`); Philistia (ID: `place:Philistine`); Syrians (ID: `group:Syria`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Vine (ID: `flora:Vine`); Israel (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); David (ID: `person:David`); Edom (ID: `place:Edom`); Coriander (ID: `flora:Coriander`); Mattock (ID: `realia:Mattock`); Must (ID: `realia:Must`); Barley (ID: `flora:Barley`); Wine (ID: `realia:Wine`)

## Amos 9:12 (id: 9790)

* Edom (see Amos 1:11) symbolizes the enemies of God and Israel (see Isaiah 34:5–6, 11; 63:1). During the time of restoration, God's enemies will be subject to his people and to God himself.
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Mattock (ID: `realia:Mattock`); Coriander (ID: `flora:Coriander`); Must (ID: `realia:Must`); Barley (ID: `flora:Barley`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Vine (ID: `flora:Vine`); Israel (ID: `person:Israel`); Mattock (ID: `realia:Mattock`); Coriander (ID: `flora:Coriander`); Must (ID: `realia:Must`); Barley (ID: `flora:Barley`); Wine (ID: `realia:Wine`)
