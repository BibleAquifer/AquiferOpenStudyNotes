...
* **Associated ACAI Concepts:** Efrata (ID: `person:Ephrathah`); Ephrathites (ID: `group:Ephrathah`); Quiliom (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Elimeleque (ID: `person:Elimelech`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Belém (ID: `place:Bethlehem`); Moabe (ID: `place:Moab`); Malom (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); Moabe (ID: `place:Moab`); Belém (ID: `place:Bethlehem`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Noemi (ID: `person:Naomi`); kindness (ID: `keyterm:Kindness`); bless (ID: `keyterm:Bless`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); Moabe (ID: `place:Moab`); Boaz (ID: `person:Boaz`); to cause to possess (ID: `keyterm:Possess`)
...
* **Associated ACAI Concepts:** Raquel (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); Lia (ID: `person:Leah`); Belém (ID: `place:Bethlehem`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Perez (ID: `person:Perez`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Tamar (ID: `person:Tamar`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Noemi (ID: `person:Naomi`); Israel (ID: `person:Israel`); bless (ID: `keyterm:Bless`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Salmom (ID: `person:Salmon`); Hezrom (ID: `person:Hezron.2`); Obede (ID: `person:Obed`); Aminadabe (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Perez (ID: `person:Perez`); Davi (ID: `person:David`); Jessé (ID: `person:Jesse`); Boaz (ID: `person:Boaz`); Naassom (ID: `person:Nahshon`)
