...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Apphia (ID: `person:Apphia`); Archîpo (ID: `person:Archippus`); Filemón (ID: `person:Philemon`); Timoteo (ID: `person:Timothy`); iglesia (ID: `keyterm:Church`); hacer la paz (ID: `keyterm:Peace`); Pablo (ID: `person:Paul`); Jehová (ID: `deity:Lord`); amado (ID: `keyterm:Beloved`); favor (ID: `keyterm:Favor`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** amar (ID: `keyterm:Love`); santo (ID: `keyterm:Holy`); Jesús (ID: `person:Jesus.2`); creer (ID: `keyterm:Believe`); comunión (ID: `keyterm:Fellowship`); Cause of Joy (ID: `keyterm:CauseOfJoy`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); entrañas (ID: `keyterm:Affection`); Jehová (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** comunión (ID: `keyterm:Fellowship`); Good (ID: `keyterm:Good`); creer (ID: `keyterm:Believe`); Jesús (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); amar (ID: `keyterm:Love`); Pablo (ID: `person:Paul`); rogar (ID: `keyterm:AskFor`); cristo (ID: `keyterm:InChrist`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Lucas (ID: `person:Luke`); Demas (ID: `person:Demas`); Epafras (ID: `person:Epaphras`); Aristarco (ID: `person:Aristarchus`); Marcos (ID: `person:Mark`); espíritu (ID: `keyterm:Spirit.2`); cristo (ID: `keyterm:InChrist`); favor (ID: `keyterm:Favor`)
