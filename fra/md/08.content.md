...
* **Associated ACAI Concepts:** Kiljon (ID: `person:Chilion`); Éphrata (ID: `person:Ephrathah`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); Naomi (ID: `person:Naomi`); Élimélec (ID: `person:Elimelech`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Bethléhem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Machlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Bethléhem (ID: `place:Bethlehem`); Naomi (ID: `person:Naomi`); Moab (ID: `place:Moab`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** grâce (ID: `keyterm:Favor`); Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** bonté (ID: `keyterm:Kindness`); benir (ID: `keyterm:Bless`); Éternel (ID: `deity:Lord`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Élimélec (ID: `person:Elimelech`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** laissiez en possession (ID: `keyterm:Possess`); Ruth (ID: `person:Ruth`); Machlon (ID: `person:Mahlon`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Bethléhem (ID: `place:Bethlehem`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Léa (ID: `person:Leah`); Elders (ID: `group:GenericElders`); Rachel (ID: `person:Rachel`)
...
* **Associated ACAI Concepts:** Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Perets (ID: `person:Perez`); Éternel (ID: `deity:Lord`); Tamar (ID: `person:Tamar`)
...
* **Associated ACAI Concepts:** Boaz (ID: `person:Boaz`); Ruth (ID: `person:Ruth`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Hetsron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Obed (ID: `person:Obed`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Isaï (ID: `person:Jesse`); Perets (ID: `person:Perez`); David (ID: `person:David`); Boaz (ID: `person:Boaz`); Nahshon (ID: `person:Nahshon`)
