...
* **Associated ACAI Concepts:** Covenant (ID: `keyterm:Covenant`); Edomites (ID: `group:Edom`); أَدومَ (ID: `place:Edom`); Understanding (ID: `keyterm:Understanding`); Peace (ID: `keyterm:IntactState`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** أَدومَ (ID: `place:Edom`); Understanding (ID: `keyterm:Understanding`); عِيسو (ID: `place:EsauMount`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); Lot (ID: `keyterm:Lot`); يَهوذَا (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Edomites (ID: `group:Edom`); أورشَلِيمَ (ID: `place:Jerusalem`); أَدومَ (ID: `place:Edom`); يوسف (ID: `person:Joseph.10`); Dispossess (ID: `keyterm:Dispossess`)
...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); أَدومَ (ID: `place:Edom`); يوسف (ID: `person:Joseph.10`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); كَنْعَان (ID: `place:Canaan`); أَفْرَايِمَ (ID: `group:Ephraim`); أورشَلِيمَ (ID: `place:Jerusalem`); فِلِشْتِيم (ID: `group:Philistine`); بَنْيَامِينَ (ID: `person:Benjamin`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); إِسْرَائِيلَ (ID: `person:Israel`); Canaanites (ID: `group:Canaan`); جِلْعَادَ (ID: `place:Gilead`); إِلَى (ID: `place:Zarephath`); أَفْرَايِمَ (ID: `person:Ephraim`); عِيسو (ID: `place:EsauMount`); بَنْيَامِينَ (ID: `group:Benjamin`); ٱلسَّهْلِ (ID: `place:Shephelah`); سَارْدِسَ (ID: `place:Sardis`); ٱلسَّامِرَةِ (ID: `place:Samaria`)
...
* **Associated ACAI Concepts:** عِيسو (ID: `place:EsauMount`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); فِلِشْتِيم (ID: `group:Philistine`); سَارْدِسَ (ID: `place:Sardis`); Canaanites (ID: `group:Canaan`); كَنْعَان (ID: `place:Canaan`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); أَفْرَايِمَ (ID: `person:Ephraim`); بَنْيَامِينَ (ID: `group:Benjamin`); ٱلسَّهْلِ (ID: `place:Shephelah`); إِسْرَائِيلَ (ID: `person:Israel`); جِلْعَادَ (ID: `place:Gilead`); ٱلسَّامِرَةِ (ID: `place:Samaria`); أَفْرَايِمَ (ID: `group:Ephraim`); بَنْيَامِينَ (ID: `person:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); إِلَى (ID: `place:Zarephath`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); كَنْعَان (ID: `place:Canaan`); إِسْرَائِيلَ (ID: `person:Israel`); Canaanites (ID: `group:Canaan`); إِلَى (ID: `place:Zarephath`); ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); سَارْدِسَ (ID: `place:Sardis`)
