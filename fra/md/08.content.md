...
* **Associated ACAI Concepts:** Èfratite; d'Èfrata (ID: `group:Ephrathah`); Kiljon (ID: `person:Chilion`); Éphrata (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Élimélec (ID: `person:Elimelech`); Bethléhem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Machlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); grâce (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); bonté (ID: `keyterm:Kindness`); Naomi (ID: `person:Naomi`); benir (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); Boaz (ID: `person:Boaz`); laissiez en possession (ID: `keyterm:Possess`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); laissiez en possession (ID: `keyterm:Possess`); Machlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Elders (ID: `group:GenericElders`); Bethléhem (ID: `place:Bethlehem`); Éternel (ID: `deity:Lord`); Léa (ID: `person:Leah`); Rachel (ID: `person:Rachel`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Perets (ID: `person:Perez`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Tamar (ID: `person:Tamar`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Éternel (ID: `deity:Lord`); Naomi (ID: `person:Naomi`); Israël (ID: `person:Israel`); benir (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Hetsron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Obed (ID: `person:Obed`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); David (ID: `person:David`); Isaï (ID: `person:Jesse`); Nahshon (ID: `person:Nahshon`); Boaz (ID: `person:Boaz`); Perets (ID: `person:Perez`)
