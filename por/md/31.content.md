...
* **Associated ACAI Concepts:** Edom (ID: `place:Edom`); SENHOR (ID: `deity:Lord`); Monte de Esaú (ID: `place:EsauMount`); Understanding (ID: `keyterm:Understanding`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); dispossess (ID: `keyterm:Dispossess`); José (ID: `person:Joseph.10`); Edomites (ID: `group:Edom`); Jerusalém (ID: `place:Jerusalem`); Edom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** dispossess (ID: `keyterm:Dispossess`); Neguebe (ID: `place:Negeb`); Benjamim (ID: `group:Benjamin`); Canaã (ID: `place:Canaan`); Efraim (ID: `group:Ephraim`); Benjamim (ID: `person:Benjamin`); Samaria (ID: `place:Samaria`); Sefalá (ID: `place:Shephelah`); Gileade (ID: `place:Gilead`); Israel (ID: `person:Israel`); Monte de Esaú (ID: `place:EsauMount`); Filisteu (ID: `group:Philistine`); cananeu (ID: `group:Canaan`); Sarepta (ID: `place:Zarephath`); Filístia (ID: `place:Philistine`); Jerusalém (ID: `place:Jerusalem`); Sardes (ID: `place:Sardis`); Efraim (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); dispossess (ID: `keyterm:Dispossess`); Monte de Esaú (ID: `place:EsauMount`); Neguebe (ID: `place:Negeb`); Gileade (ID: `place:Gilead`); Israel (ID: `person:Israel`); cananeu (ID: `group:Canaan`); Filisteu (ID: `group:Philistine`); Efraim (ID: `person:Ephraim`); Samaria (ID: `place:Samaria`); Filístia (ID: `place:Philistine`); Canaã (ID: `place:Canaan`); SENHOR (ID: `deity:Lord`); Benjamim (ID: `person:Benjamin`); Sefalá (ID: `place:Shephelah`); Sardes (ID: `place:Sardis`); Benjamim (ID: `group:Benjamin`); Efraim (ID: `group:Ephraim`); Sarepta (ID: `place:Zarephath`)
...
* **Associated ACAI Concepts:** Canaã (ID: `place:Canaan`); dispossess (ID: `keyterm:Dispossess`); Israel (ID: `person:Israel`); cananeu (ID: `group:Canaan`); Sarepta (ID: `place:Zarephath`); Jerusalém (ID: `place:Jerusalem`); Neguebe (ID: `place:Negeb`); Sardes (ID: `place:Sardis`)
