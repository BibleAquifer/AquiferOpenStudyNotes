...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); fear (ID: `keyterm:Fear`); Fish (ID: `fauna:Fish`); Ship (ID: `realia:Ship`); make a vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); Nínive (ID: `place:Nineveh`); Jope (ID: `place:Joppa`); Amittai (ID: `person:Amittai`); kindness (ID: `keyterm:Kindness`); praise (ID: `keyterm:Praise`); Társis (ID: `place:Tarshish`); salvation (ID: `keyterm:Salvation`); exempt (ID: `keyterm:Exempt`); slaughtering (ID: `keyterm:Slaughtering`); lot (ID: `keyterm:Lot`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Hebrews (ID: `group:Hebrews`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Hell (ID: `place:Hell`); Jonas (ID: `person:Jonah.2`); make a vow (ID: `keyterm:Vow`); salvation (ID: `keyterm:Salvation`); praise (ID: `keyterm:Praise`); kindness (ID: `keyterm:Kindness`); Cattails (ID: `flora:Cattails`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** make a vow (ID: `keyterm:Vow`); SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); kindness (ID: `keyterm:Kindness`); praise (ID: `keyterm:Praise`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Nínive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Believe In (ID: `keyterm:BelieveIn`); Compassionate (ID: `keyterm:Compassionate`); gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`); kindness (ID: `keyterm:Kindness`); Clothing (ID: `realia:Clothing`); Worm (ID: `fauna:Maggot`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Throne (ID: `realia:Throne`)
