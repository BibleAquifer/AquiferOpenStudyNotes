...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); أورشَلِيمَ (ID: `place:Jerusalem`); Strength (ID: `keyterm:Strength`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Love (ID: `keyterm:Love`); Deceit (ID: `keyterm:Deceit`); Work (ID: `keyterm:Work`); Mighty One (ID: `keyterm:MightyOne`); Defilement (ID: `keyterm:Defilement`); To Sin (ID: `keyterm:Sin`); إِسْرَائِيلَ (ID: `person:Israel`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Appointed Feast (ID: `keyterm:AppointedFeast`); Train (ID: `realia:Train`); Winepress (ID: `realia:Winepress`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Deer (ID: `fauna:Deer`); House (ID: `realia:House`); Yoke (ID: `realia:Yoke`); Net (ID: `realia:Net`); Grass (ID: `flora:Grass`); Casting Net (ID: `realia:CastingNet`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); Defilement (ID: `keyterm:Defilement`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); To Sin (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); Mighty One (ID: `keyterm:MightyOne`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Appointed Feast (ID: `keyterm:AppointedFeast`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Horn (ID: `keyterm:Horn`); Sheep (ID: `fauna:Lamb`); Gentiles (ID: `group:Gentile`); To Dishonor (ID: `keyterm:Dishonor`); Have a Vision (ID: `keyterm:HaveAVision`); Utterance (ID: `keyterm:Utterance`); Instruction (ID: `keyterm:Instruction`); Sabbath (ID: `keyterm:Sabbath`); Passion (ID: `keyterm:Ardour`); Tent (ID: `realia:Tent`); Measuring Reed (ID: `realia:MeasuringReed`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Sackcloth (ID: `realia:Sackcloth`); Stone Altar (ID: `realia:StoneAltar`); Grain (ID: `flora:Grain`); Bow (ID: `realia:Bow`); Vine (ID: `flora:Vine`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Appointed Feast (ID: `keyterm:AppointedFeast`); ٱلرَّبِّ (ID: `deity:Lord`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Wormwood (ID: `flora:Wormwood`); Arrow (ID: `realia:Arrow`); Kindness (ID: `keyterm:Kindness`); Arrow (ID: `keyterm:Arrow`); Peace (ID: `keyterm:IntactState`); Complete (ID: `keyterm:Complete`); Lion (ID: `fauna:Lion`); Bear (ID: `fauna:Bear`); Bow (ID: `realia:Bow`); Hewn Stone (ID: `realia:HewnStone`); Bitter Herbs (ID: `flora:Chicory`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Rebel (ID: `keyterm:Rebel`); Forgive (ID: `keyterm:Forgive`); Peace (ID: `keyterm:IntactState`); Complete (ID: `keyterm:Complete`); To Sin (ID: `keyterm:Sin`); Hope (ID: `keyterm:Hope`); Arrow (ID: `keyterm:Arrow`); Redeem (ID: `keyterm:Redeem`); Fear (ID: `keyterm:Fear`); Salvation (ID: `keyterm:Salvation`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Pit (ID: `realia:Pit`); Wormwood (ID: `flora:Wormwood`); Arrow (ID: `realia:Arrow`); Lion (ID: `fauna:Lion`); Hewn Stone (ID: `realia:HewnStone`); Bow (ID: `realia:Bow`); Yoke (ID: `realia:Yoke`); Bitter Herbs (ID: `flora:Chicory`); Bird (ID: `fauna:Bird`); Bear (ID: `fauna:Bear`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); أَدومَ (ID: `place:Edom`); To Sin (ID: `keyterm:Sin`); عوصًا (ID: `place:Uz`); Defile (ID: `keyterm:Stain`); Punishment (ID: `keyterm:Punishment`); Complete (ID: `keyterm:Complete`); Believe In (ID: `keyterm:BelieveIn`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); سَدومَ (ID: `place:Sodom`); Defilement (ID: `keyterm:Defilement`); Anointed (ID: `keyterm:Anointed`); Appoint (ID: `keyterm:Appoint`); Ostrich (ID: `fauna:Ostrich`); Jackal (ID: `fauna:Jackal`); Vulture (ID: `fauna:Vulture`); Clay Jar (ID: `realia:ClayJar`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** أَدومَ (ID: `place:Edom`); عوصًا (ID: `place:Uz`); Passion (ID: `keyterm:Ardour`); أورشَلِيمَ (ID: `place:Jerusalem`); Complete (ID: `keyterm:Complete`); To Sin (ID: `keyterm:Sin`); Appoint (ID: `keyterm:Appoint`)
...
* **Associated ACAI Concepts:** Passion (ID: `keyterm:Ardour`); أورشَلِيمَ (ID: `place:Jerusalem`); أَدومَ (ID: `place:Edom`); Complete (ID: `keyterm:Complete`); To Sin (ID: `keyterm:Sin`); Appoint (ID: `keyterm:Appoint`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); مِصْرَ (ID: `place:Egypt`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Assyria (ID: `place:Assyria`); Passion (ID: `keyterm:Ardour`); Round Dance (ID: `keyterm:RoundDance`); To Cause to Possess (ID: `keyterm:Possess`); Woe (ID: `keyterm:Woe`); Crown (ID: `realia:Crown`); Jackal (ID: `fauna:Jackal`); Hand-Mill (ID: `realia:Hand-mill`); House (ID: `realia:House`); Money (ID: `realia:Money`)
