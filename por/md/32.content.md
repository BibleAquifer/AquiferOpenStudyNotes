...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); make a vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); Amittai (ID: `person:Amittai`); Jope (ID: `place:Joppa`); Nínive (ID: `place:Nineveh`); slaughtering (ID: `keyterm:Slaughtering`); Hebrews (ID: `group:Hebrews`); kindness (ID: `keyterm:Kindness`); lot (ID: `keyterm:Lot`); salvation (ID: `keyterm:Salvation`); exempt (ID: `keyterm:Exempt`); praise (ID: `keyterm:Praise`); Társis (ID: `place:Tarshish`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Hell (ID: `place:Hell`); make a vow (ID: `keyterm:Vow`); Jonas (ID: `person:Jonah.2`); praise (ID: `keyterm:Praise`); kindness (ID: `keyterm:Kindness`); salvation (ID: `keyterm:Salvation`); Fish (ID: `fauna:Fish`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** make a vow (ID: `keyterm:Vow`); praise (ID: `keyterm:Praise`); SENHOR (ID: `deity:Lord`); kindness (ID: `keyterm:Kindness`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Nínive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Sackcloth (ID: `realia:Sackcloth`); Cattle (ID: `fauna:Bull`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Társis (ID: `place:Tarshish`); gracious (ID: `keyterm:Generous`); Compassionate (ID: `keyterm:Compassionate`); Believe In (ID: `keyterm:BelieveIn`); kindness (ID: `keyterm:Kindness`); Throne (ID: `realia:Throne`); Worm (ID: `fauna:Maggot`); Flock (ID: `fauna:Flock`); Clothing (ID: `realia:Clothing`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Nínive (ID: `place:Nineveh`); Throne (ID: `realia:Throne`); Clothing (ID: `realia:Clothing`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); Társis (ID: `place:Tarshish`); gracious (ID: `keyterm:Generous`); Compassionate (ID: `keyterm:Compassionate`); kindness (ID: `keyterm:Kindness`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Társis (ID: `place:Tarshish`); gracious (ID: `keyterm:Generous`); Compassionate (ID: `keyterm:Compassionate`); SENHOR (ID: `deity:Lord`); kindness (ID: `keyterm:Kindness`)
