...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Judas (ID: `person:Jude`); misericórdia (ID: `keyterm:Mercy`); fazer a paz (ID: `keyterm:Peace`); SENHOR (ID: `deity:Lord`); Tiago (ID: `person:James.3`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** empenho (ID: `keyterm:Eagerness`); holy (ID: `keyterm:Holy`); crer (ID: `keyterm:Believe`); amado (ID: `keyterm:Beloved`); salvation (ID: `keyterm:Salvation`); comum (ID: `keyterm:InCommon`); rogar (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** empenho (ID: `keyterm:Eagerness`); holy (ID: `keyterm:Holy`); juízo (ID: `keyterm:Judgment`); crer (ID: `keyterm:Believe`); amado (ID: `keyterm:Beloved`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); salvation (ID: `keyterm:Salvation`); comum (ID: `keyterm:InCommon`); Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** para a eternidade (ID: `keyterm:Always`); tribunal de justiça (ID: `keyterm:CourtCase`); juízo (ID: `keyterm:Judgment`); blasfemar (ID: `keyterm:Blaspheme`); corpo (ID: `keyterm:Body.3`); SENHOR (ID: `deity:Lord`); Corá (ID: `person:Korah.3`); Ability (ID: `keyterm:Ability`); speak (ID: `keyterm:Speak`); salvation (ID: `keyterm:Salvation`); Sodoma (ID: `place:Sodom`); To Command (ID: `keyterm:Command`); ágape (ID: `keyterm:FellowshipMeal`); fogo eterno (ID: `keyterm:EternalFire`); Miguel (ID: `person:Michael.11`); distinguir (ID: `keyterm:Discern`); defilement (ID: `keyterm:Defilement`); Enoque (ID: `person:Enoch.2`); holy (ID: `keyterm:Holy`); Moisés (ID: `person:Moses`); Jesus (ID: `person:Jesus.2`); Balaão (ID: `person:Balaam`); Adão (ID: `person:Adam`); An Angel (ID: `deity:Angel`); crer (ID: `keyterm:Believe`); Gomorra (ID: `place:Gomorrah`); Egito (ID: `place:Egypt`); Caim (ID: `person:Cain`); Disaster (ID: `keyterm:Disaster`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Chain (ID: `realia:Chain`)
...
* **Associated ACAI Concepts:** fogo eterno (ID: `keyterm:EternalFire`); Gomorra (ID: `place:Gomorrah`); Sodoma (ID: `place:Sodom`); corpo (ID: `keyterm:Body.3`); para a eternidade (ID: `keyterm:Always`)
...
* **Associated ACAI Concepts:** juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`); Moisés (ID: `person:Moses`); Miguel (ID: `person:Michael.11`); tribunal de justiça (ID: `keyterm:CourtCase`); blasfemar (ID: `keyterm:Blaspheme`); To Command (ID: `keyterm:Command`); distinguir (ID: `keyterm:Discern`); corpo (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** Adão (ID: `person:Adam`); Enoque (ID: `person:Enoch.2`); holy (ID: `keyterm:Holy`); juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`); speak (ID: `keyterm:Speak`); tribunal de justiça (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`); Holy Spirit (ID: `deity:HolySpirit`); amado (ID: `keyterm:Beloved`); orar (ID: `keyterm:Pray`); salvation (ID: `keyterm:Salvation`); Life (ID: `keyterm:Life`); SENHOR (ID: `deity:Lord`); distinguir (ID: `keyterm:Discern`); para a eternidade (ID: `keyterm:Always`); holy (ID: `keyterm:Holy`); palavra (ID: `keyterm:Word`); causar divisões (ID: `keyterm:CreatingDivisions`); love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`); natural (ID: `keyterm:Natural`); corpo (ID: `keyterm:Body.3`); fear (ID: `keyterm:Fear`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** holy (ID: `keyterm:Holy`); orar (ID: `keyterm:Pray`); crer (ID: `keyterm:Believe`); amado (ID: `keyterm:Beloved`); Holy Spirit (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** misericórdia (ID: `keyterm:Mercy`); salvation (ID: `keyterm:Salvation`); distinguir (ID: `keyterm:Discern`); corpo (ID: `keyterm:Body.3`); fear (ID: `keyterm:Fear`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); irrepreensível (ID: `keyterm:Unblemished`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); autoridade (ID: `keyterm:Authority.2`); salvador (ID: `keyterm:Savior`); surely! (ID: `keyterm:Surely`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`)
