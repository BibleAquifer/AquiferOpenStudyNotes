...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); حَجَّيِ (ID: `person:Haggai`); دَارِيوسَ (ID: `person:Darius.2`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `group:Judah`); زَربَّابِل (ID: `person:Zerubbabel.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); ٱلرَّبِّ (ID: `deity:Lord`); حَجَّيِ (ID: `person:Haggai`); Fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `group:Judah`); زَربَّابِل (ID: `person:Zerubbabel.2`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); حَجَّيِ (ID: `person:Haggai`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `group:Judah`); مِصْرَ (ID: `place:Egypt`); Peace (ID: `keyterm:IntactState`); Word of the Lord (ID: `keyterm:WordOfTheLord`); يَهوذَا (ID: `person:Judah.4`); Fear (ID: `keyterm:Fear`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); ٱلرَّبِّ (ID: `deity:Lord`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); حَجَّيِ (ID: `person:Haggai`); يَهوذَا (ID: `person:Judah.4`); Horse (ID: `fauna:Horse`); Chariot (ID: `realia:Chariot`); Sword (ID: `realia:Sword`)
