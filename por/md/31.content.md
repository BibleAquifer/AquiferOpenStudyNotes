...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); lot (ID: `keyterm:Lot`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); José (ID: `person:Joseph.10`); Edomites (ID: `group:Edom`); Edom (ID: `place:Edom`); dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** José (ID: `person:Joseph.10`); Edomites (ID: `group:Edom`); Edom (ID: `place:Edom`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Canaã (ID: `place:Canaan`); Gileade (ID: `place:Gilead`); Monte de Esaú (ID: `place:EsauMount`); Filístia (ID: `place:Philistine`); Efraim (ID: `group:Ephraim`); Efraim (ID: `person:Ephraim`); Sefalá (ID: `place:Shephelah`); Sarepta (ID: `place:Zarephath`); Samaria (ID: `place:Samaria`); Sardes (ID: `place:Sardis`); Benjamim (ID: `person:Benjamin`); Benjamim (ID: `group:Benjamin`); Filisteu (ID: `group:Philistine`); cananeu (ID: `group:Canaan`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); Jerusalém (ID: `place:Jerusalem`); Monte de Esaú (ID: `place:EsauMount`); dispossess (ID: `keyterm:Dispossess`); Canaã (ID: `place:Canaan`); Samaria (ID: `place:Samaria`); cananeu (ID: `group:Canaan`); Benjamim (ID: `group:Benjamin`); Sardes (ID: `place:Sardis`); Filístia (ID: `place:Philistine`); Efraim (ID: `group:Ephraim`); Israel (ID: `person:Israel`); Sefalá (ID: `place:Shephelah`); Filisteu (ID: `group:Philistine`); Gileade (ID: `place:Gilead`); Efraim (ID: `person:Ephraim`); Sarepta (ID: `place:Zarephath`); Benjamim (ID: `person:Benjamin`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Canaã (ID: `place:Canaan`); Neguebe (ID: `place:Negeb`); Sarepta (ID: `place:Zarephath`); Israel (ID: `person:Israel`); cananeu (ID: `group:Canaan`); dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`); Sardes (ID: `place:Sardis`)
