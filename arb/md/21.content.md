...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); أورشَلِيمَ (ID: `place:Jerusalem`); Intention (ID: `keyterm:Intention`); ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vine (ID: `flora:Vine`); إِسْرَائِيلَ (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); Sandalwood (ID: `flora:Sandalwood`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); أورشَلِيمَ (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); Sandalwood (ID: `flora:Sandalwood`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Sandalwood (ID: `flora:Sandalwood`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vow (ID: `keyterm:Vow`); House (ID: `realia:House`); Passion (ID: `keyterm:Ardour`); Fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Strength (ID: `keyterm:Strength`); A Man (ID: `person:GenericMale`); Slaughtering (ID: `keyterm:Slaughtering`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Stupid (ID: `keyterm:Stupid`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); To Act Wickedly (ID: `keyterm:ActWickedly`); To Sin (ID: `keyterm:Sin`); Fear (ID: `keyterm:Fear`); To Cause to Possess (ID: `keyterm:Possess`); Intention (ID: `keyterm:Intention`); Cooking Pot (ID: `realia:CookingPot`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Love (ID: `keyterm:Love`); Ability (ID: `keyterm:Ability`); Strength (ID: `keyterm:Strength`); Hell (ID: `place:Hell`); Intention (ID: `keyterm:Intention`); Vine (ID: `flora:Vine`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Caper (ID: `flora:Caper`); Almond (ID: `flora:Almond`); Locust (ID: `fauna:Locust`); Pit (ID: `realia:Pit`); Bird (ID: `fauna:Bird`); Rope (ID: `realia:Rope`); Money (ID: `realia:Money`); Clay Jar (ID: `realia:ClayJar`)
