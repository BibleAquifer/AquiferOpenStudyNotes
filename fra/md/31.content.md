...
* **Associated ACAI Concepts:** Édom (ID: `group:Edom`); Édom (ID: `place:Edom`); comprehension (ID: `keyterm:Understanding`); état intact (ID: `keyterm:IntactState`); alliance (ID: `keyterm:Covenant`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** Juda (ID: `group:Judah`); destin (ID: `keyterm:Lot`); Juda (ID: `person:Judah.4`); Jérusalem (ID: `place:Jerusalem`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Joseph (ID: `person:Joseph.10`); Édom (ID: `group:Edom`); Édom (ID: `place:Edom`); déposséder (ID: `keyterm:Dispossess`); Jérusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Joseph (ID: `person:Joseph.10`); Édom (ID: `group:Edom`); Édom (ID: `place:Edom`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Negev (ID: `place:Negeb`); déposséder (ID: `keyterm:Dispossess`); Canaan (ID: `place:Canaan`); Galaad (ID: `place:Gilead`); montagne d'Ésaü (ID: `place:EsauMount`); Philistia (ID: `place:Philistine`); Éphraïm (ID: `group:Ephraim`); Éphraïm (ID: `person:Ephraim`); Shephelah (ID: `place:Shephelah`); Sarepta (ID: `place:Zarephath`); Samarie (ID: `place:Samaria`); Sardes (ID: `place:Sardis`); Benjamin (ID: `person:Benjamin`); Benjamin (ID: `group:Benjamin`); Philistins (ID: `group:Philistine`); Canaan (ID: `group:Canaan`); Jérusalem (ID: `place:Jerusalem`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Negev (ID: `place:Negeb`); Jérusalem (ID: `place:Jerusalem`); montagne d'Ésaü (ID: `place:EsauMount`); déposséder (ID: `keyterm:Dispossess`); Canaan (ID: `place:Canaan`); Samarie (ID: `place:Samaria`); Canaan (ID: `group:Canaan`); Benjamin (ID: `group:Benjamin`); Sardes (ID: `place:Sardis`); Philistia (ID: `place:Philistine`); Éphraïm (ID: `group:Ephraim`); Israël (ID: `person:Israel`); Shephelah (ID: `place:Shephelah`); Philistins (ID: `group:Philistine`); Galaad (ID: `place:Gilead`); Éphraïm (ID: `person:Ephraim`); Sarepta (ID: `place:Zarephath`); Benjamin (ID: `person:Benjamin`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Canaan (ID: `place:Canaan`); Negev (ID: `place:Negeb`); Sarepta (ID: `place:Zarephath`); Israël (ID: `person:Israel`); Canaan (ID: `group:Canaan`); déposséder (ID: `keyterm:Dispossess`); Jérusalem (ID: `place:Jerusalem`); Sardes (ID: `place:Sardis`)
