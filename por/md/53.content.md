...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Tessalônica (ID: `place:Thessalonica`); Thessalonians (ID: `group:Thessalonica`); igreja (ID: `keyterm:Church`); Timóteo (ID: `person:Timothy`); fazer a paz (ID: `keyterm:Peace`); favor (ID: `keyterm:Favor`); Silas (ID: `person:Silas`); Paulo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); ser glorificado (ID: `keyterm:Glorified`); boa notícia (ID: `keyterm:GoodNews`); céu (ID: `keyterm:Heaven`); An Angel (ID: `deity:Angel`); tribunal de justiça (ID: `keyterm:CourtCase`); testemunhar (ID: `keyterm:BearWitness`); reino (ID: `keyterm:Kingdom`); dever (ID: `keyterm:Ought`); holy (ID: `keyterm:Holy`); Ability (ID: `keyterm:Ability`); juízo (ID: `keyterm:Judgment`); para a eternidade (ID: `keyterm:Always`); Glory (ID: `keyterm:Glory`); fazer justiça (ID: `keyterm:GrantJustice`); love (ID: `keyterm:Love`); igreja (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); Good (ID: `keyterm:Good`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Good (ID: `keyterm:Good`); ser glorificado (ID: `keyterm:Glorified`); Ability (ID: `keyterm:Ability`); To Cause to Happen (ID: `keyterm:Happen`); Name (ID: `keyterm:Name`); favor (ID: `keyterm:Favor`); orar (ID: `keyterm:Pray`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); Spirit (ID: `keyterm:Spirit.2`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); wipe (out), destroy (ID: `keyterm:Destroy`); love (ID: `keyterm:Love`); example (ID: `keyterm:Example`); decidir (ID: `keyterm:Decided`); rogar (ID: `keyterm:AskFor`); Satanás (ID: `deity:Satan`); Ability (ID: `keyterm:Ability`); maravilha (ID: `keyterm:Portent`); objeto de culto (ID: `keyterm:ObjectOfWorship`); salvation (ID: `keyterm:Salvation`); injustiça (ID: `keyterm:UnjustDeed`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Good (ID: `keyterm:Good`); hope (ID: `keyterm:Hope`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); favor (ID: `keyterm:Favor`); para a eternidade (ID: `keyterm:Always`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); crer (ID: `keyterm:Believe`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); Faithfulness (ID: `keyterm:Faithfulness`); persuadir (ID: `keyterm:Persuade`); livrar (ID: `keyterm:Deliver`); orar (ID: `keyterm:Pray`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** andar (ID: `keyterm:Live.3`); Name (ID: `keyterm:Name`); Jesus (ID: `person:Jesus.2`); tradição (ID: `keyterm:Teaching`)
...
* **Associated ACAI Concepts:** andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); rogar (ID: `keyterm:AskFor`); Name (ID: `keyterm:Name`); autoridade (ID: `keyterm:Authority.2`); tradição (ID: `keyterm:Teaching`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`)
