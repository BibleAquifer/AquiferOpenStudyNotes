...
* **Associated ACAI Concepts:** Efrata (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Ephrathites (ID: `group:Ephrathah`); Mahlon (ID: `person:Chilion`); Yehuda (ID: `group:Judah`); Mahlon (ID: `person:Mahlon`); Elimelekh (ID: `person:Elimelech`); Betlehem (ID: `place:Bethlehem`); Yehuda (ID: `person:Judah.4`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); kebaikan (ID: `keyterm:Favor`); Rut (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** menyebabkan memiliki (ID: `keyterm:Possess`); Mahlon (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Rut (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Elders (ID: `group:GenericElders`); Betlehem (ID: `place:Bethlehem`); Lea (ID: `person:Leah`); Rahel (ID: `person:Rachel`); Tuhan (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** memperanakkan (ID: `person:Salmon`); Hezron (ID: `person:Hezron.2`); Obed (ID: `person:Obed`); Aminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Isai (ID: `person:Jesse`); Boas (ID: `person:Boaz`); Nahason (ID: `person:Nahshon`); Peres (ID: `person:Perez`); Daud (ID: `person:David`)
