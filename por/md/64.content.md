...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Faithfulness (ID: `keyterm:Faithfulness`); amado (ID: `keyterm:Beloved`); Name (ID: `keyterm:Name`); igreja (ID: `keyterm:Church`); testemunhar (ID: `keyterm:BearWitness`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); dever (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** igreja (ID: `keyterm:Church`); Demétrio (ID: `person:Demetrius`); Diótrefes (ID: `person:Diotrephes`); Good (ID: `keyterm:Good`); verdadeiro (ID: `keyterm:True`); amado (ID: `keyterm:Beloved`); testemunhar (ID: `keyterm:BearWitness`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); Do Good (ID: `keyterm:DoGood`)
