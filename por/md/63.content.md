...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); favor (ID: `keyterm:Favor`); escolhido (ID: `keyterm:Chosen`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`); misericórdia (ID: `keyterm:Mercy`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); favor (ID: `keyterm:Favor`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); Jesus (ID: `person:Jesus.2`); misericórdia (ID: `keyterm:Mercy`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); andar (ID: `keyterm:Live.3`); rogar (ID: `keyterm:AskFor`); Truth (ID: `keyterm:Truth`); corpo (ID: `keyterm:Body.3`); compartilhar (ID: `keyterm:Share`); Ability (ID: `keyterm:Ability`); House (ID: `realia:House`)
