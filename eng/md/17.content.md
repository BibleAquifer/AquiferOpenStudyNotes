...
* **Associated ACAI Concepts:** Zethar (ID: `person:Zethar`); Mehuman (ID: `person:Mehuman`); Carkas (ID: `person:Carkas`); Biztha (ID: `person:Biztha`); Bigtha (ID: `person:Bigtha`); Harbona (ID: `person:Harbona`); Abagtha (ID: `person:Abagtha`); Ahasuerus (ID: `person:Ahasuerus`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Vashti (ID: `person:Vashti`); Persia (ID: `place:Persia`); Medes (ID: `group:Mede`); Ahasuerus (ID: `person:Ahasuerus`); Medan (ID: `person:Medan`); Persians (ID: `group:Persia`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Judah (ID: `person:Judah.4`); Babylon (ID: `place:Babylon`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Tribe of Judah (ID: `group:Judah`); Jehoiachin (ID: `person:Jehoiachin`)
## Esther 2:7 (id: 10917)
...
* **Associated ACAI Concepts:** Esther (ID: `person:Esther`); Favor (ID: `keyterm:Favor`); Vashti (ID: `person:Vashti`); Love (ID: `keyterm:Love`); Kindness (ID: `keyterm:Kindness`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Ahasuerus (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); Hammedatha (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Money (ID: `realia:Money`); Susa (ID: `place:Susa`); Lot (ID: `keyterm:Lot`); Servants (ID: `group:GenericServants`); Lot (ID: `realia:Lot`); Scroll (ID: `realia:Scroll`); Talent (ID: `realia:Talent`)
## Esther 3:2 (id: 10924)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Ahasuerus (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); Haman (ID: `person:Haman`)
## Esther 3:7 (id: 10926)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Zeresh (ID: `person:Zeresh`); Love (ID: `keyterm:Love`); A Group of People (ID: `group:GenericGroup`); Esther (ID: `person:Esther`); Glory (ID: `keyterm:Glory`); Jews (ID: `group:Jews`); Cubit (ID: `realia:Cubit`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Esther (ID: `person:Esther`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Agag (ID: `person:Agag.2`); Agagites (ID: `group:Agag`); Jews (ID: `group:Jews`)
## Esther 8:5 (id: 10963)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Susa (ID: `place:Susa`); Crown (ID: `realia:Crown`); Linen (ID: `realia:Linen`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** Aspatha (ID: `person:Aspatha`); Parmashta (ID: `person:Parmashta`); Adalia (ID: `person:Adalia`); Vaizatha (ID: `person:Vaizatha`); Aridai (ID: `person:Aridai`); Aridatha (ID: `person:Aridatha`); Poratha (ID: `person:Poratha`); Arisai (ID: `person:Arisai`); Parshandatha (ID: `person:Parshandatha`); Dalphon (ID: `person:Dalphon`); Haman (ID: `person:Haman`); Hammedatha (ID: `person:Hammedatha`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Ahasuerus (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); Peace (ID: `keyterm:IntactState`)
