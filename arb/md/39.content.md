...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Love (ID: `keyterm:Love`); أَدومَ (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Glory (ID: `keyterm:Glory`); Fear (ID: `keyterm:Fear`); Priests (ID: `group:GenericPriests`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Fear (ID: `keyterm:Fear`); Covenant (ID: `keyterm:Covenant`); Offering (ID: `keyterm:Offering`); Peace (ID: `keyterm:IntactState`); Priests (ID: `group:GenericPriests`); Glory (ID: `keyterm:Glory`); Defile (ID: `keyterm:Stain`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); To Curse (ID: `keyterm:Curse`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Fairness (ID: `keyterm:Fairness`); Bless (ID: `keyterm:Bless`); Truth (ID: `keyterm:Truth`); Intention (ID: `keyterm:Intention`); Gentiles (ID: `group:Gentile`); An Angel (ID: `deity:Angel`); Passion (ID: `keyterm:Ardour`); The Way (ID: `keyterm:TheWay`); Pure (ID: `keyterm:Pure`); Vow (ID: `keyterm:Vow`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Ask for (ID: `keyterm:AskFor`); To Dishonor (ID: `keyterm:Dishonor`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Defile (ID: `keyterm:Stain`); ٱلرَّبِّ (ID: `deity:Lord`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); To Dishonor (ID: `keyterm:Dishonor`); Offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); Love (ID: `keyterm:Love`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); Delight (ID: `keyterm:Delight`); يَهوذَا (ID: `person:Judah.4`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); To Dishonor (ID: `keyterm:Dishonor`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); أورشَلِيمَ (ID: `place:Jerusalem`); Fear (ID: `keyterm:Fear`); يَهوذَا (ID: `group:Judah`); An Angel (ID: `deity:Angel`); Swear (ID: `keyterm:Swear`); لَّاوِي (ID: `person:Levi.3`); Pure (ID: `keyterm:Pure`); يَهوذَا (ID: `person:Judah.4`); A Group of People (ID: `group:GenericGroup`); لَّاوِي (ID: `group:Levi`); Covenant (ID: `keyterm:Covenant`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Bless (ID: `keyterm:Bless`); إِسْرَائِيلَ (ID: `person:Israel`); To Curse (ID: `keyterm:Curse`); Decree (ID: `keyterm:Decree`); Offering (ID: `keyterm:Offering`); Wheat (ID: `flora:Wheat`); House (ID: `realia:House`); Sorghum (ID: `flora:Sorghum`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Force to Serve (ID: `keyterm:EnticedToServe`); Fear (ID: `keyterm:Fear`); Animal Pen (ID: `realia:AnimalPen`); Scroll (ID: `realia:Scroll`); Molten Image (ID: `realia:MoltenImage`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); سِينَاءَ (ID: `place:SinaiMount`); Decree (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`); موسَى (ID: `person:Moses`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Fear (ID: `keyterm:Fear`); سِينَاءَ (ID: `place:SinaiMount`); إِيلِيَّا (ID: `person:Elijah`); Decree (ID: `keyterm:Decree`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Instruction (ID: `keyterm:Instruction`); موسَى (ID: `person:Moses`); ٱلرَّبِّ (ID: `deity:Lord`)
