...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Archîpo (ID: `person:Archippus`); Apphia (ID: `person:Apphia`); Filemón (ID: `person:Philemon`); iglesia (ID: `keyterm:Church`); favor (ID: `keyterm:Favor`); Pablo (ID: `person:Paul`); hacer la paz (ID: `keyterm:Peace`); amado (ID: `keyterm:Beloved`); Jehová (ID: `deity:Lord`); Timoteo (ID: `person:Timothy`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); santo (ID: `keyterm:Holy`); amar (ID: `keyterm:Love`); creer (ID: `keyterm:Believe`); entrañas (ID: `keyterm:Affection`); Good (ID: `keyterm:Good`); comunión (ID: `keyterm:Fellowship`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Jehová (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Pablo (ID: `person:Paul`); amar (ID: `keyterm:Love`); cristo (ID: `keyterm:InChrist`); rogar (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Demas (ID: `person:Demas`); Epafras (ID: `person:Epaphras`); Lucas (ID: `person:Luke`); espíritu (ID: `keyterm:Spirit.2`); favor (ID: `keyterm:Favor`); Marcos (ID: `person:Mark`); Aristarco (ID: `person:Aristarchus`); cristo (ID: `keyterm:InChrist`)
