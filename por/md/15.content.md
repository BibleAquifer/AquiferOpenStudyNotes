...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Pérsia (ID: `place:Persia`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Israel (ID: `person:Israel`); Jeremias (ID: `person:Jeremiah.6`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `group:Benjamin`); Judá (ID: `person:Judah.4`); Levi (ID: `group:Levi`); SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `person:Benjamin`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Ciro (ID: `person:Cyrus`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Zorobabel (ID: `person:Zerubbabel.2`); Pérsia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Levi (ID: `person:Levi.3`); Salomão (ID: `person:Solomon`); Levi (ID: `group:Levi`); Jerusalém (ID: `place:Jerusalem`); Joabe (ID: `person:Joab.3`); Mordecai (ID: `person:Mordecai`); Querube (ID: `place:Cherub`); Mispar (ID: `person:Mispar`); Meunim (ID: `group:Meunim`); Necoda (ID: `person:Nekoda.2`); Tel-Harsa (ID: `place:Tel-harsha`); Jedaías (ID: `person:Jedaiah.4`); Neemias (ID: `person:Nehemiah`); Hatifa (ID: `person:Hatipha`); Hagaba (ID: `person:Hagabah`); Parós (ID: `person:Parosh`); Reelaías (ID: `person:Reelaiah`); Uza (ID: `person:Uzza.2`); Hodavias (ID: `person:Hodaviah.4`); Harim (ID: `person:Harim`); Sephatias (ID: `person:Shephatiah.6`); Harur (ID: `person:Harhur`); Sisera (ID: `person:Sisera.2`); Queros (ID: `person:Keros`); Gidel (ID: `person:Giddel.2`); Ater (ID: `person:Ater.2`); Bazlite (ID: `person:Bazluth`); Hatil (ID: `person:Hattil`)
...
* **Associated ACAI Concepts:** Neemias (ID: `person:Nehemiah`); Seraias (ID: `person:Seraiah.6`); Baana (ID: `person:Baanah.3`); Mordecai (ID: `person:Mordecai`); Bilsã (ID: `person:Bilshan`); Reelaías (ID: `person:Reelaiah`); Mispar (ID: `person:Mispar`); Reum (ID: `person:Rehum`); Bigvai (ID: `person:Bigvai`); Israel (ID: `person:Israel`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Elam (ID: `person:Elam`); Paate-Moabe (ID: `person:Pahath-moab`); Joabe (ID: `person:Joab.3`); Ará (ID: `person:Arah.2`); Bezai (ID: `person:Bezai`); Adonicão (ID: `person:Adonikam`); Adim (ID: `person:Adin`); Bigvai (ID: `person:Bigvai.2`); Ezequias (ID: `person:Hezekiah.2`); Jora (ID: `person:Jorah`); Parós (ID: `person:Parosh`); Sephatias (ID: `person:Shephatiah.6`); Hasum (ID: `person:Hashum`); Jesua (ID: `person:Jeshua.3`); Bebai (ID: `person:Bebai`); Zacai (ID: `person:Zaccai.2`); Bani (ID: `person:Bani`); Ater (ID: `person:Ater`); Asgade (ID: `person:Azgad`); Zatu (ID: `person:Zattu.2`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Netofa (ID: `place:Netophah`); Hadide (ID: `place:Hadid`); Harim (ID: `person:Harim.2`); Nebo (ID: `place:Nebo.2`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Magbis (ID: `place:Magbish`); Senaa (ID: `place:Senaah`); Lode (ID: `place:Lod`); Anatote (ID: `place:Anathoth`); Elam (ID: `person:Elam`); Beerote (ID: `place:Beeroth`); Micmás (ID: `place:Michmash`); Belém (ID: `place:Bethlehem`); Geba (ID: `place:Geba`); Cefira (ID: `place:Chephirah`); Ai (ID: `place:Ai`); Ramah (ID: `place:Ramah.2`); Ono (ID: `place:Ono`); Betel (ID: `place:Bethel`); Jericó (ID: `place:Jericho`); Quiriate-Jearim (ID: `place:Kiriath-jearim`)
...
* **Associated ACAI Concepts:** Sobai (ID: `person:Shobai`); Imer (ID: `person:Immer.2`); Hatita (ID: `person:Hatita`); Ater (ID: `person:Ater.2`); Talmom (ID: `person:Talmon`); Jesua (ID: `person:Jeshua.4`); Hodavias (ID: `person:Hodaviah.4`); Jesua (ID: `person:Jeshua`); Jedaías (ID: `person:Jedaiah.4`); Harim (ID: `person:Harim`); Pasur (ID: `person:Pashhur`); Salum (ID: `person:Shallum.8`); Levi (ID: `group:Levi`); Cadmiel (ID: `person:Kadmiel`); Asafe (ID: `person:Asaph.2`); Acube (ID: `person:Akkub.2`); Levi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Sobai (ID: `person:Shobai`); Ater (ID: `person:Ater.2`); Talmom (ID: `person:Talmon`); Hatita (ID: `person:Hatita`); Salum (ID: `person:Shallum.8`); Asafe (ID: `person:Asaph.2`); Acube (ID: `person:Akkub.2`)
...
* **Associated ACAI Concepts:** Rezim (ID: `person:Rezin.2`); Hagabe (ID: `person:Hagab`); Meunim (ID: `group:Meunim`); Baquebuque (ID: `person:Bakbuk`); Temá (ID: `person:Temah`); Hacufa (ID: `person:Hakupha`); Hatifa (ID: `person:Hatipha`); Hagaba (ID: `person:Hagabah`); Tabaote (ID: `person:Tabbaoth`); Padom (ID: `person:Padon`); Harsa (ID: `person:Harsha`); Uza (ID: `person:Uzza.2`); Gidel (ID: `person:Giddel`); Salmai (ID: `person:Shalmai`); Sia (ID: `person:Siaha`); Harur (ID: `person:Harhur`); Zia (ID: `person:Ziha`); Sisera (ID: `person:Sisera.2`); Queros (ID: `person:Keros`); Meída (ID: `person:Mehida`); Hasufa (ID: `person:Hasupha`); Nesias (ID: `person:Neziah`); Bazlite (ID: `person:Bazluth`); Reaías (ID: `person:Reaiah.3`); Asná (ID: `person:Asnah`); Necoda (ID: `person:Nekoda`); Barcos (ID: `person:Barkos`); Nephushesim (ID: `group:Nephushesim`); Gazão (ID: `person:Gazzam`); Paseia (ID: `person:Paseah.2`); Hanã (ID: `person:Hanan.4`); Besai (ID: `person:Besai`); Gaar (ID: `person:Gahar`); Acube (ID: `person:Akkub.3`); Lebana (ID: `person:Lebanah`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Soferete (ID: `person:Sophereth`); Sephatias (ID: `person:Shephatiah.7`); Gidel (ID: `person:Giddel.2`); Darcom (ID: `person:Darkon`); Hatil (ID: `person:Hattil`); Ami (ID: `person:Ami`); Jaala (ID: `person:Jaalah`); Sotai (ID: `person:Sotai`); Peruda (ID: `person:Peruda`)
...
* **Associated ACAI Concepts:** Tobias (ID: `person:Tobiah`); Tel-Harsa (ID: `place:Tel-harsha`); Tel-Melá (ID: `place:Tel-melah`); Adã (ID: `place:Addan`); Querube (ID: `place:Cherub`); Necoda (ID: `person:Nekoda.2`); Imer (ID: `place:Immer`); Delaías (ID: `person:Delaiah.3`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Barzillai (ID: `person:Barzillai.3`); Hacoz (ID: `person:Hakkoz.2`); Habaiah (ID: `person:Habaiah`); Gileadites (ID: `group:Gilead`); Barzillai (ID: `person:Barzillai`); stain (ID: `keyterm:Stain`); priesthood (ID: `keyterm:Priesthood`); Gileade (ID: `place:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); strength (ID: `keyterm:Strength`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); Mina (ID: `realia:Mina`); Tunic (ID: `realia:Tunic`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Josué (ID: `person:Joshua.5`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Sealtiel (ID: `person:Shealtiel.2`); Jeozadaque (ID: `person:Jehozadak`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Cadmiel (ID: `person:Kadmiel`); Relatives (ID: `group:Relatives`); Hodavias (ID: `person:Hodaviah.4`); Henadade (ID: `person:Henadad`); Jesua (ID: `person:Jeshua.4`); Esar-Hadom (ID: `person:Esarhaddon`); appointed feast (ID: `keyterm:AppointedFeast`); Sidonians (ID: `group:Sidon`); Hodias (ID: `person:Hodiah.2`); Jope (ID: `place:Joppa`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); holy (ID: `keyterm:Holy`); Instruction (ID: `keyterm:Instruction`); new moon festival (ID: `keyterm:NewMoonFestival`); Benjamim (ID: `group:Benjamin`); Libano (ID: `place:Lebanon`); Sidom (ID: `place:Sidon`); Tyrians (ID: `group:Tyre`); kindness (ID: `keyterm:Kindness`); counsel (ID: `keyterm:Counsel`); terror (ID: `keyterm:Terror`); Asafe (ID: `person:Asaph.2`); Dario (ID: `person:Darius.2`); Tiro (ID: `place:Tyre`); Benjamim (ID: `person:Benjamin`); Davi (ID: `person:David`); Moisés (ID: `person:Moses`); Assyria (ID: `place:Assyria`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Cedar (ID: `flora:Cedar`); Trumpet (ID: `realia:Trumpet`); Craftsman (ID: `realia:Craftsman`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); Moisés (ID: `person:Moses`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); terror (ID: `keyterm:Terror`); SENHOR (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Sidonians (ID: `group:Sidon`); Libano (ID: `place:Lebanon`); Tyrians (ID: `group:Tyre`); Jope (ID: `place:Joppa`); Tiro (ID: `place:Tyre`); Pérsia (ID: `place:Persia`); Sidom (ID: `place:Sidon`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Craftsman (ID: `realia:Craftsman`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Levi (ID: `group:Levi`); SENHOR (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Levi (ID: `group:Levi`); Davi (ID: `person:David`); Asafe (ID: `person:Asaph.2`); Levi (ID: `person:Levi.3`); kindness (ID: `keyterm:Kindness`); Trumpet (ID: `realia:Trumpet`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Benjamim (ID: `group:Benjamin`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Benjamim (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Pérsia (ID: `place:Persia`); Jews (ID: `group:Jews`); Samaria (ID: `place:Samaria`); Assuero (ID: `person:Ahasuerus`); Mitredate (ID: `person:Mithredath.2`); Tabeel (ID: `person:Tabeel`); Osnapar (ID: `person:Osnappar`); Ereque (ID: `place:Erech`); Bislão (ID: `person:Bishlam`); Dinaítas (ID: `person:Dinaite`); Babylonians (ID: `group:Babylon`); Judá (ID: `group:Judah`); Persians (ID: `group:Persia`); Susã (ID: `place:Susa`); Elamites (ID: `group:Elam`); Elam (ID: `place:Elam`); Judá (ID: `person:Judah.4`); Babilônia (ID: `place:Babylon`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Dinaítas (ID: `person:Dinaite`); Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Babylonians (ID: `group:Babylon`); Ereque (ID: `place:Erech`); Persians (ID: `group:Persia`); Susã (ID: `place:Susa`); Babilônia (ID: `place:Babylon`); Elamites (ID: `group:Elam`); Elam (ID: `place:Elam`); Pérsia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Sinsai (ID: `person:Shimshai`); Jews (ID: `group:Jews`); Reum (ID: `person:Rehum.2`); Artaxerxes (ID: `person:Artaxerxes.2`); Samaria (ID: `place:Samaria`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Jews (ID: `group:Jews`); Artaxerxes (ID: `person:Artaxerxes.2`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); Dario (ID: `person:Darius.2`); Tattenai (ID: `person:Tattenai`); Ido (ID: `person:Iddo.6`); Ageu (ID: `person:Haggai`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Zacarias (ID: `person:Zechariah.17`); Israel (ID: `person:Israel`); Josué (ID: `person:Joshua.5`); Judá (ID: `person:Judah.4`); Jeozadaque (ID: `person:Jehozadak`); Rio Eufrates (ID: `place:Euphrates`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Pérsia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Ido (ID: `person:Iddo.6`); Ageu (ID: `person:Haggai`); Zacarias (ID: `person:Zechariah.17`); Israel (ID: `person:Israel`); Jews (ID: `group:Jews`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Babilônia (ID: `place:Babylon`); Jerusalém (ID: `place:Jerusalem`); Ciro (ID: `person:Cyrus`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Dario (ID: `person:Darius.2`); Zorobabel (ID: `person:Zerubbabel.2`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Tattenai (ID: `person:Tattenai`); Israel (ID: `person:Israel`); Caldéia (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); Judá (ID: `person:Judah.4`); Rio Eufrates (ID: `place:Euphrates`); Foundation (ID: `realia:Foundation`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Ciro (ID: `person:Cyrus`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Babilônia (ID: `place:Babylon`); Zorobabel (ID: `person:Zerubbabel.2`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Zadoque (ID: `person:Zadok.4`); Azarias (ID: `person:Azariah.7`); Salum (ID: `person:Shallum.7`); Abisua (ID: `person:Abishua`); Azarias (ID: `person:Azariah.6`); Amarias (ID: `person:Amariah.2`); Seraias (ID: `person:Seraiah.2`); Zeraías (ID: `person:Zerahiah`); Buqui (ID: `person:Bukki.2`); Uzi (ID: `person:Uzzi`); Meraiote (ID: `person:Meraioth`); Aitube (ID: `person:Ahitub.3`); Artaxerxes (ID: `person:Artaxerxes`); Hilquias (ID: `person:Hilkiah.2`); Fineias (ID: `person:Phinehas`); Pérsia (ID: `place:Persia`); Arão (ID: `person:Aaron`); Eleazar (ID: `person:Eleazar.2`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); Babilônia (ID: `place:Babylon`); SENHOR (ID: `deity:Lord`); Moisés (ID: `person:Moses`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); Ezra (ID: `person:Ezra`); SENHOR (ID: `deity:Lord`); decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Artaxerxes (ID: `person:Artaxerxes`); Rio Eufrates (ID: `place:Euphrates`); Wheat (ID: `flora:Wheat`); Olive Oil (ID: `realia:OliveOil`); Kor (ID: `realia:Kor`); Talent (ID: `realia:Talent`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Jesaías (ID: `person:Jeshaiah.4`); Miguel (ID: `person:Michael.10`); Daniel (ID: `person:Daniel.2`); Elam (ID: `person:Elam`); Hacatã (ID: `person:Hakkatan`); Obadias (ID: `person:Obadiah.10`); Paate-Moabe (ID: `person:Pahath-moab`); Utai (ID: `person:Uthai.2`); Joanã (ID: `person:Johanan.8`); Joabe (ID: `person:Joab.4`); Jeuel (ID: `person:Jeuel.3`); Secanias (ID: `person:Shecaniah.6`); Atalia (ID: `person:Athaliah.3`); Elioenai (ID: `person:Eliehoenai.2`); Gérson (ID: `person:Gershom.2`); Hatus (ID: `person:Hattush.2`); Adim (ID: `person:Adin`); Adonicão (ID: `person:Adonikam`); Bigvai (ID: `person:Bigvai.2`); Zacarias (ID: `person:Zechariah.18`); Zacur (ID: `person:Zaccur.5`); Zabadias (ID: `person:Zebadiah.8`); Bebai (ID: `person:Bebai.2`); Zacarias (ID: `person:Zechariah.19`); Sephatias (ID: `person:Shephatiah.6`); Elifelete (ID: `person:Eliphelet.5`); Jônatas (ID: `person:Jonathan.9`); Semaías (ID: `person:Shemaiah.14`); Jaaziel (ID: `person:Jahaziel.5`); Josifias (ID: `person:Josiphiah`); Selomite (ID: `person:Shelomith.4`); Parós (ID: `person:Parosh.2`); Jeiel (ID: `person:Jehiel.7`); Bebai (ID: `person:Bebai`); Asgade (ID: `person:Azgad`); Ebede (ID: `person:Ebed.2`); Zeraías (ID: `person:Zerahiah.2`); Secanias (ID: `person:Shecaniah.5`); Artaxerxes (ID: `person:Artaxerxes`); Fineias (ID: `person:Phinehas`); Itamar (ID: `person:Ithamar`); Babilônia (ID: `place:Babylon`); Davi (ID: `person:David`)
...
* **Associated ACAI Concepts:** Zacarias (ID: `person:Zechariah.20`); Ariel (ID: `person:Ariel`); Jaribe (ID: `person:Jarib.2`); Ido (ID: `person:Iddo`); Mesulão (ID: `person:Meshullam.9`); Elnatã (ID: `person:Elnathan.4`); Elnatã (ID: `person:Elnathan.3`); Natã (ID: `person:Nathan.5`); Semaías (ID: `person:Shemaiah.15`); Elnatã (ID: `person:Elnathan.2`); Joiaribe (ID: `person:Joiarib.2`); Eliezer (ID: `person:Eliezer.8`); Casifia (ID: `place:Casiphia`); SENHOR (ID: `deity:Lord`); perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); Israel (ID: `person:Israel`); Levi (ID: `group:Levi`); Insight (ID: `keyterm:Insight`); Mali (ID: `person:Mahli`); SENHOR (ID: `deity:Lord`); Levi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); To Sin (ID: `keyterm:Sin`); SENHOR (ID: `deity:Lord`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); Israel (ID: `person:Israel`); be unfaithful (ID: `keyterm:Unfaithful`); Egito (ID: `place:Egypt`); Jebusites (ID: `group:Jebusites`); Levi (ID: `group:Levi`); Ammonites (ID: `group:Ammon`); Egyptians (ID: `group:Egypt`); Moabe (ID: `place:Moab`); Amorites (ID: `group:Amorites`); Hete (ID: `person:Heth`); Levi (ID: `person:Levi.3`); cananeu (ID: `group:Canaan`); Canaã (ID: `place:Canaan`); Amom (ID: `place:Ammon`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Harim (ID: `person:Harim`); Elam (ID: `person:Elam`); Judá (ID: `group:Judah`); counsel (ID: `keyterm:Counsel`); offering (ID: `keyterm:Offering`); Judá (ID: `person:Judah.4`); Macnadbai (ID: `person:Machnadebai`); Simeão (ID: `person:Shimeon`); Uri (ID: `person:Uri.3`); Quelal (ID: `person:Chelal`); Semarias (ID: `person:Shemariah.3`); Zacarias (ID: `person:Zechariah.21`); Hittites (ID: `group:Hittite`); Matitias (ID: `person:Mattithiah.3`); Matanias (ID: `person:Mattaniah.5`); Eliasibe (ID: `person:Eliashib.4`); Salum (ID: `person:Shallum.10`); Adaías (ID: `person:Adaiah.6`); Eliezer (ID: `person:Eliezer.10`); Petaías (ID: `person:Pethahiah.2`); Parós (ID: `person:Parosh`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); Israel (ID: `person:Israel`); peace (ID: `keyterm:IntactState`); to cause to possess (ID: `keyterm:Possess`); supplication (ID: `keyterm:Supplication`); defilement (ID: `keyterm:Defilement`); kindness (ID: `keyterm:Kindness`); Jerusalém (ID: `place:Jerusalem`); Pérsia (ID: `place:Persia`); dispossess (ID: `keyterm:Dispossess`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); supplication (ID: `keyterm:Supplication`); kindness (ID: `keyterm:Kindness`); Jerusalém (ID: `place:Jerusalem`); Pérsia (ID: `place:Persia`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** Jeiel (ID: `person:Jehiel.8`); Secanias (ID: `person:Shecaniah.7`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); Elam (ID: `person:Elam`); SENHOR (ID: `deity:Lord`); be unfaithful (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); swear (ID: `keyterm:Swear`); Ezra (ID: `person:Ezra`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `group:Benjamin`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `person:Benjamin`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ticva (ID: `person:Tikvah.2`); Mesulão (ID: `person:Meshullam.10`); Jônatas (ID: `person:Jonathan.10`); Asael (ID: `person:Asahel.4`); Sabetai (ID: `person:Shabbethai`); Jazeías (ID: `person:Jahzeiah`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`)
