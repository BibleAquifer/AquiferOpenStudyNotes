...
* **Associated ACAI Concepts:** état intact (ID: `keyterm:IntactState`); alliance (ID: `keyterm:Covenant`); comprehension (ID: `keyterm:Understanding`); Édom (ID: `group:Edom`); Édom (ID: `place:Edom`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** Édom (ID: `place:Edom`); Éternel (ID: `deity:Lord`); montagne d'Ésaü (ID: `place:EsauMount`); comprehension (ID: `keyterm:Understanding`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); déposséder (ID: `keyterm:Dispossess`); Joseph (ID: `person:Joseph.10`); Édom (ID: `group:Edom`); Jérusalem (ID: `place:Jerusalem`); Édom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** déposséder (ID: `keyterm:Dispossess`); Negev (ID: `place:Negeb`); Benjamin (ID: `group:Benjamin`); Canaan (ID: `place:Canaan`); Éphraïm (ID: `group:Ephraim`); Benjamin (ID: `person:Benjamin`); Samarie (ID: `place:Samaria`); Shephelah (ID: `place:Shephelah`); Galaad (ID: `place:Gilead`); Israël (ID: `person:Israel`); montagne d'Ésaü (ID: `place:EsauMount`); Philistins (ID: `group:Philistine`); Canaan (ID: `group:Canaan`); Sarepta (ID: `place:Zarephath`); Philistia (ID: `place:Philistine`); Jérusalem (ID: `place:Jerusalem`); Sardes (ID: `place:Sardis`); Éphraïm (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); déposséder (ID: `keyterm:Dispossess`); montagne d'Ésaü (ID: `place:EsauMount`); Negev (ID: `place:Negeb`); Galaad (ID: `place:Gilead`); Israël (ID: `person:Israel`); Canaan (ID: `group:Canaan`); Philistins (ID: `group:Philistine`); Éphraïm (ID: `person:Ephraim`); Samarie (ID: `place:Samaria`); Philistia (ID: `place:Philistine`); Canaan (ID: `place:Canaan`); Éternel (ID: `deity:Lord`); Benjamin (ID: `person:Benjamin`); Shephelah (ID: `place:Shephelah`); Sardes (ID: `place:Sardis`); Benjamin (ID: `group:Benjamin`); Éphraïm (ID: `group:Ephraim`); Sarepta (ID: `place:Zarephath`)
...
* **Associated ACAI Concepts:** Canaan (ID: `place:Canaan`); déposséder (ID: `keyterm:Dispossess`); Israël (ID: `person:Israel`); Canaan (ID: `group:Canaan`); Sarepta (ID: `place:Zarephath`); Jérusalem (ID: `place:Jerusalem`); Negev (ID: `place:Negeb`); Sardes (ID: `place:Sardis`)
