...
* **Associated ACAI Concepts:** Èfratite; d'Èfrata (ID: `group:Ephrathah`); Kiljon (ID: `person:Chilion`); Éphrata (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`)
## Ruth 1.4 (id: 100597)
...
* **Associated ACAI Concepts:** Salmon (ID: `person:Salmon`); Hetsron (ID: `person:Hezron.2`); Ram (ID: `person:Ram`)
