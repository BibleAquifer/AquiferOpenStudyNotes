...
* **Associated ACAI Concepts:** فَارِسَ (ID: `place:Persia`); كورَشَ (ID: `person:Cyrus`); Word of the Lord (ID: `keyterm:WordOfTheLord`); إِرْمِيَا (ID: `person:Jeremiah.6`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`); Word of the Lord (ID: `keyterm:WordOfTheLord`); إِرْمِيَا (ID: `person:Jeremiah.6`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); فَارِسَ (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); بَنْيَامِينَ (ID: `person:Benjamin`); يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `group:Benjamin`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); لَّاوِي (ID: `group:Levi`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); كورَشَ (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath`); يَهوذَا (ID: `group:Judah`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `person:Judah.4`); فَارِسَ (ID: `place:Persia`); كورَشَ (ID: `person:Cyrus`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); سلَيْمَانَ (ID: `person:Solomon`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); بَابَايَ (ID: `person:Bebai`); هَقّوصَ (ID: `person:Hakkoz.2`); فَرْعوشَ (ID: `person:Parosh`); بَقْبوقَ (ID: `person:Bakbuk`); Nephushesim (ID: `group:Nephushesim`); نَقودَا (ID: `person:Nekoda.2`); قِيروسَ (ID: `person:Keros`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); سَلْمَايَ (ID: `person:Shalmai`); سِيعَهَا (ID: `person:Siaha`); يَشوعَ (ID: `person:Jeshua.3`); Tel-melah (ID: `place:Tel-melah`); بِلْشَان (ID: `person:Bilshan`); بَصْلوتَ (ID: `person:Bazluth`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); يَعْلَةَ (ID: `person:Jaalah`); رَحوم (ID: `person:Rehum`); بِغْوَايَ (ID: `person:Bigvai`); مِسْفَار (ID: `person:Mispar`); بِغْوَايَ (ID: `person:Bigvai.2`); شَفَطْيَا (ID: `person:Shephatiah.7`); حَارِيمَ (ID: `person:Harim`); حَانَان (ID: `person:Hanan.4`); رَعْلَايَا (ID: `person:Reelaiah`)
...
* **Associated ACAI Concepts:** رَحوم (ID: `person:Rehum`); بِلْشَان (ID: `person:Bilshan`); رَعْلَايَا (ID: `person:Reelaiah`); مرْدَخَاي (ID: `person:Mordecai`); بِغْوَايَ (ID: `person:Bigvai`); مِسْفَار (ID: `person:Mispar`); سَرَايَا (ID: `person:Seraiah.6`); نَحَمْيَا (ID: `person:Nehemiah`); بَعْنَةَ (ID: `person:Baanah.3`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** حَشوم (ID: `person:Hashum`); بَابَايَ (ID: `person:Bebai`); فَرْعوشَ (ID: `person:Parosh`); زَتّو (ID: `person:Zattu.2`); آرَحَ (ID: `person:Arah.2`); حَزَقِيَّا (ID: `person:Hezekiah.2`); عِيلَامَ (ID: `person:Elam`); عَادِينَ (ID: `person:Adin`); يوآب (ID: `person:Joab.3`); يَشوعَ (ID: `person:Jeshua.3`); بَانِيَ (ID: `person:Bani`); زَكَّايَ (ID: `person:Zaccai.2`); آطِيرَ (ID: `person:Ater`); يورَةَ (ID: `person:Jorah`); شَفَطْيَا (ID: `person:Shephatiah.6`); عَرْجَدَ (ID: `person:Azgad`); أَدونِيقَامَ (ID: `person:Adonikam`); بِغْوَايَ (ID: `person:Bigvai.2`); بِيصَايَ (ID: `person:Bezai`); Pahath-moab (ID: `person:Pahath-moab`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Beth-azmaveth (ID: `place:Beth-azmaveth`); حَادِيدَ (ID: `place:Hadid`); مَغْبِيشَ (ID: `place:Magbish`); نَبو (ID: `place:Nebo.2`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); حَارِيمَ (ID: `person:Harim.2`); سَنَاءَةَ (ID: `place:Senaah`); وَلودَ (ID: `place:Lod`); مِنْ (ID: `place:Geba`); أونوَ (ID: `place:Ono`); عِيلَامَ (ID: `person:Elam`); Kiriath-jearim (ID: `place:Kiriath-jearim`); أَرِيحَا (ID: `place:Jericho`); ٱلْكَفِيرَة (ID: `place:Chephirah`); مِخْمَاسَ (ID: `place:Michmash`); بَئِيروت (ID: `place:Beeroth`); عَايٍ (ID: `place:Ai`); عَنَاثوثَ (ID: `place:Anathoth`); Ramah (ID: `place:Ramah.2`); لَحْمٍ (ID: `place:Bethlehem`); Bethel (ID: `place:Bethel`)
...
* **Associated ACAI Concepts:** لِإِيمِيرَ (ID: `person:Immer.2`); طَلْمون (ID: `person:Talmon`); حَارِيمَ (ID: `person:Harim`); هودَوْيَا (ID: `person:Hodaviah.4`); يَشوعَ (ID: `person:Jeshua`); شوبَايَ (ID: `person:Shobai`); يَشوعَ (ID: `person:Jeshua.4`); آطِيرَ (ID: `person:Ater.2`); حَطِيطَا (ID: `person:Hatita`); يَدَايَا (ID: `person:Jedaiah.4`); فَشْحور (ID: `person:Pashhur`); لَّاوِي (ID: `person:Levi.3`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); لَّاوِي (ID: `group:Levi`); شَلّوم (ID: `person:Shallum.8`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** طَلْمون (ID: `person:Talmon`); شوبَايَ (ID: `person:Shobai`); آطِيرَ (ID: `person:Ater.2`); حَطِيطَا (ID: `person:Hatita`); آسَاف (ID: `person:Asaph.2`); عَقّوب (ID: `person:Akkub.2`); شَلّوم (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** طَبَاعوتَ (ID: `person:Tabbaoth`); رَصِينَ (ID: `person:Rezin.2`); لَبَانَةَ (ID: `person:Lebanah`); نَقودَا (ID: `person:Nekoda`); بَقْبوقَ (ID: `person:Bakbuk`); Meunim (ID: `group:Meunim`); سِيسَرَا (ID: `person:Sisera.2`); Nephushesim (ID: `group:Nephushesim`); بَرْقوسَ (ID: `person:Barkos`); فَادونَ (ID: `person:Padon`); بِيسَايَ (ID: `person:Besai`); قِيروسَ (ID: `person:Keros`); حَرْحورَ (ID: `person:Harhur`); جَاحَرَ (ID: `person:Gahar`); رَآيَا (ID: `person:Reaiah.3`); صِيحَا (ID: `person:Ziha`); مَحِيدَا (ID: `person:Mehida`); سَلْمَايَ (ID: `person:Shalmai`); سِيعَهَا (ID: `person:Siaha`); حَسوفَا (ID: `person:Hasupha`); جَدِّيلَ (ID: `person:Giddel`); حَرْشَا (ID: `person:Harsha`); نَصِيحَ (ID: `person:Neziah`); حَطِيفَا (ID: `person:Hatipha`); حَقوفَا (ID: `person:Hakupha`); بَصْلوتَ (ID: `person:Bazluth`); جَزَّامَ (ID: `person:Gazzam`); حَجَابَةَ (ID: `person:Hagabah`); أَسْنَةَ (ID: `person:Asnah`); ثَامَحَ (ID: `person:Temah`); فَاسِيحَ (ID: `person:Paseah.2`); عَقّوب (ID: `person:Akkub.3`); فِي (ID: `person:Uzza.2`); حَاجَابَ (ID: `person:Hagab`); حَانَان (ID: `person:Hanan.4`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); سَوْطَايَ (ID: `person:Sotai`); حَطِّيلَ (ID: `person:Hattil`); فَرودَا (ID: `person:Peruda`); شَفَطْيَا (ID: `person:Shephatiah.7`); آمِي (ID: `person:Ami`); سوفَرَثَ (ID: `person:Sophereth`); دَرْقونَ (ID: `person:Darkon`); جَدِّيلَ (ID: `person:Giddel.2`); يَعْلَةَ (ID: `person:Jaalah`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`)
...
* **Associated ACAI Concepts:** Tel-melah (ID: `place:Tel-melah`); أَدَّان (ID: `place:Addan`); لِدَلَايَا (ID: `person:Delaiah.3`); طوبِيَّا (ID: `person:Tobiah`); كَروب (ID: `place:Cherub`); نَقودَا (ID: `person:Nekoda.2`); Tel-harsha (ID: `place:Tel-harsha`); لِإِيمِيرَ (ID: `place:Immer`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** حَبَايَا (ID: `person:Habaiah`); هَقّوصَ (ID: `person:Hakkoz.2`); بَرْزِلَّايَ (ID: `person:Barzillai.3`); بَرْزِلَّايَ (ID: `person:Barzillai`); جِلْعَادَ (ID: `place:Gilead`); Defile (ID: `keyterm:Stain`); Priesthood (ID: `keyterm:Priesthood`); Gileadites (ID: `group:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); Strength (ID: `keyterm:Strength`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); Mina (ID: `realia:Mina`); House (ID: `realia:House`); Tunic (ID: `realia:Tunic`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); يَشوع (ID: `person:Joshua.5`); فَارِسَ (ID: `place:Persia`); كورَشَ (ID: `person:Cyrus`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Relatives (ID: `group:Relatives`); هودَوْيَا (ID: `person:Hodaviah.4`); Esarhaddon (ID: `person:Esarhaddon`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); يَشوعَ (ID: `person:Jeshua.4`); حِينَادَادَ (ID: `person:Henadad`); يَافَا (ID: `place:Joppa`); صورَ (ID: `place:Tyre`); Kindness (ID: `keyterm:Kindness`); Appointed Feast (ID: `keyterm:AppointedFeast`); لبْنَانَ (ID: `place:Lebanon`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Assyria (ID: `place:Assyria`); Instruction (ID: `keyterm:Instruction`); Sidonians (ID: `group:Sidon`); Counsel (ID: `keyterm:Counsel`); صِيْدونَ (ID: `place:Sidon`); دَارِيوسَ (ID: `person:Darius.2`); Terror (ID: `keyterm:Terror`); آسَاف (ID: `person:Asaph.2`); موسَى (ID: `person:Moses`); دَاودَ (ID: `person:David`); هودِيَّا (ID: `person:Hodiah.2`); Holy (ID: `keyterm:Holy`); بَنْيَامِينَ (ID: `person:Benjamin`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Tyrians (ID: `group:Tyre`); بَنْيَامِينَ (ID: `group:Benjamin`); Trumpet (ID: `realia:Trumpet`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Cymbals (ID: `realia:Cymbals`); Craftsman (ID: `realia:Craftsman`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); Offering (ID: `keyterm:Offering`); موسَى (ID: `person:Moses`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** Sidonians (ID: `group:Sidon`); يَافَا (ID: `place:Joppa`); صورَ (ID: `place:Tyre`); لبْنَانَ (ID: `place:Lebanon`); Tyrians (ID: `group:Tyre`); فَارِسَ (ID: `place:Persia`); صِيْدونَ (ID: `place:Sidon`); كورَشَ (ID: `person:Cyrus`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Craftsman (ID: `realia:Craftsman`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); لَّاوِي (ID: `person:Levi.3`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `group:Levi`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `person:Levi.3`); Kindness (ID: `keyterm:Kindness`); لَّاوِي (ID: `group:Levi`); دَاودَ (ID: `person:David`); آسَاف (ID: `person:Asaph.2`); Trumpet (ID: `realia:Trumpet`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `person:Benjamin`); يَهوذَا (ID: `group:Judah`); إِسْرَائِيلَ (ID: `person:Israel`); بَنْيَامِينَ (ID: `group:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); فَارِسَ (ID: `place:Persia`); كورَشَ (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); فَارِسَ (ID: `place:Persia`); ٱلسَّامِرَةِ (ID: `place:Samaria`); بِشْلَام (ID: `person:Bishlam`); Babylonians (ID: `group:Babylon`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); أسْنَفَّر (ID: `person:Osnappar`); مِثْرَدَاث (ID: `person:Mithredath.2`); طَبْئِيل (ID: `person:Tabeel`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); أَرَكَ (ID: `place:Erech`); Elamites (ID: `group:Elam`); عِيلَامَ (ID: `place:Elam`); Persians (ID: `group:Persia`); فِي (ID: `place:Susa`); يَهوذَا (ID: `group:Judah`); بَابِلَ (ID: `place:Babylon`); يَهوذَا (ID: `person:Judah.4`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** بِشْلَام (ID: `person:Bishlam`); مِثْرَدَاث (ID: `person:Mithredath.2`); طَبْئِيل (ID: `person:Tabeel`); فَارِسَ (ID: `place:Persia`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`)
...
* **Associated ACAI Concepts:** Babylonians (ID: `group:Babylon`); رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); أَرَكَ (ID: `place:Erech`); Elamites (ID: `group:Elam`); بَابِلَ (ID: `place:Babylon`); فِي (ID: `place:Susa`); Persians (ID: `group:Persia`); فَارِسَ (ID: `place:Persia`); عِيلَامَ (ID: `place:Elam`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلسَّامِرَةِ (ID: `place:Samaria`); رَحوم (ID: `person:Rehum.2`); Jews (ID: `group:Jews`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); Jews (ID: `group:Jews`); أورشَلِيمَ (ID: `place:Jerusalem`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); دَارِيوسَ (ID: `person:Darius.2`); يَدّو (ID: `person:Iddo.6`); Shethar-bozenai (ID: `person:Shethar-bozenai`); زَكَرِيَّا (ID: `person:Zechariah.17`); حَجَّيِ (ID: `person:Haggai`); تَتْنَاي (ID: `person:Tattenai`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); ٱلْفرَاتِ (ID: `place:Euphrates`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** يَدّو (ID: `person:Iddo.6`); زَكَرِيَّا (ID: `person:Zechariah.17`); حَجَّيِ (ID: `person:Haggai`); Jews (ID: `group:Jews`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); بَابِلَ (ID: `place:Babylon`); أورشَلِيمَ (ID: `place:Jerusalem`); كورَشَ (ID: `person:Cyrus`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); زَربَّابِل (ID: `person:Zerubbabel.2`); دَارِيوسَ (ID: `person:Darius.2`); Shethar-bozenai (ID: `person:Shethar-bozenai`); تَتْنَاي (ID: `person:Tattenai`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلْفرَاتِ (ID: `place:Euphrates`); يَهوذَا (ID: `person:Judah.4`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); بَابِلَ (ID: `place:Babylon`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); بَابِلَ (ID: `place:Babylon`); كورَشَ (ID: `person:Cyrus`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); موسَى (ID: `person:Moses`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `group:Levi`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** سَرَايَا (ID: `person:Seraiah.2`); عَزْرَا (ID: `person:Ezra`); عَزَرْيَا (ID: `person:Azariah.7`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); حِلْقِيَّا (ID: `person:Hilkiah.2`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); أَخِيطوبَ (ID: `person:Ahitub.3`); عَزَرْيَا (ID: `person:Azariah.7`); لِمَرَايوثَ (ID: `person:Meraioth`); سَرَايَا (ID: `person:Seraiah.2`); بقِّي (ID: `person:Bukki.2`); عزِّي (ID: `person:Uzzi`); أَبِيشوعَ (ID: `person:Abishua`); عَزَرْيَا (ID: `person:Azariah.6`); شَلّوم (ID: `person:Shallum.7`); أَمَرْيَا (ID: `person:Amariah.2`); زَرَحْيَا (ID: `person:Zerahiah`); صَادوق (ID: `person:Zadok.4`); فِينَحَاس (ID: `person:Phinehas`); حِلْقِيَّا (ID: `person:Hilkiah.2`); هَارون (ID: `person:Aaron`); فَارِسَ (ID: `place:Persia`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); أَلِعَازَار (ID: `person:Eleazar.2`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); موسَى (ID: `person:Moses`); بَابِلَ (ID: `place:Babylon`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); Decree (ID: `keyterm:Decree`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); ٱلْفرَاتِ (ID: `place:Euphrates`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Decree (ID: `keyterm:Decree`); بَابِلَ (ID: `place:Babylon`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); Wheat (ID: `flora:Wheat`); Altar (ID: `realia:Altar`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Talent (ID: `realia:Talent`); Kor (ID: `realia:Kor`); Stone Altar (ID: `realia:StoneAltar`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); عَزْرَا (ID: `person:Ezra`); ٱلْفرَاتِ (ID: `place:Euphrates`); Money (ID: `realia:Money`); Kor (ID: `realia:Kor`); Wheat (ID: `flora:Wheat`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** هِقَّاطَانَ (ID: `person:Hakkatan`); عَثَلْيَا (ID: `person:Athaliah.3`); بَابَايَ (ID: `person:Bebai`); عوتَاي (ID: `person:Uthai.2`); مِيخَائِيلَ (ID: `person:Michael.10`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); يَحِيئِيل (ID: `person:Jehiel.7`); دَانِيآل (ID: `person:Daniel.2`); يَعِيئِيل (ID: `person:Jeuel.3`); يوآب (ID: `person:Joab.4`); يونَاثَانَ (ID: `person:Jonathan.9`); عوبَدْيَا (ID: `person:Obadiah.10`); عِيلَامَ (ID: `person:Elam`); شَكَنْيَا (ID: `person:Shecaniah.5`); عَادِينَ (ID: `person:Adin`); بَابَايَ (ID: `person:Bebai.2`); يوحَانَانَ (ID: `person:Johanan.8`); زَرَحْيَا (ID: `person:Zerahiah.2`); يوشَفْيَا (ID: `person:Josiphiah`); زَكّور (ID: `person:Zaccur.5`); شَكَنْيَا (ID: `person:Shecaniah.6`); زَكَرِيَّا (ID: `person:Zechariah.18`); عَابِد (ID: `person:Ebed.2`); زَبَدْيَا (ID: `person:Zebadiah.8`); يَحْزِيئِيل (ID: `person:Jahaziel.5`); يِشْعِيَا (ID: `person:Jeshaiah.4`); زَكَرِيَّا (ID: `person:Zechariah.19`); شَفَطْيَا (ID: `person:Shephatiah.6`); فَرْعوشَ (ID: `person:Parosh.2`); عَرْجَدَ (ID: `person:Azgad`); شَلومِيَةَ (ID: `person:Shelomith.4`); أَدونِيقَامَ (ID: `person:Adonikam`); Gershom (ID: `person:Gershom.2`); بِغْوَايَ (ID: `person:Bigvai.2`); حَطّوش (ID: `person:Hattush.2`); Pahath-moab (ID: `person:Pahath-moab`); شِمْعِيَا (ID: `person:Shemaiah.14`); أَلِيفَلَط (ID: `person:Eliphelet.5`); فِينَحَاس (ID: `person:Phinehas`); إِيثَامَارَ (ID: `person:Ithamar`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); دَاودَ (ID: `person:David`); بَابِلَ (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** يَارِيبَ (ID: `person:Jarib.2`); زَكَرِيَّا (ID: `person:Zechariah.20`); شِمْعِيَا (ID: `person:Shemaiah.15`); يويَارِيبَ (ID: `person:Joiarib.2`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); ٱلْمسَمَّى (ID: `place:Casiphia`); مَشلَّام (ID: `person:Meshullam.9`); نَاثَان (ID: `person:Nathan.5`); أَرِيئِيلَ (ID: `person:Ariel`); يَدّو (ID: `person:Iddo`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); أَلِيعَزَرَ (ID: `person:Eliezer.8`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); Perceive (ID: `keyterm:Perceive`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); لَّاوِي (ID: `person:Levi.3`); Insight (ID: `keyterm:Insight`); إِسْرَائِيلَ (ID: `person:Israel`); مَحْلِي (ID: `person:Mahli`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); To Sin (ID: `keyterm:Sin`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); لَّاوِي (ID: `person:Levi.3`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); مِصْرَ (ID: `place:Egypt`); لَّاوِي (ID: `group:Levi`); كَنْعَان (ID: `place:Canaan`); Ammonites (ID: `group:Ammon`); إِسْرَائِيلَ (ID: `person:Israel`); حِثًّا (ID: `person:Heth`); موآبَ (ID: `place:Moab`); Amorites (ID: `group:Amorites`); Be Unfaithful (ID: `keyterm:Unfaithful`); Jebusites (ID: `group:Jebusites`); Canaanites (ID: `group:Canaan`); Egyptians (ID: `group:Egypt`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Passion (ID: `keyterm:Ardour`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); عِيلَامَ (ID: `person:Elam`); Offering (ID: `keyterm:Offering`); يَهوذَا (ID: `group:Judah`); Counsel (ID: `keyterm:Counsel`); يَهوذَا (ID: `person:Judah.4`); بَنَايَا (ID: `person:Benaiah.8`); يَدّو (ID: `person:Jaddai`); يوئِيل (ID: `person:Joel.12`); فَرْعوشَ (ID: `person:Parosh`); شِمْعِي (ID: `person:Shimei.15`); يوزَابَاد (ID: `person:Jozabad.7`); أَلْيَاشِيب (ID: `person:Eliashib.5`); يَهونَاثَان (ID: `person:Jehohanan.4`); ومَتَّاثَا (ID: `person:Mattattah`); مَكْنَدْبَاي (ID: `person:Machnadebai`); إِسْمَاعِيل (ID: `person:Ishmael.6`); شَلّوم (ID: `person:Shallum.10`); عَزِيزَا (ID: `person:Aziza`); مَلّوخ (ID: `person:Malluch.3`); شَمَرْيَا (ID: `person:Shemariah.4`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); Kindness (ID: `keyterm:Kindness`); To Cause to Possess (ID: `keyterm:Possess`); Peace (ID: `keyterm:IntactState`); Defilement (ID: `keyterm:Defilement`); Plea for Mercy (ID: `keyterm:Supplication`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); فَارِسَ (ID: `place:Persia`); Dispossess (ID: `keyterm:Dispossess`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); فَارِسَ (ID: `place:Persia`); Kindness (ID: `keyterm:Kindness`); Plea for Mercy (ID: `keyterm:Supplication`); أورشَلِيمَ (ID: `place:Jerusalem`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** شَكَنْيَا (ID: `person:Shecaniah.7`); يَحِيئِيل (ID: `person:Jehiel.8`); عِيلَامَ (ID: `person:Elam`); عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); Be Unfaithful (ID: `keyterm:Unfaithful`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Counsel (ID: `keyterm:Counsel`); ٱلرَّبِّ (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); عَزْرَا (ID: `person:Ezra`); لَّاوِي (ID: `group:Levi`); إِسْرَائِيلَ (ID: `person:Israel`); Swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `person:Benjamin`); يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `group:Benjamin`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** تِقْوَةَ (ID: `person:Tikvah.2`); عَسَائِيل (ID: `person:Asahel.4`); شَبْتَاي (ID: `person:Shabbethai`); مَشلَّام (ID: `person:Meshullam.10`); يَحْزِيَا (ID: `person:Jahzeiah`); يونَاثَانَ (ID: `person:Jonathan.10`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`)
