...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); bem, aventurado (ID: `keyterm:Happy`); tentar (ID: `keyterm:PutToTheTest`); amado (ID: `keyterm:Beloved`); limpo (ID: `keyterm:Clean`); aprovado (ID: `keyterm:Approved`); inútil (ID: `keyterm:Worthless`); Good (ID: `keyterm:Good`); Ability (ID: `keyterm:Ability`); love (ID: `keyterm:Love`); sem mancha (ID: `keyterm:Undefiled`); coração (ID: `keyterm:Heart`); A Person (ID: `person:GenericPerson`); salvation (ID: `keyterm:Salvation`); sem mancha (ID: `keyterm:AboveCriticism`); promessa (ID: `keyterm:Promise`); Life (ID: `keyterm:Life`); que não pode ser tentado (ID: `keyterm:NotTempted`); lei (ID: `keyterm:Law`); To Sin (ID: `keyterm:Sin`); be (or show oneself) just (ID: `keyterm:Just`); Truth (ID: `keyterm:Truth`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** limpo (ID: `keyterm:Clean`); inútil (ID: `keyterm:Worthless`); sem mancha (ID: `keyterm:AboveCriticism`); sem mancha (ID: `keyterm:Undefiled`); coração (ID: `keyterm:Heart`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); favoritismo (ID: `keyterm:Partiality`); crer (ID: `keyterm:Believe`); Glory (ID: `keyterm:Glory`); Jesus (ID: `person:Jesus.2`); distinguir (ID: `keyterm:Discern`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`); Footstool (ID: `realia:Footstool`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); escolhido (ID: `keyterm:Chosen`); crer (ID: `keyterm:Believe`); promessa (ID: `keyterm:Promise`); reino (ID: `keyterm:Kingdom`); amado (ID: `keyterm:Beloved`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); tropeçar (ID: `keyterm:Stumble`); favoritismo (ID: `keyterm:Partiality`); juízo (ID: `keyterm:Judgment`); love (ID: `keyterm:Love`); To Sin (ID: `keyterm:Sin`); misericórdia (ID: `keyterm:Mercy`); decidir (ID: `keyterm:Decided`); fornication (ID: `keyterm:Fornication`); inclemente (ID: `keyterm:Merciless`); tribunal de justiça (ID: `keyterm:CourtCase`); escritura (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); Abraão (ID: `person:Abraham`); corpo (ID: `keyterm:Body.3`); SENHOR (ID: `deity:Lord`); A Person (ID: `person:GenericPerson`); inútil (ID: `keyterm:Idle`); Raabe (ID: `person:Rahab`); Demons (ID: `deity:Demons`); Isaque (ID: `person:Isaac`); To Cause to Happen (ID: `keyterm:Happen`); An Angel (ID: `deity:Angel`); Spirit (ID: `keyterm:Spirit.2`); fazer a paz (ID: `keyterm:Peace`); vazio (ID: `keyterm:Empty`); escritura (ID: `keyterm:Scripture`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); Abraão (ID: `person:Abraham`); inútil (ID: `keyterm:Idle`); Raabe (ID: `person:Rahab`); Isaque (ID: `person:Isaac`); To Cause to Happen (ID: `keyterm:Happen`); An Angel (ID: `deity:Angel`); Spirit (ID: `keyterm:Spirit.2`); corpo (ID: `keyterm:Body.3`); SENHOR (ID: `deity:Lord`); vazio (ID: `keyterm:Empty`); escritura (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`); Abraão (ID: `person:Abraham`); SENHOR (ID: `deity:Lord`); be (or show oneself) just (ID: `keyterm:Just`); escritura (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** injustiça (ID: `keyterm:UnjustDeed`); Hell (ID: `place:Hell`); corpo (ID: `keyterm:Body.3`); geena (ID: `keyterm:Gehenna`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); amizade (ID: `keyterm:Friendship`); be unfaithful (ID: `keyterm:Unfaithful`); Cause of Joy (ID: `keyterm:CauseOfJoy`); pure (ID: `keyterm:Pure`); favor (ID: `keyterm:Favor`); Spirit (ID: `keyterm:Spirit.2`); desejar (ID: `keyterm:LongFor`); To Cleanse (ID: `keyterm:Cleanse.2`); coração (ID: `keyterm:Heart`); Holy Spirit (ID: `deity:HolySpirit`); Ability (ID: `keyterm:Ability`); escritura (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** Spirit (ID: `keyterm:Spirit.2`); desejar (ID: `keyterm:LongFor`); Holy Spirit (ID: `deity:HolySpirit`); escritura (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** To Cleanse (ID: `keyterm:Cleanse.2`); coração (ID: `keyterm:Heart`); pure (ID: `keyterm:Pure`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** condenar (ID: `keyterm:Condemn`); corpo (ID: `keyterm:Body.3`); coração (ID: `keyterm:Heart`); testemunhar (ID: `keyterm:BearWitness`); SENHOR (ID: `deity:Lord`); be (or show oneself) just (ID: `keyterm:Just`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); orar (ID: `keyterm:Pray`); igreja (ID: `keyterm:Church`); SENHOR (ID: `deity:Lord`); anointed (ID: `keyterm:Anointed`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); crer (ID: `keyterm:Believe`); forgive (ID: `keyterm:Forgive`); orar (ID: `keyterm:Pray`); SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`)
