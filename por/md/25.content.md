...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); rebel (ID: `keyterm:Rebel`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Poisonous Hemlock (ID: `flora:PoisonousHemlock`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Uz (ID: `place:Uz`); stain (ID: `keyterm:Stain`); Ostrich (ID: `fauna:Ostrich`); Jackal (ID: `fauna:Jackal`)
