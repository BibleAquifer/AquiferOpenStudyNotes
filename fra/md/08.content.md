...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); Kiljon (ID: `person:Chilion`); Éphrata (ID: `person:Ephrathah`); Moab (ID: `place:Moab`); Élimélec (ID: `person:Elimelech`); Bethléhem (ID: `place:Bethlehem`); Juda (ID: `group:Judah`); Machlon (ID: `person:Mahlon`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** benir (ID: `keyterm:Bless`); Naomi (ID: `person:Naomi`); Éternel (ID: `deity:Lord`); bonté (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** Rachel (ID: `person:Rachel`); Léa (ID: `person:Leah`); Bethléhem (ID: `place:Bethlehem`); Éternel (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Tamar (ID: `person:Tamar`); Juda (ID: `group:Judah`); Éternel (ID: `deity:Lord`); Perets (ID: `person:Perez`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); benir (ID: `keyterm:Bless`); Naomi (ID: `person:Naomi`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Hetsron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Obed (ID: `person:Obed`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Nahshon (ID: `person:Nahshon`); David (ID: `person:David`); Boaz (ID: `person:Boaz`); Isaï (ID: `person:Jesse`); Perets (ID: `person:Perez`)
