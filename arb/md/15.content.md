...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); ٱلرَّبِّ (ID: `deity:Lord`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); إِسْرَائِيلَ (ID: `person:Israel`); إِرْمِيَا (ID: `person:Jeremiah.6`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `person:Judah.4`); لَّاوِي (ID: `group:Levi`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `group:Judah`); لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `person:Benjamin`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath`); كورَشَ (ID: `person:Cyrus`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); زَربَّابِل (ID: `person:Zerubbabel.2`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); لَّاوِي (ID: `person:Levi.3`); سلَيْمَانَ (ID: `person:Solomon`); لَّاوِي (ID: `group:Levi`); أورشَلِيمَ (ID: `place:Jerusalem`); يوآب (ID: `person:Joab.3`); مرْدَخَاي (ID: `person:Mordecai`); كَروب (ID: `place:Cherub`); مِسْفَار (ID: `person:Mispar`); Meunim (ID: `group:Meunim`); نَقودَا (ID: `person:Nekoda.2`); Tel-harsha (ID: `place:Tel-harsha`); يَدَايَا (ID: `person:Jedaiah.4`); نَحَمْيَا (ID: `person:Nehemiah`); حَطِيفَا (ID: `person:Hatipha`); حَجَابَةَ (ID: `person:Hagabah`); فَرْعوشَ (ID: `person:Parosh`); رَعْلَايَا (ID: `person:Reelaiah`); فِي (ID: `person:Uzza.2`); هودَوْيَا (ID: `person:Hodaviah.4`); حَارِيمَ (ID: `person:Harim`); شَفَطْيَا (ID: `person:Shephatiah.6`); حَرْحورَ (ID: `person:Harhur`); سِيسَرَا (ID: `person:Sisera.2`); قِيروسَ (ID: `person:Keros`); جَدِّيلَ (ID: `person:Giddel.2`); آطِيرَ (ID: `person:Ater.2`); بَصْلوتَ (ID: `person:Bazluth`); حَطِّيلَ (ID: `person:Hattil`)
...
* **Associated ACAI Concepts:** نَحَمْيَا (ID: `person:Nehemiah`); سَرَايَا (ID: `person:Seraiah.6`); بَعْنَةَ (ID: `person:Baanah.3`); مرْدَخَاي (ID: `person:Mordecai`); بِلْشَان (ID: `person:Bilshan`); رَعْلَايَا (ID: `person:Reelaiah`); مِسْفَار (ID: `person:Mispar`); رَحوم (ID: `person:Rehum`); بِغْوَايَ (ID: `person:Bigvai`); إِسْرَائِيلَ (ID: `person:Israel`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** عِيلَامَ (ID: `person:Elam`); Pahath-moab (ID: `person:Pahath-moab`); يوآب (ID: `person:Joab.3`); آرَحَ (ID: `person:Arah.2`); بِيصَايَ (ID: `person:Bezai`); أَدونِيقَامَ (ID: `person:Adonikam`); عَادِينَ (ID: `person:Adin`); بِغْوَايَ (ID: `person:Bigvai.2`); حَزَقِيَّا (ID: `person:Hezekiah.2`); يورَةَ (ID: `person:Jorah`); فَرْعوشَ (ID: `person:Parosh`); شَفَطْيَا (ID: `person:Shephatiah.6`); حَشوم (ID: `person:Hashum`); يَشوعَ (ID: `person:Jeshua.3`); بَابَايَ (ID: `person:Bebai`); زَكَّايَ (ID: `person:Zaccai.2`); بَانِيَ (ID: `person:Bani`); آطِيرَ (ID: `person:Ater`); عَرْجَدَ (ID: `person:Azgad`); زَتّو (ID: `person:Zattu.2`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); حَادِيدَ (ID: `place:Hadid`); حَارِيمَ (ID: `person:Harim.2`); نَبو (ID: `place:Nebo.2`); Beth-azmaveth (ID: `place:Beth-azmaveth`); مَغْبِيشَ (ID: `place:Magbish`); سَنَاءَةَ (ID: `place:Senaah`); وَلودَ (ID: `place:Lod`); عَنَاثوثَ (ID: `place:Anathoth`); عِيلَامَ (ID: `person:Elam`); بَئِيروت (ID: `place:Beeroth`); مِخْمَاسَ (ID: `place:Michmash`); لَحْمٍ (ID: `place:Bethlehem`); مِنْ (ID: `place:Geba`); ٱلْكَفِيرَة (ID: `place:Chephirah`); عَايٍ (ID: `place:Ai`); Ramah (ID: `place:Ramah.2`); أونوَ (ID: `place:Ono`); Bethel (ID: `place:Bethel`); أَرِيحَا (ID: `place:Jericho`); Kiriath-jearim (ID: `place:Kiriath-jearim`)
...
* **Associated ACAI Concepts:** شوبَايَ (ID: `person:Shobai`); لِإِيمِيرَ (ID: `person:Immer.2`); حَطِيطَا (ID: `person:Hatita`); آطِيرَ (ID: `person:Ater.2`); طَلْمون (ID: `person:Talmon`); يَشوعَ (ID: `person:Jeshua.4`); هودَوْيَا (ID: `person:Hodaviah.4`); يَشوعَ (ID: `person:Jeshua`); يَدَايَا (ID: `person:Jedaiah.4`); حَارِيمَ (ID: `person:Harim`); فَشْحور (ID: `person:Pashhur`); شَلّوم (ID: `person:Shallum.8`); لَّاوِي (ID: `group:Levi`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); آسَاف (ID: `person:Asaph.2`); عَقّوب (ID: `person:Akkub.2`); لَّاوِي (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** شوبَايَ (ID: `person:Shobai`); آطِيرَ (ID: `person:Ater.2`); طَلْمون (ID: `person:Talmon`); حَطِيطَا (ID: `person:Hatita`); شَلّوم (ID: `person:Shallum.8`); آسَاف (ID: `person:Asaph.2`); عَقّوب (ID: `person:Akkub.2`)
...
* **Associated ACAI Concepts:** رَصِينَ (ID: `person:Rezin.2`); حَاجَابَ (ID: `person:Hagab`); Meunim (ID: `group:Meunim`); بَقْبوقَ (ID: `person:Bakbuk`); ثَامَحَ (ID: `person:Temah`); حَقوفَا (ID: `person:Hakupha`); حَطِيفَا (ID: `person:Hatipha`); حَجَابَةَ (ID: `person:Hagabah`); طَبَاعوتَ (ID: `person:Tabbaoth`); فَادونَ (ID: `person:Padon`); حَرْشَا (ID: `person:Harsha`); فِي (ID: `person:Uzza.2`); جَدِّيلَ (ID: `person:Giddel`); سَلْمَايَ (ID: `person:Shalmai`); سِيعَهَا (ID: `person:Siaha`); حَرْحورَ (ID: `person:Harhur`); صِيحَا (ID: `person:Ziha`); سِيسَرَا (ID: `person:Sisera.2`); قِيروسَ (ID: `person:Keros`); مَحِيدَا (ID: `person:Mehida`); حَسوفَا (ID: `person:Hasupha`); نَصِيحَ (ID: `person:Neziah`); بَصْلوتَ (ID: `person:Bazluth`); رَآيَا (ID: `person:Reaiah.3`); أَسْنَةَ (ID: `person:Asnah`); نَقودَا (ID: `person:Nekoda`); بَرْقوسَ (ID: `person:Barkos`); Nephushesim (ID: `group:Nephushesim`); جَزَّامَ (ID: `person:Gazzam`); فَاسِيحَ (ID: `person:Paseah.2`); حَانَان (ID: `person:Hanan.4`); بِيسَايَ (ID: `person:Besai`); جَاحَرَ (ID: `person:Gahar`); عَقّوب (ID: `person:Akkub.3`); لَبَانَةَ (ID: `person:Lebanah`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); سوفَرَثَ (ID: `person:Sophereth`); شَفَطْيَا (ID: `person:Shephatiah.7`); جَدِّيلَ (ID: `person:Giddel.2`); دَرْقونَ (ID: `person:Darkon`); حَطِّيلَ (ID: `person:Hattil`); آمِي (ID: `person:Ami`); يَعْلَةَ (ID: `person:Jaalah`); سَوْطَايَ (ID: `person:Sotai`); فَرودَا (ID: `person:Peruda`)
...
* **Associated ACAI Concepts:** طوبِيَّا (ID: `person:Tobiah`); Tel-harsha (ID: `place:Tel-harsha`); Tel-melah (ID: `place:Tel-melah`); أَدَّان (ID: `place:Addan`); كَروب (ID: `place:Cherub`); نَقودَا (ID: `person:Nekoda.2`); لِإِيمِيرَ (ID: `place:Immer`); لِدَلَايَا (ID: `person:Delaiah.3`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** بَرْزِلَّايَ (ID: `person:Barzillai.3`); هَقّوصَ (ID: `person:Hakkoz.2`); حَبَايَا (ID: `person:Habaiah`); Gileadites (ID: `group:Gilead`); بَرْزِلَّايَ (ID: `person:Barzillai`); Defile (ID: `keyterm:Stain`); Priesthood (ID: `keyterm:Priesthood`); جِلْعَادَ (ID: `place:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); Strength (ID: `keyterm:Strength`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); Mina (ID: `realia:Mina`); Tunic (ID: `realia:Tunic`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); يَشوع (ID: `person:Joshua.5`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); Relatives (ID: `group:Relatives`); هودَوْيَا (ID: `person:Hodaviah.4`); حِينَادَادَ (ID: `person:Henadad`); يَشوعَ (ID: `person:Jeshua.4`); Esarhaddon (ID: `person:Esarhaddon`); Appointed Feast (ID: `keyterm:AppointedFeast`); Sidonians (ID: `group:Sidon`); هودِيَّا (ID: `person:Hodiah.2`); يَافَا (ID: `place:Joppa`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Holy (ID: `keyterm:Holy`); Instruction (ID: `keyterm:Instruction`); New Moon Festival (ID: `keyterm:NewMoonFestival`); بَنْيَامِينَ (ID: `group:Benjamin`); لبْنَانَ (ID: `place:Lebanon`); صِيْدونَ (ID: `place:Sidon`); Tyrians (ID: `group:Tyre`); Kindness (ID: `keyterm:Kindness`); Counsel (ID: `keyterm:Counsel`); Terror (ID: `keyterm:Terror`); آسَاف (ID: `person:Asaph.2`); دَارِيوسَ (ID: `person:Darius.2`); صورَ (ID: `place:Tyre`); بَنْيَامِينَ (ID: `person:Benjamin`); دَاودَ (ID: `person:David`); موسَى (ID: `person:Moses`); Assyria (ID: `place:Assyria`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Cedar (ID: `flora:Cedar`); Trumpet (ID: `realia:Trumpet`); Craftsman (ID: `realia:Craftsman`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); إِسْرَائِيلَ (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); موسَى (ID: `person:Moses`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); Terror (ID: `keyterm:Terror`); ٱلرَّبِّ (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); Sidonians (ID: `group:Sidon`); لبْنَانَ (ID: `place:Lebanon`); Tyrians (ID: `group:Tyre`); يَافَا (ID: `place:Joppa`); صورَ (ID: `place:Tyre`); فَارِسَ (ID: `place:Persia`); صِيْدونَ (ID: `place:Sidon`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Craftsman (ID: `realia:Craftsman`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); لَّاوِي (ID: `group:Levi`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `person:Levi.3`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `group:Levi`); دَاودَ (ID: `person:David`); آسَاف (ID: `person:Asaph.2`); لَّاوِي (ID: `person:Levi.3`); Kindness (ID: `keyterm:Kindness`); Trumpet (ID: `realia:Trumpet`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); فَارِسَ (ID: `place:Persia`); Jews (ID: `group:Jews`); ٱلسَّامِرَةِ (ID: `place:Samaria`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); مِثْرَدَاث (ID: `person:Mithredath.2`); طَبْئِيل (ID: `person:Tabeel`); أسْنَفَّر (ID: `person:Osnappar`); أَرَكَ (ID: `place:Erech`); بِشْلَام (ID: `person:Bishlam`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); Babylonians (ID: `group:Babylon`); يَهوذَا (ID: `group:Judah`); Persians (ID: `group:Persia`); فِي (ID: `place:Susa`); Elamites (ID: `group:Elam`); عِيلَامَ (ID: `place:Elam`); يَهوذَا (ID: `person:Judah.4`); بَابِلَ (ID: `place:Babylon`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** ٱلدِّينِيِّينَ (ID: `person:Dinaite`); شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); Babylonians (ID: `group:Babylon`); أَرَكَ (ID: `place:Erech`); Persians (ID: `group:Persia`); فِي (ID: `place:Susa`); بَابِلَ (ID: `place:Babylon`); Elamites (ID: `group:Elam`); عِيلَامَ (ID: `place:Elam`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); شِمْشَاي (ID: `person:Shimshai`); Jews (ID: `group:Jews`); رَحوم (ID: `person:Rehum.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); Jews (ID: `group:Jews`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); دَارِيوسَ (ID: `person:Darius.2`); تَتْنَاي (ID: `person:Tattenai`); يَدّو (ID: `person:Iddo.6`); حَجَّيِ (ID: `person:Haggai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); زَكَرِيَّا (ID: `person:Zechariah.17`); إِسْرَائِيلَ (ID: `person:Israel`); يَشوع (ID: `person:Joshua.5`); يَهوذَا (ID: `person:Judah.4`); يَهوصَادِقَ (ID: `person:Jehozadak`); ٱلْفرَاتِ (ID: `place:Euphrates`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** يَدّو (ID: `person:Iddo.6`); حَجَّيِ (ID: `person:Haggai`); زَكَرِيَّا (ID: `person:Zechariah.17`); إِسْرَائِيلَ (ID: `person:Israel`); Jews (ID: `group:Jews`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); بَابِلَ (ID: `place:Babylon`); أورشَلِيمَ (ID: `place:Jerusalem`); كورَشَ (ID: `person:Cyrus`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); دَارِيوسَ (ID: `person:Darius.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); Shethar-bozenai (ID: `person:Shethar-bozenai`); تَتْنَاي (ID: `person:Tattenai`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); يَهوذَا (ID: `person:Judah.4`); ٱلْفرَاتِ (ID: `place:Euphrates`); Foundation (ID: `realia:Foundation`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); Chaldeans (ID: `group:Chaldea`); بَابِلَ (ID: `place:Babylon`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Gentiles (ID: `group:Gentile`); ٱلرَّبِّ (ID: `deity:Lord`); Defilement (ID: `keyterm:Defilement`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); صَادوق (ID: `person:Zadok.4`); عَزَرْيَا (ID: `person:Azariah.7`); شَلّوم (ID: `person:Shallum.7`); أَبِيشوعَ (ID: `person:Abishua`); عَزَرْيَا (ID: `person:Azariah.6`); أَمَرْيَا (ID: `person:Amariah.2`); سَرَايَا (ID: `person:Seraiah.2`); زَرَحْيَا (ID: `person:Zerahiah`); بقِّي (ID: `person:Bukki.2`); عزِّي (ID: `person:Uzzi`); لِمَرَايوثَ (ID: `person:Meraioth`); أَخِيطوبَ (ID: `person:Ahitub.3`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); حِلْقِيَّا (ID: `person:Hilkiah.2`); فِينَحَاس (ID: `person:Phinehas`); فَارِسَ (ID: `place:Persia`); هَارون (ID: `person:Aaron`); أَلِعَازَار (ID: `person:Eleazar.2`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); عَزْرَا (ID: `person:Ezra`); ٱلرَّبِّ (ID: `deity:Lord`); Decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); ٱلْفرَاتِ (ID: `place:Euphrates`); Wheat (ID: `flora:Wheat`); Olive Oil (ID: `realia:OliveOil`); Kor (ID: `realia:Kor`); Talent (ID: `realia:Talent`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** يِشْعِيَا (ID: `person:Jeshaiah.4`); مِيخَائِيلَ (ID: `person:Michael.10`); دَانِيآل (ID: `person:Daniel.2`); عِيلَامَ (ID: `person:Elam`); هِقَّاطَانَ (ID: `person:Hakkatan`); عوبَدْيَا (ID: `person:Obadiah.10`); Pahath-moab (ID: `person:Pahath-moab`); عوتَاي (ID: `person:Uthai.2`); يوحَانَانَ (ID: `person:Johanan.8`); يوآب (ID: `person:Joab.4`); يَعِيئِيل (ID: `person:Jeuel.3`); شَكَنْيَا (ID: `person:Shecaniah.6`); عَثَلْيَا (ID: `person:Athaliah.3`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); Gershom (ID: `person:Gershom.2`); حَطّوش (ID: `person:Hattush.2`); عَادِينَ (ID: `person:Adin`); أَدونِيقَامَ (ID: `person:Adonikam`); بِغْوَايَ (ID: `person:Bigvai.2`); زَكَرِيَّا (ID: `person:Zechariah.18`); زَكّور (ID: `person:Zaccur.5`); زَبَدْيَا (ID: `person:Zebadiah.8`); بَابَايَ (ID: `person:Bebai.2`); زَكَرِيَّا (ID: `person:Zechariah.19`); شَفَطْيَا (ID: `person:Shephatiah.6`); أَلِيفَلَط (ID: `person:Eliphelet.5`); يونَاثَانَ (ID: `person:Jonathan.9`); شِمْعِيَا (ID: `person:Shemaiah.14`); يَحْزِيئِيل (ID: `person:Jahaziel.5`); يوشَفْيَا (ID: `person:Josiphiah`); شَلومِيَةَ (ID: `person:Shelomith.4`); فَرْعوشَ (ID: `person:Parosh.2`); يَحِيئِيل (ID: `person:Jehiel.7`); بَابَايَ (ID: `person:Bebai`); عَرْجَدَ (ID: `person:Azgad`); عَابِد (ID: `person:Ebed.2`); زَرَحْيَا (ID: `person:Zerahiah.2`); شَكَنْيَا (ID: `person:Shecaniah.5`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فِينَحَاس (ID: `person:Phinehas`); إِيثَامَارَ (ID: `person:Ithamar`); بَابِلَ (ID: `place:Babylon`); دَاودَ (ID: `person:David`)
...
* **Associated ACAI Concepts:** زَكَرِيَّا (ID: `person:Zechariah.20`); أَرِيئِيلَ (ID: `person:Ariel`); يَارِيبَ (ID: `person:Jarib.2`); يَدّو (ID: `person:Iddo`); مَشلَّام (ID: `person:Meshullam.9`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); نَاثَان (ID: `person:Nathan.5`); شِمْعِيَا (ID: `person:Shemaiah.15`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); يويَارِيبَ (ID: `person:Joiarib.2`); أَلِيعَزَرَ (ID: `person:Eliezer.8`); ٱلْمسَمَّى (ID: `place:Casiphia`); ٱلرَّبِّ (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `group:Levi`); Insight (ID: `keyterm:Insight`); مَحْلِي (ID: `person:Mahli`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); To Sin (ID: `keyterm:Sin`); ٱلرَّبِّ (ID: `deity:Lord`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); إِسْرَائِيلَ (ID: `person:Israel`); Be Unfaithful (ID: `keyterm:Unfaithful`); مِصْرَ (ID: `place:Egypt`); Jebusites (ID: `group:Jebusites`); لَّاوِي (ID: `group:Levi`); Ammonites (ID: `group:Ammon`); Egyptians (ID: `group:Egypt`); موآبَ (ID: `place:Moab`); Amorites (ID: `group:Amorites`); حِثًّا (ID: `person:Heth`); لَّاوِي (ID: `person:Levi.3`); Canaanites (ID: `group:Canaan`); كَنْعَان (ID: `place:Canaan`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Passion (ID: `keyterm:Ardour`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); عِيلَامَ (ID: `person:Elam`); يَهوذَا (ID: `group:Judah`); Counsel (ID: `keyterm:Counsel`); Offering (ID: `keyterm:Offering`); يَهوذَا (ID: `person:Judah.4`); مَكْنَدْبَاي (ID: `person:Machnadebai`); شِمْعون (ID: `person:Shimeon`); أورِي (ID: `person:Uri.3`); كَلَال (ID: `person:Chelal`); شَمَرْيَا (ID: `person:Shemariah.3`); زَكَرِيَّا (ID: `person:Zechariah.21`); Hittites (ID: `group:Hittite`); مَتَّثْيَا (ID: `person:Mattithiah.3`); مَتَّنْيَا (ID: `person:Mattaniah.5`); أَلْيَاشِيب (ID: `person:Eliashib.4`); شَلّوم (ID: `person:Shallum.10`); عَدَايَا (ID: `person:Adaiah.6`); أَلِيعَزَرَ (ID: `person:Eliezer.10`); فَتَحْيَا (ID: `person:Pethahiah.2`); فَرْعوشَ (ID: `person:Parosh`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); إِسْرَائِيلَ (ID: `person:Israel`); Peace (ID: `keyterm:IntactState`); To Cause to Possess (ID: `keyterm:Possess`); Plea for Mercy (ID: `keyterm:Supplication`); Defilement (ID: `keyterm:Defilement`); Kindness (ID: `keyterm:Kindness`); أورشَلِيمَ (ID: `place:Jerusalem`); فَارِسَ (ID: `place:Persia`); Dispossess (ID: `keyterm:Dispossess`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); Plea for Mercy (ID: `keyterm:Supplication`); Kindness (ID: `keyterm:Kindness`); أورشَلِيمَ (ID: `place:Jerusalem`); فَارِسَ (ID: `place:Persia`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); ٱلرَّبِّ (ID: `deity:Lord`); Repent (ID: `keyterm:Repent`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَحِيئِيل (ID: `person:Jehiel.8`); شَكَنْيَا (ID: `person:Shecaniah.7`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); عِيلَامَ (ID: `person:Elam`); ٱلرَّبِّ (ID: `deity:Lord`); Be Unfaithful (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); ٱلرَّبِّ (ID: `deity:Lord`); Counsel (ID: `keyterm:Counsel`); Covenant (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Swear (ID: `keyterm:Swear`); عَزْرَا (ID: `person:Ezra`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `person:Benjamin`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** تِقْوَةَ (ID: `person:Tikvah.2`); مَشلَّام (ID: `person:Meshullam.10`); يونَاثَانَ (ID: `person:Jonathan.10`); عَسَائِيل (ID: `person:Asahel.4`); شَبْتَاي (ID: `person:Shabbethai`); يَحْزِيَا (ID: `person:Jahzeiah`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`)
