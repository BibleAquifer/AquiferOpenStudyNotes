...
* **Associated ACAI Concepts:** Filemón (ID: `person:Philemon`); Timoteo (ID: `person:Timothy`); amado (ID: `keyterm:Beloved`); Jesús (ID: `person:Jesus.2`); Pablo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Filemón (ID: `person:Philemon`); Apphia (ID: `person:Apphia`); Archîpo (ID: `person:Archippus`); Pablo (ID: `person:Paul`); Timoteo (ID: `person:Timothy`); Jehová (ID: `deity:Lord`); iglesia (ID: `keyterm:Church`); amado (ID: `keyterm:Beloved`); favor (ID: `keyterm:Favor`); hacer la paz (ID: `keyterm:Peace`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** santo (ID: `keyterm:Holy`); Jesús (ID: `person:Jesus.2`); creer (ID: `keyterm:Believe`); amar (ID: `keyterm:Love`); Jehová (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Good (ID: `keyterm:Good`); rogar (ID: `keyterm:AskFor`); comunión (ID: `keyterm:Fellowship`); orar (ID: `keyterm:Pray`); entrañas (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); cristo (ID: `keyterm:InChrist`); amar (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`); Pablo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** buena noticia (ID: `keyterm:GoodNews`); servir (ID: `keyterm:Serve`); Good (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Lucas (ID: `person:Luke`); Demas (ID: `person:Demas`); Epafras (ID: `person:Epaphras`); espíritu (ID: `keyterm:Spirit.2`); Marcos (ID: `person:Mark`); cristo (ID: `keyterm:InChrist`); favor (ID: `keyterm:Favor`); Aristarco (ID: `person:Aristarchus`)
