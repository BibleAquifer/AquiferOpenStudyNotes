...
* **Associated ACAI Concepts:** Ephrata (ID: `person:Ephrathah`); Efratita (ID: `group:Ephrathah`); Noemi (ID: `person:Naomi`); Chelión (ID: `person:Chilion`); Judá (ID: `group:Judah`); Elimelech (ID: `person:Elimelech`); Catah (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Mahalón (ID: `person:Mahlon`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); dejar en herencia (ID: `keyterm:Possess`); Mahalón (ID: `person:Mahlon`); Ruth (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); Lea (ID: `person:Leah`); Catah (ID: `place:Bethlehem`); Israel (ID: `person:Israel`); Rachêl (ID: `person:Rachel`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Thamar (ID: `person:Tamar`); Phares (ID: `person:Perez`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); bendecir (ID: `keyterm:Bless`); Jehová (ID: `deity:Lord`); Noemi (ID: `person:Naomi`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Hesrón (ID: `person:Hezron.2`); Salmón (ID: `person:Salmon`); Obed (ID: `person:Obed`); Aminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Booz (ID: `person:Boaz`); Nahasón (ID: `person:Nahshon`); Phares (ID: `person:Perez`); David (ID: `person:David`); Isaí (ID: `person:Jesse`)
