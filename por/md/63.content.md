...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); misericórdia (ID: `keyterm:Mercy`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`); escolhido (ID: `keyterm:Chosen`); fazer a paz (ID: `keyterm:Peace`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** misericórdia (ID: `keyterm:Mercy`); favor (ID: `keyterm:Favor`); love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); Jesus (ID: `person:Jesus.2`); fazer a paz (ID: `keyterm:Peace`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); andar (ID: `keyterm:Live.3`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`); corpo (ID: `keyterm:Body.3`); Truth (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); compartilhar (ID: `keyterm:Share`); rogar (ID: `keyterm:AskFor`); House (ID: `realia:House`)
