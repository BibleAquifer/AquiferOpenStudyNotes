...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jonah (ID: `person:Jonah.2`); Fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); Hell (ID: `place:Hell`); Vow (ID: `keyterm:Vow`); Amittai (ID: `person:Amittai`); Nineveh (ID: `place:Nineveh`); Joppa (ID: `place:Joppa`); Hebrews (ID: `group:Hebrews`); Kindness (ID: `keyterm:Kindness`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Exempt (ID: `keyterm:Exempt`); Tarshish (ID: `place:Tarshish`); Praise (ID: `keyterm:Praise`); Slaughtering (ID: `keyterm:Slaughtering`); Salvation (ID: `keyterm:Salvation`); Lot (ID: `keyterm:Lot`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Hell (ID: `place:Hell`); Jonah (ID: `person:Jonah.2`); Praise (ID: `keyterm:Praise`); Salvation (ID: `keyterm:Salvation`); Vow (ID: `keyterm:Vow`); Kindness (ID: `keyterm:Kindness`); Cattails (ID: `flora:Cattails`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** Praise (ID: `keyterm:Praise`); Salvation (ID: `keyterm:Salvation`); Vow (ID: `keyterm:Vow`); Kindness (ID: `keyterm:Kindness`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jonah (ID: `person:Jonah.2`); Nineveh (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Sackcloth (ID: `realia:Sackcloth`); Cattle (ID: `fauna:Bull`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Generous (ID: `keyterm:Generous`); Tarshish (ID: `place:Tarshish`); Kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`); Believe In (ID: `keyterm:BelieveIn`); Goat (ID: `fauna:Goat`); Clothing (ID: `realia:Clothing`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Word of the Lord (ID: `keyterm:WordOfTheLord`); Nineveh (ID: `place:Nineveh`); LORD (ID: `deity:Lord`); Jonah (ID: `person:Jonah.2`)
...
* **Associated ACAI Concepts:** Generous (ID: `keyterm:Generous`); Tarshish (ID: `place:Tarshish`); Compassionate (ID: `keyterm:Compassionate`); Kindness (ID: `keyterm:Kindness`); LORD (ID: `deity:Lord`)
