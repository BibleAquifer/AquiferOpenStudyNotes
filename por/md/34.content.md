...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); strength (ID: `keyterm:Strength`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Basã (ID: `place:Bashan`); Zealous (ID: `keyterm:Zealous.3`); Libano (ID: `place:Lebanon`); Carmelo (ID: `place:Carmel`); The Way (ID: `keyterm:TheWay`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); strength (ID: `keyterm:Strength`); wickedness (ID: `keyterm:Wickedness`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Basã (ID: `place:Bashan`); Zealous (ID: `keyterm:Zealous.3`); Libano (ID: `place:Lebanon`); Carmelo (ID: `place:Carmel`); The Way (ID: `keyterm:TheWay`); Strong Drink (ID: `realia:StrongDrink`); Brier (ID: `flora:Brier`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** wickedness (ID: `keyterm:Wickedness`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); make a vow (ID: `keyterm:Vow`); peace (ID: `keyterm:IntactState`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); SENHOR (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`); Flock (ID: `fauna:Flock`)
