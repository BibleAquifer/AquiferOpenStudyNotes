...
* **Associated ACAI Concepts:** Éphrata (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); Kiljon (ID: `person:Chilion`); Juda (ID: `group:Judah`); Machlon (ID: `person:Mahlon`); Élimélec (ID: `person:Elimelech`); Bethléhem (ID: `place:Bethlehem`); Juda (ID: `person:Judah.4`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); Boaz (ID: `person:Boaz`); laissiez en possession (ID: `keyterm:Possess`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Elders (ID: `group:GenericElders`); Bethléhem (ID: `place:Bethlehem`); Léa (ID: `person:Leah`); Rachel (ID: `person:Rachel`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Salmon (ID: `person:Salmon`); Hetsron (ID: `person:Hezron.2`); Obed (ID: `person:Obed`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Isaï (ID: `person:Jesse`); Boaz (ID: `person:Boaz`); Nahshon (ID: `person:Nahshon`); Perets (ID: `person:Perez`); David (ID: `person:David`)
