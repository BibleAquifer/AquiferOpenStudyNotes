...
* **Associated ACAI Concepts:** Tessalônica (ID: `place:Thessalonica`); Jesus (ID: `person:Jesus.2`); Thessalonians (ID: `group:Thessalonica`); igreja (ID: `keyterm:Church`); Silas (ID: `person:Silas`); SENHOR (ID: `deity:Lord`); Timóteo (ID: `person:Timothy`); fazer a paz (ID: `keyterm:Peace`); favor (ID: `keyterm:Favor`); Paulo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); Macedônia (ID: `place:Macedonia`); love (ID: `keyterm:Love`); Holy Spirit (ID: `deity:HolySpirit`); Acaia (ID: `place:Achaia`); hope (ID: `keyterm:Hope`); céu (ID: `keyterm:Heaven`); Life (ID: `keyterm:Life`); verdadeiro (ID: `keyterm:True`); boa notícia (ID: `keyterm:GoodNews`); Cause of Joy (ID: `keyterm:CauseOfJoy`); orar (ID: `keyterm:Pray`); servir como escravo (ID: `keyterm:Serve.2`); livrar (ID: `keyterm:Deliver`); levantamento (ID: `keyterm:Resurrection`); Ability (ID: `keyterm:Ability`); escolhido (ID: `keyterm:Chosen`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); hope (ID: `keyterm:Hope`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); boa notícia (ID: `keyterm:GoodNews`); rogar (ID: `keyterm:AskFor`); Glory (ID: `keyterm:Glory`); Cause of Joy (ID: `keyterm:CauseOfJoy`); coração (ID: `keyterm:Heart`); Timóteo (ID: `person:Timothy`); witness (ID: `keyterm:Witness`); vazio (ID: `keyterm:Empty`); exortar (ID: `keyterm:Encourage`); love (ID: `keyterm:Love`); be blameless (ID: `keyterm:Blameless`); holy (ID: `keyterm:Holy`); Atenas (ID: `place:Athens`); hope (ID: `keyterm:Hope`); Jews (ID: `group:Jews`); testemunhar solenemente (ID: `keyterm:Declare`); Life (ID: `keyterm:Life`); verdadeiro (ID: `keyterm:True`); Judeia (ID: `place:Judea`); amado (ID: `keyterm:Beloved`); Paulo (ID: `person:Paul`); andar (ID: `keyterm:Live.3`); desejar (ID: `keyterm:LongFor`); Good (ID: `keyterm:Good`); em cristo (ID: `keyterm:InChrist`); tentar (ID: `keyterm:PutToTheTest`); reino (ID: `keyterm:Kingdom`); defilement (ID: `keyterm:Defilement`); Satanás (ID: `deity:Satan`); igreja (ID: `keyterm:Church`); salvation (ID: `keyterm:Salvation`); discernir (ID: `keyterm:Interpret`); Filipos (ID: `place:Philippi`); proclamar (ID: `keyterm:Proclaim`); To Sin (ID: `keyterm:Sin`); Gentiles (ID: `group:Gentile`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** boa notícia (ID: `keyterm:GoodNews`); coração (ID: `keyterm:Heart`); SENHOR (ID: `deity:Lord`); discernir (ID: `keyterm:Interpret`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); igreja (ID: `keyterm:Church`); em cristo (ID: `keyterm:InChrist`); SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); Atenas (ID: `place:Athens`); Jesus (ID: `person:Jesus.2`); boa notícia (ID: `keyterm:GoodNews`); SENHOR (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); tentar (ID: `keyterm:PutToTheTest`); Timóteo (ID: `person:Timothy`); exortar (ID: `keyterm:Encourage`); vazio (ID: `keyterm:Empty`)
...
* **Associated ACAI Concepts:** boa notícia (ID: `keyterm:GoodNews`); desejar (ID: `keyterm:LongFor`); Good (ID: `keyterm:Good`); Timóteo (ID: `person:Timothy`); love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); SENHOR (ID: `deity:Lord`); be blameless (ID: `keyterm:Blameless`); holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); Life (ID: `keyterm:Life`); consecration (ID: `keyterm:Consecration.2`); love (ID: `keyterm:Love`); exortar (ID: `keyterm:Encourage`); hope (ID: `keyterm:Hope`); andar (ID: `keyterm:Live.3`); em cristo (ID: `keyterm:InChrist`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); Holy Spirit (ID: `deity:HolySpirit`); amor fraternal (ID: `keyterm:LoveForOnesFellowBeliever`); Macedônia (ID: `place:Macedonia`); céu (ID: `keyterm:Heaven`); testemunhar solenemente (ID: `keyterm:Declare`); Good (ID: `keyterm:Good`); defilement (ID: `keyterm:Defilement`); ensinado por deus (ID: `keyterm:TaughtByGod`); orar (ID: `keyterm:Pray`); desanimado (ID: `keyterm:FaintHearted`); discernir (ID: `keyterm:Interpret`); viver em paz (ID: `keyterm:AtPeace`); fornication (ID: `keyterm:Fornication`); fazer a paz (ID: `keyterm:Peace`); Gentiles (ID: `group:Gentile`); Trumpet (ID: `realia:Trumpet`); Helmet (ID: `realia:Helmet`)
...
* **Associated ACAI Concepts:** be blameless (ID: `keyterm:Blameless`); Jesus (ID: `person:Jesus.2`); consecration (ID: `keyterm:Consecration.2`); SENHOR (ID: `deity:Lord`); fazer a paz (ID: `keyterm:Peace`); Spirit (ID: `keyterm:Spirit.2`); corpo (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); be blameless (ID: `keyterm:Blameless`); orar (ID: `keyterm:Pray`); consecration (ID: `keyterm:Consecration.2`); SENHOR (ID: `deity:Lord`); Faithfulness (ID: `keyterm:Faithfulness`); fazer a paz (ID: `keyterm:Peace`); favor (ID: `keyterm:Favor`); Spirit (ID: `keyterm:Spirit.2`); corpo (ID: `keyterm:Body.3`); holy (ID: `keyterm:Holy`)
