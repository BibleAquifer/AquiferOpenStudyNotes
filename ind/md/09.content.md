...
* **Associated ACAI Concepts:** Paran (ID: `place:Paran`); Samuel (ID: `person:Samuel`); Israel (ID: `person:Israel`); Daud (ID: `person:David`); Rama (ID: `place:Ramah`); House (ID: `realia:House`)
