...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Filemom (ID: `person:Philemon`); Arquipo (ID: `person:Archippus`); Áfia (ID: `person:Apphia`); igreja (ID: `keyterm:Church`); amado (ID: `keyterm:Beloved`); SENHOR (ID: `deity:Lord`); fazer a paz (ID: `keyterm:Peace`); Timóteo (ID: `person:Timothy`); favor (ID: `keyterm:Favor`); Paulo (ID: `person:Paul`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); holy (ID: `keyterm:Holy`); love (ID: `keyterm:Love`); orar (ID: `keyterm:Pray`); rogar (ID: `keyterm:AskFor`); SENHOR (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); comunhão (ID: `keyterm:Fellowship`); Good (ID: `keyterm:Good`); compaixão (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Paulo (ID: `person:Paul`); rogar (ID: `keyterm:AskFor`); love (ID: `keyterm:Love`); em cristo (ID: `keyterm:InChrist`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Demas (ID: `person:Demas`); Epafras (ID: `person:Epaphras`); Lucas (ID: `person:Luke`); Spirit (ID: `keyterm:Spirit.2`); favor (ID: `keyterm:Favor`); Marcos (ID: `person:Mark`); em cristo (ID: `keyterm:InChrist`); Aristarco (ID: `person:Aristarchus`)
