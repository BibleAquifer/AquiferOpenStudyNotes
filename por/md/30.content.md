...
* **Associated ACAI Concepts:** have a vision (ID: `keyterm:HaveAVision`); Tecoa (ID: `place:Tekoa`); Amós (ID: `person:Amos.3`); Judá (ID: `person:Judah.4`); Israel (ID: `person:Israel`); Judá (ID: `group:Judah`); Joás (ID: `person:Joash.4`); Jeroboão (ID: `person:Jeroboam.2`); Uzias (ID: `person:Uzziah`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Carmelo (ID: `place:Carmel`); Jerusalém (ID: `place:Jerusalem`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); rebel (ID: `keyterm:Rebel`); Edom (ID: `place:Edom`); Gileade (ID: `place:Gilead`); Israel (ID: `person:Israel`); Gaza (ID: `place:Gaza`); Judá (ID: `group:Judah`); Nazirites (ID: `group:Nazirite`); Amorites (ID: `group:Amorites`); Tiro (ID: `place:Tyre`); Judá (ID: `person:Judah.4`); Moabe (ID: `place:Moab`); Damasco (ID: `place:Damascus`); Amom (ID: `place:Ammon`); Hazael (ID: `person:Hazael`); Bete-Éden (ID: `place:Beth-eden`); Vale de Áven (ID: `place:AvenValley`); Quir (ID: `place:Kir`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Staff (ID: `realia:Staff`); Rod (ID: `realia:Rod`); Filisteu (ID: `group:Philistine`); Asdode (ID: `place:Ashdod`); Ben-Hadade (ID: `person:Ben-hadad.3`); strength (ID: `keyterm:Strength`); Temã (ID: `place:Teman`); speak (ID: `keyterm:Speak`); Egito (ID: `place:Egypt`); profane, dishonor (ID: `keyterm:Dishonor`); Filístia (ID: `place:Philistine`); Ecrom (ID: `place:Ekron`); Ammonites (ID: `group:Ammon`); Bozrah (ID: `place:Bozrah.2`); Jerusalém (ID: `place:Jerusalem`); dispossess (ID: `keyterm:Dispossess`); decree (ID: `keyterm:Decree`); Quiriataim (ID: `place:Kiriathaim`); Covenant (ID: `keyterm:Covenant`); poor (ID: `keyterm:Poor`); Asquelom (ID: `place:Ashkelon`); Instruction (ID: `keyterm:Instruction`); Cedar (ID: `flora:Cedar`); Grain (ID: `flora:Grain`); Horse (ID: `fauna:Horse`); Money (ID: `realia:Money`); Rams Horn (ID: `realia:RamsHorn`); Temple Altar (ID: `realia:TempleAltar`); Sheaf (ID: `realia:Sheaf`); Bow (ID: `realia:Bow`); Threshing-Sledge (ID: `realia:Threshing-sledge`); Oak (ID: `flora:Oak`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Wagon (ID: `realia:Wagon`)
...
* **Associated ACAI Concepts:** Bete-Éden (ID: `place:Beth-eden`); Quir (ID: `place:Kir`); Vale de Áven (ID: `place:AvenValley`); SENHOR (ID: `deity:Lord`); Damasco (ID: `place:Damascus`); Staff (ID: `realia:Staff`); Rod (ID: `realia:Rod`)
...
* **Associated ACAI Concepts:** Gaza (ID: `place:Gaza`); Edom (ID: `place:Edom`); SENHOR (ID: `deity:Lord`); rebel (ID: `keyterm:Rebel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Asquelom (ID: `place:Ashkelon`); Filisteu (ID: `group:Philistine`); Filístia (ID: `place:Philistine`); Ecrom (ID: `place:Ekron`); Asdode (ID: `place:Ashdod`); Staff (ID: `realia:Staff`); Rod (ID: `realia:Rod`)
...
* **Associated ACAI Concepts:** Covenant (ID: `keyterm:Covenant`); SENHOR (ID: `deity:Lord`); Tiro (ID: `place:Tyre`); Edom (ID: `place:Edom`); rebel (ID: `keyterm:Rebel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Gileade (ID: `place:Gilead`); Ammonites (ID: `group:Ammon`); Amom (ID: `place:Ammon`); rebel (ID: `keyterm:Rebel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); decree (ID: `keyterm:Decree`); rebel (ID: `keyterm:Rebel`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); decree (ID: `keyterm:Decree`); Jerusalém (ID: `place:Jerusalem`); rebel (ID: `keyterm:Rebel`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Wine (ID: `realia:Wine`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Betel (ID: `place:Bethel`); Egito (ID: `place:Egypt`); Samaria (ID: `place:Samaria`); rebel (ID: `keyterm:Rebel`); Lion (ID: `fauna:Lion`); Appoint (ID: `keyterm:Appoint`); love (ID: `keyterm:Love`); Vine (ID: `flora:Vine`); José (ID: `person:Joseph.10`); Gilgal (ID: `place:Gilgal.2`); lamentation (ID: `keyterm:Lamentation`); Harmom (ID: `place:Harmon`); swear (ID: `keyterm:Swear`); mischief (ID: `keyterm:Mischief`); have insight (ID: `keyterm:HaveInsight`); be kindly disposed (ID: `keyterm:KindlyDisposed`); Asdode (ID: `place:Ashdod`); Complete (ID: `keyterm:Complete`); innocence (ID: `keyterm:Innocence`); fear (ID: `keyterm:Fear`); speak (ID: `keyterm:Speak`); praise (ID: `keyterm:Praise`); To Sin (ID: `keyterm:Sin`); Berseba (ID: `place:Beersheba`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Gomorra (ID: `place:Gomorrah`); Basã (ID: `place:Bashan`); ardour (ID: `keyterm:Ardour`); slaughtering (ID: `keyterm:Slaughtering`); Sodoma (ID: `place:Sodom`); Horns of Altar (ID: `realia:HornsOfAltar`); Fig (ID: `flora:Fig`); Olive Tree (ID: `flora:OliveTree`); Grain (ID: `flora:Grain`); Horse (ID: `fauna:Horse`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Wormwood (ID: `flora:Wormwood`); Fishhook (ID: `realia:Fishhook`); Wine (ID: `realia:Wine`); Locust (ID: `fauna:Locust`); Rams Horn (ID: `realia:RamsHorn`); Trap (ID: `realia:Trap`); Cattle (ID: `fauna:Bull`); Flock (ID: `fauna:Flock`); Temple Altar (ID: `realia:TempleAltar`); Bed (ID: `realia:Bed`); Hewn Stone (ID: `realia:HewnStone`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Sandalwood (ID: `flora:Sandalwood`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Lion (ID: `fauna:Lion`); Trap (ID: `realia:Trap`); Bird (ID: `fauna:Bird`); Sandalwood (ID: `flora:Sandalwood`); Rams Horn (ID: `realia:RamsHorn`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Samaria (ID: `place:Samaria`); Israel (ID: `person:Israel`); Lion (ID: `fauna:Lion`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** Horns of Altar (ID: `realia:HornsOfAltar`); Appoint (ID: `keyterm:Appoint`); Israel (ID: `person:Israel`); Betel (ID: `place:Bethel`); rebel (ID: `keyterm:Rebel`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Gilgal (ID: `place:Gilgal.2`); praise (ID: `keyterm:Praise`); Israel (ID: `person:Israel`); love (ID: `keyterm:Love`); offering (ID: `keyterm:Offering`); slaughtering (ID: `keyterm:Slaughtering`); Betel (ID: `place:Bethel`); rebel (ID: `keyterm:Rebel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); praise (ID: `keyterm:Praise`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Egito (ID: `place:Egypt`); Sodoma (ID: `place:Sodom`); Gomorra (ID: `place:Gomorrah`); innocence (ID: `keyterm:Innocence`); Fig (ID: `flora:Fig`); Olive Tree (ID: `flora:OliveTree`); Vine (ID: `flora:Vine`); Grain (ID: `flora:Grain`); Horse (ID: `fauna:Horse`); Locust (ID: `fauna:Locust`)
...
* **Associated ACAI Concepts:** Betel (ID: `place:Bethel`); mischief (ID: `keyterm:Mischief`); Berseba (ID: `place:Beersheba`); Gilgal (ID: `place:Gilgal.2`)
...
* **Associated ACAI Concepts:** be kindly disposed (ID: `keyterm:KindlyDisposed`); José (ID: `person:Joseph.10`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); House (ID: `realia:House`); Woe (ID: `keyterm:Woe.2`); Hamate (ID: `place:Hamath`); offering (ID: `keyterm:Offering`); Cattle (ID: `fauna:Bull`); Lyre (ID: `realia:Lyre`); Calné (ID: `place:Calneh`); Ribeiro de Arabá (ID: `place:BrookOfTheArabah`); Lo-Debar (ID: `place:Lo-debar`); Quium (ID: `deity:Kiyyun`); Sicute (ID: `deity:Sikkuth`); lean on (ID: `keyterm:LeanOn`); swear (ID: `keyterm:Swear`); smear (ID: `keyterm:Smear`); Filisteu (ID: `group:Philistine`); Samaria (ID: `place:Samaria`); Filístia (ID: `place:Philistine`); Jerusalém (ID: `place:Jerusalem`); Gate (ID: `place:Gath`); Davi (ID: `person:David`); slaughtering (ID: `keyterm:Slaughtering`); Asterote-Carnaim (ID: `place:Ashteroth-karnaim`); José (ID: `person:Joseph.10`); Damasco (ID: `place:Damascus`); Molten Image (ID: `realia:MoltenImage`); Lion (ID: `fauna:Lion`); Goat (ID: `fauna:Goat`); Horse (ID: `fauna:Horse`); Olive Oil (ID: `realia:OliveOil`); Bear (ID: `fauna:Bear`); Anointing Oil (ID: `realia:AnointingOil`); Sheep (ID: `fauna:Lamb`); Wormwood (ID: `flora:Wormwood`); Wine (ID: `realia:Wine`); Mattock (ID: `realia:Mattock`); Flock (ID: `fauna:Flock`); Vine (ID: `flora:Vine`); Bed (ID: `realia:Bed`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Image (ID: `realia:Image`); Snake (ID: `fauna:Snake`); Animal Pen (ID: `realia:AnimalPen`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Quium (ID: `deity:Kiyyun`); Sicute (ID: `deity:Sikkuth`); Israel (ID: `person:Israel`); Damasco (ID: `place:Damascus`); slaughtering (ID: `keyterm:Slaughtering`); Image (ID: `realia:Image`); Lyre (ID: `realia:Lyre`)
...
* **Associated ACAI Concepts:** Quium (ID: `deity:Kiyyun`); Sicute (ID: `deity:Sikkuth`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); slaughtering (ID: `keyterm:Slaughtering`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** lean on (ID: `keyterm:LeanOn`); Woe (ID: `keyterm:Woe.2`); Samaria (ID: `place:Samaria`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** José (ID: `person:Joseph.10`); smear (ID: `keyterm:Smear`); Davi (ID: `person:David`); Anointing Oil (ID: `realia:AnointingOil`); Wine (ID: `realia:Wine`); Lyre (ID: `realia:Lyre`); Vine (ID: `flora:Vine`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** José (ID: `person:Joseph.10`); smear (ID: `keyterm:Smear`); Anointing Oil (ID: `realia:AnointingOil`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Amós (ID: `person:Amos.3`); speak (ID: `keyterm:Speak`); Amazias (ID: `person:Amaziah.4`); Jeroboão (ID: `person:Jeroboam.2`); Egito (ID: `place:Egypt`); swear (ID: `keyterm:Swear`); Isaque (ID: `person:Isaac`); To Sin (ID: `keyterm:Sin`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Rio Nilo (ID: `place:Nile`); Betel (ID: `place:Bethel`); Plumb Line (ID: `realia:PlumbLine`); Basket (ID: `realia:Basket`); sabbath (ID: `keyterm:Sabbath`); lamentation (ID: `keyterm:Lamentation`); Hell (ID: `place:Hell`); Carmelo (ID: `place:Carmel`); defilement (ID: `keyterm:Defilement`); Cushites (ID: `group:Cush`); Filisteu (ID: `group:Philistine`); Samaria (ID: `place:Samaria`); Dã (ID: `group:Dan`); new moon festival (ID: `keyterm:NewMoonFestival`); Judá (ID: `group:Judah`); Filístia (ID: `place:Philistine`); Dã (ID: `place:Dan`); play the prostitute (ID: `keyterm:PlayTheProstitute`); Berseba (ID: `place:Beersheba`); Deceit (ID: `keyterm:Deceit`); Creta (ID: `place:Crete`); Cush (ID: `place:Cush.2`); forgive (ID: `keyterm:Forgive`); Syrians (ID: `group:Syria`); Quir (ID: `place:Kir`); Judá (ID: `person:Judah.4`); Floor (ID: `realia:Floor`); Sieve (ID: `realia:Sieve`); Fig (ID: `flora:Fig`); Shekel (ID: `realia:Shekel`); Balance (ID: `realia:Balance`); Goat (ID: `fauna:Goat`); Doorstep (ID: `realia:Doorstep`); Sycomore Fig (ID: `flora:SycomoreFig`); Stone Pine (ID: `flora:Pine`); Grass (ID: `flora:Grass`); Money (ID: `realia:Money`); Locust (ID: `fauna:Locust`); Ephah (ID: `realia:Ephah`); Flock (ID: `fauna:Flock`); Capital (ID: `realia:Capital`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Rope (ID: `realia:Rope`); Sackcloth (ID: `realia:Sackcloth`); High Place (ID: `realia:HighPlace`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Snake (ID: `fauna:Snake`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Amós (ID: `person:Amos.3`); speak (ID: `keyterm:Speak`); Amazias (ID: `person:Amaziah.4`); SENHOR (ID: `deity:Lord`); Jeroboão (ID: `person:Jeroboam.2`); Betel (ID: `place:Bethel`); defilement (ID: `keyterm:Defilement`); Isaque (ID: `person:Isaac`); Judá (ID: `group:Judah`); play the prostitute (ID: `keyterm:PlayTheProstitute`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Fig (ID: `flora:Fig`); Goat (ID: `fauna:Goat`); Sycomore Fig (ID: `flora:SycomoreFig`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Rope (ID: `realia:Rope`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); swear (ID: `keyterm:Swear`); sabbath (ID: `keyterm:Sabbath`); Israel (ID: `person:Israel`); Samaria (ID: `place:Samaria`); Egito (ID: `place:Egypt`); Dã (ID: `group:Dan`); new moon festival (ID: `keyterm:NewMoonFestival`); Dã (ID: `place:Dan`); Berseba (ID: `place:Beersheba`); Deceit (ID: `keyterm:Deceit`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Rio Nilo (ID: `place:Nile`); lamentation (ID: `keyterm:Lamentation`); Shekel (ID: `realia:Shekel`); Balance (ID: `realia:Balance`); Money (ID: `realia:Money`); Ephah (ID: `realia:Ephah`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); swear (ID: `keyterm:Swear`); Samaria (ID: `place:Samaria`); Dã (ID: `group:Dan`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Dã (ID: `place:Dan`); Berseba (ID: `place:Beersheba`)
...
* **Associated ACAI Concepts:** swear (ID: `keyterm:Swear`); SENHOR (ID: `deity:Lord`); Samaria (ID: `place:Samaria`); Dã (ID: `group:Dan`); Dã (ID: `place:Dan`); Berseba (ID: `place:Beersheba`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Capital (ID: `realia:Capital`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Doorstep (ID: `realia:Doorstep`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Quir (ID: `place:Kir`); Creta (ID: `place:Crete`); Egito (ID: `place:Egypt`); Israel (ID: `person:Israel`); Cush (ID: `place:Cush.2`); Cushites (ID: `group:Cush`); Filisteu (ID: `group:Philistine`); Filístia (ID: `place:Philistine`); Syrians (ID: `group:Syria`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Vine (ID: `flora:Vine`); dispossess (ID: `keyterm:Dispossess`); Israel (ID: `person:Israel`); Davi (ID: `person:David`); Edom (ID: `place:Edom`); Must (ID: `realia:Must`); Wine (ID: `realia:Wine`); Coriander (ID: `flora:Coriander`); Mattock (ID: `realia:Mattock`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Must (ID: `realia:Must`); Coriander (ID: `flora:Coriander`); Mattock (ID: `realia:Mattock`); Vine (ID: `flora:Vine`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Vine (ID: `flora:Vine`); Israel (ID: `person:Israel`); Must (ID: `realia:Must`); Wine (ID: `realia:Wine`); Coriander (ID: `flora:Coriander`); Mattock (ID: `realia:Mattock`); Barley (ID: `flora:Barley`)
