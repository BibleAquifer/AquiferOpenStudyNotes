...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Strength (ID: `keyterm:Strength`); Love (ID: `keyterm:Love`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); إِسْرَائِيلَ (ID: `person:Israel`); Defilement (ID: `keyterm:Defilement`); Mighty One (ID: `keyterm:MightyOne`); Work (ID: `keyterm:Work`); Appointed Feast (ID: `keyterm:AppointedFeast`); To Sin (ID: `keyterm:Sin`); Deceit (ID: `keyterm:Deceit`); Train (ID: `realia:Train`); Yoke (ID: `realia:Yoke`); Winepress (ID: `realia:Winepress`); Grass (ID: `flora:Grass`); Casting Net (ID: `realia:CastingNet`); Net (ID: `realia:Net`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Deer (ID: `fauna:Deer`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); أورشَلِيمَ (ID: `place:Jerusalem`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Defilement (ID: `keyterm:Defilement`)
...
* **Associated ACAI Concepts:** Mighty One (ID: `keyterm:MightyOne`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Appointed Feast (ID: `keyterm:AppointedFeast`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Horn (ID: `keyterm:Horn`); Sheep (ID: `fauna:Lamb`); Sabbath (ID: `keyterm:Sabbath`); Utterance (ID: `keyterm:Utterance`); Gentiles (ID: `group:Gentile`); To Dishonor (ID: `keyterm:Dishonor`); Passion (ID: `keyterm:Ardour`); Instruction (ID: `keyterm:Instruction`); Have a Vision (ID: `keyterm:HaveAVision`); Wine (ID: `realia:Wine`); Tent (ID: `realia:Tent`); Sackcloth (ID: `realia:Sackcloth`); Vine (ID: `flora:Vine`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Measuring Reed (ID: `realia:MeasuringReed`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Bow (ID: `realia:Bow`); House (ID: `realia:House`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** Appointed Feast (ID: `keyterm:AppointedFeast`); ٱلرَّبِّ (ID: `deity:Lord`); Sabbath (ID: `keyterm:Sabbath`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Appointed Feast (ID: `keyterm:AppointedFeast`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Fear (ID: `keyterm:Fear`); Salvation (ID: `keyterm:Salvation`); Arrow (ID: `keyterm:Arrow`); Complete (ID: `keyterm:Complete`); Rebel (ID: `keyterm:Rebel`); Redeem (ID: `keyterm:Redeem`); Peace (ID: `keyterm:IntactState`); Forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); Hope (ID: `keyterm:Hope`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Pit (ID: `realia:Pit`); Arrow (ID: `realia:Arrow`); Wormwood (ID: `flora:Wormwood`); Yoke (ID: `realia:Yoke`); Bird (ID: `fauna:Bird`); Lion (ID: `fauna:Lion`); Bear (ID: `fauna:Bear`); Bow (ID: `realia:Bow`); Hewn Stone (ID: `realia:HewnStone`); Bitter Herbs (ID: `flora:Chicory`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); أَدومَ (ID: `place:Edom`); عوصًا (ID: `place:Uz`); Defile (ID: `keyterm:Stain`); Anointed (ID: `keyterm:Anointed`); Defilement (ID: `keyterm:Defilement`); Complete (ID: `keyterm:Complete`); سَدومَ (ID: `place:Sodom`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Appoint (ID: `keyterm:Appoint`); Punishment (ID: `keyterm:Punishment`); Believe In (ID: `keyterm:BelieveIn`); Jackal (ID: `fauna:Jackal`); Ostrich (ID: `fauna:Ostrich`); Clay Jar (ID: `realia:ClayJar`); Purple Cloth (ID: `realia:PurpleCloth`); Vulture (ID: `fauna:Vulture`)
...
* **Associated ACAI Concepts:** أَدومَ (ID: `place:Edom`); عوصًا (ID: `place:Uz`); أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); Appoint (ID: `keyterm:Appoint`); To Sin (ID: `keyterm:Sin`); Complete (ID: `keyterm:Complete`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); Appoint (ID: `keyterm:Appoint`); أَدومَ (ID: `place:Edom`); To Sin (ID: `keyterm:Sin`); Complete (ID: `keyterm:Complete`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); Assyria (ID: `place:Assyria`); Passion (ID: `keyterm:Ardour`); Woe (ID: `keyterm:Woe`); To Cause to Possess (ID: `keyterm:Possess`); Round Dance (ID: `keyterm:RoundDance`); يَهوذَا (ID: `person:Judah.4`); مِصْرَ (ID: `place:Egypt`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`); Jackal (ID: `fauna:Jackal`); Hand-Mill (ID: `realia:Hand-mill`); Money (ID: `realia:Money`); Crown (ID: `realia:Crown`)
