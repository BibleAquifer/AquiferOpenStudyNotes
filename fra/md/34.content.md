...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Carmel (ID: `place:Carmel`); Basan (ID: `place:Bashan`); déclarer innocent (ID: `keyterm:PronounceInnocent`); zélé (ID: `keyterm:Zealous.3`); chemin (ID: `keyterm:TheWay`); force (ID: `keyterm:Strength`); Liban (ID: `place:Lebanon`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); se réfugier (ID: `keyterm:SeekfindRefuge`); Carmel (ID: `place:Carmel`); Basan (ID: `place:Bashan`); déclarer innocent (ID: `keyterm:PronounceInnocent`); zélé (ID: `keyterm:Zealous.3`); chemin (ID: `keyterm:TheWay`); force (ID: `keyterm:Strength`); Liban (ID: `place:Lebanon`); méchanceté (ID: `keyterm:Wickedness`); Strong Drink (ID: `realia:StrongDrink`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** force (ID: `keyterm:Strength`); Éternel (ID: `deity:Lord`); déclarer innocent (ID: `keyterm:PronounceInnocent`); chemin (ID: `keyterm:TheWay`)
...
* **Associated ACAI Concepts:** état intact (ID: `keyterm:IntactState`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); faire un voeu (ID: `keyterm:Vow`); méchanceté (ID: `keyterm:Wickedness`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); Éternel (ID: `deity:Lord`); Flock (ID: `fauna:Flock`); Chariot (ID: `realia:Chariot`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`)
