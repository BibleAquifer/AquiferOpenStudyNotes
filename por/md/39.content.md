...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Edom (ID: `place:Edom`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); fear (ID: `keyterm:Fear`); SENHOR (ID: `deity:Lord`); Priests (ID: `group:GenericPriests`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`); fear (ID: `keyterm:Fear`); offering (ID: `keyterm:Offering`); Glory (ID: `keyterm:Glory`); peace (ID: `keyterm:IntactState`); stain (ID: `keyterm:Stain`); Priests (ID: `group:GenericPriests`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); utter a curse (ID: `keyterm:Curse`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); fairness (ID: `keyterm:Fairness`); evil intention (ID: `keyterm:Intention`); pure (ID: `keyterm:Pure`); The Way (ID: `keyterm:TheWay`); bless (ID: `keyterm:Bless`); be kindly disposed (ID: `keyterm:KindlyDisposed`); profane, dishonor (ID: `keyterm:Dishonor`); ardour (ID: `keyterm:Ardour`); make a vow (ID: `keyterm:Vow`); Truth (ID: `keyterm:Truth`); rogar (ID: `keyterm:AskFor`); An Angel (ID: `deity:Angel`); Gentiles (ID: `group:Gentile`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); stain (ID: `keyterm:Stain`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); utter a curse (ID: `keyterm:Curse`); make a vow (ID: `keyterm:Vow`); fear (ID: `keyterm:Fear`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** An Angel (ID: `deity:Angel`); evil intention (ID: `keyterm:Intention`); Instruction (ID: `keyterm:Instruction`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); profane, dishonor (ID: `keyterm:Dishonor`); offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); love (ID: `keyterm:Love`); delight (ID: `keyterm:Delight`); Judá (ID: `person:Judah.4`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** profane, dishonor (ID: `keyterm:Dishonor`); SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); love (ID: `keyterm:Love`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); A Group of People (ID: `group:GenericGroup`); swear (ID: `keyterm:Swear`); pure (ID: `keyterm:Pure`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); An Angel (ID: `deity:Angel`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Covenant (ID: `keyterm:Covenant`); Judá (ID: `person:Judah.4`); fear (ID: `keyterm:Fear`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); decree (ID: `keyterm:Decree`); offering (ID: `keyterm:Offering`); utter a curse (ID: `keyterm:Curse`); bless (ID: `keyterm:Bless`); Israel (ID: `person:Israel`); House (ID: `realia:House`); Sorghum (ID: `flora:Sorghum`); Vine (ID: `flora:Vine`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** decree (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`); Elias (ID: `person:Elijah`); Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`); Israel (ID: `person:Israel`); Monte Sinai (ID: `place:SinaiMount`); fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`); Elias (ID: `person:Elijah`); fear (ID: `keyterm:Fear`)
