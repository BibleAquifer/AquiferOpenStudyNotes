...
* **Associated ACAI Concepts:** Chelión (ID: `person:Chilion`); Ephrata (ID: `person:Ephrathah`); Noemi (ID: `person:Naomi`); Efratita (ID: `group:Ephrathah`); Catah (ID: `place:Bethlehem`); Judá (ID: `group:Judah`); Mahalón (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Judá (ID: `person:Judah.4`); Elimelech (ID: `person:Elimelech`)
...
* **Associated ACAI Concepts:** bondad (ID: `keyterm:Kindness`); bendecir (ID: `keyterm:Bless`); Noemi (ID: `person:Naomi`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); dejar en herencia (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Booz (ID: `person:Boaz`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Catah (ID: `place:Bethlehem`); Elders (ID: `group:GenericElders`); Jehová (ID: `deity:Lord`); Rachêl (ID: `person:Rachel`); Lea (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Hesrón (ID: `person:Hezron.2`); Salmón (ID: `person:Salmon`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Nahasón (ID: `person:Nahshon`); Phares (ID: `person:Perez`); David (ID: `person:David`); Booz (ID: `person:Boaz`); Isaí (ID: `person:Jesse`)
