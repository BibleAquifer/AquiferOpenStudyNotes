...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); pronounce innocent (ID: `keyterm:PronounceInnocent`); The Way (ID: `keyterm:TheWay`); Libano (ID: `place:Lebanon`); strength (ID: `keyterm:Strength`); Zealous (ID: `keyterm:Zealous.3`); Basã (ID: `place:Bashan`); Carmelo (ID: `place:Carmel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); pronounce innocent (ID: `keyterm:PronounceInnocent`); The Way (ID: `keyterm:TheWay`); Libano (ID: `place:Lebanon`); wickedness (ID: `keyterm:Wickedness`); strength (ID: `keyterm:Strength`); Zealous (ID: `keyterm:Zealous.3`); Basã (ID: `place:Bashan`); Carmelo (ID: `place:Carmel`); Fortress (ID: `realia:Fortress`); Strong Drink (ID: `realia:StrongDrink`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** peace (ID: `keyterm:IntactState`); Judá (ID: `person:Judah.4`); make a vow (ID: `keyterm:Vow`); wickedness (ID: `keyterm:Wickedness`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); SENHOR (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Cush (ID: `place:Cush.2`); Líbia (ID: `place:Libya`); lot (ID: `keyterm:Lot`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Pute (ID: `place:Put`); Egito (ID: `place:Egypt`)
