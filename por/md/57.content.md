...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Áfia (ID: `person:Apphia`); Arquipo (ID: `person:Archippus`); Filemom (ID: `person:Philemon`); Timóteo (ID: `person:Timothy`); igreja (ID: `keyterm:Church`); fazer a paz (ID: `keyterm:Peace`); Paulo (ID: `person:Paul`); SENHOR (ID: `deity:Lord`); amado (ID: `keyterm:Beloved`); favor (ID: `keyterm:Favor`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); holy (ID: `keyterm:Holy`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); comunhão (ID: `keyterm:Fellowship`); Cause of Joy (ID: `keyterm:CauseOfJoy`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); compaixão (ID: `keyterm:Affection`); SENHOR (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); Paulo (ID: `person:Paul`); rogar (ID: `keyterm:AskFor`); em cristo (ID: `keyterm:InChrist`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Lucas (ID: `person:Luke`); Demas (ID: `person:Demas`); Epafras (ID: `person:Epaphras`); Aristarco (ID: `person:Aristarchus`); Marcos (ID: `person:Mark`); Spirit (ID: `keyterm:Spirit.2`); em cristo (ID: `keyterm:InChrist`); favor (ID: `keyterm:Favor`)
