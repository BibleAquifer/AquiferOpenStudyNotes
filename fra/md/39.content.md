...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); aimer (ID: `keyterm:Love`); Éternel (ID: `deity:Lord`); Édom (ID: `place:Edom`); Édom (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); craindre (ID: `keyterm:Fear`); Éternel (ID: `deity:Lord`); Priests (ID: `group:GenericPriests`); gloire (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); craindre (ID: `keyterm:Fear`); offrande (ID: `keyterm:Offering`); alliance (ID: `keyterm:Covenant`); état intact (ID: `keyterm:IntactState`); souiller (ID: `keyterm:Stain`); pleurer (ID: `keyterm:Curse`); Priests (ID: `group:GenericPriests`); Lévi (ID: `person:Levi.3`); gloire (ID: `keyterm:Glory`); Lévi (ID: `group:Levi`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); niveau (ID: `keyterm:Fairness`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); agir avec bonté (ID: `keyterm:KindlyDisposed`); An Angel (ID: `deity:Angel`); vérité (ID: `keyterm:Truth`); benir (ID: `keyterm:Bless`); faire un voeu (ID: `keyterm:Vow`); ardeur (ID: `keyterm:Ardour`); sans saleté (ID: `keyterm:Pure`); nation; peuple (ID: `group:Gentile`); chemin (ID: `keyterm:TheWay`); la connaissance (ID: `keyterm:Intention`); profaner, déshonorer (ID: `keyterm:Dishonor`); prier (ID: `keyterm:AskFor`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** souiller (ID: `keyterm:Stain`); Éternel (ID: `deity:Lord`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** craindre (ID: `keyterm:Fear`); Éternel (ID: `deity:Lord`); pleurer (ID: `keyterm:Curse`); faire un voeu (ID: `keyterm:Vow`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Lévi (ID: `person:Levi.3`); Éternel (ID: `deity:Lord`); alliance (ID: `keyterm:Covenant`); Lévi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); offrande (ID: `keyterm:Offering`); profaner, déshonorer (ID: `keyterm:Dishonor`); alliance (ID: `keyterm:Covenant`); aimer (ID: `keyterm:Love`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `person:Judah.4`); délice (ID: `keyterm:Delight`); Juda (ID: `group:Judah`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); aimer (ID: `keyterm:Love`); profaner, déshonorer (ID: `keyterm:Dishonor`); Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); offrande (ID: `keyterm:Offering`); sans saleté (ID: `keyterm:Pure`); craindre (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Lévi (ID: `group:Levi`); jurer (ID: `keyterm:Swear`); Lévi (ID: `person:Levi.3`); A Group of People (ID: `group:GenericGroup`); alliance (ID: `keyterm:Covenant`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** An Angel (ID: `deity:Angel`); Éternel (ID: `deity:Lord`); alliance (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); benir (ID: `keyterm:Bless`); limite (ID: `keyterm:Decree`); pleurer (ID: `keyterm:Curse`); offrande (ID: `keyterm:Offering`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Sorghum (ID: `flora:Sorghum`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); être attiré à servir (ID: `keyterm:EnticedToServe`); craindre (ID: `keyterm:Fear`); Scroll (ID: `realia:Scroll`); Cattle (ID: `fauna:Bull`); Molten Image (ID: `realia:MoltenImage`); Animal Pen (ID: `realia:AnimalPen`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Moïse (ID: `person:Moses`); Instruction (ID: `keyterm:Instruction`); montagne de Sinaï (ID: `place:SinaiMount`); limite (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** objet qui doit être détruit (ID: `keyterm:SomethingDevotedToGod`); Israël (ID: `person:Israel`); craindre (ID: `keyterm:Fear`); Moïse (ID: `person:Moses`); Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); montagne de Sinaï (ID: `place:SinaiMount`); Élie (ID: `person:Elijah`); limite (ID: `keyterm:Decree`)
