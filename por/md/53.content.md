...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Tessalônica (ID: `place:Thessalonica`); Timóteo (ID: `person:Timothy`); favor (ID: `keyterm:Favor`); Thessalonians (ID: `group:Thessalonica`); Paulo (ID: `person:Paul`); Silas (ID: `person:Silas`); fazer a paz (ID: `keyterm:Peace`); igreja (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); dever (ID: `keyterm:Ought`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); be (or show oneself) just (ID: `keyterm:Just`); holy (ID: `keyterm:Holy`); dever (ID: `keyterm:Ought`); An Angel (ID: `deity:Angel`); reino (ID: `keyterm:Kingdom`); ser glorificado (ID: `keyterm:Glorified`); tribunal de justiça (ID: `keyterm:CourtCase`); testemunhar (ID: `keyterm:BearWitness`); boa notícia (ID: `keyterm:GoodNews`); Glory (ID: `keyterm:Glory`); fazer justiça (ID: `keyterm:GrantJustice`); igreja (ID: `keyterm:Church`); para a eternidade (ID: `keyterm:Always`); juízo (ID: `keyterm:Judgment`); céu (ID: `keyterm:Heaven`); love (ID: `keyterm:Love`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** tribunal de justiça (ID: `keyterm:CourtCase`); be (or show oneself) just (ID: `keyterm:Just`); juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`); reino (ID: `keyterm:Kingdom`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ser glorificado (ID: `keyterm:Glorified`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); Name (ID: `keyterm:Name`); favor (ID: `keyterm:Favor`); crer (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); Truth (ID: `keyterm:Truth`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Spirit (ID: `keyterm:Spirit.2`); Satanás (ID: `deity:Satan`); objeto de culto (ID: `keyterm:ObjectOfWorship`); rogar (ID: `keyterm:AskFor`); love (ID: `keyterm:Love`); decidir (ID: `keyterm:Decided`); wipe (out), destroy (ID: `keyterm:Destroy`); example (ID: `keyterm:Example`); injustiça (ID: `keyterm:UnjustDeed`); maravilha (ID: `keyterm:Portent`); Ability (ID: `keyterm:Ability`); salvation (ID: `keyterm:Salvation`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** para a eternidade (ID: `keyterm:Always`); Good (ID: `keyterm:Good`); hope (ID: `keyterm:Hope`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); rogar (ID: `keyterm:AskFor`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** rogar (ID: `keyterm:AskFor`); Good (ID: `keyterm:Good`); coração (ID: `keyterm:Heart`); exortar (ID: `keyterm:Encourage`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); orar (ID: `keyterm:Pray`); Faithfulness (ID: `keyterm:Faithfulness`); persuadir (ID: `keyterm:Persuade`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`); livrar (ID: `keyterm:Deliver`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); rogar (ID: `keyterm:AskFor`); autoridade (ID: `keyterm:Authority.2`); tradição (ID: `keyterm:Teaching`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); Ability (ID: `keyterm:Ability`)
