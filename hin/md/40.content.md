...
* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Blood (ID: `keyterm:Blood`); Be a Disciple (ID: `keyterm:Disciple`); To Sin (ID: `keyterm:Sin`); Kingdom (ID: `keyterm:Kingdom`); यहोवा (ID: `deity:Lord`); Forgive (ID: `keyterm:Forgive`); यीशु (ID: `person:Jesus.2`); Covenant (ID: `keyterm:Covenant`); Bless (ID: `keyterm:Bless`); Vine (ID: `flora:Vine`)
