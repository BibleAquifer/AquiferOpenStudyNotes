...
* **Associated ACAI Concepts:** Petuel (ID: `person:Pethuel`); Joel (ID: `person:Joel.14`)
...
* **Associated ACAI Concepts:** Petuel (ID: `person:Pethuel`); Joel (ID: `person:Joel.14`); Locust (ID: `fauna:Locust`); House (ID: `realia:House`); SENHOR (ID: `deity:Lord`)
## Joel 1.2 (id: 741507)
...
* **Associated ACAI Concepts:** Vale de Sitim (ID: `place:ShittimValley`); Pruning Knife (ID: `realia:PruningKnife`); Sabeans (ID: `group:Sabean`); Greeks (ID: `group:Greek`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Vale de Sitim (ID: `place:ShittimValley`)
## Joel 3.19 (id: 741551)
