...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Tessalônica (ID: `place:Thessalonica`); Silas (ID: `person:Silas`); Thessalonians (ID: `group:Thessalonica`); favor (ID: `keyterm:Favor`); fazer a paz (ID: `keyterm:Peace`); Paulo (ID: `person:Paul`); Timóteo (ID: `person:Timothy`); igreja (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); be (or show oneself) just (ID: `keyterm:Just`); fazer justiça (ID: `keyterm:GrantJustice`); boa notícia (ID: `keyterm:GoodNews`); juízo (ID: `keyterm:Judgment`); testemunhar (ID: `keyterm:BearWitness`); dever (ID: `keyterm:Ought`); igreja (ID: `keyterm:Church`); love (ID: `keyterm:Love`); Ability (ID: `keyterm:Ability`); Glory (ID: `keyterm:Glory`); reino (ID: `keyterm:Kingdom`); céu (ID: `keyterm:Heaven`); holy (ID: `keyterm:Holy`); para a eternidade (ID: `keyterm:Always`); An Angel (ID: `deity:Angel`); tribunal de justiça (ID: `keyterm:CourtCase`); ser glorificado (ID: `keyterm:Glorified`)
...
* **Associated ACAI Concepts:** be (or show oneself) just (ID: `keyterm:Just`); juízo (ID: `keyterm:Judgment`); tribunal de justiça (ID: `keyterm:CourtCase`); reino (ID: `keyterm:Kingdom`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); crer (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`); Ability (ID: `keyterm:Ability`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); Name (ID: `keyterm:Name`); crer (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); Good (ID: `keyterm:Good`); ser glorificado (ID: `keyterm:Glorified`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); ser glorificado (ID: `keyterm:Glorified`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); Truth (ID: `keyterm:Truth`); SENHOR (ID: `deity:Lord`); Spirit (ID: `keyterm:Spirit.2`); objeto de culto (ID: `keyterm:ObjectOfWorship`); maravilha (ID: `keyterm:Portent`); Satanás (ID: `deity:Satan`); example (ID: `keyterm:Example`); love (ID: `keyterm:Love`); decidir (ID: `keyterm:Decided`); injustiça (ID: `keyterm:UnjustDeed`); wipe (out), destroy (ID: `keyterm:Destroy`); Ability (ID: `keyterm:Ability`); rogar (ID: `keyterm:AskFor`); salvation (ID: `keyterm:Salvation`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** favor (ID: `keyterm:Favor`); love (ID: `keyterm:Love`); para a eternidade (ID: `keyterm:Always`); Jesus (ID: `person:Jesus.2`); Good (ID: `keyterm:Good`); rogar (ID: `keyterm:AskFor`); hope (ID: `keyterm:Hope`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); persuadir (ID: `keyterm:Persuade`); orar (ID: `keyterm:Pray`); crer (ID: `keyterm:Believe`); livrar (ID: `keyterm:Deliver`); love (ID: `keyterm:Love`); Faithfulness (ID: `keyterm:Faithfulness`); Glory (ID: `keyterm:Glory`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); tradição (ID: `keyterm:Teaching`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); Ability (ID: `keyterm:Ability`); rogar (ID: `keyterm:AskFor`); autoridade (ID: `keyterm:Authority.2`)
