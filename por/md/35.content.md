...
* **Associated ACAI Concepts:** Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Casting Net (ID: `realia:CastingNet`); pure (ID: `keyterm:Pure`); SENHOR (ID: `deity:Lord`); holy (ID: `keyterm:Holy`); Fortification (ID: `realia:Fortification`); Harpoon (ID: `realia:Harpoon`); Fish (ID: `fauna:Fish`); Monitor (ID: `fauna:Iguana`); Chameleon (ID: `fauna:Chameleon`); Lizard (ID: `fauna:Lizard`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); literally: nought (ID: `keyterm:Idol`); lean on (ID: `keyterm:LeanOn`); Libano (ID: `place:Lebanon`); Be Disgraced (ID: `keyterm:Disgraced`); saying (ID: `keyterm:Saying`); Beam (ID: `realia:Beam`); Graven Image (ID: `realia:GravenImage`); Image (ID: `realia:Image`); Molten Image (ID: `realia:MoltenImage`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** literally: nought (ID: `keyterm:Idol`); Woe (ID: `keyterm:Woe.2`); SENHOR (ID: `deity:Lord`); lean on (ID: `keyterm:LeanOn`); Graven Image (ID: `realia:GravenImage`); Image (ID: `realia:Image`); Money (ID: `realia:Money`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); SENHOR (ID: `deity:Lord`); arrow (ID: `keyterm:Arrow`); anointed (ID: `keyterm:Anointed`); Oath (ID: `keyterm:Oath`); Bow (ID: `realia:Bow`); Foundation (ID: `realia:Foundation`); Chariot (ID: `realia:Chariot`); Spear (ID: `realia:Spear`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); salvation (ID: `keyterm:Salvation`); Animal Pen (ID: `realia:AnimalPen`); Vine (ID: `flora:Vine`); Flock (ID: `fauna:Flock`); Sheepfold (ID: `realia:Sheepfold`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); Fig (ID: `flora:Fig`); Olive Tree (ID: `flora:OliveTree`)
