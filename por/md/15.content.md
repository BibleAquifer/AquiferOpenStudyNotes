...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`); Jeremias (ID: `person:Jeremiah.6`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `group:Benjamin`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); SENHOR (ID: `deity:Lord`); Benjamim (ID: `person:Benjamin`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Nabucodonozor (ID: `person:Nebuchadnezzar`); SENHOR (ID: `deity:Lord`); Ciro (ID: `person:Cyrus`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Pérsia (ID: `place:Persia`); Judá (ID: `group:Judah`); Zorobabel (ID: `person:Zerubbabel.2`); Ciro (ID: `person:Cyrus`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `group:Levi`); Salomão (ID: `person:Solomon`); Levi (ID: `person:Levi.3`); Besai (ID: `person:Besai`); Lebana (ID: `person:Lebanah`); Nesias (ID: `person:Neziah`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Temá (ID: `person:Temah`); Bigvai (ID: `person:Bigvai.2`); Asná (ID: `person:Asnah`); Tel-Melá (ID: `place:Tel-melah`); Reelaías (ID: `person:Reelaiah`); Darcom (ID: `person:Darkon`); Bani (ID: `person:Bani`); Hasufa (ID: `person:Hasupha`); Gazão (ID: `person:Gazzam`); Tabaote (ID: `person:Tabbaoth`); Asgade (ID: `person:Azgad`); Harsa (ID: `person:Harsha`); Ará (ID: `person:Arah.2`); Ater (ID: `person:Ater`); Tel-Harsa (ID: `place:Tel-harsha`); Gidel (ID: `person:Giddel`); Hacufa (ID: `person:Hakupha`); Magbis (ID: `place:Magbish`); Parós (ID: `person:Parosh`); Nephushesim (ID: `group:Nephushesim`)
...
* **Associated ACAI Concepts:** Bilsã (ID: `person:Bilshan`); Mordecai (ID: `person:Mordecai`); Bigvai (ID: `person:Bigvai`); Seraias (ID: `person:Seraiah.6`); Baana (ID: `person:Baanah.3`); Reelaías (ID: `person:Reelaiah`); Mispar (ID: `person:Mispar`); Neemias (ID: `person:Nehemiah`); Reum (ID: `person:Rehum`); Zorobabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`); Josué (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** Parós (ID: `person:Parosh`); Zatu (ID: `person:Zattu.2`); Joabe (ID: `person:Joab.3`); Jora (ID: `person:Jorah`); Adim (ID: `person:Adin`); Bebai (ID: `person:Bebai`); Bigvai (ID: `person:Bigvai.2`); Bezai (ID: `person:Bezai`); Bani (ID: `person:Bani`); Hasum (ID: `person:Hashum`); Adonicão (ID: `person:Adonikam`); Sephatias (ID: `person:Shephatiah.6`); Asgade (ID: `person:Azgad`); Elam (ID: `person:Elam`); Paate-Moabe (ID: `person:Pahath-moab`); Zacai (ID: `person:Zaccai.2`); Jesua (ID: `person:Jeshua.3`); Ezequias (ID: `person:Hezekiah.2`); Ará (ID: `person:Arah.2`); Ater (ID: `person:Ater`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Magbis (ID: `place:Magbish`); Hadide (ID: `place:Hadid`); Senaa (ID: `place:Senaah`); Netofa (ID: `place:Netophah`); Harim (ID: `person:Harim.2`); Nebo (ID: `place:Nebo.2`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Beerote (ID: `place:Beeroth`); Ono (ID: `place:Ono`); Lode (ID: `place:Lod`); Jericó (ID: `place:Jericho`); Ai (ID: `place:Ai`); Geba (ID: `place:Geba`); Belém (ID: `place:Bethlehem`); Ramah (ID: `place:Ramah.2`); Quiriate-Jearim (ID: `place:Kiriath-jearim`); Anatote (ID: `place:Anathoth`); Cefira (ID: `place:Chephirah`); Elam (ID: `person:Elam`); Betel (ID: `place:Bethel`); Micmás (ID: `place:Michmash`)
...
* **Associated ACAI Concepts:** Imer (ID: `person:Immer.2`); Hodavias (ID: `person:Hodaviah.4`); Jesua (ID: `person:Jeshua`); Talmom (ID: `person:Talmon`); Jedaías (ID: `person:Jedaiah.4`); Ater (ID: `person:Ater.2`); Jesua (ID: `person:Jeshua.4`); Harim (ID: `person:Harim`); Sobai (ID: `person:Shobai`); Hatita (ID: `person:Hatita`); Levi (ID: `person:Levi.3`); Salum (ID: `person:Shallum.8`); Levi (ID: `group:Levi`); Pasur (ID: `person:Pashhur`); Acube (ID: `person:Akkub.2`); Cadmiel (ID: `person:Kadmiel`); Asafe (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** Talmom (ID: `person:Talmon`); Ater (ID: `person:Ater.2`); Sobai (ID: `person:Shobai`); Hatita (ID: `person:Hatita`); Salum (ID: `person:Shallum.8`); Acube (ID: `person:Akkub.2`); Asafe (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** Hacufa (ID: `person:Hakupha`); Gidel (ID: `person:Giddel`); Paseia (ID: `person:Paseah.2`); Meunim (ID: `group:Meunim`); Besai (ID: `person:Besai`); Lebana (ID: `person:Lebanah`); Nephushesim (ID: `group:Nephushesim`); Necoda (ID: `person:Nekoda`); Nesias (ID: `person:Neziah`); Acube (ID: `person:Akkub.3`); Hagabe (ID: `person:Hagab`); Salmai (ID: `person:Shalmai`); Baquebuque (ID: `person:Bakbuk`); Bazlite (ID: `person:Bazluth`); Sisera (ID: `person:Sisera.2`); Barcos (ID: `person:Barkos`); Rezim (ID: `person:Rezin.2`); Hanã (ID: `person:Hanan.4`); Temá (ID: `person:Temah`); Padom (ID: `person:Padon`); Asná (ID: `person:Asnah`); Zia (ID: `person:Ziha`); Harur (ID: `person:Harhur`); Sia (ID: `person:Siaha`); Hatifa (ID: `person:Hatipha`); Uza (ID: `person:Uzza.2`); Hasufa (ID: `person:Hasupha`); Reaías (ID: `person:Reaiah.3`); Queros (ID: `person:Keros`); Gazão (ID: `person:Gazzam`); Tabaote (ID: `person:Tabbaoth`); Meída (ID: `person:Mehida`); Hagaba (ID: `person:Hagabah`); Harsa (ID: `person:Harsha`); Gaar (ID: `person:Gahar`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Gidel (ID: `person:Giddel.2`); Ami (ID: `person:Ami`); Soferete (ID: `person:Sophereth`); Peruda (ID: `person:Peruda`); Sotai (ID: `person:Sotai`); Sephatias (ID: `person:Shephatiah.7`); Darcom (ID: `person:Darkon`); Hatil (ID: `person:Hattil`); Jaala (ID: `person:Jaalah`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`)
...
* **Associated ACAI Concepts:** Tel-Harsa (ID: `place:Tel-harsha`); Necoda (ID: `person:Nekoda.2`); Imer (ID: `place:Immer`); Tel-Melá (ID: `place:Tel-melah`); Querube (ID: `place:Cherub`); Delaías (ID: `person:Delaiah.3`); Adã (ID: `place:Addan`); Tobias (ID: `person:Tobiah`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Habaiah (ID: `person:Habaiah`); Barzillai (ID: `person:Barzillai.3`); Hacoz (ID: `person:Hakkoz.2`); Gileade (ID: `place:Gilead`); Gileadites (ID: `group:Gilead`); Barzillai (ID: `person:Barzillai`); priesthood (ID: `keyterm:Priesthood`); stain (ID: `keyterm:Stain`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); strength (ID: `keyterm:Strength`); House (ID: `realia:House`); Tunic (ID: `realia:Tunic`); Money (ID: `realia:Money`); Mina (ID: `realia:Mina`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Josué (ID: `person:Joshua.5`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Jesua (ID: `person:Jeshua.4`); Esar-Hadom (ID: `person:Esarhaddon`); Henadade (ID: `person:Henadad`); Cadmiel (ID: `person:Kadmiel`); Relatives (ID: `group:Relatives`); Hodavias (ID: `person:Hodaviah.4`); Tyrians (ID: `group:Tyre`); Instruction (ID: `keyterm:Instruction`); Hodias (ID: `person:Hodiah.2`); terror (ID: `keyterm:Terror`); Dario (ID: `person:Darius.2`); Tiro (ID: `place:Tyre`); holy (ID: `keyterm:Holy`); Sidom (ID: `place:Sidon`); kindness (ID: `keyterm:Kindness`); Moisés (ID: `person:Moses`); Davi (ID: `person:David`); new moon festival (ID: `keyterm:NewMoonFestival`); Sidonians (ID: `group:Sidon`); Benjamim (ID: `group:Benjamin`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); Assyria (ID: `place:Assyria`); counsel (ID: `keyterm:Counsel`); appointed feast (ID: `keyterm:AppointedFeast`); Jope (ID: `place:Joppa`); Benjamim (ID: `person:Benjamin`); Libano (ID: `place:Lebanon`); Asafe (ID: `person:Asaph.2`); Cedar (ID: `flora:Cedar`); Cymbals (ID: `realia:Cymbals`); Craftsman (ID: `realia:Craftsman`); Anointing Oil (ID: `realia:AnointingOil`); Trumpet (ID: `realia:Trumpet`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Sealtiel (ID: `person:Shealtiel.2`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Instruction (ID: `keyterm:Instruction`); Moisés (ID: `person:Moses`); offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); terror (ID: `keyterm:Terror`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Pérsia (ID: `place:Persia`); Tyrians (ID: `group:Tyre`); Sidom (ID: `place:Sidon`); Jope (ID: `place:Joppa`); Ciro (ID: `person:Cyrus`); Libano (ID: `place:Lebanon`); Sidonians (ID: `group:Sidon`); Tiro (ID: `place:Tyre`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Jerusalém (ID: `place:Jerusalem`); Josué (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Levi (ID: `person:Levi.3`); kindness (ID: `keyterm:Kindness`); Levi (ID: `group:Levi`); Davi (ID: `person:David`); Asafe (ID: `person:Asaph.2`); House (ID: `realia:House`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `group:Benjamin`); SENHOR (ID: `deity:Lord`); Benjamim (ID: `person:Benjamin`); Judá (ID: `group:Judah`); Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Pérsia (ID: `place:Persia`); SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Ciro (ID: `person:Cyrus`); Israel (ID: `person:Israel`); Josué (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Pérsia (ID: `place:Persia`); Samaria (ID: `place:Samaria`); Osnapar (ID: `person:Osnappar`); Dinaítas (ID: `person:Dinaite`); Mitredate (ID: `person:Mithredath.2`); Babylonians (ID: `group:Babylon`); Ereque (ID: `place:Erech`); Assuero (ID: `person:Ahasuerus`); Tabeel (ID: `person:Tabeel`); Bislão (ID: `person:Bishlam`); Judá (ID: `person:Judah.4`); Elam (ID: `place:Elam`); Judá (ID: `group:Judah`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); Susã (ID: `place:Susa`); Babilônia (ID: `place:Babylon`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Ereque (ID: `place:Erech`); Reum (ID: `person:Rehum.2`); Dinaítas (ID: `person:Dinaite`); Sinsai (ID: `person:Shimshai`); Babylonians (ID: `group:Babylon`); Pérsia (ID: `place:Persia`); Persians (ID: `group:Persia`); Susã (ID: `place:Susa`); Elamites (ID: `group:Elam`); Babilônia (ID: `place:Babylon`); Elam (ID: `place:Elam`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Samaria (ID: `place:Samaria`); Reum (ID: `person:Rehum.2`); Jews (ID: `group:Jews`); Sinsai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); Dario (ID: `person:Darius.2`); Tattenai (ID: `person:Tattenai`); Ageu (ID: `person:Haggai`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Zacarias (ID: `person:Zechariah.17`); Ido (ID: `person:Iddo.6`); Pérsia (ID: `place:Persia`); Rio Eufrates (ID: `place:Euphrates`); Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); Josué (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** Ageu (ID: `person:Haggai`); Ido (ID: `person:Iddo.6`); Zacarias (ID: `person:Zechariah.17`); Jews (ID: `group:Jews`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); Jerusalém (ID: `place:Jerusalem`); Sealtiel (ID: `person:Shealtiel.2`); Josué (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Jerusalém (ID: `place:Jerusalem`); Babilônia (ID: `place:Babylon`); Ciro (ID: `person:Cyrus`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Dario (ID: `person:Darius.2`); Zorobabel (ID: `person:Zerubbabel.2`); Tattenai (ID: `person:Tattenai`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Rio Eufrates (ID: `place:Euphrates`); Chaldeans (ID: `group:Chaldea`); Caldéia (ID: `place:Chaldea`); Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); Money (ID: `realia:Money`); Foundation (ID: `realia:Foundation`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Jerusalém (ID: `place:Jerusalem`); Foundation (ID: `realia:Foundation`); House (ID: `realia:House`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Azarias (ID: `person:Azariah.7`); Seraias (ID: `person:Seraiah.2`); Ezra (ID: `person:Ezra`); Hilquias (ID: `person:Hilkiah.2`); Pérsia (ID: `place:Persia`); Artaxerxes (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Zeraías (ID: `person:Zerahiah`); Zadoque (ID: `person:Zadok.4`); Azarias (ID: `person:Azariah.7`); Amarias (ID: `person:Amariah.2`); Meraiote (ID: `person:Meraioth`); Buqui (ID: `person:Bukki.2`); Aitube (ID: `person:Ahitub.3`); Abisua (ID: `person:Abishua`); Salum (ID: `person:Shallum.7`); Seraias (ID: `person:Seraiah.2`); Uzi (ID: `person:Uzzi`); Azarias (ID: `person:Azariah.6`); Hilquias (ID: `person:Hilkiah.2`); Fineias (ID: `person:Phinehas`); Arão (ID: `person:Aaron`); Eleazar (ID: `person:Eleazar.2`); Pérsia (ID: `place:Persia`); Artaxerxes (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Instruction (ID: `keyterm:Instruction`); Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Babilônia (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** decree (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`); SENHOR (ID: `deity:Lord`); Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Artaxerxes (ID: `person:Artaxerxes`); Ezra (ID: `person:Ezra`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`); Wheat (ID: `flora:Wheat`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Kor (ID: `realia:Kor`)
...
* **Associated ACAI Concepts:** Jaaziel (ID: `person:Jahaziel.5`); Zeraías (ID: `person:Zerahiah.2`); Hacatã (ID: `person:Hakkatan`); Jônatas (ID: `person:Jonathan.9`); Elifelete (ID: `person:Eliphelet.5`); Jeuel (ID: `person:Jeuel.3`); Obadias (ID: `person:Obadiah.10`); Parós (ID: `person:Parosh.2`); Bebai (ID: `person:Bebai.2`); Atalia (ID: `person:Athaliah.3`); Elioenai (ID: `person:Eliehoenai.2`); Ebede (ID: `person:Ebed.2`); Adim (ID: `person:Adin`); Zacarias (ID: `person:Zechariah.18`); Hatus (ID: `person:Hattush.2`); Gérson (ID: `person:Gershom.2`); Jeiel (ID: `person:Jehiel.7`); Bebai (ID: `person:Bebai`); Bigvai (ID: `person:Bigvai.2`); Josifias (ID: `person:Josiphiah`); Zacur (ID: `person:Zaccur.5`); Joanã (ID: `person:Johanan.8`); Jesaías (ID: `person:Jeshaiah.4`); Secanias (ID: `person:Shecaniah.5`); Joabe (ID: `person:Joab.4`); Daniel (ID: `person:Daniel.2`); Adonicão (ID: `person:Adonikam`); Utai (ID: `person:Uthai.2`); Semaías (ID: `person:Shemaiah.14`); Selomite (ID: `person:Shelomith.4`); Asgade (ID: `person:Azgad`); Elam (ID: `person:Elam`); Sephatias (ID: `person:Shephatiah.6`); Miguel (ID: `person:Michael.10`); Zacarias (ID: `person:Zechariah.19`); Paate-Moabe (ID: `person:Pahath-moab`); Secanias (ID: `person:Shecaniah.6`); Zabadias (ID: `person:Zebadiah.8`); Fineias (ID: `person:Phinehas`); Itamar (ID: `person:Ithamar`); Davi (ID: `person:David`); Artaxerxes (ID: `person:Artaxerxes`); Babilônia (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** Ariel (ID: `person:Ariel`); Eliezer (ID: `person:Eliezer.8`); Zacarias (ID: `person:Zechariah.20`); Jaribe (ID: `person:Jarib.2`); Elnatã (ID: `person:Elnathan.2`); Mesulão (ID: `person:Meshullam.9`); Elnatã (ID: `person:Elnathan.4`); Ido (ID: `person:Iddo`); Natã (ID: `person:Nathan.5`); Casifia (ID: `place:Casiphia`); Semaías (ID: `person:Shemaiah.15`); Elnatã (ID: `person:Elnathan.3`); Joiaribe (ID: `person:Joiarib.2`); perceive (ID: `keyterm:Perceive`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Mali (ID: `person:Mahli`); Insight (ID: `keyterm:Insight`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Davi (ID: `person:David`); work (ID: `keyterm:Work`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); Egito (ID: `place:Egypt`); Levi (ID: `person:Levi.3`); cananeu (ID: `group:Canaan`); Amom (ID: `place:Ammon`); Levi (ID: `group:Levi`); be unfaithful (ID: `keyterm:Unfaithful`); Moabe (ID: `place:Moab`); Israel (ID: `person:Israel`); Canaã (ID: `place:Canaan`); Amorites (ID: `group:Amorites`); Egyptians (ID: `group:Egypt`); Ammonites (ID: `group:Ammon`); Jebusites (ID: `group:Jebusites`); Hete (ID: `person:Heth`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); House (ID: `realia:House`); Harim (ID: `person:Harim`); offering (ID: `keyterm:Offering`); Judá (ID: `person:Judah.4`); counsel (ID: `keyterm:Counsel`); Judá (ID: `group:Judah`); Elam (ID: `person:Elam`); Elifelete (ID: `person:Eliphelet.6`); Issias (ID: `person:Isshijah`); Quelal (ID: `person:Chelal`); Binui (ID: `person:Binnui.4`); Semaías (ID: `person:Shemaiah.16`); Natanael (ID: `person:Nethanel.8`); Semaías (ID: `person:Shemaiah.17`); Simeão (ID: `person:Shimeon`); Selemias (ID: `person:Shelemiah.3`); Jeremote (ID: `person:Jeremoth.4`); Zabade (ID: `person:Zabad.5`); Joanã (ID: `person:Jehohanan.4`); Petaías (ID: `person:Pethahiah.2`); Miamim (ID: `person:Mijamin.2`); Maaséias (ID: `person:Maaseiah.8`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); Pérsia (ID: `place:Persia`); defilement (ID: `keyterm:Defilement`); supplication (ID: `keyterm:Supplication`); kindness (ID: `keyterm:Kindness`); dispossess (ID: `keyterm:Dispossess`); peace (ID: `keyterm:IntactState`); to cause to possess (ID: `keyterm:Possess`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); Pérsia (ID: `place:Persia`); kindness (ID: `keyterm:Kindness`); supplication (ID: `keyterm:Supplication`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** arrepender, se (ID: `keyterm:Repent`); SENHOR (ID: `deity:Lord`); Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jeiel (ID: `person:Jehiel.8`); Secanias (ID: `person:Shecaniah.7`); Elam (ID: `person:Elam`); SENHOR (ID: `deity:Lord`); Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); be unfaithful (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** swear (ID: `keyterm:Swear`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `group:Benjamin`); SENHOR (ID: `deity:Lord`); Benjamim (ID: `person:Benjamin`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ticva (ID: `person:Tikvah.2`); Sabetai (ID: `person:Shabbethai`); Jônatas (ID: `person:Jonathan.10`); Asael (ID: `person:Asahel.4`); Mesulão (ID: `person:Meshullam.10`); Jazeías (ID: `person:Jahzeiah`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`)
