...
* **Associated ACAI Concepts:** Monte de Esaú (ID: `place:EsauMount`); Edom (ID: `place:Edom`); SENHOR (ID: `deity:Lord`); Understanding (ID: `keyterm:Understanding`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); lot (ID: `keyterm:Lot`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); José (ID: `person:Joseph.10`); Edom (ID: `place:Edom`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Filístia (ID: `place:Philistine`); Filisteu (ID: `group:Philistine`); Benjamim (ID: `person:Benjamin`); Sarepta (ID: `place:Zarephath`); Samaria (ID: `place:Samaria`); Sardes (ID: `place:Sardis`); cananeu (ID: `group:Canaan`); Efraim (ID: `group:Ephraim`); Monte de Esaú (ID: `place:EsauMount`); Gileade (ID: `place:Gilead`); Sefalá (ID: `place:Shephelah`); Canaã (ID: `place:Canaan`); Israel (ID: `person:Israel`); Benjamim (ID: `group:Benjamin`); Jerusalém (ID: `place:Jerusalem`); Efraim (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** Monte de Esaú (ID: `place:EsauMount`); Neguebe (ID: `place:Negeb`); Jerusalém (ID: `place:Jerusalem`); dispossess (ID: `keyterm:Dispossess`); Filístia (ID: `place:Philistine`); Sardes (ID: `place:Sardis`); Gileade (ID: `place:Gilead`); Sefalá (ID: `place:Shephelah`); Sarepta (ID: `place:Zarephath`); Efraim (ID: `group:Ephraim`); Israel (ID: `person:Israel`); Efraim (ID: `person:Ephraim`); cananeu (ID: `group:Canaan`); Canaã (ID: `place:Canaan`); Filisteu (ID: `group:Philistine`); Benjamim (ID: `person:Benjamin`); Samaria (ID: `place:Samaria`); Benjamim (ID: `group:Benjamin`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); Sarepta (ID: `place:Zarephath`); dispossess (ID: `keyterm:Dispossess`); Sardes (ID: `place:Sardis`); Canaã (ID: `place:Canaan`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); cananeu (ID: `group:Canaan`)
