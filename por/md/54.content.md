...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); salvador (ID: `keyterm:Savior`); hope (ID: `keyterm:Hope`); Paulo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Timóteo (ID: `person:Timothy`); Paulo (ID: `person:Paul`); misericórdia (ID: `keyterm:Mercy`); crer (ID: `keyterm:Believe`); salvador (ID: `keyterm:Savior`); favor (ID: `keyterm:Favor`); hope (ID: `keyterm:Hope`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** Timóteo (ID: `person:Timothy`); SENHOR (ID: `deity:Lord`); misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); favor (ID: `keyterm:Favor`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); lei (ID: `keyterm:Law`); sem lei (ID: `keyterm:Lawless`); opposite of holy: profane (ID: `keyterm:Profane`); Macedônia (ID: `place:Macedonia`); corretamente (ID: `keyterm:Lawfully`); Glory (ID: `keyterm:Glory`); palavreado vazio (ID: `keyterm:EmptyTalk`); coração (ID: `keyterm:Heart`); Good (ID: `keyterm:Good`); be (or show oneself) just (ID: `keyterm:Just`); limpo (ID: `keyterm:Clean`); consciência (ID: `keyterm:Conscience`); sem hipocrisia (ID: `keyterm:Unhypocritical`); boa notícia (ID: `keyterm:GoodNews`); bem, aventurado (ID: `keyterm:Happy`); Éfeso (ID: `place:Ephesus`); love (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** limpo (ID: `keyterm:Clean`); consciência (ID: `keyterm:Conscience`); coração (ID: `keyterm:Heart`); crer (ID: `keyterm:Believe`); Good (ID: `keyterm:Good`); sem hipocrisia (ID: `keyterm:Unhypocritical`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); sem lei (ID: `keyterm:Lawless`); opposite of holy: profane (ID: `keyterm:Profane`); bem, aventurado (ID: `keyterm:Happy`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); corretamente (ID: `keyterm:Lawfully`); Glory (ID: `keyterm:Glory`); palavreado vazio (ID: `keyterm:EmptyTalk`); be (or show oneself) just (ID: `keyterm:Just`); boa notícia (ID: `keyterm:GoodNews`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Faithfulness (ID: `keyterm:Faithfulness`); Ability (ID: `keyterm:Ability`); misericórdia (ID: `keyterm:Mercy`); para a eternidade (ID: `keyterm:Always`); crer (ID: `keyterm:Believe`); favor (ID: `keyterm:Favor`); imortal (ID: `keyterm:Imperishable`); Life (ID: `keyterm:Life`); SENHOR (ID: `deity:Lord`); surely! (ID: `keyterm:Surely`); não crer (ID: `keyterm:Disbelieve`); em cristo (ID: `keyterm:InChrist`); love (ID: `keyterm:Love`); blasfemo (ID: `keyterm:Blasphemous`); Glory (ID: `keyterm:Glory`); servir (ID: `keyterm:Serve`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** consciência (ID: `keyterm:Conscience`); Himeneu (ID: `person:Hymenaeus`); Alexandre (ID: `person:Alexander.4`); Timóteo (ID: `person:Timothy`); Satanás (ID: `deity:Satan`); crer (ID: `keyterm:Believe`); Good (ID: `keyterm:Good`); blasfemar (ID: `keyterm:Blaspheme`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); Daily Life (ID: `keyterm:DailyLife`); resgate (ID: `keyterm:Ransom`); Life (ID: `keyterm:Life`); Gentiles (ID: `group:Gentile`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); tranquilo (ID: `keyterm:Tranquil`); salvador (ID: `keyterm:Savior`); rogar (ID: `keyterm:AskFor`); orar (ID: `keyterm:Pray`); salvation (ID: `keyterm:Salvation`); testemunhar (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Adão (ID: `person:Adam`); orar (ID: `keyterm:Pray`); Truth (ID: `keyterm:Truth`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); Daily Life (ID: `keyterm:DailyLife`); Jesus (ID: `person:Jesus.2`); salvador (ID: `keyterm:Savior`); holy (ID: `keyterm:Holy`); piedade (ID: `keyterm:GodlyReverence`); Good (ID: `keyterm:Good`); resgate (ID: `keyterm:Ransom`); autoridade (ID: `keyterm:Authority.2`); Life (ID: `keyterm:Life`); Eva (ID: `person:Eve`); consecration (ID: `keyterm:Consecration.2`); promessa (ID: `keyterm:Promise`); Gentiles (ID: `group:Gentile`); tranquilo (ID: `keyterm:Tranquil`); love (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`); testemunhar (ID: `keyterm:BearWitness`); Gold Jewelry (ID: `realia:GoldJewelry`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Adão (ID: `person:Adam`); Truth (ID: `keyterm:Truth`); orar (ID: `keyterm:Pray`); servir (ID: `keyterm:Serve`); Faithfulness (ID: `keyterm:Faithfulness`); salvation (ID: `keyterm:Salvation`); testemunhar (ID: `keyterm:BearWitness`); compreensivo (ID: `keyterm:Gentle`); irrepreensível (ID: `keyterm:WithoutReproach`); Daily Life (ID: `keyterm:DailyLife`); juízo (ID: `keyterm:Judgment`); salvador (ID: `keyterm:Savior`); que não ama o dinheiro (ID: `keyterm:NotALoverOfMoney`); holy (ID: `keyterm:Holy`); piedade (ID: `keyterm:GodlyReverence`); Good (ID: `keyterm:Good`); resgate (ID: `keyterm:Ransom`); limpo (ID: `keyterm:Clean`); consciência (ID: `keyterm:Conscience`); ofício (ID: `keyterm:PositionOfResponsibility`); Life (ID: `keyterm:Life`); autoridade (ID: `keyterm:Authority.2`); irrepreensível (ID: `keyterm:BeyondReproach`); Eva (ID: `person:Eve`); em cristo (ID: `keyterm:InChrist`); consecration (ID: `keyterm:Consecration.2`); discernir (ID: `keyterm:Interpret`); promessa (ID: `keyterm:Promise`); Gentiles (ID: `group:Gentile`); igreja (ID: `keyterm:Church`); rogar (ID: `keyterm:AskFor`); tranquilo (ID: `keyterm:Tranquil`); love (ID: `keyterm:Love`); (literalmente (ID: `keyterm:DoubleTongued`); Gold Jewelry (ID: `realia:GoldJewelry`); Clothing (ID: `realia:Clothing`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Adão (ID: `person:Adam`); autoridade (ID: `keyterm:Authority.2`); crer (ID: `keyterm:Believe`); Eva (ID: `person:Eve`); love (ID: `keyterm:Love`); consecration (ID: `keyterm:Consecration.2`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** servir (ID: `keyterm:Serve`); Faithfulness (ID: `keyterm:Faithfulness`); crer (ID: `keyterm:Believe`); compreensivo (ID: `keyterm:Gentle`); irrepreensível (ID: `keyterm:WithoutReproach`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); juízo (ID: `keyterm:Judgment`); que não ama o dinheiro (ID: `keyterm:NotALoverOfMoney`); limpo (ID: `keyterm:Clean`); consciência (ID: `keyterm:Conscience`); ofício (ID: `keyterm:PositionOfResponsibility`); irrepreensível (ID: `keyterm:BeyondReproach`); em cristo (ID: `keyterm:InChrist`); discernir (ID: `keyterm:Interpret`); igreja (ID: `keyterm:Church`); (literalmente (ID: `keyterm:DoubleTongued`); testemunhar (ID: `keyterm:BearWitness`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); servir (ID: `keyterm:Serve`); irrepreensível (ID: `keyterm:WithoutReproach`); Faithfulness (ID: `keyterm:Faithfulness`); limpo (ID: `keyterm:Clean`); consciência (ID: `keyterm:Conscience`); Jesus (ID: `person:Jesus.2`); em cristo (ID: `keyterm:InChrist`); (literalmente (ID: `keyterm:DoubleTongued`); discernir (ID: `keyterm:Interpret`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Faithfulness (ID: `keyterm:Faithfulness`); crer (ID: `keyterm:Believe`); Life (ID: `keyterm:Life`); Truth (ID: `keyterm:Truth`); Holy Spirit (ID: `deity:HolySpirit`); hope (ID: `keyterm:Hope`); conduta (ID: `keyterm:Behavior`); corpo (ID: `keyterm:Body.3`); Jesus (ID: `person:Jesus.2`); Glory (ID: `keyterm:Glory`); An Angel (ID: `deity:Angel`); salvador (ID: `keyterm:Savior`); intercessão (ID: `keyterm:Intercession`); be (or show oneself) just (ID: `keyterm:Just`); consciência (ID: `keyterm:Conscience`); opposite of holy: profane (ID: `keyterm:Profane`); consecration (ID: `keyterm:Consecration.2`); proclamar (ID: `keyterm:Proclaim`); promessa (ID: `keyterm:Promise`); Ability (ID: `keyterm:Ability`); pureza (ID: `keyterm:WithoutMoralDefect`); Spirit (ID: `keyterm:Spirit.2`); igreja (ID: `keyterm:Church`); love (ID: `keyterm:Love`); Demons (ID: `deity:Demons`); favor (ID: `keyterm:Favor`); rogar (ID: `keyterm:AskFor`); salvation (ID: `keyterm:Salvation`); hipocrisia (ID: `keyterm:Hypocrisy`); Capital (ID: `realia:Capital`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); corpo (ID: `keyterm:Body.3`); Spirit (ID: `keyterm:Spirit.2`); crer (ID: `keyterm:Believe`); Glory (ID: `keyterm:Glory`); An Angel (ID: `deity:Angel`); be (or show oneself) just (ID: `keyterm:Just`); Holy Spirit (ID: `deity:HolySpirit`); proclamar (ID: `keyterm:Proclaim`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Faithfulness (ID: `keyterm:Faithfulness`); intercessão (ID: `keyterm:Intercession`); consciência (ID: `keyterm:Conscience`); crer (ID: `keyterm:Believe`); Demons (ID: `deity:Demons`); consecration (ID: `keyterm:Consecration.2`); Holy Spirit (ID: `deity:HolySpirit`); Truth (ID: `keyterm:Truth`); hipocrisia (ID: `keyterm:Hypocrisy`)
...
* **Associated ACAI Concepts:** Faithfulness (ID: `keyterm:Faithfulness`); Life (ID: `keyterm:Life`); crer (ID: `keyterm:Believe`); promessa (ID: `keyterm:Promise`); opposite of holy: profane (ID: `keyterm:Profane`); SENHOR (ID: `deity:Lord`); pureza (ID: `keyterm:WithoutMoralDefect`); Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); favor (ID: `keyterm:Favor`); rogar (ID: `keyterm:AskFor`); hope (ID: `keyterm:Hope`); salvador (ID: `keyterm:Savior`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Jesus (ID: `person:Jesus.2`); juízo (ID: `keyterm:Judgment`); Faithfulness (ID: `keyterm:Faithfulness`); crer (ID: `keyterm:Believe`); rogar (ID: `keyterm:AskFor`); inútil (ID: `keyterm:Idle`); escritura (ID: `keyterm:Scripture`); An Angel (ID: `deity:Angel`); orar (ID: `keyterm:Pray`); holy (ID: `keyterm:Holy`); Satanás (ID: `deity:Satan`); tribunal de justiça (ID: `keyterm:CourtCase`); Good (ID: `keyterm:Good`); fear (ID: `keyterm:Fear`); blasfemar (ID: `keyterm:Blaspheme`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); Life (ID: `keyterm:Life`); preconceito (ID: `keyterm:Discrimination`); irrepreensível (ID: `keyterm:BeyondReproach`); Name (ID: `keyterm:Name`); compartilhar (ID: `keyterm:Share`); servir como escravo (ID: `keyterm:Serve.2`); escolhido (ID: `keyterm:Chosen`); pureza (ID: `keyterm:WithoutMoralDefect`); igreja (ID: `keyterm:Church`); amado (ID: `keyterm:Beloved`); pure (ID: `keyterm:Pure`); be unfaithful (ID: `keyterm:Unfaithful`); testemunhar solenemente (ID: `keyterm:Declare`); witness (ID: `keyterm:Witness`); hope (ID: `keyterm:Hope`); testemunhar (ID: `keyterm:BearWitness`); Yoke (ID: `realia:Yoke`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); inútil (ID: `keyterm:Idle`); Faithfulness (ID: `keyterm:Faithfulness`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); Life (ID: `keyterm:Life`); holy (ID: `keyterm:Holy`); igreja (ID: `keyterm:Church`); irrepreensível (ID: `keyterm:BeyondReproach`); Satanás (ID: `deity:Satan`); Jesus (ID: `person:Jesus.2`); Good (ID: `keyterm:Good`); be unfaithful (ID: `keyterm:Unfaithful`); orar (ID: `keyterm:Pray`); juízo (ID: `keyterm:Judgment`); hope (ID: `keyterm:Hope`); testemunhar (ID: `keyterm:BearWitness`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** inútil (ID: `keyterm:Idle`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); Satanás (ID: `deity:Satan`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); juízo (ID: `keyterm:Judgment`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); escritura (ID: `keyterm:Scripture`); compartilhar (ID: `keyterm:Share`); escolhido (ID: `keyterm:Chosen`); SENHOR (ID: `deity:Lord`); preconceito (ID: `keyterm:Discrimination`); tribunal de justiça (ID: `keyterm:CourtCase`); Jesus (ID: `person:Jesus.2`); pure (ID: `keyterm:Pure`); witness (ID: `keyterm:Witness`); testemunhar solenemente (ID: `keyterm:Declare`); An Angel (ID: `deity:Angel`); fear (ID: `keyterm:Fear`); juízo (ID: `keyterm:Judgment`); Wine (ID: `realia:Wine`); Cattle (ID: `fauna:Bull`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); escolhido (ID: `keyterm:Chosen`); SENHOR (ID: `deity:Lord`); preconceito (ID: `keyterm:Discrimination`); Jesus (ID: `person:Jesus.2`); testemunhar solenemente (ID: `keyterm:Declare`); witness (ID: `keyterm:Witness`); An Angel (ID: `deity:Angel`); fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** escolhido (ID: `keyterm:Chosen`); SENHOR (ID: `deity:Lord`); preconceito (ID: `keyterm:Discrimination`); Jesus (ID: `person:Jesus.2`); testemunhar solenemente (ID: `keyterm:Declare`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** Faithfulness (ID: `keyterm:Faithfulness`); amor ao dinheiro (ID: `keyterm:LoveOfMoney`); servir como escravo (ID: `keyterm:Serve.2`); Ability (ID: `keyterm:Ability`); amado (ID: `keyterm:Beloved`); rogar (ID: `keyterm:AskFor`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); blasfemar (ID: `keyterm:Blaspheme`); Truth (ID: `keyterm:Truth`); Bring In (ID: `keyterm:BringIn`); tentar (ID: `keyterm:PutToTheTest`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`); Life (ID: `keyterm:Life`); Ability (ID: `keyterm:Ability`); Foolish (ID: `keyterm:Foolish`); Do Good (ID: `keyterm:DoGood`); Make Alive (ID: `keyterm:Alive`); Pilatos (ID: `person:Pilate`); surely! (ID: `keyterm:Surely`); Truth (ID: `keyterm:Truth`); generoso (ID: `keyterm:WillingToShare`); blasfemar (ID: `keyterm:Blaspheme`); be (or show oneself) just (ID: `keyterm:Just`); opposite of holy: profane (ID: `keyterm:Profane`); irrepreensível (ID: `keyterm:BeyondReproach`); sem mancha (ID: `keyterm:AboveCriticism`); bem, aventurado (ID: `keyterm:Happy`); promessa (ID: `keyterm:Promise`); Commandment (ID: `keyterm:Commandment`); amor ao dinheiro (ID: `keyterm:LoveOfMoney`); Timóteo (ID: `person:Timothy`); Faithfulness (ID: `keyterm:Faithfulness`); servir como escravo (ID: `keyterm:Serve.2`); amado (ID: `keyterm:Beloved`); witness (ID: `keyterm:Witness`); love (ID: `keyterm:Love`); favor (ID: `keyterm:Favor`); rogar (ID: `keyterm:AskFor`); hope (ID: `keyterm:Hope`); testemunhar (ID: `keyterm:BearWitness`); Bring In (ID: `keyterm:BringIn`); tentar (ID: `keyterm:PutToTheTest`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); para a eternidade (ID: `keyterm:Always`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); Make Alive (ID: `keyterm:Alive`); bem, aventurado (ID: `keyterm:Happy`); Commandment (ID: `keyterm:Commandment`); Life (ID: `keyterm:Life`); irrepreensível (ID: `keyterm:BeyondReproach`); sem mancha (ID: `keyterm:AboveCriticism`); Pilatos (ID: `person:Pilate`); surely! (ID: `keyterm:Surely`); witness (ID: `keyterm:Witness`); love (ID: `keyterm:Love`); be (or show oneself) just (ID: `keyterm:Just`); testemunhar (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** irrepreensível (ID: `keyterm:BeyondReproach`); Commandment (ID: `keyterm:Commandment`); sem mancha (ID: `keyterm:AboveCriticism`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** bem, aventurado (ID: `keyterm:Happy`); surely! (ID: `keyterm:Surely`); para a eternidade (ID: `keyterm:Always`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Do Good (ID: `keyterm:DoGood`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); para a eternidade (ID: `keyterm:Always`); generoso (ID: `keyterm:WillingToShare`); hope (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** Do Good (ID: `keyterm:DoGood`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); SENHOR (ID: `deity:Lord`); para a eternidade (ID: `keyterm:Always`); generoso (ID: `keyterm:WillingToShare`); hope (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** Foolish (ID: `keyterm:Foolish`); promessa (ID: `keyterm:Promise`); Timóteo (ID: `person:Timothy`); opposite of holy: profane (ID: `keyterm:Profane`); crer (ID: `keyterm:Believe`); favor (ID: `keyterm:Favor`)
