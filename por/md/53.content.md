...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Tessalônica (ID: `place:Thessalonica`); Paulo (ID: `person:Paul`); Silas (ID: `person:Silas`); Timóteo (ID: `person:Timothy`); Thessalonians (ID: `group:Thessalonica`); fazer a paz (ID: `keyterm:Peace`); igreja (ID: `keyterm:Church`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); céu (ID: `keyterm:Heaven`); dever (ID: `keyterm:Ought`); Ability (ID: `keyterm:Ability`); juízo (ID: `keyterm:Judgment`); testemunhar (ID: `keyterm:BearWitness`); ser glorificado (ID: `keyterm:Glorified`); love (ID: `keyterm:Love`); tribunal de justiça (ID: `keyterm:CourtCase`); fazer justiça (ID: `keyterm:GrantJustice`); igreja (ID: `keyterm:Church`); Glory (ID: `keyterm:Glory`); para a eternidade (ID: `keyterm:Always`); An Angel (ID: `deity:Angel`); reino (ID: `keyterm:Kingdom`); boa notícia (ID: `keyterm:GoodNews`); holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`); tribunal de justiça (ID: `keyterm:CourtCase`); reino (ID: `keyterm:Kingdom`); be (or show oneself) just (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); To Cause to Happen (ID: `keyterm:Happen`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Name (ID: `keyterm:Name`); Good (ID: `keyterm:Good`); Ability (ID: `keyterm:Ability`); Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`); To Cause to Happen (ID: `keyterm:Happen`); orar (ID: `keyterm:Pray`); ser glorificado (ID: `keyterm:Glorified`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); Truth (ID: `keyterm:Truth`); SENHOR (ID: `deity:Lord`); Spirit (ID: `keyterm:Spirit.2`); rogar (ID: `keyterm:AskFor`); example (ID: `keyterm:Example`); wipe (out), destroy (ID: `keyterm:Destroy`); love (ID: `keyterm:Love`); Satanás (ID: `deity:Satan`); injustiça (ID: `keyterm:UnjustDeed`); maravilha (ID: `keyterm:Portent`); Ability (ID: `keyterm:Ability`); decidir (ID: `keyterm:Decided`); salvation (ID: `keyterm:Salvation`); objeto de culto (ID: `keyterm:ObjectOfWorship`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** rogar (ID: `keyterm:AskFor`); hope (ID: `keyterm:Hope`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); para a eternidade (ID: `keyterm:Always`); Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); crer (ID: `keyterm:Believe`); persuadir (ID: `keyterm:Persuade`); Glory (ID: `keyterm:Glory`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); livrar (ID: `keyterm:Deliver`); Faithfulness (ID: `keyterm:Faithfulness`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); tradição (ID: `keyterm:Teaching`); rogar (ID: `keyterm:AskFor`); Name (ID: `keyterm:Name`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); Ability (ID: `keyterm:Ability`); autoridade (ID: `keyterm:Authority.2`)
