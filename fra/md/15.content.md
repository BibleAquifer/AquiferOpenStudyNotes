...
* **Associated ACAI Concepts:** Cyrus (ID: `person:Cyrus`); Perse (ID: `place:Persia`); Jérémie (ID: `person:Jeremiah.6`); Éternel (ID: `deity:Lord`); parole du seigneur (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** Cyrus (ID: `person:Cyrus`); Éternel (ID: `deity:Lord`); Perse (ID: `place:Persia`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Jérémie (ID: `person:Jeremiah.6`); Israël (ID: `person:Israel`); parole du seigneur (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** Cyrus (ID: `person:Cyrus`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); Perse (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); offrande (ID: `keyterm:Offering`); Éternel (ID: `deity:Lord`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Benjamin (ID: `group:Benjamin`); Benjamin (ID: `person:Benjamin`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Cyrus (ID: `person:Cyrus`); Éternel (ID: `deity:Lord`); Nebucadnetsar (ID: `person:Nebuchadnezzar`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mithredath (ID: `person:Mithredath`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Cyrus (ID: `person:Cyrus`); Perse (ID: `place:Persia`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Élam (ID: `person:Elam`); Jérusalem (ID: `place:Jerusalem`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); Salomon (ID: `person:Solomon`); Nethopha (ID: `place:Netophah`); Bésaï (ID: `person:Besai`); Cherub (ID: `place:Cherub`); Bigvaï (ID: `person:Bigvai.2`); Bébaï (ID: `person:Bebai`); Batsluth (ID: `person:Bazluth`); Pareosch (ID: `person:Parosh`); Peruda (ID: `person:Peruda`); Reélaja (ID: `person:Reelaiah`); Harim (ID: `person:Harim`); Schobaï (ID: `person:Shobai`); Hagab (ID: `person:Hagab`); Yedaya (ID: `person:Jedaiah.4`); Adin (ID: `person:Adin`); Betsaï (ID: `person:Bezai`); Seraja (ID: `person:Seraiah.6`); Mehida (ID: `person:Mehida`); Hathitha (ID: `person:Hatita`); Nekoda (ID: `person:Nekoda`); Pachath-Moab (ID: `person:Pahath-moab`); Mispar (ID: `person:Mispar`); Arach (ID: `person:Arah.2`); Retsin (ID: `person:Rezin.2`); Guiddel (ID: `person:Giddel`)
...
* **Associated ACAI Concepts:** Mispar (ID: `person:Mispar`); Mardochée (ID: `person:Mordecai`); Seraja (ID: `person:Seraiah.6`); Bigvaï (ID: `person:Bigvai`); Rehum (ID: `person:Rehum`); Reélaja (ID: `person:Reelaiah`); Bilschan (ID: `person:Bilshan`); Baana (ID: `person:Baanah.3`); Néhémie (ID: `person:Nehemiah`); Israël (ID: `person:Israel`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** Adonikam (ID: `person:Adonikam`); Bigvaï (ID: `person:Bigvai.2`); Bébaï (ID: `person:Bebai`); Élam (ID: `person:Elam`); Pareosch (ID: `person:Parosh`); Bani (ID: `person:Bani`); Josué (ID: `person:Jeshua.3`); Shefatya (ID: `person:Shephatiah.6`); Haschum (ID: `person:Hashum`); Adin (ID: `person:Adin`); Betsaï (ID: `person:Bezai`); Ézéchias (ID: `person:Hezekiah.2`); Jora (ID: `person:Jorah`); Ather (ID: `person:Ater`); Pachath-Moab (ID: `person:Pahath-moab`); Zaccaï (ID: `person:Zaccai.2`); Arach (ID: `person:Arah.2`); Joab (ID: `person:Joab.3`); Azgad (ID: `person:Azgad`); Zatthu (ID: `person:Zattu.2`); Gabaon (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Nethopha (ID: `place:Netophah`); Senaa (ID: `place:Senaah`); Harim (ID: `person:Harim.2`); Magbisch (ID: `place:Magbish`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Hadid (ID: `place:Hadid`); Nebo (ID: `place:Nebo.2`); Élam (ID: `person:Elam`); Guéba (ID: `place:Geba`); Jéricho (ID: `place:Jericho`); Anathoth (ID: `place:Anathoth`); Kirjath-Jearim (ID: `place:Kiriath-jearim`); Ono (ID: `place:Ono`); Bethel (ID: `place:Bethel`); Kephira (ID: `place:Chephirah`); Ramah (ID: `place:Ramah.2`); Beéroth (ID: `place:Beeroth`); Aï (ID: `place:Ai`); Bethléhem (ID: `place:Bethlehem`); Lod (ID: `place:Lod`); Micmasch (ID: `place:Michmash`)
...
* **Associated ACAI Concepts:** Hodavia (ID: `person:Hodaviah.4`); Immer (ID: `person:Immer.2`); Ather (ID: `person:Ater.2`); Hathitha (ID: `person:Hatita`); Thalmon (ID: `person:Talmon`); Yedaya (ID: `person:Jedaiah.4`); Josué (ID: `person:Jeshua.4`); Harim (ID: `person:Harim`); Josué (ID: `person:Jeshua`); Schobaï (ID: `person:Shobai`); Schallum (ID: `person:Shallum.8`); Kadmiel (ID: `person:Kadmiel`); Lévi (ID: `group:Levi`); Akkub (ID: `person:Akkub.2`); Asaph (ID: `person:Asaph.2`); Paschhur (ID: `person:Pashhur`); Lévi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Ather (ID: `person:Ater.2`); Hathitha (ID: `person:Hatita`); Thalmon (ID: `person:Talmon`); Schobaï (ID: `person:Shobai`); Schallum (ID: `person:Shallum.8`); Asaph (ID: `person:Asaph.2`); Akkub (ID: `person:Akkub.2`)
...
* **Associated ACAI Concepts:** Bésaï (ID: `person:Besai`); Paséach (ID: `person:Paseah.2`); Batsluth (ID: `person:Bazluth`); Hakupha (ID: `person:Hakupha`); Hathipha (ID: `person:Hatipha`); Sisera (ID: `person:Sisera.2`); Reaja (ID: `person:Reaiah.3`); Meunim (ID: `group:Meunim`); Hagaba (ID: `person:Hagabah`); Gachar (ID: `person:Gahar`); Gazzam (ID: `person:Gazzam`); Hanan (ID: `person:Hanan.4`); Hagab (ID: `person:Hagab`); Thabbaoth (ID: `person:Tabbaoth`); Harhur (ID: `person:Harhur`); Shalmai (ID: `person:Shalmai`); Barkos (ID: `person:Barkos`); Lebana (ID: `person:Lebanah`); Padon (ID: `person:Padon`); Siaha (ID: `person:Siaha`); Harscha (ID: `person:Harsha`); Uzza (ID: `person:Uzza.2`); Hasupha (ID: `person:Hasupha`); Mehida (ID: `person:Mehida`); Akkub (ID: `person:Akkub.3`); Thamach (ID: `person:Temah`); Asna (ID: `person:Asnah`); Nekoda (ID: `person:Nekoda`); Bakbuk (ID: `person:Bakbuk`); Tsicha (ID: `person:Ziha`); Retsin (ID: `person:Rezin.2`); Kéros (ID: `person:Keros`); Guiddel (ID: `person:Giddel`); Nephushesim (ID: `group:Nephushesim`); Netsiach (ID: `person:Neziah`)
...
* **Associated ACAI Concepts:** Salomon (ID: `person:Solomon`); Hatthil (ID: `person:Hattil`); Shephatiah (ID: `person:Shephatiah.7`); Darkon (ID: `person:Darkon`); Peruda (ID: `person:Peruda`); Sophéreth (ID: `person:Sophereth`); Sothaï (ID: `person:Sotai`); Ami (ID: `person:Ami`); Jaala (ID: `person:Jaalah`); Guiddel (ID: `person:Giddel.2`); Pokéreth-Hatsebaïm (ID: `person:Pochereth-hazzebaim`)
...
* **Associated ACAI Concepts:** Immer (ID: `place:Immer`); Cherub (ID: `place:Cherub`); Thel-Harscha (ID: `place:Tel-harsha`); Delaja (ID: `person:Delaiah.3`); Addan (ID: `place:Addan`); Tobija (ID: `person:Tobiah`); Nekoda (ID: `person:Nekoda.2`); Thel-Mélach (ID: `place:Tel-melah`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Hakkots (ID: `person:Hakkoz.2`); Barzillaï (ID: `person:Barzillai.3`); Habaja (ID: `person:Habaiah`); Galaad (ID: `place:Gilead`); Galaadite (ID: `group:Gilead`); sacerdoce (ID: `keyterm:Priesthood`); Barzillaï (ID: `person:Barzillai`); souiller (ID: `keyterm:Stain`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); force (ID: `keyterm:Strength`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); Tunic (ID: `realia:Tunic`); Mina (ID: `realia:Mina`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); offrande (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`); Josué (ID: `person:Joshua.5`); Perse (ID: `place:Persia`); Cyrus (ID: `person:Cyrus`); Jehozadak (ID: `person:Jehozadak`); Schealthiel (ID: `person:Shealtiel.2`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Hénadad (ID: `person:Henadad`); Kadmiel (ID: `person:Kadmiel`); Relatives (ID: `group:Relatives`); Hodavia (ID: `person:Hodaviah.4`); Asarhaddôn (ID: `person:Esarhaddon`); Josué (ID: `person:Jeshua.4`); Moïse (ID: `person:Moses`); bonté (ID: `keyterm:Kindness`); David (ID: `person:David`); saint (ID: `keyterm:Holy`); Sidonien (ID: `group:Sidon`); Joppa (ID: `place:Joppa`); Benjamin (ID: `person:Benjamin`); Liban (ID: `place:Lebanon`); Hodija (ID: `person:Hodiah.2`); Tyrien (ID: `group:Tyre`); Sidon (ID: `place:Sidon`); Darius (ID: `person:Darius.2`); terreur (ID: `keyterm:Terror`); avis (ID: `keyterm:Counsel`); Tyr (ID: `place:Tyre`); Instruction (ID: `keyterm:Instruction`); Asaph (ID: `person:Asaph.2`); fête déterminée (ID: `keyterm:AppointedFeast`); Benjamin (ID: `group:Benjamin`); Assyria (ID: `place:Assyria`); néoménies (ID: `keyterm:NewMoonFestival`); fourré (ID: `keyterm:FeastOfTabernacles`); Craftsman (ID: `realia:Craftsman`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Cedar (ID: `flora:Cedar`)
...
* **Associated ACAI Concepts:** Schealthiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Jehozadak (ID: `person:Jehozadak`); Moïse (ID: `person:Moses`); offrande (ID: `keyterm:Offering`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** terreur (ID: `keyterm:Terror`); offrande (ID: `keyterm:Offering`); Éternel (ID: `deity:Lord`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Sidonien (ID: `group:Sidon`); Joppa (ID: `place:Joppa`); Liban (ID: `place:Lebanon`); Cyrus (ID: `person:Cyrus`); Tyr (ID: `place:Tyre`); Perse (ID: `place:Persia`); Tyrien (ID: `group:Tyre`); Sidon (ID: `place:Sidon`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); Schealthiel (ID: `person:Shealtiel.2`); Lévi (ID: `group:Levi`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Jehozadak (ID: `person:Jehozadak`); Lévi (ID: `person:Levi.3`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); bonté (ID: `keyterm:Kindness`); David (ID: `person:David`); Lévi (ID: `group:Levi`); Asaph (ID: `person:Asaph.2`); Lévi (ID: `person:Levi.3`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Benjamin (ID: `group:Benjamin`); Benjamin (ID: `person:Benjamin`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Cyrus (ID: `person:Cyrus`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Perse (ID: `place:Persia`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Perse (ID: `place:Persia`); avis (ID: `keyterm:Counsel`); Cyrus (ID: `person:Cyrus`); Darius (ID: `person:Darius.2`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Euphrate (ID: `place:Euphrates`); Schimschaï (ID: `person:Shimshai`); Rehum (ID: `person:Rehum.2`); Artaxerxès (ID: `person:Artaxerxes.2`); Perse (ID: `place:Persia`); Samarie (ID: `place:Samaria`); Jews (ID: `group:Jews`); Dinaite (ID: `person:Dinaite`); Osnappar (ID: `person:Osnappar`); Babylonien (ID: `group:Babylon`); Mithredath (ID: `person:Mithredath.2`); Érec (ID: `place:Erech`); Assuérus (ID: `person:Ahasuerus`); Bischlam (ID: `person:Bishlam`); Thabeel (ID: `person:Tabeel`); Babylone (ID: `place:Babylon`); Perse (ID: `group:Persia`); Juda (ID: `person:Judah.4`); Suse (ID: `place:Susa`); Juda (ID: `group:Judah`); Almôn-Divlataïm (ID: `group:Elam`); Élam (ID: `place:Elam`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Bischlam (ID: `person:Bishlam`); Mithredath (ID: `person:Mithredath.2`); Thabeel (ID: `person:Tabeel`); Artaxerxès (ID: `person:Artaxerxes.2`); Perse (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Babylonien (ID: `group:Babylon`); Dinaite (ID: `person:Dinaite`); Érec (ID: `place:Erech`); Rehum (ID: `person:Rehum.2`); Schimschaï (ID: `person:Shimshai`); Babylone (ID: `place:Babylon`); Almôn-Divlataïm (ID: `group:Elam`); Perse (ID: `place:Persia`); Perse (ID: `group:Persia`); Élam (ID: `place:Elam`); Suse (ID: `place:Susa`)
...
* **Associated ACAI Concepts:** Euphrate (ID: `place:Euphrates`); Jérusalem (ID: `place:Jerusalem`); Artaxerxès (ID: `person:Artaxerxes.2`); Samarie (ID: `place:Samaria`); Rehum (ID: `person:Rehum.2`); Schimschaï (ID: `person:Shimshai`); Jews (ID: `group:Jews`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Rehum (ID: `person:Rehum.2`); Schimschaï (ID: `person:Shimshai`); Jérusalem (ID: `place:Jerusalem`); Artaxerxès (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Darius (ID: `person:Darius.2`); Jews (ID: `group:Jews`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Iddo (ID: `person:Iddo.6`); Aggée (ID: `person:Haggai`); Thathnaï (ID: `person:Tattenai`); Zacharie (ID: `person:Zechariah.17`); Juda (ID: `person:Judah.4`); Israël (ID: `person:Israel`); Perse (ID: `place:Persia`); Schealthiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Jehozadak (ID: `person:Jehozadak`); Euphrate (ID: `place:Euphrates`)
...
* **Associated ACAI Concepts:** Iddo (ID: `person:Iddo.6`); Zacharie (ID: `person:Zechariah.17`); Aggée (ID: `person:Haggai`); Juda (ID: `person:Judah.4`); Jérusalem (ID: `place:Jerusalem`); Israël (ID: `person:Israel`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Schealthiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Jehozadak (ID: `person:Jehozadak`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** offrande (ID: `keyterm:Offering`); Israël (ID: `person:Israel`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Seraja (ID: `person:Seraiah.2`); Azaria (ID: `person:Azariah.7`); Esdras (ID: `person:Ezra`); Perse (ID: `place:Persia`); Hilkija (ID: `person:Hilkiah.2`); Artaxerxès (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** Esdras (ID: `person:Ezra`); Tsadok (ID: `person:Zadok.4`); Achithub (ID: `person:Ahitub.3`); Amaria (ID: `person:Amariah.2`); Merajoth (ID: `person:Meraioth`); Uzzi (ID: `person:Uzzi`); Abischua (ID: `person:Abishua`); Seraja (ID: `person:Seraiah.2`); Azaria (ID: `person:Azariah.7`); Azaria (ID: `person:Azariah.6`); Bukki (ID: `person:Bukki.2`); Schallum (ID: `person:Shallum.7`); Zerachja (ID: `person:Zerahiah`); Perse (ID: `place:Persia`); Aaron (ID: `person:Aaron`); Éléazar (ID: `person:Eleazar.2`); Phinées (ID: `person:Phinehas`); Artaxerxès (ID: `person:Artaxerxes`); Hilkija (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** Esdras (ID: `person:Ezra`); Moïse (ID: `person:Moses`); Babylone (ID: `place:Babylon`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Esdras (ID: `person:Ezra`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); limite (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); Esdras (ID: `person:Ezra`); Artaxerxès (ID: `person:Artaxerxes`); Israël (ID: `person:Israel`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`); Euphrate (ID: `place:Euphrates`); limite (ID: `keyterm:Decree`); Babylone (ID: `place:Babylon`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Wheat (ID: `flora:Wheat`); Olive Oil (ID: `realia:OliveOil`); Stone Altar (ID: `realia:StoneAltar`); Kor (ID: `realia:Kor`); Sheep (ID: `fauna:Lamb`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Esdras (ID: `person:Ezra`); Euphrate (ID: `place:Euphrates`); Artaxerxès (ID: `person:Artaxerxes`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Wheat (ID: `flora:Wheat`); Kor (ID: `realia:Kor`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Adonikam (ID: `person:Adonikam`); Bébaï (ID: `person:Bebai`); Guershom (ID: `person:Gershom.2`); Élam (ID: `person:Elam`); Bigvaï (ID: `person:Bigvai.2`); Zacharie (ID: `person:Zechariah.19`); Bébaï (ID: `person:Bebai.2`); Daniel (ID: `person:Daniel.2`); Éliphéleth (ID: `person:Eliphelet.5`); Josiphia (ID: `person:Josiphiah`); Jochanan (ID: `person:Johanan.8`); Shefatya (ID: `person:Shephatiah.6`); Schecania (ID: `person:Shecaniah.6`); Abdias (ID: `person:Obadiah.10`); Jachaziel (ID: `person:Jahaziel.5`); Zevadya (ID: `person:Zebadiah.8`); Zerachja (ID: `person:Zerahiah.2`); Adin (ID: `person:Adin`); Ésaïe (ID: `person:Jeshaiah.4`); Hatthusch (ID: `person:Hattush.2`); Ébed (ID: `person:Ebed.2`); Yeïel (ID: `person:Jeuel.3`); Jehiel (ID: `person:Jehiel.7`); Schecania (ID: `person:Shecaniah.5`); Athalie (ID: `person:Athaliah.3`); Schelomith (ID: `person:Shelomith.4`); Zaccur (ID: `person:Zaccur.5`); Jonathan (ID: `person:Jonathan.9`); Joab (ID: `person:Joab.4`); Uthaï (ID: `person:Uthai.2`); Micaël (ID: `person:Michael.10`); Zacharie (ID: `person:Zechariah.18`); Éljoénaï (ID: `person:Eliehoenai.2`); Schemaeja (ID: `person:Shemaiah.14`); Pachath-Moab (ID: `person:Pahath-moab`); Pareosch (ID: `person:Parosh.2`); Azgad (ID: `person:Azgad`); Hakkathan (ID: `person:Hakkatan`); David (ID: `person:David`); Babylone (ID: `place:Babylon`); Phinées (ID: `person:Phinehas`); Artaxerxès (ID: `person:Artaxerxes`); Ithamar (ID: `person:Ithamar`)
...
* **Associated ACAI Concepts:** Ariel (ID: `person:Ariel`); Jarib (ID: `person:Jarib.2`); Nathan (ID: `person:Nathan.5`); Elnathan (ID: `person:Elnathan.4`); Schemaeja (ID: `person:Shemaiah.15`); Jojarib (ID: `person:Joiarib.2`); Éliézer (ID: `person:Eliezer.8`); Zacharie (ID: `person:Zechariah.20`); Iddo (ID: `person:Iddo`); Meschullam (ID: `person:Meshullam.9`); Elnathan (ID: `person:Elnathan.3`); Casiphia (ID: `place:Casiphia`); Elnathan (ID: `person:Elnathan.2`); Éternel (ID: `deity:Lord`); percevoir (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Schérébia (ID: `person:Sherebiah`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Machli (ID: `person:Mahli`); discernement (ID: `keyterm:Insight`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Lévi (ID: `group:Levi`); travil (ID: `keyterm:Work`); Lévi (ID: `person:Levi.3`); David (ID: `person:David`)
...
* **Associated ACAI Concepts:** offrande (ID: `keyterm:Offering`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); pécher (ID: `keyterm:Sin`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittite (ID: `group:Hittite`); Égypte (ID: `place:Egypt`); Mitsraïm (ID: `group:Egypt`); être infidèle (ID: `keyterm:Unfaithful`); Moab (ID: `place:Moab`); Jébusiens (ID: `group:Jebusites`); Heth (ID: `person:Heth`); Canaan (ID: `group:Canaan`); Israël (ID: `person:Israel`); Canaan (ID: `place:Canaan`); Amorites (ID: `group:Amorites`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); Amos (ID: `group:Ammon`); Ammon (ID: `place:Ammon`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Esdras (ID: `person:Ezra`); être infidèle (ID: `keyterm:Unfaithful`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); Jérusalem (ID: `place:Jerusalem`); ardeur (ID: `keyterm:Ardour`); House (ID: `realia:House`); Harim (ID: `person:Harim`); avis (ID: `keyterm:Counsel`); Élam (ID: `person:Elam`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); offrande (ID: `keyterm:Offering`); Adaja (ID: `person:Adaiah.5`); Juda (ID: `person:Judah.5`); Siméon (ID: `person:Shimeon`); Kelaiah (ID: `person:Kelaiah`); Pethachja (ID: `person:Pethahiah.2`); Binnuï (ID: `person:Binnui.4`); Pareosch (ID: `person:Parosh`); Éljoénaï (ID: `person:Elioenai.5`); Schallum (ID: `person:Shallum.11`); Judée (ID: `place:Judea`); Jeïel (ID: `person:Jeiel.8`); Nethaneel (ID: `person:Nethanel.8`); Jehiel (ID: `person:Jehiel.10`); Bani (ID: `person:Bani.5`); Jozabad (ID: `person:Jozabad.7`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); ardeur (ID: `keyterm:Ardour`); Judée (ID: `place:Judea`); bonté (ID: `keyterm:Kindness`); Jérusalem (ID: `place:Jerusalem`); déposséder (ID: `keyterm:Dispossess`); laissiez en possession (ID: `keyterm:Possess`); Israël (ID: `person:Israel`); état intact (ID: `keyterm:IntactState`); Perse (ID: `place:Persia`); supplication (ID: `keyterm:Supplication`); pollution (ID: `keyterm:Defilement`); Peg (ID: `realia:Peg`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Judée (ID: `place:Judea`); bonté (ID: `keyterm:Kindness`); Jérusalem (ID: `place:Jerusalem`); Perse (ID: `place:Persia`); supplication (ID: `keyterm:Supplication`); Peg (ID: `realia:Peg`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** Jehiel (ID: `person:Jehiel.8`); Schecania (ID: `person:Shecaniah.7`); être infidèle (ID: `keyterm:Unfaithful`); Élam (ID: `person:Elam`); Esdras (ID: `person:Ezra`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Esdras (ID: `person:Ezra`); Israël (ID: `person:Israel`); Lévi (ID: `group:Levi`); jurer (ID: `keyterm:Swear`); Lévi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Benjamin (ID: `group:Benjamin`); Benjamin (ID: `person:Benjamin`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jonathan (ID: `person:Jonathan.10`); Asaël (ID: `person:Asahel.4`); Shabbethai (ID: `person:Shabbethai`); Meschullam (ID: `person:Meshullam.10`); Jachzia (ID: `person:Jahzeiah`); Thikva (ID: `person:Tikvah.2`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`)
