...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Arquipo (ID: `person:Archippus`); Filemom (ID: `person:Philemon`); Áfia (ID: `person:Apphia`); Timóteo (ID: `person:Timothy`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); Paulo (ID: `person:Paul`); amado (ID: `keyterm:Beloved`); igreja (ID: `keyterm:Church`); fazer a paz (ID: `keyterm:Peace`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); holy (ID: `keyterm:Holy`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); Cause of Joy (ID: `keyterm:CauseOfJoy`); compaixão (ID: `keyterm:Affection`); comunhão (ID: `keyterm:Fellowship`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); Paulo (ID: `person:Paul`); love (ID: `keyterm:Love`); em cristo (ID: `keyterm:InChrist`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Lucas (ID: `person:Luke`); Epafras (ID: `person:Epaphras`); Demas (ID: `person:Demas`); Marcos (ID: `person:Mark`); Aristarco (ID: `person:Aristarchus`); favor (ID: `keyterm:Favor`); em cristo (ID: `keyterm:InChrist`); Spirit (ID: `keyterm:Spirit.2`)
