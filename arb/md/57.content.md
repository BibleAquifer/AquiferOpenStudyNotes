...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); إِلَى (ID: `person:Apphia`); لِأَرْخِبّسَ (ID: `person:Archippus`); إِلَى (ID: `person:Philemon`); بولسَ (ID: `person:Paul`); Make Peace (ID: `keyterm:Peace`); Beloved (ID: `keyterm:Beloved`); Favor (ID: `keyterm:Favor`); تِيموثَاوس (ID: `person:Timothy`); ٱلرَّبِّ (ID: `deity:Lord`); Church (ID: `keyterm:Church`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Holy (ID: `keyterm:Holy`); يَسوع (ID: `person:Jesus.2`); Love (ID: `keyterm:Love`); Believe (ID: `keyterm:Believe`); Pray (ID: `keyterm:Pray`); Fellowship (ID: `keyterm:Fellowship`); Ask for (ID: `keyterm:AskFor`); Good (ID: `keyterm:Good`); ٱلرَّبِّ (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Affection (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); بولسَ (ID: `person:Paul`); Love (ID: `keyterm:Love`); Ask for (ID: `keyterm:AskFor`); In Christ (ID: `keyterm:InChrist`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); لوقَا (ID: `person:Luke`); دِيمَاس (ID: `person:Demas`); أَبَفْرَاسَ (ID: `person:Epaphras`); Favor (ID: `keyterm:Favor`); In Christ (ID: `keyterm:InChrist`); Spirit (ID: `keyterm:Spirit.2`); مَرْقسَ (ID: `person:Mark`); أَرِسْتَرْخسَ (ID: `person:Aristarchus`)
