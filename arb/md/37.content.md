...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); يَهوصَادِقَ (ID: `person:Jehozadak`); حَجَّيِ (ID: `person:Haggai`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); حَجَّيِ (ID: `person:Haggai`); يَهوذَا (ID: `group:Judah`); Fear (ID: `keyterm:Fear`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Peace (ID: `keyterm:IntactState`); يَهوذَا (ID: `person:Judah.4`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); مِصْرَ (ID: `place:Egypt`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Peace (ID: `keyterm:IntactState`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); حَجَّيِ (ID: `person:Haggai`); Defilement (ID: `keyterm:Defilement`); Vine (ID: `flora:Vine`); Bless (ID: `keyterm:Bless`); Instruction (ID: `keyterm:Instruction`); Word of the Lord (ID: `keyterm:WordOfTheLord`); دَارِيوسَ (ID: `person:Darius.2`); Holy (ID: `keyterm:Holy`); Winepress (ID: `realia:Winepress`); Olive Oil (ID: `realia:OliveOil`); Grain (ID: `flora:Grain`); Fig (ID: `flora:Fig`); Wine (ID: `realia:Wine`); Barley (ID: `flora:Barley`); Coriander (ID: `flora:Coriander`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); Stew (ID: `realia:Stew`); Pomegranate (ID: `flora:Pomegranate`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `group:Judah`); حَجَّيِ (ID: `person:Haggai`); Word of the Lord (ID: `keyterm:WordOfTheLord`); يَهوذَا (ID: `person:Judah.4`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`); Sword (ID: `realia:Sword`)
