...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); Word of the Lord (ID: `keyterm:WordOfTheLord`); ٱلرَّبِّ (ID: `deity:Lord`); إِرْمِيَا (ID: `person:Jeremiah.6`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); ٱلرَّبِّ (ID: `deity:Lord`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`); Word of the Lord (ID: `keyterm:WordOfTheLord`); إِرْمِيَا (ID: `person:Jeremiah.6`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); إِسْرَائِيلَ (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); Offering (ID: `keyterm:Offering`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `group:Levi`); بَنْيَامِينَ (ID: `person:Benjamin`); بَنْيَامِينَ (ID: `group:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `person:Levi.3`); يَهوذَا (ID: `group:Judah`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath`); كورَشَ (ID: `person:Cyrus`); يَهوذَا (ID: `person:Judah.4`); زَربَّابِل (ID: `person:Zerubbabel.2`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); سلَيْمَانَ (ID: `person:Solomon`); لَّاوِي (ID: `group:Levi`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `person:Levi.3`); Tel-melah (ID: `place:Tel-melah`); بِيصَايَ (ID: `person:Bezai`); حَارِيمَ (ID: `person:Harim`); سوفَرَثَ (ID: `person:Sophereth`); طوبِيَّا (ID: `person:Tobiah`); يَعْلَةَ (ID: `person:Jaalah`); حَاجَابَ (ID: `person:Hagab`); بَصْلوتَ (ID: `person:Bazluth`); نَبو (ID: `place:Nebo.2`); بِلْشَان (ID: `person:Bilshan`); مَغْبِيشَ (ID: `place:Magbish`); ثَامَحَ (ID: `person:Temah`); حَجَابَةَ (ID: `person:Hagabah`); بَابَايَ (ID: `person:Bebai`); كَروب (ID: `place:Cherub`); بِيسَايَ (ID: `person:Besai`); فَادونَ (ID: `person:Padon`); هَقّوصَ (ID: `person:Hakkoz.2`); آمِي (ID: `person:Ami`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); صِيحَا (ID: `person:Ziha`); هودَوْيَا (ID: `person:Hodaviah.4`); فَاسِيحَ (ID: `person:Paseah.2`); نَقودَا (ID: `person:Nekoda`)
...
* **Associated ACAI Concepts:** بِغْوَايَ (ID: `person:Bigvai`); مِسْفَار (ID: `person:Mispar`); مرْدَخَاي (ID: `person:Mordecai`); رَحوم (ID: `person:Rehum`); رَعْلَايَا (ID: `person:Reelaiah`); بِلْشَان (ID: `person:Bilshan`); نَحَمْيَا (ID: `person:Nehemiah`); سَرَايَا (ID: `person:Seraiah.6`); بَعْنَةَ (ID: `person:Baanah.3`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** بِيصَايَ (ID: `person:Bezai`); Pahath-moab (ID: `person:Pahath-moab`); بَانِيَ (ID: `person:Bani`); آطِيرَ (ID: `person:Ater`); زَتّو (ID: `person:Zattu.2`); بِغْوَايَ (ID: `person:Bigvai.2`); يوآب (ID: `person:Joab.3`); عَرْجَدَ (ID: `person:Azgad`); يورَةَ (ID: `person:Jorah`); حَزَقِيَّا (ID: `person:Hezekiah.2`); عِيلَامَ (ID: `person:Elam`); بَابَايَ (ID: `person:Bebai`); يَشوعَ (ID: `person:Jeshua.3`); شَفَطْيَا (ID: `person:Shephatiah.6`); حَشوم (ID: `person:Hashum`); فَرْعوشَ (ID: `person:Parosh`); آرَحَ (ID: `person:Arah.2`); زَكَّايَ (ID: `person:Zaccai.2`); عَادِينَ (ID: `person:Adin`); أَدونِيقَامَ (ID: `person:Adonikam`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** حَادِيدَ (ID: `place:Hadid`); نَبو (ID: `place:Nebo.2`); مَغْبِيشَ (ID: `place:Magbish`); حَارِيمَ (ID: `person:Harim.2`); سَنَاءَةَ (ID: `place:Senaah`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); Beth-azmaveth (ID: `place:Beth-azmaveth`); مِخْمَاسَ (ID: `place:Michmash`); لَحْمٍ (ID: `place:Bethlehem`); وَلودَ (ID: `place:Lod`); أَرِيحَا (ID: `place:Jericho`); Bethel (ID: `place:Bethel`); عَايٍ (ID: `place:Ai`); بَئِيروت (ID: `place:Beeroth`); Kiriath-jearim (ID: `place:Kiriath-jearim`); ٱلْكَفِيرَة (ID: `place:Chephirah`); عِيلَامَ (ID: `person:Elam`); Ramah (ID: `place:Ramah.2`); أونوَ (ID: `place:Ono`); مِنْ (ID: `place:Geba`); عَنَاثوثَ (ID: `place:Anathoth`)
...
* **Associated ACAI Concepts:** آطِيرَ (ID: `person:Ater.2`); لِإِيمِيرَ (ID: `person:Immer.2`); يَشوعَ (ID: `person:Jeshua`); حَطِيطَا (ID: `person:Hatita`); يَشوعَ (ID: `person:Jeshua.4`); هودَوْيَا (ID: `person:Hodaviah.4`); حَارِيمَ (ID: `person:Harim`); شوبَايَ (ID: `person:Shobai`); طَلْمون (ID: `person:Talmon`); يَدَايَا (ID: `person:Jedaiah.4`); عَقّوب (ID: `person:Akkub.2`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); لَّاوِي (ID: `group:Levi`); آسَاف (ID: `person:Asaph.2`); فَشْحور (ID: `person:Pashhur`); لَّاوِي (ID: `person:Levi.3`); شَلّوم (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** آطِيرَ (ID: `person:Ater.2`); حَطِيطَا (ID: `person:Hatita`); شوبَايَ (ID: `person:Shobai`); طَلْمون (ID: `person:Talmon`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`); شَلّوم (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** حَانَان (ID: `person:Hanan.4`); سِيسَرَا (ID: `person:Sisera.2`); Meunim (ID: `group:Meunim`); حَرْحورَ (ID: `person:Harhur`); سِيعَهَا (ID: `person:Siaha`); طَبَاعوتَ (ID: `person:Tabbaoth`); بَقْبوقَ (ID: `person:Bakbuk`); رَآيَا (ID: `person:Reaiah.3`); حَاجَابَ (ID: `person:Hagab`); مَحِيدَا (ID: `person:Mehida`); جَزَّامَ (ID: `person:Gazzam`); بَصْلوتَ (ID: `person:Bazluth`); أَسْنَةَ (ID: `person:Asnah`); حَطِيفَا (ID: `person:Hatipha`); رَصِينَ (ID: `person:Rezin.2`); حَجَابَةَ (ID: `person:Hagabah`); ثَامَحَ (ID: `person:Temah`); Nephushesim (ID: `group:Nephushesim`); حَسوفَا (ID: `person:Hasupha`); جَاحَرَ (ID: `person:Gahar`); بِيسَايَ (ID: `person:Besai`); حَرْشَا (ID: `person:Harsha`); لَبَانَةَ (ID: `person:Lebanah`); فَادونَ (ID: `person:Padon`); جَدِّيلَ (ID: `person:Giddel`); حَقوفَا (ID: `person:Hakupha`); بَرْقوسَ (ID: `person:Barkos`); نَصِيحَ (ID: `person:Neziah`); سَلْمَايَ (ID: `person:Shalmai`); فِي (ID: `person:Uzza.2`); قِيروسَ (ID: `person:Keros`); صِيحَا (ID: `person:Ziha`); نَقودَا (ID: `person:Nekoda`); فَاسِيحَ (ID: `person:Paseah.2`); عَقّوب (ID: `person:Akkub.3`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); دَرْقونَ (ID: `person:Darkon`); جَدِّيلَ (ID: `person:Giddel.2`); يَعْلَةَ (ID: `person:Jaalah`); آمِي (ID: `person:Ami`); حَطِّيلَ (ID: `person:Hattil`); سَوْطَايَ (ID: `person:Sotai`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); شَفَطْيَا (ID: `person:Shephatiah.7`); سوفَرَثَ (ID: `person:Sophereth`); فَرودَا (ID: `person:Peruda`)
...
* **Associated ACAI Concepts:** Tel-melah (ID: `place:Tel-melah`); لِإِيمِيرَ (ID: `place:Immer`); طوبِيَّا (ID: `person:Tobiah`); كَروب (ID: `place:Cherub`); Tel-harsha (ID: `place:Tel-harsha`); نَقودَا (ID: `person:Nekoda.2`); لِدَلَايَا (ID: `person:Delaiah.3`); أَدَّان (ID: `place:Addan`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** هَقّوصَ (ID: `person:Hakkoz.2`); حَبَايَا (ID: `person:Habaiah`); بَرْزِلَّايَ (ID: `person:Barzillai.3`); Priesthood (ID: `keyterm:Priesthood`); Defile (ID: `keyterm:Stain`); جِلْعَادَ (ID: `place:Gilead`); بَرْزِلَّايَ (ID: `person:Barzillai`); Gileadites (ID: `group:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); Strength (ID: `keyterm:Strength`); Mina (ID: `realia:Mina`); Money (ID: `realia:Money`); Tunic (ID: `realia:Tunic`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); يَشوع (ID: `person:Joshua.5`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Relatives (ID: `group:Relatives`); يَشوعَ (ID: `person:Jeshua.4`); Esarhaddon (ID: `person:Esarhaddon`); حِينَادَادَ (ID: `person:Henadad`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); هودَوْيَا (ID: `person:Hodaviah.4`); دَاودَ (ID: `person:David`); Tyrians (ID: `group:Tyre`); New Moon Festival (ID: `keyterm:NewMoonFestival`); لبْنَانَ (ID: `place:Lebanon`); Appointed Feast (ID: `keyterm:AppointedFeast`); صِيْدونَ (ID: `place:Sidon`); Holy (ID: `keyterm:Holy`); Kindness (ID: `keyterm:Kindness`); يَافَا (ID: `place:Joppa`); موسَى (ID: `person:Moses`); هودِيَّا (ID: `person:Hodiah.2`); بَنْيَامِينَ (ID: `group:Benjamin`); Instruction (ID: `keyterm:Instruction`); Terror (ID: `keyterm:Terror`); صورَ (ID: `place:Tyre`); دَارِيوسَ (ID: `person:Darius.2`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Counsel (ID: `keyterm:Counsel`); Assyria (ID: `place:Assyria`); بَنْيَامِينَ (ID: `person:Benjamin`); آسَاف (ID: `person:Asaph.2`); Sidonians (ID: `group:Sidon`); Cedar (ID: `flora:Cedar`); Olive Oil (ID: `realia:OliveOil`); Cymbals (ID: `realia:Cymbals`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Trumpet (ID: `realia:Trumpet`); Craftsman (ID: `realia:Craftsman`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); موسَى (ID: `person:Moses`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Terror (ID: `keyterm:Terror`); Offering (ID: `keyterm:Offering`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Appointed Feast (ID: `keyterm:AppointedFeast`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); Tyrians (ID: `group:Tyre`); لبْنَانَ (ID: `place:Lebanon`); صورَ (ID: `place:Tyre`); فَارِسَ (ID: `place:Persia`); صِيْدونَ (ID: `place:Sidon`); يَافَا (ID: `place:Joppa`); Sidonians (ID: `group:Sidon`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Cedar (ID: `flora:Cedar`); Craftsman (ID: `realia:Craftsman`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); لَّاوِي (ID: `group:Levi`); يَشوع (ID: `person:Joshua.5`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `person:Levi.3`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `group:Levi`); دَاودَ (ID: `person:David`); آسَاف (ID: `person:Asaph.2`); لَّاوِي (ID: `person:Levi.3`); Kindness (ID: `keyterm:Kindness`); Trumpet (ID: `realia:Trumpet`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `person:Benjamin`); بَنْيَامِينَ (ID: `group:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); كورَشَ (ID: `person:Cyrus`); يَشوع (ID: `person:Joshua.5`); ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); فَارِسَ (ID: `place:Persia`); إِسْرَائِيلَ (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); دَارِيوسَ (ID: `person:Darius.2`); Counsel (ID: `keyterm:Counsel`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْفرَاتِ (ID: `place:Euphrates`); رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); ٱلسَّامِرَةِ (ID: `place:Samaria`); فَارِسَ (ID: `place:Persia`); Babylonians (ID: `group:Babylon`); أسْنَفَّر (ID: `person:Osnappar`); مِثْرَدَاث (ID: `person:Mithredath.2`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); بِشْلَام (ID: `person:Bishlam`); أَرَكَ (ID: `place:Erech`); طَبْئِيل (ID: `person:Tabeel`); يَهوذَا (ID: `person:Judah.4`); بَابِلَ (ID: `place:Babylon`); عِيلَامَ (ID: `place:Elam`); Elamites (ID: `group:Elam`); يَهوذَا (ID: `group:Judah`); فِي (ID: `place:Susa`); Persians (ID: `group:Persia`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** شِمْشَاي (ID: `person:Shimshai`); Babylonians (ID: `group:Babylon`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); أَرَكَ (ID: `place:Erech`); رَحوم (ID: `person:Rehum.2`); عِيلَامَ (ID: `place:Elam`); فَارِسَ (ID: `place:Persia`); فِي (ID: `place:Susa`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); بَابِلَ (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); ٱلسَّامِرَةِ (ID: `place:Samaria`); رَحوم (ID: `person:Rehum.2`); Jews (ID: `group:Jews`); شِمْشَاي (ID: `person:Shimshai`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); أورشَلِيمَ (ID: `place:Jerusalem`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); دَارِيوسَ (ID: `person:Darius.2`); Jews (ID: `group:Jews`); يَدّو (ID: `person:Iddo.6`); حَجَّيِ (ID: `person:Haggai`); زَكَرِيَّا (ID: `person:Zechariah.17`); تَتْنَاي (ID: `person:Tattenai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); يَهوصَادِقَ (ID: `person:Jehozadak`); ٱلْفرَاتِ (ID: `place:Euphrates`); يَشوع (ID: `person:Joshua.5`); يَهوذَا (ID: `person:Judah.4`); زَربَّابِل (ID: `person:Zerubbabel.2`); فَارِسَ (ID: `place:Persia`); إِسْرَائِيلَ (ID: `person:Israel`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** يَدّو (ID: `person:Iddo.6`); حَجَّيِ (ID: `person:Haggai`); زَكَرِيَّا (ID: `person:Zechariah.17`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); أورشَلِيمَ (ID: `place:Jerusalem`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); بَابِلَ (ID: `place:Babylon`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); كورَشَ (ID: `person:Cyrus`); زَربَّابِل (ID: `person:Zerubbabel.2`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); بَابِلَ (ID: `place:Babylon`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** سَرَايَا (ID: `person:Seraiah.2`); عَزْرَا (ID: `person:Ezra`); عَزَرْيَا (ID: `person:Azariah.7`); فَارِسَ (ID: `place:Persia`); حِلْقِيَّا (ID: `person:Hilkiah.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); زَرَحْيَا (ID: `person:Zerahiah`); بقِّي (ID: `person:Bukki.2`); أَبِيشوعَ (ID: `person:Abishua`); عَزَرْيَا (ID: `person:Azariah.7`); سَرَايَا (ID: `person:Seraiah.2`); عَزَرْيَا (ID: `person:Azariah.6`); أَخِيطوبَ (ID: `person:Ahitub.3`); لِمَرَايوثَ (ID: `person:Meraioth`); أَمَرْيَا (ID: `person:Amariah.2`); عزِّي (ID: `person:Uzzi`); صَادوق (ID: `person:Zadok.4`); شَلّوم (ID: `person:Shallum.7`); هَارون (ID: `person:Aaron`); أَلِعَازَار (ID: `person:Eleazar.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); حِلْقِيَّا (ID: `person:Hilkiah.2`); فِينَحَاس (ID: `person:Phinehas`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); موسَى (ID: `person:Moses`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); إِسْرَائِيلَ (ID: `person:Israel`); بَابِلَ (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** Decree (ID: `keyterm:Decree`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); ٱلْفرَاتِ (ID: `place:Euphrates`); Decree (ID: `keyterm:Decree`); يَهوذَا (ID: `person:Judah.4`); بَابِلَ (ID: `place:Babylon`); ٱلرَّبِّ (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Olive Oil (ID: `realia:OliveOil`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Anointing Oil (ID: `realia:AnointingOil`); Altar (ID: `realia:Altar`); Wheat (ID: `flora:Wheat`); Talent (ID: `realia:Talent`); Kor (ID: `realia:Kor`); Stone Altar (ID: `realia:StoneAltar`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); عَزْرَا (ID: `person:Ezra`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); Money (ID: `realia:Money`); Kor (ID: `realia:Kor`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Wheat (ID: `flora:Wheat`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** عوبَدْيَا (ID: `person:Obadiah.10`); فَرْعوشَ (ID: `person:Parosh.2`); يَعِيئِيل (ID: `person:Jeuel.3`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); شَكَنْيَا (ID: `person:Shecaniah.5`); Pahath-moab (ID: `person:Pahath-moab`); يوحَانَانَ (ID: `person:Johanan.8`); زَكّور (ID: `person:Zaccur.5`); شَلومِيَةَ (ID: `person:Shelomith.4`); زَكَرِيَّا (ID: `person:Zechariah.19`); يونَاثَانَ (ID: `person:Jonathan.9`); يوشَفْيَا (ID: `person:Josiphiah`); يوآب (ID: `person:Joab.4`); بِغْوَايَ (ID: `person:Bigvai.2`); عَرْجَدَ (ID: `person:Azgad`); عِيلَامَ (ID: `person:Elam`); بَابَايَ (ID: `person:Bebai`); هِقَّاطَانَ (ID: `person:Hakkatan`); زَبَدْيَا (ID: `person:Zebadiah.8`); زَكَرِيَّا (ID: `person:Zechariah.18`); بَابَايَ (ID: `person:Bebai.2`); يِشْعِيَا (ID: `person:Jeshaiah.4`); شَفَطْيَا (ID: `person:Shephatiah.6`); مِيخَائِيلَ (ID: `person:Michael.10`); أَلِيفَلَط (ID: `person:Eliphelet.5`); عوتَاي (ID: `person:Uthai.2`); عَابِد (ID: `person:Ebed.2`); شِمْعِيَا (ID: `person:Shemaiah.14`); يَحِيئِيل (ID: `person:Jehiel.7`); زَرَحْيَا (ID: `person:Zerahiah.2`); عَثَلْيَا (ID: `person:Athaliah.3`); عَادِينَ (ID: `person:Adin`); شَكَنْيَا (ID: `person:Shecaniah.6`); حَطّوش (ID: `person:Hattush.2`); دَانِيآل (ID: `person:Daniel.2`); يَحْزِيئِيل (ID: `person:Jahaziel.5`); Gershom (ID: `person:Gershom.2`); أَدونِيقَامَ (ID: `person:Adonikam`); دَاودَ (ID: `person:David`); بَابِلَ (ID: `place:Babylon`); إِيثَامَارَ (ID: `person:Ithamar`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فِينَحَاس (ID: `person:Phinehas`)
...
* **Associated ACAI Concepts:** أَلِيعَزَرَ (ID: `person:Eliezer.8`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); يَارِيبَ (ID: `person:Jarib.2`); زَكَرِيَّا (ID: `person:Zechariah.20`); يَدّو (ID: `person:Iddo`); نَاثَان (ID: `person:Nathan.5`); شِمْعِيَا (ID: `person:Shemaiah.15`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); يويَارِيبَ (ID: `person:Joiarib.2`); ٱلْمسَمَّى (ID: `place:Casiphia`); مَشلَّام (ID: `person:Meshullam.9`); أَرِيئِيلَ (ID: `person:Ariel`); ٱلرَّبِّ (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); لَّاوِي (ID: `group:Levi`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `person:Levi.3`); إِسْرَائِيلَ (ID: `person:Israel`); Insight (ID: `keyterm:Insight`); مَحْلِي (ID: `person:Mahli`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); كَنْعَان (ID: `place:Canaan`); Egyptians (ID: `group:Egypt`); لَّاوِي (ID: `group:Levi`); Ammonites (ID: `group:Ammon`); موآبَ (ID: `place:Moab`); حِثًّا (ID: `person:Heth`); Canaanites (ID: `group:Canaan`); Be Unfaithful (ID: `keyterm:Unfaithful`); مِصْرَ (ID: `place:Egypt`); لَّاوِي (ID: `person:Levi.3`); إِسْرَائِيلَ (ID: `person:Israel`); Jebusites (ID: `group:Jebusites`); Amorites (ID: `group:Amorites`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); Passion (ID: `keyterm:Ardour`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); Counsel (ID: `keyterm:Counsel`); عِيلَامَ (ID: `person:Elam`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Offering (ID: `keyterm:Offering`); مَتَّنْيَا (ID: `person:Mattaniah.5`); شَارَاي (ID: `person:Sharai`); وكَلوهِي (ID: `person:Cheluhi`); مَتَّنْيَا (ID: `person:Mattaniah.7`); عزِّيَّا (ID: `person:Uzziah.4`); شَلَمْيَا (ID: `person:Shelemiah.3`); يِزِّيَّا (ID: `person:Izziah`); أَلْعَاسَةَ (ID: `person:Elasah`); مَرِيموث (ID: `person:Meremoth.2`); عَدَايَا (ID: `person:Adaiah.6`); شَلَمْيَا (ID: `person:Shelemiah.2`); عَدَايَا (ID: `person:Adaiah.5`); يَهونَاثَان (ID: `person:Jehohanan.4`); مَلْكِيَّا (ID: `person:Malchijah.5`); يَهوذَا (ID: `person:Judah.5`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); Defilement (ID: `keyterm:Defilement`); Peace (ID: `keyterm:IntactState`); أورشَلِيمَ (ID: `place:Jerusalem`); فَارِسَ (ID: `place:Persia`); To Cause to Possess (ID: `keyterm:Possess`); إِسْرَائِيلَ (ID: `person:Israel`); Kindness (ID: `keyterm:Kindness`); Plea for Mercy (ID: `keyterm:Supplication`); Dispossess (ID: `keyterm:Dispossess`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); أورشَلِيمَ (ID: `place:Jerusalem`); فَارِسَ (ID: `place:Persia`); Kindness (ID: `keyterm:Kindness`); Plea for Mercy (ID: `keyterm:Supplication`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** Repent (ID: `keyterm:Repent`); ٱلرَّبِّ (ID: `deity:Lord`); عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَكَنْيَا (ID: `person:Shecaniah.7`); يَحِيئِيل (ID: `person:Jehiel.8`); ٱلرَّبِّ (ID: `deity:Lord`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`)
...
* **Associated ACAI Concepts:** Covenant (ID: `keyterm:Covenant`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Counsel (ID: `keyterm:Counsel`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `group:Levi`); Swear (ID: `keyterm:Swear`); عَزْرَا (ID: `person:Ezra`); لَّاوِي (ID: `person:Levi.3`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `person:Benjamin`); بَنْيَامِينَ (ID: `group:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** تِقْوَةَ (ID: `person:Tikvah.2`); شَبْتَاي (ID: `person:Shabbethai`); مَشلَّام (ID: `person:Meshullam.10`); يونَاثَانَ (ID: `person:Jonathan.10`); عَسَائِيل (ID: `person:Asahel.4`); يَحْزِيَا (ID: `person:Jahzeiah`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`)
