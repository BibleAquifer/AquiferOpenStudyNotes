...
* **Associated ACAI Concepts:** Filemom (ID: `person:Philemon`); Timóteo (ID: `person:Timothy`); Jesus (ID: `person:Jesus.2`); Paulo (ID: `person:Paul`); amado (ID: `keyterm:Beloved`)
...
* **Associated ACAI Concepts:** holy (ID: `keyterm:Holy`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); love (ID: `keyterm:Love`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); comunhão (ID: `keyterm:Fellowship`); orar (ID: `keyterm:Pray`); compaixão (ID: `keyterm:Affection`); rogar (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** comunhão (ID: `keyterm:Fellowship`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); Good (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); em cristo (ID: `keyterm:InChrist`); Paulo (ID: `person:Paul`); love (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** servir (ID: `keyterm:Serve`); Good (ID: `keyterm:Good`); boa notícia (ID: `keyterm:GoodNews`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Lucas (ID: `person:Luke`); Epafras (ID: `person:Epaphras`); Demas (ID: `person:Demas`); Aristarco (ID: `person:Aristarchus`); em cristo (ID: `keyterm:InChrist`); Marcos (ID: `person:Mark`); favor (ID: `keyterm:Favor`); Spirit (ID: `keyterm:Spirit.2`)
