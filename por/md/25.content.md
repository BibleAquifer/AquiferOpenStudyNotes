...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); rebel (ID: `keyterm:Rebel`); Jerusalém (ID: `place:Jerusalem`); strength (ID: `keyterm:Strength`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); love (ID: `keyterm:Love`); Deceit (ID: `keyterm:Deceit`); work (ID: `keyterm:Work`); Mighty One (ID: `keyterm:MightyOne`); defilement (ID: `keyterm:Defilement`); To Sin (ID: `keyterm:Sin`); Israel (ID: `person:Israel`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); appointed feast (ID: `keyterm:AppointedFeast`); Train (ID: `realia:Train`); Winepress (ID: `realia:Winepress`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Deer (ID: `fauna:Deer`); House (ID: `realia:House`); Yoke (ID: `realia:Yoke`); Net (ID: `realia:Net`); Grass (ID: `flora:Grass`); Casting Net (ID: `realia:CastingNet`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); defilement (ID: `keyterm:Defilement`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); To Sin (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** rebel (ID: `keyterm:Rebel`); SENHOR (ID: `deity:Lord`); strength (ID: `keyterm:Strength`); Yoke (ID: `realia:Yoke`)
...
* **Associated ACAI Concepts:** Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Mighty One (ID: `keyterm:MightyOne`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); horn (ID: `keyterm:Horn`); Israel (ID: `person:Israel`); Tent (ID: `realia:Tent`); Bow (ID: `realia:Bow`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); sabbath (ID: `keyterm:Sabbath`); appointed feast (ID: `keyterm:AppointedFeast`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** appointed feast (ID: `keyterm:AppointedFeast`); SENHOR (ID: `deity:Lord`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Wormwood (ID: `flora:Wormwood`); Arrow (ID: `realia:Arrow`); kindness (ID: `keyterm:Kindness`); arrow (ID: `keyterm:Arrow`); peace (ID: `keyterm:IntactState`); Complete (ID: `keyterm:Complete`); Lion (ID: `fauna:Lion`); Bear (ID: `fauna:Bear`); Bow (ID: `realia:Bow`); Hewn Stone (ID: `realia:HewnStone`); Bitter Herbs (ID: `flora:Chicory`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); kindness (ID: `keyterm:Kindness`); rebel (ID: `keyterm:Rebel`); forgive (ID: `keyterm:Forgive`); peace (ID: `keyterm:IntactState`); Complete (ID: `keyterm:Complete`); To Sin (ID: `keyterm:Sin`); hope (ID: `keyterm:Hope`); arrow (ID: `keyterm:Arrow`); comprar (ID: `keyterm:Redeem`); fear (ID: `keyterm:Fear`); salvation (ID: `keyterm:Salvation`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Pit (ID: `realia:Pit`); Wormwood (ID: `flora:Wormwood`); Arrow (ID: `realia:Arrow`); Lion (ID: `fauna:Lion`); Hewn Stone (ID: `realia:HewnStone`); Bow (ID: `realia:Bow`); Yoke (ID: `realia:Yoke`); Bitter Herbs (ID: `flora:Chicory`); Bird (ID: `fauna:Bird`); Bear (ID: `fauna:Bear`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Edom (ID: `place:Edom`); To Sin (ID: `keyterm:Sin`); Uz (ID: `place:Uz`); stain (ID: `keyterm:Stain`); Punishment (ID: `keyterm:Punishment`); Complete (ID: `keyterm:Complete`); Believe In (ID: `keyterm:BelieveIn`); be kindly disposed (ID: `keyterm:KindlyDisposed`); Sodoma (ID: `place:Sodom`); defilement (ID: `keyterm:Defilement`); anointed (ID: `keyterm:Anointed`); Appoint (ID: `keyterm:Appoint`); Ostrich (ID: `fauna:Ostrich`); Jackal (ID: `fauna:Jackal`); Vulture (ID: `fauna:Vulture`); Clay Jar (ID: `realia:ClayJar`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** Edom (ID: `place:Edom`); Uz (ID: `place:Uz`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`); Complete (ID: `keyterm:Complete`); To Sin (ID: `keyterm:Sin`); Appoint (ID: `keyterm:Appoint`)
...
* **Associated ACAI Concepts:** ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`); Edom (ID: `place:Edom`); Complete (ID: `keyterm:Complete`); To Sin (ID: `keyterm:Sin`); Appoint (ID: `keyterm:Appoint`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); Egito (ID: `place:Egypt`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Assyria (ID: `place:Assyria`); ardour (ID: `keyterm:Ardour`); round dance (ID: `keyterm:RoundDance`); to cause to possess (ID: `keyterm:Possess`); Woe (ID: `keyterm:Woe`); Crown (ID: `realia:Crown`); Jackal (ID: `fauna:Jackal`); Hand-Mill (ID: `realia:Hand-mill`); House (ID: `realia:House`); Money (ID: `realia:Money`)
