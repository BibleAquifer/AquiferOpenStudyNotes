...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); craindre (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); Hell (ID: `place:Hell`); faire un voeu (ID: `keyterm:Vow`); Joppa (ID: `place:Joppa`); Amitthaï (ID: `person:Amittai`); Ninive (ID: `place:Nineveh`); bonté (ID: `keyterm:Kindness`); exempt (ID: `keyterm:Exempt`); Hebrews (ID: `group:Hebrews`); Tarsis (ID: `place:Tarshish`); parole du seigneur (ID: `keyterm:WordOfTheLord`); louange (ID: `keyterm:Praise`); destin (ID: `keyterm:Lot`); tuerie (ID: `keyterm:Slaughtering`); aide (ID: `keyterm:Salvation`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Hell (ID: `place:Hell`); bonté (ID: `keyterm:Kindness`); Jonas (ID: `person:Jonah.2`); faire un voeu (ID: `keyterm:Vow`); louange (ID: `keyterm:Praise`); aide (ID: `keyterm:Salvation`); Fish (ID: `fauna:Fish`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** bonté (ID: `keyterm:Kindness`); Éternel (ID: `deity:Lord`); faire un voeu (ID: `keyterm:Vow`); louange (ID: `keyterm:Praise`); aide (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Ninive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); parole du seigneur (ID: `keyterm:WordOfTheLord`); bonté (ID: `keyterm:Kindness`); bienveillant (ID: `keyterm:Generous`); Tarsis (ID: `place:Tarshish`); miséricordieux (ID: `keyterm:Compassionate`); fie (ID: `keyterm:BelieveIn`); Clothing (ID: `realia:Clothing`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Throne (ID: `realia:Throne`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** bonté (ID: `keyterm:Kindness`); bienveillant (ID: `keyterm:Generous`); Éternel (ID: `deity:Lord`); Tarsis (ID: `place:Tarshish`); miséricordieux (ID: `keyterm:Compassionate`)
