...
* **Associated ACAI Concepts:** Éphrata (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); Kiljon (ID: `person:Chilion`); Moab (ID: `place:Moab`); Machlon (ID: `person:Mahlon`); Bethléhem (ID: `place:Bethlehem`); Élimélec (ID: `person:Elimelech`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); grâce (ID: `keyterm:Favor`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Elders (ID: `group:GenericElders`); Éternel (ID: `deity:Lord`); Bethléhem (ID: `place:Bethlehem`); Rachel (ID: `person:Rachel`); Léa (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Hetsron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Obed (ID: `person:Obed`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); David (ID: `person:David`); Isaï (ID: `person:Jesse`); Perets (ID: `person:Perez`); Nahshon (ID: `person:Nahshon`); Boaz (ID: `person:Boaz`)
