...
* **Associated ACAI Concepts:** Éphrata (ID: `person:Ephrathah`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); Kiljon (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Machlon (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Élimélec (ID: `person:Elimelech`); Bethléhem (ID: `place:Bethlehem`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); grâce (ID: `keyterm:Favor`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); laissiez en possession (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Machlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Rachel (ID: `person:Rachel`); Léa (ID: `person:Leah`); Bethléhem (ID: `place:Bethlehem`); Israël (ID: `person:Israel`); Elders (ID: `group:GenericElders`)
...
* **Associated ACAI Concepts:** Juda (ID: `group:Judah`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); Tamar (ID: `person:Tamar`); Perets (ID: `person:Perez`)
...
* **Associated ACAI Concepts:** Salmon (ID: `person:Salmon`); Hetsron (ID: `person:Hezron.2`); Amminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Boaz (ID: `person:Boaz`); David (ID: `person:David`); Nahshon (ID: `person:Nahshon`); Isaï (ID: `person:Jesse`); Perets (ID: `person:Perez`)
