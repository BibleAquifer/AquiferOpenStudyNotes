...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); strength (ID: `keyterm:Strength`); Zealous (ID: `keyterm:Zealous.3`); Libano (ID: `place:Lebanon`); The Way (ID: `keyterm:TheWay`); Carmelo (ID: `place:Carmel`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Basã (ID: `place:Bashan`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); strength (ID: `keyterm:Strength`); wickedness (ID: `keyterm:Wickedness`); Zealous (ID: `keyterm:Zealous.3`); Libano (ID: `place:Lebanon`); The Way (ID: `keyterm:TheWay`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Carmelo (ID: `place:Carmel`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Basã (ID: `place:Bashan`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`); Strong Drink (ID: `realia:StrongDrink`)
...
* **Associated ACAI Concepts:** make a vow (ID: `keyterm:Vow`); wickedness (ID: `keyterm:Wickedness`); peace (ID: `keyterm:IntactState`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); SENHOR (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Grass (ID: `flora:Grass`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Egito (ID: `place:Egypt`); Líbia (ID: `place:Libya`); Pute (ID: `place:Put`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Cush (ID: `place:Cush.2`); lot (ID: `keyterm:Lot`)
