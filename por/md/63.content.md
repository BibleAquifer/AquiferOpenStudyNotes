...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); escolhido (ID: `keyterm:Chosen`); fazer a paz (ID: `keyterm:Peace`); favor (ID: `keyterm:Favor`); para a eternidade (ID: `keyterm:Always`); misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** fazer a paz (ID: `keyterm:Peace`); love (ID: `keyterm:Love`); favor (ID: `keyterm:Favor`); misericórdia (ID: `keyterm:Mercy`); Truth (ID: `keyterm:Truth`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); love (ID: `keyterm:Love`); andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); compartilhar (ID: `keyterm:Share`); rogar (ID: `keyterm:AskFor`); corpo (ID: `keyterm:Body.3`); Ability (ID: `keyterm:Ability`); House (ID: `realia:House`)
