...
* **Associated ACAI Concepts:** Colossos (ID: `place:Colossae`); fazer a paz (ID: `keyterm:Peace`); holy (ID: `keyterm:Holy`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); Faithfulness (ID: `keyterm:Faithfulness`); em cristo (ID: `keyterm:InChrist`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); orar (ID: `keyterm:Pray`); holy (ID: `keyterm:Holy`); Truth (ID: `keyterm:Truth`); andar (ID: `keyterm:Live.3`); livrar (ID: `keyterm:Deliver`); Epafras (ID: `person:Epaphras`); amado (ID: `keyterm:Beloved`); boa notícia (ID: `keyterm:GoodNews`); Good (ID: `keyterm:Good`); To Sin (ID: `keyterm:Sin`); favor (ID: `keyterm:Favor`); Faithfulness (ID: `keyterm:Faithfulness`); hope (ID: `keyterm:Hope`); em cristo (ID: `keyterm:InChrist`); reino (ID: `keyterm:Kingdom`); Holy Spirit (ID: `deity:HolySpirit`); Cause of Joy (ID: `keyterm:CauseOfJoy`); céu (ID: `keyterm:Heaven`); crer (ID: `keyterm:Believe`); autoridade (ID: `keyterm:Authority.2`); libertação (ID: `keyterm:Liberation`); forgive (ID: `keyterm:Forgive`)
...
* **Associated ACAI Concepts:** andar (ID: `keyterm:Live.3`); Good (ID: `keyterm:Good`); orar (ID: `keyterm:Pray`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** livrar (ID: `keyterm:Deliver`); love (ID: `keyterm:Love`); holy (ID: `keyterm:Holy`); Ability (ID: `keyterm:Ability`); autoridade (ID: `keyterm:Authority.2`); SENHOR (ID: `deity:Lord`); reino (ID: `keyterm:Kingdom`)
...
* **Associated ACAI Concepts:** céu (ID: `keyterm:Heaven`); fazer a paz (ID: `keyterm:Peace`); igreja (ID: `keyterm:Church`); Ability (ID: `keyterm:Ability`); reconciliar (ID: `keyterm:Reconcile`); SENHOR (ID: `deity:Lord`); autoridade (ID: `keyterm:Authority.2`); sangue (ID: `keyterm:Blood`); corpo (ID: `keyterm:Body.3`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** irrepreensível (ID: `keyterm:Unblemished`); irrepreensível (ID: `keyterm:WithoutReproach`); céu (ID: `keyterm:Heaven`); proclamar (ID: `keyterm:Proclaim`); boa notícia (ID: `keyterm:GoodNews`); holy (ID: `keyterm:Holy`); crer (ID: `keyterm:Believe`); Paulo (ID: `person:Paul`); corpo (ID: `keyterm:Body.3`); hope (ID: `keyterm:Hope`); mente (ID: `keyterm:Mind.2`)
...
* **Associated ACAI Concepts:** céu (ID: `keyterm:Heaven`); proclamar (ID: `keyterm:Proclaim`); boa notícia (ID: `keyterm:GoodNews`); crer (ID: `keyterm:Believe`); Paulo (ID: `person:Paul`); hope (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); Ability (ID: `keyterm:Ability`); igreja (ID: `keyterm:Church`); coração (ID: `keyterm:Heart`); Spirit (ID: `keyterm:Spirit.2`); para a eternidade (ID: `keyterm:Always`); Glory (ID: `keyterm:Glory`); proclamar (ID: `keyterm:Proclaim`); holy (ID: `keyterm:Holy`); exortar (ID: `keyterm:Encourage`); hope (ID: `keyterm:Hope`); em cristo (ID: `keyterm:InChrist`); love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`); Laodiceia (ID: `place:Laodicea`); Gentiles (ID: `group:Gentile`); rogar (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** corpo (ID: `keyterm:Body.3`); Jesus (ID: `person:Jesus.2`); Spirit (ID: `keyterm:Spirit.2`); love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); exortar (ID: `keyterm:Encourage`); Laodiceia (ID: `place:Laodicea`); coração (ID: `keyterm:Heart`); rogar (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); corpo (ID: `keyterm:Body.3`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); autoridade (ID: `keyterm:Authority.2`); batismo (ID: `keyterm:Baptism`); vazio (ID: `keyterm:Empty`); divino (ID: `keyterm:Divine`); tradição (ID: `keyterm:Teaching`); elementos (ID: `keyterm:FundamentalPrinciples`); In Reality (ID: `keyterm:InReality`); Circumcision (ID: `keyterm:Circumcision`); SENHOR (ID: `deity:Lord`); levantamento (ID: `keyterm:Resurrection`); andar (ID: `keyterm:Live.3`); forgive (ID: `keyterm:Forgive`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** corpo (ID: `keyterm:Body.3`); Jesus (ID: `person:Jesus.2`); elementos (ID: `keyterm:FundamentalPrinciples`); sabbath (ID: `keyterm:Sabbath`); Ability (ID: `keyterm:Ability`); decidir (ID: `keyterm:Decided`); An Angel (ID: `deity:Angel`); SENHOR (ID: `deity:Lord`); religião auto, imposta (ID: `keyterm:SelfImposedReligion`); piedade (ID: `keyterm:GodlyReverence`); Life (ID: `keyterm:Life`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Scythians (ID: `group:Scythians`); pensar (ID: `keyterm:Think`); Glory (ID: `keyterm:Glory`); Greeks (ID: `group:Greek`); defilement (ID: `keyterm:Defilement`); idolatria (ID: `keyterm:Idolatry`); levantamento (ID: `keyterm:Resurrection`); Jews (ID: `group:Jews`); Circumcision (ID: `keyterm:Circumcision`); Javã (ID: `person:Javan`); blasfemar (ID: `keyterm:Blaspheme`); fornication (ID: `keyterm:Fornication`); andar (ID: `keyterm:Live.3`)
...
* **Associated ACAI Concepts:** Scythians (ID: `group:Scythians`); Greeks (ID: `group:Greek`); Circumcision (ID: `keyterm:Circumcision`); Javã (ID: `person:Javan`); Jews (ID: `group:Jews`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); coração (ID: `keyterm:Heart`); misericórdia (ID: `keyterm:Mercy`); kindness (ID: `keyterm:Kindness`); fazer a paz (ID: `keyterm:Peace`); escolhido (ID: `keyterm:Chosen`); holy (ID: `keyterm:Holy`); Ability (ID: `keyterm:Ability`); compaixão (ID: `keyterm:Affection`); favor (ID: `keyterm:Favor`); corpo (ID: `keyterm:Body.3`); forgive (ID: `keyterm:Forgive`); Name (ID: `keyterm:Name`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); to act wickedly (ID: `keyterm:ActWickedly`); favoritismo (ID: `keyterm:Partiality`); fear (ID: `keyterm:Fear`); céu (ID: `keyterm:Heaven`); love (ID: `keyterm:Love`); servir como escravo (ID: `keyterm:Serve.2`); corpo (ID: `keyterm:Body.3`); be (or show oneself) just (ID: `keyterm:Just`); coração (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** Laodiceia (ID: `place:Laodicea`); Jesus (ID: `person:Jesus.2`); amado (ID: `keyterm:Beloved`); igreja (ID: `keyterm:Church`); SENHOR (ID: `deity:Lord`); Faithfulness (ID: `keyterm:Faithfulness`); Aristarco (ID: `person:Aristarchus`); Epafras (ID: `person:Epaphras`); Onésimo (ID: `person:Onesimus`); Justo (ID: `person:Justus.3`); Tíquico (ID: `person:Tychicus`); Lucas (ID: `person:Luke`); Ninfa (ID: `person:Nympha`); Hierápolis (ID: `place:Hierapolis`); Arquipo (ID: `person:Archippus`); Demas (ID: `person:Demas`); orar (ID: `keyterm:Pray`); Paulo (ID: `person:Paul`); To Command (ID: `keyterm:Command`); coração (ID: `keyterm:Heart`); testemunhar (ID: `keyterm:BearWitness`); To Cause to Happen (ID: `keyterm:Happen`); servir (ID: `keyterm:Serve`); Barnabé (ID: `person:Barnabas`); Circumcision (ID: `keyterm:Circumcision`); Commandment (ID: `keyterm:Commandment`); Laodiceans (ID: `group:Laodicea`); exortar (ID: `keyterm:Encourage`); favor (ID: `keyterm:Favor`); Complete (ID: `keyterm:Complete`); reino (ID: `keyterm:Kingdom`); Marcos (ID: `person:Mark`); rogar (ID: `keyterm:AskFor`); Temple (ID: `realia:Temple`); Chain (ID: `realia:Chain`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Arquipo (ID: `person:Archippus`); servir (ID: `keyterm:Serve`); To Command (ID: `keyterm:Command`); Jesus (ID: `person:Jesus.2`); To Cause to Happen (ID: `keyterm:Happen`)
