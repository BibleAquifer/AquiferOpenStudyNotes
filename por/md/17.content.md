...
* **Associated ACAI Concepts:** Bizta (ID: `person:Biztha`); Bigtá (ID: `person:Bigtha`); Meumã (ID: `person:Mehuman`); Carcas (ID: `person:Carkas`); Zetar (ID: `person:Zethar`); Abagta (ID: `person:Abagtha`); Harbona (ID: `person:Harbona`); Assuero (ID: `person:Ahasuerus`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Vasti (ID: `person:Vashti`); Medes (ID: `group:Mede`); Persians (ID: `group:Persia`); Pérsia (ID: `place:Persia`); Assuero (ID: `person:Ahasuerus`); Medã (ID: `person:Medan`)
...
* **Associated ACAI Concepts:** Nabucodonozor (ID: `person:Nebuchadnezzar`); Babilônia (ID: `place:Babylon`); Jeoaquim (ID: `person:Jehoiachin`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Ester (ID: `person:Esther`); love (ID: `keyterm:Love`); favor (ID: `keyterm:Favor`); Vasti (ID: `person:Vashti`); kindness (ID: `keyterm:Kindness`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Zeres (ID: `person:Zeresh`); love (ID: `keyterm:Love`); Ester (ID: `person:Esther`); Glory (ID: `keyterm:Glory`); Jews (ID: `group:Jews`); A Group of People (ID: `group:GenericGroup`); House (ID: `realia:House`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Zeres (ID: `person:Zeresh`); love (ID: `keyterm:Love`); Mordecai (ID: `person:Mordecai.2`); A Group of People (ID: `group:GenericGroup`); Hamã (ID: `person:Haman`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Zeres (ID: `person:Zeresh`); love (ID: `keyterm:Love`); Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); A Group of People (ID: `group:GenericGroup`); Hamã (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Ester (ID: `person:Esther`); Hamã (ID: `person:Haman`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Bed (ID: `realia:Bed`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Agague (ID: `person:Agag.2`); Ester (ID: `person:Esther`); Agagites (ID: `group:Agag`); Jews (ID: `group:Jews`); beg for mercy (ID: `keyterm:BegForMercy`); Hamã (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Hamedata (ID: `person:Hammedatha`); Agague (ID: `person:Agag.2`); Agagites (ID: `group:Agag`); favor (ID: `keyterm:Favor`); Jews (ID: `group:Jews`); Hamã (ID: `person:Haman`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Farmasta (ID: `person:Parmashta`); Adalia (ID: `person:Adalia`); Vaizata (ID: `person:Vaizatha`); Aridata (ID: `person:Aridatha`); Aspata (ID: `person:Aspatha`); Aridai (ID: `person:Aridai`); Parsandata (ID: `person:Parshandatha`); Arisai (ID: `person:Arisai`); Porata (ID: `person:Poratha`); Dalfom (ID: `person:Dalphon`); Hamedata (ID: `person:Hammedatha`); Hamã (ID: `person:Haman`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Susã (ID: `place:Susa`); Hamã (ID: `person:Haman`); Ester (ID: `person:Esther`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Lot (ID: `realia:Lot`); Hamedata (ID: `person:Hammedatha`); Agague (ID: `person:Agag.2`); Mordecai (ID: `person:Mordecai.2`); Agagites (ID: `group:Agag`); Hamã (ID: `person:Haman`); lot (ID: `keyterm:Lot`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Ester (ID: `person:Esther`); Jews (ID: `group:Jews`); Mordecai (ID: `person:Mordecai.2`); Scroll (ID: `realia:Scroll`); Abiail (ID: `person:Abihail.5`); peace (ID: `keyterm:IntactState`); Assuero (ID: `person:Ahasuerus`); Truth (ID: `keyterm:Truth`)
