...
* **Associated ACAI Concepts:** Ephrata (ID: `person:Ephrathah`); Chelión (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Efratita (ID: `group:Ephrathah`); Catah (ID: `place:Bethlehem`); Judá (ID: `person:Judah.4`); Moab (ID: `place:Moab`); Judá (ID: `group:Judah`); Elimelech (ID: `person:Elimelech`); Mahalón (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); bendecir (ID: `keyterm:Bless`); bondad (ID: `keyterm:Kindness`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Booz (ID: `person:Boaz`); Moab (ID: `place:Moab`); Noemi (ID: `person:Naomi`); dejar en herencia (ID: `keyterm:Possess`)
...
* **Associated ACAI Concepts:** Lea (ID: `person:Leah`); Catah (ID: `place:Bethlehem`); Israel (ID: `person:Israel`); Jehová (ID: `deity:Lord`); Rachêl (ID: `person:Rachel`); Elders (ID: `group:GenericElders`)
...
* **Associated ACAI Concepts:** Phares (ID: `person:Perez`); Judá (ID: `person:Judah.4`); Thamar (ID: `person:Tamar`); Judá (ID: `group:Judah`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Hesrón (ID: `person:Hezron.2`); Salmón (ID: `person:Salmon`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Nahasón (ID: `person:Nahshon`); Phares (ID: `person:Perez`); Booz (ID: `person:Boaz`); David (ID: `person:David`); Isaí (ID: `person:Jesse`)
