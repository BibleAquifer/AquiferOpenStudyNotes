...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Beloved (ID: `keyterm:Beloved`); Truth (ID: `keyterm:Truth`); ٱلرَّبِّ (ID: `deity:Lord`); Church (ID: `keyterm:Church`); Faithfulness (ID: `keyterm:Faithfulness`); Obligated (ID: `keyterm:Ought`); Name (ID: `keyterm:Name`); Bear Witness (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** Church (ID: `keyterm:Church`); دِيوتْرِيفِسَ (ID: `person:Diotrephes`); دِيمِتْرِيوس (ID: `person:Demetrius`); Good (ID: `keyterm:Good`); Beloved (ID: `keyterm:Beloved`); True (ID: `keyterm:True`); ٱلرَّبِّ (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); Do Good (ID: `keyterm:DoGood`); Bear Witness (ID: `keyterm:BearWitness`)
