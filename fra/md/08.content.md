...
* **Associated ACAI Concepts:** Kiljon (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Éphrata (ID: `person:Ephrathah`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); Bethléhem (ID: `place:Bethlehem`); Juda (ID: `group:Judah`); Élimélec (ID: `person:Elimelech`); Moab (ID: `place:Moab`); Machlon (ID: `person:Mahlon`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Bethléhem (ID: `place:Bethlehem`); Naomi (ID: `person:Naomi`); Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** bonté (ID: `keyterm:Kindness`); Naomi (ID: `person:Naomi`); benir (ID: `keyterm:Bless`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Bethléhem (ID: `place:Bethlehem`); Elders (ID: `group:GenericElders`); Rachel (ID: `person:Rachel`); Léa (ID: `person:Leah`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Hetsron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Amminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Perets (ID: `person:Perez`); Nahshon (ID: `person:Nahshon`); Boaz (ID: `person:Boaz`); David (ID: `person:David`); Isaï (ID: `person:Jesse`)
