...
* **Associated ACAI Concepts:** kebenaran (ID: `keyterm:Truth`); kekasih (ID: `keyterm:Beloved`); hidup (ID: `keyterm:Live.3`); Gayus (ID: `person:Gaius.4`); bersaksi (ID: `keyterm:BearWitness`); berdoa (ID: `keyterm:Pray`); Cause of Joy (ID: `keyterm:CauseOfJoy`); kasihi (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** kesetiaan (ID: `keyterm:Faithfulness`); kebenaran (ID: `keyterm:Truth`); bersaksi (ID: `keyterm:BearWitness`); Tuhan (ID: `deity:Lord`); nama (ID: `keyterm:Name`); kekasih (ID: `keyterm:Beloved`); wajib (ID: `keyterm:Ought`); jemaat (ID: `keyterm:Church`); kasihi (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); jemaat (ID: `keyterm:Church`); kasihi (ID: `keyterm:Love`); bersaksi (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** jemaat (ID: `keyterm:Church`); Diotrefes (ID: `person:Diotrephes`); Demetrius (ID: `person:Demetrius`); kebenaran (ID: `keyterm:Truth`); bersaksi (ID: `keyterm:BearWitness`); Tuhan (ID: `deity:Lord`); yang baik (ID: `keyterm:Good`); benar (ID: `keyterm:True`); kekasih (ID: `keyterm:Beloved`); lakukan baik (ID: `keyterm:DoGood`)
...
* **Associated ACAI Concepts:** Ink (ID: `realia:Ink`); Pen (ID: `realia:Pen`); memperdamaikan (ID: `keyterm:Peace`); nama (ID: `keyterm:Name`); harapan (ID: `keyterm:Hope`); Reed (ID: `flora:Reed`)
