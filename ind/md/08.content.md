...
* **Associated ACAI Concepts:** Efrata (ID: `person:Ephrathah`); Ephrathites (ID: `group:Ephrathah`); Mahlon (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Yehuda (ID: `group:Judah`); Yehuda (ID: `person:Judah.4`); Mahlon (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Elimelekh (ID: `person:Elimelech`); Betlehem (ID: `place:Bethlehem`)
...
* **Associated ACAI Concepts:** Rut (ID: `person:Ruth`); menyebabkan memiliki (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Mahlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Rahel (ID: `person:Rachel`); Lea (ID: `person:Leah`); Betlehem (ID: `place:Bethlehem`); Israel (ID: `person:Israel`); Elders (ID: `group:GenericElders`)
...
* **Associated ACAI Concepts:** Yehuda (ID: `group:Judah`); Tuhan (ID: `deity:Lord`); Yehuda (ID: `person:Judah.4`); Tamar (ID: `person:Tamar`); Peres (ID: `person:Perez`)
...
* **Associated ACAI Concepts:** memperanakkan (ID: `person:Salmon`); Hezron (ID: `person:Hezron.2`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Boas (ID: `person:Boaz`); Daud (ID: `person:David`); Nahason (ID: `person:Nahshon`); Isai (ID: `person:Jesse`); Peres (ID: `person:Perez`)
