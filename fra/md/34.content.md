...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); déclarer innocent (ID: `keyterm:PronounceInnocent`); chemin (ID: `keyterm:TheWay`); zélé (ID: `keyterm:Zealous.3`); Liban (ID: `place:Lebanon`); Carmel (ID: `place:Carmel`); Basan (ID: `place:Bashan`); force (ID: `keyterm:Strength`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); se réfugier (ID: `keyterm:SeekfindRefuge`); déclarer innocent (ID: `keyterm:PronounceInnocent`); chemin (ID: `keyterm:TheWay`); zélé (ID: `keyterm:Zealous.3`); Liban (ID: `place:Lebanon`); Basan (ID: `place:Bashan`); Carmel (ID: `place:Carmel`); force (ID: `keyterm:Strength`); méchanceté (ID: `keyterm:Wickedness`); Fortress (ID: `realia:Fortress`); Strong Drink (ID: `realia:StrongDrink`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** force (ID: `keyterm:Strength`); Éternel (ID: `deity:Lord`); chemin (ID: `keyterm:TheWay`); déclarer innocent (ID: `keyterm:PronounceInnocent`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); se réfugier (ID: `keyterm:SeekfindRefuge`); méchanceté (ID: `keyterm:Wickedness`); Fortress (ID: `realia:Fortress`); Strong Drink (ID: `realia:StrongDrink`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); House (ID: `realia:House`); Graven Image (ID: `realia:GravenImage`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated ACAI Concepts:** faire un voeu (ID: `keyterm:Vow`); état intact (ID: `keyterm:IntactState`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); méchanceté (ID: `keyterm:Wickedness`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); Éternel (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Flock (ID: `fauna:Flock`); Grass (ID: `flora:Grass`); Chariot (ID: `realia:Chariot`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Puth (ID: `place:Put`); Cush (ID: `place:Cush.2`); destin (ID: `keyterm:Lot`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Libya (ID: `place:Libya`); Égypte (ID: `place:Egypt`)
