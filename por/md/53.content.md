...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Tessalônica (ID: `place:Thessalonica`); Timóteo (ID: `person:Timothy`); favor (ID: `keyterm:Favor`); igreja (ID: `keyterm:Church`); Paulo (ID: `person:Paul`); Thessalonians (ID: `group:Thessalonica`); fazer a paz (ID: `keyterm:Peace`); Silas (ID: `person:Silas`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); igreja (ID: `keyterm:Church`); tribunal de justiça (ID: `keyterm:CourtCase`); love (ID: `keyterm:Love`); reino (ID: `keyterm:Kingdom`); ser glorificado (ID: `keyterm:Glorified`); Glory (ID: `keyterm:Glory`); céu (ID: `keyterm:Heaven`); An Angel (ID: `deity:Angel`); boa notícia (ID: `keyterm:GoodNews`); dever (ID: `keyterm:Ought`); para a eternidade (ID: `keyterm:Always`); juízo (ID: `keyterm:Judgment`); fazer justiça (ID: `keyterm:GrantJustice`); Ability (ID: `keyterm:Ability`); holy (ID: `keyterm:Holy`); testemunhar (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); juízo (ID: `keyterm:Judgment`); tribunal de justiça (ID: `keyterm:CourtCase`); reino (ID: `keyterm:Kingdom`); be (or show oneself) just (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); To Cause to Happen (ID: `keyterm:Happen`); Ability (ID: `keyterm:Ability`); Good (ID: `keyterm:Good`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); To Cause to Happen (ID: `keyterm:Happen`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); Good (ID: `keyterm:Good`); crer (ID: `keyterm:Believe`); ser glorificado (ID: `keyterm:Glorified`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); ser glorificado (ID: `keyterm:Glorified`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); crer (ID: `keyterm:Believe`); Spirit (ID: `keyterm:Spirit.2`); maravilha (ID: `keyterm:Portent`); decidir (ID: `keyterm:Decided`); wipe (out), destroy (ID: `keyterm:Destroy`); Satanás (ID: `deity:Satan`); objeto de culto (ID: `keyterm:ObjectOfWorship`); Ability (ID: `keyterm:Ability`); example (ID: `keyterm:Example`); rogar (ID: `keyterm:AskFor`); injustiça (ID: `keyterm:UnjustDeed`); salvation (ID: `keyterm:Salvation`); love (ID: `keyterm:Love`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); para a eternidade (ID: `keyterm:Always`); Jesus (ID: `person:Jesus.2`); hope (ID: `keyterm:Hope`); rogar (ID: `keyterm:AskFor`); Good (ID: `keyterm:Good`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); livrar (ID: `keyterm:Deliver`); Faithfulness (ID: `keyterm:Faithfulness`); SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); Glory (ID: `keyterm:Glory`); persuadir (ID: `keyterm:Persuade`); crer (ID: `keyterm:Believe`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); andar (ID: `keyterm:Live.3`); tradição (ID: `keyterm:Teaching`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); rogar (ID: `keyterm:AskFor`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); autoridade (ID: `keyterm:Authority.2`)
