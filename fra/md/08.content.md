...
* **Associated ACAI Concepts:** Kiljon (ID: `person:Chilion`); Éphrata (ID: `person:Ephrathah`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); Naomi (ID: `person:Naomi`); Juda (ID: `person:Judah.4`); Moab (ID: `place:Moab`); Bethléhem (ID: `place:Bethlehem`); Élimélec (ID: `person:Elimelech`); Juda (ID: `group:Judah`); Machlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Bethléhem (ID: `place:Bethlehem`); Ruth (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** grâce (ID: `keyterm:Favor`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); Ruth (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); laissiez en possession (ID: `keyterm:Possess`); Boaz (ID: `person:Boaz`)
...
* **Associated ACAI Concepts:** Machlon (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); laissiez en possession (ID: `keyterm:Possess`)
...
* **Associated ACAI Concepts:** Bethléhem (ID: `place:Bethlehem`); Rachel (ID: `person:Rachel`); Éternel (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); Israël (ID: `person:Israel`); Léa (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Tamar (ID: `person:Tamar`); Juda (ID: `person:Judah.4`); Éternel (ID: `deity:Lord`); Juda (ID: `group:Judah`); Perets (ID: `person:Perez`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); benir (ID: `keyterm:Bless`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Salmon (ID: `person:Salmon`); Hetsron (ID: `person:Hezron.2`); Obed (ID: `person:Obed`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Nahshon (ID: `person:Nahshon`); Isaï (ID: `person:Jesse`); Perets (ID: `person:Perez`); David (ID: `person:David`); Boaz (ID: `person:Boaz`)
