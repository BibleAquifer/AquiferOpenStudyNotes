...
* **Associated ACAI Concepts:** Pérsia (ID: `place:Persia`); Ciro (ID: `person:Cyrus`); Jeremias (ID: `person:Jeremiah.6`); SENHOR (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Pérsia (ID: `place:Persia`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Jeremias (ID: `person:Jeremiah.6`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Benjamim (ID: `person:Benjamin`); Benjamim (ID: `group:Benjamin`); Judá (ID: `person:Judah.4`); Levi (ID: `group:Levi`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Nabucodonozor (ID: `person:Nebuchadnezzar`); Ciro (ID: `person:Cyrus`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Pérsia (ID: `place:Persia`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `group:Judah`); Ciro (ID: `person:Cyrus`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Money (ID: `realia:Money`); Babilônia (ID: `place:Babylon`); Jerusalém (ID: `place:Jerusalem`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Salomão (ID: `person:Solomon`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `group:Levi`); Asná (ID: `person:Asnah`); Necoda (ID: `person:Nekoda`); Neemias (ID: `person:Nehemiah`); Darcom (ID: `person:Darkon`); Reelaías (ID: `person:Reelaiah`); Nesias (ID: `person:Neziah`); Delaías (ID: `person:Delaiah.3`); Hagabe (ID: `person:Hagab`); Querube (ID: `place:Cherub`); Meunim (ID: `group:Meunim`); Jesua (ID: `person:Jeshua.3`); Jora (ID: `person:Jorah`); Harsa (ID: `person:Harsha`); Barcos (ID: `person:Barkos`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Hatita (ID: `person:Hatita`); Uza (ID: `person:Uzza.2`); Imer (ID: `person:Immer.2`); Jesua (ID: `person:Jeshua`); Hasum (ID: `person:Hashum`); Lebana (ID: `person:Lebanah`); Bebai (ID: `person:Bebai`); Magbis (ID: `place:Magbish`); Soferete (ID: `person:Sophereth`)
...
* **Associated ACAI Concepts:** Reelaías (ID: `person:Reelaiah`); Bigvai (ID: `person:Bigvai`); Seraias (ID: `person:Seraiah.6`); Baana (ID: `person:Baanah.3`); Reum (ID: `person:Rehum`); Mispar (ID: `person:Mispar`); Mordecai (ID: `person:Mordecai`); Bilsã (ID: `person:Bilshan`); Neemias (ID: `person:Nehemiah`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Adim (ID: `person:Adin`); Zatu (ID: `person:Zattu.2`); Elam (ID: `person:Elam`); Ezequias (ID: `person:Hezekiah.2`); Jesua (ID: `person:Jeshua.3`); Jora (ID: `person:Jorah`); Bezai (ID: `person:Bezai`); Zacai (ID: `person:Zaccai.2`); Adonicão (ID: `person:Adonikam`); Sephatias (ID: `person:Shephatiah.6`); Ará (ID: `person:Arah.2`); Joabe (ID: `person:Joab.3`); Parós (ID: `person:Parosh`); Ater (ID: `person:Ater`); Hasum (ID: `person:Hashum`); Paate-Moabe (ID: `person:Pahath-moab`); Bebai (ID: `person:Bebai`); Bani (ID: `person:Bani`); Asgade (ID: `person:Azgad`); Bigvai (ID: `person:Bigvai.2`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Harim (ID: `person:Harim.2`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Hadide (ID: `place:Hadid`); Netofa (ID: `place:Netophah`); Magbis (ID: `place:Magbish`); Senaa (ID: `place:Senaah`); Nebo (ID: `place:Nebo.2`); Lode (ID: `place:Lod`); Cefira (ID: `place:Chephirah`); Elam (ID: `person:Elam`); Ono (ID: `place:Ono`); Micmás (ID: `place:Michmash`); Jericó (ID: `place:Jericho`); Ai (ID: `place:Ai`); Betel (ID: `place:Bethel`); Beerote (ID: `place:Beeroth`); Anatote (ID: `place:Anathoth`); Geba (ID: `place:Geba`); Ramah (ID: `place:Ramah.2`); Quiriate-Jearim (ID: `place:Kiriath-jearim`); Belém (ID: `place:Bethlehem`)
...
* **Associated ACAI Concepts:** Jesua (ID: `person:Jeshua`); Talmom (ID: `person:Talmon`); Hatita (ID: `person:Hatita`); Ater (ID: `person:Ater.2`); Imer (ID: `person:Immer.2`); Sobai (ID: `person:Shobai`); Jesua (ID: `person:Jeshua.4`); Jedaías (ID: `person:Jedaiah.4`); Hodavias (ID: `person:Hodaviah.4`); Harim (ID: `person:Harim`); Salum (ID: `person:Shallum.8`); Acube (ID: `person:Akkub.2`); Pasur (ID: `person:Pashhur`); Cadmiel (ID: `person:Kadmiel`); Asafe (ID: `person:Asaph.2`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Talmom (ID: `person:Talmon`); Hatita (ID: `person:Hatita`); Ater (ID: `person:Ater.2`); Sobai (ID: `person:Shobai`); Salum (ID: `person:Shallum.8`); Acube (ID: `person:Akkub.2`); Asafe (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** Gidel (ID: `person:Giddel`); Asná (ID: `person:Asnah`); Meída (ID: `person:Mehida`); Queros (ID: `person:Keros`); Padom (ID: `person:Padon`); Hatifa (ID: `person:Hatipha`); Necoda (ID: `person:Nekoda`); Sisera (ID: `person:Sisera.2`); Hanã (ID: `person:Hanan.4`); Tabaote (ID: `person:Tabbaoth`); Gazão (ID: `person:Gazzam`); Nesias (ID: `person:Neziah`); Hasufa (ID: `person:Hasupha`); Salmai (ID: `person:Shalmai`); Rezim (ID: `person:Rezin.2`); Hagabe (ID: `person:Hagab`); Meunim (ID: `group:Meunim`); Hacufa (ID: `person:Hakupha`); Paseia (ID: `person:Paseah.2`); Besai (ID: `person:Besai`); Harsa (ID: `person:Harsha`); Barcos (ID: `person:Barkos`); Uza (ID: `person:Uzza.2`); Bazlite (ID: `person:Bazluth`); Temá (ID: `person:Temah`); Nephushesim (ID: `group:Nephushesim`); Baquebuque (ID: `person:Bakbuk`); Sia (ID: `person:Siaha`); Zia (ID: `person:Ziha`); Lebana (ID: `person:Lebanah`); Harur (ID: `person:Harhur`); Reaías (ID: `person:Reaiah.3`); Hagaba (ID: `person:Hagabah`); Acube (ID: `person:Akkub.3`); Gaar (ID: `person:Gahar`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Sephatias (ID: `person:Shephatiah.7`); Soferete (ID: `person:Sophereth`); Peruda (ID: `person:Peruda`); Hatil (ID: `person:Hattil`); Ami (ID: `person:Ami`); Sotai (ID: `person:Sotai`); Gidel (ID: `person:Giddel.2`); Darcom (ID: `person:Darkon`); Jaala (ID: `person:Jaalah`)
...
* **Associated ACAI Concepts:** Tel-Harsa (ID: `place:Tel-harsha`); Delaías (ID: `person:Delaiah.3`); Necoda (ID: `person:Nekoda.2`); Tobias (ID: `person:Tobiah`); Querube (ID: `place:Cherub`); Adã (ID: `place:Addan`); Imer (ID: `place:Immer`); Tel-Melá (ID: `place:Tel-melah`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Barzillai (ID: `person:Barzillai.3`); Habaiah (ID: `person:Habaiah`); Hacoz (ID: `person:Hakkoz.2`); stain (ID: `keyterm:Stain`); Gileade (ID: `place:Gilead`); Barzillai (ID: `person:Barzillai`); priesthood (ID: `keyterm:Priesthood`); Gileadites (ID: `group:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); strength (ID: `keyterm:Strength`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Mina (ID: `realia:Mina`); Money (ID: `realia:Money`); Tunic (ID: `realia:Tunic`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Josué (ID: `person:Joshua.5`); Pérsia (ID: `place:Persia`); Ciro (ID: `person:Cyrus`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Jesua (ID: `person:Jeshua.4`); Relatives (ID: `group:Relatives`); Esar-Hadom (ID: `person:Esarhaddon`); Henadade (ID: `person:Henadad`); Hodavias (ID: `person:Hodaviah.4`); Cadmiel (ID: `person:Kadmiel`); Instruction (ID: `keyterm:Instruction`); Dario (ID: `person:Darius.2`); terror (ID: `keyterm:Terror`); Tyrians (ID: `group:Tyre`); Sidom (ID: `place:Sidon`); kindness (ID: `keyterm:Kindness`); new moon festival (ID: `keyterm:NewMoonFestival`); Benjamim (ID: `group:Benjamin`); Hodias (ID: `person:Hodiah.2`); Assyria (ID: `place:Assyria`); Libano (ID: `place:Lebanon`); Davi (ID: `person:David`); counsel (ID: `keyterm:Counsel`); appointed feast (ID: `keyterm:AppointedFeast`); Jope (ID: `place:Joppa`); Asafe (ID: `person:Asaph.2`); Tiro (ID: `place:Tyre`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); Moisés (ID: `person:Moses`); holy (ID: `keyterm:Holy`); Benjamim (ID: `person:Benjamin`); Sidonians (ID: `group:Sidon`); Anointing Oil (ID: `realia:AnointingOil`); Cedar (ID: `flora:Cedar`); Cymbals (ID: `realia:Cymbals`); Olive Oil (ID: `realia:OliveOil`); Craftsman (ID: `realia:Craftsman`); Trumpet (ID: `realia:Trumpet`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Josué (ID: `person:Joshua.5`); Instruction (ID: `keyterm:Instruction`); Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Israel (ID: `person:Israel`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Pérsia (ID: `place:Persia`); Libano (ID: `place:Lebanon`); Tyrians (ID: `group:Tyre`); Jope (ID: `place:Joppa`); Sidom (ID: `place:Sidon`); Ciro (ID: `person:Cyrus`); Sidonians (ID: `group:Sidon`); Tiro (ID: `place:Tyre`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Cedar (ID: `flora:Cedar`); Craftsman (ID: `realia:Craftsman`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); SENHOR (ID: `deity:Lord`); Levi (ID: `group:Levi`); Sealtiel (ID: `person:Shealtiel.2`); Jerusalém (ID: `place:Jerusalem`); Josué (ID: `person:Joshua.5`); Levi (ID: `person:Levi.3`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); kindness (ID: `keyterm:Kindness`); Asafe (ID: `person:Asaph.2`); Levi (ID: `group:Levi`); Davi (ID: `person:David`); Levi (ID: `person:Levi.3`); House (ID: `realia:House`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Benjamim (ID: `person:Benjamin`); Benjamim (ID: `group:Benjamin`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Esar-Hadom (ID: `person:Esarhaddon`); SENHOR (ID: `deity:Lord`); Assyria (ID: `place:Assyria`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Pérsia (ID: `place:Persia`); Zorobabel (ID: `person:Zerubbabel.2`); SENHOR (ID: `deity:Lord`); Ciro (ID: `person:Cyrus`); Josué (ID: `person:Joshua.5`); Israel (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Rio Eufrates (ID: `place:Euphrates`); Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Artaxerxes (ID: `person:Artaxerxes.2`); Pérsia (ID: `place:Persia`); Samaria (ID: `place:Samaria`); Jews (ID: `group:Jews`); Ereque (ID: `place:Erech`); Tabeel (ID: `person:Tabeel`); Babylonians (ID: `group:Babylon`); Assuero (ID: `person:Ahasuerus`); Osnapar (ID: `person:Osnappar`); Bislão (ID: `person:Bishlam`); Mitredate (ID: `person:Mithredath.2`); Dinaítas (ID: `person:Dinaite`); Persians (ID: `group:Persia`); Elamites (ID: `group:Elam`); Babilônia (ID: `place:Babylon`); Elam (ID: `place:Elam`); Susã (ID: `place:Susa`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Tabeel (ID: `person:Tabeel`); Bislão (ID: `person:Bishlam`); Mitredate (ID: `person:Mithredath.2`); Pérsia (ID: `place:Persia`); Artaxerxes (ID: `person:Artaxerxes.2`)
...
* **Associated ACAI Concepts:** Ereque (ID: `place:Erech`); Babylonians (ID: `group:Babylon`); Sinsai (ID: `person:Shimshai`); Dinaítas (ID: `person:Dinaite`); Reum (ID: `person:Rehum.2`); Pérsia (ID: `place:Persia`); Persians (ID: `group:Persia`); Susã (ID: `place:Susa`); Elamites (ID: `group:Elam`); Babilônia (ID: `place:Babylon`); Elam (ID: `place:Elam`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Jews (ID: `group:Jews`); Samaria (ID: `place:Samaria`); Sinsai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Reum (ID: `person:Rehum.2`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Dario (ID: `person:Darius.2`); Jews (ID: `group:Jews`); Tattenai (ID: `person:Tattenai`); Zacarias (ID: `person:Zechariah.17`); Ageu (ID: `person:Haggai`); Ido (ID: `person:Iddo.6`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Pérsia (ID: `place:Persia`); Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); Rio Eufrates (ID: `place:Euphrates`); Judá (ID: `person:Judah.4`); Sealtiel (ID: `person:Shealtiel.2`); Josué (ID: `person:Joshua.5`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Zacarias (ID: `person:Zechariah.17`); Ageu (ID: `person:Haggai`); Ido (ID: `person:Iddo.6`); Jews (ID: `group:Jews`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Jerusalém (ID: `place:Jerusalem`); Josué (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Babilônia (ID: `place:Babylon`); Jerusalém (ID: `place:Jerusalem`); Ciro (ID: `person:Cyrus`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Dario (ID: `person:Darius.2`); Zorobabel (ID: `person:Zerubbabel.2`); Tattenai (ID: `person:Tattenai`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Chaldeans (ID: `group:Chaldea`); Rio Eufrates (ID: `place:Euphrates`); Judá (ID: `person:Judah.4`); Caldéia (ID: `place:Chaldea`); Israel (ID: `person:Israel`); Foundation (ID: `realia:Foundation`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** Nabucodonozor (ID: `person:Nebuchadnezzar`); Babilônia (ID: `place:Babylon`); Chaldeans (ID: `group:Chaldea`); Caldéia (ID: `place:Chaldea`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Zorobabel (ID: `person:Zerubbabel.2`); Ciro (ID: `person:Cyrus`); Babilônia (ID: `place:Babylon`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Cubit (ID: `realia:Cubit`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Moisés (ID: `person:Moses`); Levi (ID: `group:Levi`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `person:Levi.3`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** passover (ID: `keyterm:Passover`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); pure (ID: `keyterm:Pure`)
...
* **Associated ACAI Concepts:** defilement (ID: `keyterm:Defilement`); SENHOR (ID: `deity:Lord`); Gentiles (ID: `group:Gentile`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Assyria (ID: `place:Assyria`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); House (ID: `realia:House`); Unleavened Bread (ID: `realia:UnleavenedBread`)
...
* **Associated ACAI Concepts:** Azarias (ID: `person:Azariah.7`); Ezra (ID: `person:Ezra`); Seraias (ID: `person:Seraiah.2`); Pérsia (ID: `place:Persia`); Artaxerxes (ID: `person:Artaxerxes`); Hilquias (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Aitube (ID: `person:Ahitub.3`); Zadoque (ID: `person:Zadok.4`); Azarias (ID: `person:Azariah.7`); Abisua (ID: `person:Abishua`); Meraiote (ID: `person:Meraioth`); Salum (ID: `person:Shallum.7`); Azarias (ID: `person:Azariah.6`); Amarias (ID: `person:Amariah.2`); Buqui (ID: `person:Bukki.2`); Zeraías (ID: `person:Zerahiah`); Uzi (ID: `person:Uzzi`); Seraias (ID: `person:Seraiah.2`); Pérsia (ID: `place:Persia`); Fineias (ID: `person:Phinehas`); Eleazar (ID: `person:Eleazar.2`); Arão (ID: `person:Aaron`); Hilquias (ID: `person:Hilkiah.2`); Artaxerxes (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Instruction (ID: `keyterm:Instruction`); Moisés (ID: `person:Moses`); Babilônia (ID: `place:Babylon`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); Ezra (ID: `person:Ezra`); decree (ID: `keyterm:Decree`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Artaxerxes (ID: `person:Artaxerxes`); Ezra (ID: `person:Ezra`); Rio Eufrates (ID: `place:Euphrates`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`); Kor (ID: `realia:Kor`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** Selomite (ID: `person:Shelomith.4`); Zacarias (ID: `person:Zechariah.19`); Zacarias (ID: `person:Zechariah.18`); Obadias (ID: `person:Obadiah.10`); Zeraías (ID: `person:Zerahiah.2`); Josifias (ID: `person:Josiphiah`); Semaías (ID: `person:Shemaiah.14`); Adim (ID: `person:Adin`); Jesaías (ID: `person:Jeshaiah.4`); Atalia (ID: `person:Athaliah.3`); Elam (ID: `person:Elam`); Joabe (ID: `person:Joab.4`); Gérson (ID: `person:Gershom.2`); Ebede (ID: `person:Ebed.2`); Hatus (ID: `person:Hattush.2`); Secanias (ID: `person:Shecaniah.5`); Jeuel (ID: `person:Jeuel.3`); Zacur (ID: `person:Zaccur.5`); Adonicão (ID: `person:Adonikam`); Sephatias (ID: `person:Shephatiah.6`); Parós (ID: `person:Parosh.2`); Jeiel (ID: `person:Jehiel.7`); Elifelete (ID: `person:Eliphelet.5`); Secanias (ID: `person:Shecaniah.6`); Zabadias (ID: `person:Zebadiah.8`); Hacatã (ID: `person:Hakkatan`); Miguel (ID: `person:Michael.10`); Bebai (ID: `person:Bebai.2`); Utai (ID: `person:Uthai.2`); Joanã (ID: `person:Johanan.8`); Elioenai (ID: `person:Eliehoenai.2`); Jônatas (ID: `person:Jonathan.9`); Bebai (ID: `person:Bebai`); Paate-Moabe (ID: `person:Pahath-moab`); Daniel (ID: `person:Daniel.2`); Asgade (ID: `person:Azgad`); Jaaziel (ID: `person:Jahaziel.5`); Bigvai (ID: `person:Bigvai.2`); Fineias (ID: `person:Phinehas`); Babilônia (ID: `place:Babylon`); Davi (ID: `person:David`); Artaxerxes (ID: `person:Artaxerxes`); Itamar (ID: `person:Ithamar`)
...
* **Associated ACAI Concepts:** Elnatã (ID: `person:Elnathan.2`); Ido (ID: `person:Iddo`); Zacarias (ID: `person:Zechariah.20`); Elnatã (ID: `person:Elnathan.3`); Casifia (ID: `place:Casiphia`); Eliezer (ID: `person:Eliezer.8`); Elnatã (ID: `person:Elnathan.4`); Semaías (ID: `person:Shemaiah.15`); Joiaribe (ID: `person:Joiarib.2`); Ariel (ID: `person:Ariel`); Jaribe (ID: `person:Jarib.2`); Natã (ID: `person:Nathan.5`); Mesulão (ID: `person:Meshullam.9`); SENHOR (ID: `deity:Lord`); perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); Mali (ID: `person:Mahli`); Insight (ID: `keyterm:Insight`); Levi (ID: `group:Levi`); SENHOR (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Levi (ID: `group:Levi`); Davi (ID: `person:David`); Levi (ID: `person:Levi.3`); work (ID: `keyterm:Work`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); Canaã (ID: `place:Canaan`); Ammonites (ID: `group:Ammon`); Amorites (ID: `group:Amorites`); Egyptians (ID: `group:Egypt`); Egito (ID: `place:Egypt`); be unfaithful (ID: `keyterm:Unfaithful`); Amom (ID: `place:Ammon`); cananeu (ID: `group:Canaan`); Hete (ID: `person:Heth`); Levi (ID: `group:Levi`); Moabe (ID: `place:Moab`); Jebusites (ID: `group:Jebusites`); Levi (ID: `person:Levi.3`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Harim (ID: `person:Harim`); offering (ID: `keyterm:Offering`); Judá (ID: `group:Judah`); Elam (ID: `person:Elam`); counsel (ID: `keyterm:Counsel`); Judá (ID: `person:Judah.4`); Jasube (ID: `person:Jashub.2`); Zabadias (ID: `person:Zebadiah.9`); Jeremai (ID: `person:Jeremai`); Eliezer (ID: `person:Eliezer.10`); Eliezer (ID: `person:Eliezer.9`); Jozabade (ID: `person:Jozabad.8`); Issias (ID: `person:Isshijah`); Salum (ID: `person:Shallum.10`); Matitias (ID: `person:Mattithiah.3`); Kelaiah (ID: `person:Kelaiah`); Selemias (ID: `person:Shelemiah.2`); Simei (ID: `person:Shimei.15`); Jozabade (ID: `person:Jozabad.7`); Azarel (ID: `person:Azarel.4`); Secanias (ID: `person:Shecaniah.7`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); Pérsia (ID: `place:Persia`); supplication (ID: `keyterm:Supplication`); kindness (ID: `keyterm:Kindness`); peace (ID: `keyterm:IntactState`); defilement (ID: `keyterm:Defilement`); dispossess (ID: `keyterm:Dispossess`); to cause to possess (ID: `keyterm:Possess`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Peg (ID: `realia:Peg`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); Pérsia (ID: `place:Persia`); supplication (ID: `keyterm:Supplication`); kindness (ID: `keyterm:Kindness`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** Jeiel (ID: `person:Jehiel.8`); Secanias (ID: `person:Shecaniah.7`); Elam (ID: `person:Elam`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** swear (ID: `keyterm:Swear`); Ezra (ID: `person:Ezra`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Benjamim (ID: `person:Benjamin`); Benjamim (ID: `group:Benjamin`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Asael (ID: `person:Asahel.4`); Mesulão (ID: `person:Meshullam.10`); Jazeías (ID: `person:Jahzeiah`); Jônatas (ID: `person:Jonathan.10`); Ticva (ID: `person:Tikvah.2`); Sabetai (ID: `person:Shabbethai`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`)
