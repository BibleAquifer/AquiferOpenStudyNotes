...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); أَدومَ (ID: `place:Edom`); Edomites (ID: `group:Edom`); Love (ID: `keyterm:Love`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`); Fear (ID: `keyterm:Fear`); Offering (ID: `keyterm:Offering`); لَّاوِي (ID: `person:Levi.3`); Priests (ID: `group:GenericPriests`); Peace (ID: `keyterm:IntactState`); لَّاوِي (ID: `group:Levi`); Defile (ID: `keyterm:Stain`); To Curse (ID: `keyterm:Curse`); Glory (ID: `keyterm:Glory`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Fairness (ID: `keyterm:Fairness`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Intention (ID: `keyterm:Intention`); To Dishonor (ID: `keyterm:Dishonor`); The Way (ID: `keyterm:TheWay`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); An Angel (ID: `deity:Angel`); Pure (ID: `keyterm:Pure`); Ask for (ID: `keyterm:AskFor`); Vow (ID: `keyterm:Vow`); Gentiles (ID: `group:Gentile`); Truth (ID: `keyterm:Truth`); Bless (ID: `keyterm:Bless`); Passion (ID: `keyterm:Ardour`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Defile (ID: `keyterm:Stain`); ٱلرَّبِّ (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** To Curse (ID: `keyterm:Curse`); ٱلرَّبِّ (ID: `deity:Lord`); Bless (ID: `keyterm:Bless`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Covenant (ID: `keyterm:Covenant`); Offering (ID: `keyterm:Offering`); To Dishonor (ID: `keyterm:Dishonor`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Love (ID: `keyterm:Love`); Delight (ID: `keyterm:Delight`); أورشَلِيمَ (ID: `place:Jerusalem`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); Love (ID: `keyterm:Love`); ٱلرَّبِّ (ID: `deity:Lord`); To Dishonor (ID: `keyterm:Dishonor`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); Swear (ID: `keyterm:Swear`); An Angel (ID: `deity:Angel`); يَهوذَا (ID: `person:Judah.4`); لَّاوِي (ID: `group:Levi`); Pure (ID: `keyterm:Pure`); A Group of People (ID: `group:GenericGroup`); Fear (ID: `keyterm:Fear`); يَهوذَا (ID: `group:Judah`); لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); Soap (ID: `realia:Soap`); Hammada (ID: `flora:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Bless (ID: `keyterm:Bless`); To Curse (ID: `keyterm:Curse`); Decree (ID: `keyterm:Decree`); Wheat (ID: `flora:Wheat`); Vine (ID: `flora:Vine`); Sorghum (ID: `flora:Sorghum`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Force to Serve (ID: `keyterm:EnticedToServe`); Fear (ID: `keyterm:Fear`); Cattle (ID: `fauna:Bull`); Animal Pen (ID: `realia:AnimalPen`); Molten Image (ID: `realia:MoltenImage`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); سِينَاءَ (ID: `place:SinaiMount`); Decree (ID: `keyterm:Decree`); موسَى (ID: `person:Moses`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); سِينَاءَ (ID: `place:SinaiMount`); Decree (ID: `keyterm:Decree`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); إِيلِيَّا (ID: `person:Elijah`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); موسَى (ID: `person:Moses`)
...
* **Associated ACAI Concepts:** إِيلِيَّا (ID: `person:Elijah`); Fear (ID: `keyterm:Fear`); ٱلرَّبِّ (ID: `deity:Lord`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`)
