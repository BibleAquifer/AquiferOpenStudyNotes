...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Carmelo (ID: `place:Carmel`); Libano (ID: `place:Lebanon`); The Way (ID: `keyterm:TheWay`); Zealous (ID: `keyterm:Zealous.3`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Basã (ID: `place:Bashan`); strength (ID: `keyterm:Strength`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Carmelo (ID: `place:Carmel`); Libano (ID: `place:Lebanon`); The Way (ID: `keyterm:TheWay`); Zealous (ID: `keyterm:Zealous.3`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Basã (ID: `place:Bashan`); wickedness (ID: `keyterm:Wickedness`); strength (ID: `keyterm:Strength`); Strong Drink (ID: `realia:StrongDrink`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** make a vow (ID: `keyterm:Vow`); peace (ID: `keyterm:IntactState`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); wickedness (ID: `keyterm:Wickedness`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); SENHOR (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Flock (ID: `fauna:Flock`); Chariot (ID: `realia:Chariot`); Grass (ID: `flora:Grass`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Líbia (ID: `place:Libya`); Egito (ID: `place:Egypt`); Cush (ID: `place:Cush.2`); Pute (ID: `place:Put`); lot (ID: `keyterm:Lot`)
