...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Daud (ID: `person:David`); Samuel (ID: `person:Samuel`); Rama (ID: `place:Ramah`); Paran (ID: `place:Paran`); House (ID: `realia:House`)
