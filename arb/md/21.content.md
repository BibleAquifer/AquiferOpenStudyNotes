...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); أورشَلِيمَ (ID: `place:Jerusalem`); Intention (ID: `keyterm:Intention`); ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vine (ID: `flora:Vine`); To Sin (ID: `keyterm:Sin`); إِسْرَائِيلَ (ID: `person:Israel`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`); Wine (ID: `realia:Wine`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`); Wine (ID: `realia:Wine`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vow (ID: `keyterm:Vow`); House (ID: `realia:House`); Strength (ID: `keyterm:Strength`); Slaughtering (ID: `keyterm:Slaughtering`); An Angel (ID: `deity:Angel`); Fear (ID: `keyterm:Fear`); Passion (ID: `keyterm:Ardour`); A Man (ID: `person:GenericMale`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** Stupid (ID: `keyterm:Stupid`); ٱلرَّبِّ (ID: `deity:Lord`); Slaughtering (ID: `keyterm:Slaughtering`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Stupid (ID: `keyterm:Stupid`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); To Act Wickedly (ID: `keyterm:ActWickedly`); To Sin (ID: `keyterm:Sin`); To Cause to Possess (ID: `keyterm:Possess`); Intention (ID: `keyterm:Intention`); Fear (ID: `keyterm:Fear`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Cooking Pot (ID: `realia:CookingPot`); Olive Oil (ID: `realia:OliveOil`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Fishnet (ID: `realia:Fishnet`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Hell (ID: `place:Hell`); Ability (ID: `keyterm:Ability`); Strength (ID: `keyterm:Strength`); Love (ID: `keyterm:Love`); Intention (ID: `keyterm:Intention`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Caper (ID: `flora:Caper`); Locust (ID: `fauna:Locust`); Money (ID: `realia:Money`); Almond (ID: `flora:Almond`); Bird (ID: `fauna:Bird`); Rope (ID: `realia:Rope`); Pit (ID: `realia:Pit`); Clay Jar (ID: `realia:ClayJar`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Straightness (ID: `keyterm:Straightness`); Intention (ID: `keyterm:Intention`); Truth (ID: `keyterm:Truth`); Proverb (ID: `keyterm:Saying`); Fear (ID: `keyterm:Fear`); Goad (ID: `realia:Goad`); Flock (ID: `fauna:Flock`); Scroll (ID: `realia:Scroll`); Nail (ID: `realia:Nail`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
