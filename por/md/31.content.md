...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Monte de Esaú (ID: `place:EsauMount`); Edom (ID: `place:Edom`); Understanding (ID: `keyterm:Understanding`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); lot (ID: `keyterm:Lot`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); dispossess (ID: `keyterm:Dispossess`); Edomites (ID: `group:Edom`); Jerusalém (ID: `place:Jerusalem`); José (ID: `person:Joseph.10`); Edom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); Israel (ID: `person:Israel`); José (ID: `person:Joseph.10`); SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Sefalá (ID: `place:Shephelah`); Efraim (ID: `group:Ephraim`); Filisteu (ID: `group:Philistine`); Israel (ID: `person:Israel`); cananeu (ID: `group:Canaan`); Benjamim (ID: `group:Benjamin`); Jerusalém (ID: `place:Jerusalem`); Gileade (ID: `place:Gilead`); Samaria (ID: `place:Samaria`); Benjamim (ID: `person:Benjamin`); Sardes (ID: `place:Sardis`); Monte de Esaú (ID: `place:EsauMount`); Canaã (ID: `place:Canaan`); Sarepta (ID: `place:Zarephath`); Efraim (ID: `person:Ephraim`); Filístia (ID: `place:Philistine`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); Monte de Esaú (ID: `place:EsauMount`); dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`); Canaã (ID: `place:Canaan`); Efraim (ID: `person:Ephraim`); Efraim (ID: `group:Ephraim`); Israel (ID: `person:Israel`); Benjamim (ID: `group:Benjamin`); Benjamim (ID: `person:Benjamin`); SENHOR (ID: `deity:Lord`); Sefalá (ID: `place:Shephelah`); Filístia (ID: `place:Philistine`); cananeu (ID: `group:Canaan`); Filisteu (ID: `group:Philistine`); Gileade (ID: `place:Gilead`); Samaria (ID: `place:Samaria`); Sardes (ID: `place:Sardis`); Sarepta (ID: `place:Zarephath`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); cananeu (ID: `group:Canaan`); dispossess (ID: `keyterm:Dispossess`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Sardes (ID: `place:Sardis`); Canaã (ID: `place:Canaan`); Sarepta (ID: `place:Zarephath`)
