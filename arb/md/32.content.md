...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); Fear (ID: `keyterm:Fear`); Fish (ID: `fauna:Fish`); Ship (ID: `realia:Ship`); Hell (ID: `place:Hell`); Vow (ID: `keyterm:Vow`); يَافَا (ID: `place:Joppa`); أَمِتَّايَ (ID: `person:Amittai`); نِينَوَى (ID: `place:Nineveh`); تَرْشِيشَ (ID: `place:Tarshish`); Salvation (ID: `keyterm:Salvation`); Hebrews (ID: `group:Hebrews`); Exempt (ID: `keyterm:Exempt`); Kindness (ID: `keyterm:Kindness`); Slaughtering (ID: `keyterm:Slaughtering`); Praise (ID: `keyterm:Praise`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Lot (ID: `keyterm:Lot`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Vow (ID: `keyterm:Vow`); Slaughtering (ID: `keyterm:Slaughtering`); Fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Hell (ID: `place:Hell`); Vow (ID: `keyterm:Vow`); Praise (ID: `keyterm:Praise`); Kindness (ID: `keyterm:Kindness`); Salvation (ID: `keyterm:Salvation`); يونَانَ (ID: `person:Jonah.2`); Cattails (ID: `flora:Cattails`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** نِينَوَى (ID: `place:Nineveh`); ٱلرَّبِّ (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); يونَانَ (ID: `person:Jonah.2`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); نِينَوَى (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Sackcloth (ID: `realia:Sackcloth`); Cattle (ID: `fauna:Bull`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Generous (ID: `keyterm:Generous`); تَرْشِيشَ (ID: `place:Tarshish`); Believe In (ID: `keyterm:BelieveIn`); Compassionate (ID: `keyterm:Compassionate`); Kindness (ID: `keyterm:Kindness`); Clothing (ID: `realia:Clothing`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Worm (ID: `fauna:Maggot`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); Generous (ID: `keyterm:Generous`); تَرْشِيشَ (ID: `place:Tarshish`); Compassionate (ID: `keyterm:Compassionate`); Kindness (ID: `keyterm:Kindness`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Generous (ID: `keyterm:Generous`); ٱلرَّبِّ (ID: `deity:Lord`); تَرْشِيشَ (ID: `place:Tarshish`); Compassionate (ID: `keyterm:Compassionate`); Kindness (ID: `keyterm:Kindness`)
