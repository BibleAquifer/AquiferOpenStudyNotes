...
* **Associated ACAI Concepts:** Efratita (ID: `group:Ephrathah`); Ephrata (ID: `person:Ephrathah`); Noemi (ID: `person:Naomi`); Chelión (ID: `person:Chilion`); Moab (ID: `place:Moab`); Judá (ID: `group:Judah`); Elimelech (ID: `person:Elimelech`); Judá (ID: `person:Judah.4`); Catah (ID: `place:Bethlehem`); Mahalón (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); Noemi (ID: `person:Naomi`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** bondad (ID: `keyterm:Kindness`); Jehová (ID: `deity:Lord`); Noemi (ID: `person:Naomi`); bendecir (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); dejar en herencia (ID: `keyterm:Possess`); Ruth (ID: `person:Ruth`); Mahalón (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Rachêl (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); Jehová (ID: `deity:Lord`); Lea (ID: `person:Leah`); Catah (ID: `place:Bethlehem`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Phares (ID: `person:Perez`); Thamar (ID: `person:Tamar`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Salmón (ID: `person:Salmon`); Hesrón (ID: `person:Hezron.2`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Phares (ID: `person:Perez`); Booz (ID: `person:Boaz`); Isaí (ID: `person:Jesse`); David (ID: `person:David`); Nahasón (ID: `person:Nahshon`)
