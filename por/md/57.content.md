...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Áfia (ID: `person:Apphia`); Filemom (ID: `person:Philemon`); Arquipo (ID: `person:Archippus`); Paulo (ID: `person:Paul`); igreja (ID: `keyterm:Church`); Timóteo (ID: `person:Timothy`); favor (ID: `keyterm:Favor`); fazer a paz (ID: `keyterm:Peace`); amado (ID: `keyterm:Beloved`); SENHOR (ID: `deity:Lord`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); holy (ID: `keyterm:Holy`); love (ID: `keyterm:Love`); orar (ID: `keyterm:Pray`); rogar (ID: `keyterm:AskFor`); SENHOR (ID: `deity:Lord`); Good (ID: `keyterm:Good`); comunhão (ID: `keyterm:Fellowship`); Cause of Joy (ID: `keyterm:CauseOfJoy`); compaixão (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Paulo (ID: `person:Paul`); rogar (ID: `keyterm:AskFor`); em cristo (ID: `keyterm:InChrist`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Epafras (ID: `person:Epaphras`); Demas (ID: `person:Demas`); Lucas (ID: `person:Luke`); favor (ID: `keyterm:Favor`); em cristo (ID: `keyterm:InChrist`); Aristarco (ID: `person:Aristarchus`); Marcos (ID: `person:Mark`); Spirit (ID: `keyterm:Spirit.2`)
