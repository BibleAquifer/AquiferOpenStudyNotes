...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`); misericórdia (ID: `keyterm:Mercy`); SENHOR (ID: `deity:Lord`); fazer a paz (ID: `keyterm:Peace`); para a eternidade (ID: `keyterm:Always`); favor (ID: `keyterm:Favor`); escolhido (ID: `keyterm:Chosen`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); misericórdia (ID: `keyterm:Mercy`); SENHOR (ID: `deity:Lord`); fazer a paz (ID: `keyterm:Peace`); favor (ID: `keyterm:Favor`); love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); Jesus (ID: `person:Jesus.2`); andar (ID: `keyterm:Live.3`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); compartilhar (ID: `keyterm:Share`); Ability (ID: `keyterm:Ability`); rogar (ID: `keyterm:AskFor`); Truth (ID: `keyterm:Truth`); corpo (ID: `keyterm:Body.3`); House (ID: `realia:House`)
