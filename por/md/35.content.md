...
* **Associated ACAI Concepts:** literally: nought (ID: `keyterm:Idol`); Woe (ID: `keyterm:Woe.2`); lean on (ID: `keyterm:LeanOn`); SENHOR (ID: `deity:Lord`); Image (ID: `realia:Image`); Graven Image (ID: `realia:GravenImage`); Money (ID: `realia:Money`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); Cusã (ID: `place:Cushan`); Temã (ID: `place:Teman`); Monte Paran (ID: `place:ParanMount`); holy (ID: `keyterm:Holy`); anointed (ID: `keyterm:Anointed`); Midiã (ID: `place:Midian`); Oath (ID: `keyterm:Oath`); mischief (ID: `keyterm:Mischief`); SENHOR (ID: `deity:Lord`); majesty (ID: `keyterm:Majesty`); arrow (ID: `keyterm:Arrow`); Foundation (ID: `realia:Foundation`); Chariot (ID: `realia:Chariot`); Bow (ID: `realia:Bow`); Tent (ID: `realia:Tent`); Spear (ID: `realia:Spear`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); Oath (ID: `keyterm:Oath`); anointed (ID: `keyterm:Anointed`); SENHOR (ID: `deity:Lord`); arrow (ID: `keyterm:Arrow`); Foundation (ID: `realia:Foundation`); Bow (ID: `realia:Bow`); Spear (ID: `realia:Spear`); Chariot (ID: `realia:Chariot`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); salvation (ID: `keyterm:Salvation`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Sheepfold (ID: `realia:Sheepfold`); Fig (ID: `flora:Fig`); Vine (ID: `flora:Vine`); Cattle (ID: `fauna:Bull`); Olive Tree (ID: `flora:OliveTree`); Animal Pen (ID: `realia:AnimalPen`)
