...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); mencobai (ID: `keyterm:PutToTheTest`); berbahagialah (ID: `keyterm:Happy`); kekasih (ID: `keyterm:Beloved`); sia, sia (ID: `keyterm:Worthless`); suci (ID: `keyterm:Clean`); tahan uji (ID: `keyterm:Approved`); yang baik (ID: `keyterm:Good`); hati (ID: `keyterm:Heart`); janji (ID: `keyterm:Promise`); keahlian (ID: `keyterm:Ability`); A Person (ID: `person:GenericPerson`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kebenaran (ID: `keyterm:Truth`); berbuat dosa (ID: `keyterm:Sin`); kasihi (ID: `keyterm:Love`); hukum (ID: `keyterm:Law`); kehidupan (ID: `keyterm:Life`); tak bernoda (ID: `keyterm:AboveCriticism`); keselamatan (ID: `keyterm:Salvation`); tidak dapat dicobai (ID: `keyterm:NotTempted`); tidak dicemarkan (ID: `keyterm:Undefiled`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** sia, sia (ID: `keyterm:Worthless`); suci (ID: `keyterm:Clean`); Tuhan (ID: `deity:Lord`); hati (ID: `keyterm:Heart`); tidak dicemarkan (ID: `keyterm:Undefiled`); keahlian (ID: `keyterm:Ability`); tak bernoda (ID: `keyterm:AboveCriticism`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); tonton bulu atau muka (ID: `keyterm:Partiality`); kemuliaan (ID: `keyterm:Glory`); Yesus (ID: `person:Jesus.2`); bimbang (ID: `keyterm:Discern`); percaya (ID: `keyterm:Believe`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); janji (ID: `keyterm:Promise`); orang pilihan (ID: `keyterm:Chosen`); keahlian (ID: `keyterm:Ability`); kasihi (ID: `keyterm:Love`); kerajaan (ID: `keyterm:Kingdom`); kekasih (ID: `keyterm:Beloved`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); tonton bulu atau muka (ID: `keyterm:Partiality`); tersandung (ID: `keyterm:Stumble`); penghakiman (ID: `keyterm:Judgment`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`); kasihi (ID: `keyterm:Love`); persundalan (ID: `keyterm:Fornication`); memutuskan (ID: `keyterm:Decided`); kitab suci (ID: `keyterm:Scripture`); pengadilan (ID: `keyterm:CourtCase`); belas kasihan (ID: `keyterm:Mercy`); berbuat dosa (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** penghakiman (ID: `keyterm:Judgment`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`); belas kasihan (ID: `keyterm:Mercy`); pengadilan (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Tuhan (ID: `deity:Lord`); tubuh (ID: `keyterm:Body.3`); A Person (ID: `person:GenericPerson`); Abraham (ID: `person:Abraham`); Rahab (ID: `person:Rahab`); sia, sia (ID: `keyterm:Idle`); roh (ID: `keyterm:Spirit.2`); Demons (ID: `deity:Demons`); memperdamaikan (ID: `keyterm:Peace`); keselamatan (ID: `keyterm:Salvation`); An Angel (ID: `deity:Angel`); menggenapi (ID: `keyterm:Happen`); kitab suci (ID: `keyterm:Scripture`); Ishak (ID: `person:Isaac`); hampa (ID: `keyterm:Empty`)
...
* **Associated ACAI Concepts:** A Person (ID: `person:GenericPerson`); tubuh (ID: `keyterm:Body.3`); memperdamaikan (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); Rahab (ID: `person:Rahab`); sia, sia (ID: `keyterm:Idle`); Tuhan (ID: `deity:Lord`); roh (ID: `keyterm:Spirit.2`); tubuh (ID: `keyterm:Body.3`); An Angel (ID: `deity:Angel`); menggenapi (ID: `keyterm:Happen`); kitab suci (ID: `keyterm:Scripture`); Ishak (ID: `person:Isaac`); hampa (ID: `keyterm:Empty`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); menggenapi (ID: `keyterm:Happen`); kitab suci (ID: `keyterm:Scripture`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** neraka (ID: `keyterm:Gehenna`); Hell (ID: `place:Hell`); keahlian (ID: `keyterm:Ability`); tubuh (ID: `keyterm:Body.3`); lalim (ID: `keyterm:UnjustDeed`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); persahabatan (ID: `keyterm:Friendship`); tidak setia (ID: `keyterm:Unfaithful`); Roh (ID: `deity:HolySpirit`); roh (ID: `keyterm:Spirit.2`); hati (ID: `keyterm:Heart`); murni (ID: `keyterm:Pure`); keahlian (ID: `keyterm:Ability`); ingin (ID: `keyterm:LongFor`); kitab suci (ID: `keyterm:Scripture`); kebaikan (ID: `keyterm:Favor`); membersihkan (ID: `keyterm:Cleanse.2`); Cause of Joy (ID: `keyterm:CauseOfJoy`)
...
* **Associated ACAI Concepts:** hati (ID: `keyterm:Heart`); murni (ID: `keyterm:Pure`); Tuhan (ID: `deity:Lord`); membersihkan (ID: `keyterm:Cleanse.2`)
...
* **Associated ACAI Concepts:** hati (ID: `keyterm:Heart`); bersaksi (ID: `keyterm:BearWitness`); Tuhan (ID: `deity:Lord`); tubuh (ID: `keyterm:Body.3`); menentang (ID: `keyterm:Condemn`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); diurapi (ID: `keyterm:Anointed`); nama (ID: `keyterm:Name`); berdoa (ID: `keyterm:Pray`); jemaat (ID: `keyterm:Church`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); mengampuni (ID: `keyterm:Forgive`); berbuat dosa (ID: `keyterm:Sin`); berdoa (ID: `keyterm:Pray`); keselamatan (ID: `keyterm:Salvation`); percaya (ID: `keyterm:Believe`)
