...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Libano (ID: `place:Lebanon`); The Way (ID: `keyterm:TheWay`); strength (ID: `keyterm:Strength`); Basã (ID: `place:Bashan`); Zealous (ID: `keyterm:Zealous.3`); Carmelo (ID: `place:Carmel`); pronounce innocent (ID: `keyterm:PronounceInnocent`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); wickedness (ID: `keyterm:Wickedness`); Libano (ID: `place:Lebanon`); strength (ID: `keyterm:Strength`); The Way (ID: `keyterm:TheWay`); Basã (ID: `place:Bashan`); Zealous (ID: `keyterm:Zealous.3`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Carmelo (ID: `place:Carmel`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Brier (ID: `flora:Brier`); Strong Drink (ID: `realia:StrongDrink`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); SENHOR (ID: `deity:Lord`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`); Chariot (ID: `realia:Chariot`)
...
* **Associated ACAI Concepts:** Líbia (ID: `place:Libya`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Egito (ID: `place:Egypt`); lot (ID: `keyterm:Lot`); Cush (ID: `place:Cush.2`); Pute (ID: `place:Put`)
