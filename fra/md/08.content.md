...
* **Associated ACAI Concepts:** Éphrata (ID: `person:Ephrathah`); Kiljon (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); Moab (ID: `place:Moab`); Machlon (ID: `person:Mahlon`); Juda (ID: `person:Judah.4`); Bethléhem (ID: `place:Bethlehem`); Élimélec (ID: `person:Elimelech`); Juda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Rachel (ID: `person:Rachel`); Éternel (ID: `deity:Lord`); Léa (ID: `person:Leah`); Bethléhem (ID: `place:Bethlehem`); Elders (ID: `group:GenericElders`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); Perets (ID: `person:Perez`); Tamar (ID: `person:Tamar`); Juda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Israël (ID: `person:Israel`); benir (ID: `keyterm:Bless`); Éternel (ID: `deity:Lord`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Hetsron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Obed (ID: `person:Obed`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Isaï (ID: `person:Jesse`); David (ID: `person:David`); Nahshon (ID: `person:Nahshon`); Perets (ID: `person:Perez`); Boaz (ID: `person:Boaz`)
