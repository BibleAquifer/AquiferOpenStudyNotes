...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Apphia (ID: `person:Apphia`); Filemón (ID: `person:Philemon`); Archîpo (ID: `person:Archippus`); Pablo (ID: `person:Paul`); iglesia (ID: `keyterm:Church`); Timoteo (ID: `person:Timothy`); favor (ID: `keyterm:Favor`); hacer la paz (ID: `keyterm:Peace`); amado (ID: `keyterm:Beloved`); Jehová (ID: `deity:Lord`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); creer (ID: `keyterm:Believe`); santo (ID: `keyterm:Holy`); amar (ID: `keyterm:Love`); orar (ID: `keyterm:Pray`); rogar (ID: `keyterm:AskFor`); Jehová (ID: `deity:Lord`); Good (ID: `keyterm:Good`); comunión (ID: `keyterm:Fellowship`); Cause of Joy (ID: `keyterm:CauseOfJoy`); entrañas (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Good (ID: `keyterm:Good`); comunión (ID: `keyterm:Fellowship`); Jesús (ID: `person:Jesus.2`); creer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Pablo (ID: `person:Paul`); rogar (ID: `keyterm:AskFor`); cristo (ID: `keyterm:InChrist`); amar (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Epafras (ID: `person:Epaphras`); Demas (ID: `person:Demas`); Lucas (ID: `person:Luke`); favor (ID: `keyterm:Favor`); cristo (ID: `keyterm:InChrist`); Aristarco (ID: `person:Aristarchus`); Marcos (ID: `person:Mark`); espíritu (ID: `keyterm:Spirit.2`)
