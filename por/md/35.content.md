...
* **Associated ACAI Concepts:** fear (ID: `keyterm:Fear`); Caldéia (ID: `place:Chaldea`); dispossess (ID: `keyterm:Dispossess`); SENHOR (ID: `deity:Lord`); Chaldeans (ID: `group:Chaldea`); Believe In (ID: `keyterm:BelieveIn`); strength (ID: `keyterm:Strength`); Vulture (ID: `fauna:Vulture`); Horse (ID: `fauna:Horse`); Leopard (ID: `fauna:Leopard`); Wolf (ID: `fauna:Wolf`)
...
* **Associated ACAI Concepts:** Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Casting Net (ID: `realia:CastingNet`); pure (ID: `keyterm:Pure`); holy (ID: `keyterm:Holy`); SENHOR (ID: `deity:Lord`); Fortification (ID: `realia:Fortification`); Chameleon (ID: `fauna:Chameleon`); Monitor (ID: `fauna:Iguana`); Fish (ID: `fauna:Fish`); Harpoon (ID: `realia:Harpoon`); Lizard (ID: `fauna:Lizard`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); literally: nought (ID: `keyterm:Idol`); lean on (ID: `keyterm:LeanOn`); saying (ID: `keyterm:Saying`); Libano (ID: `place:Lebanon`); Hell (ID: `place:Hell`); Be Disgraced (ID: `keyterm:Disgraced`); Money (ID: `realia:Money`); Wine (ID: `realia:Wine`); Image (ID: `realia:Image`); Molten Image (ID: `realia:MoltenImage`); Tablet (ID: `realia:Tablet`); Vine (ID: `flora:Vine`); Graven Image (ID: `realia:GravenImage`); Beam (ID: `realia:Beam`)
...
* **Associated ACAI Concepts:** Libano (ID: `place:Lebanon`); Be Disgraced (ID: `keyterm:Disgraced`); SENHOR (ID: `deity:Lord`); Woe (ID: `keyterm:Woe.2`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** literally: nought (ID: `keyterm:Idol`); lean on (ID: `keyterm:LeanOn`); SENHOR (ID: `deity:Lord`); Woe (ID: `keyterm:Woe.2`); Money (ID: `realia:Money`); Image (ID: `realia:Image`); Molten Image (ID: `realia:MoltenImage`); Graven Image (ID: `realia:GravenImage`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); Monte Paran (ID: `place:ParanMount`); Cusã (ID: `place:Cushan`); Temã (ID: `place:Teman`); Habacuque (ID: `person:Habakkuk`); Midiã (ID: `place:Midian`); anointed (ID: `keyterm:Anointed`); mischief (ID: `keyterm:Mischief`); Oath (ID: `keyterm:Oath`); arrow (ID: `keyterm:Arrow`); fear (ID: `keyterm:Fear`); holy (ID: `keyterm:Holy`); majesty (ID: `keyterm:Majesty`); Deer (ID: `fauna:Deer`); Cattle (ID: `fauna:Bull`); Bow (ID: `realia:Bow`); Spear (ID: `realia:Spear`); Goat (ID: `fauna:Goat`); Tent (ID: `realia:Tent`); Chariot (ID: `realia:Chariot`); Fig (ID: `flora:Fig`); Flock (ID: `fauna:Flock`); Sheepfold (ID: `realia:Sheepfold`); Vine (ID: `flora:Vine`); Foundation (ID: `realia:Foundation`); Olive Tree (ID: `flora:OliveTree`); Animal Pen (ID: `realia:AnimalPen`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); arrow (ID: `keyterm:Arrow`); Oath (ID: `keyterm:Oath`); SENHOR (ID: `deity:Lord`); anointed (ID: `keyterm:Anointed`); Foundation (ID: `realia:Foundation`); Bow (ID: `realia:Bow`); Spear (ID: `realia:Spear`); Chariot (ID: `realia:Chariot`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); salvation (ID: `keyterm:Salvation`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); Fig (ID: `flora:Fig`); Flock (ID: `fauna:Flock`); Olive Tree (ID: `flora:OliveTree`); Sheepfold (ID: `realia:Sheepfold`); Vine (ID: `flora:Vine`); Animal Pen (ID: `realia:AnimalPen`)
