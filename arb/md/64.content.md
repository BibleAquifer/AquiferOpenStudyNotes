...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); Beloved (ID: `keyterm:Beloved`); Live (ID: `keyterm:Live.3`); غَايوس (ID: `person:Gaius.4`); Bear Witness (ID: `keyterm:BearWitness`); Love (ID: `keyterm:Love`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Pray (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); Truth (ID: `keyterm:Truth`); ٱلرَّبِّ (ID: `deity:Lord`); Bear Witness (ID: `keyterm:BearWitness`); Beloved (ID: `keyterm:Beloved`); Love (ID: `keyterm:Love`); Obligated (ID: `keyterm:Ought`); Faithfulness (ID: `keyterm:Faithfulness`); Church (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** Church (ID: `keyterm:Church`); دِيوتْرِيفِسَ (ID: `person:Diotrephes`); دِيمِتْرِيوس (ID: `person:Demetrius`); Truth (ID: `keyterm:Truth`); Good (ID: `keyterm:Good`); ٱلرَّبِّ (ID: `deity:Lord`); Bear Witness (ID: `keyterm:BearWitness`); Beloved (ID: `keyterm:Beloved`); Do Good (ID: `keyterm:DoGood`); True (ID: `keyterm:True`)
