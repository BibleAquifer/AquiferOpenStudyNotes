...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Carmel (ID: `place:Carmel`); zélé (ID: `keyterm:Zealous.3`); force (ID: `keyterm:Strength`); Basan (ID: `place:Bashan`); Liban (ID: `place:Lebanon`); déclarer innocent (ID: `keyterm:PronounceInnocent`); chemin (ID: `keyterm:TheWay`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Carmel (ID: `place:Carmel`); méchanceté (ID: `keyterm:Wickedness`); zélé (ID: `keyterm:Zealous.3`); force (ID: `keyterm:Strength`); Basan (ID: `place:Bashan`); Liban (ID: `place:Lebanon`); déclarer innocent (ID: `keyterm:PronounceInnocent`); chemin (ID: `keyterm:TheWay`); se réfugier (ID: `keyterm:SeekfindRefuge`); Fortress (ID: `realia:Fortress`); Strong Drink (ID: `realia:StrongDrink`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** méchanceté (ID: `keyterm:Wickedness`); état intact (ID: `keyterm:IntactState`); Juda (ID: `person:Judah.4`); faire un voeu (ID: `keyterm:Vow`); Juda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); Éternel (ID: `deity:Lord`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`); Chariot (ID: `realia:Chariot`)
...
* **Associated ACAI Concepts:** Libya (ID: `place:Libya`); Égypte (ID: `place:Egypt`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Puth (ID: `place:Put`); Cush (ID: `place:Cush.2`); destin (ID: `keyterm:Lot`)
