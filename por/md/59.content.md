...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); tentar (ID: `keyterm:PutToTheTest`); bem, aventurado (ID: `keyterm:Happy`); amado (ID: `keyterm:Beloved`); inútil (ID: `keyterm:Worthless`); aprovado (ID: `keyterm:Approved`); limpo (ID: `keyterm:Clean`); Ability (ID: `keyterm:Ability`); que não pode ser tentado (ID: `keyterm:NotTempted`); A Person (ID: `person:GenericPerson`); Good (ID: `keyterm:Good`); salvation (ID: `keyterm:Salvation`); love (ID: `keyterm:Love`); lei (ID: `keyterm:Law`); promessa (ID: `keyterm:Promise`); sem mancha (ID: `keyterm:Undefiled`); Truth (ID: `keyterm:Truth`); Life (ID: `keyterm:Life`); be (or show oneself) just (ID: `keyterm:Just`); To Sin (ID: `keyterm:Sin`); coração (ID: `keyterm:Heart`); sem mancha (ID: `keyterm:AboveCriticism`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** inútil (ID: `keyterm:Worthless`); limpo (ID: `keyterm:Clean`); Ability (ID: `keyterm:Ability`); coração (ID: `keyterm:Heart`); sem mancha (ID: `keyterm:Undefiled`); SENHOR (ID: `deity:Lord`); sem mancha (ID: `keyterm:AboveCriticism`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); favoritismo (ID: `keyterm:Partiality`); Glory (ID: `keyterm:Glory`); Jesus (ID: `person:Jesus.2`); distinguir (ID: `keyterm:Discern`); crer (ID: `keyterm:Believe`); Seal (ID: `realia:Seal`); Synagogue (ID: `realia:Synagogue`); Footstool (ID: `realia:Footstool`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); amado (ID: `keyterm:Beloved`); reino (ID: `keyterm:Kingdom`); love (ID: `keyterm:Love`); promessa (ID: `keyterm:Promise`); SENHOR (ID: `deity:Lord`); escolhido (ID: `keyterm:Chosen`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); juízo (ID: `keyterm:Judgment`); tropeçar (ID: `keyterm:Stumble`); favoritismo (ID: `keyterm:Partiality`); fornication (ID: `keyterm:Fornication`); inclemente (ID: `keyterm:Merciless`); escritura (ID: `keyterm:Scripture`); To Sin (ID: `keyterm:Sin`); misericórdia (ID: `keyterm:Mercy`); love (ID: `keyterm:Love`); decidir (ID: `keyterm:Decided`); tribunal de justiça (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); corpo (ID: `keyterm:Body.3`); A Person (ID: `person:GenericPerson`); SENHOR (ID: `deity:Lord`); Abraão (ID: `person:Abraham`); inútil (ID: `keyterm:Idle`); Raabe (ID: `person:Rahab`); fazer a paz (ID: `keyterm:Peace`); vazio (ID: `keyterm:Empty`); An Angel (ID: `deity:Angel`); escritura (ID: `keyterm:Scripture`); Isaque (ID: `person:Isaac`); Demons (ID: `deity:Demons`); To Cause to Happen (ID: `keyterm:Happen`); Spirit (ID: `keyterm:Spirit.2`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); Abraão (ID: `person:Abraham`); inútil (ID: `keyterm:Idle`); Raabe (ID: `person:Rahab`); vazio (ID: `keyterm:Empty`); An Angel (ID: `deity:Angel`); escritura (ID: `keyterm:Scripture`); Isaque (ID: `person:Isaac`); corpo (ID: `keyterm:Body.3`); To Cause to Happen (ID: `keyterm:Happen`); SENHOR (ID: `deity:Lord`); Spirit (ID: `keyterm:Spirit.2`)
...
* **Associated ACAI Concepts:** escritura (ID: `keyterm:Scripture`); SENHOR (ID: `deity:Lord`); Abraão (ID: `person:Abraham`); be (or show oneself) just (ID: `keyterm:Just`); crer (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** Hell (ID: `place:Hell`); Ability (ID: `keyterm:Ability`); geena (ID: `keyterm:Gehenna`); injustiça (ID: `keyterm:UnjustDeed`); corpo (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); amizade (ID: `keyterm:Friendship`); be unfaithful (ID: `keyterm:Unfaithful`); Ability (ID: `keyterm:Ability`); Holy Spirit (ID: `deity:HolySpirit`); escritura (ID: `keyterm:Scripture`); To Cleanse (ID: `keyterm:Cleanse.2`); coração (ID: `keyterm:Heart`); pure (ID: `keyterm:Pure`); favor (ID: `keyterm:Favor`); Spirit (ID: `keyterm:Spirit.2`); desejar (ID: `keyterm:LongFor`); Cause of Joy (ID: `keyterm:CauseOfJoy`)
...
* **Associated ACAI Concepts:** coração (ID: `keyterm:Heart`); corpo (ID: `keyterm:Body.3`); testemunhar (ID: `keyterm:BearWitness`); SENHOR (ID: `deity:Lord`); condenar (ID: `keyterm:Condemn`); be (or show oneself) just (ID: `keyterm:Just`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); anointed (ID: `keyterm:Anointed`); SENHOR (ID: `deity:Lord`); Name (ID: `keyterm:Name`); igreja (ID: `keyterm:Church`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`)
