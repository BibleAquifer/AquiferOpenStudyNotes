...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Pérsia (ID: `place:Persia`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); House (ID: `realia:House`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Jeremias (ID: `person:Jeremiah.6`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Pérsia (ID: `place:Persia`); Judá (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Israel (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Levi (ID: `group:Levi`); Benjamim (ID: `person:Benjamin`); Benjamim (ID: `group:Benjamin`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `person:Levi.3`); Judá (ID: `group:Judah`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Ciro (ID: `person:Cyrus`); Judá (ID: `person:Judah.4`); Zorobabel (ID: `person:Zerubbabel.2`); Pérsia (ID: `place:Persia`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Salomão (ID: `person:Solomon`); Levi (ID: `group:Levi`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `person:Levi.3`); Tel-Melá (ID: `place:Tel-melah`); Bezai (ID: `person:Bezai`); Harim (ID: `person:Harim`); Soferete (ID: `person:Sophereth`); Tobias (ID: `person:Tobiah`); Jaala (ID: `person:Jaalah`); Hagabe (ID: `person:Hagab`); Bazlite (ID: `person:Bazluth`); Nebo (ID: `place:Nebo.2`); Bilsã (ID: `person:Bilshan`); Magbis (ID: `place:Magbish`); Temá (ID: `person:Temah`); Hagaba (ID: `person:Hagabah`); Bebai (ID: `person:Bebai`); Querube (ID: `place:Cherub`); Besai (ID: `person:Besai`); Padom (ID: `person:Padon`); Hacoz (ID: `person:Hakkoz.2`); Ami (ID: `person:Ami`); Netofa (ID: `place:Netophah`); Zia (ID: `person:Ziha`); Hodavias (ID: `person:Hodaviah.4`); Paseia (ID: `person:Paseah.2`); Necoda (ID: `person:Nekoda`)
...
* **Associated ACAI Concepts:** Bigvai (ID: `person:Bigvai`); Mispar (ID: `person:Mispar`); Mordecai (ID: `person:Mordecai`); Reum (ID: `person:Rehum`); Reelaías (ID: `person:Reelaiah`); Bilsã (ID: `person:Bilshan`); Neemias (ID: `person:Nehemiah`); Seraias (ID: `person:Seraiah.6`); Baana (ID: `person:Baanah.3`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Bezai (ID: `person:Bezai`); Paate-Moabe (ID: `person:Pahath-moab`); Bani (ID: `person:Bani`); Ater (ID: `person:Ater`); Zatu (ID: `person:Zattu.2`); Bigvai (ID: `person:Bigvai.2`); Joabe (ID: `person:Joab.3`); Asgade (ID: `person:Azgad`); Jora (ID: `person:Jorah`); Ezequias (ID: `person:Hezekiah.2`); Elam (ID: `person:Elam`); Bebai (ID: `person:Bebai`); Jesua (ID: `person:Jeshua.3`); Sephatias (ID: `person:Shephatiah.6`); Hasum (ID: `person:Hashum`); Parós (ID: `person:Parosh`); Ará (ID: `person:Arah.2`); Zacai (ID: `person:Zaccai.2`); Adim (ID: `person:Adin`); Adonicão (ID: `person:Adonikam`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Hadide (ID: `place:Hadid`); Nebo (ID: `place:Nebo.2`); Magbis (ID: `place:Magbish`); Harim (ID: `person:Harim.2`); Senaa (ID: `place:Senaah`); Netofa (ID: `place:Netophah`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Micmás (ID: `place:Michmash`); Belém (ID: `place:Bethlehem`); Lode (ID: `place:Lod`); Jericó (ID: `place:Jericho`); Betel (ID: `place:Bethel`); Ai (ID: `place:Ai`); Beerote (ID: `place:Beeroth`); Quiriate-Jearim (ID: `place:Kiriath-jearim`); Cefira (ID: `place:Chephirah`); Elam (ID: `person:Elam`); Ramah (ID: `place:Ramah.2`); Ono (ID: `place:Ono`); Geba (ID: `place:Geba`); Anatote (ID: `place:Anathoth`)
...
* **Associated ACAI Concepts:** Ater (ID: `person:Ater.2`); Imer (ID: `person:Immer.2`); Jesua (ID: `person:Jeshua`); Hatita (ID: `person:Hatita`); Jesua (ID: `person:Jeshua.4`); Hodavias (ID: `person:Hodaviah.4`); Harim (ID: `person:Harim`); Sobai (ID: `person:Shobai`); Talmom (ID: `person:Talmon`); Jedaías (ID: `person:Jedaiah.4`); Acube (ID: `person:Akkub.2`); Cadmiel (ID: `person:Kadmiel`); Levi (ID: `group:Levi`); Asafe (ID: `person:Asaph.2`); Pasur (ID: `person:Pashhur`); Levi (ID: `person:Levi.3`); Salum (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** Ater (ID: `person:Ater.2`); Hatita (ID: `person:Hatita`); Sobai (ID: `person:Shobai`); Talmom (ID: `person:Talmon`); Acube (ID: `person:Akkub.2`); Asafe (ID: `person:Asaph.2`); Salum (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** Hanã (ID: `person:Hanan.4`); Sisera (ID: `person:Sisera.2`); Meunim (ID: `group:Meunim`); Harur (ID: `person:Harhur`); Sia (ID: `person:Siaha`); Tabaote (ID: `person:Tabbaoth`); Baquebuque (ID: `person:Bakbuk`); Reaías (ID: `person:Reaiah.3`); Hagabe (ID: `person:Hagab`); Meída (ID: `person:Mehida`); Gazão (ID: `person:Gazzam`); Bazlite (ID: `person:Bazluth`); Asná (ID: `person:Asnah`); Hatifa (ID: `person:Hatipha`); Rezim (ID: `person:Rezin.2`); Hagaba (ID: `person:Hagabah`); Temá (ID: `person:Temah`); Nephushesim (ID: `group:Nephushesim`); Hasufa (ID: `person:Hasupha`); Gaar (ID: `person:Gahar`); Besai (ID: `person:Besai`); Harsa (ID: `person:Harsha`); Lebana (ID: `person:Lebanah`); Padom (ID: `person:Padon`); Gidel (ID: `person:Giddel`); Hacufa (ID: `person:Hakupha`); Barcos (ID: `person:Barkos`); Nesias (ID: `person:Neziah`); Salmai (ID: `person:Shalmai`); Uza (ID: `person:Uzza.2`); Queros (ID: `person:Keros`); Zia (ID: `person:Ziha`); Necoda (ID: `person:Nekoda`); Paseia (ID: `person:Paseah.2`); Acube (ID: `person:Akkub.3`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Darcom (ID: `person:Darkon`); Gidel (ID: `person:Giddel.2`); Jaala (ID: `person:Jaalah`); Ami (ID: `person:Ami`); Hatil (ID: `person:Hattil`); Sotai (ID: `person:Sotai`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Sephatias (ID: `person:Shephatiah.7`); Soferete (ID: `person:Sophereth`); Peruda (ID: `person:Peruda`)
...
* **Associated ACAI Concepts:** Tel-Melá (ID: `place:Tel-melah`); Imer (ID: `place:Immer`); Tobias (ID: `person:Tobiah`); Querube (ID: `place:Cherub`); Tel-Harsa (ID: `place:Tel-harsha`); Necoda (ID: `person:Nekoda.2`); Delaías (ID: `person:Delaiah.3`); Adã (ID: `place:Addan`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Hacoz (ID: `person:Hakkoz.2`); Habaiah (ID: `person:Habaiah`); Barzillai (ID: `person:Barzillai.3`); priesthood (ID: `keyterm:Priesthood`); stain (ID: `keyterm:Stain`); Gileade (ID: `place:Gilead`); Barzillai (ID: `person:Barzillai`); Gileadites (ID: `group:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); strength (ID: `keyterm:Strength`); Mina (ID: `realia:Mina`); Money (ID: `realia:Money`); Tunic (ID: `realia:Tunic`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Josué (ID: `person:Joshua.5`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Relatives (ID: `group:Relatives`); Jesua (ID: `person:Jeshua.4`); Esar-Hadom (ID: `person:Esarhaddon`); Henadade (ID: `person:Henadad`); Cadmiel (ID: `person:Kadmiel`); Hodavias (ID: `person:Hodaviah.4`); Davi (ID: `person:David`); Tyrians (ID: `group:Tyre`); new moon festival (ID: `keyterm:NewMoonFestival`); Libano (ID: `place:Lebanon`); appointed feast (ID: `keyterm:AppointedFeast`); Sidom (ID: `place:Sidon`); holy (ID: `keyterm:Holy`); kindness (ID: `keyterm:Kindness`); Jope (ID: `place:Joppa`); Moisés (ID: `person:Moses`); Hodias (ID: `person:Hodiah.2`); Benjamim (ID: `group:Benjamin`); Instruction (ID: `keyterm:Instruction`); terror (ID: `keyterm:Terror`); Tiro (ID: `place:Tyre`); Dario (ID: `person:Darius.2`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); counsel (ID: `keyterm:Counsel`); Assyria (ID: `place:Assyria`); Benjamim (ID: `person:Benjamin`); Asafe (ID: `person:Asaph.2`); Sidonians (ID: `group:Sidon`); Cedar (ID: `flora:Cedar`); Olive Oil (ID: `realia:OliveOil`); Cymbals (ID: `realia:Cymbals`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Trumpet (ID: `realia:Trumpet`); Craftsman (ID: `realia:Craftsman`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); appointed feast (ID: `keyterm:AppointedFeast`); new moon festival (ID: `keyterm:NewMoonFestival`); holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Tyrians (ID: `group:Tyre`); Libano (ID: `place:Lebanon`); Tiro (ID: `place:Tyre`); Pérsia (ID: `place:Persia`); Sidom (ID: `place:Sidon`); Jope (ID: `place:Joppa`); Sidonians (ID: `group:Sidon`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Cedar (ID: `flora:Cedar`); Craftsman (ID: `realia:Craftsman`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Levi (ID: `group:Levi`); Josué (ID: `person:Joshua.5`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `person:Levi.3`); Sealtiel (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Levi (ID: `group:Levi`); Davi (ID: `person:David`); Asafe (ID: `person:Asaph.2`); Levi (ID: `person:Levi.3`); kindness (ID: `keyterm:Kindness`); Trumpet (ID: `realia:Trumpet`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `person:Benjamin`); Benjamim (ID: `group:Benjamin`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Ciro (ID: `person:Cyrus`); Josué (ID: `person:Joshua.5`); SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Pérsia (ID: `place:Persia`); Israel (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Dario (ID: `person:Darius.2`); counsel (ID: `keyterm:Counsel`); Pérsia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Rio Eufrates (ID: `place:Euphrates`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Samaria (ID: `place:Samaria`); Pérsia (ID: `place:Persia`); Babylonians (ID: `group:Babylon`); Osnapar (ID: `person:Osnappar`); Mitredate (ID: `person:Mithredath.2`); Assuero (ID: `person:Ahasuerus`); Dinaítas (ID: `person:Dinaite`); Bislão (ID: `person:Bishlam`); Ereque (ID: `place:Erech`); Tabeel (ID: `person:Tabeel`); Judá (ID: `person:Judah.4`); Babilônia (ID: `place:Babylon`); Elam (ID: `place:Elam`); Elamites (ID: `group:Elam`); Judá (ID: `group:Judah`); Susã (ID: `place:Susa`); Persians (ID: `group:Persia`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Sinsai (ID: `person:Shimshai`); Babylonians (ID: `group:Babylon`); Dinaítas (ID: `person:Dinaite`); Ereque (ID: `place:Erech`); Reum (ID: `person:Rehum.2`); Elam (ID: `place:Elam`); Pérsia (ID: `place:Persia`); Susã (ID: `place:Susa`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); Babilônia (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Artaxerxes (ID: `person:Artaxerxes.2`); Samaria (ID: `place:Samaria`); Reum (ID: `person:Rehum.2`); Jews (ID: `group:Jews`); Sinsai (ID: `person:Shimshai`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Dario (ID: `person:Darius.2`); Jews (ID: `group:Jews`); Ido (ID: `person:Iddo.6`); Ageu (ID: `person:Haggai`); Zacarias (ID: `person:Zechariah.17`); Tattenai (ID: `person:Tattenai`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Jeozadaque (ID: `person:Jehozadak`); Rio Eufrates (ID: `place:Euphrates`); Josué (ID: `person:Joshua.5`); Judá (ID: `person:Judah.4`); Zorobabel (ID: `person:Zerubbabel.2`); Pérsia (ID: `place:Persia`); Israel (ID: `person:Israel`); Sealtiel (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** Ido (ID: `person:Iddo.6`); Ageu (ID: `person:Haggai`); Zacarias (ID: `person:Zechariah.17`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Jerusalém (ID: `place:Jerusalem`); Zorobabel (ID: `person:Zerubbabel.2`); Sealtiel (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Caldéia (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Babilônia (ID: `place:Babylon`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Ciro (ID: `person:Cyrus`); Zorobabel (ID: `person:Zerubbabel.2`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Babilônia (ID: `place:Babylon`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Seraias (ID: `person:Seraiah.2`); Ezra (ID: `person:Ezra`); Azarias (ID: `person:Azariah.7`); Pérsia (ID: `place:Persia`); Hilquias (ID: `person:Hilkiah.2`); Artaxerxes (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Zeraías (ID: `person:Zerahiah`); Buqui (ID: `person:Bukki.2`); Abisua (ID: `person:Abishua`); Azarias (ID: `person:Azariah.7`); Seraias (ID: `person:Seraiah.2`); Azarias (ID: `person:Azariah.6`); Aitube (ID: `person:Ahitub.3`); Meraiote (ID: `person:Meraioth`); Amarias (ID: `person:Amariah.2`); Uzi (ID: `person:Uzzi`); Zadoque (ID: `person:Zadok.4`); Salum (ID: `person:Shallum.7`); Arão (ID: `person:Aaron`); Eleazar (ID: `person:Eleazar.2`); Artaxerxes (ID: `person:Artaxerxes`); Hilquias (ID: `person:Hilkiah.2`); Fineias (ID: `person:Phinehas`); Pérsia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Israel (ID: `person:Israel`); Babilônia (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** decree (ID: `keyterm:Decree`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); Artaxerxes (ID: `person:Artaxerxes`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Rio Eufrates (ID: `place:Euphrates`); decree (ID: `keyterm:Decree`); Judá (ID: `person:Judah.4`); Babilônia (ID: `place:Babylon`); SENHOR (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Olive Oil (ID: `realia:OliveOil`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Anointing Oil (ID: `realia:AnointingOil`); Altar (ID: `realia:Altar`); Wheat (ID: `flora:Wheat`); Talent (ID: `realia:Talent`); Kor (ID: `realia:Kor`); Stone Altar (ID: `realia:StoneAltar`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Ezra (ID: `person:Ezra`); Artaxerxes (ID: `person:Artaxerxes`); Money (ID: `realia:Money`); Kor (ID: `realia:Kor`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Wheat (ID: `flora:Wheat`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** Obadias (ID: `person:Obadiah.10`); Parós (ID: `person:Parosh.2`); Jeuel (ID: `person:Jeuel.3`); Elioenai (ID: `person:Eliehoenai.2`); Secanias (ID: `person:Shecaniah.5`); Paate-Moabe (ID: `person:Pahath-moab`); Joanã (ID: `person:Johanan.8`); Zacur (ID: `person:Zaccur.5`); Selomite (ID: `person:Shelomith.4`); Zacarias (ID: `person:Zechariah.19`); Jônatas (ID: `person:Jonathan.9`); Josifias (ID: `person:Josiphiah`); Joabe (ID: `person:Joab.4`); Bigvai (ID: `person:Bigvai.2`); Asgade (ID: `person:Azgad`); Elam (ID: `person:Elam`); Bebai (ID: `person:Bebai`); Hacatã (ID: `person:Hakkatan`); Zabadias (ID: `person:Zebadiah.8`); Zacarias (ID: `person:Zechariah.18`); Bebai (ID: `person:Bebai.2`); Jesaías (ID: `person:Jeshaiah.4`); Sephatias (ID: `person:Shephatiah.6`); Miguel (ID: `person:Michael.10`); Elifelete (ID: `person:Eliphelet.5`); Utai (ID: `person:Uthai.2`); Ebede (ID: `person:Ebed.2`); Semaías (ID: `person:Shemaiah.14`); Jeiel (ID: `person:Jehiel.7`); Zeraías (ID: `person:Zerahiah.2`); Atalia (ID: `person:Athaliah.3`); Adim (ID: `person:Adin`); Secanias (ID: `person:Shecaniah.6`); Hatus (ID: `person:Hattush.2`); Daniel (ID: `person:Daniel.2`); Jaaziel (ID: `person:Jahaziel.5`); Gérson (ID: `person:Gershom.2`); Adonicão (ID: `person:Adonikam`); Davi (ID: `person:David`); Babilônia (ID: `place:Babylon`); Itamar (ID: `person:Ithamar`); Artaxerxes (ID: `person:Artaxerxes`); Fineias (ID: `person:Phinehas`)
...
* **Associated ACAI Concepts:** Eliezer (ID: `person:Eliezer.8`); Elnatã (ID: `person:Elnathan.2`); Jaribe (ID: `person:Jarib.2`); Zacarias (ID: `person:Zechariah.20`); Ido (ID: `person:Iddo`); Natã (ID: `person:Nathan.5`); Semaías (ID: `person:Shemaiah.15`); Elnatã (ID: `person:Elnathan.3`); Elnatã (ID: `person:Elnathan.4`); Joiaribe (ID: `person:Joiarib.2`); Casifia (ID: `place:Casiphia`); Mesulão (ID: `person:Meshullam.9`); Ariel (ID: `person:Ariel`); SENHOR (ID: `deity:Lord`); perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); Levi (ID: `group:Levi`); SENHOR (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); Israel (ID: `person:Israel`); Insight (ID: `keyterm:Insight`); Mali (ID: `person:Mahli`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); Amom (ID: `place:Ammon`); Canaã (ID: `place:Canaan`); Egyptians (ID: `group:Egypt`); Levi (ID: `group:Levi`); Ammonites (ID: `group:Ammon`); Moabe (ID: `place:Moab`); Hete (ID: `person:Heth`); cananeu (ID: `group:Canaan`); be unfaithful (ID: `keyterm:Unfaithful`); Egito (ID: `place:Egypt`); Levi (ID: `person:Levi.3`); Israel (ID: `person:Israel`); Jebusites (ID: `group:Jebusites`); Amorites (ID: `group:Amorites`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Harim (ID: `person:Harim`); counsel (ID: `keyterm:Counsel`); Elam (ID: `person:Elam`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); offering (ID: `keyterm:Offering`); Matanias (ID: `person:Mattaniah.5`); Sarai (ID: `person:Sharai`); Queluí (ID: `person:Cheluhi`); Matanias (ID: `person:Mattaniah.7`); Uzias (ID: `person:Uzziah.4`); Selemias (ID: `person:Shelemiah.3`); Jezias (ID: `person:Izziah`); Elasa (ID: `person:Elasah`); Meremote (ID: `person:Meremoth.2`); Adaías (ID: `person:Adaiah.6`); Selemias (ID: `person:Shelemiah.2`); Adaías (ID: `person:Adaiah.5`); Joanã (ID: `person:Jehohanan.4`); Malquias (ID: `person:Malchijah.5`); Judá (ID: `person:Judah.5`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); defilement (ID: `keyterm:Defilement`); peace (ID: `keyterm:IntactState`); Jerusalém (ID: `place:Jerusalem`); Pérsia (ID: `place:Persia`); to cause to possess (ID: `keyterm:Possess`); Israel (ID: `person:Israel`); kindness (ID: `keyterm:Kindness`); supplication (ID: `keyterm:Supplication`); dispossess (ID: `keyterm:Dispossess`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); Jerusalém (ID: `place:Jerusalem`); Pérsia (ID: `place:Persia`); kindness (ID: `keyterm:Kindness`); supplication (ID: `keyterm:Supplication`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** Secanias (ID: `person:Shecaniah.7`); Jeiel (ID: `person:Jehiel.8`); SENHOR (ID: `deity:Lord`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Israel (ID: `person:Israel`); Elam (ID: `person:Elam`)
...
* **Associated ACAI Concepts:** Covenant (ID: `keyterm:Covenant`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); counsel (ID: `keyterm:Counsel`)
...
* **Associated ACAI Concepts:** Levi (ID: `group:Levi`); swear (ID: `keyterm:Swear`); Ezra (ID: `person:Ezra`); Levi (ID: `person:Levi.3`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `person:Benjamin`); Benjamim (ID: `group:Benjamin`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ticva (ID: `person:Tikvah.2`); Sabetai (ID: `person:Shabbethai`); Mesulão (ID: `person:Meshullam.10`); Jônatas (ID: `person:Jonathan.10`); Asael (ID: `person:Asahel.4`); Jazeías (ID: `person:Jahzeiah`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`)
