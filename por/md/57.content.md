...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Arquipo (ID: `person:Archippus`); Áfia (ID: `person:Apphia`); Filemom (ID: `person:Philemon`); amado (ID: `keyterm:Beloved`); SENHOR (ID: `deity:Lord`); Timóteo (ID: `person:Timothy`); igreja (ID: `keyterm:Church`); fazer a paz (ID: `keyterm:Peace`); Paulo (ID: `person:Paul`); favor (ID: `keyterm:Favor`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); holy (ID: `keyterm:Holy`); crer (ID: `keyterm:Believe`); compaixão (ID: `keyterm:Affection`); SENHOR (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); orar (ID: `keyterm:Pray`); rogar (ID: `keyterm:AskFor`); Good (ID: `keyterm:Good`); comunhão (ID: `keyterm:Fellowship`)
...
* **Associated ACAI Concepts:** servir (ID: `keyterm:Serve`); boa notícia (ID: `keyterm:GoodNews`); Good (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Demas (ID: `person:Demas`); Epafras (ID: `person:Epaphras`); Lucas (ID: `person:Luke`); Marcos (ID: `person:Mark`); em cristo (ID: `keyterm:InChrist`); Aristarco (ID: `person:Aristarchus`); Spirit (ID: `keyterm:Spirit.2`); favor (ID: `keyterm:Favor`)
