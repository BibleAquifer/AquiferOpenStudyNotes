...
* **Associated ACAI Concepts:** desejar (ID: `keyterm:LongFor`); compaixão (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Síntique (ID: `person:Syntyche`); Evódia (ID: `person:Euodia`)
...
* **Associated ACAI Concepts:** Síntique (ID: `person:Syntyche`); Clemente (ID: `person:Clement`); Evódia (ID: `person:Euodia`); compreensivo (ID: `keyterm:Gentle`)
...
* **Associated ACAI Concepts:** Philippians (ID: `group:Philippi`); Epafrodito (ID: `person:Epaphroditus`); compartilhar (ID: `keyterm:Share`)
...
* **Associated ACAI Concepts:** Philippians (ID: `group:Philippi`); compartilhar (ID: `keyterm:Share`)
