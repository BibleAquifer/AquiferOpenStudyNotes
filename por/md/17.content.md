...
* **Associated ACAI Concepts:** Carcas (ID: `person:Carkas`); Harbona (ID: `person:Harbona`); Meumã (ID: `person:Mehuman`); Bizta (ID: `person:Biztha`); Zetar (ID: `person:Zethar`); Abagta (ID: `person:Abagtha`); Bigtá (ID: `person:Bigtha`); Assuero (ID: `person:Ahasuerus`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Vasti (ID: `person:Vashti`); Medã (ID: `person:Medan`); Assuero (ID: `person:Ahasuerus`); Medes (ID: `group:Mede`); Pérsia (ID: `place:Persia`); Persians (ID: `group:Persia`)
...
* **Associated ACAI Concepts:** Babilônia (ID: `place:Babylon`); Judá (ID: `person:Judah.4`); Jeoaquim (ID: `person:Jehoiachin`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Nabucodonozor (ID: `person:Nebuchadnezzar`)
...
* **Associated ACAI Concepts:** Ester (ID: `person:Esther`); kindness (ID: `keyterm:Kindness`); favor (ID: `keyterm:Favor`); love (ID: `keyterm:Love`); Vasti (ID: `person:Vashti`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Zeres (ID: `person:Zeresh`); love (ID: `keyterm:Love`); Ester (ID: `person:Esther`); A Group of People (ID: `group:GenericGroup`); Glory (ID: `keyterm:Glory`); Jews (ID: `group:Jews`); House (ID: `realia:House`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** beg for mercy (ID: `keyterm:BegForMercy`); Hamã (ID: `person:Haman`); Agague (ID: `person:Agag.2`); Agagites (ID: `group:Agag`); Ester (ID: `person:Esther`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Parsandata (ID: `person:Parshandatha`); Arisai (ID: `person:Arisai`); Aridai (ID: `person:Aridai`); Aspata (ID: `person:Aspatha`); Porata (ID: `person:Poratha`); Dalfom (ID: `person:Dalphon`); Adalia (ID: `person:Adalia`); Farmasta (ID: `person:Parmashta`); Vaizata (ID: `person:Vaizatha`); Aridata (ID: `person:Aridatha`); Hamedata (ID: `person:Hammedatha`); Hamã (ID: `person:Haman`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Susã (ID: `place:Susa`); Ester (ID: `person:Esther`); Jews (ID: `group:Jews`); Hamã (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Pérsia (ID: `place:Persia`); Mordecai (ID: `person:Mordecai.2`); Media (ID: `place:Media`); Assuero (ID: `person:Ahasuerus`)
...
* **Associated ACAI Concepts:** Pérsia (ID: `place:Persia`); Media (ID: `place:Media`); Mordecai (ID: `person:Mordecai.2`)
