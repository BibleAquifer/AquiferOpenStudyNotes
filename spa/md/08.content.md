...
* **Associated ACAI Concepts:** Efratita (ID: `group:Ephrathah`); Ephrata (ID: `person:Ephrathah`); Chelión (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Judá (ID: `group:Judah`); Mahalón (ID: `person:Mahlon`); Elimelech (ID: `person:Elimelech`); Catah (ID: `place:Bethlehem`); Judá (ID: `person:Judah.4`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Catah (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Booz (ID: `person:Boaz`); Moab (ID: `place:Moab`); dejar en herencia (ID: `keyterm:Possess`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Mahalón (ID: `person:Mahlon`); dejar en herencia (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Lea (ID: `person:Leah`); Catah (ID: `place:Bethlehem`); Rachêl (ID: `person:Rachel`); Jehová (ID: `deity:Lord`); Elders (ID: `group:GenericElders`)
...
* **Associated ACAI Concepts:** Thamar (ID: `person:Tamar`); Judá (ID: `group:Judah`); Phares (ID: `person:Perez`); Judá (ID: `person:Judah.4`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Hesrón (ID: `person:Hezron.2`); Salmón (ID: `person:Salmon`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Booz (ID: `person:Boaz`); Isaí (ID: `person:Jesse`); Phares (ID: `person:Perez`); Nahasón (ID: `person:Nahshon`); David (ID: `person:David`)
