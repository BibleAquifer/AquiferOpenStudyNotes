...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); fear (ID: `keyterm:Fear`); offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); Levi (ID: `person:Levi.3`); peace (ID: `keyterm:IntactState`); utter a curse (ID: `keyterm:Curse`); Levi (ID: `group:Levi`); Priests (ID: `group:GenericPriests`); Glory (ID: `keyterm:Glory`); stain (ID: `keyterm:Stain`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); fairness (ID: `keyterm:Fairness`); The Way (ID: `keyterm:TheWay`); Gentiles (ID: `group:Gentile`); pure (ID: `keyterm:Pure`); make a vow (ID: `keyterm:Vow`); rogar (ID: `keyterm:AskFor`); evil intention (ID: `keyterm:Intention`); Truth (ID: `keyterm:Truth`); An Angel (ID: `deity:Angel`); ardour (ID: `keyterm:Ardour`); bless (ID: `keyterm:Bless`); be kindly disposed (ID: `keyterm:KindlyDisposed`); profane, dishonor (ID: `keyterm:Dishonor`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** bless (ID: `keyterm:Bless`); Glory (ID: `keyterm:Glory`); SENHOR (ID: `deity:Lord`); utter a curse (ID: `keyterm:Curse`)
...
* **Associated ACAI Concepts:** evil intention (ID: `keyterm:Intention`); An Angel (ID: `deity:Angel`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); profane, dishonor (ID: `keyterm:Dishonor`); Covenant (ID: `keyterm:Covenant`); offering (ID: `keyterm:Offering`); love (ID: `keyterm:Love`); Judá (ID: `group:Judah`); delight (ID: `keyterm:Delight`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** profane, dishonor (ID: `keyterm:Dishonor`); love (ID: `keyterm:Love`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); swear (ID: `keyterm:Swear`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Covenant (ID: `keyterm:Covenant`); Judá (ID: `group:Judah`); pure (ID: `keyterm:Pure`); Jerusalém (ID: `place:Jerusalem`); A Group of People (ID: `group:GenericGroup`); Judá (ID: `person:Judah.4`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); bless (ID: `keyterm:Bless`); utter a curse (ID: `keyterm:Curse`); offering (ID: `keyterm:Offering`); decree (ID: `keyterm:Decree`); Israel (ID: `person:Israel`); Sorghum (ID: `flora:Sorghum`); Vine (ID: `flora:Vine`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); be enticed to serve (ID: `keyterm:EnticedToServe`); fear (ID: `keyterm:Fear`); Molten Image (ID: `realia:MoltenImage`); Scroll (ID: `realia:Scroll`); Cattle (ID: `fauna:Bull`); Animal Pen (ID: `realia:AnimalPen`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); Monte Sinai (ID: `place:SinaiMount`); decree (ID: `keyterm:Decree`); Moisés (ID: `person:Moses`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** fear (ID: `keyterm:Fear`); Instruction (ID: `keyterm:Instruction`); Elias (ID: `person:Elijah`); SENHOR (ID: `deity:Lord`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`); Monte Sinai (ID: `place:SinaiMount`); decree (ID: `keyterm:Decree`); Moisés (ID: `person:Moses`); Israel (ID: `person:Israel`)
