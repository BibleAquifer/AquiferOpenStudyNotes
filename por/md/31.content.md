...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); lot (ID: `keyterm:Lot`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Edomites (ID: `group:Edom`); Jerusalém (ID: `place:Jerusalem`); Edom (ID: `place:Edom`); José (ID: `person:Joseph.10`); dispossess (ID: `keyterm:Dispossess`)
...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); Edom (ID: `place:Edom`); José (ID: `person:Joseph.10`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Canaã (ID: `place:Canaan`); Efraim (ID: `group:Ephraim`); Jerusalém (ID: `place:Jerusalem`); Filisteu (ID: `group:Philistine`); Benjamim (ID: `person:Benjamin`); Filístia (ID: `place:Philistine`); Israel (ID: `person:Israel`); cananeu (ID: `group:Canaan`); Gileade (ID: `place:Gilead`); Sarepta (ID: `place:Zarephath`); Efraim (ID: `person:Ephraim`); Monte de Esaú (ID: `place:EsauMount`); Benjamim (ID: `group:Benjamin`); Sefalá (ID: `place:Shephelah`); Sardes (ID: `place:Sardis`); Samaria (ID: `place:Samaria`)
...
* **Associated ACAI Concepts:** Monte de Esaú (ID: `place:EsauMount`); Jerusalém (ID: `place:Jerusalem`); Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Filisteu (ID: `group:Philistine`); Sardes (ID: `place:Sardis`); cananeu (ID: `group:Canaan`); Canaã (ID: `place:Canaan`); Filístia (ID: `place:Philistine`); Efraim (ID: `person:Ephraim`); Benjamim (ID: `group:Benjamin`); Sefalá (ID: `place:Shephelah`); Israel (ID: `person:Israel`); Gileade (ID: `place:Gilead`); Samaria (ID: `place:Samaria`); Efraim (ID: `group:Ephraim`); Benjamim (ID: `person:Benjamin`); SENHOR (ID: `deity:Lord`); Sarepta (ID: `place:Zarephath`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Canaã (ID: `place:Canaan`); Israel (ID: `person:Israel`); cananeu (ID: `group:Canaan`); Sarepta (ID: `place:Zarephath`); Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Sardes (ID: `place:Sardis`)
