...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Édom (ID: `place:Edom`); Édom (ID: `group:Edom`); aimer (ID: `keyterm:Love`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); alliance (ID: `keyterm:Covenant`); craindre (ID: `keyterm:Fear`); offrande (ID: `keyterm:Offering`); Lévi (ID: `person:Levi.3`); Priests (ID: `group:GenericPriests`); état intact (ID: `keyterm:IntactState`); Lévi (ID: `group:Levi`); souiller (ID: `keyterm:Stain`); pleurer (ID: `keyterm:Curse`); gloire (ID: `keyterm:Glory`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); niveau (ID: `keyterm:Fairness`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); la connaissance (ID: `keyterm:Intention`); profaner, déshonorer (ID: `keyterm:Dishonor`); chemin (ID: `keyterm:TheWay`); agir avec bonté (ID: `keyterm:KindlyDisposed`); An Angel (ID: `deity:Angel`); sans saleté (ID: `keyterm:Pure`); prier (ID: `keyterm:AskFor`); faire un voeu (ID: `keyterm:Vow`); nation; peuple (ID: `group:Gentile`); vérité (ID: `keyterm:Truth`); benir (ID: `keyterm:Bless`); ardeur (ID: `keyterm:Ardour`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** souiller (ID: `keyterm:Stain`); Éternel (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** faire un voeu (ID: `keyterm:Vow`); Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); pleurer (ID: `keyterm:Curse`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** pleurer (ID: `keyterm:Curse`); Éternel (ID: `deity:Lord`); benir (ID: `keyterm:Bless`); gloire (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); alliance (ID: `keyterm:Covenant`); offrande (ID: `keyterm:Offering`); profaner, déshonorer (ID: `keyterm:Dishonor`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); aimer (ID: `keyterm:Love`); délice (ID: `keyterm:Delight`); Jérusalem (ID: `place:Jerusalem`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Juda (ID: `person:Judah.4`); aimer (ID: `keyterm:Love`); Éternel (ID: `deity:Lord`); profaner, déshonorer (ID: `keyterm:Dishonor`); Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); offrande (ID: `keyterm:Offering`); alliance (ID: `keyterm:Covenant`); jurer (ID: `keyterm:Swear`); An Angel (ID: `deity:Angel`); Juda (ID: `person:Judah.4`); Lévi (ID: `group:Levi`); sans saleté (ID: `keyterm:Pure`); A Group of People (ID: `group:GenericGroup`); craindre (ID: `keyterm:Fear`); Juda (ID: `group:Judah`); Lévi (ID: `person:Levi.3`); Jérusalem (ID: `place:Jerusalem`); Soap (ID: `realia:Soap`); Hammada (ID: `flora:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); alliance (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); offrande (ID: `keyterm:Offering`); benir (ID: `keyterm:Bless`); pleurer (ID: `keyterm:Curse`); limite (ID: `keyterm:Decree`); Wheat (ID: `flora:Wheat`); Vine (ID: `flora:Vine`); Sorghum (ID: `flora:Sorghum`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); être attiré à servir (ID: `keyterm:EnticedToServe`); craindre (ID: `keyterm:Fear`); Cattle (ID: `fauna:Bull`); Animal Pen (ID: `realia:AnimalPen`); Molten Image (ID: `realia:MoltenImage`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); montagne de Sinaï (ID: `place:SinaiMount`); limite (ID: `keyterm:Decree`); Moïse (ID: `person:Moses`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); montagne de Sinaï (ID: `place:SinaiMount`); limite (ID: `keyterm:Decree`); objet qui doit être détruit (ID: `keyterm:SomethingDevotedToGod`); Élie (ID: `person:Elijah`); Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); Moïse (ID: `person:Moses`)
...
* **Associated ACAI Concepts:** Élie (ID: `person:Elijah`); craindre (ID: `keyterm:Fear`); Éternel (ID: `deity:Lord`); objet qui doit être détruit (ID: `keyterm:SomethingDevotedToGod`)
