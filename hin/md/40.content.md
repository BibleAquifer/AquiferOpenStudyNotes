...
* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Blood (ID: `keyterm:Blood`); To Sin (ID: `keyterm:Sin`); यहोवा (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); Bless (ID: `keyterm:Bless`); Forgive (ID: `keyterm:Forgive`); Be a Disciple (ID: `keyterm:Disciple`); Kingdom (ID: `keyterm:Kingdom`); यीशु (ID: `person:Jesus.2`); Vine (ID: `flora:Vine`)
