...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); rebel (ID: `keyterm:Rebel`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); strength (ID: `keyterm:Strength`); love (ID: `keyterm:Love`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Israel (ID: `person:Israel`); defilement (ID: `keyterm:Defilement`); Mighty One (ID: `keyterm:MightyOne`); work (ID: `keyterm:Work`); appointed feast (ID: `keyterm:AppointedFeast`); To Sin (ID: `keyterm:Sin`); Deceit (ID: `keyterm:Deceit`); Train (ID: `realia:Train`); Yoke (ID: `realia:Yoke`); Winepress (ID: `realia:Winepress`); Grass (ID: `flora:Grass`); Casting Net (ID: `realia:CastingNet`); Net (ID: `realia:Net`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Deer (ID: `fauna:Deer`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); Jerusalém (ID: `place:Jerusalem`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); defilement (ID: `keyterm:Defilement`)
...
* **Associated ACAI Concepts:** Mighty One (ID: `keyterm:MightyOne`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** appointed feast (ID: `keyterm:AppointedFeast`); SENHOR (ID: `deity:Lord`); sabbath (ID: `keyterm:Sabbath`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** appointed feast (ID: `keyterm:AppointedFeast`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Edom (ID: `place:Edom`); Uz (ID: `place:Uz`); stain (ID: `keyterm:Stain`); anointed (ID: `keyterm:Anointed`); defilement (ID: `keyterm:Defilement`); Complete (ID: `keyterm:Complete`); Sodoma (ID: `place:Sodom`); be kindly disposed (ID: `keyterm:KindlyDisposed`); Appoint (ID: `keyterm:Appoint`); Punishment (ID: `keyterm:Punishment`); Believe In (ID: `keyterm:BelieveIn`); Jackal (ID: `fauna:Jackal`); Ostrich (ID: `fauna:Ostrich`); Clay Jar (ID: `realia:ClayJar`); Purple Cloth (ID: `realia:PurpleCloth`); Vulture (ID: `fauna:Vulture`)
...
* **Associated ACAI Concepts:** Edom (ID: `place:Edom`); Uz (ID: `place:Uz`); Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); Appoint (ID: `keyterm:Appoint`); To Sin (ID: `keyterm:Sin`); Complete (ID: `keyterm:Complete`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); Appoint (ID: `keyterm:Appoint`); Edom (ID: `place:Edom`); To Sin (ID: `keyterm:Sin`); Complete (ID: `keyterm:Complete`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); Assyria (ID: `place:Assyria`); ardour (ID: `keyterm:Ardour`); Woe (ID: `keyterm:Woe`); to cause to possess (ID: `keyterm:Possess`); round dance (ID: `keyterm:RoundDance`); Judá (ID: `person:Judah.4`); Egito (ID: `place:Egypt`); Judá (ID: `group:Judah`); House (ID: `realia:House`); Jackal (ID: `fauna:Jackal`); Hand-Mill (ID: `realia:Hand-mill`); Money (ID: `realia:Money`); Crown (ID: `realia:Crown`)
