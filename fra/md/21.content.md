...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); la connaissance (ID: `keyterm:Intention`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); stupide (ID: `keyterm:Stupid`); Vine (ID: `flora:Vine`); pécher (ID: `keyterm:Sin`); Israël (ID: `person:Israel`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); capacité (ID: `keyterm:Ability`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Sandalwood (ID: `flora:Sandalwood`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Sandalwood (ID: `flora:Sandalwood`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); stupide (ID: `keyterm:Stupid`); faire un voeu (ID: `keyterm:Vow`); House (ID: `realia:House`); tuerie (ID: `keyterm:Slaughtering`); A Man (ID: `person:GenericMale`); force (ID: `keyterm:Strength`); An Angel (ID: `deity:Angel`); ardeur (ID: `keyterm:Ardour`); craindre (ID: `keyterm:Fear`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** stupide (ID: `keyterm:Stupid`); capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`); la connaissance (ID: `keyterm:Intention`); pécher (ID: `keyterm:Sin`); agir par méchanceté (ID: `keyterm:ActWickedly`); laissiez en possession (ID: `keyterm:Possess`); craindre (ID: `keyterm:Fear`); Brier (ID: `flora:Brier`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Cooking Pot (ID: `realia:CookingPot`)
...
* **Associated ACAI Concepts:** pécher (ID: `keyterm:Sin`); Éternel (ID: `deity:Lord`); Fishnet (ID: `realia:Fishnet`); Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); aimer (ID: `keyterm:Love`); capacité (ID: `keyterm:Ability`); jurer (ID: `keyterm:Swear`); la connaissance (ID: `keyterm:Intention`); sans saleté (ID: `keyterm:Pure`); securité (ID: `keyterm:Safety`); percevoir (ID: `keyterm:Perceive`); adjuration (ID: `keyterm:Oath`); force (ID: `keyterm:Strength`); pollution (ID: `keyterm:Defilement`); pécher (ID: `keyterm:Sin`); Hell (ID: `place:Hell`); grâce (ID: `keyterm:Favor`); ardeur (ID: `keyterm:Ardour`); Dog (ID: `fauna:Dog`); Lion (ID: `fauna:Lion`); Anointing Oil (ID: `realia:AnointingOil`); Fish (ID: `fauna:Fish`); Net (ID: `realia:Net`); Wine (ID: `realia:Wine`); Fishnet (ID: `realia:Fishnet`); Vine (ID: `flora:Vine`); Bird (ID: `fauna:Bird`); Trap (ID: `realia:Trap`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** jurer (ID: `keyterm:Swear`); pécher (ID: `keyterm:Sin`); pollution (ID: `keyterm:Defilement`); sans saleté (ID: `keyterm:Pure`); adjuration (ID: `keyterm:Oath`)
...
* **Associated ACAI Concepts:** la connaissance (ID: `keyterm:Intention`); Hell (ID: `place:Hell`); Éternel (ID: `deity:Lord`); aimer (ID: `keyterm:Love`); capacité (ID: `keyterm:Ability`); force (ID: `keyterm:Strength`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** la connaissance (ID: `keyterm:Intention`); capacité (ID: `keyterm:Ability`); Hell (ID: `place:Hell`); force (ID: `keyterm:Strength`)
...
* **Associated ACAI Concepts:** stupide (ID: `keyterm:Stupid`); Wine (ID: `realia:Wine`); Bed (ID: `realia:Bed`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); craindre (ID: `keyterm:Fear`); Éternel (ID: `deity:Lord`); Caper (ID: `flora:Caper`); Clay Jar (ID: `realia:ClayJar`); Bird (ID: `fauna:Bird`); Rope (ID: `realia:Rope`); Money (ID: `realia:Money`); Locust (ID: `fauna:Locust`); Pit (ID: `realia:Pit`); Almond (ID: `flora:Almond`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); la connaissance (ID: `keyterm:Intention`); droiture (ID: `keyterm:Straightness`); vérité (ID: `keyterm:Truth`); proverbe (ID: `keyterm:Saying`); craindre (ID: `keyterm:Fear`); Goad (ID: `realia:Goad`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Scroll (ID: `realia:Scroll`); Nail (ID: `realia:Nail`)
