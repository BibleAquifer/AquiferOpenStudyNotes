...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); Rebel (ID: `keyterm:Rebel`); Strength (ID: `keyterm:Strength`); Love (ID: `keyterm:Love`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Appointed Feast (ID: `keyterm:AppointedFeast`); Work (ID: `keyterm:Work`); إِسْرَائِيلَ (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); Mighty One (ID: `keyterm:MightyOne`); Deceit (ID: `keyterm:Deceit`); Defilement (ID: `keyterm:Defilement`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Train (ID: `realia:Train`); Deer (ID: `fauna:Deer`); Net (ID: `realia:Net`); Casting Net (ID: `realia:CastingNet`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Yoke (ID: `realia:Yoke`); House (ID: `realia:House`); Grass (ID: `flora:Grass`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); Mighty One (ID: `keyterm:MightyOne`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Appointed Feast (ID: `keyterm:AppointedFeast`); يَهوذَا (ID: `group:Judah`); Horn (ID: `keyterm:Horn`); يَهوذَا (ID: `person:Judah.4`); Sheep (ID: `fauna:Lamb`); Gentiles (ID: `group:Gentile`); Utterance (ID: `keyterm:Utterance`); Instruction (ID: `keyterm:Instruction`); Have a Vision (ID: `keyterm:HaveAVision`); Sabbath (ID: `keyterm:Sabbath`); Passion (ID: `keyterm:Ardour`); To Dishonor (ID: `keyterm:Dishonor`); Wine (ID: `realia:Wine`); Measuring Reed (ID: `realia:MeasuringReed`); Altar (ID: `realia:Altar`); Vine (ID: `flora:Vine`); Bow (ID: `realia:Bow`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`); Tent (ID: `realia:Tent`); Sackcloth (ID: `realia:Sackcloth`); Grain (ID: `flora:Grain`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Sabbath (ID: `keyterm:Sabbath`); ٱلرَّبِّ (ID: `deity:Lord`); Appointed Feast (ID: `keyterm:AppointedFeast`)
...
* **Associated ACAI Concepts:** Appointed Feast (ID: `keyterm:AppointedFeast`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Arrow (ID: `realia:Arrow`); Wormwood (ID: `flora:Wormwood`); Kindness (ID: `keyterm:Kindness`); Peace (ID: `keyterm:IntactState`); Arrow (ID: `keyterm:Arrow`); Complete (ID: `keyterm:Complete`); Hewn Stone (ID: `realia:HewnStone`); Bow (ID: `realia:Bow`); Bitter Herbs (ID: `flora:Chicory`); Lion (ID: `fauna:Lion`); Bear (ID: `fauna:Bear`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Arrow (ID: `keyterm:Arrow`); Fear (ID: `keyterm:Fear`); Rebel (ID: `keyterm:Rebel`); To Sin (ID: `keyterm:Sin`); Peace (ID: `keyterm:IntactState`); Forgive (ID: `keyterm:Forgive`); Salvation (ID: `keyterm:Salvation`); Redeem (ID: `keyterm:Redeem`); Complete (ID: `keyterm:Complete`); Hope (ID: `keyterm:Hope`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Pit (ID: `realia:Pit`); Arrow (ID: `realia:Arrow`); Wormwood (ID: `flora:Wormwood`); Hewn Stone (ID: `realia:HewnStone`); Bitter Herbs (ID: `flora:Chicory`); Bow (ID: `realia:Bow`); Bird (ID: `fauna:Bird`); Yoke (ID: `realia:Yoke`); Lion (ID: `fauna:Lion`); Bear (ID: `fauna:Bear`)
...
* **Associated ACAI Concepts:** Passion (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`); أَدومَ (ID: `place:Edom`); Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); أورشَلِيمَ (ID: `place:Jerusalem`)
