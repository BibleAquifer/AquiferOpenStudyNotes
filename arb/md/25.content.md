...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Strength (ID: `keyterm:Strength`); Love (ID: `keyterm:Love`); إِسْرَائِيلَ (ID: `person:Israel`); Defilement (ID: `keyterm:Defilement`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Deceit (ID: `keyterm:Deceit`); Mighty One (ID: `keyterm:MightyOne`); Appointed Feast (ID: `keyterm:AppointedFeast`); To Sin (ID: `keyterm:Sin`); Work (ID: `keyterm:Work`); Train (ID: `realia:Train`); Flock (ID: `fauna:Flock`); Winepress (ID: `realia:Winepress`); Net (ID: `realia:Net`); Grass (ID: `flora:Grass`); Yoke (ID: `realia:Yoke`); Goat (ID: `fauna:Goat`); Deer (ID: `fauna:Deer`); House (ID: `realia:House`); Casting Net (ID: `realia:CastingNet`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); Defilement (ID: `keyterm:Defilement`); To Sin (ID: `keyterm:Sin`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Appointed Feast (ID: `keyterm:AppointedFeast`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Horn (ID: `keyterm:Horn`); Sheep (ID: `fauna:Lamb`); Instruction (ID: `keyterm:Instruction`); Gentiles (ID: `group:Gentile`); Sabbath (ID: `keyterm:Sabbath`); Passion (ID: `keyterm:Ardour`); Have a Vision (ID: `keyterm:HaveAVision`); Utterance (ID: `keyterm:Utterance`); To Dishonor (ID: `keyterm:Dishonor`); Bow (ID: `realia:Bow`); Temple Altar (ID: `realia:TempleAltar`); Sackcloth (ID: `realia:Sackcloth`); Tent (ID: `realia:Tent`); Vine (ID: `flora:Vine`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Wine (ID: `realia:Wine`); Grain (ID: `flora:Grain`); Stone Altar (ID: `realia:StoneAltar`); Measuring Reed (ID: `realia:MeasuringReed`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); Horn (ID: `keyterm:Horn`); Bow (ID: `realia:Bow`); Sheep (ID: `fauna:Lamb`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Appointed Feast (ID: `keyterm:AppointedFeast`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Arrow (ID: `realia:Arrow`); Wormwood (ID: `flora:Wormwood`); Arrow (ID: `keyterm:Arrow`); Peace (ID: `keyterm:IntactState`); Kindness (ID: `keyterm:Kindness`); Complete (ID: `keyterm:Complete`); Bow (ID: `realia:Bow`); Hewn Stone (ID: `realia:HewnStone`); Lion (ID: `fauna:Lion`); Bear (ID: `fauna:Bear`); Bitter Herbs (ID: `flora:Chicory`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Peace (ID: `keyterm:IntactState`); Salvation (ID: `keyterm:Salvation`); Arrow (ID: `keyterm:Arrow`); Fear (ID: `keyterm:Fear`); Redeem (ID: `keyterm:Redeem`); Rebel (ID: `keyterm:Rebel`); Hope (ID: `keyterm:Hope`); Complete (ID: `keyterm:Complete`); Forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Wormwood (ID: `flora:Wormwood`); Pit (ID: `realia:Pit`); Arrow (ID: `realia:Arrow`); Bird (ID: `fauna:Bird`); Bow (ID: `realia:Bow`); Hewn Stone (ID: `realia:HewnStone`); Bitter Herbs (ID: `flora:Chicory`); Yoke (ID: `realia:Yoke`); Bear (ID: `fauna:Bear`); Lion (ID: `fauna:Lion`)
...
* **Associated ACAI Concepts:** أَدومَ (ID: `place:Edom`); عوصًا (ID: `place:Uz`); Appoint (ID: `keyterm:Appoint`); أورشَلِيمَ (ID: `place:Jerusalem`); Complete (ID: `keyterm:Complete`); Passion (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** Appoint (ID: `keyterm:Appoint`); أورشَلِيمَ (ID: `place:Jerusalem`); Complete (ID: `keyterm:Complete`); Passion (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`); أَدومَ (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); مِصْرَ (ID: `place:Egypt`); Round Dance (ID: `keyterm:RoundDance`); Assyria (ID: `place:Assyria`); يَهوذَا (ID: `group:Judah`); Woe (ID: `keyterm:Woe`); يَهوذَا (ID: `person:Judah.4`); Passion (ID: `keyterm:Ardour`); To Cause to Possess (ID: `keyterm:Possess`); Crown (ID: `realia:Crown`); Hand-Mill (ID: `realia:Hand-mill`); House (ID: `realia:House`); Jackal (ID: `fauna:Jackal`); Money (ID: `realia:Money`)
