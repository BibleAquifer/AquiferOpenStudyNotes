...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Love (ID: `keyterm:Love`); ٱلرَّبِّ (ID: `deity:Lord`); أَدومَ (ID: `place:Edom`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Fear (ID: `keyterm:Fear`); Offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); Peace (ID: `keyterm:IntactState`); Defile (ID: `keyterm:Stain`); To Curse (ID: `keyterm:Curse`); Priests (ID: `group:GenericPriests`); لَّاوِي (ID: `person:Levi.3`); Glory (ID: `keyterm:Glory`); لَّاوِي (ID: `group:Levi`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Fairness (ID: `keyterm:Fairness`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); An Angel (ID: `deity:Angel`); Truth (ID: `keyterm:Truth`); Bless (ID: `keyterm:Bless`); Vow (ID: `keyterm:Vow`); Passion (ID: `keyterm:Ardour`); Pure (ID: `keyterm:Pure`); Gentiles (ID: `group:Gentile`); The Way (ID: `keyterm:TheWay`); Intention (ID: `keyterm:Intention`); To Dishonor (ID: `keyterm:Dishonor`); Ask for (ID: `keyterm:AskFor`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Defile (ID: `keyterm:Stain`); ٱلرَّبِّ (ID: `deity:Lord`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** Fear (ID: `keyterm:Fear`); ٱلرَّبِّ (ID: `deity:Lord`); To Curse (ID: `keyterm:Curse`); Vow (ID: `keyterm:Vow`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); To Dishonor (ID: `keyterm:Dishonor`); Covenant (ID: `keyterm:Covenant`); Love (ID: `keyterm:Love`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); Delight (ID: `keyterm:Delight`); يَهوذَا (ID: `group:Judah`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Love (ID: `keyterm:Love`); To Dishonor (ID: `keyterm:Dishonor`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Pure (ID: `keyterm:Pure`); Fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); لَّاوِي (ID: `group:Levi`); Swear (ID: `keyterm:Swear`); لَّاوِي (ID: `person:Levi.3`); A Group of People (ID: `group:GenericGroup`); Covenant (ID: `keyterm:Covenant`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** An Angel (ID: `deity:Angel`); ٱلرَّبِّ (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Bless (ID: `keyterm:Bless`); Decree (ID: `keyterm:Decree`); To Curse (ID: `keyterm:Curse`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Sorghum (ID: `flora:Sorghum`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Force to Serve (ID: `keyterm:EnticedToServe`); Fear (ID: `keyterm:Fear`); Scroll (ID: `realia:Scroll`); Cattle (ID: `fauna:Bull`); Molten Image (ID: `realia:MoltenImage`); Animal Pen (ID: `realia:AnimalPen`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); موسَى (ID: `person:Moses`); Instruction (ID: `keyterm:Instruction`); سِينَاءَ (ID: `place:SinaiMount`); Decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); إِسْرَائِيلَ (ID: `person:Israel`); Fear (ID: `keyterm:Fear`); موسَى (ID: `person:Moses`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); سِينَاءَ (ID: `place:SinaiMount`); إِيلِيَّا (ID: `person:Elijah`); Decree (ID: `keyterm:Decree`)
