...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); berbahagialah (ID: `keyterm:Happy`); mencobai (ID: `keyterm:PutToTheTest`); kekasih (ID: `keyterm:Beloved`); tahan uji (ID: `keyterm:Approved`); suci (ID: `keyterm:Clean`); sia, sia (ID: `keyterm:Worthless`); tak bernoda (ID: `keyterm:AboveCriticism`); kebenaran (ID: `keyterm:Truth`); tidak dapat dicobai (ID: `keyterm:NotTempted`); keselamatan (ID: `keyterm:Salvation`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); berbuat dosa (ID: `keyterm:Sin`); keahlian (ID: `keyterm:Ability`); kehidupan (ID: `keyterm:Life`); hukum (ID: `keyterm:Law`); janji (ID: `keyterm:Promise`); yang baik (ID: `keyterm:Good`); A Person (ID: `person:GenericPerson`); kasihi (ID: `keyterm:Love`); tidak dicemarkan (ID: `keyterm:Undefiled`); hati (ID: `keyterm:Heart`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** suci (ID: `keyterm:Clean`); sia, sia (ID: `keyterm:Worthless`); keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`); tak bernoda (ID: `keyterm:AboveCriticism`); tidak dicemarkan (ID: `keyterm:Undefiled`); hati (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); tonton bulu atau muka (ID: `keyterm:Partiality`); percaya (ID: `keyterm:Believe`); kemuliaan (ID: `keyterm:Glory`); Yesus (ID: `person:Jesus.2`); bimbang (ID: `keyterm:Discern`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** orang pilihan (ID: `keyterm:Chosen`); percaya (ID: `keyterm:Believe`); kasihi (ID: `keyterm:Love`); keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`); kekasih (ID: `keyterm:Beloved`); janji (ID: `keyterm:Promise`); kerajaan (ID: `keyterm:Kingdom`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); tonton bulu atau muka (ID: `keyterm:Partiality`); tersandung (ID: `keyterm:Stumble`); penghakiman (ID: `keyterm:Judgment`); belas kasihan (ID: `keyterm:Mercy`); berbuat dosa (ID: `keyterm:Sin`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`); kasihi (ID: `keyterm:Love`); persundalan (ID: `keyterm:Fornication`); memutuskan (ID: `keyterm:Decided`); pengadilan (ID: `keyterm:CourtCase`); kitab suci (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); A Person (ID: `person:GenericPerson`); Tuhan (ID: `deity:Lord`); Abraham (ID: `person:Abraham`); tubuh (ID: `keyterm:Body.3`); Rahab (ID: `person:Rahab`); sia, sia (ID: `keyterm:Idle`); An Angel (ID: `deity:Angel`); hampa (ID: `keyterm:Empty`); kitab suci (ID: `keyterm:Scripture`); menggenapi (ID: `keyterm:Happen`); Demons (ID: `deity:Demons`); memperdamaikan (ID: `keyterm:Peace`); Ishak (ID: `person:Isaac`); roh (ID: `keyterm:Spirit.2`); keselamatan (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); menggenapi (ID: `keyterm:Happen`); Tuhan (ID: `deity:Lord`); Abraham (ID: `person:Abraham`); kitab suci (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); tidak setia (ID: `keyterm:Unfaithful`); persahabatan (ID: `keyterm:Friendship`); murni (ID: `keyterm:Pure`); Roh (ID: `deity:HolySpirit`); ingin (ID: `keyterm:LongFor`); Cause of Joy (ID: `keyterm:CauseOfJoy`); keahlian (ID: `keyterm:Ability`); roh (ID: `keyterm:Spirit.2`); membersihkan (ID: `keyterm:Cleanse.2`); hati (ID: `keyterm:Heart`); kebaikan (ID: `keyterm:Favor`); kitab suci (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Tuhan (ID: `deity:Lord`); tubuh (ID: `keyterm:Body.3`); menentang (ID: `keyterm:Condemn`); bersaksi (ID: `keyterm:BearWitness`); hati (ID: `keyterm:Heart`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** jemaat (ID: `keyterm:Church`); Tuhan (ID: `deity:Lord`); nama (ID: `keyterm:Name`); diurapi (ID: `keyterm:Anointed`); berdoa (ID: `keyterm:Pray`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); berbuat dosa (ID: `keyterm:Sin`); Tuhan (ID: `deity:Lord`); mengampuni (ID: `keyterm:Forgive`); keselamatan (ID: `keyterm:Salvation`); berdoa (ID: `keyterm:Pray`)
