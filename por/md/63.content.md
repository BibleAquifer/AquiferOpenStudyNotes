...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); misericórdia (ID: `keyterm:Mercy`); fazer a paz (ID: `keyterm:Peace`); escolhido (ID: `keyterm:Chosen`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`)
...
* **Associated ACAI Concepts:** misericórdia (ID: `keyterm:Mercy`); love (ID: `keyterm:Love`); fazer a paz (ID: `keyterm:Peace`); Truth (ID: `keyterm:Truth`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); compartilhar (ID: `keyterm:Share`); Ability (ID: `keyterm:Ability`); Truth (ID: `keyterm:Truth`); corpo (ID: `keyterm:Body.3`); rogar (ID: `keyterm:AskFor`); House (ID: `realia:House`)
