...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Liban (ID: `place:Lebanon`); chemin (ID: `keyterm:TheWay`); force (ID: `keyterm:Strength`); Basan (ID: `place:Bashan`); zélé (ID: `keyterm:Zealous.3`); Carmel (ID: `place:Carmel`); déclarer innocent (ID: `keyterm:PronounceInnocent`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); méchanceté (ID: `keyterm:Wickedness`); Liban (ID: `place:Lebanon`); force (ID: `keyterm:Strength`); chemin (ID: `keyterm:TheWay`); Basan (ID: `place:Bashan`); zélé (ID: `keyterm:Zealous.3`); se réfugier (ID: `keyterm:SeekfindRefuge`); Carmel (ID: `place:Carmel`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Brier (ID: `flora:Brier`); Strong Drink (ID: `realia:StrongDrink`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** Libya (ID: `place:Libya`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Égypte (ID: `place:Egypt`); destin (ID: `keyterm:Lot`); Cush (ID: `place:Cush.2`); Puth (ID: `place:Put`)
