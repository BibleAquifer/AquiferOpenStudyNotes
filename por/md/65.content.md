...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Judas (ID: `person:Jude`); Tiago (ID: `person:James.3`); misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`); fazer a paz (ID: `keyterm:Peace`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); comum (ID: `keyterm:InCommon`); holy (ID: `keyterm:Holy`); empenho (ID: `keyterm:Eagerness`); rogar (ID: `keyterm:AskFor`); amado (ID: `keyterm:Beloved`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); comum (ID: `keyterm:InCommon`); favor (ID: `keyterm:Favor`); holy (ID: `keyterm:Holy`); Jesus (ID: `person:Jesus.2`); juízo (ID: `keyterm:Judgment`); empenho (ID: `keyterm:Eagerness`); rogar (ID: `keyterm:AskFor`); amado (ID: `keyterm:Beloved`); SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); juízo (ID: `keyterm:Judgment`)
...
* **Associated ACAI Concepts:** corpo (ID: `keyterm:Body.3`); juízo (ID: `keyterm:Judgment`); blasfemar (ID: `keyterm:Blaspheme`); para a eternidade (ID: `keyterm:Always`); tribunal de justiça (ID: `keyterm:CourtCase`); SENHOR (ID: `deity:Lord`); Corá (ID: `person:Korah.3`); crer (ID: `keyterm:Believe`); Egito (ID: `place:Egypt`); ágape (ID: `keyterm:FellowshipMeal`); Jesus (ID: `person:Jesus.2`); Adão (ID: `person:Adam`); Caim (ID: `person:Cain`); salvation (ID: `keyterm:Salvation`); Miguel (ID: `person:Michael.11`); distinguir (ID: `keyterm:Discern`); speak (ID: `keyterm:Speak`); Enoque (ID: `person:Enoch.2`); defilement (ID: `keyterm:Defilement`); Ability (ID: `keyterm:Ability`); Balaão (ID: `person:Balaam`); Gomorra (ID: `place:Gomorrah`); To Command (ID: `keyterm:Command`); Moisés (ID: `person:Moses`); holy (ID: `keyterm:Holy`); An Angel (ID: `deity:Angel`); Sodoma (ID: `place:Sodom`); fogo eterno (ID: `keyterm:EternalFire`); Disaster (ID: `keyterm:Disaster`); Flock (ID: `fauna:Flock`); Chain (ID: `realia:Chain`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** para a eternidade (ID: `keyterm:Always`); corpo (ID: `keyterm:Body.3`); Sodoma (ID: `place:Sodom`); fogo eterno (ID: `keyterm:EternalFire`); Gomorra (ID: `place:Gomorrah`)
...
* **Associated ACAI Concepts:** To Command (ID: `keyterm:Command`); Miguel (ID: `person:Michael.11`); Moisés (ID: `person:Moses`); distinguir (ID: `keyterm:Discern`); blasfemar (ID: `keyterm:Blaspheme`); corpo (ID: `keyterm:Body.3`); juízo (ID: `keyterm:Judgment`); tribunal de justiça (ID: `keyterm:CourtCase`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Enoque (ID: `person:Enoch.2`); SENHOR (ID: `deity:Lord`); holy (ID: `keyterm:Holy`); juízo (ID: `keyterm:Judgment`); Adão (ID: `person:Adam`); tribunal de justiça (ID: `keyterm:CourtCase`); speak (ID: `keyterm:Speak`)
...
* **Associated ACAI Concepts:** misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`); Holy Spirit (ID: `deity:HolySpirit`); amado (ID: `keyterm:Beloved`); crer (ID: `keyterm:Believe`); fear (ID: `keyterm:Fear`); causar divisões (ID: `keyterm:CreatingDivisions`); corpo (ID: `keyterm:Body.3`); Life (ID: `keyterm:Life`); salvation (ID: `keyterm:Salvation`); orar (ID: `keyterm:Pray`); distinguir (ID: `keyterm:Discern`); palavra (ID: `keyterm:Word`); love (ID: `keyterm:Love`); natural (ID: `keyterm:Natural`); holy (ID: `keyterm:Holy`); para a eternidade (ID: `keyterm:Always`); SENHOR (ID: `deity:Lord`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); crer (ID: `keyterm:Believe`); Holy Spirit (ID: `deity:HolySpirit`); holy (ID: `keyterm:Holy`); amado (ID: `keyterm:Beloved`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); surely! (ID: `keyterm:Surely`); para a eternidade (ID: `keyterm:Always`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); irrepreensível (ID: `keyterm:Unblemished`); autoridade (ID: `keyterm:Authority.2`); SENHOR (ID: `deity:Lord`); salvador (ID: `keyterm:Savior`)
