...
* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Blood (ID: `keyterm:Blood`); Covenant (ID: `keyterm:Covenant`); यहोवा (ID: `deity:Lord`); Bless (ID: `keyterm:Bless`); Be a Disciple (ID: `keyterm:Disciple`); Forgive (ID: `keyterm:Forgive`); Kingdom (ID: `keyterm:Kingdom`); To Sin (ID: `keyterm:Sin`); यीशु (ID: `person:Jesus.2`); Vine (ID: `flora:Vine`)
