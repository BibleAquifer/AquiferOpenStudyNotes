...
* **Associated ACAI Concepts:** Blood (ID: `keyterm:Blood`); Body (ID: `keyterm:Body.3`); Kingdom (ID: `keyterm:Kingdom`); Covenant (ID: `keyterm:Covenant`); To Sin (ID: `keyterm:Sin`); Be a Disciple (ID: `keyterm:Disciple`); Bless (ID: `keyterm:Bless`); यहोवा (ID: `deity:Lord`); यीशु (ID: `person:Jesus.2`); Forgive (ID: `keyterm:Forgive`); Vine (ID: `flora:Vine`)
