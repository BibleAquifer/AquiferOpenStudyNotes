...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); Understanding (ID: `keyterm:Understanding`); Covenant (ID: `keyterm:Covenant`); أَدومَ (ID: `place:Edom`); Peace (ID: `keyterm:IntactState`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** Lot (ID: `keyterm:Lot`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Edomites (ID: `group:Edom`); إِسْرَائِيلَ (ID: `person:Israel`); أَدومَ (ID: `place:Edom`); يوسف (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); ٱلْجَنوبِ (ID: `place:Negeb`); Canaanites (ID: `group:Canaan`); سَارْدِسَ (ID: `place:Sardis`); جِلْعَادَ (ID: `place:Gilead`); كَنْعَان (ID: `place:Canaan`); ٱلسَّهْلِ (ID: `place:Shephelah`); أورشَلِيمَ (ID: `place:Jerusalem`); إِلَى (ID: `place:Zarephath`); بَنْيَامِينَ (ID: `group:Benjamin`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); ٱلسَّامِرَةِ (ID: `place:Samaria`); فِلِشْتِيم (ID: `group:Philistine`); إِسْرَائِيلَ (ID: `person:Israel`); أَفْرَايِمَ (ID: `group:Ephraim`); أَفْرَايِمَ (ID: `person:Ephraim`); عِيسو (ID: `place:EsauMount`); بَنْيَامِينَ (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Dispossess (ID: `keyterm:Dispossess`); ٱلْجَنوبِ (ID: `place:Negeb`); عِيسو (ID: `place:EsauMount`); بَنْيَامِينَ (ID: `group:Benjamin`); ٱلسَّامِرَةِ (ID: `place:Samaria`); كَنْعَان (ID: `place:Canaan`); أَفْرَايِمَ (ID: `group:Ephraim`); Canaanites (ID: `group:Canaan`); ٱلرَّبِّ (ID: `deity:Lord`); جِلْعَادَ (ID: `place:Gilead`); ٱلسَّهْلِ (ID: `place:Shephelah`); إِلَى (ID: `place:Zarephath`); أَفْرَايِمَ (ID: `person:Ephraim`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); فِلِشْتِيم (ID: `group:Philistine`); إِسْرَائِيلَ (ID: `person:Israel`); بَنْيَامِينَ (ID: `person:Benjamin`); سَارْدِسَ (ID: `place:Sardis`)
...
* **Associated ACAI Concepts:** Canaanites (ID: `group:Canaan`); سَارْدِسَ (ID: `place:Sardis`); أورشَلِيمَ (ID: `place:Jerusalem`); إِلَى (ID: `place:Zarephath`); Dispossess (ID: `keyterm:Dispossess`); إِسْرَائِيلَ (ID: `person:Israel`); كَنْعَان (ID: `place:Canaan`); ٱلْجَنوبِ (ID: `place:Negeb`)
