...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); أورشَلِيمَ (ID: `place:Jerusalem`); Intention (ID: `keyterm:Intention`); Stupid (ID: `keyterm:Stupid`); ٱلرَّبِّ (ID: `deity:Lord`); Vine (ID: `flora:Vine`); To Sin (ID: `keyterm:Sin`); إِسْرَائِيلَ (ID: `person:Israel`); Wine (ID: `realia:Wine`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`); Sandalwood (ID: `flora:Sandalwood`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); أورشَلِيمَ (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Flock (ID: `fauna:Flock`); Vine (ID: `flora:Vine`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Intention (ID: `keyterm:Intention`); ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vow (ID: `keyterm:Vow`); House (ID: `realia:House`); A Man (ID: `person:GenericMale`); Passion (ID: `keyterm:Ardour`); Strength (ID: `keyterm:Strength`); Slaughtering (ID: `keyterm:Slaughtering`); An Angel (ID: `deity:Angel`); Fear (ID: `keyterm:Fear`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Stupid (ID: `keyterm:Stupid`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); To Act Wickedly (ID: `keyterm:ActWickedly`); To Sin (ID: `keyterm:Sin`); To Cause to Possess (ID: `keyterm:Possess`); Intention (ID: `keyterm:Intention`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Brier (ID: `flora:Brier`); Cooking Pot (ID: `realia:CookingPot`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); ٱلرَّبِّ (ID: `deity:Lord`); Dragnet (ID: `realia:Dragnet`); Fishnet (ID: `realia:Fishnet`); Net (ID: `realia:Net`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Strength (ID: `keyterm:Strength`); Love (ID: `keyterm:Love`); Hell (ID: `place:Hell`); Intention (ID: `keyterm:Intention`); ٱلرَّبِّ (ID: `deity:Lord`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Caper (ID: `flora:Caper`); Pit (ID: `realia:Pit`); Rope (ID: `realia:Rope`); Bird (ID: `fauna:Bird`); Clay Jar (ID: `realia:ClayJar`); Almond (ID: `flora:Almond`); Locust (ID: `fauna:Locust`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Straightness (ID: `keyterm:Straightness`); Fear (ID: `keyterm:Fear`); Truth (ID: `keyterm:Truth`); Intention (ID: `keyterm:Intention`); Proverb (ID: `keyterm:Saying`); Goad (ID: `realia:Goad`); Nail (ID: `realia:Nail`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Scroll (ID: `realia:Scroll`); Sheep (ID: `fauna:Lamb`)
