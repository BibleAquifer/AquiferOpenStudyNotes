...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`); Israel (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Jeremias (ID: `person:Jeremiah.6`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Pérsia (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `group:Benjamin`); SENHOR (ID: `deity:Lord`); Benjamim (ID: `person:Benjamin`); Judá (ID: `person:Judah.4`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Judá (ID: `group:Judah`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Judá (ID: `group:Judah`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `person:Judah.4`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Salomão (ID: `person:Solomon`); Jerusalém (ID: `place:Jerusalem`); Hacufa (ID: `person:Hakupha`); Nesias (ID: `person:Neziah`); Rezim (ID: `person:Rezin.2`); Bezai (ID: `person:Bezai`); Bigvai (ID: `person:Bigvai`); Ará (ID: `person:Arah.2`); Sephatias (ID: `person:Shephatiah.7`); Nephushesim (ID: `group:Nephushesim`); Hasufa (ID: `person:Hasupha`); Harim (ID: `person:Harim.2`); Jesua (ID: `person:Jeshua.3`); Tel-Melá (ID: `place:Tel-melah`); Bigvai (ID: `person:Bigvai.2`); Barzillai (ID: `person:Barzillai.3`); Hatita (ID: `person:Hatita`); Adim (ID: `person:Adin`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Jedaías (ID: `person:Jedaiah.4`); Reelaías (ID: `person:Reelaiah`); Meunim (ID: `group:Meunim`); Temá (ID: `person:Temah`); Reaías (ID: `person:Reaiah.3`); Baquebuque (ID: `person:Bakbuk`); Darcom (ID: `person:Darkon`)
...
* **Associated ACAI Concepts:** Bilsã (ID: `person:Bilshan`); Baana (ID: `person:Baanah.3`); Mispar (ID: `person:Mispar`); Bigvai (ID: `person:Bigvai`); Reelaías (ID: `person:Reelaiah`); Seraias (ID: `person:Seraiah.6`); Neemias (ID: `person:Nehemiah`); Reum (ID: `person:Rehum`); Mordecai (ID: `person:Mordecai`); Israel (ID: `person:Israel`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** Parós (ID: `person:Parosh`); Bebai (ID: `person:Bebai`); Bezai (ID: `person:Bezai`); Ará (ID: `person:Arah.2`); Ater (ID: `person:Ater`); Bani (ID: `person:Bani`); Elam (ID: `person:Elam`); Jesua (ID: `person:Jeshua.3`); Asgade (ID: `person:Azgad`); Bigvai (ID: `person:Bigvai.2`); Adim (ID: `person:Adin`); Joabe (ID: `person:Joab.3`); Zacai (ID: `person:Zaccai.2`); Sephatias (ID: `person:Shephatiah.6`); Paate-Moabe (ID: `person:Pahath-moab`); Hasum (ID: `person:Hashum`); Ezequias (ID: `person:Hezekiah.2`); Zatu (ID: `person:Zattu.2`); Jora (ID: `person:Jorah`); Adonicão (ID: `person:Adonikam`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Netofa (ID: `place:Netophah`); Nebo (ID: `place:Nebo.2`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Harim (ID: `person:Harim.2`); Hadide (ID: `place:Hadid`); Magbis (ID: `place:Magbish`); Senaa (ID: `place:Senaah`); Quiriate-Jearim (ID: `place:Kiriath-jearim`); Ai (ID: `place:Ai`); Elam (ID: `person:Elam`); Lode (ID: `place:Lod`); Cefira (ID: `place:Chephirah`); Betel (ID: `place:Bethel`); Ramah (ID: `place:Ramah.2`); Geba (ID: `place:Geba`); Micmás (ID: `place:Michmash`); Jericó (ID: `place:Jericho`); Belém (ID: `place:Bethlehem`); Beerote (ID: `place:Beeroth`); Ono (ID: `place:Ono`); Anatote (ID: `place:Anathoth`)
...
* **Associated ACAI Concepts:** Harim (ID: `person:Harim`); Ater (ID: `person:Ater.2`); Jedaías (ID: `person:Jedaiah.4`); Imer (ID: `person:Immer.2`); Talmom (ID: `person:Talmon`); Hatita (ID: `person:Hatita`); Jesua (ID: `person:Jeshua.4`); Sobai (ID: `person:Shobai`); Jesua (ID: `person:Jeshua`); Hodavias (ID: `person:Hodaviah.4`); Pasur (ID: `person:Pashhur`); Salum (ID: `person:Shallum.8`); Asafe (ID: `person:Asaph.2`); Acube (ID: `person:Akkub.2`); Cadmiel (ID: `person:Kadmiel`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Ater (ID: `person:Ater.2`); Talmom (ID: `person:Talmon`); Hatita (ID: `person:Hatita`); Sobai (ID: `person:Shobai`); Salum (ID: `person:Shallum.8`); Asafe (ID: `person:Asaph.2`); Acube (ID: `person:Akkub.2`)
...
* **Associated ACAI Concepts:** Hacufa (ID: `person:Hakupha`); Nesias (ID: `person:Neziah`); Sisera (ID: `person:Sisera.2`); Rezim (ID: `person:Rezin.2`); Hanã (ID: `person:Hanan.4`); Gazão (ID: `person:Gazzam`); Uza (ID: `person:Uzza.2`); Queros (ID: `person:Keros`); Padom (ID: `person:Padon`); Nephushesim (ID: `group:Nephushesim`); Bazlite (ID: `person:Bazluth`); Lebana (ID: `person:Lebanah`); Harur (ID: `person:Harhur`); Asná (ID: `person:Asnah`); Gidel (ID: `person:Giddel`); Hasufa (ID: `person:Hasupha`); Hatifa (ID: `person:Hatipha`); Gaar (ID: `person:Gahar`); Meída (ID: `person:Mehida`); Hagaba (ID: `person:Hagabah`); Zia (ID: `person:Ziha`); Barcos (ID: `person:Barkos`); Paseia (ID: `person:Paseah.2`); Hagabe (ID: `person:Hagab`); Sia (ID: `person:Siaha`); Tabaote (ID: `person:Tabbaoth`); Meunim (ID: `group:Meunim`); Acube (ID: `person:Akkub.3`); Temá (ID: `person:Temah`); Reaías (ID: `person:Reaiah.3`); Salmai (ID: `person:Shalmai`); Baquebuque (ID: `person:Bakbuk`); Harsa (ID: `person:Harsha`); Necoda (ID: `person:Nekoda`); Besai (ID: `person:Besai`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Jaala (ID: `person:Jaalah`); Peruda (ID: `person:Peruda`); Darcom (ID: `person:Darkon`); Soferete (ID: `person:Sophereth`); Sotai (ID: `person:Sotai`); Ami (ID: `person:Ami`); Sephatias (ID: `person:Shephatiah.7`); Hatil (ID: `person:Hattil`); Gidel (ID: `person:Giddel.2`)
...
* **Associated ACAI Concepts:** Necoda (ID: `person:Nekoda.2`); Tobias (ID: `person:Tobiah`); Imer (ID: `place:Immer`); Tel-Harsa (ID: `place:Tel-harsha`); Tel-Melá (ID: `place:Tel-melah`); Adã (ID: `place:Addan`); Querube (ID: `place:Cherub`); Delaías (ID: `person:Delaiah.3`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Habaiah (ID: `person:Habaiah`); Hacoz (ID: `person:Hakkoz.2`); Barzillai (ID: `person:Barzillai.3`); Barzillai (ID: `person:Barzillai`); stain (ID: `keyterm:Stain`); Gileade (ID: `place:Gilead`); priesthood (ID: `keyterm:Priesthood`); Gileadites (ID: `group:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); strength (ID: `keyterm:Strength`); House (ID: `realia:House`); Mina (ID: `realia:Mina`); Money (ID: `realia:Money`); Tunic (ID: `realia:Tunic`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Josué (ID: `person:Joshua.5`); Pérsia (ID: `place:Persia`); Ciro (ID: `person:Cyrus`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Esar-Hadom (ID: `person:Esarhaddon`); Relatives (ID: `group:Relatives`); Jesua (ID: `person:Jeshua.4`); Hodavias (ID: `person:Hodaviah.4`); Henadade (ID: `person:Henadad`); Cadmiel (ID: `person:Kadmiel`); Jope (ID: `place:Joppa`); Benjamim (ID: `group:Benjamin`); Dario (ID: `person:Darius.2`); Libano (ID: `place:Lebanon`); Hodias (ID: `person:Hodiah.2`); kindness (ID: `keyterm:Kindness`); Assyria (ID: `place:Assyria`); new moon festival (ID: `keyterm:NewMoonFestival`); Asafe (ID: `person:Asaph.2`); Davi (ID: `person:David`); Moisés (ID: `person:Moses`); appointed feast (ID: `keyterm:AppointedFeast`); terror (ID: `keyterm:Terror`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); Tyrians (ID: `group:Tyre`); Sidom (ID: `place:Sidon`); counsel (ID: `keyterm:Counsel`); holy (ID: `keyterm:Holy`); Benjamim (ID: `person:Benjamin`); Sidonians (ID: `group:Sidon`); Tiro (ID: `place:Tyre`); Instruction (ID: `keyterm:Instruction`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Cedar (ID: `flora:Cedar`); Craftsman (ID: `realia:Craftsman`); Trumpet (ID: `realia:Trumpet`); Olive Oil (ID: `realia:OliveOil`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Moisés (ID: `person:Moses`); Instruction (ID: `keyterm:Instruction`); offering (ID: `keyterm:Offering`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Jope (ID: `place:Joppa`); Libano (ID: `place:Lebanon`); Sidonians (ID: `group:Sidon`); Tiro (ID: `place:Tyre`); Tyrians (ID: `group:Tyre`); Sidom (ID: `place:Sidon`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Craftsman (ID: `realia:Craftsman`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Asafe (ID: `person:Asaph.2`); Davi (ID: `person:David`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); kindness (ID: `keyterm:Kindness`); House (ID: `realia:House`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Artaxerxes (ID: `person:Artaxerxes.2`); Pérsia (ID: `place:Persia`); Samaria (ID: `place:Samaria`); Jews (ID: `group:Jews`); Bislão (ID: `person:Bishlam`); Ereque (ID: `place:Erech`); Mitredate (ID: `person:Mithredath.2`); Babylonians (ID: `group:Babylon`); Osnapar (ID: `person:Osnappar`); Dinaítas (ID: `person:Dinaite`); Tabeel (ID: `person:Tabeel`); Assuero (ID: `person:Ahasuerus`); Judá (ID: `group:Judah`); Elam (ID: `place:Elam`); Persians (ID: `group:Persia`); Judá (ID: `person:Judah.4`); Elamites (ID: `group:Elam`); Susã (ID: `place:Susa`); Babilônia (ID: `place:Babylon`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Babylonians (ID: `group:Babylon`); Dinaítas (ID: `person:Dinaite`); Ereque (ID: `place:Erech`); Susã (ID: `place:Susa`); Elam (ID: `place:Elam`); Persians (ID: `group:Persia`); Babilônia (ID: `place:Babylon`); Elamites (ID: `group:Elam`); Pérsia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Reum (ID: `person:Rehum.2`); Jews (ID: `group:Jews`); Sinsai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Samaria (ID: `place:Samaria`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Dario (ID: `person:Darius.2`); Jews (ID: `group:Jews`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Ageu (ID: `person:Haggai`); Ido (ID: `person:Iddo.6`); Zacarias (ID: `person:Zechariah.17`); Tattenai (ID: `person:Tattenai`); Jeozadaque (ID: `person:Jehozadak`); Israel (ID: `person:Israel`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `person:Judah.4`); Pérsia (ID: `place:Persia`); Rio Eufrates (ID: `place:Euphrates`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** Ageu (ID: `person:Haggai`); Ido (ID: `person:Iddo.6`); Zacarias (ID: `person:Zechariah.17`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Jews (ID: `group:Jews`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Jerusalém (ID: `place:Jerusalem`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Jerusalém (ID: `place:Jerusalem`); Babilônia (ID: `place:Babylon`); Ciro (ID: `person:Cyrus`); Dario (ID: `person:Darius.2`); Zorobabel (ID: `person:Zerubbabel.2`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Tattenai (ID: `person:Tattenai`); Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); Chaldeans (ID: `group:Chaldea`); Rio Eufrates (ID: `place:Euphrates`); Caldéia (ID: `place:Chaldea`); Hewn Stone (ID: `realia:HewnStone`); Money (ID: `realia:Money`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Babilônia (ID: `place:Babylon`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Chaldeans (ID: `group:Chaldea`); Caldéia (ID: `place:Chaldea`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Babilônia (ID: `place:Babylon`); Zorobabel (ID: `person:Zerubbabel.2`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Ciro (ID: `person:Cyrus`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Moisés (ID: `person:Moses`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Levi (ID: `group:Levi`); passover (ID: `keyterm:Passover`); pure (ID: `keyterm:Pure`); Levi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); defilement (ID: `keyterm:Defilement`); Gentiles (ID: `group:Gentile`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Buqui (ID: `person:Bukki.2`); Zadoque (ID: `person:Zadok.4`); Amarias (ID: `person:Amariah.2`); Uzi (ID: `person:Uzzi`); Zeraías (ID: `person:Zerahiah`); Abisua (ID: `person:Abishua`); Meraiote (ID: `person:Meraioth`); Seraias (ID: `person:Seraiah.2`); Aitube (ID: `person:Ahitub.3`); Salum (ID: `person:Shallum.7`); Azarias (ID: `person:Azariah.7`); Azarias (ID: `person:Azariah.6`); Eleazar (ID: `person:Eleazar.2`); Fineias (ID: `person:Phinehas`); Pérsia (ID: `place:Persia`); Arão (ID: `person:Aaron`); Hilquias (ID: `person:Hilkiah.2`); Artaxerxes (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Rio Eufrates (ID: `place:Euphrates`); Artaxerxes (ID: `person:Artaxerxes`); Money (ID: `realia:Money`); Wheat (ID: `flora:Wheat`); Anointing Oil (ID: `realia:AnointingOil`); Kor (ID: `realia:Kor`); Olive Oil (ID: `realia:OliveOil`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** Jaaziel (ID: `person:Jahaziel.5`); Jônatas (ID: `person:Jonathan.9`); Hacatã (ID: `person:Hakkatan`); Zacur (ID: `person:Zaccur.5`); Joabe (ID: `person:Joab.4`); Daniel (ID: `person:Daniel.2`); Bebai (ID: `person:Bebai`); Atalia (ID: `person:Athaliah.3`); Elam (ID: `person:Elam`); Joanã (ID: `person:Johanan.8`); Asgade (ID: `person:Azgad`); Jesaías (ID: `person:Jeshaiah.4`); Secanias (ID: `person:Shecaniah.6`); Bigvai (ID: `person:Bigvai.2`); Selomite (ID: `person:Shelomith.4`); Utai (ID: `person:Uthai.2`); Adim (ID: `person:Adin`); Elioenai (ID: `person:Eliehoenai.2`); Bebai (ID: `person:Bebai.2`); Obadias (ID: `person:Obadiah.10`); Hatus (ID: `person:Hattush.2`); Jeuel (ID: `person:Jeuel.3`); Jeiel (ID: `person:Jehiel.7`); Ebede (ID: `person:Ebed.2`); Gérson (ID: `person:Gershom.2`); Josifias (ID: `person:Josiphiah`); Zabadias (ID: `person:Zebadiah.8`); Semaías (ID: `person:Shemaiah.14`); Sephatias (ID: `person:Shephatiah.6`); Secanias (ID: `person:Shecaniah.5`); Paate-Moabe (ID: `person:Pahath-moab`); Miguel (ID: `person:Michael.10`); Elifelete (ID: `person:Eliphelet.5`); Parós (ID: `person:Parosh.2`); Zeraías (ID: `person:Zerahiah.2`); Adonicão (ID: `person:Adonikam`); Zacarias (ID: `person:Zechariah.19`); Zacarias (ID: `person:Zechariah.18`); Fineias (ID: `person:Phinehas`); Itamar (ID: `person:Ithamar`); Davi (ID: `person:David`); Babilônia (ID: `place:Babylon`); Artaxerxes (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** Mesulão (ID: `person:Meshullam.9`); Casifia (ID: `place:Casiphia`); Ido (ID: `person:Iddo`); Ariel (ID: `person:Ariel`); Elnatã (ID: `person:Elnathan.2`); Elnatã (ID: `person:Elnathan.4`); Elnatã (ID: `person:Elnathan.3`); Natã (ID: `person:Nathan.5`); Zacarias (ID: `person:Zechariah.20`); Semaías (ID: `person:Shemaiah.15`); Eliezer (ID: `person:Eliezer.8`); Jaribe (ID: `person:Jarib.2`); Joiaribe (ID: `person:Joiarib.2`); SENHOR (ID: `deity:Lord`); perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); Insight (ID: `keyterm:Insight`); Mali (ID: `person:Mahli`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); offering (ID: `keyterm:Offering`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); Amom (ID: `place:Ammon`); be unfaithful (ID: `keyterm:Unfaithful`); Israel (ID: `person:Israel`); Ammonites (ID: `group:Ammon`); cananeu (ID: `group:Canaan`); Jebusites (ID: `group:Jebusites`); Egyptians (ID: `group:Egypt`); Hete (ID: `person:Heth`); Canaã (ID: `place:Canaan`); Levi (ID: `person:Levi.3`); Moabe (ID: `place:Moab`); Amorites (ID: `group:Amorites`); Egito (ID: `place:Egypt`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Harim (ID: `person:Harim`); Elam (ID: `person:Elam`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); offering (ID: `keyterm:Offering`); counsel (ID: `keyterm:Counsel`); Semaías (ID: `person:Shemaiah.17`); Josadaque (ID: `person:Jozadak.2`); Jeremote (ID: `person:Jeremoth.4`); Sarai (ID: `person:Sharai`); Jônatas (ID: `person:Jonathan.10`); Jadai (ID: `person:Jaddai`); Simei (ID: `person:Shimei.16`); Natã (ID: `person:Nathan.6`); Zabai (ID: `person:Zabbai`); Eleazar (ID: `person:Eleazar.7`); Jeremote (ID: `person:Jeremoth.3`); Simei (ID: `person:Shimei.15`); Matanias (ID: `person:Mattaniah.7`); Sasai (ID: `person:Shashai`); Benjamim (ID: `person:Benjamin.3`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); Jerusalém (ID: `place:Jerusalem`); peace (ID: `keyterm:IntactState`); to cause to possess (ID: `keyterm:Possess`); supplication (ID: `keyterm:Supplication`); Israel (ID: `person:Israel`); defilement (ID: `keyterm:Defilement`); dispossess (ID: `keyterm:Dispossess`); kindness (ID: `keyterm:Kindness`); Pérsia (ID: `place:Persia`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); Jerusalém (ID: `place:Jerusalem`); supplication (ID: `keyterm:Supplication`); kindness (ID: `keyterm:Kindness`); Pérsia (ID: `place:Persia`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** Secanias (ID: `person:Shecaniah.7`); Jeiel (ID: `person:Jehiel.8`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Elam (ID: `person:Elam`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); counsel (ID: `keyterm:Counsel`); Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `group:Benjamin`); SENHOR (ID: `deity:Lord`); Benjamim (ID: `person:Benjamin`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ticva (ID: `person:Tikvah.2`); Jônatas (ID: `person:Jonathan.10`); Jazeías (ID: `person:Jahzeiah`); Mesulão (ID: `person:Meshullam.10`); Asael (ID: `person:Asahel.4`); Sabetai (ID: `person:Shabbethai`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`)
