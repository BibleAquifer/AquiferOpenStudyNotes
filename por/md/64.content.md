...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); amado (ID: `keyterm:Beloved`); andar (ID: `keyterm:Live.3`); Gaio (ID: `person:Gaius.4`); testemunhar (ID: `keyterm:BearWitness`); orar (ID: `keyterm:Pray`); Cause of Joy (ID: `keyterm:CauseOfJoy`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Faithfulness (ID: `keyterm:Faithfulness`); Truth (ID: `keyterm:Truth`); testemunhar (ID: `keyterm:BearWitness`); SENHOR (ID: `deity:Lord`); Name (ID: `keyterm:Name`); amado (ID: `keyterm:Beloved`); dever (ID: `keyterm:Ought`); igreja (ID: `keyterm:Church`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); igreja (ID: `keyterm:Church`); love (ID: `keyterm:Love`); testemunhar (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); dever (ID: `keyterm:Ought`); Name (ID: `keyterm:Name`)
...
* **Associated ACAI Concepts:** igreja (ID: `keyterm:Church`); Diótrefes (ID: `person:Diotrephes`); Demétrio (ID: `person:Demetrius`); Truth (ID: `keyterm:Truth`); testemunhar (ID: `keyterm:BearWitness`); SENHOR (ID: `deity:Lord`); Good (ID: `keyterm:Good`); verdadeiro (ID: `keyterm:True`); amado (ID: `keyterm:Beloved`); Do Good (ID: `keyterm:DoGood`)
...
* **Associated ACAI Concepts:** amado (ID: `keyterm:Beloved`); SENHOR (ID: `deity:Lord`); Good (ID: `keyterm:Good`); Do Good (ID: `keyterm:DoGood`)
...
* **Associated ACAI Concepts:** Ink (ID: `realia:Ink`); Pen (ID: `realia:Pen`); fazer a paz (ID: `keyterm:Peace`); Name (ID: `keyterm:Name`); hope (ID: `keyterm:Hope`); Reed (ID: `flora:Reed`)
