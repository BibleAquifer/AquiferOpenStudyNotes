...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); أورشَلِيمَ (ID: `place:Jerusalem`); Intention (ID: `keyterm:Intention`); ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vine (ID: `flora:Vine`); إِسْرَائِيلَ (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Cattle (ID: `fauna:Bull`); Flock (ID: `fauna:Flock`); Money (ID: `realia:Money`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Cattle (ID: `fauna:Bull`); Flock (ID: `fauna:Flock`); Money (ID: `realia:Money`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Cattle (ID: `fauna:Bull`); Flock (ID: `fauna:Flock`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vow (ID: `keyterm:Vow`); House (ID: `realia:House`); Strength (ID: `keyterm:Strength`); Fear (ID: `keyterm:Fear`); Slaughtering (ID: `keyterm:Slaughtering`); A Man (ID: `person:GenericMale`); Passion (ID: `keyterm:Ardour`); An Angel (ID: `deity:Angel`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Stupid (ID: `keyterm:Stupid`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); To Cause to Possess (ID: `keyterm:Possess`); To Sin (ID: `keyterm:Sin`); Fear (ID: `keyterm:Fear`); To Act Wickedly (ID: `keyterm:ActWickedly`); Intention (ID: `keyterm:Intention`); Olive Oil (ID: `realia:OliveOil`); Cooking Pot (ID: `realia:CookingPot`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** Strength (ID: `keyterm:Strength`); ٱلرَّبِّ (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Hell (ID: `place:Hell`); Intention (ID: `keyterm:Intention`); Love (ID: `keyterm:Love`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Caper (ID: `flora:Caper`); Bird (ID: `fauna:Bird`); Locust (ID: `fauna:Locust`); Pit (ID: `realia:Pit`); Almond (ID: `flora:Almond`); Rope (ID: `realia:Rope`); Clay Jar (ID: `realia:ClayJar`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Straightness (ID: `keyterm:Straightness`); Fear (ID: `keyterm:Fear`); Intention (ID: `keyterm:Intention`); Proverb (ID: `keyterm:Saying`); Truth (ID: `keyterm:Truth`); Goad (ID: `realia:Goad`); Goat (ID: `fauna:Goat`); Scroll (ID: `realia:Scroll`); Flock (ID: `fauna:Flock`); Nail (ID: `realia:Nail`); Sheep (ID: `fauna:Lamb`)
