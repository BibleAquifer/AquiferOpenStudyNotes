...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Áfia (ID: `person:Apphia`); Filemom (ID: `person:Philemon`); Arquipo (ID: `person:Archippus`); fazer a paz (ID: `keyterm:Peace`); favor (ID: `keyterm:Favor`); Paulo (ID: `person:Paul`); Timóteo (ID: `person:Timothy`); igreja (ID: `keyterm:Church`); amado (ID: `keyterm:Beloved`); SENHOR (ID: `deity:Lord`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); holy (ID: `keyterm:Holy`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); Cause of Joy (ID: `keyterm:CauseOfJoy`); comunhão (ID: `keyterm:Fellowship`); rogar (ID: `keyterm:AskFor`); SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); compaixão (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); Paulo (ID: `person:Paul`); em cristo (ID: `keyterm:InChrist`); rogar (ID: `keyterm:AskFor`)
