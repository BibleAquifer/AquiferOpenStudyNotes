...
* **Associated ACAI Concepts:** Ephrathah (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Ephrathites (ID: `group:Ephrathah`); Chilion (ID: `person:Chilion`); Tribe of Judah (ID: `group:Judah`); Mahlon (ID: `person:Mahlon`); Elimelech (ID: `person:Elimelech`); Bethlehem (ID: `place:Bethlehem`); Judah (ID: `person:Judah.4`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); Favor (ID: `keyterm:Favor`); Ruth (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Elders (ID: `group:GenericElders`); Bethlehem (ID: `place:Bethlehem`); Leah (ID: `person:Leah`); Rachel (ID: `person:Rachel`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Salmon (ID: `person:Salmon`); Hezron (ID: `person:Hezron.2`); Obed (ID: `person:Obed`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Jesse (ID: `person:Jesse`); Boaz (ID: `person:Boaz`); Nahshon (ID: `person:Nahshon`); Perez (ID: `person:Perez`); David (ID: `person:David`)
