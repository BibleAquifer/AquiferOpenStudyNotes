...
* **Associated ACAI Concepts:** Carkas (ID: `person:Carkas`); Biztha (ID: `person:Biztha`); Abagtha (ID: `person:Abagtha`); Zethar (ID: `person:Zethar`); Harbona (ID: `person:Harbona`); Mehuman (ID: `person:Mehuman`); Bigtha (ID: `person:Bigtha`); Ahasuerus (ID: `person:Ahasuerus`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Vashti (ID: `person:Vashti`); Persians (ID: `group:Persia`); Medes (ID: `group:Mede`); Ahasuerus (ID: `person:Ahasuerus`); Persia (ID: `place:Persia`); Medan (ID: `person:Medan`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Babylon (ID: `place:Babylon`); Jehoiachin (ID: `person:Jehoiachin`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Hammedatha (ID: `person:Hammedatha`); Jews (ID: `group:Jews`); Agag (ID: `person:Agag.2`); Agagites (ID: `group:Agag`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Zeresh (ID: `person:Zeresh`); Love (ID: `keyterm:Love`); A Group of People (ID: `group:GenericGroup`); Glory (ID: `keyterm:Glory`); Esther (ID: `person:Esther`); Jews (ID: `group:Jews`); House (ID: `realia:House`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Zeresh (ID: `person:Zeresh`); Mordecai (ID: `person:Mordecai.2`); A Group of People (ID: `group:GenericGroup`); Love (ID: `keyterm:Love`); Haman (ID: `person:Haman`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Esther (ID: `person:Esther`); Mordecai (ID: `person:Mordecai.2`); Haman (ID: `person:Haman`); Jews (ID: `group:Jews`); Ahasuerus (ID: `person:Ahasuerus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Esther (ID: `person:Esther`); Jews (ID: `group:Jews`); Agag (ID: `person:Agag.2`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Agagites (ID: `group:Agag`)
...
* **Associated ACAI Concepts:** Arisai (ID: `person:Arisai`); Aridai (ID: `person:Aridai`); Adalia (ID: `person:Adalia`); Aspatha (ID: `person:Aspatha`); Dalphon (ID: `person:Dalphon`); Parshandatha (ID: `person:Parshandatha`); Aridatha (ID: `person:Aridatha`); Vaizatha (ID: `person:Vaizatha`); Parmashta (ID: `person:Parmashta`); Poratha (ID: `person:Poratha`); Hammedatha (ID: `person:Hammedatha`); Haman (ID: `person:Haman`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Esther (ID: `person:Esther`); Susa (ID: `place:Susa`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Lot (ID: `realia:Lot`); Hammedatha (ID: `person:Hammedatha`); Mordecai (ID: `person:Mordecai.2`); Haman (ID: `person:Haman`); Lot (ID: `keyterm:Lot`); Agag (ID: `person:Agag.2`); Agagites (ID: `group:Agag`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Esther (ID: `person:Esther`); Jews (ID: `group:Jews`); Mordecai (ID: `person:Mordecai.2`); Scroll (ID: `realia:Scroll`); Abihail (ID: `person:Abihail.5`); Truth (ID: `keyterm:Truth`); Peace (ID: `keyterm:IntactState`); Ahasuerus (ID: `person:Ahasuerus`)
