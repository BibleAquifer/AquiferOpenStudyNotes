...
* **Associated ACAI Concepts:** Éphrata (ID: `person:Ephrathah`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); Naomi (ID: `person:Naomi`); Kiljon (ID: `person:Chilion`); Moab (ID: `place:Moab`); Juda (ID: `group:Judah`); Élimélec (ID: `person:Elimelech`); Juda (ID: `person:Judah.4`); Bethléhem (ID: `place:Bethlehem`); Machlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); Bethléhem (ID: `place:Bethlehem`); Ruth (ID: `person:Ruth`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** benir (ID: `keyterm:Bless`); Naomi (ID: `person:Naomi`); bonté (ID: `keyterm:Kindness`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Rachel (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); Léa (ID: `person:Leah`); Éternel (ID: `deity:Lord`); Bethléhem (ID: `place:Bethlehem`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Juda (ID: `group:Judah`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); Perets (ID: `person:Perez`); Tamar (ID: `person:Tamar`)
...
* **Associated ACAI Concepts:** Salmon (ID: `person:Salmon`); Hetsron (ID: `person:Hezron.2`); Amminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Nahshon (ID: `person:Nahshon`); Perets (ID: `person:Perez`); Boaz (ID: `person:Boaz`); Isaï (ID: `person:Jesse`); David (ID: `person:David`)
