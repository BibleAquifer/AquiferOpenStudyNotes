...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Chaldeans (ID: `group:Chaldea`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); Believe In (ID: `keyterm:BelieveIn`); Strength (ID: `keyterm:Strength`); Leopard (ID: `fauna:Leopard`); Vulture (ID: `fauna:Vulture`); Horse (ID: `fauna:Horse`); Wolf (ID: `fauna:Wolf`)
...
* **Associated ACAI Concepts:** Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Casting Net (ID: `realia:CastingNet`); ٱلرَّبِّ (ID: `deity:Lord`); Pure (ID: `keyterm:Pure`); Holy (ID: `keyterm:Holy`); Fortification (ID: `realia:Fortification`); Harpoon (ID: `realia:Harpoon`); Chameleon (ID: `fauna:Chameleon`); Fish (ID: `fauna:Fish`); Monitor (ID: `fauna:Iguana`); Lizard (ID: `fauna:Lizard`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); Woe (ID: `keyterm:Woe.2`); ٱلرَّبِّ (ID: `deity:Lord`); لبْنَانَ (ID: `place:Lebanon`); Be Disgraced (ID: `keyterm:Disgraced`)
...
* **Associated ACAI Concepts:** Idol (ID: `keyterm:Idol`); Trust (ID: `keyterm:LeanOn`); ٱلرَّبِّ (ID: `deity:Lord`); Woe (ID: `keyterm:Woe.2`); Molten Image (ID: `realia:MoltenImage`); Graven Image (ID: `realia:GravenImage`); Image (ID: `realia:Image`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); تَيْمَانَ (ID: `place:Teman`); كوشَانَ (ID: `place:Cushan`); حَبَقّوق (ID: `person:Habakkuk`); فَارَانَ (ID: `place:ParanMount`); Mischief (ID: `keyterm:Mischief`); Fear (ID: `keyterm:Fear`); Arrow (ID: `keyterm:Arrow`); مِدْيَانَ (ID: `place:Midian`); Holy (ID: `keyterm:Holy`); Majesty (ID: `keyterm:Majesty`); Anointed (ID: `keyterm:Anointed`); Oath (ID: `keyterm:Oath`); Deer (ID: `fauna:Deer`); Sheepfold (ID: `realia:Sheepfold`); Fig (ID: `flora:Fig`); Olive Tree (ID: `flora:OliveTree`); Chariot (ID: `realia:Chariot`); Foundation (ID: `realia:Foundation`); Goat (ID: `fauna:Goat`); Spear (ID: `realia:Spear`); Cattle (ID: `fauna:Bull`); Tent (ID: `realia:Tent`); Flock (ID: `fauna:Flock`); Vine (ID: `flora:Vine`); Bow (ID: `realia:Bow`); Animal Pen (ID: `realia:AnimalPen`)
...
* **Associated ACAI Concepts:** Salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); تَيْمَانَ (ID: `place:Teman`); كوشَانَ (ID: `place:Cushan`); فَارَانَ (ID: `place:ParanMount`); Mischief (ID: `keyterm:Mischief`); Arrow (ID: `keyterm:Arrow`); مِدْيَانَ (ID: `place:Midian`); Holy (ID: `keyterm:Holy`); ٱلرَّبِّ (ID: `deity:Lord`); Majesty (ID: `keyterm:Majesty`); Anointed (ID: `keyterm:Anointed`); Oath (ID: `keyterm:Oath`); Chariot (ID: `realia:Chariot`); Foundation (ID: `realia:Foundation`); Spear (ID: `realia:Spear`); Tent (ID: `realia:Tent`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** Salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); ٱلرَّبِّ (ID: `deity:Lord`); Arrow (ID: `keyterm:Arrow`); Oath (ID: `keyterm:Oath`); Anointed (ID: `keyterm:Anointed`); Chariot (ID: `realia:Chariot`); Spear (ID: `realia:Spear`); Foundation (ID: `realia:Foundation`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); Salvation (ID: `keyterm:Salvation`); Sheepfold (ID: `realia:Sheepfold`); Cattle (ID: `fauna:Bull`); Fig (ID: `flora:Fig`); Olive Tree (ID: `flora:OliveTree`); Flock (ID: `fauna:Flock`); Animal Pen (ID: `realia:AnimalPen`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`)
