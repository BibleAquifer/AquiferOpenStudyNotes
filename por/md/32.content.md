...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); fear (ID: `keyterm:Fear`); Fish (ID: `fauna:Fish`); Ship (ID: `realia:Ship`); Hell (ID: `place:Hell`); make a vow (ID: `keyterm:Vow`); Nínive (ID: `place:Nineveh`); Jope (ID: `place:Joppa`); Amittai (ID: `person:Amittai`); praise (ID: `keyterm:Praise`); Word of the Lord (ID: `keyterm:WordOfTheLord`); lot (ID: `keyterm:Lot`); slaughtering (ID: `keyterm:Slaughtering`); salvation (ID: `keyterm:Salvation`); kindness (ID: `keyterm:Kindness`); exempt (ID: `keyterm:Exempt`); Társis (ID: `place:Tarshish`); Hebrews (ID: `group:Hebrews`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Hell (ID: `place:Hell`); salvation (ID: `keyterm:Salvation`); Jonas (ID: `person:Jonah.2`); praise (ID: `keyterm:Praise`); kindness (ID: `keyterm:Kindness`); make a vow (ID: `keyterm:Vow`); Fish (ID: `fauna:Fish`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); praise (ID: `keyterm:Praise`); kindness (ID: `keyterm:Kindness`); SENHOR (ID: `deity:Lord`); make a vow (ID: `keyterm:Vow`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Nínive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Sackcloth (ID: `realia:Sackcloth`); Cattle (ID: `fauna:Bull`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Compassionate (ID: `keyterm:Compassionate`); kindness (ID: `keyterm:Kindness`); Believe In (ID: `keyterm:BelieveIn`); Társis (ID: `place:Tarshish`); gracious (ID: `keyterm:Generous`); Flock (ID: `fauna:Flock`); Clothing (ID: `realia:Clothing`); Throne (ID: `realia:Throne`); Worm (ID: `fauna:Maggot`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); Compassionate (ID: `keyterm:Compassionate`); kindness (ID: `keyterm:Kindness`); Társis (ID: `place:Tarshish`); gracious (ID: `keyterm:Generous`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Compassionate (ID: `keyterm:Compassionate`); kindness (ID: `keyterm:Kindness`); Társis (ID: `place:Tarshish`); SENHOR (ID: `deity:Lord`); gracious (ID: `keyterm:Generous`)
