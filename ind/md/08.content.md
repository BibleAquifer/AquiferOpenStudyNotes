...
* **Associated ACAI Concepts:** Ephrathites (ID: `group:Ephrathah`); Mahlon (ID: `person:Chilion`); Efrata (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Elimelekh (ID: `person:Elimelech`); Betlehem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Yehuda (ID: `person:Judah.4`); Yehuda (ID: `group:Judah`); Mahlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Betlehem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); Rut (ID: `person:Ruth`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); kebaikan (ID: `keyterm:Kindness`); Naomi (ID: `person:Naomi`); memberkati (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Rut (ID: `person:Ruth`); Moab (ID: `place:Moab`); Boas (ID: `person:Boaz`); menyebabkan memiliki (ID: `keyterm:Possess`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Rut (ID: `person:Ruth`); Moab (ID: `place:Moab`); menyebabkan memiliki (ID: `keyterm:Possess`); Mahlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Elders (ID: `group:GenericElders`); Betlehem (ID: `place:Bethlehem`); Tuhan (ID: `deity:Lord`); Lea (ID: `person:Leah`); Rahel (ID: `person:Rachel`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Peres (ID: `person:Perez`); Tuhan (ID: `deity:Lord`); Yehuda (ID: `person:Judah.4`); Yehuda (ID: `group:Judah`); Tamar (ID: `person:Tamar`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); memperanakkan (ID: `person:Salmon`); Obed (ID: `person:Obed`); Aminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Daud (ID: `person:David`); Isai (ID: `person:Jesse`); Nahason (ID: `person:Nahshon`); Boas (ID: `person:Boaz`); Peres (ID: `person:Perez`)
