...
* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Blood (ID: `keyterm:Blood`); Bless (ID: `keyterm:Bless`); यीशु (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Kingdom (ID: `keyterm:Kingdom`); Forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); यहोवा (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); Vine (ID: `flora:Vine`)
