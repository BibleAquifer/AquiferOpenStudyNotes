...
* **Associated ACAI Concepts:** Chelión (ID: `person:Chilion`); Ephrata (ID: `person:Ephrathah`); Efratita (ID: `group:Ephrathah`); Noemi (ID: `person:Naomi`); Elimelech (ID: `person:Elimelech`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Catah (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Mahalón (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** favor (ID: `keyterm:Favor`); Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** bondad (ID: `keyterm:Kindness`); bendecir (ID: `keyterm:Bless`); Jehová (ID: `deity:Lord`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Elimelech (ID: `person:Elimelech`); Moab (ID: `place:Moab`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Catah (ID: `place:Bethlehem`); Jehová (ID: `deity:Lord`); Israel (ID: `person:Israel`); Lea (ID: `person:Leah`); Elders (ID: `group:GenericElders`); Rachêl (ID: `person:Rachel`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Phares (ID: `person:Perez`); Jehová (ID: `deity:Lord`); Thamar (ID: `person:Tamar`)
...
* **Associated ACAI Concepts:** Hesrón (ID: `person:Hezron.2`); Salmón (ID: `person:Salmon`); Obed (ID: `person:Obed`); Aminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Isaí (ID: `person:Jesse`); Phares (ID: `person:Perez`); David (ID: `person:David`); Booz (ID: `person:Boaz`); Nahasón (ID: `person:Nahshon`)
