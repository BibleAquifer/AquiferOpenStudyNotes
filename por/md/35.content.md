...
* **Associated ACAI Concepts:** strength (ID: `keyterm:Strength`); fear (ID: `keyterm:Fear`); Caldéia (ID: `place:Chaldea`); dispossess (ID: `keyterm:Dispossess`); SENHOR (ID: `deity:Lord`); Chaldeans (ID: `group:Chaldea`); Believe In (ID: `keyterm:BelieveIn`); Vulture (ID: `fauna:Vulture`); Horse (ID: `fauna:Horse`); Leopard (ID: `fauna:Leopard`); Wolf (ID: `fauna:Wolf`)
...
* **Associated ACAI Concepts:** Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Casting Net (ID: `realia:CastingNet`); SENHOR (ID: `deity:Lord`); holy (ID: `keyterm:Holy`); pure (ID: `keyterm:Pure`); Fortification (ID: `realia:Fortification`); Harpoon (ID: `realia:Harpoon`); Chameleon (ID: `fauna:Chameleon`); Lizard (ID: `fauna:Lizard`); Fish (ID: `fauna:Fish`); Monitor (ID: `fauna:Iguana`)
...
* **Associated ACAI Concepts:** Hell (ID: `place:Hell`); SENHOR (ID: `deity:Lord`); Tablet (ID: `realia:Tablet`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Libano (ID: `place:Lebanon`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); Be Disgraced (ID: `keyterm:Disgraced`); Woe (ID: `keyterm:Woe.2`)
...
* **Associated ACAI Concepts:** literally: nought (ID: `keyterm:Idol`); SENHOR (ID: `deity:Lord`); lean on (ID: `keyterm:LeanOn`); Woe (ID: `keyterm:Woe.2`); Image (ID: `realia:Image`); Graven Image (ID: `realia:GravenImage`); Money (ID: `realia:Money`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); Temã (ID: `place:Teman`); Monte Paran (ID: `place:ParanMount`); Cusã (ID: `place:Cushan`); Habacuque (ID: `person:Habakkuk`); Oath (ID: `keyterm:Oath`); Midiã (ID: `place:Midian`); holy (ID: `keyterm:Holy`); majesty (ID: `keyterm:Majesty`); mischief (ID: `keyterm:Mischief`); arrow (ID: `keyterm:Arrow`); anointed (ID: `keyterm:Anointed`); fear (ID: `keyterm:Fear`); Deer (ID: `fauna:Deer`); Tent (ID: `realia:Tent`); Cattle (ID: `fauna:Bull`); Fig (ID: `flora:Fig`); Spear (ID: `realia:Spear`); Olive Tree (ID: `flora:OliveTree`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sheepfold (ID: `realia:Sheepfold`); Chariot (ID: `realia:Chariot`); Animal Pen (ID: `realia:AnimalPen`); Bow (ID: `realia:Bow`); Vine (ID: `flora:Vine`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); Temã (ID: `place:Teman`); Monte Paran (ID: `place:ParanMount`); Cusã (ID: `place:Cushan`); Oath (ID: `keyterm:Oath`); Midiã (ID: `place:Midian`); holy (ID: `keyterm:Holy`); majesty (ID: `keyterm:Majesty`); SENHOR (ID: `deity:Lord`); mischief (ID: `keyterm:Mischief`); arrow (ID: `keyterm:Arrow`); anointed (ID: `keyterm:Anointed`); Tent (ID: `realia:Tent`); Spear (ID: `realia:Spear`); Chariot (ID: `realia:Chariot`); Bow (ID: `realia:Bow`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); Oath (ID: `keyterm:Oath`); arrow (ID: `keyterm:Arrow`); SENHOR (ID: `deity:Lord`); anointed (ID: `keyterm:Anointed`); Spear (ID: `realia:Spear`); Chariot (ID: `realia:Chariot`); Bow (ID: `realia:Bow`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); salvation (ID: `keyterm:Salvation`); Sheepfold (ID: `realia:Sheepfold`); Animal Pen (ID: `realia:AnimalPen`); Cattle (ID: `fauna:Bull`); Olive Tree (ID: `flora:OliveTree`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Fig (ID: `flora:Fig`); Vine (ID: `flora:Vine`)
