...
* **Associated ACAI Concepts:** kebenaran (ID: `keyterm:Truth`); kekasih (ID: `keyterm:Beloved`); hidup (ID: `keyterm:Live.3`); Gayus (ID: `person:Gaius.4`); Cause of Joy (ID: `keyterm:CauseOfJoy`); kasihi (ID: `keyterm:Love`); berdoa (ID: `keyterm:Pray`); bersaksi (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** nama (ID: `keyterm:Name`); kesetiaan (ID: `keyterm:Faithfulness`); Tuhan (ID: `deity:Lord`); jemaat (ID: `keyterm:Church`); kekasih (ID: `keyterm:Beloved`); wajib (ID: `keyterm:Ought`); kasihi (ID: `keyterm:Love`); kebenaran (ID: `keyterm:Truth`); bersaksi (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** jemaat (ID: `keyterm:Church`); Demetrius (ID: `person:Demetrius`); Diotrefes (ID: `person:Diotrephes`); Tuhan (ID: `deity:Lord`); benar (ID: `keyterm:True`); kekasih (ID: `keyterm:Beloved`); lakukan baik (ID: `keyterm:DoGood`); yang baik (ID: `keyterm:Good`); kebenaran (ID: `keyterm:Truth`); bersaksi (ID: `keyterm:BearWitness`)
