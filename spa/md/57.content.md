...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Filemón (ID: `person:Philemon`); Apphia (ID: `person:Apphia`); Archîpo (ID: `person:Archippus`); iglesia (ID: `keyterm:Church`); Jehová (ID: `deity:Lord`); Timoteo (ID: `person:Timothy`); hacer la paz (ID: `keyterm:Peace`); favor (ID: `keyterm:Favor`); amado (ID: `keyterm:Beloved`); Pablo (ID: `person:Paul`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); amar (ID: `keyterm:Love`); creer (ID: `keyterm:Believe`); santo (ID: `keyterm:Holy`); orar (ID: `keyterm:Pray`); comunión (ID: `keyterm:Fellowship`); Good (ID: `keyterm:Good`); Jehová (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); entrañas (ID: `keyterm:Affection`); Cause of Joy (ID: `keyterm:CauseOfJoy`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Good (ID: `keyterm:Good`); creer (ID: `keyterm:Believe`); comunión (ID: `keyterm:Fellowship`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Lucas (ID: `person:Luke`); Demas (ID: `person:Demas`); Epafras (ID: `person:Epaphras`); Aristarco (ID: `person:Aristarchus`); cristo (ID: `keyterm:InChrist`); favor (ID: `keyterm:Favor`); Marcos (ID: `person:Mark`); espíritu (ID: `keyterm:Spirit.2`)
