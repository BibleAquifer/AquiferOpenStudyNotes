...
* **Associated ACAI Concepts:** Ephrathites (ID: `group:Ephrathah`); Efrata (ID: `person:Ephrathah`); Noemi (ID: `person:Naomi`); Quiliom (ID: `person:Chilion`); Elimeleque (ID: `person:Elimelech`); Judá (ID: `person:Judah.4`); Malom (ID: `person:Mahlon`); Belém (ID: `place:Bethlehem`); Moabe (ID: `place:Moab`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Noemi (ID: `person:Naomi`); SENHOR (ID: `deity:Lord`); bless (ID: `keyterm:Bless`); kindness (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** Noemi (ID: `person:Naomi`); Elimeleque (ID: `person:Elimelech`); Moabe (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); Boaz (ID: `person:Boaz`); to cause to possess (ID: `keyterm:Possess`); Moabe (ID: `place:Moab`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Belém (ID: `place:Bethlehem`); Raquel (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); SENHOR (ID: `deity:Lord`); Lia (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Judá (ID: `person:Judah.4`); Tamar (ID: `person:Tamar`); SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Perez (ID: `person:Perez`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Boaz (ID: `person:Boaz`); Rute (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); bless (ID: `keyterm:Bless`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Salmom (ID: `person:Salmon`); Hezrom (ID: `person:Hezron.2`); Aminadabe (ID: `person:Amminadab`); Obede (ID: `person:Obed`); Ram (ID: `person:Ram`); Boaz (ID: `person:Boaz`); Davi (ID: `person:David`); Jessé (ID: `person:Jesse`); Perez (ID: `person:Perez`); Naassom (ID: `person:Nahshon`)
