...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Judas (ID: `person:Jude`); misericórdia (ID: `keyterm:Mercy`); Tiago (ID: `person:James.3`); Jesus (ID: `person:Jesus.2`); fazer a paz (ID: `keyterm:Peace`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); holy (ID: `keyterm:Holy`); amado (ID: `keyterm:Beloved`); comum (ID: `keyterm:InCommon`); rogar (ID: `keyterm:AskFor`); empenho (ID: `keyterm:Eagerness`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); favor (ID: `keyterm:Favor`); holy (ID: `keyterm:Holy`); amado (ID: `keyterm:Beloved`); comum (ID: `keyterm:InCommon`); rogar (ID: `keyterm:AskFor`); Jesus (ID: `person:Jesus.2`); juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`); empenho (ID: `keyterm:Eagerness`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); Egito (ID: `place:Egypt`); salvation (ID: `keyterm:Salvation`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** tribunal de justiça (ID: `keyterm:CourtCase`); para a eternidade (ID: `keyterm:Always`); juízo (ID: `keyterm:Judgment`); corpo (ID: `keyterm:Body.3`); blasfemar (ID: `keyterm:Blaspheme`); SENHOR (ID: `deity:Lord`); Corá (ID: `person:Korah.3`); Miguel (ID: `person:Michael.11`); ágape (ID: `keyterm:FellowshipMeal`); distinguir (ID: `keyterm:Discern`); To Command (ID: `keyterm:Command`); Sodoma (ID: `place:Sodom`); Egito (ID: `place:Egypt`); crer (ID: `keyterm:Believe`); Caim (ID: `person:Cain`); holy (ID: `keyterm:Holy`); Disaster (ID: `keyterm:Disaster`); Adão (ID: `person:Adam`); Enoque (ID: `person:Enoch.2`); salvation (ID: `keyterm:Salvation`); Moisés (ID: `person:Moses`); An Angel (ID: `deity:Angel`); Gomorra (ID: `place:Gomorrah`); fogo eterno (ID: `keyterm:EternalFire`); defilement (ID: `keyterm:Defilement`); speak (ID: `keyterm:Speak`); Jesus (ID: `person:Jesus.2`); Balaão (ID: `person:Balaam`); Ability (ID: `keyterm:Ability`); Chain (ID: `realia:Chain`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Miguel (ID: `person:Michael.11`); Moisés (ID: `person:Moses`); juízo (ID: `keyterm:Judgment`); corpo (ID: `keyterm:Body.3`); blasfemar (ID: `keyterm:Blaspheme`); SENHOR (ID: `deity:Lord`); distinguir (ID: `keyterm:Discern`); tribunal de justiça (ID: `keyterm:CourtCase`); To Command (ID: `keyterm:Command`)
...
* **Associated ACAI Concepts:** speak (ID: `keyterm:Speak`); holy (ID: `keyterm:Holy`); juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`); Adão (ID: `person:Adam`); tribunal de justiça (ID: `keyterm:CourtCase`); Enoque (ID: `person:Enoch.2`)
...
* **Associated ACAI Concepts:** misericórdia (ID: `keyterm:Mercy`); amado (ID: `keyterm:Beloved`); Holy Spirit (ID: `deity:HolySpirit`); Jesus (ID: `person:Jesus.2`); fear (ID: `keyterm:Fear`); SENHOR (ID: `deity:Lord`); distinguir (ID: `keyterm:Discern`); love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`); holy (ID: `keyterm:Holy`); salvation (ID: `keyterm:Salvation`); para a eternidade (ID: `keyterm:Always`); orar (ID: `keyterm:Pray`); corpo (ID: `keyterm:Body.3`); Life (ID: `keyterm:Life`); causar divisões (ID: `keyterm:CreatingDivisions`); natural (ID: `keyterm:Natural`); palavra (ID: `keyterm:Word`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** fear (ID: `keyterm:Fear`); misericórdia (ID: `keyterm:Mercy`); corpo (ID: `keyterm:Body.3`); salvation (ID: `keyterm:Salvation`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); irrepreensível (ID: `keyterm:Unblemished`); para a eternidade (ID: `keyterm:Always`); Jesus (ID: `person:Jesus.2`); salvador (ID: `keyterm:Savior`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); autoridade (ID: `keyterm:Authority.2`); surely! (ID: `keyterm:Surely`)
