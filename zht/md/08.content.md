...
* **Associated ACAI Concepts:** Ephrathah (ID: `person:Ephrathah`); Ephrathites (ID: `group:Ephrathah`); Chilion (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Mahlon (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Elimelech (ID: `person:Elimelech`); Bethlehem (ID: `place:Bethlehem`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); To Cause to Possess (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Mahlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Rachel (ID: `person:Rachel`); Leah (ID: `person:Leah`); Bethlehem (ID: `place:Bethlehem`); Israel (ID: `person:Israel`); Elders (ID: `group:GenericElders`)
...
* **Associated ACAI Concepts:** Tribe of Judah (ID: `group:Judah`); LORD (ID: `deity:Lord`); Judah (ID: `person:Judah.4`); Tamar (ID: `person:Tamar`); Perez (ID: `person:Perez`)
...
* **Associated ACAI Concepts:** Salmon (ID: `person:Salmon`); Hezron (ID: `person:Hezron.2`); Amminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Boaz (ID: `person:Boaz`); David (ID: `person:David`); Nahshon (ID: `person:Nahshon`); Jesse (ID: `person:Jesse`); Perez (ID: `person:Perez`)
