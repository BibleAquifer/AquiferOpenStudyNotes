...
* **Associated ACAI Concepts:** Ido (ID: `person:Iddo.6`); Zacarias (ID: `person:Zechariah.17`); Berequias (ID: `person:Berechiah.6`); SENHOR (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Dario (ID: `person:Darius.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Jerusalém (ID: `place:Jerusalem`); Myrtle (ID: `flora:Myrtle`); Ido (ID: `person:Iddo.6`); Berequias (ID: `person:Berechiah.6`); Be Zealous (ID: `keyterm:Zealous`); Zacarias (ID: `person:Zechariah.17`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `person:Judah.4`); Dario (ID: `person:Darius.2`); Judá (ID: `group:Judah`); ardour (ID: `keyterm:Ardour`); Measuring Reed (ID: `realia:MeasuringReed`); House (ID: `realia:House`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Jerusalém (ID: `place:Jerusalem`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `group:Judah`); ardour (ID: `keyterm:Ardour`); horn (ID: `keyterm:Horn`); Olive Tree (ID: `flora:OliveTree`); Horse (ID: `fauna:Horse`); Sofonias (ID: `person:Zephaniah.4`); Tobias (ID: `person:Tobijah.2`); Jedaías (ID: `person:Jedaiah.6`); Josias (ID: `person:Josiah.2`); Heldai (ID: `person:Heldai`); Satanás (ID: `deity:Satan`); swear (ID: `keyterm:Swear`); Glory (ID: `keyterm:Glory`); Come On! (ID: `keyterm:ComeOn`); Babilônia (ID: `place:Babylon`); Myrtle (ID: `flora:Myrtle`); Chariot (ID: `realia:Chariot`); Sheep (ID: `fauna:Lamb`); Ido (ID: `person:Iddo.6`); Jeozadaque (ID: `person:Jehozadak`); Berequias (ID: `person:Berechiah.6`); Sinar (ID: `place:Shinar`)
...
* **Associated ACAI Concepts:** Be Zealous (ID: `keyterm:Zealous`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); An Angel (ID: `deity:Angel`); ardour (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** horn (ID: `keyterm:Horn`); Sheep (ID: `fauna:Lamb`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Gentiles (ID: `group:Gentile`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); An Angel (ID: `deity:Angel`); Craftsman (ID: `realia:Craftsman`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Come On! (ID: `keyterm:ComeOn`); Judá (ID: `person:Judah.4`); Glory (ID: `keyterm:Glory`); Judá (ID: `group:Judah`); An Angel (ID: `deity:Angel`); Babilônia (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Josué (ID: `person:Joshua.5`); An Angel (ID: `deity:Angel`); Satanás (ID: `deity:Satan`); ardour (ID: `keyterm:Ardour`); The Way (ID: `keyterm:TheWay`); pure (ID: `keyterm:Pure`); Jerusalém (ID: `place:Jerusalem`); example (ID: `keyterm:Example`); Turban (ID: `realia:Turban.2`); Fig (ID: `flora:Fig`); Craftsman (ID: `realia:Craftsman`); House (ID: `realia:House`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Satanás (ID: `deity:Satan`); Josué (ID: `person:Joshua.5`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Sofonias (ID: `person:Zephaniah.4`); Tobias (ID: `person:Tobijah.2`); Jedaías (ID: `person:Jedaiah.6`); Josias (ID: `person:Josiah.2`); Heldai (ID: `person:Heldai`); Crown (ID: `realia:Crown`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); counsel (ID: `keyterm:Counsel`); peace (ID: `keyterm:IntactState`); Word of the Lord (ID: `keyterm:WordOfTheLord`); majesty (ID: `keyterm:Majesty`); Babilônia (ID: `place:Babylon`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Sofonias (ID: `person:Zephaniah.4`); Tobias (ID: `person:Tobijah.2`); Jedaías (ID: `person:Jedaiah.6`); Josias (ID: `person:Josiah.2`); Heldai (ID: `person:Heldai`); Babilônia (ID: `place:Babylon`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Sofonias (ID: `person:Zephaniah.4`); Tobias (ID: `person:Tobijah.2`); Jedaías (ID: `person:Jedaiah.6`); Josias (ID: `person:Josiah.2`); Heldai (ID: `person:Heldai`); SENHOR (ID: `deity:Lord`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Zacarias (ID: `person:Zechariah.17`); Sarezer (ID: `person:Sharezer.2`); Regém-Meleque (ID: `person:Regem-melech`); rogar (ID: `keyterm:AskFor`); Instruction (ID: `keyterm:Instruction`); Jerusalém (ID: `place:Jerusalem`); Sefalá (ID: `place:Shephelah`); Dario (ID: `person:Darius.2`); Neguebe (ID: `place:Negeb`); kindness (ID: `keyterm:Kindness`); Truth (ID: `keyterm:Truth`); Betel (ID: `place:Bethel`); withdraw oneself (ID: `keyterm:WithdrawOneself`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Truth (ID: `keyterm:Truth`); peace (ID: `keyterm:IntactState`); Judá (ID: `person:Judah.4`); rogar (ID: `keyterm:AskFor`); Judá (ID: `group:Judah`); Zacarias (ID: `person:Zechariah.17`); fear (ID: `keyterm:Fear`); love (ID: `keyterm:Love`); Jews (ID: `group:Jews`); Regém-Meleque (ID: `person:Regem-melech`); Sarezer (ID: `person:Sharezer.2`); House (ID: `realia:House`); Be Zealous (ID: `keyterm:Zealous`); Oath (ID: `keyterm:Oath`); ardour (ID: `keyterm:Ardour`); Betel (ID: `place:Bethel`); bless (ID: `keyterm:Bless`); Sefalá (ID: `place:Shephelah`); appointed feast (ID: `keyterm:AppointedFeast`); Neguebe (ID: `place:Negeb`); kindness (ID: `keyterm:Kindness`); Israel (ID: `person:Israel`); withdraw oneself (ID: `keyterm:WithdrawOneself`); Instruction (ID: `keyterm:Instruction`); Dario (ID: `person:Darius.2`); Staff (ID: `realia:Staff`); Cattle (ID: `fauna:Bull`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Sarezer (ID: `person:Sharezer.2`); Regém-Meleque (ID: `person:Regem-melech`); rogar (ID: `keyterm:AskFor`); SENHOR (ID: `deity:Lord`); Betel (ID: `place:Bethel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Sefalá (ID: `place:Shephelah`); Jerusalém (ID: `place:Jerusalem`); Neguebe (ID: `place:Negeb`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); peace (ID: `keyterm:IntactState`); Truth (ID: `keyterm:Truth`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); rogar (ID: `keyterm:AskFor`); Word of the Lord (ID: `keyterm:WordOfTheLord`); fear (ID: `keyterm:Fear`); love (ID: `keyterm:Love`); Jews (ID: `group:Jews`); Be Zealous (ID: `keyterm:Zealous`); Oath (ID: `keyterm:Oath`); ardour (ID: `keyterm:Ardour`); bless (ID: `keyterm:Bless`); appointed feast (ID: `keyterm:AppointedFeast`); Israel (ID: `person:Israel`); Staff (ID: `realia:Staff`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); peace (ID: `keyterm:IntactState`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Israel (ID: `person:Israel`); fear (ID: `keyterm:Fear`); bless (ID: `keyterm:Bless`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); peace (ID: `keyterm:IntactState`); Judá (ID: `person:Judah.4`); appointed feast (ID: `keyterm:AppointedFeast`); Judá (ID: `group:Judah`); Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Hadraque (ID: `place:Hadrach`); SENHOR (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Utterance (ID: `keyterm:Utterance`); Damasco (ID: `place:Damascus`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ecrom (ID: `place:Ekron`); Tiro (ID: `place:Tyre`); Hadraque (ID: `place:Hadrach`); Judá (ID: `person:Judah.4`); Utterance (ID: `keyterm:Utterance`); Damasco (ID: `place:Damascus`); Asquelom (ID: `place:Ashkelon`); Filisteu (ID: `group:Philistine`); Sidom (ID: `place:Sidon`); Jebusites (ID: `group:Jebusites`); Israel (ID: `person:Israel`); Asdode (ID: `place:Ashdod`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Hamate (ID: `place:Hamath`); Gaza (ID: `place:Gaza`); Judá (ID: `group:Judah`); fear (ID: `keyterm:Fear`); abomination (ID: `keyterm:DetestedThing`); Filístia (ID: `place:Philistine`); dispossess (ID: `keyterm:Dispossess`); Fortification (ID: `realia:Fortification`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Sheep (ID: `fauna:Lamb`); Efraim (ID: `group:Ephraim`); Jerusalém (ID: `place:Jerusalem`); Efraim (ID: `person:Ephraim`); Bow (ID: `realia:Bow`); Egito (ID: `place:Egypt`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Appoint (ID: `keyterm:Appoint`); Libano (ID: `place:Lebanon`); Israel (ID: `person:Israel`); Ecrom (ID: `place:Ekron`); Assyria (ID: `place:Assyria`); Covenant (ID: `keyterm:Covenant`); Tiro (ID: `place:Tyre`); Money (ID: `realia:Money`); Staff (ID: `realia:Staff`); Rod (ID: `realia:Rod`); Vine (ID: `flora:Vine`); Horse (ID: `fauna:Horse`); Hadraque (ID: `place:Hadrach`); terafins (ID: `deity:Teraphim`); Cedar (ID: `flora:Cedar`); comprar (ID: `keyterm:Redeem`); Grécia (ID: `place:Greece`); bless (ID: `keyterm:Bless`); Woe (ID: `keyterm:Woe.2`); José (ID: `person:Joseph.10`); Mighty (ID: `keyterm:Mighty`); have a vision (ID: `keyterm:HaveAVision`); Sidom (ID: `place:Sidon`); Jebusites (ID: `group:Jebusites`); Damasco (ID: `place:Damascus`); Foolish (ID: `keyterm:Foolish`); practice divination (ID: `keyterm:PracticeDivination`); fear (ID: `keyterm:Fear`); abomination (ID: `keyterm:DetestedThing`); Filístia (ID: `place:Philistine`); majesty (ID: `keyterm:Majesty`); Rio Nilo (ID: `place:Nile`); hope (ID: `keyterm:Hope`); Utterance (ID: `keyterm:Utterance`); Asquelom (ID: `place:Ashkelon`); arrow (ID: `keyterm:Arrow`); Filisteu (ID: `group:Philistine`); mischief (ID: `keyterm:Mischief`); Asdode (ID: `place:Ashdod`); Gileade (ID: `place:Gilead`); Hamate (ID: `place:Hamath`); Jordan River (ID: `place:Jordan`); Gaza (ID: `place:Gaza`); Basã (ID: `place:Bashan`); Rio Eufrates (ID: `place:Euphrates`); peace (ID: `keyterm:IntactState`); dispossess (ID: `keyterm:Dispossess`); Sword (ID: `realia:Sword`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Fir (ID: `flora:Fir`); Donkey (ID: `fauna:Donkey`); Temple Altar (ID: `realia:TempleAltar`); Sling (ID: `realia:Sling`); Chariot (ID: `realia:Chariot`); Peg (ID: `realia:Peg`); Fortification (ID: `realia:Fortification`); Pit (ID: `realia:Pit`); Grass (ID: `flora:Grass`); Altar (ID: `realia:Altar`); Grecian Juniper (ID: `flora:Juniper`); Grain (ID: `flora:Grain`); Sandalwood (ID: `flora:Sandalwood`); Household Idols (ID: `realia:HouseholdIdols`); Lion (ID: `fauna:Lion`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Must (ID: `realia:Must`); Oak (ID: `flora:Oak`); Rams Horn (ID: `realia:RamsHorn`); Crown (ID: `realia:Crown`); Cypress (ID: `flora:Cypress`); Peg (ID: `realia:Peg.2`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Davi (ID: `person:David`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Egito (ID: `place:Egypt`); House (ID: `realia:House`); Horse (ID: `fauna:Horse`); Money (ID: `realia:Money`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); plague (ID: `keyterm:Blow`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Israel (ID: `person:Israel`); Efraim (ID: `group:Ephraim`); Efraim (ID: `person:Ephraim`); Appoint (ID: `keyterm:Appoint`); Libano (ID: `place:Lebanon`); Ecrom (ID: `place:Ekron`); Assyria (ID: `place:Assyria`); Covenant (ID: `keyterm:Covenant`); Utterance (ID: `keyterm:Utterance`); speak (ID: `keyterm:Speak`); Tiro (ID: `place:Tyre`); Bow (ID: `realia:Bow`); Sword (ID: `realia:Sword`); Staff (ID: `realia:Staff`); Rod (ID: `realia:Rod`)
...
* **Associated ACAI Concepts:** Asdode (ID: `place:Ashdod`); Filisteu (ID: `group:Philistine`); Filístia (ID: `place:Philistine`); Gaza (ID: `place:Gaza`); Asquelom (ID: `place:Ashkelon`); Ecrom (ID: `place:Ekron`); fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** abomination (ID: `keyterm:DetestedThing`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Jebusites (ID: `group:Jebusites`); Judá (ID: `group:Judah`); Ecrom (ID: `place:Ekron`)
...
* **Associated ACAI Concepts:** Bow (ID: `realia:Bow`); Rio Eufrates (ID: `place:Euphrates`); peace (ID: `keyterm:IntactState`); Efraim (ID: `person:Ephraim`); Jerusalém (ID: `place:Jerusalem`); Efraim (ID: `group:Ephraim`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** Grécia (ID: `place:Greece`); Efraim (ID: `person:Ephraim`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Efraim (ID: `group:Ephraim`); Bow (ID: `realia:Bow`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Sling (ID: `realia:Sling`); Wine (ID: `realia:Wine`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); terafins (ID: `deity:Teraphim`); Appoint (ID: `keyterm:Appoint`); practice divination (ID: `keyterm:PracticeDivination`); have a vision (ID: `keyterm:HaveAVision`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); majesty (ID: `keyterm:Majesty`); mischief (ID: `keyterm:Mischief`); Grass (ID: `flora:Grass`); Household Idols (ID: `realia:HouseholdIdols`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** terafins (ID: `deity:Teraphim`); practice divination (ID: `keyterm:PracticeDivination`); have a vision (ID: `keyterm:HaveAVision`); mischief (ID: `keyterm:Mischief`); Flock (ID: `fauna:Flock`); Household Idols (ID: `realia:HouseholdIdols`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Appoint (ID: `keyterm:Appoint`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); majesty (ID: `keyterm:Majesty`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Horse (ID: `fauna:Horse`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Assyria (ID: `place:Assyria`); Egito (ID: `place:Egypt`); Rio Nilo (ID: `place:Nile`); comprar (ID: `keyterm:Redeem`); José (ID: `person:Joseph.10`); Efraim (ID: `person:Ephraim`); Gileade (ID: `place:Gilead`); Libano (ID: `place:Lebanon`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Efraim (ID: `group:Ephraim`); Wine (ID: `realia:Wine`); Bow (ID: `realia:Bow`); Peg (ID: `realia:Peg.2`); Horse (ID: `fauna:Horse`); Vine (ID: `flora:Vine`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** Assyria (ID: `place:Assyria`); Egito (ID: `place:Egypt`); Gileade (ID: `place:Gilead`); Libano (ID: `place:Lebanon`)
...
* **Associated ACAI Concepts:** Fir (ID: `flora:Fir`); Basã (ID: `place:Bashan`); Mighty (ID: `keyterm:Mighty`); Cypress (ID: `flora:Cypress`); Cedar (ID: `flora:Cedar`); Sandalwood (ID: `flora:Sandalwood`); Oak (ID: `flora:Oak`); Grecian Juniper (ID: `flora:Juniper`)
...
* **Associated ACAI Concepts:** Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); SENHOR (ID: `deity:Lord`); Rod (ID: `realia:Rod`); Staff (ID: `realia:Staff`); Money (ID: `realia:Money`); Appoint (ID: `keyterm:Appoint`); Foolish (ID: `keyterm:Foolish`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `person:Judah.4`); bless (ID: `keyterm:Bless`); Israel (ID: `person:Israel`); Judá (ID: `group:Judah`); Covenant (ID: `keyterm:Covenant`); Woe (ID: `keyterm:Woe.2`); Sword (ID: `realia:Sword`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); bless (ID: `keyterm:Bless`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Foolish (ID: `keyterm:Foolish`); SENHOR (ID: `deity:Lord`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Davi (ID: `person:David`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); House (ID: `realia:House`); plague (ID: `keyterm:Blow`); Horse (ID: `fauna:Horse`); Egito (ID: `place:Egypt`); speak (ID: `keyterm:Speak`); Hadade-Rimom (ID: `place:Hadad-rimmon`); Shimeites (ID: `group:Shimei`); Azal (ID: `place:Azal`); Simei (ID: `person:Shimei.4`); Monte das Oliveiras (ID: `place:OlivesMount`); Torre de Hanamel (ID: `place:TowerOfHananel`); Benjamin Gate (ID: `place:BenjaminGate`); Money (ID: `realia:Money`); Cooking Pot (ID: `realia:CookingPot`); defilement (ID: `keyterm:Defilement`); state of being under siege (ID: `keyterm:StateOfBeingUnderSiege`); Megido (ID: `place:Megiddo`); Natã (ID: `person:Nathan`); Utterance (ID: `keyterm:Utterance`); Levi (ID: `person:Levi.3`); An Angel (ID: `deity:Angel`); Arabá (ID: `place:Arabah`); be enticed to serve (ID: `keyterm:EnticedToServe`); Punishment (ID: `keyterm:Punishment`); Corner Gate (ID: `place:CornerGate`); To Sin (ID: `keyterm:Sin`); Uzias (ID: `person:Uzziah`); Israel (ID: `person:Israel`); holy (ID: `keyterm:Holy`); supplication (ID: `keyterm:Supplication`); Safety (ID: `keyterm:Safety`); Ain (ID: `place:Ain`); Word of the Lord (ID: `keyterm:WordOfTheLord`); love (ID: `keyterm:Love`); Geba (ID: `place:Geba`); Levi (ID: `group:Levi`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`); favor (ID: `keyterm:Favor`); Bowl (ID: `realia:Bowl`); Temple Altar (ID: `realia:TempleAltar`); Image (ID: `realia:Image`); Donkey (ID: `fauna:Donkey`); Flock (ID: `fauna:Flock`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Sword (ID: `realia:Sword`); Clothing (ID: `realia:Clothing`); Goat (ID: `fauna:Goat`); Altar (ID: `realia:Altar`); Winepress (ID: `realia:Winepress`); Camel (ID: `fauna:Camel`); Sheaf (ID: `realia:Sheaf`); Stone Altar (ID: `realia:StoneAltar`); Olive Tree (ID: `flora:OliveTree`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Mule (ID: `fauna:Mule`)
...
* **Associated ACAI Concepts:** Simei (ID: `person:Shimei.4`); Shimeites (ID: `group:Shimei`); Levi (ID: `group:Levi`); Davi (ID: `person:David`); Natã (ID: `person:Nathan`); Levi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); speak (ID: `keyterm:Speak`); defilement (ID: `keyterm:Defilement`); Davi (ID: `person:David`); To Sin (ID: `keyterm:Sin`); Jerusalém (ID: `place:Jerusalem`); be enticed to serve (ID: `keyterm:EnticedToServe`); love (ID: `keyterm:Love`); Clothing (ID: `realia:Clothing`); Image (ID: `realia:Image`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); Judá (ID: `person:Judah.4`); plague (ID: `keyterm:Blow`); Judá (ID: `group:Judah`); House (ID: `realia:House`); Egito (ID: `place:Egypt`); Cooking Pot (ID: `realia:CookingPot`); Horse (ID: `fauna:Horse`); Azal (ID: `place:Azal`); Monte das Oliveiras (ID: `place:OlivesMount`); Torre de Hanamel (ID: `place:TowerOfHananel`); Benjamin Gate (ID: `place:BenjaminGate`); Arabá (ID: `place:Arabah`); Punishment (ID: `keyterm:Punishment`); Corner Gate (ID: `place:CornerGate`); Uzias (ID: `person:Uzziah`); holy (ID: `keyterm:Holy`); Safety (ID: `keyterm:Safety`); Ain (ID: `place:Ain`); Geba (ID: `place:Geba`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`); Temple Altar (ID: `realia:TempleAltar`); Donkey (ID: `fauna:Donkey`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Money (ID: `realia:Money`); Altar (ID: `realia:Altar`); Winepress (ID: `realia:Winepress`); Camel (ID: `fauna:Camel`); Stone Altar (ID: `realia:StoneAltar`); Olive Tree (ID: `flora:OliveTree`); Cattle (ID: `fauna:Bull`); Mule (ID: `fauna:Mule`)
...
* **Associated ACAI Concepts:** Azal (ID: `place:Azal`); SENHOR (ID: `deity:Lord`); Uzias (ID: `person:Uzziah`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Cooking Pot (ID: `realia:CookingPot`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); House (ID: `realia:House`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Cooking Pot (ID: `realia:CookingPot`); House (ID: `realia:House`)
