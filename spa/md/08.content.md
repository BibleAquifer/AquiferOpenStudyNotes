...
* **Associated ACAI Concepts:** Ephrata (ID: `person:Ephrathah`); Efratita (ID: `group:Ephrathah`); Chelión (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Mahalón (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Elimelech (ID: `person:Elimelech`); Catah (ID: `place:Bethlehem`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); dejar en herencia (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Mahalón (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); Rachêl (ID: `person:Rachel`); Lea (ID: `person:Leah`); Catah (ID: `place:Bethlehem`); Israel (ID: `person:Israel`); Elders (ID: `group:GenericElders`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Jehová (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Thamar (ID: `person:Tamar`); Phares (ID: `person:Perez`)
...
* **Associated ACAI Concepts:** Salmón (ID: `person:Salmon`); Hesrón (ID: `person:Hezron.2`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Booz (ID: `person:Boaz`); David (ID: `person:David`); Nahasón (ID: `person:Nahshon`); Isaí (ID: `person:Jesse`); Phares (ID: `person:Perez`)
