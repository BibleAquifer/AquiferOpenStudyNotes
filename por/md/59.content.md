...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); tentar (ID: `keyterm:PutToTheTest`); bem, aventurado (ID: `keyterm:Happy`); amado (ID: `keyterm:Beloved`); limpo (ID: `keyterm:Clean`); aprovado (ID: `keyterm:Approved`); inútil (ID: `keyterm:Worthless`); Life (ID: `keyterm:Life`); lei (ID: `keyterm:Law`); promessa (ID: `keyterm:Promise`); love (ID: `keyterm:Love`); que não pode ser tentado (ID: `keyterm:NotTempted`); be (or show oneself) just (ID: `keyterm:Just`); To Sin (ID: `keyterm:Sin`); salvation (ID: `keyterm:Salvation`); A Person (ID: `person:GenericPerson`); sem mancha (ID: `keyterm:AboveCriticism`); Good (ID: `keyterm:Good`); coração (ID: `keyterm:Heart`); sem mancha (ID: `keyterm:Undefiled`); Truth (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** inútil (ID: `keyterm:Worthless`); limpo (ID: `keyterm:Clean`); sem mancha (ID: `keyterm:Undefiled`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); sem mancha (ID: `keyterm:AboveCriticism`); coração (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); favoritismo (ID: `keyterm:Partiality`); Jesus (ID: `person:Jesus.2`); Glory (ID: `keyterm:Glory`); distinguir (ID: `keyterm:Discern`); crer (ID: `keyterm:Believe`); Seal (ID: `realia:Seal`); Synagogue (ID: `realia:Synagogue`); Footstool (ID: `realia:Footstool`)
...
* **Associated ACAI Concepts:** amado (ID: `keyterm:Beloved`); escolhido (ID: `keyterm:Chosen`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); reino (ID: `keyterm:Kingdom`); promessa (ID: `keyterm:Promise`); crer (ID: `keyterm:Believe`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); juízo (ID: `keyterm:Judgment`); favoritismo (ID: `keyterm:Partiality`); tropeçar (ID: `keyterm:Stumble`); escritura (ID: `keyterm:Scripture`); inclemente (ID: `keyterm:Merciless`); fornication (ID: `keyterm:Fornication`); decidir (ID: `keyterm:Decided`); tribunal de justiça (ID: `keyterm:CourtCase`); misericórdia (ID: `keyterm:Mercy`); love (ID: `keyterm:Love`); To Sin (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); SENHOR (ID: `deity:Lord`); Abraão (ID: `person:Abraham`); A Person (ID: `person:GenericPerson`); corpo (ID: `keyterm:Body.3`); Raabe (ID: `person:Rahab`); inútil (ID: `keyterm:Idle`); escritura (ID: `keyterm:Scripture`); vazio (ID: `keyterm:Empty`); To Cause to Happen (ID: `keyterm:Happen`); Demons (ID: `deity:Demons`); An Angel (ID: `deity:Angel`); salvation (ID: `keyterm:Salvation`); Isaque (ID: `person:Isaac`); Spirit (ID: `keyterm:Spirit.2`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); Abraão (ID: `person:Abraham`); Raabe (ID: `person:Rahab`); inútil (ID: `keyterm:Idle`); escritura (ID: `keyterm:Scripture`); SENHOR (ID: `deity:Lord`); vazio (ID: `keyterm:Empty`); To Cause to Happen (ID: `keyterm:Happen`); An Angel (ID: `deity:Angel`); Isaque (ID: `person:Isaac`); Spirit (ID: `keyterm:Spirit.2`); corpo (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** escritura (ID: `keyterm:Scripture`); SENHOR (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); Abraão (ID: `person:Abraham`); crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** Hell (ID: `place:Hell`); Ability (ID: `keyterm:Ability`); injustiça (ID: `keyterm:UnjustDeed`); corpo (ID: `keyterm:Body.3`); geena (ID: `keyterm:Gehenna`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); amizade (ID: `keyterm:Friendship`); be unfaithful (ID: `keyterm:Unfaithful`); escritura (ID: `keyterm:Scripture`); Holy Spirit (ID: `deity:HolySpirit`); Cause of Joy (ID: `keyterm:CauseOfJoy`); favor (ID: `keyterm:Favor`); pure (ID: `keyterm:Pure`); Ability (ID: `keyterm:Ability`); Spirit (ID: `keyterm:Spirit.2`); coração (ID: `keyterm:Heart`); desejar (ID: `keyterm:LongFor`); To Cleanse (ID: `keyterm:Cleanse.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); testemunhar (ID: `keyterm:BearWitness`); condenar (ID: `keyterm:Condemn`); corpo (ID: `keyterm:Body.3`); be (or show oneself) just (ID: `keyterm:Just`); coração (ID: `keyterm:Heart`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); igreja (ID: `keyterm:Church`); Name (ID: `keyterm:Name`); anointed (ID: `keyterm:Anointed`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); To Sin (ID: `keyterm:Sin`); forgive (ID: `keyterm:Forgive`)
