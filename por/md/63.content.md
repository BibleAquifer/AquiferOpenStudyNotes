...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); escolhido (ID: `keyterm:Chosen`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); para a eternidade (ID: `keyterm:Always`); Jesus (ID: `person:Jesus.2`); misericórdia (ID: `keyterm:Mercy`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); misericórdia (ID: `keyterm:Mercy`); Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); andar (ID: `keyterm:Live.3`); Truth (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); rogar (ID: `keyterm:AskFor`); corpo (ID: `keyterm:Body.3`); compartilhar (ID: `keyterm:Share`); House (ID: `realia:House`)
