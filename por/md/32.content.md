...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); fear (ID: `keyterm:Fear`); Fish (ID: `fauna:Fish`); Ship (ID: `realia:Ship`); make a vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); Jope (ID: `place:Joppa`); Nínive (ID: `place:Nineveh`); Amittai (ID: `person:Amittai`); Hebrews (ID: `group:Hebrews`); kindness (ID: `keyterm:Kindness`); slaughtering (ID: `keyterm:Slaughtering`); Word of the Lord (ID: `keyterm:WordOfTheLord`); salvation (ID: `keyterm:Salvation`); praise (ID: `keyterm:Praise`); exempt (ID: `keyterm:Exempt`); lot (ID: `keyterm:Lot`); Társis (ID: `place:Tarshish`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** make a vow (ID: `keyterm:Vow`); SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); praise (ID: `keyterm:Praise`); kindness (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Nínive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Társis (ID: `place:Tarshish`); Compassionate (ID: `keyterm:Compassionate`); gracious (ID: `keyterm:Generous`); Believe In (ID: `keyterm:BelieveIn`); kindness (ID: `keyterm:Kindness`); Throne (ID: `realia:Throne`); Worm (ID: `fauna:Maggot`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Nínive (ID: `place:Nineveh`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Jonas (ID: `person:Jonah.2`)
...
* **Associated ACAI Concepts:** Cattle (ID: `fauna:Bull`); SENHOR (ID: `deity:Lord`); Nínive (ID: `place:Nineveh`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); Compassionate (ID: `keyterm:Compassionate`); gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`); kindness (ID: `keyterm:Kindness`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Compassionate (ID: `keyterm:Compassionate`); SENHOR (ID: `deity:Lord`); gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`); kindness (ID: `keyterm:Kindness`)
