...
* **Associated ACAI Concepts:** Dario (ID: `person:Darius.2`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Ageu (ID: `person:Haggai`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Ageu (ID: `person:Haggai`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Dario (ID: `person:Darius.2`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `group:Judah`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Must (ID: `realia:Must`); Vine (ID: `flora:Vine`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); Grain (ID: `flora:Grain`); Olive Oil (ID: `realia:OliveOil`); Mule (ID: `fauna:Mule`); Bag (ID: `realia:Bag`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); fear (ID: `keyterm:Fear`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); SENHOR (ID: `deity:Lord`); Sealtiel (ID: `person:Shealtiel.2`); Ageu (ID: `person:Haggai`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `group:Judah`); Josué (ID: `person:Joshua.5`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`); Sealtiel (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Ageu (ID: `person:Haggai`); Egito (ID: `place:Egypt`); peace (ID: `keyterm:IntactState`); fear (ID: `keyterm:Fear`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Sealtiel (ID: `person:Shealtiel.2`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Sealtiel (ID: `person:Shealtiel.2`); Ageu (ID: `person:Haggai`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`); Sword (ID: `realia:Sword`)
