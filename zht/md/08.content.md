...
* **Associated ACAI Concepts:** Ephrathites (ID: `group:Ephrathah`); Chilion (ID: `person:Chilion`); Ephrathah (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Elimelech (ID: `person:Elimelech`); Bethlehem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Mahlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Bethlehem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); Ruth (ID: `person:Ruth`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Naomi (ID: `person:Naomi`); Bless (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); Boaz (ID: `person:Boaz`); To Cause to Possess (ID: `keyterm:Possess`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); To Cause to Possess (ID: `keyterm:Possess`); Mahlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Elders (ID: `group:GenericElders`); Bethlehem (ID: `place:Bethlehem`); LORD (ID: `deity:Lord`); Leah (ID: `person:Leah`); Rachel (ID: `person:Rachel`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Perez (ID: `person:Perez`); LORD (ID: `deity:Lord`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Tamar (ID: `person:Tamar`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Obed (ID: `person:Obed`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); David (ID: `person:David`); Jesse (ID: `person:Jesse`); Nahshon (ID: `person:Nahshon`); Boaz (ID: `person:Boaz`); Perez (ID: `person:Perez`)
