...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Ageu (ID: `person:Haggai`); Josué (ID: `person:Joshua.5`); Dario (ID: `person:Darius.2`); Sealtiel (ID: `person:Shealtiel.2`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Ageu (ID: `person:Haggai`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Sealtiel (ID: `person:Shealtiel.2`); Dario (ID: `person:Darius.2`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `group:Judah`); An Angel (ID: `deity:Angel`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); fear (ID: `keyterm:Fear`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Bag (ID: `realia:Bag`); Grain (ID: `flora:Grain`); Must (ID: `realia:Must`); Olive Tree (ID: `flora:OliveTree`); Vine (ID: `flora:Vine`); Mule (ID: `fauna:Mule`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); Ageu (ID: `person:Haggai`); Josué (ID: `person:Joshua.5`); SENHOR (ID: `deity:Lord`); Sealtiel (ID: `person:Shealtiel.2`); fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `group:Judah`); Sealtiel (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Ageu (ID: `person:Haggai`); Sealtiel (ID: `person:Shealtiel.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); peace (ID: `keyterm:IntactState`); Judá (ID: `person:Judah.4`); Egito (ID: `place:Egypt`); Judá (ID: `group:Judah`); fear (ID: `keyterm:Fear`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ageu (ID: `person:Haggai`); defilement (ID: `keyterm:Defilement`); Vine (ID: `flora:Vine`); bless (ID: `keyterm:Bless`); holy (ID: `keyterm:Holy`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Instruction (ID: `keyterm:Instruction`); Dario (ID: `person:Darius.2`); Fig (ID: `flora:Fig`); Wine (ID: `realia:Wine`); Barley (ID: `flora:Barley`); Olive Oil (ID: `realia:OliveOil`); Coriander (ID: `flora:Coriander`); Anointing Oil (ID: `realia:AnointingOil`); Pomegranate (ID: `flora:Pomegranate`); Winepress (ID: `realia:Winepress`); Stew (ID: `realia:Stew`); Grain (ID: `flora:Grain`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Ageu (ID: `person:Haggai`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Sealtiel (ID: `person:Shealtiel.2`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`); Sword (ID: `realia:Sword`)
