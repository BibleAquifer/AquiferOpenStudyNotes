...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); misericórdia (ID: `keyterm:Mercy`); escolhido (ID: `keyterm:Chosen`); Jesus (ID: `person:Jesus.2`); fazer a paz (ID: `keyterm:Peace`); para a eternidade (ID: `keyterm:Always`)
...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`); fazer a paz (ID: `keyterm:Peace`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); SENHOR (ID: `deity:Lord`); andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`); Truth (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); compartilhar (ID: `keyterm:Share`); corpo (ID: `keyterm:Body.3`); House (ID: `realia:House`)
