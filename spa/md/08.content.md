...
* **Associated ACAI Concepts:** Ephrata (ID: `person:Ephrathah`); Noemi (ID: `person:Naomi`); Chelión (ID: `person:Chilion`); Efratita (ID: `group:Ephrathah`); Judá (ID: `group:Judah`); Catah (ID: `place:Bethlehem`); Judá (ID: `person:Judah.4`); Elimelech (ID: `person:Elimelech`); Moab (ID: `place:Moab`); Mahalón (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); bondad (ID: `keyterm:Kindness`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); Catah (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** favor (ID: `keyterm:Favor`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); bondad (ID: `keyterm:Kindness`); Noemi (ID: `person:Naomi`); bendecir (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); dejar en herencia (ID: `keyterm:Possess`); Booz (ID: `person:Boaz`); Noemi (ID: `person:Naomi`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** dejar en herencia (ID: `keyterm:Possess`); Ruth (ID: `person:Ruth`); Mahalón (ID: `person:Mahlon`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Jehová (ID: `deity:Lord`); Catah (ID: `place:Bethlehem`); Lea (ID: `person:Leah`); Elders (ID: `group:GenericElders`); Rachêl (ID: `person:Rachel`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Noemi (ID: `person:Naomi`); Israel (ID: `person:Israel`); Jehová (ID: `deity:Lord`); bendecir (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Hesrón (ID: `person:Hezron.2`); Salmón (ID: `person:Salmon`); Obed (ID: `person:Obed`); Aminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Booz (ID: `person:Boaz`); Isaí (ID: `person:Jesse`); Nahasón (ID: `person:Nahshon`); David (ID: `person:David`); Phares (ID: `person:Perez`)
