...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); rebel (ID: `keyterm:Rebel`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); strength (ID: `keyterm:Strength`); Judá (ID: `group:Judah`); love (ID: `keyterm:Love`); Mighty One (ID: `keyterm:MightyOne`); work (ID: `keyterm:Work`); defilement (ID: `keyterm:Defilement`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Israel (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); appointed feast (ID: `keyterm:AppointedFeast`); Deceit (ID: `keyterm:Deceit`); Train (ID: `realia:Train`); House (ID: `realia:House`); Winepress (ID: `realia:Winepress`); Yoke (ID: `realia:Yoke`); Grass (ID: `flora:Grass`); Deer (ID: `fauna:Deer`); Flock (ID: `fauna:Flock`); Net (ID: `realia:Net`); Goat (ID: `fauna:Goat`); Casting Net (ID: `realia:CastingNet`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); defilement (ID: `keyterm:Defilement`); To Sin (ID: `keyterm:Sin`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Mighty One (ID: `keyterm:MightyOne`); Judá (ID: `person:Judah.4`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); appointed feast (ID: `keyterm:AppointedFeast`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); horn (ID: `keyterm:Horn`); Sheep (ID: `fauna:Lamb`); Instruction (ID: `keyterm:Instruction`); profane, dishonor (ID: `keyterm:Dishonor`); have a vision (ID: `keyterm:HaveAVision`); ardour (ID: `keyterm:Ardour`); sabbath (ID: `keyterm:Sabbath`); Gentiles (ID: `group:Gentile`); Utterance (ID: `keyterm:Utterance`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Grain (ID: `flora:Grain`); Altar (ID: `realia:Altar`); Tent (ID: `realia:Tent`); Wine (ID: `realia:Wine`); Bow (ID: `realia:Bow`); Vine (ID: `flora:Vine`); Sackcloth (ID: `realia:Sackcloth`); Measuring Reed (ID: `realia:MeasuringReed`)
...
* **Associated ACAI Concepts:** horn (ID: `keyterm:Horn`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Bow (ID: `realia:Bow`); Sheep (ID: `fauna:Lamb`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); appointed feast (ID: `keyterm:AppointedFeast`); sabbath (ID: `keyterm:Sabbath`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Gentiles (ID: `group:Gentile`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Wormwood (ID: `flora:Wormwood`); Arrow (ID: `realia:Arrow`); kindness (ID: `keyterm:Kindness`); peace (ID: `keyterm:IntactState`); Complete (ID: `keyterm:Complete`); arrow (ID: `keyterm:Arrow`); Bow (ID: `realia:Bow`); Lion (ID: `fauna:Lion`); Hewn Stone (ID: `realia:HewnStone`); Bear (ID: `fauna:Bear`); Bitter Herbs (ID: `flora:Chicory`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`); Edom (ID: `place:Edom`); Uz (ID: `place:Uz`); stain (ID: `keyterm:Stain`); Punishment (ID: `keyterm:Punishment`); defilement (ID: `keyterm:Defilement`); be kindly disposed (ID: `keyterm:KindlyDisposed`); Appoint (ID: `keyterm:Appoint`); anointed (ID: `keyterm:Anointed`); Sodoma (ID: `place:Sodom`); Believe In (ID: `keyterm:BelieveIn`); Complete (ID: `keyterm:Complete`); Jackal (ID: `fauna:Jackal`); Ostrich (ID: `fauna:Ostrich`); Clay Jar (ID: `realia:ClayJar`); Purple Cloth (ID: `realia:PurpleCloth`); Vulture (ID: `fauna:Vulture`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`); Edom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Jerusalém (ID: `place:Jerusalem`); Egito (ID: `place:Egypt`); Woe (ID: `keyterm:Woe`); to cause to possess (ID: `keyterm:Possess`); round dance (ID: `keyterm:RoundDance`); Assyria (ID: `place:Assyria`); Judá (ID: `group:Judah`); ardour (ID: `keyterm:Ardour`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`); Jackal (ID: `fauna:Jackal`); Hand-Mill (ID: `realia:Hand-mill`); Money (ID: `realia:Money`); Crown (ID: `realia:Crown`)
