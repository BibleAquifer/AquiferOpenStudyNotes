...
* **Associated ACAI Concepts:** Ephrata (ID: `person:Ephrathah`); Efratita (ID: `group:Ephrathah`); Noemi (ID: `person:Naomi`); Chelión (ID: `person:Chilion`); Moab (ID: `place:Moab`); Judá (ID: `group:Judah`); Elimelech (ID: `person:Elimelech`); Judá (ID: `person:Judah.4`); Catah (ID: `place:Bethlehem`); Mahalón (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Noemi (ID: `person:Naomi`); Ruth (ID: `person:Ruth`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** bendecir (ID: `keyterm:Bless`); Noemi (ID: `person:Naomi`); bondad (ID: `keyterm:Kindness`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Rachêl (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); Lea (ID: `person:Leah`); Jehová (ID: `deity:Lord`); Catah (ID: `place:Bethlehem`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Jehová (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Phares (ID: `person:Perez`); Thamar (ID: `person:Tamar`)
...
* **Associated ACAI Concepts:** Salmón (ID: `person:Salmon`); Hesrón (ID: `person:Hezron.2`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Nahasón (ID: `person:Nahshon`); Phares (ID: `person:Perez`); Booz (ID: `person:Boaz`); Isaí (ID: `person:Jesse`); David (ID: `person:David`)
