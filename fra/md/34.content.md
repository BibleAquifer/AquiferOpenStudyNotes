...
* **Associated ACAI Concepts:** Elkosch (ID: `place:Elkosh`); Nahum (ID: `person:Nahum.2`); Utterance (ID: `keyterm:Utterance`); Ninive (ID: `place:Nineveh`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); déclarer innocent (ID: `keyterm:PronounceInnocent`); chemin (ID: `keyterm:TheWay`); zélé (ID: `keyterm:Zealous.3`); Liban (ID: `place:Lebanon`); force (ID: `keyterm:Strength`); Basan (ID: `place:Bashan`); Carmel (ID: `place:Carmel`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); déclarer innocent (ID: `keyterm:PronounceInnocent`); chemin (ID: `keyterm:TheWay`); zélé (ID: `keyterm:Zealous.3`); Liban (ID: `place:Lebanon`); force (ID: `keyterm:Strength`); méchanceté (ID: `keyterm:Wickedness`); Basan (ID: `place:Bashan`); Carmel (ID: `place:Carmel`); se réfugier (ID: `keyterm:SeekfindRefuge`); Brier (ID: `flora:Brier`); Strong Drink (ID: `realia:StrongDrink`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** chemin (ID: `keyterm:TheWay`); Éternel (ID: `deity:Lord`); déclarer innocent (ID: `keyterm:PronounceInnocent`); force (ID: `keyterm:Strength`)
...
* **Associated ACAI Concepts:** Liban (ID: `place:Lebanon`); Carmel (ID: `place:Carmel`); Basan (ID: `place:Bashan`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); méchanceté (ID: `keyterm:Wickedness`); se réfugier (ID: `keyterm:SeekfindRefuge`); Brier (ID: `flora:Brier`); Strong Drink (ID: `realia:StrongDrink`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** état intact (ID: `keyterm:IntactState`); Juda (ID: `group:Judah`); méchanceté (ID: `keyterm:Wickedness`); faire un voeu (ID: `keyterm:Vow`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); Éternel (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Libya (ID: `place:Libya`); Puth (ID: `place:Put`); Cush (ID: `place:Cush.2`); destin (ID: `keyterm:Lot`); Égypte (ID: `place:Egypt`)
