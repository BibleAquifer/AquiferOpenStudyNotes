...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Tessalônica (ID: `place:Thessalonica`); Paulo (ID: `person:Paul`); Timóteo (ID: `person:Timothy`); igreja (ID: `keyterm:Church`); favor (ID: `keyterm:Favor`); Thessalonians (ID: `group:Thessalonica`); Silas (ID: `person:Silas`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); dever (ID: `keyterm:Ought`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); be (or show oneself) just (ID: `keyterm:Just`); igreja (ID: `keyterm:Church`); testemunhar (ID: `keyterm:BearWitness`); tribunal de justiça (ID: `keyterm:CourtCase`); Glory (ID: `keyterm:Glory`); fazer justiça (ID: `keyterm:GrantJustice`); Ability (ID: `keyterm:Ability`); ser glorificado (ID: `keyterm:Glorified`); reino (ID: `keyterm:Kingdom`); dever (ID: `keyterm:Ought`); juízo (ID: `keyterm:Judgment`); boa notícia (ID: `keyterm:GoodNews`); An Angel (ID: `deity:Angel`); holy (ID: `keyterm:Holy`); love (ID: `keyterm:Love`); céu (ID: `keyterm:Heaven`); para a eternidade (ID: `keyterm:Always`)
...
* **Associated ACAI Concepts:** An Angel (ID: `deity:Angel`); céu (ID: `keyterm:Heaven`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); To Cause to Happen (ID: `keyterm:Happen`); Good (ID: `keyterm:Good`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); Name (ID: `keyterm:Name`); To Cause to Happen (ID: `keyterm:Happen`); favor (ID: `keyterm:Favor`); Good (ID: `keyterm:Good`); Jesus (ID: `person:Jesus.2`); ser glorificado (ID: `keyterm:Glorified`); crer (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); ser glorificado (ID: `keyterm:Glorified`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); Spirit (ID: `keyterm:Spirit.2`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); rogar (ID: `keyterm:AskFor`); objeto de culto (ID: `keyterm:ObjectOfWorship`); Satanás (ID: `deity:Satan`); maravilha (ID: `keyterm:Portent`); wipe (out), destroy (ID: `keyterm:Destroy`); example (ID: `keyterm:Example`); injustiça (ID: `keyterm:UnjustDeed`); love (ID: `keyterm:Love`); decidir (ID: `keyterm:Decided`); Ability (ID: `keyterm:Ability`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`); favor (ID: `keyterm:Favor`); Good (ID: `keyterm:Good`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`); SENHOR (ID: `deity:Lord`); hope (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); orar (ID: `keyterm:Pray`); love (ID: `keyterm:Love`); Faithfulness (ID: `keyterm:Faithfulness`); livrar (ID: `keyterm:Deliver`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); persuadir (ID: `keyterm:Persuade`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** tradição (ID: `keyterm:Teaching`); Name (ID: `keyterm:Name`); Jesus (ID: `person:Jesus.2`); andar (ID: `keyterm:Live.3`)
...
* **Associated ACAI Concepts:** andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); tradição (ID: `keyterm:Teaching`); Name (ID: `keyterm:Name`); rogar (ID: `keyterm:AskFor`); autoridade (ID: `keyterm:Authority.2`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); Ability (ID: `keyterm:Ability`)
