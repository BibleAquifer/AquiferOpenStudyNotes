...
* **Associated ACAI Concepts:** tahan uji (ID: `keyterm:Approved`); berbahagialah (ID: `keyterm:Happy`); janji (ID: `keyterm:Promise`); kehidupan (ID: `keyterm:Life`); kasihi (ID: `keyterm:Love`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); mencobai (ID: `keyterm:PutToTheTest`); berbahagialah (ID: `keyterm:Happy`); kekasih (ID: `keyterm:Beloved`); sia, sia (ID: `keyterm:Worthless`); tahan uji (ID: `keyterm:Approved`); suci (ID: `keyterm:Clean`); keahlian (ID: `keyterm:Ability`); hukum (ID: `keyterm:Law`); hati (ID: `keyterm:Heart`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); tidak dicemarkan (ID: `keyterm:Undefiled`); kehidupan (ID: `keyterm:Life`); berbuat dosa (ID: `keyterm:Sin`); yang baik (ID: `keyterm:Good`); tak bernoda (ID: `keyterm:AboveCriticism`); kasihi (ID: `keyterm:Love`); keselamatan (ID: `keyterm:Salvation`); janji (ID: `keyterm:Promise`); tidak dapat dicobai (ID: `keyterm:NotTempted`); kebenaran (ID: `keyterm:Truth`); A Person (ID: `person:GenericPerson`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** sia, sia (ID: `keyterm:Worthless`); suci (ID: `keyterm:Clean`); keahlian (ID: `keyterm:Ability`); tidak dicemarkan (ID: `keyterm:Undefiled`); tak bernoda (ID: `keyterm:AboveCriticism`); Tuhan (ID: `deity:Lord`); hati (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); tonton bulu atau muka (ID: `keyterm:Partiality`); Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); bimbang (ID: `keyterm:Discern`); kemuliaan (ID: `keyterm:Glory`); Seal (ID: `realia:Seal`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** janji (ID: `keyterm:Promise`); keahlian (ID: `keyterm:Ability`); orang pilihan (ID: `keyterm:Chosen`); kerajaan (ID: `keyterm:Kingdom`); kasihi (ID: `keyterm:Love`); percaya (ID: `keyterm:Believe`); kekasih (ID: `keyterm:Beloved`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); tonton bulu atau muka (ID: `keyterm:Partiality`); penghakiman (ID: `keyterm:Judgment`); tersandung (ID: `keyterm:Stumble`); belas kasihan (ID: `keyterm:Mercy`); berbuat dosa (ID: `keyterm:Sin`); pengadilan (ID: `keyterm:CourtCase`); persundalan (ID: `keyterm:Fornication`); kasihi (ID: `keyterm:Love`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`); kitab suci (ID: `keyterm:Scripture`); memutuskan (ID: `keyterm:Decided`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); A Person (ID: `person:GenericPerson`); Abraham (ID: `person:Abraham`); Tuhan (ID: `deity:Lord`); tubuh (ID: `keyterm:Body.3`); sia, sia (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); menggenapi (ID: `keyterm:Happen`); Demons (ID: `deity:Demons`); memperdamaikan (ID: `keyterm:Peace`); hampa (ID: `keyterm:Empty`); roh (ID: `keyterm:Spirit.2`); An Angel (ID: `deity:Angel`); keselamatan (ID: `keyterm:Salvation`); kitab suci (ID: `keyterm:Scripture`); Ishak (ID: `person:Isaac`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); Demons (ID: `deity:Demons`); Tuhan (ID: `deity:Lord`); A Person (ID: `person:GenericPerson`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); sia, sia (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); menggenapi (ID: `keyterm:Happen`); roh (ID: `keyterm:Spirit.2`); hampa (ID: `keyterm:Empty`); An Angel (ID: `deity:Angel`); kitab suci (ID: `keyterm:Scripture`); Tuhan (ID: `deity:Lord`); Ishak (ID: `person:Isaac`); tubuh (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** menggenapi (ID: `keyterm:Happen`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); percaya (ID: `keyterm:Believe`); Abraham (ID: `person:Abraham`); kitab suci (ID: `keyterm:Scripture`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** roh (ID: `keyterm:Spirit.2`); tubuh (ID: `keyterm:Body.3`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** keahlian (ID: `keyterm:Ability`); neraka (ID: `keyterm:Gehenna`); lalim (ID: `keyterm:UnjustDeed`); Hell (ID: `place:Hell`); tubuh (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** kebenaran (ID: `keyterm:Truth`); hati (ID: `keyterm:Heart`); iri hati (ID: `keyterm:Resentment`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); persahabatan (ID: `keyterm:Friendship`); tidak setia (ID: `keyterm:Unfaithful`); keahlian (ID: `keyterm:Ability`); roh (ID: `keyterm:Spirit.2`); kebaikan (ID: `keyterm:Favor`); Roh (ID: `deity:HolySpirit`); murni (ID: `keyterm:Pure`); membersihkan (ID: `keyterm:Cleanse.2`); ingin (ID: `keyterm:LongFor`); kitab suci (ID: `keyterm:Scripture`); hati (ID: `keyterm:Heart`); Cause of Joy (ID: `keyterm:CauseOfJoy`)
...
* **Associated ACAI Concepts:** ingin (ID: `keyterm:LongFor`); Roh (ID: `deity:HolySpirit`); roh (ID: `keyterm:Spirit.2`); kitab suci (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** murni (ID: `keyterm:Pure`); Tuhan (ID: `deity:Lord`); hati (ID: `keyterm:Heart`); membersihkan (ID: `keyterm:Cleanse.2`)
...
* **Associated ACAI Concepts:** menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); bersaksi (ID: `keyterm:BearWitness`); menentang (ID: `keyterm:Condemn`); Tuhan (ID: `deity:Lord`); hati (ID: `keyterm:Heart`); tubuh (ID: `keyterm:Body.3`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Ayub (ID: `person:Job`); penyayang (ID: `keyterm:Compassionate`); penuh belas kasihan (ID: `keyterm:FullOfCompassion`); menyebut berbahagia (ID: `keyterm:RegardAsHappy`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** jemaat (ID: `keyterm:Church`); nama (ID: `keyterm:Name`); diurapi (ID: `keyterm:Anointed`); Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** berbuat dosa (ID: `keyterm:Sin`); mengampuni (ID: `keyterm:Forgive`); percaya (ID: `keyterm:Believe`); keselamatan (ID: `keyterm:Salvation`); Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`)
