...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); lot (ID: `keyterm:Lot`); Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); José (ID: `person:Joseph.10`); Edom (ID: `place:Edom`); dispossess (ID: `keyterm:Dispossess`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** José (ID: `person:Joseph.10`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** dispossess (ID: `keyterm:Dispossess`); Neguebe (ID: `place:Negeb`); Sefalá (ID: `place:Shephelah`); Benjamim (ID: `group:Benjamin`); Jerusalém (ID: `place:Jerusalem`); Filisteu (ID: `group:Philistine`); Samaria (ID: `place:Samaria`); Israel (ID: `person:Israel`); cananeu (ID: `group:Canaan`); Benjamim (ID: `person:Benjamin`); Filístia (ID: `place:Philistine`); Sardes (ID: `place:Sardis`); Sarepta (ID: `place:Zarephath`); Gileade (ID: `place:Gilead`); Canaã (ID: `place:Canaan`); Efraim (ID: `group:Ephraim`); Monte de Esaú (ID: `place:EsauMount`); Efraim (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`); Neguebe (ID: `place:Negeb`); Monte de Esaú (ID: `place:EsauMount`); Benjamim (ID: `group:Benjamin`); Filisteu (ID: `group:Philistine`); Israel (ID: `person:Israel`); Samaria (ID: `place:Samaria`); Sefalá (ID: `place:Shephelah`); Gileade (ID: `place:Gilead`); Canaã (ID: `place:Canaan`); Efraim (ID: `person:Ephraim`); SENHOR (ID: `deity:Lord`); cananeu (ID: `group:Canaan`); Benjamim (ID: `person:Benjamin`); Sardes (ID: `place:Sardis`); Sarepta (ID: `place:Zarephath`); Efraim (ID: `group:Ephraim`); Filístia (ID: `place:Philistine`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); cananeu (ID: `group:Canaan`); Sardes (ID: `place:Sardis`); Sarepta (ID: `place:Zarephath`); dispossess (ID: `keyterm:Dispossess`); Canaã (ID: `place:Canaan`); Neguebe (ID: `place:Negeb`)
