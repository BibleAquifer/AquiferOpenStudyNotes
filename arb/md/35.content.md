...
* **Associated ACAI Concepts:** Strength (ID: `keyterm:Strength`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Believe In (ID: `keyterm:BelieveIn`); Dispossess (ID: `keyterm:Dispossess`); Vulture (ID: `fauna:Vulture`); Horse (ID: `fauna:Horse`); Leopard (ID: `fauna:Leopard`); Wolf (ID: `fauna:Wolf`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); ٱلرَّبِّ (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); Idol (ID: `keyterm:Idol`); Proverb (ID: `keyterm:Saying`); Hell (ID: `place:Hell`); Trust (ID: `keyterm:LeanOn`); لبْنَانَ (ID: `place:Lebanon`); Be Disgraced (ID: `keyterm:Disgraced`); Image (ID: `realia:Image`); Graven Image (ID: `realia:GravenImage`); Tablet (ID: `realia:Tablet`); Vine (ID: `flora:Vine`); Beam (ID: `realia:Beam`); Wine (ID: `realia:Wine`); Money (ID: `realia:Money`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); ٱلرَّبِّ (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); Idol (ID: `keyterm:Idol`); Proverb (ID: `keyterm:Saying`); Trust (ID: `keyterm:LeanOn`); لبْنَانَ (ID: `place:Lebanon`); Be Disgraced (ID: `keyterm:Disgraced`); Image (ID: `realia:Image`); Graven Image (ID: `realia:GravenImage`); Beam (ID: `realia:Beam`); Money (ID: `realia:Money`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated ACAI Concepts:** Idol (ID: `keyterm:Idol`); Woe (ID: `keyterm:Woe.2`); Trust (ID: `keyterm:LeanOn`); ٱلرَّبِّ (ID: `deity:Lord`); Image (ID: `realia:Image`); Graven Image (ID: `realia:GravenImage`); Money (ID: `realia:Money`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated ACAI Concepts:** Salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); كوشَانَ (ID: `place:Cushan`); تَيْمَانَ (ID: `place:Teman`); فَارَانَ (ID: `place:ParanMount`); Holy (ID: `keyterm:Holy`); Anointed (ID: `keyterm:Anointed`); مِدْيَانَ (ID: `place:Midian`); Oath (ID: `keyterm:Oath`); Mischief (ID: `keyterm:Mischief`); ٱلرَّبِّ (ID: `deity:Lord`); Majesty (ID: `keyterm:Majesty`); Arrow (ID: `keyterm:Arrow`); Foundation (ID: `realia:Foundation`); Chariot (ID: `realia:Chariot`); Bow (ID: `realia:Bow`); Tent (ID: `realia:Tent`); Spear (ID: `realia:Spear`)
...
* **Associated ACAI Concepts:** Salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); Oath (ID: `keyterm:Oath`); Anointed (ID: `keyterm:Anointed`); ٱلرَّبِّ (ID: `deity:Lord`); Arrow (ID: `keyterm:Arrow`); Foundation (ID: `realia:Foundation`); Bow (ID: `realia:Bow`); Spear (ID: `realia:Spear`); Chariot (ID: `realia:Chariot`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); Salvation (ID: `keyterm:Salvation`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Sheepfold (ID: `realia:Sheepfold`); Fig (ID: `flora:Fig`); Vine (ID: `flora:Vine`); Cattle (ID: `fauna:Bull`); Olive Tree (ID: `flora:OliveTree`); Animal Pen (ID: `realia:AnimalPen`)
