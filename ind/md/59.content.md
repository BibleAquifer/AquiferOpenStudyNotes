...
* **Associated ACAI Concepts:** berbahagialah (ID: `keyterm:Happy`); tahan uji (ID: `keyterm:Approved`); kasihi (ID: `keyterm:Love`); janji (ID: `keyterm:Promise`); kehidupan (ID: `keyterm:Life`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); berbahagialah (ID: `keyterm:Happy`); mencobai (ID: `keyterm:PutToTheTest`); kekasih (ID: `keyterm:Beloved`); suci (ID: `keyterm:Clean`); tahan uji (ID: `keyterm:Approved`); sia, sia (ID: `keyterm:Worthless`); berbuat dosa (ID: `keyterm:Sin`); hati (ID: `keyterm:Heart`); tidak dicemarkan (ID: `keyterm:Undefiled`); kebenaran (ID: `keyterm:Truth`); keahlian (ID: `keyterm:Ability`); A Person (ID: `person:GenericPerson`); keselamatan (ID: `keyterm:Salvation`); kasihi (ID: `keyterm:Love`); janji (ID: `keyterm:Promise`); hukum (ID: `keyterm:Law`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); tak bernoda (ID: `keyterm:AboveCriticism`); kehidupan (ID: `keyterm:Life`); yang baik (ID: `keyterm:Good`); tidak dapat dicobai (ID: `keyterm:NotTempted`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** suci (ID: `keyterm:Clean`); sia, sia (ID: `keyterm:Worthless`); tak bernoda (ID: `keyterm:AboveCriticism`); hati (ID: `keyterm:Heart`); tidak dicemarkan (ID: `keyterm:Undefiled`); Tuhan (ID: `deity:Lord`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); tonton bulu atau muka (ID: `keyterm:Partiality`); percaya (ID: `keyterm:Believe`); Yesus (ID: `person:Jesus.2`); bimbang (ID: `keyterm:Discern`); kemuliaan (ID: `keyterm:Glory`); Seal (ID: `realia:Seal`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** kerajaan (ID: `keyterm:Kingdom`); kasihi (ID: `keyterm:Love`); janji (ID: `keyterm:Promise`); orang pilihan (ID: `keyterm:Chosen`); kekasih (ID: `keyterm:Beloved`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); penghakiman (ID: `keyterm:Judgment`); tonton bulu atau muka (ID: `keyterm:Partiality`); tersandung (ID: `keyterm:Stumble`); kasihi (ID: `keyterm:Love`); berbuat dosa (ID: `keyterm:Sin`); kitab suci (ID: `keyterm:Scripture`); persundalan (ID: `keyterm:Fornication`); pengadilan (ID: `keyterm:CourtCase`); belas kasihan (ID: `keyterm:Mercy`); memutuskan (ID: `keyterm:Decided`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); A Person (ID: `person:GenericPerson`); Tuhan (ID: `deity:Lord`); tubuh (ID: `keyterm:Body.3`); sia, sia (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); menggenapi (ID: `keyterm:Happen`); roh (ID: `keyterm:Spirit.2`); An Angel (ID: `deity:Angel`); keselamatan (ID: `keyterm:Salvation`); Ishak (ID: `person:Isaac`); hampa (ID: `keyterm:Empty`); Demons (ID: `deity:Demons`); kitab suci (ID: `keyterm:Scripture`); memperdamaikan (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); sia, sia (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); menggenapi (ID: `keyterm:Happen`); roh (ID: `keyterm:Spirit.2`); An Angel (ID: `deity:Angel`); Ishak (ID: `person:Isaac`); hampa (ID: `keyterm:Empty`); Tuhan (ID: `deity:Lord`); kitab suci (ID: `keyterm:Scripture`); tubuh (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** menggenapi (ID: `keyterm:Happen`); Abraham (ID: `person:Abraham`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kitab suci (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** lalim (ID: `keyterm:UnjustDeed`); neraka (ID: `keyterm:Gehenna`); tubuh (ID: `keyterm:Body.3`); Hell (ID: `place:Hell`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); persahabatan (ID: `keyterm:Friendship`); tidak setia (ID: `keyterm:Unfaithful`); ingin (ID: `keyterm:LongFor`); roh (ID: `keyterm:Spirit.2`); kebaikan (ID: `keyterm:Favor`); Cause of Joy (ID: `keyterm:CauseOfJoy`); murni (ID: `keyterm:Pure`); hati (ID: `keyterm:Heart`); membersihkan (ID: `keyterm:Cleanse.2`); Roh (ID: `deity:HolySpirit`); kitab suci (ID: `keyterm:Scripture`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** membersihkan (ID: `keyterm:Cleanse.2`); Tuhan (ID: `deity:Lord`); murni (ID: `keyterm:Pure`); hati (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** hati (ID: `keyterm:Heart`); menentang (ID: `keyterm:Condemn`); Tuhan (ID: `deity:Lord`); bersaksi (ID: `keyterm:BearWitness`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); tubuh (ID: `keyterm:Body.3`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** nama (ID: `keyterm:Name`); jemaat (ID: `keyterm:Church`); diurapi (ID: `keyterm:Anointed`); Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** berbuat dosa (ID: `keyterm:Sin`); keselamatan (ID: `keyterm:Salvation`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`); mengampuni (ID: `keyterm:Forgive`)
