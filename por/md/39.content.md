...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Edomites (ID: `group:Edom`); SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`); Israel (ID: `person:Israel`); love (ID: `keyterm:Love`); to cause to possess (ID: `keyterm:Possess`); Jackal (ID: `fauna:Jackal`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`); offering (ID: `keyterm:Offering`); fear (ID: `keyterm:Fear`); Levi (ID: `group:Levi`); Glory (ID: `keyterm:Glory`); peace (ID: `keyterm:IntactState`); Levi (ID: `person:Levi.3`); Priests (ID: `group:GenericPriests`); utter a curse (ID: `keyterm:Curse`); stain (ID: `keyterm:Stain`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); fairness (ID: `keyterm:Fairness`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); pure (ID: `keyterm:Pure`); make a vow (ID: `keyterm:Vow`); Truth (ID: `keyterm:Truth`); be kindly disposed (ID: `keyterm:KindlyDisposed`); evil intention (ID: `keyterm:Intention`); Gentiles (ID: `group:Gentile`); profane, dishonor (ID: `keyterm:Dishonor`); bless (ID: `keyterm:Bless`); rogar (ID: `keyterm:AskFor`); ardour (ID: `keyterm:Ardour`); The Way (ID: `keyterm:TheWay`); An Angel (ID: `deity:Angel`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** stain (ID: `keyterm:Stain`); SENHOR (ID: `deity:Lord`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** fear (ID: `keyterm:Fear`); SENHOR (ID: `deity:Lord`); utter a curse (ID: `keyterm:Curse`); make a vow (ID: `keyterm:Vow`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Covenant (ID: `keyterm:Covenant`); offering (ID: `keyterm:Offering`); profane, dishonor (ID: `keyterm:Dishonor`); love (ID: `keyterm:Love`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); delight (ID: `keyterm:Delight`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); profane, dishonor (ID: `keyterm:Dishonor`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); Levi (ID: `person:Levi.3`); An Angel (ID: `deity:Angel`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); pure (ID: `keyterm:Pure`); fear (ID: `keyterm:Fear`); Judá (ID: `person:Judah.4`); swear (ID: `keyterm:Swear`); A Group of People (ID: `group:GenericGroup`); Levi (ID: `group:Levi`); Soap (ID: `realia:Soap`); Hammada (ID: `flora:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); decree (ID: `keyterm:Decree`); offering (ID: `keyterm:Offering`); bless (ID: `keyterm:Bless`); utter a curse (ID: `keyterm:Curse`); Israel (ID: `person:Israel`); Vine (ID: `flora:Vine`); Sorghum (ID: `flora:Sorghum`); Wheat (ID: `flora:Wheat`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** decree (ID: `keyterm:Decree`); Moisés (ID: `person:Moses`); Monte Sinai (ID: `place:SinaiMount`); Instruction (ID: `keyterm:Instruction`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** decree (ID: `keyterm:Decree`); Moisés (ID: `person:Moses`); Monte Sinai (ID: `place:SinaiMount`); fear (ID: `keyterm:Fear`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Elias (ID: `person:Elijah`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`); fear (ID: `keyterm:Fear`); Elias (ID: `person:Elijah`)
