...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Judas (ID: `person:Jude`); Jesus (ID: `person:Jesus.2`); Tiago (ID: `person:James.3`); misericórdia (ID: `keyterm:Mercy`); SENHOR (ID: `deity:Lord`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); empenho (ID: `keyterm:Eagerness`); juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); rogar (ID: `keyterm:AskFor`); comum (ID: `keyterm:InCommon`); favor (ID: `keyterm:Favor`); amado (ID: `keyterm:Beloved`); crer (ID: `keyterm:Believe`); holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** tribunal de justiça (ID: `keyterm:CourtCase`); juízo (ID: `keyterm:Judgment`); corpo (ID: `keyterm:Body.3`); para a eternidade (ID: `keyterm:Always`); blasfemar (ID: `keyterm:Blaspheme`); SENHOR (ID: `deity:Lord`); Corá (ID: `person:Korah.3`); Moisés (ID: `person:Moses`); Caim (ID: `person:Cain`); An Angel (ID: `deity:Angel`); ágape (ID: `keyterm:FellowshipMeal`); Miguel (ID: `person:Michael.11`); Egito (ID: `place:Egypt`); Enoque (ID: `person:Enoch.2`); defilement (ID: `keyterm:Defilement`); fogo eterno (ID: `keyterm:EternalFire`); crer (ID: `keyterm:Believe`); Gomorra (ID: `place:Gomorrah`); Adão (ID: `person:Adam`); Sodoma (ID: `place:Sodom`); distinguir (ID: `keyterm:Discern`); salvation (ID: `keyterm:Salvation`); To Command (ID: `keyterm:Command`); Disaster (ID: `keyterm:Disaster`); holy (ID: `keyterm:Holy`); Jesus (ID: `person:Jesus.2`); Balaão (ID: `person:Balaam`); speak (ID: `keyterm:Speak`); Ability (ID: `keyterm:Ability`); Goat (ID: `fauna:Goat`); Chain (ID: `realia:Chain`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Gomorra (ID: `place:Gomorrah`); Sodoma (ID: `place:Sodom`); fogo eterno (ID: `keyterm:EternalFire`); para a eternidade (ID: `keyterm:Always`); corpo (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** Moisés (ID: `person:Moses`); distinguir (ID: `keyterm:Discern`); Miguel (ID: `person:Michael.11`); juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`); To Command (ID: `keyterm:Command`); tribunal de justiça (ID: `keyterm:CourtCase`); corpo (ID: `keyterm:Body.3`); blasfemar (ID: `keyterm:Blaspheme`)
...
* **Associated ACAI Concepts:** Adão (ID: `person:Adam`); speak (ID: `keyterm:Speak`); juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`); Enoque (ID: `person:Enoch.2`); tribunal de justiça (ID: `keyterm:CourtCase`); holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** misericórdia (ID: `keyterm:Mercy`); amado (ID: `keyterm:Beloved`); Holy Spirit (ID: `deity:HolySpirit`); Jesus (ID: `person:Jesus.2`); fear (ID: `keyterm:Fear`); Life (ID: `keyterm:Life`); natural (ID: `keyterm:Natural`); crer (ID: `keyterm:Believe`); orar (ID: `keyterm:Pray`); distinguir (ID: `keyterm:Discern`); SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); palavra (ID: `keyterm:Word`); love (ID: `keyterm:Love`); corpo (ID: `keyterm:Body.3`); holy (ID: `keyterm:Holy`); para a eternidade (ID: `keyterm:Always`); causar divisões (ID: `keyterm:CreatingDivisions`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); Holy Spirit (ID: `deity:HolySpirit`); amado (ID: `keyterm:Beloved`); crer (ID: `keyterm:Believe`); holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** misericórdia (ID: `keyterm:Mercy`); distinguir (ID: `keyterm:Discern`); fear (ID: `keyterm:Fear`); salvation (ID: `keyterm:Salvation`); corpo (ID: `keyterm:Body.3`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); Jesus (ID: `person:Jesus.2`); irrepreensível (ID: `keyterm:Unblemished`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); autoridade (ID: `keyterm:Authority.2`); para a eternidade (ID: `keyterm:Always`); surely! (ID: `keyterm:Surely`); salvador (ID: `keyterm:Savior`)
