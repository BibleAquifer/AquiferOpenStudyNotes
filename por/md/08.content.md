...
* **Associated ACAI Concepts:** Efrata (ID: `person:Ephrathah`); Quiliom (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Ephrathites (ID: `group:Ephrathah`); Moabe (ID: `place:Moab`); Malom (ID: `person:Mahlon`); Judá (ID: `person:Judah.4`); Belém (ID: `place:Bethlehem`); Elimeleque (ID: `person:Elimelech`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Noemi (ID: `person:Naomi`); SENHOR (ID: `deity:Lord`); kindness (ID: `keyterm:Kindness`); bless (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Raquel (ID: `person:Rachel`); SENHOR (ID: `deity:Lord`); Lia (ID: `person:Leah`); Belém (ID: `place:Bethlehem`); Elders (ID: `group:GenericElders`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Perez (ID: `person:Perez`); Tamar (ID: `person:Tamar`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Hezrom (ID: `person:Hezron.2`); Salmom (ID: `person:Salmon`); Obede (ID: `person:Obed`); Aminadabe (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Jessé (ID: `person:Jesse`); Davi (ID: `person:David`); Naassom (ID: `person:Nahshon`); Perez (ID: `person:Perez`); Boaz (ID: `person:Boaz`)
