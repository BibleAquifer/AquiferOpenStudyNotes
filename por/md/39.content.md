...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); fear (ID: `keyterm:Fear`); Glory (ID: `keyterm:Glory`); Priests (ID: `group:GenericPriests`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); fear (ID: `keyterm:Fear`); Covenant (ID: `keyterm:Covenant`); offering (ID: `keyterm:Offering`); peace (ID: `keyterm:IntactState`); utter a curse (ID: `keyterm:Curse`); Levi (ID: `person:Levi.3`); stain (ID: `keyterm:Stain`); Levi (ID: `group:Levi`); Glory (ID: `keyterm:Glory`); Priests (ID: `group:GenericPriests`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); fairness (ID: `keyterm:Fairness`); ardour (ID: `keyterm:Ardour`); evil intention (ID: `keyterm:Intention`); The Way (ID: `keyterm:TheWay`); profane, dishonor (ID: `keyterm:Dishonor`); An Angel (ID: `deity:Angel`); be kindly disposed (ID: `keyterm:KindlyDisposed`); make a vow (ID: `keyterm:Vow`); Gentiles (ID: `group:Gentile`); rogar (ID: `keyterm:AskFor`); pure (ID: `keyterm:Pure`); bless (ID: `keyterm:Bless`); Truth (ID: `keyterm:Truth`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** make a vow (ID: `keyterm:Vow`); fear (ID: `keyterm:Fear`); utter a curse (ID: `keyterm:Curse`); SENHOR (ID: `deity:Lord`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); profane, dishonor (ID: `keyterm:Dishonor`); love (ID: `keyterm:Love`); delight (ID: `keyterm:Delight`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); profane, dishonor (ID: `keyterm:Dishonor`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Levi (ID: `group:Levi`); fear (ID: `keyterm:Fear`); pure (ID: `keyterm:Pure`); Covenant (ID: `keyterm:Covenant`); An Angel (ID: `deity:Angel`); Judá (ID: `person:Judah.4`); Levi (ID: `person:Levi.3`); swear (ID: `keyterm:Swear`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); A Group of People (ID: `group:GenericGroup`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); bless (ID: `keyterm:Bless`); decree (ID: `keyterm:Decree`); offering (ID: `keyterm:Offering`); Israel (ID: `person:Israel`); utter a curse (ID: `keyterm:Curse`); Sorghum (ID: `flora:Sorghum`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); be enticed to serve (ID: `keyterm:EnticedToServe`); fear (ID: `keyterm:Fear`); Molten Image (ID: `realia:MoltenImage`); Animal Pen (ID: `realia:AnimalPen`); Cattle (ID: `fauna:Bull`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Moisés (ID: `person:Moses`); Instruction (ID: `keyterm:Instruction`); decree (ID: `keyterm:Decree`); Israel (ID: `person:Israel`); Monte Sinai (ID: `place:SinaiMount`)
...
* **Associated ACAI Concepts:** fear (ID: `keyterm:Fear`); Moisés (ID: `person:Moses`); decree (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`); Israel (ID: `person:Israel`); Elias (ID: `person:Elijah`); Monte Sinai (ID: `place:SinaiMount`); SENHOR (ID: `deity:Lord`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`)
...
* **Associated ACAI Concepts:** fear (ID: `keyterm:Fear`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`); Elias (ID: `person:Elijah`); SENHOR (ID: `deity:Lord`)
