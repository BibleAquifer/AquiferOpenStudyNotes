...
* **Associated ACAI Concepts:** Efratita (ID: `group:Ephrathah`); Chelión (ID: `person:Chilion`); Ephrata (ID: `person:Ephrathah`); Noemi (ID: `person:Naomi`); Elimelech (ID: `person:Elimelech`); Catah (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Mahalón (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Catah (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Noemi (ID: `person:Naomi`); Ruth (ID: `person:Ruth`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); Booz (ID: `person:Boaz`); dejar en herencia (ID: `keyterm:Possess`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Elders (ID: `group:GenericElders`); Catah (ID: `place:Bethlehem`); Jehová (ID: `deity:Lord`); Lea (ID: `person:Leah`); Rachêl (ID: `person:Rachel`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Phares (ID: `person:Perez`); Jehová (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Thamar (ID: `person:Tamar`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Jehová (ID: `deity:Lord`); Noemi (ID: `person:Naomi`); Israel (ID: `person:Israel`); bendecir (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Hesrón (ID: `person:Hezron.2`); Salmón (ID: `person:Salmon`); Obed (ID: `person:Obed`); Aminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); David (ID: `person:David`); Isaí (ID: `person:Jesse`); Nahasón (ID: `person:Nahshon`); Booz (ID: `person:Boaz`); Phares (ID: `person:Perez`)
