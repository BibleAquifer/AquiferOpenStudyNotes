...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Basã (ID: `place:Bashan`); Libano (ID: `place:Lebanon`); Carmelo (ID: `place:Carmel`); strength (ID: `keyterm:Strength`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Zealous (ID: `keyterm:Zealous.3`); The Way (ID: `keyterm:TheWay`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); SENHOR (ID: `deity:Lord`); Grass (ID: `flora:Grass`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Chariot (ID: `realia:Chariot`)
...
* **Associated ACAI Concepts:** being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Egito (ID: `place:Egypt`); Líbia (ID: `place:Libya`); Pute (ID: `place:Put`); lot (ID: `keyterm:Lot`); Cush (ID: `place:Cush.2`)
