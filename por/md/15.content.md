...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Pérsia (ID: `place:Persia`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Jeremias (ID: `person:Jeremiah.6`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Judá (ID: `group:Judah`); Benjamim (ID: `group:Benjamin`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Benjamim (ID: `person:Benjamin`); Judá (ID: `person:Judah.4`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Ciro (ID: `person:Cyrus`); Judá (ID: `group:Judah`); Zorobabel (ID: `person:Zerubbabel.2`); Pérsia (ID: `place:Persia`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Levi (ID: `group:Levi`); Salomão (ID: `person:Solomon`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `person:Levi.3`); Jesua (ID: `person:Jeshua.3`); Neemias (ID: `person:Nehemiah`); Rezim (ID: `person:Rezin.2`); Paate-Moabe (ID: `person:Pahath-moab`); Harim (ID: `person:Harim`); Salmai (ID: `person:Shalmai`); Paseia (ID: `person:Paseah.2`); Gidel (ID: `person:Giddel`); Harsa (ID: `person:Harsha`); Tel-Harsa (ID: `place:Tel-harsha`); Magbis (ID: `place:Magbish`); Senaa (ID: `place:Senaah`); Meída (ID: `person:Mehida`); Hatifa (ID: `person:Hatipha`); Padom (ID: `person:Padon`); Reum (ID: `person:Rehum`); Gazão (ID: `person:Gazzam`); Zia (ID: `person:Ziha`); Bebai (ID: `person:Bebai`); Hadide (ID: `place:Hadid`); Harur (ID: `person:Harhur`); Hacufa (ID: `person:Hakupha`); Jora (ID: `person:Jorah`); Tobias (ID: `person:Tobiah`)
...
* **Associated ACAI Concepts:** Bigvai (ID: `person:Bigvai`); Neemias (ID: `person:Nehemiah`); Seraias (ID: `person:Seraiah.6`); Reelaías (ID: `person:Reelaiah`); Baana (ID: `person:Baanah.3`); Mispar (ID: `person:Mispar`); Reum (ID: `person:Rehum`); Bilsã (ID: `person:Bilshan`); Mordecai (ID: `person:Mordecai`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Jesua (ID: `person:Jeshua.3`); Parós (ID: `person:Parosh`); Paate-Moabe (ID: `person:Pahath-moab`); Adim (ID: `person:Adin`); Elam (ID: `person:Elam`); Bani (ID: `person:Bani`); Hasum (ID: `person:Hashum`); Joabe (ID: `person:Joab.3`); Ará (ID: `person:Arah.2`); Zatu (ID: `person:Zattu.2`); Zacai (ID: `person:Zaccai.2`); Bebai (ID: `person:Bebai`); Ater (ID: `person:Ater`); Bigvai (ID: `person:Bigvai.2`); Asgade (ID: `person:Azgad`); Jora (ID: `person:Jorah`); Ezequias (ID: `person:Hezekiah.2`); Adonicão (ID: `person:Adonikam`); Bezai (ID: `person:Bezai`); Sephatias (ID: `person:Shephatiah.6`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Beth-azmaveth (ID: `place:Beth-azmaveth`); Magbis (ID: `place:Magbish`); Senaa (ID: `place:Senaah`); Hadide (ID: `place:Hadid`); Netofa (ID: `place:Netophah`); Nebo (ID: `place:Nebo.2`); Harim (ID: `person:Harim.2`); Quiriate-Jearim (ID: `place:Kiriath-jearim`); Betel (ID: `place:Bethel`); Elam (ID: `person:Elam`); Geba (ID: `place:Geba`); Cefira (ID: `place:Chephirah`); Lode (ID: `place:Lod`); Ai (ID: `place:Ai`); Micmás (ID: `place:Michmash`); Anatote (ID: `place:Anathoth`); Jericó (ID: `place:Jericho`); Belém (ID: `place:Bethlehem`); Ono (ID: `place:Ono`); Beerote (ID: `place:Beeroth`); Ramah (ID: `place:Ramah.2`)
...
* **Associated ACAI Concepts:** Imer (ID: `person:Immer.2`); Talmom (ID: `person:Talmon`); Ater (ID: `person:Ater.2`); Jedaías (ID: `person:Jedaiah.4`); Jesua (ID: `person:Jeshua.4`); Harim (ID: `person:Harim`); Hatita (ID: `person:Hatita`); Sobai (ID: `person:Shobai`); Jesua (ID: `person:Jeshua`); Hodavias (ID: `person:Hodaviah.4`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Salum (ID: `person:Shallum.8`); Cadmiel (ID: `person:Kadmiel`); Pasur (ID: `person:Pashhur`); Acube (ID: `person:Akkub.2`); Asafe (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** Talmom (ID: `person:Talmon`); Ater (ID: `person:Ater.2`); Sobai (ID: `person:Shobai`); Hatita (ID: `person:Hatita`); Acube (ID: `person:Akkub.2`); Asafe (ID: `person:Asaph.2`); Salum (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** Rezim (ID: `person:Rezin.2`); Reaías (ID: `person:Reaiah.3`); Bazlite (ID: `person:Bazluth`); Salmai (ID: `person:Shalmai`); Paseia (ID: `person:Paseah.2`); Gidel (ID: `person:Giddel`); Harsa (ID: `person:Harsha`); Besai (ID: `person:Besai`); Hatifa (ID: `person:Hatipha`); Meída (ID: `person:Mehida`); Asná (ID: `person:Asnah`); Padom (ID: `person:Padon`); Acube (ID: `person:Akkub.3`); Tabaote (ID: `person:Tabbaoth`); Zia (ID: `person:Ziha`); Gazão (ID: `person:Gazzam`); Hanã (ID: `person:Hanan.4`); Hagaba (ID: `person:Hagabah`); Lebana (ID: `person:Lebanah`); Baquebuque (ID: `person:Bakbuk`); Harur (ID: `person:Harhur`); Temá (ID: `person:Temah`); Hacufa (ID: `person:Hakupha`); Hagabe (ID: `person:Hagab`); Sisera (ID: `person:Sisera.2`); Meunim (ID: `group:Meunim`); Sia (ID: `person:Siaha`); Barcos (ID: `person:Barkos`); Queros (ID: `person:Keros`); Hasufa (ID: `person:Hasupha`); Nesias (ID: `person:Neziah`); Nephushesim (ID: `group:Nephushesim`); Uza (ID: `person:Uzza.2`); Necoda (ID: `person:Nekoda`); Gaar (ID: `person:Gahar`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Jaala (ID: `person:Jaalah`); Peruda (ID: `person:Peruda`); Gidel (ID: `person:Giddel.2`); Hatil (ID: `person:Hattil`); Sephatias (ID: `person:Shephatiah.7`); Darcom (ID: `person:Darkon`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Sotai (ID: `person:Sotai`); Soferete (ID: `person:Sophereth`); Ami (ID: `person:Ami`)
...
* **Associated ACAI Concepts:** Delaías (ID: `person:Delaiah.3`); Imer (ID: `place:Immer`); Querube (ID: `place:Cherub`); Adã (ID: `place:Addan`); Tobias (ID: `person:Tobiah`); Necoda (ID: `person:Nekoda.2`); Tel-Melá (ID: `place:Tel-melah`); Tel-Harsa (ID: `place:Tel-harsha`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Habaiah (ID: `person:Habaiah`); Hacoz (ID: `person:Hakkoz.2`); Barzillai (ID: `person:Barzillai.3`); Gileadites (ID: `group:Gilead`); Barzillai (ID: `person:Barzillai`); priesthood (ID: `keyterm:Priesthood`); stain (ID: `keyterm:Stain`); Gileade (ID: `place:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); strength (ID: `keyterm:Strength`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Mina (ID: `realia:Mina`); Tunic (ID: `realia:Tunic`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Josué (ID: `person:Joshua.5`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Sealtiel (ID: `person:Shealtiel.2`); Jeozadaque (ID: `person:Jehozadak`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Esar-Hadom (ID: `person:Esarhaddon`); Henadade (ID: `person:Henadad`); Jesua (ID: `person:Jeshua.4`); Cadmiel (ID: `person:Kadmiel`); Relatives (ID: `group:Relatives`); Hodavias (ID: `person:Hodaviah.4`); Sidonians (ID: `group:Sidon`); Sidom (ID: `place:Sidon`); Libano (ID: `place:Lebanon`); Davi (ID: `person:David`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); new moon festival (ID: `keyterm:NewMoonFestival`); kindness (ID: `keyterm:Kindness`); terror (ID: `keyterm:Terror`); holy (ID: `keyterm:Holy`); Benjamim (ID: `group:Benjamin`); Dario (ID: `person:Darius.2`); appointed feast (ID: `keyterm:AppointedFeast`); Benjamim (ID: `person:Benjamin`); Tyrians (ID: `group:Tyre`); Moisés (ID: `person:Moses`); Tiro (ID: `place:Tyre`); Assyria (ID: `place:Assyria`); Instruction (ID: `keyterm:Instruction`); Jope (ID: `place:Joppa`); Asafe (ID: `person:Asaph.2`); counsel (ID: `keyterm:Counsel`); Hodias (ID: `person:Hodiah.2`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Cedar (ID: `flora:Cedar`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Instruction (ID: `keyterm:Instruction`); SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Moisés (ID: `person:Moses`); Israel (ID: `person:Israel`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** terror (ID: `keyterm:Terror`); SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Sidonians (ID: `group:Sidon`); Sidom (ID: `place:Sidon`); Tiro (ID: `place:Tyre`); Libano (ID: `place:Lebanon`); Jope (ID: `place:Joppa`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Tyrians (ID: `group:Tyre`); Craftsman (ID: `realia:Craftsman`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Cedar (ID: `flora:Cedar`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Jeozadaque (ID: `person:Jehozadak`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Davi (ID: `person:David`); Asafe (ID: `person:Asaph.2`); kindness (ID: `keyterm:Kindness`); Trumpet (ID: `realia:Trumpet`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Benjamim (ID: `group:Benjamin`); SENHOR (ID: `deity:Lord`); Benjamim (ID: `person:Benjamin`); Judá (ID: `person:Judah.4`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Josué (ID: `person:Joshua.5`); Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Pérsia (ID: `place:Persia`); Israel (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Pérsia (ID: `place:Persia`); Dario (ID: `person:Darius.2`); counsel (ID: `keyterm:Counsel`); Ciro (ID: `person:Cyrus`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Rio Eufrates (ID: `place:Euphrates`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Pérsia (ID: `place:Persia`); Samaria (ID: `place:Samaria`); Jews (ID: `group:Jews`); Assuero (ID: `person:Ahasuerus`); Ereque (ID: `place:Erech`); Mitredate (ID: `person:Mithredath.2`); Tabeel (ID: `person:Tabeel`); Dinaítas (ID: `person:Dinaite`); Osnapar (ID: `person:Osnappar`); Bislão (ID: `person:Bishlam`); Babylonians (ID: `group:Babylon`); Babilônia (ID: `place:Babylon`); Judá (ID: `group:Judah`); Susã (ID: `place:Susa`); Elam (ID: `place:Elam`); Persians (ID: `group:Persia`); Elamites (ID: `group:Elam`); Judá (ID: `person:Judah.4`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Ereque (ID: `place:Erech`); Reum (ID: `person:Rehum.2`); Dinaítas (ID: `person:Dinaite`); Sinsai (ID: `person:Shimshai`); Babylonians (ID: `group:Babylon`); Elam (ID: `place:Elam`); Persians (ID: `group:Persia`); Elamites (ID: `group:Elam`); Babilônia (ID: `place:Babylon`); Pérsia (ID: `place:Persia`); Susã (ID: `place:Susa`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Reum (ID: `person:Rehum.2`); Artaxerxes (ID: `person:Artaxerxes.2`); Samaria (ID: `place:Samaria`); Sinsai (ID: `person:Shimshai`); Jews (ID: `group:Jews`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Dario (ID: `person:Darius.2`); Jews (ID: `group:Jews`); Tattenai (ID: `person:Tattenai`); Ido (ID: `person:Iddo.6`); Ageu (ID: `person:Haggai`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Zacarias (ID: `person:Zechariah.17`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); Rio Eufrates (ID: `place:Euphrates`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Pérsia (ID: `place:Persia`); Judá (ID: `person:Judah.4`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Ido (ID: `person:Iddo.6`); Zacarias (ID: `person:Zechariah.17`); Ageu (ID: `person:Haggai`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Jews (ID: `group:Jews`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); Jeozadaque (ID: `person:Jehozadak`); Jerusalém (ID: `place:Jerusalem`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Babilônia (ID: `place:Babylon`); Jerusalém (ID: `place:Jerusalem`); Ciro (ID: `person:Cyrus`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Dario (ID: `person:Darius.2`); Zorobabel (ID: `person:Zerubbabel.2`); Tattenai (ID: `person:Tattenai`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Caldéia (ID: `place:Chaldea`); Rio Eufrates (ID: `place:Euphrates`); Judá (ID: `person:Judah.4`); Chaldeans (ID: `group:Chaldea`); Israel (ID: `person:Israel`); Foundation (ID: `realia:Foundation`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** Caldéia (ID: `place:Chaldea`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Babilônia (ID: `place:Babylon`); Chaldeans (ID: `group:Chaldea`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Ciro (ID: `person:Cyrus`); Babilônia (ID: `place:Babylon`); Zorobabel (ID: `person:Zerubbabel.2`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Assyria (ID: `place:Assyria`); Israel (ID: `person:Israel`); Unleavened Bread (ID: `realia:UnleavenedBread`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Azarias (ID: `person:Azariah.7`); Ezra (ID: `person:Ezra`); Seraias (ID: `person:Seraiah.2`); Artaxerxes (ID: `person:Artaxerxes`); Pérsia (ID: `place:Persia`); Hilquias (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Meraiote (ID: `person:Meraioth`); Salum (ID: `person:Shallum.7`); Azarias (ID: `person:Azariah.6`); Amarias (ID: `person:Amariah.2`); Buqui (ID: `person:Bukki.2`); Zadoque (ID: `person:Zadok.4`); Zeraías (ID: `person:Zerahiah`); Uzi (ID: `person:Uzzi`); Seraias (ID: `person:Seraiah.2`); Abisua (ID: `person:Abishua`); Aitube (ID: `person:Ahitub.3`); Azarias (ID: `person:Azariah.7`); Arão (ID: `person:Aaron`); Fineias (ID: `person:Phinehas`); Artaxerxes (ID: `person:Artaxerxes`); Pérsia (ID: `place:Persia`); Hilquias (ID: `person:Hilkiah.2`); Eleazar (ID: `person:Eleazar.2`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Instruction (ID: `keyterm:Instruction`); Babilônia (ID: `place:Babylon`); SENHOR (ID: `deity:Lord`); Moisés (ID: `person:Moses`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); Ezra (ID: `person:Ezra`); SENHOR (ID: `deity:Lord`); decree (ID: `keyterm:Decree`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Artaxerxes (ID: `person:Artaxerxes`); Rio Eufrates (ID: `place:Euphrates`); Ezra (ID: `person:Ezra`); Kor (ID: `realia:Kor`); Money (ID: `realia:Money`); Talent (ID: `realia:Talent`); Olive Oil (ID: `realia:OliveOil`); Wheat (ID: `flora:Wheat`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Obadias (ID: `person:Obadiah.10`); Atalia (ID: `person:Athaliah.3`); Utai (ID: `person:Uthai.2`); Hatus (ID: `person:Hattush.2`); Paate-Moabe (ID: `person:Pahath-moab`); Adim (ID: `person:Adin`); Elam (ID: `person:Elam`); Elifelete (ID: `person:Eliphelet.5`); Jônatas (ID: `person:Jonathan.9`); Joabe (ID: `person:Joab.4`); Semaías (ID: `person:Shemaiah.14`); Josifias (ID: `person:Josiphiah`); Zabadias (ID: `person:Zebadiah.8`); Jeuel (ID: `person:Jeuel.3`); Bebai (ID: `person:Bebai.2`); Gérson (ID: `person:Gershom.2`); Jeiel (ID: `person:Jehiel.7`); Bebai (ID: `person:Bebai`); Joanã (ID: `person:Johanan.8`); Ebede (ID: `person:Ebed.2`); Secanias (ID: `person:Shecaniah.6`); Jaaziel (ID: `person:Jahaziel.5`); Zacarias (ID: `person:Zechariah.19`); Parós (ID: `person:Parosh.2`); Bigvai (ID: `person:Bigvai.2`); Asgade (ID: `person:Azgad`); Selomite (ID: `person:Shelomith.4`); Zeraías (ID: `person:Zerahiah.2`); Hacatã (ID: `person:Hakkatan`); Elioenai (ID: `person:Eliehoenai.2`); Miguel (ID: `person:Michael.10`); Adonicão (ID: `person:Adonikam`); Daniel (ID: `person:Daniel.2`); Zacur (ID: `person:Zaccur.5`); Secanias (ID: `person:Shecaniah.5`); Jesaías (ID: `person:Jeshaiah.4`); Zacarias (ID: `person:Zechariah.18`); Sephatias (ID: `person:Shephatiah.6`); Babilônia (ID: `place:Babylon`); Davi (ID: `person:David`); Fineias (ID: `person:Phinehas`); Artaxerxes (ID: `person:Artaxerxes`); Itamar (ID: `person:Ithamar`)
...
* **Associated ACAI Concepts:** Eliezer (ID: `person:Eliezer.8`); Mesulão (ID: `person:Meshullam.9`); Zacarias (ID: `person:Zechariah.20`); Ariel (ID: `person:Ariel`); Jaribe (ID: `person:Jarib.2`); Elnatã (ID: `person:Elnathan.3`); Elnatã (ID: `person:Elnathan.4`); Ido (ID: `person:Iddo`); Joiaribe (ID: `person:Joiarib.2`); Natã (ID: `person:Nathan.5`); Semaías (ID: `person:Shemaiah.15`); Casifia (ID: `place:Casiphia`); Elnatã (ID: `person:Elnathan.2`); perceive (ID: `keyterm:Perceive`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Insight (ID: `keyterm:Insight`); SENHOR (ID: `deity:Lord`); Mali (ID: `person:Mahli`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Davi (ID: `person:David`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); work (ID: `keyterm:Work`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Israel (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); Ammonites (ID: `group:Ammon`); Levi (ID: `person:Levi.3`); Hete (ID: `person:Heth`); Moabe (ID: `place:Moab`); Levi (ID: `group:Levi`); Amom (ID: `place:Ammon`); Canaã (ID: `place:Canaan`); Jebusites (ID: `group:Jebusites`); cananeu (ID: `group:Canaan`); Egyptians (ID: `group:Egypt`); be unfaithful (ID: `keyterm:Unfaithful`); Egito (ID: `place:Egypt`); Amorites (ID: `group:Amorites`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Harim (ID: `person:Harim`); Judá (ID: `person:Judah.4`); Elam (ID: `person:Elam`); counsel (ID: `keyterm:Counsel`); Judá (ID: `group:Judah`); offering (ID: `keyterm:Offering`); Elioenai (ID: `person:Elioenai.5`); Quelal (ID: `person:Chelal`); Jeiel (ID: `person:Jehiel.8`); Atlai (ID: `person:Athlai`); Simei (ID: `person:Shimei.17`); Benaia (ID: `person:Benaiah.8`); Jeremai (ID: `person:Jeremai`); Manassés (ID: `person:Manasseh.4`); Uel (ID: `person:Uel`); Malquias (ID: `person:Malchijah.5`); Secanias (ID: `person:Shecaniah.7`); Maaséias (ID: `person:Maaseiah.9`); Matanias (ID: `person:Mattaniah.8`); Jazeías (ID: `person:Jahzeiah`); Binui (ID: `person:Binnui.3`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); supplication (ID: `keyterm:Supplication`); to cause to possess (ID: `keyterm:Possess`); peace (ID: `keyterm:IntactState`); defilement (ID: `keyterm:Defilement`); dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`); Pérsia (ID: `place:Persia`); kindness (ID: `keyterm:Kindness`); Israel (ID: `person:Israel`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); supplication (ID: `keyterm:Supplication`); Jerusalém (ID: `place:Jerusalem`); Pérsia (ID: `place:Persia`); kindness (ID: `keyterm:Kindness`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); SENHOR (ID: `deity:Lord`); arrepender, se (ID: `keyterm:Repent`); Israel (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Secanias (ID: `person:Shecaniah.7`); Jeiel (ID: `person:Jehiel.8`); Ezra (ID: `person:Ezra`); SENHOR (ID: `deity:Lord`); Elam (ID: `person:Elam`); be unfaithful (ID: `keyterm:Unfaithful`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Benjamim (ID: `group:Benjamin`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Benjamim (ID: `person:Benjamin`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jônatas (ID: `person:Jonathan.10`); Asael (ID: `person:Asahel.4`); Mesulão (ID: `person:Meshullam.10`); Jazeías (ID: `person:Jahzeiah`); Sabetai (ID: `person:Shabbethai`); Ticva (ID: `person:Tikvah.2`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`)
