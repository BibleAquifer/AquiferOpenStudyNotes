...
* **Associated ACAI Concepts:** Understanding (ID: `keyterm:Understanding`); Edomites (ID: `group:Edom`); Peace (ID: `keyterm:IntactState`); Covenant (ID: `keyterm:Covenant`); أَدومَ (ID: `place:Edom`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); Lot (ID: `keyterm:Lot`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); يوسف (ID: `person:Joseph.10`); Edomites (ID: `group:Edom`); أورشَلِيمَ (ID: `place:Jerusalem`); Dispossess (ID: `keyterm:Dispossess`); أَدومَ (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** يوسف (ID: `person:Joseph.10`); Edomites (ID: `group:Edom`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); أَدومَ (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); بَنْيَامِينَ (ID: `group:Benjamin`); سَارْدِسَ (ID: `place:Sardis`); أَفْرَايِمَ (ID: `person:Ephraim`); فِلِشْتِيم (ID: `group:Philistine`); جِلْعَادَ (ID: `place:Gilead`); Canaanites (ID: `group:Canaan`); إِلَى (ID: `place:Zarephath`); عِيسو (ID: `place:EsauMount`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); أَفْرَايِمَ (ID: `group:Ephraim`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلسَّامِرَةِ (ID: `place:Samaria`); كَنْعَان (ID: `place:Canaan`); ٱلسَّهْلِ (ID: `place:Shephelah`); بَنْيَامِينَ (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** عِيسو (ID: `place:EsauMount`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); سَارْدِسَ (ID: `place:Sardis`); ٱلرَّبِّ (ID: `deity:Lord`); إِلَى (ID: `place:Zarephath`); بَنْيَامِينَ (ID: `person:Benjamin`); بَنْيَامِينَ (ID: `group:Benjamin`); أَفْرَايِمَ (ID: `person:Ephraim`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); كَنْعَان (ID: `place:Canaan`); ٱلسَّهْلِ (ID: `place:Shephelah`); جِلْعَادَ (ID: `place:Gilead`); Canaanites (ID: `group:Canaan`); أَفْرَايِمَ (ID: `group:Ephraim`); ٱلسَّامِرَةِ (ID: `place:Samaria`); فِلِشْتِيم (ID: `group:Philistine`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** سَارْدِسَ (ID: `place:Sardis`); Canaanites (ID: `group:Canaan`); إِلَى (ID: `place:Zarephath`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْجَنوبِ (ID: `place:Negeb`); كَنْعَان (ID: `place:Canaan`); Dispossess (ID: `keyterm:Dispossess`)
