...
* **Associated ACAI Concepts:** Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); lot (ID: `keyterm:Lot`)
...
* **Associated ACAI Concepts:** dispossess (ID: `keyterm:Dispossess`); Neguebe (ID: `place:Negeb`); Gileade (ID: `place:Gilead`); Benjamim (ID: `group:Benjamin`); Benjamim (ID: `person:Benjamin`); Jerusalém (ID: `place:Jerusalem`); Sarepta (ID: `place:Zarephath`); cananeu (ID: `group:Canaan`); Samaria (ID: `place:Samaria`); Sefalá (ID: `place:Shephelah`); Israel (ID: `person:Israel`); Canaã (ID: `place:Canaan`); Filístia (ID: `place:Philistine`); Efraim (ID: `group:Ephraim`); Efraim (ID: `person:Ephraim`); Monte de Esaú (ID: `place:EsauMount`); Filisteu (ID: `group:Philistine`); Sardes (ID: `place:Sardis`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); Jerusalém (ID: `place:Jerusalem`); dispossess (ID: `keyterm:Dispossess`); Monte de Esaú (ID: `place:EsauMount`); cananeu (ID: `group:Canaan`); Efraim (ID: `person:Ephraim`); Sardes (ID: `place:Sardis`); Gileade (ID: `place:Gilead`); Benjamim (ID: `person:Benjamin`); Samaria (ID: `place:Samaria`); SENHOR (ID: `deity:Lord`); Canaã (ID: `place:Canaan`); Filisteu (ID: `group:Philistine`); Sarepta (ID: `place:Zarephath`); Israel (ID: `person:Israel`); Benjamim (ID: `group:Benjamin`); Sefalá (ID: `place:Shephelah`); Filístia (ID: `place:Philistine`); Efraim (ID: `group:Ephraim`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Sarepta (ID: `place:Zarephath`); dispossess (ID: `keyterm:Dispossess`); Neguebe (ID: `place:Negeb`); cananeu (ID: `group:Canaan`); Israel (ID: `person:Israel`); Canaã (ID: `place:Canaan`); Sardes (ID: `place:Sardis`)
