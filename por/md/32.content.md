...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); make a vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); Amittai (ID: `person:Amittai`); Nínive (ID: `place:Nineveh`); Jope (ID: `place:Joppa`); exempt (ID: `keyterm:Exempt`); salvation (ID: `keyterm:Salvation`); kindness (ID: `keyterm:Kindness`); lot (ID: `keyterm:Lot`); praise (ID: `keyterm:Praise`); Word of the Lord (ID: `keyterm:WordOfTheLord`); slaughtering (ID: `keyterm:Slaughtering`); Társis (ID: `place:Tarshish`); Hebrews (ID: `group:Hebrews`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Hell (ID: `place:Hell`); praise (ID: `keyterm:Praise`); make a vow (ID: `keyterm:Vow`); Jonas (ID: `person:Jonah.2`); kindness (ID: `keyterm:Kindness`); salvation (ID: `keyterm:Salvation`); Cattails (ID: `flora:Cattails`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** praise (ID: `keyterm:Praise`); make a vow (ID: `keyterm:Vow`); SENHOR (ID: `deity:Lord`); kindness (ID: `keyterm:Kindness`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Nínive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Sackcloth (ID: `realia:Sackcloth`); Cattle (ID: `fauna:Bull`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Believe In (ID: `keyterm:BelieveIn`); Társis (ID: `place:Tarshish`); gracious (ID: `keyterm:Generous`); kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`); Worm (ID: `fauna:Maggot`); Flock (ID: `fauna:Flock`); Throne (ID: `realia:Throne`); Clothing (ID: `realia:Clothing`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Cattle (ID: `fauna:Bull`); SENHOR (ID: `deity:Lord`); Nínive (ID: `place:Nineveh`); Flock (ID: `fauna:Flock`); Sackcloth (ID: `realia:Sackcloth`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); Társis (ID: `place:Tarshish`); gracious (ID: `keyterm:Generous`); kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Társis (ID: `place:Tarshish`); SENHOR (ID: `deity:Lord`); gracious (ID: `keyterm:Generous`); kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`)
