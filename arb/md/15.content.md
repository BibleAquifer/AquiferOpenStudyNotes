...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`); إِسْرَائِيلَ (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); إِرْمِيَا (ID: `person:Jeremiah.6`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); فَارِسَ (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `group:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `person:Benjamin`); يَهوذَا (ID: `person:Judah.4`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath`); يَهوذَا (ID: `group:Judah`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `person:Judah.4`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); سلَيْمَانَ (ID: `person:Solomon`); أورشَلِيمَ (ID: `place:Jerusalem`); حَقوفَا (ID: `person:Hakupha`); نَصِيحَ (ID: `person:Neziah`); رَصِينَ (ID: `person:Rezin.2`); بِيصَايَ (ID: `person:Bezai`); بِغْوَايَ (ID: `person:Bigvai`); آرَحَ (ID: `person:Arah.2`); شَفَطْيَا (ID: `person:Shephatiah.7`); Nephushesim (ID: `group:Nephushesim`); حَسوفَا (ID: `person:Hasupha`); حَارِيمَ (ID: `person:Harim.2`); يَشوعَ (ID: `person:Jeshua.3`); Tel-melah (ID: `place:Tel-melah`); بِغْوَايَ (ID: `person:Bigvai.2`); بَرْزِلَّايَ (ID: `person:Barzillai.3`); حَطِيطَا (ID: `person:Hatita`); عَادِينَ (ID: `person:Adin`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); يَدَايَا (ID: `person:Jedaiah.4`); رَعْلَايَا (ID: `person:Reelaiah`); Meunim (ID: `group:Meunim`); ثَامَحَ (ID: `person:Temah`); رَآيَا (ID: `person:Reaiah.3`); بَقْبوقَ (ID: `person:Bakbuk`); دَرْقونَ (ID: `person:Darkon`)
...
* **Associated ACAI Concepts:** بِلْشَان (ID: `person:Bilshan`); بَعْنَةَ (ID: `person:Baanah.3`); مِسْفَار (ID: `person:Mispar`); بِغْوَايَ (ID: `person:Bigvai`); رَعْلَايَا (ID: `person:Reelaiah`); سَرَايَا (ID: `person:Seraiah.6`); نَحَمْيَا (ID: `person:Nehemiah`); رَحوم (ID: `person:Rehum`); مرْدَخَاي (ID: `person:Mordecai`); إِسْرَائِيلَ (ID: `person:Israel`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** فَرْعوشَ (ID: `person:Parosh`); بَابَايَ (ID: `person:Bebai`); بِيصَايَ (ID: `person:Bezai`); آرَحَ (ID: `person:Arah.2`); آطِيرَ (ID: `person:Ater`); بَانِيَ (ID: `person:Bani`); عِيلَامَ (ID: `person:Elam`); يَشوعَ (ID: `person:Jeshua.3`); عَرْجَدَ (ID: `person:Azgad`); بِغْوَايَ (ID: `person:Bigvai.2`); عَادِينَ (ID: `person:Adin`); يوآب (ID: `person:Joab.3`); زَكَّايَ (ID: `person:Zaccai.2`); شَفَطْيَا (ID: `person:Shephatiah.6`); Pahath-moab (ID: `person:Pahath-moab`); حَشوم (ID: `person:Hashum`); حَزَقِيَّا (ID: `person:Hezekiah.2`); زَتّو (ID: `person:Zattu.2`); يورَةَ (ID: `person:Jorah`); أَدونِيقَامَ (ID: `person:Adonikam`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); نَبو (ID: `place:Nebo.2`); Beth-azmaveth (ID: `place:Beth-azmaveth`); حَارِيمَ (ID: `person:Harim.2`); حَادِيدَ (ID: `place:Hadid`); مَغْبِيشَ (ID: `place:Magbish`); سَنَاءَةَ (ID: `place:Senaah`); Kiriath-jearim (ID: `place:Kiriath-jearim`); عَايٍ (ID: `place:Ai`); عِيلَامَ (ID: `person:Elam`); وَلودَ (ID: `place:Lod`); ٱلْكَفِيرَة (ID: `place:Chephirah`); Bethel (ID: `place:Bethel`); Ramah (ID: `place:Ramah.2`); مِنْ (ID: `place:Geba`); مِخْمَاسَ (ID: `place:Michmash`); أَرِيحَا (ID: `place:Jericho`); لَحْمٍ (ID: `place:Bethlehem`); بَئِيروت (ID: `place:Beeroth`); أونوَ (ID: `place:Ono`); عَنَاثوثَ (ID: `place:Anathoth`)
...
* **Associated ACAI Concepts:** حَارِيمَ (ID: `person:Harim`); آطِيرَ (ID: `person:Ater.2`); يَدَايَا (ID: `person:Jedaiah.4`); لِإِيمِيرَ (ID: `person:Immer.2`); طَلْمون (ID: `person:Talmon`); حَطِيطَا (ID: `person:Hatita`); يَشوعَ (ID: `person:Jeshua.4`); شوبَايَ (ID: `person:Shobai`); يَشوعَ (ID: `person:Jeshua`); هودَوْيَا (ID: `person:Hodaviah.4`); فَشْحور (ID: `person:Pashhur`); شَلّوم (ID: `person:Shallum.8`); آسَاف (ID: `person:Asaph.2`); عَقّوب (ID: `person:Akkub.2`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** آطِيرَ (ID: `person:Ater.2`); طَلْمون (ID: `person:Talmon`); حَطِيطَا (ID: `person:Hatita`); شوبَايَ (ID: `person:Shobai`); شَلّوم (ID: `person:Shallum.8`); آسَاف (ID: `person:Asaph.2`); عَقّوب (ID: `person:Akkub.2`)
...
* **Associated ACAI Concepts:** حَقوفَا (ID: `person:Hakupha`); نَصِيحَ (ID: `person:Neziah`); سِيسَرَا (ID: `person:Sisera.2`); رَصِينَ (ID: `person:Rezin.2`); حَانَان (ID: `person:Hanan.4`); جَزَّامَ (ID: `person:Gazzam`); فِي (ID: `person:Uzza.2`); قِيروسَ (ID: `person:Keros`); فَادونَ (ID: `person:Padon`); Nephushesim (ID: `group:Nephushesim`); بَصْلوتَ (ID: `person:Bazluth`); لَبَانَةَ (ID: `person:Lebanah`); حَرْحورَ (ID: `person:Harhur`); أَسْنَةَ (ID: `person:Asnah`); جَدِّيلَ (ID: `person:Giddel`); حَسوفَا (ID: `person:Hasupha`); حَطِيفَا (ID: `person:Hatipha`); جَاحَرَ (ID: `person:Gahar`); مَحِيدَا (ID: `person:Mehida`); حَجَابَةَ (ID: `person:Hagabah`); صِيحَا (ID: `person:Ziha`); بَرْقوسَ (ID: `person:Barkos`); فَاسِيحَ (ID: `person:Paseah.2`); حَاجَابَ (ID: `person:Hagab`); سِيعَهَا (ID: `person:Siaha`); طَبَاعوتَ (ID: `person:Tabbaoth`); Meunim (ID: `group:Meunim`); عَقّوب (ID: `person:Akkub.3`); ثَامَحَ (ID: `person:Temah`); رَآيَا (ID: `person:Reaiah.3`); سَلْمَايَ (ID: `person:Shalmai`); بَقْبوقَ (ID: `person:Bakbuk`); حَرْشَا (ID: `person:Harsha`); نَقودَا (ID: `person:Nekoda`); بِيسَايَ (ID: `person:Besai`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); يَعْلَةَ (ID: `person:Jaalah`); فَرودَا (ID: `person:Peruda`); دَرْقونَ (ID: `person:Darkon`); سوفَرَثَ (ID: `person:Sophereth`); سَوْطَايَ (ID: `person:Sotai`); آمِي (ID: `person:Ami`); شَفَطْيَا (ID: `person:Shephatiah.7`); حَطِّيلَ (ID: `person:Hattil`); جَدِّيلَ (ID: `person:Giddel.2`)
...
* **Associated ACAI Concepts:** نَقودَا (ID: `person:Nekoda.2`); طوبِيَّا (ID: `person:Tobiah`); لِإِيمِيرَ (ID: `place:Immer`); Tel-harsha (ID: `place:Tel-harsha`); Tel-melah (ID: `place:Tel-melah`); أَدَّان (ID: `place:Addan`); كَروب (ID: `place:Cherub`); لِدَلَايَا (ID: `person:Delaiah.3`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** حَبَايَا (ID: `person:Habaiah`); هَقّوصَ (ID: `person:Hakkoz.2`); بَرْزِلَّايَ (ID: `person:Barzillai.3`); بَرْزِلَّايَ (ID: `person:Barzillai`); Defile (ID: `keyterm:Stain`); جِلْعَادَ (ID: `place:Gilead`); Priesthood (ID: `keyterm:Priesthood`); Gileadites (ID: `group:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); Strength (ID: `keyterm:Strength`); House (ID: `realia:House`); Mina (ID: `realia:Mina`); Money (ID: `realia:Money`); Tunic (ID: `realia:Tunic`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); يَشوع (ID: `person:Joshua.5`); فَارِسَ (ID: `place:Persia`); كورَشَ (ID: `person:Cyrus`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Esarhaddon (ID: `person:Esarhaddon`); Relatives (ID: `group:Relatives`); يَشوعَ (ID: `person:Jeshua.4`); هودَوْيَا (ID: `person:Hodaviah.4`); حِينَادَادَ (ID: `person:Henadad`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); يَافَا (ID: `place:Joppa`); بَنْيَامِينَ (ID: `group:Benjamin`); دَارِيوسَ (ID: `person:Darius.2`); لبْنَانَ (ID: `place:Lebanon`); هودِيَّا (ID: `person:Hodiah.2`); Kindness (ID: `keyterm:Kindness`); Assyria (ID: `place:Assyria`); New Moon Festival (ID: `keyterm:NewMoonFestival`); آسَاف (ID: `person:Asaph.2`); دَاودَ (ID: `person:David`); موسَى (ID: `person:Moses`); Appointed Feast (ID: `keyterm:AppointedFeast`); Terror (ID: `keyterm:Terror`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Tyrians (ID: `group:Tyre`); صِيْدونَ (ID: `place:Sidon`); Counsel (ID: `keyterm:Counsel`); Holy (ID: `keyterm:Holy`); بَنْيَامِينَ (ID: `person:Benjamin`); Sidonians (ID: `group:Sidon`); صورَ (ID: `place:Tyre`); Instruction (ID: `keyterm:Instruction`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Cedar (ID: `flora:Cedar`); Craftsman (ID: `realia:Craftsman`); Trumpet (ID: `realia:Trumpet`); Olive Oil (ID: `realia:OliveOil`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** يَافَا (ID: `place:Joppa`); لبْنَانَ (ID: `place:Lebanon`); Sidonians (ID: `group:Sidon`); صورَ (ID: `place:Tyre`); Tyrians (ID: `group:Tyre`); صِيْدونَ (ID: `place:Sidon`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); Craftsman (ID: `realia:Craftsman`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); آسَاف (ID: `person:Asaph.2`); دَاودَ (ID: `person:David`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Kindness (ID: `keyterm:Kindness`); House (ID: `realia:House`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); فَارِسَ (ID: `place:Persia`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Jews (ID: `group:Jews`); بِشْلَام (ID: `person:Bishlam`); أَرَكَ (ID: `place:Erech`); مِثْرَدَاث (ID: `person:Mithredath.2`); Babylonians (ID: `group:Babylon`); أسْنَفَّر (ID: `person:Osnappar`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); طَبْئِيل (ID: `person:Tabeel`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); يَهوذَا (ID: `group:Judah`); عِيلَامَ (ID: `place:Elam`); Persians (ID: `group:Persia`); يَهوذَا (ID: `person:Judah.4`); Elamites (ID: `group:Elam`); فِي (ID: `place:Susa`); بَابِلَ (ID: `place:Babylon`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); Babylonians (ID: `group:Babylon`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); أَرَكَ (ID: `place:Erech`); فِي (ID: `place:Susa`); عِيلَامَ (ID: `place:Elam`); Persians (ID: `group:Persia`); بَابِلَ (ID: `place:Babylon`); Elamites (ID: `group:Elam`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); رَحوم (ID: `person:Rehum.2`); Jews (ID: `group:Jews`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); دَارِيوسَ (ID: `person:Darius.2`); Jews (ID: `group:Jews`); Shethar-bozenai (ID: `person:Shethar-bozenai`); حَجَّيِ (ID: `person:Haggai`); يَدّو (ID: `person:Iddo.6`); زَكَرِيَّا (ID: `person:Zechariah.17`); تَتْنَاي (ID: `person:Tattenai`); يَهوصَادِقَ (ID: `person:Jehozadak`); إِسْرَائِيلَ (ID: `person:Israel`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `person:Judah.4`); فَارِسَ (ID: `place:Persia`); ٱلْفرَاتِ (ID: `place:Euphrates`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** حَجَّيِ (ID: `person:Haggai`); يَدّو (ID: `person:Iddo.6`); زَكَرِيَّا (ID: `person:Zechariah.17`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Jews (ID: `group:Jews`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); أورشَلِيمَ (ID: `place:Jerusalem`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** بَابِلَ (ID: `place:Babylon`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); Chaldeans (ID: `group:Chaldea`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); بَابِلَ (ID: `place:Babylon`); زَربَّابِل (ID: `person:Zerubbabel.2`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); كورَشَ (ID: `person:Cyrus`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); موسَى (ID: `person:Moses`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `group:Levi`); Passover (ID: `keyterm:Passover`); Pure (ID: `keyterm:Pure`); لَّاوِي (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Defilement (ID: `keyterm:Defilement`); Gentiles (ID: `group:Gentile`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); بقِّي (ID: `person:Bukki.2`); صَادوق (ID: `person:Zadok.4`); أَمَرْيَا (ID: `person:Amariah.2`); عزِّي (ID: `person:Uzzi`); زَرَحْيَا (ID: `person:Zerahiah`); أَبِيشوعَ (ID: `person:Abishua`); لِمَرَايوثَ (ID: `person:Meraioth`); سَرَايَا (ID: `person:Seraiah.2`); أَخِيطوبَ (ID: `person:Ahitub.3`); شَلّوم (ID: `person:Shallum.7`); عَزَرْيَا (ID: `person:Azariah.7`); عَزَرْيَا (ID: `person:Azariah.6`); أَلِعَازَار (ID: `person:Eleazar.2`); فِينَحَاس (ID: `person:Phinehas`); فَارِسَ (ID: `place:Persia`); هَارون (ID: `person:Aaron`); حِلْقِيَّا (ID: `person:Hilkiah.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); ٱلْفرَاتِ (ID: `place:Euphrates`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); Money (ID: `realia:Money`); Wheat (ID: `flora:Wheat`); Anointing Oil (ID: `realia:AnointingOil`); Kor (ID: `realia:Kor`); Olive Oil (ID: `realia:OliveOil`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** يَحْزِيئِيل (ID: `person:Jahaziel.5`); يونَاثَانَ (ID: `person:Jonathan.9`); هِقَّاطَانَ (ID: `person:Hakkatan`); زَكّور (ID: `person:Zaccur.5`); يوآب (ID: `person:Joab.4`); دَانِيآل (ID: `person:Daniel.2`); بَابَايَ (ID: `person:Bebai`); عَثَلْيَا (ID: `person:Athaliah.3`); عِيلَامَ (ID: `person:Elam`); يوحَانَانَ (ID: `person:Johanan.8`); عَرْجَدَ (ID: `person:Azgad`); يِشْعِيَا (ID: `person:Jeshaiah.4`); شَكَنْيَا (ID: `person:Shecaniah.6`); بِغْوَايَ (ID: `person:Bigvai.2`); شَلومِيَةَ (ID: `person:Shelomith.4`); عوتَاي (ID: `person:Uthai.2`); عَادِينَ (ID: `person:Adin`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); بَابَايَ (ID: `person:Bebai.2`); عوبَدْيَا (ID: `person:Obadiah.10`); حَطّوش (ID: `person:Hattush.2`); يَعِيئِيل (ID: `person:Jeuel.3`); يَحِيئِيل (ID: `person:Jehiel.7`); عَابِد (ID: `person:Ebed.2`); Gershom (ID: `person:Gershom.2`); يوشَفْيَا (ID: `person:Josiphiah`); زَبَدْيَا (ID: `person:Zebadiah.8`); شِمْعِيَا (ID: `person:Shemaiah.14`); شَفَطْيَا (ID: `person:Shephatiah.6`); شَكَنْيَا (ID: `person:Shecaniah.5`); Pahath-moab (ID: `person:Pahath-moab`); مِيخَائِيلَ (ID: `person:Michael.10`); أَلِيفَلَط (ID: `person:Eliphelet.5`); فَرْعوشَ (ID: `person:Parosh.2`); زَرَحْيَا (ID: `person:Zerahiah.2`); أَدونِيقَامَ (ID: `person:Adonikam`); زَكَرِيَّا (ID: `person:Zechariah.19`); زَكَرِيَّا (ID: `person:Zechariah.18`); فِينَحَاس (ID: `person:Phinehas`); إِيثَامَارَ (ID: `person:Ithamar`); دَاودَ (ID: `person:David`); بَابِلَ (ID: `place:Babylon`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** مَشلَّام (ID: `person:Meshullam.9`); ٱلْمسَمَّى (ID: `place:Casiphia`); يَدّو (ID: `person:Iddo`); أَرِيئِيلَ (ID: `person:Ariel`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); نَاثَان (ID: `person:Nathan.5`); زَكَرِيَّا (ID: `person:Zechariah.20`); شِمْعِيَا (ID: `person:Shemaiah.15`); أَلِيعَزَرَ (ID: `person:Eliezer.8`); يَارِيبَ (ID: `person:Jarib.2`); يويَارِيبَ (ID: `person:Joiarib.2`); ٱلرَّبِّ (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); Insight (ID: `keyterm:Insight`); مَحْلِي (ID: `person:Mahli`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); دَاودَ (ID: `person:David`); Work (ID: `keyterm:Work`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Offering (ID: `keyterm:Offering`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); Be Unfaithful (ID: `keyterm:Unfaithful`); إِسْرَائِيلَ (ID: `person:Israel`); Ammonites (ID: `group:Ammon`); Canaanites (ID: `group:Canaan`); Jebusites (ID: `group:Jebusites`); Egyptians (ID: `group:Egypt`); حِثًّا (ID: `person:Heth`); كَنْعَان (ID: `place:Canaan`); لَّاوِي (ID: `person:Levi.3`); موآبَ (ID: `place:Moab`); Amorites (ID: `group:Amorites`); مِصْرَ (ID: `place:Egypt`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); Passion (ID: `keyterm:Ardour`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); عِيلَامَ (ID: `person:Elam`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Offering (ID: `keyterm:Offering`); Counsel (ID: `keyterm:Counsel`); شِمْعِيَا (ID: `person:Shemaiah.17`); يوصَادَاقَ (ID: `person:Jozadak.2`); يَرِيموت (ID: `person:Jeremoth.4`); شَارَاي (ID: `person:Sharai`); يونَاثَانَ (ID: `person:Jonathan.10`); يَدّو (ID: `person:Jaddai`); شِمْعِي (ID: `person:Shimei.16`); نَاثَان (ID: `person:Nathan.6`); زَبَاي (ID: `person:Zabbai`); أَلِعَازَار (ID: `person:Eleazar.7`); يَرِيموت (ID: `person:Jeremoth.3`); شِمْعِي (ID: `person:Shimei.15`); مَتَّنْيَا (ID: `person:Mattaniah.7`); شَاشَاي (ID: `person:Shashai`); بَنْيَامِينَ (ID: `person:Benjamin.3`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); أورشَلِيمَ (ID: `place:Jerusalem`); Peace (ID: `keyterm:IntactState`); To Cause to Possess (ID: `keyterm:Possess`); Plea for Mercy (ID: `keyterm:Supplication`); إِسْرَائِيلَ (ID: `person:Israel`); Defilement (ID: `keyterm:Defilement`); Dispossess (ID: `keyterm:Dispossess`); Kindness (ID: `keyterm:Kindness`); فَارِسَ (ID: `place:Persia`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); أورشَلِيمَ (ID: `place:Jerusalem`); Plea for Mercy (ID: `keyterm:Supplication`); Kindness (ID: `keyterm:Kindness`); فَارِسَ (ID: `place:Persia`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** شَكَنْيَا (ID: `person:Shecaniah.7`); يَحِيئِيل (ID: `person:Jehiel.8`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); عِيلَامَ (ID: `person:Elam`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Counsel (ID: `keyterm:Counsel`); Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); Swear (ID: `keyterm:Swear`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `group:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `person:Benjamin`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** تِقْوَةَ (ID: `person:Tikvah.2`); يونَاثَانَ (ID: `person:Jonathan.10`); يَحْزِيَا (ID: `person:Jahzeiah`); مَشلَّام (ID: `person:Meshullam.10`); عَسَائِيل (ID: `person:Asahel.4`); شَبْتَاي (ID: `person:Shabbethai`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`)
