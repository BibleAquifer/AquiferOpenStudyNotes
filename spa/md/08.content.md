...
* **Associated ACAI Concepts:** Efratita (ID: `group:Ephrathah`); Ephrata (ID: `person:Ephrathah`); Chelión (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Judá (ID: `person:Judah.4`); Moab (ID: `place:Moab`); Judá (ID: `group:Judah`); Mahalón (ID: `person:Mahlon`); Catah (ID: `place:Bethlehem`); Elimelech (ID: `person:Elimelech`)
...
* **Associated ACAI Concepts:** bendecir (ID: `keyterm:Bless`); Jehová (ID: `deity:Lord`); Noemi (ID: `person:Naomi`); bondad (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); dejar en herencia (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Booz (ID: `person:Boaz`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Mahalón (ID: `person:Mahlon`); Moab (ID: `place:Moab`); dejar en herencia (ID: `keyterm:Possess`); Ruth (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Lea (ID: `person:Leah`); Jehová (ID: `deity:Lord`); Israel (ID: `person:Israel`); Elders (ID: `group:GenericElders`); Rachêl (ID: `person:Rachel`); Catah (ID: `place:Bethlehem`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Phares (ID: `person:Perez`); Thamar (ID: `person:Tamar`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Jehová (ID: `deity:Lord`); Israel (ID: `person:Israel`); Noemi (ID: `person:Naomi`); bendecir (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Hesrón (ID: `person:Hezron.2`); Salmón (ID: `person:Salmon`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Booz (ID: `person:Boaz`); David (ID: `person:David`); Phares (ID: `person:Perez`); Nahasón (ID: `person:Nahshon`); Isaí (ID: `person:Jesse`)
