...
* **Associated ACAI Concepts:** alliance (ID: `keyterm:Covenant`); comprehension (ID: `keyterm:Understanding`); Édom (ID: `place:Edom`); état intact (ID: `keyterm:IntactState`); Édom (ID: `group:Edom`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** Juda (ID: `person:Judah.4`); destin (ID: `keyterm:Lot`); Jérusalem (ID: `place:Jerusalem`); Israël (ID: `person:Israel`); Juda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Édom (ID: `place:Edom`); Joseph (ID: `person:Joseph.10`); déposséder (ID: `keyterm:Dispossess`); Jérusalem (ID: `place:Jerusalem`); Édom (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Édom (ID: `place:Edom`); Joseph (ID: `person:Joseph.10`); Israël (ID: `person:Israel`); Édom (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** déposséder (ID: `keyterm:Dispossess`); Negev (ID: `place:Negeb`); Canaan (ID: `place:Canaan`); Galaad (ID: `place:Gilead`); Benjamin (ID: `person:Benjamin`); montagne d'Ésaü (ID: `place:EsauMount`); Philistia (ID: `place:Philistine`); Philistins (ID: `group:Philistine`); Sarepta (ID: `place:Zarephath`); Jérusalem (ID: `place:Jerusalem`); Éphraïm (ID: `person:Ephraim`); Benjamin (ID: `group:Benjamin`); Éphraïm (ID: `group:Ephraim`); Sardes (ID: `place:Sardis`); Shephelah (ID: `place:Shephelah`); Israël (ID: `person:Israel`); Samarie (ID: `place:Samaria`); Canaan (ID: `group:Canaan`)
...
* **Associated ACAI Concepts:** déposséder (ID: `keyterm:Dispossess`); Jérusalem (ID: `place:Jerusalem`); Negev (ID: `place:Negeb`); montagne d'Ésaü (ID: `place:EsauMount`); Éternel (ID: `deity:Lord`); Philistia (ID: `place:Philistine`); Philistins (ID: `group:Philistine`); Éphraïm (ID: `person:Ephraim`); Benjamin (ID: `group:Benjamin`); Benjamin (ID: `person:Benjamin`); Galaad (ID: `place:Gilead`); Sarepta (ID: `place:Zarephath`); Éphraïm (ID: `group:Ephraim`); Israël (ID: `person:Israel`); Canaan (ID: `place:Canaan`); Sardes (ID: `place:Sardis`); Shephelah (ID: `place:Shephelah`); Samarie (ID: `place:Samaria`); Canaan (ID: `group:Canaan`)
...
* **Associated ACAI Concepts:** Canaan (ID: `place:Canaan`); Sarepta (ID: `place:Zarephath`); Jérusalem (ID: `place:Jerusalem`); déposséder (ID: `keyterm:Dispossess`); Sardes (ID: `place:Sardis`); Israël (ID: `person:Israel`); Negev (ID: `place:Negeb`); Canaan (ID: `group:Canaan`)
