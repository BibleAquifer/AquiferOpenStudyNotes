...
* **Associated ACAI Concepts:** Capadócia (ID: `place:Cappadocia`); Bitínia (ID: `place:Bithynia`); Ponto (ID: `place:Pontus`); Galácia (ID: `place:Galatia`)
...
* **Associated ACAI Concepts:** imortal (ID: `keyterm:Imperishable`); hope (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** holy (ID: `keyterm:Holy`); irrepreensível (ID: `keyterm:Unblemished`); libertação (ID: `keyterm:Liberation`); invocar (ID: `keyterm:CallUpon`)
...
* **Associated ACAI Concepts:** escândalo (ID: `keyterm:StumblingBlock`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Do Good (ID: `keyterm:DoGood`); Gold Jewelry (ID: `realia:GoldJewelry`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Christians (ID: `group:Christ`); compartilhar (ID: `keyterm:Share`)
