...
* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Blood (ID: `keyterm:Blood`); To Sin (ID: `keyterm:Sin`); यीशु (ID: `person:Jesus.2`); Forgive (ID: `keyterm:Forgive`); यहोवा (ID: `deity:Lord`); Kingdom (ID: `keyterm:Kingdom`); Be a Disciple (ID: `keyterm:Disciple`); Bless (ID: `keyterm:Bless`); Covenant (ID: `keyterm:Covenant`); Vine (ID: `flora:Vine`)
