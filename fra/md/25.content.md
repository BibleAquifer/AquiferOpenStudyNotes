...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); se rebeller (ID: `keyterm:Rebel`); Jérusalem (ID: `place:Jerusalem`); force (ID: `keyterm:Strength`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); aimer (ID: `keyterm:Love`); tromperie (ID: `keyterm:Deceit`); pécher (ID: `keyterm:Sin`); pollution (ID: `keyterm:Defilement`); fête déterminée (ID: `keyterm:AppointedFeast`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Israël (ID: `person:Israel`); travil (ID: `keyterm:Work`); indomptables (ID: `keyterm:MightyOne`); Train (ID: `realia:Train`); Winepress (ID: `realia:Winepress`); Deer (ID: `fauna:Deer`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Casting Net (ID: `realia:CastingNet`); Yoke (ID: `realia:Yoke`); Net (ID: `realia:Net`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); pollution (ID: `keyterm:Defilement`); Jérusalem (ID: `place:Jerusalem`); pécher (ID: `keyterm:Sin`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** fête déterminée (ID: `keyterm:AppointedFeast`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); sabbat (ID: `keyterm:Sabbath`)
...
* **Associated ACAI Concepts:** fête déterminée (ID: `keyterm:AppointedFeast`); Éternel (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); ardeur (ID: `keyterm:Ardour`); Éternel (ID: `deity:Lord`); Édom (ID: `place:Edom`); pécher (ID: `keyterm:Sin`); souiller (ID: `keyterm:Stain`); Uts (ID: `place:Uz`); oint (ID: `keyterm:Anointed`); charger (ID: `keyterm:Appoint`); fie (ID: `keyterm:BelieveIn`); juste (ID: `keyterm:Complete`); agir avec bonté (ID: `keyterm:KindlyDisposed`); punition (ID: `keyterm:Punishment`); pollution (ID: `keyterm:Defilement`); Sodome (ID: `place:Sodom`); Jackal (ID: `fauna:Jackal`); Ostrich (ID: `fauna:Ostrich`); Clay Jar (ID: `realia:ClayJar`); Vulture (ID: `fauna:Vulture`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** Édom (ID: `place:Edom`); Uts (ID: `place:Uz`); Jérusalem (ID: `place:Jerusalem`); pécher (ID: `keyterm:Sin`); charger (ID: `keyterm:Appoint`); juste (ID: `keyterm:Complete`); ardeur (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); pécher (ID: `keyterm:Sin`); Édom (ID: `place:Edom`); charger (ID: `keyterm:Appoint`); juste (ID: `keyterm:Complete`); ardeur (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); pécher (ID: `keyterm:Sin`); Woe (ID: `keyterm:Woe`); Juda (ID: `person:Judah.4`); Assyria (ID: `place:Assyria`); danse en rond (ID: `keyterm:RoundDance`); ardeur (ID: `keyterm:Ardour`); laissiez en possession (ID: `keyterm:Possess`); Juda (ID: `group:Judah`); Égypte (ID: `place:Egypt`); Hand-Mill (ID: `realia:Hand-mill`); Jackal (ID: `fauna:Jackal`); Money (ID: `realia:Money`); Crown (ID: `realia:Crown`); House (ID: `realia:House`)
