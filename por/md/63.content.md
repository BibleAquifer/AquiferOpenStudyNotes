...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); escolhido (ID: `keyterm:Chosen`); SENHOR (ID: `deity:Lord`); misericórdia (ID: `keyterm:Mercy`); para a eternidade (ID: `keyterm:Always`); Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** misericórdia (ID: `keyterm:Mercy`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); favor (ID: `keyterm:Favor`); fazer a paz (ID: `keyterm:Peace`); Truth (ID: `keyterm:Truth`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); SENHOR (ID: `deity:Lord`); andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); compartilhar (ID: `keyterm:Share`); Ability (ID: `keyterm:Ability`); corpo (ID: `keyterm:Body.3`); rogar (ID: `keyterm:AskFor`); Truth (ID: `keyterm:Truth`); House (ID: `realia:House`)
