...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Tessalônica (ID: `place:Thessalonica`); Thessalonians (ID: `group:Thessalonica`); Timóteo (ID: `person:Timothy`); fazer a paz (ID: `keyterm:Peace`); Paulo (ID: `person:Paul`); igreja (ID: `keyterm:Church`); Silas (ID: `person:Silas`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); be (or show oneself) just (ID: `keyterm:Just`); para a eternidade (ID: `keyterm:Always`); céu (ID: `keyterm:Heaven`); juízo (ID: `keyterm:Judgment`); Ability (ID: `keyterm:Ability`); testemunhar (ID: `keyterm:BearWitness`); holy (ID: `keyterm:Holy`); fazer justiça (ID: `keyterm:GrantJustice`); dever (ID: `keyterm:Ought`); Glory (ID: `keyterm:Glory`); ser glorificado (ID: `keyterm:Glorified`); boa notícia (ID: `keyterm:GoodNews`); tribunal de justiça (ID: `keyterm:CourtCase`); love (ID: `keyterm:Love`); An Angel (ID: `deity:Angel`); reino (ID: `keyterm:Kingdom`); igreja (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** Good (ID: `keyterm:Good`); orar (ID: `keyterm:Pray`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Good (ID: `keyterm:Good`); orar (ID: `keyterm:Pray`); favor (ID: `keyterm:Favor`); Ability (ID: `keyterm:Ability`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); ser glorificado (ID: `keyterm:Glorified`); crer (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); ser glorificado (ID: `keyterm:Glorified`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); Truth (ID: `keyterm:Truth`); SENHOR (ID: `deity:Lord`); Spirit (ID: `keyterm:Spirit.2`); crer (ID: `keyterm:Believe`); love (ID: `keyterm:Love`); Satanás (ID: `deity:Satan`); decidir (ID: `keyterm:Decided`); objeto de culto (ID: `keyterm:ObjectOfWorship`); wipe (out), destroy (ID: `keyterm:Destroy`); injustiça (ID: `keyterm:UnjustDeed`); Ability (ID: `keyterm:Ability`); example (ID: `keyterm:Example`); maravilha (ID: `keyterm:Portent`); rogar (ID: `keyterm:AskFor`); salvation (ID: `keyterm:Salvation`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** example (ID: `keyterm:Example`); Satanás (ID: `deity:Satan`); maravilha (ID: `keyterm:Portent`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Good (ID: `keyterm:Good`); love (ID: `keyterm:Love`); para a eternidade (ID: `keyterm:Always`); SENHOR (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); Jesus (ID: `person:Jesus.2`); hope (ID: `keyterm:Hope`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); orar (ID: `keyterm:Pray`); love (ID: `keyterm:Love`); Glory (ID: `keyterm:Glory`); persuadir (ID: `keyterm:Persuade`); livrar (ID: `keyterm:Deliver`); SENHOR (ID: `deity:Lord`); Faithfulness (ID: `keyterm:Faithfulness`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); andar (ID: `keyterm:Live.3`); autoridade (ID: `keyterm:Authority.2`); Name (ID: `keyterm:Name`); rogar (ID: `keyterm:AskFor`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); tradição (ID: `keyterm:Teaching`); Ability (ID: `keyterm:Ability`)
