...
* **Associated ACAI Concepts:** Rama (ID: `place:Ramah`); Samuel (ID: `person:Samuel`); Israel (ID: `person:Israel`); Daud (ID: `person:David`); Paran (ID: `place:Paran`); House (ID: `realia:House`)
