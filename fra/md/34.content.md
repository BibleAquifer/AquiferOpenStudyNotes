...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Carmel (ID: `place:Carmel`); Liban (ID: `place:Lebanon`); Basan (ID: `place:Bashan`); zélé (ID: `keyterm:Zealous.3`); force (ID: `keyterm:Strength`); chemin (ID: `keyterm:TheWay`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Carmel (ID: `place:Carmel`); Liban (ID: `place:Lebanon`); méchanceté (ID: `keyterm:Wickedness`); Basan (ID: `place:Bashan`); se réfugier (ID: `keyterm:SeekfindRefuge`); zélé (ID: `keyterm:Zealous.3`); force (ID: `keyterm:Strength`); chemin (ID: `keyterm:TheWay`); Fortress (ID: `realia:Fortress`); Strong Drink (ID: `realia:StrongDrink`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** méchanceté (ID: `keyterm:Wickedness`); Juda (ID: `group:Judah`); faire un voeu (ID: `keyterm:Vow`); état intact (ID: `keyterm:IntactState`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); Éternel (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Flock (ID: `fauna:Flock`); Grass (ID: `flora:Grass`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Puth (ID: `place:Put`); Libya (ID: `place:Libya`); Cush (ID: `place:Cush.2`); destin (ID: `keyterm:Lot`); Égypte (ID: `place:Egypt`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`)
