...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); mencobai (ID: `keyterm:PutToTheTest`); berbahagialah (ID: `keyterm:Happy`); kekasih (ID: `keyterm:Beloved`); sia, sia (ID: `keyterm:Worthless`); tahan uji (ID: `keyterm:Approved`); suci (ID: `keyterm:Clean`); keahlian (ID: `keyterm:Ability`); tidak dapat dicobai (ID: `keyterm:NotTempted`); A Person (ID: `person:GenericPerson`); yang baik (ID: `keyterm:Good`); keselamatan (ID: `keyterm:Salvation`); kasihi (ID: `keyterm:Love`); hukum (ID: `keyterm:Law`); janji (ID: `keyterm:Promise`); tidak dicemarkan (ID: `keyterm:Undefiled`); kebenaran (ID: `keyterm:Truth`); kehidupan (ID: `keyterm:Life`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); berbuat dosa (ID: `keyterm:Sin`); hati (ID: `keyterm:Heart`); tak bernoda (ID: `keyterm:AboveCriticism`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** sia, sia (ID: `keyterm:Worthless`); suci (ID: `keyterm:Clean`); keahlian (ID: `keyterm:Ability`); hati (ID: `keyterm:Heart`); tidak dicemarkan (ID: `keyterm:Undefiled`); Tuhan (ID: `deity:Lord`); tak bernoda (ID: `keyterm:AboveCriticism`)
...
* **Associated ACAI Concepts:** tonton bulu atau muka (ID: `keyterm:Partiality`); percaya (ID: `keyterm:Believe`); kemuliaan (ID: `keyterm:Glory`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); tonton bulu atau muka (ID: `keyterm:Partiality`); kemuliaan (ID: `keyterm:Glory`); Yesus (ID: `person:Jesus.2`); bimbang (ID: `keyterm:Discern`); percaya (ID: `keyterm:Believe`); Seal (ID: `realia:Seal`); Synagogue (ID: `realia:Synagogue`); Footstool (ID: `realia:Footstool`)
...
* **Associated ACAI Concepts:** keahlian (ID: `keyterm:Ability`); kekasih (ID: `keyterm:Beloved`); kerajaan (ID: `keyterm:Kingdom`); kasihi (ID: `keyterm:Love`); janji (ID: `keyterm:Promise`); Tuhan (ID: `deity:Lord`); orang pilihan (ID: `keyterm:Chosen`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** kasihi (ID: `keyterm:Love`); hukum (ID: `keyterm:Law`); kitab suci (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); penghakiman (ID: `keyterm:Judgment`); tersandung (ID: `keyterm:Stumble`); tonton bulu atau muka (ID: `keyterm:Partiality`); persundalan (ID: `keyterm:Fornication`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`); kitab suci (ID: `keyterm:Scripture`); berbuat dosa (ID: `keyterm:Sin`); belas kasihan (ID: `keyterm:Mercy`); kasihi (ID: `keyterm:Love`); memutuskan (ID: `keyterm:Decided`); pengadilan (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); tubuh (ID: `keyterm:Body.3`); A Person (ID: `person:GenericPerson`); Tuhan (ID: `deity:Lord`); Abraham (ID: `person:Abraham`); sia, sia (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); memperdamaikan (ID: `keyterm:Peace`); hampa (ID: `keyterm:Empty`); An Angel (ID: `deity:Angel`); kitab suci (ID: `keyterm:Scripture`); Ishak (ID: `person:Isaac`); Demons (ID: `deity:Demons`); menggenapi (ID: `keyterm:Happen`); roh (ID: `keyterm:Spirit.2`); keselamatan (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); Tuhan (ID: `deity:Lord`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); sia, sia (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); hampa (ID: `keyterm:Empty`); An Angel (ID: `deity:Angel`); kitab suci (ID: `keyterm:Scripture`); Ishak (ID: `person:Isaac`); tubuh (ID: `keyterm:Body.3`); menggenapi (ID: `keyterm:Happen`); Tuhan (ID: `deity:Lord`); roh (ID: `keyterm:Spirit.2`)
...
* **Associated ACAI Concepts:** kitab suci (ID: `keyterm:Scripture`); Tuhan (ID: `deity:Lord`); Abraham (ID: `person:Abraham`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); percaya (ID: `keyterm:Believe`); menggenapi (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** Hell (ID: `place:Hell`); keahlian (ID: `keyterm:Ability`); neraka (ID: `keyterm:Gehenna`); lalim (ID: `keyterm:UnjustDeed`); tubuh (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); persahabatan (ID: `keyterm:Friendship`); tidak setia (ID: `keyterm:Unfaithful`); keahlian (ID: `keyterm:Ability`); Roh (ID: `deity:HolySpirit`); kitab suci (ID: `keyterm:Scripture`); membersihkan (ID: `keyterm:Cleanse.2`); hati (ID: `keyterm:Heart`); murni (ID: `keyterm:Pure`); kebaikan (ID: `keyterm:Favor`); roh (ID: `keyterm:Spirit.2`); ingin (ID: `keyterm:LongFor`); Cause of Joy (ID: `keyterm:CauseOfJoy`)
...
* **Associated ACAI Concepts:** Roh (ID: `deity:HolySpirit`); roh (ID: `keyterm:Spirit.2`); ingin (ID: `keyterm:LongFor`); kitab suci (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** memutuskan (ID: `keyterm:Decided`); hukum (ID: `keyterm:Law`); keselamatan (ID: `keyterm:Salvation`); pembuat hukum (ID: `keyterm:Lawgiver`)
...
* **Associated ACAI Concepts:** hati (ID: `keyterm:Heart`); tubuh (ID: `keyterm:Body.3`); bersaksi (ID: `keyterm:BearWitness`); Tuhan (ID: `deity:Lord`); menentang (ID: `keyterm:Condemn`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Ayub (ID: `person:Job`); penyayang (ID: `keyterm:Compassionate`); penuh belas kasihan (ID: `keyterm:FullOfCompassion`); Tuhan (ID: `deity:Lord`); menyebut berbahagia (ID: `keyterm:RegardAsHappy`)
...
* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); diurapi (ID: `keyterm:Anointed`); Tuhan (ID: `deity:Lord`); nama (ID: `keyterm:Name`); jemaat (ID: `keyterm:Church`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); mengampuni (ID: `keyterm:Forgive`); berbuat dosa (ID: `keyterm:Sin`); Tuhan (ID: `deity:Lord`); percaya (ID: `keyterm:Believe`); keselamatan (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Elia (ID: `person:Elijah`); berdoa (ID: `keyterm:Pray`)
