...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); إِلَى (ID: `person:Apphia`); إِلَى (ID: `person:Philemon`); لِأَرْخِبّسَ (ID: `person:Archippus`); بولسَ (ID: `person:Paul`); Church (ID: `keyterm:Church`); تِيموثَاوس (ID: `person:Timothy`); Favor (ID: `keyterm:Favor`); Make Peace (ID: `keyterm:Peace`); Beloved (ID: `keyterm:Beloved`); ٱلرَّبِّ (ID: `deity:Lord`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Believe (ID: `keyterm:Believe`); Holy (ID: `keyterm:Holy`); Love (ID: `keyterm:Love`); Pray (ID: `keyterm:Pray`); Ask for (ID: `keyterm:AskFor`); ٱلرَّبِّ (ID: `deity:Lord`); Good (ID: `keyterm:Good`); Fellowship (ID: `keyterm:Fellowship`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Affection (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Good (ID: `keyterm:Good`); Fellowship (ID: `keyterm:Fellowship`); يَسوع (ID: `person:Jesus.2`); Believe (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); بولسَ (ID: `person:Paul`); Ask for (ID: `keyterm:AskFor`); In Christ (ID: `keyterm:InChrist`); Love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); أَبَفْرَاسَ (ID: `person:Epaphras`); دِيمَاس (ID: `person:Demas`); لوقَا (ID: `person:Luke`); Favor (ID: `keyterm:Favor`); In Christ (ID: `keyterm:InChrist`); أَرِسْتَرْخسَ (ID: `person:Aristarchus`); مَرْقسَ (ID: `person:Mark`); Spirit (ID: `keyterm:Spirit.2`)
