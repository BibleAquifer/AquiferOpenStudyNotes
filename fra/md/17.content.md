...
* **Associated ACAI Concepts:** Cotton (ID: `flora:Cotton`); Bed (ID: `realia:Bed`); Money (ID: `realia:Money`); Linen (ID: `realia:Linen`); Rope (ID: `realia:Rope`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** Zéthar (ID: `person:Zethar`); Mehuman (ID: `person:Mehuman`); Carcas (ID: `person:Carkas`); Biztha (ID: `person:Biztha`); Bigtha (ID: `person:Bigtha`); Harbona (ID: `person:Harbona`); Abagtha (ID: `person:Abagtha`); Assuérus (ID: `person:Ahasuerus`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Vasthi (ID: `person:Vashti`); Perse (ID: `place:Persia`); Mède(s); Médie (ID: `group:Mede`); Assuérus (ID: `person:Ahasuerus`); Medan (ID: `person:Medan`); Perse (ID: `group:Persia`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Juda (ID: `person:Judah.4`); Babylone (ID: `place:Babylon`); Nebucadnetsar (ID: `person:Nebuchadnezzar`); Juda (ID: `group:Judah`); Jojakin (ID: `person:Jehoiachin`)
...
* **Associated ACAI Concepts:** Esther (ID: `person:Esther`); grâce (ID: `keyterm:Favor`); Vasthi (ID: `person:Vashti`); aimer (ID: `keyterm:Love`); bonté (ID: `keyterm:Kindness`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Mardochée (ID: `person:Mordecai.2`); Assuérus (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); Hammedatha (ID: `person:Hammedatha`); Agaguite (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Money (ID: `realia:Money`); Suse (ID: `place:Susa`); destin (ID: `keyterm:Lot`); Servants (ID: `group:GenericServants`); Lot (ID: `realia:Lot`); Scroll (ID: `realia:Scroll`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** Mardochée (ID: `person:Mordecai.2`); Assuérus (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); Haman (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Mardochée (ID: `person:Mordecai.2`); Zéresch (ID: `person:Zeresh`); aimer (ID: `keyterm:Love`); A Group of People (ID: `group:GenericGroup`); Esther (ID: `person:Esther`); gloire (ID: `keyterm:Glory`); Jews (ID: `group:Jews`); Cubit (ID: `realia:Cubit`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Esther (ID: `person:Esther`); Bed (ID: `realia:Bed`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Esther (ID: `person:Esther`); prier pour la pitié (ID: `keyterm:BegForMercy`); Agag (ID: `person:Agag.2`); Agaguite (ID: `group:Agag`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Mardochée (ID: `person:Mordecai.2`); Suse (ID: `place:Susa`); Crown (ID: `realia:Crown`); Linen (ID: `realia:Linen`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** Aspatha (ID: `person:Aspatha`); Parmaschtha (ID: `person:Parmashta`); Adalia (ID: `person:Adalia`); Vajezatha (ID: `person:Vaizatha`); Aridaï (ID: `person:Aridai`); Aridatha (ID: `person:Aridatha`); Poratha (ID: `person:Poratha`); Arizaï (ID: `person:Arisai`); Parschandatha (ID: `person:Parshandatha`); Dalphon (ID: `person:Dalphon`); Haman (ID: `person:Haman`); Hammedatha (ID: `person:Hammedatha`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Esther (ID: `person:Esther`); Suse (ID: `place:Susa`); Jews (ID: `group:Jews`); Haman (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Mardochée (ID: `person:Mordecai.2`); Assuérus (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); état intact (ID: `keyterm:IntactState`)
