...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); أورشَلِيمَ (ID: `place:Jerusalem`); Intention (ID: `keyterm:Intention`); Stupid (ID: `keyterm:Stupid`); ٱلرَّبِّ (ID: `deity:Lord`); Vine (ID: `flora:Vine`); إِسْرَائِيلَ (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); Vine (ID: `flora:Vine`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Wine (ID: `realia:Wine`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vow (ID: `keyterm:Vow`); House (ID: `realia:House`); Passion (ID: `keyterm:Ardour`); An Angel (ID: `deity:Angel`); A Man (ID: `person:GenericMale`); Slaughtering (ID: `keyterm:Slaughtering`); Fear (ID: `keyterm:Fear`); Strength (ID: `keyterm:Strength`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Stupid (ID: `keyterm:Stupid`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); To Cause to Possess (ID: `keyterm:Possess`); To Act Wickedly (ID: `keyterm:ActWickedly`); To Sin (ID: `keyterm:Sin`); Fear (ID: `keyterm:Fear`); Intention (ID: `keyterm:Intention`); Cooking Pot (ID: `realia:CookingPot`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Brier (ID: `flora:Brier`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Hell (ID: `place:Hell`); Ability (ID: `keyterm:Ability`); ٱلرَّبِّ (ID: `deity:Lord`); Strength (ID: `keyterm:Strength`); Intention (ID: `keyterm:Intention`); Love (ID: `keyterm:Love`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Caper (ID: `flora:Caper`); Locust (ID: `fauna:Locust`); Bird (ID: `fauna:Bird`); Rope (ID: `realia:Rope`); Money (ID: `realia:Money`); Pit (ID: `realia:Pit`); Clay Jar (ID: `realia:ClayJar`); Almond (ID: `flora:Almond`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); Fear (ID: `keyterm:Fear`); Proverb (ID: `keyterm:Saying`); Intention (ID: `keyterm:Intention`); Straightness (ID: `keyterm:Straightness`); Goad (ID: `realia:Goad`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Scroll (ID: `realia:Scroll`); Nail (ID: `realia:Nail`)
