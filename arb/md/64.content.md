...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); Beloved (ID: `keyterm:Beloved`); Live (ID: `keyterm:Live.3`); غَايوس (ID: `person:Gaius.4`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Pray (ID: `keyterm:Pray`); Bear Witness (ID: `keyterm:BearWitness`); Love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Beloved (ID: `keyterm:Beloved`); Obligated (ID: `keyterm:Ought`); ٱلرَّبِّ (ID: `deity:Lord`); Faithfulness (ID: `keyterm:Faithfulness`); Church (ID: `keyterm:Church`); Name (ID: `keyterm:Name`); Truth (ID: `keyterm:Truth`); Love (ID: `keyterm:Love`); Bear Witness (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** Church (ID: `keyterm:Church`); دِيوتْرِيفِسَ (ID: `person:Diotrephes`); دِيمِتْرِيوس (ID: `person:Demetrius`); Beloved (ID: `keyterm:Beloved`); ٱلرَّبِّ (ID: `deity:Lord`); True (ID: `keyterm:True`); Truth (ID: `keyterm:Truth`); Good (ID: `keyterm:Good`); Do Good (ID: `keyterm:DoGood`); Bear Witness (ID: `keyterm:BearWitness`)
