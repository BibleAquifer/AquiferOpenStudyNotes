...
* **Associated ACAI Concepts:** Ephrathites (ID: `group:Ephrathah`); Efrata (ID: `person:Ephrathah`); Mahlon (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Elimelekh (ID: `person:Elimelech`); Yehuda (ID: `group:Judah`); Mahlon (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Betlehem (ID: `place:Bethlehem`); Yehuda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); menugaskan (ID: `keyterm:Appoint`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Rut (ID: `person:Ruth`); Moab (ID: `place:Moab`); Betlehem (ID: `place:Bethlehem`); Naomi (ID: `person:Naomi`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Rut (ID: `person:Ruth`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); kebaikan (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); kebaikan (ID: `keyterm:Kindness`); memberkati (ID: `keyterm:Bless`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** menyebabkan memiliki (ID: `keyterm:Possess`); Rut (ID: `person:Ruth`); Mahlon (ID: `person:Mahlon`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Rahel (ID: `person:Rachel`); Tuhan (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); Israel (ID: `person:Israel`); Betlehem (ID: `place:Bethlehem`); Lea (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yehuda (ID: `group:Judah`); Tamar (ID: `person:Tamar`); Peres (ID: `person:Perez`); Yehuda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Tuhan (ID: `deity:Lord`); memberkati (ID: `keyterm:Bless`); Israel (ID: `person:Israel`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); memperanakkan (ID: `person:Salmon`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Isai (ID: `person:Jesse`); Nahason (ID: `person:Nahshon`); Boas (ID: `person:Boaz`); Daud (ID: `person:David`); Peres (ID: `person:Perez`)
