...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Filemom (ID: `person:Philemon`); Áfia (ID: `person:Apphia`); Arquipo (ID: `person:Archippus`); igreja (ID: `keyterm:Church`); SENHOR (ID: `deity:Lord`); Timóteo (ID: `person:Timothy`); fazer a paz (ID: `keyterm:Peace`); favor (ID: `keyterm:Favor`); amado (ID: `keyterm:Beloved`); Paulo (ID: `person:Paul`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`); holy (ID: `keyterm:Holy`); orar (ID: `keyterm:Pray`); comunhão (ID: `keyterm:Fellowship`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); compaixão (ID: `keyterm:Affection`); Cause of Joy (ID: `keyterm:CauseOfJoy`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Good (ID: `keyterm:Good`); crer (ID: `keyterm:Believe`); comunhão (ID: `keyterm:Fellowship`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Lucas (ID: `person:Luke`); Demas (ID: `person:Demas`); Epafras (ID: `person:Epaphras`); Aristarco (ID: `person:Aristarchus`); em cristo (ID: `keyterm:InChrist`); favor (ID: `keyterm:Favor`); Marcos (ID: `person:Mark`); Spirit (ID: `keyterm:Spirit.2`)
