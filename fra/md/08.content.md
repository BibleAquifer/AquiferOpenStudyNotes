...
* **Associated ACAI Concepts:** Èfratite; d'Èfrata (ID: `group:Ephrathah`); Éphrata (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Kiljon (ID: `person:Chilion`); Élimélec (ID: `person:Elimelech`); Juda (ID: `person:Judah.4`); Machlon (ID: `person:Mahlon`); Bethléhem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Juda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Boaz (ID: `person:Boaz`); laissiez en possession (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Bethléhem (ID: `place:Bethlehem`); Rachel (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); Éternel (ID: `deity:Lord`); Léa (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); benir (ID: `keyterm:Bless`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Salmon (ID: `person:Salmon`); Hetsron (ID: `person:Hezron.2`); Amminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Boaz (ID: `person:Boaz`); David (ID: `person:David`); Isaï (ID: `person:Jesse`); Perets (ID: `person:Perez`); Nahshon (ID: `person:Nahshon`)
