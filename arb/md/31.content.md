...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); أَدومَ (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أَدومَ (ID: `place:Edom`); عِيسو (ID: `place:EsauMount`); Understanding (ID: `keyterm:Understanding`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `group:Judah`); Lot (ID: `keyterm:Lot`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Dispossess (ID: `keyterm:Dispossess`); Edomites (ID: `group:Edom`); أَدومَ (ID: `place:Edom`); أورشَلِيمَ (ID: `place:Jerusalem`); يوسف (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Edomites (ID: `group:Edom`); ٱلرَّبِّ (ID: `deity:Lord`); أَدومَ (ID: `place:Edom`); يوسف (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); فِلِشْتِيم (ID: `group:Philistine`); سَارْدِسَ (ID: `place:Sardis`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); ٱلسَّهْلِ (ID: `place:Shephelah`); إِلَى (ID: `place:Zarephath`); جِلْعَادَ (ID: `place:Gilead`); إِسْرَائِيلَ (ID: `person:Israel`); Canaanites (ID: `group:Canaan`); ٱلسَّامِرَةِ (ID: `place:Samaria`); أورشَلِيمَ (ID: `place:Jerusalem`); أَفْرَايِمَ (ID: `person:Ephraim`); بَنْيَامِينَ (ID: `person:Benjamin`); عِيسو (ID: `place:EsauMount`); كَنْعَان (ID: `place:Canaan`); أَفْرَايِمَ (ID: `group:Ephraim`); بَنْيَامِينَ (ID: `group:Benjamin`)
...
* **Associated ACAI Concepts:** ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); أورشَلِيمَ (ID: `place:Jerusalem`); عِيسو (ID: `place:EsauMount`); فِلِشْتِيم (ID: `group:Philistine`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلسَّامِرَةِ (ID: `place:Samaria`); بَنْيَامِينَ (ID: `person:Benjamin`); سَارْدِسَ (ID: `place:Sardis`); إِلَى (ID: `place:Zarephath`); جِلْعَادَ (ID: `place:Gilead`); ٱلرَّبِّ (ID: `deity:Lord`); أَفْرَايِمَ (ID: `person:Ephraim`); أَفْرَايِمَ (ID: `group:Ephraim`); بَنْيَامِينَ (ID: `group:Benjamin`); ٱلسَّهْلِ (ID: `place:Shephelah`); Canaanites (ID: `group:Canaan`); كَنْعَان (ID: `place:Canaan`)
...
* **Associated ACAI Concepts:** سَارْدِسَ (ID: `place:Sardis`); ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); إِلَى (ID: `place:Zarephath`); إِسْرَائِيلَ (ID: `person:Israel`); Canaanites (ID: `group:Canaan`); كَنْعَان (ID: `place:Canaan`); أورشَلِيمَ (ID: `place:Jerusalem`)
