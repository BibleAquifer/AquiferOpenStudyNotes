...
* **Associated ACAI Concepts:** Chilion (ID: `person:Chilion`); Ephrathah (ID: `person:Ephrathah`); Ephrathites (ID: `group:Ephrathah`); Naomi (ID: `person:Naomi`); Elimelech (ID: `person:Elimelech`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Bethlehem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Mahlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Appoint (ID: `keyterm:Appoint`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Kindness (ID: `keyterm:Kindness`); LORD (ID: `deity:Lord`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Bethlehem (ID: `place:Bethlehem`); Naomi (ID: `person:Naomi`); Moab (ID: `place:Moab`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Favor (ID: `keyterm:Favor`); Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Kindness (ID: `keyterm:Kindness`); Bless (ID: `keyterm:Bless`); LORD (ID: `deity:Lord`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** To Cause to Possess (ID: `keyterm:Possess`); Ruth (ID: `person:Ruth`); Mahlon (ID: `person:Mahlon`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Bethlehem (ID: `place:Bethlehem`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Leah (ID: `person:Leah`); Elders (ID: `group:GenericElders`); Rachel (ID: `person:Rachel`)
...
* **Associated ACAI Concepts:** Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Perez (ID: `person:Perez`); LORD (ID: `deity:Lord`); Tamar (ID: `person:Tamar`)
...
* **Associated ACAI Concepts:** Boaz (ID: `person:Boaz`); Ruth (ID: `person:Ruth`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Obed (ID: `person:Obed`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Jesse (ID: `person:Jesse`); Perez (ID: `person:Perez`); David (ID: `person:David`); Boaz (ID: `person:Boaz`); Nahshon (ID: `person:Nahshon`)
