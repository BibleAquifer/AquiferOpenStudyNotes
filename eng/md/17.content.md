...
* **Associated ACAI Concepts:** Harbona (ID: `person:Harbona`); Mehuman (ID: `person:Mehuman`); Zethar (ID: `person:Zethar`); Biztha (ID: `person:Biztha`); Carkas (ID: `person:Carkas`); Bigtha (ID: `person:Bigtha`); Abagtha (ID: `person:Abagtha`); Ahasuerus (ID: `person:Ahasuerus`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Vashti (ID: `person:Vashti`); Persians (ID: `group:Persia`); Medan (ID: `person:Medan`); Medes (ID: `group:Mede`); Ahasuerus (ID: `person:Ahasuerus`); Persia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Babylon (ID: `place:Babylon`); Tribe of Judah (ID: `group:Judah`); Jehoiachin (ID: `person:Jehoiachin`); Jerusalem (ID: `place:Jerusalem`); Judah (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Ahasuerus (ID: `person:Ahasuerus`); Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Agagites (ID: `group:Agag`); Hammedatha (ID: `person:Hammedatha`); Agag (ID: `person:Agag.2`); Money (ID: `realia:Money`); Servants (ID: `group:GenericServants`); Lot (ID: `keyterm:Lot`); Susa (ID: `place:Susa`); Scroll (ID: `realia:Scroll`); Talent (ID: `realia:Talent`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** Zeresh (ID: `person:Zeresh`); Love (ID: `keyterm:Love`); Haman (ID: `person:Haman`); A Group of People (ID: `group:GenericGroup`); Mordecai (ID: `person:Mordecai.2`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Zeresh (ID: `person:Zeresh`); Love (ID: `keyterm:Love`); Haman (ID: `person:Haman`); A Group of People (ID: `group:GenericGroup`); Jews (ID: `group:Jews`); Mordecai (ID: `person:Mordecai.2`)
...
* **Associated ACAI Concepts:** To Beg for Mercy (ID: `keyterm:BegForMercy`); Haman (ID: `person:Haman`); Agagites (ID: `group:Agag`); Esther (ID: `person:Esther`); Agag (ID: `person:Agag.2`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Haman (ID: `person:Haman`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Jews (ID: `group:Jews`); Favor (ID: `keyterm:Favor`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Lot (ID: `realia:Lot`); Hammedatha (ID: `person:Hammedatha`); Haman (ID: `person:Haman`); Agagites (ID: `group:Agag`); Lot (ID: `keyterm:Lot`); Agag (ID: `person:Agag.2`); Mordecai (ID: `person:Mordecai.2`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Esther (ID: `person:Esther`); Jews (ID: `group:Jews`); Mordecai (ID: `person:Mordecai.2`); Scroll (ID: `realia:Scroll`); Abihail (ID: `person:Abihail.5`); Peace (ID: `keyterm:IntactState`); Truth (ID: `keyterm:Truth`); Ahasuerus (ID: `person:Ahasuerus`)
...
* **Associated ACAI Concepts:** Peace (ID: `keyterm:IntactState`); Ahasuerus (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); Mordecai (ID: `person:Mordecai.2`)
