...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); ٱلرَّبِّ (ID: `deity:Lord`); إِرْمِيَا (ID: `person:Jeremiah.6`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); إِسْرَائِيلَ (ID: `person:Israel`); إِرْمِيَا (ID: `person:Jeremiah.6`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); فَارِسَ (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); لَّاوِي (ID: `group:Levi`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `group:Benjamin`); لَّاوِي (ID: `person:Levi.3`); بَنْيَامِينَ (ID: `person:Benjamin`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); أورشَلِيمَ (ID: `place:Jerusalem`); كورَشَ (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); كورَشَ (ID: `person:Cyrus`); زَربَّابِل (ID: `person:Zerubbabel.2`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); سلَيْمَانَ (ID: `person:Solomon`); طوبِيَّا (ID: `person:Tobiah`); رَحوم (ID: `person:Rehum`); رَآيَا (ID: `person:Reaiah.3`); Pahath-moab (ID: `person:Pahath-moab`); آطِيرَ (ID: `person:Ater.2`); جَدِّيلَ (ID: `person:Giddel.2`); بِغْوَايَ (ID: `person:Bigvai.2`); حَرْحورَ (ID: `person:Harhur`); Beth-azmaveth (ID: `place:Beth-azmaveth`); مِسْفَار (ID: `person:Mispar`); آرَحَ (ID: `person:Arah.2`); بَانِيَ (ID: `person:Bani`); عَادِينَ (ID: `person:Adin`); جَدِّيلَ (ID: `person:Giddel`); فِي (ID: `person:Uzza.2`); لَبَانَةَ (ID: `person:Lebanah`); حَجَابَةَ (ID: `person:Hagabah`); عَقّوب (ID: `person:Akkub.3`); فَرْعوشَ (ID: `person:Parosh`); طَبَاعوتَ (ID: `person:Tabbaoth`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); بَابَايَ (ID: `person:Bebai`); بِغْوَايَ (ID: `person:Bigvai`); نَبو (ID: `place:Nebo.2`)
...
* **Associated ACAI Concepts:** سَرَايَا (ID: `person:Seraiah.6`); مِسْفَار (ID: `person:Mispar`); رَحوم (ID: `person:Rehum`); مرْدَخَاي (ID: `person:Mordecai`); بِلْشَان (ID: `person:Bilshan`); بِغْوَايَ (ID: `person:Bigvai`); نَحَمْيَا (ID: `person:Nehemiah`); رَعْلَايَا (ID: `person:Reelaiah`); بَعْنَةَ (ID: `person:Baanah.3`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** حَزَقِيَّا (ID: `person:Hezekiah.2`); Pahath-moab (ID: `person:Pahath-moab`); بِيصَايَ (ID: `person:Bezai`); بِغْوَايَ (ID: `person:Bigvai.2`); آرَحَ (ID: `person:Arah.2`); بَانِيَ (ID: `person:Bani`); عَادِينَ (ID: `person:Adin`); يوآب (ID: `person:Joab.3`); زَتّو (ID: `person:Zattu.2`); عِيلَامَ (ID: `person:Elam`); فَرْعوشَ (ID: `person:Parosh`); زَكَّايَ (ID: `person:Zaccai.2`); عَرْجَدَ (ID: `person:Azgad`); بَابَايَ (ID: `person:Bebai`); شَفَطْيَا (ID: `person:Shephatiah.6`); أَدونِيقَامَ (ID: `person:Adonikam`); آطِيرَ (ID: `person:Ater`); يورَةَ (ID: `person:Jorah`); يَشوعَ (ID: `person:Jeshua.3`); حَشوم (ID: `person:Hashum`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** سَنَاءَةَ (ID: `place:Senaah`); Beth-azmaveth (ID: `place:Beth-azmaveth`); حَادِيدَ (ID: `place:Hadid`); مَغْبِيشَ (ID: `place:Magbish`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); حَارِيمَ (ID: `person:Harim.2`); نَبو (ID: `place:Nebo.2`); بَئِيروت (ID: `place:Beeroth`); Ramah (ID: `place:Ramah.2`); أَرِيحَا (ID: `place:Jericho`); مِخْمَاسَ (ID: `place:Michmash`); عِيلَامَ (ID: `person:Elam`); Kiriath-jearim (ID: `place:Kiriath-jearim`); وَلودَ (ID: `place:Lod`); مِنْ (ID: `place:Geba`); لَحْمٍ (ID: `place:Bethlehem`); عَايٍ (ID: `place:Ai`); ٱلْكَفِيرَة (ID: `place:Chephirah`); Bethel (ID: `place:Bethel`); عَنَاثوثَ (ID: `place:Anathoth`); أونوَ (ID: `place:Ono`)
...
* **Associated ACAI Concepts:** شوبَايَ (ID: `person:Shobai`); هودَوْيَا (ID: `person:Hodaviah.4`); يَدَايَا (ID: `person:Jedaiah.4`); طَلْمون (ID: `person:Talmon`); حَارِيمَ (ID: `person:Harim`); يَشوعَ (ID: `person:Jeshua`); لِإِيمِيرَ (ID: `person:Immer.2`); آطِيرَ (ID: `person:Ater.2`); حَطِيطَا (ID: `person:Hatita`); يَشوعَ (ID: `person:Jeshua.4`); شَلّوم (ID: `person:Shallum.8`); لَّاوِي (ID: `group:Levi`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`); فَشْحور (ID: `person:Pashhur`); لَّاوِي (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** طَلْمون (ID: `person:Talmon`); آطِيرَ (ID: `person:Ater.2`); حَطِيطَا (ID: `person:Hatita`); شوبَايَ (ID: `person:Shobai`); شَلّوم (ID: `person:Shallum.8`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** قِيروسَ (ID: `person:Keros`); بَصْلوتَ (ID: `person:Bazluth`); رَآيَا (ID: `person:Reaiah.3`); حَاجَابَ (ID: `person:Hagab`); جَزَّامَ (ID: `person:Gazzam`); Meunim (ID: `group:Meunim`); مَحِيدَا (ID: `person:Mehida`); حَرْحورَ (ID: `person:Harhur`); فَاسِيحَ (ID: `person:Paseah.2`); نَصِيحَ (ID: `person:Neziah`); جَدِّيلَ (ID: `person:Giddel`); فِي (ID: `person:Uzza.2`); لَبَانَةَ (ID: `person:Lebanah`); رَصِينَ (ID: `person:Rezin.2`); حَجَابَةَ (ID: `person:Hagabah`); عَقّوب (ID: `person:Akkub.3`); سِيعَهَا (ID: `person:Siaha`); سِيسَرَا (ID: `person:Sisera.2`); نَقودَا (ID: `person:Nekoda`); أَسْنَةَ (ID: `person:Asnah`); طَبَاعوتَ (ID: `person:Tabbaoth`); فَادونَ (ID: `person:Padon`); سَلْمَايَ (ID: `person:Shalmai`); Nephushesim (ID: `group:Nephushesim`); صِيحَا (ID: `person:Ziha`); ثَامَحَ (ID: `person:Temah`); جَاحَرَ (ID: `person:Gahar`); حَطِيفَا (ID: `person:Hatipha`); بِيسَايَ (ID: `person:Besai`); بَرْقوسَ (ID: `person:Barkos`); حَرْشَا (ID: `person:Harsha`); حَانَان (ID: `person:Hanan.4`); بَقْبوقَ (ID: `person:Bakbuk`); حَسوفَا (ID: `person:Hasupha`); حَقوفَا (ID: `person:Hakupha`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); حَطِّيلَ (ID: `person:Hattil`); شَفَطْيَا (ID: `person:Shephatiah.7`); سَوْطَايَ (ID: `person:Sotai`); جَدِّيلَ (ID: `person:Giddel.2`); سوفَرَثَ (ID: `person:Sophereth`); دَرْقونَ (ID: `person:Darkon`); يَعْلَةَ (ID: `person:Jaalah`); فَرودَا (ID: `person:Peruda`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); آمِي (ID: `person:Ami`)
...
* **Associated ACAI Concepts:** طوبِيَّا (ID: `person:Tobiah`); أَدَّان (ID: `place:Addan`); Tel-melah (ID: `place:Tel-melah`); لِدَلَايَا (ID: `person:Delaiah.3`); نَقودَا (ID: `person:Nekoda.2`); كَروب (ID: `place:Cherub`); لِإِيمِيرَ (ID: `place:Immer`); Tel-harsha (ID: `place:Tel-harsha`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** هَقّوصَ (ID: `person:Hakkoz.2`); بَرْزِلَّايَ (ID: `person:Barzillai.3`); حَبَايَا (ID: `person:Habaiah`); جِلْعَادَ (ID: `place:Gilead`); Priesthood (ID: `keyterm:Priesthood`); Defile (ID: `keyterm:Stain`); بَرْزِلَّايَ (ID: `person:Barzillai`); Gileadites (ID: `group:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); Strength (ID: `keyterm:Strength`); House (ID: `realia:House`); Money (ID: `realia:Money`); Tunic (ID: `realia:Tunic`); Mina (ID: `realia:Mina`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); يَشوع (ID: `person:Joshua.5`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Relatives (ID: `group:Relatives`); هودَوْيَا (ID: `person:Hodaviah.4`); حِينَادَادَ (ID: `person:Henadad`); يَشوعَ (ID: `person:Jeshua.4`); Esarhaddon (ID: `person:Esarhaddon`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); بَنْيَامِينَ (ID: `group:Benjamin`); دَارِيوسَ (ID: `person:Darius.2`); Terror (ID: `keyterm:Terror`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Tyrians (ID: `group:Tyre`); لبْنَانَ (ID: `place:Lebanon`); Instruction (ID: `keyterm:Instruction`); آسَاف (ID: `person:Asaph.2`); Appointed Feast (ID: `keyterm:AppointedFeast`); Assyria (ID: `place:Assyria`); دَاودَ (ID: `person:David`); صِيْدونَ (ID: `place:Sidon`); صورَ (ID: `place:Tyre`); هودِيَّا (ID: `person:Hodiah.2`); يَافَا (ID: `place:Joppa`); Kindness (ID: `keyterm:Kindness`); Counsel (ID: `keyterm:Counsel`); بَنْيَامِينَ (ID: `person:Benjamin`); موسَى (ID: `person:Moses`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Holy (ID: `keyterm:Holy`); Sidonians (ID: `group:Sidon`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Cymbals (ID: `realia:Cymbals`); Trumpet (ID: `realia:Trumpet`); Cedar (ID: `flora:Cedar`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَشوع (ID: `person:Joshua.5`); ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Instruction (ID: `keyterm:Instruction`); موسَى (ID: `person:Moses`); إِسْرَائِيلَ (ID: `person:Israel`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Appointed Feast (ID: `keyterm:AppointedFeast`); Holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** Tyrians (ID: `group:Tyre`); لبْنَانَ (ID: `place:Lebanon`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); صِيْدونَ (ID: `place:Sidon`); صورَ (ID: `place:Tyre`); يَافَا (ID: `place:Joppa`); Sidonians (ID: `group:Sidon`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Cedar (ID: `flora:Cedar`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوصَادِقَ (ID: `person:Jehozadak`); لَّاوِي (ID: `group:Levi`); أورشَلِيمَ (ID: `place:Jerusalem`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَشوع (ID: `person:Joshua.5`); لَّاوِي (ID: `person:Levi.3`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `group:Levi`); آسَاف (ID: `person:Asaph.2`); دَاودَ (ID: `person:David`); لَّاوِي (ID: `person:Levi.3`); Kindness (ID: `keyterm:Kindness`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); بَنْيَامِينَ (ID: `group:Benjamin`); إِسْرَائِيلَ (ID: `person:Israel`); بَنْيَامِينَ (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); ٱلرَّبِّ (ID: `deity:Lord`); كورَشَ (ID: `person:Cyrus`); زَربَّابِل (ID: `person:Zerubbabel.2`); فَارِسَ (ID: `place:Persia`); يَشوع (ID: `person:Joshua.5`); إِسْرَائِيلَ (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Jews (ID: `group:Jews`); فَارِسَ (ID: `place:Persia`); طَبْئِيل (ID: `person:Tabeel`); مِثْرَدَاث (ID: `person:Mithredath.2`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); Babylonians (ID: `group:Babylon`); أسْنَفَّر (ID: `person:Osnappar`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); بِشْلَام (ID: `person:Bishlam`); أَرَكَ (ID: `place:Erech`); بَابِلَ (ID: `place:Babylon`); Persians (ID: `group:Persia`); فِي (ID: `place:Susa`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Elamites (ID: `group:Elam`); عِيلَامَ (ID: `place:Elam`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** شِمْشَاي (ID: `person:Shimshai`); Babylonians (ID: `group:Babylon`); رَحوم (ID: `person:Rehum.2`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); أَرَكَ (ID: `place:Erech`); عِيلَامَ (ID: `place:Elam`); بَابِلَ (ID: `place:Babylon`); Persians (ID: `group:Persia`); فَارِسَ (ID: `place:Persia`); Elamites (ID: `group:Elam`); فِي (ID: `place:Susa`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); شِمْشَاي (ID: `person:Shimshai`); Jews (ID: `group:Jews`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); ٱلسَّامِرَةِ (ID: `place:Samaria`); رَحوم (ID: `person:Rehum.2`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); دَارِيوسَ (ID: `person:Darius.2`); زَكَرِيَّا (ID: `person:Zechariah.17`); تَتْنَاي (ID: `person:Tattenai`); حَجَّيِ (ID: `person:Haggai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); يَدّو (ID: `person:Iddo.6`); يَهوذَا (ID: `person:Judah.4`); يَهوصَادِقَ (ID: `person:Jehozadak`); فَارِسَ (ID: `place:Persia`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلْفرَاتِ (ID: `place:Euphrates`)
...
* **Associated ACAI Concepts:** زَكَرِيَّا (ID: `person:Zechariah.17`); حَجَّيِ (ID: `person:Haggai`); يَدّو (ID: `person:Iddo.6`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); Jews (ID: `group:Jews`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); أورشَلِيمَ (ID: `place:Jerusalem`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَشوع (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); بَابِلَ (ID: `place:Babylon`); أورشَلِيمَ (ID: `place:Jerusalem`); كورَشَ (ID: `person:Cyrus`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); زَربَّابِل (ID: `person:Zerubbabel.2`); دَارِيوسَ (ID: `person:Darius.2`); تَتْنَاي (ID: `person:Tattenai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); يَهوذَا (ID: `person:Judah.4`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); ٱلْفرَاتِ (ID: `place:Euphrates`); Money (ID: `realia:Money`); Foundation (ID: `realia:Foundation`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); بَابِلَ (ID: `place:Babylon`); كورَشَ (ID: `person:Cyrus`); زَربَّابِل (ID: `person:Zerubbabel.2`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); كورَشَ (ID: `person:Cyrus`); House (ID: `realia:House`); Foundation (ID: `realia:Foundation`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `group:Levi`); أورشَلِيمَ (ID: `place:Jerusalem`); موسَى (ID: `person:Moses`); لَّاوِي (ID: `person:Levi.3`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Gentiles (ID: `group:Gentile`); Defilement (ID: `keyterm:Defilement`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** سَرَايَا (ID: `person:Seraiah.2`); عَزَرْيَا (ID: `person:Azariah.7`); عَزْرَا (ID: `person:Ezra`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); حِلْقِيَّا (ID: `person:Hilkiah.2`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); عَزَرْيَا (ID: `person:Azariah.7`); بقِّي (ID: `person:Bukki.2`); أَبِيشوعَ (ID: `person:Abishua`); أَخِيطوبَ (ID: `person:Ahitub.3`); شَلّوم (ID: `person:Shallum.7`); عزِّي (ID: `person:Uzzi`); لِمَرَايوثَ (ID: `person:Meraioth`); أَمَرْيَا (ID: `person:Amariah.2`); صَادوق (ID: `person:Zadok.4`); سَرَايَا (ID: `person:Seraiah.2`); زَرَحْيَا (ID: `person:Zerahiah`); عَزَرْيَا (ID: `person:Azariah.6`); حِلْقِيَّا (ID: `person:Hilkiah.2`); هَارون (ID: `person:Aaron`); فِينَحَاس (ID: `person:Phinehas`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فَارِسَ (ID: `place:Persia`); أَلِعَازَار (ID: `person:Eleazar.2`)
...
* **Associated ACAI Concepts:** Decree (ID: `keyterm:Decree`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); عَزْرَا (ID: `person:Ezra`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); ٱلْفرَاتِ (ID: `place:Euphrates`); Decree (ID: `keyterm:Decree`); ٱلرَّبِّ (ID: `deity:Lord`); بَابِلَ (ID: `place:Babylon`); يَهوذَا (ID: `person:Judah.4`); Stone Altar (ID: `realia:StoneAltar`); Anointing Oil (ID: `realia:AnointingOil`); Talent (ID: `realia:Talent`); Wheat (ID: `flora:Wheat`); Sheep (ID: `fauna:Lamb`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Olive Oil (ID: `realia:OliveOil`); Altar (ID: `realia:Altar`); Kor (ID: `realia:Kor`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); عَزْرَا (ID: `person:Ezra`); ٱلْفرَاتِ (ID: `place:Euphrates`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Talent (ID: `realia:Talent`); Wheat (ID: `flora:Wheat`); Kor (ID: `realia:Kor`)
...
* **Associated ACAI Concepts:** يوشَفْيَا (ID: `person:Josiphiah`); عَثَلْيَا (ID: `person:Athaliah.3`); Pahath-moab (ID: `person:Pahath-moab`); دَانِيآل (ID: `person:Daniel.2`); شَكَنْيَا (ID: `person:Shecaniah.6`); زَبَدْيَا (ID: `person:Zebadiah.8`); بِغْوَايَ (ID: `person:Bigvai.2`); بَابَايَ (ID: `person:Bebai.2`); شِمْعِيَا (ID: `person:Shemaiah.14`); عَادِينَ (ID: `person:Adin`); يوآب (ID: `person:Joab.4`); أَلِيفَلَط (ID: `person:Eliphelet.5`); يِشْعِيَا (ID: `person:Jeshaiah.4`); زَكَرِيَّا (ID: `person:Zechariah.18`); عِيلَامَ (ID: `person:Elam`); شَلومِيَةَ (ID: `person:Shelomith.4`); زَرَحْيَا (ID: `person:Zerahiah.2`); هِقَّاطَانَ (ID: `person:Hakkatan`); عَرْجَدَ (ID: `person:Azgad`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); عوتَاي (ID: `person:Uthai.2`); Gershom (ID: `person:Gershom.2`); زَكّور (ID: `person:Zaccur.5`); بَابَايَ (ID: `person:Bebai`); زَكَرِيَّا (ID: `person:Zechariah.19`); يَحْزِيئِيل (ID: `person:Jahaziel.5`); يَحِيئِيل (ID: `person:Jehiel.7`); شَكَنْيَا (ID: `person:Shecaniah.5`); يَعِيئِيل (ID: `person:Jeuel.3`); فَرْعوشَ (ID: `person:Parosh.2`); شَفَطْيَا (ID: `person:Shephatiah.6`); مِيخَائِيلَ (ID: `person:Michael.10`); أَدونِيقَامَ (ID: `person:Adonikam`); يوحَانَانَ (ID: `person:Johanan.8`); عوبَدْيَا (ID: `person:Obadiah.10`); يونَاثَانَ (ID: `person:Jonathan.9`); حَطّوش (ID: `person:Hattush.2`); عَابِد (ID: `person:Ebed.2`); فِينَحَاس (ID: `person:Phinehas`); إِيثَامَارَ (ID: `person:Ithamar`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); بَابِلَ (ID: `place:Babylon`); دَاودَ (ID: `person:David`)
...
* **Associated ACAI Concepts:** ٱلْمسَمَّى (ID: `place:Casiphia`); مَشلَّام (ID: `person:Meshullam.9`); زَكَرِيَّا (ID: `person:Zechariah.20`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); يَارِيبَ (ID: `person:Jarib.2`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); شِمْعِيَا (ID: `person:Shemaiah.15`); أَرِيئِيلَ (ID: `person:Ariel`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); يويَارِيبَ (ID: `person:Joiarib.2`); يَدّو (ID: `person:Iddo`); أَلِيعَزَرَ (ID: `person:Eliezer.8`); نَاثَان (ID: `person:Nathan.5`); ٱلرَّبِّ (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); ٱلرَّبِّ (ID: `deity:Lord`); مَحْلِي (ID: `person:Mahli`); لَّاوِي (ID: `group:Levi`); Insight (ID: `keyterm:Insight`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); Canaanites (ID: `group:Canaan`); لَّاوِي (ID: `group:Levi`); كَنْعَان (ID: `place:Canaan`); Amorites (ID: `group:Amorites`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); Egyptians (ID: `group:Egypt`); Jebusites (ID: `group:Jebusites`); موآبَ (ID: `place:Moab`); حِثًّا (ID: `person:Heth`); إِسْرَائِيلَ (ID: `person:Israel`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `person:Levi.3`); مِصْرَ (ID: `place:Egypt`); Ammonites (ID: `group:Ammon`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); Counsel (ID: `keyterm:Counsel`); يَهوذَا (ID: `group:Judah`); عِيلَامَ (ID: `person:Elam`); يَهوذَا (ID: `person:Judah.4`); Offering (ID: `keyterm:Offering`); مِيَّامِين (ID: `person:Mijamin.2`); شَلَمْيَا (ID: `person:Shelemiah.2`); نَاثَان (ID: `person:Nathan.6`); مَلْكِيَّا (ID: `person:Malchijah.4`); أَلِيوعِينَاي (ID: `person:Elioenai.5`); Hittites (ID: `group:Hittite`); أَلِيعَزَرَ (ID: `person:Eliezer.11`); شِمْعون (ID: `person:Shimeon`); بِيدْيَا (ID: `person:Bedeiah`); أَلِيوعِينَاي (ID: `person:Elioenai.4`); عَثْلَاي (ID: `person:Athlai`); بَانِيَ (ID: `person:Bani`); يَارِيبَ (ID: `person:Jarib.3`); يَعْسو (ID: `person:Jaasu`); عَدَايَا (ID: `person:Adaiah.5`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); Plea for Mercy (ID: `keyterm:Supplication`); أورشَلِيمَ (ID: `place:Jerusalem`); To Cause to Possess (ID: `keyterm:Possess`); Defilement (ID: `keyterm:Defilement`); فَارِسَ (ID: `place:Persia`); Dispossess (ID: `keyterm:Dispossess`); إِسْرَائِيلَ (ID: `person:Israel`); Peace (ID: `keyterm:IntactState`); Kindness (ID: `keyterm:Kindness`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); أورشَلِيمَ (ID: `place:Jerusalem`); فَارِسَ (ID: `place:Persia`); Kindness (ID: `keyterm:Kindness`); Plea for Mercy (ID: `keyterm:Supplication`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `group:Benjamin`); بَنْيَامِينَ (ID: `person:Benjamin`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** تِقْوَةَ (ID: `person:Tikvah.2`); يونَاثَانَ (ID: `person:Jonathan.10`); يَحْزِيَا (ID: `person:Jahzeiah`); مَشلَّام (ID: `person:Meshullam.10`); عَسَائِيل (ID: `person:Asahel.4`); شَبْتَاي (ID: `person:Shabbethai`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`)
