...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); Israël (ID: `person:Israel`); Édom (ID: `group:Edom`); Éternel (ID: `deity:Lord`); Édom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); gloire (ID: `keyterm:Glory`); Éternel (ID: `deity:Lord`); Priests (ID: `group:GenericPriests`); craindre (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); alliance (ID: `keyterm:Covenant`); offrande (ID: `keyterm:Offering`); craindre (ID: `keyterm:Fear`); pleurer (ID: `keyterm:Curse`); état intact (ID: `keyterm:IntactState`); Priests (ID: `group:GenericPriests`); Lévi (ID: `group:Levi`); gloire (ID: `keyterm:Glory`); souiller (ID: `keyterm:Stain`); Lévi (ID: `person:Levi.3`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); niveau (ID: `keyterm:Fairness`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); faire un voeu (ID: `keyterm:Vow`); profaner, déshonorer (ID: `keyterm:Dishonor`); la connaissance (ID: `keyterm:Intention`); chemin (ID: `keyterm:TheWay`); An Angel (ID: `deity:Angel`); benir (ID: `keyterm:Bless`); vérité (ID: `keyterm:Truth`); agir avec bonté (ID: `keyterm:KindlyDisposed`); nation; peuple (ID: `group:Gentile`); ardeur (ID: `keyterm:Ardour`); sans saleté (ID: `keyterm:Pure`); prier (ID: `keyterm:AskFor`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** souiller (ID: `keyterm:Stain`); Éternel (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** profaner, déshonorer (ID: `keyterm:Dishonor`); Éternel (ID: `deity:Lord`); souiller (ID: `keyterm:Stain`)
...
* **Associated ACAI Concepts:** pleurer (ID: `keyterm:Curse`); Éternel (ID: `deity:Lord`); faire un voeu (ID: `keyterm:Vow`); craindre (ID: `keyterm:Fear`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** benir (ID: `keyterm:Bless`); pleurer (ID: `keyterm:Curse`); Éternel (ID: `deity:Lord`); gloire (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); alliance (ID: `keyterm:Covenant`); offrande (ID: `keyterm:Offering`); profaner, déshonorer (ID: `keyterm:Dishonor`); aimer (ID: `keyterm:Love`); délice (ID: `keyterm:Delight`); Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `person:Judah.4`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); Israël (ID: `person:Israel`); profaner, déshonorer (ID: `keyterm:Dishonor`); Éternel (ID: `deity:Lord`); Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); offrande (ID: `keyterm:Offering`); alliance (ID: `keyterm:Covenant`); jurer (ID: `keyterm:Swear`); An Angel (ID: `deity:Angel`); A Group of People (ID: `group:GenericGroup`); Juda (ID: `group:Judah`); Lévi (ID: `person:Levi.3`); sans saleté (ID: `keyterm:Pure`); Jérusalem (ID: `place:Jerusalem`); Lévi (ID: `group:Levi`); craindre (ID: `keyterm:Fear`); Juda (ID: `person:Judah.4`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); pleurer (ID: `keyterm:Curse`); offrande (ID: `keyterm:Offering`); Israël (ID: `person:Israel`); benir (ID: `keyterm:Bless`); limite (ID: `keyterm:Decree`); Sorghum (ID: `flora:Sorghum`); Wheat (ID: `flora:Wheat`); Vine (ID: `flora:Vine`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** montagne de Sinaï (ID: `place:SinaiMount`); Israël (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); Moïse (ID: `person:Moses`); limite (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** montagne de Sinaï (ID: `place:SinaiMount`); Israël (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); Éternel (ID: `deity:Lord`); Moïse (ID: `person:Moses`); Élie (ID: `person:Elijah`); limite (ID: `keyterm:Decree`); craindre (ID: `keyterm:Fear`); objet qui doit être détruit (ID: `keyterm:SomethingDevotedToGod`)
