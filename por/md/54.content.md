...
* **Associated ACAI Concepts:** Paulo (ID: `person:Paul`); Jesus (ID: `person:Jesus.2`); salvador (ID: `keyterm:Savior`); SENHOR (ID: `deity:Lord`); hope (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Timóteo (ID: `person:Timothy`); Paulo (ID: `person:Paul`); favor (ID: `keyterm:Favor`); misericórdia (ID: `keyterm:Mercy`); crer (ID: `keyterm:Believe`); fazer a paz (ID: `keyterm:Peace`); salvador (ID: `keyterm:Savior`); hope (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** Timóteo (ID: `person:Timothy`); favor (ID: `keyterm:Favor`); misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); fazer a paz (ID: `keyterm:Peace`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); lei (ID: `keyterm:Law`); SENHOR (ID: `deity:Lord`); sem lei (ID: `keyterm:Lawless`); opposite of holy: profane (ID: `keyterm:Profane`); bem, aventurado (ID: `keyterm:Happy`); be (or show oneself) just (ID: `keyterm:Just`); Good (ID: `keyterm:Good`); corretamente (ID: `keyterm:Lawfully`); Glory (ID: `keyterm:Glory`); palavreado vazio (ID: `keyterm:EmptyTalk`); limpo (ID: `keyterm:Clean`); boa notícia (ID: `keyterm:GoodNews`); sem hipocrisia (ID: `keyterm:Unhypocritical`); love (ID: `keyterm:Love`); consciência (ID: `keyterm:Conscience`); rogar (ID: `keyterm:AskFor`); Éfeso (ID: `place:Ephesus`); Macedônia (ID: `place:Macedonia`); coração (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** consciência (ID: `keyterm:Conscience`); limpo (ID: `keyterm:Clean`); Good (ID: `keyterm:Good`); sem hipocrisia (ID: `keyterm:Unhypocritical`); crer (ID: `keyterm:Believe`); love (ID: `keyterm:Love`); coração (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); sem lei (ID: `keyterm:Lawless`); opposite of holy: profane (ID: `keyterm:Profane`); Glory (ID: `keyterm:Glory`); palavreado vazio (ID: `keyterm:EmptyTalk`); boa notícia (ID: `keyterm:GoodNews`); bem, aventurado (ID: `keyterm:Happy`); be (or show oneself) just (ID: `keyterm:Just`); corretamente (ID: `keyterm:Lawfully`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); boa notícia (ID: `keyterm:GoodNews`); bem, aventurado (ID: `keyterm:Happy`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Faithfulness (ID: `keyterm:Faithfulness`); favor (ID: `keyterm:Favor`); misericórdia (ID: `keyterm:Mercy`); para a eternidade (ID: `keyterm:Always`); crer (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`); imortal (ID: `keyterm:Imperishable`); salvation (ID: `keyterm:Salvation`); Glory (ID: `keyterm:Glory`); surely! (ID: `keyterm:Surely`); não crer (ID: `keyterm:Disbelieve`); Life (ID: `keyterm:Life`); em cristo (ID: `keyterm:InChrist`); blasfemo (ID: `keyterm:Blasphemous`); servir (ID: `keyterm:Serve`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Alexandre (ID: `person:Alexander.4`); Himeneu (ID: `person:Hymenaeus`); consciência (ID: `keyterm:Conscience`); blasfemar (ID: `keyterm:Blaspheme`); Timóteo (ID: `person:Timothy`); Satanás (ID: `deity:Satan`); Good (ID: `keyterm:Good`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); SENHOR (ID: `deity:Lord`); Daily Life (ID: `keyterm:DailyLife`); orar (ID: `keyterm:Pray`); salvation (ID: `keyterm:Salvation`); rogar (ID: `keyterm:AskFor`); Gentiles (ID: `group:Gentile`); Life (ID: `keyterm:Life`); Jesus (ID: `person:Jesus.2`); testemunhar (ID: `keyterm:BearWitness`); crer (ID: `keyterm:Believe`); tranquilo (ID: `keyterm:Tranquil`); salvador (ID: `keyterm:Savior`); resgate (ID: `keyterm:Ransom`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); Truth (ID: `keyterm:Truth`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); Adão (ID: `person:Adam`); Daily Life (ID: `keyterm:DailyLife`); Good (ID: `keyterm:Good`); testemunhar (ID: `keyterm:BearWitness`); autoridade (ID: `keyterm:Authority.2`); salvador (ID: `keyterm:Savior`); Eva (ID: `person:Eve`); Jesus (ID: `person:Jesus.2`); piedade (ID: `keyterm:GodlyReverence`); Gentiles (ID: `group:Gentile`); Life (ID: `keyterm:Life`); promessa (ID: `keyterm:Promise`); consecration (ID: `keyterm:Consecration.2`); holy (ID: `keyterm:Holy`); tranquilo (ID: `keyterm:Tranquil`); love (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`); resgate (ID: `keyterm:Ransom`); Clothing (ID: `realia:Clothing`); Gold Jewelry (ID: `realia:GoldJewelry`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); Truth (ID: `keyterm:Truth`); testemunhar (ID: `keyterm:BearWitness`); Jesus (ID: `person:Jesus.2`); salvation (ID: `keyterm:Salvation`); Faithfulness (ID: `keyterm:Faithfulness`); servir (ID: `keyterm:Serve`); Adão (ID: `person:Adam`); irrepreensível (ID: `keyterm:WithoutReproach`); Daily Life (ID: `keyterm:DailyLife`); compreensivo (ID: `keyterm:Gentle`); ofício (ID: `keyterm:PositionOfResponsibility`); igreja (ID: `keyterm:Church`); irrepreensível (ID: `keyterm:BeyondReproach`); (literalmente (ID: `keyterm:DoubleTongued`); Good (ID: `keyterm:Good`); em cristo (ID: `keyterm:InChrist`); autoridade (ID: `keyterm:Authority.2`); salvador (ID: `keyterm:Savior`); Eva (ID: `person:Eve`); limpo (ID: `keyterm:Clean`); que não ama o dinheiro (ID: `keyterm:NotALoverOfMoney`); piedade (ID: `keyterm:GodlyReverence`); juízo (ID: `keyterm:Judgment`); Gentiles (ID: `group:Gentile`); Life (ID: `keyterm:Life`); promessa (ID: `keyterm:Promise`); consecration (ID: `keyterm:Consecration.2`); holy (ID: `keyterm:Holy`); tranquilo (ID: `keyterm:Tranquil`); love (ID: `keyterm:Love`); consciência (ID: `keyterm:Conscience`); rogar (ID: `keyterm:AskFor`); discernir (ID: `keyterm:Interpret`); resgate (ID: `keyterm:Ransom`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`); Gold Jewelry (ID: `realia:GoldJewelry`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); resgate (ID: `keyterm:Ransom`); Jesus (ID: `person:Jesus.2`); testemunhar (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** promessa (ID: `keyterm:Promise`); Good (ID: `keyterm:Good`); piedade (ID: `keyterm:GodlyReverence`); Clothing (ID: `realia:Clothing`); Gold Jewelry (ID: `realia:GoldJewelry`)
...
* **Associated ACAI Concepts:** Adão (ID: `person:Adam`); salvation (ID: `keyterm:Salvation`); consecration (ID: `keyterm:Consecration.2`); autoridade (ID: `keyterm:Authority.2`); crer (ID: `keyterm:Believe`); love (ID: `keyterm:Love`); Eva (ID: `person:Eve`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); Faithfulness (ID: `keyterm:Faithfulness`); servir (ID: `keyterm:Serve`); irrepreensível (ID: `keyterm:WithoutReproach`); compreensivo (ID: `keyterm:Gentle`); ofício (ID: `keyterm:PositionOfResponsibility`); igreja (ID: `keyterm:Church`); irrepreensível (ID: `keyterm:BeyondReproach`); (literalmente (ID: `keyterm:DoubleTongued`); em cristo (ID: `keyterm:InChrist`); testemunhar (ID: `keyterm:BearWitness`); limpo (ID: `keyterm:Clean`); Jesus (ID: `person:Jesus.2`); que não ama o dinheiro (ID: `keyterm:NotALoverOfMoney`); SENHOR (ID: `deity:Lord`); juízo (ID: `keyterm:Judgment`); consciência (ID: `keyterm:Conscience`); discernir (ID: `keyterm:Interpret`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** servir (ID: `keyterm:Serve`); crer (ID: `keyterm:Believe`); irrepreensível (ID: `keyterm:WithoutReproach`); Faithfulness (ID: `keyterm:Faithfulness`); (literalmente (ID: `keyterm:DoubleTongued`); limpo (ID: `keyterm:Clean`); em cristo (ID: `keyterm:InChrist`); Jesus (ID: `person:Jesus.2`); discernir (ID: `keyterm:Interpret`); consciência (ID: `keyterm:Conscience`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Faithfulness (ID: `keyterm:Faithfulness`); Life (ID: `keyterm:Life`); Truth (ID: `keyterm:Truth`); Holy Spirit (ID: `deity:HolySpirit`); hope (ID: `keyterm:Hope`); conduta (ID: `keyterm:Behavior`); igreja (ID: `keyterm:Church`); be (or show oneself) just (ID: `keyterm:Just`); salvador (ID: `keyterm:Savior`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); Jesus (ID: `person:Jesus.2`); Demons (ID: `deity:Demons`); pureza (ID: `keyterm:WithoutMoralDefect`); salvation (ID: `keyterm:Salvation`); intercessão (ID: `keyterm:Intercession`); favor (ID: `keyterm:Favor`); promessa (ID: `keyterm:Promise`); An Angel (ID: `deity:Angel`); opposite of holy: profane (ID: `keyterm:Profane`); consecration (ID: `keyterm:Consecration.2`); love (ID: `keyterm:Love`); Spirit (ID: `keyterm:Spirit.2`); hipocrisia (ID: `keyterm:Hypocrisy`); consciência (ID: `keyterm:Conscience`); corpo (ID: `keyterm:Body.3`); proclamar (ID: `keyterm:Proclaim`); rogar (ID: `keyterm:AskFor`); Capital (ID: `realia:Capital`)
...
* **Associated ACAI Concepts:** corpo (ID: `keyterm:Body.3`); proclamar (ID: `keyterm:Proclaim`); An Angel (ID: `deity:Angel`); be (or show oneself) just (ID: `keyterm:Just`); Spirit (ID: `keyterm:Spirit.2`); crer (ID: `keyterm:Believe`); Holy Spirit (ID: `deity:HolySpirit`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); intercessão (ID: `keyterm:Intercession`); Faithfulness (ID: `keyterm:Faithfulness`); consecration (ID: `keyterm:Consecration.2`); Truth (ID: `keyterm:Truth`); Demons (ID: `deity:Demons`); crer (ID: `keyterm:Believe`); Holy Spirit (ID: `deity:HolySpirit`); hipocrisia (ID: `keyterm:Hypocrisy`); consciência (ID: `keyterm:Conscience`)
...
* **Associated ACAI Concepts:** Faithfulness (ID: `keyterm:Faithfulness`); Life (ID: `keyterm:Life`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); love (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`); favor (ID: `keyterm:Favor`); promessa (ID: `keyterm:Promise`); opposite of holy: profane (ID: `keyterm:Profane`); Jesus (ID: `person:Jesus.2`); salvador (ID: `keyterm:Savior`); SENHOR (ID: `deity:Lord`); pureza (ID: `keyterm:WithoutMoralDefect`); hope (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); juízo (ID: `keyterm:Judgment`); Faithfulness (ID: `keyterm:Faithfulness`); rogar (ID: `keyterm:AskFor`); inútil (ID: `keyterm:Idle`); orar (ID: `keyterm:Pray`); igreja (ID: `keyterm:Church`); irrepreensível (ID: `keyterm:BeyondReproach`); Good (ID: `keyterm:Good`); testemunhar (ID: `keyterm:BearWitness`); escolhido (ID: `keyterm:Chosen`); witness (ID: `keyterm:Witness`); tribunal de justiça (ID: `keyterm:CourtCase`); blasfemar (ID: `keyterm:Blaspheme`); pureza (ID: `keyterm:WithoutMoralDefect`); be unfaithful (ID: `keyterm:Unfaithful`); Satanás (ID: `deity:Satan`); fear (ID: `keyterm:Fear`); Life (ID: `keyterm:Life`); An Angel (ID: `deity:Angel`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); servir como escravo (ID: `keyterm:Serve.2`); amado (ID: `keyterm:Beloved`); holy (ID: `keyterm:Holy`); escritura (ID: `keyterm:Scripture`); testemunhar solenemente (ID: `keyterm:Declare`); hope (ID: `keyterm:Hope`); pure (ID: `keyterm:Pure`); preconceito (ID: `keyterm:Discrimination`); Name (ID: `keyterm:Name`); compartilhar (ID: `keyterm:Share`); Wine (ID: `realia:Wine`); Grain (ID: `flora:Grain`); Yoke (ID: `realia:Yoke`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); inútil (ID: `keyterm:Idle`); orar (ID: `keyterm:Pray`); be unfaithful (ID: `keyterm:Unfaithful`); igreja (ID: `keyterm:Church`); Faithfulness (ID: `keyterm:Faithfulness`); irrepreensível (ID: `keyterm:BeyondReproach`); Satanás (ID: `deity:Satan`); Life (ID: `keyterm:Life`); Good (ID: `keyterm:Good`); Jesus (ID: `person:Jesus.2`); testemunhar (ID: `keyterm:BearWitness`); holy (ID: `keyterm:Holy`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); juízo (ID: `keyterm:Judgment`); hope (ID: `keyterm:Hope`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** inútil (ID: `keyterm:Idle`); Satanás (ID: `deity:Satan`); Jesus (ID: `person:Jesus.2`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); crer (ID: `keyterm:Believe`); juízo (ID: `keyterm:Judgment`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); preconceito (ID: `keyterm:Discrimination`); escritura (ID: `keyterm:Scripture`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Jesus (ID: `person:Jesus.2`); pure (ID: `keyterm:Pure`); escolhido (ID: `keyterm:Chosen`); tribunal de justiça (ID: `keyterm:CourtCase`); compartilhar (ID: `keyterm:Share`); juízo (ID: `keyterm:Judgment`); testemunhar solenemente (ID: `keyterm:Declare`); witness (ID: `keyterm:Witness`); Wine (ID: `realia:Wine`); Grain (ID: `flora:Grain`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** preconceito (ID: `keyterm:Discrimination`); fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Jesus (ID: `person:Jesus.2`); escolhido (ID: `keyterm:Chosen`); witness (ID: `keyterm:Witness`); To Sin (ID: `keyterm:Sin`); SENHOR (ID: `deity:Lord`); testemunhar solenemente (ID: `keyterm:Declare`)
...
* **Associated ACAI Concepts:** preconceito (ID: `keyterm:Discrimination`); An Angel (ID: `deity:Angel`); Jesus (ID: `person:Jesus.2`); escolhido (ID: `keyterm:Chosen`); SENHOR (ID: `deity:Lord`); testemunhar solenemente (ID: `keyterm:Declare`)
...
* **Associated ACAI Concepts:** tentar (ID: `keyterm:PutToTheTest`); blasfemar (ID: `keyterm:Blaspheme`); Bring In (ID: `keyterm:BringIn`); rogar (ID: `keyterm:AskFor`); Faithfulness (ID: `keyterm:Faithfulness`); amor ao dinheiro (ID: `keyterm:LoveOfMoney`); Jesus (ID: `person:Jesus.2`); Truth (ID: `keyterm:Truth`); servir como escravo (ID: `keyterm:Serve.2`); amado (ID: `keyterm:Beloved`); crer (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); Foolish (ID: `keyterm:Foolish`); Do Good (ID: `keyterm:DoGood`); Make Alive (ID: `keyterm:Alive`); tentar (ID: `keyterm:PutToTheTest`); Bring In (ID: `keyterm:BringIn`); generoso (ID: `keyterm:WillingToShare`); irrepreensível (ID: `keyterm:BeyondReproach`); sem mancha (ID: `keyterm:AboveCriticism`); bem, aventurado (ID: `keyterm:Happy`); be (or show oneself) just (ID: `keyterm:Just`); Truth (ID: `keyterm:Truth`); testemunhar (ID: `keyterm:BearWitness`); witness (ID: `keyterm:Witness`); blasfemar (ID: `keyterm:Blaspheme`); Pilatos (ID: `person:Pilate`); Timóteo (ID: `person:Timothy`); Faithfulness (ID: `keyterm:Faithfulness`); surely! (ID: `keyterm:Surely`); favor (ID: `keyterm:Favor`); promessa (ID: `keyterm:Promise`); opposite of holy: profane (ID: `keyterm:Profane`); servir como escravo (ID: `keyterm:Serve.2`); Commandment (ID: `keyterm:Commandment`); amado (ID: `keyterm:Beloved`); love (ID: `keyterm:Love`); hope (ID: `keyterm:Hope`); rogar (ID: `keyterm:AskFor`); amor ao dinheiro (ID: `keyterm:LoveOfMoney`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`); crer (ID: `keyterm:Believe`); Make Alive (ID: `keyterm:Alive`); love (ID: `keyterm:Love`); Pilatos (ID: `person:Pilate`); surely! (ID: `keyterm:Surely`); irrepreensível (ID: `keyterm:BeyondReproach`); Life (ID: `keyterm:Life`); bem, aventurado (ID: `keyterm:Happy`); sem mancha (ID: `keyterm:AboveCriticism`); be (or show oneself) just (ID: `keyterm:Just`); testemunhar (ID: `keyterm:BearWitness`); witness (ID: `keyterm:Witness`); Commandment (ID: `keyterm:Commandment`)
...
* **Associated ACAI Concepts:** bem, aventurado (ID: `keyterm:Happy`); SENHOR (ID: `deity:Lord`); surely! (ID: `keyterm:Surely`); para a eternidade (ID: `keyterm:Always`)
...
* **Associated ACAI Concepts:** Do Good (ID: `keyterm:DoGood`); generoso (ID: `keyterm:WillingToShare`); para a eternidade (ID: `keyterm:Always`); SENHOR (ID: `deity:Lord`); hope (ID: `keyterm:Hope`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Do Good (ID: `keyterm:DoGood`); generoso (ID: `keyterm:WillingToShare`); Life (ID: `keyterm:Life`); para a eternidade (ID: `keyterm:Always`); SENHOR (ID: `deity:Lord`); hope (ID: `keyterm:Hope`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Foolish (ID: `keyterm:Foolish`); Timóteo (ID: `person:Timothy`); favor (ID: `keyterm:Favor`); promessa (ID: `keyterm:Promise`); opposite of holy: profane (ID: `keyterm:Profane`); crer (ID: `keyterm:Believe`)
