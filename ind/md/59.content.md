...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); mencobai (ID: `keyterm:PutToTheTest`); berbahagialah (ID: `keyterm:Happy`); kekasih (ID: `keyterm:Beloved`); suci (ID: `keyterm:Clean`); sia, sia (ID: `keyterm:Worthless`); tahan uji (ID: `keyterm:Approved`); tak bernoda (ID: `keyterm:AboveCriticism`); keahlian (ID: `keyterm:Ability`); A Person (ID: `person:GenericPerson`); keselamatan (ID: `keyterm:Salvation`); kehidupan (ID: `keyterm:Life`); hati (ID: `keyterm:Heart`); yang baik (ID: `keyterm:Good`); tidak dapat dicobai (ID: `keyterm:NotTempted`); hukum (ID: `keyterm:Law`); berbuat dosa (ID: `keyterm:Sin`); tidak dicemarkan (ID: `keyterm:Undefiled`); janji (ID: `keyterm:Promise`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kasihi (ID: `keyterm:Love`); kebenaran (ID: `keyterm:Truth`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** suci (ID: `keyterm:Clean`); sia, sia (ID: `keyterm:Worthless`); tak bernoda (ID: `keyterm:AboveCriticism`); tidak dicemarkan (ID: `keyterm:Undefiled`); keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`); hati (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); tonton bulu atau muka (ID: `keyterm:Partiality`); kemuliaan (ID: `keyterm:Glory`); percaya (ID: `keyterm:Believe`); bimbang (ID: `keyterm:Discern`); Yesus (ID: `person:Jesus.2`); Seal (ID: `realia:Seal`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** kasihi (ID: `keyterm:Love`); orang pilihan (ID: `keyterm:Chosen`); keahlian (ID: `keyterm:Ability`); percaya (ID: `keyterm:Believe`); kekasih (ID: `keyterm:Beloved`); Tuhan (ID: `deity:Lord`); janji (ID: `keyterm:Promise`); kerajaan (ID: `keyterm:Kingdom`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); penghakiman (ID: `keyterm:Judgment`); tersandung (ID: `keyterm:Stumble`); tonton bulu atau muka (ID: `keyterm:Partiality`); belas kasihan (ID: `keyterm:Mercy`); kasihi (ID: `keyterm:Love`); memutuskan (ID: `keyterm:Decided`); kitab suci (ID: `keyterm:Scripture`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`); pengadilan (ID: `keyterm:CourtCase`); persundalan (ID: `keyterm:Fornication`); berbuat dosa (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); sia, sia (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); roh (ID: `keyterm:Spirit.2`); hampa (ID: `keyterm:Empty`); Ishak (ID: `person:Isaac`); Tuhan (ID: `deity:Lord`); kitab suci (ID: `keyterm:Scripture`); An Angel (ID: `deity:Angel`); tubuh (ID: `keyterm:Body.3`); menggenapi (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); kitab suci (ID: `keyterm:Scripture`); Tuhan (ID: `deity:Lord`); Abraham (ID: `person:Abraham`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); menggenapi (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** lalim (ID: `keyterm:UnjustDeed`); Hell (ID: `place:Hell`); keahlian (ID: `keyterm:Ability`); neraka (ID: `keyterm:Gehenna`); tubuh (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); tidak setia (ID: `keyterm:Unfaithful`); persahabatan (ID: `keyterm:Friendship`); roh (ID: `keyterm:Spirit.2`); keahlian (ID: `keyterm:Ability`); kitab suci (ID: `keyterm:Scripture`); membersihkan (ID: `keyterm:Cleanse.2`); ingin (ID: `keyterm:LongFor`); kebaikan (ID: `keyterm:Favor`); murni (ID: `keyterm:Pure`); Roh (ID: `deity:HolySpirit`); hati (ID: `keyterm:Heart`); Cause of Joy (ID: `keyterm:CauseOfJoy`)
...
* **Associated ACAI Concepts:** kitab suci (ID: `keyterm:Scripture`); roh (ID: `keyterm:Spirit.2`); ingin (ID: `keyterm:LongFor`); Roh (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** memutuskan (ID: `keyterm:Decided`); keselamatan (ID: `keyterm:Salvation`); hukum (ID: `keyterm:Law`); pembuat hukum (ID: `keyterm:Lawgiver`)
...
* **Associated ACAI Concepts:** menentang (ID: `keyterm:Condemn`); Tuhan (ID: `deity:Lord`); tubuh (ID: `keyterm:Body.3`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); hati (ID: `keyterm:Heart`); bersaksi (ID: `keyterm:BearWitness`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Ayub (ID: `person:Job`); penyayang (ID: `keyterm:Compassionate`); Tuhan (ID: `deity:Lord`); menyebut berbahagia (ID: `keyterm:RegardAsHappy`); penuh belas kasihan (ID: `keyterm:FullOfCompassion`)
...
* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); Tuhan (ID: `deity:Lord`); diurapi (ID: `keyterm:Anointed`); jemaat (ID: `keyterm:Church`); nama (ID: `keyterm:Name`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); keselamatan (ID: `keyterm:Salvation`); mengampuni (ID: `keyterm:Forgive`); berbuat dosa (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** keselamatan (ID: `keyterm:Salvation`); kebenaran (ID: `keyterm:Truth`); berbuat dosa (ID: `keyterm:Sin`)
