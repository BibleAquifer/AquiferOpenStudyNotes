...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Tessalônica (ID: `place:Thessalonica`); Timóteo (ID: `person:Timothy`); Silas (ID: `person:Silas`); Thessalonians (ID: `group:Thessalonica`); fazer a paz (ID: `keyterm:Peace`); igreja (ID: `keyterm:Church`); Paulo (ID: `person:Paul`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); be (or show oneself) just (ID: `keyterm:Just`); Glory (ID: `keyterm:Glory`); tribunal de justiça (ID: `keyterm:CourtCase`); love (ID: `keyterm:Love`); An Angel (ID: `deity:Angel`); juízo (ID: `keyterm:Judgment`); fazer justiça (ID: `keyterm:GrantJustice`); para a eternidade (ID: `keyterm:Always`); reino (ID: `keyterm:Kingdom`); igreja (ID: `keyterm:Church`); holy (ID: `keyterm:Holy`); céu (ID: `keyterm:Heaven`); testemunhar (ID: `keyterm:BearWitness`); boa notícia (ID: `keyterm:GoodNews`); ser glorificado (ID: `keyterm:Glorified`); dever (ID: `keyterm:Ought`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** To Cause to Happen (ID: `keyterm:Happen`); SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); crer (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ser glorificado (ID: `keyterm:Glorified`); To Cause to Happen (ID: `keyterm:Happen`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); crer (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** ser glorificado (ID: `keyterm:Glorified`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); crer (ID: `keyterm:Believe`); Spirit (ID: `keyterm:Spirit.2`); Satanás (ID: `deity:Satan`); injustiça (ID: `keyterm:UnjustDeed`); love (ID: `keyterm:Love`); salvation (ID: `keyterm:Salvation`); example (ID: `keyterm:Example`); objeto de culto (ID: `keyterm:ObjectOfWorship`); Ability (ID: `keyterm:Ability`); decidir (ID: `keyterm:Decided`); rogar (ID: `keyterm:AskFor`); maravilha (ID: `keyterm:Portent`); wipe (out), destroy (ID: `keyterm:Destroy`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`); hope (ID: `keyterm:Hope`); Good (ID: `keyterm:Good`); para a eternidade (ID: `keyterm:Always`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); love (ID: `keyterm:Love`); Faithfulness (ID: `keyterm:Faithfulness`); livrar (ID: `keyterm:Deliver`); persuadir (ID: `keyterm:Persuade`); orar (ID: `keyterm:Pray`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); autoridade (ID: `keyterm:Authority.2`); rogar (ID: `keyterm:AskFor`); tradição (ID: `keyterm:Teaching`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); Ability (ID: `keyterm:Ability`)
