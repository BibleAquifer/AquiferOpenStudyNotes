...
* **Associated ACAI Concepts:** fear (ID: `keyterm:Fear`); strength (ID: `keyterm:Strength`); dispossess (ID: `keyterm:Dispossess`); SENHOR (ID: `deity:Lord`); Caldéia (ID: `place:Chaldea`); Believe In (ID: `keyterm:BelieveIn`); Chaldeans (ID: `group:Chaldea`); Horse (ID: `fauna:Horse`); Vulture (ID: `fauna:Vulture`); Wolf (ID: `fauna:Wolf`); Leopard (ID: `fauna:Leopard`)
...
* **Associated ACAI Concepts:** Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Casting Net (ID: `realia:CastingNet`); holy (ID: `keyterm:Holy`); SENHOR (ID: `deity:Lord`); pure (ID: `keyterm:Pure`); Fortification (ID: `realia:Fortification`); Monitor (ID: `fauna:Iguana`); Harpoon (ID: `realia:Harpoon`); Chameleon (ID: `fauna:Chameleon`); Fish (ID: `fauna:Fish`); Lizard (ID: `fauna:Lizard`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); literally: nought (ID: `keyterm:Idol`); lean on (ID: `keyterm:LeanOn`); Libano (ID: `place:Lebanon`); Be Disgraced (ID: `keyterm:Disgraced`); saying (ID: `keyterm:Saying`); Molten Image (ID: `realia:MoltenImage`); Beam (ID: `realia:Beam`); Graven Image (ID: `realia:GravenImage`); Image (ID: `realia:Image`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** literally: nought (ID: `keyterm:Idol`); lean on (ID: `keyterm:LeanOn`); Woe (ID: `keyterm:Woe.2`); SENHOR (ID: `deity:Lord`); Molten Image (ID: `realia:MoltenImage`); Image (ID: `realia:Image`); Graven Image (ID: `realia:GravenImage`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); Habacuque (ID: `person:Habakkuk`); Temã (ID: `place:Teman`); Cusã (ID: `place:Cushan`); Monte Paran (ID: `place:ParanMount`); fear (ID: `keyterm:Fear`); Oath (ID: `keyterm:Oath`); holy (ID: `keyterm:Holy`); Midiã (ID: `place:Midian`); mischief (ID: `keyterm:Mischief`); anointed (ID: `keyterm:Anointed`); arrow (ID: `keyterm:Arrow`); majesty (ID: `keyterm:Majesty`); Deer (ID: `fauna:Deer`); Tent (ID: `realia:Tent`); Chariot (ID: `realia:Chariot`); Bow (ID: `realia:Bow`); Flock (ID: `fauna:Flock`); Sheepfold (ID: `realia:Sheepfold`); Cattle (ID: `fauna:Bull`); Fig (ID: `flora:Fig`); Vine (ID: `flora:Vine`); Spear (ID: `realia:Spear`); Goat (ID: `fauna:Goat`); Animal Pen (ID: `realia:AnimalPen`); Olive Tree (ID: `flora:OliveTree`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); Temã (ID: `place:Teman`); Cusã (ID: `place:Cushan`); Monte Paran (ID: `place:ParanMount`); Oath (ID: `keyterm:Oath`); SENHOR (ID: `deity:Lord`); holy (ID: `keyterm:Holy`); Midiã (ID: `place:Midian`); mischief (ID: `keyterm:Mischief`); anointed (ID: `keyterm:Anointed`); arrow (ID: `keyterm:Arrow`); majesty (ID: `keyterm:Majesty`); Tent (ID: `realia:Tent`); Chariot (ID: `realia:Chariot`); Bow (ID: `realia:Bow`); Spear (ID: `realia:Spear`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); Oath (ID: `keyterm:Oath`); SENHOR (ID: `deity:Lord`); anointed (ID: `keyterm:Anointed`); arrow (ID: `keyterm:Arrow`); Chariot (ID: `realia:Chariot`); Bow (ID: `realia:Bow`); Foundation (ID: `realia:Foundation`); Spear (ID: `realia:Spear`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); salvation (ID: `keyterm:Salvation`); Sheepfold (ID: `realia:Sheepfold`); Animal Pen (ID: `realia:AnimalPen`); Cattle (ID: `fauna:Bull`); Olive Tree (ID: `flora:OliveTree`); Fig (ID: `flora:Fig`); Vine (ID: `flora:Vine`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
