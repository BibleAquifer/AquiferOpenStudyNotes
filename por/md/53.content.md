...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Tessalônica (ID: `place:Thessalonica`); favor (ID: `keyterm:Favor`); Timóteo (ID: `person:Timothy`); fazer a paz (ID: `keyterm:Peace`); Paulo (ID: `person:Paul`); Thessalonians (ID: `group:Thessalonica`); Silas (ID: `person:Silas`); igreja (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); dever (ID: `keyterm:Ought`); juízo (ID: `keyterm:Judgment`); tribunal de justiça (ID: `keyterm:CourtCase`); Glory (ID: `keyterm:Glory`); fazer justiça (ID: `keyterm:GrantJustice`); holy (ID: `keyterm:Holy`); love (ID: `keyterm:Love`); igreja (ID: `keyterm:Church`); Ability (ID: `keyterm:Ability`); boa notícia (ID: `keyterm:GoodNews`); reino (ID: `keyterm:Kingdom`); An Angel (ID: `deity:Angel`); testemunhar (ID: `keyterm:BearWitness`); céu (ID: `keyterm:Heaven`); para a eternidade (ID: `keyterm:Always`); ser glorificado (ID: `keyterm:Glorified`)
...
* **Associated ACAI Concepts:** juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`); reino (ID: `keyterm:Kingdom`); be (or show oneself) just (ID: `keyterm:Just`); tribunal de justiça (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** To Cause to Happen (ID: `keyterm:Happen`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); orar (ID: `keyterm:Pray`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); Good (ID: `keyterm:Good`); Name (ID: `keyterm:Name`); crer (ID: `keyterm:Believe`); orar (ID: `keyterm:Pray`); Ability (ID: `keyterm:Ability`); ser glorificado (ID: `keyterm:Glorified`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Spirit (ID: `keyterm:Spirit.2`); crer (ID: `keyterm:Believe`); Truth (ID: `keyterm:Truth`); wipe (out), destroy (ID: `keyterm:Destroy`); Satanás (ID: `deity:Satan`); rogar (ID: `keyterm:AskFor`); maravilha (ID: `keyterm:Portent`); objeto de culto (ID: `keyterm:ObjectOfWorship`); injustiça (ID: `keyterm:UnjustDeed`); love (ID: `keyterm:Love`); example (ID: `keyterm:Example`); Ability (ID: `keyterm:Ability`); salvation (ID: `keyterm:Salvation`); decidir (ID: `keyterm:Decided`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); hope (ID: `keyterm:Hope`); love (ID: `keyterm:Love`); para a eternidade (ID: `keyterm:Always`); rogar (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); love (ID: `keyterm:Love`); livrar (ID: `keyterm:Deliver`); orar (ID: `keyterm:Pray`); Faithfulness (ID: `keyterm:Faithfulness`); persuadir (ID: `keyterm:Persuade`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); autoridade (ID: `keyterm:Authority.2`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); rogar (ID: `keyterm:AskFor`); tradição (ID: `keyterm:Teaching`)
