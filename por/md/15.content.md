...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Pérsia (ID: `place:Persia`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `group:Benjamin`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `person:Benjamin`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Nabucodonozor (ID: `person:Nebuchadnezzar`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Ciro (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Zorobabel (ID: `person:Zerubbabel.2`); Pérsia (ID: `place:Persia`); Judá (ID: `person:Judah.4`); Ciro (ID: `person:Cyrus`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Levi (ID: `group:Levi`); Salomão (ID: `person:Solomon`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `person:Levi.3`); Darcom (ID: `person:Darkon`); Seraias (ID: `person:Seraiah.6`); Barcos (ID: `person:Barkos`); Ezequias (ID: `person:Hezekiah.2`); Bebai (ID: `person:Bebai`); Ater (ID: `person:Ater`); Bani (ID: `person:Bani`); Asná (ID: `person:Asnah`); Netofa (ID: `place:Netophah`); Tel-Harsa (ID: `place:Tel-harsha`); Joabe (ID: `person:Joab.3`); Bezai (ID: `person:Bezai`); Salmai (ID: `person:Shalmai`); Hanã (ID: `person:Hanan.4`); Sephatias (ID: `person:Shephatiah.6`); Sobai (ID: `person:Shobai`); Tel-Melá (ID: `place:Tel-melah`); Padom (ID: `person:Padon`); Acube (ID: `person:Akkub.3`); Imer (ID: `person:Immer.2`); Adã (ID: `place:Addan`); Asgade (ID: `person:Azgad`); Uza (ID: `person:Uzza.2`); Querube (ID: `place:Cherub`)
...
* **Associated ACAI Concepts:** Bigvai (ID: `person:Bigvai`); Mordecai (ID: `person:Mordecai`); Neemias (ID: `person:Nehemiah`); Reum (ID: `person:Rehum`); Reelaías (ID: `person:Reelaiah`); Bilsã (ID: `person:Bilshan`); Seraias (ID: `person:Seraiah.6`); Baana (ID: `person:Baanah.3`); Mispar (ID: `person:Mispar`); Israel (ID: `person:Israel`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Asgade (ID: `person:Azgad`); Jora (ID: `person:Jorah`); Elam (ID: `person:Elam`); Ezequias (ID: `person:Hezekiah.2`); Bebai (ID: `person:Bebai`); Bigvai (ID: `person:Bigvai.2`); Adim (ID: `person:Adin`); Ater (ID: `person:Ater`); Ará (ID: `person:Arah.2`); Bani (ID: `person:Bani`); Jesua (ID: `person:Jeshua.3`); Zacai (ID: `person:Zaccai.2`); Paate-Moabe (ID: `person:Pahath-moab`); Hasum (ID: `person:Hashum`); Joabe (ID: `person:Joab.3`); Parós (ID: `person:Parosh`); Adonicão (ID: `person:Adonikam`); Zatu (ID: `person:Zattu.2`); Bezai (ID: `person:Bezai`); Sephatias (ID: `person:Shephatiah.6`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Harim (ID: `person:Harim.2`); Hadide (ID: `place:Hadid`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Senaa (ID: `place:Senaah`); Nebo (ID: `place:Nebo.2`); Netofa (ID: `place:Netophah`); Magbis (ID: `place:Magbish`); Ono (ID: `place:Ono`); Belém (ID: `place:Bethlehem`); Elam (ID: `person:Elam`); Lode (ID: `place:Lod`); Quiriate-Jearim (ID: `place:Kiriath-jearim`); Betel (ID: `place:Bethel`); Geba (ID: `place:Geba`); Ai (ID: `place:Ai`); Beerote (ID: `place:Beeroth`); Cefira (ID: `place:Chephirah`); Anatote (ID: `place:Anathoth`); Ramah (ID: `place:Ramah.2`); Jericó (ID: `place:Jericho`); Micmás (ID: `place:Michmash`)
...
* **Associated ACAI Concepts:** Imer (ID: `person:Immer.2`); Jedaías (ID: `person:Jedaiah.4`); Hatita (ID: `person:Hatita`); Harim (ID: `person:Harim`); Jesua (ID: `person:Jeshua.4`); Jesua (ID: `person:Jeshua`); Talmom (ID: `person:Talmon`); Hodavias (ID: `person:Hodaviah.4`); Ater (ID: `person:Ater.2`); Sobai (ID: `person:Shobai`); Asafe (ID: `person:Asaph.2`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Pasur (ID: `person:Pashhur`); Salum (ID: `person:Shallum.8`); Acube (ID: `person:Akkub.2`); Cadmiel (ID: `person:Kadmiel`)
...
* **Associated ACAI Concepts:** Hatita (ID: `person:Hatita`); Talmom (ID: `person:Talmon`); Ater (ID: `person:Ater.2`); Sobai (ID: `person:Shobai`); Asafe (ID: `person:Asaph.2`); Salum (ID: `person:Shallum.8`); Acube (ID: `person:Akkub.2`)
...
* **Associated ACAI Concepts:** Temá (ID: `person:Temah`); Padom (ID: `person:Padon`); Acube (ID: `person:Akkub.3`); Harur (ID: `person:Harhur`); Sisera (ID: `person:Sisera.2`); Uza (ID: `person:Uzza.2`); Gidel (ID: `person:Giddel`); Meunim (ID: `group:Meunim`); Queros (ID: `person:Keros`); Barcos (ID: `person:Barkos`); Necoda (ID: `person:Nekoda`); Reaías (ID: `person:Reaiah.3`); Tabaote (ID: `person:Tabbaoth`); Harsa (ID: `person:Harsha`); Rezim (ID: `person:Rezin.2`); Hasufa (ID: `person:Hasupha`); Nephushesim (ID: `group:Nephushesim`); Nesias (ID: `person:Neziah`); Sia (ID: `person:Siaha`); Hagabe (ID: `person:Hagab`); Gaar (ID: `person:Gahar`); Meída (ID: `person:Mehida`); Hatifa (ID: `person:Hatipha`); Asná (ID: `person:Asnah`); Zia (ID: `person:Ziha`); Bazlite (ID: `person:Bazluth`); Hacufa (ID: `person:Hakupha`); Gazão (ID: `person:Gazzam`); Lebana (ID: `person:Lebanah`); Salmai (ID: `person:Shalmai`); Hagaba (ID: `person:Hagabah`); Hanã (ID: `person:Hanan.4`); Besai (ID: `person:Besai`); Baquebuque (ID: `person:Bakbuk`); Paseia (ID: `person:Paseah.2`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Peruda (ID: `person:Peruda`); Gidel (ID: `person:Giddel.2`); Jaala (ID: `person:Jaalah`); Darcom (ID: `person:Darkon`); Sotai (ID: `person:Sotai`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Soferete (ID: `person:Sophereth`); Hatil (ID: `person:Hattil`); Ami (ID: `person:Ami`); Sephatias (ID: `person:Shephatiah.7`)
...
* **Associated ACAI Concepts:** Tel-Melá (ID: `place:Tel-melah`); Tobias (ID: `person:Tobiah`); Tel-Harsa (ID: `place:Tel-harsha`); Adã (ID: `place:Addan`); Delaías (ID: `person:Delaiah.3`); Necoda (ID: `person:Nekoda.2`); Querube (ID: `place:Cherub`); Imer (ID: `place:Immer`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Barzillai (ID: `person:Barzillai.3`); Hacoz (ID: `person:Hakkoz.2`); Habaiah (ID: `person:Habaiah`); Gileade (ID: `place:Gilead`); Gileadites (ID: `group:Gilead`); stain (ID: `keyterm:Stain`); Barzillai (ID: `person:Barzillai`); priesthood (ID: `keyterm:Priesthood`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); strength (ID: `keyterm:Strength`); Money (ID: `realia:Money`); House (ID: `realia:House`); Tunic (ID: `realia:Tunic`); Mina (ID: `realia:Mina`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Josué (ID: `person:Joshua.5`); Pérsia (ID: `place:Persia`); Ciro (ID: `person:Cyrus`); Sealtiel (ID: `person:Shealtiel.2`); Jeozadaque (ID: `person:Jehozadak`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Cadmiel (ID: `person:Kadmiel`); Henadade (ID: `person:Henadad`); Jesua (ID: `person:Jeshua.4`); Esar-Hadom (ID: `person:Esarhaddon`); Relatives (ID: `group:Relatives`); Hodavias (ID: `person:Hodaviah.4`); Hodias (ID: `person:Hodiah.2`); Libano (ID: `place:Lebanon`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); Moisés (ID: `person:Moses`); appointed feast (ID: `keyterm:AppointedFeast`); Assyria (ID: `place:Assyria`); kindness (ID: `keyterm:Kindness`); Instruction (ID: `keyterm:Instruction`); Tiro (ID: `place:Tyre`); Benjamim (ID: `person:Benjamin`); Asafe (ID: `person:Asaph.2`); Davi (ID: `person:David`); holy (ID: `keyterm:Holy`); Sidonians (ID: `group:Sidon`); Dario (ID: `person:Darius.2`); Jope (ID: `place:Joppa`); Tyrians (ID: `group:Tyre`); counsel (ID: `keyterm:Counsel`); Sidom (ID: `place:Sidon`); Benjamim (ID: `group:Benjamin`); terror (ID: `keyterm:Terror`); new moon festival (ID: `keyterm:NewMoonFestival`); Olive Oil (ID: `realia:OliveOil`); Cedar (ID: `flora:Cedar`); Craftsman (ID: `realia:Craftsman`); Cymbals (ID: `realia:Cymbals`); Trumpet (ID: `realia:Trumpet`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Sealtiel (ID: `person:Shealtiel.2`); Jeozadaque (ID: `person:Jehozadak`); offering (ID: `keyterm:Offering`); Israel (ID: `person:Israel`); Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); terror (ID: `keyterm:Terror`); SENHOR (ID: `deity:Lord`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); holy (ID: `keyterm:Holy`); new moon festival (ID: `keyterm:NewMoonFestival`); appointed feast (ID: `keyterm:AppointedFeast`)
...
* **Associated ACAI Concepts:** Sidom (ID: `place:Sidon`); Libano (ID: `place:Lebanon`); Sidonians (ID: `group:Sidon`); Tiro (ID: `place:Tyre`); Jope (ID: `place:Joppa`); Tyrians (ID: `group:Tyre`); Pérsia (ID: `place:Persia`); Ciro (ID: `person:Cyrus`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Craftsman (ID: `realia:Craftsman`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Josué (ID: `person:Joshua.5`); SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Jerusalém (ID: `place:Jerusalem`); Sealtiel (ID: `person:Shealtiel.2`); Jeozadaque (ID: `person:Jehozadak`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Davi (ID: `person:David`); Asafe (ID: `person:Asaph.2`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); kindness (ID: `keyterm:Kindness`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `group:Benjamin`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Benjamim (ID: `person:Benjamin`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Israel (ID: `person:Israel`); Josué (ID: `person:Joshua.5`); SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Pérsia (ID: `place:Persia`); Ciro (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Rio Eufrates (ID: `place:Euphrates`); Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Artaxerxes (ID: `person:Artaxerxes.2`); Samaria (ID: `place:Samaria`); Jews (ID: `group:Jews`); Pérsia (ID: `place:Persia`); Ereque (ID: `place:Erech`); Babylonians (ID: `group:Babylon`); Bislão (ID: `person:Bishlam`); Mitredate (ID: `person:Mithredath.2`); Dinaítas (ID: `person:Dinaite`); Tabeel (ID: `person:Tabeel`); Osnapar (ID: `person:Osnappar`); Assuero (ID: `person:Ahasuerus`); Elamites (ID: `group:Elam`); Elam (ID: `place:Elam`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Babilônia (ID: `place:Babylon`); Susã (ID: `place:Susa`); Persians (ID: `group:Persia`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Ereque (ID: `place:Erech`); Babylonians (ID: `group:Babylon`); Dinaítas (ID: `person:Dinaite`); Elamites (ID: `group:Elam`); Babilônia (ID: `place:Babylon`); Pérsia (ID: `place:Persia`); Elam (ID: `place:Elam`); Susã (ID: `place:Susa`); Persians (ID: `group:Persia`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Samaria (ID: `place:Samaria`); Jews (ID: `group:Jews`); Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Artaxerxes (ID: `person:Artaxerxes.2`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); Dario (ID: `person:Darius.2`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Tattenai (ID: `person:Tattenai`); Zacarias (ID: `person:Zechariah.17`); Ageu (ID: `person:Haggai`); Ido (ID: `person:Iddo.6`); Israel (ID: `person:Israel`); Rio Eufrates (ID: `place:Euphrates`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Sealtiel (ID: `person:Shealtiel.2`); Judá (ID: `person:Judah.4`); Pérsia (ID: `place:Persia`); Jeozadaque (ID: `person:Jehozadak`)
...
* **Associated ACAI Concepts:** Zacarias (ID: `person:Zechariah.17`); Ageu (ID: `person:Haggai`); Ido (ID: `person:Iddo.6`); Israel (ID: `person:Israel`); Jews (ID: `group:Jews`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Jerusalém (ID: `place:Jerusalem`); Zorobabel (ID: `person:Zerubbabel.2`); Sealtiel (ID: `person:Shealtiel.2`); Jeozadaque (ID: `person:Jehozadak`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Moisés (ID: `person:Moses`); Jerusalém (ID: `place:Jerusalem`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Aitube (ID: `person:Ahitub.3`); Abisua (ID: `person:Abishua`); Azarias (ID: `person:Azariah.7`); Meraiote (ID: `person:Meraioth`); Zeraías (ID: `person:Zerahiah`); Amarias (ID: `person:Amariah.2`); Seraias (ID: `person:Seraiah.2`); Uzi (ID: `person:Uzzi`); Zadoque (ID: `person:Zadok.4`); Buqui (ID: `person:Bukki.2`); Azarias (ID: `person:Azariah.6`); Salum (ID: `person:Shallum.7`); Eleazar (ID: `person:Eleazar.2`); Hilquias (ID: `person:Hilkiah.2`); Arão (ID: `person:Aaron`); Fineias (ID: `person:Phinehas`); Artaxerxes (ID: `person:Artaxerxes`); Pérsia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); Babilônia (ID: `place:Babylon`); Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); SENHOR (ID: `deity:Lord`); Ezra (ID: `person:Ezra`); decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Ezra (ID: `person:Ezra`); Artaxerxes (ID: `person:Artaxerxes`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Wheat (ID: `flora:Wheat`); Kor (ID: `realia:Kor`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Jesaías (ID: `person:Jeshaiah.4`); Miguel (ID: `person:Michael.10`); Asgade (ID: `person:Azgad`); Joabe (ID: `person:Joab.4`); Zabadias (ID: `person:Zebadiah.8`); Jeuel (ID: `person:Jeuel.3`); Elam (ID: `person:Elam`); Gérson (ID: `person:Gershom.2`); Utai (ID: `person:Uthai.2`); Secanias (ID: `person:Shecaniah.5`); Ebede (ID: `person:Ebed.2`); Bebai (ID: `person:Bebai.2`); Bebai (ID: `person:Bebai`); Jeiel (ID: `person:Jehiel.7`); Parós (ID: `person:Parosh.2`); Jaaziel (ID: `person:Jahaziel.5`); Bigvai (ID: `person:Bigvai.2`); Elioenai (ID: `person:Eliehoenai.2`); Zacur (ID: `person:Zaccur.5`); Hatus (ID: `person:Hattush.2`); Zacarias (ID: `person:Zechariah.18`); Elifelete (ID: `person:Eliphelet.5`); Adim (ID: `person:Adin`); Obadias (ID: `person:Obadiah.10`); Zacarias (ID: `person:Zechariah.19`); Joanã (ID: `person:Johanan.8`); Selomite (ID: `person:Shelomith.4`); Secanias (ID: `person:Shecaniah.6`); Hacatã (ID: `person:Hakkatan`); Paate-Moabe (ID: `person:Pahath-moab`); Atalia (ID: `person:Athaliah.3`); Adonicão (ID: `person:Adonikam`); Josifias (ID: `person:Josiphiah`); Daniel (ID: `person:Daniel.2`); Jônatas (ID: `person:Jonathan.9`); Sephatias (ID: `person:Shephatiah.6`); Semaías (ID: `person:Shemaiah.14`); Zeraías (ID: `person:Zerahiah.2`); Itamar (ID: `person:Ithamar`); Davi (ID: `person:David`); Babilônia (ID: `place:Babylon`); Fineias (ID: `person:Phinehas`); Artaxerxes (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** Elnatã (ID: `person:Elnathan.3`); Elnatã (ID: `person:Elnathan.2`); Mesulão (ID: `person:Meshullam.9`); Natã (ID: `person:Nathan.5`); Ido (ID: `person:Iddo`); Joiaribe (ID: `person:Joiarib.2`); Semaías (ID: `person:Shemaiah.15`); Elnatã (ID: `person:Elnathan.4`); Ariel (ID: `person:Ariel`); Casifia (ID: `place:Casiphia`); Jaribe (ID: `person:Jarib.2`); Zacarias (ID: `person:Zechariah.20`); Eliezer (ID: `person:Eliezer.8`); SENHOR (ID: `deity:Lord`); perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); Israel (ID: `person:Israel`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); SENHOR (ID: `deity:Lord`); Mali (ID: `person:Mahli`); Insight (ID: `keyterm:Insight`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); Moabe (ID: `place:Moab`); cananeu (ID: `group:Canaan`); be unfaithful (ID: `keyterm:Unfaithful`); Israel (ID: `person:Israel`); Egito (ID: `place:Egypt`); Ammonites (ID: `group:Ammon`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Canaã (ID: `place:Canaan`); Jebusites (ID: `group:Jebusites`); Amorites (ID: `group:Amorites`); Hete (ID: `person:Heth`); Egyptians (ID: `group:Egypt`); Amom (ID: `place:Ammon`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); House (ID: `realia:House`); Harim (ID: `person:Harim`); counsel (ID: `keyterm:Counsel`); Elam (ID: `person:Elam`); Judá (ID: `person:Judah.4`); offering (ID: `keyterm:Offering`); Judá (ID: `group:Judah`); Salum (ID: `person:Shallum.11`); Jeiel (ID: `person:Jehiel.8`); Abdi (ID: `person:Abdi.3`); Bezalel (ID: `person:Bezalel.2`); Elioenai (ID: `person:Elioenai.5`); Zabade (ID: `person:Zabad.5`); Benaia (ID: `person:Benaiah.10`); Natanael (ID: `person:Nethanel.8`); Zabai (ID: `person:Zabbai`); Maaséias (ID: `person:Maaseiah.7`); Meremote (ID: `person:Meremoth.2`); Seal (ID: `person:Sheal`); Malquias (ID: `person:Malchijah.5`); Matenai (ID: `person:Mattenai.2`); Semaías (ID: `person:Shemaiah.17`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); peace (ID: `keyterm:IntactState`); Israel (ID: `person:Israel`); defilement (ID: `keyterm:Defilement`); dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`); to cause to possess (ID: `keyterm:Possess`); Pérsia (ID: `place:Persia`); supplication (ID: `keyterm:Supplication`); kindness (ID: `keyterm:Kindness`); Peg (ID: `realia:Peg`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); Jerusalém (ID: `place:Jerusalem`); Pérsia (ID: `place:Persia`); supplication (ID: `keyterm:Supplication`); kindness (ID: `keyterm:Kindness`); Peg (ID: `realia:Peg`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Ezra (ID: `person:Ezra`); arrepender, se (ID: `keyterm:Repent`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jeiel (ID: `person:Jehiel.8`); Secanias (ID: `person:Shecaniah.7`); Israel (ID: `person:Israel`); be unfaithful (ID: `keyterm:Unfaithful`); SENHOR (ID: `deity:Lord`); Ezra (ID: `person:Ezra`); Elam (ID: `person:Elam`)
...
* **Associated ACAI Concepts:** Covenant (ID: `keyterm:Covenant`); Instruction (ID: `keyterm:Instruction`); SENHOR (ID: `deity:Lord`); counsel (ID: `keyterm:Counsel`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `group:Benjamin`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `person:Benjamin`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jazeías (ID: `person:Jahzeiah`); Ticva (ID: `person:Tikvah.2`); Asael (ID: `person:Asahel.4`); Jônatas (ID: `person:Jonathan.10`); Sabetai (ID: `person:Shabbethai`); Mesulão (ID: `person:Meshullam.10`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`)
