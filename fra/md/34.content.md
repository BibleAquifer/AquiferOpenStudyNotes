...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); force (ID: `keyterm:Strength`); Liban (ID: `place:Lebanon`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Basan (ID: `place:Bashan`); chemin (ID: `keyterm:TheWay`); zélé (ID: `keyterm:Zealous.3`); Carmel (ID: `place:Carmel`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Carmel (ID: `place:Carmel`); force (ID: `keyterm:Strength`); Liban (ID: `place:Lebanon`); déclarer innocent (ID: `keyterm:PronounceInnocent`); se réfugier (ID: `keyterm:SeekfindRefuge`); Basan (ID: `place:Bashan`); méchanceté (ID: `keyterm:Wickedness`); chemin (ID: `keyterm:TheWay`); zélé (ID: `keyterm:Zealous.3`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`); Strong Drink (ID: `realia:StrongDrink`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); se réfugier (ID: `keyterm:SeekfindRefuge`); méchanceté (ID: `keyterm:Wickedness`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`); Strong Drink (ID: `realia:StrongDrink`)
...
* **Associated ACAI Concepts:** faire un voeu (ID: `keyterm:Vow`); état intact (ID: `keyterm:IntactState`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); méchanceté (ID: `keyterm:Wickedness`)
...
* **Associated ACAI Concepts:** se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); destin (ID: `keyterm:Lot`); Puth (ID: `place:Put`); Égypte (ID: `place:Egypt`); Libya (ID: `place:Libya`); Cush (ID: `place:Cush.2`)
