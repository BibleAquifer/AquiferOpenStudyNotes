...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); love (ID: `keyterm:Love`); Wine (ID: `realia:Wine`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); fairness (ID: `keyterm:Fairness`); Quedar (ID: `person:Kedar`); En-Gedi (ID: `place:Engedi`); Faraó (ID: `person:Pharaoh.7`); Jerusalém (ID: `place:Jerusalem`); Salomão (ID: `person:Solomon`); Nard (ID: `flora:Nard`); Henna (ID: `flora:Henna`); Kid (ID: `fauna:Kid`); Chariot (ID: `realia:Chariot`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Bag (ID: `realia:Bag`); Linen Strips (ID: `realia:LinenStrips`); Myrrh (ID: `flora:Myrrh`); Tent (ID: `realia:Tent`); Horse (ID: `fauna:Horse`); Goat Hair Strips (ID: `realia:GoatHairStrips`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Jerusalém (ID: `place:Jerusalem`); Quedar (ID: `person:Kedar`); Vine (ID: `flora:Vine`); Goat Hair Strips (ID: `realia:GoatHairStrips`); Linen Strips (ID: `realia:LinenStrips`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Salomão (ID: `person:Solomon`); Faraó (ID: `person:Pharaoh.7`); love (ID: `keyterm:Love`); Jerusalém (ID: `place:Jerusalem`); Quedar (ID: `person:Kedar`); Kid (ID: `fauna:Kid`); Horse (ID: `fauna:Horse`); Vine (ID: `flora:Vine`); Goat Hair Strips (ID: `realia:GoatHairStrips`); Linen Strips (ID: `realia:LinenStrips`); Chariot (ID: `realia:Chariot`); Tent (ID: `realia:Tent`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Deer (ID: `fauna:Deer`); Vine (ID: `flora:Vine`); Gazelle (ID: `fauna:Gazelle`); Dove (ID: `fauna:Dove`); Beter (ID: `place:BetherMountain`); Jackal (ID: `fauna:Jackal`); Window (ID: `realia:Window`); Fig (ID: `flora:Fig`); Lily (ID: `flora:Lily`)
...
* **Associated ACAI Concepts:** Libano (ID: `place:Lebanon`); Wine (ID: `realia:Wine`); Balsam Tree (ID: `flora:BalsamTree`); Cloak (ID: `realia:Cloak`); Vine (ID: `flora:Vine`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Lily (ID: `flora:Lily`); Jerusalém (ID: `place:Jerusalem`); swear (ID: `keyterm:Swear`); Balsam Tree (ID: `flora:BalsamTree`); Myrrh (ID: `flora:Myrrh`); Dove (ID: `fauna:Dove`); Libano (ID: `place:Lebanon`); love (ID: `keyterm:Love`); Tunic (ID: `realia:Tunic.2`); Veil (ID: `realia:Veil`); Cedar (ID: `flora:Cedar`); Crow (ID: `fauna:Crow`)
...
* **Associated ACAI Concepts:** Libano (ID: `place:Lebanon`); Jerusalém (ID: `place:Jerusalem`); Cedar (ID: `flora:Cedar`); Balsam Tree (ID: `flora:BalsamTree`); Crow (ID: `fauna:Crow`); Lily (ID: `flora:Lily`); Myrrh (ID: `flora:Myrrh`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Libano (ID: `place:Lebanon`); Balsam Tree (ID: `flora:BalsamTree`); Cedar (ID: `flora:Cedar`); Crow (ID: `fauna:Crow`); Lily (ID: `flora:Lily`); Myrrh (ID: `flora:Myrrh`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Standard (ID: `realia:Standard`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Tirza (ID: `place:Tirzah`); Gileade (ID: `place:Gilead`); Jerusalém (ID: `place:Jerusalem`); Veil (ID: `realia:Veil`); Sheep (ID: `fauna:Lamb`); Pomegranate (ID: `flora:Pomegranate`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Date Palm (ID: `flora:DatePalm`); Bate-Rabim (ID: `place:Bath-rabbim`); Shulammites (ID: `group:Shulammites`); Carmelo (ID: `place:Carmel`); Hesbom (ID: `place:Heshbon`); Libano (ID: `place:Lebanon`); love (ID: `keyterm:Love`); fairness (ID: `keyterm:Fairness`); Damasco (ID: `place:Damascus`); Purple Cloth (ID: `realia:PurpleCloth`); Tower (ID: `realia:Tower`); Lily (ID: `flora:Lily`); Wheat (ID: `flora:Wheat`); Gazelle (ID: `fauna:Gazelle`); Apple (ID: `flora:AppleTree`)
...
* **Associated ACAI Concepts:** Bate-Rabim (ID: `place:Bath-rabbim`); Carmelo (ID: `place:Carmel`); Hesbom (ID: `place:Heshbon`); Libano (ID: `place:Lebanon`); Damasco (ID: `place:Damascus`); Wine (ID: `realia:Wine`); Purple Cloth (ID: `realia:PurpleCloth`); Tower (ID: `realia:Tower`); Wheat (ID: `flora:Wheat`); Lily (ID: `flora:Lily`); Gazelle (ID: `fauna:Gazelle`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); love (ID: `keyterm:Love`); swear (ID: `keyterm:Swear`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Pomegranate (ID: `flora:Pomegranate`); Vine (ID: `flora:Vine`); Must (ID: `realia:Must`)
