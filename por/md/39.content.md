...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); love (ID: `keyterm:Love`); Edom (ID: `place:Edom`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); fear (ID: `keyterm:Fear`); offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); peace (ID: `keyterm:IntactState`); Priests (ID: `group:GenericPriests`); stain (ID: `keyterm:Stain`); Glory (ID: `keyterm:Glory`); utter a curse (ID: `keyterm:Curse`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); fairness (ID: `keyterm:Fairness`); ardour (ID: `keyterm:Ardour`); Gentiles (ID: `group:Gentile`); Truth (ID: `keyterm:Truth`); profane, dishonor (ID: `keyterm:Dishonor`); The Way (ID: `keyterm:TheWay`); be kindly disposed (ID: `keyterm:KindlyDisposed`); bless (ID: `keyterm:Bless`); rogar (ID: `keyterm:AskFor`); pure (ID: `keyterm:Pure`); An Angel (ID: `deity:Angel`); evil intention (ID: `keyterm:Intention`); make a vow (ID: `keyterm:Vow`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** stain (ID: `keyterm:Stain`); SENHOR (ID: `deity:Lord`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** bless (ID: `keyterm:Bless`); SENHOR (ID: `deity:Lord`); utter a curse (ID: `keyterm:Curse`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** An Angel (ID: `deity:Angel`); Instruction (ID: `keyterm:Instruction`); SENHOR (ID: `deity:Lord`); evil intention (ID: `keyterm:Intention`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); profane, dishonor (ID: `keyterm:Dishonor`); offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); delight (ID: `keyterm:Delight`); Judá (ID: `group:Judah`); love (ID: `keyterm:Love`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); love (ID: `keyterm:Love`); profane, dishonor (ID: `keyterm:Dishonor`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); A Group of People (ID: `group:GenericGroup`); fear (ID: `keyterm:Fear`); Judá (ID: `group:Judah`); swear (ID: `keyterm:Swear`); An Angel (ID: `deity:Angel`); pure (ID: `keyterm:Pure`); Judá (ID: `person:Judah.4`); Levi (ID: `group:Levi`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `person:Levi.3`); Covenant (ID: `keyterm:Covenant`); Soap (ID: `realia:Soap`); Hammada (ID: `flora:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); bless (ID: `keyterm:Bless`); decree (ID: `keyterm:Decree`); utter a curse (ID: `keyterm:Curse`); Israel (ID: `person:Israel`); Sorghum (ID: `flora:Sorghum`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); Monte Sinai (ID: `place:SinaiMount`); Moisés (ID: `person:Moses`); decree (ID: `keyterm:Decree`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); Monte Sinai (ID: `place:SinaiMount`); fear (ID: `keyterm:Fear`); Moisés (ID: `person:Moses`); Elias (ID: `person:Elijah`); decree (ID: `keyterm:Decree`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`)
