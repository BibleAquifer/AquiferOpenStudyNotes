...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Édom (ID: `place:Edom`); aimer (ID: `keyterm:Love`); Israël (ID: `person:Israel`); Édom (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Éternel (ID: `deity:Lord`); Priests (ID: `group:GenericPriests`); gloire (ID: `keyterm:Glory`); craindre (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); offrande (ID: `keyterm:Offering`); craindre (ID: `keyterm:Fear`); alliance (ID: `keyterm:Covenant`); gloire (ID: `keyterm:Glory`); Lévi (ID: `group:Levi`); état intact (ID: `keyterm:IntactState`); Lévi (ID: `person:Levi.3`); Priests (ID: `group:GenericPriests`); souiller (ID: `keyterm:Stain`); pleurer (ID: `keyterm:Curse`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); niveau (ID: `keyterm:Fairness`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); agir avec bonté (ID: `keyterm:KindlyDisposed`); An Angel (ID: `deity:Angel`); sans saleté (ID: `keyterm:Pure`); benir (ID: `keyterm:Bless`); la connaissance (ID: `keyterm:Intention`); faire un voeu (ID: `keyterm:Vow`); vérité (ID: `keyterm:Truth`); chemin (ID: `keyterm:TheWay`); nation; peuple (ID: `group:Gentile`); ardeur (ID: `keyterm:Ardour`); profaner, déshonorer (ID: `keyterm:Dishonor`); prier (ID: `keyterm:AskFor`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); souiller (ID: `keyterm:Stain`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); faire un voeu (ID: `keyterm:Vow`); pleurer (ID: `keyterm:Curse`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** la connaissance (ID: `keyterm:Intention`); Instruction (ID: `keyterm:Instruction`); Éternel (ID: `deity:Lord`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); alliance (ID: `keyterm:Covenant`); offrande (ID: `keyterm:Offering`); profaner, déshonorer (ID: `keyterm:Dishonor`); aimer (ID: `keyterm:Love`); délice (ID: `keyterm:Delight`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); aimer (ID: `keyterm:Love`); profaner, déshonorer (ID: `keyterm:Dishonor`); Jérusalem (ID: `place:Jerusalem`); Israël (ID: `person:Israel`); Juda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); offrande (ID: `keyterm:Offering`); jurer (ID: `keyterm:Swear`); alliance (ID: `keyterm:Covenant`); Juda (ID: `person:Judah.4`); A Group of People (ID: `group:GenericGroup`); Lévi (ID: `group:Levi`); Jérusalem (ID: `place:Jerusalem`); craindre (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Juda (ID: `group:Judah`); Lévi (ID: `person:Levi.3`); sans saleté (ID: `keyterm:Pure`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); benir (ID: `keyterm:Bless`); limite (ID: `keyterm:Decree`); offrande (ID: `keyterm:Offering`); Israël (ID: `person:Israel`); pleurer (ID: `keyterm:Curse`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Wheat (ID: `flora:Wheat`); Sorghum (ID: `flora:Sorghum`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); pleurer (ID: `keyterm:Curse`); offrande (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** Moïse (ID: `person:Moses`); montagne de Sinaï (ID: `place:SinaiMount`); Israël (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); limite (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** Moïse (ID: `person:Moses`); Éternel (ID: `deity:Lord`); montagne de Sinaï (ID: `place:SinaiMount`); craindre (ID: `keyterm:Fear`); Israël (ID: `person:Israel`); objet qui doit être détruit (ID: `keyterm:SomethingDevotedToGod`); Élie (ID: `person:Elijah`); Instruction (ID: `keyterm:Instruction`); limite (ID: `keyterm:Decree`)
