...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); Jérusalem (ID: `place:Jerusalem`); la connaissance (ID: `keyterm:Intention`); stupide (ID: `keyterm:Stupid`); Éternel (ID: `deity:Lord`); Vine (ID: `flora:Vine`); Israël (ID: `person:Israel`); pécher (ID: `keyterm:Sin`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); capacité (ID: `keyterm:Ability`); Vine (ID: `flora:Vine`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Wine (ID: `realia:Wine`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); stupide (ID: `keyterm:Stupid`); faire un voeu (ID: `keyterm:Vow`); House (ID: `realia:House`); ardeur (ID: `keyterm:Ardour`); An Angel (ID: `deity:Angel`); A Man (ID: `person:GenericMale`); tuerie (ID: `keyterm:Slaughtering`); craindre (ID: `keyterm:Fear`); force (ID: `keyterm:Strength`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); stupide (ID: `keyterm:Stupid`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`); laissiez en possession (ID: `keyterm:Possess`); agir par méchanceté (ID: `keyterm:ActWickedly`); pécher (ID: `keyterm:Sin`); craindre (ID: `keyterm:Fear`); la connaissance (ID: `keyterm:Intention`); Cooking Pot (ID: `realia:CookingPot`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Brier (ID: `flora:Brier`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); aimer (ID: `keyterm:Love`); capacité (ID: `keyterm:Ability`); Hell (ID: `place:Hell`); pollution (ID: `keyterm:Defilement`); jurer (ID: `keyterm:Swear`); percevoir (ID: `keyterm:Perceive`); securité (ID: `keyterm:Safety`); sans saleté (ID: `keyterm:Pure`); adjuration (ID: `keyterm:Oath`); pécher (ID: `keyterm:Sin`); la connaissance (ID: `keyterm:Intention`); ardeur (ID: `keyterm:Ardour`); grâce (ID: `keyterm:Favor`); force (ID: `keyterm:Strength`); Wine (ID: `realia:Wine`); Anointing Oil (ID: `realia:AnointingOil`); Vine (ID: `flora:Vine`); Trap (ID: `realia:Trap`); Bird (ID: `fauna:Bird`); Net (ID: `realia:Net`); Fish (ID: `fauna:Fish`); Fishnet (ID: `realia:Fishnet`); Dog (ID: `fauna:Dog`); Lion (ID: `fauna:Lion`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** adjuration (ID: `keyterm:Oath`); pécher (ID: `keyterm:Sin`); pollution (ID: `keyterm:Defilement`); sans saleté (ID: `keyterm:Pure`); jurer (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** Hell (ID: `place:Hell`); capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); force (ID: `keyterm:Strength`); la connaissance (ID: `keyterm:Intention`); aimer (ID: `keyterm:Love`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** la connaissance (ID: `keyterm:Intention`); force (ID: `keyterm:Strength`); Hell (ID: `place:Hell`); capacité (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** stupide (ID: `keyterm:Stupid`); House (ID: `realia:House`); Bed (ID: `realia:Bed`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); Caper (ID: `flora:Caper`); Locust (ID: `fauna:Locust`); Bird (ID: `fauna:Bird`); Rope (ID: `realia:Rope`); Money (ID: `realia:Money`); Pit (ID: `realia:Pit`); Clay Jar (ID: `realia:ClayJar`); Almond (ID: `flora:Almond`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); vérité (ID: `keyterm:Truth`); craindre (ID: `keyterm:Fear`); proverbe (ID: `keyterm:Saying`); la connaissance (ID: `keyterm:Intention`); droiture (ID: `keyterm:Straightness`); Goad (ID: `realia:Goad`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Scroll (ID: `realia:Scroll`); Nail (ID: `realia:Nail`)
