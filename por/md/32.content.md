...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); make a vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); Nínive (ID: `place:Nineveh`); Jope (ID: `place:Joppa`); Amittai (ID: `person:Amittai`); Hebrews (ID: `group:Hebrews`); slaughtering (ID: `keyterm:Slaughtering`); praise (ID: `keyterm:Praise`); kindness (ID: `keyterm:Kindness`); exempt (ID: `keyterm:Exempt`); lot (ID: `keyterm:Lot`); salvation (ID: `keyterm:Salvation`); Társis (ID: `place:Tarshish`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Hell (ID: `place:Hell`); praise (ID: `keyterm:Praise`); make a vow (ID: `keyterm:Vow`); kindness (ID: `keyterm:Kindness`); salvation (ID: `keyterm:Salvation`); Jonas (ID: `person:Jonah.2`); Cattails (ID: `flora:Cattails`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** praise (ID: `keyterm:Praise`); make a vow (ID: `keyterm:Vow`); kindness (ID: `keyterm:Kindness`); SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Nínive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Társis (ID: `place:Tarshish`); gracious (ID: `keyterm:Generous`); kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`); Believe In (ID: `keyterm:BelieveIn`); Goat (ID: `fauna:Goat`); Throne (ID: `realia:Throne`); Clothing (ID: `realia:Clothing`); Flock (ID: `fauna:Flock`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Társis (ID: `place:Tarshish`); gracious (ID: `keyterm:Generous`); kindness (ID: `keyterm:Kindness`); SENHOR (ID: `deity:Lord`); Compassionate (ID: `keyterm:Compassionate`)
