...
* **Associated ACAI Concepts:** Efrata (ID: `person:Ephrathah`); Ephrathites (ID: `group:Ephrathah`); Noemi (ID: `person:Naomi`); Quiliom (ID: `person:Chilion`); Moabe (ID: `place:Moab`); Judá (ID: `group:Judah`); Elimeleque (ID: `person:Elimelech`); Judá (ID: `person:Judah.4`); Belém (ID: `place:Bethlehem`); Malom (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Noemi (ID: `person:Naomi`); kindness (ID: `keyterm:Kindness`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Moabe (ID: `place:Moab`); Noemi (ID: `person:Naomi`); Belém (ID: `place:Bethlehem`); Rute (ID: `person:Ruth`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Moabe (ID: `place:Moab`); Noemi (ID: `person:Naomi`); Rute (ID: `person:Ruth`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** bless (ID: `keyterm:Bless`); Noemi (ID: `person:Naomi`); kindness (ID: `keyterm:Kindness`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Raquel (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); Lia (ID: `person:Leah`); SENHOR (ID: `deity:Lord`); Belém (ID: `place:Bethlehem`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Perez (ID: `person:Perez`); Tamar (ID: `person:Tamar`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); SENHOR (ID: `deity:Lord`); Noemi (ID: `person:Naomi`); Israel (ID: `person:Israel`); bless (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Salmom (ID: `person:Salmon`); Hezrom (ID: `person:Hezron.2`); Aminadabe (ID: `person:Amminadab`); Obede (ID: `person:Obed`); Ram (ID: `person:Ram`); Naassom (ID: `person:Nahshon`); Perez (ID: `person:Perez`); Boaz (ID: `person:Boaz`); Jessé (ID: `person:Jesse`); Davi (ID: `person:David`)
