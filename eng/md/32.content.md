...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jonah (ID: `person:Jonah.2`); Fear (ID: `keyterm:Fear`); Fish (ID: `fauna:Fish`); Ship (ID: `realia:Ship`); Hell (ID: `place:Hell`); Vow (ID: `keyterm:Vow`); Nineveh (ID: `place:Nineveh`); Amittai (ID: `person:Amittai`); Joppa (ID: `place:Joppa`); Exempt (ID: `keyterm:Exempt`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Slaughtering (ID: `keyterm:Slaughtering`); Hebrews (ID: `group:Hebrews`); Praise (ID: `keyterm:Praise`); Salvation (ID: `keyterm:Salvation`); Kindness (ID: `keyterm:Kindness`); Tarshish (ID: `place:Tarshish`); Lot (ID: `keyterm:Lot`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Vow (ID: `keyterm:Vow`); Salvation (ID: `keyterm:Salvation`); Praise (ID: `keyterm:Praise`); Kindness (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jonah (ID: `person:Jonah.2`); Nineveh (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Generous (ID: `keyterm:Generous`); Tarshish (ID: `place:Tarshish`); Compassionate (ID: `keyterm:Compassionate`); Believe In (ID: `keyterm:BelieveIn`); Kindness (ID: `keyterm:Kindness`); Goat (ID: `fauna:Goat`); Worm (ID: `fauna:Maggot`); Flock (ID: `fauna:Flock`); Throne (ID: `realia:Throne`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Generous (ID: `keyterm:Generous`); Tarshish (ID: `place:Tarshish`); LORD (ID: `deity:Lord`); Compassionate (ID: `keyterm:Compassionate`); Kindness (ID: `keyterm:Kindness`)
