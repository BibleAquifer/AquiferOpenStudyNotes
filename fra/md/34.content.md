...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); déclarer innocent (ID: `keyterm:PronounceInnocent`); chemin (ID: `keyterm:TheWay`); force (ID: `keyterm:Strength`); Liban (ID: `place:Lebanon`); Carmel (ID: `place:Carmel`); Basan (ID: `place:Bashan`); zélé (ID: `keyterm:Zealous.3`)
...
* **Associated ACAI Concepts:** chemin (ID: `keyterm:TheWay`); déclarer innocent (ID: `keyterm:PronounceInnocent`); force (ID: `keyterm:Strength`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); état intact (ID: `keyterm:IntactState`); faire un voeu (ID: `keyterm:Vow`); méchanceté (ID: `keyterm:Wickedness`)
...
* **Associated ACAI Concepts:** se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Libya (ID: `place:Libya`); Cush (ID: `place:Cush.2`); Égypte (ID: `place:Egypt`); Puth (ID: `place:Put`); destin (ID: `keyterm:Lot`)
