...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); zélé (ID: `keyterm:Zealous.3`); force (ID: `keyterm:Strength`); Liban (ID: `place:Lebanon`); Basan (ID: `place:Bashan`); Carmel (ID: `place:Carmel`); déclarer innocent (ID: `keyterm:PronounceInnocent`); chemin (ID: `keyterm:TheWay`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); zélé (ID: `keyterm:Zealous.3`); se réfugier (ID: `keyterm:SeekfindRefuge`); force (ID: `keyterm:Strength`); Liban (ID: `place:Lebanon`); Basan (ID: `place:Bashan`); Carmel (ID: `place:Carmel`); déclarer innocent (ID: `keyterm:PronounceInnocent`); méchanceté (ID: `keyterm:Wickedness`); chemin (ID: `keyterm:TheWay`); Strong Drink (ID: `realia:StrongDrink`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** déclarer innocent (ID: `keyterm:PronounceInnocent`); Éternel (ID: `deity:Lord`); chemin (ID: `keyterm:TheWay`); force (ID: `keyterm:Strength`)
...
* **Associated ACAI Concepts:** Carmel (ID: `place:Carmel`); Liban (ID: `place:Lebanon`); Basan (ID: `place:Bashan`)
...
* **Associated ACAI Concepts:** Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); faire un voeu (ID: `keyterm:Vow`); état intact (ID: `keyterm:IntactState`); méchanceté (ID: `keyterm:Wickedness`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); Éternel (ID: `deity:Lord`); Grass (ID: `flora:Grass`); Goat (ID: `fauna:Goat`); Chariot (ID: `realia:Chariot`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Lion (ID: `fauna:Lion`); Chariot (ID: `realia:Chariot`)
...
* **Associated ACAI Concepts:** Cush (ID: `place:Cush.2`); Libya (ID: `place:Libya`); Puth (ID: `place:Put`); destin (ID: `keyterm:Lot`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Égypte (ID: `place:Egypt`)
