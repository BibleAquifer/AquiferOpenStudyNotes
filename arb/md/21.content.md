...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); أورشَلِيمَ (ID: `place:Jerusalem`); Intention (ID: `keyterm:Intention`); ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vine (ID: `flora:Vine`); To Sin (ID: `keyterm:Sin`); إِسْرَائِيلَ (ID: `person:Israel`); Sandalwood (ID: `flora:Sandalwood`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Flock (ID: `fauna:Flock`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); أورشَلِيمَ (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Flock (ID: `fauna:Flock`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Flock (ID: `fauna:Flock`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vow (ID: `keyterm:Vow`); House (ID: `realia:House`); Slaughtering (ID: `keyterm:Slaughtering`); An Angel (ID: `deity:Angel`); Strength (ID: `keyterm:Strength`); Fear (ID: `keyterm:Fear`); A Man (ID: `person:GenericMale`); Passion (ID: `keyterm:Ardour`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Stupid (ID: `keyterm:Stupid`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); To Sin (ID: `keyterm:Sin`); To Cause to Possess (ID: `keyterm:Possess`); Fear (ID: `keyterm:Fear`); To Act Wickedly (ID: `keyterm:ActWickedly`); Intention (ID: `keyterm:Intention`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Cooking Pot (ID: `realia:CookingPot`); Brier (ID: `flora:Brier`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Ability (ID: `keyterm:Ability`); Strength (ID: `keyterm:Strength`); ٱلرَّبِّ (ID: `deity:Lord`); Hell (ID: `place:Hell`); Intention (ID: `keyterm:Intention`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); ٱلرَّبِّ (ID: `deity:Lord`); Caper (ID: `flora:Caper`); Clay Jar (ID: `realia:ClayJar`); Pit (ID: `realia:Pit`); Rope (ID: `realia:Rope`); Bird (ID: `fauna:Bird`); Almond (ID: `flora:Almond`); Locust (ID: `fauna:Locust`); Money (ID: `realia:Money`)
