...
* **Associated ACAI Concepts:** tahan uji (ID: `keyterm:Approved`); berbahagialah (ID: `keyterm:Happy`); kasihi (ID: `keyterm:Love`); janji (ID: `keyterm:Promise`); kehidupan (ID: `keyterm:Life`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); mencobai (ID: `keyterm:PutToTheTest`); berbahagialah (ID: `keyterm:Happy`); kekasih (ID: `keyterm:Beloved`); sia, sia (ID: `keyterm:Worthless`); suci (ID: `keyterm:Clean`); tahan uji (ID: `keyterm:Approved`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kehidupan (ID: `keyterm:Life`); tak bernoda (ID: `keyterm:AboveCriticism`); keahlian (ID: `keyterm:Ability`); tidak dapat dicobai (ID: `keyterm:NotTempted`); A Person (ID: `person:GenericPerson`); yang baik (ID: `keyterm:Good`); keselamatan (ID: `keyterm:Salvation`); tidak dicemarkan (ID: `keyterm:Undefiled`); kebenaran (ID: `keyterm:Truth`); kasihi (ID: `keyterm:Love`); hati (ID: `keyterm:Heart`); berbuat dosa (ID: `keyterm:Sin`); janji (ID: `keyterm:Promise`); hukum (ID: `keyterm:Law`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** sia, sia (ID: `keyterm:Worthless`); suci (ID: `keyterm:Clean`); hati (ID: `keyterm:Heart`); Tuhan (ID: `deity:Lord`); tidak dicemarkan (ID: `keyterm:Undefiled`); tak bernoda (ID: `keyterm:AboveCriticism`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); tonton bulu atau muka (ID: `keyterm:Partiality`); bimbang (ID: `keyterm:Discern`); kemuliaan (ID: `keyterm:Glory`); Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** kasihi (ID: `keyterm:Love`); keahlian (ID: `keyterm:Ability`); janji (ID: `keyterm:Promise`); Tuhan (ID: `deity:Lord`); kerajaan (ID: `keyterm:Kingdom`); orang pilihan (ID: `keyterm:Chosen`); kekasih (ID: `keyterm:Beloved`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); tonton bulu atau muka (ID: `keyterm:Partiality`); tersandung (ID: `keyterm:Stumble`); penghakiman (ID: `keyterm:Judgment`); kasihi (ID: `keyterm:Love`); kitab suci (ID: `keyterm:Scripture`); memutuskan (ID: `keyterm:Decided`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`); berbuat dosa (ID: `keyterm:Sin`); belas kasihan (ID: `keyterm:Mercy`); persundalan (ID: `keyterm:Fornication`); pengadilan (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kitab suci (ID: `keyterm:Scripture`); Tuhan (ID: `deity:Lord`); Abraham (ID: `person:Abraham`); percaya (ID: `keyterm:Believe`); menggenapi (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** lalim (ID: `keyterm:UnjustDeed`); neraka (ID: `keyterm:Gehenna`); Hell (ID: `place:Hell`); tubuh (ID: `keyterm:Body.3`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); persahabatan (ID: `keyterm:Friendship`); tidak setia (ID: `keyterm:Unfaithful`); Cause of Joy (ID: `keyterm:CauseOfJoy`); kitab suci (ID: `keyterm:Scripture`); ingin (ID: `keyterm:LongFor`); hati (ID: `keyterm:Heart`); membersihkan (ID: `keyterm:Cleanse.2`); murni (ID: `keyterm:Pure`); roh (ID: `keyterm:Spirit.2`); Roh (ID: `deity:HolySpirit`); keahlian (ID: `keyterm:Ability`); kebaikan (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); bersaksi (ID: `keyterm:BearWitness`); hati (ID: `keyterm:Heart`); menentang (ID: `keyterm:Condemn`); Tuhan (ID: `deity:Lord`); tubuh (ID: `keyterm:Body.3`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); diurapi (ID: `keyterm:Anointed`); Tuhan (ID: `deity:Lord`); jemaat (ID: `keyterm:Church`); nama (ID: `keyterm:Name`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); berbuat dosa (ID: `keyterm:Sin`); Tuhan (ID: `deity:Lord`); keselamatan (ID: `keyterm:Salvation`); percaya (ID: `keyterm:Believe`); mengampuni (ID: `keyterm:Forgive`)
