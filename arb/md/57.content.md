...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); إِلَى (ID: `person:Philemon`); إِلَى (ID: `person:Apphia`); لِأَرْخِبّسَ (ID: `person:Archippus`); بولسَ (ID: `person:Paul`); تِيموثَاوس (ID: `person:Timothy`); ٱلرَّبِّ (ID: `deity:Lord`); Church (ID: `keyterm:Church`); Beloved (ID: `keyterm:Beloved`); Favor (ID: `keyterm:Favor`); Make Peace (ID: `keyterm:Peace`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Holy (ID: `keyterm:Holy`); يَسوع (ID: `person:Jesus.2`); Believe (ID: `keyterm:Believe`); Love (ID: `keyterm:Love`); ٱلرَّبِّ (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Good (ID: `keyterm:Good`); Ask for (ID: `keyterm:AskFor`); Fellowship (ID: `keyterm:Fellowship`); Pray (ID: `keyterm:Pray`); Affection (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); In Christ (ID: `keyterm:InChrist`); Love (ID: `keyterm:Love`); Ask for (ID: `keyterm:AskFor`); بولسَ (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); لوقَا (ID: `person:Luke`); دِيمَاس (ID: `person:Demas`); أَبَفْرَاسَ (ID: `person:Epaphras`); Spirit (ID: `keyterm:Spirit.2`); مَرْقسَ (ID: `person:Mark`); In Christ (ID: `keyterm:InChrist`); Favor (ID: `keyterm:Favor`); أَرِسْتَرْخسَ (ID: `person:Aristarchus`)
