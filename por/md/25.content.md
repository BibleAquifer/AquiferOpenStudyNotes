...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); defilement (ID: `keyterm:Defilement`); Jerusalém (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** appointed feast (ID: `keyterm:AppointedFeast`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); sabbath (ID: `keyterm:Sabbath`)
...
* **Associated ACAI Concepts:** appointed feast (ID: `keyterm:AppointedFeast`); SENHOR (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); To Sin (ID: `keyterm:Sin`); stain (ID: `keyterm:Stain`); Uz (ID: `place:Uz`); anointed (ID: `keyterm:Anointed`); Appoint (ID: `keyterm:Appoint`); Believe In (ID: `keyterm:BelieveIn`); Complete (ID: `keyterm:Complete`); be kindly disposed (ID: `keyterm:KindlyDisposed`); Punishment (ID: `keyterm:Punishment`); defilement (ID: `keyterm:Defilement`); Sodoma (ID: `place:Sodom`); Jackal (ID: `fauna:Jackal`); Ostrich (ID: `fauna:Ostrich`); Clay Jar (ID: `realia:ClayJar`); Vulture (ID: `fauna:Vulture`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** Edom (ID: `place:Edom`); Uz (ID: `place:Uz`); Jerusalém (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); ardour (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); Edom (ID: `place:Edom`); Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); ardour (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); Woe (ID: `keyterm:Woe`); Judá (ID: `person:Judah.4`); Assyria (ID: `place:Assyria`); round dance (ID: `keyterm:RoundDance`); ardour (ID: `keyterm:Ardour`); to cause to possess (ID: `keyterm:Possess`); Judá (ID: `group:Judah`); Egito (ID: `place:Egypt`); Hand-Mill (ID: `realia:Hand-mill`); Jackal (ID: `fauna:Jackal`); Money (ID: `realia:Money`); Crown (ID: `realia:Crown`); House (ID: `realia:House`)
