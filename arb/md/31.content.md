...
* **Associated ACAI Concepts:** Peace (ID: `keyterm:IntactState`); Covenant (ID: `keyterm:Covenant`); Understanding (ID: `keyterm:Understanding`); Edomites (ID: `group:Edom`); أَدومَ (ID: `place:Edom`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** أَدومَ (ID: `place:Edom`); ٱلرَّبِّ (ID: `deity:Lord`); عِيسو (ID: `place:EsauMount`); Understanding (ID: `keyterm:Understanding`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `person:Judah.4`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); Lot (ID: `keyterm:Lot`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); يوسف (ID: `person:Joseph.10`); Edomites (ID: `group:Edom`); أورشَلِيمَ (ID: `place:Jerusalem`); أَدومَ (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** يوسف (ID: `person:Joseph.10`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Edomites (ID: `group:Edom`); أَدومَ (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); ٱلْجَنوبِ (ID: `place:Negeb`); بَنْيَامِينَ (ID: `group:Benjamin`); كَنْعَان (ID: `place:Canaan`); أَفْرَايِمَ (ID: `group:Ephraim`); بَنْيَامِينَ (ID: `person:Benjamin`); ٱلسَّامِرَةِ (ID: `place:Samaria`); ٱلسَّهْلِ (ID: `place:Shephelah`); جِلْعَادَ (ID: `place:Gilead`); إِسْرَائِيلَ (ID: `person:Israel`); عِيسو (ID: `place:EsauMount`); فِلِشْتِيم (ID: `group:Philistine`); Canaanites (ID: `group:Canaan`); إِلَى (ID: `place:Zarephath`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); أورشَلِيمَ (ID: `place:Jerusalem`); سَارْدِسَ (ID: `place:Sardis`); أَفْرَايِمَ (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Dispossess (ID: `keyterm:Dispossess`); عِيسو (ID: `place:EsauMount`); ٱلْجَنوبِ (ID: `place:Negeb`); جِلْعَادَ (ID: `place:Gilead`); إِسْرَائِيلَ (ID: `person:Israel`); Canaanites (ID: `group:Canaan`); فِلِشْتِيم (ID: `group:Philistine`); أَفْرَايِمَ (ID: `person:Ephraim`); ٱلسَّامِرَةِ (ID: `place:Samaria`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); كَنْعَان (ID: `place:Canaan`); ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `person:Benjamin`); ٱلسَّهْلِ (ID: `place:Shephelah`); سَارْدِسَ (ID: `place:Sardis`); بَنْيَامِينَ (ID: `group:Benjamin`); أَفْرَايِمَ (ID: `group:Ephraim`); إِلَى (ID: `place:Zarephath`)
...
* **Associated ACAI Concepts:** كَنْعَان (ID: `place:Canaan`); Dispossess (ID: `keyterm:Dispossess`); إِسْرَائِيلَ (ID: `person:Israel`); Canaanites (ID: `group:Canaan`); إِلَى (ID: `place:Zarephath`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْجَنوبِ (ID: `place:Negeb`); سَارْدِسَ (ID: `place:Sardis`)
