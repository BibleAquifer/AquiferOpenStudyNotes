...
* **Associated ACAI Concepts:** Believe In (ID: `keyterm:BelieveIn`); Caldéia (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); strength (ID: `keyterm:Strength`); dispossess (ID: `keyterm:Dispossess`); Leopard (ID: `fauna:Leopard`); Wolf (ID: `fauna:Wolf`); Vulture (ID: `fauna:Vulture`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Casting Net (ID: `realia:CastingNet`); pure (ID: `keyterm:Pure`); SENHOR (ID: `deity:Lord`); holy (ID: `keyterm:Holy`); Fortification (ID: `realia:Fortification`); Fish (ID: `fauna:Fish`); Chameleon (ID: `fauna:Chameleon`); Monitor (ID: `fauna:Iguana`); Lizard (ID: `fauna:Lizard`); Harpoon (ID: `realia:Harpoon`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); literally: nought (ID: `keyterm:Idol`); Be Disgraced (ID: `keyterm:Disgraced`); Hell (ID: `place:Hell`); Libano (ID: `place:Lebanon`); lean on (ID: `keyterm:LeanOn`); saying (ID: `keyterm:Saying`); Money (ID: `realia:Money`); Graven Image (ID: `realia:GravenImage`); Beam (ID: `realia:Beam`); Tablet (ID: `realia:Tablet`); Image (ID: `realia:Image`); Wine (ID: `realia:Wine`); Molten Image (ID: `realia:MoltenImage`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Be Disgraced (ID: `keyterm:Disgraced`); SENHOR (ID: `deity:Lord`); Libano (ID: `place:Lebanon`); Glory (ID: `keyterm:Glory`); Woe (ID: `keyterm:Woe.2`)
...
* **Associated ACAI Concepts:** literally: nought (ID: `keyterm:Idol`); SENHOR (ID: `deity:Lord`); lean on (ID: `keyterm:LeanOn`); Woe (ID: `keyterm:Woe.2`); Money (ID: `realia:Money`); Graven Image (ID: `realia:GravenImage`); Image (ID: `realia:Image`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); Cusã (ID: `place:Cushan`); Temã (ID: `place:Teman`); Monte Paran (ID: `place:ParanMount`); Oath (ID: `keyterm:Oath`); anointed (ID: `keyterm:Anointed`); arrow (ID: `keyterm:Arrow`); holy (ID: `keyterm:Holy`); mischief (ID: `keyterm:Mischief`); Midiã (ID: `place:Midian`); SENHOR (ID: `deity:Lord`); majesty (ID: `keyterm:Majesty`); Chariot (ID: `realia:Chariot`); Spear (ID: `realia:Spear`); Foundation (ID: `realia:Foundation`); Bow (ID: `realia:Bow`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); Oath (ID: `keyterm:Oath`); SENHOR (ID: `deity:Lord`); anointed (ID: `keyterm:Anointed`); arrow (ID: `keyterm:Arrow`); Foundation (ID: `realia:Foundation`); Bow (ID: `realia:Bow`); Chariot (ID: `realia:Chariot`); Spear (ID: `realia:Spear`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); salvation (ID: `keyterm:Salvation`); Flock (ID: `fauna:Flock`); Fig (ID: `flora:Fig`); Olive Tree (ID: `flora:OliveTree`); Animal Pen (ID: `realia:AnimalPen`); Sheepfold (ID: `realia:Sheepfold`); Cattle (ID: `fauna:Bull`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`)
