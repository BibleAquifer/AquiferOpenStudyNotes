...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Betlehem (ID: `place:Bethlehem`); Yehuda (ID: `person:Judah.4`); Yehuda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Mahlon (ID: `person:Chilion`); Efrata (ID: `person:Ephrathah`); Ephrathites (ID: `group:Ephrathah`); Naomi (ID: `person:Naomi`); Yehuda (ID: `person:Judah.4`); Moab (ID: `place:Moab`); Betlehem (ID: `place:Bethlehem`); Elimelekh (ID: `person:Elimelech`); Yehuda (ID: `group:Judah`); Mahlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Betlehem (ID: `place:Bethlehem`); Rut (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** kebaikan (ID: `keyterm:Favor`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); Rut (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); memberkati (ID: `keyterm:Bless`); Naomi (ID: `person:Naomi`); kebaikan (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** Rut (ID: `person:Ruth`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); menyebabkan memiliki (ID: `keyterm:Possess`); Boas (ID: `person:Boaz`)
...
* **Associated ACAI Concepts:** Betlehem (ID: `place:Bethlehem`); Rahel (ID: `person:Rachel`); Tuhan (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); Israel (ID: `person:Israel`); Lea (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Tamar (ID: `person:Tamar`); Yehuda (ID: `person:Judah.4`); Tuhan (ID: `deity:Lord`); Yehuda (ID: `group:Judah`); Peres (ID: `person:Perez`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); memberkati (ID: `keyterm:Bless`); Tuhan (ID: `deity:Lord`); Israel (ID: `person:Israel`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** memperanakkan (ID: `person:Salmon`); Hezron (ID: `person:Hezron.2`); Obed (ID: `person:Obed`); Aminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Nahason (ID: `person:Nahshon`); Isai (ID: `person:Jesse`); Peres (ID: `person:Perez`); Daud (ID: `person:David`); Boas (ID: `person:Boaz`)
