...
* **Associated ACAI Concepts:** niveau (ID: `keyterm:Fairness`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Soap (ID: `realia:Soap`); Hammada (ID: `flora:Soap`); Éternel (ID: `deity:Lord`)
