...
* **Associated ACAI Concepts:** James (ID: `person:James.3`); LORD (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`)
...
* **Associated Articles:** James 2:1 (ID: `17410@TyndaleStudyNotes`)
...
* **Associated ACAI Concepts:** Happy (ID: `keyterm:Happy`); Approved (ID: `keyterm:Approved`); Life (ID: `keyterm:Life`); Promise (ID: `keyterm:Promise`); Love (ID: `keyterm:Love`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Put to the Test (ID: `keyterm:PutToTheTest`); Happy (ID: `keyterm:Happy`); Beloved (ID: `keyterm:Beloved`); Clean (ID: `keyterm:Clean`); Worthless (ID: `keyterm:Worthless`); Approved (ID: `keyterm:Approved`); Law (ID: `keyterm:Law`); Above Criticism (ID: `keyterm:AboveCriticism`); Good (ID: `keyterm:Good`); A Person (ID: `person:GenericPerson`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Truth (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); Undefiled (ID: `keyterm:Undefiled`); Salvation (ID: `keyterm:Salvation`); To Sin (ID: `keyterm:Sin`); Life (ID: `keyterm:Life`); Promise (ID: `keyterm:Promise`); Not Tempted (ID: `keyterm:NotTempted`); Love (ID: `keyterm:Love`); Heart (ID: `keyterm:Heart`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** Put to the Test (ID: `keyterm:PutToTheTest`); LORD (ID: `deity:Lord`); A Person (ID: `person:GenericPerson`); Not Tempted (ID: `keyterm:NotTempted`)
...
*forgets what he looks like*: The issue is not the poor quality of an ancient mirror, but the viewer's lack of attention (see [Matthew 7:24–27](https://ref.ly/Matt7:24-Matt7:27)).
...
* **Associated ACAI Concepts:** Clean (ID: `keyterm:Clean`); Worthless (ID: `keyterm:Worthless`); Heart (ID: `keyterm:Heart`); Above Criticism (ID: `keyterm:AboveCriticism`); Undefiled (ID: `keyterm:Undefiled`); LORD (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); Partiality (ID: `keyterm:Partiality`); Jesus (ID: `person:Jesus.2`); Believe (ID: `keyterm:Believe`); Discern (ID: `keyterm:Discern`); Glory (ID: `keyterm:Glory`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Promise (ID: `keyterm:Promise`); Chosen (ID: `keyterm:Chosen`); Kingdom (ID: `keyterm:Kingdom`); Beloved (ID: `keyterm:Beloved`); Believe (ID: `keyterm:Believe`); LORD (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Written (ID: `keyterm:Scripture`); Love (ID: `keyterm:Love`); Law (ID: `keyterm:Law`)
...
* **Associated ACAI Concepts:** Law (ID: `keyterm:Law`); Partiality (ID: `keyterm:Partiality`); Judgment (ID: `keyterm:Judgment`); Stumble (ID: `keyterm:Stumble`); Written (ID: `keyterm:Scripture`); Merciless (ID: `keyterm:Merciless`); Court Case (ID: `keyterm:CourtCase`); Mercy (ID: `keyterm:Mercy`); Fornication (ID: `keyterm:Fornication`); To Sin (ID: `keyterm:Sin`); Love (ID: `keyterm:Love`); Decided (ID: `keyterm:Decided`)
...
* **Associated Articles:** James 1:25 (ID: `17394@TyndaleStudyNotes`)
...
* **Associated ACAI Concepts:** Judgment (ID: `keyterm:Judgment`); Court Case (ID: `keyterm:CourtCase`); Merciless (ID: `keyterm:Merciless`); Mercy (ID: `keyterm:Mercy`)
...
* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Body (ID: `keyterm:Body.3`); Abraham (ID: `person:Abraham`); A Person (ID: `person:GenericPerson`); LORD (ID: `deity:Lord`); Rahab (ID: `person:Rahab`); Useless (ID: `keyterm:Idle`); Salvation (ID: `keyterm:Salvation`); Empty (ID: `keyterm:Empty`); To Cause to Happen (ID: `keyterm:Happen`); Written (ID: `keyterm:Scripture`); An Angel (ID: `deity:Angel`); Demons (ID: `deity:Demons`); Spirit (ID: `keyterm:Spirit.2`); Make Peace (ID: `keyterm:Peace`); Isaac (ID: `person:Isaac`)
...
* **Associated Articles:** James 1:13 (ID: `17383@TyndaleStudyNotes`)
...
* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); Rahab (ID: `person:Rahab`); Useless (ID: `keyterm:Idle`); Body (ID: `keyterm:Body.3`); Empty (ID: `keyterm:Empty`); To Cause to Happen (ID: `keyterm:Happen`); Written (ID: `keyterm:Scripture`); LORD (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Isaac (ID: `person:Isaac`); Spirit (ID: `keyterm:Spirit.2`)
...
* *the Scripture was fulfilled*: James saw the offering of Isaac in [Genesis 22](https://ref.ly/Gen22:1-Gen22:24) as fulfilling the pledge of the faith of Abraham and the declaration of God that Abraham was righteous (quoted from [Genesis 15:6](https://ref.ly/Gen15:6)).
...
* **Associated ACAI Concepts:** Written (ID: `keyterm:Scripture`); To Cause to Happen (ID: `keyterm:Happen`); Abraham (ID: `person:Abraham`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Believe (ID: `keyterm:Believe`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Hell (ID: `place:Hell`); Unjust Deed (ID: `keyterm:UnjustDeed`); Gehenna (ID: `keyterm:Gehenna`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Be Unfaithful (ID: `keyterm:Unfaithful`); Friendship (ID: `keyterm:Friendship`); LORD (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Be Unfaithful (ID: `keyterm:Unfaithful`); Friendship (ID: `keyterm:Friendship`); Written (ID: `keyterm:Scripture`); Heart (ID: `keyterm:Heart`); Favor (ID: `keyterm:Favor`); Long For (ID: `keyterm:LongFor`); Pure (ID: `keyterm:Pure`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Spirit (ID: `keyterm:Spirit.2`); Holy Spirit (ID: `deity:HolySpirit`); To Cleanse (ID: `keyterm:Cleanse.2`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Holy Spirit (ID: `deity:HolySpirit`); Written (ID: `keyterm:Scripture`); Long For (ID: `keyterm:LongFor`); Spirit (ID: `keyterm:Spirit.2`)
...
* **Associated ACAI Concepts:** Pure (ID: `keyterm:Pure`); LORD (ID: `deity:Lord`); To Cleanse (ID: `keyterm:Cleanse.2`); Heart (ID: `keyterm:Heart`)
...
* **Associated Articles:** James 1:22-23 (ID: `17391@TyndaleStudyNotes`)

* **Associated ACAI Concepts:** Decided (ID: `keyterm:Decided`); Lawgiver (ID: `keyterm:Lawgiver`); Law (ID: `keyterm:Law`); Salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Condemn (ID: `keyterm:Condemn`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Bear Witness (ID: `keyterm:BearWitness`); LORD (ID: `deity:Lord`); Heart (ID: `keyterm:Heart`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Compassionate (ID: `keyterm:Compassionate`); Job (ID: `person:Job`); Regard as Happy (ID: `keyterm:RegardAsHappy`); LORD (ID: `deity:Lord`); Full of Compassion (ID: `keyterm:FullOfCompassion`)

## James 5:12 (id: 17451)

*do not swear*: The churches were having serious arguments ([4:1–3](https://ref.ly/Jas4:1-Jas4:3), [11–12](https://ref.ly/Jas4:11-Jas4:12)), so James advised them to avoid dishonest oaths by not using any oaths at all ([Matt 5:33–37](https://ref.ly/Matt5:33-Matt5:37)). Swearing an oath in the Lord's name meant asking God to enforce it ([Genesis 31:53](https://ref.ly/Gen31:53); [1 Kings 8:31–32](https://ref.ly/1Kgs8:31-1Kgs8:32)). People swore by heaven or earth. They either pretended to be respectful while avoiding speaking God's name or used tricky words to deceive ([Matthew 23:16–22](https://ref.ly/Matt23:16-Matt23:22)). Peter used an oath dishonestly ([Matthew 26:71–73](https://ref.ly/Matt26:71-Matt26:73)). But Paul used one to support his claims ([Romans 1:9](https://ref.ly/Rom1:9); [2 Corinthians 1:23](https://ref.ly/2Cor1:23)). This indicates that the rule against oaths is not absolute.
...
* **Associated Articles:** James (ID: `27344@TyndaleStudyNotesBookIntros`)

* **Associated ACAI Concepts:** Pray (ID: `keyterm:Pray`); Name (ID: `keyterm:Name`); Church (ID: `keyterm:Church`); Anointed (ID: `keyterm:Anointed`); LORD (ID: `deity:Lord`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Pray (ID: `keyterm:Pray`); Salvation (ID: `keyterm:Salvation`); Believe (ID: `keyterm:Believe`); Forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); LORD (ID: `deity:Lord`)
