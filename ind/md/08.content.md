...
* **Associated ACAI Concepts:** Mahlon (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Efrata (ID: `person:Ephrathah`); Ephrathites (ID: `group:Ephrathah`); Betlehem (ID: `place:Bethlehem`); Yehuda (ID: `group:Judah`); Elimelekh (ID: `person:Elimelech`); Moab (ID: `place:Moab`); Mahlon (ID: `person:Mahlon`); Yehuda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Betlehem (ID: `place:Bethlehem`); Naomi (ID: `person:Naomi`); Rut (ID: `person:Ruth`); Moab (ID: `place:Moab`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Rut (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); kebaikan (ID: `keyterm:Favor`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** kebaikan (ID: `keyterm:Kindness`); Naomi (ID: `person:Naomi`); memberkati (ID: `keyterm:Bless`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Rut (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); Boas (ID: `person:Boaz`); menyebabkan memiliki (ID: `keyterm:Possess`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Rut (ID: `person:Ruth`); Mahlon (ID: `person:Mahlon`); menyebabkan memiliki (ID: `keyterm:Possess`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Betlehem (ID: `place:Bethlehem`); Elders (ID: `group:GenericElders`); Rahel (ID: `person:Rachel`); Lea (ID: `person:Leah`); Israel (ID: `person:Israel`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Peres (ID: `person:Perez`); Tamar (ID: `person:Tamar`); Yehuda (ID: `group:Judah`); Tuhan (ID: `deity:Lord`); Yehuda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Naomi (ID: `person:Naomi`); Tuhan (ID: `deity:Lord`); Israel (ID: `person:Israel`); memberkati (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); memperanakkan (ID: `person:Salmon`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Peres (ID: `person:Perez`); Nahason (ID: `person:Nahshon`); Boas (ID: `person:Boaz`); Daud (ID: `person:David`); Isai (ID: `person:Jesse`)
