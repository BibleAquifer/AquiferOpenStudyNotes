...
* **Associated ACAI Concepts:** Covenant (ID: `keyterm:Covenant`); Peace (ID: `keyterm:IntactState`); Edomites (ID: `group:Edom`); Understanding (ID: `keyterm:Understanding`); Edom (ID: `place:Edom`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** Tribe of Judah (ID: `group:Judah`); Lot (ID: `keyterm:Lot`); Israel (ID: `person:Israel`); Jerusalem (ID: `place:Jerusalem`); Judah (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); Joseph (ID: `person:Joseph.10`); Edom (ID: `place:Edom`); Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Negev (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); Philistia (ID: `place:Philistine`); Philistines (ID: `group:Philistine`); Benjamin (ID: `person:Benjamin`); Zarephath (ID: `place:Zarephath`); Samaria (ID: `place:Samaria`); Sardis (ID: `place:Sardis`); Canaanites (ID: `group:Canaan`); Tribe of Ephraim (ID: `group:Ephraim`); Mount Esau (ID: `place:EsauMount`); Gilead (ID: `place:Gilead`); Shephelah (ID: `place:Shephelah`); Canaan (ID: `place:Canaan`); Israel (ID: `person:Israel`); Tribe of Benjamin (ID: `group:Benjamin`); Jerusalem (ID: `place:Jerusalem`); Ephraim (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** Mount Esau (ID: `place:EsauMount`); Negev (ID: `place:Negeb`); Jerusalem (ID: `place:Jerusalem`); Dispossess (ID: `keyterm:Dispossess`); Philistia (ID: `place:Philistine`); Sardis (ID: `place:Sardis`); Gilead (ID: `place:Gilead`); Shephelah (ID: `place:Shephelah`); Zarephath (ID: `place:Zarephath`); Tribe of Ephraim (ID: `group:Ephraim`); Israel (ID: `person:Israel`); Ephraim (ID: `person:Ephraim`); Canaanites (ID: `group:Canaan`); Canaan (ID: `place:Canaan`); Philistines (ID: `group:Philistine`); Benjamin (ID: `person:Benjamin`); Samaria (ID: `place:Samaria`); Tribe of Benjamin (ID: `group:Benjamin`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Negev (ID: `place:Negeb`); Zarephath (ID: `place:Zarephath`); Dispossess (ID: `keyterm:Dispossess`); Sardis (ID: `place:Sardis`); Canaan (ID: `place:Canaan`); Israel (ID: `person:Israel`); Jerusalem (ID: `place:Jerusalem`); Canaanites (ID: `group:Canaan`)
