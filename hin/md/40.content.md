...
* **Associated ACAI Concepts:** Blood (ID: `keyterm:Blood`); Body (ID: `keyterm:Body.3`); यहोवा (ID: `deity:Lord`); यीशु (ID: `person:Jesus.2`); Kingdom (ID: `keyterm:Kingdom`); Covenant (ID: `keyterm:Covenant`); Bless (ID: `keyterm:Bless`); To Sin (ID: `keyterm:Sin`); Be a Disciple (ID: `keyterm:Disciple`); Forgive (ID: `keyterm:Forgive`); Vine (ID: `flora:Vine`)
