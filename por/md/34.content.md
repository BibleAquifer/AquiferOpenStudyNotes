...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Carmelo (ID: `place:Carmel`); Libano (ID: `place:Lebanon`); Basã (ID: `place:Bashan`); Zealous (ID: `keyterm:Zealous.3`); strength (ID: `keyterm:Strength`); The Way (ID: `keyterm:TheWay`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Carmelo (ID: `place:Carmel`); Libano (ID: `place:Lebanon`); wickedness (ID: `keyterm:Wickedness`); Basã (ID: `place:Bashan`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Zealous (ID: `keyterm:Zealous.3`); strength (ID: `keyterm:Strength`); The Way (ID: `keyterm:TheWay`); Fortress (ID: `realia:Fortress`); Strong Drink (ID: `realia:StrongDrink`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** wickedness (ID: `keyterm:Wickedness`); Judá (ID: `group:Judah`); make a vow (ID: `keyterm:Vow`); peace (ID: `keyterm:IntactState`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); SENHOR (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Flock (ID: `fauna:Flock`); Grass (ID: `flora:Grass`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Pute (ID: `place:Put`); Líbia (ID: `place:Libya`); Cush (ID: `place:Cush.2`); lot (ID: `keyterm:Lot`); Egito (ID: `place:Egypt`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`)
