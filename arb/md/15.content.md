...
* **Associated ACAI Concepts:** فَارِسَ (ID: `place:Persia`); كورَشَ (ID: `person:Cyrus`); ٱلرَّبِّ (ID: `deity:Lord`); إِرْمِيَا (ID: `person:Jeremiah.6`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`); إِسْرَائِيلَ (ID: `person:Israel`); إِرْمِيَا (ID: `person:Jeremiah.6`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
## عزرا 1: 2 (id: 751923)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`)
## عزرا 1: 3 (id: 751924)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`)
## عزرا 1: 4 (id: 751925)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `person:Benjamin`); لَّاوِي (ID: `group:Levi`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `group:Benjamin`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`)
## عزرا 1: 7 (id: 751927)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); كورَشَ (ID: `person:Cyrus`); House (ID: `realia:House`)
## عزرا 1: 8 (id: 751928)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath`); فَارِسَ (ID: `place:Persia`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `person:Judah.4`); كورَشَ (ID: `person:Cyrus`); يَهوذَا (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); أورشَلِيمَ (ID: `place:Jerusalem`); سلَيْمَانَ (ID: `person:Solomon`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); جَاحَرَ (ID: `person:Gahar`); بَابَايَ (ID: `person:Bebai`); جَدِّيلَ (ID: `person:Giddel.2`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); هَقّوصَ (ID: `person:Hakkoz.2`); Beth-azmaveth (ID: `place:Beth-azmaveth`); حَارِيمَ (ID: `person:Harim.2`); فَاسِيحَ (ID: `person:Paseah.2`); حَرْشَا (ID: `person:Harsha`); نَقودَا (ID: `person:Nekoda.2`); رَحوم (ID: `person:Rehum`); فِي (ID: `person:Uzza.2`); حَطِّيلَ (ID: `person:Hattil`); سَرَايَا (ID: `person:Seraiah.6`); مرْدَخَاي (ID: `person:Mordecai`); Nephushesim (ID: `group:Nephushesim`); صِيحَا (ID: `person:Ziha`); يَدَايَا (ID: `person:Jedaiah.4`); بَانِيَ (ID: `person:Bani`); زَتّو (ID: `person:Zattu.2`); Tel-harsha (ID: `place:Tel-harsha`); كَروب (ID: `place:Cherub`); حَارِيمَ (ID: `person:Harim`); بِلْشَان (ID: `person:Bilshan`)
## عزرا 2: 2 (id: 751941)
...
* **Associated ACAI Concepts:** رَعْلَايَا (ID: `person:Reelaiah`); نَحَمْيَا (ID: `person:Nehemiah`); بَعْنَةَ (ID: `person:Baanah.3`); سَرَايَا (ID: `person:Seraiah.6`); مِسْفَار (ID: `person:Mispar`); مرْدَخَاي (ID: `person:Mordecai`); بِغْوَايَ (ID: `person:Bigvai`); رَحوم (ID: `person:Rehum`); بِلْشَان (ID: `person:Bilshan`); إِسْرَائِيلَ (ID: `person:Israel`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** حَشوم (ID: `person:Hashum`); عَادِينَ (ID: `person:Adin`); زَكَّايَ (ID: `person:Zaccai.2`); بَابَايَ (ID: `person:Bebai`); بِغْوَايَ (ID: `person:Bigvai.2`); بِيصَايَ (ID: `person:Bezai`); آرَحَ (ID: `person:Arah.2`); شَفَطْيَا (ID: `person:Shephatiah.6`); يَشوعَ (ID: `person:Jeshua.3`); يوآب (ID: `person:Joab.3`); عِيلَامَ (ID: `person:Elam`); يورَةَ (ID: `person:Jorah`); Pahath-moab (ID: `person:Pahath-moab`); أَدونِيقَامَ (ID: `person:Adonikam`); آطِيرَ (ID: `person:Ater`); فَرْعوشَ (ID: `person:Parosh`); عَرْجَدَ (ID: `person:Azgad`); بَانِيَ (ID: `person:Bani`); زَتّو (ID: `person:Zattu.2`); حَزَقِيَّا (ID: `person:Hezekiah.2`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** سَنَاءَةَ (ID: `place:Senaah`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); Beth-azmaveth (ID: `place:Beth-azmaveth`); حَارِيمَ (ID: `person:Harim.2`); حَادِيدَ (ID: `place:Hadid`); نَبو (ID: `place:Nebo.2`); مَغْبِيشَ (ID: `place:Magbish`); Bethel (ID: `place:Bethel`); عَايٍ (ID: `place:Ai`); مِنْ (ID: `place:Geba`); عَنَاثوثَ (ID: `place:Anathoth`); أَرِيحَا (ID: `place:Jericho`); Kiriath-jearim (ID: `place:Kiriath-jearim`); عِيلَامَ (ID: `person:Elam`); أونوَ (ID: `place:Ono`); Ramah (ID: `place:Ramah.2`); بَئِيروت (ID: `place:Beeroth`); لَحْمٍ (ID: `place:Bethlehem`); مِخْمَاسَ (ID: `place:Michmash`); وَلودَ (ID: `place:Lod`); ٱلْكَفِيرَة (ID: `place:Chephirah`)
...
* **Associated ACAI Concepts:** حَطِيطَا (ID: `person:Hatita`); آطِيرَ (ID: `person:Ater.2`); يَشوعَ (ID: `person:Jeshua`); يَشوعَ (ID: `person:Jeshua.4`); لِإِيمِيرَ (ID: `person:Immer.2`); طَلْمون (ID: `person:Talmon`); حَارِيمَ (ID: `person:Harim`); يَدَايَا (ID: `person:Jedaiah.4`); هودَوْيَا (ID: `person:Hodaviah.4`); شوبَايَ (ID: `person:Shobai`); لَّاوِي (ID: `person:Levi.3`); فَشْحور (ID: `person:Pashhur`); لَّاوِي (ID: `group:Levi`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); عَقّوب (ID: `person:Akkub.2`); شَلّوم (ID: `person:Shallum.8`); آسَاف (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** حَطِيطَا (ID: `person:Hatita`); آطِيرَ (ID: `person:Ater.2`); طَلْمون (ID: `person:Talmon`); شوبَايَ (ID: `person:Shobai`); عَقّوب (ID: `person:Akkub.2`); شَلّوم (ID: `person:Shallum.8`); آسَاف (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** لَبَانَةَ (ID: `person:Lebanah`); جَاحَرَ (ID: `person:Gahar`); بِيسَايَ (ID: `person:Besai`); نَقودَا (ID: `person:Nekoda`); طَبَاعوتَ (ID: `person:Tabbaoth`); بَقْبوقَ (ID: `person:Bakbuk`); ثَامَحَ (ID: `person:Temah`); حَجَابَةَ (ID: `person:Hagabah`); سِيعَهَا (ID: `person:Siaha`); جَدِّيلَ (ID: `person:Giddel`); جَزَّامَ (ID: `person:Gazzam`); فَاسِيحَ (ID: `person:Paseah.2`); رَآيَا (ID: `person:Reaiah.3`); بَرْقوسَ (ID: `person:Barkos`); حَرْشَا (ID: `person:Harsha`); قِيروسَ (ID: `person:Keros`); حَسوفَا (ID: `person:Hasupha`); فِي (ID: `person:Uzza.2`); حَرْحورَ (ID: `person:Harhur`); عَقّوب (ID: `person:Akkub.3`); رَصِينَ (ID: `person:Rezin.2`); سَلْمَايَ (ID: `person:Shalmai`); Meunim (ID: `group:Meunim`); حَقوفَا (ID: `person:Hakupha`); حَاجَابَ (ID: `person:Hagab`); Nephushesim (ID: `group:Nephushesim`); سِيسَرَا (ID: `person:Sisera.2`); مَحِيدَا (ID: `person:Mehida`); صِيحَا (ID: `person:Ziha`); أَسْنَةَ (ID: `person:Asnah`); حَطِيفَا (ID: `person:Hatipha`); نَصِيحَ (ID: `person:Neziah`); فَادونَ (ID: `person:Padon`); بَصْلوتَ (ID: `person:Bazluth`); حَانَان (ID: `person:Hanan.4`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); شَفَطْيَا (ID: `person:Shephatiah.7`); يَعْلَةَ (ID: `person:Jaalah`); دَرْقونَ (ID: `person:Darkon`); جَدِّيلَ (ID: `person:Giddel.2`); سَوْطَايَ (ID: `person:Sotai`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); فَرودَا (ID: `person:Peruda`); سوفَرَثَ (ID: `person:Sophereth`); حَطِّيلَ (ID: `person:Hattil`); آمِي (ID: `person:Ami`)
...
* **Associated ACAI Concepts:** Tel-melah (ID: `place:Tel-melah`); أَدَّان (ID: `place:Addan`); لِإِيمِيرَ (ID: `place:Immer`); نَقودَا (ID: `person:Nekoda.2`); Tel-harsha (ID: `place:Tel-harsha`); كَروب (ID: `place:Cherub`); طوبِيَّا (ID: `person:Tobiah`); لِدَلَايَا (ID: `person:Delaiah.3`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** بَرْزِلَّايَ (ID: `person:Barzillai.3`); هَقّوصَ (ID: `person:Hakkoz.2`); حَبَايَا (ID: `person:Habaiah`); بَرْزِلَّايَ (ID: `person:Barzillai`); Priesthood (ID: `keyterm:Priesthood`); جِلْعَادَ (ID: `place:Gilead`); Gileadites (ID: `group:Gilead`); Defile (ID: `keyterm:Stain`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); أورشَلِيمَ (ID: `place:Jerusalem`); Strength (ID: `keyterm:Strength`); ٱلرَّبِّ (ID: `deity:Lord`); Mina (ID: `realia:Mina`); Money (ID: `realia:Money`); Tunic (ID: `realia:Tunic`); House (ID: `realia:House`)
## عزرا 2: 69 (id: 751951)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); يَشوع (ID: `person:Joshua.5`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Relatives (ID: `group:Relatives`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); يَشوعَ (ID: `person:Jeshua.4`); هودَوْيَا (ID: `person:Hodaviah.4`); حِينَادَادَ (ID: `person:Henadad`); Esarhaddon (ID: `person:Esarhaddon`); Tyrians (ID: `group:Tyre`); هودِيَّا (ID: `person:Hodiah.2`); صِيْدونَ (ID: `place:Sidon`); يَافَا (ID: `place:Joppa`); آسَاف (ID: `person:Asaph.2`); دَارِيوسَ (ID: `person:Darius.2`); Holy (ID: `keyterm:Holy`); Sidonians (ID: `group:Sidon`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); بَنْيَامِينَ (ID: `group:Benjamin`); Kindness (ID: `keyterm:Kindness`); Appointed Feast (ID: `keyterm:AppointedFeast`); Terror (ID: `keyterm:Terror`); صورَ (ID: `place:Tyre`); Instruction (ID: `keyterm:Instruction`); لبْنَانَ (ID: `place:Lebanon`); موسَى (ID: `person:Moses`); Counsel (ID: `keyterm:Counsel`); بَنْيَامِينَ (ID: `person:Benjamin`); Assyria (ID: `place:Assyria`); دَاودَ (ID: `person:David`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`); Craftsman (ID: `realia:Craftsman`)
## عزرا 3: 2 (id: 751956)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Offering (ID: `keyterm:Offering`); موسَى (ID: `person:Moses`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`)
## عزرا 3: 3 (id: 751957)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Terror (ID: `keyterm:Terror`); Offering (ID: `keyterm:Offering`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`)
## عزرا 3: 4 (id: 751958)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Holy (ID: `keyterm:Holy`); Appointed Feast (ID: `keyterm:AppointedFeast`); New Moon Festival (ID: `keyterm:NewMoonFestival`)
## عزرا 3: 7 (id: 751960)
...
* **Associated ACAI Concepts:** فَارِسَ (ID: `place:Persia`); Tyrians (ID: `group:Tyre`); Sidonians (ID: `group:Sidon`); صِيْدونَ (ID: `place:Sidon`); صورَ (ID: `place:Tyre`); يَافَا (ID: `place:Joppa`); لبْنَانَ (ID: `place:Lebanon`); كورَشَ (ID: `person:Cyrus`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Craftsman (ID: `realia:Craftsman`)
## عزرا 3: 8 (id: 751961)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `group:Levi`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); ٱلرَّبِّ (ID: `deity:Lord`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); دَاودَ (ID: `person:David`); Kindness (ID: `keyterm:Kindness`); آسَاف (ID: `person:Asaph.2`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); House (ID: `realia:House`)
## عزرا 3: 12 (id: 751954)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `person:Benjamin`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `group:Judah`)
## عزرا 4: 2 (id: 751974)
...
* **Associated ACAI Concepts:** Esarhaddon (ID: `person:Esarhaddon`); Assyria (ID: `place:Assyria`); ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`)
## عزرا 4: 3 (id: 751975)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); فَارِسَ (ID: `place:Persia`); إِسْرَائِيلَ (ID: `person:Israel`); زَربَّابِل (ID: `person:Zerubbabel.2`); ٱلرَّبِّ (ID: `deity:Lord`); كورَشَ (ID: `person:Cyrus`); يَشوع (ID: `person:Joshua.5`); House (ID: `realia:House`)
## عزرا 4: 4 (id: 751976)
...
* **Associated ACAI Concepts:** دَارِيوسَ (ID: `person:Darius.2`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); Counsel (ID: `keyterm:Counsel`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); فَارِسَ (ID: `place:Persia`); ٱلسَّامِرَةِ (ID: `place:Samaria`); أَرَكَ (ID: `place:Erech`); مِثْرَدَاث (ID: `person:Mithredath.2`); بِشْلَام (ID: `person:Bishlam`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); طَبْئِيل (ID: `person:Tabeel`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); Babylonians (ID: `group:Babylon`); أسْنَفَّر (ID: `person:Osnappar`); فِي (ID: `place:Susa`); Persians (ID: `group:Persia`); يَهوذَا (ID: `group:Judah`); Elamites (ID: `group:Elam`); عِيلَامَ (ID: `place:Elam`); يَهوذَا (ID: `person:Judah.4`); بَابِلَ (ID: `place:Babylon`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
## عزرا 4: 7 (id: 751979)
...
* **Associated ACAI Concepts:** ٱلدِّينِيِّينَ (ID: `person:Dinaite`); Babylonians (ID: `group:Babylon`); أَرَكَ (ID: `place:Erech`); شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); فَارِسَ (ID: `place:Persia`); فِي (ID: `place:Susa`); عِيلَامَ (ID: `place:Elam`); بَابِلَ (ID: `place:Babylon`); Persians (ID: `group:Persia`); Elamites (ID: `group:Elam`)
## عزرا 4: 10 (id: 751962)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); ٱلسَّامِرَةِ (ID: `place:Samaria`); رَحوم (ID: `person:Rehum.2`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
## عزرا 4: 13 (id: 751964)
...
* **Associated ACAI Concepts:** شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); أورشَلِيمَ (ID: `place:Jerusalem`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`)
## عزرا ٤: ٢٤ (id: 751973)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); دَارِيوسَ (ID: `person:Darius.2`); Jews (ID: `group:Jews`); تَتْنَاي (ID: `person:Tattenai`); حَجَّيِ (ID: `person:Haggai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); زَكَرِيَّا (ID: `person:Zechariah.17`); يَدّو (ID: `person:Iddo.6`); فَارِسَ (ID: `place:Persia`); إِسْرَائِيلَ (ID: `person:Israel`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَهوذَا (ID: `person:Judah.4`); ٱلْفرَاتِ (ID: `place:Euphrates`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`)
## عزرا 5: 1 (id: 751986)
...
* **Associated ACAI Concepts:** حَجَّيِ (ID: `person:Haggai`); زَكَرِيَّا (ID: `person:Zechariah.17`); يَدّو (ID: `person:Iddo.6`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); Jews (ID: `group:Jews`)
## عزرا 5: 2 (id: 751987)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
## عزرا 5: 3 (id: 751988)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); أورشَلِيمَ (ID: `place:Jerusalem`); بَابِلَ (ID: `place:Babylon`); كورَشَ (ID: `person:Cyrus`); دَارِيوسَ (ID: `person:Darius.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); تَتْنَاي (ID: `person:Tattenai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); ٱلْفرَاتِ (ID: `place:Euphrates`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`); Foundation (ID: `realia:Foundation`)
## عزرا 5: 8 (id: 751992)
...
* **Associated ACAI Concepts:** ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); بَابِلَ (ID: `place:Babylon`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); House (ID: `realia:House`)
## عزرا 5: 13 (id: 751983)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); بَابِلَ (ID: `place:Babylon`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); كورَشَ (ID: `person:Cyrus`); Money (ID: `realia:Money`)
## عزرا ٥: ١٦ (id: 751985)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`)
## عزرا 6: 18 (id: 751997)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); Passover (ID: `keyterm:Passover`); لَّاوِي (ID: `group:Levi`); Pure (ID: `keyterm:Pure`)
## عزرا 6: 21 (id: 752000)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Assyria (ID: `place:Assyria`); House (ID: `realia:House`); Unleavened Bread (ID: `realia:UnleavenedBread`)
## عزرا 7: 1 (id: 752012)
...
* **Associated ACAI Concepts:** عَزَرْيَا (ID: `person:Azariah.7`); سَرَايَا (ID: `person:Seraiah.2`); عَزْرَا (ID: `person:Ezra`); فَارِسَ (ID: `place:Persia`); حِلْقِيَّا (ID: `person:Hilkiah.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); عَزَرْيَا (ID: `person:Azariah.6`); بقِّي (ID: `person:Bukki.2`); لِمَرَايوثَ (ID: `person:Meraioth`); عزِّي (ID: `person:Uzzi`); صَادوق (ID: `person:Zadok.4`); سَرَايَا (ID: `person:Seraiah.2`); شَلّوم (ID: `person:Shallum.7`); أَبِيشوعَ (ID: `person:Abishua`); عَزَرْيَا (ID: `person:Azariah.7`); أَمَرْيَا (ID: `person:Amariah.2`); زَرَحْيَا (ID: `person:Zerahiah`); أَخِيطوبَ (ID: `person:Ahitub.3`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فِينَحَاس (ID: `person:Phinehas`); فَارِسَ (ID: `place:Persia`); هَارون (ID: `person:Aaron`); أَلِعَازَار (ID: `person:Eleazar.2`); حِلْقِيَّا (ID: `person:Hilkiah.2`)
## عزرا 7: 6 (id: 752017)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); بَابِلَ (ID: `place:Babylon`); Instruction (ID: `keyterm:Instruction`); موسَى (ID: `person:Moses`)
## عزرا 7: 9 (id: 752018)
...
* **Associated ACAI Concepts:** Decree (ID: `keyterm:Decree`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); عَزْرَا (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); عَزْرَا (ID: `person:Ezra`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `group:Levi`); ٱلْفرَاتِ (ID: `place:Euphrates`); لَّاوِي (ID: `person:Levi.3`); Decree (ID: `keyterm:Decree`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); بَابِلَ (ID: `place:Babylon`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Sheep (ID: `fauna:Lamb`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Talent (ID: `realia:Talent`); Kor (ID: `realia:Kor`); Altar (ID: `realia:Altar`); Wheat (ID: `flora:Wheat`); Temple Altar (ID: `realia:TempleAltar`)
## عزرا 7: 14 (id: 752009)
...
* **Associated ACAI Concepts:** أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); ٱلْفرَاتِ (ID: `place:Euphrates`); عَزْرَا (ID: `person:Ezra`); Money (ID: `realia:Money`); Wheat (ID: `flora:Wheat`); Kor (ID: `realia:Kor`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Talent (ID: `realia:Talent`)
## عزرا 7: 23 (id: 752014)
...
* **Associated ACAI Concepts:** يوآب (ID: `person:Joab.4`); عَادِينَ (ID: `person:Adin`); يوشَفْيَا (ID: `person:Josiphiah`); شَكَنْيَا (ID: `person:Shecaniah.6`); بَابَايَ (ID: `person:Bebai`); حَطّوش (ID: `person:Hattush.2`); يَحِيئِيل (ID: `person:Jehiel.7`); بِغْوَايَ (ID: `person:Bigvai.2`); يونَاثَانَ (ID: `person:Jonathan.9`); زَكّور (ID: `person:Zaccur.5`); شَكَنْيَا (ID: `person:Shecaniah.5`); دَانِيآل (ID: `person:Daniel.2`); زَكَرِيَّا (ID: `person:Zechariah.19`); شَفَطْيَا (ID: `person:Shephatiah.6`); عَثَلْيَا (ID: `person:Athaliah.3`); يِشْعِيَا (ID: `person:Jeshaiah.4`); مِيخَائِيلَ (ID: `person:Michael.10`); عِيلَامَ (ID: `person:Elam`); عوتَاي (ID: `person:Uthai.2`); زَبَدْيَا (ID: `person:Zebadiah.8`); Pahath-moab (ID: `person:Pahath-moab`); Gershom (ID: `person:Gershom.2`); يوحَانَانَ (ID: `person:Johanan.8`); أَدونِيقَامَ (ID: `person:Adonikam`); زَكَرِيَّا (ID: `person:Zechariah.18`); شَلومِيَةَ (ID: `person:Shelomith.4`); شِمْعِيَا (ID: `person:Shemaiah.14`); عوبَدْيَا (ID: `person:Obadiah.10`); يَعِيئِيل (ID: `person:Jeuel.3`); فَرْعوشَ (ID: `person:Parosh.2`); زَرَحْيَا (ID: `person:Zerahiah.2`); هِقَّاطَانَ (ID: `person:Hakkatan`); عَابِد (ID: `person:Ebed.2`); عَرْجَدَ (ID: `person:Azgad`); أَلِيفَلَط (ID: `person:Eliphelet.5`); بَابَايَ (ID: `person:Bebai.2`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); يَحْزِيئِيل (ID: `person:Jahaziel.5`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فِينَحَاس (ID: `person:Phinehas`); إِيثَامَارَ (ID: `person:Ithamar`); بَابِلَ (ID: `place:Babylon`); دَاودَ (ID: `person:David`)
## عزرا 8: 15 (id: 752020)
...
* **Associated ACAI Concepts:** أَرِيئِيلَ (ID: `person:Ariel`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); يَارِيبَ (ID: `person:Jarib.2`); شِمْعِيَا (ID: `person:Shemaiah.15`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); يويَارِيبَ (ID: `person:Joiarib.2`); نَاثَان (ID: `person:Nathan.5`); يَدّو (ID: `person:Iddo`); أَلِيعَزَرَ (ID: `person:Eliezer.8`); زَكَرِيَّا (ID: `person:Zechariah.20`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); ٱلْمسَمَّى (ID: `place:Casiphia`); مَشلَّام (ID: `person:Meshullam.9`); ٱلرَّبِّ (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
## عزرا 8: 18 (id: 752022)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Insight (ID: `keyterm:Insight`); مَحْلِي (ID: `person:Mahli`)
## عزرا 8: 20 (id: 752023)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); Work (ID: `keyterm:Work`); لَّاوِي (ID: `group:Levi`); دَاودَ (ID: `person:David`)
## عزرا 8: 21 (id: 752024)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); لَّاوِي (ID: `person:Levi.3`); كَنْعَان (ID: `place:Canaan`); Amorites (ID: `group:Amorites`); لَّاوِي (ID: `group:Levi`); إِسْرَائِيلَ (ID: `person:Israel`); Canaanites (ID: `group:Canaan`); Egyptians (ID: `group:Egypt`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); Be Unfaithful (ID: `keyterm:Unfaithful`); Jebusites (ID: `group:Jebusites`); Ammonites (ID: `group:Ammon`); حِثًّا (ID: `person:Heth`); موآبَ (ID: `place:Moab`); مِصْرَ (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); Counsel (ID: `keyterm:Counsel`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); عِيلَامَ (ID: `person:Elam`); Offering (ID: `keyterm:Offering`); بَنْيَامِينَ (ID: `person:Benjamin.3`); أَلِيعَزَرَ (ID: `person:Eliezer.9`); أَلْيَاشِيب (ID: `person:Eliashib.5`); نْيَا (ID: `person:Vaniah`); نَثَنْئِيل (ID: `person:Nethanel.8`); بِيدْيَا (ID: `person:Bedeiah`); شِمْعِيَا (ID: `person:Shemaiah.16`); مَتَّثْيَا (ID: `person:Mattithiah.3`); يَحِيئِيل (ID: `person:Jehiel.10`); يَهوذَا (ID: `person:Judah.5`); مَنَسَّى (ID: `person:Manasseh.4`); مَتَّنْيَا (ID: `person:Mattaniah.8`); مَشلَّام (ID: `person:Meshullam.11`); شَآل (ID: `person:Sheal`); يَعْسو (ID: `person:Jaasu`)
## عزرا 9: 3 (id: 752036)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); Defilement (ID: `keyterm:Defilement`); أورشَلِيمَ (ID: `place:Jerusalem`); فَارِسَ (ID: `place:Persia`); Kindness (ID: `keyterm:Kindness`); إِسْرَائِيلَ (ID: `person:Israel`); Plea for Mercy (ID: `keyterm:Supplication`); Peace (ID: `keyterm:IntactState`); To Cause to Possess (ID: `keyterm:Possess`); Dispossess (ID: `keyterm:Dispossess`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`)
## عزرا 9: 7 (id: 752041)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); فَارِسَ (ID: `place:Persia`); أورشَلِيمَ (ID: `place:Jerusalem`); Kindness (ID: `keyterm:Kindness`); Plea for Mercy (ID: `keyterm:Supplication`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Repent (ID: `keyterm:Repent`); عَزْرَا (ID: `person:Ezra`); House (ID: `realia:House`)
## عزرا 10: 2 (id: 751932)
...
* **Associated ACAI Concepts:** يَحِيئِيل (ID: `person:Jehiel.8`); شَكَنْيَا (ID: `person:Shecaniah.7`); عِيلَامَ (ID: `person:Elam`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Be Unfaithful (ID: `keyterm:Unfaithful`); عَزْرَا (ID: `person:Ezra`)
## عزرا 10: 3 (id: 751933)
...
* **Associated ACAI Concepts:** Covenant (ID: `keyterm:Covenant`); ٱلرَّبِّ (ID: `deity:Lord`); Counsel (ID: `keyterm:Counsel`); Instruction (ID: `keyterm:Instruction`)
## عزرا 10: 4 (id: 751935)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Swear (ID: `keyterm:Swear`)
## عزرا 10: 8 (id: 751937)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `person:Benjamin`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** مَشلَّام (ID: `person:Meshullam.10`); يَحْزِيَا (ID: `person:Jahzeiah`); عَسَائِيل (ID: `person:Asahel.4`); يونَاثَانَ (ID: `person:Jonathan.10`); شَبْتَاي (ID: `person:Shabbethai`); تِقْوَةَ (ID: `person:Tikvah.2`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`)
