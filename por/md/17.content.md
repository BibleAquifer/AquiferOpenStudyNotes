...
* **Associated ACAI Concepts:** Harbona (ID: `person:Harbona`); Bizta (ID: `person:Biztha`); Meumã (ID: `person:Mehuman`); Bigtá (ID: `person:Bigtha`); Abagta (ID: `person:Abagtha`); Zetar (ID: `person:Zethar`); Carcas (ID: `person:Carkas`); Assuero (ID: `person:Ahasuerus`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Vasti (ID: `person:Vashti`); Medã (ID: `person:Medan`); Persians (ID: `group:Persia`); Assuero (ID: `person:Ahasuerus`); Medes (ID: `group:Mede`); Pérsia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Jeoaquim (ID: `person:Jehoiachin`); Babilônia (ID: `place:Babylon`); Judá (ID: `person:Judah.4`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Assuero (ID: `person:Ahasuerus`); Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Agagites (ID: `group:Agag`); Hamedata (ID: `person:Hammedatha`); Agague (ID: `person:Agag.2`); Money (ID: `realia:Money`); Susã (ID: `place:Susa`); lot (ID: `keyterm:Lot`); Servants (ID: `group:GenericServants`); Lot (ID: `realia:Lot`); Scroll (ID: `realia:Scroll`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Hamã (ID: `person:Haman`); Assuero (ID: `person:Ahasuerus`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Agagites (ID: `group:Agag`); Agague (ID: `person:Agag.2`); Jews (ID: `group:Jews`); Hamedata (ID: `person:Hammedatha`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Zeres (ID: `person:Zeresh`); A Group of People (ID: `group:GenericGroup`); Jews (ID: `group:Jews`); Mordecai (ID: `person:Mordecai.2`); Hamã (ID: `person:Haman`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Agague (ID: `person:Agag.2`); Jews (ID: `group:Jews`); beg for mercy (ID: `keyterm:BegForMercy`); Ester (ID: `person:Esther`); Agagites (ID: `group:Agag`); Hamã (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Hamedata (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); favor (ID: `keyterm:Favor`); Agague (ID: `person:Agag.2`); Jews (ID: `group:Jews`); Hamã (ID: `person:Haman`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Susã (ID: `place:Susa`); Mordecai (ID: `person:Mordecai.2`); Purple Cloth (ID: `realia:PurpleCloth`); Linen (ID: `realia:Linen`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Adalia (ID: `person:Adalia`); Aridai (ID: `person:Aridai`); Parsandata (ID: `person:Parshandatha`); Arisai (ID: `person:Arisai`); Aspata (ID: `person:Aspatha`); Porata (ID: `person:Poratha`); Aridata (ID: `person:Aridatha`); Dalfom (ID: `person:Dalphon`); Vaizata (ID: `person:Vaizatha`); Farmasta (ID: `person:Parmashta`); Jews (ID: `group:Jews`); Hamedata (ID: `person:Hammedatha`); Hamã (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Lot (ID: `realia:Lot`); Hamedata (ID: `person:Hammedatha`); lot (ID: `keyterm:Lot`); Agagites (ID: `group:Agag`); Agague (ID: `person:Agag.2`); Mordecai (ID: `person:Mordecai.2`); Hamã (ID: `person:Haman`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Media (ID: `place:Media`); Mordecai (ID: `person:Mordecai.2`); Pérsia (ID: `place:Persia`); Assuero (ID: `person:Ahasuerus`)
