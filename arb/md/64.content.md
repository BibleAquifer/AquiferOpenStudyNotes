...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); Beloved (ID: `keyterm:Beloved`); Live (ID: `keyterm:Live.3`); غَايوس (ID: `person:Gaius.4`); Love (ID: `keyterm:Love`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Pray (ID: `keyterm:Pray`); Bear Witness (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Faithfulness (ID: `keyterm:Faithfulness`); Beloved (ID: `keyterm:Beloved`); Name (ID: `keyterm:Name`); Church (ID: `keyterm:Church`); Bear Witness (ID: `keyterm:BearWitness`); ٱلرَّبِّ (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); Obligated (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** Church (ID: `keyterm:Church`); دِيمِتْرِيوس (ID: `person:Demetrius`); دِيوتْرِيفِسَ (ID: `person:Diotrephes`); Good (ID: `keyterm:Good`); True (ID: `keyterm:True`); Beloved (ID: `keyterm:Beloved`); Bear Witness (ID: `keyterm:BearWitness`); ٱلرَّبِّ (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); Do Good (ID: `keyterm:DoGood`)
