...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); Fear (ID: `keyterm:Fear`); Fish (ID: `fauna:Fish`); Ship (ID: `realia:Ship`); Vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); يَافَا (ID: `place:Joppa`); أَمِتَّايَ (ID: `person:Amittai`); نِينَوَى (ID: `place:Nineveh`); Kindness (ID: `keyterm:Kindness`); Exempt (ID: `keyterm:Exempt`); Lot (ID: `keyterm:Lot`); Salvation (ID: `keyterm:Salvation`); Hebrews (ID: `group:Hebrews`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Slaughtering (ID: `keyterm:Slaughtering`); Praise (ID: `keyterm:Praise`); تَرْشِيشَ (ID: `place:Tarshish`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Hell (ID: `place:Hell`); يونَانَ (ID: `person:Jonah.2`); Kindness (ID: `keyterm:Kindness`); Salvation (ID: `keyterm:Salvation`); Vow (ID: `keyterm:Vow`); Praise (ID: `keyterm:Praise`); Cattails (ID: `flora:Cattails`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Salvation (ID: `keyterm:Salvation`); Vow (ID: `keyterm:Vow`); Praise (ID: `keyterm:Praise`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); نِينَوَى (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Generous (ID: `keyterm:Generous`); Kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`); تَرْشِيشَ (ID: `place:Tarshish`); Believe In (ID: `keyterm:BelieveIn`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`); Worm (ID: `fauna:Maggot`); Clothing (ID: `realia:Clothing`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); Generous (ID: `keyterm:Generous`); Kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`); تَرْشِيشَ (ID: `place:Tarshish`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Generous (ID: `keyterm:Generous`); Kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`); تَرْشِيشَ (ID: `place:Tarshish`)
