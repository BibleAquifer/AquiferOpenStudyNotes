...
* **Associated ACAI Concepts:** Dario (ID: `person:Darius.2`); Jeozadaque (ID: `person:Jehozadak`); Ageu (ID: `person:Haggai`); Sealtiel (ID: `person:Shealtiel.2`); Josué (ID: `person:Joshua.5`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Ageu (ID: `person:Haggai`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Dario (ID: `person:Darius.2`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); An Angel (ID: `deity:Angel`); fear (ID: `keyterm:Fear`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Vine (ID: `flora:Vine`); Olive Tree (ID: `flora:OliveTree`); Mule (ID: `fauna:Mule`); Anointing Oil (ID: `realia:AnointingOil`); Grain (ID: `flora:Grain`); Olive Oil (ID: `realia:OliveOil`); Bag (ID: `realia:Bag`); Must (ID: `realia:Must`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); SENHOR (ID: `deity:Lord`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Ageu (ID: `person:Haggai`); fear (ID: `keyterm:Fear`); Sealtiel (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Josué (ID: `person:Joshua.5`); Judá (ID: `person:Judah.4`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Ageu (ID: `person:Haggai`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `group:Judah`); Egito (ID: `place:Egypt`); Judá (ID: `person:Judah.4`); peace (ID: `keyterm:IntactState`); fear (ID: `keyterm:Fear`); Sealtiel (ID: `person:Shealtiel.2`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `group:Judah`); Ageu (ID: `person:Haggai`); Judá (ID: `person:Judah.4`); Sealtiel (ID: `person:Shealtiel.2`); Horse (ID: `fauna:Horse`); Sword (ID: `realia:Sword`); Chariot (ID: `realia:Chariot`)
