...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Intention (ID: `keyterm:Intention`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vine (ID: `flora:Vine`); إِسْرَائِيلَ (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`); Wine (ID: `realia:Wine`); Cattle (ID: `fauna:Bull`); Sandalwood (ID: `flora:Sandalwood`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); أورشَلِيمَ (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`); Wine (ID: `realia:Wine`); Cattle (ID: `fauna:Bull`); Sandalwood (ID: `flora:Sandalwood`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); Sandalwood (ID: `flora:Sandalwood`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Intention (ID: `keyterm:Intention`); Ability (ID: `keyterm:Ability`); ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vow (ID: `keyterm:Vow`); House (ID: `realia:House`); Passion (ID: `keyterm:Ardour`); An Angel (ID: `deity:Angel`); Fear (ID: `keyterm:Fear`); Strength (ID: `keyterm:Strength`); Slaughtering (ID: `keyterm:Slaughtering`); A Man (ID: `person:GenericMale`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Stupid (ID: `keyterm:Stupid`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); To Sin (ID: `keyterm:Sin`); Intention (ID: `keyterm:Intention`); To Act Wickedly (ID: `keyterm:ActWickedly`); To Cause to Possess (ID: `keyterm:Possess`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Brier (ID: `flora:Brier`); Cooking Pot (ID: `realia:CookingPot`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Intention (ID: `keyterm:Intention`); Love (ID: `keyterm:Love`); Hell (ID: `place:Hell`); ٱلرَّبِّ (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Strength (ID: `keyterm:Strength`); Wine (ID: `realia:Wine`); Olive Oil (ID: `realia:OliveOil`); Vine (ID: `flora:Vine`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); ٱلرَّبِّ (ID: `deity:Lord`); Caper (ID: `flora:Caper`); Money (ID: `realia:Money`); Pit (ID: `realia:Pit`); Rope (ID: `realia:Rope`); Bird (ID: `fauna:Bird`); Almond (ID: `flora:Almond`); Locust (ID: `fauna:Locust`); Clay Jar (ID: `realia:ClayJar`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Proverb (ID: `keyterm:Saying`); Fear (ID: `keyterm:Fear`); Intention (ID: `keyterm:Intention`); Truth (ID: `keyterm:Truth`); Straightness (ID: `keyterm:Straightness`); Goad (ID: `realia:Goad`); Scroll (ID: `realia:Scroll`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Nail (ID: `realia:Nail`)
