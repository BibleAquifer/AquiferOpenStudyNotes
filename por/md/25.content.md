...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); rebel (ID: `keyterm:Rebel`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); love (ID: `keyterm:Love`); Judá (ID: `group:Judah`); strength (ID: `keyterm:Strength`); Deceit (ID: `keyterm:Deceit`); appointed feast (ID: `keyterm:AppointedFeast`); defilement (ID: `keyterm:Defilement`); To Sin (ID: `keyterm:Sin`); work (ID: `keyterm:Work`); Israel (ID: `person:Israel`); Mighty One (ID: `keyterm:MightyOne`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Train (ID: `realia:Train`); Goat (ID: `fauna:Goat`); Deer (ID: `fauna:Deer`); Winepress (ID: `realia:Winepress`); Yoke (ID: `realia:Yoke`); Net (ID: `realia:Net`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Grass (ID: `flora:Grass`); Casting Net (ID: `realia:CastingNet`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); To Sin (ID: `keyterm:Sin`); defilement (ID: `keyterm:Defilement`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** rebel (ID: `keyterm:Rebel`); strength (ID: `keyterm:Strength`); SENHOR (ID: `deity:Lord`); Yoke (ID: `realia:Yoke`)
...
* **Associated ACAI Concepts:** Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Mighty One (ID: `keyterm:MightyOne`); SENHOR (ID: `deity:Lord`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); appointed feast (ID: `keyterm:AppointedFeast`); Judá (ID: `person:Judah.4`); horn (ID: `keyterm:Horn`); Judá (ID: `group:Judah`); Sheep (ID: `fauna:Lamb`); ardour (ID: `keyterm:Ardour`); Gentiles (ID: `group:Gentile`); sabbath (ID: `keyterm:Sabbath`); Instruction (ID: `keyterm:Instruction`); have a vision (ID: `keyterm:HaveAVision`); profane, dishonor (ID: `keyterm:Dishonor`); Utterance (ID: `keyterm:Utterance`); Sackcloth (ID: `realia:Sackcloth`); Measuring Reed (ID: `realia:MeasuringReed`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); House (ID: `realia:House`); Grain (ID: `flora:Grain`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Tent (ID: `realia:Tent`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** horn (ID: `keyterm:Horn`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Sheep (ID: `fauna:Lamb`); Tent (ID: `realia:Tent`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** appointed feast (ID: `keyterm:AppointedFeast`); SENHOR (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); House (ID: `realia:House`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); To Sin (ID: `keyterm:Sin`); Uz (ID: `place:Uz`); stain (ID: `keyterm:Stain`); Punishment (ID: `keyterm:Punishment`); Appoint (ID: `keyterm:Appoint`); Sodoma (ID: `place:Sodom`); defilement (ID: `keyterm:Defilement`); Believe In (ID: `keyterm:BelieveIn`); anointed (ID: `keyterm:Anointed`); Complete (ID: `keyterm:Complete`); be kindly disposed (ID: `keyterm:KindlyDisposed`); Jackal (ID: `fauna:Jackal`); Ostrich (ID: `fauna:Ostrich`); Purple Cloth (ID: `realia:PurpleCloth`); Vulture (ID: `fauna:Vulture`); Clay Jar (ID: `realia:ClayJar`)
...
* **Associated ACAI Concepts:** Edom (ID: `place:Edom`); To Sin (ID: `keyterm:Sin`); Appoint (ID: `keyterm:Appoint`); ardour (ID: `keyterm:Ardour`); Complete (ID: `keyterm:Complete`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Jerusalém (ID: `place:Jerusalem`); Assyria (ID: `place:Assyria`); Woe (ID: `keyterm:Woe`); Egito (ID: `place:Egypt`); round dance (ID: `keyterm:RoundDance`); Judá (ID: `person:Judah.4`); ardour (ID: `keyterm:Ardour`); Judá (ID: `group:Judah`); to cause to possess (ID: `keyterm:Possess`); House (ID: `realia:House`); Money (ID: `realia:Money`); Crown (ID: `realia:Crown`); Hand-Mill (ID: `realia:Hand-mill`); Jackal (ID: `fauna:Jackal`)
