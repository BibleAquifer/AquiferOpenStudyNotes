...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Catah (ID: `place:Bethlehem`)
...
* **Associated ACAI Concepts:** Ephrata (ID: `person:Ephrathah`); Chelión (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Efratita (ID: `group:Ephrathah`); Moab (ID: `place:Moab`); Mahalón (ID: `person:Mahlon`); Judá (ID: `person:Judah.4`); Catah (ID: `place:Bethlehem`); Elimelech (ID: `person:Elimelech`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Noemi (ID: `person:Naomi`); Ruth (ID: `person:Ruth`); Catah (ID: `place:Bethlehem`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Noemi (ID: `person:Naomi`); Jehová (ID: `deity:Lord`); bondad (ID: `keyterm:Kindness`); bendecir (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); dejar en herencia (ID: `keyterm:Possess`); Mahalón (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Rachêl (ID: `person:Rachel`); Jehová (ID: `deity:Lord`); Lea (ID: `person:Leah`); Catah (ID: `place:Bethlehem`); Elders (ID: `group:GenericElders`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Phares (ID: `person:Perez`); Thamar (ID: `person:Tamar`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Israel (ID: `person:Israel`); bendecir (ID: `keyterm:Bless`); Jehová (ID: `deity:Lord`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Hesrón (ID: `person:Hezron.2`); Salmón (ID: `person:Salmon`); Obed (ID: `person:Obed`); Aminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Isaí (ID: `person:Jesse`); David (ID: `person:David`); Nahasón (ID: `person:Nahshon`); Phares (ID: `person:Perez`); Booz (ID: `person:Boaz`)
