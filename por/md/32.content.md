...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); fear (ID: `keyterm:Fear`); Fish (ID: `fauna:Fish`); Ship (ID: `realia:Ship`); make a vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); Jope (ID: `place:Joppa`); Amittai (ID: `person:Amittai`); Nínive (ID: `place:Nineveh`); kindness (ID: `keyterm:Kindness`); exempt (ID: `keyterm:Exempt`); lot (ID: `keyterm:Lot`); salvation (ID: `keyterm:Salvation`); Hebrews (ID: `group:Hebrews`); Word of the Lord (ID: `keyterm:WordOfTheLord`); slaughtering (ID: `keyterm:Slaughtering`); praise (ID: `keyterm:Praise`); Társis (ID: `place:Tarshish`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Hell (ID: `place:Hell`); Jonas (ID: `person:Jonah.2`); kindness (ID: `keyterm:Kindness`); salvation (ID: `keyterm:Salvation`); make a vow (ID: `keyterm:Vow`); praise (ID: `keyterm:Praise`); Cattails (ID: `flora:Cattails`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); kindness (ID: `keyterm:Kindness`); salvation (ID: `keyterm:Salvation`); make a vow (ID: `keyterm:Vow`); praise (ID: `keyterm:Praise`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Nínive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); gracious (ID: `keyterm:Generous`); kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`); Társis (ID: `place:Tarshish`); Believe In (ID: `keyterm:BelieveIn`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`); Worm (ID: `fauna:Maggot`); Clothing (ID: `realia:Clothing`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); gracious (ID: `keyterm:Generous`); kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`); Társis (ID: `place:Tarshish`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); gracious (ID: `keyterm:Generous`); kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`); Társis (ID: `place:Tarshish`)
