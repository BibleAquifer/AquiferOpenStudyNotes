...
* **Associated ACAI Concepts:** Jude (ID: `person:Jude`); LORD (ID: `deity:Lord`); James (ID: `person:James.3`); Love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Jude (ID: `person:Jude`); LORD (ID: `deity:Lord`); James (ID: `person:James.3`); Make Peace (ID: `keyterm:Peace`); Mercy (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Eagerness (ID: `keyterm:Eagerness`); Salvation (ID: `keyterm:Salvation`); Holy (ID: `keyterm:Holy`); Beloved (ID: `keyterm:Beloved`); Ask for (ID: `keyterm:AskFor`); Believe (ID: `keyterm:Believe`); In Common (ID: `keyterm:InCommon`)
...
* **Associated ACAI Concepts:** Eagerness (ID: `keyterm:Eagerness`); LORD (ID: `deity:Lord`); Salvation (ID: `keyterm:Salvation`); Jesus (ID: `person:Jesus.2`); Favor (ID: `keyterm:Favor`); Holy (ID: `keyterm:Holy`); Judgment (ID: `keyterm:Judgment`); Beloved (ID: `keyterm:Beloved`); Ask for (ID: `keyterm:AskFor`); Believe (ID: `keyterm:Believe`); In Common (ID: `keyterm:InCommon`)
...
* **Associated ACAI Concepts:** Judgment (ID: `keyterm:Judgment`); LORD (ID: `deity:Lord`); Favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Egypt (ID: `place:Egypt`); Salvation (ID: `keyterm:Salvation`); Believe (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Always (ID: `keyterm:Always`); Blaspheme (ID: `keyterm:Blaspheme`); Judgment (ID: `keyterm:Judgment`); Body (ID: `keyterm:Body.3`); Court Case (ID: `keyterm:CourtCase`); LORD (ID: `deity:Lord`); Korah (ID: `person:Korah.3`); Michael (ID: `person:Michael.11`); Eternal Fire (ID: `keyterm:EternalFire`); Ability (ID: `keyterm:Ability`); Defilement (ID: `keyterm:Defilement`); Enoch (ID: `person:Enoch.2`); To Command (ID: `keyterm:Command`); Discern (ID: `keyterm:Discern`); Believe (ID: `keyterm:Believe`); Speak as a Prophet (ID: `keyterm:Speak`); Egypt (ID: `place:Egypt`); Jesus (ID: `person:Jesus.2`); Holy (ID: `keyterm:Holy`); Moses (ID: `person:Moses`); Fellowship Meal (ID: `keyterm:FellowshipMeal`); Cain (ID: `person:Cain`); An Angel (ID: `deity:Angel`); Disaster (ID: `keyterm:Disaster`); Gomorrah (ID: `place:Gomorrah`); Salvation (ID: `keyterm:Salvation`); Balaam (ID: `person:Balaam`); Sodom (ID: `place:Sodom`); Adam (ID: `person:Adam`); Goat (ID: `fauna:Goat`); Chain (ID: `realia:Chain`); Flock (ID: `fauna:Flock`)
...
* **Associated Articles:** Ezekiel 28:12-19 (ID: `11655@TyndaleStudyNotes`); 2 Peter 2:4 (ID: `14805@TyndaleStudyNotes`); Isaiah 14:12 (ID: `15874@TyndaleStudyNotes`); 1 Peter 3:19-20 (ID: `15756@TyndaleStudyNotes`)

* **Associated ACAI Concepts:** Always (ID: `keyterm:Always`); Judgment (ID: `keyterm:Judgment`); An Angel (ID: `deity:Angel`); Court Case (ID: `keyterm:CourtCase`); Chain (ID: `realia:Chain`)
...
* **Associated ACAI Concepts:** Always (ID: `keyterm:Always`); Eternal Fire (ID: `keyterm:EternalFire`); Body (ID: `keyterm:Body.3`); Sodom (ID: `place:Sodom`); Gomorrah (ID: `place:Gomorrah`)
...
Michael is one of the most powerful angels. In Jewish tradition, an "archangel" is the highest rank of angel (see also [1 Thessalonians 4:16](https://ref.ly/1Thess4:16)). Michael is mentioned several times in the Bible ([Daniel 10:13](https://ref.ly/Dan10:13), [21](https://ref.ly/Dan10:21); [12:1](https://ref.ly/Dan12:1); [Revelation 12:7](https://ref.ly/Rev12:7)). The story of him fighting the devil about the body of Moses is not in the Old Testament but is found in Jewish tradition (see *Assumption of Moses*).

* **Associated Passages:** Jude 1:9

* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Michael (ID: `person:Michael.11`); Blaspheme (ID: `keyterm:Blaspheme`); Body (ID: `keyterm:Body.3`); To Command (ID: `keyterm:Command`); Court Case (ID: `keyterm:CourtCase`); Judgment (ID: `keyterm:Judgment`); Moses (ID: `person:Moses`); Discern (ID: `keyterm:Discern`)
...
* **Associated ACAI Concepts:** Korah (ID: `person:Korah.3`); Balaam (ID: `person:Balaam`); Disaster (ID: `keyterm:Disaster`); Cain (ID: `person:Cain`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Speak as a Prophet (ID: `keyterm:Speak`); Adam (ID: `person:Adam`); Enoch (ID: `person:Enoch.2`); Court Case (ID: `keyterm:CourtCase`); Holy (ID: `keyterm:Holy`); Judgment (ID: `keyterm:Judgment`)
...
* **Associated ACAI Concepts:** Mercy (ID: `keyterm:Mercy`); Holy Spirit (ID: `deity:HolySpirit`); Jesus (ID: `person:Jesus.2`); Beloved (ID: `keyterm:Beloved`); Always (ID: `keyterm:Always`); Natural (ID: `keyterm:Natural`); Word (ID: `keyterm:Word`); Discern (ID: `keyterm:Discern`); Believe (ID: `keyterm:Believe`); Fear (ID: `keyterm:Fear`); Holy (ID: `keyterm:Holy`); LORD (ID: `deity:Lord`); Body (ID: `keyterm:Body.3`); Love (ID: `keyterm:Love`); Life (ID: `keyterm:Life`); Pray (ID: `keyterm:Pray`); Salvation (ID: `keyterm:Salvation`); Creating Divisions (ID: `keyterm:CreatingDivisions`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Holy Spirit (ID: `deity:HolySpirit`); Holy (ID: `keyterm:Holy`); Beloved (ID: `keyterm:Beloved`); Pray (ID: `keyterm:Pray`); Believe (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); Always (ID: `keyterm:Always`); LORD (ID: `deity:Lord`); Savior (ID: `keyterm:Savior`); Ability (ID: `keyterm:Ability`); Authority (ID: `keyterm:Authority.2`); Surely! (ID: `keyterm:Surely`); Jesus (ID: `person:Jesus.2`); Unblemished (ID: `keyterm:Unblemished`)
