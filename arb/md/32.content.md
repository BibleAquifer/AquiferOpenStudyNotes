...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); Fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); Vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); يَافَا (ID: `place:Joppa`); نِينَوَى (ID: `place:Nineveh`); أَمِتَّايَ (ID: `person:Amittai`); Slaughtering (ID: `keyterm:Slaughtering`); Kindness (ID: `keyterm:Kindness`); Hebrews (ID: `group:Hebrews`); Praise (ID: `keyterm:Praise`); Lot (ID: `keyterm:Lot`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Exempt (ID: `keyterm:Exempt`); تَرْشِيشَ (ID: `place:Tarshish`); Salvation (ID: `keyterm:Salvation`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Hell (ID: `place:Hell`); Praise (ID: `keyterm:Praise`); Kindness (ID: `keyterm:Kindness`); Vow (ID: `keyterm:Vow`); Salvation (ID: `keyterm:Salvation`); يونَانَ (ID: `person:Jonah.2`); Cattails (ID: `flora:Cattails`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** Praise (ID: `keyterm:Praise`); ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Vow (ID: `keyterm:Vow`); Salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); نِينَوَى (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Believe In (ID: `keyterm:BelieveIn`); تَرْشِيشَ (ID: `place:Tarshish`); Kindness (ID: `keyterm:Kindness`); Generous (ID: `keyterm:Generous`); Compassionate (ID: `keyterm:Compassionate`); Goat (ID: `fauna:Goat`); Throne (ID: `realia:Throne`); Clothing (ID: `realia:Clothing`); Flock (ID: `fauna:Flock`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); تَرْشِيشَ (ID: `place:Tarshish`); Kindness (ID: `keyterm:Kindness`); Generous (ID: `keyterm:Generous`); Compassionate (ID: `keyterm:Compassionate`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); تَرْشِيشَ (ID: `place:Tarshish`); Kindness (ID: `keyterm:Kindness`); Generous (ID: `keyterm:Generous`); Compassionate (ID: `keyterm:Compassionate`)
