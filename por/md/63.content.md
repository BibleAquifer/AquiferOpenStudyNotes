...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); misericórdia (ID: `keyterm:Mercy`); escolhido (ID: `keyterm:Chosen`); fazer a paz (ID: `keyterm:Peace`); Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`); para a eternidade (ID: `keyterm:Always`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); misericórdia (ID: `keyterm:Mercy`); fazer a paz (ID: `keyterm:Peace`); Jesus (ID: `person:Jesus.2`); Truth (ID: `keyterm:Truth`); favor (ID: `keyterm:Favor`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); andar (ID: `keyterm:Live.3`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`); Ability (ID: `keyterm:Ability`); corpo (ID: `keyterm:Body.3`); Truth (ID: `keyterm:Truth`); compartilhar (ID: `keyterm:Share`); House (ID: `realia:House`)
