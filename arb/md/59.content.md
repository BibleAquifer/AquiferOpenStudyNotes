...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Put to the Test (ID: `keyterm:PutToTheTest`); Happy (ID: `keyterm:Happy`); Beloved (ID: `keyterm:Beloved`); Clean (ID: `keyterm:Clean`); Approved (ID: `keyterm:Approved`); Worthless (ID: `keyterm:Worthless`); Truth (ID: `keyterm:Truth`); Not Tempted (ID: `keyterm:NotTempted`); Heart (ID: `keyterm:Heart`); Salvation (ID: `keyterm:Salvation`); A Person (ID: `person:GenericPerson`); Above Criticism (ID: `keyterm:AboveCriticism`); Undefiled (ID: `keyterm:Undefiled`); Ability (ID: `keyterm:Ability`); To Sin (ID: `keyterm:Sin`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Promise (ID: `keyterm:Promise`); Law (ID: `keyterm:Law`); Good (ID: `keyterm:Good`); Life (ID: `keyterm:Life`); Love (ID: `keyterm:Love`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Put to the Test (ID: `keyterm:PutToTheTest`); ٱلرَّبِّ (ID: `deity:Lord`); A Person (ID: `person:GenericPerson`); Not Tempted (ID: `keyterm:NotTempted`)
...
* **Associated ACAI Concepts:** Clean (ID: `keyterm:Clean`); Worthless (ID: `keyterm:Worthless`); Above Criticism (ID: `keyterm:AboveCriticism`); Heart (ID: `keyterm:Heart`); Ability (ID: `keyterm:Ability`); ٱلرَّبِّ (ID: `deity:Lord`); Undefiled (ID: `keyterm:Undefiled`)
...
* **Associated ACAI Concepts:** Promise (ID: `keyterm:Promise`); Ability (ID: `keyterm:Ability`); ٱلرَّبِّ (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Chosen (ID: `keyterm:Chosen`); Beloved (ID: `keyterm:Beloved`); Kingdom (ID: `keyterm:Kingdom`); Love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); إِبْرَاهِيمَ (ID: `person:Abraham`); ٱلرَّبِّ (ID: `deity:Lord`); A Person (ID: `person:GenericPerson`); Body (ID: `keyterm:Body.3`); Useless (ID: `keyterm:Idle`); رَاحَاب (ID: `person:Rahab`); Spirit (ID: `keyterm:Spirit.2`); An Angel (ID: `deity:Angel`); Written (ID: `keyterm:Scripture`); إِسْحَاق (ID: `person:Isaac`); Make Peace (ID: `keyterm:Peace`); Salvation (ID: `keyterm:Salvation`); Empty (ID: `keyterm:Empty`); To Cause to Happen (ID: `keyterm:Happen`); Demons (ID: `deity:Demons`)
...
* **Associated ACAI Concepts:** إِبْرَاهِيمَ (ID: `person:Abraham`); Written (ID: `keyterm:Scripture`); ٱلرَّبِّ (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`); Be (Or Show Oneself) Just (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Friendship (ID: `keyterm:Friendship`); Be Unfaithful (ID: `keyterm:Unfaithful`); Spirit (ID: `keyterm:Spirit.2`); Heart (ID: `keyterm:Heart`); Written (ID: `keyterm:Scripture`); Ability (ID: `keyterm:Ability`); Favor (ID: `keyterm:Favor`); ٱلرّوحِ (ID: `deity:HolySpirit`); Long For (ID: `keyterm:LongFor`); To Cleanse (ID: `keyterm:Cleanse.2`); Pure (ID: `keyterm:Pure`); Cause of Joy (ID: `keyterm:CauseOfJoy`)
...
* **Associated ACAI Concepts:** Spirit (ID: `keyterm:Spirit.2`); ٱلرّوحِ (ID: `deity:HolySpirit`); Written (ID: `keyterm:Scripture`); Long For (ID: `keyterm:LongFor`)
...
* **Associated ACAI Concepts:** Heart (ID: `keyterm:Heart`); Bear Witness (ID: `keyterm:BearWitness`); ٱلرَّبِّ (ID: `deity:Lord`); Condemn (ID: `keyterm:Condemn`); Body (ID: `keyterm:Body.3`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Compassionate (ID: `keyterm:Compassionate`); أَيّوبَ (ID: `person:Job`); ٱلرَّبِّ (ID: `deity:Lord`); Full of Compassion (ID: `keyterm:FullOfCompassion`); Regard as Happy (ID: `keyterm:RegardAsHappy`)
...
* **Associated ACAI Concepts:** Anointed (ID: `keyterm:Anointed`); ٱلرَّبِّ (ID: `deity:Lord`); Name (ID: `keyterm:Name`); Pray (ID: `keyterm:Pray`); Church (ID: `keyterm:Church`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); Salvation (ID: `keyterm:Salvation`); Pray (ID: `keyterm:Pray`)
