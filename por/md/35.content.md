...
* **Associated ACAI Concepts:** strength (ID: `keyterm:Strength`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); dispossess (ID: `keyterm:Dispossess`); Caldéia (ID: `place:Chaldea`); Believe In (ID: `keyterm:BelieveIn`); Chaldeans (ID: `group:Chaldea`); Horse (ID: `fauna:Horse`); Leopard (ID: `fauna:Leopard`); Vulture (ID: `fauna:Vulture`); Wolf (ID: `fauna:Wolf`)
...
* **Associated ACAI Concepts:** Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Casting Net (ID: `realia:CastingNet`); SENHOR (ID: `deity:Lord`); pure (ID: `keyterm:Pure`); holy (ID: `keyterm:Holy`); Fortification (ID: `realia:Fortification`); Harpoon (ID: `realia:Harpoon`); Monitor (ID: `fauna:Iguana`); Lizard (ID: `fauna:Lizard`); Fish (ID: `fauna:Fish`); Chameleon (ID: `fauna:Chameleon`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); literally: nought (ID: `keyterm:Idol`); lean on (ID: `keyterm:LeanOn`); Libano (ID: `place:Lebanon`); Be Disgraced (ID: `keyterm:Disgraced`); saying (ID: `keyterm:Saying`); Graven Image (ID: `realia:GravenImage`); Image (ID: `realia:Image`); Beam (ID: `realia:Beam`); Molten Image (ID: `realia:MoltenImage`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Libano (ID: `place:Lebanon`); Glory (ID: `keyterm:Glory`); Be Disgraced (ID: `keyterm:Disgraced`); Woe (ID: `keyterm:Woe.2`)
...
* **Associated ACAI Concepts:** literally: nought (ID: `keyterm:Idol`); lean on (ID: `keyterm:LeanOn`); SENHOR (ID: `deity:Lord`); Woe (ID: `keyterm:Woe.2`); Graven Image (ID: `realia:GravenImage`); Image (ID: `realia:Image`); Molten Image (ID: `realia:MoltenImage`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); arrow (ID: `keyterm:Arrow`); Oath (ID: `keyterm:Oath`); SENHOR (ID: `deity:Lord`); anointed (ID: `keyterm:Anointed`); Chariot (ID: `realia:Chariot`); Foundation (ID: `realia:Foundation`); Bow (ID: `realia:Bow`); Spear (ID: `realia:Spear`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); salvation (ID: `keyterm:Salvation`); Goat (ID: `fauna:Goat`); Olive Tree (ID: `flora:OliveTree`); Fig (ID: `flora:Fig`); Animal Pen (ID: `realia:AnimalPen`); Cattle (ID: `fauna:Bull`); Flock (ID: `fauna:Flock`); Sheepfold (ID: `realia:Sheepfold`); Vine (ID: `flora:Vine`)
