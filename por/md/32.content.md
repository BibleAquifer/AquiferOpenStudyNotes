...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Hell (ID: `place:Hell`); salvation (ID: `keyterm:Salvation`); praise (ID: `keyterm:Praise`); Jonas (ID: `person:Jonah.2`); kindness (ID: `keyterm:Kindness`); make a vow (ID: `keyterm:Vow`); Cattails (ID: `flora:Cattails`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); praise (ID: `keyterm:Praise`); kindness (ID: `keyterm:Kindness`); make a vow (ID: `keyterm:Vow`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Nínive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Compassionate (ID: `keyterm:Compassionate`); Believe In (ID: `keyterm:BelieveIn`); Társis (ID: `place:Tarshish`); kindness (ID: `keyterm:Kindness`); gracious (ID: `keyterm:Generous`); Clothing (ID: `realia:Clothing`); Goat (ID: `fauna:Goat`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`); Worm (ID: `fauna:Maggot`)
