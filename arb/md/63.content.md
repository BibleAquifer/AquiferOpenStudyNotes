...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); Love (ID: `keyterm:Love`); Chosen (ID: `keyterm:Chosen`); Make Peace (ID: `keyterm:Peace`); Favor (ID: `keyterm:Favor`); Always (ID: `keyterm:Always`); Mercy (ID: `keyterm:Mercy`); يَسوع (ID: `person:Jesus.2`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Make Peace (ID: `keyterm:Peace`); Love (ID: `keyterm:Love`); Favor (ID: `keyterm:Favor`); Mercy (ID: `keyterm:Mercy`); Truth (ID: `keyterm:Truth`); يَسوع (ID: `person:Jesus.2`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); Love (ID: `keyterm:Love`); Live (ID: `keyterm:Live.3`); يَسوع (ID: `person:Jesus.2`); ٱلرَّبِّ (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); Share (ID: `keyterm:Share`); Ask for (ID: `keyterm:AskFor`); Body (ID: `keyterm:Body.3`); Ability (ID: `keyterm:Ability`); House (ID: `realia:House`)
