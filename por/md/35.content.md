...
* **Associated ACAI Concepts:** Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Casting Net (ID: `realia:CastingNet`); holy (ID: `keyterm:Holy`); pure (ID: `keyterm:Pure`); SENHOR (ID: `deity:Lord`); Fortification (ID: `realia:Fortification`); Chameleon (ID: `fauna:Chameleon`); Lizard (ID: `fauna:Lizard`); Fish (ID: `fauna:Fish`); Monitor (ID: `fauna:Iguana`); Harpoon (ID: `realia:Harpoon`)
...
* **Associated ACAI Concepts:** Libano (ID: `place:Lebanon`); Glory (ID: `keyterm:Glory`); SENHOR (ID: `deity:Lord`); Be Disgraced (ID: `keyterm:Disgraced`); Woe (ID: `keyterm:Woe.2`)
...
* **Associated ACAI Concepts:** literally: nought (ID: `keyterm:Idol`); lean on (ID: `keyterm:LeanOn`); SENHOR (ID: `deity:Lord`); Woe (ID: `keyterm:Woe.2`); Money (ID: `realia:Money`); Molten Image (ID: `realia:MoltenImage`); Graven Image (ID: `realia:GravenImage`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); Temã (ID: `place:Teman`); Habacuque (ID: `person:Habakkuk`); Cusã (ID: `place:Cushan`); Monte Paran (ID: `place:ParanMount`); arrow (ID: `keyterm:Arrow`); fear (ID: `keyterm:Fear`); Midiã (ID: `place:Midian`); anointed (ID: `keyterm:Anointed`); Oath (ID: `keyterm:Oath`); mischief (ID: `keyterm:Mischief`); holy (ID: `keyterm:Holy`); majesty (ID: `keyterm:Majesty`); Deer (ID: `fauna:Deer`); Chariot (ID: `realia:Chariot`); Foundation (ID: `realia:Foundation`); Vine (ID: `flora:Vine`); Bow (ID: `realia:Bow`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Fig (ID: `flora:Fig`); Olive Tree (ID: `flora:OliveTree`); Animal Pen (ID: `realia:AnimalPen`); Tent (ID: `realia:Tent`); Sheepfold (ID: `realia:Sheepfold`); Spear (ID: `realia:Spear`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); Temã (ID: `place:Teman`); Cusã (ID: `place:Cushan`); Monte Paran (ID: `place:ParanMount`); arrow (ID: `keyterm:Arrow`); Midiã (ID: `place:Midian`); anointed (ID: `keyterm:Anointed`); Oath (ID: `keyterm:Oath`); mischief (ID: `keyterm:Mischief`); holy (ID: `keyterm:Holy`); SENHOR (ID: `deity:Lord`); majesty (ID: `keyterm:Majesty`); Chariot (ID: `realia:Chariot`); Foundation (ID: `realia:Foundation`); Bow (ID: `realia:Bow`); Tent (ID: `realia:Tent`); Spear (ID: `realia:Spear`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); arrow (ID: `keyterm:Arrow`); anointed (ID: `keyterm:Anointed`); Oath (ID: `keyterm:Oath`); SENHOR (ID: `deity:Lord`); Bow (ID: `realia:Bow`); Chariot (ID: `realia:Chariot`); Spear (ID: `realia:Spear`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); salvation (ID: `keyterm:Salvation`); Sheepfold (ID: `realia:Sheepfold`); Flock (ID: `fauna:Flock`); Fig (ID: `flora:Fig`); Olive Tree (ID: `flora:OliveTree`); Animal Pen (ID: `realia:AnimalPen`); Cattle (ID: `fauna:Bull`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`)
