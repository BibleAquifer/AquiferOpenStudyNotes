...
* **Associated ACAI Concepts:** Efrata (ID: `person:Ephrathah`); Noemi (ID: `person:Naomi`); Ephrathites (ID: `group:Ephrathah`); Quiliom (ID: `person:Chilion`); Judá (ID: `group:Judah`); Malom (ID: `person:Mahlon`); Elimeleque (ID: `person:Elimelech`); Belém (ID: `place:Bethlehem`); Judá (ID: `person:Judah.4`); Moabe (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Moabe (ID: `place:Moab`); Noemi (ID: `person:Naomi`); favor (ID: `keyterm:Favor`); Rute (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** to cause to possess (ID: `keyterm:Possess`); Malom (ID: `person:Mahlon`); Moabe (ID: `place:Moab`); Rute (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Elders (ID: `group:GenericElders`); Belém (ID: `place:Bethlehem`); Lia (ID: `person:Leah`); Raquel (ID: `person:Rachel`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Salmom (ID: `person:Salmon`); Hezrom (ID: `person:Hezron.2`); Obede (ID: `person:Obed`); Aminadabe (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Jessé (ID: `person:Jesse`); Boaz (ID: `person:Boaz`); Naassom (ID: `person:Nahshon`); Perez (ID: `person:Perez`); Davi (ID: `person:David`)
