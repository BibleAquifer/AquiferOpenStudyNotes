...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); make a vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); Amittai (ID: `person:Amittai`); Nínive (ID: `place:Nineveh`); Jope (ID: `place:Joppa`); Társis (ID: `place:Tarshish`); exempt (ID: `keyterm:Exempt`); lot (ID: `keyterm:Lot`); Hebrews (ID: `group:Hebrews`); Word of the Lord (ID: `keyterm:WordOfTheLord`); kindness (ID: `keyterm:Kindness`); praise (ID: `keyterm:Praise`); salvation (ID: `keyterm:Salvation`); slaughtering (ID: `keyterm:Slaughtering`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** fear (ID: `keyterm:Fear`); make a vow (ID: `keyterm:Vow`); slaughtering (ID: `keyterm:Slaughtering`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Hell (ID: `place:Hell`); salvation (ID: `keyterm:Salvation`); make a vow (ID: `keyterm:Vow`); kindness (ID: `keyterm:Kindness`); praise (ID: `keyterm:Praise`); Jonas (ID: `person:Jonah.2`); Fish (ID: `fauna:Fish`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); make a vow (ID: `keyterm:Vow`); kindness (ID: `keyterm:Kindness`); praise (ID: `keyterm:Praise`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Nínive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Sackcloth (ID: `realia:Sackcloth`); Cattle (ID: `fauna:Bull`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Compassionate (ID: `keyterm:Compassionate`); Társis (ID: `place:Tarshish`); gracious (ID: `keyterm:Generous`); kindness (ID: `keyterm:Kindness`); Believe In (ID: `keyterm:BelieveIn`); Goat (ID: `fauna:Goat`); Clothing (ID: `realia:Clothing`); Worm (ID: `fauna:Maggot`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Word of the Lord (ID: `keyterm:WordOfTheLord`); Nínive (ID: `place:Nineveh`); Jonas (ID: `person:Jonah.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Compassionate (ID: `keyterm:Compassionate`); gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`); kindness (ID: `keyterm:Kindness`); SENHOR (ID: `deity:Lord`)
