...
* **Associated ACAI Concepts:** إِلَى (ID: `person:Philemon`); Beloved (ID: `keyterm:Beloved`); تِيموثَاوس (ID: `person:Timothy`); يَسوع (ID: `person:Jesus.2`); بولسَ (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); إِلَى (ID: `person:Philemon`); لِأَرْخِبّسَ (ID: `person:Archippus`); إِلَى (ID: `person:Apphia`); Beloved (ID: `keyterm:Beloved`); تِيموثَاوس (ID: `person:Timothy`); ٱلرَّبِّ (ID: `deity:Lord`); Favor (ID: `keyterm:Favor`); Church (ID: `keyterm:Church`); بولسَ (ID: `person:Paul`); Make Peace (ID: `keyterm:Peace`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Believe (ID: `keyterm:Believe`); Love (ID: `keyterm:Love`); Holy (ID: `keyterm:Holy`); ٱلرَّبِّ (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Pray (ID: `keyterm:Pray`); Ask for (ID: `keyterm:AskFor`); Fellowship (ID: `keyterm:Fellowship`); Good (ID: `keyterm:Good`); Affection (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); أَبَفْرَاسَ (ID: `person:Epaphras`); دِيمَاس (ID: `person:Demas`); لوقَا (ID: `person:Luke`); Favor (ID: `keyterm:Favor`); مَرْقسَ (ID: `person:Mark`); In Christ (ID: `keyterm:InChrist`); Spirit (ID: `keyterm:Spirit.2`); أَرِسْتَرْخسَ (ID: `person:Aristarchus`)
