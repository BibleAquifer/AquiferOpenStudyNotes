...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Fear (ID: `keyterm:Fear`); Covenant (ID: `keyterm:Covenant`); Offering (ID: `keyterm:Offering`); Priests (ID: `group:GenericPriests`); To Curse (ID: `keyterm:Curse`); Peace (ID: `keyterm:IntactState`); Glory (ID: `keyterm:Glory`); Defile (ID: `keyterm:Stain`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Fairness (ID: `keyterm:Fairness`); Truth (ID: `keyterm:Truth`); An Angel (ID: `deity:Angel`); Ask for (ID: `keyterm:AskFor`); Pure (ID: `keyterm:Pure`); Bless (ID: `keyterm:Bless`); The Way (ID: `keyterm:TheWay`); Gentiles (ID: `group:Gentile`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Intention (ID: `keyterm:Intention`); To Dishonor (ID: `keyterm:Dishonor`); Passion (ID: `keyterm:Ardour`); Vow (ID: `keyterm:Vow`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Vow (ID: `keyterm:Vow`); To Curse (ID: `keyterm:Curse`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); To Curse (ID: `keyterm:Curse`); Glory (ID: `keyterm:Glory`); Bless (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); Covenant (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Intention (ID: `keyterm:Intention`); An Angel (ID: `deity:Angel`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); To Dishonor (ID: `keyterm:Dishonor`); Covenant (ID: `keyterm:Covenant`); Offering (ID: `keyterm:Offering`); أورشَلِيمَ (ID: `place:Jerusalem`); Love (ID: `keyterm:Love`); يَهوذَا (ID: `person:Judah.4`); Delight (ID: `keyterm:Delight`); يَهوذَا (ID: `group:Judah`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** To Dishonor (ID: `keyterm:Dishonor`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); أورشَلِيمَ (ID: `place:Jerusalem`); An Angel (ID: `deity:Angel`); Covenant (ID: `keyterm:Covenant`); A Group of People (ID: `group:GenericGroup`); Fear (ID: `keyterm:Fear`); Pure (ID: `keyterm:Pure`); يَهوذَا (ID: `person:Judah.4`); Swear (ID: `keyterm:Swear`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); يَهوذَا (ID: `group:Judah`); Soap (ID: `realia:Soap`); Hammada (ID: `flora:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Bless (ID: `keyterm:Bless`); To Curse (ID: `keyterm:Curse`); Decree (ID: `keyterm:Decree`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Sorghum (ID: `flora:Sorghum`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); To Curse (ID: `keyterm:Curse`); Offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** إِيلِيَّا (ID: `person:Elijah`); Decree (ID: `keyterm:Decree`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Instruction (ID: `keyterm:Instruction`); سِينَاءَ (ID: `place:SinaiMount`); موسَى (ID: `person:Moses`)
