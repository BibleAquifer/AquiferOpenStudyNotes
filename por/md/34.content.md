...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Zealous (ID: `keyterm:Zealous.3`); Carmelo (ID: `place:Carmel`); The Way (ID: `keyterm:TheWay`); Libano (ID: `place:Lebanon`); strength (ID: `keyterm:Strength`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Basã (ID: `place:Bashan`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Zealous (ID: `keyterm:Zealous.3`); wickedness (ID: `keyterm:Wickedness`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Carmelo (ID: `place:Carmel`); The Way (ID: `keyterm:TheWay`); Libano (ID: `place:Lebanon`); strength (ID: `keyterm:Strength`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Basã (ID: `place:Bashan`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`); Strong Drink (ID: `realia:StrongDrink`)
...
* **Associated ACAI Concepts:** pronounce innocent (ID: `keyterm:PronounceInnocent`); strength (ID: `keyterm:Strength`); The Way (ID: `keyterm:TheWay`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); wickedness (ID: `keyterm:Wickedness`); Fortress (ID: `realia:Fortress`); Strong Drink (ID: `realia:StrongDrink`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** Judá (ID: `person:Judah.4`); peace (ID: `keyterm:IntactState`); make a vow (ID: `keyterm:Vow`); wickedness (ID: `keyterm:Wickedness`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); SENHOR (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Flock (ID: `fauna:Flock`); Chariot (ID: `realia:Chariot`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); lot (ID: `keyterm:Lot`); Cush (ID: `place:Cush.2`); Líbia (ID: `place:Libya`); Pute (ID: `place:Put`); Egito (ID: `place:Egypt`)
