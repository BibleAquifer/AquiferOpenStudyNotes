...
* **Associated ACAI Concepts:** Covenant (ID: `keyterm:Covenant`); Understanding (ID: `keyterm:Understanding`); أَدومَ (ID: `place:Edom`); Peace (ID: `keyterm:IntactState`); Edomites (ID: `group:Edom`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `person:Judah.4`); Lot (ID: `keyterm:Lot`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); أَدومَ (ID: `place:Edom`); يوسف (ID: `person:Joseph.10`); Dispossess (ID: `keyterm:Dispossess`); أورشَلِيمَ (ID: `place:Jerusalem`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أَدومَ (ID: `place:Edom`); يوسف (ID: `person:Joseph.10`); إِسْرَائِيلَ (ID: `person:Israel`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); ٱلْجَنوبِ (ID: `place:Negeb`); كَنْعَان (ID: `place:Canaan`); جِلْعَادَ (ID: `place:Gilead`); بَنْيَامِينَ (ID: `person:Benjamin`); عِيسو (ID: `place:EsauMount`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); فِلِشْتِيم (ID: `group:Philistine`); إِلَى (ID: `place:Zarephath`); أورشَلِيمَ (ID: `place:Jerusalem`); أَفْرَايِمَ (ID: `person:Ephraim`); بَنْيَامِينَ (ID: `group:Benjamin`); أَفْرَايِمَ (ID: `group:Ephraim`); سَارْدِسَ (ID: `place:Sardis`); ٱلسَّهْلِ (ID: `place:Shephelah`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Canaanites (ID: `group:Canaan`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْجَنوبِ (ID: `place:Negeb`); عِيسو (ID: `place:EsauMount`); ٱلرَّبِّ (ID: `deity:Lord`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); فِلِشْتِيم (ID: `group:Philistine`); أَفْرَايِمَ (ID: `person:Ephraim`); بَنْيَامِينَ (ID: `group:Benjamin`); بَنْيَامِينَ (ID: `person:Benjamin`); جِلْعَادَ (ID: `place:Gilead`); إِلَى (ID: `place:Zarephath`); أَفْرَايِمَ (ID: `group:Ephraim`); إِسْرَائِيلَ (ID: `person:Israel`); كَنْعَان (ID: `place:Canaan`); سَارْدِسَ (ID: `place:Sardis`); ٱلسَّهْلِ (ID: `place:Shephelah`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Canaanites (ID: `group:Canaan`)
...
* **Associated ACAI Concepts:** كَنْعَان (ID: `place:Canaan`); إِلَى (ID: `place:Zarephath`); أورشَلِيمَ (ID: `place:Jerusalem`); Dispossess (ID: `keyterm:Dispossess`); سَارْدِسَ (ID: `place:Sardis`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلْجَنوبِ (ID: `place:Negeb`); Canaanites (ID: `group:Canaan`)
