...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Mighty One (ID: `keyterm:MightyOne`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); sabbath (ID: `keyterm:Sabbath`); SENHOR (ID: `deity:Lord`); appointed feast (ID: `keyterm:AppointedFeast`)
...
* **Associated ACAI Concepts:** appointed feast (ID: `keyterm:AppointedFeast`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); To Sin (ID: `keyterm:Sin`); Uz (ID: `place:Uz`); stain (ID: `keyterm:Stain`); Believe In (ID: `keyterm:BelieveIn`); Punishment (ID: `keyterm:Punishment`); Sodoma (ID: `place:Sodom`); anointed (ID: `keyterm:Anointed`); be kindly disposed (ID: `keyterm:KindlyDisposed`); defilement (ID: `keyterm:Defilement`); Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); Jackal (ID: `fauna:Jackal`); Ostrich (ID: `fauna:Ostrich`); Clay Jar (ID: `realia:ClayJar`); Purple Cloth (ID: `realia:PurpleCloth`); Vulture (ID: `fauna:Vulture`)
...
* **Associated ACAI Concepts:** ardour (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`); Edom (ID: `place:Edom`); Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); to cause to possess (ID: `keyterm:Possess`); Egito (ID: `place:Egypt`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); round dance (ID: `keyterm:RoundDance`); Assyria (ID: `place:Assyria`); Woe (ID: `keyterm:Woe`); Jackal (ID: `fauna:Jackal`); House (ID: `realia:House`); Hand-Mill (ID: `realia:Hand-mill`); Crown (ID: `realia:Crown`); Money (ID: `realia:Money`)
