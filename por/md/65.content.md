...
* **Associated ACAI Concepts:** holy (ID: `keyterm:Holy`); amado (ID: `keyterm:Beloved`); crer (ID: `keyterm:Believe`); rogar (ID: `keyterm:AskFor`); salvation (ID: `keyterm:Salvation`); empenho (ID: `keyterm:Eagerness`); comum (ID: `keyterm:InCommon`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); holy (ID: `keyterm:Holy`); amado (ID: `keyterm:Beloved`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); favor (ID: `keyterm:Favor`); juízo (ID: `keyterm:Judgment`); rogar (ID: `keyterm:AskFor`); salvation (ID: `keyterm:Salvation`); empenho (ID: `keyterm:Eagerness`); comum (ID: `keyterm:InCommon`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`); juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); Egito (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** corpo (ID: `keyterm:Body.3`); juízo (ID: `keyterm:Judgment`); tribunal de justiça (ID: `keyterm:CourtCase`); blasfemar (ID: `keyterm:Blaspheme`); para a eternidade (ID: `keyterm:Always`); SENHOR (ID: `deity:Lord`); Corá (ID: `person:Korah.3`); Caim (ID: `person:Cain`); Disaster (ID: `keyterm:Disaster`); Jesus (ID: `person:Jesus.2`); Adão (ID: `person:Adam`); Enoque (ID: `person:Enoch.2`); An Angel (ID: `deity:Angel`); distinguir (ID: `keyterm:Discern`); holy (ID: `keyterm:Holy`); Egito (ID: `place:Egypt`); Miguel (ID: `person:Michael.11`); Moisés (ID: `person:Moses`); To Command (ID: `keyterm:Command`); ágape (ID: `keyterm:FellowshipMeal`); defilement (ID: `keyterm:Defilement`); Sodoma (ID: `place:Sodom`); fogo eterno (ID: `keyterm:EternalFire`); Balaão (ID: `person:Balaam`); Ability (ID: `keyterm:Ability`); crer (ID: `keyterm:Believe`); speak (ID: `keyterm:Speak`); Gomorra (ID: `place:Gomorrah`); salvation (ID: `keyterm:Salvation`); Goat (ID: `fauna:Goat`); Chain (ID: `realia:Chain`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** para a eternidade (ID: `keyterm:Always`); tribunal de justiça (ID: `keyterm:CourtCase`); An Angel (ID: `deity:Angel`); juízo (ID: `keyterm:Judgment`); Chain (ID: `realia:Chain`)
...
* **Associated ACAI Concepts:** para a eternidade (ID: `keyterm:Always`); corpo (ID: `keyterm:Body.3`); Gomorra (ID: `place:Gomorrah`); Sodoma (ID: `place:Sodom`); fogo eterno (ID: `keyterm:EternalFire`)
...
* **Associated ACAI Concepts:** To Command (ID: `keyterm:Command`); SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); tribunal de justiça (ID: `keyterm:CourtCase`); Miguel (ID: `person:Michael.11`); distinguir (ID: `keyterm:Discern`); blasfemar (ID: `keyterm:Blaspheme`); juízo (ID: `keyterm:Judgment`); Moisés (ID: `person:Moses`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); holy (ID: `keyterm:Holy`); tribunal de justiça (ID: `keyterm:CourtCase`); speak (ID: `keyterm:Speak`); Enoque (ID: `person:Enoch.2`); Adão (ID: `person:Adam`); juízo (ID: `keyterm:Judgment`)
...
* **Associated ACAI Concepts:** misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`); Holy Spirit (ID: `deity:HolySpirit`); amado (ID: `keyterm:Beloved`); SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); natural (ID: `keyterm:Natural`); distinguir (ID: `keyterm:Discern`); orar (ID: `keyterm:Pray`); holy (ID: `keyterm:Holy`); fear (ID: `keyterm:Fear`); causar divisões (ID: `keyterm:CreatingDivisions`); Life (ID: `keyterm:Life`); palavra (ID: `keyterm:Word`); para a eternidade (ID: `keyterm:Always`); crer (ID: `keyterm:Believe`); love (ID: `keyterm:Love`); salvation (ID: `keyterm:Salvation`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); irrepreensível (ID: `keyterm:Unblemished`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); autoridade (ID: `keyterm:Authority.2`); para a eternidade (ID: `keyterm:Always`); Jesus (ID: `person:Jesus.2`); surely! (ID: `keyterm:Surely`); salvador (ID: `keyterm:Savior`)
