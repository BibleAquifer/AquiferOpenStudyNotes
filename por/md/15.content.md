...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Pérsia (ID: `place:Persia`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Israel (ID: `person:Israel`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `group:Benjamin`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Benjamim (ID: `person:Benjamin`); Judá (ID: `group:Judah`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `group:Levi`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Ciro (ID: `person:Cyrus`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Pérsia (ID: `place:Persia`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Levi (ID: `person:Levi.3`); Salomão (ID: `person:Solomon`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `group:Levi`); Adim (ID: `person:Adin`); Lebana (ID: `person:Lebanah`); Asgade (ID: `person:Azgad`); Reelaías (ID: `person:Reelaiah`); Sisera (ID: `person:Sisera.2`); Besai (ID: `person:Besai`); Jora (ID: `person:Jorah`); Hasum (ID: `person:Hashum`); Zia (ID: `person:Ziha`); Adonicão (ID: `person:Adonikam`); Soferete (ID: `person:Sophereth`); Meunim (ID: `group:Meunim`); Imer (ID: `person:Immer.2`); Necoda (ID: `person:Nekoda`); Tel-Harsa (ID: `place:Tel-harsha`); Hatil (ID: `person:Hattil`); Harim (ID: `person:Harim.2`); Harim (ID: `person:Harim`); Reaías (ID: `person:Reaiah.3`); Hagabe (ID: `person:Hagab`); Bazlite (ID: `person:Bazluth`); Netofa (ID: `place:Netophah`); Imer (ID: `place:Immer`); Necoda (ID: `person:Nekoda.2`)
...
* **Associated ACAI Concepts:** Mispar (ID: `person:Mispar`); Baana (ID: `person:Baanah.3`); Mordecai (ID: `person:Mordecai`); Reelaías (ID: `person:Reelaiah`); Reum (ID: `person:Rehum`); Seraias (ID: `person:Seraiah.6`); Bilsã (ID: `person:Bilshan`); Neemias (ID: `person:Nehemiah`); Bigvai (ID: `person:Bigvai`); Israel (ID: `person:Israel`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** Elam (ID: `person:Elam`); Bani (ID: `person:Bani`); Adim (ID: `person:Adin`); Asgade (ID: `person:Azgad`); Sephatias (ID: `person:Shephatiah.6`); Jora (ID: `person:Jorah`); Hasum (ID: `person:Hashum`); Ezequias (ID: `person:Hezekiah.2`); Zacai (ID: `person:Zaccai.2`); Adonicão (ID: `person:Adonikam`); Bigvai (ID: `person:Bigvai.2`); Jesua (ID: `person:Jeshua.3`); Ater (ID: `person:Ater`); Joabe (ID: `person:Joab.3`); Paate-Moabe (ID: `person:Pahath-moab`); Parós (ID: `person:Parosh`); Bezai (ID: `person:Bezai`); Bebai (ID: `person:Bebai`); Ará (ID: `person:Arah.2`); Zatu (ID: `person:Zattu.2`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Magbis (ID: `place:Magbish`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Senaa (ID: `place:Senaah`); Harim (ID: `person:Harim.2`); Netofa (ID: `place:Netophah`); Nebo (ID: `place:Nebo.2`); Hadide (ID: `place:Hadid`); Quiriate-Jearim (ID: `place:Kiriath-jearim`); Elam (ID: `person:Elam`); Micmás (ID: `place:Michmash`); Ono (ID: `place:Ono`); Geba (ID: `place:Geba`); Beerote (ID: `place:Beeroth`); Lode (ID: `place:Lod`); Ai (ID: `place:Ai`); Jericó (ID: `place:Jericho`); Anatote (ID: `place:Anathoth`); Ramah (ID: `place:Ramah.2`); Cefira (ID: `place:Chephirah`); Belém (ID: `place:Bethlehem`); Betel (ID: `place:Bethel`)
...
* **Associated ACAI Concepts:** Harim (ID: `person:Harim`); Sobai (ID: `person:Shobai`); Imer (ID: `person:Immer.2`); Jedaías (ID: `person:Jedaiah.4`); Talmom (ID: `person:Talmon`); Hatita (ID: `person:Hatita`); Hodavias (ID: `person:Hodaviah.4`); Jesua (ID: `person:Jeshua`); Ater (ID: `person:Ater.2`); Jesua (ID: `person:Jeshua.4`); Asafe (ID: `person:Asaph.2`); Cadmiel (ID: `person:Kadmiel`); Acube (ID: `person:Akkub.2`); Levi (ID: `person:Levi.3`); Pasur (ID: `person:Pashhur`); Levi (ID: `group:Levi`); Salum (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** Sobai (ID: `person:Shobai`); Talmom (ID: `person:Talmon`); Hatita (ID: `person:Hatita`); Ater (ID: `person:Ater.2`); Asafe (ID: `person:Asaph.2`); Acube (ID: `person:Akkub.2`); Salum (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** Nephushesim (ID: `group:Nephushesim`); Lebana (ID: `person:Lebanah`); Tabaote (ID: `person:Tabbaoth`); Temá (ID: `person:Temah`); Besai (ID: `person:Besai`); Sisera (ID: `person:Sisera.2`); Barcos (ID: `person:Barkos`); Hanã (ID: `person:Hanan.4`); Gaar (ID: `person:Gahar`); Queros (ID: `person:Keros`); Zia (ID: `person:Ziha`); Gazão (ID: `person:Gazzam`); Hacufa (ID: `person:Hakupha`); Padom (ID: `person:Padon`); Meunim (ID: `group:Meunim`); Hasufa (ID: `person:Hasupha`); Meída (ID: `person:Mehida`); Paseia (ID: `person:Paseah.2`); Hatifa (ID: `person:Hatipha`); Nesias (ID: `person:Neziah`); Acube (ID: `person:Akkub.3`); Necoda (ID: `person:Nekoda`); Asná (ID: `person:Asnah`); Harsa (ID: `person:Harsha`); Rezim (ID: `person:Rezin.2`); Sia (ID: `person:Siaha`); Reaías (ID: `person:Reaiah.3`); Hagaba (ID: `person:Hagabah`); Harur (ID: `person:Harhur`); Hagabe (ID: `person:Hagab`); Gidel (ID: `person:Giddel`); Bazlite (ID: `person:Bazluth`); Salmai (ID: `person:Shalmai`); Baquebuque (ID: `person:Bakbuk`); Uza (ID: `person:Uzza.2`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Sotai (ID: `person:Sotai`); Peruda (ID: `person:Peruda`); Soferete (ID: `person:Sophereth`); Sephatias (ID: `person:Shephatiah.7`); Ami (ID: `person:Ami`); Jaala (ID: `person:Jaalah`); Hatil (ID: `person:Hattil`); Gidel (ID: `person:Giddel.2`); Darcom (ID: `person:Darkon`)
...
* **Associated ACAI Concepts:** Tobias (ID: `person:Tobiah`); Delaías (ID: `person:Delaiah.3`); Tel-Harsa (ID: `place:Tel-harsha`); Adã (ID: `place:Addan`); Tel-Melá (ID: `place:Tel-melah`); Imer (ID: `place:Immer`); Querube (ID: `place:Cherub`); Necoda (ID: `person:Nekoda.2`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Barzillai (ID: `person:Barzillai.3`); Habaiah (ID: `person:Habaiah`); Hacoz (ID: `person:Hakkoz.2`); Gileadites (ID: `group:Gilead`); Gileade (ID: `place:Gilead`); stain (ID: `keyterm:Stain`); Barzillai (ID: `person:Barzillai`); priesthood (ID: `keyterm:Priesthood`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); strength (ID: `keyterm:Strength`); Mina (ID: `realia:Mina`); House (ID: `realia:House`); Tunic (ID: `realia:Tunic`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Josué (ID: `person:Joshua.5`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Cadmiel (ID: `person:Kadmiel`); Relatives (ID: `group:Relatives`); Henadade (ID: `person:Henadad`); Esar-Hadom (ID: `person:Esarhaddon`); Hodavias (ID: `person:Hodaviah.4`); Jesua (ID: `person:Jeshua.4`); Asafe (ID: `person:Asaph.2`); Assyria (ID: `place:Assyria`); Tyrians (ID: `group:Tyre`); terror (ID: `keyterm:Terror`); new moon festival (ID: `keyterm:NewMoonFestival`); kindness (ID: `keyterm:Kindness`); Sidonians (ID: `group:Sidon`); holy (ID: `keyterm:Holy`); Moisés (ID: `person:Moses`); Hodias (ID: `person:Hodiah.2`); appointed feast (ID: `keyterm:AppointedFeast`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); Libano (ID: `place:Lebanon`); Benjamim (ID: `person:Benjamin`); Davi (ID: `person:David`); Dario (ID: `person:Darius.2`); counsel (ID: `keyterm:Counsel`); Benjamim (ID: `group:Benjamin`); Tiro (ID: `place:Tyre`); Jope (ID: `place:Joppa`); Sidom (ID: `place:Sidon`); Instruction (ID: `keyterm:Instruction`); Trumpet (ID: `realia:Trumpet`); Cedar (ID: `flora:Cedar`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Craftsman (ID: `realia:Craftsman`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); terror (ID: `keyterm:Terror`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Tiro (ID: `place:Tyre`); Libano (ID: `place:Lebanon`); Jope (ID: `place:Joppa`); Sidom (ID: `place:Sidon`); Pérsia (ID: `place:Persia`); Tyrians (ID: `group:Tyre`); Sidonians (ID: `group:Sidon`); Anointing Oil (ID: `realia:AnointingOil`); Cedar (ID: `flora:Cedar`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); Zorobabel (ID: `person:Zerubbabel.2`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `group:Levi`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Asafe (ID: `person:Asaph.2`); kindness (ID: `keyterm:Kindness`); Davi (ID: `person:David`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `group:Benjamin`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Benjamim (ID: `person:Benjamin`); Israel (ID: `person:Israel`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Rio Eufrates (ID: `place:Euphrates`); Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Artaxerxes (ID: `person:Artaxerxes.2`); Samaria (ID: `place:Samaria`); Pérsia (ID: `place:Persia`); Jews (ID: `group:Jews`); Ereque (ID: `place:Erech`); Mitredate (ID: `person:Mithredath.2`); Osnapar (ID: `person:Osnappar`); Assuero (ID: `person:Ahasuerus`); Dinaítas (ID: `person:Dinaite`); Tabeel (ID: `person:Tabeel`); Bislão (ID: `person:Bishlam`); Babylonians (ID: `group:Babylon`); Babilônia (ID: `place:Babylon`); Persians (ID: `group:Persia`); Susã (ID: `place:Susa`); Judá (ID: `group:Judah`); Elam (ID: `place:Elam`); Elamites (ID: `group:Elam`); Judá (ID: `person:Judah.4`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Dinaítas (ID: `person:Dinaite`); Ereque (ID: `place:Erech`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Babylonians (ID: `group:Babylon`); Persians (ID: `group:Persia`); Babilônia (ID: `place:Babylon`); Susã (ID: `place:Susa`); Elam (ID: `place:Elam`); Pérsia (ID: `place:Persia`); Elamites (ID: `group:Elam`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Artaxerxes (ID: `person:Artaxerxes.2`); Samaria (ID: `place:Samaria`); Jews (ID: `group:Jews`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); Dario (ID: `person:Darius.2`); Ageu (ID: `person:Haggai`); Tattenai (ID: `person:Tattenai`); Zacarias (ID: `person:Zechariah.17`); Ido (ID: `person:Iddo.6`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Rio Eufrates (ID: `place:Euphrates`); Judá (ID: `person:Judah.4`); Israel (ID: `person:Israel`); Pérsia (ID: `place:Persia`); Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** Ageu (ID: `person:Haggai`); Zacarias (ID: `person:Zechariah.17`); Ido (ID: `person:Iddo.6`); Judá (ID: `person:Judah.4`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Jerusalém (ID: `place:Jerusalem`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Babilônia (ID: `place:Babylon`); Jerusalém (ID: `place:Jerusalem`); Ciro (ID: `person:Cyrus`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Dario (ID: `person:Darius.2`); Zorobabel (ID: `person:Zerubbabel.2`); Tattenai (ID: `person:Tattenai`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Judá (ID: `person:Judah.4`); Israel (ID: `person:Israel`); Chaldeans (ID: `group:Chaldea`); Caldéia (ID: `place:Chaldea`); Rio Eufrates (ID: `place:Euphrates`); Hewn Stone (ID: `realia:HewnStone`); Foundation (ID: `realia:Foundation`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Babilônia (ID: `place:Babylon`); Chaldeans (ID: `group:Chaldea`); Caldéia (ID: `place:Chaldea`); Nabucodonozor (ID: `person:Nebuchadnezzar`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Ciro (ID: `person:Cyrus`); Babilônia (ID: `place:Babylon`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Zorobabel (ID: `person:Zerubbabel.2`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Azarias (ID: `person:Azariah.7`); Meraiote (ID: `person:Meraioth`); Zadoque (ID: `person:Zadok.4`); Zeraías (ID: `person:Zerahiah`); Abisua (ID: `person:Abishua`); Seraias (ID: `person:Seraiah.2`); Aitube (ID: `person:Ahitub.3`); Amarias (ID: `person:Amariah.2`); Buqui (ID: `person:Bukki.2`); Salum (ID: `person:Shallum.7`); Azarias (ID: `person:Azariah.6`); Uzi (ID: `person:Uzzi`); Hilquias (ID: `person:Hilkiah.2`); Eleazar (ID: `person:Eleazar.2`); Arão (ID: `person:Aaron`); Artaxerxes (ID: `person:Artaxerxes`); Pérsia (ID: `place:Persia`); Fineias (ID: `person:Phinehas`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); decree (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Artaxerxes (ID: `person:Artaxerxes`); Rio Eufrates (ID: `place:Euphrates`); Anointing Oil (ID: `realia:AnointingOil`); Wheat (ID: `flora:Wheat`); Talent (ID: `realia:Talent`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Kor (ID: `realia:Kor`)
...
* **Associated ACAI Concepts:** Elam (ID: `person:Elam`); Hatus (ID: `person:Hattush.2`); Adim (ID: `person:Adin`); Joanã (ID: `person:Johanan.8`); Asgade (ID: `person:Azgad`); Zacarias (ID: `person:Zechariah.19`); Sephatias (ID: `person:Shephatiah.6`); Secanias (ID: `person:Shecaniah.5`); Ebede (ID: `person:Ebed.2`); Zabadias (ID: `person:Zebadiah.8`); Joabe (ID: `person:Joab.4`); Josifias (ID: `person:Josiphiah`); Obadias (ID: `person:Obadiah.10`); Jeiel (ID: `person:Jehiel.7`); Hacatã (ID: `person:Hakkatan`); Jaaziel (ID: `person:Jahaziel.5`); Selomite (ID: `person:Shelomith.4`); Jônatas (ID: `person:Jonathan.9`); Semaías (ID: `person:Shemaiah.14`); Adonicão (ID: `person:Adonikam`); Atalia (ID: `person:Athaliah.3`); Elioenai (ID: `person:Eliehoenai.2`); Bigvai (ID: `person:Bigvai.2`); Utai (ID: `person:Uthai.2`); Jeuel (ID: `person:Jeuel.3`); Zacarias (ID: `person:Zechariah.18`); Miguel (ID: `person:Michael.10`); Daniel (ID: `person:Daniel.2`); Parós (ID: `person:Parosh.2`); Gérson (ID: `person:Gershom.2`); Paate-Moabe (ID: `person:Pahath-moab`); Bebai (ID: `person:Bebai.2`); Bebai (ID: `person:Bebai`); Zeraías (ID: `person:Zerahiah.2`); Jesaías (ID: `person:Jeshaiah.4`); Secanias (ID: `person:Shecaniah.6`); Elifelete (ID: `person:Eliphelet.5`); Zacur (ID: `person:Zaccur.5`); Babilônia (ID: `place:Babylon`); Artaxerxes (ID: `person:Artaxerxes`); Davi (ID: `person:David`); Itamar (ID: `person:Ithamar`); Fineias (ID: `person:Phinehas`)
...
* **Associated ACAI Concepts:** Zacarias (ID: `person:Zechariah.20`); Semaías (ID: `person:Shemaiah.15`); Ariel (ID: `person:Ariel`); Ido (ID: `person:Iddo`); Elnatã (ID: `person:Elnathan.4`); Elnatã (ID: `person:Elnathan.2`); Natã (ID: `person:Nathan.5`); Eliezer (ID: `person:Eliezer.8`); Elnatã (ID: `person:Elnathan.3`); Mesulão (ID: `person:Meshullam.9`); Jaribe (ID: `person:Jarib.2`); Joiaribe (ID: `person:Joiarib.2`); Casifia (ID: `place:Casiphia`); SENHOR (ID: `deity:Lord`); perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); SENHOR (ID: `deity:Lord`); Mali (ID: `person:Mahli`); Israel (ID: `person:Israel`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Insight (ID: `keyterm:Insight`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); work (ID: `keyterm:Work`); Davi (ID: `person:David`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); To Sin (ID: `keyterm:Sin`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); Canaã (ID: `place:Canaan`); Moabe (ID: `place:Moab`); Egyptians (ID: `group:Egypt`); Egito (ID: `place:Egypt`); Israel (ID: `person:Israel`); cananeu (ID: `group:Canaan`); Levi (ID: `person:Levi.3`); Ammonites (ID: `group:Ammon`); Hete (ID: `person:Heth`); Amom (ID: `place:Ammon`); Levi (ID: `group:Levi`); be unfaithful (ID: `keyterm:Unfaithful`); Jebusites (ID: `group:Jebusites`); Amorites (ID: `group:Amorites`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); House (ID: `realia:House`); Harim (ID: `person:Harim`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); offering (ID: `keyterm:Offering`); Elam (ID: `person:Elam`); counsel (ID: `keyterm:Counsel`); Aziza (ID: `person:Aziza`); Perizzites (ID: `group:Perizzites`); Atlai (ID: `person:Athlai`); Jaribe (ID: `person:Jarib.3`); Matanias (ID: `person:Mattaniah.8`); Elioenai (ID: `person:Elioenai.5`); Eliasibe (ID: `person:Eliashib.5`); Salum (ID: `person:Shallum.11`); Jozabade (ID: `person:Jozabad.7`); Hasum (ID: `person:Hashum`); Jozabade (ID: `person:Jozabad.8`); Simei (ID: `person:Shimei.17`); Telem (ID: `person:Telem`); Manassés (ID: `person:Manasseh.3`); Sasai (ID: `person:Shashai`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); dispossess (ID: `keyterm:Dispossess`); supplication (ID: `keyterm:Supplication`); peace (ID: `keyterm:IntactState`); to cause to possess (ID: `keyterm:Possess`); Israel (ID: `person:Israel`); defilement (ID: `keyterm:Defilement`); kindness (ID: `keyterm:Kindness`); Pérsia (ID: `place:Persia`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); supplication (ID: `keyterm:Supplication`); kindness (ID: `keyterm:Kindness`); Pérsia (ID: `place:Persia`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); arrepender, se (ID: `keyterm:Repent`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jeiel (ID: `person:Jehiel.8`); Secanias (ID: `person:Shecaniah.7`); Ezra (ID: `person:Ezra`); SENHOR (ID: `deity:Lord`); Elam (ID: `person:Elam`); Israel (ID: `person:Israel`); be unfaithful (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** swear (ID: `keyterm:Swear`); Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `group:Benjamin`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Benjamim (ID: `person:Benjamin`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mesulão (ID: `person:Meshullam.10`); Ticva (ID: `person:Tikvah.2`); Asael (ID: `person:Asahel.4`); Jônatas (ID: `person:Jonathan.10`); Jazeías (ID: `person:Jahzeiah`); Sabetai (ID: `person:Shabbethai`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`)
