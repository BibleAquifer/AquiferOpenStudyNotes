...
* **Associated ACAI Concepts:** Strength (ID: `keyterm:Strength`); Believe In (ID: `keyterm:BelieveIn`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Dispossess (ID: `keyterm:Dispossess`); Wolf (ID: `fauna:Wolf`); Horse (ID: `fauna:Horse`); Leopard (ID: `fauna:Leopard`); Vulture (ID: `fauna:Vulture`)
...
* **Associated ACAI Concepts:** Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Casting Net (ID: `realia:CastingNet`); Holy (ID: `keyterm:Holy`); Pure (ID: `keyterm:Pure`); ٱلرَّبِّ (ID: `deity:Lord`); Fortification (ID: `realia:Fortification`); Chameleon (ID: `fauna:Chameleon`); Lizard (ID: `fauna:Lizard`); Fish (ID: `fauna:Fish`); Monitor (ID: `fauna:Iguana`); Harpoon (ID: `realia:Harpoon`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); ٱلرَّبِّ (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); Idol (ID: `keyterm:Idol`); Trust (ID: `keyterm:LeanOn`); لبْنَانَ (ID: `place:Lebanon`); Hell (ID: `place:Hell`); Proverb (ID: `keyterm:Saying`); Be Disgraced (ID: `keyterm:Disgraced`); Wine (ID: `realia:Wine`); Molten Image (ID: `realia:MoltenImage`); Graven Image (ID: `realia:GravenImage`); Tablet (ID: `realia:Tablet`); Vine (ID: `flora:Vine`); Beam (ID: `realia:Beam`); Image (ID: `realia:Image`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** لبْنَانَ (ID: `place:Lebanon`); Glory (ID: `keyterm:Glory`); ٱلرَّبِّ (ID: `deity:Lord`); Be Disgraced (ID: `keyterm:Disgraced`); Woe (ID: `keyterm:Woe.2`)
...
* **Associated ACAI Concepts:** Idol (ID: `keyterm:Idol`); Trust (ID: `keyterm:LeanOn`); ٱلرَّبِّ (ID: `deity:Lord`); Woe (ID: `keyterm:Woe.2`); Money (ID: `realia:Money`); Molten Image (ID: `realia:MoltenImage`); Graven Image (ID: `realia:GravenImage`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** Salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); تَيْمَانَ (ID: `place:Teman`); كوشَانَ (ID: `place:Cushan`); فَارَانَ (ID: `place:ParanMount`); Arrow (ID: `keyterm:Arrow`); مِدْيَانَ (ID: `place:Midian`); Anointed (ID: `keyterm:Anointed`); Oath (ID: `keyterm:Oath`); Mischief (ID: `keyterm:Mischief`); Holy (ID: `keyterm:Holy`); ٱلرَّبِّ (ID: `deity:Lord`); Majesty (ID: `keyterm:Majesty`); Chariot (ID: `realia:Chariot`); Foundation (ID: `realia:Foundation`); Bow (ID: `realia:Bow`); Tent (ID: `realia:Tent`); Spear (ID: `realia:Spear`)
...
* **Associated ACAI Concepts:** Salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); Arrow (ID: `keyterm:Arrow`); Anointed (ID: `keyterm:Anointed`); Oath (ID: `keyterm:Oath`); ٱلرَّبِّ (ID: `deity:Lord`); Bow (ID: `realia:Bow`); Chariot (ID: `realia:Chariot`); Spear (ID: `realia:Spear`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); Salvation (ID: `keyterm:Salvation`); Sheepfold (ID: `realia:Sheepfold`); Flock (ID: `fauna:Flock`); Fig (ID: `flora:Fig`); Olive Tree (ID: `flora:OliveTree`); Animal Pen (ID: `realia:AnimalPen`); Cattle (ID: `fauna:Bull`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`)
