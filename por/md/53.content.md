...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Tessalônica (ID: `place:Thessalonica`); igreja (ID: `keyterm:Church`); favor (ID: `keyterm:Favor`); Paulo (ID: `person:Paul`); fazer a paz (ID: `keyterm:Peace`); Thessalonians (ID: `group:Thessalonica`); Timóteo (ID: `person:Timothy`); Silas (ID: `person:Silas`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); be (or show oneself) just (ID: `keyterm:Just`); igreja (ID: `keyterm:Church`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); testemunhar (ID: `keyterm:BearWitness`); boa notícia (ID: `keyterm:GoodNews`); fazer justiça (ID: `keyterm:GrantJustice`); reino (ID: `keyterm:Kingdom`); love (ID: `keyterm:Love`); ser glorificado (ID: `keyterm:Glorified`); céu (ID: `keyterm:Heaven`); para a eternidade (ID: `keyterm:Always`); tribunal de justiça (ID: `keyterm:CourtCase`); holy (ID: `keyterm:Holy`); dever (ID: `keyterm:Ought`); juízo (ID: `keyterm:Judgment`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** be (or show oneself) just (ID: `keyterm:Just`); reino (ID: `keyterm:Kingdom`); juízo (ID: `keyterm:Judgment`); tribunal de justiça (ID: `keyterm:CourtCase`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** To Cause to Happen (ID: `keyterm:Happen`); Ability (ID: `keyterm:Ability`); Good (ID: `keyterm:Good`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); Ability (ID: `keyterm:Ability`); Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`); Good (ID: `keyterm:Good`); Name (ID: `keyterm:Name`); crer (ID: `keyterm:Believe`); ser glorificado (ID: `keyterm:Glorified`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`); Name (ID: `keyterm:Name`); ser glorificado (ID: `keyterm:Glorified`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); Spirit (ID: `keyterm:Spirit.2`); crer (ID: `keyterm:Believe`); Truth (ID: `keyterm:Truth`); SENHOR (ID: `deity:Lord`); wipe (out), destroy (ID: `keyterm:Destroy`); Ability (ID: `keyterm:Ability`); rogar (ID: `keyterm:AskFor`); objeto de culto (ID: `keyterm:ObjectOfWorship`); example (ID: `keyterm:Example`); love (ID: `keyterm:Love`); injustiça (ID: `keyterm:UnjustDeed`); Satanás (ID: `deity:Satan`); salvation (ID: `keyterm:Salvation`); decidir (ID: `keyterm:Decided`); maravilha (ID: `keyterm:Portent`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Satanás (ID: `deity:Satan`); Ability (ID: `keyterm:Ability`); example (ID: `keyterm:Example`); maravilha (ID: `keyterm:Portent`)
...
* **Associated ACAI Concepts:** boa notícia (ID: `keyterm:GoodNews`); Jesus (ID: `person:Jesus.2`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`); Good (ID: `keyterm:Good`); love (ID: `keyterm:Love`); para a eternidade (ID: `keyterm:Always`); SENHOR (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); hope (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); persuadir (ID: `keyterm:Persuade`); Faithfulness (ID: `keyterm:Faithfulness`); love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`); orar (ID: `keyterm:Pray`); livrar (ID: `keyterm:Deliver`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); andar (ID: `keyterm:Live.3`); Ability (ID: `keyterm:Ability`); tradição (ID: `keyterm:Teaching`); Name (ID: `keyterm:Name`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); autoridade (ID: `keyterm:Authority.2`); rogar (ID: `keyterm:AskFor`)
