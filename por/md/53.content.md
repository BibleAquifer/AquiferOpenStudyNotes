...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Tessalônica (ID: `place:Thessalonica`); Paulo (ID: `person:Paul`); fazer a paz (ID: `keyterm:Peace`); favor (ID: `keyterm:Favor`); Silas (ID: `person:Silas`); Timóteo (ID: `person:Timothy`); Thessalonians (ID: `group:Thessalonica`); igreja (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); Ability (ID: `keyterm:Ability`); céu (ID: `keyterm:Heaven`); igreja (ID: `keyterm:Church`); holy (ID: `keyterm:Holy`); An Angel (ID: `deity:Angel`); love (ID: `keyterm:Love`); testemunhar (ID: `keyterm:BearWitness`); ser glorificado (ID: `keyterm:Glorified`); fazer justiça (ID: `keyterm:GrantJustice`); juízo (ID: `keyterm:Judgment`); boa notícia (ID: `keyterm:GoodNews`); Glory (ID: `keyterm:Glory`); reino (ID: `keyterm:Kingdom`); para a eternidade (ID: `keyterm:Always`); tribunal de justiça (ID: `keyterm:CourtCase`); dever (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** juízo (ID: `keyterm:Judgment`); reino (ID: `keyterm:Kingdom`); SENHOR (ID: `deity:Lord`); tribunal de justiça (ID: `keyterm:CourtCase`); be (or show oneself) just (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); orar (ID: `keyterm:Pray`); Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`); Good (ID: `keyterm:Good`); ser glorificado (ID: `keyterm:Glorified`); crer (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`); Name (ID: `keyterm:Name`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`); SENHOR (ID: `deity:Lord`); ser glorificado (ID: `keyterm:Glorified`); Name (ID: `keyterm:Name`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); Spirit (ID: `keyterm:Spirit.2`); crer (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`); maravilha (ID: `keyterm:Portent`); rogar (ID: `keyterm:AskFor`); love (ID: `keyterm:Love`); decidir (ID: `keyterm:Decided`); injustiça (ID: `keyterm:UnjustDeed`); wipe (out), destroy (ID: `keyterm:Destroy`); objeto de culto (ID: `keyterm:ObjectOfWorship`); example (ID: `keyterm:Example`); Satanás (ID: `deity:Satan`); salvation (ID: `keyterm:Salvation`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); maravilha (ID: `keyterm:Portent`); example (ID: `keyterm:Example`); Satanás (ID: `deity:Satan`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); love (ID: `keyterm:Love`); favor (ID: `keyterm:Favor`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); para a eternidade (ID: `keyterm:Always`); hope (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); livrar (ID: `keyterm:Deliver`); Glory (ID: `keyterm:Glory`); orar (ID: `keyterm:Pray`); love (ID: `keyterm:Love`); Faithfulness (ID: `keyterm:Faithfulness`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); persuadir (ID: `keyterm:Persuade`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); andar (ID: `keyterm:Live.3`); Ability (ID: `keyterm:Ability`); tradição (ID: `keyterm:Teaching`); autoridade (ID: `keyterm:Authority.2`); rogar (ID: `keyterm:AskFor`); Name (ID: `keyterm:Name`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`)
