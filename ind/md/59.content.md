...
* **Associated ACAI Concepts:** tahan uji (ID: `keyterm:Approved`); berbahagialah (ID: `keyterm:Happy`)
...
* **Associated ACAI Concepts:** mencobai (ID: `keyterm:PutToTheTest`); berbahagialah (ID: `keyterm:Happy`); Mirror (ID: `realia:Mirror`); tahan uji (ID: `keyterm:Approved`); sia, sia (ID: `keyterm:Worthless`); suci (ID: `keyterm:Clean`)
...
* **Associated ACAI Concepts:** sia, sia (ID: `keyterm:Worthless`); suci (ID: `keyterm:Clean`)
...
* **Associated ACAI Concepts:** tonton bulu atau muka (ID: `keyterm:Partiality`); tersandung (ID: `keyterm:Stumble`); penghakiman (ID: `keyterm:Judgment`); hukum (ID: `keyterm:Law`)
...
* **Associated ACAI Concepts:** persahabatan (ID: `keyterm:Friendship`); tidak setia (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** persahabatan (ID: `keyterm:Friendship`); tidak setia (ID: `keyterm:Unfaithful`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** penyayang (ID: `keyterm:Compassionate`); Ayub (ID: `person:Job`)
