...
* **Associated ACAI Concepts:** comprehension (ID: `keyterm:Understanding`); Édom (ID: `group:Edom`); état intact (ID: `keyterm:IntactState`); alliance (ID: `keyterm:Covenant`); Édom (ID: `place:Edom`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`); destin (ID: `keyterm:Lot`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Joseph (ID: `person:Joseph.10`); Édom (ID: `group:Edom`); Jérusalem (ID: `place:Jerusalem`); déposséder (ID: `keyterm:Dispossess`); Édom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** Joseph (ID: `person:Joseph.10`); Édom (ID: `group:Edom`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Édom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** Negev (ID: `place:Negeb`); déposséder (ID: `keyterm:Dispossess`); Benjamin (ID: `group:Benjamin`); Sardes (ID: `place:Sardis`); Éphraïm (ID: `person:Ephraim`); Philistins (ID: `group:Philistine`); Galaad (ID: `place:Gilead`); Canaan (ID: `group:Canaan`); Sarepta (ID: `place:Zarephath`); montagne d'Ésaü (ID: `place:EsauMount`); Philistia (ID: `place:Philistine`); Éphraïm (ID: `group:Ephraim`); Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`); Samarie (ID: `place:Samaria`); Canaan (ID: `place:Canaan`); Shephelah (ID: `place:Shephelah`); Benjamin (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** montagne d'Ésaü (ID: `place:EsauMount`); Jérusalem (ID: `place:Jerusalem`); Negev (ID: `place:Negeb`); déposséder (ID: `keyterm:Dispossess`); Sardes (ID: `place:Sardis`); Éternel (ID: `deity:Lord`); Sarepta (ID: `place:Zarephath`); Benjamin (ID: `person:Benjamin`); Benjamin (ID: `group:Benjamin`); Éphraïm (ID: `person:Ephraim`); Philistia (ID: `place:Philistine`); Canaan (ID: `place:Canaan`); Shephelah (ID: `place:Shephelah`); Galaad (ID: `place:Gilead`); Canaan (ID: `group:Canaan`); Éphraïm (ID: `group:Ephraim`); Samarie (ID: `place:Samaria`); Philistins (ID: `group:Philistine`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Sardes (ID: `place:Sardis`); Canaan (ID: `group:Canaan`); Sarepta (ID: `place:Zarephath`); Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`); Negev (ID: `place:Negeb`); Canaan (ID: `place:Canaan`); déposséder (ID: `keyterm:Dispossess`)
