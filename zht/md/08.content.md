...
* **Associated ACAI Concepts:** Ephrathah (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Ephrathites (ID: `group:Ephrathah`); Chilion (ID: `person:Chilion`); Moab (ID: `place:Moab`); Mahlon (ID: `person:Mahlon`); Bethlehem (ID: `place:Bethlehem`); Elimelech (ID: `person:Elimelech`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); Bethlehem (ID: `place:Bethlehem`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Favor (ID: `keyterm:Favor`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Bless (ID: `keyterm:Bless`); Kindness (ID: `keyterm:Kindness`); LORD (ID: `deity:Lord`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elders (ID: `group:GenericElders`); LORD (ID: `deity:Lord`); Bethlehem (ID: `place:Bethlehem`); Rachel (ID: `person:Rachel`); Leah (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Naomi (ID: `person:Naomi`); Bless (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Obed (ID: `person:Obed`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); David (ID: `person:David`); Jesse (ID: `person:Jesse`); Perez (ID: `person:Perez`); Nahshon (ID: `person:Nahshon`); Boaz (ID: `person:Boaz`)
