...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Catah (ID: `place:Bethlehem`)
...
* **Associated ACAI Concepts:** Chelión (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Efratita (ID: `group:Ephrathah`); Ephrata (ID: `person:Ephrathah`); Elimelech (ID: `person:Elimelech`); Judá (ID: `group:Judah`); Mahalón (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Catah (ID: `place:Bethlehem`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Orpha (ID: `person:Orpah`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Appoint (ID: `keyterm:Appoint`); Moab (ID: `place:Moab`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Noemi (ID: `person:Naomi`); Catah (ID: `place:Bethlehem`); Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Noemi (ID: `person:Naomi`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** bondad (ID: `keyterm:Kindness`); Noemi (ID: `person:Naomi`); Jehová (ID: `deity:Lord`); bendecir (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Elimelech (ID: `person:Elimelech`); Noemi (ID: `person:Naomi`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); dejar en herencia (ID: `keyterm:Possess`); Noemi (ID: `person:Naomi`); Booz (ID: `person:Boaz`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Rachêl (ID: `person:Rachel`); Israel (ID: `person:Israel`); Catah (ID: `place:Bethlehem`); Elders (ID: `group:GenericElders`); Lea (ID: `person:Leah`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Thamar (ID: `person:Tamar`); Phares (ID: `person:Perez`); Judá (ID: `person:Judah.4`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Israel (ID: `person:Israel`); Noemi (ID: `person:Naomi`); Jehová (ID: `deity:Lord`); bendecir (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Hesrón (ID: `person:Hezron.2`); Salmón (ID: `person:Salmon`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Isaí (ID: `person:Jesse`); Nahasón (ID: `person:Nahshon`); David (ID: `person:David`); Phares (ID: `person:Perez`); Booz (ID: `person:Boaz`)
