...
* **Associated ACAI Concepts:** Dragon Spring (ID: `place:DragonSpring`); آسَاف (ID: `person:Asaph.4`); Horonites (ID: `group:Horonites`); ٱلْوَادِي (ID: `place:ValleyGate`); حَنَانِي (ID: `person:Hanani.4`); سَنْبَلَّط (ID: `person:Sanballat`); حَكَلْيَا (ID: `person:Hacaliah`); طوبِيَّا (ID: `person:Tobiah.2`); ٱلْعَيْنِ (ID: `place:FountainGate`); ٱلدِّمْنِ (ID: `place:DungGate`); جَشَمٌ (ID: `person:Geshem`); نَحَمْيَا (ID: `person:Nehemiah.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فِي (ID: `place:Susa`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`)
## نحميا 1: 2 (id: 756328)
...
* **Associated ACAI Concepts:** حَنَانِي (ID: `person:Hanani.4`)
## نحميا 1: 3 (id: 756329)
...
* **Associated ACAI Concepts:** أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`)
## نحميا 2: 2 (id: 756395)
...
* **Associated ACAI Concepts:** آسَاف (ID: `person:Asaph.4`)
## نحميا 2: 9 (id: 756401)
...
* **Associated ACAI Concepts:** Horonites (ID: `group:Horonites`); سَنْبَلَّط (ID: `person:Sanballat`); طوبِيَّا (ID: `person:Tobiah.2`)
...
* **Associated ACAI Concepts:** Dragon Spring (ID: `place:DragonSpring`); ٱلْوَادِي (ID: `place:ValleyGate`); ٱلْعَيْنِ (ID: `place:FountainGate`); ٱلدِّمْنِ (ID: `place:DungGate`)
...
* **Associated ACAI Concepts:** Dragon Spring (ID: `place:DragonSpring`); ٱلدِّمْنِ (ID: `place:DungGate`); ٱلْوَادِي (ID: `place:ValleyGate`)
...
* **Associated ACAI Concepts:** ٱلْعَيْنِ (ID: `place:FountainGate`)
...
* **Associated ACAI Concepts:** Horonites (ID: `group:Horonites`); جَشَمٌ (ID: `person:Geshem`); طوبِيَّا (ID: `person:Tobiah.2`)
...
* **Associated ACAI Concepts:** برْجِ (ID: `place:TowerOfTheHundred`); أَلْيَاشِيب (ID: `person:Eliashib.7`); ٱلضَّأْنِ (ID: `place:SheepGate`); برْجِ (ID: `place:TowerOfHananel`)
...
* **Associated ACAI Concepts:** بَعْنَا (ID: `person:Baana.3`); صَادوق (ID: `person:Zadok.5`); زَكّور (ID: `person:Zaccur.6`); مَشِيزَبْئِيلَ (ID: `person:Meshezabel`); إِمْرِي (ID: `person:Imri.2`); برْجِ (ID: `place:TowerOfTheHundred`); هَقّوصَ (ID: `person:Hakkoz.3`); لِأورِيَّا (ID: `person:Uriah.4`); هَسْنوآةَ (ID: `person:Hassenuah`); مَشلَّام (ID: `person:Meshullam.12`); أَلْيَاشِيب (ID: `person:Eliashib.7`); بَرَخْيَا (ID: `person:Berechiah.5`); ٱلضَّأْنِ (ID: `place:SheepGate`); برْجِ (ID: `place:TowerOfHananel`); باب ٱلسَّمَكِ (ID: `place:FishGate`); مَرِيموث (ID: `person:Meremoth`); تَقوعَ (ID: `place:Tekoa`)
...
* **Associated ACAI Concepts:** أَلْيَاشِيب (ID: `person:Eliashib.7`); هَقّوصَ (ID: `person:Hakkoz.3`); عَزَرْيَا (ID: `person:Azariah.17`); حَانون (ID: `person:Hanun.2`); لِإِيمِيرَ (ID: `person:Immer.3`); عَازَر (ID: `person:Ezer.5`); يَشوعَ (ID: `person:Jeshua.6`); زَبَاي (ID: `person:Zabbai.2`); بَنْيَامِينَ (ID: `person:Benjamin.4`); صَادوق (ID: `person:Zadok.5`); زَكّور (ID: `person:Zaccur.6`); فَدَايَا (ID: `person:Pedaiah.4`); عَنَنْيَا (ID: `person:Ananiah`); مَلَطْيَا (ID: `person:Melatiah`); نَحَمْيَا (ID: `person:Nehemiah.3`); رَكَابٍ (ID: `person:Rechab.3`); يَدَايَا (ID: `person:Jedaiah.2`); شَلَمْيَا (ID: `person:Shelemiah.4`); حِينَادَادَ (ID: `person:Henadad.2`); إِمْرِي (ID: `person:Imri.2`); شَلّوم (ID: `person:Shallum.12`); بَاروخَ (ID: `person:Baruch`); بَعْنَا (ID: `person:Baana.3`); حَشّوب (ID: `person:Hasshub.3`); فَرْعوشَ (ID: `person:Parosh.3`); عزِّيئِيل (ID: `person:Uzziel.6`); صَالَافَ (ID: `person:Zalaph`); رَحوم (ID: `person:Rehum.3`); مَشِيزَبْئِيلَ (ID: `person:Meshezabel`); حَانون (ID: `person:Hanun.3`); صَادوق (ID: `person:Zadok.6`); Muster Gate (ID: `place:InspectionGate`); بَنّويَ (ID: `person:Binnui.5`); حِينَادَادَ (ID: `person:Henadad.3`); حَشَبْنِيَا (ID: `person:Hashabneiah`); بَانِيَ (ID: `person:Bani.7`); حَشَبْيَا (ID: `person:Hashabiah.8`); Col-hozeh (ID: `person:Col-hozeh`); حَرْهَايَا (ID: `person:Harhaiah`); عَزْبوقَ (ID: `person:Azbuk`); مَلْكِيَّا (ID: `person:Malchijah.7`); مَشلَّام (ID: `person:Meshullam.13`); ٱلشَّرْقِ (ID: `place:EastGate`); مَلْكِيَّا (ID: `person:Malchijah.6`); حَشّوب (ID: `person:Hasshub.2`); مَلْكِيَّا (ID: `person:Malchijah.8`); بَسودْيَا (ID: `person:Besodeiah`); أوزَايَ (ID: `person:Uzai`); يويَادَاعَ (ID: `person:Joiada`); شِمْعِيَا (ID: `person:Shemaiah.18`); فَالَال (ID: `person:Palal`); حور (ID: `person:Hur.4`); يَادون (ID: `person:Jadon`); مَعْسِيَّا (ID: `person:Maaseiah.10`); فَاسِيحَ (ID: `person:Paseah.3`); حَرومَافَ (ID: `person:Harumaph`); رَفَايَا (ID: `person:Rephaiah.5`); بَوَّاي (ID: `person:Bavvai`); حَارِيمَ (ID: `person:Harim.3`); شَلّوم (ID: `person:Shallum.15`); حَنَنِيَّا (ID: `person:Hananiah.7`); Pahath-moab (ID: `person:Pahath-moab.2`); حَنَنِيَّا (ID: `person:Hananiah.6`); حَطّوش (ID: `person:Hattush.3`); بَرَخْيَا (ID: `person:Berechiah.5`); مَشلَّام (ID: `person:Meshullam.12`); لِأورِيَّا (ID: `person:Uriah.4`); ٱلدِّمْنِ (ID: `place:DungGate`); ٱلضَّأْنِ (ID: `place:SheepGate`); ٱلْأَكَمَةِ (ID: `place:Ophel`); مَرِيموث (ID: `person:Meremoth`); شَكَنْيَا (ID: `person:Shecaniah.7`); برْجِ (ID: `place:TowerOfTheHundred`); Beth-haccherem (ID: `place:Beth-haccherem`); Gate of Jeshanah (ID: `place:YeshanahGate`); هَلّوحِيشَ (ID: `person:Hallohesh`); برْجَ (ID: `place:TowerOfTheOvens`); ٱلسّورِ (ID: `place:BroadWall`); ٱلْخَيْلِ (ID: `place:HorseGate`); Meronothites (ID: `group:Meronothite`); تَقوعَ (ID: `place:Tekoa`); هَسْنوآةَ (ID: `person:Hassenuah`); ٱلْعَيْنِ (ID: `place:FountainGate`); برْجِ (ID: `place:TowerOfHananel`); ٱلْوَادِي (ID: `place:ValleyGate`); باب ٱلسَّمَكِ (ID: `place:FishGate`); زَانوح (ID: `place:Zanoah`); ٱلْمَاءِ (ID: `place:WaterGate`); House (ID: `realia:House`)
## نحميا ٣: ٣ (id: 756415)
...
* **Associated ACAI Concepts:** بَعْنَا (ID: `person:Baana.3`); مَشِيزَبْئِيلَ (ID: `person:Meshezabel`); صَادوق (ID: `person:Zadok.5`); هَقّوصَ (ID: `person:Hakkoz.3`); مَشلَّام (ID: `person:Meshullam.12`); بَرَخْيَا (ID: `person:Berechiah.5`); لِأورِيَّا (ID: `person:Uriah.4`); مَرِيموث (ID: `person:Meremoth`)
## نحميا ٣: ٥ (id: 756417)
...
* **Associated ACAI Concepts:** تَقوعَ (ID: `place:Tekoa`)
## نحميا 3: 6 (id: 756419)
...
* **Associated ACAI Concepts:** مَشلَّام (ID: `person:Meshullam.13`); يويَادَاعَ (ID: `person:Joiada`); بَسودْيَا (ID: `person:Besodeiah`); فَاسِيحَ (ID: `person:Paseah.3`); Gate of Jeshanah (ID: `place:YeshanahGate`)
...
* **Associated ACAI Concepts:** مَلَطْيَا (ID: `person:Melatiah`); بَسودْيَا (ID: `person:Besodeiah`); مَشلَّام (ID: `person:Meshullam.13`); حَنَنِيَّا (ID: `person:Hananiah.6`); عزِّيئِيل (ID: `person:Uzziel.6`); يويَادَاعَ (ID: `person:Joiada`); حَرْهَايَا (ID: `person:Harhaiah`); فَاسِيحَ (ID: `person:Paseah.3`); يَادون (ID: `person:Jadon`); Gate of Jeshanah (ID: `place:YeshanahGate`); ٱلسّورِ (ID: `place:BroadWall`); Meronothites (ID: `group:Meronothite`)
## نحميا ٣: ٧ (id: 756420)
...
* **Associated ACAI Concepts:** مَلَطْيَا (ID: `person:Melatiah`); يَادون (ID: `person:Jadon`); Meronothites (ID: `group:Meronothite`)
## نحميا ٣: ٨ (id: 756421)
...
* **Associated ACAI Concepts:** حَنَنِيَّا (ID: `person:Hananiah.6`); عزِّيئِيل (ID: `person:Uzziel.6`); حَرْهَايَا (ID: `person:Harhaiah`); ٱلسّورِ (ID: `place:BroadWall`)
...
* **Associated ACAI Concepts:** حَانون (ID: `person:Hanun.2`); حَرومَافَ (ID: `person:Harumaph`); رَفَايَا (ID: `person:Rephaiah.5`); مَلْكِيَّا (ID: `person:Malchijah.6`); حَشّوب (ID: `person:Hasshub.2`); حَارِيمَ (ID: `person:Harim.3`); يَدَايَا (ID: `person:Jedaiah.2`); Pahath-moab (ID: `person:Pahath-moab.2`); شَلّوم (ID: `person:Shallum.12`); حَشَبْنِيَا (ID: `person:Hashabneiah`); حور (ID: `person:Hur.4`); حَطّوش (ID: `person:Hattush.3`); هَلّوحِيشَ (ID: `person:Hallohesh`); برْجَ (ID: `place:TowerOfTheOvens`); ٱلدِّمْنِ (ID: `place:DungGate`); زَانوح (ID: `place:Zanoah`); ٱلْوَادِي (ID: `place:ValleyGate`)
...
* **Associated ACAI Concepts:** مَلْكِيَّا (ID: `person:Malchijah.6`); حَشّوب (ID: `person:Hasshub.2`); Pahath-moab (ID: `person:Pahath-moab.2`); حَارِيمَ (ID: `person:Harim.3`); برْجَ (ID: `place:TowerOfTheOvens`)
...
* **Associated ACAI Concepts:** حَانون (ID: `person:Hanun.2`); ٱلدِّمْنِ (ID: `place:DungGate`); زَانوح (ID: `place:Zanoah`); ٱلْوَادِي (ID: `place:ValleyGate`)
...
* **Associated ACAI Concepts:** رَكَابٍ (ID: `person:Rechab.3`); مَلْكِيَّا (ID: `person:Malchijah.7`); Beth-haccherem (ID: `place:Beth-haccherem`)
...
* **Associated ACAI Concepts:** شَلّوم (ID: `person:Shallum.15`); مَلْكِيَّا (ID: `person:Malchijah.7`); Col-hozeh (ID: `person:Col-hozeh`); رَكَابٍ (ID: `person:Rechab.3`); Beth-haccherem (ID: `place:Beth-haccherem`); ٱلْعَيْنِ (ID: `place:FountainGate`)
...
* **Associated ACAI Concepts:** شَلّوم (ID: `person:Shallum.15`); Col-hozeh (ID: `person:Col-hozeh`); ٱلْعَيْنِ (ID: `place:FountainGate`)
...
* **Associated ACAI Concepts:** نَحَمْيَا (ID: `person:Nehemiah.3`); عَزْبوقَ (ID: `person:Azbuk`)
...
* **Associated ACAI Concepts:** عَزَرْيَا (ID: `person:Azariah.17`); حَشّوب (ID: `person:Hasshub.3`); لِإِيمِيرَ (ID: `person:Immer.3`); عَزْبوقَ (ID: `person:Azbuk`); فَرْعوشَ (ID: `person:Parosh.3`); عَازَر (ID: `person:Ezer.5`); يَشوعَ (ID: `person:Jeshua.6`); زَبَاي (ID: `person:Zabbai.2`); بَنْيَامِينَ (ID: `person:Benjamin.4`); مَعْسِيَّا (ID: `person:Maaseiah.10`); فَدَايَا (ID: `person:Pedaiah.4`); عَنَنْيَا (ID: `person:Ananiah`); صَالَافَ (ID: `person:Zalaph`); ٱلشَّرْقِ (ID: `place:EastGate`); نَحَمْيَا (ID: `person:Nehemiah.3`); رَحوم (ID: `person:Rehum.3`); بَوَّاي (ID: `person:Bavvai`); مَلْكِيَّا (ID: `person:Malchijah.8`); حَانون (ID: `person:Hanun.3`); صَادوق (ID: `person:Zadok.6`); Muster Gate (ID: `place:InspectionGate`); أوزَايَ (ID: `person:Uzai`); شَلَمْيَا (ID: `person:Shelemiah.4`); حَنَنِيَّا (ID: `person:Hananiah.7`); حِينَادَادَ (ID: `person:Henadad.2`); بَنّويَ (ID: `person:Binnui.5`); شِمْعِيَا (ID: `person:Shemaiah.18`); فَالَال (ID: `person:Palal`); حِينَادَادَ (ID: `person:Henadad.3`); بَانِيَ (ID: `person:Bani.7`); حَشَبْيَا (ID: `person:Hashabiah.8`); بَاروخَ (ID: `person:Baruch`); أَلْيَاشِيب (ID: `person:Eliashib.7`); ٱلْأَكَمَةِ (ID: `place:Ophel`); شَكَنْيَا (ID: `person:Shecaniah.7`); ٱلْخَيْلِ (ID: `place:HorseGate`); هَقّوصَ (ID: `person:Hakkoz.3`); لِأورِيَّا (ID: `person:Uriah.4`); مَشلَّام (ID: `person:Meshullam.12`); بَرَخْيَا (ID: `person:Berechiah.5`); ٱلضَّأْنِ (ID: `place:SheepGate`); ٱلْمَاءِ (ID: `place:WaterGate`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** بَنّويَ (ID: `person:Binnui.5`); حِينَادَادَ (ID: `person:Henadad.3`); عَزَرْيَا (ID: `person:Azariah.17`)
...
* **Associated ACAI Concepts:** أوزَايَ (ID: `person:Uzai`); فَرْعوشَ (ID: `person:Parosh.3`); فَالَال (ID: `person:Palal`); فَدَايَا (ID: `person:Pedaiah.4`); ٱلْمَاءِ (ID: `place:WaterGate`); ٱلْأَكَمَةِ (ID: `place:Ophel`)
...
* **Associated ACAI Concepts:** ٱلشَّرْقِ (ID: `place:EastGate`); Muster Gate (ID: `place:InspectionGate`); لِإِيمِيرَ (ID: `person:Immer.3`); شِمْعِيَا (ID: `person:Shemaiah.18`); مَلْكِيَّا (ID: `person:Malchijah.8`); حَانون (ID: `person:Hanun.3`); شَلَمْيَا (ID: `person:Shelemiah.4`); حَنَنِيَّا (ID: `person:Hananiah.7`); صَادوق (ID: `person:Zadok.6`); صَالَافَ (ID: `person:Zalaph`); ٱلْخَيْلِ (ID: `place:HorseGate`); شَكَنْيَا (ID: `person:Shecaniah.7`); بَرَخْيَا (ID: `person:Berechiah.5`); مَشلَّام (ID: `person:Meshullam.12`); ٱلضَّأْنِ (ID: `place:SheepGate`)
## نحميا 4: 2 (id: 756431)
...
* **Associated ACAI Concepts:** طوبِيَّا (ID: `person:Tobiah.2`); جَشَمٌ (ID: `person:Geshem`); مَهِيطَبْئِيلَ (ID: `person:Mehetabel.2`); آرَحَ (ID: `person:Arah.3`); يَهونَاثَان (ID: `person:Jehohanan.6`); شِمْعِيَا (ID: `person:Shemaiah.19`); لِدَلَايَا (ID: `person:Delaiah.4`); شَكَنْيَا (ID: `person:Shecaniah.8`); نوعَدْيَةَ (ID: `person:Noadiah.2`); مَشلَّام (ID: `person:Meshullam.12`); بَرَخْيَا (ID: `person:Berechiah.5`); أونوَ (ID: `place:Ono`); سَنْبَلَّط (ID: `person:Sanballat`); Fear (ID: `keyterm:Fear`)
## نحميا ٦: ٢ (id: 756454)
...
* **Associated ACAI Concepts:** جَشَمٌ (ID: `person:Geshem`); أونوَ (ID: `place:Ono`)
...
* **Associated ACAI Concepts:** جَشَمٌ (ID: `person:Geshem`)
...
* **Associated ACAI Concepts:** حَنَنِيَّا (ID: `person:Hananiah.8`); حَنَانِي (ID: `person:Hanani.4`)
## نحميا 7: 3 (id: 756459)
...
* **Associated ACAI Concepts:** نَحَمَانِي (ID: `person:Nahamani`); بَعْنَةَ (ID: `person:Baanah.3`); نَحَمْيَا (ID: `person:Nehemiah`); مِسْفَار (ID: `person:Mispar`); مرْدَخَاي (ID: `person:Mordecai`); رَعْلَايَا (ID: `person:Reelaiah`); بِغْوَايَ (ID: `person:Bigvai`); بِلْشَان (ID: `person:Bilshan`); عَزَرْيَا (ID: `person:Azariah.18`); رَحوم (ID: `person:Rehum`)
...
* **Associated ACAI Concepts:** عِيلَامَ (ID: `person:Elam`); يوآب (ID: `person:Joab.3`); بِيصَايَ (ID: `person:Bezai`); حَارِيمَ (ID: `person:Harim.2`); يورَةَ (ID: `person:Jorah`); يَشوعَ (ID: `person:Jeshua.3`); حَزَقِيَّا (ID: `person:Hezekiah.2`); آرَحَ (ID: `person:Arah.2`); سَنَاءَةَ (ID: `place:Senaah`); آطِيرَ (ID: `person:Ater`); زَكَّايَ (ID: `person:Zaccai.2`); عَادِينَ (ID: `person:Adin`); عَرْجَدَ (ID: `person:Azgad`); نَبو (ID: `place:Nebo.2`); زَتّو (ID: `person:Zattu.2`); شَفَطْيَا (ID: `person:Shephatiah.6`); بِغْوَايَ (ID: `person:Bigvai.2`); حَادِيدَ (ID: `place:Hadid`); Beth-azmaveth (ID: `place:Beth-azmaveth`); أَدونِيقَامَ (ID: `person:Adonikam`); فَرْعوشَ (ID: `person:Parosh`); حَشوم (ID: `person:Hashum`); ٱلْكَفِيرَة (ID: `place:Chephirah`); بَابَايَ (ID: `person:Bebai`); Pahath-moab (ID: `person:Pahath-moab`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`)
...
* **Associated ACAI Concepts:** فَاسِيحَ (ID: `person:Paseah.2`); مَحِيدَا (ID: `person:Mehida`); فِي (ID: `person:Uzza.2`); حَطِيطَا (ID: `person:Hatita`); جَدِّيلَ (ID: `person:Giddel`); يَعْلَةَ (ID: `person:Jaalah`); سَوْطَايَ (ID: `person:Sotai`); حَجَابَةَ (ID: `person:Hagabah`); حَطِّيلَ (ID: `person:Hattil`); بَصْلوتَ (ID: `person:Bazluth`); شوبَايَ (ID: `person:Shobai`); لَبَانَةَ (ID: `person:Lebanah`); رَصِينَ (ID: `person:Rezin.2`); سِيسَرَا (ID: `person:Sisera.2`); حَرْشَا (ID: `person:Harsha`); آمِي (ID: `person:Ami`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); بَرْقوسَ (ID: `person:Barkos`); حَسوفَا (ID: `person:Hasupha`); صِيحَا (ID: `person:Ziha`); جَزَّامَ (ID: `person:Gazzam`); فَرودَا (ID: `person:Peruda`); حَرْحورَ (ID: `person:Harhur`); طَبَاعوتَ (ID: `person:Tabbaoth`); سوفَرَثَ (ID: `person:Sophereth`); رَآيَا (ID: `person:Reaiah.3`); جَاحَرَ (ID: `person:Gahar`); شَفَطْيَا (ID: `person:Shephatiah.7`); سَلْمَايَ (ID: `person:Shalmai`); حَطِيفَا (ID: `person:Hatipha`); حَانَان (ID: `person:Hanan.4`); نَصِيحَ (ID: `person:Neziah`); آطِيرَ (ID: `person:Ater.2`); ثَامَحَ (ID: `person:Temah`); جَدِّيلَ (ID: `person:Giddel.2`); دَرْقونَ (ID: `person:Darkon`); Meunim (ID: `group:Meunim`); حَقوفَا (ID: `person:Hakupha`); قِيروسَ (ID: `person:Keros`); نَقودَا (ID: `person:Nekoda`); سِيعَهَا (ID: `person:Siaha`); فَادونَ (ID: `person:Padon`); Nephushesim (ID: `group:Nephushesim`); بِيسَايَ (ID: `person:Besai`); بَقْبوقَ (ID: `person:Bakbuk`); هودَوْيَا (ID: `person:Hodaviah.4`); يَدَايَا (ID: `person:Jedaiah.4`); يَشوعَ (ID: `person:Jeshua`); شَلّوم (ID: `person:Shallum.8`); عَقّوب (ID: `person:Akkub.2`); حَارِيمَ (ID: `person:Harim`)
...
* **Associated ACAI Concepts:** كَروب (ID: `place:Cherub`); Tel-melah (ID: `place:Tel-melah`); لِإِيمِيرَ (ID: `place:Immer`); Tel-harsha (ID: `place:Tel-harsha`); لِدَلَايَا (ID: `person:Delaiah.3`); طوبِيَّا (ID: `person:Tobiah`); نَقودَا (ID: `person:Nekoda.2`)
...
* **Associated ACAI Concepts:** بَانِيَ (ID: `person:Bani.8`); شَبَنْيَا (ID: `person:Shebaniah.2`); فَلَايَا (ID: `person:Pelaiah`); قَلِيطَا (ID: `person:Kelita.2`); بَانِيَ (ID: `person:Bani.11`); حَانَان (ID: `person:Hanan.5`); Instruction (ID: `keyterm:Instruction`); Perceive (ID: `keyterm:Perceive`); شَرَبْيَا (ID: `person:Sherebiah`); ٱلْمَاءِ (ID: `place:WaterGate`); هودِيَّا (ID: `person:Hodiah.2`); مَشلَّام (ID: `person:Meshullam.16`); مَلْكِيَّا (ID: `person:Malchijah.10`); Ahiah (ID: `person:Ahiah`); بِغْوَايَ (ID: `person:Bigvai.3`); أَدونِيَّا (ID: `person:Adonijah.3`); حَشْبَدَّانَة (ID: `person:Hashbaddanah`); فَرْعوشَ (ID: `person:Parosh.4`); هودِيَّا (ID: `person:Hodiah.4`); Shobek (ID: `person:Shobek`); عَزَرْيَا (ID: `person:Azariah.19`); عِيلَامَ (ID: `person:Elam.5`); Beninu (ID: `person:Beninu`); بَابَايَ (ID: `person:Bebai.3`); بونِّي (ID: `person:Bunni.2`); عَقّوب (ID: `person:Akkub.4`); حَشوم (ID: `person:Hashum.3`); هوشَعَ (ID: `person:Hoshea.3`); مَتَّثْيَا (ID: `person:Mattithiah.4`); لِهَفْصِيصَ (ID: `person:Hezir.2`)
## نحميا 8: 1 (id: 756476)
...
* **Associated ACAI Concepts:** ٱلْمَاءِ (ID: `place:WaterGate`)
## نحميا 8: 2 (id: 756477)
...
* **Associated ACAI Concepts:** حَشوم (ID: `person:Hashum.2`); مَشلَّام (ID: `person:Meshullam.14`); مَلْكِيَّا (ID: `person:Malchijah.9`); زَكَرِيَّا (ID: `person:Zechariah.22`); مَتَّثْيَا (ID: `person:Mattithiah.4`); مَعْسِيَّا (ID: `person:Maaseiah.11`); فَدَايَا (ID: `person:Pedaiah.5`); لِأورِيَّا (ID: `person:Uriah.5`); حَشْبَدَّانَة (ID: `person:Hashbaddanah`); عَنَايَا (ID: `person:Anaiah`); مِيشَائِيل (ID: `person:Mishael.2`); حِلْقِيَّا (ID: `person:Hilkiah.5`); شَامِعَ (ID: `person:Shema.4`)
## نحميا 8: 5 (id: 756480)
...
* **Associated ACAI Concepts:** مَعْسِيَّا (ID: `person:Maaseiah.12`); يَمِين (ID: `person:Jamin.3`); عَزَرْيَا (ID: `person:Azariah.19`); شَبْتَاي (ID: `person:Shabbethai.2`); يوزَابَاد (ID: `person:Jozabad.9`); عَقّوب (ID: `person:Akkub.4`); Perceive (ID: `keyterm:Perceive`); Instruction (ID: `keyterm:Instruction`); فَلَايَا (ID: `person:Pelaiah`); حَانَان (ID: `person:Hanan.5`); قَلِيطَا (ID: `person:Kelita.2`); شَرَبْيَا (ID: `person:Sherebiah`); نَحَمْيَا (ID: `person:Nehemiah.2`); هودِيَّا (ID: `person:Hodiah.2`); بَانِيَ (ID: `person:Bani.8`)
...
* **Associated ACAI Concepts:** نَحَمْيَا (ID: `person:Nehemiah.2`)
...
* **Associated ACAI Concepts:** أَفْرَايِمَ (ID: `place:EphraimGate`); ٱلْمَاءِ (ID: `place:WaterGate`)
...
* **Associated ACAI Concepts:** فَتَحْيَا (ID: `person:Pethahiah.3`); حَشَبْنِيَا (ID: `person:Hashabneiah.2`); شَبَنْيَا (ID: `person:Shebaniah.2`); هودِيَّا (ID: `person:Hodiah.2`); بَانِيَ (ID: `person:Bani.8`)
...
* **Associated ACAI Concepts:** فَتَحْيَا (ID: `person:Pethahiah.3`); حَشَبْنِيَا (ID: `person:Hashabneiah.2`); شَبَنْيَا (ID: `person:Shebaniah.2`); هودِيَّا (ID: `person:Hodiah.2`); بَانِيَ (ID: `person:Bani.8`); Girgashites (ID: `group:Girgashites`); Dispossess (ID: `keyterm:Dispossess`); Instruction (ID: `keyterm:Instruction`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** مَشلَّام (ID: `person:Meshullam.16`); مَلْكِيَّا (ID: `person:Malchijah.10`); Ahiah (ID: `person:Ahiah`); بِغْوَايَ (ID: `person:Bigvai.3`); أَدونِيَّا (ID: `person:Adonijah.3`); فَرْعوشَ (ID: `person:Parosh.4`); هودِيَّا (ID: `person:Hodiah.4`); Shobek (ID: `person:Shobek`); عِيلَامَ (ID: `person:Elam.5`); بَابَايَ (ID: `person:Bebai.3`); Beninu (ID: `person:Beninu`); بونِّي (ID: `person:Bunni.2`); حَشوم (ID: `person:Hashum.3`); هوشَعَ (ID: `person:Hoshea.3`); لِهَفْصِيصَ (ID: `person:Hezir.2`); بَعْنَةَ (ID: `person:Baanah.4`); Azaniah (ID: `person:Azaniah`); Hashabnah (ID: `person:Hashabnah`); حَانَان (ID: `person:Hanan.6`); حَشّوب (ID: `person:Hasshub.4`); Pahath-moab (ID: `person:Pahath-moab.3`); بِيصَايَ (ID: `person:Bezai.2`); بَاروخَ (ID: `person:Baruch.2`); مِيخَا (ID: `person:Mica.2`); يَدّوعَ (ID: `person:Jaddua`); عَنَاثوثَ (ID: `person:Anathoth.2`); حَنَنِيَّا (ID: `person:Hananiah.9`); شَبَنْيَا (ID: `person:Shebaniah.4`); صِدْقِيَّا (ID: `person:Zedekiah.5`); حَارِيفَ (ID: `person:Hariph`); زَكّور (ID: `person:Zaccur.7`); حَزَقِيَّا (ID: `person:Hezekiah.3`); Magpiash (ID: `person:Magpiash`); حَارِيمَ (ID: `person:Harim.4`); فَشْحور (ID: `person:Pashhur.2`); عَزورَ (ID: `person:Azzur`); رَحوم (ID: `person:Rehum.4`); Pilha (ID: `person:Pilha`); صَادوق (ID: `person:Zadok.7`); عَادِينَ (ID: `person:Adin.2`); بَانِيَ (ID: `person:Bani.9`); مَشِيزَبْئِيلَ (ID: `person:Meshezabel.2`); عَنَايَا (ID: `person:Anaiah.2`); رَحوبَ (ID: `person:Rehob.2`); مَعْسِيَّا (ID: `person:Maaseiah.13`); آطِيرَ (ID: `person:Ater.3`); هودِيَّا (ID: `person:Hodiah.3`); زَتّو (ID: `person:Zattu`); فَلَطْيَا (ID: `person:Pelatiah.3`); مَلّوخ (ID: `person:Malluch.5`); عَرْجَدَ (ID: `person:Azgad.2`); عوبَدْيَا (ID: `person:Obadiah.11`); Nebai (ID: `person:Nebai`); Anan (ID: `person:Anan`); حَانَان (ID: `person:Hanan.7`); فَلَايَا (ID: `person:Pelaiah`); دَانِيآل (ID: `person:Daniel.2`); حَكَلْيَا (ID: `person:Hacaliah`); قَلِيطَا (ID: `person:Kelita.2`); هَلّوحِيشَ (ID: `person:Hallohesh`); بَانِيَ (ID: `person:Bani.11`); حِينَادَادَ (ID: `person:Henadad`); حَطّوش (ID: `person:Hattush.4`); حَانَان (ID: `person:Hanan.5`); مَشلَّام (ID: `person:Meshullam.15`); شَبَنْيَا (ID: `person:Shebaniah.3`); مَلّوخ (ID: `person:Malluch.4`); شَرَبْيَا (ID: `person:Sherebiah.2`); مِيَّامِين (ID: `person:Mijamin.3`); لِمَعَزْيَا (ID: `person:Maaziah.2`); أَبِيَّا (ID: `person:Abijah.7`); أَمَرْيَا (ID: `person:Amariah.7`); شَبَنْيَا (ID: `person:Shebaniah.2`); عَزَرْيَا (ID: `person:Azariah.18`); بَلْجَة (ID: `person:Bilgah.2`); جِنْتوي (ID: `person:Ginnethon`); إِرْمِيَا (ID: `person:Jeremiah.7`); سَرَايَا (ID: `person:Seraiah.6`); شِمْعِيَا (ID: `person:Shemaiah.20`); رَحوم (ID: `person:Rehum`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); House (ID: `realia:House`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** مَشلَّام (ID: `person:Meshullam.16`); مَلْكِيَّا (ID: `person:Malchijah.10`); Ahiah (ID: `person:Ahiah`); بِغْوَايَ (ID: `person:Bigvai.3`); أَدونِيَّا (ID: `person:Adonijah.3`); فَرْعوشَ (ID: `person:Parosh.4`); هودِيَّا (ID: `person:Hodiah.4`); Shobek (ID: `person:Shobek`); عِيلَامَ (ID: `person:Elam.5`); بَابَايَ (ID: `person:Bebai.3`); Beninu (ID: `person:Beninu`); بونِّي (ID: `person:Bunni.2`); حَشوم (ID: `person:Hashum.3`); هوشَعَ (ID: `person:Hoshea.3`); لِهَفْصِيصَ (ID: `person:Hezir.2`); بَعْنَةَ (ID: `person:Baanah.4`); Azaniah (ID: `person:Azaniah`); Hashabnah (ID: `person:Hashabnah`); حَانَان (ID: `person:Hanan.6`); حَشّوب (ID: `person:Hasshub.4`); Pahath-moab (ID: `person:Pahath-moab.3`); بِيصَايَ (ID: `person:Bezai.2`); بَاروخَ (ID: `person:Baruch.2`); مِيخَا (ID: `person:Mica.2`); يَدّوعَ (ID: `person:Jaddua`); عَنَاثوثَ (ID: `person:Anathoth.2`); حَنَنِيَّا (ID: `person:Hananiah.9`); شَبَنْيَا (ID: `person:Shebaniah.4`); صِدْقِيَّا (ID: `person:Zedekiah.5`); حَارِيفَ (ID: `person:Hariph`); زَكّور (ID: `person:Zaccur.7`); حَزَقِيَّا (ID: `person:Hezekiah.3`); Magpiash (ID: `person:Magpiash`); حَارِيمَ (ID: `person:Harim.4`); فَشْحور (ID: `person:Pashhur.2`); عَزورَ (ID: `person:Azzur`); رَحوم (ID: `person:Rehum.4`); صَادوق (ID: `person:Zadok.7`); Pilha (ID: `person:Pilha`); بَانِيَ (ID: `person:Bani.9`); عَادِينَ (ID: `person:Adin.2`); مَشِيزَبْئِيلَ (ID: `person:Meshezabel.2`); عَنَايَا (ID: `person:Anaiah.2`); رَحوبَ (ID: `person:Rehob.2`); مَعْسِيَّا (ID: `person:Maaseiah.13`); آطِيرَ (ID: `person:Ater.3`); هودِيَّا (ID: `person:Hodiah.3`); زَتّو (ID: `person:Zattu`); فَلَطْيَا (ID: `person:Pelatiah.3`); مَلّوخ (ID: `person:Malluch.5`); عَرْجَدَ (ID: `person:Azgad.2`); عوبَدْيَا (ID: `person:Obadiah.11`); Nebai (ID: `person:Nebai`); Anan (ID: `person:Anan`); حَانَان (ID: `person:Hanan.7`); فَلَايَا (ID: `person:Pelaiah`); دَانِيآل (ID: `person:Daniel.2`); حَكَلْيَا (ID: `person:Hacaliah`); قَلِيطَا (ID: `person:Kelita.2`); هَلّوحِيشَ (ID: `person:Hallohesh`); بَانِيَ (ID: `person:Bani.11`); حِينَادَادَ (ID: `person:Henadad`); حَطّوش (ID: `person:Hattush.4`); حَانَان (ID: `person:Hanan.5`); مَشلَّام (ID: `person:Meshullam.15`); شَبَنْيَا (ID: `person:Shebaniah.3`); مَلّوخ (ID: `person:Malluch.4`); شَرَبْيَا (ID: `person:Sherebiah.2`); مِيَّامِين (ID: `person:Mijamin.3`); لِمَعَزْيَا (ID: `person:Maaziah.2`); أَبِيَّا (ID: `person:Abijah.7`); أَمَرْيَا (ID: `person:Amariah.7`); شَبَنْيَا (ID: `person:Shebaniah.2`); عَزَرْيَا (ID: `person:Azariah.18`); بَلْجَة (ID: `person:Bilgah.2`); جِنْتوي (ID: `person:Ginnethon`); إِرْمِيَا (ID: `person:Jeremiah.7`); سَرَايَا (ID: `person:Seraiah.6`); شِمْعِيَا (ID: `person:Shemaiah.20`); رَحوم (ID: `person:Rehum`)
...
* **Associated ACAI Concepts:** يوزَابَاد (ID: `person:Jozabad.10`); دِيبونَ (ID: `place:Dibon.2`); يويَارِيبَ (ID: `person:Joiarib.3`); مَشِيزَبْئِيلَ (ID: `person:Meshezabel.3`); عزِّيَّا (ID: `person:Uzziah.5`); صَبوعِيمَ (ID: `place:Zeboim`); زَبْدِيئِيل (ID: `person:Zabdiel.2`); زَكَرِيَّا (ID: `person:Zechariah.24`); سَلّو (ID: `person:Sallu.3`); فَتَحْيَا (ID: `person:Pethahiah.4`); مَشلَّام (ID: `person:Meshullam.17`); جِشْفَا (ID: `person:Gishpa`); زَكَرِيَّا (ID: `person:Zechariah.23`); يِشْعِيَا (ID: `person:Jeshaiah.6`); Col-hozeh (ID: `person:Col-hozeh.2`); عزِّي (ID: `person:Uzzi.5`); قولَايَا (ID: `person:Kolaiah`); زَكَرِيَّا (ID: `person:Zechariah.25`); نَبَلَّاَطَ (ID: `place:Neballat`); Haggedolim (ID: `person:Haggedolim`); يوعِيدَ (ID: `person:Joed`); عَثَايَا (ID: `person:Athaiah`); زِكْرِي (ID: `person:Zichri.11`); يوئِيل (ID: `person:Joel.13`); مَكونَةَ (ID: `place:Meconah`); يَهوذَا (ID: `person:Judah.6`); بَاروخَ (ID: `person:Baruch.3`); فَدَايَا (ID: `person:Pedaiah.6`); حَزَايَا (ID: `person:Hazaiah`); شَفَطْيَا (ID: `person:Shephatiah.8`); عَنَنْيَا (ID: `place:Ananiah`); أَمَرْيَا (ID: `person:Amariah.8`); حَاصورَ (ID: `place:Hazor.4`); فَلَلْيَا (ID: `person:Pelaliah`); Shiloni (ID: `group:Shiloni`); بونِّي (ID: `person:Bunni.3`); صِيحَا (ID: `person:Ziha.2`); عَدَايَا (ID: `person:Adaiah.7`); مَعْسِيَّا (ID: `person:Maaseiah.14`); إِيثِيئِيلَ (ID: `person:Ithiel`); شَبْتَاي (ID: `person:Shabbethai.3`); مَعْسِيَّا (ID: `person:Maaseiah.15`); مَهْلَلْئِيلَ (ID: `person:Mahalalel.2`); لِسَلَّايَ (ID: `person:Sallai`); أَمْصِي (ID: `person:Amzi.2`); جَبَّاي (ID: `person:Gabbai`); بَانِيَ (ID: `person:Bani.10`); حَشَبْيَا (ID: `person:Hashabiah.9`); يَشوعَ (ID: `place:Jeshua`); يَروحَامَ (ID: `person:Jeroham.4`); مِيخَا (ID: `person:Mica.3`); حَشّوب (ID: `person:Hasshub`); يَدوثونَ (ID: `person:Jeduthun.2`); Meshillemith (ID: `person:Meshillemith`); عَدَايَا (ID: `person:Adaiah.3`); عَدِيئِيلَ (ID: `person:Adiel.2`); زِكْرِي (ID: `person:Zichri.5`); Ge-harashim (ID: `place:Ge-harashim`); Beth-pelet (ID: `place:Beth-pelet`); مَعْسَاي (ID: `person:Maasai`); إِلَى (ID: `place:Gittaim`); شِمْعِيَا (ID: `person:Shemaiah.6`); آسَاف (ID: `person:Asaph.3`); مِيخَا (ID: `person:Mica`); مَتَّنْيَا (ID: `person:Mattaniah.9`); شِمْعِيَا (ID: `person:Shemaiah.5`); يَاكِين (ID: `person:Jachin.2`); حَشَبْيَا (ID: `person:Hashabiah.2`); جَلَالَ (ID: `person:Galal.2`); لِإِيمِيرَ (ID: `person:Immer`); عَزْرِيقَام (ID: `person:Azrikam.3`); مَلْكِيَّا (ID: `person:Malchijah.2`); مَشلَّام (ID: `person:Meshullam.7`); هَسْنوآةَ (ID: `person:Hassenuah`); عوبَدْيَا (ID: `person:Obadiah.5`); حَادِيدَ (ID: `place:Hadid`); بَقْبقْيَا (ID: `person:Bakbukiah`); صَادوق (ID: `person:Zadok.4`); يويَارِيبَ (ID: `person:Joiarib`); زَانوح (ID: `place:Zanoah`); مَتَّنْيَا (ID: `person:Mattaniah`); يَدَايَا (ID: `person:Jedaiah.3`); فَشْحور (ID: `person:Pashhur`); شَلّوم (ID: `person:Shallum.7`); سَرَايَا (ID: `person:Seraiah.2`); طَلْمون (ID: `person:Talmon`); وَلودَ (ID: `place:Lod`); عَزِيقَةَ (ID: `place:Azekah`); عَايٍ (ID: `place:Ai`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** عَثَايَا (ID: `person:Athaiah`); شَفَطْيَا (ID: `person:Shephatiah.8`); عزِّيَّا (ID: `person:Uzziah.5`); مَهْلَلْئِيلَ (ID: `person:Mahalalel.2`); زَكَرِيَّا (ID: `person:Zechariah.23`); أَمَرْيَا (ID: `person:Amariah.8`)
...
* **Associated ACAI Concepts:** شَبْتَاي (ID: `person:Shabbethai.3`); يوزَابَاد (ID: `person:Jozabad.10`)
...
* **Associated ACAI Concepts:** شِمْعِيَا (ID: `person:Shemaiah.6`); جَلَالَ (ID: `person:Galal.2`); آسَاف (ID: `person:Asaph.3`); مِيخَا (ID: `person:Mica`); يَدوثونَ (ID: `person:Jeduthun.2`); زِكْرِي (ID: `person:Zichri.5`); بَقْبقْيَا (ID: `person:Bakbukiah`); عوبَدْيَا (ID: `person:Obadiah.5`); مَتَّنْيَا (ID: `person:Mattaniah`)
...
* **Associated ACAI Concepts:** صِيحَا (ID: `person:Ziha.2`); جِشْفَا (ID: `person:Gishpa`)
...
* **Associated ACAI Concepts:** مَشِيزَبْئِيلَ (ID: `person:Meshezabel.3`); فَتَحْيَا (ID: `person:Pethahiah.4`)
...
* **Associated ACAI Concepts:** زَانوح (ID: `place:Zanoah`); عَزِيقَةَ (ID: `place:Azekah`)
...
* **Associated ACAI Concepts:** عنِّي (ID: `person:Unni.2`); سَلّو (ID: `person:Sallu`); يَدَايَا (ID: `person:Jedaiah.5`); حَطّوش (ID: `person:Hattush.4`); يَدّو (ID: `person:Iddo.7`); حِلْقِيَّا (ID: `person:Hilkiah.6`); عَاموق (ID: `person:Amok`); يَهوذَا (ID: `person:Judah.7`); أَبِيَّا (ID: `person:Abijah.7`); شَبَنْيَا (ID: `person:Shebaniah.3`); شَرَبْيَا (ID: `person:Sherebiah.2`); عَزْرَا (ID: `person:Ezra.2`); أَمَرْيَا (ID: `person:Amariah.7`); بَقْبقْيَا (ID: `person:Bakbukiah`); مَلّوخ (ID: `person:Malluch.4`); مِيَّامِين (ID: `person:Mijamin.3`); جِنْتوي (ID: `person:Ginnethon`); لِمَعَزْيَا (ID: `person:Maaziah.2`); بَلْجَة (ID: `person:Bilgah.2`); مَتَّنْيَا (ID: `person:Mattaniah`); يَدَايَا (ID: `person:Jedaiah.3`); يويَارِيبَ (ID: `person:Joiarib`); إِرْمِيَا (ID: `person:Jeremiah.7`); شِمْعِيَا (ID: `person:Shemaiah.20`); سَرَايَا (ID: `person:Seraiah.6`); هودِيَّا (ID: `person:Hodiah.2`); بَانِيَ (ID: `person:Bani.8`); مَرِيموث (ID: `person:Meremoth`); يَشوعَ (ID: `person:Jeshua.4`)
...
* **Associated ACAI Concepts:** يوحَانَانَ (ID: `person:Johanan.9`); يويَاقِيمَ (ID: `person:Joiakim`); يويَادَاعَ (ID: `person:Joiada.2`); أَلْيَاشِيب (ID: `person:Eliashib.8`); سَلّو (ID: `person:Sallu`); يَدَايَا (ID: `person:Jedaiah.5`); يَدّو (ID: `person:Iddo.7`); حِلْقِيَّا (ID: `person:Hilkiah.6`); يَدّوعَ (ID: `person:Jaddua.2`); عَاموق (ID: `person:Amok`); دَارِيوسَ (ID: `person:Darius`); عَدْنَا (ID: `person:Adna.2`); عَابِر (ID: `person:Eber.5`); عزِّي (ID: `person:Uzzi.6`); حَشَبْيَا (ID: `person:Hashabiah.10`); مَرَايَا (ID: `person:Meraiah`); حَلْقَاي (ID: `person:Helkai`); مَشلَّام (ID: `person:Meshullam.18`); عنِّي (ID: `person:Unni.2`); زَكَرِيَّا (ID: `person:Zechariah.26`); مَشلَّام (ID: `person:Meshullam.20`); يوسف (ID: `person:Joseph.14`); زِكْرِي (ID: `person:Zichri.12`); يَهونَاثَان (ID: `person:Jehohanan.7`); نَثَنْئِيل (ID: `person:Nethanel.9`); مَتَّنَاي (ID: `person:Mattenai.3`); مَشلَّام (ID: `person:Meshullam.19`); يَشوعَ (ID: `person:Jeshua.7`); قَلَّاي (ID: `person:Kallai`); فِلْطَاي (ID: `person:Piltai`); يَهونَاثَان (ID: `person:Jehonathan.2`); شَمّوع (ID: `person:Shammua.3`); حَنَنِيَّا (ID: `person:Hananiah.10`); يونَاثَانَ (ID: `person:Jonathan.11`); أَبِيَّا (ID: `person:Abijah.7`); شَبَنْيَا (ID: `person:Shebaniah.3`); شَرَبْيَا (ID: `person:Sherebiah.2`); عَزْرَا (ID: `person:Ezra.2`); أَمَرْيَا (ID: `person:Amariah.7`); بَقْبقْيَا (ID: `person:Bakbukiah`); مَلّوخ (ID: `person:Malluch.4`); مِيَّامِين (ID: `person:Mijamin.3`); جِنْتوي (ID: `person:Ginnethon`); لِمَعَزْيَا (ID: `person:Maaziah.2`); بَلْجَة (ID: `person:Bilgah.2`); مَتَّنْيَا (ID: `person:Mattaniah`); يَدَايَا (ID: `person:Jedaiah.3`); يويَارِيبَ (ID: `person:Joiarib`); إِرْمِيَا (ID: `person:Jeremiah.7`); شِمْعِيَا (ID: `person:Shemaiah.20`); سَرَايَا (ID: `person:Seraiah.6`); مَرِيموث (ID: `person:Meremoth`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); حَطّوش (ID: `person:Hattush.4`); يَهوذَا (ID: `person:Judah.7`); عوبَدْيَا (ID: `person:Obadiah.5`); حَشَبْيَا (ID: `person:Hashabiah.7`); نَحَمْيَا (ID: `person:Nehemiah.2`); هودِيَّا (ID: `person:Hodiah.2`); عَقّوب (ID: `person:Akkub.2`); بَانِيَ (ID: `person:Bani.8`); Persians (ID: `group:Persia`); يَشوعَ (ID: `person:Jeshua.4`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** سَلّو (ID: `person:Sallu`); عَاموق (ID: `person:Amok`); يَدَايَا (ID: `person:Jedaiah.5`); حِلْقِيَّا (ID: `person:Hilkiah.6`)
...
* **Associated ACAI Concepts:** عنِّي (ID: `person:Unni.2`); يَهوذَا (ID: `person:Judah.7`); بَقْبقْيَا (ID: `person:Bakbukiah`); شَرَبْيَا (ID: `person:Sherebiah.2`); مَتَّنْيَا (ID: `person:Mattaniah`); هودِيَّا (ID: `person:Hodiah.2`); بَانِيَ (ID: `person:Bani.8`); يَشوعَ (ID: `person:Jeshua.4`)
...
* **Associated ACAI Concepts:** يويَادَاعَ (ID: `person:Joiada.2`); يَدّوعَ (ID: `person:Jaddua.2`); يوحَانَانَ (ID: `person:Johanan.9`); يويَاقِيمَ (ID: `person:Joiakim`); أَلْيَاشِيب (ID: `person:Eliashib.8`)
...
* **Associated ACAI Concepts:** عزِّي (ID: `person:Uzzi.6`); يوسف (ID: `person:Joseph.14`); عَدْنَا (ID: `person:Adna.2`); عَابِر (ID: `person:Eber.5`); حَشَبْيَا (ID: `person:Hashabiah.10`); مَرَايَا (ID: `person:Meraiah`); زَكَرِيَّا (ID: `person:Zechariah.26`); حَلْقَاي (ID: `person:Helkai`); مَشلَّام (ID: `person:Meshullam.18`); زِكْرِي (ID: `person:Zichri.12`); يَهونَاثَان (ID: `person:Jehohanan.7`); نَثَنْئِيل (ID: `person:Nethanel.9`); مَتَّنَاي (ID: `person:Mattenai.3`); مَشلَّام (ID: `person:Meshullam.19`); يَهونَاثَان (ID: `person:Jehonathan.2`); شَمّوع (ID: `person:Shammua.3`); قَلَّاي (ID: `person:Kallai`); فِلْطَاي (ID: `person:Piltai`); حَنَنِيَّا (ID: `person:Hananiah.10`); يونَاثَانَ (ID: `person:Jonathan.11`); سَلّو (ID: `person:Sallu`); يَدَايَا (ID: `person:Jedaiah.5`); يَدّو (ID: `person:Iddo.7`); حِلْقِيَّا (ID: `person:Hilkiah.6`); عَاموق (ID: `person:Amok`); أَبِيَّا (ID: `person:Abijah.7`); شَبَنْيَا (ID: `person:Shebaniah.3`); عَزْرَا (ID: `person:Ezra.2`); أَمَرْيَا (ID: `person:Amariah.7`); يويَاقِيمَ (ID: `person:Joiakim`); مَلّوخ (ID: `person:Malluch.4`); مِيَّامِين (ID: `person:Mijamin.3`); جِنْتوي (ID: `person:Ginnethon`); لِمَعَزْيَا (ID: `person:Maaziah.2`); بَلْجَة (ID: `person:Bilgah.2`); إِرْمِيَا (ID: `person:Jeremiah.7`); شِمْعِيَا (ID: `person:Shemaiah.20`); سَرَايَا (ID: `person:Seraiah.6`)
...
* **Associated ACAI Concepts:** أَلِعَازَار (ID: `person:Eleazar.8`); عَزَرْئِيل (ID: `person:Azarel.5`); شِمْعِيَا (ID: `person:Shemaiah.22`); عزِّي (ID: `person:Uzzi.7`); مَعْسِيَّا (ID: `person:Maaseiah.16`); مِيخَا (ID: `person:Micaiah.4`); أَلِيَاقِيم (ID: `person:Eliakim.4`); أَلِيوعِينَاي (ID: `person:Elioenai.6`); زَكَرِيَّا (ID: `person:Zechariah.27`); مَنْيَامِين (ID: `person:Miniamin.3`); يِزْرَحْيَا (ID: `person:Jezrahiah`); جِلَلَاي (ID: `person:Gilalai`); هوشَعْيَا (ID: `person:Hoshaiah`); يونَاثَانَ (ID: `person:Jonathan.12`); شِمْعِيَا (ID: `person:Shemaiah.21`); عِيلَامَ (ID: `person:Elam.6`); نَثَنْئِيل (ID: `person:Nethanel.10`); عَازَر (ID: `person:Ezer.6`); يَهونَاثَان (ID: `person:Jehohanan.8`); زَكَرِيَّا (ID: `person:Zechariah.28`); مَعْسِيَّا (ID: `person:Maaseiah.17`); بَنْيَامِينَ (ID: `person:Benjamin.5`); حَنَانِي (ID: `person:Hanani.5`); مَاعَاي (ID: `person:Maai`); ٱلسِّجْنِ (ID: `place:GuardGate`); شِمْعِيَا (ID: `person:Shemaiah.23`); يَهوذَا (ID: `person:Judah.8`); حَنَنِيَّا (ID: `person:Hananiah.11`); مِلَلَاي (ID: `person:Milalai`); مَلْكِيَّا (ID: `person:Malchijah.11`); مِيخَا (ID: `person:Mica.3`); ٱلسّورِ (ID: `place:BroadWall`); برْجِ (ID: `place:TowerOfTheHundred`); Gate of Jeshanah (ID: `place:YeshanahGate`); مَتَّنْيَا (ID: `person:Mattaniah.9`); برْجَ (ID: `place:TowerOfTheOvens`); مَشلَّام (ID: `person:Meshullam.15`); يَهوذَا (ID: `person:Judah.7`); زَكّور (ID: `person:Zaccur.4`); عَزْرَا (ID: `person:Ezra.2`); عَزَرْيَا (ID: `person:Azariah.18`); Beth-azmaveth (ID: `place:Beth-azmaveth`); ٱلْعَيْنِ (ID: `place:FountainGate`); ٱلضَّأْنِ (ID: `place:SheepGate`); ٱلدِّمْنِ (ID: `place:DungGate`); باب ٱلسَّمَكِ (ID: `place:FishGate`); أَفْرَايِمَ (ID: `place:EphraimGate`); ٱلْمَاءِ (ID: `place:WaterGate`)
...
* **Associated ACAI Concepts:** عَزَرْئِيل (ID: `person:Azarel.5`); شِمْعِيَا (ID: `person:Shemaiah.22`); جِلَلَاي (ID: `person:Gilalai`); هوشَعْيَا (ID: `person:Hoshaiah`); يونَاثَانَ (ID: `person:Jonathan.12`); شِمْعِيَا (ID: `person:Shemaiah.21`); نَثَنْئِيل (ID: `person:Nethanel.10`); زَكَرِيَّا (ID: `person:Zechariah.28`); بَنْيَامِينَ (ID: `person:Benjamin.5`); حَنَانِي (ID: `person:Hanani.5`); مَاعَاي (ID: `person:Maai`); يَهوذَا (ID: `person:Judah.8`); مِلَلَاي (ID: `person:Milalai`); مِيخَا (ID: `person:Mica.3`); مَتَّنْيَا (ID: `person:Mattaniah.9`); مَشلَّام (ID: `person:Meshullam.15`); يَهوذَا (ID: `person:Judah.7`); زَكّور (ID: `person:Zaccur.4`); عَزْرَا (ID: `person:Ezra.2`); عَزَرْيَا (ID: `person:Azariah.18`); ٱلْعَيْنِ (ID: `place:FountainGate`); ٱلدِّمْنِ (ID: `place:DungGate`); ٱلْمَاءِ (ID: `place:WaterGate`)
...
* **Associated ACAI Concepts:** يونَاثَانَ (ID: `person:Jonathan.12`); شِمْعِيَا (ID: `person:Shemaiah.21`); زَكَرِيَّا (ID: `person:Zechariah.28`); مَتَّنْيَا (ID: `person:Mattaniah.9`); مِيخَا (ID: `person:Mica.3`); زَكّور (ID: `person:Zaccur.4`)
...
* **Associated ACAI Concepts:** ٱلسِّجْنِ (ID: `place:GuardGate`); برْجَ (ID: `place:TowerOfTheOvens`); Gate of Jeshanah (ID: `place:YeshanahGate`); ٱلسّورِ (ID: `place:BroadWall`); برْجِ (ID: `place:TowerOfTheHundred`); باب ٱلسَّمَكِ (ID: `place:FishGate`); أَفْرَايِمَ (ID: `place:EphraimGate`); ٱلضَّأْنِ (ID: `place:SheepGate`)
...
* **Associated ACAI Concepts:** أَلْيَاشِيب (ID: `person:Eliashib.9`)
...
* **Associated ACAI Concepts:** أَلْيَاشِيب (ID: `person:Eliashib.9`); مَتَّنْيَا (ID: `person:Mattaniah.10`); صَادوق (ID: `person:Zadok.8`); زَكّور (ID: `person:Zaccur.8`); حَانَان (ID: `person:Hanan.8`); فَدَايَا (ID: `person:Pedaiah.7`); شَلَمْيَا (ID: `person:Shelemiah.5`); House (ID: `realia:House`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** مَتَّنْيَا (ID: `person:Mattaniah.10`); صَادوق (ID: `person:Zadok.8`); زَكّور (ID: `person:Zaccur.8`); شَلَمْيَا (ID: `person:Shelemiah.5`); حَانَان (ID: `person:Hanan.8`); فَدَايَا (ID: `person:Pedaiah.7`)
...
* **Associated ACAI Concepts:** Horonites (ID: `group:Horonites`); يويَادَاعَ (ID: `person:Joiada.2`); أَلْيَاشِيب (ID: `person:Eliashib.8`); Sabbath (ID: `keyterm:Sabbath`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Horonites (ID: `group:Horonites`); يويَادَاعَ (ID: `person:Joiada.2`); أَلْيَاشِيب (ID: `person:Eliashib.8`)
