...
* **Associated ACAI Concepts:** Ephrathites (ID: `group:Ephrathah`); Efrata (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Mahlon (ID: `person:Chilion`); Elimelekh (ID: `person:Elimelech`); Yehuda (ID: `person:Judah.4`); Mahlon (ID: `person:Mahlon`); Betlehem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Yehuda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** menugaskan (ID: `keyterm:Appoint`); Tuhan (ID: `deity:Lord`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); Tuhan (ID: `deity:Lord`); kebaikan (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); Tuhan (ID: `deity:Lord`); memberkati (ID: `keyterm:Bless`); kebaikan (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); Elimelekh (ID: `person:Elimelech`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Rut (ID: `person:Ruth`); Boas (ID: `person:Boaz`); menyebabkan memiliki (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Betlehem (ID: `place:Bethlehem`); Rahel (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); Tuhan (ID: `deity:Lord`); Lea (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Yehuda (ID: `person:Judah.4`); Tamar (ID: `person:Tamar`); Tuhan (ID: `deity:Lord`); Yehuda (ID: `group:Judah`); Peres (ID: `person:Perez`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Boas (ID: `person:Boaz`); Rut (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Israel (ID: `person:Israel`); Tuhan (ID: `deity:Lord`); memberkati (ID: `keyterm:Bless`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** memperanakkan (ID: `person:Salmon`); Hezron (ID: `person:Hezron.2`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Boas (ID: `person:Boaz`); Daud (ID: `person:David`); Isai (ID: `person:Jesse`); Peres (ID: `person:Perez`); Nahason (ID: `person:Nahshon`)
