...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Jerusalém (ID: `place:Jerusalem`); Quedar (ID: `person:Kedar`); Goat Hair Strips (ID: `realia:GoatHairStrips`); Vine (ID: `flora:Vine`); Linen Strips (ID: `realia:LinenStrips`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Gazelle (ID: `fauna:Gazelle`); Deer (ID: `fauna:Deer`); Dove (ID: `fauna:Dove`); Beter (ID: `place:BetherMountain`); Fig (ID: `flora:Fig`); Window (ID: `realia:Window`); Lily (ID: `flora:Lily`); Jackal (ID: `fauna:Jackal`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Jerusalém (ID: `place:Jerusalem`); love (ID: `keyterm:Love`); Libano (ID: `place:Lebanon`); Israel (ID: `person:Israel`); Bier (ID: `realia:Bier`); Myrrh (ID: `flora:Myrrh`); Money (ID: `realia:Money`); Frankincense (ID: `flora:Frankincense`); Purple Cloth (ID: `realia:PurpleCloth`); Sword (ID: `realia:Sword`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Balsam Tree (ID: `flora:BalsamTree`); Libano (ID: `place:Lebanon`); Myrrh (ID: `flora:Myrrh`); Pomegranate (ID: `flora:Pomegranate`); Wine (ID: `realia:Wine`); Frankincense (ID: `flora:Frankincense`); Nard (ID: `flora:Nard`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Veil (ID: `realia:Veil`); Vine (ID: `flora:Vine`); Monte Hermom (ID: `place:HermonMount`); Monte Amana (ID: `place:Amana`); Davi (ID: `person:David`); Gileade (ID: `place:Gilead`); Calamus (ID: `flora:Calamus`); Saffron Plant (ID: `flora:SaffronPlant`); Henna (ID: `flora:Henna`); Lion (ID: `fauna:Lion`); Gazelle (ID: `fauna:Gazelle`); Dove (ID: `fauna:Dove`); Anointing Oil (ID: `realia:AnointingOil`); Small Shield (ID: `realia:SmallShield`); Thread (ID: `realia:Thread`); Lily (ID: `flora:Lily`); Olive Oil (ID: `realia:OliveOil`); Tower (ID: `realia:Tower`); Cinnamon (ID: `flora:Cinnamon`); Cloak (ID: `realia:Cloak`); Agarwood (ID: `flora:Agarwood`); Leopard (ID: `fauna:Leopard`)
...
* **Associated ACAI Concepts:** Libano (ID: `place:Lebanon`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Balsam Tree (ID: `flora:BalsamTree`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Lily (ID: `flora:Lily`); swear (ID: `keyterm:Swear`); Jerusalém (ID: `place:Jerusalem`); Myrrh (ID: `flora:Myrrh`); Balsam Tree (ID: `flora:BalsamTree`); Dove (ID: `fauna:Dove`); love (ID: `keyterm:Love`); Libano (ID: `place:Lebanon`); Crow (ID: `fauna:Crow`); Tunic (ID: `realia:Tunic.2`); Veil (ID: `realia:Veil`); Cedar (ID: `flora:Cedar`)
...
* **Associated ACAI Concepts:** Libano (ID: `place:Lebanon`); Jerusalém (ID: `place:Jerusalem`); Crow (ID: `fauna:Crow`); Myrrh (ID: `flora:Myrrh`); Balsam Tree (ID: `flora:BalsamTree`); Lily (ID: `flora:Lily`); Cedar (ID: `flora:Cedar`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Libano (ID: `place:Lebanon`); Crow (ID: `fauna:Crow`); Myrrh (ID: `flora:Myrrh`); Balsam Tree (ID: `flora:BalsamTree`); Lily (ID: `flora:Lily`); Cedar (ID: `flora:Cedar`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Standard (ID: `realia:Standard`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Jerusalém (ID: `place:Jerusalem`); Tirza (ID: `place:Tirzah`); Gileade (ID: `place:Gilead`); Sheep (ID: `fauna:Lamb`); Veil (ID: `realia:Veil`); Pomegranate (ID: `flora:Pomegranate`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Date Palm (ID: `flora:DatePalm`); Wine (ID: `realia:Wine`); Shulammites (ID: `group:Shulammites`); Bate-Rabim (ID: `place:Bath-rabbim`); fairness (ID: `keyterm:Fairness`); Hesbom (ID: `place:Heshbon`); love (ID: `keyterm:Love`); Damasco (ID: `place:Damascus`); Libano (ID: `place:Lebanon`); Carmelo (ID: `place:Carmel`); Gazelle (ID: `fauna:Gazelle`); Apple (ID: `flora:AppleTree`); Lily (ID: `flora:Lily`); Purple Cloth (ID: `realia:PurpleCloth`); Wheat (ID: `flora:Wheat`); Tower (ID: `realia:Tower`)
...
* **Associated ACAI Concepts:** Bate-Rabim (ID: `place:Bath-rabbim`); Hesbom (ID: `place:Heshbon`); Damasco (ID: `place:Damascus`); Libano (ID: `place:Lebanon`); Carmelo (ID: `place:Carmel`); Gazelle (ID: `fauna:Gazelle`); Wine (ID: `realia:Wine`); Lily (ID: `flora:Lily`); Purple Cloth (ID: `realia:PurpleCloth`); Wheat (ID: `flora:Wheat`); Tower (ID: `realia:Tower`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); swear (ID: `keyterm:Swear`); Jerusalém (ID: `place:Jerusalem`); Must (ID: `realia:Must`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Pomegranate (ID: `flora:Pomegranate`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Vine (ID: `flora:Vine`); Monte Hermom (ID: `place:HermonMount`); Gazelle (ID: `fauna:Gazelle`); Deer (ID: `fauna:Deer`); Money (ID: `realia:Money`); Balsam Tree (ID: `flora:BalsamTree`)
