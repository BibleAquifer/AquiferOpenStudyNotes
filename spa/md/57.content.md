...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Apphia (ID: `person:Apphia`); Archîpo (ID: `person:Archippus`); Filemón (ID: `person:Philemon`); Pablo (ID: `person:Paul`); hacer la paz (ID: `keyterm:Peace`); amado (ID: `keyterm:Beloved`); favor (ID: `keyterm:Favor`); Timoteo (ID: `person:Timothy`); Jehová (ID: `deity:Lord`); iglesia (ID: `keyterm:Church`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** santo (ID: `keyterm:Holy`); Jesús (ID: `person:Jesus.2`); amar (ID: `keyterm:Love`); creer (ID: `keyterm:Believe`); orar (ID: `keyterm:Pray`); comunión (ID: `keyterm:Fellowship`); rogar (ID: `keyterm:AskFor`); Good (ID: `keyterm:Good`); Jehová (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); entrañas (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Pablo (ID: `person:Paul`); amar (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`); cristo (ID: `keyterm:InChrist`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Lucas (ID: `person:Luke`); Demas (ID: `person:Demas`); Epafras (ID: `person:Epaphras`); favor (ID: `keyterm:Favor`); cristo (ID: `keyterm:InChrist`); espíritu (ID: `keyterm:Spirit.2`); Marcos (ID: `person:Mark`); Aristarco (ID: `person:Aristarchus`)
