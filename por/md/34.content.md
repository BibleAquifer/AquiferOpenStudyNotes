...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); The Way (ID: `keyterm:TheWay`); Basã (ID: `place:Bashan`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Carmelo (ID: `place:Carmel`); Libano (ID: `place:Lebanon`); Zealous (ID: `keyterm:Zealous.3`); strength (ID: `keyterm:Strength`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); The Way (ID: `keyterm:TheWay`); wickedness (ID: `keyterm:Wickedness`); Basã (ID: `place:Bashan`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Carmelo (ID: `place:Carmel`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Libano (ID: `place:Lebanon`); Zealous (ID: `keyterm:Zealous.3`); strength (ID: `keyterm:Strength`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`); Strong Drink (ID: `realia:StrongDrink`)
...
* **Associated ACAI Concepts:** wickedness (ID: `keyterm:Wickedness`); peace (ID: `keyterm:IntactState`); Judá (ID: `group:Judah`); make a vow (ID: `keyterm:Vow`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Egito (ID: `place:Egypt`); Líbia (ID: `place:Libya`); lot (ID: `keyterm:Lot`); Pute (ID: `place:Put`); Cush (ID: `place:Cush.2`)
