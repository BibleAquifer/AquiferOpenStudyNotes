...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); love (ID: `keyterm:Love`); Edomites (ID: `group:Edom`); Edom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); fear (ID: `keyterm:Fear`); offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); utter a curse (ID: `keyterm:Curse`); Priests (ID: `group:GenericPriests`); Levi (ID: `person:Levi.3`); Glory (ID: `keyterm:Glory`); stain (ID: `keyterm:Stain`); peace (ID: `keyterm:IntactState`); Levi (ID: `group:Levi`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); fairness (ID: `keyterm:Fairness`); make a vow (ID: `keyterm:Vow`); be kindly disposed (ID: `keyterm:KindlyDisposed`); rogar (ID: `keyterm:AskFor`); Truth (ID: `keyterm:Truth`); profane, dishonor (ID: `keyterm:Dishonor`); pure (ID: `keyterm:Pure`); An Angel (ID: `deity:Angel`); ardour (ID: `keyterm:Ardour`); The Way (ID: `keyterm:TheWay`); Gentiles (ID: `group:Gentile`); bless (ID: `keyterm:Bless`); evil intention (ID: `keyterm:Intention`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); stain (ID: `keyterm:Stain`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Covenant (ID: `keyterm:Covenant`); offering (ID: `keyterm:Offering`); profane, dishonor (ID: `keyterm:Dishonor`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); love (ID: `keyterm:Love`); delight (ID: `keyterm:Delight`); Jerusalém (ID: `place:Jerusalem`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Israel (ID: `person:Israel`); Judá (ID: `group:Judah`); love (ID: `keyterm:Love`); profane, dishonor (ID: `keyterm:Dishonor`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); swear (ID: `keyterm:Swear`); Covenant (ID: `keyterm:Covenant`); pure (ID: `keyterm:Pure`); Judá (ID: `person:Judah.4`); fear (ID: `keyterm:Fear`); Judá (ID: `group:Judah`); An Angel (ID: `deity:Angel`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Jerusalém (ID: `place:Jerusalem`); A Group of People (ID: `group:GenericGroup`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); utter a curse (ID: `keyterm:Curse`); offering (ID: `keyterm:Offering`); decree (ID: `keyterm:Decree`); Israel (ID: `person:Israel`); bless (ID: `keyterm:Bless`); Wheat (ID: `flora:Wheat`); House (ID: `realia:House`); Sorghum (ID: `flora:Sorghum`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); be enticed to serve (ID: `keyterm:EnticedToServe`); fear (ID: `keyterm:Fear`); Molten Image (ID: `realia:MoltenImage`); Cattle (ID: `fauna:Bull`); Scroll (ID: `realia:Scroll`); Animal Pen (ID: `realia:AnimalPen`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Elias (ID: `person:Elijah`); fear (ID: `keyterm:Fear`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`); Israel (ID: `person:Israel`); decree (ID: `keyterm:Decree`); Monte Sinai (ID: `place:SinaiMount`); Moisés (ID: `person:Moses`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Elias (ID: `person:Elijah`); fear (ID: `keyterm:Fear`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`)
