...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); para a eternidade (ID: `keyterm:Always`); fazer a paz (ID: `keyterm:Peace`); misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`); escolhido (ID: `keyterm:Chosen`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); fazer a paz (ID: `keyterm:Peace`); misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); Truth (ID: `keyterm:Truth`); compartilhar (ID: `keyterm:Share`); Ability (ID: `keyterm:Ability`); corpo (ID: `keyterm:Body.3`); House (ID: `realia:House`)
