...
* **Associated ACAI Concepts:** Éphrata (ID: `person:Ephrathah`); Kiljon (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); Bethléhem (ID: `place:Bethlehem`); Juda (ID: `person:Judah.4`); Moab (ID: `place:Moab`); Juda (ID: `group:Judah`); Élimélec (ID: `person:Elimelech`); Machlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); benir (ID: `keyterm:Bless`); bonté (ID: `keyterm:Kindness`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Léa (ID: `person:Leah`); Bethléhem (ID: `place:Bethlehem`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); Rachel (ID: `person:Rachel`); Elders (ID: `group:GenericElders`)
...
* **Associated ACAI Concepts:** Perets (ID: `person:Perez`); Juda (ID: `person:Judah.4`); Tamar (ID: `person:Tamar`); Juda (ID: `group:Judah`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Hetsron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Amminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Nahshon (ID: `person:Nahshon`); Perets (ID: `person:Perez`); Boaz (ID: `person:Boaz`); David (ID: `person:David`); Isaï (ID: `person:Jesse`)
