...
* **Associated ACAI Concepts:** Malaquias (ID: `person:Malachi`); Utterance (ID: `keyterm:Utterance`)
...
* **Associated ACAI Concepts:** fairness (ID: `keyterm:Fairness`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Soap (ID: `realia:Soap`); Hammada (ID: `flora:Soap`); SENHOR (ID: `deity:Lord`)
