...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Edomites (ID: `group:Edom`); ٱلرَّبِّ (ID: `deity:Lord`); أَدومَ (ID: `place:Edom`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`); Offering (ID: `keyterm:Offering`); Fear (ID: `keyterm:Fear`); لَّاوِي (ID: `group:Levi`); Glory (ID: `keyterm:Glory`); Peace (ID: `keyterm:IntactState`); لَّاوِي (ID: `person:Levi.3`); Priests (ID: `group:GenericPriests`); To Curse (ID: `keyterm:Curse`); Defile (ID: `keyterm:Stain`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Fairness (ID: `keyterm:Fairness`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Pure (ID: `keyterm:Pure`); Vow (ID: `keyterm:Vow`); Truth (ID: `keyterm:Truth`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Intention (ID: `keyterm:Intention`); Gentiles (ID: `group:Gentile`); To Dishonor (ID: `keyterm:Dishonor`); Bless (ID: `keyterm:Bless`); Ask for (ID: `keyterm:AskFor`); Passion (ID: `keyterm:Ardour`); The Way (ID: `keyterm:TheWay`); An Angel (ID: `deity:Angel`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Covenant (ID: `keyterm:Covenant`); Offering (ID: `keyterm:Offering`); To Dishonor (ID: `keyterm:Dishonor`); Love (ID: `keyterm:Love`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Delight (ID: `keyterm:Delight`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); To Dishonor (ID: `keyterm:Dishonor`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); لَّاوِي (ID: `person:Levi.3`); An Angel (ID: `deity:Angel`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); Pure (ID: `keyterm:Pure`); Fear (ID: `keyterm:Fear`); يَهوذَا (ID: `person:Judah.4`); Swear (ID: `keyterm:Swear`); A Group of People (ID: `group:GenericGroup`); لَّاوِي (ID: `group:Levi`); Soap (ID: `realia:Soap`); Hammada (ID: `flora:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Decree (ID: `keyterm:Decree`); Offering (ID: `keyterm:Offering`); Bless (ID: `keyterm:Bless`); To Curse (ID: `keyterm:Curse`); إِسْرَائِيلَ (ID: `person:Israel`); Vine (ID: `flora:Vine`); Sorghum (ID: `flora:Sorghum`); Wheat (ID: `flora:Wheat`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Decree (ID: `keyterm:Decree`); موسَى (ID: `person:Moses`); سِينَاءَ (ID: `place:SinaiMount`); Instruction (ID: `keyterm:Instruction`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Decree (ID: `keyterm:Decree`); موسَى (ID: `person:Moses`); سِينَاءَ (ID: `place:SinaiMount`); Fear (ID: `keyterm:Fear`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); إِيلِيَّا (ID: `person:Elijah`); إِسْرَائِيلَ (ID: `person:Israel`)
