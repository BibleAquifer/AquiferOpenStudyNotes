...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); lot (ID: `keyterm:Lot`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`); Edom (ID: `place:Edom`); José (ID: `person:Joseph.10`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); José (ID: `person:Joseph.10`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** dispossess (ID: `keyterm:Dispossess`); Neguebe (ID: `place:Negeb`); Benjamim (ID: `group:Benjamin`); cananeu (ID: `group:Canaan`); Efraim (ID: `person:Ephraim`); Gileade (ID: `place:Gilead`); Samaria (ID: `place:Samaria`); Efraim (ID: `group:Ephraim`); Filisteu (ID: `group:Philistine`); Sefalá (ID: `place:Shephelah`); Israel (ID: `person:Israel`); Sarepta (ID: `place:Zarephath`); Canaã (ID: `place:Canaan`); Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `person:Benjamin`); Sardes (ID: `place:Sardis`); Monte de Esaú (ID: `place:EsauMount`); Filístia (ID: `place:Philistine`)
...
* **Associated ACAI Concepts:** dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`); Monte de Esaú (ID: `place:EsauMount`); Neguebe (ID: `place:Negeb`); Canaã (ID: `place:Canaan`); Sardes (ID: `place:Sardis`); Efraim (ID: `person:Ephraim`); Samaria (ID: `place:Samaria`); Efraim (ID: `group:Ephraim`); Sarepta (ID: `place:Zarephath`); Benjamim (ID: `person:Benjamin`); cananeu (ID: `group:Canaan`); Gileade (ID: `place:Gilead`); Filisteu (ID: `group:Philistine`); Sefalá (ID: `place:Shephelah`); Benjamim (ID: `group:Benjamin`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Filístia (ID: `place:Philistine`)
...
* **Associated ACAI Concepts:** cananeu (ID: `group:Canaan`); Israel (ID: `person:Israel`); dispossess (ID: `keyterm:Dispossess`); Sarepta (ID: `place:Zarephath`); Neguebe (ID: `place:Negeb`); Canaã (ID: `place:Canaan`); Jerusalém (ID: `place:Jerusalem`); Sardes (ID: `place:Sardis`)
