...
* **Associated ACAI Concepts:** aprovado (ID: `keyterm:Approved`); bem, aventurado (ID: `keyterm:Happy`); Life (ID: `keyterm:Life`); love (ID: `keyterm:Love`); promessa (ID: `keyterm:Promise`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); tentar (ID: `keyterm:PutToTheTest`); bem, aventurado (ID: `keyterm:Happy`); amado (ID: `keyterm:Beloved`); aprovado (ID: `keyterm:Approved`); inútil (ID: `keyterm:Worthless`); limpo (ID: `keyterm:Clean`); que não pode ser tentado (ID: `keyterm:NotTempted`); Truth (ID: `keyterm:Truth`); be (or show oneself) just (ID: `keyterm:Just`); To Sin (ID: `keyterm:Sin`); coração (ID: `keyterm:Heart`); Good (ID: `keyterm:Good`); Ability (ID: `keyterm:Ability`); promessa (ID: `keyterm:Promise`); love (ID: `keyterm:Love`); lei (ID: `keyterm:Law`); Life (ID: `keyterm:Life`); salvation (ID: `keyterm:Salvation`); sem mancha (ID: `keyterm:Undefiled`); A Person (ID: `person:GenericPerson`); sem mancha (ID: `keyterm:AboveCriticism`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** inútil (ID: `keyterm:Worthless`); limpo (ID: `keyterm:Clean`); sem mancha (ID: `keyterm:Undefiled`); coração (ID: `keyterm:Heart`); sem mancha (ID: `keyterm:AboveCriticism`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); favoritismo (ID: `keyterm:Partiality`); Glory (ID: `keyterm:Glory`); distinguir (ID: `keyterm:Discern`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** amado (ID: `keyterm:Beloved`); reino (ID: `keyterm:Kingdom`); escolhido (ID: `keyterm:Chosen`); love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`); promessa (ID: `keyterm:Promise`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); juízo (ID: `keyterm:Judgment`); tropeçar (ID: `keyterm:Stumble`); favoritismo (ID: `keyterm:Partiality`); inclemente (ID: `keyterm:Merciless`); fornication (ID: `keyterm:Fornication`); decidir (ID: `keyterm:Decided`); To Sin (ID: `keyterm:Sin`); tribunal de justiça (ID: `keyterm:CourtCase`); escritura (ID: `keyterm:Scripture`); love (ID: `keyterm:Love`); misericórdia (ID: `keyterm:Mercy`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); Abraão (ID: `person:Abraham`); A Person (ID: `person:GenericPerson`); corpo (ID: `keyterm:Body.3`); SENHOR (ID: `deity:Lord`); Raabe (ID: `person:Rahab`); inútil (ID: `keyterm:Idle`); salvation (ID: `keyterm:Salvation`); Demons (ID: `deity:Demons`); fazer a paz (ID: `keyterm:Peace`); Isaque (ID: `person:Isaac`); Spirit (ID: `keyterm:Spirit.2`); escritura (ID: `keyterm:Scripture`); To Cause to Happen (ID: `keyterm:Happen`); An Angel (ID: `deity:Angel`); vazio (ID: `keyterm:Empty`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); Abraão (ID: `person:Abraham`); Raabe (ID: `person:Rahab`); inútil (ID: `keyterm:Idle`); Spirit (ID: `keyterm:Spirit.2`); Isaque (ID: `person:Isaac`); escritura (ID: `keyterm:Scripture`); To Cause to Happen (ID: `keyterm:Happen`); corpo (ID: `keyterm:Body.3`); An Angel (ID: `deity:Angel`); vazio (ID: `keyterm:Empty`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Abraão (ID: `person:Abraham`); escritura (ID: `keyterm:Scripture`); To Cause to Happen (ID: `keyterm:Happen`); crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Hell (ID: `place:Hell`); geena (ID: `keyterm:Gehenna`); corpo (ID: `keyterm:Body.3`); Ability (ID: `keyterm:Ability`); injustiça (ID: `keyterm:UnjustDeed`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); be unfaithful (ID: `keyterm:Unfaithful`); amizade (ID: `keyterm:Friendship`); Spirit (ID: `keyterm:Spirit.2`); Holy Spirit (ID: `deity:HolySpirit`); desejar (ID: `keyterm:LongFor`); escritura (ID: `keyterm:Scripture`); favor (ID: `keyterm:Favor`); coração (ID: `keyterm:Heart`); To Cleanse (ID: `keyterm:Cleanse.2`); Cause of Joy (ID: `keyterm:CauseOfJoy`); pure (ID: `keyterm:Pure`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** condenar (ID: `keyterm:Condemn`); coração (ID: `keyterm:Heart`); corpo (ID: `keyterm:Body.3`); be (or show oneself) just (ID: `keyterm:Just`); testemunhar (ID: `keyterm:BearWitness`); SENHOR (ID: `deity:Lord`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); igreja (ID: `keyterm:Church`); anointed (ID: `keyterm:Anointed`); orar (ID: `keyterm:Pray`); SENHOR (ID: `deity:Lord`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); crer (ID: `keyterm:Believe`); orar (ID: `keyterm:Pray`); SENHOR (ID: `deity:Lord`)
