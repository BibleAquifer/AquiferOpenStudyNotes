...
* **Associated ACAI Concepts:** Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Casting Net (ID: `realia:CastingNet`); holy (ID: `keyterm:Holy`); SENHOR (ID: `deity:Lord`); pure (ID: `keyterm:Pure`); Fortification (ID: `realia:Fortification`); Fish (ID: `fauna:Fish`); Monitor (ID: `fauna:Iguana`); Chameleon (ID: `fauna:Chameleon`); Lizard (ID: `fauna:Lizard`); Harpoon (ID: `realia:Harpoon`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); literally: nought (ID: `keyterm:Idol`); Hell (ID: `place:Hell`); saying (ID: `keyterm:Saying`); lean on (ID: `keyterm:LeanOn`); Libano (ID: `place:Lebanon`); Be Disgraced (ID: `keyterm:Disgraced`); Molten Image (ID: `realia:MoltenImage`); Money (ID: `realia:Money`); Image (ID: `realia:Image`); Tablet (ID: `realia:Tablet`); Beam (ID: `realia:Beam`); Graven Image (ID: `realia:GravenImage`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); SENHOR (ID: `deity:Lord`); Woe (ID: `keyterm:Woe.2`); Libano (ID: `place:Lebanon`); Be Disgraced (ID: `keyterm:Disgraced`)
...
* **Associated ACAI Concepts:** literally: nought (ID: `keyterm:Idol`); SENHOR (ID: `deity:Lord`); Woe (ID: `keyterm:Woe.2`); lean on (ID: `keyterm:LeanOn`); Molten Image (ID: `realia:MoltenImage`); Money (ID: `realia:Money`); Image (ID: `realia:Image`); Graven Image (ID: `realia:GravenImage`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); Habacuque (ID: `person:Habakkuk`); Monte Paran (ID: `place:ParanMount`); Cusã (ID: `place:Cushan`); Temã (ID: `place:Teman`); anointed (ID: `keyterm:Anointed`); Midiã (ID: `place:Midian`); holy (ID: `keyterm:Holy`); Oath (ID: `keyterm:Oath`); majesty (ID: `keyterm:Majesty`); mischief (ID: `keyterm:Mischief`); arrow (ID: `keyterm:Arrow`); fear (ID: `keyterm:Fear`); Deer (ID: `fauna:Deer`); Bow (ID: `realia:Bow`); Cattle (ID: `fauna:Bull`); Olive Tree (ID: `flora:OliveTree`); Vine (ID: `flora:Vine`); Sheepfold (ID: `realia:Sheepfold`); Chariot (ID: `realia:Chariot`); Animal Pen (ID: `realia:AnimalPen`); Flock (ID: `fauna:Flock`); Foundation (ID: `realia:Foundation`); Fig (ID: `flora:Fig`); Tent (ID: `realia:Tent`); Spear (ID: `realia:Spear`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); Monte Paran (ID: `place:ParanMount`); Cusã (ID: `place:Cushan`); Temã (ID: `place:Teman`); SENHOR (ID: `deity:Lord`); anointed (ID: `keyterm:Anointed`); Midiã (ID: `place:Midian`); holy (ID: `keyterm:Holy`); Oath (ID: `keyterm:Oath`); majesty (ID: `keyterm:Majesty`); mischief (ID: `keyterm:Mischief`); arrow (ID: `keyterm:Arrow`); Bow (ID: `realia:Bow`); Chariot (ID: `realia:Chariot`); Foundation (ID: `realia:Foundation`); Tent (ID: `realia:Tent`); Spear (ID: `realia:Spear`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); Oath (ID: `keyterm:Oath`); SENHOR (ID: `deity:Lord`); anointed (ID: `keyterm:Anointed`); arrow (ID: `keyterm:Arrow`); Bow (ID: `realia:Bow`); Chariot (ID: `realia:Chariot`); Foundation (ID: `realia:Foundation`); Spear (ID: `realia:Spear`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); salvation (ID: `keyterm:Salvation`); Cattle (ID: `fauna:Bull`); Olive Tree (ID: `flora:OliveTree`); Animal Pen (ID: `realia:AnimalPen`); Flock (ID: `fauna:Flock`); Vine (ID: `flora:Vine`); Sheepfold (ID: `realia:Sheepfold`); Fig (ID: `flora:Fig`); Goat (ID: `fauna:Goat`)
