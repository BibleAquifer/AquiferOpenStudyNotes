...
* **Associated ACAI Concepts:** Efrata (ID: `person:Ephrathah`); Ephrathites (ID: `group:Ephrathah`); Naomi (ID: `person:Naomi`); Mahlon (ID: `person:Chilion`); Moab (ID: `place:Moab`); Yehuda (ID: `group:Judah`); Elimelekh (ID: `person:Elimelech`); Yehuda (ID: `person:Judah.4`); Betlehem (ID: `place:Bethlehem`); Mahlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); Betlehem (ID: `place:Bethlehem`); Rut (ID: `person:Ruth`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); Rut (ID: `person:Ruth`); kebaikan (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** memberkati (ID: `keyterm:Bless`); Naomi (ID: `person:Naomi`); kebaikan (ID: `keyterm:Kindness`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Rahel (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); Lea (ID: `person:Leah`); Tuhan (ID: `deity:Lord`); Betlehem (ID: `place:Bethlehem`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Yehuda (ID: `group:Judah`); Tuhan (ID: `deity:Lord`); Yehuda (ID: `person:Judah.4`); Peres (ID: `person:Perez`); Tamar (ID: `person:Tamar`)
...
* **Associated ACAI Concepts:** Boas (ID: `person:Boaz`); Rut (ID: `person:Ruth`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Tuhan (ID: `deity:Lord`); Naomi (ID: `person:Naomi`); Israel (ID: `person:Israel`); memberkati (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** memperanakkan (ID: `person:Salmon`); Hezron (ID: `person:Hezron.2`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Nahason (ID: `person:Nahshon`); Peres (ID: `person:Perez`); Boas (ID: `person:Boaz`); Isai (ID: `person:Jesse`); Daud (ID: `person:David`)
