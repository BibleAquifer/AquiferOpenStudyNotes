...
* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Blood (ID: `keyterm:Blood`); यहोवा (ID: `deity:Lord`); Kingdom (ID: `keyterm:Kingdom`); Covenant (ID: `keyterm:Covenant`); Forgive (ID: `keyterm:Forgive`); Be a Disciple (ID: `keyterm:Disciple`); यीशु (ID: `person:Jesus.2`); To Sin (ID: `keyterm:Sin`); Bless (ID: `keyterm:Bless`); Vine (ID: `flora:Vine`)
