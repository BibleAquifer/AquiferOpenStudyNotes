...
* **Associated ACAI Concepts:** Cyrus (ID: `person:Cyrus`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Éternel (ID: `deity:Lord`); Perse (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); offrande (ID: `keyterm:Offering`); Éternel (ID: `deity:Lord`); Money (ID: `realia:Money`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Benjamin (ID: `group:Benjamin`); Juda (ID: `group:Judah`); Benjamin (ID: `person:Benjamin`); Lévi (ID: `person:Levi.3`); Juda (ID: `person:Judah.4`); Éternel (ID: `deity:Lord`); Lévi (ID: `group:Levi`); Money (ID: `realia:Money`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Cyrus (ID: `person:Cyrus`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); Nebucadnetsar (ID: `person:Nebuchadnezzar`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mithredath (ID: `person:Mithredath`); Cyrus (ID: `person:Cyrus`); Zorobabel (ID: `person:Zerubbabel.2`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Perse (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Élam (ID: `person:Elam`); Salomon (ID: `person:Solomon`); Jérusalem (ID: `place:Jerusalem`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`); Thel-Mélach (ID: `place:Tel-melah`); Nekoda (ID: `person:Nekoda.2`); Ather (ID: `person:Ater.2`); Immer (ID: `person:Immer.2`); Reaja (ID: `person:Reaiah.3`); Cherub (ID: `place:Cherub`); Guiddel (ID: `person:Giddel.2`); Baana (ID: `person:Baanah.3`); Delaja (ID: `person:Delaiah.3`); Zaccaï (ID: `person:Zaccai.2`); Gazzam (ID: `person:Gazzam`); Sothaï (ID: `person:Sotai`); Rehum (ID: `person:Rehum`); Adin (ID: `person:Adin`); Thamach (ID: `person:Temah`); Habaja (ID: `person:Habaiah`); Nebo (ID: `place:Nebo.2`); Arach (ID: `person:Arah.2`); Mispar (ID: `person:Mispar`); Pokéreth-Hatsebaïm (ID: `person:Pochereth-hazzebaim`); Hakupha (ID: `person:Hakupha`); Lebana (ID: `person:Lebanah`); Kéros (ID: `person:Keros`); Ézéchias (ID: `person:Hezekiah.2`)
...
* **Associated ACAI Concepts:** Bilschan (ID: `person:Bilshan`); Mispar (ID: `person:Mispar`); Reélaja (ID: `person:Reelaiah`); Seraja (ID: `person:Seraiah.6`); Rehum (ID: `person:Rehum`); Bigvaï (ID: `person:Bigvai`); Baana (ID: `person:Baanah.3`); Néhémie (ID: `person:Nehemiah`); Mardochée (ID: `person:Mordecai`); Zorobabel (ID: `person:Zerubbabel.2`); Israël (ID: `person:Israel`); Josué (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** Zatthu (ID: `person:Zattu.2`); Shefatya (ID: `person:Shephatiah.6`); Ather (ID: `person:Ater`); Jora (ID: `person:Jorah`); Joab (ID: `person:Joab.3`); Adonikam (ID: `person:Adonikam`); Bigvaï (ID: `person:Bigvai.2`); Pareosch (ID: `person:Parosh`); Josué (ID: `person:Jeshua.3`); Zaccaï (ID: `person:Zaccai.2`); Betsaï (ID: `person:Bezai`); Haschum (ID: `person:Hashum`); Adin (ID: `person:Adin`); Bani (ID: `person:Bani`); Arach (ID: `person:Arah.2`); Azgad (ID: `person:Azgad`); Pachath-Moab (ID: `person:Pahath-moab`); Élam (ID: `person:Elam`); Ézéchias (ID: `person:Hezekiah.2`); Bébaï (ID: `person:Bebai`); Gabaon (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Magbisch (ID: `place:Magbish`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Senaa (ID: `place:Senaah`); Harim (ID: `person:Harim.2`); Hadid (ID: `place:Hadid`); Nethopha (ID: `place:Netophah`); Nebo (ID: `place:Nebo.2`); Kephira (ID: `place:Chephirah`); Guéba (ID: `place:Geba`); Anathoth (ID: `place:Anathoth`); Aï (ID: `place:Ai`); Bethléhem (ID: `place:Bethlehem`); Kirjath-Jearim (ID: `place:Kiriath-jearim`); Jéricho (ID: `place:Jericho`); Lod (ID: `place:Lod`); Bethel (ID: `place:Bethel`); Élam (ID: `person:Elam`); Micmasch (ID: `place:Michmash`); Beéroth (ID: `place:Beeroth`); Ono (ID: `place:Ono`); Ramah (ID: `place:Ramah.2`)
...
* **Associated ACAI Concepts:** Harim (ID: `person:Harim`); Josué (ID: `person:Jeshua`); Yedaya (ID: `person:Jedaiah.4`); Schobaï (ID: `person:Shobai`); Josué (ID: `person:Jeshua.4`); Ather (ID: `person:Ater.2`); Immer (ID: `person:Immer.2`); Hathitha (ID: `person:Hatita`); Thalmon (ID: `person:Talmon`); Hodavia (ID: `person:Hodaviah.4`); Akkub (ID: `person:Akkub.2`); Kadmiel (ID: `person:Kadmiel`); Asaph (ID: `person:Asaph.2`); Lévi (ID: `person:Levi.3`); Schallum (ID: `person:Shallum.8`); Paschhur (ID: `person:Pashhur`); Lévi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Schobaï (ID: `person:Shobai`); Ather (ID: `person:Ater.2`); Hathitha (ID: `person:Hatita`); Thalmon (ID: `person:Talmon`); Akkub (ID: `person:Akkub.2`); Asaph (ID: `person:Asaph.2`); Schallum (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** Hathipha (ID: `person:Hatipha`); Harhur (ID: `person:Harhur`); Asna (ID: `person:Asnah`); Netsiach (ID: `person:Neziah`); Reaja (ID: `person:Reaiah.3`); Thabbaoth (ID: `person:Tabbaoth`); Gachar (ID: `person:Gahar`); Uzza (ID: `person:Uzza.2`); Sisera (ID: `person:Sisera.2`); Siaha (ID: `person:Siaha`); Hasupha (ID: `person:Hasupha`); Retsin (ID: `person:Rezin.2`); Barkos (ID: `person:Barkos`); Hagaba (ID: `person:Hagabah`); Tsicha (ID: `person:Ziha`); Bakbuk (ID: `person:Bakbuk`); Mehida (ID: `person:Mehida`); Gazzam (ID: `person:Gazzam`); Harscha (ID: `person:Harsha`); Shalmai (ID: `person:Shalmai`); Hanan (ID: `person:Hanan.4`); Meunim (ID: `group:Meunim`); Thamach (ID: `person:Temah`); Nephushesim (ID: `group:Nephushesim`); Hakupha (ID: `person:Hakupha`); Paséach (ID: `person:Paseah.2`); Lebana (ID: `person:Lebanah`); Hagab (ID: `person:Hagab`); Kéros (ID: `person:Keros`); Nekoda (ID: `person:Nekoda`); Batsluth (ID: `person:Bazluth`); Bésaï (ID: `person:Besai`); Guiddel (ID: `person:Giddel`); Padon (ID: `person:Padon`); Akkub (ID: `person:Akkub.3`)
...
* **Associated ACAI Concepts:** Salomon (ID: `person:Solomon`); Pokéreth-Hatsebaïm (ID: `person:Pochereth-hazzebaim`); Sothaï (ID: `person:Sotai`); Ami (ID: `person:Ami`); Guiddel (ID: `person:Giddel.2`); Hatthil (ID: `person:Hattil`); Sophéreth (ID: `person:Sophereth`); Shephatiah (ID: `person:Shephatiah.7`); Jaala (ID: `person:Jaalah`); Peruda (ID: `person:Peruda`); Darkon (ID: `person:Darkon`)
...
* **Associated ACAI Concepts:** Cherub (ID: `place:Cherub`); Delaja (ID: `person:Delaiah.3`); Addan (ID: `place:Addan`); Thel-Mélach (ID: `place:Tel-melah`); Nekoda (ID: `person:Nekoda.2`); Immer (ID: `place:Immer`); Thel-Harscha (ID: `place:Tel-harsha`); Tobija (ID: `person:Tobiah`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Hakkots (ID: `person:Hakkoz.2`); Habaja (ID: `person:Habaiah`); Barzillaï (ID: `person:Barzillai.3`); Barzillaï (ID: `person:Barzillai`); souiller (ID: `keyterm:Stain`); sacerdoce (ID: `keyterm:Priesthood`); Galaad (ID: `place:Gilead`); Galaadite (ID: `group:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); Jérusalem (ID: `place:Jerusalem`); force (ID: `keyterm:Strength`); Éternel (ID: `deity:Lord`); Tunic (ID: `realia:Tunic`); House (ID: `realia:House`); Money (ID: `realia:Money`); Mina (ID: `realia:Mina`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); force (ID: `keyterm:Strength`); Tunic (ID: `realia:Tunic`); Money (ID: `realia:Money`); Mina (ID: `realia:Mina`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); offrande (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); Josué (ID: `person:Joshua.5`); Cyrus (ID: `person:Cyrus`); Perse (ID: `place:Persia`); Jehozadak (ID: `person:Jehozadak`); Schealthiel (ID: `person:Shealtiel.2`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Hénadad (ID: `person:Henadad`); Josué (ID: `person:Jeshua.4`); Asarhaddôn (ID: `person:Esarhaddon`); Kadmiel (ID: `person:Kadmiel`); Relatives (ID: `group:Relatives`); Hodavia (ID: `person:Hodaviah.4`); néoménies (ID: `keyterm:NewMoonFestival`); Joppa (ID: `place:Joppa`); Sidonien (ID: `group:Sidon`); Asaph (ID: `person:Asaph.2`); Assyria (ID: `place:Assyria`); terreur (ID: `keyterm:Terror`); avis (ID: `keyterm:Counsel`); Sidon (ID: `place:Sidon`); Benjamin (ID: `group:Benjamin`); Benjamin (ID: `person:Benjamin`); Instruction (ID: `keyterm:Instruction`); David (ID: `person:David`); Liban (ID: `place:Lebanon`); Tyrien (ID: `group:Tyre`); bonté (ID: `keyterm:Kindness`); saint (ID: `keyterm:Holy`); fête déterminée (ID: `keyterm:AppointedFeast`); Darius (ID: `person:Darius.2`); fourré (ID: `keyterm:FeastOfTabernacles`); Tyr (ID: `place:Tyre`); Hodija (ID: `person:Hodiah.2`); Moïse (ID: `person:Moses`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Cymbals (ID: `realia:Cymbals`); Trumpet (ID: `realia:Trumpet`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Jehozadak (ID: `person:Jehozadak`); Schealthiel (ID: `person:Shealtiel.2`); Israël (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); Moïse (ID: `person:Moses`); offrande (ID: `keyterm:Offering`); Éternel (ID: `deity:Lord`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** terreur (ID: `keyterm:Terror`); offrande (ID: `keyterm:Offering`); Éternel (ID: `deity:Lord`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** offrande (ID: `keyterm:Offering`); Éternel (ID: `deity:Lord`); néoménies (ID: `keyterm:NewMoonFestival`); saint (ID: `keyterm:Holy`); fête déterminée (ID: `keyterm:AppointedFeast`)
...
* **Associated ACAI Concepts:** Cyrus (ID: `person:Cyrus`); Tyrien (ID: `group:Tyre`); Sidon (ID: `place:Sidon`); Sidonien (ID: `group:Sidon`); Tyr (ID: `place:Tyre`); Joppa (ID: `place:Joppa`); Perse (ID: `place:Persia`); Liban (ID: `place:Lebanon`); Cedar (ID: `flora:Cedar`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Jérusalem (ID: `place:Jerusalem`); Josué (ID: `person:Joshua.5`); Lévi (ID: `person:Levi.3`); Jehozadak (ID: `person:Jehozadak`); Éternel (ID: `deity:Lord`); Schealthiel (ID: `person:Shealtiel.2`); Lévi (ID: `group:Levi`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); bonté (ID: `keyterm:Kindness`); Asaph (ID: `person:Asaph.2`); Lévi (ID: `person:Levi.3`); David (ID: `person:David`); Lévi (ID: `group:Levi`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Benjamin (ID: `group:Benjamin`); Juda (ID: `group:Judah`); Benjamin (ID: `person:Benjamin`); Juda (ID: `person:Judah.4`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Cyrus (ID: `person:Cyrus`); Zorobabel (ID: `person:Zerubbabel.2`); Israël (ID: `person:Israel`); Josué (ID: `person:Joshua.5`); Éternel (ID: `deity:Lord`); Perse (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Cyrus (ID: `person:Cyrus`); Perse (ID: `place:Persia`); Darius (ID: `person:Darius.2`); avis (ID: `keyterm:Counsel`)
...
* **Associated ACAI Concepts:** Euphrate (ID: `place:Euphrates`); Jérusalem (ID: `place:Jerusalem`); Rehum (ID: `person:Rehum.2`); Schimschaï (ID: `person:Shimshai`); Artaxerxès (ID: `person:Artaxerxes.2`); Perse (ID: `place:Persia`); Jews (ID: `group:Jews`); Samarie (ID: `place:Samaria`); Osnappar (ID: `person:Osnappar`); Érec (ID: `place:Erech`); Bischlam (ID: `person:Bishlam`); Assuérus (ID: `person:Ahasuerus`); Mithredath (ID: `person:Mithredath.2`); Thabeel (ID: `person:Tabeel`); Dinaite (ID: `person:Dinaite`); Babylonien (ID: `group:Babylon`); Suse (ID: `place:Susa`); Almôn-Divlataïm (ID: `group:Elam`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Babylone (ID: `place:Babylon`); Élam (ID: `place:Elam`); Perse (ID: `group:Persia`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Dinaite (ID: `person:Dinaite`); Schimschaï (ID: `person:Shimshai`); Rehum (ID: `person:Rehum.2`); Érec (ID: `place:Erech`); Babylonien (ID: `group:Babylon`); Suse (ID: `place:Susa`); Perse (ID: `group:Persia`); Babylone (ID: `place:Babylon`); Almôn-Divlataïm (ID: `group:Elam`); Perse (ID: `place:Persia`); Élam (ID: `place:Elam`)
...
* **Associated ACAI Concepts:** Euphrate (ID: `place:Euphrates`); Jérusalem (ID: `place:Jerusalem`); Artaxerxès (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Samarie (ID: `place:Samaria`); Schimschaï (ID: `person:Shimshai`); Rehum (ID: `person:Rehum.2`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Schimschaï (ID: `person:Shimshai`); Rehum (ID: `person:Rehum.2`); Artaxerxès (ID: `person:Artaxerxes.2`); Jérusalem (ID: `place:Jerusalem`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Darius (ID: `person:Darius.2`); Perse (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Darius (ID: `person:Darius.2`); Jews (ID: `group:Jews`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Thathnaï (ID: `person:Tattenai`); Iddo (ID: `person:Iddo.6`); Zacharie (ID: `person:Zechariah.17`); Aggée (ID: `person:Haggai`); Euphrate (ID: `place:Euphrates`); Zorobabel (ID: `person:Zerubbabel.2`); Israël (ID: `person:Israel`); Josué (ID: `person:Joshua.5`); Jehozadak (ID: `person:Jehozadak`); Juda (ID: `person:Judah.4`); Perse (ID: `place:Persia`); Schealthiel (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** Iddo (ID: `person:Iddo.6`); Zacharie (ID: `person:Zechariah.17`); Aggée (ID: `person:Haggai`); Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`); Jews (ID: `group:Jews`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Jérusalem (ID: `place:Jerusalem`); Josué (ID: `person:Joshua.5`); Jehozadak (ID: `person:Jehozadak`); Schealthiel (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Jérusalem (ID: `place:Jerusalem`); Babylone (ID: `place:Babylon`); Cyrus (ID: `person:Cyrus`); Darius (ID: `person:Darius.2`); Zorobabel (ID: `person:Zerubbabel.2`); Nebucadnetsar (ID: `person:Nebuchadnezzar`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Thathnaï (ID: `person:Tattenai`); Euphrate (ID: `place:Euphrates`); Chaldéens (ID: `group:Chaldea`); Israël (ID: `person:Israel`); Juda (ID: `person:Judah.4`); Chaldée (ID: `place:Chaldea`); Foundation (ID: `realia:Foundation`); Hewn Stone (ID: `realia:HewnStone`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Cyrus (ID: `person:Cyrus`); Zorobabel (ID: `person:Zerubbabel.2`); Babylone (ID: `place:Babylon`); Nebucadnetsar (ID: `person:Nebuchadnezzar`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Zorobabel (ID: `person:Zerubbabel.2`); Foundation (ID: `realia:Foundation`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); offrande (ID: `keyterm:Offering`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); pollution (ID: `keyterm:Defilement`); nation; peuple (ID: `group:Gentile`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Azaria (ID: `person:Azariah.7`); Esdras (ID: `person:Ezra`); Seraja (ID: `person:Seraiah.2`); Artaxerxès (ID: `person:Artaxerxes`); Hilkija (ID: `person:Hilkiah.2`); Perse (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Esdras (ID: `person:Ezra`); Amaria (ID: `person:Amariah.2`); Bukki (ID: `person:Bukki.2`); Azaria (ID: `person:Azariah.6`); Azaria (ID: `person:Azariah.7`); Merajoth (ID: `person:Meraioth`); Schallum (ID: `person:Shallum.7`); Seraja (ID: `person:Seraiah.2`); Zerachja (ID: `person:Zerahiah`); Abischua (ID: `person:Abishua`); Tsadok (ID: `person:Zadok.4`); Uzzi (ID: `person:Uzzi`); Achithub (ID: `person:Ahitub.3`); Artaxerxès (ID: `person:Artaxerxes`); Aaron (ID: `person:Aaron`); Perse (ID: `place:Persia`); Éléazar (ID: `person:Eleazar.2`); Hilkija (ID: `person:Hilkiah.2`); Phinées (ID: `person:Phinehas`)
...
* **Associated ACAI Concepts:** Esdras (ID: `person:Ezra`); Israël (ID: `person:Israel`); Babylone (ID: `place:Babylon`); Instruction (ID: `keyterm:Instruction`); Moïse (ID: `person:Moses`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); Esdras (ID: `person:Ezra`); Artaxerxès (ID: `person:Artaxerxes`); Israël (ID: `person:Israel`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); Euphrate (ID: `place:Euphrates`); limite (ID: `keyterm:Decree`); Juda (ID: `person:Judah.4`); Babylone (ID: `place:Babylon`); Éternel (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Wheat (ID: `flora:Wheat`); Anointing Oil (ID: `realia:AnointingOil`); Altar (ID: `realia:Altar`); Sheep (ID: `fauna:Lamb`); Talent (ID: `realia:Talent`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Olive Oil (ID: `realia:OliveOil`); Kor (ID: `realia:Kor`)
...
* **Associated ACAI Concepts:** Euphrate (ID: `place:Euphrates`); Artaxerxès (ID: `person:Artaxerxes`); Esdras (ID: `person:Ezra`); Wheat (ID: `flora:Wheat`); Kor (ID: `realia:Kor`); Olive Oil (ID: `realia:OliveOil`); Talent (ID: `realia:Talent`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Bébaï (ID: `person:Bebai.2`); Ébed (ID: `person:Ebed.2`); Hakkathan (ID: `person:Hakkatan`); Shefatya (ID: `person:Shephatiah.6`); Daniel (ID: `person:Daniel.2`); Schemaeja (ID: `person:Shemaiah.14`); Guershom (ID: `person:Gershom.2`); Josiphia (ID: `person:Josiphiah`); Adonikam (ID: `person:Adonikam`); Bigvaï (ID: `person:Bigvai.2`); Zaccur (ID: `person:Zaccur.5`); Zerachja (ID: `person:Zerahiah.2`); Joab (ID: `person:Joab.4`); Hatthusch (ID: `person:Hattush.2`); Pareosch (ID: `person:Parosh.2`); Zevadya (ID: `person:Zebadiah.8`); Abdias (ID: `person:Obadiah.10`); Zacharie (ID: `person:Zechariah.18`); Schecania (ID: `person:Shecaniah.6`); Schelomith (ID: `person:Shelomith.4`); Jachaziel (ID: `person:Jahaziel.5`); Éljoénaï (ID: `person:Eliehoenai.2`); Jochanan (ID: `person:Johanan.8`); Jonathan (ID: `person:Jonathan.9`); Micaël (ID: `person:Michael.10`); Ésaïe (ID: `person:Jeshaiah.4`); Schecania (ID: `person:Shecaniah.5`); Adin (ID: `person:Adin`); Zacharie (ID: `person:Zechariah.19`); Jehiel (ID: `person:Jehiel.7`); Azgad (ID: `person:Azgad`); Pachath-Moab (ID: `person:Pahath-moab`); Élam (ID: `person:Elam`); Uthaï (ID: `person:Uthai.2`); Yeïel (ID: `person:Jeuel.3`); Éliphéleth (ID: `person:Eliphelet.5`); Athalie (ID: `person:Athaliah.3`); Bébaï (ID: `person:Bebai`); Artaxerxès (ID: `person:Artaxerxes`); Babylone (ID: `place:Babylon`); David (ID: `person:David`); Ithamar (ID: `person:Ithamar`); Phinées (ID: `person:Phinehas`)
...
* **Associated ACAI Concepts:** Ariel (ID: `person:Ariel`); Elnathan (ID: `person:Elnathan.3`); Iddo (ID: `person:Iddo`); Éliézer (ID: `person:Eliezer.8`); Elnathan (ID: `person:Elnathan.4`); Nathan (ID: `person:Nathan.5`); Jojarib (ID: `person:Joiarib.2`); Schemaeja (ID: `person:Shemaiah.15`); Zacharie (ID: `person:Zechariah.20`); Elnathan (ID: `person:Elnathan.2`); Jarib (ID: `person:Jarib.2`); Casiphia (ID: `place:Casiphia`); Meschullam (ID: `person:Meshullam.9`); percevoir (ID: `keyterm:Perceive`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Schérébia (ID: `person:Sherebiah`); Machli (ID: `person:Mahli`); Israël (ID: `person:Israel`); Lévi (ID: `person:Levi.3`); Éternel (ID: `deity:Lord`); Lévi (ID: `group:Levi`); discernement (ID: `keyterm:Insight`)
...
* **Associated ACAI Concepts:** David (ID: `person:David`); Lévi (ID: `person:Levi.3`); travil (ID: `keyterm:Work`); Lévi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); pécher (ID: `keyterm:Sin`); offrande (ID: `keyterm:Offering`); Éternel (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Hittite (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); être infidèle (ID: `keyterm:Unfaithful`); Égypte (ID: `place:Egypt`); Canaan (ID: `group:Canaan`); Jébusiens (ID: `group:Jebusites`); Israël (ID: `person:Israel`); Ammon (ID: `place:Ammon`); Mitsraïm (ID: `group:Egypt`); Lévi (ID: `person:Levi.3`); Moab (ID: `place:Moab`); Amos (ID: `group:Ammon`); Canaan (ID: `place:Canaan`); Heth (ID: `person:Heth`); Lévi (ID: `group:Levi`); Amorites (ID: `group:Amorites`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Esdras (ID: `person:Ezra`); être infidèle (ID: `keyterm:Unfaithful`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`); ardeur (ID: `keyterm:Ardour`); Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Harim (ID: `person:Harim`); avis (ID: `keyterm:Counsel`); Élam (ID: `person:Elam`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); offrande (ID: `keyterm:Offering`); Amaria (ID: `person:Amariah.6`); Jochanan (ID: `person:Jehohanan.4`); Éliaschib (ID: `person:Eliashib.4`); Maaséja (ID: `person:Maaseiah.7`); Schemaeja (ID: `person:Shemaiah.16`); Guedalia (ID: `person:Gedaliah`); Élie (ID: `person:Elijah.4`); Uri (ID: `person:Uri.3`); Abdi (ID: `person:Abdi.3`); Schemaeja (ID: `person:Shemaiah.17`); Macnadbaï (ID: `person:Machnadebai`); Kelaiah (ID: `person:Kelaiah`); Ozias (ID: `person:Uzziah.4`); Jaasaï (ID: `person:Jaasu`); Schallum (ID: `person:Shallum.11`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); ardeur (ID: `keyterm:Ardour`); Judée (ID: `place:Judea`); déposséder (ID: `keyterm:Dispossess`); Israël (ID: `person:Israel`); état intact (ID: `keyterm:IntactState`); Jérusalem (ID: `place:Jerusalem`); bonté (ID: `keyterm:Kindness`); pollution (ID: `keyterm:Defilement`); Perse (ID: `place:Persia`); laissiez en possession (ID: `keyterm:Possess`); supplication (ID: `keyterm:Supplication`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Judée (ID: `place:Judea`); Jérusalem (ID: `place:Jerusalem`); bonté (ID: `keyterm:Kindness`); Perse (ID: `place:Persia`); supplication (ID: `keyterm:Supplication`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** déposséder (ID: `keyterm:Dispossess`); pollution (ID: `keyterm:Defilement`); laissiez en possession (ID: `keyterm:Possess`); état intact (ID: `keyterm:IntactState`)
...
* **Associated ACAI Concepts:** Jehiel (ID: `person:Jehiel.8`); Schecania (ID: `person:Shecaniah.7`); être infidèle (ID: `keyterm:Unfaithful`); Israël (ID: `person:Israel`); Élam (ID: `person:Elam`); Esdras (ID: `person:Ezra`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); jurer (ID: `keyterm:Swear`); Lévi (ID: `person:Levi.3`); Esdras (ID: `person:Ezra`); Lévi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Thikva (ID: `person:Tikvah.2`); Meschullam (ID: `person:Meshullam.10`); Jonathan (ID: `person:Jonathan.10`); Jachzia (ID: `person:Jahzeiah`); Asaël (ID: `person:Asahel.4`); Shabbethai (ID: `person:Shabbethai`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`)
