...
* **Associated ACAI Concepts:** vérité (ID: `keyterm:Truth`); marcher (ID: `keyterm:Live.3`); bien, aimé (ID: `keyterm:Beloved`); Gaïus (ID: `person:Gaius.4`); témoigner (ID: `keyterm:BearWitness`); prier (ID: `keyterm:Pray`); Cause of Joy (ID: `keyterm:CauseOfJoy`); aimer (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** témoigner (ID: `keyterm:BearWitness`); église (ID: `keyterm:Church`); Éternel (ID: `deity:Lord`); fidelité (ID: `keyterm:Faithfulness`); nom (ID: `keyterm:Name`); sois obligé (ID: `keyterm:Ought`); aimer (ID: `keyterm:Love`); vérité (ID: `keyterm:Truth`); bien, aimé (ID: `keyterm:Beloved`)
...
* **Associated ACAI Concepts:** église (ID: `keyterm:Church`); Diotrèphe (ID: `person:Diotrephes`); Démétrius (ID: `person:Demetrius`); témoigner (ID: `keyterm:BearWitness`); vrai (ID: `keyterm:True`); le bien (ID: `keyterm:Good`); Éternel (ID: `deity:Lord`); faire du bien (ID: `keyterm:DoGood`); vérité (ID: `keyterm:Truth`); bien, aimé (ID: `keyterm:Beloved`)
