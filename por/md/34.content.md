...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Carmelo (ID: `place:Carmel`); Zealous (ID: `keyterm:Zealous.3`); The Way (ID: `keyterm:TheWay`); strength (ID: `keyterm:Strength`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Basã (ID: `place:Bashan`); Libano (ID: `place:Lebanon`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); wickedness (ID: `keyterm:Wickedness`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Carmelo (ID: `place:Carmel`); Zealous (ID: `keyterm:Zealous.3`); The Way (ID: `keyterm:TheWay`); strength (ID: `keyterm:Strength`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Basã (ID: `place:Bashan`); Libano (ID: `place:Lebanon`); Strong Drink (ID: `realia:StrongDrink`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** peace (ID: `keyterm:IntactState`); make a vow (ID: `keyterm:Vow`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); wickedness (ID: `keyterm:Wickedness`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); SENHOR (ID: `deity:Lord`); Goat (ID: `fauna:Goat`); Chariot (ID: `realia:Chariot`); Grass (ID: `flora:Grass`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Cush (ID: `place:Cush.2`); Egito (ID: `place:Egypt`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); lot (ID: `keyterm:Lot`); Pute (ID: `place:Put`); Líbia (ID: `place:Libya`)
