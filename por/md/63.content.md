...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); para a eternidade (ID: `keyterm:Always`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); misericórdia (ID: `keyterm:Mercy`); escolhido (ID: `keyterm:Chosen`); Jesus (ID: `person:Jesus.2`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); love (ID: `keyterm:Love`); misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); andar (ID: `keyterm:Live.3`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`); Truth (ID: `keyterm:Truth`); corpo (ID: `keyterm:Body.3`); rogar (ID: `keyterm:AskFor`); compartilhar (ID: `keyterm:Share`); Ability (ID: `keyterm:Ability`); House (ID: `realia:House`)
