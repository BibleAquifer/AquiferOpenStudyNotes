...
* **Associated ACAI Concepts:** Rama (ID: `place:Ramah`); Samuel (ID: `person:Samuel`); Paran (ID: `place:Paran`); Israel (ID: `person:Israel`); Daud (ID: `person:David`); House (ID: `realia:House`)
