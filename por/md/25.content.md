...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); rebel (ID: `keyterm:Rebel`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); love (ID: `keyterm:Love`); strength (ID: `keyterm:Strength`); Judá (ID: `group:Judah`); Mighty One (ID: `keyterm:MightyOne`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); appointed feast (ID: `keyterm:AppointedFeast`); Israel (ID: `person:Israel`); work (ID: `keyterm:Work`); Deceit (ID: `keyterm:Deceit`); defilement (ID: `keyterm:Defilement`); To Sin (ID: `keyterm:Sin`); Train (ID: `realia:Train`); House (ID: `realia:House`); Yoke (ID: `realia:Yoke`); Winepress (ID: `realia:Winepress`); Net (ID: `realia:Net`); Flock (ID: `fauna:Flock`); Deer (ID: `fauna:Deer`); Casting Net (ID: `realia:CastingNet`); Grass (ID: `flora:Grass`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); defilement (ID: `keyterm:Defilement`); To Sin (ID: `keyterm:Sin`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`)
...
* **Associated ACAI Concepts:** horn (ID: `keyterm:Horn`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Tent (ID: `realia:Tent`); Sheep (ID: `fauna:Lamb`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** appointed feast (ID: `keyterm:AppointedFeast`); SENHOR (ID: `deity:Lord`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`); Edom (ID: `place:Edom`); Uz (ID: `place:Uz`); stain (ID: `keyterm:Stain`); Believe In (ID: `keyterm:BelieveIn`); Sodoma (ID: `place:Sodom`); Appoint (ID: `keyterm:Appoint`); Punishment (ID: `keyterm:Punishment`); be kindly disposed (ID: `keyterm:KindlyDisposed`); defilement (ID: `keyterm:Defilement`); Complete (ID: `keyterm:Complete`); anointed (ID: `keyterm:Anointed`); Jackal (ID: `fauna:Jackal`); Ostrich (ID: `fauna:Ostrich`); Clay Jar (ID: `realia:ClayJar`); Purple Cloth (ID: `realia:PurpleCloth`); Vulture (ID: `fauna:Vulture`)
...
* **Associated ACAI Concepts:** Edom (ID: `place:Edom`); Uz (ID: `place:Uz`); Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); To Sin (ID: `keyterm:Sin`); Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); To Sin (ID: `keyterm:Sin`); Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); Edom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Jerusalém (ID: `place:Jerusalem`); Egito (ID: `place:Egypt`); round dance (ID: `keyterm:RoundDance`); Assyria (ID: `place:Assyria`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); ardour (ID: `keyterm:Ardour`); to cause to possess (ID: `keyterm:Possess`); Woe (ID: `keyterm:Woe`); Hand-Mill (ID: `realia:Hand-mill`); Crown (ID: `realia:Crown`); House (ID: `realia:House`); Jackal (ID: `fauna:Jackal`); Money (ID: `realia:Money`)
