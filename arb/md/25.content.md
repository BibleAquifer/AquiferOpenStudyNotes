...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); Rebel (ID: `keyterm:Rebel`); Love (ID: `keyterm:Love`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Strength (ID: `keyterm:Strength`); Defilement (ID: `keyterm:Defilement`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); To Sin (ID: `keyterm:Sin`); Mighty One (ID: `keyterm:MightyOne`); Deceit (ID: `keyterm:Deceit`); إِسْرَائِيلَ (ID: `person:Israel`); Work (ID: `keyterm:Work`); Appointed Feast (ID: `keyterm:AppointedFeast`); Train (ID: `realia:Train`); Casting Net (ID: `realia:CastingNet`); Grass (ID: `flora:Grass`); Net (ID: `realia:Net`); Flock (ID: `fauna:Flock`); Deer (ID: `fauna:Deer`); House (ID: `realia:House`); Yoke (ID: `realia:Yoke`); Winepress (ID: `realia:Winepress`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); Defilement (ID: `keyterm:Defilement`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Appointed Feast (ID: `keyterm:AppointedFeast`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Horn (ID: `keyterm:Horn`); Sheep (ID: `fauna:Lamb`); Instruction (ID: `keyterm:Instruction`); Have a Vision (ID: `keyterm:HaveAVision`); Utterance (ID: `keyterm:Utterance`); Gentiles (ID: `group:Gentile`); Passion (ID: `keyterm:Ardour`); Sabbath (ID: `keyterm:Sabbath`); To Dishonor (ID: `keyterm:Dishonor`); Vine (ID: `flora:Vine`); Grain (ID: `flora:Grain`); Measuring Reed (ID: `realia:MeasuringReed`); Stone Altar (ID: `realia:StoneAltar`); Bow (ID: `realia:Bow`); Wine (ID: `realia:Wine`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); House (ID: `realia:House`); Tent (ID: `realia:Tent`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Horn (ID: `keyterm:Horn`); إِسْرَائِيلَ (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Bow (ID: `realia:Bow`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Appointed Feast (ID: `keyterm:AppointedFeast`); أورشَلِيمَ (ID: `place:Jerusalem`); Sabbath (ID: `keyterm:Sabbath`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Appointed Feast (ID: `keyterm:AppointedFeast`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Arrow (ID: `realia:Arrow`); Wormwood (ID: `flora:Wormwood`); Peace (ID: `keyterm:IntactState`); Arrow (ID: `keyterm:Arrow`); Complete (ID: `keyterm:Complete`); Kindness (ID: `keyterm:Kindness`); Bitter Herbs (ID: `flora:Chicory`); Lion (ID: `fauna:Lion`); Bow (ID: `realia:Bow`); Bear (ID: `fauna:Bear`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Complete (ID: `keyterm:Complete`); Forgive (ID: `keyterm:Forgive`); Fear (ID: `keyterm:Fear`); Hope (ID: `keyterm:Hope`); To Sin (ID: `keyterm:Sin`); Peace (ID: `keyterm:IntactState`); Salvation (ID: `keyterm:Salvation`); Rebel (ID: `keyterm:Rebel`); Arrow (ID: `keyterm:Arrow`); Redeem (ID: `keyterm:Redeem`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Wormwood (ID: `flora:Wormwood`); Pit (ID: `realia:Pit`); Arrow (ID: `realia:Arrow`); Hewn Stone (ID: `realia:HewnStone`); Lion (ID: `fauna:Lion`); Bow (ID: `realia:Bow`); Bitter Herbs (ID: `flora:Chicory`); Bird (ID: `fauna:Bird`); Bear (ID: `fauna:Bear`); Yoke (ID: `realia:Yoke`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`); أَدومَ (ID: `place:Edom`); عوصًا (ID: `place:Uz`); Defile (ID: `keyterm:Stain`); Defilement (ID: `keyterm:Defilement`); Anointed (ID: `keyterm:Anointed`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Complete (ID: `keyterm:Complete`); سَدومَ (ID: `place:Sodom`); Believe In (ID: `keyterm:BelieveIn`); Punishment (ID: `keyterm:Punishment`); Appoint (ID: `keyterm:Appoint`); Ostrich (ID: `fauna:Ostrich`); Jackal (ID: `fauna:Jackal`); Vulture (ID: `fauna:Vulture`); Clay Jar (ID: `realia:ClayJar`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** أَدومَ (ID: `place:Edom`); عوصًا (ID: `place:Uz`); To Sin (ID: `keyterm:Sin`); Complete (ID: `keyterm:Complete`); أورشَلِيمَ (ID: `place:Jerusalem`); Appoint (ID: `keyterm:Appoint`); Passion (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); أَدومَ (ID: `place:Edom`); Complete (ID: `keyterm:Complete`); أورشَلِيمَ (ID: `place:Jerusalem`); Appoint (ID: `keyterm:Appoint`); Passion (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); أورشَلِيمَ (ID: `place:Jerusalem`); To Cause to Possess (ID: `keyterm:Possess`); يَهوذَا (ID: `person:Judah.4`); Assyria (ID: `place:Assyria`); Round Dance (ID: `keyterm:RoundDance`); Passion (ID: `keyterm:Ardour`); مِصْرَ (ID: `place:Egypt`); يَهوذَا (ID: `group:Judah`); Woe (ID: `keyterm:Woe`); House (ID: `realia:House`); Money (ID: `realia:Money`); Hand-Mill (ID: `realia:Hand-mill`); Jackal (ID: `fauna:Jackal`); Crown (ID: `realia:Crown`)
