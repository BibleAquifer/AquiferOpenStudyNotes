...
* **Associated ACAI Concepts:** Èfratite; d'Èfrata (ID: `group:Ephrathah`); Naomi (ID: `person:Naomi`); Éphrata (ID: `person:Ephrathah`); Kiljon (ID: `person:Chilion`); Juda (ID: `person:Judah.4`); Élimélec (ID: `person:Elimelech`); Bethléhem (ID: `place:Bethlehem`); Juda (ID: `group:Judah`); Moab (ID: `place:Moab`); Machlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Bethléhem (ID: `place:Bethlehem`); Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** benir (ID: `keyterm:Bless`); bonté (ID: `keyterm:Kindness`); Naomi (ID: `person:Naomi`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); laissiez en possession (ID: `keyterm:Possess`); Boaz (ID: `person:Boaz`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Machlon (ID: `person:Mahlon`); Ruth (ID: `person:Ruth`); laissiez en possession (ID: `keyterm:Possess`)
...
* **Associated ACAI Concepts:** Rachel (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); Éternel (ID: `deity:Lord`); Bethléhem (ID: `place:Bethlehem`); Léa (ID: `person:Leah`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Juda (ID: `person:Judah.4`); Perets (ID: `person:Perez`); Tamar (ID: `person:Tamar`); Éternel (ID: `deity:Lord`); Juda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); benir (ID: `keyterm:Bless`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Salmon (ID: `person:Salmon`); Hetsron (ID: `person:Hezron.2`); Obed (ID: `person:Obed`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Perets (ID: `person:Perez`); Nahshon (ID: `person:Nahshon`); David (ID: `person:David`); Boaz (ID: `person:Boaz`); Isaï (ID: `person:Jesse`)
