...
* **Associated ACAI Concepts:** Quiliom (ID: `person:Chilion`); Efrata (ID: `person:Ephrathah`); Ephrathites (ID: `group:Ephrathah`); Noemi (ID: `person:Naomi`); Elimeleque (ID: `person:Elimelech`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Belém (ID: `place:Bethlehem`); Moabe (ID: `place:Moab`); Malom (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Appoint (ID: `keyterm:Appoint`); Moabe (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** favor (ID: `keyterm:Favor`); Rute (ID: `person:Ruth`); Moabe (ID: `place:Moab`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** kindness (ID: `keyterm:Kindness`); bless (ID: `keyterm:Bless`); SENHOR (ID: `deity:Lord`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** to cause to possess (ID: `keyterm:Possess`); Rute (ID: `person:Ruth`); Malom (ID: `person:Mahlon`); Moabe (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Belém (ID: `place:Bethlehem`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Lia (ID: `person:Leah`); Elders (ID: `group:GenericElders`); Raquel (ID: `person:Rachel`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Perez (ID: `person:Perez`); SENHOR (ID: `deity:Lord`); Tamar (ID: `person:Tamar`)
...
* **Associated ACAI Concepts:** Hezrom (ID: `person:Hezron.2`); Salmom (ID: `person:Salmon`); Obede (ID: `person:Obed`); Aminadabe (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Jessé (ID: `person:Jesse`); Perez (ID: `person:Perez`); Davi (ID: `person:David`); Boaz (ID: `person:Boaz`); Naassom (ID: `person:Nahshon`)
