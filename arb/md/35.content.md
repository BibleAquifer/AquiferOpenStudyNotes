...
* **Associated ACAI Concepts:** Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Casting Net (ID: `realia:CastingNet`); Holy (ID: `keyterm:Holy`); Pure (ID: `keyterm:Pure`); ٱلرَّبِّ (ID: `deity:Lord`); Fortification (ID: `realia:Fortification`); Harpoon (ID: `realia:Harpoon`); Chameleon (ID: `fauna:Chameleon`); Fish (ID: `fauna:Fish`); Monitor (ID: `fauna:Iguana`); Lizard (ID: `fauna:Lizard`)
...
* **Associated ACAI Concepts:** Be Disgraced (ID: `keyterm:Disgraced`); لبْنَانَ (ID: `place:Lebanon`); Woe (ID: `keyterm:Woe.2`); Glory (ID: `keyterm:Glory`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Idol (ID: `keyterm:Idol`); Woe (ID: `keyterm:Woe.2`); Trust (ID: `keyterm:LeanOn`); ٱلرَّبِّ (ID: `deity:Lord`); Money (ID: `realia:Money`); Molten Image (ID: `realia:MoltenImage`); Image (ID: `realia:Image`); Graven Image (ID: `realia:GravenImage`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); فَارَانَ (ID: `place:ParanMount`); حَبَقّوق (ID: `person:Habakkuk`); تَيْمَانَ (ID: `place:Teman`); كوشَانَ (ID: `place:Cushan`); Fear (ID: `keyterm:Fear`); Mischief (ID: `keyterm:Mischief`); مِدْيَانَ (ID: `place:Midian`); Oath (ID: `keyterm:Oath`); Anointed (ID: `keyterm:Anointed`); Holy (ID: `keyterm:Holy`); Majesty (ID: `keyterm:Majesty`); Arrow (ID: `keyterm:Arrow`); Deer (ID: `fauna:Deer`); Sheepfold (ID: `realia:Sheepfold`); Olive Tree (ID: `flora:OliveTree`); Flock (ID: `fauna:Flock`); Chariot (ID: `realia:Chariot`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); Tent (ID: `realia:Tent`); Spear (ID: `realia:Spear`); Bow (ID: `realia:Bow`); Animal Pen (ID: `realia:AnimalPen`); Fig (ID: `flora:Fig`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); فَارَانَ (ID: `place:ParanMount`); تَيْمَانَ (ID: `place:Teman`); كوشَانَ (ID: `place:Cushan`); Mischief (ID: `keyterm:Mischief`); مِدْيَانَ (ID: `place:Midian`); Oath (ID: `keyterm:Oath`); Anointed (ID: `keyterm:Anointed`); Holy (ID: `keyterm:Holy`); Majesty (ID: `keyterm:Majesty`); Arrow (ID: `keyterm:Arrow`); ٱلرَّبِّ (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Tent (ID: `realia:Tent`); Spear (ID: `realia:Spear`); Bow (ID: `realia:Bow`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); Anointed (ID: `keyterm:Anointed`); Oath (ID: `keyterm:Oath`); Arrow (ID: `keyterm:Arrow`); ٱلرَّبِّ (ID: `deity:Lord`); Foundation (ID: `realia:Foundation`); Spear (ID: `realia:Spear`); Chariot (ID: `realia:Chariot`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); Salvation (ID: `keyterm:Salvation`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Olive Tree (ID: `flora:OliveTree`); Sheepfold (ID: `realia:Sheepfold`); Cattle (ID: `fauna:Bull`); Animal Pen (ID: `realia:AnimalPen`); Fig (ID: `flora:Fig`); Vine (ID: `flora:Vine`)
