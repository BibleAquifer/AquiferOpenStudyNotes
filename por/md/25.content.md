...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); rebel (ID: `keyterm:Rebel`); Jerusalém (ID: `place:Jerusalem`); love (ID: `keyterm:Love`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); strength (ID: `keyterm:Strength`); To Sin (ID: `keyterm:Sin`); appointed feast (ID: `keyterm:AppointedFeast`); Deceit (ID: `keyterm:Deceit`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Mighty One (ID: `keyterm:MightyOne`); work (ID: `keyterm:Work`); Israel (ID: `person:Israel`); defilement (ID: `keyterm:Defilement`); Train (ID: `realia:Train`); Yoke (ID: `realia:Yoke`); Casting Net (ID: `realia:CastingNet`); Flock (ID: `fauna:Flock`); Net (ID: `realia:Net`); Winepress (ID: `realia:Winepress`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Grass (ID: `flora:Grass`); Deer (ID: `fauna:Deer`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); work (ID: `keyterm:Work`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); SENHOR (ID: `deity:Lord`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Jerusalém (ID: `place:Jerusalem`); defilement (ID: `keyterm:Defilement`); To Sin (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Mighty One (ID: `keyterm:MightyOne`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); horn (ID: `keyterm:Horn`); Sheep (ID: `fauna:Lamb`); Tent (ID: `realia:Tent`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); appointed feast (ID: `keyterm:AppointedFeast`); House (ID: `realia:House`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Pit (ID: `realia:Pit`); comprar (ID: `keyterm:Redeem`); fear (ID: `keyterm:Fear`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** Pit (ID: `realia:Pit`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`); Edom (ID: `place:Edom`); stain (ID: `keyterm:Stain`); Uz (ID: `place:Uz`); Punishment (ID: `keyterm:Punishment`); Appoint (ID: `keyterm:Appoint`); anointed (ID: `keyterm:Anointed`); be kindly disposed (ID: `keyterm:KindlyDisposed`); Sodoma (ID: `place:Sodom`); defilement (ID: `keyterm:Defilement`); Complete (ID: `keyterm:Complete`); Believe In (ID: `keyterm:BelieveIn`); Ostrich (ID: `fauna:Ostrich`); Jackal (ID: `fauna:Jackal`); Clay Jar (ID: `realia:ClayJar`); Vulture (ID: `fauna:Vulture`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** Edom (ID: `place:Edom`); Uz (ID: `place:Uz`); Jerusalém (ID: `place:Jerusalem`); Complete (ID: `keyterm:Complete`); Appoint (ID: `keyterm:Appoint`); ardour (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Complete (ID: `keyterm:Complete`); Appoint (ID: `keyterm:Appoint`); Edom (ID: `place:Edom`); ardour (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); Judá (ID: `group:Judah`); Woe (ID: `keyterm:Woe`); Judá (ID: `person:Judah.4`); round dance (ID: `keyterm:RoundDance`); to cause to possess (ID: `keyterm:Possess`); Assyria (ID: `place:Assyria`); Egito (ID: `place:Egypt`); ardour (ID: `keyterm:Ardour`); House (ID: `realia:House`); Crown (ID: `realia:Crown`); Money (ID: `realia:Money`); Hand-Mill (ID: `realia:Hand-mill`); Jackal (ID: `fauna:Jackal`)
