...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); love (ID: `keyterm:Love`); Edom (ID: `place:Edom`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Priests (ID: `group:GenericPriests`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); fear (ID: `keyterm:Fear`); Covenant (ID: `keyterm:Covenant`); offering (ID: `keyterm:Offering`); Priests (ID: `group:GenericPriests`); utter a curse (ID: `keyterm:Curse`); Glory (ID: `keyterm:Glory`); Levi (ID: `person:Levi.3`); peace (ID: `keyterm:IntactState`); Levi (ID: `group:Levi`); stain (ID: `keyterm:Stain`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); fairness (ID: `keyterm:Fairness`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); pure (ID: `keyterm:Pure`); evil intention (ID: `keyterm:Intention`); rogar (ID: `keyterm:AskFor`); ardour (ID: `keyterm:Ardour`); bless (ID: `keyterm:Bless`); make a vow (ID: `keyterm:Vow`); be kindly disposed (ID: `keyterm:KindlyDisposed`); profane, dishonor (ID: `keyterm:Dishonor`); Truth (ID: `keyterm:Truth`); An Angel (ID: `deity:Angel`); Gentiles (ID: `group:Gentile`); The Way (ID: `keyterm:TheWay`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** make a vow (ID: `keyterm:Vow`); utter a curse (ID: `keyterm:Curse`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); utter a curse (ID: `keyterm:Curse`); bless (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); Covenant (ID: `keyterm:Covenant`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); profane, dishonor (ID: `keyterm:Dishonor`); Judá (ID: `group:Judah`); love (ID: `keyterm:Love`); delight (ID: `keyterm:Delight`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); love (ID: `keyterm:Love`); profane, dishonor (ID: `keyterm:Dishonor`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Jerusalém (ID: `place:Jerusalem`); A Group of People (ID: `group:GenericGroup`); Covenant (ID: `keyterm:Covenant`); Levi (ID: `person:Levi.3`); fear (ID: `keyterm:Fear`); Judá (ID: `group:Judah`); pure (ID: `keyterm:Pure`); Judá (ID: `person:Judah.4`); swear (ID: `keyterm:Swear`); An Angel (ID: `deity:Angel`); Levi (ID: `group:Levi`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); decree (ID: `keyterm:Decree`); utter a curse (ID: `keyterm:Curse`); bless (ID: `keyterm:Bless`); Israel (ID: `person:Israel`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Vine (ID: `flora:Vine`); Sorghum (ID: `flora:Sorghum`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); be enticed to serve (ID: `keyterm:EnticedToServe`); fear (ID: `keyterm:Fear`); Molten Image (ID: `realia:MoltenImage`); Scroll (ID: `realia:Scroll`); Animal Pen (ID: `realia:AnimalPen`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Monte Sinai (ID: `place:SinaiMount`); Moisés (ID: `person:Moses`); decree (ID: `keyterm:Decree`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Monte Sinai (ID: `place:SinaiMount`); Moisés (ID: `person:Moses`); Elias (ID: `person:Elijah`); decree (ID: `keyterm:Decree`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Instruction (ID: `keyterm:Instruction`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`)
