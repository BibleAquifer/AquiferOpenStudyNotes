...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); أورشَلِيمَ (ID: `place:Jerusalem`); Strength (ID: `keyterm:Strength`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Love (ID: `keyterm:Love`); Deceit (ID: `keyterm:Deceit`); To Sin (ID: `keyterm:Sin`); Defilement (ID: `keyterm:Defilement`); Appointed Feast (ID: `keyterm:AppointedFeast`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); إِسْرَائِيلَ (ID: `person:Israel`); Work (ID: `keyterm:Work`); Mighty One (ID: `keyterm:MightyOne`); Train (ID: `realia:Train`); Winepress (ID: `realia:Winepress`); Deer (ID: `fauna:Deer`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Casting Net (ID: `realia:CastingNet`); Yoke (ID: `realia:Yoke`); Net (ID: `realia:Net`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); Defilement (ID: `keyterm:Defilement`); أورشَلِيمَ (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Appointed Feast (ID: `keyterm:AppointedFeast`); Horn (ID: `keyterm:Horn`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Sheep (ID: `fauna:Lamb`); Utterance (ID: `keyterm:Utterance`); Sabbath (ID: `keyterm:Sabbath`); To Dishonor (ID: `keyterm:Dishonor`); Gentiles (ID: `group:Gentile`); Have a Vision (ID: `keyterm:HaveAVision`); Passion (ID: `keyterm:Ardour`); Instruction (ID: `keyterm:Instruction`); Stone Altar (ID: `realia:StoneAltar`); Tent (ID: `realia:Tent`); Grain (ID: `flora:Grain`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`); Bow (ID: `realia:Bow`); Sackcloth (ID: `realia:Sackcloth`); Vine (ID: `flora:Vine`); Altar (ID: `realia:Altar`); Measuring Reed (ID: `realia:MeasuringReed`); Wine (ID: `realia:Wine`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Appointed Feast (ID: `keyterm:AppointedFeast`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); Sabbath (ID: `keyterm:Sabbath`)
...
* **Associated ACAI Concepts:** Appointed Feast (ID: `keyterm:AppointedFeast`); ٱلرَّبِّ (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Complete (ID: `keyterm:Complete`); To Sin (ID: `keyterm:Sin`); Fear (ID: `keyterm:Fear`); Arrow (ID: `keyterm:Arrow`); Rebel (ID: `keyterm:Rebel`); Hope (ID: `keyterm:Hope`); Redeem (ID: `keyterm:Redeem`); Salvation (ID: `keyterm:Salvation`); Peace (ID: `keyterm:IntactState`); Forgive (ID: `keyterm:Forgive`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Wormwood (ID: `flora:Wormwood`); Pit (ID: `realia:Pit`); Arrow (ID: `realia:Arrow`); Bird (ID: `fauna:Bird`); Hewn Stone (ID: `realia:HewnStone`); Bow (ID: `realia:Bow`); Lion (ID: `fauna:Lion`); Bear (ID: `fauna:Bear`); Yoke (ID: `realia:Yoke`); Bitter Herbs (ID: `flora:Chicory`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); ٱلرَّبِّ (ID: `deity:Lord`); أَدومَ (ID: `place:Edom`); To Sin (ID: `keyterm:Sin`); Defile (ID: `keyterm:Stain`); عوصًا (ID: `place:Uz`); Anointed (ID: `keyterm:Anointed`); Appoint (ID: `keyterm:Appoint`); Believe In (ID: `keyterm:BelieveIn`); Complete (ID: `keyterm:Complete`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Punishment (ID: `keyterm:Punishment`); Defilement (ID: `keyterm:Defilement`); سَدومَ (ID: `place:Sodom`); Jackal (ID: `fauna:Jackal`); Ostrich (ID: `fauna:Ostrich`); Clay Jar (ID: `realia:ClayJar`); Vulture (ID: `fauna:Vulture`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** أَدومَ (ID: `place:Edom`); عوصًا (ID: `place:Uz`); أورشَلِيمَ (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); Passion (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); أَدومَ (ID: `place:Edom`); Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); Passion (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); Woe (ID: `keyterm:Woe`); يَهوذَا (ID: `person:Judah.4`); Assyria (ID: `place:Assyria`); Round Dance (ID: `keyterm:RoundDance`); Passion (ID: `keyterm:Ardour`); To Cause to Possess (ID: `keyterm:Possess`); يَهوذَا (ID: `group:Judah`); مِصْرَ (ID: `place:Egypt`); Hand-Mill (ID: `realia:Hand-mill`); Jackal (ID: `fauna:Jackal`); Money (ID: `realia:Money`); Crown (ID: `realia:Crown`); House (ID: `realia:House`)
