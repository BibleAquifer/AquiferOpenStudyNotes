...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Tessalônica (ID: `place:Thessalonica`); Thessalonians (ID: `group:Thessalonica`); Silas (ID: `person:Silas`); Timóteo (ID: `person:Timothy`); igreja (ID: `keyterm:Church`); fazer a paz (ID: `keyterm:Peace`); favor (ID: `keyterm:Favor`); Paulo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); Glory (ID: `keyterm:Glory`); An Angel (ID: `deity:Angel`); juízo (ID: `keyterm:Judgment`); holy (ID: `keyterm:Holy`); ser glorificado (ID: `keyterm:Glorified`); tribunal de justiça (ID: `keyterm:CourtCase`); dever (ID: `keyterm:Ought`); fazer justiça (ID: `keyterm:GrantJustice`); boa notícia (ID: `keyterm:GoodNews`); Ability (ID: `keyterm:Ability`); céu (ID: `keyterm:Heaven`); reino (ID: `keyterm:Kingdom`); igreja (ID: `keyterm:Church`); para a eternidade (ID: `keyterm:Always`); love (ID: `keyterm:Love`); testemunhar (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** reino (ID: `keyterm:Kingdom`); SENHOR (ID: `deity:Lord`); tribunal de justiça (ID: `keyterm:CourtCase`); juízo (ID: `keyterm:Judgment`); be (or show oneself) just (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** An Angel (ID: `deity:Angel`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); céu (ID: `keyterm:Heaven`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); crer (ID: `keyterm:Believe`); Good (ID: `keyterm:Good`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); ser glorificado (ID: `keyterm:Glorified`); To Cause to Happen (ID: `keyterm:Happen`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); Good (ID: `keyterm:Good`); favor (ID: `keyterm:Favor`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); SENHOR (ID: `deity:Lord`); ser glorificado (ID: `keyterm:Glorified`); Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Spirit (ID: `keyterm:Spirit.2`); crer (ID: `keyterm:Believe`); Truth (ID: `keyterm:Truth`); example (ID: `keyterm:Example`); Ability (ID: `keyterm:Ability`); Satanás (ID: `deity:Satan`); objeto de culto (ID: `keyterm:ObjectOfWorship`); injustiça (ID: `keyterm:UnjustDeed`); love (ID: `keyterm:Love`); maravilha (ID: `keyterm:Portent`); decidir (ID: `keyterm:Decided`); rogar (ID: `keyterm:AskFor`); salvation (ID: `keyterm:Salvation`); wipe (out), destroy (ID: `keyterm:Destroy`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); para a eternidade (ID: `keyterm:Always`); Jesus (ID: `person:Jesus.2`); Good (ID: `keyterm:Good`); love (ID: `keyterm:Love`); favor (ID: `keyterm:Favor`); rogar (ID: `keyterm:AskFor`); hope (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); livrar (ID: `keyterm:Deliver`); Faithfulness (ID: `keyterm:Faithfulness`); SENHOR (ID: `deity:Lord`); persuadir (ID: `keyterm:Persuade`); crer (ID: `keyterm:Believe`); love (ID: `keyterm:Love`); Glory (ID: `keyterm:Glory`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); tradição (ID: `keyterm:Teaching`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); Ability (ID: `keyterm:Ability`); autoridade (ID: `keyterm:Authority.2`); rogar (ID: `keyterm:AskFor`)
