...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Carmel (ID: `place:Carmel`); zélé (ID: `keyterm:Zealous.3`); chemin (ID: `keyterm:TheWay`); force (ID: `keyterm:Strength`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Basan (ID: `place:Bashan`); Liban (ID: `place:Lebanon`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); méchanceté (ID: `keyterm:Wickedness`); se réfugier (ID: `keyterm:SeekfindRefuge`); Carmel (ID: `place:Carmel`); zélé (ID: `keyterm:Zealous.3`); chemin (ID: `keyterm:TheWay`); force (ID: `keyterm:Strength`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Basan (ID: `place:Bashan`); Liban (ID: `place:Lebanon`); Strong Drink (ID: `realia:StrongDrink`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** force (ID: `keyterm:Strength`); déclarer innocent (ID: `keyterm:PronounceInnocent`); chemin (ID: `keyterm:TheWay`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); se réfugier (ID: `keyterm:SeekfindRefuge`); méchanceté (ID: `keyterm:Wickedness`); Strong Drink (ID: `realia:StrongDrink`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** état intact (ID: `keyterm:IntactState`); faire un voeu (ID: `keyterm:Vow`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); méchanceté (ID: `keyterm:Wickedness`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); Éternel (ID: `deity:Lord`); Goat (ID: `fauna:Goat`); Chariot (ID: `realia:Chariot`); Grass (ID: `flora:Grass`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** An Angel (ID: `deity:Angel`); Éternel (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Lion (ID: `fauna:Lion`)
...
* **Associated ACAI Concepts:** Cush (ID: `place:Cush.2`); Égypte (ID: `place:Egypt`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); destin (ID: `keyterm:Lot`); Puth (ID: `place:Put`); Libya (ID: `place:Libya`)
