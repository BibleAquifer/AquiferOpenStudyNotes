...
* **Associated ACAI Concepts:** Yakobus (ID: `person:James.3`); Tuhan (ID: `deity:Lord`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** berbahagialah (ID: `keyterm:Happy`); tahan uji (ID: `keyterm:Approved`); kehidupan (ID: `keyterm:Life`); janji (ID: `keyterm:Promise`); kasihi (ID: `keyterm:Love`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); mencobai (ID: `keyterm:PutToTheTest`); berbahagialah (ID: `keyterm:Happy`); kekasih (ID: `keyterm:Beloved`); suci (ID: `keyterm:Clean`); sia, sia (ID: `keyterm:Worthless`); tahan uji (ID: `keyterm:Approved`); hukum (ID: `keyterm:Law`); tak bernoda (ID: `keyterm:AboveCriticism`); yang baik (ID: `keyterm:Good`); A Person (ID: `person:GenericPerson`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kebenaran (ID: `keyterm:Truth`); keahlian (ID: `keyterm:Ability`); tidak dicemarkan (ID: `keyterm:Undefiled`); keselamatan (ID: `keyterm:Salvation`); berbuat dosa (ID: `keyterm:Sin`); kehidupan (ID: `keyterm:Life`); janji (ID: `keyterm:Promise`); tidak dapat dicobai (ID: `keyterm:NotTempted`); kasihi (ID: `keyterm:Love`); hati (ID: `keyterm:Heart`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** mencobai (ID: `keyterm:PutToTheTest`); Tuhan (ID: `deity:Lord`); A Person (ID: `person:GenericPerson`); tidak dapat dicobai (ID: `keyterm:NotTempted`)
...
* **Associated ACAI Concepts:** suci (ID: `keyterm:Clean`); sia, sia (ID: `keyterm:Worthless`); hati (ID: `keyterm:Heart`); tak bernoda (ID: `keyterm:AboveCriticism`); tidak dicemarkan (ID: `keyterm:Undefiled`); Tuhan (ID: `deity:Lord`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); tonton bulu atau muka (ID: `keyterm:Partiality`); Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); bimbang (ID: `keyterm:Discern`); kemuliaan (ID: `keyterm:Glory`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** kasihi (ID: `keyterm:Love`); janji (ID: `keyterm:Promise`); orang pilihan (ID: `keyterm:Chosen`); kerajaan (ID: `keyterm:Kingdom`); kekasih (ID: `keyterm:Beloved`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** kitab suci (ID: `keyterm:Scripture`); kasihi (ID: `keyterm:Love`); hukum (ID: `keyterm:Law`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); tonton bulu atau muka (ID: `keyterm:Partiality`); penghakiman (ID: `keyterm:Judgment`); tersandung (ID: `keyterm:Stumble`); kitab suci (ID: `keyterm:Scripture`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`); pengadilan (ID: `keyterm:CourtCase`); belas kasihan (ID: `keyterm:Mercy`); persundalan (ID: `keyterm:Fornication`); berbuat dosa (ID: `keyterm:Sin`); kasihi (ID: `keyterm:Love`); memutuskan (ID: `keyterm:Decided`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); tubuh (ID: `keyterm:Body.3`); Abraham (ID: `person:Abraham`); A Person (ID: `person:GenericPerson`); Tuhan (ID: `deity:Lord`); Rahab (ID: `person:Rahab`); sia, sia (ID: `keyterm:Idle`); keselamatan (ID: `keyterm:Salvation`); hampa (ID: `keyterm:Empty`); menggenapi (ID: `keyterm:Happen`); kitab suci (ID: `keyterm:Scripture`); An Angel (ID: `deity:Angel`); Demons (ID: `deity:Demons`); roh (ID: `keyterm:Spirit.2`); memperdamaikan (ID: `keyterm:Peace`); Ishak (ID: `person:Isaac`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); Rahab (ID: `person:Rahab`); sia, sia (ID: `keyterm:Idle`); tubuh (ID: `keyterm:Body.3`); hampa (ID: `keyterm:Empty`); menggenapi (ID: `keyterm:Happen`); kitab suci (ID: `keyterm:Scripture`); Tuhan (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Ishak (ID: `person:Isaac`); roh (ID: `keyterm:Spirit.2`)
...
* **Associated ACAI Concepts:** kitab suci (ID: `keyterm:Scripture`); menggenapi (ID: `keyterm:Happen`); Abraham (ID: `person:Abraham`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** tubuh (ID: `keyterm:Body.3`); Hell (ID: `place:Hell`); lalim (ID: `keyterm:UnjustDeed`); neraka (ID: `keyterm:Gehenna`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); tidak setia (ID: `keyterm:Unfaithful`); persahabatan (ID: `keyterm:Friendship`); kitab suci (ID: `keyterm:Scripture`); hati (ID: `keyterm:Heart`); kebaikan (ID: `keyterm:Favor`); ingin (ID: `keyterm:LongFor`); murni (ID: `keyterm:Pure`); Cause of Joy (ID: `keyterm:CauseOfJoy`); roh (ID: `keyterm:Spirit.2`); Roh (ID: `deity:HolySpirit`); membersihkan (ID: `keyterm:Cleanse.2`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Roh (ID: `deity:HolySpirit`); kitab suci (ID: `keyterm:Scripture`); ingin (ID: `keyterm:LongFor`); roh (ID: `keyterm:Spirit.2`)
...
* **Associated ACAI Concepts:** murni (ID: `keyterm:Pure`); Tuhan (ID: `deity:Lord`); membersihkan (ID: `keyterm:Cleanse.2`); hati (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** tubuh (ID: `keyterm:Body.3`); menentang (ID: `keyterm:Condemn`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); bersaksi (ID: `keyterm:BearWitness`); Tuhan (ID: `deity:Lord`); hati (ID: `keyterm:Heart`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** penyayang (ID: `keyterm:Compassionate`); Ayub (ID: `person:Job`); menyebut berbahagia (ID: `keyterm:RegardAsHappy`); Tuhan (ID: `deity:Lord`); penuh belas kasihan (ID: `keyterm:FullOfCompassion`)
...
* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); nama (ID: `keyterm:Name`); jemaat (ID: `keyterm:Church`); diurapi (ID: `keyterm:Anointed`); Tuhan (ID: `deity:Lord`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); keselamatan (ID: `keyterm:Salvation`); percaya (ID: `keyterm:Believe`); mengampuni (ID: `keyterm:Forgive`); berbuat dosa (ID: `keyterm:Sin`); Tuhan (ID: `deity:Lord`)
