...
* **Associated ACAI Concepts:** أَدومَ (ID: `place:Edom`); Peace (ID: `keyterm:IntactState`); Understanding (ID: `keyterm:Understanding`); Edomites (ID: `group:Edom`); Covenant (ID: `keyterm:Covenant`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أَدومَ (ID: `place:Edom`); Understanding (ID: `keyterm:Understanding`); عِيسو (ID: `place:EsauMount`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Lot (ID: `keyterm:Lot`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); يوسف (ID: `person:Joseph.10`); أَدومَ (ID: `place:Edom`); Edomites (ID: `group:Edom`); Dispossess (ID: `keyterm:Dispossess`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** يوسف (ID: `person:Joseph.10`); أَدومَ (ID: `place:Edom`); Edomites (ID: `group:Edom`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); ٱلْجَنوبِ (ID: `place:Negeb`); جِلْعَادَ (ID: `place:Gilead`); أَفْرَايِمَ (ID: `person:Ephraim`); إِلَى (ID: `place:Zarephath`); كَنْعَان (ID: `place:Canaan`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلسَّامِرَةِ (ID: `place:Samaria`); أَفْرَايِمَ (ID: `group:Ephraim`); سَارْدِسَ (ID: `place:Sardis`); Canaanites (ID: `group:Canaan`); عِيسو (ID: `place:EsauMount`); بَنْيَامِينَ (ID: `person:Benjamin`); فِلِشْتِيم (ID: `group:Philistine`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلسَّهْلِ (ID: `place:Shephelah`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); بَنْيَامِينَ (ID: `group:Benjamin`)
...
* **Associated ACAI Concepts:** ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); عِيسو (ID: `place:EsauMount`); أورشَلِيمَ (ID: `place:Jerusalem`); أَفْرَايِمَ (ID: `person:Ephraim`); سَارْدِسَ (ID: `place:Sardis`); فِلِشْتِيم (ID: `group:Philistine`); ٱلسَّهْلِ (ID: `place:Shephelah`); بَنْيَامِينَ (ID: `group:Benjamin`); بَنْيَامِينَ (ID: `person:Benjamin`); أَفْرَايِمَ (ID: `group:Ephraim`); ٱلسَّامِرَةِ (ID: `place:Samaria`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); إِسْرَائِيلَ (ID: `person:Israel`); كَنْعَان (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); إِلَى (ID: `place:Zarephath`); جِلْعَادَ (ID: `place:Gilead`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** إِلَى (ID: `place:Zarephath`); كَنْعَان (ID: `place:Canaan`); ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); سَارْدِسَ (ID: `place:Sardis`); إِسْرَائِيلَ (ID: `person:Israel`); Canaanites (ID: `group:Canaan`); أورشَلِيمَ (ID: `place:Jerusalem`)
