...
* **Associated ACAI Concepts:** Carcas (ID: `person:Carkas`); Harbona (ID: `person:Harbona`); Meumã (ID: `person:Mehuman`); Bigtá (ID: `person:Bigtha`); Abagta (ID: `person:Abagtha`); Bizta (ID: `person:Biztha`); Zetar (ID: `person:Zethar`); Assuero (ID: `person:Ahasuerus`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Vasti (ID: `person:Vashti`); Persians (ID: `group:Persia`); Pérsia (ID: `place:Persia`); Medes (ID: `group:Mede`); Medã (ID: `person:Medan`); Assuero (ID: `person:Ahasuerus`)
...
* **Associated ACAI Concepts:** Jeoaquim (ID: `person:Jehoiachin`); Judá (ID: `person:Judah.4`); Babilônia (ID: `place:Babylon`); Judá (ID: `group:Judah`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Ester (ID: `person:Esther`); love (ID: `keyterm:Love`); kindness (ID: `keyterm:Kindness`); Vasti (ID: `person:Vashti`); favor (ID: `keyterm:Favor`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Assuero (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Agague (ID: `person:Agag.2`); Hamedata (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Jews (ID: `group:Jews`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Zeres (ID: `person:Zeresh`); love (ID: `keyterm:Love`); Ester (ID: `person:Esther`); Glory (ID: `keyterm:Glory`); A Group of People (ID: `group:GenericGroup`); Jews (ID: `group:Jews`); House (ID: `realia:House`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Ester (ID: `person:Esther`); Hamã (ID: `person:Haman`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** Ester (ID: `person:Esther`); Agague (ID: `person:Agag.2`); Hamã (ID: `person:Haman`); Agagites (ID: `group:Agag`); beg for mercy (ID: `keyterm:BegForMercy`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Hamedata (ID: `person:Hammedatha`); Agague (ID: `person:Agag.2`); Hamã (ID: `person:Haman`); Agagites (ID: `group:Agag`); favor (ID: `keyterm:Favor`); Jews (ID: `group:Jews`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** delight (ID: `keyterm:Delight`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Arisai (ID: `person:Arisai`); Aspata (ID: `person:Aspatha`); Vaizata (ID: `person:Vaizatha`); Parsandata (ID: `person:Parshandatha`); Porata (ID: `person:Poratha`); Farmasta (ID: `person:Parmashta`); Aridai (ID: `person:Aridai`); Dalfom (ID: `person:Dalphon`); Adalia (ID: `person:Adalia`); Aridata (ID: `person:Aridatha`); Hamedata (ID: `person:Hammedatha`); Hamã (ID: `person:Haman`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Lot (ID: `realia:Lot`); Hamedata (ID: `person:Hammedatha`); Mordecai (ID: `person:Mordecai.2`); Agague (ID: `person:Agag.2`); Hamã (ID: `person:Haman`); Agagites (ID: `group:Agag`); lot (ID: `keyterm:Lot`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Pérsia (ID: `place:Persia`); Assuero (ID: `person:Ahasuerus`); Media (ID: `place:Media`)
...
* **Associated ACAI Concepts:** peace (ID: `keyterm:IntactState`); Mordecai (ID: `person:Mordecai.2`); Assuero (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`)
