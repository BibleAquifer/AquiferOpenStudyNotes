...
* **Associated ACAI Concepts:** Ephrata (ID: `person:Ephrathah`); Noemi (ID: `person:Naomi`); Efratita (ID: `group:Ephrathah`); Chelión (ID: `person:Chilion`); Judá (ID: `group:Judah`); Mahalón (ID: `person:Mahlon`); Elimelech (ID: `person:Elimelech`); Catah (ID: `place:Bethlehem`); Judá (ID: `person:Judah.4`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Jehová (ID: `deity:Lord`); Appoint (ID: `keyterm:Appoint`)
...
* **Associated ACAI Concepts:** Noemi (ID: `person:Naomi`); Ruth (ID: `person:Ruth`); Catah (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Noemi (ID: `person:Naomi`); favor (ID: `keyterm:Favor`); Ruth (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** bondad (ID: `keyterm:Kindness`); bendecir (ID: `keyterm:Bless`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); Booz (ID: `person:Boaz`); dejar en herencia (ID: `keyterm:Possess`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** dejar en herencia (ID: `keyterm:Possess`); Mahalón (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Elders (ID: `group:GenericElders`); Catah (ID: `place:Bethlehem`); Lea (ID: `person:Leah`); Rachêl (ID: `person:Rachel`); Jehová (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Noemi (ID: `person:Naomi`); bendecir (ID: `keyterm:Bless`); Jehová (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Salmón (ID: `person:Salmon`); Hesrón (ID: `person:Hezron.2`); Obed (ID: `person:Obed`); Aminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Isaí (ID: `person:Jesse`); Booz (ID: `person:Boaz`); Nahasón (ID: `person:Nahshon`); Phares (ID: `person:Perez`); David (ID: `person:David`)
