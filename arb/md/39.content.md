...
* **Associated ACAI Concepts:** Utterance (ID: `keyterm:Utterance`); مَلَاخِي (ID: `person:Malachi`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); أَدومَ (ID: `place:Edom`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** أَدومَ (ID: `place:Edom`); ٱلرَّبِّ (ID: `deity:Lord`); Edomites (ID: `group:Edom`); إِسْرَائِيلَ (ID: `person:Israel`); To Cause to Possess (ID: `keyterm:Possess`); Love (ID: `keyterm:Love`); Jackal (ID: `fauna:Jackal`)
...
* **Associated ACAI Concepts:** Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Fear (ID: `keyterm:Fear`); Priests (ID: `group:GenericPriests`); ٱلرَّبِّ (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`); Fear (ID: `keyterm:Fear`); Offering (ID: `keyterm:Offering`); Peace (ID: `keyterm:IntactState`); To Curse (ID: `keyterm:Curse`); Defile (ID: `keyterm:Stain`); لَّاوِي (ID: `person:Levi.3`); Priests (ID: `group:GenericPriests`); Glory (ID: `keyterm:Glory`); لَّاوِي (ID: `group:Levi`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Fairness (ID: `keyterm:Fairness`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Truth (ID: `keyterm:Truth`); Gentiles (ID: `group:Gentile`); To Dishonor (ID: `keyterm:Dishonor`); Ask for (ID: `keyterm:AskFor`); Bless (ID: `keyterm:Bless`); An Angel (ID: `deity:Angel`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Vow (ID: `keyterm:Vow`); Intention (ID: `keyterm:Intention`); Pure (ID: `keyterm:Pure`); The Way (ID: `keyterm:TheWay`); Passion (ID: `keyterm:Ardour`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Fear (ID: `keyterm:Fear`); To Curse (ID: `keyterm:Curse`); ٱلرَّبِّ (ID: `deity:Lord`); Vow (ID: `keyterm:Vow`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `group:Levi`); Covenant (ID: `keyterm:Covenant`); لَّاوِي (ID: `person:Levi.3`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); To Dishonor (ID: `keyterm:Dishonor`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); An Angel (ID: `deity:Angel`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Fear (ID: `keyterm:Fear`); أورشَلِيمَ (ID: `place:Jerusalem`); A Group of People (ID: `group:GenericGroup`); لَّاوِي (ID: `group:Levi`); Covenant (ID: `keyterm:Covenant`); Swear (ID: `keyterm:Swear`); Pure (ID: `keyterm:Pure`); لَّاوِي (ID: `person:Levi.3`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); To Curse (ID: `keyterm:Curse`); إِسْرَائِيلَ (ID: `person:Israel`); Bless (ID: `keyterm:Bless`); Decree (ID: `keyterm:Decree`); Sorghum (ID: `flora:Sorghum`); Wheat (ID: `flora:Wheat`); Vine (ID: `flora:Vine`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** موسَى (ID: `person:Moses`); إِسْرَائِيلَ (ID: `person:Israel`); سِينَاءَ (ID: `place:SinaiMount`); Instruction (ID: `keyterm:Instruction`); Decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** موسَى (ID: `person:Moses`); Fear (ID: `keyterm:Fear`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); سِينَاءَ (ID: `place:SinaiMount`); Instruction (ID: `keyterm:Instruction`); Decree (ID: `keyterm:Decree`); إِيلِيَّا (ID: `person:Elijah`)
...
* **Associated ACAI Concepts:** Fear (ID: `keyterm:Fear`); ٱلرَّبِّ (ID: `deity:Lord`); إِيلِيَّا (ID: `person:Elijah`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`)
