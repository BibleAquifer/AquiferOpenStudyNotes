...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); أورشَلِيمَ (ID: `place:Jerusalem`); Love (ID: `keyterm:Love`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Strength (ID: `keyterm:Strength`); To Sin (ID: `keyterm:Sin`); Appointed Feast (ID: `keyterm:AppointedFeast`); Deceit (ID: `keyterm:Deceit`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Mighty One (ID: `keyterm:MightyOne`); Work (ID: `keyterm:Work`); إِسْرَائِيلَ (ID: `person:Israel`); Defilement (ID: `keyterm:Defilement`); Train (ID: `realia:Train`); Yoke (ID: `realia:Yoke`); Casting Net (ID: `realia:CastingNet`); Flock (ID: `fauna:Flock`); Net (ID: `realia:Net`); Winepress (ID: `realia:Winepress`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Grass (ID: `flora:Grass`); Deer (ID: `fauna:Deer`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); Work (ID: `keyterm:Work`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); ٱلرَّبِّ (ID: `deity:Lord`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); أورشَلِيمَ (ID: `place:Jerusalem`); Defilement (ID: `keyterm:Defilement`); To Sin (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Appointed Feast (ID: `keyterm:AppointedFeast`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Horn (ID: `keyterm:Horn`); Sheep (ID: `fauna:Lamb`); Sabbath (ID: `keyterm:Sabbath`); Instruction (ID: `keyterm:Instruction`); To Dishonor (ID: `keyterm:Dishonor`); Utterance (ID: `keyterm:Utterance`); Gentiles (ID: `group:Gentile`); Have a Vision (ID: `keyterm:HaveAVision`); Passion (ID: `keyterm:Ardour`); Tent (ID: `realia:Tent`); Stone Altar (ID: `realia:StoneAltar`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Sackcloth (ID: `realia:Sackcloth`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Measuring Reed (ID: `realia:MeasuringReed`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Bow (ID: `realia:Bow`); House (ID: `realia:House`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Horn (ID: `keyterm:Horn`); Sheep (ID: `fauna:Lamb`); Tent (ID: `realia:Tent`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Appointed Feast (ID: `keyterm:AppointedFeast`); House (ID: `realia:House`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Hope (ID: `keyterm:Hope`); Arrow (ID: `keyterm:Arrow`); To Sin (ID: `keyterm:Sin`); Salvation (ID: `keyterm:Salvation`); Rebel (ID: `keyterm:Rebel`); Redeem (ID: `keyterm:Redeem`); Forgive (ID: `keyterm:Forgive`); Complete (ID: `keyterm:Complete`); Peace (ID: `keyterm:IntactState`); Fear (ID: `keyterm:Fear`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Wormwood (ID: `flora:Wormwood`); Arrow (ID: `realia:Arrow`); Pit (ID: `realia:Pit`); Yoke (ID: `realia:Yoke`); Lion (ID: `fauna:Lion`); Bitter Herbs (ID: `flora:Chicory`); Bear (ID: `fauna:Bear`); Bow (ID: `realia:Bow`); Bird (ID: `fauna:Bird`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Pit (ID: `realia:Pit`); Redeem (ID: `keyterm:Redeem`); Fear (ID: `keyterm:Fear`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`); أَدومَ (ID: `place:Edom`); Defile (ID: `keyterm:Stain`); عوصًا (ID: `place:Uz`); Punishment (ID: `keyterm:Punishment`); Appoint (ID: `keyterm:Appoint`); Anointed (ID: `keyterm:Anointed`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); سَدومَ (ID: `place:Sodom`); Defilement (ID: `keyterm:Defilement`); Complete (ID: `keyterm:Complete`); Believe In (ID: `keyterm:BelieveIn`); Ostrich (ID: `fauna:Ostrich`); Jackal (ID: `fauna:Jackal`); Clay Jar (ID: `realia:ClayJar`); Vulture (ID: `fauna:Vulture`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** أَدومَ (ID: `place:Edom`); عوصًا (ID: `place:Uz`); أورشَلِيمَ (ID: `place:Jerusalem`); Complete (ID: `keyterm:Complete`); Appoint (ID: `keyterm:Appoint`); Passion (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Complete (ID: `keyterm:Complete`); Appoint (ID: `keyterm:Appoint`); أَدومَ (ID: `place:Edom`); Passion (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); يَهوذَا (ID: `group:Judah`); Woe (ID: `keyterm:Woe`); يَهوذَا (ID: `person:Judah.4`); Round Dance (ID: `keyterm:RoundDance`); To Cause to Possess (ID: `keyterm:Possess`); Assyria (ID: `place:Assyria`); مِصْرَ (ID: `place:Egypt`); Passion (ID: `keyterm:Ardour`); House (ID: `realia:House`); Crown (ID: `realia:Crown`); Money (ID: `realia:Money`); Hand-Mill (ID: `realia:Hand-mill`); Jackal (ID: `fauna:Jackal`)
