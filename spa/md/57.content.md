...
* **Associated ACAI Concepts:** Filemón (ID: `person:Philemon`); Pablo (ID: `person:Paul`); amado (ID: `keyterm:Beloved`); Jesús (ID: `person:Jesus.2`); Timoteo (ID: `person:Timothy`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Archîpo (ID: `person:Archippus`); Apphia (ID: `person:Apphia`); Filemón (ID: `person:Philemon`); Pablo (ID: `person:Paul`); amado (ID: `keyterm:Beloved`); Jehová (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); hacer la paz (ID: `keyterm:Peace`); Timoteo (ID: `person:Timothy`); iglesia (ID: `keyterm:Church`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** creer (ID: `keyterm:Believe`); santo (ID: `keyterm:Holy`); amar (ID: `keyterm:Love`); Jesús (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); Jehová (ID: `deity:Lord`); comunión (ID: `keyterm:Fellowship`); Cause of Joy (ID: `keyterm:CauseOfJoy`); entrañas (ID: `keyterm:Affection`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Demas (ID: `person:Demas`); Epafras (ID: `person:Epaphras`); Lucas (ID: `person:Luke`); cristo (ID: `keyterm:InChrist`); Marcos (ID: `person:Mark`); Aristarco (ID: `person:Aristarchus`); favor (ID: `keyterm:Favor`); espíritu (ID: `keyterm:Spirit.2`)
