...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); amado (ID: `keyterm:Beloved`); andar (ID: `keyterm:Live.3`); Gaio (ID: `person:Gaius.4`); love (ID: `keyterm:Love`); orar (ID: `keyterm:Pray`); Cause of Joy (ID: `keyterm:CauseOfJoy`); testemunhar (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** amado (ID: `keyterm:Beloved`); Name (ID: `keyterm:Name`); Truth (ID: `keyterm:Truth`); igreja (ID: `keyterm:Church`); love (ID: `keyterm:Love`); dever (ID: `keyterm:Ought`); Faithfulness (ID: `keyterm:Faithfulness`); testemunhar (ID: `keyterm:BearWitness`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** igreja (ID: `keyterm:Church`); Demétrio (ID: `person:Demetrius`); Diótrefes (ID: `person:Diotrephes`); Do Good (ID: `keyterm:DoGood`); amado (ID: `keyterm:Beloved`); verdadeiro (ID: `keyterm:True`); Truth (ID: `keyterm:Truth`); Good (ID: `keyterm:Good`); testemunhar (ID: `keyterm:BearWitness`); SENHOR (ID: `deity:Lord`)
