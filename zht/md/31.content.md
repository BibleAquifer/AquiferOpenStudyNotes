...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); Edom (ID: `place:Edom`); Understanding (ID: `keyterm:Understanding`); Covenant (ID: `keyterm:Covenant`); Peace (ID: `keyterm:IntactState`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Jerusalem (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Lot (ID: `keyterm:Lot`)
...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); Edom (ID: `place:Edom`); LORD (ID: `deity:Lord`); Joseph (ID: `person:Joseph.10`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); Negev (ID: `place:Negeb`); Gilead (ID: `place:Gilead`); Tribe of Benjamin (ID: `group:Benjamin`); Benjamin (ID: `person:Benjamin`); Jerusalem (ID: `place:Jerusalem`); Zarephath (ID: `place:Zarephath`); Canaanites (ID: `group:Canaan`); Samaria (ID: `place:Samaria`); Shephelah (ID: `place:Shephelah`); Israel (ID: `person:Israel`); Canaan (ID: `place:Canaan`); Philistia (ID: `place:Philistine`); Tribe of Ephraim (ID: `group:Ephraim`); Ephraim (ID: `person:Ephraim`); Mount Esau (ID: `place:EsauMount`); Philistines (ID: `group:Philistine`); Sardis (ID: `place:Sardis`)
...
* **Associated ACAI Concepts:** Negev (ID: `place:Negeb`); Jerusalem (ID: `place:Jerusalem`); Dispossess (ID: `keyterm:Dispossess`); Mount Esau (ID: `place:EsauMount`); Canaanites (ID: `group:Canaan`); Ephraim (ID: `person:Ephraim`); Sardis (ID: `place:Sardis`); Gilead (ID: `place:Gilead`); Benjamin (ID: `person:Benjamin`); Samaria (ID: `place:Samaria`); LORD (ID: `deity:Lord`); Canaan (ID: `place:Canaan`); Philistines (ID: `group:Philistine`); Zarephath (ID: `place:Zarephath`); Israel (ID: `person:Israel`); Tribe of Benjamin (ID: `group:Benjamin`); Shephelah (ID: `place:Shephelah`); Philistia (ID: `place:Philistine`); Tribe of Ephraim (ID: `group:Ephraim`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Zarephath (ID: `place:Zarephath`); Dispossess (ID: `keyterm:Dispossess`); Negev (ID: `place:Negeb`); Canaanites (ID: `group:Canaan`); Israel (ID: `person:Israel`); Canaan (ID: `place:Canaan`); Sardis (ID: `place:Sardis`)
