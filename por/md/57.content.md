...
* **Associated ACAI Concepts:** Filemom (ID: `person:Philemon`); Jesus (ID: `person:Jesus.2`); Paulo (ID: `person:Paul`); amado (ID: `keyterm:Beloved`); Timóteo (ID: `person:Timothy`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Arquipo (ID: `person:Archippus`); Áfia (ID: `person:Apphia`); Filemom (ID: `person:Philemon`); igreja (ID: `keyterm:Church`); favor (ID: `keyterm:Favor`); Paulo (ID: `person:Paul`); fazer a paz (ID: `keyterm:Peace`); amado (ID: `keyterm:Beloved`); SENHOR (ID: `deity:Lord`); Timóteo (ID: `person:Timothy`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); holy (ID: `keyterm:Holy`); love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`); compaixão (ID: `keyterm:Affection`); Good (ID: `keyterm:Good`); comunhão (ID: `keyterm:Fellowship`); Cause of Joy (ID: `keyterm:CauseOfJoy`); SENHOR (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Paulo (ID: `person:Paul`); love (ID: `keyterm:Love`); em cristo (ID: `keyterm:InChrist`); rogar (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Demas (ID: `person:Demas`); Epafras (ID: `person:Epaphras`); Lucas (ID: `person:Luke`); Spirit (ID: `keyterm:Spirit.2`); favor (ID: `keyterm:Favor`); Marcos (ID: `person:Mark`); Aristarco (ID: `person:Aristarchus`); em cristo (ID: `keyterm:InChrist`)
