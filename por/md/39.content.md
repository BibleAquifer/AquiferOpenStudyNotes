...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); Edom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); fear (ID: `keyterm:Fear`); Covenant (ID: `keyterm:Covenant`); offering (ID: `keyterm:Offering`); peace (ID: `keyterm:IntactState`); Priests (ID: `group:GenericPriests`); Glory (ID: `keyterm:Glory`); stain (ID: `keyterm:Stain`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); utter a curse (ID: `keyterm:Curse`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); fairness (ID: `keyterm:Fairness`); bless (ID: `keyterm:Bless`); Truth (ID: `keyterm:Truth`); evil intention (ID: `keyterm:Intention`); Gentiles (ID: `group:Gentile`); An Angel (ID: `deity:Angel`); ardour (ID: `keyterm:Ardour`); The Way (ID: `keyterm:TheWay`); pure (ID: `keyterm:Pure`); make a vow (ID: `keyterm:Vow`); be kindly disposed (ID: `keyterm:KindlyDisposed`); rogar (ID: `keyterm:AskFor`); profane, dishonor (ID: `keyterm:Dishonor`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** stain (ID: `keyterm:Stain`); SENHOR (ID: `deity:Lord`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); profane, dishonor (ID: `keyterm:Dishonor`); offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); love (ID: `keyterm:Love`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); delight (ID: `keyterm:Delight`); Judá (ID: `person:Judah.4`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); profane, dishonor (ID: `keyterm:Dishonor`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Jerusalém (ID: `place:Jerusalem`); fear (ID: `keyterm:Fear`); Judá (ID: `group:Judah`); An Angel (ID: `deity:Angel`); swear (ID: `keyterm:Swear`); Levi (ID: `person:Levi.3`); pure (ID: `keyterm:Pure`); Judá (ID: `person:Judah.4`); A Group of People (ID: `group:GenericGroup`); Levi (ID: `group:Levi`); Covenant (ID: `keyterm:Covenant`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); bless (ID: `keyterm:Bless`); Israel (ID: `person:Israel`); utter a curse (ID: `keyterm:Curse`); decree (ID: `keyterm:Decree`); offering (ID: `keyterm:Offering`); Wheat (ID: `flora:Wheat`); House (ID: `realia:House`); Sorghum (ID: `flora:Sorghum`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); be enticed to serve (ID: `keyterm:EnticedToServe`); fear (ID: `keyterm:Fear`); Animal Pen (ID: `realia:AnimalPen`); Scroll (ID: `realia:Scroll`); Molten Image (ID: `realia:MoltenImage`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Monte Sinai (ID: `place:SinaiMount`); decree (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`); Moisés (ID: `person:Moses`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); fear (ID: `keyterm:Fear`); Monte Sinai (ID: `place:SinaiMount`); Elias (ID: `person:Elijah`); decree (ID: `keyterm:Decree`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`); Instruction (ID: `keyterm:Instruction`); Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`)
