...
* **Associated ACAI Concepts:** Covenant (ID: `keyterm:Covenant`); Peace (ID: `keyterm:IntactState`); Understanding (ID: `keyterm:Understanding`); أَدومَ (ID: `place:Edom`); Edomites (ID: `group:Edom`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); Lot (ID: `keyterm:Lot`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); يوسف (ID: `person:Joseph.10`); Dispossess (ID: `keyterm:Dispossess`); أورشَلِيمَ (ID: `place:Jerusalem`); أَدومَ (ID: `place:Edom`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); يوسف (ID: `person:Joseph.10`); ٱلرَّبِّ (ID: `deity:Lord`); أَدومَ (ID: `place:Edom`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); ٱلْجَنوبِ (ID: `place:Negeb`); أَفْرَايِمَ (ID: `group:Ephraim`); ٱلسَّامِرَةِ (ID: `place:Samaria`); جِلْعَادَ (ID: `place:Gilead`); كَنْعَان (ID: `place:Canaan`); ٱلسَّهْلِ (ID: `place:Shephelah`); إِسْرَائِيلَ (ID: `person:Israel`); فِلِشْتِيم (ID: `group:Philistine`); إِلَى (ID: `place:Zarephath`); سَارْدِسَ (ID: `place:Sardis`); Canaanites (ID: `group:Canaan`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `person:Benjamin`); عِيسو (ID: `place:EsauMount`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); بَنْيَامِينَ (ID: `group:Benjamin`); أَفْرَايِمَ (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** عِيسو (ID: `place:EsauMount`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); كَنْعَان (ID: `place:Canaan`); بَنْيَامِينَ (ID: `person:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); ٱلسَّامِرَةِ (ID: `place:Samaria`); جِلْعَادَ (ID: `place:Gilead`); ٱلسَّهْلِ (ID: `place:Shephelah`); إِسْرَائِيلَ (ID: `person:Israel`); بَنْيَامِينَ (ID: `group:Benjamin`); أَفْرَايِمَ (ID: `person:Ephraim`); Canaanites (ID: `group:Canaan`); سَارْدِسَ (ID: `place:Sardis`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); أَفْرَايِمَ (ID: `group:Ephraim`); فِلِشْتِيم (ID: `group:Philistine`); إِلَى (ID: `place:Zarephath`)
...
* **Associated ACAI Concepts:** كَنْعَان (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); إِسْرَائِيلَ (ID: `person:Israel`); إِلَى (ID: `place:Zarephath`); سَارْدِسَ (ID: `place:Sardis`); Dispossess (ID: `keyterm:Dispossess`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْجَنوبِ (ID: `place:Negeb`)
