...
* **Associated ACAI Concepts:** Utterance (ID: `keyterm:Utterance`); Malaquias (ID: `person:Malachi`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** Edom (ID: `place:Edom`); SENHOR (ID: `deity:Lord`); Edomites (ID: `group:Edom`); Israel (ID: `person:Israel`); to cause to possess (ID: `keyterm:Possess`); love (ID: `keyterm:Love`); Jackal (ID: `fauna:Jackal`)
...
* **Associated ACAI Concepts:** being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); fear (ID: `keyterm:Fear`); Priests (ID: `group:GenericPriests`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`); fear (ID: `keyterm:Fear`); offering (ID: `keyterm:Offering`); peace (ID: `keyterm:IntactState`); utter a curse (ID: `keyterm:Curse`); stain (ID: `keyterm:Stain`); Levi (ID: `person:Levi.3`); Priests (ID: `group:GenericPriests`); Glory (ID: `keyterm:Glory`); Levi (ID: `group:Levi`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); fairness (ID: `keyterm:Fairness`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Truth (ID: `keyterm:Truth`); Gentiles (ID: `group:Gentile`); profane, dishonor (ID: `keyterm:Dishonor`); rogar (ID: `keyterm:AskFor`); bless (ID: `keyterm:Bless`); An Angel (ID: `deity:Angel`); be kindly disposed (ID: `keyterm:KindlyDisposed`); make a vow (ID: `keyterm:Vow`); evil intention (ID: `keyterm:Intention`); pure (ID: `keyterm:Pure`); The Way (ID: `keyterm:TheWay`); ardour (ID: `keyterm:Ardour`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); stain (ID: `keyterm:Stain`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** fear (ID: `keyterm:Fear`); utter a curse (ID: `keyterm:Curse`); SENHOR (ID: `deity:Lord`); make a vow (ID: `keyterm:Vow`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Levi (ID: `group:Levi`); Covenant (ID: `keyterm:Covenant`); Levi (ID: `person:Levi.3`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); profane, dishonor (ID: `keyterm:Dishonor`); offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); love (ID: `keyterm:Love`); delight (ID: `keyterm:Delight`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); profane, dishonor (ID: `keyterm:Dishonor`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); An Angel (ID: `deity:Angel`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); fear (ID: `keyterm:Fear`); Jerusalém (ID: `place:Jerusalem`); A Group of People (ID: `group:GenericGroup`); Levi (ID: `group:Levi`); Covenant (ID: `keyterm:Covenant`); swear (ID: `keyterm:Swear`); pure (ID: `keyterm:Pure`); Levi (ID: `person:Levi.3`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); utter a curse (ID: `keyterm:Curse`); Israel (ID: `person:Israel`); bless (ID: `keyterm:Bless`); decree (ID: `keyterm:Decree`); Sorghum (ID: `flora:Sorghum`); Wheat (ID: `flora:Wheat`); Vine (ID: `flora:Vine`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Moisés (ID: `person:Moses`); Israel (ID: `person:Israel`); Monte Sinai (ID: `place:SinaiMount`); Instruction (ID: `keyterm:Instruction`); decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** Moisés (ID: `person:Moses`); fear (ID: `keyterm:Fear`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`); Monte Sinai (ID: `place:SinaiMount`); Instruction (ID: `keyterm:Instruction`); decree (ID: `keyterm:Decree`); Elias (ID: `person:Elijah`)
...
* **Associated ACAI Concepts:** fear (ID: `keyterm:Fear`); SENHOR (ID: `deity:Lord`); Elias (ID: `person:Elijah`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`)
