...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`); fear (ID: `keyterm:Fear`); offering (ID: `keyterm:Offering`); Levi (ID: `person:Levi.3`); Priests (ID: `group:GenericPriests`); peace (ID: `keyterm:IntactState`); Levi (ID: `group:Levi`); stain (ID: `keyterm:Stain`); utter a curse (ID: `keyterm:Curse`); Glory (ID: `keyterm:Glory`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); fairness (ID: `keyterm:Fairness`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); evil intention (ID: `keyterm:Intention`); profane, dishonor (ID: `keyterm:Dishonor`); The Way (ID: `keyterm:TheWay`); be kindly disposed (ID: `keyterm:KindlyDisposed`); An Angel (ID: `deity:Angel`); pure (ID: `keyterm:Pure`); rogar (ID: `keyterm:AskFor`); make a vow (ID: `keyterm:Vow`); Gentiles (ID: `group:Gentile`); Truth (ID: `keyterm:Truth`); bless (ID: `keyterm:Bless`); ardour (ID: `keyterm:Ardour`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** stain (ID: `keyterm:Stain`); SENHOR (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** utter a curse (ID: `keyterm:Curse`); SENHOR (ID: `deity:Lord`); bless (ID: `keyterm:Bless`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); SENHOR (ID: `deity:Lord`); Levi (ID: `group:Levi`); Covenant (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Covenant (ID: `keyterm:Covenant`); offering (ID: `keyterm:Offering`); profane, dishonor (ID: `keyterm:Dishonor`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); love (ID: `keyterm:Love`); delight (ID: `keyterm:Delight`); Jerusalém (ID: `place:Jerusalem`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); profane, dishonor (ID: `keyterm:Dishonor`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); swear (ID: `keyterm:Swear`); An Angel (ID: `deity:Angel`); Judá (ID: `person:Judah.4`); Levi (ID: `group:Levi`); pure (ID: `keyterm:Pure`); A Group of People (ID: `group:GenericGroup`); fear (ID: `keyterm:Fear`); Judá (ID: `group:Judah`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); Soap (ID: `realia:Soap`); Hammada (ID: `flora:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); bless (ID: `keyterm:Bless`); utter a curse (ID: `keyterm:Curse`); decree (ID: `keyterm:Decree`); Wheat (ID: `flora:Wheat`); Vine (ID: `flora:Vine`); Sorghum (ID: `flora:Sorghum`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); be enticed to serve (ID: `keyterm:EnticedToServe`); fear (ID: `keyterm:Fear`); Cattle (ID: `fauna:Bull`); Animal Pen (ID: `realia:AnimalPen`); Molten Image (ID: `realia:MoltenImage`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); Monte Sinai (ID: `place:SinaiMount`); decree (ID: `keyterm:Decree`); Moisés (ID: `person:Moses`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); Monte Sinai (ID: `place:SinaiMount`); decree (ID: `keyterm:Decree`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`); Elias (ID: `person:Elijah`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Moisés (ID: `person:Moses`)
...
* **Associated ACAI Concepts:** Elias (ID: `person:Elijah`); fear (ID: `keyterm:Fear`); SENHOR (ID: `deity:Lord`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`)
