...
* **Associated ACAI Concepts:** berbahagialah (ID: `keyterm:Happy`); tahan uji (ID: `keyterm:Approved`); janji (ID: `keyterm:Promise`); kasihi (ID: `keyterm:Love`); kehidupan (ID: `keyterm:Life`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); mencobai (ID: `keyterm:PutToTheTest`); berbahagialah (ID: `keyterm:Happy`); kekasih (ID: `keyterm:Beloved`); suci (ID: `keyterm:Clean`); tahan uji (ID: `keyterm:Approved`); sia, sia (ID: `keyterm:Worthless`); kebenaran (ID: `keyterm:Truth`); tidak dapat dicobai (ID: `keyterm:NotTempted`); hati (ID: `keyterm:Heart`); keselamatan (ID: `keyterm:Salvation`); A Person (ID: `person:GenericPerson`); tak bernoda (ID: `keyterm:AboveCriticism`); tidak dicemarkan (ID: `keyterm:Undefiled`); keahlian (ID: `keyterm:Ability`); berbuat dosa (ID: `keyterm:Sin`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); janji (ID: `keyterm:Promise`); hukum (ID: `keyterm:Law`); yang baik (ID: `keyterm:Good`); kehidupan (ID: `keyterm:Life`); kasihi (ID: `keyterm:Love`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** suci (ID: `keyterm:Clean`); sia, sia (ID: `keyterm:Worthless`); tak bernoda (ID: `keyterm:AboveCriticism`); hati (ID: `keyterm:Heart`); keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`); tidak dicemarkan (ID: `keyterm:Undefiled`)
...
* **Associated ACAI Concepts:** janji (ID: `keyterm:Promise`); keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`); percaya (ID: `keyterm:Believe`); orang pilihan (ID: `keyterm:Chosen`); kekasih (ID: `keyterm:Beloved`); kerajaan (ID: `keyterm:Kingdom`); kasihi (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); penghakiman (ID: `keyterm:Judgment`); tonton bulu atau muka (ID: `keyterm:Partiality`); tersandung (ID: `keyterm:Stumble`); pengadilan (ID: `keyterm:CourtCase`); kitab suci (ID: `keyterm:Scripture`); berbuat dosa (ID: `keyterm:Sin`); kasihi (ID: `keyterm:Love`); belas kasihan (ID: `keyterm:Mercy`); memutuskan (ID: `keyterm:Decided`); persundalan (ID: `keyterm:Fornication`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); Tuhan (ID: `deity:Lord`); A Person (ID: `person:GenericPerson`); tubuh (ID: `keyterm:Body.3`); sia, sia (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); roh (ID: `keyterm:Spirit.2`); An Angel (ID: `deity:Angel`); kitab suci (ID: `keyterm:Scripture`); Ishak (ID: `person:Isaac`); memperdamaikan (ID: `keyterm:Peace`); keselamatan (ID: `keyterm:Salvation`); hampa (ID: `keyterm:Empty`); menggenapi (ID: `keyterm:Happen`); Demons (ID: `deity:Demons`)
...
* **Associated ACAI Concepts:** Abraham (ID: `person:Abraham`); kitab suci (ID: `keyterm:Scripture`); Tuhan (ID: `deity:Lord`); percaya (ID: `keyterm:Believe`); menggenapi (ID: `keyterm:Happen`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** Hell (ID: `place:Hell`); keahlian (ID: `keyterm:Ability`); neraka (ID: `keyterm:Gehenna`); tubuh (ID: `keyterm:Body.3`); lalim (ID: `keyterm:UnjustDeed`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); persahabatan (ID: `keyterm:Friendship`); tidak setia (ID: `keyterm:Unfaithful`); roh (ID: `keyterm:Spirit.2`); hati (ID: `keyterm:Heart`); kitab suci (ID: `keyterm:Scripture`); keahlian (ID: `keyterm:Ability`); kebaikan (ID: `keyterm:Favor`); Roh (ID: `deity:HolySpirit`); ingin (ID: `keyterm:LongFor`); membersihkan (ID: `keyterm:Cleanse.2`); murni (ID: `keyterm:Pure`); Cause of Joy (ID: `keyterm:CauseOfJoy`)
...
* **Associated ACAI Concepts:** roh (ID: `keyterm:Spirit.2`); Roh (ID: `deity:HolySpirit`); kitab suci (ID: `keyterm:Scripture`); ingin (ID: `keyterm:LongFor`)
...
* **Associated ACAI Concepts:** hati (ID: `keyterm:Heart`); bersaksi (ID: `keyterm:BearWitness`); Tuhan (ID: `deity:Lord`); menentang (ID: `keyterm:Condemn`); tubuh (ID: `keyterm:Body.3`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** diurapi (ID: `keyterm:Anointed`); Tuhan (ID: `deity:Lord`); nama (ID: `keyterm:Name`); berdoa (ID: `keyterm:Pray`); jemaat (ID: `keyterm:Church`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); percaya (ID: `keyterm:Believe`); mengampuni (ID: `keyterm:Forgive`); berbuat dosa (ID: `keyterm:Sin`); keselamatan (ID: `keyterm:Salvation`); berdoa (ID: `keyterm:Pray`)
