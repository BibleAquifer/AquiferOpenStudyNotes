...
* **Associated ACAI Concepts:** Ephrathites (ID: `group:Ephrathah`); Efrata (ID: `person:Ephrathah`); Mahlon (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Yehuda (ID: `person:Judah.4`); Moab (ID: `place:Moab`); Yehuda (ID: `group:Judah`); Mahlon (ID: `person:Mahlon`); Betlehem (ID: `place:Bethlehem`); Elimelekh (ID: `person:Elimelech`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); Rut (ID: `person:Ruth`); Betlehem (ID: `place:Bethlehem`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Rut (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); Moab (ID: `place:Moab`); kebaikan (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** memberkati (ID: `keyterm:Bless`); Tuhan (ID: `deity:Lord`); Naomi (ID: `person:Naomi`); kebaikan (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** Rut (ID: `person:Ruth`); menyebabkan memiliki (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Boas (ID: `person:Boaz`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Lea (ID: `person:Leah`); Tuhan (ID: `deity:Lord`); Israel (ID: `person:Israel`); Elders (ID: `group:GenericElders`); Rahel (ID: `person:Rachel`); Betlehem (ID: `place:Bethlehem`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yehuda (ID: `person:Judah.4`); Yehuda (ID: `group:Judah`); Peres (ID: `person:Perez`); Tamar (ID: `person:Tamar`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Tuhan (ID: `deity:Lord`); Israel (ID: `person:Israel`); Naomi (ID: `person:Naomi`); memberkati (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); memperanakkan (ID: `person:Salmon`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Boas (ID: `person:Boaz`); Daud (ID: `person:David`); Peres (ID: `person:Perez`); Nahason (ID: `person:Nahshon`); Isai (ID: `person:Jesse`)
