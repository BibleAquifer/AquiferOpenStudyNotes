...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Tessalônica (ID: `place:Thessalonica`); Thessalonians (ID: `group:Thessalonica`); favor (ID: `keyterm:Favor`); igreja (ID: `keyterm:Church`); fazer a paz (ID: `keyterm:Peace`); Timóteo (ID: `person:Timothy`); Silas (ID: `person:Silas`); Paulo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); be (or show oneself) just (ID: `keyterm:Just`); Ability (ID: `keyterm:Ability`); fazer justiça (ID: `keyterm:GrantJustice`); ser glorificado (ID: `keyterm:Glorified`); love (ID: `keyterm:Love`); céu (ID: `keyterm:Heaven`); boa notícia (ID: `keyterm:GoodNews`); holy (ID: `keyterm:Holy`); testemunhar (ID: `keyterm:BearWitness`); tribunal de justiça (ID: `keyterm:CourtCase`); reino (ID: `keyterm:Kingdom`); An Angel (ID: `deity:Angel`); para a eternidade (ID: `keyterm:Always`); juízo (ID: `keyterm:Judgment`); dever (ID: `keyterm:Ought`); Glory (ID: `keyterm:Glory`); igreja (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** reino (ID: `keyterm:Kingdom`); juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`); be (or show oneself) just (ID: `keyterm:Just`); tribunal de justiça (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** Good (ID: `keyterm:Good`); To Cause to Happen (ID: `keyterm:Happen`); crer (ID: `keyterm:Believe`); orar (ID: `keyterm:Pray`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Good (ID: `keyterm:Good`); crer (ID: `keyterm:Believe`); favor (ID: `keyterm:Favor`); To Cause to Happen (ID: `keyterm:Happen`); Name (ID: `keyterm:Name`); Jesus (ID: `person:Jesus.2`); orar (ID: `keyterm:Pray`); ser glorificado (ID: `keyterm:Glorified`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); Spirit (ID: `keyterm:Spirit.2`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); injustiça (ID: `keyterm:UnjustDeed`); love (ID: `keyterm:Love`); Satanás (ID: `deity:Satan`); maravilha (ID: `keyterm:Portent`); wipe (out), destroy (ID: `keyterm:Destroy`); objeto de culto (ID: `keyterm:ObjectOfWorship`); decidir (ID: `keyterm:Decided`); rogar (ID: `keyterm:AskFor`); example (ID: `keyterm:Example`); Ability (ID: `keyterm:Ability`); salvation (ID: `keyterm:Salvation`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); example (ID: `keyterm:Example`); maravilha (ID: `keyterm:Portent`); Satanás (ID: `deity:Satan`)
...
* **Associated ACAI Concepts:** Good (ID: `keyterm:Good`); love (ID: `keyterm:Love`); favor (ID: `keyterm:Favor`); para a eternidade (ID: `keyterm:Always`); Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); SENHOR (ID: `deity:Lord`); hope (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); love (ID: `keyterm:Love`); livrar (ID: `keyterm:Deliver`); Glory (ID: `keyterm:Glory`); crer (ID: `keyterm:Believe`); Faithfulness (ID: `keyterm:Faithfulness`); persuadir (ID: `keyterm:Persuade`); orar (ID: `keyterm:Pray`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); coração (ID: `keyterm:Heart`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); andar (ID: `keyterm:Live.3`); tradição (ID: `keyterm:Teaching`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); Name (ID: `keyterm:Name`); rogar (ID: `keyterm:AskFor`); Ability (ID: `keyterm:Ability`); autoridade (ID: `keyterm:Authority.2`)
