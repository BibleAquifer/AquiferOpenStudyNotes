...
* **Associated ACAI Concepts:** Édom (ID: `group:Edom`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Édom (ID: `place:Edom`); aimer (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); alliance (ID: `keyterm:Covenant`); craindre (ID: `keyterm:Fear`); offrande (ID: `keyterm:Offering`); gloire (ID: `keyterm:Glory`); état intact (ID: `keyterm:IntactState`); souiller (ID: `keyterm:Stain`); Priests (ID: `group:GenericPriests`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`); pleurer (ID: `keyterm:Curse`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); niveau (ID: `keyterm:Fairness`); la connaissance (ID: `keyterm:Intention`); sans saleté (ID: `keyterm:Pure`); chemin (ID: `keyterm:TheWay`); benir (ID: `keyterm:Bless`); agir avec bonté (ID: `keyterm:KindlyDisposed`); profaner, déshonorer (ID: `keyterm:Dishonor`); ardeur (ID: `keyterm:Ardour`); faire un voeu (ID: `keyterm:Vow`); vérité (ID: `keyterm:Truth`); prier (ID: `keyterm:AskFor`); An Angel (ID: `deity:Angel`); nation; peuple (ID: `group:Gentile`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); souiller (ID: `keyterm:Stain`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** An Angel (ID: `deity:Angel`); la connaissance (ID: `keyterm:Intention`); Instruction (ID: `keyterm:Instruction`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); profaner, déshonorer (ID: `keyterm:Dishonor`); offrande (ID: `keyterm:Offering`); alliance (ID: `keyterm:Covenant`); Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`); aimer (ID: `keyterm:Love`); délice (ID: `keyterm:Delight`); Juda (ID: `person:Judah.4`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** profaner, déshonorer (ID: `keyterm:Dishonor`); Éternel (ID: `deity:Lord`); Juda (ID: `group:Judah`); Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`); aimer (ID: `keyterm:Love`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); offrande (ID: `keyterm:Offering`); A Group of People (ID: `group:GenericGroup`); jurer (ID: `keyterm:Swear`); sans saleté (ID: `keyterm:Pure`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`); An Angel (ID: `deity:Angel`); Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`); alliance (ID: `keyterm:Covenant`); Juda (ID: `person:Judah.4`); craindre (ID: `keyterm:Fear`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); limite (ID: `keyterm:Decree`); offrande (ID: `keyterm:Offering`); pleurer (ID: `keyterm:Curse`); benir (ID: `keyterm:Bless`); Israël (ID: `person:Israel`); House (ID: `realia:House`); Sorghum (ID: `flora:Sorghum`); Vine (ID: `flora:Vine`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** limite (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`); Élie (ID: `person:Elijah`); Moïse (ID: `person:Moses`); Éternel (ID: `deity:Lord`); objet qui doit être détruit (ID: `keyterm:SomethingDevotedToGod`); Israël (ID: `person:Israel`); montagne de Sinaï (ID: `place:SinaiMount`); craindre (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); objet qui doit être détruit (ID: `keyterm:SomethingDevotedToGod`); Élie (ID: `person:Elijah`); craindre (ID: `keyterm:Fear`)
