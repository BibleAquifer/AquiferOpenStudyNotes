...
* **Associated ACAI Concepts:** Peace (ID: `keyterm:IntactState`); Understanding (ID: `keyterm:Understanding`); Covenant (ID: `keyterm:Covenant`); أَدومَ (ID: `place:Edom`); Edomites (ID: `group:Edom`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** Understanding (ID: `keyterm:Understanding`); عِيسو (ID: `place:EsauMount`); ٱلرَّبِّ (ID: `deity:Lord`); أَدومَ (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); Lot (ID: `keyterm:Lot`); يَهوذَا (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Dispossess (ID: `keyterm:Dispossess`); أورشَلِيمَ (ID: `place:Jerusalem`); أَدومَ (ID: `place:Edom`); يوسف (ID: `person:Joseph.10`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); أَدومَ (ID: `place:Edom`); يوسف (ID: `person:Joseph.10`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); ٱلْجَنوبِ (ID: `place:Negeb`); بَنْيَامِينَ (ID: `group:Benjamin`); Canaanites (ID: `group:Canaan`); أَفْرَايِمَ (ID: `person:Ephraim`); جِلْعَادَ (ID: `place:Gilead`); ٱلسَّامِرَةِ (ID: `place:Samaria`); أَفْرَايِمَ (ID: `group:Ephraim`); فِلِشْتِيم (ID: `group:Philistine`); ٱلسَّهْلِ (ID: `place:Shephelah`); إِسْرَائِيلَ (ID: `person:Israel`); إِلَى (ID: `place:Zarephath`); كَنْعَان (ID: `place:Canaan`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `person:Benjamin`); سَارْدِسَ (ID: `place:Sardis`); عِيسو (ID: `place:EsauMount`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); أورشَلِيمَ (ID: `place:Jerusalem`); عِيسو (ID: `place:EsauMount`); ٱلْجَنوبِ (ID: `place:Negeb`); كَنْعَان (ID: `place:Canaan`); سَارْدِسَ (ID: `place:Sardis`); أَفْرَايِمَ (ID: `person:Ephraim`); ٱلسَّامِرَةِ (ID: `place:Samaria`); أَفْرَايِمَ (ID: `group:Ephraim`); إِلَى (ID: `place:Zarephath`); بَنْيَامِينَ (ID: `person:Benjamin`); Canaanites (ID: `group:Canaan`); جِلْعَادَ (ID: `place:Gilead`); فِلِشْتِيم (ID: `group:Philistine`); ٱلسَّهْلِ (ID: `place:Shephelah`); بَنْيَامِينَ (ID: `group:Benjamin`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`)
...
* **Associated ACAI Concepts:** Canaanites (ID: `group:Canaan`); إِسْرَائِيلَ (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); إِلَى (ID: `place:Zarephath`); ٱلْجَنوبِ (ID: `place:Negeb`); كَنْعَان (ID: `place:Canaan`); أورشَلِيمَ (ID: `place:Jerusalem`); سَارْدِسَ (ID: `place:Sardis`)
...
* **Associated ACAI Concepts:** عِيسو (ID: `place:EsauMount`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`)
