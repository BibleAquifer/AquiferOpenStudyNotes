...
* **Associated ACAI Concepts:** Filemom (ID: `person:Philemon`); amado (ID: `keyterm:Beloved`); Timóteo (ID: `person:Timothy`); Jesus (ID: `person:Jesus.2`); Paulo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Filemom (ID: `person:Philemon`); Arquipo (ID: `person:Archippus`); Áfia (ID: `person:Apphia`); amado (ID: `keyterm:Beloved`); Timóteo (ID: `person:Timothy`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); igreja (ID: `keyterm:Church`); Paulo (ID: `person:Paul`); fazer a paz (ID: `keyterm:Peace`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); love (ID: `keyterm:Love`); holy (ID: `keyterm:Holy`); SENHOR (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); orar (ID: `keyterm:Pray`); rogar (ID: `keyterm:AskFor`); comunhão (ID: `keyterm:Fellowship`); Good (ID: `keyterm:Good`); compaixão (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Epafras (ID: `person:Epaphras`); Demas (ID: `person:Demas`); Lucas (ID: `person:Luke`); favor (ID: `keyterm:Favor`); Marcos (ID: `person:Mark`); em cristo (ID: `keyterm:InChrist`); Spirit (ID: `keyterm:Spirit.2`); Aristarco (ID: `person:Aristarchus`)
