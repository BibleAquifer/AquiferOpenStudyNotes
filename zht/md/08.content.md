...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Bethlehem (ID: `place:Bethlehem`)
...
* **Associated ACAI Concepts:** Ephrathah (ID: `person:Ephrathah`); Chilion (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Ephrathites (ID: `group:Ephrathah`); Moab (ID: `place:Moab`); Mahlon (ID: `person:Mahlon`); Judah (ID: `person:Judah.4`); Bethlehem (ID: `place:Bethlehem`); Elimelech (ID: `person:Elimelech`); Tribe of Judah (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); LORD (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Bless (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Rachel (ID: `person:Rachel`); LORD (ID: `deity:Lord`); Leah (ID: `person:Leah`); Bethlehem (ID: `place:Bethlehem`); Elders (ID: `group:GenericElders`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Judah (ID: `person:Judah.4`); Perez (ID: `person:Perez`); Tamar (ID: `person:Tamar`); Tribe of Judah (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Obed (ID: `person:Obed`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Jesse (ID: `person:Jesse`); David (ID: `person:David`); Nahshon (ID: `person:Nahshon`); Perez (ID: `person:Perez`); Boaz (ID: `person:Boaz`)
