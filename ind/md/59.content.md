...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); berbahagialah (ID: `keyterm:Happy`); mencobai (ID: `keyterm:PutToTheTest`); kekasih (ID: `keyterm:Beloved`); suci (ID: `keyterm:Clean`); tahan uji (ID: `keyterm:Approved`); sia, sia (ID: `keyterm:Worthless`); yang baik (ID: `keyterm:Good`); keahlian (ID: `keyterm:Ability`); kasihi (ID: `keyterm:Love`); tidak dicemarkan (ID: `keyterm:Undefiled`); hati (ID: `keyterm:Heart`); A Person (ID: `person:GenericPerson`); keselamatan (ID: `keyterm:Salvation`); tak bernoda (ID: `keyterm:AboveCriticism`); janji (ID: `keyterm:Promise`); kehidupan (ID: `keyterm:Life`); tidak dapat dicobai (ID: `keyterm:NotTempted`); hukum (ID: `keyterm:Law`); berbuat dosa (ID: `keyterm:Sin`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kebenaran (ID: `keyterm:Truth`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** suci (ID: `keyterm:Clean`); sia, sia (ID: `keyterm:Worthless`); tak bernoda (ID: `keyterm:AboveCriticism`); tidak dicemarkan (ID: `keyterm:Undefiled`); hati (ID: `keyterm:Heart`); Tuhan (ID: `deity:Lord`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); tonton bulu atau muka (ID: `keyterm:Partiality`); percaya (ID: `keyterm:Believe`); kemuliaan (ID: `keyterm:Glory`); Yesus (ID: `person:Jesus.2`); bimbang (ID: `keyterm:Discern`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`); Footstool (ID: `realia:Footstool`)
...
* **Associated ACAI Concepts:** kasihi (ID: `keyterm:Love`); orang pilihan (ID: `keyterm:Chosen`); percaya (ID: `keyterm:Believe`); janji (ID: `keyterm:Promise`); kerajaan (ID: `keyterm:Kingdom`); kekasih (ID: `keyterm:Beloved`); Tuhan (ID: `deity:Lord`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); tersandung (ID: `keyterm:Stumble`); tonton bulu atau muka (ID: `keyterm:Partiality`); penghakiman (ID: `keyterm:Judgment`); kasihi (ID: `keyterm:Love`); berbuat dosa (ID: `keyterm:Sin`); belas kasihan (ID: `keyterm:Mercy`); memutuskan (ID: `keyterm:Decided`); persundalan (ID: `keyterm:Fornication`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`); pengadilan (ID: `keyterm:CourtCase`); kitab suci (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); tubuh (ID: `keyterm:Body.3`); Tuhan (ID: `deity:Lord`); A Person (ID: `person:GenericPerson`); sia, sia (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); Demons (ID: `deity:Demons`); Ishak (ID: `person:Isaac`); menggenapi (ID: `keyterm:Happen`); An Angel (ID: `deity:Angel`); roh (ID: `keyterm:Spirit.2`); memperdamaikan (ID: `keyterm:Peace`); hampa (ID: `keyterm:Empty`); kitab suci (ID: `keyterm:Scripture`); keselamatan (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menggenapi (ID: `keyterm:Happen`); Abraham (ID: `person:Abraham`); Tuhan (ID: `deity:Lord`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kitab suci (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** lalim (ID: `keyterm:UnjustDeed`); Hell (ID: `place:Hell`); tubuh (ID: `keyterm:Body.3`); neraka (ID: `keyterm:Gehenna`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); persahabatan (ID: `keyterm:Friendship`); tidak setia (ID: `keyterm:Unfaithful`); Cause of Joy (ID: `keyterm:CauseOfJoy`); murni (ID: `keyterm:Pure`); kebaikan (ID: `keyterm:Favor`); roh (ID: `keyterm:Spirit.2`); ingin (ID: `keyterm:LongFor`); membersihkan (ID: `keyterm:Cleanse.2`); hati (ID: `keyterm:Heart`); Roh (ID: `deity:HolySpirit`); keahlian (ID: `keyterm:Ability`); kitab suci (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** roh (ID: `keyterm:Spirit.2`); ingin (ID: `keyterm:LongFor`); Roh (ID: `deity:HolySpirit`); kitab suci (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** membersihkan (ID: `keyterm:Cleanse.2`); hati (ID: `keyterm:Heart`); murni (ID: `keyterm:Pure`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** menentang (ID: `keyterm:Condemn`); tubuh (ID: `keyterm:Body.3`); hati (ID: `keyterm:Heart`); bersaksi (ID: `keyterm:BearWitness`); Tuhan (ID: `deity:Lord`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** nama (ID: `keyterm:Name`); berdoa (ID: `keyterm:Pray`); jemaat (ID: `keyterm:Church`); Tuhan (ID: `deity:Lord`); diurapi (ID: `keyterm:Anointed`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** berbuat dosa (ID: `keyterm:Sin`); percaya (ID: `keyterm:Believe`); mengampuni (ID: `keyterm:Forgive`); berdoa (ID: `keyterm:Pray`); Tuhan (ID: `deity:Lord`); keselamatan (ID: `keyterm:Salvation`)
