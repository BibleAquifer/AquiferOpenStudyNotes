...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`); Jeremias (ID: `person:Jeremiah.6`); Israel (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Levi (ID: `person:Levi.3`); Benjamim (ID: `person:Benjamin`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `group:Levi`); Benjamim (ID: `group:Benjamin`); Judá (ID: `person:Judah.4`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ciro (ID: `person:Cyrus`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Pérsia (ID: `place:Persia`); Judá (ID: `group:Judah`); Ciro (ID: `person:Cyrus`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Salomão (ID: `person:Solomon`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Delaías (ID: `person:Delaiah.3`); Adã (ID: `place:Addan`); Salmai (ID: `person:Shalmai`); Parós (ID: `person:Parosh`); Hacufa (ID: `person:Hakupha`); Bigvai (ID: `person:Bigvai`); Gidel (ID: `person:Giddel`); Sia (ID: `person:Siaha`); Gazão (ID: `person:Gazzam`); Gaar (ID: `person:Gahar`); Harsa (ID: `person:Harsha`); Temá (ID: `person:Temah`); Ater (ID: `person:Ater`); Netofa (ID: `place:Netophah`); Hatil (ID: `person:Hattil`); Uza (ID: `person:Uzza.2`); Zia (ID: `person:Ziha`); Neemias (ID: `person:Nehemiah`); Habaiah (ID: `person:Habaiah`); Bilsã (ID: `person:Bilshan`); Jesua (ID: `person:Jeshua.3`); Asná (ID: `person:Asnah`); Hatita (ID: `person:Hatita`); Harur (ID: `person:Harhur`)
...
* **Associated ACAI Concepts:** Neemias (ID: `person:Nehemiah`); Bilsã (ID: `person:Bilshan`); Mispar (ID: `person:Mispar`); Seraias (ID: `person:Seraiah.6`); Bigvai (ID: `person:Bigvai`); Reum (ID: `person:Rehum`); Reelaías (ID: `person:Reelaiah`); Baana (ID: `person:Baanah.3`); Mordecai (ID: `person:Mordecai`); Israel (ID: `person:Israel`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** Parós (ID: `person:Parosh`); Adonicão (ID: `person:Adonikam`); Elam (ID: `person:Elam`); Bani (ID: `person:Bani`); Zacai (ID: `person:Zaccai.2`); Jora (ID: `person:Jorah`); Ezequias (ID: `person:Hezekiah.2`); Ater (ID: `person:Ater`); Asgade (ID: `person:Azgad`); Bezai (ID: `person:Bezai`); Ará (ID: `person:Arah.2`); Zatu (ID: `person:Zattu.2`); Hasum (ID: `person:Hashum`); Bigvai (ID: `person:Bigvai.2`); Paate-Moabe (ID: `person:Pahath-moab`); Jesua (ID: `person:Jeshua.3`); Joabe (ID: `person:Joab.3`); Bebai (ID: `person:Bebai`); Adim (ID: `person:Adin`); Sephatias (ID: `person:Shephatiah.6`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Beth-azmaveth (ID: `place:Beth-azmaveth`); Netofa (ID: `place:Netophah`); Magbis (ID: `place:Magbish`); Nebo (ID: `place:Nebo.2`); Harim (ID: `person:Harim.2`); Hadide (ID: `place:Hadid`); Senaa (ID: `place:Senaah`); Micmás (ID: `place:Michmash`); Ramah (ID: `place:Ramah.2`); Beerote (ID: `place:Beeroth`); Elam (ID: `person:Elam`); Anatote (ID: `place:Anathoth`); Jericó (ID: `place:Jericho`); Geba (ID: `place:Geba`); Betel (ID: `place:Bethel`); Cefira (ID: `place:Chephirah`); Lode (ID: `place:Lod`); Belém (ID: `place:Bethlehem`); Quiriate-Jearim (ID: `place:Kiriath-jearim`); Ai (ID: `place:Ai`); Ono (ID: `place:Ono`)
...
* **Associated ACAI Concepts:** Jesua (ID: `person:Jeshua`); Ater (ID: `person:Ater.2`); Sobai (ID: `person:Shobai`); Talmom (ID: `person:Talmon`); Hodavias (ID: `person:Hodaviah.4`); Jesua (ID: `person:Jeshua.4`); Imer (ID: `person:Immer.2`); Jedaías (ID: `person:Jedaiah.4`); Hatita (ID: `person:Hatita`); Harim (ID: `person:Harim`); Pasur (ID: `person:Pashhur`); Cadmiel (ID: `person:Kadmiel`); Levi (ID: `person:Levi.3`); Acube (ID: `person:Akkub.2`); Salum (ID: `person:Shallum.8`); Levi (ID: `group:Levi`); Asafe (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** Ater (ID: `person:Ater.2`); Sobai (ID: `person:Shobai`); Talmom (ID: `person:Talmon`); Hatita (ID: `person:Hatita`); Acube (ID: `person:Akkub.2`); Salum (ID: `person:Shallum.8`); Asafe (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** Padom (ID: `person:Padon`); Harur (ID: `person:Harhur`); Salmai (ID: `person:Shalmai`); Hacufa (ID: `person:Hakupha`); Gidel (ID: `person:Giddel`); Hagabe (ID: `person:Hagab`); Sia (ID: `person:Siaha`); Gazão (ID: `person:Gazzam`); Bazlite (ID: `person:Bazluth`); Gaar (ID: `person:Gahar`); Hasufa (ID: `person:Hasupha`); Harsa (ID: `person:Harsha`); Besai (ID: `person:Besai`); Temá (ID: `person:Temah`); Nesias (ID: `person:Neziah`); Acube (ID: `person:Akkub.3`); Lebana (ID: `person:Lebanah`); Meunim (ID: `group:Meunim`); Meída (ID: `person:Mehida`); Hatifa (ID: `person:Hatipha`); Hanã (ID: `person:Hanan.4`); Tabaote (ID: `person:Tabbaoth`); Hagaba (ID: `person:Hagabah`); Baquebuque (ID: `person:Bakbuk`); Queros (ID: `person:Keros`); Uza (ID: `person:Uzza.2`); Paseia (ID: `person:Paseah.2`); Necoda (ID: `person:Nekoda`); Barcos (ID: `person:Barkos`); Zia (ID: `person:Ziha`); Sisera (ID: `person:Sisera.2`); Asná (ID: `person:Asnah`); Nephushesim (ID: `group:Nephushesim`); Rezim (ID: `person:Rezin.2`); Reaías (ID: `person:Reaiah.3`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Hatil (ID: `person:Hattil`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Soferete (ID: `person:Sophereth`); Sotai (ID: `person:Sotai`); Sephatias (ID: `person:Shephatiah.7`); Darcom (ID: `person:Darkon`); Gidel (ID: `person:Giddel.2`); Ami (ID: `person:Ami`); Peruda (ID: `person:Peruda`); Jaala (ID: `person:Jaalah`)
...
* **Associated ACAI Concepts:** Querube (ID: `place:Cherub`); Delaías (ID: `person:Delaiah.3`); Tel-Harsa (ID: `place:Tel-harsha`); Tel-Melá (ID: `place:Tel-melah`); Adã (ID: `place:Addan`); Tobias (ID: `person:Tobiah`); Necoda (ID: `person:Nekoda.2`); Imer (ID: `place:Immer`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Habaiah (ID: `person:Habaiah`); Barzillai (ID: `person:Barzillai.3`); Hacoz (ID: `person:Hakkoz.2`); stain (ID: `keyterm:Stain`); Barzillai (ID: `person:Barzillai`); priesthood (ID: `keyterm:Priesthood`); Gileade (ID: `place:Gilead`); Gileadites (ID: `group:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); SENHOR (ID: `deity:Lord`); strength (ID: `keyterm:Strength`); Jerusalém (ID: `place:Jerusalem`); Money (ID: `realia:Money`); Mina (ID: `realia:Mina`); House (ID: `realia:House`); Tunic (ID: `realia:Tunic`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Josué (ID: `person:Joshua.5`); Pérsia (ID: `place:Persia`); Ciro (ID: `person:Cyrus`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Hodavias (ID: `person:Hodaviah.4`); Esar-Hadom (ID: `person:Esarhaddon`); Jesua (ID: `person:Jeshua.4`); Relatives (ID: `group:Relatives`); Henadade (ID: `person:Henadad`); Cadmiel (ID: `person:Kadmiel`); Tyrians (ID: `group:Tyre`); appointed feast (ID: `keyterm:AppointedFeast`); Davi (ID: `person:David`); Benjamim (ID: `person:Benjamin`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); Tiro (ID: `place:Tyre`); terror (ID: `keyterm:Terror`); counsel (ID: `keyterm:Counsel`); Instruction (ID: `keyterm:Instruction`); Dario (ID: `person:Darius.2`); Jope (ID: `place:Joppa`); kindness (ID: `keyterm:Kindness`); holy (ID: `keyterm:Holy`); Moisés (ID: `person:Moses`); Assyria (ID: `place:Assyria`); Benjamim (ID: `group:Benjamin`); Hodias (ID: `person:Hodiah.2`); new moon festival (ID: `keyterm:NewMoonFestival`); Sidom (ID: `place:Sidon`); Sidonians (ID: `group:Sidon`); Libano (ID: `place:Lebanon`); Asafe (ID: `person:Asaph.2`); Cymbals (ID: `realia:Cymbals`); Craftsman (ID: `realia:Craftsman`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Cedar (ID: `flora:Cedar`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); offering (ID: `keyterm:Offering`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); SENHOR (ID: `deity:Lord`); Moisés (ID: `person:Moses`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); terror (ID: `keyterm:Terror`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Tyrians (ID: `group:Tyre`); Jope (ID: `place:Joppa`); Pérsia (ID: `place:Persia`); Sidom (ID: `place:Sidon`); Ciro (ID: `person:Cyrus`); Sidonians (ID: `group:Sidon`); Tiro (ID: `place:Tyre`); Libano (ID: `place:Lebanon`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Craftsman (ID: `realia:Craftsman`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Jerusalém (ID: `place:Jerusalem`); Josué (ID: `person:Joshua.5`); Levi (ID: `group:Levi`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); kindness (ID: `keyterm:Kindness`); Davi (ID: `person:David`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Asafe (ID: `person:Asaph.2`); Trumpet (ID: `realia:Trumpet`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Benjamim (ID: `person:Benjamin`); Benjamim (ID: `group:Benjamin`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Israel (ID: `person:Israel`); Pérsia (ID: `place:Persia`); SENHOR (ID: `deity:Lord`); Ciro (ID: `person:Cyrus`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); counsel (ID: `keyterm:Counsel`); Dario (ID: `person:Darius.2`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Rio Eufrates (ID: `place:Euphrates`); Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Artaxerxes (ID: `person:Artaxerxes.2`); Pérsia (ID: `place:Persia`); Samaria (ID: `place:Samaria`); Jews (ID: `group:Jews`); Babylonians (ID: `group:Babylon`); Osnapar (ID: `person:Osnappar`); Dinaítas (ID: `person:Dinaite`); Mitredate (ID: `person:Mithredath.2`); Bislão (ID: `person:Bishlam`); Ereque (ID: `place:Erech`); Tabeel (ID: `person:Tabeel`); Assuero (ID: `person:Ahasuerus`); Susã (ID: `place:Susa`); Elam (ID: `place:Elam`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Babilônia (ID: `place:Babylon`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Sinsai (ID: `person:Shimshai`); Babylonians (ID: `group:Babylon`); Reum (ID: `person:Rehum.2`); Dinaítas (ID: `person:Dinaite`); Ereque (ID: `place:Erech`); Pérsia (ID: `place:Persia`); Elam (ID: `place:Elam`); Susã (ID: `place:Susa`); Babilônia (ID: `place:Babylon`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Sinsai (ID: `person:Shimshai`); Jews (ID: `group:Jews`); Samaria (ID: `place:Samaria`); Reum (ID: `person:Rehum.2`); Artaxerxes (ID: `person:Artaxerxes.2`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); Dario (ID: `person:Darius.2`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Ageu (ID: `person:Haggai`); Tattenai (ID: `person:Tattenai`); Zacarias (ID: `person:Zechariah.17`); Ido (ID: `person:Iddo.6`); Rio Eufrates (ID: `place:Euphrates`); Pérsia (ID: `place:Persia`); Israel (ID: `person:Israel`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Ageu (ID: `person:Haggai`); Ido (ID: `person:Iddo.6`); Zacarias (ID: `person:Zechariah.17`); Israel (ID: `person:Israel`); Jews (ID: `group:Jews`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Jerusalém (ID: `place:Jerusalem`); Josué (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Babilônia (ID: `place:Babylon`); Jerusalém (ID: `place:Jerusalem`); Ciro (ID: `person:Cyrus`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Zorobabel (ID: `person:Zerubbabel.2`); Dario (ID: `person:Darius.2`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Tattenai (ID: `person:Tattenai`); Rio Eufrates (ID: `place:Euphrates`); Chaldeans (ID: `group:Chaldea`); Israel (ID: `person:Israel`); Caldéia (ID: `place:Chaldea`); Judá (ID: `person:Judah.4`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Ciro (ID: `person:Cyrus`); Zorobabel (ID: `person:Zerubbabel.2`); Babilônia (ID: `place:Babylon`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); defilement (ID: `keyterm:Defilement`); SENHOR (ID: `deity:Lord`); Gentiles (ID: `group:Gentile`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Seraias (ID: `person:Seraiah.2`); Azarias (ID: `person:Azariah.7`); Pérsia (ID: `place:Persia`); Artaxerxes (ID: `person:Artaxerxes`); Hilquias (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Buqui (ID: `person:Bukki.2`); Seraias (ID: `person:Seraiah.2`); Zeraías (ID: `person:Zerahiah`); Meraiote (ID: `person:Meraioth`); Zadoque (ID: `person:Zadok.4`); Salum (ID: `person:Shallum.7`); Azarias (ID: `person:Azariah.7`); Amarias (ID: `person:Amariah.2`); Aitube (ID: `person:Ahitub.3`); Abisua (ID: `person:Abishua`); Azarias (ID: `person:Azariah.6`); Uzi (ID: `person:Uzzi`); Pérsia (ID: `place:Persia`); Fineias (ID: `person:Phinehas`); Hilquias (ID: `person:Hilkiah.2`); Artaxerxes (ID: `person:Artaxerxes`); Arão (ID: `person:Aaron`); Eleazar (ID: `person:Eleazar.2`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); SENHOR (ID: `deity:Lord`); Moisés (ID: `person:Moses`); Babilônia (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); SENHOR (ID: `deity:Lord`); decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Ezra (ID: `person:Ezra`); Artaxerxes (ID: `person:Artaxerxes`); Olive Oil (ID: `realia:OliveOil`); Talent (ID: `realia:Talent`); Money (ID: `realia:Money`); Kor (ID: `realia:Kor`); Anointing Oil (ID: `realia:AnointingOil`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** Daniel (ID: `person:Daniel.2`); Secanias (ID: `person:Shecaniah.5`); Bebai (ID: `person:Bebai.2`); Zacarias (ID: `person:Zechariah.18`); Jeiel (ID: `person:Jehiel.7`); Adonicão (ID: `person:Adonikam`); Elam (ID: `person:Elam`); Jaaziel (ID: `person:Jahaziel.5`); Jônatas (ID: `person:Jonathan.9`); Miguel (ID: `person:Michael.10`); Atalia (ID: `person:Athaliah.3`); Ebede (ID: `person:Ebed.2`); Secanias (ID: `person:Shecaniah.6`); Zacarias (ID: `person:Zechariah.19`); Hacatã (ID: `person:Hakkatan`); Asgade (ID: `person:Azgad`); Elioenai (ID: `person:Eliehoenai.2`); Selomite (ID: `person:Shelomith.4`); Zabadias (ID: `person:Zebadiah.8`); Joabe (ID: `person:Joab.4`); Parós (ID: `person:Parosh.2`); Hatus (ID: `person:Hattush.2`); Jeuel (ID: `person:Jeuel.3`); Obadias (ID: `person:Obadiah.10`); Josifias (ID: `person:Josiphiah`); Gérson (ID: `person:Gershom.2`); Bigvai (ID: `person:Bigvai.2`); Paate-Moabe (ID: `person:Pahath-moab`); Zeraías (ID: `person:Zerahiah.2`); Elifelete (ID: `person:Eliphelet.5`); Utai (ID: `person:Uthai.2`); Jesaías (ID: `person:Jeshaiah.4`); Joanã (ID: `person:Johanan.8`); Bebai (ID: `person:Bebai`); Zacur (ID: `person:Zaccur.5`); Semaías (ID: `person:Shemaiah.14`); Adim (ID: `person:Adin`); Sephatias (ID: `person:Shephatiah.6`); Davi (ID: `person:David`); Fineias (ID: `person:Phinehas`); Artaxerxes (ID: `person:Artaxerxes`); Itamar (ID: `person:Ithamar`); Babilônia (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** Elnatã (ID: `person:Elnathan.4`); Mesulão (ID: `person:Meshullam.9`); Zacarias (ID: `person:Zechariah.20`); Elnatã (ID: `person:Elnathan.3`); Joiaribe (ID: `person:Joiarib.2`); Elnatã (ID: `person:Elnathan.2`); Ido (ID: `person:Iddo`); Natã (ID: `person:Nathan.5`); Jaribe (ID: `person:Jarib.2`); Semaías (ID: `person:Shemaiah.15`); Ariel (ID: `person:Ariel`); Casifia (ID: `place:Casiphia`); Eliezer (ID: `person:Eliezer.8`); perceive (ID: `keyterm:Perceive`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Insight (ID: `keyterm:Insight`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Mali (ID: `person:Mahli`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); Egyptians (ID: `group:Egypt`); Hete (ID: `person:Heth`); be unfaithful (ID: `keyterm:Unfaithful`); Israel (ID: `person:Israel`); Ammonites (ID: `group:Ammon`); Moabe (ID: `place:Moab`); cananeu (ID: `group:Canaan`); Levi (ID: `person:Levi.3`); Egito (ID: `place:Egypt`); Canaã (ID: `place:Canaan`); Levi (ID: `group:Levi`); Amom (ID: `place:Ammon`); Jebusites (ID: `group:Jebusites`); Amorites (ID: `group:Amorites`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); House (ID: `realia:House`); Harim (ID: `person:Harim`); counsel (ID: `keyterm:Counsel`); offering (ID: `keyterm:Offering`); Elam (ID: `person:Elam`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Bani (ID: `person:Bani.6`); Elioenai (ID: `person:Elioenai.4`); Jeremote (ID: `person:Jeremoth.4`); Bedias (ID: `person:Bedeiah`); Parós (ID: `person:Parosh`); Matatá (ID: `person:Mattattah`); Salum (ID: `person:Shallum.10`); Sabetai (ID: `person:Shabbethai`); Perizzites (ID: `group:Perizzites`); Adaías (ID: `person:Adaiah.6`); Manassés (ID: `person:Manasseh.3`); Zabade (ID: `person:Zabad.6`); Maaséias (ID: `person:Maaseiah.7`); Bezalel (ID: `person:Bezalel.2`); Malquias (ID: `person:Malchijah.5`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); defilement (ID: `keyterm:Defilement`); kindness (ID: `keyterm:Kindness`); dispossess (ID: `keyterm:Dispossess`); Pérsia (ID: `place:Persia`); Israel (ID: `person:Israel`); to cause to possess (ID: `keyterm:Possess`); Jerusalém (ID: `place:Jerusalem`); supplication (ID: `keyterm:Supplication`); peace (ID: `keyterm:IntactState`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); kindness (ID: `keyterm:Kindness`); Pérsia (ID: `place:Persia`); Jerusalém (ID: `place:Jerusalem`); supplication (ID: `keyterm:Supplication`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** Jeiel (ID: `person:Jehiel.8`); Secanias (ID: `person:Shecaniah.7`); be unfaithful (ID: `keyterm:Unfaithful`); Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Elam (ID: `person:Elam`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); swear (ID: `keyterm:Swear`); Israel (ID: `person:Israel`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Benjamim (ID: `person:Benjamin`); Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `group:Benjamin`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mesulão (ID: `person:Meshullam.10`); Asael (ID: `person:Asahel.4`); Ticva (ID: `person:Tikvah.2`); Jazeías (ID: `person:Jahzeiah`); Jônatas (ID: `person:Jonathan.10`); Sabetai (ID: `person:Shabbethai`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`)
