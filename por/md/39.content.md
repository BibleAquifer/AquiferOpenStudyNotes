...
* **Associated ACAI Concepts:** being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); Priests (ID: `group:GenericPriests`); fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); fear (ID: `keyterm:Fear`); Levi (ID: `group:Levi`); stain (ID: `keyterm:Stain`); Levi (ID: `person:Levi.3`); Priests (ID: `group:GenericPriests`); Glory (ID: `keyterm:Glory`); utter a curse (ID: `keyterm:Curse`); peace (ID: `keyterm:IntactState`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); fairness (ID: `keyterm:Fairness`); make a vow (ID: `keyterm:Vow`); profane, dishonor (ID: `keyterm:Dishonor`); The Way (ID: `keyterm:TheWay`); bless (ID: `keyterm:Bless`); be kindly disposed (ID: `keyterm:KindlyDisposed`); Gentiles (ID: `group:Gentile`); An Angel (ID: `deity:Angel`); pure (ID: `keyterm:Pure`); evil intention (ID: `keyterm:Intention`); Truth (ID: `keyterm:Truth`); rogar (ID: `keyterm:AskFor`); ardour (ID: `keyterm:Ardour`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); stain (ID: `keyterm:Stain`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); make a vow (ID: `keyterm:Vow`); utter a curse (ID: `keyterm:Curse`); fear (ID: `keyterm:Fear`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** bless (ID: `keyterm:Bless`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); utter a curse (ID: `keyterm:Curse`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); An Angel (ID: `deity:Angel`); evil intention (ID: `keyterm:Intention`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); profane, dishonor (ID: `keyterm:Dishonor`); Covenant (ID: `keyterm:Covenant`); Judá (ID: `group:Judah`); delight (ID: `keyterm:Delight`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); love (ID: `keyterm:Love`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); profane, dishonor (ID: `keyterm:Dishonor`); Israel (ID: `person:Israel`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Levi (ID: `group:Levi`); Jerusalém (ID: `place:Jerusalem`); An Angel (ID: `deity:Angel`); pure (ID: `keyterm:Pure`); Covenant (ID: `keyterm:Covenant`); Levi (ID: `person:Levi.3`); swear (ID: `keyterm:Swear`); A Group of People (ID: `group:GenericGroup`); fear (ID: `keyterm:Fear`); Soap (ID: `realia:Soap`); Hammada (ID: `flora:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); decree (ID: `keyterm:Decree`); offering (ID: `keyterm:Offering`); Israel (ID: `person:Israel`); bless (ID: `keyterm:Bless`); utter a curse (ID: `keyterm:Curse`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Sorghum (ID: `flora:Sorghum`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** decree (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`); Moisés (ID: `person:Moses`); Israel (ID: `person:Israel`); Monte Sinai (ID: `place:SinaiMount`)
...
* **Associated ACAI Concepts:** decree (ID: `keyterm:Decree`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`); SENHOR (ID: `deity:Lord`); Elias (ID: `person:Elijah`); Instruction (ID: `keyterm:Instruction`); Moisés (ID: `person:Moses`); Israel (ID: `person:Israel`); Monte Sinai (ID: `place:SinaiMount`); fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** something devoted to god (ID: `keyterm:SomethingDevotedToGod`); Elias (ID: `person:Elijah`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`)
