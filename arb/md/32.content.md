...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); Fear (ID: `keyterm:Fear`); Fish (ID: `fauna:Fish`); Ship (ID: `realia:Ship`); Vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); يَافَا (ID: `place:Joppa`); نِينَوَى (ID: `place:Nineveh`); أَمِتَّايَ (ID: `person:Amittai`); Hebrews (ID: `group:Hebrews`); Kindness (ID: `keyterm:Kindness`); Slaughtering (ID: `keyterm:Slaughtering`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Salvation (ID: `keyterm:Salvation`); Praise (ID: `keyterm:Praise`); Exempt (ID: `keyterm:Exempt`); Lot (ID: `keyterm:Lot`); تَرْشِيشَ (ID: `place:Tarshish`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Vow (ID: `keyterm:Vow`); Slaughtering (ID: `keyterm:Slaughtering`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Hell (ID: `place:Hell`); Vow (ID: `keyterm:Vow`); Salvation (ID: `keyterm:Salvation`); يونَانَ (ID: `person:Jonah.2`); Praise (ID: `keyterm:Praise`); Kindness (ID: `keyterm:Kindness`); Fish (ID: `fauna:Fish`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** Vow (ID: `keyterm:Vow`); ٱلرَّبِّ (ID: `deity:Lord`); Salvation (ID: `keyterm:Salvation`); Praise (ID: `keyterm:Praise`); Kindness (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); نِينَوَى (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); تَرْشِيشَ (ID: `place:Tarshish`); Compassionate (ID: `keyterm:Compassionate`); Generous (ID: `keyterm:Generous`); Believe In (ID: `keyterm:BelieveIn`); Kindness (ID: `keyterm:Kindness`); Throne (ID: `realia:Throne`); Worm (ID: `fauna:Maggot`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Compassionate (ID: `keyterm:Compassionate`); ٱلرَّبِّ (ID: `deity:Lord`); Generous (ID: `keyterm:Generous`); تَرْشِيشَ (ID: `place:Tarshish`); Kindness (ID: `keyterm:Kindness`)
