...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Filemom (ID: `person:Philemon`); Arquipo (ID: `person:Archippus`); Áfia (ID: `person:Apphia`); Paulo (ID: `person:Paul`); Timóteo (ID: `person:Timothy`); SENHOR (ID: `deity:Lord`); amado (ID: `keyterm:Beloved`); fazer a paz (ID: `keyterm:Peace`); igreja (ID: `keyterm:Church`); favor (ID: `keyterm:Favor`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`); holy (ID: `keyterm:Holy`); rogar (ID: `keyterm:AskFor`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); compaixão (ID: `keyterm:Affection`); comunhão (ID: `keyterm:Fellowship`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Epafras (ID: `person:Epaphras`); Demas (ID: `person:Demas`); Lucas (ID: `person:Luke`); Marcos (ID: `person:Mark`); Aristarco (ID: `person:Aristarchus`); em cristo (ID: `keyterm:InChrist`); Spirit (ID: `keyterm:Spirit.2`); favor (ID: `keyterm:Favor`)
