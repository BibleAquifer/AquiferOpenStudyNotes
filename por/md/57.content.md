...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Áfia (ID: `person:Apphia`); Filemom (ID: `person:Philemon`); Arquipo (ID: `person:Archippus`); fazer a paz (ID: `keyterm:Peace`); amado (ID: `keyterm:Beloved`); Paulo (ID: `person:Paul`); igreja (ID: `keyterm:Church`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); Timóteo (ID: `person:Timothy`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); holy (ID: `keyterm:Holy`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); Good (ID: `keyterm:Good`); orar (ID: `keyterm:Pray`); compaixão (ID: `keyterm:Affection`); SENHOR (ID: `deity:Lord`); comunhão (ID: `keyterm:Fellowship`); Cause of Joy (ID: `keyterm:CauseOfJoy`); rogar (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Lucas (ID: `person:Luke`); Demas (ID: `person:Demas`); Epafras (ID: `person:Epaphras`); Spirit (ID: `keyterm:Spirit.2`); Marcos (ID: `person:Mark`); favor (ID: `keyterm:Favor`); Aristarco (ID: `person:Aristarchus`); em cristo (ID: `keyterm:InChrist`)
