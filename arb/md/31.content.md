...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); Understanding (ID: `keyterm:Understanding`); Peace (ID: `keyterm:IntactState`); أَدومَ (ID: `place:Edom`); Covenant (ID: `keyterm:Covenant`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** Lot (ID: `keyterm:Lot`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Edomites (ID: `group:Edom`); يوسف (ID: `person:Joseph.10`); أورشَلِيمَ (ID: `place:Jerusalem`); أَدومَ (ID: `place:Edom`); Dispossess (ID: `keyterm:Dispossess`)
...
* **Associated ACAI Concepts:** ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); كَنْعَان (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); بَنْيَامِينَ (ID: `person:Benjamin`); بَنْيَامِينَ (ID: `group:Benjamin`); أَفْرَايِمَ (ID: `person:Ephraim`); جِلْعَادَ (ID: `place:Gilead`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); ٱلسَّهْلِ (ID: `place:Shephelah`); ٱلسَّامِرَةِ (ID: `place:Samaria`); أَفْرَايِمَ (ID: `group:Ephraim`); فِلِشْتِيم (ID: `group:Philistine`); أورشَلِيمَ (ID: `place:Jerusalem`); سَارْدِسَ (ID: `place:Sardis`); إِسْرَائِيلَ (ID: `person:Israel`); إِلَى (ID: `place:Zarephath`); عِيسو (ID: `place:EsauMount`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْجَنوبِ (ID: `place:Negeb`); عِيسو (ID: `place:EsauMount`); Dispossess (ID: `keyterm:Dispossess`); كَنْعَان (ID: `place:Canaan`); فِلِشْتِيم (ID: `group:Philistine`); ٱلسَّهْلِ (ID: `place:Shephelah`); Canaanites (ID: `group:Canaan`); إِسْرَائِيلَ (ID: `person:Israel`); بَنْيَامِينَ (ID: `group:Benjamin`); أَفْرَايِمَ (ID: `person:Ephraim`); جِلْعَادَ (ID: `place:Gilead`); إِلَى (ID: `place:Zarephath`); بَنْيَامِينَ (ID: `person:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); سَارْدِسَ (ID: `place:Sardis`); ٱلسَّامِرَةِ (ID: `place:Samaria`); أَفْرَايِمَ (ID: `group:Ephraim`)
...
* **Associated ACAI Concepts:** كَنْعَان (ID: `place:Canaan`); أورشَلِيمَ (ID: `place:Jerusalem`); سَارْدِسَ (ID: `place:Sardis`); Canaanites (ID: `group:Canaan`); إِلَى (ID: `place:Zarephath`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`)
