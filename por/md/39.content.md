...
* **Associated ACAI Concepts:** Utterance (ID: `keyterm:Utterance`); Malaquias (ID: `person:Malachi`); Word of the Lord (ID: `keyterm:WordOfTheLord`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); fear (ID: `keyterm:Fear`); Priests (ID: `group:GenericPriests`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); offering (ID: `keyterm:Offering`); fear (ID: `keyterm:Fear`); Covenant (ID: `keyterm:Covenant`); Glory (ID: `keyterm:Glory`); Priests (ID: `group:GenericPriests`); Levi (ID: `person:Levi.3`); stain (ID: `keyterm:Stain`); peace (ID: `keyterm:IntactState`); utter a curse (ID: `keyterm:Curse`); Levi (ID: `group:Levi`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); fairness (ID: `keyterm:Fairness`); An Angel (ID: `deity:Angel`); make a vow (ID: `keyterm:Vow`); Truth (ID: `keyterm:Truth`); profane, dishonor (ID: `keyterm:Dishonor`); bless (ID: `keyterm:Bless`); be kindly disposed (ID: `keyterm:KindlyDisposed`); evil intention (ID: `keyterm:Intention`); The Way (ID: `keyterm:TheWay`); Gentiles (ID: `group:Gentile`); pure (ID: `keyterm:Pure`); ardour (ID: `keyterm:Ardour`); rogar (ID: `keyterm:AskFor`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); profane, dishonor (ID: `keyterm:Dishonor`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); delight (ID: `keyterm:Delight`); love (ID: `keyterm:Love`); Jerusalém (ID: `place:Jerusalem`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); love (ID: `keyterm:Love`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); profane, dishonor (ID: `keyterm:Dishonor`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); swear (ID: `keyterm:Swear`); Levi (ID: `person:Levi.3`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); pure (ID: `keyterm:Pure`); An Angel (ID: `deity:Angel`); Jerusalém (ID: `place:Jerusalem`); fear (ID: `keyterm:Fear`); Covenant (ID: `keyterm:Covenant`); A Group of People (ID: `group:GenericGroup`); Levi (ID: `group:Levi`); Soap (ID: `realia:Soap`); Hammada (ID: `flora:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); decree (ID: `keyterm:Decree`); utter a curse (ID: `keyterm:Curse`); Israel (ID: `person:Israel`); bless (ID: `keyterm:Bless`); House (ID: `realia:House`); Sorghum (ID: `flora:Sorghum`); Vine (ID: `flora:Vine`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** Monte Sinai (ID: `place:SinaiMount`); decree (ID: `keyterm:Decree`); Israel (ID: `person:Israel`); Moisés (ID: `person:Moses`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Monte Sinai (ID: `place:SinaiMount`); decree (ID: `keyterm:Decree`); Elias (ID: `person:Elijah`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`); Israel (ID: `person:Israel`); fear (ID: `keyterm:Fear`); Moisés (ID: `person:Moses`); Instruction (ID: `keyterm:Instruction`)
