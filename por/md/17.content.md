...
* **Associated ACAI Concepts:** Harbona (ID: `person:Harbona`); Zetar (ID: `person:Zethar`); Abagta (ID: `person:Abagtha`); Bizta (ID: `person:Biztha`); Carcas (ID: `person:Carkas`); Bigtá (ID: `person:Bigtha`); Meumã (ID: `person:Mehuman`); Assuero (ID: `person:Ahasuerus`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Vasti (ID: `person:Vashti`); Pérsia (ID: `place:Persia`); Medes (ID: `group:Mede`); Persians (ID: `group:Persia`); Medã (ID: `person:Medan`); Assuero (ID: `person:Ahasuerus`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Jeoaquim (ID: `person:Jehoiachin`); Judá (ID: `person:Judah.4`); Babilônia (ID: `place:Babylon`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Ester (ID: `person:Esther`); Vasti (ID: `person:Vashti`); kindness (ID: `keyterm:Kindness`); love (ID: `keyterm:Love`); favor (ID: `keyterm:Favor`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Assuero (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); Mordecai (ID: `person:Mordecai.2`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Jews (ID: `group:Jews`); Hamedata (ID: `person:Hammedatha`); Agague (ID: `person:Agag.2`); Agagites (ID: `group:Agag`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Zeres (ID: `person:Zeresh`); love (ID: `keyterm:Love`); Jews (ID: `group:Jews`); Ester (ID: `person:Esther`); Glory (ID: `keyterm:Glory`); A Group of People (ID: `group:GenericGroup`); House (ID: `realia:House`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Zeres (ID: `person:Zeresh`); Hamã (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); love (ID: `keyterm:Love`); A Group of People (ID: `group:GenericGroup`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Ester (ID: `person:Esther`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Bed (ID: `realia:Bed`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Ester (ID: `person:Esther`); Hamã (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Assuero (ID: `person:Ahasuerus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Jews (ID: `group:Jews`); beg for mercy (ID: `keyterm:BegForMercy`); Ester (ID: `person:Esther`); Agague (ID: `person:Agag.2`); Agagites (ID: `group:Agag`)
...
* **Associated ACAI Concepts:** Aspata (ID: `person:Aspatha`); Farmasta (ID: `person:Parmashta`); Aridai (ID: `person:Aridai`); Arisai (ID: `person:Arisai`); Vaizata (ID: `person:Vaizatha`); Dalfom (ID: `person:Dalphon`); Aridata (ID: `person:Aridatha`); Adalia (ID: `person:Adalia`); Porata (ID: `person:Poratha`); Parsandata (ID: `person:Parshandatha`); Hamã (ID: `person:Haman`); Jews (ID: `group:Jews`); Hamedata (ID: `person:Hammedatha`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Hamã (ID: `person:Haman`); Susã (ID: `place:Susa`); Ester (ID: `person:Esther`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Lot (ID: `realia:Lot`); Hamedata (ID: `person:Hammedatha`); Hamã (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Agague (ID: `person:Agag.2`); Agagites (ID: `group:Agag`); lot (ID: `keyterm:Lot`); Scroll (ID: `realia:Scroll`)
