...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Ageu (ID: `person:Haggai`); Dario (ID: `person:Darius.2`); Sealtiel (ID: `person:Shealtiel.2`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `person:Judah.4`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Ageu (ID: `person:Haggai`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Dario (ID: `person:Darius.2`); Judá (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `person:Judah.4`); fear (ID: `keyterm:Fear`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); An Angel (ID: `deity:Angel`); Olive Oil (ID: `realia:OliveOil`); Grain (ID: `flora:Grain`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); Vine (ID: `flora:Vine`); Mule (ID: `fauna:Mule`); Must (ID: `realia:Must`); Bag (ID: `realia:Bag`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Jeozadaque (ID: `person:Jehozadak`); Ageu (ID: `person:Haggai`); Sealtiel (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Ageu (ID: `person:Haggai`); Judá (ID: `group:Judah`); fear (ID: `keyterm:Fear`); Word of the Lord (ID: `keyterm:WordOfTheLord`); peace (ID: `keyterm:IntactState`); Judá (ID: `person:Judah.4`); Sealtiel (ID: `person:Shealtiel.2`); Egito (ID: `place:Egypt`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ageu (ID: `person:Haggai`); defilement (ID: `keyterm:Defilement`); Vine (ID: `flora:Vine`); bless (ID: `keyterm:Bless`); Instruction (ID: `keyterm:Instruction`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Dario (ID: `person:Darius.2`); holy (ID: `keyterm:Holy`); Winepress (ID: `realia:Winepress`); Olive Oil (ID: `realia:OliveOil`); Grain (ID: `flora:Grain`); Fig (ID: `flora:Fig`); Wine (ID: `realia:Wine`); Barley (ID: `flora:Barley`); Coriander (ID: `flora:Coriander`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); Stew (ID: `realia:Stew`); Pomegranate (ID: `flora:Pomegranate`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `group:Judah`); Ageu (ID: `person:Haggai`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `person:Judah.4`); Sealtiel (ID: `person:Shealtiel.2`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`); Sword (ID: `realia:Sword`)
