...
* **Associated ACAI Concepts:** تَقوعَ (ID: `place:Tekoa`); عَاموس (ID: `person:Amos.3`); Have a Vision (ID: `keyterm:HaveAVision`); عزِّيَّا (ID: `person:Uzziah`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); يَربْعَام (ID: `person:Jeroboam.2`); يوآش (ID: `person:Joash.4`); يَهوذَا (ID: `group:Judah`)
## عاموس 1: 2 (id: 750824)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); فِي (ID: `place:Carmel`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
## عاموس 1: 3 (id: 750827)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); أَدومَ (ID: `place:Edom`); Amorites (ID: `group:Amorites`); موآبَ (ID: `place:Moab`); إِسْرَائِيلَ (ID: `person:Israel`); دِمَشْقَ (ID: `place:Damascus`); جِلْعَادَ (ID: `place:Gilead`); صورَ (ID: `place:Tyre`); يَهوذَا (ID: `group:Judah`); Nazirites (ID: `group:Nazirite`); يَهوذَا (ID: `person:Judah.4`); غَزَّةَ (ID: `place:Gaza`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); Beth-eden (ID: `place:Beth-eden`); حَزَائِيل (ID: `person:Hazael`); Valley of Aven (ID: `place:AvenValley`); إِلَى (ID: `place:Kir`); Rod (ID: `realia:Rod`); House (ID: `realia:House`); Staff (ID: `realia:Staff`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); فِلِشْتِيم (ID: `group:Philistine`); To Dishonor (ID: `keyterm:Dishonor`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); Ben-hadad (ID: `person:Ben-hadad.3`); Covenant (ID: `keyterm:Covenant`); أورشَلِيمَ (ID: `place:Jerusalem`); Strength (ID: `keyterm:Strength`); Decree (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`); قَرْيَتَايِمَ (ID: `place:Kiriathaim`); Ammonites (ID: `group:Ammon`); تَيْمَانَ (ID: `place:Teman`); أَشْقَلونَ (ID: `place:Ashkelon`); Speak as a Prophet (ID: `keyterm:Speak`); Poor (ID: `keyterm:Poor`); أَشْدودَ (ID: `place:Ashdod`); Bozrah (ID: `place:Bozrah.2`); Dispossess (ID: `keyterm:Dispossess`); عَقْرونَ (ID: `place:Ekron`); مِصْرَ (ID: `place:Egypt`); Stone Altar (ID: `realia:StoneAltar`); Oak (ID: `flora:Oak`); Grain (ID: `flora:Grain`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Rams Horn (ID: `realia:RamsHorn`); Bow (ID: `realia:Bow`); Horse (ID: `fauna:Horse`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`); Altar (ID: `realia:Altar`); Sheaf (ID: `realia:Sheaf`); Wagon (ID: `realia:Wagon`); Threshing-Sledge (ID: `realia:Threshing-sledge`); Temple Altar (ID: `realia:TempleAltar`)
## عاموس 1: 4 (id: 750828)
...
* **Associated ACAI Concepts:** Beth-eden (ID: `place:Beth-eden`); إِلَى (ID: `place:Kir`); Valley of Aven (ID: `place:AvenValley`); ٱلرَّبِّ (ID: `deity:Lord`); دِمَشْقَ (ID: `place:Damascus`); Rod (ID: `realia:Rod`); Staff (ID: `realia:Staff`)
## عاموس 1: 6 (id: 750830)
...
* **Associated ACAI Concepts:** فِلِشْتِيم (ID: `group:Philistine`); أَشْقَلونَ (ID: `place:Ashkelon`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); ٱلرَّبِّ (ID: `deity:Lord`); أَشْدودَ (ID: `place:Ashdod`); عَقْرونَ (ID: `place:Ekron`); Rod (ID: `realia:Rod`); Staff (ID: `realia:Staff`)
## عاموس 1: 9 (id: 750833)
...
* **Associated ACAI Concepts:** Covenant (ID: `keyterm:Covenant`); أَدومَ (ID: `place:Edom`); ٱلرَّبِّ (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); صورَ (ID: `place:Tyre`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); جِلْعَادَ (ID: `place:Gilead`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`)
...
* **Associated ACAI Concepts:** Decree (ID: `keyterm:Decree`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); Rebel (ID: `keyterm:Rebel`); Instruction (ID: `keyterm:Instruction`); يَهوذَا (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); Decree (ID: `keyterm:Decree`); ٱلرَّبِّ (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); Instruction (ID: `keyterm:Instruction`)
## عاموس 2: 5 (id: 750842)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Wine (ID: `realia:Wine`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Vine (ID: `flora:Vine`); House (ID: `realia:House`); Altar (ID: `realia:Altar`)
## عاموس 2: 9 (id: 750847)
...
* **Associated ACAI Concepts:** Nazirites (ID: `group:Nazirite`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Speak as a Prophet (ID: `keyterm:Speak`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Bethel (ID: `place:Bethel`); Rebel (ID: `keyterm:Rebel`); ٱلسَّامِرَةِ (ID: `place:Samaria`); مِصْرَ (ID: `place:Egypt`); Appoint (ID: `keyterm:Appoint`); Gilgal (ID: `place:Gilgal.2`); يوسف (ID: `person:Joseph.10`); Lion (ID: `fauna:Lion`); Vine (ID: `flora:Vine`); Love (ID: `keyterm:Love`); Lamentation (ID: `keyterm:Lamentation`); إِلَى (ID: `place:Harmon`); Praise (ID: `keyterm:Praise`); Complete (ID: `keyterm:Complete`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); House (ID: `realia:House`); Swear (ID: `keyterm:Swear`); To Sin (ID: `keyterm:Sin`); Mischief (ID: `keyterm:Mischief`); بَاشَانَ (ID: `place:Bashan`); Fear (ID: `keyterm:Fear`); Beersheba (ID: `place:Beersheba`); Passion (ID: `keyterm:Ardour`); سَدومَ (ID: `place:Sodom`); عَمورَةَ (ID: `place:Gomorrah`); Offering (ID: `keyterm:Offering`); Innocence (ID: `keyterm:Innocence`); Slaughtering (ID: `keyterm:Slaughtering`); Speak as a Prophet (ID: `keyterm:Speak`); أَشْدودَ (ID: `place:Ashdod`); Have Insight (ID: `keyterm:HaveInsight`); Horns of Altar (ID: `realia:HornsOfAltar`); Bird (ID: `fauna:Bird`); Stone Altar (ID: `realia:StoneAltar`); Grain (ID: `flora:Grain`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Sheep (ID: `fauna:Lamb`); Hewn Stone (ID: `realia:HewnStone`); Rams Horn (ID: `realia:RamsHorn`); Bed (ID: `realia:Bed`); Fishhook (ID: `realia:Fishhook`); Locust (ID: `fauna:Locust`); Flock (ID: `fauna:Flock`); Horse (ID: `fauna:Horse`); Cattle (ID: `fauna:Bull`); Wormwood (ID: `flora:Wormwood`); Fig (ID: `flora:Fig`); Sandalwood (ID: `flora:Sandalwood`); Altar (ID: `realia:Altar`); Trap (ID: `realia:Trap`); Wine (ID: `realia:Wine`); Temple Altar (ID: `realia:TempleAltar`); Olive Tree (ID: `flora:OliveTree`); Goat (ID: `fauna:Goat`)
## عاموس 3: 2 (id: 750857)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Lion (ID: `fauna:Lion`); Bird (ID: `fauna:Bird`); Trap (ID: `realia:Trap`); Sandalwood (ID: `flora:Sandalwood`); Rams Horn (ID: `realia:RamsHorn`)
## عاموس 3: 4 (id: 750860)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Bed (ID: `realia:Bed`); Lion (ID: `fauna:Lion`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Horns of Altar (ID: `realia:HornsOfAltar`); Bethel (ID: `place:Bethel`); Appoint (ID: `keyterm:Appoint`); إِسْرَائِيلَ (ID: `person:Israel`); Rebel (ID: `keyterm:Rebel`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Slaughtering (ID: `keyterm:Slaughtering`); Gilgal (ID: `place:Gilgal.2`); Praise (ID: `keyterm:Praise`); Bethel (ID: `place:Bethel`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); Love (ID: `keyterm:Love`); Offering (ID: `keyterm:Offering`)
## عاموس 4: 5 (id: 750875)
...
* **Associated ACAI Concepts:** Praise (ID: `keyterm:Praise`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Love (ID: `keyterm:Love`); Offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Innocence (ID: `keyterm:Innocence`); سَدومَ (ID: `place:Sodom`); عَمورَةَ (ID: `place:Gomorrah`); مِصْرَ (ID: `place:Egypt`); Fig (ID: `flora:Fig`); Locust (ID: `fauna:Locust`); Olive Tree (ID: `flora:OliveTree`); Horse (ID: `fauna:Horse`); Grain (ID: `flora:Grain`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** يوسف (ID: `person:Joseph.10`); Love (ID: `keyterm:Love`); ٱلرَّبِّ (ID: `deity:Lord`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); House (ID: `realia:House`); Woe (ID: `keyterm:Woe.2`); حَمَاةَ (ID: `place:Hamath`); Offering (ID: `keyterm:Offering`); Cattle (ID: `fauna:Bull`); Lyre (ID: `realia:Lyre`); خَيْمَةَ (ID: `deity:Sikkuth`); أَصْنَامِكمْ (ID: `deity:Kiyyun`); كَلْنَةَ (ID: `place:Calneh`); Lo-debar (ID: `place:Lo-debar`); وَادِي (ID: `place:BrookOfTheArabah`); فِلِشْتِيم (ID: `group:Philistine`); Swear (ID: `keyterm:Swear`); يوسف (ID: `person:Joseph.10`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); Ashteroth-karnaim (ID: `place:Ashteroth-karnaim`); إِلَى (ID: `place:Gath`); أورشَلِيمَ (ID: `place:Jerusalem`); دِمَشْقَ (ID: `place:Damascus`); Trust (ID: `keyterm:LeanOn`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Slaughtering (ID: `keyterm:Slaughtering`); Smear (ID: `keyterm:Smear`); دَاودَ (ID: `person:David`); Image (ID: `realia:Image`); Sheep (ID: `fauna:Lamb`); Bed (ID: `realia:Bed`); Flock (ID: `fauna:Flock`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Molten Image (ID: `realia:MoltenImage`); Horse (ID: `fauna:Horse`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Wormwood (ID: `flora:Wormwood`); Lion (ID: `fauna:Lion`); Mattock (ID: `realia:Mattock`); Vine (ID: `flora:Vine`); Bear (ID: `fauna:Bear`); Animal Pen (ID: `realia:AnimalPen`); Wine (ID: `realia:Wine`); Goat (ID: `fauna:Goat`); Snake (ID: `fauna:Snake`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); خَيْمَةَ (ID: `deity:Sikkuth`); أَصْنَامِكمْ (ID: `deity:Kiyyun`); Slaughtering (ID: `keyterm:Slaughtering`); إِسْرَائِيلَ (ID: `person:Israel`); دِمَشْقَ (ID: `place:Damascus`); Image (ID: `realia:Image`); Lyre (ID: `realia:Lyre`)
...
* **Associated ACAI Concepts:** خَيْمَةَ (ID: `deity:Sikkuth`); أَصْنَامِكمْ (ID: `deity:Kiyyun`); Slaughtering (ID: `keyterm:Slaughtering`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Woe (ID: `keyterm:Woe.2`); إِسْرَائِيلَ (ID: `person:Israel`); Trust (ID: `keyterm:LeanOn`); ٱلسَّامِرَةِ (ID: `place:Samaria`)
## عاموس 6: 2 (id: 750905)
...
* **Associated ACAI Concepts:** Smear (ID: `keyterm:Smear`); يوسف (ID: `person:Joseph.10`); دَاودَ (ID: `person:David`); Lyre (ID: `realia:Lyre`); Wine (ID: `realia:Wine`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Vine (ID: `flora:Vine`)
## عاموس 6: 6 (id: 750909)
...
* **Associated ACAI Concepts:** Smear (ID: `keyterm:Smear`); يوسف (ID: `person:Joseph.10`); Wine (ID: `realia:Wine`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Vine (ID: `flora:Vine`)
## عاموس 6: 8 (id: 750910)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَاموس (ID: `person:Amos.3`); Speak as a Prophet (ID: `keyterm:Speak`); أَمَصْيَا (ID: `person:Amaziah.4`); يَربْعَام (ID: `person:Jeroboam.2`); مِصْرَ (ID: `place:Egypt`); Bethel (ID: `place:Bethel`); إِسْحَاق (ID: `person:Isaac`); Swear (ID: `keyterm:Swear`); To Sin (ID: `keyterm:Sin`); Word of the Lord (ID: `keyterm:WordOfTheLord`); فِي (ID: `place:Nile`); Plumb Line (ID: `realia:PlumbLine`); Basket (ID: `realia:Basket`); Lamentation (ID: `keyterm:Lamentation`); فِلِشْتِيم (ID: `group:Philistine`); Deceit (ID: `keyterm:Deceit`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Cush (ID: `place:Cush.2`); دَانَ (ID: `group:Dan`); Sabbath (ID: `keyterm:Sabbath`); New Moon Festival (ID: `keyterm:NewMoonFestival`); كِرِيتَ (ID: `place:Crete`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); Beersheba (ID: `place:Beersheba`); Defilement (ID: `keyterm:Defilement`); Syrians (ID: `group:Syria`); إِلَى (ID: `place:Kir`); يَهوذَا (ID: `group:Judah`); Hell (ID: `place:Hell`); ٱلسَّامِرَةِ (ID: `place:Samaria`); يَهوذَا (ID: `person:Judah.4`); فِي (ID: `place:Carmel`); Cushites (ID: `group:Cush`); دَانَ (ID: `place:Dan`); Forgive (ID: `keyterm:Forgive`); Floor (ID: `realia:Floor`); Sieve (ID: `realia:Sieve`); Ephah (ID: `realia:Ephah`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Pine (ID: `flora:Pine`); House (ID: `realia:House`); Balance (ID: `realia:Balance`); Capital (ID: `realia:Capital`); Flock (ID: `fauna:Flock`); Locust (ID: `fauna:Locust`); Doorstep (ID: `realia:Doorstep`); Shekel (ID: `realia:Shekel`); Sackcloth (ID: `realia:Sackcloth`); Fig (ID: `flora:Fig`); Money (ID: `realia:Money`); Rope (ID: `realia:Rope`); Altar (ID: `realia:Altar`); High Place (ID: `realia:HighPlace`); Snake (ID: `fauna:Snake`); Temple Altar (ID: `realia:TempleAltar`); Sycomore Fig (ID: `flora:SycomoreFig`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`)
## عاموس 7: 2 (id: 750923)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عَاموس (ID: `person:Amos.3`); Speak as a Prophet (ID: `keyterm:Speak`); أَمَصْيَا (ID: `person:Amaziah.4`); ٱلرَّبِّ (ID: `deity:Lord`); يَربْعَام (ID: `person:Jeroboam.2`); Bethel (ID: `place:Bethel`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); إِسْحَاق (ID: `person:Isaac`); Defilement (ID: `keyterm:Defilement`); Word of the Lord (ID: `keyterm:WordOfTheLord`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Fig (ID: `flora:Fig`); Rope (ID: `realia:Rope`); Sycomore Fig (ID: `flora:SycomoreFig`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْحَاق (ID: `person:Isaac`); Speak as a Prophet (ID: `keyterm:Speak`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Swear (ID: `keyterm:Swear`); Lamentation (ID: `keyterm:Lamentation`); Deceit (ID: `keyterm:Deceit`); دَانَ (ID: `place:Dan`); دَانَ (ID: `group:Dan`); Sabbath (ID: `keyterm:Sabbath`); Beersheba (ID: `place:Beersheba`); إِسْرَائِيلَ (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); فِي (ID: `place:Nile`); ٱلسَّامِرَةِ (ID: `place:Samaria`); New Moon Festival (ID: `keyterm:NewMoonFestival`); مِصْرَ (ID: `place:Egypt`); Ephah (ID: `realia:Ephah`); Balance (ID: `realia:Balance`); Shekel (ID: `realia:Shekel`); Sackcloth (ID: `realia:Sackcloth`); Money (ID: `realia:Money`)
## عاموس 8: 5 (id: 750935)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Swear (ID: `keyterm:Swear`); Beersheba (ID: `place:Beersheba`); دَانَ (ID: `group:Dan`); دَانَ (ID: `place:Dan`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Swear (ID: `keyterm:Swear`); Beersheba (ID: `place:Beersheba`); دَانَ (ID: `group:Dan`); دَانَ (ID: `place:Dan`); ٱلسَّامِرَةِ (ID: `place:Samaria`)
## عاموس 9: 1 (id: 750944)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Capital (ID: `realia:Capital`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Doorstep (ID: `realia:Doorstep`); Altar (ID: `realia:Altar`)
## عاموس 9: 2 (id: 750946)
...
* **Associated ACAI Concepts:** كِرِيتَ (ID: `place:Crete`); فِلِشْتِيم (ID: `group:Philistine`); Syrians (ID: `group:Syria`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); ٱلرَّبِّ (ID: `deity:Lord`); إِلَى (ID: `place:Kir`); Cush (ID: `place:Cush.2`); Cushites (ID: `group:Cush`); مِصْرَ (ID: `place:Egypt`)
## عاموس 9: 8 (id: 750950)
...
* **Associated ACAI Concepts:** أَدومَ (ID: `place:Edom`); Dispossess (ID: `keyterm:Dispossess`); ٱلرَّبِّ (ID: `deity:Lord`); دَاودَ (ID: `person:David`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Vine (ID: `flora:Vine`); أَدومَ (ID: `place:Edom`); إِسْرَائِيلَ (ID: `person:Israel`); دَاودَ (ID: `person:David`); Dispossess (ID: `keyterm:Dispossess`); Wine (ID: `realia:Wine`); Mattock (ID: `realia:Mattock`); Barley (ID: `flora:Barley`); Must (ID: `realia:Must`); Coriander (ID: `flora:Coriander`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Mattock (ID: `realia:Mattock`); Barley (ID: `flora:Barley`); Vine (ID: `flora:Vine`); Must (ID: `realia:Must`); Coriander (ID: `flora:Coriander`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Vine (ID: `flora:Vine`); إِسْرَائِيلَ (ID: `person:Israel`); Wine (ID: `realia:Wine`); Mattock (ID: `realia:Mattock`); Barley (ID: `flora:Barley`); Must (ID: `realia:Must`); Coriander (ID: `flora:Coriander`)
