...
* **Associated ACAI Concepts:** Kiljon (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); Éphrata (ID: `person:Ephrathah`); Élimélec (ID: `person:Elimelech`); Juda (ID: `group:Judah`); Machlon (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Bethléhem (ID: `place:Bethlehem`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** charger (ID: `keyterm:Appoint`); Moab (ID: `place:Moab`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); Bethléhem (ID: `place:Bethlehem`); Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); laissiez en possession (ID: `keyterm:Possess`); Naomi (ID: `person:Naomi`); Boaz (ID: `person:Boaz`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Rachel (ID: `person:Rachel`); Israël (ID: `person:Israel`); Bethléhem (ID: `place:Bethlehem`); Elders (ID: `group:GenericElders`); Léa (ID: `person:Leah`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Juda (ID: `group:Judah`); Tamar (ID: `person:Tamar`); Perets (ID: `person:Perez`); Juda (ID: `person:Judah.4`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Israël (ID: `person:Israel`); Naomi (ID: `person:Naomi`); Éternel (ID: `deity:Lord`); benir (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Hetsron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Amminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Isaï (ID: `person:Jesse`); Nahshon (ID: `person:Nahshon`); David (ID: `person:David`); Perets (ID: `person:Perez`); Boaz (ID: `person:Boaz`)
