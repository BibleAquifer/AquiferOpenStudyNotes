...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); Love (ID: `keyterm:Love`); Mercy (ID: `keyterm:Mercy`); Make Peace (ID: `keyterm:Peace`); Chosen (ID: `keyterm:Chosen`); ٱلرَّبِّ (ID: `deity:Lord`); Favor (ID: `keyterm:Favor`); يَسوع (ID: `person:Jesus.2`); Always (ID: `keyterm:Always`)
...
* **Associated ACAI Concepts:** Mercy (ID: `keyterm:Mercy`); Love (ID: `keyterm:Love`); Make Peace (ID: `keyterm:Peace`); Truth (ID: `keyterm:Truth`); ٱلرَّبِّ (ID: `deity:Lord`); Favor (ID: `keyterm:Favor`); يَسوع (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); Love (ID: `keyterm:Love`); ٱلرَّبِّ (ID: `deity:Lord`); Live (ID: `keyterm:Live.3`); يَسوع (ID: `person:Jesus.2`); Share (ID: `keyterm:Share`); Ability (ID: `keyterm:Ability`); Truth (ID: `keyterm:Truth`); Body (ID: `keyterm:Body.3`); Ask for (ID: `keyterm:AskFor`); House (ID: `realia:House`)
