...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); force (ID: `keyterm:Strength`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Basan (ID: `place:Bashan`); zélé (ID: `keyterm:Zealous.3`); Liban (ID: `place:Lebanon`); Carmel (ID: `place:Carmel`); chemin (ID: `keyterm:TheWay`)
...
* **Associated ACAI Concepts:** méchanceté (ID: `keyterm:Wickedness`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); faire un voeu (ID: `keyterm:Vow`); état intact (ID: `keyterm:IntactState`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); Éternel (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Égypte (ID: `place:Egypt`); Puth (ID: `place:Put`); Libya (ID: `place:Libya`); Cush (ID: `place:Cush.2`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); destin (ID: `keyterm:Lot`)
