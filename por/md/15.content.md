...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Pérsia (ID: `place:Persia`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Jeremias (ID: `person:Jeremiah.6`); Israel (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Pérsia (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Benjamim (ID: `group:Benjamin`); Benjamim (ID: `person:Benjamin`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Nabucodonozor (ID: `person:Nebuchadnezzar`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Salomão (ID: `person:Solomon`); Netofa (ID: `place:Netophah`); Besai (ID: `person:Besai`); Querube (ID: `place:Cherub`); Bigvai (ID: `person:Bigvai.2`); Bebai (ID: `person:Bebai`); Bazlite (ID: `person:Bazluth`); Parós (ID: `person:Parosh`); Peruda (ID: `person:Peruda`); Reelaías (ID: `person:Reelaiah`); Harim (ID: `person:Harim`); Sobai (ID: `person:Shobai`); Hagabe (ID: `person:Hagab`); Jedaías (ID: `person:Jedaiah.4`); Adim (ID: `person:Adin`); Bezai (ID: `person:Bezai`); Seraias (ID: `person:Seraiah.6`); Meída (ID: `person:Mehida`); Hatita (ID: `person:Hatita`); Necoda (ID: `person:Nekoda`); Paate-Moabe (ID: `person:Pahath-moab`); Mispar (ID: `person:Mispar`); Ará (ID: `person:Arah.2`); Rezim (ID: `person:Rezin.2`); Gidel (ID: `person:Giddel`)
...
* **Associated ACAI Concepts:** Mispar (ID: `person:Mispar`); Mordecai (ID: `person:Mordecai`); Seraias (ID: `person:Seraiah.6`); Bigvai (ID: `person:Bigvai`); Reum (ID: `person:Rehum`); Reelaías (ID: `person:Reelaiah`); Bilsã (ID: `person:Bilshan`); Baana (ID: `person:Baanah.3`); Neemias (ID: `person:Nehemiah`); Israel (ID: `person:Israel`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** Adonicão (ID: `person:Adonikam`); Bigvai (ID: `person:Bigvai.2`); Bebai (ID: `person:Bebai`); Elam (ID: `person:Elam`); Parós (ID: `person:Parosh`); Bani (ID: `person:Bani`); Jesua (ID: `person:Jeshua.3`); Sephatias (ID: `person:Shephatiah.6`); Hasum (ID: `person:Hashum`); Adim (ID: `person:Adin`); Bezai (ID: `person:Bezai`); Ezequias (ID: `person:Hezekiah.2`); Jora (ID: `person:Jorah`); Ater (ID: `person:Ater`); Paate-Moabe (ID: `person:Pahath-moab`); Zacai (ID: `person:Zaccai.2`); Ará (ID: `person:Arah.2`); Joabe (ID: `person:Joab.3`); Asgade (ID: `person:Azgad`); Zatu (ID: `person:Zattu.2`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Netofa (ID: `place:Netophah`); Senaa (ID: `place:Senaah`); Harim (ID: `person:Harim.2`); Magbis (ID: `place:Magbish`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Hadide (ID: `place:Hadid`); Nebo (ID: `place:Nebo.2`); Elam (ID: `person:Elam`); Geba (ID: `place:Geba`); Jericó (ID: `place:Jericho`); Anatote (ID: `place:Anathoth`); Quiriate-Jearim (ID: `place:Kiriath-jearim`); Ono (ID: `place:Ono`); Betel (ID: `place:Bethel`); Cefira (ID: `place:Chephirah`); Ramah (ID: `place:Ramah.2`); Beerote (ID: `place:Beeroth`); Ai (ID: `place:Ai`); Belém (ID: `place:Bethlehem`); Lode (ID: `place:Lod`); Micmás (ID: `place:Michmash`)
...
* **Associated ACAI Concepts:** Hodavias (ID: `person:Hodaviah.4`); Imer (ID: `person:Immer.2`); Ater (ID: `person:Ater.2`); Hatita (ID: `person:Hatita`); Talmom (ID: `person:Talmon`); Jedaías (ID: `person:Jedaiah.4`); Jesua (ID: `person:Jeshua.4`); Harim (ID: `person:Harim`); Jesua (ID: `person:Jeshua`); Sobai (ID: `person:Shobai`); Salum (ID: `person:Shallum.8`); Cadmiel (ID: `person:Kadmiel`); Levi (ID: `group:Levi`); Acube (ID: `person:Akkub.2`); Asafe (ID: `person:Asaph.2`); Pasur (ID: `person:Pashhur`); Levi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Ater (ID: `person:Ater.2`); Hatita (ID: `person:Hatita`); Talmom (ID: `person:Talmon`); Sobai (ID: `person:Shobai`); Salum (ID: `person:Shallum.8`); Asafe (ID: `person:Asaph.2`); Acube (ID: `person:Akkub.2`)
...
* **Associated ACAI Concepts:** Besai (ID: `person:Besai`); Paseia (ID: `person:Paseah.2`); Bazlite (ID: `person:Bazluth`); Hacufa (ID: `person:Hakupha`); Hatifa (ID: `person:Hatipha`); Sisera (ID: `person:Sisera.2`); Reaías (ID: `person:Reaiah.3`); Meunim (ID: `group:Meunim`); Hagaba (ID: `person:Hagabah`); Gaar (ID: `person:Gahar`); Gazão (ID: `person:Gazzam`); Hanã (ID: `person:Hanan.4`); Hagabe (ID: `person:Hagab`); Tabaote (ID: `person:Tabbaoth`); Harur (ID: `person:Harhur`); Salmai (ID: `person:Shalmai`); Barcos (ID: `person:Barkos`); Lebana (ID: `person:Lebanah`); Padom (ID: `person:Padon`); Sia (ID: `person:Siaha`); Harsa (ID: `person:Harsha`); Uza (ID: `person:Uzza.2`); Hasufa (ID: `person:Hasupha`); Meída (ID: `person:Mehida`); Acube (ID: `person:Akkub.3`); Temá (ID: `person:Temah`); Asná (ID: `person:Asnah`); Necoda (ID: `person:Nekoda`); Baquebuque (ID: `person:Bakbuk`); Zia (ID: `person:Ziha`); Rezim (ID: `person:Rezin.2`); Queros (ID: `person:Keros`); Gidel (ID: `person:Giddel`); Nephushesim (ID: `group:Nephushesim`); Nesias (ID: `person:Neziah`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Hatil (ID: `person:Hattil`); Sephatias (ID: `person:Shephatiah.7`); Darcom (ID: `person:Darkon`); Peruda (ID: `person:Peruda`); Soferete (ID: `person:Sophereth`); Sotai (ID: `person:Sotai`); Ami (ID: `person:Ami`); Jaala (ID: `person:Jaalah`); Gidel (ID: `person:Giddel.2`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`)
...
* **Associated ACAI Concepts:** Imer (ID: `place:Immer`); Querube (ID: `place:Cherub`); Tel-Harsa (ID: `place:Tel-harsha`); Delaías (ID: `person:Delaiah.3`); Adã (ID: `place:Addan`); Tobias (ID: `person:Tobiah`); Necoda (ID: `person:Nekoda.2`); Tel-Melá (ID: `place:Tel-melah`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Hacoz (ID: `person:Hakkoz.2`); Barzillai (ID: `person:Barzillai.3`); Habaiah (ID: `person:Habaiah`); Gileade (ID: `place:Gilead`); Gileadites (ID: `group:Gilead`); priesthood (ID: `keyterm:Priesthood`); Barzillai (ID: `person:Barzillai`); stain (ID: `keyterm:Stain`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); strength (ID: `keyterm:Strength`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Tunic (ID: `realia:Tunic`); Mina (ID: `realia:Mina`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Josué (ID: `person:Joshua.5`); Pérsia (ID: `place:Persia`); Ciro (ID: `person:Cyrus`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Henadade (ID: `person:Henadad`); Cadmiel (ID: `person:Kadmiel`); Relatives (ID: `group:Relatives`); Hodavias (ID: `person:Hodaviah.4`); Esar-Hadom (ID: `person:Esarhaddon`); Jesua (ID: `person:Jeshua.4`); Moisés (ID: `person:Moses`); kindness (ID: `keyterm:Kindness`); Davi (ID: `person:David`); holy (ID: `keyterm:Holy`); Sidonians (ID: `group:Sidon`); Jope (ID: `place:Joppa`); Benjamim (ID: `person:Benjamin`); Libano (ID: `place:Lebanon`); Hodias (ID: `person:Hodiah.2`); Tyrians (ID: `group:Tyre`); Sidom (ID: `place:Sidon`); Dario (ID: `person:Darius.2`); terror (ID: `keyterm:Terror`); counsel (ID: `keyterm:Counsel`); Tiro (ID: `place:Tyre`); Instruction (ID: `keyterm:Instruction`); Asafe (ID: `person:Asaph.2`); appointed feast (ID: `keyterm:AppointedFeast`); Benjamim (ID: `group:Benjamin`); Assyria (ID: `place:Assyria`); new moon festival (ID: `keyterm:NewMoonFestival`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); Craftsman (ID: `realia:Craftsman`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Cedar (ID: `flora:Cedar`)
...
* **Associated ACAI Concepts:** Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Moisés (ID: `person:Moses`); offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** terror (ID: `keyterm:Terror`); offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Sidonians (ID: `group:Sidon`); Jope (ID: `place:Joppa`); Libano (ID: `place:Lebanon`); Ciro (ID: `person:Cyrus`); Tiro (ID: `place:Tyre`); Pérsia (ID: `place:Persia`); Tyrians (ID: `group:Tyre`); Sidom (ID: `place:Sidon`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Sealtiel (ID: `person:Shealtiel.2`); Levi (ID: `group:Levi`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Levi (ID: `person:Levi.3`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); kindness (ID: `keyterm:Kindness`); Davi (ID: `person:David`); Levi (ID: `group:Levi`); Asafe (ID: `person:Asaph.2`); Levi (ID: `person:Levi.3`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Benjamim (ID: `group:Benjamin`); Benjamim (ID: `person:Benjamin`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Pérsia (ID: `place:Persia`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Pérsia (ID: `place:Persia`); counsel (ID: `keyterm:Counsel`); Ciro (ID: `person:Cyrus`); Dario (ID: `person:Darius.2`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Rio Eufrates (ID: `place:Euphrates`); Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Artaxerxes (ID: `person:Artaxerxes.2`); Pérsia (ID: `place:Persia`); Samaria (ID: `place:Samaria`); Jews (ID: `group:Jews`); Dinaítas (ID: `person:Dinaite`); Osnapar (ID: `person:Osnappar`); Babylonians (ID: `group:Babylon`); Mitredate (ID: `person:Mithredath.2`); Ereque (ID: `place:Erech`); Assuero (ID: `person:Ahasuerus`); Bislão (ID: `person:Bishlam`); Tabeel (ID: `person:Tabeel`); Babilônia (ID: `place:Babylon`); Persians (ID: `group:Persia`); Judá (ID: `person:Judah.4`); Susã (ID: `place:Susa`); Judá (ID: `group:Judah`); Elamites (ID: `group:Elam`); Elam (ID: `place:Elam`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Babylonians (ID: `group:Babylon`); Dinaítas (ID: `person:Dinaite`); Ereque (ID: `place:Erech`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Babilônia (ID: `place:Babylon`); Elamites (ID: `group:Elam`); Pérsia (ID: `place:Persia`); Persians (ID: `group:Persia`); Elam (ID: `place:Elam`); Susã (ID: `place:Susa`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Artaxerxes (ID: `person:Artaxerxes.2`); Samaria (ID: `place:Samaria`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Jews (ID: `group:Jews`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Jerusalém (ID: `place:Jerusalem`); Artaxerxes (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Dario (ID: `person:Darius.2`); Jews (ID: `group:Jews`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Ido (ID: `person:Iddo.6`); Ageu (ID: `person:Haggai`); Tattenai (ID: `person:Tattenai`); Zacarias (ID: `person:Zechariah.17`); Judá (ID: `person:Judah.4`); Israel (ID: `person:Israel`); Pérsia (ID: `place:Persia`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Rio Eufrates (ID: `place:Euphrates`)
...
* **Associated ACAI Concepts:** Ido (ID: `person:Iddo.6`); Zacarias (ID: `person:Zechariah.17`); Ageu (ID: `person:Haggai`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Babilônia (ID: `place:Babylon`); Caldéia (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); Nabucodonozor (ID: `person:Nebuchadnezzar`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); passover (ID: `keyterm:Passover`); pure (ID: `keyterm:Pure`)
...
* **Associated ACAI Concepts:** defilement (ID: `keyterm:Defilement`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Gentiles (ID: `group:Gentile`)
...
* **Associated ACAI Concepts:** Assyria (ID: `place:Assyria`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Unleavened Bread (ID: `realia:UnleavenedBread`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Seraias (ID: `person:Seraiah.2`); Azarias (ID: `person:Azariah.7`); Ezra (ID: `person:Ezra`); Pérsia (ID: `place:Persia`); Hilquias (ID: `person:Hilkiah.2`); Artaxerxes (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Zadoque (ID: `person:Zadok.4`); Aitube (ID: `person:Ahitub.3`); Amarias (ID: `person:Amariah.2`); Meraiote (ID: `person:Meraioth`); Uzi (ID: `person:Uzzi`); Abisua (ID: `person:Abishua`); Seraias (ID: `person:Seraiah.2`); Azarias (ID: `person:Azariah.7`); Azarias (ID: `person:Azariah.6`); Buqui (ID: `person:Bukki.2`); Salum (ID: `person:Shallum.7`); Zeraías (ID: `person:Zerahiah`); Pérsia (ID: `place:Persia`); Arão (ID: `person:Aaron`); Eleazar (ID: `person:Eleazar.2`); Fineias (ID: `person:Phinehas`); Artaxerxes (ID: `person:Artaxerxes`); Hilquias (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Moisés (ID: `person:Moses`); Babilônia (ID: `place:Babylon`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); Ezra (ID: `person:Ezra`); Artaxerxes (ID: `person:Artaxerxes`); Israel (ID: `person:Israel`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Rio Eufrates (ID: `place:Euphrates`); decree (ID: `keyterm:Decree`); Babilônia (ID: `place:Babylon`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Wheat (ID: `flora:Wheat`); Olive Oil (ID: `realia:OliveOil`); Stone Altar (ID: `realia:StoneAltar`); Kor (ID: `realia:Kor`); Sheep (ID: `fauna:Lamb`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Rio Eufrates (ID: `place:Euphrates`); Artaxerxes (ID: `person:Artaxerxes`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Wheat (ID: `flora:Wheat`); Kor (ID: `realia:Kor`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Adonicão (ID: `person:Adonikam`); Bebai (ID: `person:Bebai`); Gérson (ID: `person:Gershom.2`); Elam (ID: `person:Elam`); Bigvai (ID: `person:Bigvai.2`); Zacarias (ID: `person:Zechariah.19`); Bebai (ID: `person:Bebai.2`); Daniel (ID: `person:Daniel.2`); Elifelete (ID: `person:Eliphelet.5`); Josifias (ID: `person:Josiphiah`); Joanã (ID: `person:Johanan.8`); Sephatias (ID: `person:Shephatiah.6`); Secanias (ID: `person:Shecaniah.6`); Obadias (ID: `person:Obadiah.10`); Jaaziel (ID: `person:Jahaziel.5`); Zabadias (ID: `person:Zebadiah.8`); Zeraías (ID: `person:Zerahiah.2`); Adim (ID: `person:Adin`); Jesaías (ID: `person:Jeshaiah.4`); Hatus (ID: `person:Hattush.2`); Ebede (ID: `person:Ebed.2`); Jeuel (ID: `person:Jeuel.3`); Jeiel (ID: `person:Jehiel.7`); Secanias (ID: `person:Shecaniah.5`); Atalia (ID: `person:Athaliah.3`); Selomite (ID: `person:Shelomith.4`); Zacur (ID: `person:Zaccur.5`); Jônatas (ID: `person:Jonathan.9`); Joabe (ID: `person:Joab.4`); Utai (ID: `person:Uthai.2`); Miguel (ID: `person:Michael.10`); Zacarias (ID: `person:Zechariah.18`); Elioenai (ID: `person:Eliehoenai.2`); Semaías (ID: `person:Shemaiah.14`); Paate-Moabe (ID: `person:Pahath-moab`); Parós (ID: `person:Parosh.2`); Asgade (ID: `person:Azgad`); Hacatã (ID: `person:Hakkatan`); Davi (ID: `person:David`); Babilônia (ID: `place:Babylon`); Fineias (ID: `person:Phinehas`); Artaxerxes (ID: `person:Artaxerxes`); Itamar (ID: `person:Ithamar`)
...
* **Associated ACAI Concepts:** Ariel (ID: `person:Ariel`); Jaribe (ID: `person:Jarib.2`); Natã (ID: `person:Nathan.5`); Elnatã (ID: `person:Elnathan.4`); Semaías (ID: `person:Shemaiah.15`); Joiaribe (ID: `person:Joiarib.2`); Eliezer (ID: `person:Eliezer.8`); Zacarias (ID: `person:Zechariah.20`); Ido (ID: `person:Iddo`); Mesulão (ID: `person:Meshullam.9`); Elnatã (ID: `person:Elnathan.3`); Casifia (ID: `place:Casiphia`); Elnatã (ID: `person:Elnathan.2`); SENHOR (ID: `deity:Lord`); perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Mali (ID: `person:Mahli`); Insight (ID: `keyterm:Insight`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Levi (ID: `group:Levi`); work (ID: `keyterm:Work`); Levi (ID: `person:Levi.3`); Davi (ID: `person:David`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); Egito (ID: `place:Egypt`); Egyptians (ID: `group:Egypt`); be unfaithful (ID: `keyterm:Unfaithful`); Moabe (ID: `place:Moab`); Jebusites (ID: `group:Jebusites`); Hete (ID: `person:Heth`); cananeu (ID: `group:Canaan`); Israel (ID: `person:Israel`); Canaã (ID: `place:Canaan`); Amorites (ID: `group:Amorites`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Ammonites (ID: `group:Ammon`); Amom (ID: `place:Ammon`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); House (ID: `realia:House`); Harim (ID: `person:Harim`); counsel (ID: `keyterm:Counsel`); Elam (ID: `person:Elam`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); offering (ID: `keyterm:Offering`); Adaías (ID: `person:Adaiah.5`); Judá (ID: `person:Judah.5`); Simeão (ID: `person:Shimeon`); Kelaiah (ID: `person:Kelaiah`); Petaías (ID: `person:Pethahiah.2`); Binui (ID: `person:Binnui.4`); Parós (ID: `person:Parosh`); Elioenai (ID: `person:Elioenai.5`); Salum (ID: `person:Shallum.11`); Judeia (ID: `place:Judea`); Jeiel (ID: `person:Jeiel.8`); Natanael (ID: `person:Nethanel.8`); Jeiel (ID: `person:Jehiel.10`); Bani (ID: `person:Bani.5`); Jozabade (ID: `person:Jozabad.7`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); kindness (ID: `keyterm:Kindness`); Jerusalém (ID: `place:Jerusalem`); dispossess (ID: `keyterm:Dispossess`); to cause to possess (ID: `keyterm:Possess`); Israel (ID: `person:Israel`); peace (ID: `keyterm:IntactState`); Pérsia (ID: `place:Persia`); supplication (ID: `keyterm:Supplication`); defilement (ID: `keyterm:Defilement`); Peg (ID: `realia:Peg`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); kindness (ID: `keyterm:Kindness`); Jerusalém (ID: `place:Jerusalem`); Pérsia (ID: `place:Persia`); supplication (ID: `keyterm:Supplication`); Peg (ID: `realia:Peg`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** arrepender, se (ID: `keyterm:Repent`); Ezra (ID: `person:Ezra`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jeiel (ID: `person:Jehiel.8`); Secanias (ID: `person:Shecaniah.7`); be unfaithful (ID: `keyterm:Unfaithful`); Elam (ID: `person:Elam`); Ezra (ID: `person:Ezra`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); Levi (ID: `group:Levi`); swear (ID: `keyterm:Swear`); Levi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Benjamim (ID: `group:Benjamin`); Benjamim (ID: `person:Benjamin`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jônatas (ID: `person:Jonathan.10`); Asael (ID: `person:Asahel.4`); Sabetai (ID: `person:Shabbethai`); Mesulão (ID: `person:Meshullam.10`); Jazeías (ID: `person:Jahzeiah`); Ticva (ID: `person:Tikvah.2`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`)
