...
* **Associated ACAI Concepts:** kasihi (ID: `keyterm:Love`); jemaat (ID: `keyterm:Church`); kebenaran (ID: `keyterm:Truth`); Tuhan (ID: `deity:Lord`); nama (ID: `keyterm:Name`); kekasih (ID: `keyterm:Beloved`); kesetiaan (ID: `keyterm:Faithfulness`); bersaksi (ID: `keyterm:BearWitness`); wajib (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** jemaat (ID: `keyterm:Church`); Diotrefes (ID: `person:Diotrephes`); Demetrius (ID: `person:Demetrius`); lakukan baik (ID: `keyterm:DoGood`); yang baik (ID: `keyterm:Good`); kebenaran (ID: `keyterm:Truth`); Tuhan (ID: `deity:Lord`); kekasih (ID: `keyterm:Beloved`); bersaksi (ID: `keyterm:BearWitness`); benar (ID: `keyterm:True`)
...
* **Associated ACAI Concepts:** lakukan baik (ID: `keyterm:DoGood`); Tuhan (ID: `deity:Lord`); yang baik (ID: `keyterm:Good`); kekasih (ID: `keyterm:Beloved`)
