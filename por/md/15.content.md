...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`)
...
* **Associated ACAI Concepts:** Hagabe (ID: `person:Hagab`); Acube (ID: `person:Akkub.3`); Magbis (ID: `place:Magbish`); Asná (ID: `person:Asnah`); Elam (ID: `person:Elam`); Baana (ID: `person:Baanah.3`); Imer (ID: `place:Immer`); Uza (ID: `person:Uzza.2`); Reelaías (ID: `person:Reelaiah`); Sobai (ID: `person:Shobai`); Rezim (ID: `person:Rezin.2`); Querube (ID: `place:Cherub`); Sisera (ID: `person:Sisera.2`); Zia (ID: `person:Ziha`); Gazão (ID: `person:Gazzam`); Harur (ID: `person:Harhur`); Reaías (ID: `person:Reaiah.3`); Gaar (ID: `person:Gahar`); Ezequias (ID: `person:Hezekiah.2`); Neemias (ID: `person:Nehemiah`); Mordecai (ID: `person:Mordecai`); Padom (ID: `person:Padon`); Paseia (ID: `person:Paseah.2`); Hatita (ID: `person:Hatita`); Adã (ID: `place:Addan`); Sotai (ID: `person:Sotai`); Bazlite (ID: `person:Bazluth`); Lebana (ID: `person:Lebanah`); Harsa (ID: `person:Harsha`); Bigvai (ID: `person:Bigvai`)
...
* **Associated ACAI Concepts:** Baana (ID: `person:Baanah.3`); Neemias (ID: `person:Nehemiah`); Mispar (ID: `person:Mispar`); Mordecai (ID: `person:Mordecai`); Reelaías (ID: `person:Reelaiah`); Bigvai (ID: `person:Bigvai`); Bilsã (ID: `person:Bilshan`); Seraias (ID: `person:Seraiah.6`); Reum (ID: `person:Rehum`)
...
* **Associated ACAI Concepts:** Joabe (ID: `person:Joab.3`); Bezai (ID: `person:Bezai`); Jora (ID: `person:Jorah`); Jesua (ID: `person:Jeshua.3`); Ezequias (ID: `person:Hezekiah.2`); Ará (ID: `person:Arah.2`); Ater (ID: `person:Ater`); Zacai (ID: `person:Zaccai.2`); Adim (ID: `person:Adin`); Asgade (ID: `person:Azgad`); Zatu (ID: `person:Zattu.2`); Sephatias (ID: `person:Shephatiah.6`); Bigvai (ID: `person:Bigvai.2`); Adonicão (ID: `person:Adonikam`); Bani (ID: `person:Bani`); Parós (ID: `person:Parosh`); Hasum (ID: `person:Hashum`); Bebai (ID: `person:Bebai`); Paate-Moabe (ID: `person:Pahath-moab`); Elam (ID: `person:Elam`)
...
* **Associated ACAI Concepts:** Magbis (ID: `place:Magbish`); Harim (ID: `person:Harim.2`); Senaa (ID: `place:Senaah`); Nebo (ID: `place:Nebo.2`); Hadide (ID: `place:Hadid`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Netofa (ID: `place:Netophah`)
...
* **Associated ACAI Concepts:** Ater (ID: `person:Ater.2`); Hatita (ID: `person:Hatita`); Sobai (ID: `person:Shobai`); Hodavias (ID: `person:Hodaviah.4`); Jedaías (ID: `person:Jedaiah.4`); Jesua (ID: `person:Jeshua`); Imer (ID: `person:Immer.2`); Talmom (ID: `person:Talmon`); Harim (ID: `person:Harim`); Jesua (ID: `person:Jeshua.4`)
...
* **Associated ACAI Concepts:** Ater (ID: `person:Ater.2`); Hatita (ID: `person:Hatita`); Sobai (ID: `person:Shobai`); Talmom (ID: `person:Talmon`)
...
* **Associated ACAI Concepts:** Hagabe (ID: `person:Hagab`); Acube (ID: `person:Akkub.3`); Asná (ID: `person:Asnah`); Paseia (ID: `person:Paseah.2`); Meída (ID: `person:Mehida`); Uza (ID: `person:Uzza.2`); Gidel (ID: `person:Giddel`); Hagaba (ID: `person:Hagabah`); Bazlite (ID: `person:Bazluth`); Lebana (ID: `person:Lebanah`); Rezim (ID: `person:Rezin.2`); Sisera (ID: `person:Sisera.2`); Harsa (ID: `person:Harsha`); Barcos (ID: `person:Barkos`); Hasufa (ID: `person:Hasupha`); Zia (ID: `person:Ziha`); Gazão (ID: `person:Gazzam`); Harur (ID: `person:Harhur`); Tabaote (ID: `person:Tabbaoth`); Reaías (ID: `person:Reaiah.3`); Gaar (ID: `person:Gahar`); Salmai (ID: `person:Shalmai`); Hatifa (ID: `person:Hatipha`); Hanã (ID: `person:Hanan.4`); Nesias (ID: `person:Neziah`); Temá (ID: `person:Temah`); Sia (ID: `person:Siaha`); Meunim (ID: `group:Meunim`); Queros (ID: `person:Keros`); Hacufa (ID: `person:Hakupha`); Necoda (ID: `person:Nekoda`); Padom (ID: `person:Padon`); Nephushesim (ID: `group:Nephushesim`); Besai (ID: `person:Besai`); Baquebuque (ID: `person:Bakbuk`)
...
* **Associated ACAI Concepts:** Gidel (ID: `person:Giddel.2`); Darcom (ID: `person:Darkon`); Soferete (ID: `person:Sophereth`); Ami (ID: `person:Ami`); Jaala (ID: `person:Jaalah`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Sotai (ID: `person:Sotai`); Hatil (ID: `person:Hattil`); Sephatias (ID: `person:Shephatiah.7`); Peruda (ID: `person:Peruda`)
...
* **Associated ACAI Concepts:** Querube (ID: `place:Cherub`); Tel-Melá (ID: `place:Tel-melah`); Imer (ID: `place:Immer`); Adã (ID: `place:Addan`); Tel-Harsa (ID: `place:Tel-harsha`); Delaías (ID: `person:Delaiah.3`); Tobias (ID: `person:Tobiah`); Necoda (ID: `person:Nekoda.2`)
...
* **Associated ACAI Concepts:** Hacoz (ID: `person:Hakkoz.2`); Habaiah (ID: `person:Habaiah`); Barzillai (ID: `person:Barzillai.3`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Henadade (ID: `person:Henadad`); Relatives (ID: `group:Relatives`); Sealtiel (ID: `person:Shealtiel.2`); Jeozadaque (ID: `person:Jehozadak`); Hodavias (ID: `person:Hodaviah.4`); Esar-Hadom (ID: `person:Esarhaddon`); Jesua (ID: `person:Jeshua.4`); Cadmiel (ID: `person:Kadmiel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Sealtiel (ID: `person:Shealtiel.2`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Esar-Hadom (ID: `person:Esarhaddon`)
...
* **Associated ACAI Concepts:** Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Babylonians (ID: `group:Babylon`); Bislão (ID: `person:Bishlam`); Dinaítas (ID: `person:Dinaite`); Tabeel (ID: `person:Tabeel`); Osnapar (ID: `person:Osnappar`); Mitredate (ID: `person:Mithredath.2`); Ereque (ID: `place:Erech`); Assuero (ID: `person:Ahasuerus`); Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Bislão (ID: `person:Bishlam`); Tabeel (ID: `person:Tabeel`); Mitredate (ID: `person:Mithredath.2`)
...
* **Associated ACAI Concepts:** Babylonians (ID: `group:Babylon`); Dinaítas (ID: `person:Dinaite`); Ereque (ID: `place:Erech`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`)
...
* **Associated ACAI Concepts:** Osnapar (ID: `person:Osnappar`)
...
* **Associated ACAI Concepts:** Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`)
...
* **Associated ACAI Concepts:** Tattenai (ID: `person:Tattenai`); Ido (ID: `person:Iddo.6`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Zacarias (ID: `person:Zechariah.17`); Ageu (ID: `person:Haggai`)
...
* **Associated ACAI Concepts:** Ido (ID: `person:Iddo.6`); Zacarias (ID: `person:Zechariah.17`); Ageu (ID: `person:Haggai`)
...
* **Associated ACAI Concepts:** Tattenai (ID: `person:Tattenai`); Setar-Bozenai (ID: `person:Shethar-bozenai`)
...
* **Associated ACAI Concepts:** Tattenai (ID: `person:Tattenai`); Setar-Bozenai (ID: `person:Shethar-bozenai`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ecbátana (ID: `place:Ecbatana`)
...
* **Associated ACAI Concepts:** Azarias (ID: `person:Azariah.7`); Seraias (ID: `person:Seraiah.2`); Ezra (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** Amarias (ID: `person:Amariah.2`); Aitube (ID: `person:Ahitub.3`); Buqui (ID: `person:Bukki.2`); Azarias (ID: `person:Azariah.6`); Azarias (ID: `person:Azariah.7`); Abisua (ID: `person:Abishua`); Uzi (ID: `person:Uzzi`); Zadoque (ID: `person:Zadok.4`); Salum (ID: `person:Shallum.7`); Zeraías (ID: `person:Zerahiah`); Seraias (ID: `person:Seraiah.2`); Meraiote (ID: `person:Meraioth`); Ezra (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** decree (ID: `keyterm:Decree`); Money (ID: `realia:Money`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Elioenai (ID: `person:Eliehoenai.2`); Miguel (ID: `person:Michael.10`); Hatus (ID: `person:Hattush.2`); Elifelete (ID: `person:Eliphelet.5`); Atalia (ID: `person:Athaliah.3`); Gérson (ID: `person:Gershom.2`); Josifias (ID: `person:Josiphiah`); Jeiel (ID: `person:Jehiel.7`); Zacarias (ID: `person:Zechariah.18`); Bebai (ID: `person:Bebai.2`); Zacur (ID: `person:Zaccur.5`); Semaías (ID: `person:Shemaiah.14`); Secanias (ID: `person:Shecaniah.5`); Ebede (ID: `person:Ebed.2`); Joanã (ID: `person:Johanan.8`); Obadias (ID: `person:Obadiah.10`); Jesaías (ID: `person:Jeshaiah.4`); Jeuel (ID: `person:Jeuel.3`); Zeraías (ID: `person:Zerahiah.2`); Parós (ID: `person:Parosh.2`); Utai (ID: `person:Uthai.2`); Selomite (ID: `person:Shelomith.4`); Joabe (ID: `person:Joab.4`); Zabadias (ID: `person:Zebadiah.8`); Secanias (ID: `person:Shecaniah.6`); Zacarias (ID: `person:Zechariah.19`); Jaaziel (ID: `person:Jahaziel.5`); Hacatã (ID: `person:Hakkatan`); Jônatas (ID: `person:Jonathan.9`); Daniel (ID: `person:Daniel.2`); Adim (ID: `person:Adin`); Asgade (ID: `person:Azgad`); Sephatias (ID: `person:Shephatiah.6`); Bigvai (ID: `person:Bigvai.2`); Adonicão (ID: `person:Adonikam`); Bebai (ID: `person:Bebai`); Paate-Moabe (ID: `person:Pahath-moab`); Elam (ID: `person:Elam`)
...
* **Associated ACAI Concepts:** Aava (ID: `place:Ahava`)
...
* **Associated ACAI Concepts:** Ariel (ID: `person:Ariel`); Casifia (ID: `place:Casiphia`); Mesulão (ID: `person:Meshullam.9`); Elnatã (ID: `person:Elnathan.4`); Jaribe (ID: `person:Jarib.2`); Elnatã (ID: `person:Elnathan.2`); Ido (ID: `person:Iddo`); Joiaribe (ID: `person:Joiarib.2`); Natã (ID: `person:Nathan.5`); Semaías (ID: `person:Shemaiah.15`); Eliezer (ID: `person:Eliezer.8`); Elnatã (ID: `person:Elnathan.3`); Zacarias (ID: `person:Zechariah.20`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`)
...
* **Associated ACAI Concepts:** be unfaithful (ID: `keyterm:Unfaithful`); Joanã (ID: `person:Jehohanan.5`); Atlai (ID: `person:Athlai`); Judá (ID: `person:Judah.5`); Sasai (ID: `person:Shashai`); Matanias (ID: `person:Mattaniah.8`); Maadai (ID: `person:Maadai`); Binui (ID: `person:Binnui.3`); Elias (ID: `person:Elijah.4`); Maaséias (ID: `person:Maaseiah.9`); Azarel (ID: `person:Azarel.4`); Seal (ID: `person:Sheal`); Jozabade (ID: `person:Jozabad.7`); Sabetai (ID: `person:Shabbethai`); Jaribe (ID: `person:Jarib.3`); Matatá (ID: `person:Mattattah`); Jeiel (ID: `person:Jehiel.9`); Eliezer (ID: `person:Eliezer.11`); Manassés (ID: `person:Manasseh.3`); Hananias (ID: `person:Hananiah.5`); Adna (ID: `person:Adna`); Zabade (ID: `person:Zabad.7`); Uri (ID: `person:Uri.3`); Zabade (ID: `person:Zabad.5`); Matenai (ID: `person:Mattenai`); Selemias (ID: `person:Shelemiah.3`); Jeremote (ID: `person:Jeremoth.3`); Manassés (ID: `person:Manasseh.4`); Eliezer (ID: `person:Eliezer.10`); Jadai (ID: `person:Jaddai`)
...
* **Associated ACAI Concepts:** Judeia (ID: `place:Judea`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jeiel (ID: `person:Jehiel.8`); Secanias (ID: `person:Shecaniah.7`)
...
* **Associated ACAI Concepts:** Sabetai (ID: `person:Shabbethai`); Mesulão (ID: `person:Meshullam.10`); Jazeías (ID: `person:Jahzeiah`); Jônatas (ID: `person:Jonathan.10`); Asael (ID: `person:Asahel.4`); Ticva (ID: `person:Tikvah.2`)
