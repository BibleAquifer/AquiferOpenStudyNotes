...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Liban (ID: `place:Lebanon`); Basan (ID: `place:Bashan`); Carmel (ID: `place:Carmel`); force (ID: `keyterm:Strength`); chemin (ID: `keyterm:TheWay`); déclarer innocent (ID: `keyterm:PronounceInnocent`); zélé (ID: `keyterm:Zealous.3`)
...
* **Associated ACAI Concepts:** Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); faire un voeu (ID: `keyterm:Vow`); méchanceté (ID: `keyterm:Wickedness`); état intact (ID: `keyterm:IntactState`)
...
* **Associated ACAI Concepts:** destin (ID: `keyterm:Lot`); Libya (ID: `place:Libya`); Puth (ID: `place:Put`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Égypte (ID: `place:Egypt`); Cush (ID: `place:Cush.2`)
