...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); rebel (ID: `keyterm:Rebel`); Judá (ID: `group:Judah`); strength (ID: `keyterm:Strength`); Judá (ID: `person:Judah.4`); love (ID: `keyterm:Love`); To Sin (ID: `keyterm:Sin`); work (ID: `keyterm:Work`); Mighty One (ID: `keyterm:MightyOne`); appointed feast (ID: `keyterm:AppointedFeast`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); defilement (ID: `keyterm:Defilement`); Israel (ID: `person:Israel`); Deceit (ID: `keyterm:Deceit`); Train (ID: `realia:Train`); Casting Net (ID: `realia:CastingNet`); Goat (ID: `fauna:Goat`); Winepress (ID: `realia:Winepress`); Yoke (ID: `realia:Yoke`); Net (ID: `realia:Net`); Deer (ID: `fauna:Deer`); Grass (ID: `flora:Grass`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** work (ID: `keyterm:Work`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); To Sin (ID: `keyterm:Sin`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); defilement (ID: `keyterm:Defilement`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Mighty One (ID: `keyterm:MightyOne`); Judá (ID: `person:Judah.4`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** horn (ID: `keyterm:Horn`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Tent (ID: `realia:Tent`); Bow (ID: `realia:Bow`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** appointed feast (ID: `keyterm:AppointedFeast`); sabbath (ID: `keyterm:Sabbath`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** appointed feast (ID: `keyterm:AppointedFeast`); SENHOR (ID: `deity:Lord`); Stone Altar (ID: `realia:StoneAltar`); House (ID: `realia:House`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Wormwood (ID: `flora:Wormwood`); Arrow (ID: `realia:Arrow`); arrow (ID: `keyterm:Arrow`); kindness (ID: `keyterm:Kindness`); peace (ID: `keyterm:IntactState`); Complete (ID: `keyterm:Complete`); Bitter Herbs (ID: `flora:Chicory`); Lion (ID: `fauna:Lion`); Bear (ID: `fauna:Bear`); Hewn Stone (ID: `realia:HewnStone`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`); Edom (ID: `place:Edom`); Uz (ID: `place:Uz`); stain (ID: `keyterm:Stain`); Believe In (ID: `keyterm:BelieveIn`); anointed (ID: `keyterm:Anointed`); be kindly disposed (ID: `keyterm:KindlyDisposed`); Complete (ID: `keyterm:Complete`); defilement (ID: `keyterm:Defilement`); Sodoma (ID: `place:Sodom`); Punishment (ID: `keyterm:Punishment`); Appoint (ID: `keyterm:Appoint`); Jackal (ID: `fauna:Jackal`); Ostrich (ID: `fauna:Ostrich`); Clay Jar (ID: `realia:ClayJar`); Vulture (ID: `fauna:Vulture`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** Edom (ID: `place:Edom`); Uz (ID: `place:Uz`); To Sin (ID: `keyterm:Sin`); Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); Complete (ID: `keyterm:Complete`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`); Appoint (ID: `keyterm:Appoint`); Edom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Jerusalém (ID: `place:Jerusalem`); round dance (ID: `keyterm:RoundDance`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Egito (ID: `place:Egypt`); to cause to possess (ID: `keyterm:Possess`); ardour (ID: `keyterm:Ardour`); Woe (ID: `keyterm:Woe`); Assyria (ID: `place:Assyria`); Hand-Mill (ID: `realia:Hand-mill`); House (ID: `realia:House`); Money (ID: `realia:Money`); Crown (ID: `realia:Crown`); Jackal (ID: `fauna:Jackal`)
