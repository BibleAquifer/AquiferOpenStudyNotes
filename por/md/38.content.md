...
* **Associated ACAI Concepts:** Ido (ID: `person:Iddo.6`); Zacarias (ID: `person:Zechariah.17`); Berequias (ID: `person:Berechiah.6`); Dario (ID: `person:Darius.2`); SENHOR (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ido (ID: `person:Iddo.6`); Zacarias (ID: `person:Zechariah.17`); Berequias (ID: `person:Berechiah.6`); Dario (ID: `person:Darius.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Jerusalém (ID: `place:Jerusalem`); Myrtle (ID: `flora:Myrtle`); Ido (ID: `person:Iddo.6`); Berequias (ID: `person:Berechiah.6`); Dario (ID: `person:Darius.2`); ardour (ID: `keyterm:Ardour`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Zacarias (ID: `person:Zechariah.17`); Be Zealous (ID: `keyterm:Zealous`); Judá (ID: `group:Judah`); House (ID: `realia:House`); Measuring Reed (ID: `realia:MeasuringReed`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Jerusalém (ID: `place:Jerusalem`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); ardour (ID: `keyterm:Ardour`); horn (ID: `keyterm:Horn`); Horse (ID: `fauna:Horse`); Olive Tree (ID: `flora:OliveTree`); Sofonias (ID: `person:Zephaniah.4`); Heldai (ID: `person:Heldai`); Josias (ID: `person:Josiah.2`); Jedaías (ID: `person:Jedaiah.6`); Tobias (ID: `person:Tobijah.2`); Satanás (ID: `deity:Satan`); Come On! (ID: `keyterm:ComeOn`); swear (ID: `keyterm:Swear`); Glory (ID: `keyterm:Glory`); Babilônia (ID: `place:Babylon`); Myrtle (ID: `flora:Myrtle`); Sheep (ID: `fauna:Lamb`); Chariot (ID: `realia:Chariot`); Jeozadaque (ID: `person:Jehozadak`); Berequias (ID: `person:Berechiah.6`); Ido (ID: `person:Iddo.6`); Sinar (ID: `place:Shinar`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); An Angel (ID: `deity:Angel`); SENHOR (ID: `deity:Lord`); Be Zealous (ID: `keyterm:Zealous`)
...
* **Associated ACAI Concepts:** horn (ID: `keyterm:Horn`); Sheep (ID: `fauna:Lamb`); Jerusalém (ID: `place:Jerusalem`); An Angel (ID: `deity:Angel`); Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** horn (ID: `keyterm:Horn`); Sheep (ID: `fauna:Lamb`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); An Angel (ID: `deity:Angel`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Gentiles (ID: `group:Gentile`); Craftsman (ID: `realia:Craftsman`)
...
* **Associated ACAI Concepts:** Gentiles (ID: `group:Gentile`); Judá (ID: `person:Judah.4`); horn (ID: `keyterm:Horn`); Judá (ID: `group:Judah`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Come On! (ID: `keyterm:ComeOn`); An Angel (ID: `deity:Angel`); Glory (ID: `keyterm:Glory`); Babilônia (ID: `place:Babylon`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Josué (ID: `person:Joshua.5`); An Angel (ID: `deity:Angel`); Satanás (ID: `deity:Satan`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`); example (ID: `keyterm:Example`); The Way (ID: `keyterm:TheWay`); pure (ID: `keyterm:Pure`); Turban (ID: `realia:Turban.2`); Craftsman (ID: `realia:Craftsman`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); An Angel (ID: `deity:Angel`); SENHOR (ID: `deity:Lord`); Satanás (ID: `deity:Satan`); Josué (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); The Way (ID: `keyterm:TheWay`); Josué (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Word of the Lord (ID: `keyterm:WordOfTheLord`); Zorobabel (ID: `person:Zerubbabel.2`); SENHOR (ID: `deity:Lord`); strength (ID: `keyterm:Strength`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Tobias (ID: `person:Tobijah.2`); Heldai (ID: `person:Heldai`); Josias (ID: `person:Josiah.2`); Sofonias (ID: `person:Zephaniah.4`); Jedaías (ID: `person:Jedaiah.6`); Crown (ID: `realia:Crown`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); majesty (ID: `keyterm:Majesty`); counsel (ID: `keyterm:Counsel`); peace (ID: `keyterm:IntactState`); Babilônia (ID: `place:Babylon`); Word of the Lord (ID: `keyterm:WordOfTheLord`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Tobias (ID: `person:Tobijah.2`); Heldai (ID: `person:Heldai`); Sofonias (ID: `person:Zephaniah.4`); Josias (ID: `person:Josiah.2`); Jedaías (ID: `person:Jedaiah.6`); Babilônia (ID: `place:Babylon`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Tobias (ID: `person:Tobijah.2`); Heldai (ID: `person:Heldai`); Sofonias (ID: `person:Zephaniah.4`); Josias (ID: `person:Josiah.2`); Jedaías (ID: `person:Jedaiah.6`); SENHOR (ID: `deity:Lord`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Zacarias (ID: `person:Zechariah.17`); Sarezer (ID: `person:Sharezer.2`); Regém-Meleque (ID: `person:Regem-melech`); rogar (ID: `keyterm:AskFor`); Betel (ID: `place:Bethel`); Jerusalém (ID: `place:Jerusalem`); Dario (ID: `person:Darius.2`); Sefalá (ID: `place:Shephelah`); Truth (ID: `keyterm:Truth`); withdraw oneself (ID: `keyterm:WithdrawOneself`); Instruction (ID: `keyterm:Instruction`); Neguebe (ID: `place:Negeb`); kindness (ID: `keyterm:Kindness`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Truth (ID: `keyterm:Truth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); peace (ID: `keyterm:IntactState`); Judá (ID: `group:Judah`); rogar (ID: `keyterm:AskFor`); Judá (ID: `person:Judah.4`); fear (ID: `keyterm:Fear`); Zacarias (ID: `person:Zechariah.17`); love (ID: `keyterm:Love`); Regém-Meleque (ID: `person:Regem-melech`); Jews (ID: `group:Jews`); Sarezer (ID: `person:Sharezer.2`); House (ID: `realia:House`); Dario (ID: `person:Darius.2`); Israel (ID: `person:Israel`); kindness (ID: `keyterm:Kindness`); Betel (ID: `place:Bethel`); withdraw oneself (ID: `keyterm:WithdrawOneself`); Sefalá (ID: `place:Shephelah`); bless (ID: `keyterm:Bless`); appointed feast (ID: `keyterm:AppointedFeast`); Oath (ID: `keyterm:Oath`); Be Zealous (ID: `keyterm:Zealous`); ardour (ID: `keyterm:Ardour`); Instruction (ID: `keyterm:Instruction`); Neguebe (ID: `place:Negeb`); Staff (ID: `realia:Staff`); Vine (ID: `flora:Vine`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Regém-Meleque (ID: `person:Regem-melech`); Sarezer (ID: `person:Sharezer.2`); rogar (ID: `keyterm:AskFor`); Betel (ID: `place:Bethel`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Neguebe (ID: `place:Negeb`); Sefalá (ID: `place:Shephelah`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Truth (ID: `keyterm:Truth`); peace (ID: `keyterm:IntactState`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); fear (ID: `keyterm:Fear`); rogar (ID: `keyterm:AskFor`); Word of the Lord (ID: `keyterm:WordOfTheLord`); love (ID: `keyterm:Love`); Jews (ID: `group:Jews`); Israel (ID: `person:Israel`); bless (ID: `keyterm:Bless`); appointed feast (ID: `keyterm:AppointedFeast`); Oath (ID: `keyterm:Oath`); Be Zealous (ID: `keyterm:Zealous`); ardour (ID: `keyterm:Ardour`); Staff (ID: `realia:Staff`); Vine (ID: `flora:Vine`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Be Zealous (ID: `keyterm:Zealous`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** peace (ID: `keyterm:IntactState`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); fear (ID: `keyterm:Fear`); Judá (ID: `person:Judah.4`); bless (ID: `keyterm:Bless`); Judá (ID: `group:Judah`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** appointed feast (ID: `keyterm:AppointedFeast`); Truth (ID: `keyterm:Truth`); peace (ID: `keyterm:IntactState`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Hadraque (ID: `place:Hadrach`); Utterance (ID: `keyterm:Utterance`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Damasco (ID: `place:Damascus`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ecrom (ID: `place:Ekron`); Tiro (ID: `place:Tyre`); Hadraque (ID: `place:Hadrach`); Filisteu (ID: `group:Philistine`); Israel (ID: `person:Israel`); fear (ID: `keyterm:Fear`); Asdode (ID: `place:Ashdod`); abomination (ID: `keyterm:DetestedThing`); Judá (ID: `group:Judah`); Damasco (ID: `place:Damascus`); Jebusites (ID: `group:Jebusites`); dispossess (ID: `keyterm:Dispossess`); Asquelom (ID: `place:Ashkelon`); Hamate (ID: `place:Hamath`); Utterance (ID: `keyterm:Utterance`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Gaza (ID: `place:Gaza`); Sidom (ID: `place:Sidon`); Filístia (ID: `place:Philistine`); Money (ID: `realia:Money`); Fortification (ID: `realia:Fortification`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Sheep (ID: `fauna:Lamb`); Efraim (ID: `group:Ephraim`); Efraim (ID: `person:Ephraim`); Jerusalém (ID: `place:Jerusalem`); Bow (ID: `realia:Bow`); Israel (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Libano (ID: `place:Lebanon`); Egito (ID: `place:Egypt`); Appoint (ID: `keyterm:Appoint`); Tiro (ID: `place:Tyre`); Assyria (ID: `place:Assyria`); Covenant (ID: `keyterm:Covenant`); Ecrom (ID: `place:Ekron`); Staff (ID: `realia:Staff`); Vine (ID: `flora:Vine`); Horse (ID: `fauna:Horse`); Rod (ID: `realia:Rod`); Money (ID: `realia:Money`); terafins (ID: `deity:Teraphim`); Hadraque (ID: `place:Hadrach`); Cedar (ID: `flora:Cedar`); Rio Eufrates (ID: `place:Euphrates`); Jebusites (ID: `group:Jebusites`); Asquelom (ID: `place:Ashkelon`); majesty (ID: `keyterm:Majesty`); Utterance (ID: `keyterm:Utterance`); Gaza (ID: `place:Gaza`); Rio Nilo (ID: `place:Nile`); José (ID: `person:Joseph.10`); Filisteu (ID: `group:Philistine`); fear (ID: `keyterm:Fear`); arrow (ID: `keyterm:Arrow`); Asdode (ID: `place:Ashdod`); abomination (ID: `keyterm:DetestedThing`); Grécia (ID: `place:Greece`); comprar (ID: `keyterm:Redeem`); Sidom (ID: `place:Sidon`); Filístia (ID: `place:Philistine`); Basã (ID: `place:Bashan`); Damasco (ID: `place:Damascus`); dispossess (ID: `keyterm:Dispossess`); bless (ID: `keyterm:Bless`); peace (ID: `keyterm:IntactState`); Mighty (ID: `keyterm:Mighty`); mischief (ID: `keyterm:Mischief`); Gileade (ID: `place:Gilead`); Woe (ID: `keyterm:Woe.2`); Hamate (ID: `place:Hamath`); practice divination (ID: `keyterm:PracticeDivination`); Foolish (ID: `keyterm:Foolish`); Jordan River (ID: `place:Jordan`); hope (ID: `keyterm:Hope`); have a vision (ID: `keyterm:HaveAVision`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Sword (ID: `realia:Sword`); Donkey (ID: `fauna:Donkey`); Fir (ID: `flora:Fir`); Rams Horn (ID: `realia:RamsHorn`); Oak (ID: `flora:Oak`); Pit (ID: `realia:Pit`); Peg (ID: `realia:Peg.2`); Must (ID: `realia:Must`); Temple Altar (ID: `realia:TempleAltar`); Crown (ID: `realia:Crown`); Grain (ID: `flora:Grain`); Sandalwood (ID: `flora:Sandalwood`); Sling (ID: `realia:Sling`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Chariot (ID: `realia:Chariot`); Cypress (ID: `flora:Cypress`); Grass (ID: `flora:Grass`); Grecian Juniper (ID: `flora:Juniper`); Household Idols (ID: `realia:HouseholdIdols`); Fortification (ID: `realia:Fortification`); Altar (ID: `realia:Altar`); Peg (ID: `realia:Peg`); Lion (ID: `fauna:Lion`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Davi (ID: `person:David`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); House (ID: `realia:House`); Horse (ID: `fauna:Horse`); Egito (ID: `place:Egypt`); Money (ID: `realia:Money`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); Israel (ID: `person:Israel`); plague (ID: `keyterm:Blow`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Efraim (ID: `group:Ephraim`); Efraim (ID: `person:Ephraim`); speak (ID: `keyterm:Speak`); Utterance (ID: `keyterm:Utterance`); Libano (ID: `place:Lebanon`); Appoint (ID: `keyterm:Appoint`); Tiro (ID: `place:Tyre`); Assyria (ID: `place:Assyria`); Covenant (ID: `keyterm:Covenant`); Ecrom (ID: `place:Ekron`); Bow (ID: `realia:Bow`); Staff (ID: `realia:Staff`); Vine (ID: `flora:Vine`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** Filisteu (ID: `group:Philistine`); fear (ID: `keyterm:Fear`); Asdode (ID: `place:Ashdod`); Asquelom (ID: `place:Ashkelon`); Ecrom (ID: `place:Ekron`); Gaza (ID: `place:Gaza`); Filístia (ID: `place:Philistine`)
...
* **Associated ACAI Concepts:** Bow (ID: `realia:Bow`); Jerusalém (ID: `place:Jerusalem`); peace (ID: `keyterm:IntactState`); Rio Eufrates (ID: `place:Euphrates`); Efraim (ID: `group:Ephraim`); Efraim (ID: `person:Ephraim`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Grécia (ID: `place:Greece`); Judá (ID: `person:Judah.4`); Efraim (ID: `group:Ephraim`); Judá (ID: `group:Judah`); Efraim (ID: `person:Ephraim`); Bow (ID: `realia:Bow`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Temple Altar (ID: `realia:TempleAltar`); Sling (ID: `realia:Sling`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Libano (ID: `place:Lebanon`); Judá (ID: `group:Judah`); Assyria (ID: `place:Assyria`); Judá (ID: `person:Judah.4`); Egito (ID: `place:Egypt`); Cedar (ID: `flora:Cedar`); Horse (ID: `fauna:Horse`); terafins (ID: `deity:Teraphim`); Mighty (ID: `keyterm:Mighty`); José (ID: `person:Joseph.10`); mischief (ID: `keyterm:Mischief`); have a vision (ID: `keyterm:HaveAVision`); Basã (ID: `place:Bashan`); comprar (ID: `keyterm:Redeem`); Gileade (ID: `place:Gilead`); majesty (ID: `keyterm:Majesty`); practice divination (ID: `keyterm:PracticeDivination`); Jordan River (ID: `place:Jordan`); Efraim (ID: `person:Ephraim`); Appoint (ID: `keyterm:Appoint`); Efraim (ID: `group:Ephraim`); Rio Nilo (ID: `place:Nile`); Fir (ID: `flora:Fir`); Wine (ID: `realia:Wine`); Peg (ID: `realia:Peg.2`); Cypress (ID: `flora:Cypress`); Grass (ID: `flora:Grass`); Oak (ID: `flora:Oak`); Vine (ID: `flora:Vine`); Grecian Juniper (ID: `flora:Juniper`); Household Idols (ID: `realia:HouseholdIdols`); Bow (ID: `realia:Bow`); Peg (ID: `realia:Peg`); Sandalwood (ID: `flora:Sandalwood`); Lion (ID: `fauna:Lion`)
...
* **Associated ACAI Concepts:** terafins (ID: `deity:Teraphim`); practice divination (ID: `keyterm:PracticeDivination`); mischief (ID: `keyterm:Mischief`); have a vision (ID: `keyterm:HaveAVision`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Household Idols (ID: `realia:HouseholdIdols`)
...
* **Associated ACAI Concepts:** majesty (ID: `keyterm:Majesty`); SENHOR (ID: `deity:Lord`); Appoint (ID: `keyterm:Appoint`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Sheep (ID: `fauna:Lamb`); Horse (ID: `fauna:Horse`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Assyria (ID: `place:Assyria`); Gileade (ID: `place:Gilead`); Egito (ID: `place:Egypt`); Libano (ID: `place:Lebanon`)
...
* **Associated ACAI Concepts:** Fir (ID: `flora:Fir`); Mighty (ID: `keyterm:Mighty`); Basã (ID: `place:Bashan`); Cedar (ID: `flora:Cedar`); Cypress (ID: `flora:Cypress`); Grecian Juniper (ID: `flora:Juniper`); Sandalwood (ID: `flora:Sandalwood`); Oak (ID: `flora:Oak`)
...
* **Associated ACAI Concepts:** Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); SENHOR (ID: `deity:Lord`); Rod (ID: `realia:Rod`); Staff (ID: `realia:Staff`); Money (ID: `realia:Money`); Woe (ID: `keyterm:Woe.2`); Covenant (ID: `keyterm:Covenant`); Israel (ID: `person:Israel`); Appoint (ID: `keyterm:Appoint`); Foolish (ID: `keyterm:Foolish`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); bless (ID: `keyterm:Bless`); Judá (ID: `group:Judah`); House (ID: `realia:House`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Foolish (ID: `keyterm:Foolish`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Davi (ID: `person:David`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); House (ID: `realia:House`); plague (ID: `keyterm:Blow`); Horse (ID: `fauna:Horse`); speak (ID: `keyterm:Speak`); Egito (ID: `place:Egypt`); Torre de Hanamel (ID: `place:TowerOfHananel`); Azal (ID: `place:Azal`); Shimeites (ID: `group:Shimei`); Hadade-Rimom (ID: `place:Hadad-rimmon`); Monte das Oliveiras (ID: `place:OlivesMount`); Simei (ID: `person:Shimei.4`); Benjamin Gate (ID: `place:BenjaminGate`); Money (ID: `realia:Money`); Cooking Pot (ID: `realia:CookingPot`); An Angel (ID: `deity:Angel`); Israel (ID: `person:Israel`); defilement (ID: `keyterm:Defilement`); Corner Gate (ID: `place:CornerGate`); Uzias (ID: `person:Uzziah`); be enticed to serve (ID: `keyterm:EnticedToServe`); Safety (ID: `keyterm:Safety`); Natã (ID: `person:Nathan`); Arabá (ID: `place:Arabah`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`); state of being under siege (ID: `keyterm:StateOfBeingUnderSiege`); Utterance (ID: `keyterm:Utterance`); To Sin (ID: `keyterm:Sin`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Levi (ID: `group:Levi`); Geba (ID: `place:Geba`); holy (ID: `keyterm:Holy`); Punishment (ID: `keyterm:Punishment`); favor (ID: `keyterm:Favor`); supplication (ID: `keyterm:Supplication`); Megido (ID: `place:Megiddo`); Ain (ID: `place:Ain`); Levi (ID: `person:Levi.3`); love (ID: `keyterm:Love`); Sheep (ID: `fauna:Lamb`); Winepress (ID: `realia:Winepress`); Clothing (ID: `realia:Clothing`); Donkey (ID: `fauna:Donkey`); Bowl (ID: `realia:Bowl`); Stone Altar (ID: `realia:StoneAltar`); Mule (ID: `fauna:Mule`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Sheaf (ID: `realia:Sheaf`); Temple Altar (ID: `realia:TempleAltar`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Altar (ID: `realia:Altar`); Image (ID: `realia:Image`); Cattle (ID: `fauna:Bull`); Sword (ID: `realia:Sword`); Olive Tree (ID: `flora:OliveTree`); Camel (ID: `fauna:Camel`)
...
* **Associated ACAI Concepts:** Simei (ID: `person:Shimei.4`); Shimeites (ID: `group:Shimei`); Natã (ID: `person:Nathan`); Davi (ID: `person:David`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); speak (ID: `keyterm:Speak`); be enticed to serve (ID: `keyterm:EnticedToServe`); Jerusalém (ID: `place:Jerusalem`); To Sin (ID: `keyterm:Sin`); defilement (ID: `keyterm:Defilement`); Davi (ID: `person:David`); love (ID: `keyterm:Love`); House (ID: `realia:House`); Clothing (ID: `realia:Clothing`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Sword (ID: `realia:Sword`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`); Sword (ID: `realia:Sword`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Torre de Hanamel (ID: `place:TowerOfHananel`); Benjamin Gate (ID: `place:BenjaminGate`); Jerusalém (ID: `place:Jerusalem`); Corner Gate (ID: `place:CornerGate`); Ain (ID: `place:Ain`); Arabá (ID: `place:Arabah`); Geba (ID: `place:Geba`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Cooking Pot (ID: `realia:CookingPot`); Temple Altar (ID: `realia:TempleAltar`); Horse (ID: `fauna:Horse`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); House (ID: `realia:House`); Cooking Pot (ID: `realia:CookingPot`)
