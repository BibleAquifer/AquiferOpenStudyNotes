...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Judas (ID: `person:Jude`); SENHOR (ID: `deity:Lord`); Tiago (ID: `person:James.3`); misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** empenho (ID: `keyterm:Eagerness`); comum (ID: `keyterm:InCommon`); rogar (ID: `keyterm:AskFor`); holy (ID: `keyterm:Holy`); amado (ID: `keyterm:Beloved`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** empenho (ID: `keyterm:Eagerness`); comum (ID: `keyterm:InCommon`); juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); rogar (ID: `keyterm:AskFor`); holy (ID: `keyterm:Holy`); amado (ID: `keyterm:Beloved`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); juízo (ID: `keyterm:Judgment`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** corpo (ID: `keyterm:Body.3`); tribunal de justiça (ID: `keyterm:CourtCase`); blasfemar (ID: `keyterm:Blaspheme`); para a eternidade (ID: `keyterm:Always`); juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`); Corá (ID: `person:Korah.3`); Moisés (ID: `person:Moses`); Egito (ID: `place:Egypt`); Enoque (ID: `person:Enoch.2`); fogo eterno (ID: `keyterm:EternalFire`); ágape (ID: `keyterm:FellowshipMeal`); holy (ID: `keyterm:Holy`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); Sodoma (ID: `place:Sodom`); defilement (ID: `keyterm:Defilement`); Adão (ID: `person:Adam`); Disaster (ID: `keyterm:Disaster`); speak (ID: `keyterm:Speak`); Gomorra (ID: `place:Gomorrah`); distinguir (ID: `keyterm:Discern`); Caim (ID: `person:Cain`); Balaão (ID: `person:Balaam`); Miguel (ID: `person:Michael.11`); To Command (ID: `keyterm:Command`); Ability (ID: `keyterm:Ability`); salvation (ID: `keyterm:Salvation`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Chain (ID: `realia:Chain`)
...
* **Associated ACAI Concepts:** An Angel (ID: `deity:Angel`); tribunal de justiça (ID: `keyterm:CourtCase`); para a eternidade (ID: `keyterm:Always`); juízo (ID: `keyterm:Judgment`); Chain (ID: `realia:Chain`)
...
* **Associated ACAI Concepts:** para a eternidade (ID: `keyterm:Always`); Gomorra (ID: `place:Gomorrah`); corpo (ID: `keyterm:Body.3`); fogo eterno (ID: `keyterm:EternalFire`); Sodoma (ID: `place:Sodom`)
...
* **Associated ACAI Concepts:** Moisés (ID: `person:Moses`); tribunal de justiça (ID: `keyterm:CourtCase`); juízo (ID: `keyterm:Judgment`); corpo (ID: `keyterm:Body.3`); SENHOR (ID: `deity:Lord`); Miguel (ID: `person:Michael.11`); distinguir (ID: `keyterm:Discern`); To Command (ID: `keyterm:Command`); blasfemar (ID: `keyterm:Blaspheme`)
...
* **Associated ACAI Concepts:** tribunal de justiça (ID: `keyterm:CourtCase`); Enoque (ID: `person:Enoch.2`); speak (ID: `keyterm:Speak`); juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`); holy (ID: `keyterm:Holy`); Adão (ID: `person:Adam`)
...
* **Associated ACAI Concepts:** misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`); Holy Spirit (ID: `deity:HolySpirit`); amado (ID: `keyterm:Beloved`); natural (ID: `keyterm:Natural`); holy (ID: `keyterm:Holy`); crer (ID: `keyterm:Believe`); palavra (ID: `keyterm:Word`); corpo (ID: `keyterm:Body.3`); SENHOR (ID: `deity:Lord`); causar divisões (ID: `keyterm:CreatingDivisions`); distinguir (ID: `keyterm:Discern`); Life (ID: `keyterm:Life`); orar (ID: `keyterm:Pray`); para a eternidade (ID: `keyterm:Always`); fear (ID: `keyterm:Fear`); love (ID: `keyterm:Love`); salvation (ID: `keyterm:Salvation`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); Holy Spirit (ID: `deity:HolySpirit`); holy (ID: `keyterm:Holy`); crer (ID: `keyterm:Believe`); amado (ID: `keyterm:Beloved`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); para a eternidade (ID: `keyterm:Always`); irrepreensível (ID: `keyterm:Unblemished`); surely! (ID: `keyterm:Surely`); SENHOR (ID: `deity:Lord`); salvador (ID: `keyterm:Savior`); autoridade (ID: `keyterm:Authority.2`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`)
