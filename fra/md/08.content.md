...
* **Associated ACAI Concepts:** Éphrata (ID: `person:Ephrathah`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); Kiljon (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Élimélec (ID: `person:Elimelech`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Bethléhem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Machlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); Moab (ID: `place:Moab`); Bethléhem (ID: `place:Bethlehem`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); bonté (ID: `keyterm:Kindness`); benir (ID: `keyterm:Bless`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Machlon (ID: `person:Mahlon`); laissiez en possession (ID: `keyterm:Possess`)
...
* **Associated ACAI Concepts:** Rachel (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); Léa (ID: `person:Leah`); Bethléhem (ID: `place:Bethlehem`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Perets (ID: `person:Perez`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Tamar (ID: `person:Tamar`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Boaz (ID: `person:Boaz`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Naomi (ID: `person:Naomi`); Israël (ID: `person:Israel`); benir (ID: `keyterm:Bless`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Salmon (ID: `person:Salmon`); Hetsron (ID: `person:Hezron.2`); Obed (ID: `person:Obed`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Perets (ID: `person:Perez`); David (ID: `person:David`); Isaï (ID: `person:Jesse`); Boaz (ID: `person:Boaz`); Nahshon (ID: `person:Nahshon`)
