...
* **Associated ACAI Concepts:** Èfratite; d'Èfrata (ID: `group:Ephrathah`); Éphrata (ID: `person:Ephrathah`); Kiljon (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Juda (ID: `person:Judah.4`); Moab (ID: `place:Moab`); Juda (ID: `group:Judah`); Machlon (ID: `person:Mahlon`); Bethléhem (ID: `place:Bethlehem`); Élimélec (ID: `person:Elimelech`)
...
* **Associated ACAI Concepts:** Léa (ID: `person:Leah`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Elders (ID: `group:GenericElders`); Rachel (ID: `person:Rachel`); Bethléhem (ID: `place:Bethlehem`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Perets (ID: `person:Perez`); Tamar (ID: `person:Tamar`)
...
* **Associated ACAI Concepts:** Hetsron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Amminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Boaz (ID: `person:Boaz`); David (ID: `person:David`); Perets (ID: `person:Perez`); Nahshon (ID: `person:Nahshon`); Isaï (ID: `person:Jesse`)
