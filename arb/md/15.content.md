...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); إِسْرَائِيلَ (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); إِرْمِيَا (ID: `person:Jeremiah.6`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `group:Levi`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `person:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `group:Benjamin`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); أورشَلِيمَ (ID: `place:Jerusalem`); كورَشَ (ID: `person:Cyrus`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath`); فَارِسَ (ID: `place:Persia`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); كورَشَ (ID: `person:Cyrus`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); سلَيْمَانَ (ID: `person:Solomon`); أورشَلِيمَ (ID: `place:Jerusalem`); Beth-azmaveth (ID: `place:Beth-azmaveth`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); Tel-melah (ID: `place:Tel-melah`); حَجَابَةَ (ID: `person:Hagabah`); يورَةَ (ID: `person:Jorah`); نَحَمْيَا (ID: `person:Nehemiah`); عَقّوب (ID: `person:Akkub.3`); زَتّو (ID: `person:Zattu.2`); فِي (ID: `person:Uzza.2`); مرْدَخَاي (ID: `person:Mordecai`); حَسوفَا (ID: `person:Hasupha`); حَطِيطَا (ID: `person:Hatita`); Tel-harsha (ID: `place:Tel-harsha`); سَنَاءَةَ (ID: `place:Senaah`); طَبَاعوتَ (ID: `person:Tabbaoth`); رَعْلَايَا (ID: `person:Reelaiah`); يوآب (ID: `person:Joab.3`); جَدِّيلَ (ID: `person:Giddel.2`); سوفَرَثَ (ID: `person:Sophereth`); آطِيرَ (ID: `person:Ater.2`); ثَامَحَ (ID: `person:Temah`); آمِي (ID: `person:Ami`); حَارِيمَ (ID: `person:Harim`); حَانَان (ID: `person:Hanan.4`)
...
* **Associated ACAI Concepts:** مِسْفَار (ID: `person:Mispar`); بِلْشَان (ID: `person:Bilshan`); مرْدَخَاي (ID: `person:Mordecai`); نَحَمْيَا (ID: `person:Nehemiah`); سَرَايَا (ID: `person:Seraiah.6`); بِغْوَايَ (ID: `person:Bigvai`); رَعْلَايَا (ID: `person:Reelaiah`); بَعْنَةَ (ID: `person:Baanah.3`); رَحوم (ID: `person:Rehum`); يَشوع (ID: `person:Joshua.5`); إِسْرَائِيلَ (ID: `person:Israel`); زَربَّابِل (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** عَادِينَ (ID: `person:Adin`); يورَةَ (ID: `person:Jorah`); حَشوم (ID: `person:Hashum`); بِغْوَايَ (ID: `person:Bigvai.2`); زَتّو (ID: `person:Zattu.2`); بَابَايَ (ID: `person:Bebai`); يَشوعَ (ID: `person:Jeshua.3`); عَرْجَدَ (ID: `person:Azgad`); حَزَقِيَّا (ID: `person:Hezekiah.2`); آرَحَ (ID: `person:Arah.2`); بَانِيَ (ID: `person:Bani`); آطِيرَ (ID: `person:Ater`); فَرْعوشَ (ID: `person:Parosh`); أَدونِيقَامَ (ID: `person:Adonikam`); بِيصَايَ (ID: `person:Bezai`); شَفَطْيَا (ID: `person:Shephatiah.6`); زَكَّايَ (ID: `person:Zaccai.2`); Pahath-moab (ID: `person:Pahath-moab`); عِيلَامَ (ID: `person:Elam`); يوآب (ID: `person:Joab.3`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Beth-azmaveth (ID: `place:Beth-azmaveth`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); حَادِيدَ (ID: `place:Hadid`); نَبو (ID: `place:Nebo.2`); حَارِيمَ (ID: `person:Harim.2`); سَنَاءَةَ (ID: `place:Senaah`); مَغْبِيشَ (ID: `place:Magbish`); عَايٍ (ID: `place:Ai`); Bethel (ID: `place:Bethel`); عَنَاثوثَ (ID: `place:Anathoth`); بَئِيروت (ID: `place:Beeroth`); مِخْمَاسَ (ID: `place:Michmash`); Kiriath-jearim (ID: `place:Kiriath-jearim`); Ramah (ID: `place:Ramah.2`); ٱلْكَفِيرَة (ID: `place:Chephirah`); أَرِيحَا (ID: `place:Jericho`); لَحْمٍ (ID: `place:Bethlehem`); مِنْ (ID: `place:Geba`); أونوَ (ID: `place:Ono`); عِيلَامَ (ID: `person:Elam`); وَلودَ (ID: `place:Lod`)
...
* **Associated ACAI Concepts:** يَدَايَا (ID: `person:Jedaiah.4`); حَطِيطَا (ID: `person:Hatita`); يَشوعَ (ID: `person:Jeshua.4`); لِإِيمِيرَ (ID: `person:Immer.2`); يَشوعَ (ID: `person:Jeshua`); هودَوْيَا (ID: `person:Hodaviah.4`); آطِيرَ (ID: `person:Ater.2`); شوبَايَ (ID: `person:Shobai`); حَارِيمَ (ID: `person:Harim`); طَلْمون (ID: `person:Talmon`); لَّاوِي (ID: `group:Levi`); آسَاف (ID: `person:Asaph.2`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); شَلّوم (ID: `person:Shallum.8`); لَّاوِي (ID: `person:Levi.3`); عَقّوب (ID: `person:Akkub.2`); فَشْحور (ID: `person:Pashhur`)
...
* **Associated ACAI Concepts:** حَطِيطَا (ID: `person:Hatita`); آطِيرَ (ID: `person:Ater.2`); شوبَايَ (ID: `person:Shobai`); طَلْمون (ID: `person:Talmon`); آسَاف (ID: `person:Asaph.2`); شَلّوم (ID: `person:Shallum.8`); عَقّوب (ID: `person:Akkub.2`)
...
* **Associated ACAI Concepts:** حَرْشَا (ID: `person:Harsha`); حَجَابَةَ (ID: `person:Hagabah`); رَصِينَ (ID: `person:Rezin.2`); Meunim (ID: `group:Meunim`); ثَامَحَ (ID: `person:Temah`); عَقّوب (ID: `person:Akkub.3`); بِيسَايَ (ID: `person:Besai`); حَانَان (ID: `person:Hanan.4`); فِي (ID: `person:Uzza.2`); مَحِيدَا (ID: `person:Mehida`); نَصِيحَ (ID: `person:Neziah`); فَادونَ (ID: `person:Padon`); رَآيَا (ID: `person:Reaiah.3`); حَرْحورَ (ID: `person:Harhur`); حَسوفَا (ID: `person:Hasupha`); سِيسَرَا (ID: `person:Sisera.2`); قِيروسَ (ID: `person:Keros`); حَاجَابَ (ID: `person:Hagab`); جَزَّامَ (ID: `person:Gazzam`); سَلْمَايَ (ID: `person:Shalmai`); Nephushesim (ID: `group:Nephushesim`); جَاحَرَ (ID: `person:Gahar`); سِيعَهَا (ID: `person:Siaha`); حَطِيفَا (ID: `person:Hatipha`); لَبَانَةَ (ID: `person:Lebanah`); بَرْقوسَ (ID: `person:Barkos`); أَسْنَةَ (ID: `person:Asnah`); نَقودَا (ID: `person:Nekoda`); فَاسِيحَ (ID: `person:Paseah.2`); بَقْبوقَ (ID: `person:Bakbuk`); طَبَاعوتَ (ID: `person:Tabbaoth`); صِيحَا (ID: `person:Ziha`); جَدِّيلَ (ID: `person:Giddel`); بَصْلوتَ (ID: `person:Bazluth`); حَقوفَا (ID: `person:Hakupha`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); دَرْقونَ (ID: `person:Darkon`); فَرودَا (ID: `person:Peruda`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); سوفَرَثَ (ID: `person:Sophereth`); حَطِّيلَ (ID: `person:Hattil`); جَدِّيلَ (ID: `person:Giddel.2`); آمِي (ID: `person:Ami`); سَوْطَايَ (ID: `person:Sotai`); يَعْلَةَ (ID: `person:Jaalah`); شَفَطْيَا (ID: `person:Shephatiah.7`)
...
* **Associated ACAI Concepts:** لِدَلَايَا (ID: `person:Delaiah.3`); نَقودَا (ID: `person:Nekoda.2`); Tel-melah (ID: `place:Tel-melah`); لِإِيمِيرَ (ID: `place:Immer`); Tel-harsha (ID: `place:Tel-harsha`); أَدَّان (ID: `place:Addan`); كَروب (ID: `place:Cherub`); طوبِيَّا (ID: `person:Tobiah`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** بَرْزِلَّايَ (ID: `person:Barzillai.3`); هَقّوصَ (ID: `person:Hakkoz.2`); حَبَايَا (ID: `person:Habaiah`); Priesthood (ID: `keyterm:Priesthood`); جِلْعَادَ (ID: `place:Gilead`); بَرْزِلَّايَ (ID: `person:Barzillai`); Gileadites (ID: `group:Gilead`); Defile (ID: `keyterm:Stain`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); يَشوع (ID: `person:Joshua.5`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); هودَوْيَا (ID: `person:Hodaviah.4`); حِينَادَادَ (ID: `person:Henadad`); Relatives (ID: `group:Relatives`); Esarhaddon (ID: `person:Esarhaddon`); يَشوعَ (ID: `person:Jeshua.4`); Instruction (ID: `keyterm:Instruction`); دَاودَ (ID: `person:David`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); بَنْيَامِينَ (ID: `person:Benjamin`); صورَ (ID: `place:Tyre`); Kindness (ID: `keyterm:Kindness`); آسَاف (ID: `person:Asaph.2`); يَافَا (ID: `place:Joppa`); Appointed Feast (ID: `keyterm:AppointedFeast`); لبْنَانَ (ID: `place:Lebanon`); Holy (ID: `keyterm:Holy`); هودِيَّا (ID: `person:Hodiah.2`); New Moon Festival (ID: `keyterm:NewMoonFestival`); بَنْيَامِينَ (ID: `group:Benjamin`); موسَى (ID: `person:Moses`); Terror (ID: `keyterm:Terror`); Assyria (ID: `place:Assyria`); Sidonians (ID: `group:Sidon`); دَارِيوسَ (ID: `person:Darius.2`); Tyrians (ID: `group:Tyre`); صِيْدونَ (ID: `place:Sidon`); Counsel (ID: `keyterm:Counsel`); Trumpet (ID: `realia:Trumpet`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`); Cymbals (ID: `realia:Cymbals`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); موسَى (ID: `person:Moses`); Instruction (ID: `keyterm:Instruction`); Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Terror (ID: `keyterm:Terror`); Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** فَارِسَ (ID: `place:Persia`); يَافَا (ID: `place:Joppa`); لبْنَانَ (ID: `place:Lebanon`); Sidonians (ID: `group:Sidon`); كورَشَ (ID: `person:Cyrus`); Tyrians (ID: `group:Tyre`); صورَ (ID: `place:Tyre`); صِيْدونَ (ID: `place:Sidon`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); لَّاوِي (ID: `group:Levi`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `group:Levi`); آسَاف (ID: `person:Asaph.2`); دَاودَ (ID: `person:David`); لَّاوِي (ID: `person:Levi.3`); Kindness (ID: `keyterm:Kindness`); Cymbals (ID: `realia:Cymbals`); House (ID: `realia:House`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `person:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `group:Benjamin`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); فَارِسَ (ID: `place:Persia`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); كورَشَ (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْفرَاتِ (ID: `place:Euphrates`); رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); ٱلسَّامِرَةِ (ID: `place:Samaria`); فَارِسَ (ID: `place:Persia`); Jews (ID: `group:Jews`); مِثْرَدَاث (ID: `person:Mithredath.2`); طَبْئِيل (ID: `person:Tabeel`); أَرَكَ (ID: `place:Erech`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); Babylonians (ID: `group:Babylon`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); أسْنَفَّر (ID: `person:Osnappar`); بِشْلَام (ID: `person:Bishlam`); يَهوذَا (ID: `person:Judah.4`); فِي (ID: `place:Susa`); يَهوذَا (ID: `group:Judah`); عِيلَامَ (ID: `place:Elam`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); بَابِلَ (ID: `place:Babylon`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** رَحوم (ID: `person:Rehum.2`); أَرَكَ (ID: `place:Erech`); Babylonians (ID: `group:Babylon`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); شِمْشَاي (ID: `person:Shimshai`); Persians (ID: `group:Persia`); فَارِسَ (ID: `place:Persia`); فِي (ID: `place:Susa`); بَابِلَ (ID: `place:Babylon`); عِيلَامَ (ID: `place:Elam`); Elamites (ID: `group:Elam`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); ٱلسَّامِرَةِ (ID: `place:Samaria`); رَحوم (ID: `person:Rehum.2`); Jews (ID: `group:Jews`); شِمْشَاي (ID: `person:Shimshai`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); دَارِيوسَ (ID: `person:Darius.2`); حَجَّيِ (ID: `person:Haggai`); تَتْنَاي (ID: `person:Tattenai`); زَكَرِيَّا (ID: `person:Zechariah.17`); Shethar-bozenai (ID: `person:Shethar-bozenai`); يَدّو (ID: `person:Iddo.6`); يَهوصَادِقَ (ID: `person:Jehozadak`); فَارِسَ (ID: `place:Persia`); يَشوع (ID: `person:Joshua.5`); إِسْرَائِيلَ (ID: `person:Israel`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `person:Judah.4`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); ٱلْفرَاتِ (ID: `place:Euphrates`)
...
* **Associated ACAI Concepts:** حَجَّيِ (ID: `person:Haggai`); زَكَرِيَّا (ID: `person:Zechariah.17`); يَدّو (ID: `person:Iddo.6`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); Jews (ID: `group:Jews`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); بَابِلَ (ID: `place:Babylon`); أورشَلِيمَ (ID: `place:Jerusalem`); كورَشَ (ID: `person:Cyrus`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); زَربَّابِل (ID: `person:Zerubbabel.2`); دَارِيوسَ (ID: `person:Darius.2`); تَتْنَاي (ID: `person:Tattenai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); ٱلْفرَاتِ (ID: `place:Euphrates`); Hewn Stone (ID: `realia:HewnStone`); Money (ID: `realia:Money`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `group:Levi`); موسَى (ID: `person:Moses`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `person:Levi.3`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Passover (ID: `keyterm:Passover`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Pure (ID: `keyterm:Pure`)
...
* **Associated ACAI Concepts:** Defilement (ID: `keyterm:Defilement`); Gentiles (ID: `group:Gentile`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** عَزَرْيَا (ID: `person:Azariah.7`); عَزْرَا (ID: `person:Ezra`); سَرَايَا (ID: `person:Seraiah.2`); فَارِسَ (ID: `place:Persia`); حِلْقِيَّا (ID: `person:Hilkiah.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); أَخِيطوبَ (ID: `person:Ahitub.3`); أَمَرْيَا (ID: `person:Amariah.2`); سَرَايَا (ID: `person:Seraiah.2`); عزِّي (ID: `person:Uzzi`); عَزَرْيَا (ID: `person:Azariah.7`); عَزَرْيَا (ID: `person:Azariah.6`); لِمَرَايوثَ (ID: `person:Meraioth`); بقِّي (ID: `person:Bukki.2`); صَادوق (ID: `person:Zadok.4`); زَرَحْيَا (ID: `person:Zerahiah`); شَلّوم (ID: `person:Shallum.7`); أَبِيشوعَ (ID: `person:Abishua`); فَارِسَ (ID: `place:Persia`); حِلْقِيَّا (ID: `person:Hilkiah.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); أَلِعَازَار (ID: `person:Eleazar.2`); فِينَحَاس (ID: `person:Phinehas`); هَارون (ID: `person:Aaron`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); موسَى (ID: `person:Moses`); Instruction (ID: `keyterm:Instruction`); بَابِلَ (ID: `place:Babylon`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Decree (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); عَزْرَا (ID: `person:Ezra`); ٱلْفرَاتِ (ID: `place:Euphrates`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Talent (ID: `realia:Talent`); Wheat (ID: `flora:Wheat`); Money (ID: `realia:Money`); Kor (ID: `realia:Kor`)
...
* **Associated ACAI Concepts:** زَكّور (ID: `person:Zaccur.5`); عَادِينَ (ID: `person:Adin`); شَكَنْيَا (ID: `person:Shecaniah.6`); عَثَلْيَا (ID: `person:Athaliah.3`); يونَاثَانَ (ID: `person:Jonathan.9`); عوتَاي (ID: `person:Uthai.2`); بِغْوَايَ (ID: `person:Bigvai.2`); عوبَدْيَا (ID: `person:Obadiah.10`); بَابَايَ (ID: `person:Bebai`); عَرْجَدَ (ID: `person:Azgad`); شَلومِيَةَ (ID: `person:Shelomith.4`); أَلِيفَلَط (ID: `person:Eliphelet.5`); Gershom (ID: `person:Gershom.2`); يوحَانَانَ (ID: `person:Johanan.8`); زَرَحْيَا (ID: `person:Zerahiah.2`); يَحْزِيئِيل (ID: `person:Jahaziel.5`); عَابِد (ID: `person:Ebed.2`); فَرْعوشَ (ID: `person:Parosh.2`); يَحِيئِيل (ID: `person:Jehiel.7`); يوآب (ID: `person:Joab.4`); حَطّوش (ID: `person:Hattush.2`); زَكَرِيَّا (ID: `person:Zechariah.19`); أَدونِيقَامَ (ID: `person:Adonikam`); بَابَايَ (ID: `person:Bebai.2`); شَفَطْيَا (ID: `person:Shephatiah.6`); دَانِيآل (ID: `person:Daniel.2`); شَكَنْيَا (ID: `person:Shecaniah.5`); شِمْعِيَا (ID: `person:Shemaiah.14`); يَعِيئِيل (ID: `person:Jeuel.3`); هِقَّاطَانَ (ID: `person:Hakkatan`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); زَبَدْيَا (ID: `person:Zebadiah.8`); يِشْعِيَا (ID: `person:Jeshaiah.4`); مِيخَائِيلَ (ID: `person:Michael.10`); زَكَرِيَّا (ID: `person:Zechariah.18`); يوشَفْيَا (ID: `person:Josiphiah`); عِيلَامَ (ID: `person:Elam`); Pahath-moab (ID: `person:Pahath-moab`); دَاودَ (ID: `person:David`); إِيثَامَارَ (ID: `person:Ithamar`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فِينَحَاس (ID: `person:Phinehas`); بَابِلَ (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** يَارِيبَ (ID: `person:Jarib.2`); شِمْعِيَا (ID: `person:Shemaiah.15`); يويَارِيبَ (ID: `person:Joiarib.2`); أَلِيعَزَرَ (ID: `person:Eliezer.8`); زَكَرِيَّا (ID: `person:Zechariah.20`); يَدّو (ID: `person:Iddo`); مَشلَّام (ID: `person:Meshullam.9`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); ٱلْمسَمَّى (ID: `place:Casiphia`); نَاثَان (ID: `person:Nathan.5`); أَرِيئِيلَ (ID: `person:Ariel`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); ٱلرَّبِّ (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); مِصْرَ (ID: `place:Egypt`); Jebusites (ID: `group:Jebusites`); Ammonites (ID: `group:Ammon`); لَّاوِي (ID: `group:Levi`); حِثًّا (ID: `person:Heth`); كَنْعَان (ID: `place:Canaan`); إِسْرَائِيلَ (ID: `person:Israel`); Canaanites (ID: `group:Canaan`); Egyptians (ID: `group:Egypt`); موآبَ (ID: `place:Moab`); لَّاوِي (ID: `person:Levi.3`); Amorites (ID: `group:Amorites`); Be Unfaithful (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Passion (ID: `keyterm:Ardour`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); يَهوذَا (ID: `group:Judah`); عِيلَامَ (ID: `person:Elam`); Offering (ID: `keyterm:Offering`); Counsel (ID: `keyterm:Counsel`); يَهوذَا (ID: `person:Judah.4`); يَاشوب (ID: `person:Jashub.2`); يَحِيئِيل (ID: `person:Jehiel.8`); عزِّيَّا (ID: `person:Uzziah.4`); يَرِيموت (ID: `person:Jeremoth.3`); نَاثَان (ID: `person:Nathan.6`); مَعْسِيَّا (ID: `person:Maaseiah.6`); شِمْعِيَا (ID: `person:Shemaiah.17`); حَنَنِيَّا (ID: `person:Hananiah.5`); طَالَم (ID: `person:Telem`); عَدْنَا (ID: `person:Adna`); زَبَاي (ID: `person:Zabbai`); يَهوذَا (ID: `place:Judea`); يوزَابَاد (ID: `person:Jozabad.8`); يَحِيئِيل (ID: `person:Jehiel.9`); يَعْسو (ID: `person:Jaasu`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); Defilement (ID: `keyterm:Defilement`); فَارِسَ (ID: `place:Persia`); إِسْرَائِيلَ (ID: `person:Israel`); Peace (ID: `keyterm:IntactState`); Plea for Mercy (ID: `keyterm:Supplication`); Dispossess (ID: `keyterm:Dispossess`); أورشَلِيمَ (ID: `place:Jerusalem`); To Cause to Possess (ID: `keyterm:Possess`); Kindness (ID: `keyterm:Kindness`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); فَارِسَ (ID: `place:Persia`); Plea for Mercy (ID: `keyterm:Supplication`); أورشَلِيمَ (ID: `place:Jerusalem`); Kindness (ID: `keyterm:Kindness`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** يَحِيئِيل (ID: `person:Jehiel.8`); شَكَنْيَا (ID: `person:Shecaniah.7`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); ٱلرَّبِّ (ID: `deity:Lord`); عِيلَامَ (ID: `person:Elam`); Be Unfaithful (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`); Counsel (ID: `keyterm:Counsel`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `group:Levi`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); لَّاوِي (ID: `person:Levi.3`); Swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `person:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `group:Benjamin`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** تِقْوَةَ (ID: `person:Tikvah.2`); يونَاثَانَ (ID: `person:Jonathan.10`); شَبْتَاي (ID: `person:Shabbethai`); عَسَائِيل (ID: `person:Asahel.4`); يَحْزِيَا (ID: `person:Jahzeiah`); مَشلَّام (ID: `person:Meshullam.10`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`)
