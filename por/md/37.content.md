...
* **Associated ACAI Concepts:** Sealtiel (ID: `person:Shealtiel.2`); Dario (ID: `person:Darius.2`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Ageu (ID: `person:Haggai`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Ageu (ID: `person:Haggai`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Dario (ID: `person:Darius.2`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); An Angel (ID: `deity:Angel`); fear (ID: `keyterm:Fear`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Vine (ID: `flora:Vine`); Mule (ID: `fauna:Mule`); Olive Tree (ID: `flora:OliveTree`); Grain (ID: `flora:Grain`); Must (ID: `realia:Must`); Anointing Oil (ID: `realia:AnointingOil`); Bag (ID: `realia:Bag`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Sealtiel (ID: `person:Shealtiel.2`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Ageu (ID: `person:Haggai`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); SENHOR (ID: `deity:Lord`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Ageu (ID: `person:Haggai`); Sealtiel (ID: `person:Shealtiel.2`); Judá (ID: `person:Judah.4`); peace (ID: `keyterm:IntactState`); fear (ID: `keyterm:Fear`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `group:Judah`); Egito (ID: `place:Egypt`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Sealtiel (ID: `person:Shealtiel.2`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `group:Judah`); Ageu (ID: `person:Haggai`); Horse (ID: `fauna:Horse`); Chariot (ID: `realia:Chariot`); Sword (ID: `realia:Sword`)
