...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Acaia (ID: `place:Achaia`); Paulo (ID: `person:Paul`); Corinto (ID: `place:Corinth`); Timóteo (ID: `person:Timothy`); fazer a paz (ID: `keyterm:Peace`); igreja (ID: `keyterm:Church`); favor (ID: `keyterm:Favor`); holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** rogar (ID: `keyterm:AskFor`); bless (ID: `keyterm:Bless`); SENHOR (ID: `deity:Lord`); misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** rogar (ID: `keyterm:AskFor`); SENHOR (ID: `deity:Lord`); exortar (ID: `keyterm:Encourage`); hope (ID: `keyterm:Hope`); Jesus (ID: `person:Jesus.2`); livrar (ID: `keyterm:Deliver`); levantamento (ID: `keyterm:Resurrection`); persuadir (ID: `keyterm:Persuade`); bless (ID: `keyterm:Bless`); orar (ID: `keyterm:Pray`); favor (ID: `keyterm:Favor`); salvation (ID: `keyterm:Salvation`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); coração (ID: `keyterm:Heart`); misericórdia (ID: `keyterm:Mercy`); Asia (ID: `place:Asia`); sentença (ID: `keyterm:Verdict`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); rogar (ID: `keyterm:AskFor`); exortar (ID: `keyterm:Encourage`)
...
* **Associated ACAI Concepts:** livrar (ID: `keyterm:Deliver`); persuadir (ID: `keyterm:Persuade`); hope (ID: `keyterm:Hope`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); coração (ID: `keyterm:Heart`); levantamento (ID: `keyterm:Resurrection`); Asia (ID: `place:Asia`); orar (ID: `keyterm:Pray`); sentença (ID: `keyterm:Verdict`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); testemunhar (ID: `keyterm:BearWitness`); Ability (ID: `keyterm:Ability`); favor (ID: `keyterm:Favor`); carnal (ID: `keyterm:Carnal`); consciência (ID: `keyterm:Conscience`)
...
* **Associated ACAI Concepts:** hope (ID: `keyterm:Hope`); SENHOR (ID: `deity:Lord`); testemunhar (ID: `keyterm:BearWitness`); Ability (ID: `keyterm:Ability`); Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`); carnal (ID: `keyterm:Carnal`); consciência (ID: `keyterm:Conscience`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Silas (ID: `person:Silas`); proclamar (ID: `keyterm:Proclaim`); Cause of Joy (ID: `keyterm:CauseOfJoy`); promessa (ID: `keyterm:Promise`); corpo (ID: `keyterm:Body.3`); surely! (ID: `keyterm:Surely`); coração (ID: `keyterm:Heart`); invocar (ID: `keyterm:CallUpon`); Faithfulness (ID: `keyterm:Faithfulness`); Holy Spirit (ID: `deity:HolySpirit`); Timóteo (ID: `person:Timothy`); decidir (ID: `keyterm:Decided`); anointed (ID: `keyterm:Anointed`); crer (ID: `keyterm:Believe`); Judeia (ID: `place:Judea`); Corinto (ID: `place:Corinth`); Glory (ID: `keyterm:Glory`); witness (ID: `keyterm:Witness`); favor (ID: `keyterm:Favor`); Macedônia (ID: `place:Macedonia`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Silas (ID: `person:Silas`); Glory (ID: `keyterm:Glory`); Timóteo (ID: `person:Timothy`); promessa (ID: `keyterm:Promise`); proclamar (ID: `keyterm:Proclaim`); surely! (ID: `keyterm:Surely`); Faithfulness (ID: `keyterm:Faithfulness`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Silas (ID: `person:Silas`); Holy Spirit (ID: `deity:HolySpirit`); Glory (ID: `keyterm:Glory`); surely! (ID: `keyterm:Surely`); Timóteo (ID: `person:Timothy`); proclamar (ID: `keyterm:Proclaim`); Faithfulness (ID: `keyterm:Faithfulness`); coração (ID: `keyterm:Heart`); anointed (ID: `keyterm:Anointed`); promessa (ID: `keyterm:Promise`)
...
* **Associated ACAI Concepts:** promessa (ID: `keyterm:Promise`); SENHOR (ID: `deity:Lord`); surely! (ID: `keyterm:Surely`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** Holy Spirit (ID: `deity:HolySpirit`); SENHOR (ID: `deity:Lord`); coração (ID: `keyterm:Heart`); anointed (ID: `keyterm:Anointed`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); Corinto (ID: `place:Corinth`); SENHOR (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); decidir (ID: `keyterm:Decided`); invocar (ID: `keyterm:CallUpon`); witness (ID: `keyterm:Witness`)
...
* **Associated ACAI Concepts:** rogar (ID: `keyterm:AskFor`); forgive (ID: `keyterm:Forgive`); love (ID: `keyterm:Love`); Satanás (ID: `deity:Satan`); Jesus (ID: `person:Jesus.2`); exortar (ID: `keyterm:Encourage`)
...
* **Associated ACAI Concepts:** Tito (ID: `person:Titus`); Jesus (ID: `person:Jesus.2`); boa notícia (ID: `keyterm:GoodNews`); Spirit (ID: `keyterm:Spirit.2`); Troas (ID: `place:Troas`); Macedônia (ID: `place:Macedonia`); Door (ID: `realia:Door`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Glory (ID: `keyterm:Glory`); corpo (ID: `keyterm:Body.3`); Life (ID: `keyterm:Life`); coração (ID: `keyterm:Heart`); Holy Spirit (ID: `deity:HolySpirit`); servir (ID: `keyterm:Serve`); em cristo (ID: `keyterm:InChrist`); Ability (ID: `keyterm:Ability`); be (or show oneself) just (ID: `keyterm:Just`); para a eternidade (ID: `keyterm:Always`); reconciliar (ID: `keyterm:Reconcile`); Moisés (ID: `person:Moses`); Spirit (ID: `keyterm:Spirit.2`); rogar (ID: `keyterm:AskFor`); be unfaithful (ID: `keyterm:Unfaithful`); favor (ID: `keyterm:Favor`); Veil (ID: `realia:Veil`); letra (ID: `keyterm:Letter`); Israel (ID: `person:Israel`); céu (ID: `keyterm:Heaven`); fear (ID: `keyterm:Fear`); levantamento (ID: `keyterm:Resurrection`); hope (ID: `keyterm:Hope`); Covenant (ID: `keyterm:Covenant`); Truth (ID: `keyterm:Truth`); defilement (ID: `keyterm:Defilement`); salvation (ID: `keyterm:Salvation`); condenar (ID: `keyterm:Condemn`)
...
* **Associated ACAI Concepts:** Life (ID: `keyterm:Life`); SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** coração (ID: `keyterm:Heart`); Ink (ID: `realia:Ink`); Holy Spirit (ID: `deity:HolySpirit`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); servir (ID: `keyterm:Serve`); carnal (ID: `keyterm:Carnal`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Make Alive (ID: `keyterm:Alive`); letra (ID: `keyterm:Letter`); Holy Spirit (ID: `deity:HolySpirit`); Covenant (ID: `keyterm:Covenant`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); Holy Spirit (ID: `deity:HolySpirit`); Jesus (ID: `person:Jesus.2`); Veil (ID: `realia:Veil`); Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`); servir (ID: `keyterm:Serve`); letra (ID: `keyterm:Letter`); Israel (ID: `person:Israel`); Covenant (ID: `keyterm:Covenant`); Israelites (ID: `group:Israel`); Make Alive (ID: `keyterm:Alive`); condenar (ID: `keyterm:Condemn`); hope (ID: `keyterm:Hope`); em cristo (ID: `keyterm:InChrist`); be (or show oneself) just (ID: `keyterm:Just`); coração (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); servir (ID: `keyterm:Serve`); Israel (ID: `person:Israel`); condenar (ID: `keyterm:Condemn`); Holy Spirit (ID: `deity:HolySpirit`); Moisés (ID: `person:Moses`); Israelites (ID: `group:Israel`); be (or show oneself) just (ID: `keyterm:Just`); letra (ID: `keyterm:Letter`)
...
* **Associated ACAI Concepts:** Veil (ID: `realia:Veil`); Moisés (ID: `person:Moses`); Israel (ID: `person:Israel`); hope (ID: `keyterm:Hope`); Covenant (ID: `keyterm:Covenant`); Israelites (ID: `group:Israel`); em cristo (ID: `keyterm:InChrist`); coração (ID: `keyterm:Heart`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** andar (ID: `keyterm:Live.3`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); consciência (ID: `keyterm:Conscience`)
...
* **Associated ACAI Concepts:** boa notícia (ID: `keyterm:GoodNews`); Glory (ID: `keyterm:Glory`); SENHOR (ID: `deity:Lord`); para a eternidade (ID: `keyterm:Always`); Ability (ID: `keyterm:Ability`); be unfaithful (ID: `keyterm:Unfaithful`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); Spirit (ID: `keyterm:Spirit.2`); levantamento (ID: `keyterm:Resurrection`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** persuadir (ID: `keyterm:Persuade`); hope (ID: `keyterm:Hope`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); consciência (ID: `keyterm:Conscience`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); reconciliar (ID: `keyterm:Reconcile`); be (or show oneself) just (ID: `keyterm:Just`); coração (ID: `keyterm:Heart`); Life (ID: `keyterm:Life`); rogar (ID: `keyterm:AskFor`); em cristo (ID: `keyterm:InChrist`); fear (ID: `keyterm:Fear`); Ability (ID: `keyterm:Ability`); corpo (ID: `keyterm:Body.3`); servir (ID: `keyterm:Serve`); defilement (ID: `keyterm:Defilement`); love (ID: `keyterm:Love`); Spirit (ID: `keyterm:Spirit.2`); be unfaithful (ID: `keyterm:Unfaithful`); sem hipocrisia (ID: `keyterm:Unhypocritical`); vazio (ID: `keyterm:Empty`); Corinthians (ID: `group:Corinth`); Cause of Joy (ID: `keyterm:CauseOfJoy`); pureza (ID: `keyterm:WithoutMoralDefect`); promessa (ID: `keyterm:Promise`); kindness (ID: `keyterm:Kindness`); motivo de tropeço (ID: `keyterm:Obstacle`); unir, se em jugo desigual (ID: `keyterm:UnequallyYoked`); levantamento (ID: `keyterm:Resurrection`); jejuar (ID: `keyterm:Fast`); to act wickedly (ID: `keyterm:ActWickedly`); persuadir (ID: `keyterm:Persuade`); To Sin (ID: `keyterm:Sin`); hope (ID: `keyterm:Hope`); Truth (ID: `keyterm:Truth`); To Cleanse (ID: `keyterm:Cleanse.2`); Satanás (ID: `deity:Satan`); sem lei (ID: `keyterm:Lawless`); compaixão (ID: `keyterm:Affection`); salvation (ID: `keyterm:Salvation`); Faithfulness (ID: `keyterm:Faithfulness`); Holy Spirit (ID: `deity:HolySpirit`); condenar (ID: `keyterm:Condemn`); amado (ID: `keyterm:Beloved`); viver com (ID: `keyterm:LiveWith`); decidir (ID: `keyterm:Decided`); comunhão (ID: `keyterm:Partnership`); verdadeiro (ID: `keyterm:True`); Glory (ID: `keyterm:Glory`); Corinto (ID: `place:Corinth`); comunhão (ID: `keyterm:Fellowship`); favor (ID: `keyterm:Favor`); holy (ID: `keyterm:Holy`); consciência (ID: `keyterm:Conscience`); Image (ID: `realia:Image`); Temple (ID: `realia:Temple`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** decidir (ID: `keyterm:Decided`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); em cristo (ID: `keyterm:InChrist`); love (ID: `keyterm:Love`); decidir (ID: `keyterm:Decided`); corpo (ID: `keyterm:Body.3`); levantamento (ID: `keyterm:Resurrection`); Life (ID: `keyterm:Life`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); reconciliar (ID: `keyterm:Reconcile`); Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); To Sin (ID: `keyterm:Sin`); Ability (ID: `keyterm:Ability`); em cristo (ID: `keyterm:InChrist`); be (or show oneself) just (ID: `keyterm:Just`); servir (ID: `keyterm:Serve`)
...
* **Associated ACAI Concepts:** reconciliar (ID: `keyterm:Reconcile`); SENHOR (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** vazio (ID: `keyterm:Empty`); rogar (ID: `keyterm:AskFor`); SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); sem hipocrisia (ID: `keyterm:Unhypocritical`); Holy Spirit (ID: `deity:HolySpirit`); jejuar (ID: `keyterm:Fast`); verdadeiro (ID: `keyterm:True`); Truth (ID: `keyterm:Truth`); Glory (ID: `keyterm:Glory`); love (ID: `keyterm:Love`); pureza (ID: `keyterm:WithoutMoralDefect`); Ability (ID: `keyterm:Ability`); be (or show oneself) just (ID: `keyterm:Just`); Life (ID: `keyterm:Life`); Spirit (ID: `keyterm:Spirit.2`); kindness (ID: `keyterm:Kindness`); servir (ID: `keyterm:Serve`); motivo de tropeço (ID: `keyterm:Obstacle`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** sem hipocrisia (ID: `keyterm:Unhypocritical`); Holy Spirit (ID: `deity:HolySpirit`); Truth (ID: `keyterm:Truth`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); pureza (ID: `keyterm:WithoutMoralDefect`); Ability (ID: `keyterm:Ability`); be (or show oneself) just (ID: `keyterm:Just`); Spirit (ID: `keyterm:Spirit.2`); kindness (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** Life (ID: `keyterm:Life`); verdadeiro (ID: `keyterm:True`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** Corinthians (ID: `group:Corinth`); coração (ID: `keyterm:Heart`); compaixão (ID: `keyterm:Affection`); Corinto (ID: `place:Corinth`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); be unfaithful (ID: `keyterm:Unfaithful`); comunhão (ID: `keyterm:Partnership`); be (or show oneself) just (ID: `keyterm:Just`); comunhão (ID: `keyterm:Fellowship`); unir, se em jugo desigual (ID: `keyterm:UnequallyYoked`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); defilement (ID: `keyterm:Defilement`); be unfaithful (ID: `keyterm:Unfaithful`); fear (ID: `keyterm:Fear`); promessa (ID: `keyterm:Promise`); be (or show oneself) just (ID: `keyterm:Just`); corpo (ID: `keyterm:Body.3`); unir, se em jugo desigual (ID: `keyterm:UnequallyYoked`); To Cleanse (ID: `keyterm:Cleanse.2`); Satanás (ID: `deity:Satan`); sem lei (ID: `keyterm:Lawless`); Faithfulness (ID: `keyterm:Faithfulness`); Jesus (ID: `person:Jesus.2`); amado (ID: `keyterm:Beloved`); comunhão (ID: `keyterm:Partnership`); Life (ID: `keyterm:Life`); Spirit (ID: `keyterm:Spirit.2`); comunhão (ID: `keyterm:Fellowship`); holy (ID: `keyterm:Holy`); Image (ID: `realia:Image`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Cleanse (ID: `keyterm:Cleanse.2`); amado (ID: `keyterm:Beloved`); fear (ID: `keyterm:Fear`); defilement (ID: `keyterm:Defilement`); promessa (ID: `keyterm:Promise`); corpo (ID: `keyterm:Body.3`); Spirit (ID: `keyterm:Spirit.2`); holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** to act wickedly (ID: `keyterm:ActWickedly`); condenar (ID: `keyterm:Condemn`); rogar (ID: `keyterm:AskFor`); Cause of Joy (ID: `keyterm:CauseOfJoy`); viver com (ID: `keyterm:LiveWith`); coração (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** exortar (ID: `keyterm:Encourage`); rogar (ID: `keyterm:AskFor`); Tito (ID: `person:Titus`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); zelo (ID: `keyterm:Extremely`); corpo (ID: `keyterm:Body.3`); Macedônia (ID: `place:Macedonia`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); arrepender, se (ID: `keyterm:Repent`); empenho (ID: `keyterm:Eagerness`); pure (ID: `keyterm:Pure`); zelo (ID: `keyterm:Extremely`); to act wickedly (ID: `keyterm:ActWickedly`); rogar (ID: `keyterm:AskFor`); Tito (ID: `person:Titus`); fear (ID: `keyterm:Fear`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Ability (ID: `keyterm:Ability`); fazer justiça (ID: `keyterm:GrantJustice`); irrevogável (ID: `keyterm:NotToBeRegretted`); salvation (ID: `keyterm:Salvation`); Spirit (ID: `keyterm:Spirit.2`); exortar (ID: `keyterm:Encourage`)
...
* **Associated ACAI Concepts:** Tito (ID: `person:Titus`); rogar (ID: `keyterm:AskFor`); Truth (ID: `keyterm:Truth`); fear (ID: `keyterm:Fear`); Cause of Joy (ID: `keyterm:CauseOfJoy`); compaixão (ID: `keyterm:Affection`); Spirit (ID: `keyterm:Spirit.2`); exortar (ID: `keyterm:Encourage`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); igreja (ID: `keyterm:Church`); favor (ID: `keyterm:Favor`); Macedônia (ID: `place:Macedonia`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); servir (ID: `keyterm:Serve`); Jesus (ID: `person:Jesus.2`); igreja (ID: `keyterm:Church`); love (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`); empenho (ID: `keyterm:Eagerness`); Tito (ID: `person:Titus`); holy (ID: `keyterm:Holy`); Macedônia (ID: `place:Macedonia`); be (or show oneself) just (ID: `keyterm:Just`); coração (ID: `keyterm:Heart`); Glory (ID: `keyterm:Glory`); boa notícia (ID: `keyterm:GoodNews`); comunhão (ID: `keyterm:Fellowship`); zelo (ID: `keyterm:Extremely`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Ability (ID: `keyterm:Ability`); promessa (ID: `keyterm:Promise`); essência (ID: `keyterm:Confidence`); hope (ID: `keyterm:Hope`); Acaia (ID: `place:Achaia`); testemunhar (ID: `keyterm:BearWitness`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); discernir (ID: `keyterm:Interpret`); desejar (ID: `keyterm:LongFor`); priesthood (ID: `keyterm:Priesthood`); esvaziar (ID: `keyterm:DepriveOfPower`); crer (ID: `keyterm:Believe`); para a eternidade (ID: `keyterm:Always`); Grain (ID: `flora:Grain`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** igreja (ID: `keyterm:Church`); Jesus (ID: `person:Jesus.2`); servir (ID: `keyterm:Serve`); Tito (ID: `person:Titus`); Glory (ID: `keyterm:Glory`); love (ID: `keyterm:Love`); boa notícia (ID: `keyterm:GoodNews`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); igreja (ID: `keyterm:Church`); Tito (ID: `person:Titus`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Macedônia (ID: `place:Macedonia`); essência (ID: `keyterm:Confidence`); rogar (ID: `keyterm:AskFor`); Acaia (ID: `place:Achaia`); zelo (ID: `keyterm:Extremely`); promessa (ID: `keyterm:Promise`); esvaziar (ID: `keyterm:DepriveOfPower`); servir (ID: `keyterm:Serve`); holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); para a eternidade (ID: `keyterm:Always`); be (or show oneself) just (ID: `keyterm:Just`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); servir (ID: `keyterm:Serve`); Glory (ID: `keyterm:Glory`); orar (ID: `keyterm:Pray`); favor (ID: `keyterm:Favor`); priesthood (ID: `keyterm:Priesthood`); be (or show oneself) just (ID: `keyterm:Just`); desejar (ID: `keyterm:LongFor`); Jesus (ID: `person:Jesus.2`); boa notícia (ID: `keyterm:GoodNews`); comunhão (ID: `keyterm:Fellowship`); holy (ID: `keyterm:Holy`); Barley (ID: `flora:Barley`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** Paulo (ID: `person:Paul`); kindness (ID: `keyterm:Kindness`); rogar (ID: `keyterm:AskFor`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); corpo (ID: `keyterm:Body.3`); Paulo (ID: `person:Paul`); rogar (ID: `keyterm:AskFor`); kindness (ID: `keyterm:Kindness`); carnal (ID: `keyterm:Carnal`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); Ability (ID: `keyterm:Ability`); love (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`); boa notícia (ID: `keyterm:GoodNews`); Building Up (ID: `keyterm:BuildingUp`); Truth (ID: `keyterm:Truth`); igreja (ID: `keyterm:Church`); To Sin (ID: `keyterm:Sin`); dever (ID: `keyterm:Ought`); hope (ID: `keyterm:Hope`); aprovado (ID: `keyterm:Approved`); palavra (ID: `keyterm:Word`); crer (ID: `keyterm:Believe`); fear (ID: `keyterm:Fear`); em cristo (ID: `keyterm:InChrist`); Spirit (ID: `keyterm:Spirit.2`); andar (ID: `keyterm:Live.3`); orar (ID: `keyterm:Pray`); An Angel (ID: `deity:Angel`); autoridade (ID: `keyterm:Authority.2`); Aretas (ID: `person:Aretas`); Eva (ID: `person:Eve`); discernir (ID: `keyterm:Interpret`); bless (ID: `keyterm:Bless`); Gentiles (ID: `group:Gentile`); proclamar (ID: `keyterm:Proclaim`); zelo (ID: `keyterm:Extremely`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Fortress (ID: `realia:Fortress`); andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); corpo (ID: `keyterm:Body.3`); carnal (ID: `keyterm:Carnal`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); persuadir (ID: `keyterm:Persuade`); Building Up (ID: `keyterm:BuildingUp`); Ability (ID: `keyterm:Ability`); coração (ID: `keyterm:Heart`); corpo (ID: `keyterm:Body.3`); autoridade (ID: `keyterm:Authority.2`)
...
* **Associated ACAI Concepts:** boa notícia (ID: `keyterm:GoodNews`); crer (ID: `keyterm:Believe`); hope (ID: `keyterm:Hope`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Eva (ID: `person:Eve`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); pure (ID: `keyterm:Pure`); proclamar (ID: `keyterm:Proclaim`); zelo (ID: `keyterm:Extremely`); pureza (ID: `keyterm:WithoutMoralDefect`); ter casamento contratado (ID: `keyterm:Engaged`); Spirit (ID: `keyterm:Spirit.2`); boa notícia (ID: `keyterm:GoodNews`); Snake (ID: `fauna:Snake`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); pure (ID: `keyterm:Pure`); zelo (ID: `keyterm:Extremely`); ter casamento contratado (ID: `keyterm:Engaged`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** boa notícia (ID: `keyterm:GoodNews`); Spirit (ID: `keyterm:Spirit.2`); proclamar (ID: `keyterm:Proclaim`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** igreja (ID: `keyterm:Church`); servir (ID: `keyterm:Serve`); Macedônia (ID: `place:Macedonia`)
...
* **Associated ACAI Concepts:** Satanás (ID: `deity:Satan`); be (or show oneself) just (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Israel (ID: `person:Israel`); essência (ID: `keyterm:Confidence`); Jews (ID: `group:Jews`); fazer tropeçar (ID: `keyterm:CauseToStumble`); Gentiles (ID: `group:Gentile`); Israelites (ID: `group:Israel`); Abraão (ID: `person:Abraham`); Hebrews (ID: `group:Hebrews`); corpo (ID: `keyterm:Body.3`); igreja (ID: `keyterm:Church`); jejuar (ID: `keyterm:Fast`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Gentiles (ID: `group:Gentile`); fazer tropeçar (ID: `keyterm:CauseToStumble`); Israelites (ID: `group:Israel`); Jews (ID: `group:Jews`); Abraão (ID: `person:Abraham`); Hebrews (ID: `group:Hebrews`); Jesus (ID: `person:Jesus.2`); igreja (ID: `keyterm:Church`); jejuar (ID: `keyterm:Fast`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Israelites (ID: `group:Israel`); Hebrews (ID: `group:Hebrews`); Abraão (ID: `person:Abraham`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); Jesus (ID: `person:Jesus.2`); Truth (ID: `keyterm:Truth`); céu (ID: `keyterm:Heaven`); Be Lawful (ID: `keyterm:Lawful`); An Angel (ID: `deity:Angel`); paraíso (ID: `keyterm:Paradise`); em cristo (ID: `keyterm:InChrist`); palavra (ID: `keyterm:Word`)
...
* **Associated ACAI Concepts:** céu (ID: `keyterm:Heaven`); SENHOR (ID: `deity:Lord`); em cristo (ID: `keyterm:InChrist`); Jesus (ID: `person:Jesus.2`); corpo (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Be Lawful (ID: `keyterm:Lawful`); paraíso (ID: `keyterm:Paradise`); corpo (ID: `keyterm:Body.3`); palavra (ID: `keyterm:Word`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); SENHOR (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Ability (ID: `keyterm:Ability`); corpo (ID: `keyterm:Body.3`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** example (ID: `keyterm:Example`); injustiça (ID: `keyterm:UnjustDeed`); maravilha (ID: `keyterm:Portent`); dever (ID: `keyterm:Ought`); Ability (ID: `keyterm:Ability`); igreja (ID: `keyterm:Church`); forgive (ID: `keyterm:Forgive`)
...
* **Associated ACAI Concepts:** igreja (ID: `keyterm:Church`); injustiça (ID: `keyterm:UnjustDeed`); forgive (ID: `keyterm:Forgive`)
...
* **Associated ACAI Concepts:** Spirit (ID: `keyterm:Spirit.2`); rogar (ID: `keyterm:AskFor`); Tito (ID: `person:Titus`)
...
* **Associated ACAI Concepts:** Building Up (ID: `keyterm:BuildingUp`); SENHOR (ID: `deity:Lord`); amado (ID: `keyterm:Beloved`); em cristo (ID: `keyterm:InChrist`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** fornication (ID: `keyterm:Fornication`); zelo (ID: `keyterm:Resentment`); To Sin (ID: `keyterm:Sin`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); defilement (ID: `keyterm:Defilement`); arrepender, se (ID: `keyterm:Repent`)
...
* **Associated ACAI Concepts:** fornication (ID: `keyterm:Fornication`); To Sin (ID: `keyterm:Sin`); SENHOR (ID: `deity:Lord`); defilement (ID: `keyterm:Defilement`); arrepender, se (ID: `keyterm:Repent`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Jesus (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** aprovado (ID: `keyterm:Approved`); SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); bom (ID: `keyterm:Honest`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); Truth (ID: `keyterm:Truth`); Building Up (ID: `keyterm:BuildingUp`); aprovado (ID: `keyterm:Approved`); Ability (ID: `keyterm:Ability`); bom (ID: `keyterm:Honest`); Jesus (ID: `person:Jesus.2`); autoridade (ID: `keyterm:Authority.2`)
...
* **Associated ACAI Concepts:** Building Up (ID: `keyterm:BuildingUp`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Jesus (ID: `person:Jesus.2`); autoridade (ID: `keyterm:Authority.2`)
...
* **Associated ACAI Concepts:** rogar (ID: `keyterm:AskFor`); viver em paz (ID: `keyterm:AtPeace`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); fazer a paz (ID: `keyterm:Peace`); exortar (ID: `keyterm:Encourage`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); Holy Spirit (ID: `deity:HolySpirit`); rogar (ID: `keyterm:AskFor`); viver em paz (ID: `keyterm:AtPeace`); fazer a paz (ID: `keyterm:Peace`); Jesus (ID: `person:Jesus.2`); comunhão (ID: `keyterm:Fellowship`); exortar (ID: `keyterm:Encourage`); holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** Holy Spirit (ID: `deity:HolySpirit`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`); comunhão (ID: `keyterm:Fellowship`); holy (ID: `keyterm:Holy`)
