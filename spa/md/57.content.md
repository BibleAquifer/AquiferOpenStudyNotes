...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Filemón (ID: `person:Philemon`); Archîpo (ID: `person:Archippus`); Apphia (ID: `person:Apphia`); iglesia (ID: `keyterm:Church`); amado (ID: `keyterm:Beloved`); Jehová (ID: `deity:Lord`); hacer la paz (ID: `keyterm:Peace`); Timoteo (ID: `person:Timothy`); favor (ID: `keyterm:Favor`); Pablo (ID: `person:Paul`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** creer (ID: `keyterm:Believe`); Jesús (ID: `person:Jesus.2`); santo (ID: `keyterm:Holy`); amar (ID: `keyterm:Love`); orar (ID: `keyterm:Pray`); rogar (ID: `keyterm:AskFor`); Jehová (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); comunión (ID: `keyterm:Fellowship`); Good (ID: `keyterm:Good`); entrañas (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Demas (ID: `person:Demas`); Epafras (ID: `person:Epaphras`); Lucas (ID: `person:Luke`); espíritu (ID: `keyterm:Spirit.2`); favor (ID: `keyterm:Favor`); Marcos (ID: `person:Mark`); cristo (ID: `keyterm:InChrist`); Aristarco (ID: `person:Aristarchus`)
