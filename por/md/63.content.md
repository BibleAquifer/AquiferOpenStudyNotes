...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); fazer a paz (ID: `keyterm:Peace`); Jesus (ID: `person:Jesus.2`); misericórdia (ID: `keyterm:Mercy`); favor (ID: `keyterm:Favor`); para a eternidade (ID: `keyterm:Always`); SENHOR (ID: `deity:Lord`); escolhido (ID: `keyterm:Chosen`)
...
* **Associated ACAI Concepts:** fazer a paz (ID: `keyterm:Peace`); Jesus (ID: `person:Jesus.2`); misericórdia (ID: `keyterm:Mercy`); love (ID: `keyterm:Love`); favor (ID: `keyterm:Favor`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); andar (ID: `keyterm:Live.3`); Ability (ID: `keyterm:Ability`); rogar (ID: `keyterm:AskFor`); corpo (ID: `keyterm:Body.3`); compartilhar (ID: `keyterm:Share`); Truth (ID: `keyterm:Truth`); House (ID: `realia:House`)
