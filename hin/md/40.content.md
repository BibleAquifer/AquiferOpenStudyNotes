...
* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Blood (ID: `keyterm:Blood`); Be a Disciple (ID: `keyterm:Disciple`); Forgive (ID: `keyterm:Forgive`); Kingdom (ID: `keyterm:Kingdom`); यहोवा (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); यीशु (ID: `person:Jesus.2`); Covenant (ID: `keyterm:Covenant`); Bless (ID: `keyterm:Bless`); Vine (ID: `flora:Vine`)
