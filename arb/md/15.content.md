...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); ٱلرَّبِّ (ID: `deity:Lord`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`); إِسْرَائِيلَ (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); إِرْمِيَا (ID: `person:Jeremiah.6`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); فَارِسَ (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `group:Benjamin`); لَّاوِي (ID: `group:Levi`); يَهوذَا (ID: `person:Judah.4`); لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `person:Benjamin`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); ٱلرَّبِّ (ID: `deity:Lord`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); لَّاوِي (ID: `group:Levi`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `person:Levi.3`); سلَيْمَانَ (ID: `person:Solomon`); سَوْطَايَ (ID: `person:Sotai`); نَبو (ID: `place:Nebo.2`); حَاجَابَ (ID: `person:Hagab`); جَاحَرَ (ID: `person:Gahar`); Beth-azmaveth (ID: `place:Beth-azmaveth`); عَقّوب (ID: `person:Akkub.3`); حَرْشَا (ID: `person:Harsha`); حَارِيمَ (ID: `person:Harim.2`); شوبَايَ (ID: `person:Shobai`); نَحَمْيَا (ID: `person:Nehemiah`); بِلْشَان (ID: `person:Bilshan`); بِيسَايَ (ID: `person:Besai`); Nephushesim (ID: `group:Nephushesim`); بِيصَايَ (ID: `person:Bezai`); حَشوم (ID: `person:Hashum`); سَنَاءَةَ (ID: `place:Senaah`); لِدَلَايَا (ID: `person:Delaiah.3`); شَفَطْيَا (ID: `person:Shephatiah.6`); مِسْفَار (ID: `person:Mispar`); بَابَايَ (ID: `person:Bebai`); حَجَابَةَ (ID: `person:Hagabah`); زَكَّايَ (ID: `person:Zaccai.2`); حَارِيمَ (ID: `person:Harim`); قِيروسَ (ID: `person:Keros`)
...
* **Associated ACAI Concepts:** بَعْنَةَ (ID: `person:Baanah.3`); بِغْوَايَ (ID: `person:Bigvai`); مرْدَخَاي (ID: `person:Mordecai`); سَرَايَا (ID: `person:Seraiah.6`); مِسْفَار (ID: `person:Mispar`); نَحَمْيَا (ID: `person:Nehemiah`); بِلْشَان (ID: `person:Bilshan`); رَحوم (ID: `person:Rehum`); رَعْلَايَا (ID: `person:Reelaiah`); إِسْرَائِيلَ (ID: `person:Israel`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Pahath-moab (ID: `person:Pahath-moab`); أَدونِيقَامَ (ID: `person:Adonikam`); بَانِيَ (ID: `person:Bani`); يَشوعَ (ID: `person:Jeshua.3`); زَتّو (ID: `person:Zattu.2`); بِيصَايَ (ID: `person:Bezai`); حَشوم (ID: `person:Hashum`); يورَةَ (ID: `person:Jorah`); فَرْعوشَ (ID: `person:Parosh`); شَفَطْيَا (ID: `person:Shephatiah.6`); عَرْجَدَ (ID: `person:Azgad`); عَادِينَ (ID: `person:Adin`); آرَحَ (ID: `person:Arah.2`); بِغْوَايَ (ID: `person:Bigvai.2`); حَزَقِيَّا (ID: `person:Hezekiah.2`); عِيلَامَ (ID: `person:Elam`); بَابَايَ (ID: `person:Bebai`); زَكَّايَ (ID: `person:Zaccai.2`); يوآب (ID: `person:Joab.3`); آطِيرَ (ID: `person:Ater`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** نَبو (ID: `place:Nebo.2`); Beth-azmaveth (ID: `place:Beth-azmaveth`); حَارِيمَ (ID: `person:Harim.2`); حَادِيدَ (ID: `place:Hadid`); سَنَاءَةَ (ID: `place:Senaah`); مَغْبِيشَ (ID: `place:Magbish`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); عَايٍ (ID: `place:Ai`); لَحْمٍ (ID: `place:Bethlehem`); ٱلْكَفِيرَة (ID: `place:Chephirah`); بَئِيروت (ID: `place:Beeroth`); Kiriath-jearim (ID: `place:Kiriath-jearim`); أونوَ (ID: `place:Ono`); وَلودَ (ID: `place:Lod`); مِنْ (ID: `place:Geba`); عِيلَامَ (ID: `person:Elam`); عَنَاثوثَ (ID: `place:Anathoth`); أَرِيحَا (ID: `place:Jericho`); مِخْمَاسَ (ID: `place:Michmash`); Bethel (ID: `place:Bethel`); Ramah (ID: `place:Ramah.2`)
...
* **Associated ACAI Concepts:** آطِيرَ (ID: `person:Ater.2`); حَارِيمَ (ID: `person:Harim`); يَدَايَا (ID: `person:Jedaiah.4`); لِإِيمِيرَ (ID: `person:Immer.2`); شوبَايَ (ID: `person:Shobai`); هودَوْيَا (ID: `person:Hodaviah.4`); يَشوعَ (ID: `person:Jeshua`); يَشوعَ (ID: `person:Jeshua.4`); طَلْمون (ID: `person:Talmon`); حَطِيطَا (ID: `person:Hatita`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); فَشْحور (ID: `person:Pashhur`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`); شَلّوم (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** آطِيرَ (ID: `person:Ater.2`); شوبَايَ (ID: `person:Shobai`); طَلْمون (ID: `person:Talmon`); حَطِيطَا (ID: `person:Hatita`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`); شَلّوم (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** لَبَانَةَ (ID: `person:Lebanah`); حَرْحورَ (ID: `person:Harhur`); فَادونَ (ID: `person:Padon`); رَآيَا (ID: `person:Reaiah.3`); قِيروسَ (ID: `person:Keros`); بَصْلوتَ (ID: `person:Bazluth`); حَاجَابَ (ID: `person:Hagab`); جَدِّيلَ (ID: `person:Giddel`); سَلْمَايَ (ID: `person:Shalmai`); جَاحَرَ (ID: `person:Gahar`); نَقودَا (ID: `person:Nekoda`); بَقْبوقَ (ID: `person:Bakbuk`); فِي (ID: `person:Uzza.2`); حَرْشَا (ID: `person:Harsha`); عَقّوب (ID: `person:Akkub.3`); Meunim (ID: `group:Meunim`); سِيعَهَا (ID: `person:Siaha`); حَسوفَا (ID: `person:Hasupha`); رَصِينَ (ID: `person:Rezin.2`); بِيسَايَ (ID: `person:Besai`); Nephushesim (ID: `group:Nephushesim`); جَزَّامَ (ID: `person:Gazzam`); بَرْقوسَ (ID: `person:Barkos`); صِيحَا (ID: `person:Ziha`); مَحِيدَا (ID: `person:Mehida`); نَصِيحَ (ID: `person:Neziah`); سِيسَرَا (ID: `person:Sisera.2`); فَاسِيحَ (ID: `person:Paseah.2`); حَطِيفَا (ID: `person:Hatipha`); ثَامَحَ (ID: `person:Temah`); حَجَابَةَ (ID: `person:Hagabah`); طَبَاعوتَ (ID: `person:Tabbaoth`); أَسْنَةَ (ID: `person:Asnah`); حَقوفَا (ID: `person:Hakupha`); حَانَان (ID: `person:Hanan.4`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); آمِي (ID: `person:Ami`); سوفَرَثَ (ID: `person:Sophereth`); سَوْطَايَ (ID: `person:Sotai`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); دَرْقونَ (ID: `person:Darkon`); جَدِّيلَ (ID: `person:Giddel.2`); شَفَطْيَا (ID: `person:Shephatiah.7`); حَطِّيلَ (ID: `person:Hattil`); فَرودَا (ID: `person:Peruda`); يَعْلَةَ (ID: `person:Jaalah`)
...
* **Associated ACAI Concepts:** طوبِيَّا (ID: `person:Tobiah`); Tel-melah (ID: `place:Tel-melah`); لِإِيمِيرَ (ID: `place:Immer`); نَقودَا (ID: `person:Nekoda.2`); لِدَلَايَا (ID: `person:Delaiah.3`); كَروب (ID: `place:Cherub`); أَدَّان (ID: `place:Addan`); Tel-harsha (ID: `place:Tel-harsha`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** بَرْزِلَّايَ (ID: `person:Barzillai.3`); حَبَايَا (ID: `person:Habaiah`); هَقّوصَ (ID: `person:Hakkoz.2`); بَرْزِلَّايَ (ID: `person:Barzillai`); Gileadites (ID: `group:Gilead`); جِلْعَادَ (ID: `place:Gilead`); Defile (ID: `keyterm:Stain`); Priesthood (ID: `keyterm:Priesthood`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); ٱلرَّبِّ (ID: `deity:Lord`); Strength (ID: `keyterm:Strength`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Mina (ID: `realia:Mina`); Money (ID: `realia:Money`); Tunic (ID: `realia:Tunic`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); يَشوع (ID: `person:Joshua.5`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Esarhaddon (ID: `person:Esarhaddon`); حِينَادَادَ (ID: `person:Henadad`); هودَوْيَا (ID: `person:Hodaviah.4`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); يَشوعَ (ID: `person:Jeshua.4`); Relatives (ID: `group:Relatives`); صورَ (ID: `place:Tyre`); New Moon Festival (ID: `keyterm:NewMoonFestival`); صِيْدونَ (ID: `place:Sidon`); Kindness (ID: `keyterm:Kindness`); Instruction (ID: `keyterm:Instruction`); بَنْيَامِينَ (ID: `person:Benjamin`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); يَافَا (ID: `place:Joppa`); Sidonians (ID: `group:Sidon`); لبْنَانَ (ID: `place:Lebanon`); Tyrians (ID: `group:Tyre`); هودِيَّا (ID: `person:Hodiah.2`); دَاودَ (ID: `person:David`); موسَى (ID: `person:Moses`); بَنْيَامِينَ (ID: `group:Benjamin`); Appointed Feast (ID: `keyterm:AppointedFeast`); Terror (ID: `keyterm:Terror`); Assyria (ID: `place:Assyria`); دَارِيوسَ (ID: `person:Darius.2`); آسَاف (ID: `person:Asaph.2`); Holy (ID: `keyterm:Holy`); Counsel (ID: `keyterm:Counsel`); Cedar (ID: `flora:Cedar`); Cymbals (ID: `realia:Cymbals`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Trumpet (ID: `realia:Trumpet`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); إِسْرَائِيلَ (ID: `person:Israel`); موسَى (ID: `person:Moses`); ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Instruction (ID: `keyterm:Instruction`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Terror (ID: `keyterm:Terror`); ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); صورَ (ID: `place:Tyre`); يَافَا (ID: `place:Joppa`); Sidonians (ID: `group:Sidon`); لبْنَانَ (ID: `place:Lebanon`); صِيْدونَ (ID: `place:Sidon`); Tyrians (ID: `group:Tyre`); فَارِسَ (ID: `place:Persia`); Craftsman (ID: `realia:Craftsman`); Cedar (ID: `flora:Cedar`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوصَادِقَ (ID: `person:Jehozadak`); لَّاوِي (ID: `group:Levi`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); زَربَّابِل (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); دَاودَ (ID: `person:David`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); Kindness (ID: `keyterm:Kindness`); آسَاف (ID: `person:Asaph.2`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); إِسْرَائِيلَ (ID: `person:Israel`); يَشوع (ID: `person:Joshua.5`); كورَشَ (ID: `person:Cyrus`); ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); فَارِسَ (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); ٱلسَّامِرَةِ (ID: `place:Samaria`); فَارِسَ (ID: `place:Persia`); أَرَكَ (ID: `place:Erech`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); أسْنَفَّر (ID: `person:Osnappar`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); مِثْرَدَاث (ID: `person:Mithredath.2`); طَبْئِيل (ID: `person:Tabeel`); بِشْلَام (ID: `person:Bishlam`); Babylonians (ID: `group:Babylon`); فِي (ID: `place:Susa`); يَهوذَا (ID: `group:Judah`); بَابِلَ (ID: `place:Babylon`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); يَهوذَا (ID: `person:Judah.4`); عِيلَامَ (ID: `place:Elam`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** أَرَكَ (ID: `place:Erech`); رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); Babylonians (ID: `group:Babylon`); فِي (ID: `place:Susa`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); عِيلَامَ (ID: `place:Elam`); فَارِسَ (ID: `place:Persia`); بَابِلَ (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); Jews (ID: `group:Jews`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); دَارِيوسَ (ID: `person:Darius.2`); زَكَرِيَّا (ID: `person:Zechariah.17`); حَجَّيِ (ID: `person:Haggai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); تَتْنَاي (ID: `person:Tattenai`); يَدّو (ID: `person:Iddo.6`); إِسْرَائِيلَ (ID: `person:Israel`); يَشوع (ID: `person:Joshua.5`); ٱلْفرَاتِ (ID: `place:Euphrates`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَهوذَا (ID: `person:Judah.4`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** زَكَرِيَّا (ID: `person:Zechariah.17`); حَجَّيِ (ID: `person:Haggai`); يَدّو (ID: `person:Iddo.6`); إِسْرَائِيلَ (ID: `person:Israel`); Jews (ID: `group:Jews`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); زَربَّابِل (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); كورَشَ (ID: `person:Cyrus`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); زَربَّابِل (ID: `person:Zerubbabel.2`); بَابِلَ (ID: `place:Babylon`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** موسَى (ID: `person:Moses`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** عَزَرْيَا (ID: `person:Azariah.7`); سَرَايَا (ID: `person:Seraiah.2`); عَزْرَا (ID: `person:Ezra`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); حِلْقِيَّا (ID: `person:Hilkiah.2`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); أَخِيطوبَ (ID: `person:Ahitub.3`); شَلّوم (ID: `person:Shallum.7`); لِمَرَايوثَ (ID: `person:Meraioth`); صَادوق (ID: `person:Zadok.4`); سَرَايَا (ID: `person:Seraiah.2`); أَبِيشوعَ (ID: `person:Abishua`); عَزَرْيَا (ID: `person:Azariah.7`); بقِّي (ID: `person:Bukki.2`); أَمَرْيَا (ID: `person:Amariah.2`); عَزَرْيَا (ID: `person:Azariah.6`); عزِّي (ID: `person:Uzzi`); زَرَحْيَا (ID: `person:Zerahiah`); فِينَحَاس (ID: `person:Phinehas`); حِلْقِيَّا (ID: `person:Hilkiah.2`); فَارِسَ (ID: `place:Persia`); هَارون (ID: `person:Aaron`); أَلِعَازَار (ID: `person:Eleazar.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); موسَى (ID: `person:Moses`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); بَابِلَ (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Decree (ID: `keyterm:Decree`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); عَزْرَا (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); عَزْرَا (ID: `person:Ezra`); Talent (ID: `realia:Talent`); Kor (ID: `realia:Kor`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** يِشْعِيَا (ID: `person:Jeshaiah.4`); Pahath-moab (ID: `person:Pahath-moab`); شَكَنْيَا (ID: `person:Shecaniah.5`); زَكَرِيَّا (ID: `person:Zechariah.18`); زَكّور (ID: `person:Zaccur.5`); يوآب (ID: `person:Joab.4`); Gershom (ID: `person:Gershom.2`); أَدونِيقَامَ (ID: `person:Adonikam`); زَرَحْيَا (ID: `person:Zerahiah.2`); يوحَانَانَ (ID: `person:Johanan.8`); عَثَلْيَا (ID: `person:Athaliah.3`); يَحِيئِيل (ID: `person:Jehiel.7`); يَحْزِيئِيل (ID: `person:Jahaziel.5`); يوشَفْيَا (ID: `person:Josiphiah`); عوتَاي (ID: `person:Uthai.2`); مِيخَائِيلَ (ID: `person:Michael.10`); يَعِيئِيل (ID: `person:Jeuel.3`); عوبَدْيَا (ID: `person:Obadiah.10`); شَلومِيَةَ (ID: `person:Shelomith.4`); دَانِيآل (ID: `person:Daniel.2`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); شَفَطْيَا (ID: `person:Shephatiah.6`); عَادِينَ (ID: `person:Adin`); عَرْجَدَ (ID: `person:Azgad`); شِمْعِيَا (ID: `person:Shemaiah.14`); أَلِيفَلَط (ID: `person:Eliphelet.5`); زَبَدْيَا (ID: `person:Zebadiah.8`); زَكَرِيَّا (ID: `person:Zechariah.19`); عَابِد (ID: `person:Ebed.2`); شَكَنْيَا (ID: `person:Shecaniah.6`); عِيلَامَ (ID: `person:Elam`); يونَاثَانَ (ID: `person:Jonathan.9`); حَطّوش (ID: `person:Hattush.2`); بَابَايَ (ID: `person:Bebai.2`); بَابَايَ (ID: `person:Bebai`); بِغْوَايَ (ID: `person:Bigvai.2`); فَرْعوشَ (ID: `person:Parosh.2`); هِقَّاطَانَ (ID: `person:Hakkatan`); فِينَحَاس (ID: `person:Phinehas`); إِيثَامَارَ (ID: `person:Ithamar`); بَابِلَ (ID: `place:Babylon`); دَاودَ (ID: `person:David`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** شِمْعِيَا (ID: `person:Shemaiah.15`); مَشلَّام (ID: `person:Meshullam.9`); ٱلْمسَمَّى (ID: `place:Casiphia`); يَارِيبَ (ID: `person:Jarib.2`); أَرِيئِيلَ (ID: `person:Ariel`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); يويَارِيبَ (ID: `person:Joiarib.2`); نَاثَان (ID: `person:Nathan.5`); يَدّو (ID: `person:Iddo`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); زَكَرِيَّا (ID: `person:Zechariah.20`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); أَلِيعَزَرَ (ID: `person:Eliezer.8`); ٱلرَّبِّ (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `group:Levi`); Insight (ID: `keyterm:Insight`); لَّاوِي (ID: `person:Levi.3`); مَحْلِي (ID: `person:Mahli`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); إِسْرَائِيلَ (ID: `person:Israel`); Egyptians (ID: `group:Egypt`); موآبَ (ID: `place:Moab`); كَنْعَان (ID: `place:Canaan`); Ammonites (ID: `group:Ammon`); حِثًّا (ID: `person:Heth`); لَّاوِي (ID: `group:Levi`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `person:Levi.3`); Amorites (ID: `group:Amorites`); Canaanites (ID: `group:Canaan`); Jebusites (ID: `group:Jebusites`); مِصْرَ (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); Offering (ID: `keyterm:Offering`); يَهوذَا (ID: `person:Judah.4`); عِيلَامَ (ID: `person:Elam`); Counsel (ID: `keyterm:Counsel`); يَهوذَا (ID: `group:Judah`); مَتَّنْيَا (ID: `person:Mattaniah.7`); كَلَال (ID: `person:Chelal`); نَاثَان (ID: `person:Nathan.6`); أَلْعَاسَةَ (ID: `person:Elasah`); يِزِّيَّا (ID: `person:Izziah`); يَعِيئِيل (ID: `person:Jeiel.8`); عَسَائِيل (ID: `person:Asahel.4`); يَعْسو (ID: `person:Jaasu`); مَعْسِيَّا (ID: `person:Maaseiah.7`); شَلَمْيَا (ID: `person:Shelemiah.3`); يوزَابَاد (ID: `person:Jozabad.7`); فَتَحْيَا (ID: `person:Pethahiah.2`); شِمْعِي (ID: `person:Shimei.15`); شِمْعون (ID: `person:Shimeon`); شَبْتَاي (ID: `person:Shabbethai`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); إِسْرَائِيلَ (ID: `person:Israel`); Plea for Mercy (ID: `keyterm:Supplication`); Defilement (ID: `keyterm:Defilement`); Peace (ID: `keyterm:IntactState`); To Cause to Possess (ID: `keyterm:Possess`); Dispossess (ID: `keyterm:Dispossess`); Kindness (ID: `keyterm:Kindness`); أورشَلِيمَ (ID: `place:Jerusalem`); فَارِسَ (ID: `place:Persia`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** يَحِيئِيل (ID: `person:Jehiel.8`); شَكَنْيَا (ID: `person:Shecaniah.7`); إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); ٱلرَّبِّ (ID: `deity:Lord`); Be Unfaithful (ID: `keyterm:Unfaithful`); عَزْرَا (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`); Counsel (ID: `keyterm:Counsel`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Swear (ID: `keyterm:Swear`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); عَزْرَا (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `person:Benjamin`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَحْزِيَا (ID: `person:Jahzeiah`); مَشلَّام (ID: `person:Meshullam.10`); شَبْتَاي (ID: `person:Shabbethai`); تِقْوَةَ (ID: `person:Tikvah.2`); عَسَائِيل (ID: `person:Asahel.4`); يونَاثَانَ (ID: `person:Jonathan.10`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`)
