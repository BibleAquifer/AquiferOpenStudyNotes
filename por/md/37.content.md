...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Dario (ID: `person:Darius.2`); Ageu (ID: `person:Haggai`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Ageu (ID: `person:Haggai`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); Dario (ID: `person:Darius.2`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); An Angel (ID: `deity:Angel`); fear (ID: `keyterm:Fear`); Anointing Oil (ID: `realia:AnointingOil`); Bag (ID: `realia:Bag`); Must (ID: `realia:Must`); Vine (ID: `flora:Vine`); Mule (ID: `fauna:Mule`); Grain (ID: `flora:Grain`); Olive Tree (ID: `flora:OliveTree`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); Ageu (ID: `person:Haggai`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `person:Judah.4`); Josué (ID: `person:Joshua.5`); Judá (ID: `group:Judah`); Sealtiel (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Ageu (ID: `person:Haggai`); peace (ID: `keyterm:IntactState`); fear (ID: `keyterm:Fear`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Egito (ID: `place:Egypt`); Judá (ID: `group:Judah`); Sealtiel (ID: `person:Shealtiel.2`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Ageu (ID: `person:Haggai`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `group:Judah`); Sealtiel (ID: `person:Shealtiel.2`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`); Sword (ID: `realia:Sword`)
