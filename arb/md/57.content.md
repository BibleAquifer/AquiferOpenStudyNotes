...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); إِلَى (ID: `person:Philemon`); إِلَى (ID: `person:Apphia`); لِأَرْخِبّسَ (ID: `person:Archippus`); Church (ID: `keyterm:Church`); ٱلرَّبِّ (ID: `deity:Lord`); تِيموثَاوس (ID: `person:Timothy`); Make Peace (ID: `keyterm:Peace`); Favor (ID: `keyterm:Favor`); Beloved (ID: `keyterm:Beloved`); بولسَ (ID: `person:Paul`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Love (ID: `keyterm:Love`); Believe (ID: `keyterm:Believe`); Holy (ID: `keyterm:Holy`); Pray (ID: `keyterm:Pray`); Fellowship (ID: `keyterm:Fellowship`); Good (ID: `keyterm:Good`); ٱلرَّبِّ (ID: `deity:Lord`); Ask for (ID: `keyterm:AskFor`); Affection (ID: `keyterm:Affection`); Cause of Joy (ID: `keyterm:CauseOfJoy`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Good (ID: `keyterm:Good`); Believe (ID: `keyterm:Believe`); Fellowship (ID: `keyterm:Fellowship`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); In Christ (ID: `keyterm:InChrist`); Affection (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); لوقَا (ID: `person:Luke`); دِيمَاس (ID: `person:Demas`); أَبَفْرَاسَ (ID: `person:Epaphras`); أَرِسْتَرْخسَ (ID: `person:Aristarchus`); In Christ (ID: `keyterm:InChrist`); Favor (ID: `keyterm:Favor`); مَرْقسَ (ID: `person:Mark`); Spirit (ID: `keyterm:Spirit.2`)
