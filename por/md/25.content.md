...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); rebel (ID: `keyterm:Rebel`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); strength (ID: `keyterm:Strength`); love (ID: `keyterm:Love`); Judá (ID: `person:Judah.4`); Israel (ID: `person:Israel`); defilement (ID: `keyterm:Defilement`); appointed feast (ID: `keyterm:AppointedFeast`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Mighty One (ID: `keyterm:MightyOne`); To Sin (ID: `keyterm:Sin`); work (ID: `keyterm:Work`); Deceit (ID: `keyterm:Deceit`); Train (ID: `realia:Train`); Winepress (ID: `realia:Winepress`); Grass (ID: `flora:Grass`); Yoke (ID: `realia:Yoke`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Casting Net (ID: `realia:CastingNet`); Net (ID: `realia:Net`); Deer (ID: `fauna:Deer`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); To Sin (ID: `keyterm:Sin`); defilement (ID: `keyterm:Defilement`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); horn (ID: `keyterm:Horn`); Jerusalém (ID: `place:Jerusalem`); Bow (ID: `realia:Bow`); Tent (ID: `realia:Tent`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** appointed feast (ID: `keyterm:AppointedFeast`); SENHOR (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); House (ID: `realia:House`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Edom (ID: `place:Edom`); To Sin (ID: `keyterm:Sin`); Uz (ID: `place:Uz`); stain (ID: `keyterm:Stain`); Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); defilement (ID: `keyterm:Defilement`); Punishment (ID: `keyterm:Punishment`); be kindly disposed (ID: `keyterm:KindlyDisposed`); anointed (ID: `keyterm:Anointed`); Believe In (ID: `keyterm:BelieveIn`); Sodoma (ID: `place:Sodom`); Ostrich (ID: `fauna:Ostrich`); Jackal (ID: `fauna:Jackal`); Purple Cloth (ID: `realia:PurpleCloth`); Vulture (ID: `fauna:Vulture`); Clay Jar (ID: `realia:ClayJar`)
...
* **Associated ACAI Concepts:** Edom (ID: `place:Edom`); Uz (ID: `place:Uz`); Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); To Sin (ID: `keyterm:Sin`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); Edom (ID: `place:Edom`); To Sin (ID: `keyterm:Sin`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Jerusalém (ID: `place:Jerusalem`); Woe (ID: `keyterm:Woe`); round dance (ID: `keyterm:RoundDance`); Judá (ID: `person:Judah.4`); to cause to possess (ID: `keyterm:Possess`); Judá (ID: `group:Judah`); ardour (ID: `keyterm:Ardour`); Egito (ID: `place:Egypt`); Assyria (ID: `place:Assyria`); Hand-Mill (ID: `realia:Hand-mill`); Crown (ID: `realia:Crown`); Jackal (ID: `fauna:Jackal`); House (ID: `realia:House`); Money (ID: `realia:Money`)
