...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); إِلَى (ID: `person:Apphia`); إِلَى (ID: `person:Philemon`); لِأَرْخِبّسَ (ID: `person:Archippus`); Make Peace (ID: `keyterm:Peace`); Beloved (ID: `keyterm:Beloved`); بولسَ (ID: `person:Paul`); Church (ID: `keyterm:Church`); ٱلرَّبِّ (ID: `deity:Lord`); Favor (ID: `keyterm:Favor`); تِيموثَاوس (ID: `person:Timothy`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Holy (ID: `keyterm:Holy`); Believe (ID: `keyterm:Believe`); يَسوع (ID: `person:Jesus.2`); Good (ID: `keyterm:Good`); Pray (ID: `keyterm:Pray`); Affection (ID: `keyterm:Affection`); ٱلرَّبِّ (ID: `deity:Lord`); Fellowship (ID: `keyterm:Fellowship`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Ask for (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Love (ID: `keyterm:Love`); بولسَ (ID: `person:Paul`); In Christ (ID: `keyterm:InChrist`); Ask for (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); لوقَا (ID: `person:Luke`); دِيمَاس (ID: `person:Demas`); أَبَفْرَاسَ (ID: `person:Epaphras`); Spirit (ID: `keyterm:Spirit.2`); مَرْقسَ (ID: `person:Mark`); Favor (ID: `keyterm:Favor`); أَرِسْتَرْخسَ (ID: `person:Aristarchus`); In Christ (ID: `keyterm:InChrist`)
