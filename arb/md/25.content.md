...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); Rebel (ID: `keyterm:Rebel`); Strength (ID: `keyterm:Strength`); يَهوذَا (ID: `person:Judah.4`); Love (ID: `keyterm:Love`); يَهوذَا (ID: `group:Judah`); To Sin (ID: `keyterm:Sin`); إِسْرَائِيلَ (ID: `person:Israel`); Defilement (ID: `keyterm:Defilement`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Appointed Feast (ID: `keyterm:AppointedFeast`); Work (ID: `keyterm:Work`); Deceit (ID: `keyterm:Deceit`); Mighty One (ID: `keyterm:MightyOne`); Train (ID: `realia:Train`); Grass (ID: `flora:Grass`); Deer (ID: `fauna:Deer`); Casting Net (ID: `realia:CastingNet`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Net (ID: `realia:Net`); Goat (ID: `fauna:Goat`); Yoke (ID: `realia:Yoke`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); To Sin (ID: `keyterm:Sin`); Defilement (ID: `keyterm:Defilement`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); Mighty One (ID: `keyterm:MightyOne`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Appointed Feast (ID: `keyterm:AppointedFeast`); يَهوذَا (ID: `person:Judah.4`); Horn (ID: `keyterm:Horn`); يَهوذَا (ID: `group:Judah`); Sheep (ID: `fauna:Lamb`); Have a Vision (ID: `keyterm:HaveAVision`); Sabbath (ID: `keyterm:Sabbath`); Utterance (ID: `keyterm:Utterance`); Gentiles (ID: `group:Gentile`); To Dishonor (ID: `keyterm:Dishonor`); Passion (ID: `keyterm:Ardour`); Instruction (ID: `keyterm:Instruction`); Measuring Reed (ID: `realia:MeasuringReed`); Grain (ID: `flora:Grain`); Wine (ID: `realia:Wine`); Tent (ID: `realia:Tent`); Sackcloth (ID: `realia:Sackcloth`); Temple Altar (ID: `realia:TempleAltar`); House (ID: `realia:House`); Bow (ID: `realia:Bow`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Horn (ID: `keyterm:Horn`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Bow (ID: `realia:Bow`); Tent (ID: `realia:Tent`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Appointed Feast (ID: `keyterm:AppointedFeast`); ٱلرَّبِّ (ID: `deity:Lord`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Wormwood (ID: `flora:Wormwood`); Arrow (ID: `realia:Arrow`); Kindness (ID: `keyterm:Kindness`); Arrow (ID: `keyterm:Arrow`); Complete (ID: `keyterm:Complete`); Peace (ID: `keyterm:IntactState`); Bear (ID: `fauna:Bear`); Hewn Stone (ID: `realia:HewnStone`); Lion (ID: `fauna:Lion`); Bow (ID: `realia:Bow`); Bitter Herbs (ID: `flora:Chicory`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); To Sin (ID: `keyterm:Sin`); Redeem (ID: `keyterm:Redeem`); Rebel (ID: `keyterm:Rebel`); Salvation (ID: `keyterm:Salvation`); Peace (ID: `keyterm:IntactState`); Forgive (ID: `keyterm:Forgive`); Hope (ID: `keyterm:Hope`); Fear (ID: `keyterm:Fear`); Arrow (ID: `keyterm:Arrow`); Complete (ID: `keyterm:Complete`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Arrow (ID: `realia:Arrow`); Wormwood (ID: `flora:Wormwood`); Pit (ID: `realia:Pit`); Hewn Stone (ID: `realia:HewnStone`); Bitter Herbs (ID: `flora:Chicory`); Bear (ID: `fauna:Bear`); Lion (ID: `fauna:Lion`); Bow (ID: `realia:Bow`); Yoke (ID: `realia:Yoke`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); أَدومَ (ID: `place:Edom`); عوصًا (ID: `place:Uz`); Defile (ID: `keyterm:Stain`); Appoint (ID: `keyterm:Appoint`); Anointed (ID: `keyterm:Anointed`); سَدومَ (ID: `place:Sodom`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Believe In (ID: `keyterm:BelieveIn`); Defilement (ID: `keyterm:Defilement`); Punishment (ID: `keyterm:Punishment`); Complete (ID: `keyterm:Complete`); Jackal (ID: `fauna:Jackal`); Ostrich (ID: `fauna:Ostrich`); Vulture (ID: `fauna:Vulture`); Purple Cloth (ID: `realia:PurpleCloth`); Clay Jar (ID: `realia:ClayJar`)
...
* **Associated ACAI Concepts:** أَدومَ (ID: `place:Edom`); عوصًا (ID: `place:Uz`); Appoint (ID: `keyterm:Appoint`); To Sin (ID: `keyterm:Sin`); أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); Complete (ID: `keyterm:Complete`)
...
* **Associated ACAI Concepts:** Appoint (ID: `keyterm:Appoint`); To Sin (ID: `keyterm:Sin`); أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); Complete (ID: `keyterm:Complete`); أَدومَ (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); To Cause to Possess (ID: `keyterm:Possess`); Woe (ID: `keyterm:Woe`); Round Dance (ID: `keyterm:RoundDance`); يَهوذَا (ID: `person:Judah.4`); Passion (ID: `keyterm:Ardour`); Assyria (ID: `place:Assyria`); مِصْرَ (ID: `place:Egypt`); Crown (ID: `realia:Crown`); Jackal (ID: `fauna:Jackal`); Hand-Mill (ID: `realia:Hand-mill`); House (ID: `realia:House`); Money (ID: `realia:Money`)
