...
* **Associated ACAI Concepts:** tahan uji (ID: `keyterm:Approved`); berbahagialah (ID: `keyterm:Happy`); kehidupan (ID: `keyterm:Life`); kasihi (ID: `keyterm:Love`); janji (ID: `keyterm:Promise`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); mencobai (ID: `keyterm:PutToTheTest`); berbahagialah (ID: `keyterm:Happy`); kekasih (ID: `keyterm:Beloved`); tahan uji (ID: `keyterm:Approved`); sia, sia (ID: `keyterm:Worthless`); suci (ID: `keyterm:Clean`); tidak dapat dicobai (ID: `keyterm:NotTempted`); kebenaran (ID: `keyterm:Truth`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); berbuat dosa (ID: `keyterm:Sin`); hati (ID: `keyterm:Heart`); yang baik (ID: `keyterm:Good`); keahlian (ID: `keyterm:Ability`); janji (ID: `keyterm:Promise`); kasihi (ID: `keyterm:Love`); hukum (ID: `keyterm:Law`); kehidupan (ID: `keyterm:Life`); keselamatan (ID: `keyterm:Salvation`); tidak dicemarkan (ID: `keyterm:Undefiled`); A Person (ID: `person:GenericPerson`); tak bernoda (ID: `keyterm:AboveCriticism`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** sia, sia (ID: `keyterm:Worthless`); suci (ID: `keyterm:Clean`); tidak dicemarkan (ID: `keyterm:Undefiled`); hati (ID: `keyterm:Heart`); tak bernoda (ID: `keyterm:AboveCriticism`); keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); tonton bulu atau muka (ID: `keyterm:Partiality`); kemuliaan (ID: `keyterm:Glory`); bimbang (ID: `keyterm:Discern`); percaya (ID: `keyterm:Believe`); Yesus (ID: `person:Jesus.2`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** kekasih (ID: `keyterm:Beloved`); kerajaan (ID: `keyterm:Kingdom`); orang pilihan (ID: `keyterm:Chosen`); kasihi (ID: `keyterm:Love`); percaya (ID: `keyterm:Believe`); keahlian (ID: `keyterm:Ability`); janji (ID: `keyterm:Promise`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); penghakiman (ID: `keyterm:Judgment`); tersandung (ID: `keyterm:Stumble`); tonton bulu atau muka (ID: `keyterm:Partiality`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`); persundalan (ID: `keyterm:Fornication`); memutuskan (ID: `keyterm:Decided`); berbuat dosa (ID: `keyterm:Sin`); pengadilan (ID: `keyterm:CourtCase`); kitab suci (ID: `keyterm:Scripture`); kasihi (ID: `keyterm:Love`); belas kasihan (ID: `keyterm:Mercy`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); A Person (ID: `person:GenericPerson`); tubuh (ID: `keyterm:Body.3`); Tuhan (ID: `deity:Lord`); Rahab (ID: `person:Rahab`); sia, sia (ID: `keyterm:Idle`); keselamatan (ID: `keyterm:Salvation`); Demons (ID: `deity:Demons`); memperdamaikan (ID: `keyterm:Peace`); Ishak (ID: `person:Isaac`); roh (ID: `keyterm:Spirit.2`); kitab suci (ID: `keyterm:Scripture`); menggenapi (ID: `keyterm:Happen`); An Angel (ID: `deity:Angel`); hampa (ID: `keyterm:Empty`)
...
* **Associated ACAI Concepts:** memperdamaikan (ID: `keyterm:Peace`); A Person (ID: `person:GenericPerson`); tubuh (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); Rahab (ID: `person:Rahab`); sia, sia (ID: `keyterm:Idle`); roh (ID: `keyterm:Spirit.2`); Ishak (ID: `person:Isaac`); kitab suci (ID: `keyterm:Scripture`); menggenapi (ID: `keyterm:Happen`); tubuh (ID: `keyterm:Body.3`); An Angel (ID: `deity:Angel`); hampa (ID: `keyterm:Empty`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Abraham (ID: `person:Abraham`); kitab suci (ID: `keyterm:Scripture`); menggenapi (ID: `keyterm:Happen`); percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Hell (ID: `place:Hell`); neraka (ID: `keyterm:Gehenna`); tubuh (ID: `keyterm:Body.3`); keahlian (ID: `keyterm:Ability`); lalim (ID: `keyterm:UnjustDeed`)
...
* **Associated ACAI Concepts:** hati (ID: `keyterm:Heart`); iri hati (ID: `keyterm:Resentment`); kebenaran (ID: `keyterm:Truth`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); tidak setia (ID: `keyterm:Unfaithful`); persahabatan (ID: `keyterm:Friendship`); roh (ID: `keyterm:Spirit.2`); Roh (ID: `deity:HolySpirit`); ingin (ID: `keyterm:LongFor`); kitab suci (ID: `keyterm:Scripture`); kebaikan (ID: `keyterm:Favor`); hati (ID: `keyterm:Heart`); membersihkan (ID: `keyterm:Cleanse.2`); Cause of Joy (ID: `keyterm:CauseOfJoy`); murni (ID: `keyterm:Pure`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** menentang (ID: `keyterm:Condemn`); hati (ID: `keyterm:Heart`); tubuh (ID: `keyterm:Body.3`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); bersaksi (ID: `keyterm:BearWitness`); Tuhan (ID: `deity:Lord`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** nama (ID: `keyterm:Name`); jemaat (ID: `keyterm:Church`); diurapi (ID: `keyterm:Anointed`); berdoa (ID: `keyterm:Pray`); Tuhan (ID: `deity:Lord`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** keselamatan (ID: `keyterm:Salvation`); mengampuni (ID: `keyterm:Forgive`); berbuat dosa (ID: `keyterm:Sin`); percaya (ID: `keyterm:Believe`); berdoa (ID: `keyterm:Pray`); Tuhan (ID: `deity:Lord`)
