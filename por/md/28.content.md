...
* **Associated ACAI Concepts:** Beeri (ID: `person:Beeri.2`); Oseias (ID: `person:Hosea`)
...
* **Associated ACAI Concepts:** Gomer (ID: `person:Gomer.2`); Diblaim (ID: `person:Diblaim`); Oseias (ID: `person:Hosea`); play the prostitute (ID: `keyterm:PlayTheProstitute`)
...
* **Associated ACAI Concepts:** Lo-Ruama (ID: `person:Lo-ruhamah`); Gomer (ID: `person:Gomer.2`); Diblaim (ID: `person:Diblaim`); Jizreel (ID: `person:Jezreel.2`); Lo-Ami (ID: `person:Lo-ammi`); play the prostitute (ID: `keyterm:PlayTheProstitute`); Flax (ID: `flora:Flax`); Vale de Jezreel (ID: `place:JezreelValley`); Oseias (ID: `person:Hosea`); Vale de Acor (ID: `place:AchorValley`); Homer (ID: `realia:Homer`); Vine (ID: `flora:Vine`); love (ID: `keyterm:Love`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jizreel (ID: `person:Jezreel.2`)
...
* **Associated ACAI Concepts:** Lo-Ruama (ID: `person:Lo-ruhamah`)
...
* **Associated ACAI Concepts:** Flax (ID: `flora:Flax`); Vale de Acor (ID: `place:AchorValley`); Vine (ID: `flora:Vine`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Vale de Acor (ID: `place:AchorValley`)
...
* **Associated ACAI Concepts:** Molten Image (ID: `realia:MoltenImage`); Styrax (ID: `flora:Styrax`); Bete-Arbel (ID: `place:Beth-arbel`); rebel (ID: `keyterm:Rebel`); Deceit (ID: `keyterm:Deceit`); Betel (ID: `place:Bethel`); defection (ID: `keyterm:Defection`); Thistle (ID: `flora:Thistle`); Salmaneser (ID: `person:Shalmaneser`); Strong Drink (ID: `realia:StrongDrink`); Admá (ID: `place:Admah`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); out of free will (ID: `keyterm:OutOfFreeWill`); Nettle (ID: `flora:Nettle`); Lily (ID: `flora:Lily`); Efraim (ID: `group:Ephraim`); Efraim (ID: `person:Ephraim`); play the prostitute (ID: `keyterm:PlayTheProstitute`); Assyria (ID: `place:Assyria`); Samaria (ID: `place:Samaria`); Appoint (ID: `keyterm:Appoint`); ardour (ID: `keyterm:Ardour`); Image (ID: `realia:Image`); Vine (ID: `flora:Vine`); love (ID: `keyterm:Love`); kindness (ID: `keyterm:Kindness`); Cattle (ID: `fauna:Bull`); Egito (ID: `place:Egypt`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Admá (ID: `place:Admah`); defection (ID: `keyterm:Defection`)
...
* **Associated ACAI Concepts:** Admá (ID: `place:Admah`)
