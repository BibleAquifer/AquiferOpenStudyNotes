...
* **Associated ACAI Concepts:** Èfratite; d'Èfrata (ID: `group:Ephrathah`); Éphrata (ID: `person:Ephrathah`); Kiljon (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Juda (ID: `group:Judah`); Machlon (ID: `person:Mahlon`); Élimélec (ID: `person:Elimelech`); Bethléhem (ID: `place:Bethlehem`); Juda (ID: `person:Judah.4`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Bethléhem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Boaz (ID: `person:Boaz`); Moab (ID: `place:Moab`); laissiez en possession (ID: `keyterm:Possess`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Léa (ID: `person:Leah`); Bethléhem (ID: `place:Bethlehem`); Rachel (ID: `person:Rachel`); Éternel (ID: `deity:Lord`); Elders (ID: `group:GenericElders`)
...
* **Associated ACAI Concepts:** Tamar (ID: `person:Tamar`); Juda (ID: `group:Judah`); Perets (ID: `person:Perez`); Juda (ID: `person:Judah.4`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); benir (ID: `keyterm:Bless`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Hetsron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Amminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Boaz (ID: `person:Boaz`); Isaï (ID: `person:Jesse`); Perets (ID: `person:Perez`); Nahshon (ID: `person:Nahshon`); David (ID: `person:David`)
