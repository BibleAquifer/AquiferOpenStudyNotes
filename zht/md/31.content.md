...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Edom (ID: `place:Edom`); Understanding (ID: `keyterm:Understanding`); Mount Esau (ID: `place:EsauMount`)
...
* **Associated ACAI Concepts:** Lot (ID: `keyterm:Lot`); Judah (ID: `person:Judah.4`); Jerusalem (ID: `place:Jerusalem`); Tribe of Judah (ID: `group:Judah`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Edomites (ID: `group:Edom`); Joseph (ID: `person:Joseph.10`); Jerusalem (ID: `place:Jerusalem`); Edom (ID: `place:Edom`); Dispossess (ID: `keyterm:Dispossess`)
...
* **Associated ACAI Concepts:** Negev (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); Canaan (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); Benjamin (ID: `person:Benjamin`); Tribe of Benjamin (ID: `group:Benjamin`); Ephraim (ID: `person:Ephraim`); Gilead (ID: `place:Gilead`); Philistia (ID: `place:Philistine`); Shephelah (ID: `place:Shephelah`); Samaria (ID: `place:Samaria`); Tribe of Ephraim (ID: `group:Ephraim`); Philistines (ID: `group:Philistine`); Jerusalem (ID: `place:Jerusalem`); Sardis (ID: `place:Sardis`); Israel (ID: `person:Israel`); Zarephath (ID: `place:Zarephath`); Mount Esau (ID: `place:EsauMount`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Negev (ID: `place:Negeb`); Mount Esau (ID: `place:EsauMount`); Dispossess (ID: `keyterm:Dispossess`); Canaan (ID: `place:Canaan`); Philistines (ID: `group:Philistine`); Shephelah (ID: `place:Shephelah`); Canaanites (ID: `group:Canaan`); Israel (ID: `person:Israel`); Tribe of Benjamin (ID: `group:Benjamin`); Ephraim (ID: `person:Ephraim`); Gilead (ID: `place:Gilead`); Zarephath (ID: `place:Zarephath`); Benjamin (ID: `person:Benjamin`); LORD (ID: `deity:Lord`); Philistia (ID: `place:Philistine`); Sardis (ID: `place:Sardis`); Samaria (ID: `place:Samaria`); Tribe of Ephraim (ID: `group:Ephraim`)
...
* **Associated ACAI Concepts:** Canaan (ID: `place:Canaan`); Jerusalem (ID: `place:Jerusalem`); Sardis (ID: `place:Sardis`); Canaanites (ID: `group:Canaan`); Zarephath (ID: `place:Zarephath`); Israel (ID: `person:Israel`); Negev (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`)
