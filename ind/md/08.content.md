...
* **Associated ACAI Concepts:** Mahlon (ID: `person:Chilion`); Efrata (ID: `person:Ephrathah`); Ephrathites (ID: `group:Ephrathah`); Naomi (ID: `person:Naomi`); Elimelekh (ID: `person:Elimelech`); Yehuda (ID: `person:Judah.4`); Yehuda (ID: `group:Judah`); Betlehem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Mahlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** kebaikan (ID: `keyterm:Favor`); Rut (ID: `person:Ruth`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** kebaikan (ID: `keyterm:Kindness`); memberkati (ID: `keyterm:Bless`); Tuhan (ID: `deity:Lord`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Betlehem (ID: `place:Bethlehem`); Tuhan (ID: `deity:Lord`); Israel (ID: `person:Israel`); Lea (ID: `person:Leah`); Elders (ID: `group:GenericElders`); Rahel (ID: `person:Rachel`)
...
* **Associated ACAI Concepts:** Yehuda (ID: `group:Judah`); Yehuda (ID: `person:Judah.4`); Peres (ID: `person:Perez`); Tuhan (ID: `deity:Lord`); Tamar (ID: `person:Tamar`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); memperanakkan (ID: `person:Salmon`); Obed (ID: `person:Obed`); Aminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Isai (ID: `person:Jesse`); Peres (ID: `person:Perez`); Daud (ID: `person:David`); Boas (ID: `person:Boaz`); Nahason (ID: `person:Nahshon`)
