...
* **Associated ACAI Concepts:** vérité (ID: `keyterm:Truth`); marcher (ID: `keyterm:Live.3`); bien, aimé (ID: `keyterm:Beloved`); Gaïus (ID: `person:Gaius.4`); témoigner (ID: `keyterm:BearWitness`); aimer (ID: `keyterm:Love`); Cause of Joy (ID: `keyterm:CauseOfJoy`); prier (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** témoigner (ID: `keyterm:BearWitness`); Éternel (ID: `deity:Lord`); bien, aimé (ID: `keyterm:Beloved`); vérité (ID: `keyterm:Truth`); aimer (ID: `keyterm:Love`); fidelité (ID: `keyterm:Faithfulness`); nom (ID: `keyterm:Name`); église (ID: `keyterm:Church`); sois obligé (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** église (ID: `keyterm:Church`); Démétrius (ID: `person:Demetrius`); Diotrèphe (ID: `person:Diotrephes`); témoigner (ID: `keyterm:BearWitness`); Éternel (ID: `deity:Lord`); bien, aimé (ID: `keyterm:Beloved`); vérité (ID: `keyterm:Truth`); vrai (ID: `keyterm:True`); faire du bien (ID: `keyterm:DoGood`); le bien (ID: `keyterm:Good`)
