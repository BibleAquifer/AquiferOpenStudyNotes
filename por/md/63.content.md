...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); escolhido (ID: `keyterm:Chosen`); favor (ID: `keyterm:Favor`); misericórdia (ID: `keyterm:Mercy`); para a eternidade (ID: `keyterm:Always`); Jesus (ID: `person:Jesus.2`); fazer a paz (ID: `keyterm:Peace`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); favor (ID: `keyterm:Favor`); misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`); fazer a paz (ID: `keyterm:Peace`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`); andar (ID: `keyterm:Live.3`); SENHOR (ID: `deity:Lord`); compartilhar (ID: `keyterm:Share`); rogar (ID: `keyterm:AskFor`); corpo (ID: `keyterm:Body.3`); Ability (ID: `keyterm:Ability`); Truth (ID: `keyterm:Truth`); House (ID: `realia:House`)
