...
* **Associated ACAI Concepts:** kebenaran (ID: `keyterm:Truth`); kekasih (ID: `keyterm:Beloved`); hidup (ID: `keyterm:Live.3`); Gayus (ID: `person:Gaius.4`); Cause of Joy (ID: `keyterm:CauseOfJoy`); berdoa (ID: `keyterm:Pray`); bersaksi (ID: `keyterm:BearWitness`); kasihi (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** kekasih (ID: `keyterm:Beloved`); wajib (ID: `keyterm:Ought`); Tuhan (ID: `deity:Lord`); kesetiaan (ID: `keyterm:Faithfulness`); jemaat (ID: `keyterm:Church`); nama (ID: `keyterm:Name`); kebenaran (ID: `keyterm:Truth`); kasihi (ID: `keyterm:Love`); bersaksi (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** jemaat (ID: `keyterm:Church`); Diotrefes (ID: `person:Diotrephes`); Demetrius (ID: `person:Demetrius`); kekasih (ID: `keyterm:Beloved`); Tuhan (ID: `deity:Lord`); benar (ID: `keyterm:True`); kebenaran (ID: `keyterm:Truth`); yang baik (ID: `keyterm:Good`); lakukan baik (ID: `keyterm:DoGood`); bersaksi (ID: `keyterm:BearWitness`)
