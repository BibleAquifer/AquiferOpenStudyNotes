...
* **Associated ACAI Concepts:** Efrata (ID: `person:Ephrathah`); Mahlon (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Ephrathites (ID: `group:Ephrathah`); Moab (ID: `place:Moab`); Mahlon (ID: `person:Mahlon`); Yehuda (ID: `person:Judah.4`); Betlehem (ID: `place:Bethlehem`); Elimelekh (ID: `person:Elimelech`); Yehuda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); Tuhan (ID: `deity:Lord`); kebaikan (ID: `keyterm:Kindness`); memberkati (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Rahel (ID: `person:Rachel`); Tuhan (ID: `deity:Lord`); Lea (ID: `person:Leah`); Betlehem (ID: `place:Bethlehem`); Elders (ID: `group:GenericElders`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yehuda (ID: `person:Judah.4`); Peres (ID: `person:Perez`); Tamar (ID: `person:Tamar`); Yehuda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); memperanakkan (ID: `person:Salmon`); Obed (ID: `person:Obed`); Aminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Isai (ID: `person:Jesse`); Daud (ID: `person:David`); Nahason (ID: `person:Nahshon`); Peres (ID: `person:Perez`); Boas (ID: `person:Boaz`)
