...
* **Associated ACAI Concepts:** Èfratite; d'Èfrata (ID: `group:Ephrathah`); Éphrata (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Kiljon (ID: `person:Chilion`); Moab (ID: `place:Moab`); Juda (ID: `group:Judah`); Élimélec (ID: `person:Elimelech`); Juda (ID: `person:Judah.4`); Bethléhem (ID: `place:Bethlehem`); Machlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); Ruth (ID: `person:Ruth`); Bethléhem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); laissiez en possession (ID: `keyterm:Possess`); Ruth (ID: `person:Ruth`); Machlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Rachel (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); Éternel (ID: `deity:Lord`); Léa (ID: `person:Leah`); Bethléhem (ID: `place:Bethlehem`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Perets (ID: `person:Perez`); Tamar (ID: `person:Tamar`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Naomi (ID: `person:Naomi`); benir (ID: `keyterm:Bless`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Salmon (ID: `person:Salmon`); Hetsron (ID: `person:Hezron.2`); Amminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Perets (ID: `person:Perez`); Boaz (ID: `person:Boaz`); Isaï (ID: `person:Jesse`); David (ID: `person:David`); Nahshon (ID: `person:Nahshon`)
