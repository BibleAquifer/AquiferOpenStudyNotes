...
* **Associated ACAI Concepts:** Mahlon (ID: `person:Chilion`); Efrata (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Ephrathites (ID: `group:Ephrathah`); Betlehem (ID: `place:Bethlehem`); Yehuda (ID: `group:Judah`); Mahlon (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Yehuda (ID: `person:Judah.4`); Elimelekh (ID: `person:Elimelech`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Tuhan (ID: `deity:Lord`); menugaskan (ID: `keyterm:Appoint`)
...
* **Associated ACAI Concepts:** kebaikan (ID: `keyterm:Kindness`); memberkati (ID: `keyterm:Bless`); Naomi (ID: `person:Naomi`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Rut (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); menyebabkan memiliki (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Boas (ID: `person:Boaz`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Betlehem (ID: `place:Bethlehem`); Elders (ID: `group:GenericElders`); Tuhan (ID: `deity:Lord`); Rahel (ID: `person:Rachel`); Lea (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); memperanakkan (ID: `person:Salmon`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Nahason (ID: `person:Nahshon`); Peres (ID: `person:Perez`); Daud (ID: `person:David`); Boas (ID: `person:Boaz`); Isai (ID: `person:Jesse`)
