...
* **Associated ACAI Concepts:** Perse (ID: `place:Persia`); Cyrus (ID: `person:Cyrus`); parole du seigneur (ID: `keyterm:WordOfTheLord`); Jérémie (ID: `person:Jeremiah.6`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Cyrus (ID: `person:Cyrus`); Perse (ID: `place:Persia`); Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `person:Judah.4`); House (ID: `realia:House`); parole du seigneur (ID: `keyterm:WordOfTheLord`); Jérémie (ID: `person:Jeremiah.6`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Cyrus (ID: `person:Cyrus`); Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); Perse (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Juda (ID: `group:Judah`); Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Lévi (ID: `person:Levi.3`); Benjamin (ID: `person:Benjamin`); Juda (ID: `group:Judah`); Benjamin (ID: `group:Benjamin`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); Lévi (ID: `group:Levi`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Nebucadnetsar (ID: `person:Nebuchadnezzar`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); Cyrus (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mithredath (ID: `person:Mithredath`); Juda (ID: `group:Judah`); Zorobabel (ID: `person:Zerubbabel.2`); Juda (ID: `person:Judah.4`); Perse (ID: `place:Persia`); Cyrus (ID: `person:Cyrus`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Élam (ID: `person:Elam`); Salomon (ID: `person:Solomon`); Jérusalem (ID: `place:Jerusalem`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`); Bébaï (ID: `person:Bebai`); Hakkots (ID: `person:Hakkoz.2`); Pareosch (ID: `person:Parosh`); Bakbuk (ID: `person:Bakbuk`); Nephushesim (ID: `group:Nephushesim`); Nekoda (ID: `person:Nekoda.2`); Kéros (ID: `person:Keros`); Pokéreth-Hatsebaïm (ID: `person:Pochereth-hazzebaim`); Shalmai (ID: `person:Shalmai`); Siaha (ID: `person:Siaha`); Josué (ID: `person:Jeshua.3`); Thel-Mélach (ID: `place:Tel-melah`); Bilschan (ID: `person:Bilshan`); Batsluth (ID: `person:Bazluth`); Nethopha (ID: `place:Netophah`); Jaala (ID: `person:Jaalah`); Rehum (ID: `person:Rehum`); Bigvaï (ID: `person:Bigvai`); Mispar (ID: `person:Mispar`); Bigvaï (ID: `person:Bigvai.2`); Shephatiah (ID: `person:Shephatiah.7`); Harim (ID: `person:Harim`); Hanan (ID: `person:Hanan.4`); Reélaja (ID: `person:Reelaiah`)
...
* **Associated ACAI Concepts:** Rehum (ID: `person:Rehum`); Bilschan (ID: `person:Bilshan`); Reélaja (ID: `person:Reelaiah`); Mardochée (ID: `person:Mordecai`); Bigvaï (ID: `person:Bigvai`); Mispar (ID: `person:Mispar`); Seraja (ID: `person:Seraiah.6`); Néhémie (ID: `person:Nehemiah`); Baana (ID: `person:Baanah.3`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Haschum (ID: `person:Hashum`); Bébaï (ID: `person:Bebai`); Pareosch (ID: `person:Parosh`); Zatthu (ID: `person:Zattu.2`); Arach (ID: `person:Arah.2`); Ézéchias (ID: `person:Hezekiah.2`); Élam (ID: `person:Elam`); Adin (ID: `person:Adin`); Joab (ID: `person:Joab.3`); Josué (ID: `person:Jeshua.3`); Bani (ID: `person:Bani`); Zaccaï (ID: `person:Zaccai.2`); Ather (ID: `person:Ater`); Jora (ID: `person:Jorah`); Shefatya (ID: `person:Shephatiah.6`); Azgad (ID: `person:Azgad`); Adonikam (ID: `person:Adonikam`); Bigvaï (ID: `person:Bigvai.2`); Betsaï (ID: `person:Bezai`); Pachath-Moab (ID: `person:Pahath-moab`); Gabaon (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Beth-azmaveth (ID: `place:Beth-azmaveth`); Hadid (ID: `place:Hadid`); Magbisch (ID: `place:Magbish`); Nebo (ID: `place:Nebo.2`); Nethopha (ID: `place:Netophah`); Harim (ID: `person:Harim.2`); Senaa (ID: `place:Senaah`); Lod (ID: `place:Lod`); Guéba (ID: `place:Geba`); Ono (ID: `place:Ono`); Élam (ID: `person:Elam`); Kirjath-Jearim (ID: `place:Kiriath-jearim`); Jéricho (ID: `place:Jericho`); Kephira (ID: `place:Chephirah`); Micmasch (ID: `place:Michmash`); Beéroth (ID: `place:Beeroth`); Aï (ID: `place:Ai`); Anathoth (ID: `place:Anathoth`); Ramah (ID: `place:Ramah.2`); Bethléhem (ID: `place:Bethlehem`); Bethel (ID: `place:Bethel`)
...
* **Associated ACAI Concepts:** Immer (ID: `person:Immer.2`); Thalmon (ID: `person:Talmon`); Harim (ID: `person:Harim`); Hodavia (ID: `person:Hodaviah.4`); Josué (ID: `person:Jeshua`); Schobaï (ID: `person:Shobai`); Josué (ID: `person:Jeshua.4`); Ather (ID: `person:Ater.2`); Hathitha (ID: `person:Hatita`); Yedaya (ID: `person:Jedaiah.4`); Paschhur (ID: `person:Pashhur`); Lévi (ID: `person:Levi.3`); Kadmiel (ID: `person:Kadmiel`); Lévi (ID: `group:Levi`); Schallum (ID: `person:Shallum.8`); Akkub (ID: `person:Akkub.2`); Asaph (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** Thalmon (ID: `person:Talmon`); Schobaï (ID: `person:Shobai`); Ather (ID: `person:Ater.2`); Hathitha (ID: `person:Hatita`); Asaph (ID: `person:Asaph.2`); Akkub (ID: `person:Akkub.2`); Schallum (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** Thabbaoth (ID: `person:Tabbaoth`); Retsin (ID: `person:Rezin.2`); Lebana (ID: `person:Lebanah`); Nekoda (ID: `person:Nekoda`); Bakbuk (ID: `person:Bakbuk`); Meunim (ID: `group:Meunim`); Sisera (ID: `person:Sisera.2`); Nephushesim (ID: `group:Nephushesim`); Barkos (ID: `person:Barkos`); Padon (ID: `person:Padon`); Bésaï (ID: `person:Besai`); Kéros (ID: `person:Keros`); Harhur (ID: `person:Harhur`); Gachar (ID: `person:Gahar`); Reaja (ID: `person:Reaiah.3`); Tsicha (ID: `person:Ziha`); Mehida (ID: `person:Mehida`); Shalmai (ID: `person:Shalmai`); Siaha (ID: `person:Siaha`); Hasupha (ID: `person:Hasupha`); Guiddel (ID: `person:Giddel`); Harscha (ID: `person:Harsha`); Netsiach (ID: `person:Neziah`); Hathipha (ID: `person:Hatipha`); Hakupha (ID: `person:Hakupha`); Batsluth (ID: `person:Bazluth`); Gazzam (ID: `person:Gazzam`); Hagaba (ID: `person:Hagabah`); Asna (ID: `person:Asnah`); Thamach (ID: `person:Temah`); Paséach (ID: `person:Paseah.2`); Akkub (ID: `person:Akkub.3`); Uzza (ID: `person:Uzza.2`); Hagab (ID: `person:Hagab`); Hanan (ID: `person:Hanan.4`)
...
* **Associated ACAI Concepts:** Salomon (ID: `person:Solomon`); Sothaï (ID: `person:Sotai`); Hatthil (ID: `person:Hattil`); Peruda (ID: `person:Peruda`); Shephatiah (ID: `person:Shephatiah.7`); Ami (ID: `person:Ami`); Sophéreth (ID: `person:Sophereth`); Darkon (ID: `person:Darkon`); Guiddel (ID: `person:Giddel.2`); Jaala (ID: `person:Jaalah`); Pokéreth-Hatsebaïm (ID: `person:Pochereth-hazzebaim`)
...
* **Associated ACAI Concepts:** Thel-Mélach (ID: `place:Tel-melah`); Addan (ID: `place:Addan`); Delaja (ID: `person:Delaiah.3`); Tobija (ID: `person:Tobiah`); Cherub (ID: `place:Cherub`); Nekoda (ID: `person:Nekoda.2`); Thel-Harscha (ID: `place:Tel-harsha`); Immer (ID: `place:Immer`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Habaja (ID: `person:Habaiah`); Hakkots (ID: `person:Hakkoz.2`); Barzillaï (ID: `person:Barzillai.3`); Barzillaï (ID: `person:Barzillai`); Galaad (ID: `place:Gilead`); souiller (ID: `keyterm:Stain`); sacerdoce (ID: `keyterm:Priesthood`); Galaadite (ID: `group:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); force (ID: `keyterm:Strength`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); Mina (ID: `realia:Mina`); House (ID: `realia:House`); Tunic (ID: `realia:Tunic`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); offrande (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`); Josué (ID: `person:Joshua.5`); Perse (ID: `place:Persia`); Cyrus (ID: `person:Cyrus`); Schealthiel (ID: `person:Shealtiel.2`); Jehozadak (ID: `person:Jehozadak`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Relatives (ID: `group:Relatives`); Hodavia (ID: `person:Hodaviah.4`); Asarhaddôn (ID: `person:Esarhaddon`); Kadmiel (ID: `person:Kadmiel`); Josué (ID: `person:Jeshua.4`); Hénadad (ID: `person:Henadad`); Joppa (ID: `place:Joppa`); Tyr (ID: `place:Tyre`); bonté (ID: `keyterm:Kindness`); fête déterminée (ID: `keyterm:AppointedFeast`); Liban (ID: `place:Lebanon`); néoménies (ID: `keyterm:NewMoonFestival`); Assyria (ID: `place:Assyria`); Instruction (ID: `keyterm:Instruction`); Sidonien (ID: `group:Sidon`); avis (ID: `keyterm:Counsel`); Sidon (ID: `place:Sidon`); Darius (ID: `person:Darius.2`); terreur (ID: `keyterm:Terror`); Asaph (ID: `person:Asaph.2`); Moïse (ID: `person:Moses`); David (ID: `person:David`); Hodija (ID: `person:Hodiah.2`); saint (ID: `keyterm:Holy`); Benjamin (ID: `person:Benjamin`); fourré (ID: `keyterm:FeastOfTabernacles`); Tyrien (ID: `group:Tyre`); Benjamin (ID: `group:Benjamin`); Trumpet (ID: `realia:Trumpet`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Cymbals (ID: `realia:Cymbals`); Craftsman (ID: `realia:Craftsman`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Schealthiel (ID: `person:Shealtiel.2`); Jehozadak (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); offrande (ID: `keyterm:Offering`); Moïse (ID: `person:Moses`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Schealthiel (ID: `person:Shealtiel.2`); Lévi (ID: `person:Levi.3`); Jehozadak (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); Lévi (ID: `group:Levi`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); Lévi (ID: `person:Levi.3`); bonté (ID: `keyterm:Kindness`); Lévi (ID: `group:Levi`); David (ID: `person:David`); Asaph (ID: `person:Asaph.2`); Trumpet (ID: `realia:Trumpet`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** Benjamin (ID: `person:Benjamin`); Juda (ID: `group:Judah`); Israël (ID: `person:Israel`); Benjamin (ID: `group:Benjamin`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); Perse (ID: `place:Persia`); Cyrus (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Euphrate (ID: `place:Euphrates`); Jérusalem (ID: `place:Jerusalem`); Schimschaï (ID: `person:Shimshai`); Rehum (ID: `person:Rehum.2`); Artaxerxès (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Perse (ID: `place:Persia`); Samarie (ID: `place:Samaria`); Bischlam (ID: `person:Bishlam`); Babylonien (ID: `group:Babylon`); Assuérus (ID: `person:Ahasuerus`); Osnappar (ID: `person:Osnappar`); Mithredath (ID: `person:Mithredath.2`); Thabeel (ID: `person:Tabeel`); Dinaite (ID: `person:Dinaite`); Érec (ID: `place:Erech`); Almôn-Divlataïm (ID: `group:Elam`); Élam (ID: `place:Elam`); Perse (ID: `group:Persia`); Suse (ID: `place:Susa`); Juda (ID: `group:Judah`); Babylone (ID: `place:Babylon`); Juda (ID: `person:Judah.4`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Bischlam (ID: `person:Bishlam`); Mithredath (ID: `person:Mithredath.2`); Thabeel (ID: `person:Tabeel`); Perse (ID: `place:Persia`); Artaxerxès (ID: `person:Artaxerxes.2`)
...
* **Associated ACAI Concepts:** Babylonien (ID: `group:Babylon`); Rehum (ID: `person:Rehum.2`); Schimschaï (ID: `person:Shimshai`); Dinaite (ID: `person:Dinaite`); Érec (ID: `place:Erech`); Almôn-Divlataïm (ID: `group:Elam`); Babylone (ID: `place:Babylon`); Suse (ID: `place:Susa`); Perse (ID: `group:Persia`); Perse (ID: `place:Persia`); Élam (ID: `place:Elam`)
...
* **Associated ACAI Concepts:** Euphrate (ID: `place:Euphrates`); Jérusalem (ID: `place:Jerusalem`); Samarie (ID: `place:Samaria`); Rehum (ID: `person:Rehum.2`); Jews (ID: `group:Jews`); Schimschaï (ID: `person:Shimshai`); Artaxerxès (ID: `person:Artaxerxes.2`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Rehum (ID: `person:Rehum.2`); Schimschaï (ID: `person:Shimshai`); Jews (ID: `group:Jews`); Jérusalem (ID: `place:Jerusalem`); Artaxerxès (ID: `person:Artaxerxes.2`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); Darius (ID: `person:Darius.2`); Iddo (ID: `person:Iddo.6`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Zacharie (ID: `person:Zechariah.17`); Aggée (ID: `person:Haggai`); Thathnaï (ID: `person:Tattenai`); Josué (ID: `person:Joshua.5`); Schealthiel (ID: `person:Shealtiel.2`); Jehozadak (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Euphrate (ID: `place:Euphrates`); Israël (ID: `person:Israel`); Juda (ID: `person:Judah.4`); Perse (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Iddo (ID: `person:Iddo.6`); Zacharie (ID: `person:Zechariah.17`); Aggée (ID: `person:Haggai`); Jews (ID: `group:Jews`); Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Schealthiel (ID: `person:Shealtiel.2`); Jehozadak (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Babylone (ID: `place:Babylon`); Jérusalem (ID: `place:Jerusalem`); Cyrus (ID: `person:Cyrus`); Nebucadnetsar (ID: `person:Nebuchadnezzar`); Zorobabel (ID: `person:Zerubbabel.2`); Darius (ID: `person:Darius.2`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Thathnaï (ID: `person:Tattenai`); Chaldée (ID: `place:Chaldea`); Chaldéens (ID: `group:Chaldea`); Israël (ID: `person:Israel`); Euphrate (ID: `place:Euphrates`); Juda (ID: `person:Judah.4`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Nebucadnetsar (ID: `person:Nebuchadnezzar`); Babylone (ID: `place:Babylon`); Cyrus (ID: `person:Cyrus`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** offrande (ID: `keyterm:Offering`); Israël (ID: `person:Israel`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Lévi (ID: `person:Levi.3`); Moïse (ID: `person:Moses`); Jérusalem (ID: `place:Jerusalem`); Lévi (ID: `group:Levi`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Seraja (ID: `person:Seraiah.2`); Esdras (ID: `person:Ezra`); Azaria (ID: `person:Azariah.7`); Artaxerxès (ID: `person:Artaxerxes`); Hilkija (ID: `person:Hilkiah.2`); Perse (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Esdras (ID: `person:Ezra`); Achithub (ID: `person:Ahitub.3`); Azaria (ID: `person:Azariah.7`); Merajoth (ID: `person:Meraioth`); Seraja (ID: `person:Seraiah.2`); Bukki (ID: `person:Bukki.2`); Uzzi (ID: `person:Uzzi`); Abischua (ID: `person:Abishua`); Azaria (ID: `person:Azariah.6`); Schallum (ID: `person:Shallum.7`); Amaria (ID: `person:Amariah.2`); Zerachja (ID: `person:Zerahiah`); Tsadok (ID: `person:Zadok.4`); Phinées (ID: `person:Phinehas`); Hilkija (ID: `person:Hilkiah.2`); Aaron (ID: `person:Aaron`); Perse (ID: `place:Persia`); Artaxerxès (ID: `person:Artaxerxes`); Éléazar (ID: `person:Eleazar.2`)
...
* **Associated ACAI Concepts:** Esdras (ID: `person:Ezra`); Moïse (ID: `person:Moses`); Babylone (ID: `place:Babylon`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Esdras (ID: `person:Ezra`); limite (ID: `keyterm:Decree`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); Esdras (ID: `person:Ezra`); Israël (ID: `person:Israel`); Artaxerxès (ID: `person:Artaxerxes`); Euphrate (ID: `place:Euphrates`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`); limite (ID: `keyterm:Decree`); Babylone (ID: `place:Babylon`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); Wheat (ID: `flora:Wheat`); Altar (ID: `realia:Altar`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Talent (ID: `realia:Talent`); Kor (ID: `realia:Kor`); Stone Altar (ID: `realia:StoneAltar`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Artaxerxès (ID: `person:Artaxerxes`); Esdras (ID: `person:Ezra`); Euphrate (ID: `place:Euphrates`); Money (ID: `realia:Money`); Kor (ID: `realia:Kor`); Wheat (ID: `flora:Wheat`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Hakkathan (ID: `person:Hakkatan`); Athalie (ID: `person:Athaliah.3`); Bébaï (ID: `person:Bebai`); Uthaï (ID: `person:Uthai.2`); Micaël (ID: `person:Michael.10`); Éljoénaï (ID: `person:Eliehoenai.2`); Jehiel (ID: `person:Jehiel.7`); Daniel (ID: `person:Daniel.2`); Yeïel (ID: `person:Jeuel.3`); Joab (ID: `person:Joab.4`); Jonathan (ID: `person:Jonathan.9`); Abdias (ID: `person:Obadiah.10`); Élam (ID: `person:Elam`); Schecania (ID: `person:Shecaniah.5`); Adin (ID: `person:Adin`); Bébaï (ID: `person:Bebai.2`); Jochanan (ID: `person:Johanan.8`); Zerachja (ID: `person:Zerahiah.2`); Josiphia (ID: `person:Josiphiah`); Zaccur (ID: `person:Zaccur.5`); Schecania (ID: `person:Shecaniah.6`); Zacharie (ID: `person:Zechariah.18`); Ébed (ID: `person:Ebed.2`); Zevadya (ID: `person:Zebadiah.8`); Jachaziel (ID: `person:Jahaziel.5`); Ésaïe (ID: `person:Jeshaiah.4`); Zacharie (ID: `person:Zechariah.19`); Shefatya (ID: `person:Shephatiah.6`); Pareosch (ID: `person:Parosh.2`); Azgad (ID: `person:Azgad`); Schelomith (ID: `person:Shelomith.4`); Adonikam (ID: `person:Adonikam`); Guershom (ID: `person:Gershom.2`); Bigvaï (ID: `person:Bigvai.2`); Hatthusch (ID: `person:Hattush.2`); Pachath-Moab (ID: `person:Pahath-moab`); Schemaeja (ID: `person:Shemaiah.14`); Éliphéleth (ID: `person:Eliphelet.5`); Phinées (ID: `person:Phinehas`); Ithamar (ID: `person:Ithamar`); Artaxerxès (ID: `person:Artaxerxes`); David (ID: `person:David`); Babylone (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** Jarib (ID: `person:Jarib.2`); Zacharie (ID: `person:Zechariah.20`); Schemaeja (ID: `person:Shemaiah.15`); Jojarib (ID: `person:Joiarib.2`); Elnathan (ID: `person:Elnathan.2`); Casiphia (ID: `place:Casiphia`); Meschullam (ID: `person:Meshullam.9`); Nathan (ID: `person:Nathan.5`); Ariel (ID: `person:Ariel`); Iddo (ID: `person:Iddo`); Elnathan (ID: `person:Elnathan.4`); Éliézer (ID: `person:Eliezer.8`); Elnathan (ID: `person:Elnathan.3`); percevoir (ID: `keyterm:Perceive`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Schérébia (ID: `person:Sherebiah`); Lévi (ID: `person:Levi.3`); discernement (ID: `keyterm:Insight`); Israël (ID: `person:Israel`); Machli (ID: `person:Mahli`); Éternel (ID: `deity:Lord`); Lévi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** offrande (ID: `keyterm:Offering`); pécher (ID: `keyterm:Sin`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Hittite (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); Lévi (ID: `person:Levi.3`); Ammon (ID: `place:Ammon`); Égypte (ID: `place:Egypt`); Lévi (ID: `group:Levi`); Canaan (ID: `place:Canaan`); Amos (ID: `group:Ammon`); Israël (ID: `person:Israel`); Heth (ID: `person:Heth`); Moab (ID: `place:Moab`); Amorites (ID: `group:Amorites`); être infidèle (ID: `keyterm:Unfaithful`); Jébusiens (ID: `group:Jebusites`); Canaan (ID: `group:Canaan`); Mitsraïm (ID: `group:Egypt`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Esdras (ID: `person:Ezra`); être infidèle (ID: `keyterm:Unfaithful`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`); ardeur (ID: `keyterm:Ardour`); Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Harim (ID: `person:Harim`); Élam (ID: `person:Elam`); offrande (ID: `keyterm:Offering`); Juda (ID: `group:Judah`); avis (ID: `keyterm:Counsel`); Juda (ID: `person:Judah.4`); Benaja (ID: `person:Benaiah.8`); Jaddaï (ID: `person:Jaddai`); Joël (ID: `person:Joel.12`); Pareosch (ID: `person:Parosh`); Schimeï (ID: `person:Shimei.15`); Jozabad (ID: `person:Jozabad.7`); Éliaschib (ID: `person:Eliashib.5`); Jochanan (ID: `person:Jehohanan.4`); Matthattha (ID: `person:Mattattah`); Macnadbaï (ID: `person:Machnadebai`); Ismaël (ID: `person:Ishmael.6`); Schallum (ID: `person:Shallum.10`); Aziza (ID: `person:Aziza`); Malluc (ID: `person:Malluch.3`); Schemaria (ID: `person:Shemariah.4`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); ardeur (ID: `keyterm:Ardour`); Judée (ID: `place:Judea`); bonté (ID: `keyterm:Kindness`); laissiez en possession (ID: `keyterm:Possess`); état intact (ID: `keyterm:IntactState`); pollution (ID: `keyterm:Defilement`); supplication (ID: `keyterm:Supplication`); Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`); Perse (ID: `place:Persia`); déposséder (ID: `keyterm:Dispossess`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Judée (ID: `place:Judea`); Perse (ID: `place:Persia`); bonté (ID: `keyterm:Kindness`); supplication (ID: `keyterm:Supplication`); Jérusalem (ID: `place:Jerusalem`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** Schecania (ID: `person:Shecaniah.7`); Jehiel (ID: `person:Jehiel.8`); Élam (ID: `person:Elam`); Esdras (ID: `person:Ezra`); Israël (ID: `person:Israel`); être infidèle (ID: `keyterm:Unfaithful`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** avis (ID: `keyterm:Counsel`); Éternel (ID: `deity:Lord`); alliance (ID: `keyterm:Covenant`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Lévi (ID: `person:Levi.3`); Esdras (ID: `person:Ezra`); Lévi (ID: `group:Levi`); Israël (ID: `person:Israel`); jurer (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** Benjamin (ID: `person:Benjamin`); Juda (ID: `group:Judah`); Benjamin (ID: `group:Benjamin`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Thikva (ID: `person:Tikvah.2`); Asaël (ID: `person:Asahel.4`); Shabbethai (ID: `person:Shabbethai`); Meschullam (ID: `person:Meshullam.10`); Jachzia (ID: `person:Jahzeiah`); Jonathan (ID: `person:Jonathan.10`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`)
