...
* **Associated ACAI Concepts:** berbahagialah (ID: `keyterm:Happy`); tahan uji (ID: `keyterm:Approved`); kehidupan (ID: `keyterm:Life`); janji (ID: `keyterm:Promise`); kasihi (ID: `keyterm:Love`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); mencobai (ID: `keyterm:PutToTheTest`); berbahagialah (ID: `keyterm:Happy`); kekasih (ID: `keyterm:Beloved`); tahan uji (ID: `keyterm:Approved`); suci (ID: `keyterm:Clean`); sia, sia (ID: `keyterm:Worthless`); tak bernoda (ID: `keyterm:AboveCriticism`); kehidupan (ID: `keyterm:Life`); A Person (ID: `person:GenericPerson`); tidak dicemarkan (ID: `keyterm:Undefiled`); berbuat dosa (ID: `keyterm:Sin`); tidak dapat dicobai (ID: `keyterm:NotTempted`); janji (ID: `keyterm:Promise`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kasihi (ID: `keyterm:Love`); keahlian (ID: `keyterm:Ability`); kebenaran (ID: `keyterm:Truth`); keselamatan (ID: `keyterm:Salvation`); hati (ID: `keyterm:Heart`); yang baik (ID: `keyterm:Good`); hukum (ID: `keyterm:Law`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** suci (ID: `keyterm:Clean`); sia, sia (ID: `keyterm:Worthless`); tidak dicemarkan (ID: `keyterm:Undefiled`); tak bernoda (ID: `keyterm:AboveCriticism`); hati (ID: `keyterm:Heart`); Tuhan (ID: `deity:Lord`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); tonton bulu atau muka (ID: `keyterm:Partiality`); Yesus (ID: `person:Jesus.2`); bimbang (ID: `keyterm:Discern`); percaya (ID: `keyterm:Believe`); kemuliaan (ID: `keyterm:Glory`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`); Footstool (ID: `realia:Footstool`)
...
* **Associated ACAI Concepts:** janji (ID: `keyterm:Promise`); orang pilihan (ID: `keyterm:Chosen`); Tuhan (ID: `deity:Lord`); kerajaan (ID: `keyterm:Kingdom`); percaya (ID: `keyterm:Believe`); kasihi (ID: `keyterm:Love`); keahlian (ID: `keyterm:Ability`); kekasih (ID: `keyterm:Beloved`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); tonton bulu atau muka (ID: `keyterm:Partiality`); tersandung (ID: `keyterm:Stumble`); penghakiman (ID: `keyterm:Judgment`); berbuat dosa (ID: `keyterm:Sin`); kasihi (ID: `keyterm:Love`); kitab suci (ID: `keyterm:Scripture`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`); belas kasihan (ID: `keyterm:Mercy`); pengadilan (ID: `keyterm:CourtCase`); persundalan (ID: `keyterm:Fornication`); memutuskan (ID: `keyterm:Decided`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); tubuh (ID: `keyterm:Body.3`); Tuhan (ID: `deity:Lord`); A Person (ID: `person:GenericPerson`); Rahab (ID: `person:Rahab`); sia, sia (ID: `keyterm:Idle`); menggenapi (ID: `keyterm:Happen`); Demons (ID: `deity:Demons`); memperdamaikan (ID: `keyterm:Peace`); hampa (ID: `keyterm:Empty`); kitab suci (ID: `keyterm:Scripture`); An Angel (ID: `deity:Angel`); Ishak (ID: `person:Isaac`); roh (ID: `keyterm:Spirit.2`); keselamatan (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); sia, sia (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); tubuh (ID: `keyterm:Body.3`); menggenapi (ID: `keyterm:Happen`); hampa (ID: `keyterm:Empty`); kitab suci (ID: `keyterm:Scripture`); An Angel (ID: `deity:Angel`); Tuhan (ID: `deity:Lord`); Ishak (ID: `person:Isaac`); roh (ID: `keyterm:Spirit.2`)
...
* **Associated ACAI Concepts:** Abraham (ID: `person:Abraham`); menggenapi (ID: `keyterm:Happen`); kitab suci (ID: `keyterm:Scripture`); Tuhan (ID: `deity:Lord`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** tubuh (ID: `keyterm:Body.3`); Hell (ID: `place:Hell`); neraka (ID: `keyterm:Gehenna`); keahlian (ID: `keyterm:Ability`); lalim (ID: `keyterm:UnjustDeed`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); persahabatan (ID: `keyterm:Friendship`); tidak setia (ID: `keyterm:Unfaithful`); Cause of Joy (ID: `keyterm:CauseOfJoy`); membersihkan (ID: `keyterm:Cleanse.2`); murni (ID: `keyterm:Pure`); kebaikan (ID: `keyterm:Favor`); keahlian (ID: `keyterm:Ability`); Roh (ID: `deity:HolySpirit`); hati (ID: `keyterm:Heart`); kitab suci (ID: `keyterm:Scripture`); ingin (ID: `keyterm:LongFor`); roh (ID: `keyterm:Spirit.2`)
...
* **Associated ACAI Concepts:** roh (ID: `keyterm:Spirit.2`); Roh (ID: `deity:HolySpirit`); ingin (ID: `keyterm:LongFor`); kitab suci (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); membersihkan (ID: `keyterm:Cleanse.2`); murni (ID: `keyterm:Pure`); hati (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** tubuh (ID: `keyterm:Body.3`); hati (ID: `keyterm:Heart`); Tuhan (ID: `deity:Lord`); menentang (ID: `keyterm:Condemn`); bersaksi (ID: `keyterm:BearWitness`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** penyayang (ID: `keyterm:Compassionate`); Ayub (ID: `person:Job`); menyebut berbahagia (ID: `keyterm:RegardAsHappy`); penuh belas kasihan (ID: `keyterm:FullOfCompassion`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); nama (ID: `keyterm:Name`); diurapi (ID: `keyterm:Anointed`); berdoa (ID: `keyterm:Pray`); jemaat (ID: `keyterm:Church`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** berbuat dosa (ID: `keyterm:Sin`); mengampuni (ID: `keyterm:Forgive`); Tuhan (ID: `deity:Lord`); percaya (ID: `keyterm:Believe`); berdoa (ID: `keyterm:Pray`); keselamatan (ID: `keyterm:Salvation`)
