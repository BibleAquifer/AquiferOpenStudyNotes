...
* **Associated ACAI Concepts:** شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); دَارِيوسَ (ID: `person:Darius.2`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); حَجَّيِ (ID: `person:Haggai`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); حَجَّيِ (ID: `person:Haggai`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); حَجَّيِ (ID: `person:Haggai`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); ٱلرَّبِّ (ID: `deity:Lord`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); حَجَّيِ (ID: `person:Haggai`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `person:Judah.4`); Peace (ID: `keyterm:IntactState`); Fear (ID: `keyterm:Fear`); Word of the Lord (ID: `keyterm:WordOfTheLord`); يَهوذَا (ID: `group:Judah`); مِصْرَ (ID: `place:Egypt`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); حَجَّيِ (ID: `person:Haggai`); Defilement (ID: `keyterm:Defilement`); Vine (ID: `flora:Vine`); Instruction (ID: `keyterm:Instruction`); Bless (ID: `keyterm:Bless`); Holy (ID: `keyterm:Holy`); Word of the Lord (ID: `keyterm:WordOfTheLord`); دَارِيوسَ (ID: `person:Darius.2`); Olive Tree (ID: `flora:OliveTree`); Grain (ID: `flora:Grain`); Pomegranate (ID: `flora:Pomegranate`); Coriander (ID: `flora:Coriander`); Barley (ID: `flora:Barley`); Wine (ID: `realia:Wine`); Fig (ID: `flora:Fig`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Stew (ID: `realia:Stew`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** Defilement (ID: `keyterm:Defilement`); ٱلرَّبِّ (ID: `deity:Lord`); حَجَّيِ (ID: `person:Haggai`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); يَهوذَا (ID: `group:Judah`); حَجَّيِ (ID: `person:Haggai`); Horse (ID: `fauna:Horse`); Chariot (ID: `realia:Chariot`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); ٱلرَّبِّ (ID: `deity:Lord`)
