...
* **Associated ACAI Concepts:** Harbona (ID: `person:Harbona`); Bizta (ID: `person:Biztha`); Abagta (ID: `person:Abagtha`); Meumã (ID: `person:Mehuman`); Carcas (ID: `person:Carkas`); Bigtá (ID: `person:Bigtha`); Zetar (ID: `person:Zethar`); Assuero (ID: `person:Ahasuerus`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Vasti (ID: `person:Vashti`); Assuero (ID: `person:Ahasuerus`); Persians (ID: `group:Persia`); Pérsia (ID: `place:Persia`); Medes (ID: `group:Mede`); Medã (ID: `person:Medan`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Babilônia (ID: `place:Babylon`); Judá (ID: `person:Judah.4`); Jeoaquim (ID: `person:Jehoiachin`); Nabucodonozor (ID: `person:Nebuchadnezzar`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Assuero (ID: `person:Ahasuerus`); Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Agagites (ID: `group:Agag`); Hamedata (ID: `person:Hammedatha`); Agague (ID: `person:Agag.2`); Money (ID: `realia:Money`); Susã (ID: `place:Susa`); lot (ID: `keyterm:Lot`); Servants (ID: `group:GenericServants`); Lot (ID: `realia:Lot`); Talent (ID: `realia:Talent`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Assuero (ID: `person:Ahasuerus`); Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Hamã (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Zeres (ID: `person:Zeresh`); love (ID: `keyterm:Love`); Glory (ID: `keyterm:Glory`); Ester (ID: `person:Esther`); Jews (ID: `group:Jews`); A Group of People (ID: `group:GenericGroup`); Cubit (ID: `realia:Cubit`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Zeres (ID: `person:Zeresh`); Jews (ID: `group:Jews`); Mordecai (ID: `person:Mordecai.2`); A Group of People (ID: `group:GenericGroup`); love (ID: `keyterm:Love`); Hamã (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Ester (ID: `person:Esther`); Hamã (ID: `person:Haman`); Bed (ID: `realia:Bed`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** beg for mercy (ID: `keyterm:BegForMercy`); Ester (ID: `person:Esther`); Agagites (ID: `group:Agag`); Jews (ID: `group:Jews`); Agague (ID: `person:Agag.2`); Hamã (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Hamedata (ID: `person:Hammedatha`); favor (ID: `keyterm:Favor`); Agagites (ID: `group:Agag`); Jews (ID: `group:Jews`); Agague (ID: `person:Agag.2`); Hamã (ID: `person:Haman`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Arisai (ID: `person:Arisai`); Aridata (ID: `person:Aridatha`); Farmasta (ID: `person:Parmashta`); Parsandata (ID: `person:Parshandatha`); Aridai (ID: `person:Aridai`); Dalfom (ID: `person:Dalphon`); Adalia (ID: `person:Adalia`); Porata (ID: `person:Poratha`); Aspata (ID: `person:Aspatha`); Vaizata (ID: `person:Vaizatha`); Jews (ID: `group:Jews`); Hamedata (ID: `person:Hammedatha`); Hamã (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Lot (ID: `realia:Lot`); Hamedata (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); lot (ID: `keyterm:Lot`); Agague (ID: `person:Agag.2`); Mordecai (ID: `person:Mordecai.2`); Hamã (ID: `person:Haman`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Assuero (ID: `person:Ahasuerus`); peace (ID: `keyterm:IntactState`); Jews (ID: `group:Jews`); Mordecai (ID: `person:Mordecai.2`)
