...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); la connaissance (ID: `keyterm:Intention`); Jérusalem (ID: `place:Jerusalem`); stupide (ID: `keyterm:Stupid`); Éternel (ID: `deity:Lord`); Vine (ID: `flora:Vine`); pécher (ID: `keyterm:Sin`); Israël (ID: `person:Israel`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); capacité (ID: `keyterm:Ability`); Vine (ID: `flora:Vine`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** stupide (ID: `keyterm:Stupid`); capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`); craindre (ID: `keyterm:Fear`); la connaissance (ID: `keyterm:Intention`); agir par méchanceté (ID: `keyterm:ActWickedly`); pécher (ID: `keyterm:Sin`); laissiez en possession (ID: `keyterm:Possess`); Anointing Oil (ID: `realia:AnointingOil`); Cooking Pot (ID: `realia:CookingPot`); Brier (ID: `flora:Brier`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); aimer (ID: `keyterm:Love`); capacité (ID: `keyterm:Ability`); adjuration (ID: `keyterm:Oath`); ardeur (ID: `keyterm:Ardour`); la connaissance (ID: `keyterm:Intention`); securité (ID: `keyterm:Safety`); sans saleté (ID: `keyterm:Pure`); force (ID: `keyterm:Strength`); grâce (ID: `keyterm:Favor`); jurer (ID: `keyterm:Swear`); pollution (ID: `keyterm:Defilement`); pécher (ID: `keyterm:Sin`); Hell (ID: `place:Hell`); percevoir (ID: `keyterm:Perceive`); Dog (ID: `fauna:Dog`); Net (ID: `realia:Net`); Lion (ID: `fauna:Lion`); Anointing Oil (ID: `realia:AnointingOil`); Vine (ID: `flora:Vine`); Fish (ID: `fauna:Fish`); Wine (ID: `realia:Wine`); Bird (ID: `fauna:Bird`); Olive Oil (ID: `realia:OliveOil`); Fishnet (ID: `realia:Fishnet`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** pollution (ID: `keyterm:Defilement`); adjuration (ID: `keyterm:Oath`); pécher (ID: `keyterm:Sin`); jurer (ID: `keyterm:Swear`); sans saleté (ID: `keyterm:Pure`)
...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); la connaissance (ID: `keyterm:Intention`); force (ID: `keyterm:Strength`); Hell (ID: `place:Hell`); Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); Anointing Oil (ID: `realia:AnointingOil`); Wine (ID: `realia:Wine`); Olive Oil (ID: `realia:OliveOil`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); pécher (ID: `keyterm:Sin`); gloire (ID: `keyterm:Glory`); Anointing Oil (ID: `realia:AnointingOil`); Fly (ID: `fauna:Fly`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** stupide (ID: `keyterm:Stupid`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Bed (ID: `realia:Bed`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); craindre (ID: `keyterm:Fear`); Éternel (ID: `deity:Lord`); Caper (ID: `flora:Caper`); Locust (ID: `fauna:Locust`); Almond (ID: `flora:Almond`); Bird (ID: `fauna:Bird`); Clay Jar (ID: `realia:ClayJar`); Pit (ID: `realia:Pit`); Money (ID: `realia:Money`); Rope (ID: `realia:Rope`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); la connaissance (ID: `keyterm:Intention`); droiture (ID: `keyterm:Straightness`); proverbe (ID: `keyterm:Saying`); vérité (ID: `keyterm:Truth`); Goad (ID: `realia:Goad`); Sheep (ID: `fauna:Lamb`); Nail (ID: `realia:Nail`); Scroll (ID: `realia:Scroll`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
