...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Arquipo (ID: `person:Archippus`); Áfia (ID: `person:Apphia`); Filemom (ID: `person:Philemon`); Paulo (ID: `person:Paul`); amado (ID: `keyterm:Beloved`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); fazer a paz (ID: `keyterm:Peace`); Timóteo (ID: `person:Timothy`); igreja (ID: `keyterm:Church`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); holy (ID: `keyterm:Holy`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); SENHOR (ID: `deity:Lord`); comunhão (ID: `keyterm:Fellowship`); Cause of Joy (ID: `keyterm:CauseOfJoy`); compaixão (ID: `keyterm:Affection`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Demas (ID: `person:Demas`); Epafras (ID: `person:Epaphras`); Lucas (ID: `person:Luke`); em cristo (ID: `keyterm:InChrist`); Marcos (ID: `person:Mark`); Aristarco (ID: `person:Aristarchus`); favor (ID: `keyterm:Favor`); Spirit (ID: `keyterm:Spirit.2`)
