...
* **Associated ACAI Concepts:** Ephrata (ID: `person:Ephrathah`); Noemi (ID: `person:Naomi`); Efratita (ID: `group:Ephrathah`); Chelión (ID: `person:Chilion`); Moab (ID: `place:Moab`); Mahalón (ID: `person:Mahlon`); Catah (ID: `place:Bethlehem`); Elimelech (ID: `person:Elimelech`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** bondad (ID: `keyterm:Kindness`); Jehová (ID: `deity:Lord`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); Catah (ID: `place:Bethlehem`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); favor (ID: `keyterm:Favor`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** bendecir (ID: `keyterm:Bless`); bondad (ID: `keyterm:Kindness`); Jehová (ID: `deity:Lord`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Mahalón (ID: `person:Mahlon`); dejar en herencia (ID: `keyterm:Possess`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elders (ID: `group:GenericElders`); Jehová (ID: `deity:Lord`); Catah (ID: `place:Bethlehem`); Rachêl (ID: `person:Rachel`); Lea (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Thamar (ID: `person:Tamar`); Jehová (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Phares (ID: `person:Perez`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Israel (ID: `person:Israel`); Jehová (ID: `deity:Lord`); Noemi (ID: `person:Naomi`); bendecir (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Hesrón (ID: `person:Hezron.2`); Salmón (ID: `person:Salmon`); Obed (ID: `person:Obed`); Aminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); David (ID: `person:David`); Isaí (ID: `person:Jesse`); Phares (ID: `person:Perez`); Nahasón (ID: `person:Nahshon`); Booz (ID: `person:Boaz`)
