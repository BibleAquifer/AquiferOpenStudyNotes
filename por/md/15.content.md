...
* **Associated ACAI Concepts:** Pérsia (ID: `place:Persia`); Ciro (ID: `person:Cyrus`); Jeremias (ID: `person:Jeremiah.6`); Word of the Lord (ID: `keyterm:WordOfTheLord`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Pérsia (ID: `place:Persia`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Jeremias (ID: `person:Jeremiah.6`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Levi (ID: `group:Levi`); Judá (ID: `group:Judah`); Benjamim (ID: `person:Benjamin`); Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `group:Benjamin`); House (ID: `realia:House`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Pérsia (ID: `place:Persia`); Judá (ID: `person:Judah.4`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `group:Judah`); Ciro (ID: `person:Cyrus`)
...
* **Associated ACAI Concepts:** Money (ID: `realia:Money`); Zorobabel (ID: `person:Zerubbabel.2`); Jerusalém (ID: `place:Jerusalem`); Babilônia (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Salomão (ID: `person:Solomon`); Jerusalém (ID: `place:Jerusalem`); Gazão (ID: `person:Gazzam`); Habaiah (ID: `person:Habaiah`); Tel-Melá (ID: `place:Tel-melah`); Ater (ID: `person:Ater`); Padom (ID: `person:Padon`); Mordecai (ID: `person:Mordecai`); Barcos (ID: `person:Barkos`); Adã (ID: `place:Addan`); Ará (ID: `person:Arah.2`); Ezequias (ID: `person:Hezekiah.2`); Gaar (ID: `person:Gahar`); Netofa (ID: `place:Netophah`); Baquebuque (ID: `person:Bakbuk`); Sia (ID: `person:Siaha`); Hacufa (ID: `person:Hakupha`); Hanã (ID: `person:Hanan.4`); Tel-Harsa (ID: `place:Tel-harsha`); Magbis (ID: `place:Magbish`); Acube (ID: `person:Akkub.3`); Temá (ID: `person:Temah`); Hatifa (ID: `person:Hatipha`); Bilsã (ID: `person:Bilshan`); Hatil (ID: `person:Hattil`); Necoda (ID: `person:Nekoda`)
...
* **Associated ACAI Concepts:** Bilsã (ID: `person:Bilshan`); Reelaías (ID: `person:Reelaiah`); Reum (ID: `person:Rehum`); Seraias (ID: `person:Seraiah.6`); Mispar (ID: `person:Mispar`); Bigvai (ID: `person:Bigvai`); Neemias (ID: `person:Nehemiah`); Mordecai (ID: `person:Mordecai`); Baana (ID: `person:Baanah.3`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Adim (ID: `person:Adin`); Bezai (ID: `person:Bezai`); Parós (ID: `person:Parosh`); Ater (ID: `person:Ater`); Elam (ID: `person:Elam`); Zacai (ID: `person:Zaccai.2`); Ará (ID: `person:Arah.2`); Ezequias (ID: `person:Hezekiah.2`); Joabe (ID: `person:Joab.3`); Jesua (ID: `person:Jeshua.3`); Bebai (ID: `person:Bebai`); Paate-Moabe (ID: `person:Pahath-moab`); Bani (ID: `person:Bani`); Hasum (ID: `person:Hashum`); Jora (ID: `person:Jorah`); Sephatias (ID: `person:Shephatiah.6`); Asgade (ID: `person:Azgad`); Zatu (ID: `person:Zattu.2`); Adonicão (ID: `person:Adonikam`); Bigvai (ID: `person:Bigvai.2`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Beth-azmaveth (ID: `place:Beth-azmaveth`); Netofa (ID: `place:Netophah`); Nebo (ID: `place:Nebo.2`); Senaa (ID: `place:Senaah`); Hadide (ID: `place:Hadid`); Magbis (ID: `place:Magbish`); Harim (ID: `person:Harim.2`); Ramah (ID: `place:Ramah.2`); Beerote (ID: `place:Beeroth`); Micmás (ID: `place:Michmash`); Elam (ID: `person:Elam`); Lode (ID: `place:Lod`); Ai (ID: `place:Ai`); Ono (ID: `place:Ono`); Quiriate-Jearim (ID: `place:Kiriath-jearim`); Cefira (ID: `place:Chephirah`); Belém (ID: `place:Bethlehem`); Betel (ID: `place:Bethel`); Geba (ID: `place:Geba`); Jericó (ID: `place:Jericho`); Anatote (ID: `place:Anathoth`)
...
* **Associated ACAI Concepts:** Hodavias (ID: `person:Hodaviah.4`); Jedaías (ID: `person:Jedaiah.4`); Jesua (ID: `person:Jeshua.4`); Sobai (ID: `person:Shobai`); Harim (ID: `person:Harim`); Ater (ID: `person:Ater.2`); Hatita (ID: `person:Hatita`); Imer (ID: `person:Immer.2`); Jesua (ID: `person:Jeshua`); Talmom (ID: `person:Talmon`); Levi (ID: `person:Levi.3`); Cadmiel (ID: `person:Kadmiel`); Pasur (ID: `person:Pashhur`); Salum (ID: `person:Shallum.8`); Acube (ID: `person:Akkub.2`); Asafe (ID: `person:Asaph.2`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Sobai (ID: `person:Shobai`); Ater (ID: `person:Ater.2`); Hatita (ID: `person:Hatita`); Talmom (ID: `person:Talmon`); Salum (ID: `person:Shallum.8`); Acube (ID: `person:Akkub.2`); Asafe (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** Gazão (ID: `person:Gazzam`); Meída (ID: `person:Mehida`); Paseia (ID: `person:Paseah.2`); Padom (ID: `person:Padon`); Queros (ID: `person:Keros`); Hagaba (ID: `person:Hagabah`); Harsa (ID: `person:Harsha`); Barcos (ID: `person:Barkos`); Sisera (ID: `person:Sisera.2`); Gaar (ID: `person:Gahar`); Lebana (ID: `person:Lebanah`); Baquebuque (ID: `person:Bakbuk`); Sia (ID: `person:Siaha`); Gidel (ID: `person:Giddel`); Meunim (ID: `group:Meunim`); Hacufa (ID: `person:Hakupha`); Hanã (ID: `person:Hanan.4`); Zia (ID: `person:Ziha`); Hagabe (ID: `person:Hagab`); Asná (ID: `person:Asnah`); Hasufa (ID: `person:Hasupha`); Nephushesim (ID: `group:Nephushesim`); Acube (ID: `person:Akkub.3`); Temá (ID: `person:Temah`); Hatifa (ID: `person:Hatipha`); Bazlite (ID: `person:Bazluth`); Besai (ID: `person:Besai`); Tabaote (ID: `person:Tabbaoth`); Necoda (ID: `person:Nekoda`); Reaías (ID: `person:Reaiah.3`); Harur (ID: `person:Harhur`); Uza (ID: `person:Uzza.2`); Nesias (ID: `person:Neziah`); Salmai (ID: `person:Shalmai`); Rezim (ID: `person:Rezin.2`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Hatil (ID: `person:Hattil`); Ami (ID: `person:Ami`); Jaala (ID: `person:Jaalah`); Darcom (ID: `person:Darkon`); Gidel (ID: `person:Giddel.2`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Sotai (ID: `person:Sotai`); Sephatias (ID: `person:Shephatiah.7`); Soferete (ID: `person:Sophereth`); Peruda (ID: `person:Peruda`)
...
* **Associated ACAI Concepts:** Adã (ID: `place:Addan`); Tel-Harsa (ID: `place:Tel-harsha`); Delaías (ID: `person:Delaiah.3`); Necoda (ID: `person:Nekoda.2`); Tobias (ID: `person:Tobiah`); Querube (ID: `place:Cherub`); Tel-Melá (ID: `place:Tel-melah`); Imer (ID: `place:Immer`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Habaiah (ID: `person:Habaiah`); Hacoz (ID: `person:Hakkoz.2`); Barzillai (ID: `person:Barzillai.3`); priesthood (ID: `keyterm:Priesthood`); Gileadites (ID: `group:Gilead`); stain (ID: `keyterm:Stain`); Gileade (ID: `place:Gilead`); Barzillai (ID: `person:Barzillai`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); Jerusalém (ID: `place:Jerusalem`); strength (ID: `keyterm:Strength`); SENHOR (ID: `deity:Lord`); Tunic (ID: `realia:Tunic`); House (ID: `realia:House`); Mina (ID: `realia:Mina`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Josué (ID: `person:Joshua.5`); Pérsia (ID: `place:Persia`); Ciro (ID: `person:Cyrus`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Hodavias (ID: `person:Hodaviah.4`); Esar-Hadom (ID: `person:Esarhaddon`); Henadade (ID: `person:Henadad`); Relatives (ID: `group:Relatives`); Jesua (ID: `person:Jeshua.4`); Cadmiel (ID: `person:Kadmiel`); Dario (ID: `person:Darius.2`); Tiro (ID: `place:Tyre`); appointed feast (ID: `keyterm:AppointedFeast`); Asafe (ID: `person:Asaph.2`); Moisés (ID: `person:Moses`); Benjamim (ID: `group:Benjamin`); kindness (ID: `keyterm:Kindness`); Sidom (ID: `place:Sidon`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); holy (ID: `keyterm:Holy`); Hodias (ID: `person:Hodiah.2`); terror (ID: `keyterm:Terror`); Sidonians (ID: `group:Sidon`); Jope (ID: `place:Joppa`); Tyrians (ID: `group:Tyre`); counsel (ID: `keyterm:Counsel`); Davi (ID: `person:David`); Instruction (ID: `keyterm:Instruction`); Libano (ID: `place:Lebanon`); Assyria (ID: `place:Assyria`); new moon festival (ID: `keyterm:NewMoonFestival`); Benjamim (ID: `person:Benjamin`); Trumpet (ID: `realia:Trumpet`); Craftsman (ID: `realia:Craftsman`); Cedar (ID: `flora:Cedar`); Cymbals (ID: `realia:Cymbals`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); offering (ID: `keyterm:Offering`); Moisés (ID: `person:Moses`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); SENHOR (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); appointed feast (ID: `keyterm:AppointedFeast`); new moon festival (ID: `keyterm:NewMoonFestival`); holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** Sidonians (ID: `group:Sidon`); Tiro (ID: `place:Tyre`); Jope (ID: `place:Joppa`); Pérsia (ID: `place:Persia`); Sidom (ID: `place:Sidon`); Tyrians (ID: `group:Tyre`); Ciro (ID: `person:Cyrus`); Libano (ID: `place:Lebanon`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); Levi (ID: `group:Levi`); Jerusalém (ID: `place:Jerusalem`); Sealtiel (ID: `person:Shealtiel.2`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); kindness (ID: `keyterm:Kindness`); Asafe (ID: `person:Asaph.2`); Davi (ID: `person:David`); Levi (ID: `group:Levi`); House (ID: `realia:House`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Benjamim (ID: `person:Benjamin`); Israel (ID: `person:Israel`); Benjamim (ID: `group:Benjamin`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Josué (ID: `person:Joshua.5`); Pérsia (ID: `place:Persia`); Zorobabel (ID: `person:Zerubbabel.2`); Ciro (ID: `person:Cyrus`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Artaxerxes (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Samaria (ID: `place:Samaria`); Pérsia (ID: `place:Persia`); Assuero (ID: `person:Ahasuerus`); Mitredate (ID: `person:Mithredath.2`); Osnapar (ID: `person:Osnappar`); Babylonians (ID: `group:Babylon`); Tabeel (ID: `person:Tabeel`); Dinaítas (ID: `person:Dinaite`); Ereque (ID: `place:Erech`); Bislão (ID: `person:Bishlam`); Elam (ID: `place:Elam`); Persians (ID: `group:Persia`); Judá (ID: `person:Judah.4`); Babilônia (ID: `place:Babylon`); Elamites (ID: `group:Elam`); Judá (ID: `group:Judah`); Susã (ID: `place:Susa`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath.2`); Tabeel (ID: `person:Tabeel`); Bislão (ID: `person:Bishlam`); Artaxerxes (ID: `person:Artaxerxes.2`); Pérsia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Babylonians (ID: `group:Babylon`); Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Dinaítas (ID: `person:Dinaite`); Ereque (ID: `place:Erech`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); Elam (ID: `place:Elam`); Pérsia (ID: `place:Persia`); Babilônia (ID: `place:Babylon`); Susã (ID: `place:Susa`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Artaxerxes (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Sinsai (ID: `person:Shimshai`); Samaria (ID: `place:Samaria`); Reum (ID: `person:Rehum.2`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Artaxerxes (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Dario (ID: `person:Darius.2`); Jews (ID: `group:Jews`); Ageu (ID: `person:Haggai`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Tattenai (ID: `person:Tattenai`); Zacarias (ID: `person:Zechariah.17`); Ido (ID: `person:Iddo.6`); Josué (ID: `person:Joshua.5`); Rio Eufrates (ID: `place:Euphrates`); Pérsia (ID: `place:Persia`); Judá (ID: `person:Judah.4`); Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); Israel (ID: `person:Israel`); Sealtiel (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** Ageu (ID: `person:Haggai`); Zacarias (ID: `person:Zechariah.17`); Ido (ID: `person:Iddo.6`); Jews (ID: `group:Jews`); Judá (ID: `person:Judah.4`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); Jerusalém (ID: `place:Jerusalem`); Sealtiel (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Jerusalém (ID: `place:Jerusalem`); Foundation (ID: `realia:Foundation`); Cubit (ID: `realia:Cubit`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); Moisés (ID: `person:Moses`); Levi (ID: `group:Levi`); Jerusalém (ID: `place:Jerusalem`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** defilement (ID: `keyterm:Defilement`); Israel (ID: `person:Israel`); Gentiles (ID: `group:Gentile`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Azarias (ID: `person:Azariah.7`); Seraias (ID: `person:Seraiah.2`); Pérsia (ID: `place:Persia`); Artaxerxes (ID: `person:Artaxerxes`); Hilquias (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Amarias (ID: `person:Amariah.2`); Azarias (ID: `person:Azariah.6`); Aitube (ID: `person:Ahitub.3`); Uzi (ID: `person:Uzzi`); Buqui (ID: `person:Bukki.2`); Seraias (ID: `person:Seraiah.2`); Zeraías (ID: `person:Zerahiah`); Salum (ID: `person:Shallum.7`); Meraiote (ID: `person:Meraioth`); Abisua (ID: `person:Abishua`); Azarias (ID: `person:Azariah.7`); Zadoque (ID: `person:Zadok.4`); Arão (ID: `person:Aaron`); Fineias (ID: `person:Phinehas`); Artaxerxes (ID: `person:Artaxerxes`); Pérsia (ID: `place:Persia`); Eleazar (ID: `person:Eleazar.2`); Hilquias (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Moisés (ID: `person:Moses`); Babilônia (ID: `place:Babylon`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); decree (ID: `keyterm:Decree`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); Artaxerxes (ID: `person:Artaxerxes`); Levi (ID: `person:Levi.3`); Rio Eufrates (ID: `place:Euphrates`); Levi (ID: `group:Levi`); decree (ID: `keyterm:Decree`); Judá (ID: `person:Judah.4`); Babilônia (ID: `place:Babylon`); SENHOR (ID: `deity:Lord`); Wheat (ID: `flora:Wheat`); Talent (ID: `realia:Talent`); Stone Altar (ID: `realia:StoneAltar`); Anointing Oil (ID: `realia:AnointingOil`); Temple Altar (ID: `realia:TempleAltar`); Olive Oil (ID: `realia:OliveOil`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Kor (ID: `realia:Kor`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Rio Eufrates (ID: `place:Euphrates`); Artaxerxes (ID: `person:Artaxerxes`); Olive Oil (ID: `realia:OliveOil`); Wheat (ID: `flora:Wheat`); Kor (ID: `realia:Kor`); Talent (ID: `realia:Talent`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Bebai (ID: `person:Bebai.2`); Adim (ID: `person:Adin`); Parós (ID: `person:Parosh.2`); Jeuel (ID: `person:Jeuel.3`); Atalia (ID: `person:Athaliah.3`); Selomite (ID: `person:Shelomith.4`); Secanias (ID: `person:Shecaniah.6`); Elam (ID: `person:Elam`); Semaías (ID: `person:Shemaiah.14`); Hatus (ID: `person:Hattush.2`); Elifelete (ID: `person:Eliphelet.5`); Jeiel (ID: `person:Jehiel.7`); Bebai (ID: `person:Bebai`); Elioenai (ID: `person:Eliehoenai.2`); Miguel (ID: `person:Michael.10`); Daniel (ID: `person:Daniel.2`); Paate-Moabe (ID: `person:Pahath-moab`); Joanã (ID: `person:Johanan.8`); Utai (ID: `person:Uthai.2`); Josifias (ID: `person:Josiphiah`); Ebede (ID: `person:Ebed.2`); Joabe (ID: `person:Joab.4`); Zabadias (ID: `person:Zebadiah.8`); Zacur (ID: `person:Zaccur.5`); Zacarias (ID: `person:Zechariah.19`); Zeraías (ID: `person:Zerahiah.2`); Sephatias (ID: `person:Shephatiah.6`); Gérson (ID: `person:Gershom.2`); Asgade (ID: `person:Azgad`); Jaaziel (ID: `person:Jahaziel.5`); Obadias (ID: `person:Obadiah.10`); Jônatas (ID: `person:Jonathan.9`); Secanias (ID: `person:Shecaniah.5`); Hacatã (ID: `person:Hakkatan`); Adonicão (ID: `person:Adonikam`); Jesaías (ID: `person:Jeshaiah.4`); Zacarias (ID: `person:Zechariah.18`); Bigvai (ID: `person:Bigvai.2`); Itamar (ID: `person:Ithamar`); Fineias (ID: `person:Phinehas`); Artaxerxes (ID: `person:Artaxerxes`); Babilônia (ID: `place:Babylon`); Davi (ID: `person:David`)
...
* **Associated ACAI Concepts:** Natã (ID: `person:Nathan.5`); Ariel (ID: `person:Ariel`); Elnatã (ID: `person:Elnathan.4`); Elnatã (ID: `person:Elnathan.3`); Zacarias (ID: `person:Zechariah.20`); Elnatã (ID: `person:Elnathan.2`); Semaías (ID: `person:Shemaiah.15`); Jaribe (ID: `person:Jarib.2`); Mesulão (ID: `person:Meshullam.9`); Ido (ID: `person:Iddo`); Eliezer (ID: `person:Eliezer.8`); Joiaribe (ID: `person:Joiarib.2`); Casifia (ID: `place:Casiphia`); SENHOR (ID: `deity:Lord`); perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); Levi (ID: `person:Levi.3`); Insight (ID: `keyterm:Insight`); Mali (ID: `person:Mahli`); Levi (ID: `group:Levi`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); work (ID: `keyterm:Work`); Davi (ID: `person:David`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); offering (ID: `keyterm:Offering`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Harim (ID: `person:Harim`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); counsel (ID: `keyterm:Counsel`); Elam (ID: `person:Elam`); offering (ID: `keyterm:Offering`); Kelaiah (ID: `person:Kelaiah`); Sarai (ID: `person:Sharai`); Maadai (ID: `person:Maadai`); Zabade (ID: `person:Zabad.6`); Gedalias (ID: `person:Gedaliah`); Seal (ID: `person:Sheal`); Adna (ID: `person:Adna`); Telem (ID: `person:Telem`); Zabade (ID: `person:Zabad.7`); Quelal (ID: `person:Chelal`); Binui (ID: `person:Binnui.3`); Judeia (ID: `place:Judea`); Matanias (ID: `person:Mattaniah.5`); Sabetai (ID: `person:Shabbethai`); Jeiel (ID: `person:Jehiel.9`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); peace (ID: `keyterm:IntactState`); defilement (ID: `keyterm:Defilement`); supplication (ID: `keyterm:Supplication`); Pérsia (ID: `place:Persia`); dispossess (ID: `keyterm:Dispossess`); kindness (ID: `keyterm:Kindness`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); to cause to possess (ID: `keyterm:Possess`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); supplication (ID: `keyterm:Supplication`); Pérsia (ID: `place:Persia`); kindness (ID: `keyterm:Kindness`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); arrepender, se (ID: `keyterm:Repent`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jeiel (ID: `person:Jehiel.8`); Secanias (ID: `person:Shecaniah.7`); Ezra (ID: `person:Ezra`); Elam (ID: `person:Elam`); be unfaithful (ID: `keyterm:Unfaithful`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); Ezra (ID: `person:Ezra`); swear (ID: `keyterm:Swear`); Levi (ID: `group:Levi`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Benjamim (ID: `person:Benjamin`); Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `group:Benjamin`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jazeías (ID: `person:Jahzeiah`); Sabetai (ID: `person:Shabbethai`); Jônatas (ID: `person:Jonathan.10`); Ticva (ID: `person:Tikvah.2`); Asael (ID: `person:Asahel.4`); Mesulão (ID: `person:Meshullam.10`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`)
