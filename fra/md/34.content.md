...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); force (ID: `keyterm:Strength`); zélé (ID: `keyterm:Zealous.3`); Liban (ID: `place:Lebanon`); chemin (ID: `keyterm:TheWay`); Carmel (ID: `place:Carmel`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Basan (ID: `place:Bashan`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); force (ID: `keyterm:Strength`); méchanceté (ID: `keyterm:Wickedness`); zélé (ID: `keyterm:Zealous.3`); Liban (ID: `place:Lebanon`); chemin (ID: `keyterm:TheWay`); se réfugier (ID: `keyterm:SeekfindRefuge`); Carmel (ID: `place:Carmel`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Basan (ID: `place:Bashan`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`); Strong Drink (ID: `realia:StrongDrink`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Molten Image (ID: `realia:MoltenImage`); Graven Image (ID: `realia:GravenImage`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** faire un voeu (ID: `keyterm:Vow`); méchanceté (ID: `keyterm:Wickedness`); état intact (ID: `keyterm:IntactState`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); Éternel (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Grass (ID: `flora:Grass`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Égypte (ID: `place:Egypt`); Libya (ID: `place:Libya`); Puth (ID: `place:Put`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Cush (ID: `place:Cush.2`); destin (ID: `keyterm:Lot`)
