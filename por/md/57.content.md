...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Arquipo (ID: `person:Archippus`); Filemom (ID: `person:Philemon`); Áfia (ID: `person:Apphia`); favor (ID: `keyterm:Favor`); amado (ID: `keyterm:Beloved`); fazer a paz (ID: `keyterm:Peace`); igreja (ID: `keyterm:Church`); Timóteo (ID: `person:Timothy`); SENHOR (ID: `deity:Lord`); Paulo (ID: `person:Paul`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`); holy (ID: `keyterm:Holy`); Jesus (ID: `person:Jesus.2`); Good (ID: `keyterm:Good`); Cause of Joy (ID: `keyterm:CauseOfJoy`); compaixão (ID: `keyterm:Affection`); orar (ID: `keyterm:Pray`); rogar (ID: `keyterm:AskFor`); comunhão (ID: `keyterm:Fellowship`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); Good (ID: `keyterm:Good`); comunhão (ID: `keyterm:Fellowship`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`); em cristo (ID: `keyterm:InChrist`); Paulo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Demas (ID: `person:Demas`); Lucas (ID: `person:Luke`); Epafras (ID: `person:Epaphras`); favor (ID: `keyterm:Favor`); Spirit (ID: `keyterm:Spirit.2`); Marcos (ID: `person:Mark`); em cristo (ID: `keyterm:InChrist`); Aristarco (ID: `person:Aristarchus`)
