...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Archîpo (ID: `person:Archippus`); Filemón (ID: `person:Philemon`); Apphia (ID: `person:Apphia`); Timoteo (ID: `person:Timothy`); Jehová (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); Pablo (ID: `person:Paul`); amado (ID: `keyterm:Beloved`); iglesia (ID: `keyterm:Church`); hacer la paz (ID: `keyterm:Peace`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Archîpo (ID: `person:Archippus`); Apphia (ID: `person:Apphia`); iglesia (ID: `keyterm:Church`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** amar (ID: `keyterm:Love`); santo (ID: `keyterm:Holy`); creer (ID: `keyterm:Believe`); Jesús (ID: `person:Jesus.2`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); Jehová (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); Cause of Joy (ID: `keyterm:CauseOfJoy`); entrañas (ID: `keyterm:Affection`); comunión (ID: `keyterm:Fellowship`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); Pablo (ID: `person:Paul`); amar (ID: `keyterm:Love`); cristo (ID: `keyterm:InChrist`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); cuerpo (ID: `keyterm:Body.3`); amado (ID: `keyterm:Beloved`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); cristo (ID: `keyterm:InChrist`); entrañas (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Guest Room (ID: `realia:GuestRoom`); esperanza (ID: `keyterm:Hope`); perdonar (ID: `keyterm:Forgive`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Lucas (ID: `person:Luke`); Epafras (ID: `person:Epaphras`); Demas (ID: `person:Demas`); Marcos (ID: `person:Mark`); Aristarco (ID: `person:Aristarchus`); favor (ID: `keyterm:Favor`); cristo (ID: `keyterm:InChrist`); espíritu (ID: `keyterm:Spirit.2`)
...
* **Associated ACAI Concepts:** Lucas (ID: `person:Luke`); Demas (ID: `person:Demas`); Aristarco (ID: `person:Aristarchus`); Marcos (ID: `person:Mark`)
