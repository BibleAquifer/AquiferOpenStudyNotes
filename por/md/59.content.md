...
* **Associated ACAI Concepts:** aprovado (ID: `keyterm:Approved`); bem, aventurado (ID: `keyterm:Happy`); promessa (ID: `keyterm:Promise`); Life (ID: `keyterm:Life`); love (ID: `keyterm:Love`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); tentar (ID: `keyterm:PutToTheTest`); bem, aventurado (ID: `keyterm:Happy`); amado (ID: `keyterm:Beloved`); aprovado (ID: `keyterm:Approved`); limpo (ID: `keyterm:Clean`); inútil (ID: `keyterm:Worthless`); que não pode ser tentado (ID: `keyterm:NotTempted`); Life (ID: `keyterm:Life`); Truth (ID: `keyterm:Truth`); promessa (ID: `keyterm:Promise`); Good (ID: `keyterm:Good`); sem mancha (ID: `keyterm:Undefiled`); be (or show oneself) just (ID: `keyterm:Just`); salvation (ID: `keyterm:Salvation`); love (ID: `keyterm:Love`); lei (ID: `keyterm:Law`); A Person (ID: `person:GenericPerson`); sem mancha (ID: `keyterm:AboveCriticism`); To Sin (ID: `keyterm:Sin`); coração (ID: `keyterm:Heart`); Ability (ID: `keyterm:Ability`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** limpo (ID: `keyterm:Clean`); inútil (ID: `keyterm:Worthless`); coração (ID: `keyterm:Heart`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); sem mancha (ID: `keyterm:AboveCriticism`); sem mancha (ID: `keyterm:Undefiled`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); favoritismo (ID: `keyterm:Partiality`); Jesus (ID: `person:Jesus.2`); distinguir (ID: `keyterm:Discern`); Glory (ID: `keyterm:Glory`); crer (ID: `keyterm:Believe`); Synagogue (ID: `realia:Synagogue`); Footstool (ID: `realia:Footstool`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** promessa (ID: `keyterm:Promise`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); reino (ID: `keyterm:Kingdom`); escolhido (ID: `keyterm:Chosen`); love (ID: `keyterm:Love`); amado (ID: `keyterm:Beloved`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); juízo (ID: `keyterm:Judgment`); favoritismo (ID: `keyterm:Partiality`); tropeçar (ID: `keyterm:Stumble`); decidir (ID: `keyterm:Decided`); escritura (ID: `keyterm:Scripture`); To Sin (ID: `keyterm:Sin`); misericórdia (ID: `keyterm:Mercy`); fornication (ID: `keyterm:Fornication`); inclemente (ID: `keyterm:Merciless`); love (ID: `keyterm:Love`); tribunal de justiça (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); Abraão (ID: `person:Abraham`); Raabe (ID: `person:Rahab`); inútil (ID: `keyterm:Idle`); corpo (ID: `keyterm:Body.3`); To Cause to Happen (ID: `keyterm:Happen`); escritura (ID: `keyterm:Scripture`); SENHOR (ID: `deity:Lord`); Isaque (ID: `person:Isaac`); An Angel (ID: `deity:Angel`); Spirit (ID: `keyterm:Spirit.2`); vazio (ID: `keyterm:Empty`)
...
* **Associated ACAI Concepts:** To Cause to Happen (ID: `keyterm:Happen`); be (or show oneself) just (ID: `keyterm:Just`); escritura (ID: `keyterm:Scripture`); SENHOR (ID: `deity:Lord`); Abraão (ID: `person:Abraham`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** geena (ID: `keyterm:Gehenna`); Ability (ID: `keyterm:Ability`); injustiça (ID: `keyterm:UnjustDeed`); Hell (ID: `place:Hell`); corpo (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); be unfaithful (ID: `keyterm:Unfaithful`); amizade (ID: `keyterm:Friendship`); desejar (ID: `keyterm:LongFor`); escritura (ID: `keyterm:Scripture`); Ability (ID: `keyterm:Ability`); coração (ID: `keyterm:Heart`); pure (ID: `keyterm:Pure`); favor (ID: `keyterm:Favor`); Spirit (ID: `keyterm:Spirit.2`); Cause of Joy (ID: `keyterm:CauseOfJoy`); To Cleanse (ID: `keyterm:Cleanse.2`); Holy Spirit (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** desejar (ID: `keyterm:LongFor`); Spirit (ID: `keyterm:Spirit.2`); escritura (ID: `keyterm:Scripture`); Holy Spirit (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** testemunhar (ID: `keyterm:BearWitness`); be (or show oneself) just (ID: `keyterm:Just`); coração (ID: `keyterm:Heart`); SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); condenar (ID: `keyterm:Condemn`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Compassionate (ID: `keyterm:Compassionate`); Jó (ID: `person:Job`); SENHOR (ID: `deity:Lord`); considerar feliz (ID: `keyterm:RegardAsHappy`); mui compassivo (ID: `keyterm:FullOfCompassion`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); igreja (ID: `keyterm:Church`); anointed (ID: `keyterm:Anointed`); SENHOR (ID: `deity:Lord`); Name (ID: `keyterm:Name`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); To Sin (ID: `keyterm:Sin`); forgive (ID: `keyterm:Forgive`); SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); crer (ID: `keyterm:Believe`)
