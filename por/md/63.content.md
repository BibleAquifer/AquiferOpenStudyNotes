...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`); fazer a paz (ID: `keyterm:Peace`); escolhido (ID: `keyterm:Chosen`); misericórdia (ID: `keyterm:Mercy`); para a eternidade (ID: `keyterm:Always`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`); fazer a paz (ID: `keyterm:Peace`); love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); misericórdia (ID: `keyterm:Mercy`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); andar (ID: `keyterm:Live.3`); Ability (ID: `keyterm:Ability`); Truth (ID: `keyterm:Truth`); compartilhar (ID: `keyterm:Share`); rogar (ID: `keyterm:AskFor`); corpo (ID: `keyterm:Body.3`); House (ID: `realia:House`)
