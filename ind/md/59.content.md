...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); mencobai (ID: `keyterm:PutToTheTest`); berbahagialah (ID: `keyterm:Happy`); kekasih (ID: `keyterm:Beloved`); suci (ID: `keyterm:Clean`); tahan uji (ID: `keyterm:Approved`); sia, sia (ID: `keyterm:Worthless`); kehidupan (ID: `keyterm:Life`); hukum (ID: `keyterm:Law`); janji (ID: `keyterm:Promise`); kasihi (ID: `keyterm:Love`); tidak dapat dicobai (ID: `keyterm:NotTempted`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); berbuat dosa (ID: `keyterm:Sin`); keselamatan (ID: `keyterm:Salvation`); A Person (ID: `person:GenericPerson`); tak bernoda (ID: `keyterm:AboveCriticism`); yang baik (ID: `keyterm:Good`); hati (ID: `keyterm:Heart`); tidak dicemarkan (ID: `keyterm:Undefiled`); kebenaran (ID: `keyterm:Truth`); keahlian (ID: `keyterm:Ability`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** sia, sia (ID: `keyterm:Worthless`); suci (ID: `keyterm:Clean`); tidak dicemarkan (ID: `keyterm:Undefiled`); Tuhan (ID: `deity:Lord`); keahlian (ID: `keyterm:Ability`); tak bernoda (ID: `keyterm:AboveCriticism`); hati (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); tonton bulu atau muka (ID: `keyterm:Partiality`); Yesus (ID: `person:Jesus.2`); kemuliaan (ID: `keyterm:Glory`); bimbang (ID: `keyterm:Discern`); percaya (ID: `keyterm:Believe`); Seal (ID: `realia:Seal`); Synagogue (ID: `realia:Synagogue`); Footstool (ID: `realia:Footstool`)
...
* **Associated ACAI Concepts:** kekasih (ID: `keyterm:Beloved`); orang pilihan (ID: `keyterm:Chosen`); Tuhan (ID: `deity:Lord`); keahlian (ID: `keyterm:Ability`); kerajaan (ID: `keyterm:Kingdom`); janji (ID: `keyterm:Promise`); percaya (ID: `keyterm:Believe`); kasihi (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** kitab suci (ID: `keyterm:Scripture`); Tuhan (ID: `deity:Lord`); menggenapi (ID: `keyterm:Happen`); Abraham (ID: `person:Abraham`); percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** Hell (ID: `place:Hell`); keahlian (ID: `keyterm:Ability`); lalim (ID: `keyterm:UnjustDeed`); tubuh (ID: `keyterm:Body.3`); neraka (ID: `keyterm:Gehenna`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); persahabatan (ID: `keyterm:Friendship`); tidak setia (ID: `keyterm:Unfaithful`); kitab suci (ID: `keyterm:Scripture`); Roh (ID: `deity:HolySpirit`); Cause of Joy (ID: `keyterm:CauseOfJoy`); kebaikan (ID: `keyterm:Favor`); murni (ID: `keyterm:Pure`); keahlian (ID: `keyterm:Ability`); roh (ID: `keyterm:Spirit.2`); hati (ID: `keyterm:Heart`); ingin (ID: `keyterm:LongFor`); membersihkan (ID: `keyterm:Cleanse.2`)
...
* **Associated ACAI Concepts:** kitab suci (ID: `keyterm:Scripture`); roh (ID: `keyterm:Spirit.2`); Roh (ID: `deity:HolySpirit`); ingin (ID: `keyterm:LongFor`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); bersaksi (ID: `keyterm:BearWitness`); menentang (ID: `keyterm:Condemn`); tubuh (ID: `keyterm:Body.3`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); hati (ID: `keyterm:Heart`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** penyayang (ID: `keyterm:Compassionate`); Ayub (ID: `person:Job`); Tuhan (ID: `deity:Lord`); penuh belas kasihan (ID: `keyterm:FullOfCompassion`); menyebut berbahagia (ID: `keyterm:RegardAsHappy`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`); jemaat (ID: `keyterm:Church`); nama (ID: `keyterm:Name`); diurapi (ID: `keyterm:Anointed`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`); percaya (ID: `keyterm:Believe`); keselamatan (ID: `keyterm:Salvation`); berbuat dosa (ID: `keyterm:Sin`); mengampuni (ID: `keyterm:Forgive`)
