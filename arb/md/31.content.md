...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); عِيسو (ID: `place:EsauMount`); Understanding (ID: `keyterm:Understanding`); أَدومَ (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** Lot (ID: `keyterm:Lot`); يَهوذَا (ID: `group:Judah`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Edomites (ID: `group:Edom`); Dispossess (ID: `keyterm:Dispossess`); يوسف (ID: `person:Joseph.10`); أورشَلِيمَ (ID: `place:Jerusalem`); أَدومَ (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); يوسف (ID: `person:Joseph.10`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); أَدومَ (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); ٱلْجَنوبِ (ID: `place:Negeb`); جِلْعَادَ (ID: `place:Gilead`); إِلَى (ID: `place:Zarephath`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); عِيسو (ID: `place:EsauMount`); ٱلسَّامِرَةِ (ID: `place:Samaria`); ٱلسَّهْلِ (ID: `place:Shephelah`); بَنْيَامِينَ (ID: `group:Benjamin`); فِلِشْتِيم (ID: `group:Philistine`); أَفْرَايِمَ (ID: `group:Ephraim`); سَارْدِسَ (ID: `place:Sardis`); بَنْيَامِينَ (ID: `person:Benjamin`); أَفْرَايِمَ (ID: `person:Ephraim`); كَنْعَان (ID: `place:Canaan`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); Canaanites (ID: `group:Canaan`)
...
* **Associated ACAI Concepts:** عِيسو (ID: `place:EsauMount`); Dispossess (ID: `keyterm:Dispossess`); ٱلْجَنوبِ (ID: `place:Negeb`); أورشَلِيمَ (ID: `place:Jerusalem`); إِلَى (ID: `place:Zarephath`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); فِلِشْتِيم (ID: `group:Philistine`); Canaanites (ID: `group:Canaan`); أَفْرَايِمَ (ID: `group:Ephraim`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); جِلْعَادَ (ID: `place:Gilead`); بَنْيَامِينَ (ID: `group:Benjamin`); كَنْعَان (ID: `place:Canaan`); ٱلسَّامِرَةِ (ID: `place:Samaria`); ٱلسَّهْلِ (ID: `place:Shephelah`); سَارْدِسَ (ID: `place:Sardis`); بَنْيَامِينَ (ID: `person:Benjamin`); أَفْرَايِمَ (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** إِلَى (ID: `place:Zarephath`); Dispossess (ID: `keyterm:Dispossess`); سَارْدِسَ (ID: `place:Sardis`); كَنْعَان (ID: `place:Canaan`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْجَنوبِ (ID: `place:Negeb`); Canaanites (ID: `group:Canaan`)
