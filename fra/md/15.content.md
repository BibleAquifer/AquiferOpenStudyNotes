...
* **Associated ACAI Concepts:** Perse (ID: `place:Persia`); Cyrus (ID: `person:Cyrus`); Jérémie (ID: `person:Jeremiah.6`); parole du seigneur (ID: `keyterm:WordOfTheLord`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Cyrus (ID: `person:Cyrus`); Éternel (ID: `deity:Lord`); Perse (ID: `place:Persia`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Jérémie (ID: `person:Jeremiah.6`); parole du seigneur (ID: `keyterm:WordOfTheLord`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Cyrus (ID: `person:Cyrus`); Perse (ID: `place:Persia`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** offrande (ID: `keyterm:Offering`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Lévi (ID: `person:Levi.3`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); Lévi (ID: `group:Levi`); Juda (ID: `group:Judah`); Benjamin (ID: `person:Benjamin`); Jérusalem (ID: `place:Jerusalem`); Benjamin (ID: `group:Benjamin`); House (ID: `realia:House`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Cyrus (ID: `person:Cyrus`); Nebucadnetsar (ID: `person:Nebuchadnezzar`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mithredath (ID: `person:Mithredath`); Perse (ID: `place:Persia`); Juda (ID: `person:Judah.4`); Zorobabel (ID: `person:Zerubbabel.2`); Juda (ID: `group:Judah`); Cyrus (ID: `person:Cyrus`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Élam (ID: `person:Elam`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`); Salomon (ID: `person:Solomon`); Jérusalem (ID: `place:Jerusalem`); Gazzam (ID: `person:Gazzam`); Habaja (ID: `person:Habaiah`); Thel-Mélach (ID: `place:Tel-melah`); Ather (ID: `person:Ater`); Padon (ID: `person:Padon`); Mardochée (ID: `person:Mordecai`); Barkos (ID: `person:Barkos`); Addan (ID: `place:Addan`); Arach (ID: `person:Arah.2`); Ézéchias (ID: `person:Hezekiah.2`); Gachar (ID: `person:Gahar`); Nethopha (ID: `place:Netophah`); Bakbuk (ID: `person:Bakbuk`); Siaha (ID: `person:Siaha`); Hakupha (ID: `person:Hakupha`); Hanan (ID: `person:Hanan.4`); Thel-Harscha (ID: `place:Tel-harsha`); Magbisch (ID: `place:Magbish`); Akkub (ID: `person:Akkub.3`); Thamach (ID: `person:Temah`); Hathipha (ID: `person:Hatipha`); Bilschan (ID: `person:Bilshan`); Hatthil (ID: `person:Hattil`); Nekoda (ID: `person:Nekoda`)
...
* **Associated ACAI Concepts:** Bilschan (ID: `person:Bilshan`); Reélaja (ID: `person:Reelaiah`); Rehum (ID: `person:Rehum`); Seraja (ID: `person:Seraiah.6`); Mispar (ID: `person:Mispar`); Bigvaï (ID: `person:Bigvai`); Néhémie (ID: `person:Nehemiah`); Mardochée (ID: `person:Mordecai`); Baana (ID: `person:Baanah.3`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Adin (ID: `person:Adin`); Betsaï (ID: `person:Bezai`); Pareosch (ID: `person:Parosh`); Ather (ID: `person:Ater`); Élam (ID: `person:Elam`); Zaccaï (ID: `person:Zaccai.2`); Arach (ID: `person:Arah.2`); Ézéchias (ID: `person:Hezekiah.2`); Joab (ID: `person:Joab.3`); Josué (ID: `person:Jeshua.3`); Bébaï (ID: `person:Bebai`); Pachath-Moab (ID: `person:Pahath-moab`); Bani (ID: `person:Bani`); Haschum (ID: `person:Hashum`); Jora (ID: `person:Jorah`); Shefatya (ID: `person:Shephatiah.6`); Azgad (ID: `person:Azgad`); Zatthu (ID: `person:Zattu.2`); Adonikam (ID: `person:Adonikam`); Bigvaï (ID: `person:Bigvai.2`); Gabaon (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Beth-azmaveth (ID: `place:Beth-azmaveth`); Nethopha (ID: `place:Netophah`); Nebo (ID: `place:Nebo.2`); Senaa (ID: `place:Senaah`); Hadid (ID: `place:Hadid`); Magbisch (ID: `place:Magbish`); Harim (ID: `person:Harim.2`); Ramah (ID: `place:Ramah.2`); Beéroth (ID: `place:Beeroth`); Micmasch (ID: `place:Michmash`); Élam (ID: `person:Elam`); Lod (ID: `place:Lod`); Aï (ID: `place:Ai`); Ono (ID: `place:Ono`); Kirjath-Jearim (ID: `place:Kiriath-jearim`); Kephira (ID: `place:Chephirah`); Bethléhem (ID: `place:Bethlehem`); Bethel (ID: `place:Bethel`); Guéba (ID: `place:Geba`); Jéricho (ID: `place:Jericho`); Anathoth (ID: `place:Anathoth`)
...
* **Associated ACAI Concepts:** Hodavia (ID: `person:Hodaviah.4`); Yedaya (ID: `person:Jedaiah.4`); Josué (ID: `person:Jeshua.4`); Schobaï (ID: `person:Shobai`); Harim (ID: `person:Harim`); Ather (ID: `person:Ater.2`); Hathitha (ID: `person:Hatita`); Immer (ID: `person:Immer.2`); Josué (ID: `person:Jeshua`); Thalmon (ID: `person:Talmon`); Lévi (ID: `person:Levi.3`); Kadmiel (ID: `person:Kadmiel`); Paschhur (ID: `person:Pashhur`); Schallum (ID: `person:Shallum.8`); Akkub (ID: `person:Akkub.2`); Asaph (ID: `person:Asaph.2`); Lévi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Schobaï (ID: `person:Shobai`); Ather (ID: `person:Ater.2`); Hathitha (ID: `person:Hatita`); Thalmon (ID: `person:Talmon`); Schallum (ID: `person:Shallum.8`); Akkub (ID: `person:Akkub.2`); Asaph (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** Gazzam (ID: `person:Gazzam`); Mehida (ID: `person:Mehida`); Paséach (ID: `person:Paseah.2`); Padon (ID: `person:Padon`); Kéros (ID: `person:Keros`); Hagaba (ID: `person:Hagabah`); Harscha (ID: `person:Harsha`); Barkos (ID: `person:Barkos`); Sisera (ID: `person:Sisera.2`); Gachar (ID: `person:Gahar`); Lebana (ID: `person:Lebanah`); Bakbuk (ID: `person:Bakbuk`); Siaha (ID: `person:Siaha`); Guiddel (ID: `person:Giddel`); Meunim (ID: `group:Meunim`); Hakupha (ID: `person:Hakupha`); Hanan (ID: `person:Hanan.4`); Tsicha (ID: `person:Ziha`); Hagab (ID: `person:Hagab`); Asna (ID: `person:Asnah`); Hasupha (ID: `person:Hasupha`); Nephushesim (ID: `group:Nephushesim`); Akkub (ID: `person:Akkub.3`); Thamach (ID: `person:Temah`); Hathipha (ID: `person:Hatipha`); Batsluth (ID: `person:Bazluth`); Bésaï (ID: `person:Besai`); Thabbaoth (ID: `person:Tabbaoth`); Nekoda (ID: `person:Nekoda`); Reaja (ID: `person:Reaiah.3`); Harhur (ID: `person:Harhur`); Uzza (ID: `person:Uzza.2`); Netsiach (ID: `person:Neziah`); Shalmai (ID: `person:Shalmai`); Retsin (ID: `person:Rezin.2`)
...
* **Associated ACAI Concepts:** Salomon (ID: `person:Solomon`); Hatthil (ID: `person:Hattil`); Ami (ID: `person:Ami`); Jaala (ID: `person:Jaalah`); Darkon (ID: `person:Darkon`); Guiddel (ID: `person:Giddel.2`); Pokéreth-Hatsebaïm (ID: `person:Pochereth-hazzebaim`); Sothaï (ID: `person:Sotai`); Shephatiah (ID: `person:Shephatiah.7`); Sophéreth (ID: `person:Sophereth`); Peruda (ID: `person:Peruda`)
...
* **Associated ACAI Concepts:** Addan (ID: `place:Addan`); Thel-Harscha (ID: `place:Tel-harsha`); Delaja (ID: `person:Delaiah.3`); Nekoda (ID: `person:Nekoda.2`); Tobija (ID: `person:Tobiah`); Cherub (ID: `place:Cherub`); Thel-Mélach (ID: `place:Tel-melah`); Immer (ID: `place:Immer`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Habaja (ID: `person:Habaiah`); Hakkots (ID: `person:Hakkoz.2`); Barzillaï (ID: `person:Barzillai.3`); sacerdoce (ID: `keyterm:Priesthood`); Galaadite (ID: `group:Gilead`); souiller (ID: `keyterm:Stain`); Galaad (ID: `place:Gilead`); Barzillaï (ID: `person:Barzillai`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); Jérusalem (ID: `place:Jerusalem`); force (ID: `keyterm:Strength`); Éternel (ID: `deity:Lord`); Tunic (ID: `realia:Tunic`); House (ID: `realia:House`); Mina (ID: `realia:Mina`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); force (ID: `keyterm:Strength`); Tunic (ID: `realia:Tunic`); Mina (ID: `realia:Mina`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); offrande (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`); Josué (ID: `person:Joshua.5`); Perse (ID: `place:Persia`); Cyrus (ID: `person:Cyrus`); Jehozadak (ID: `person:Jehozadak`); Schealthiel (ID: `person:Shealtiel.2`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Hodavia (ID: `person:Hodaviah.4`); Asarhaddôn (ID: `person:Esarhaddon`); Hénadad (ID: `person:Henadad`); Relatives (ID: `group:Relatives`); Josué (ID: `person:Jeshua.4`); Kadmiel (ID: `person:Kadmiel`); Darius (ID: `person:Darius.2`); Tyr (ID: `place:Tyre`); fête déterminée (ID: `keyterm:AppointedFeast`); Asaph (ID: `person:Asaph.2`); Moïse (ID: `person:Moses`); Benjamin (ID: `group:Benjamin`); bonté (ID: `keyterm:Kindness`); Sidon (ID: `place:Sidon`); fourré (ID: `keyterm:FeastOfTabernacles`); saint (ID: `keyterm:Holy`); Hodija (ID: `person:Hodiah.2`); terreur (ID: `keyterm:Terror`); Sidonien (ID: `group:Sidon`); Joppa (ID: `place:Joppa`); Tyrien (ID: `group:Tyre`); avis (ID: `keyterm:Counsel`); David (ID: `person:David`); Instruction (ID: `keyterm:Instruction`); Liban (ID: `place:Lebanon`); Assyria (ID: `place:Assyria`); néoménies (ID: `keyterm:NewMoonFestival`); Benjamin (ID: `person:Benjamin`); Trumpet (ID: `realia:Trumpet`); Craftsman (ID: `realia:Craftsman`); Cedar (ID: `flora:Cedar`); Cymbals (ID: `realia:Cymbals`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Jehozadak (ID: `person:Jehozadak`); Schealthiel (ID: `person:Shealtiel.2`); offrande (ID: `keyterm:Offering`); Moïse (ID: `person:Moses`); Israël (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); Éternel (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** terreur (ID: `keyterm:Terror`); offrande (ID: `keyterm:Offering`); Éternel (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** offrande (ID: `keyterm:Offering`); Éternel (ID: `deity:Lord`); fête déterminée (ID: `keyterm:AppointedFeast`); néoménies (ID: `keyterm:NewMoonFestival`); saint (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** Sidonien (ID: `group:Sidon`); Tyr (ID: `place:Tyre`); Joppa (ID: `place:Joppa`); Perse (ID: `place:Persia`); Sidon (ID: `place:Sidon`); Tyrien (ID: `group:Tyre`); Cyrus (ID: `person:Cyrus`); Liban (ID: `place:Lebanon`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Lévi (ID: `person:Levi.3`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Jehozadak (ID: `person:Jehozadak`); Lévi (ID: `group:Levi`); Jérusalem (ID: `place:Jerusalem`); Schealthiel (ID: `person:Shealtiel.2`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); Lévi (ID: `person:Levi.3`); bonté (ID: `keyterm:Kindness`); Asaph (ID: `person:Asaph.2`); David (ID: `person:David`); Lévi (ID: `group:Levi`); House (ID: `realia:House`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Benjamin (ID: `person:Benjamin`); Israël (ID: `person:Israel`); Benjamin (ID: `group:Benjamin`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Josué (ID: `person:Joshua.5`); Perse (ID: `place:Persia`); Zorobabel (ID: `person:Zerubbabel.2`); Cyrus (ID: `person:Cyrus`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** avis (ID: `keyterm:Counsel`); Darius (ID: `person:Darius.2`); Cyrus (ID: `person:Cyrus`); Perse (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Euphrate (ID: `place:Euphrates`); Jérusalem (ID: `place:Jerusalem`); Schimschaï (ID: `person:Shimshai`); Rehum (ID: `person:Rehum.2`); Artaxerxès (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Samarie (ID: `place:Samaria`); Perse (ID: `place:Persia`); Assuérus (ID: `person:Ahasuerus`); Mithredath (ID: `person:Mithredath.2`); Osnappar (ID: `person:Osnappar`); Babylonien (ID: `group:Babylon`); Thabeel (ID: `person:Tabeel`); Dinaite (ID: `person:Dinaite`); Érec (ID: `place:Erech`); Bischlam (ID: `person:Bishlam`); Élam (ID: `place:Elam`); Perse (ID: `group:Persia`); Juda (ID: `person:Judah.4`); Babylone (ID: `place:Babylon`); Almôn-Divlataïm (ID: `group:Elam`); Juda (ID: `group:Judah`); Suse (ID: `place:Susa`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Mithredath (ID: `person:Mithredath.2`); Thabeel (ID: `person:Tabeel`); Bischlam (ID: `person:Bishlam`); Artaxerxès (ID: `person:Artaxerxes.2`); Perse (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Babylonien (ID: `group:Babylon`); Schimschaï (ID: `person:Shimshai`); Rehum (ID: `person:Rehum.2`); Dinaite (ID: `person:Dinaite`); Érec (ID: `place:Erech`); Almôn-Divlataïm (ID: `group:Elam`); Perse (ID: `group:Persia`); Élam (ID: `place:Elam`); Perse (ID: `place:Persia`); Babylone (ID: `place:Babylon`); Suse (ID: `place:Susa`)
...
* **Associated ACAI Concepts:** Euphrate (ID: `place:Euphrates`); Jérusalem (ID: `place:Jerusalem`); Artaxerxès (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Schimschaï (ID: `person:Shimshai`); Samarie (ID: `place:Samaria`); Rehum (ID: `person:Rehum.2`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Schimschaï (ID: `person:Shimshai`); Rehum (ID: `person:Rehum.2`); Artaxerxès (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Jérusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Darius (ID: `person:Darius.2`); Jews (ID: `group:Jews`); Aggée (ID: `person:Haggai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Thathnaï (ID: `person:Tattenai`); Zacharie (ID: `person:Zechariah.17`); Iddo (ID: `person:Iddo.6`); Josué (ID: `person:Joshua.5`); Euphrate (ID: `place:Euphrates`); Perse (ID: `place:Persia`); Juda (ID: `person:Judah.4`); Zorobabel (ID: `person:Zerubbabel.2`); Jehozadak (ID: `person:Jehozadak`); Israël (ID: `person:Israel`); Schealthiel (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** Aggée (ID: `person:Haggai`); Zacharie (ID: `person:Zechariah.17`); Iddo (ID: `person:Iddo.6`); Jews (ID: `group:Jews`); Juda (ID: `person:Judah.4`); Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Jehozadak (ID: `person:Jehozadak`); Jérusalem (ID: `place:Jerusalem`); Schealthiel (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Babylone (ID: `place:Babylon`); Jérusalem (ID: `place:Jerusalem`); Cyrus (ID: `person:Cyrus`); Darius (ID: `person:Darius.2`); Zorobabel (ID: `person:Zerubbabel.2`); Nebucadnetsar (ID: `person:Nebuchadnezzar`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Thathnaï (ID: `person:Tattenai`); Chaldéens (ID: `group:Chaldea`); Euphrate (ID: `place:Euphrates`); Juda (ID: `person:Judah.4`); Chaldée (ID: `place:Chaldea`); Israël (ID: `person:Israel`); Foundation (ID: `realia:Foundation`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** Cyrus (ID: `person:Cyrus`); Jérusalem (ID: `place:Jerusalem`); Foundation (ID: `realia:Foundation`); Cubit (ID: `realia:Cubit`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** offrande (ID: `keyterm:Offering`); Israël (ID: `person:Israel`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Lévi (ID: `person:Levi.3`); Moïse (ID: `person:Moses`); Lévi (ID: `group:Levi`); Jérusalem (ID: `place:Jerusalem`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); sacrifice de la pâque (ID: `keyterm:Passover`); sans saleté (ID: `keyterm:Pure`)
...
* **Associated ACAI Concepts:** pollution (ID: `keyterm:Defilement`); Israël (ID: `person:Israel`); nation; peuple (ID: `group:Gentile`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Assyria (ID: `place:Assyria`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); Unleavened Bread (ID: `realia:UnleavenedBread`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Esdras (ID: `person:Ezra`); Azaria (ID: `person:Azariah.7`); Seraja (ID: `person:Seraiah.2`); Perse (ID: `place:Persia`); Artaxerxès (ID: `person:Artaxerxes`); Hilkija (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** Esdras (ID: `person:Ezra`); Amaria (ID: `person:Amariah.2`); Azaria (ID: `person:Azariah.6`); Achithub (ID: `person:Ahitub.3`); Uzzi (ID: `person:Uzzi`); Bukki (ID: `person:Bukki.2`); Seraja (ID: `person:Seraiah.2`); Zerachja (ID: `person:Zerahiah`); Schallum (ID: `person:Shallum.7`); Merajoth (ID: `person:Meraioth`); Abischua (ID: `person:Abishua`); Azaria (ID: `person:Azariah.7`); Tsadok (ID: `person:Zadok.4`); Aaron (ID: `person:Aaron`); Phinées (ID: `person:Phinehas`); Artaxerxès (ID: `person:Artaxerxes`); Perse (ID: `place:Persia`); Éléazar (ID: `person:Eleazar.2`); Hilkija (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** Esdras (ID: `person:Ezra`); Moïse (ID: `person:Moses`); Babylone (ID: `place:Babylon`); Israël (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Esdras (ID: `person:Ezra`); limite (ID: `keyterm:Decree`); Israël (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); Esdras (ID: `person:Ezra`); Israël (ID: `person:Israel`); Artaxerxès (ID: `person:Artaxerxes`); Lévi (ID: `person:Levi.3`); Euphrate (ID: `place:Euphrates`); Lévi (ID: `group:Levi`); limite (ID: `keyterm:Decree`); Juda (ID: `person:Judah.4`); Babylone (ID: `place:Babylon`); Éternel (ID: `deity:Lord`); Wheat (ID: `flora:Wheat`); Talent (ID: `realia:Talent`); Stone Altar (ID: `realia:StoneAltar`); Anointing Oil (ID: `realia:AnointingOil`); Temple Altar (ID: `realia:TempleAltar`); Olive Oil (ID: `realia:OliveOil`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Kor (ID: `realia:Kor`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Esdras (ID: `person:Ezra`); Euphrate (ID: `place:Euphrates`); Artaxerxès (ID: `person:Artaxerxes`); Olive Oil (ID: `realia:OliveOil`); Wheat (ID: `flora:Wheat`); Kor (ID: `realia:Kor`); Talent (ID: `realia:Talent`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Bébaï (ID: `person:Bebai.2`); Adin (ID: `person:Adin`); Pareosch (ID: `person:Parosh.2`); Yeïel (ID: `person:Jeuel.3`); Athalie (ID: `person:Athaliah.3`); Schelomith (ID: `person:Shelomith.4`); Schecania (ID: `person:Shecaniah.6`); Élam (ID: `person:Elam`); Schemaeja (ID: `person:Shemaiah.14`); Hatthusch (ID: `person:Hattush.2`); Éliphéleth (ID: `person:Eliphelet.5`); Jehiel (ID: `person:Jehiel.7`); Bébaï (ID: `person:Bebai`); Éljoénaï (ID: `person:Eliehoenai.2`); Micaël (ID: `person:Michael.10`); Daniel (ID: `person:Daniel.2`); Pachath-Moab (ID: `person:Pahath-moab`); Jochanan (ID: `person:Johanan.8`); Uthaï (ID: `person:Uthai.2`); Josiphia (ID: `person:Josiphiah`); Ébed (ID: `person:Ebed.2`); Joab (ID: `person:Joab.4`); Zevadya (ID: `person:Zebadiah.8`); Zaccur (ID: `person:Zaccur.5`); Zacharie (ID: `person:Zechariah.19`); Zerachja (ID: `person:Zerahiah.2`); Shefatya (ID: `person:Shephatiah.6`); Guershom (ID: `person:Gershom.2`); Azgad (ID: `person:Azgad`); Jachaziel (ID: `person:Jahaziel.5`); Abdias (ID: `person:Obadiah.10`); Jonathan (ID: `person:Jonathan.9`); Schecania (ID: `person:Shecaniah.5`); Hakkathan (ID: `person:Hakkatan`); Adonikam (ID: `person:Adonikam`); Ésaïe (ID: `person:Jeshaiah.4`); Zacharie (ID: `person:Zechariah.18`); Bigvaï (ID: `person:Bigvai.2`); Ithamar (ID: `person:Ithamar`); Phinées (ID: `person:Phinehas`); Artaxerxès (ID: `person:Artaxerxes`); Babylone (ID: `place:Babylon`); David (ID: `person:David`)
...
* **Associated ACAI Concepts:** Ahava (ID: `place:Ahava`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); percevoir (ID: `keyterm:Perceive`)
...
* **Associated ACAI Concepts:** Nathan (ID: `person:Nathan.5`); Ariel (ID: `person:Ariel`); Elnathan (ID: `person:Elnathan.4`); Elnathan (ID: `person:Elnathan.3`); Zacharie (ID: `person:Zechariah.20`); Elnathan (ID: `person:Elnathan.2`); Schemaeja (ID: `person:Shemaiah.15`); Jarib (ID: `person:Jarib.2`); Meschullam (ID: `person:Meshullam.9`); Iddo (ID: `person:Iddo`); Éliézer (ID: `person:Eliezer.8`); Jojarib (ID: `person:Joiarib.2`); Casiphia (ID: `place:Casiphia`); Éternel (ID: `deity:Lord`); percevoir (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Schérébia (ID: `person:Sherebiah`); Lévi (ID: `person:Levi.3`); discernement (ID: `keyterm:Insight`); Machli (ID: `person:Mahli`); Lévi (ID: `group:Levi`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); travil (ID: `keyterm:Work`); David (ID: `person:David`)
...
* **Associated ACAI Concepts:** pécher (ID: `keyterm:Sin`); offrande (ID: `keyterm:Offering`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittite (ID: `group:Hittite`); Lévi (ID: `person:Levi.3`); Mitsraïm (ID: `group:Egypt`); Jébusiens (ID: `group:Jebusites`); Égypte (ID: `place:Egypt`); Ammon (ID: `place:Ammon`); Amos (ID: `group:Ammon`); Amorites (ID: `group:Amorites`); Canaan (ID: `group:Canaan`); être infidèle (ID: `keyterm:Unfaithful`); Heth (ID: `person:Heth`); Lévi (ID: `group:Levi`); Israël (ID: `person:Israel`); Moab (ID: `place:Moab`); Canaan (ID: `place:Canaan`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Esdras (ID: `person:Ezra`); être infidèle (ID: `keyterm:Unfaithful`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`); ardeur (ID: `keyterm:Ardour`); Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Harim (ID: `person:Harim`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); avis (ID: `keyterm:Counsel`); Élam (ID: `person:Elam`); offrande (ID: `keyterm:Offering`); Kelaiah (ID: `person:Kelaiah`); Scharaï (ID: `person:Sharai`); Maadaï (ID: `person:Maadai`); Zabad (ID: `person:Zabad.6`); Guedalia (ID: `person:Gedaliah`); Scheal (ID: `person:Sheal`); Adna (ID: `person:Adna`); Thélem (ID: `person:Telem`); Zabad (ID: `person:Zabad.7`); Kelal (ID: `person:Chelal`); Binnuï (ID: `person:Binnui.3`); Judée (ID: `place:Judea`); Matthania (ID: `person:Mattaniah.5`); Shabbethai (ID: `person:Shabbethai`); Jehiel (ID: `person:Jehiel.9`)
...
* **Associated ACAI Concepts:** être infidèle (ID: `keyterm:Unfaithful`); Israël (ID: `person:Israel`); offrande (ID: `keyterm:Offering`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); ardeur (ID: `keyterm:Ardour`); Judée (ID: `place:Judea`); état intact (ID: `keyterm:IntactState`); pollution (ID: `keyterm:Defilement`); supplication (ID: `keyterm:Supplication`); Perse (ID: `place:Persia`); déposséder (ID: `keyterm:Dispossess`); bonté (ID: `keyterm:Kindness`); Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`); laissiez en possession (ID: `keyterm:Possess`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Judée (ID: `place:Judea`); supplication (ID: `keyterm:Supplication`); Perse (ID: `place:Persia`); bonté (ID: `keyterm:Kindness`); Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** déposséder (ID: `keyterm:Dispossess`); laissiez en possession (ID: `keyterm:Possess`); état intact (ID: `keyterm:IntactState`); pollution (ID: `keyterm:Defilement`)
...
* **Associated ACAI Concepts:** Esdras (ID: `person:Ezra`); se repentir (ID: `keyterm:Repent`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jehiel (ID: `person:Jehiel.8`); Schecania (ID: `person:Shecaniah.7`); Esdras (ID: `person:Ezra`); Élam (ID: `person:Elam`); être infidèle (ID: `keyterm:Unfaithful`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Lévi (ID: `person:Levi.3`); Esdras (ID: `person:Ezra`); jurer (ID: `keyterm:Swear`); Lévi (ID: `group:Levi`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Benjamin (ID: `person:Benjamin`); Jérusalem (ID: `place:Jerusalem`); Benjamin (ID: `group:Benjamin`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jachzia (ID: `person:Jahzeiah`); Shabbethai (ID: `person:Shabbethai`); Jonathan (ID: `person:Jonathan.10`); Thikva (ID: `person:Tikvah.2`); Asaël (ID: `person:Asahel.4`); Meschullam (ID: `person:Meshullam.10`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`)
