...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Yehuda (ID: `group:Judah`); Yehuda (ID: `person:Judah.4`); Betlehem (ID: `place:Bethlehem`)
...
* **Associated ACAI Concepts:** Efrata (ID: `person:Ephrathah`); Ephrathites (ID: `group:Ephrathah`); Naomi (ID: `person:Naomi`); Mahlon (ID: `person:Chilion`); Yehuda (ID: `group:Judah`); Elimelekh (ID: `person:Elimelech`); Betlehem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Mahlon (ID: `person:Mahlon`); Yehuda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Rut (ID: `person:Ruth`); menyebabkan memiliki (ID: `keyterm:Possess`); Boas (ID: `person:Boaz`); Naomi (ID: `person:Naomi`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); menyebabkan memiliki (ID: `keyterm:Possess`); Mahlon (ID: `person:Mahlon`); Rut (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); Lea (ID: `person:Leah`); Betlehem (ID: `place:Bethlehem`); Israel (ID: `person:Israel`); Rahel (ID: `person:Rachel`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yehuda (ID: `person:Judah.4`); Tamar (ID: `person:Tamar`); Peres (ID: `person:Perez`); Yehuda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); memberkati (ID: `keyterm:Bless`); Tuhan (ID: `deity:Lord`); Naomi (ID: `person:Naomi`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); memperanakkan (ID: `person:Salmon`); Obed (ID: `person:Obed`); Aminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Boas (ID: `person:Boaz`); Nahason (ID: `person:Nahshon`); Peres (ID: `person:Perez`); Daud (ID: `person:David`); Isai (ID: `person:Jesse`)
