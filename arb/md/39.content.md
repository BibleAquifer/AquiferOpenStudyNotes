...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); Love (ID: `keyterm:Love`); أَدومَ (ID: `place:Edom`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Priests (ID: `group:GenericPriests`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Fear (ID: `keyterm:Fear`); Covenant (ID: `keyterm:Covenant`); Offering (ID: `keyterm:Offering`); Priests (ID: `group:GenericPriests`); To Curse (ID: `keyterm:Curse`); Glory (ID: `keyterm:Glory`); لَّاوِي (ID: `person:Levi.3`); Peace (ID: `keyterm:IntactState`); لَّاوِي (ID: `group:Levi`); Defile (ID: `keyterm:Stain`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Fairness (ID: `keyterm:Fairness`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Pure (ID: `keyterm:Pure`); Intention (ID: `keyterm:Intention`); Ask for (ID: `keyterm:AskFor`); Passion (ID: `keyterm:Ardour`); Bless (ID: `keyterm:Bless`); Vow (ID: `keyterm:Vow`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); To Dishonor (ID: `keyterm:Dishonor`); Truth (ID: `keyterm:Truth`); An Angel (ID: `deity:Angel`); Gentiles (ID: `group:Gentile`); The Way (ID: `keyterm:TheWay`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Vow (ID: `keyterm:Vow`); To Curse (ID: `keyterm:Curse`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); To Curse (ID: `keyterm:Curse`); Bless (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `person:Levi.3`); Covenant (ID: `keyterm:Covenant`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); To Dishonor (ID: `keyterm:Dishonor`); يَهوذَا (ID: `group:Judah`); Love (ID: `keyterm:Love`); Delight (ID: `keyterm:Delight`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); Love (ID: `keyterm:Love`); To Dishonor (ID: `keyterm:Dishonor`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); أورشَلِيمَ (ID: `place:Jerusalem`); A Group of People (ID: `group:GenericGroup`); Covenant (ID: `keyterm:Covenant`); لَّاوِي (ID: `person:Levi.3`); Fear (ID: `keyterm:Fear`); يَهوذَا (ID: `group:Judah`); Pure (ID: `keyterm:Pure`); يَهوذَا (ID: `person:Judah.4`); Swear (ID: `keyterm:Swear`); An Angel (ID: `deity:Angel`); لَّاوِي (ID: `group:Levi`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Decree (ID: `keyterm:Decree`); To Curse (ID: `keyterm:Curse`); Bless (ID: `keyterm:Bless`); إِسْرَائِيلَ (ID: `person:Israel`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Vine (ID: `flora:Vine`); Sorghum (ID: `flora:Sorghum`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Force to Serve (ID: `keyterm:EnticedToServe`); Fear (ID: `keyterm:Fear`); Molten Image (ID: `realia:MoltenImage`); Scroll (ID: `realia:Scroll`); Animal Pen (ID: `realia:AnimalPen`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** سِينَاءَ (ID: `place:SinaiMount`); موسَى (ID: `person:Moses`); Decree (ID: `keyterm:Decree`); إِسْرَائِيلَ (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** سِينَاءَ (ID: `place:SinaiMount`); موسَى (ID: `person:Moses`); إِيلِيَّا (ID: `person:Elijah`); Decree (ID: `keyterm:Decree`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Instruction (ID: `keyterm:Instruction`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`)
