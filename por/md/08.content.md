...
* **Associated ACAI Concepts:** Ephrathites (ID: `group:Ephrathah`); Efrata (ID: `person:Ephrathah`); Quiliom (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Elimeleque (ID: `person:Elimelech`); Judá (ID: `group:Judah`); Malom (ID: `person:Mahlon`); Moabe (ID: `place:Moab`); Belém (ID: `place:Bethlehem`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); Moabe (ID: `place:Moab`); Belém (ID: `place:Bethlehem`); Noemi (ID: `person:Naomi`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); kindness (ID: `keyterm:Kindness`); bless (ID: `keyterm:Bless`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Raquel (ID: `person:Rachel`); SENHOR (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); Israel (ID: `person:Israel`); Belém (ID: `place:Bethlehem`); Lia (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Tamar (ID: `person:Tamar`); Perez (ID: `person:Perez`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); SENHOR (ID: `deity:Lord`); bless (ID: `keyterm:Bless`); Israel (ID: `person:Israel`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Hezrom (ID: `person:Hezron.2`); Salmom (ID: `person:Salmon`); Aminadabe (ID: `person:Amminadab`); Obede (ID: `person:Obed`); Ram (ID: `person:Ram`); Jessé (ID: `person:Jesse`); Naassom (ID: `person:Nahshon`); Boaz (ID: `person:Boaz`); Davi (ID: `person:David`); Perez (ID: `person:Perez`)
