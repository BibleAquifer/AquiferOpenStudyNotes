...
* **Associated ACAI Concepts:** Chilion (ID: `person:Chilion`); Ephrathah (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Ephrathites (ID: `group:Ephrathah`); Bethlehem (ID: `place:Bethlehem`); Tribe of Judah (ID: `group:Judah`); Mahlon (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Judah (ID: `person:Judah.4`); Elimelech (ID: `person:Elimelech`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); LORD (ID: `deity:Lord`); Appoint (ID: `keyterm:Appoint`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); Favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); To Cause to Possess (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Boaz (ID: `person:Boaz`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Bethlehem (ID: `place:Bethlehem`); Elders (ID: `group:GenericElders`); LORD (ID: `deity:Lord`); Rachel (ID: `person:Rachel`); Leah (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Perez (ID: `person:Perez`); Tamar (ID: `person:Tamar`); Tribe of Judah (ID: `group:Judah`); LORD (ID: `deity:Lord`); Judah (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Amminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Nahshon (ID: `person:Nahshon`); Perez (ID: `person:Perez`); David (ID: `person:David`); Boaz (ID: `person:Boaz`); Jesse (ID: `person:Jesse`)
