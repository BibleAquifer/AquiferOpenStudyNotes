...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Word of the Lord (ID: `keyterm:WordOfTheLord`); إِرْمِيَا (ID: `person:Jeremiah.6`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `group:Benjamin`); لَّاوِي (ID: `person:Levi.3`); يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `group:Levi`); بَنْيَامِينَ (ID: `person:Benjamin`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); زَربَّابِل (ID: `person:Zerubbabel.2`); كورَشَ (ID: `person:Cyrus`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); أورشَلِيمَ (ID: `place:Jerusalem`); سلَيْمَانَ (ID: `person:Solomon`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); عَقّوب (ID: `person:Akkub.3`); سَنَاءَةَ (ID: `place:Senaah`); بِيصَايَ (ID: `person:Bezai`); حَارِيمَ (ID: `person:Harim`); حَسوفَا (ID: `person:Hasupha`); يَشوعَ (ID: `person:Jeshua`); سِيسَرَا (ID: `person:Sisera.2`); دَرْقونَ (ID: `person:Darkon`); هودَوْيَا (ID: `person:Hodaviah.4`); يَدَايَا (ID: `person:Jedaiah.4`); سَلْمَايَ (ID: `person:Shalmai`); لِإِيمِيرَ (ID: `place:Immer`); طَبَاعوتَ (ID: `person:Tabbaoth`); Meunim (ID: `group:Meunim`); طَلْمون (ID: `person:Talmon`); بَعْنَةَ (ID: `person:Baanah.3`); لِدَلَايَا (ID: `person:Delaiah.3`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); بَرْقوسَ (ID: `person:Barkos`); أَدَّان (ID: `place:Addan`); شَفَطْيَا (ID: `person:Shephatiah.6`); بَرْزِلَّايَ (ID: `person:Barzillai.3`); حَادِيدَ (ID: `place:Hadid`)
...
* **Associated ACAI Concepts:** رَحوم (ID: `person:Rehum`); مِسْفَار (ID: `person:Mispar`); سَرَايَا (ID: `person:Seraiah.6`); بِغْوَايَ (ID: `person:Bigvai`); رَعْلَايَا (ID: `person:Reelaiah`); بَعْنَةَ (ID: `person:Baanah.3`); بِلْشَان (ID: `person:Bilshan`); نَحَمْيَا (ID: `person:Nehemiah`); مرْدَخَاي (ID: `person:Mordecai`); زَربَّابِل (ID: `person:Zerubbabel.2`); إِسْرَائِيلَ (ID: `person:Israel`); يَشوع (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** بَانِيَ (ID: `person:Bani`); زَتّو (ID: `person:Zattu.2`); يَشوعَ (ID: `person:Jeshua.3`); فَرْعوشَ (ID: `person:Parosh`); بِيصَايَ (ID: `person:Bezai`); عِيلَامَ (ID: `person:Elam`); بِغْوَايَ (ID: `person:Bigvai.2`); آطِيرَ (ID: `person:Ater`); يوآب (ID: `person:Joab.3`); أَدونِيقَامَ (ID: `person:Adonikam`); يورَةَ (ID: `person:Jorah`); آرَحَ (ID: `person:Arah.2`); حَزَقِيَّا (ID: `person:Hezekiah.2`); بَابَايَ (ID: `person:Bebai`); زَكَّايَ (ID: `person:Zaccai.2`); عَادِينَ (ID: `person:Adin`); Pahath-moab (ID: `person:Pahath-moab`); عَرْجَدَ (ID: `person:Azgad`); حَشوم (ID: `person:Hashum`); شَفَطْيَا (ID: `person:Shephatiah.6`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** سَنَاءَةَ (ID: `place:Senaah`); مَغْبِيشَ (ID: `place:Magbish`); حَارِيمَ (ID: `person:Harim.2`); نَبو (ID: `place:Nebo.2`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); Beth-azmaveth (ID: `place:Beth-azmaveth`); حَادِيدَ (ID: `place:Hadid`); Ramah (ID: `place:Ramah.2`); أَرِيحَا (ID: `place:Jericho`); عِيلَامَ (ID: `person:Elam`); عَايٍ (ID: `place:Ai`); عَنَاثوثَ (ID: `place:Anathoth`); ٱلْكَفِيرَة (ID: `place:Chephirah`); أونوَ (ID: `place:Ono`); مِخْمَاسَ (ID: `place:Michmash`); Bethel (ID: `place:Bethel`); لَحْمٍ (ID: `place:Bethlehem`); بَئِيروت (ID: `place:Beeroth`); وَلودَ (ID: `place:Lod`); Kiriath-jearim (ID: `place:Kiriath-jearim`); مِنْ (ID: `place:Geba`)
...
* **Associated ACAI Concepts:** حَطِيطَا (ID: `person:Hatita`); يَشوعَ (ID: `person:Jeshua`); حَارِيمَ (ID: `person:Harim`); طَلْمون (ID: `person:Talmon`); هودَوْيَا (ID: `person:Hodaviah.4`); يَدَايَا (ID: `person:Jedaiah.4`); لِإِيمِيرَ (ID: `person:Immer.2`); آطِيرَ (ID: `person:Ater.2`); شوبَايَ (ID: `person:Shobai`); يَشوعَ (ID: `person:Jeshua.4`); شَلّوم (ID: `person:Shallum.8`); لَّاوِي (ID: `person:Levi.3`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`); فَشْحور (ID: `person:Pashhur`); لَّاوِي (ID: `group:Levi`); قَدْمِيئِيلَ (ID: `person:Kadmiel`)
...
* **Associated ACAI Concepts:** عَقّوب (ID: `person:Akkub.3`); حَرْشَا (ID: `person:Harsha`); حَرْحورَ (ID: `person:Harhur`); سِيعَهَا (ID: `person:Siaha`); مَحِيدَا (ID: `person:Mehida`); أَسْنَةَ (ID: `person:Asnah`); حَسوفَا (ID: `person:Hasupha`); حَاجَابَ (ID: `person:Hagab`); صِيحَا (ID: `person:Ziha`); حَانَان (ID: `person:Hanan.4`); جَدِّيلَ (ID: `person:Giddel`); جَزَّامَ (ID: `person:Gazzam`); سِيسَرَا (ID: `person:Sisera.2`); حَجَابَةَ (ID: `person:Hagabah`); رَآيَا (ID: `person:Reaiah.3`); سَلْمَايَ (ID: `person:Shalmai`); حَطِيفَا (ID: `person:Hatipha`); Nephushesim (ID: `group:Nephushesim`); بِيسَايَ (ID: `person:Besai`); رَصِينَ (ID: `person:Rezin.2`); طَبَاعوتَ (ID: `person:Tabbaoth`); قِيروسَ (ID: `person:Keros`); Meunim (ID: `group:Meunim`); فَادونَ (ID: `person:Padon`); نَصِيحَ (ID: `person:Neziah`); ثَامَحَ (ID: `person:Temah`); بَصْلوتَ (ID: `person:Bazluth`); نَقودَا (ID: `person:Nekoda`); بَرْقوسَ (ID: `person:Barkos`); بَقْبوقَ (ID: `person:Bakbuk`); حَقوفَا (ID: `person:Hakupha`); فِي (ID: `person:Uzza.2`); لَبَانَةَ (ID: `person:Lebanah`); جَاحَرَ (ID: `person:Gahar`); فَاسِيحَ (ID: `person:Paseah.2`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); حَطِّيلَ (ID: `person:Hattil`); جَدِّيلَ (ID: `person:Giddel.2`); دَرْقونَ (ID: `person:Darkon`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); آمِي (ID: `person:Ami`); يَعْلَةَ (ID: `person:Jaalah`); سوفَرَثَ (ID: `person:Sophereth`); شَفَطْيَا (ID: `person:Shephatiah.7`); فَرودَا (ID: `person:Peruda`); سَوْطَايَ (ID: `person:Sotai`)
...
* **Associated ACAI Concepts:** لِإِيمِيرَ (ID: `place:Immer`); Tel-harsha (ID: `place:Tel-harsha`); أَدَّان (ID: `place:Addan`); Tel-melah (ID: `place:Tel-melah`); كَروب (ID: `place:Cherub`); نَقودَا (ID: `person:Nekoda.2`); لِدَلَايَا (ID: `person:Delaiah.3`); طوبِيَّا (ID: `person:Tobiah`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** بَرْزِلَّايَ (ID: `person:Barzillai.3`); هَقّوصَ (ID: `person:Hakkoz.2`); حَبَايَا (ID: `person:Habaiah`); بَرْزِلَّايَ (ID: `person:Barzillai`); Defile (ID: `keyterm:Stain`); Gileadites (ID: `group:Gilead`); Priesthood (ID: `keyterm:Priesthood`); جِلْعَادَ (ID: `place:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); Strength (ID: `keyterm:Strength`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); Tunic (ID: `realia:Tunic`); Mina (ID: `realia:Mina`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); يَشوع (ID: `person:Joshua.5`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); هودَوْيَا (ID: `person:Hodaviah.4`); حِينَادَادَ (ID: `person:Henadad`); Esarhaddon (ID: `person:Esarhaddon`); Relatives (ID: `group:Relatives`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); يَشوعَ (ID: `person:Jeshua.4`); دَارِيوسَ (ID: `person:Darius.2`); يَافَا (ID: `place:Joppa`); صورَ (ID: `place:Tyre`); لبْنَانَ (ID: `place:Lebanon`); Instruction (ID: `keyterm:Instruction`); بَنْيَامِينَ (ID: `person:Benjamin`); بَنْيَامِينَ (ID: `group:Benjamin`); آسَاف (ID: `person:Asaph.2`); Holy (ID: `keyterm:Holy`); صِيْدونَ (ID: `place:Sidon`); Kindness (ID: `keyterm:Kindness`); هودِيَّا (ID: `person:Hodiah.2`); موسَى (ID: `person:Moses`); دَاودَ (ID: `person:David`); Terror (ID: `keyterm:Terror`); Appointed Feast (ID: `keyterm:AppointedFeast`); Tyrians (ID: `group:Tyre`); Assyria (ID: `place:Assyria`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Counsel (ID: `keyterm:Counsel`); Sidonians (ID: `group:Sidon`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Cedar (ID: `flora:Cedar`); Trumpet (ID: `realia:Trumpet`); Craftsman (ID: `realia:Craftsman`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); Terror (ID: `keyterm:Terror`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** فَارِسَ (ID: `place:Persia`); يَافَا (ID: `place:Joppa`); صِيْدونَ (ID: `place:Sidon`); صورَ (ID: `place:Tyre`); Sidonians (ID: `group:Sidon`); Tyrians (ID: `group:Tyre`); لبْنَانَ (ID: `place:Lebanon`); كورَشَ (ID: `person:Cyrus`); Craftsman (ID: `realia:Craftsman`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); ٱلرَّبِّ (ID: `deity:Lord`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); أورشَلِيمَ (ID: `place:Jerusalem`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `group:Levi`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `person:Levi.3`); آسَاف (ID: `person:Asaph.2`); Kindness (ID: `keyterm:Kindness`); دَاودَ (ID: `person:David`); لَّاوِي (ID: `group:Levi`); Trumpet (ID: `realia:Trumpet`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); إِسْرَائِيلَ (ID: `person:Israel`); بَنْيَامِينَ (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); فَارِسَ (ID: `place:Persia`); ٱلرَّبِّ (ID: `deity:Lord`); يَشوع (ID: `person:Joshua.5`); إِسْرَائِيلَ (ID: `person:Israel`); زَربَّابِل (ID: `person:Zerubbabel.2`); كورَشَ (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); ٱلسَّامِرَةِ (ID: `place:Samaria`); فَارِسَ (ID: `place:Persia`); مِثْرَدَاث (ID: `person:Mithredath.2`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); أَرَكَ (ID: `place:Erech`); طَبْئِيل (ID: `person:Tabeel`); Babylonians (ID: `group:Babylon`); بِشْلَام (ID: `person:Bishlam`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); أسْنَفَّر (ID: `person:Osnappar`); يَهوذَا (ID: `group:Judah`); Elamites (ID: `group:Elam`); عِيلَامَ (ID: `place:Elam`); Persians (ID: `group:Persia`); فِي (ID: `place:Susa`); بَابِلَ (ID: `place:Babylon`); يَهوذَا (ID: `person:Judah.4`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** ٱلدِّينِيِّينَ (ID: `person:Dinaite`); رَحوم (ID: `person:Rehum.2`); أَرَكَ (ID: `place:Erech`); Babylonians (ID: `group:Babylon`); شِمْشَاي (ID: `person:Shimshai`); فَارِسَ (ID: `place:Persia`); Elamites (ID: `group:Elam`); عِيلَامَ (ID: `place:Elam`); Persians (ID: `group:Persia`); فِي (ID: `place:Susa`); بَابِلَ (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); Jews (ID: `group:Jews`); رَحوم (ID: `person:Rehum.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); ٱلسَّامِرَةِ (ID: `place:Samaria`); شِمْشَاي (ID: `person:Shimshai`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); دَارِيوسَ (ID: `person:Darius.2`); Shethar-bozenai (ID: `person:Shethar-bozenai`); تَتْنَاي (ID: `person:Tattenai`); يَدّو (ID: `person:Iddo.6`); حَجَّيِ (ID: `person:Haggai`); زَكَرِيَّا (ID: `person:Zechariah.17`); فَارِسَ (ID: `place:Persia`); يَهوصَادِقَ (ID: `person:Jehozadak`); ٱلْفرَاتِ (ID: `place:Euphrates`); يَهوذَا (ID: `person:Judah.4`); زَربَّابِل (ID: `person:Zerubbabel.2`); إِسْرَائِيلَ (ID: `person:Israel`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَشوع (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** يَدّو (ID: `person:Iddo.6`); حَجَّيِ (ID: `person:Haggai`); زَكَرِيَّا (ID: `person:Zechariah.17`); Jews (ID: `group:Jews`); يَهوذَا (ID: `person:Judah.4`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); أورشَلِيمَ (ID: `place:Jerusalem`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); بَابِلَ (ID: `place:Babylon`); أورشَلِيمَ (ID: `place:Jerusalem`); كورَشَ (ID: `person:Cyrus`); دَارِيوسَ (ID: `person:Darius.2`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); زَربَّابِل (ID: `person:Zerubbabel.2`); Shethar-bozenai (ID: `person:Shethar-bozenai`); تَتْنَاي (ID: `person:Tattenai`); Chaldeans (ID: `group:Chaldea`); يَهوذَا (ID: `person:Judah.4`); ٱلْفرَاتِ (ID: `place:Euphrates`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); Money (ID: `realia:Money`); Foundation (ID: `realia:Foundation`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); عَزَرْيَا (ID: `person:Azariah.7`); سَرَايَا (ID: `person:Seraiah.2`); فَارِسَ (ID: `place:Persia`); حِلْقِيَّا (ID: `person:Hilkiah.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); صَادوق (ID: `person:Zadok.4`); بقِّي (ID: `person:Bukki.2`); أَخِيطوبَ (ID: `person:Ahitub.3`); عزِّي (ID: `person:Uzzi`); أَمَرْيَا (ID: `person:Amariah.2`); شَلّوم (ID: `person:Shallum.7`); زَرَحْيَا (ID: `person:Zerahiah`); لِمَرَايوثَ (ID: `person:Meraioth`); أَبِيشوعَ (ID: `person:Abishua`); سَرَايَا (ID: `person:Seraiah.2`); عَزَرْيَا (ID: `person:Azariah.6`); عَزَرْيَا (ID: `person:Azariah.7`); حِلْقِيَّا (ID: `person:Hilkiah.2`); هَارون (ID: `person:Aaron`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); أَلِعَازَار (ID: `person:Eleazar.2`); فَارِسَ (ID: `place:Persia`); فِينَحَاس (ID: `person:Phinehas`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); ٱلرَّبِّ (ID: `deity:Lord`); بَابِلَ (ID: `place:Babylon`); إِسْرَائِيلَ (ID: `person:Israel`); موسَى (ID: `person:Moses`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Decree (ID: `keyterm:Decree`); عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); عَزْرَا (ID: `person:Ezra`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلْفرَاتِ (ID: `place:Euphrates`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Decree (ID: `keyterm:Decree`); ٱلرَّبِّ (ID: `deity:Lord`); بَابِلَ (ID: `place:Babylon`); يَهوذَا (ID: `person:Judah.4`); Altar (ID: `realia:Altar`); Sheep (ID: `fauna:Lamb`); Temple Altar (ID: `realia:TempleAltar`); Anointing Oil (ID: `realia:AnointingOil`); Stone Altar (ID: `realia:StoneAltar`); Talent (ID: `realia:Talent`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Olive Oil (ID: `realia:OliveOil`); Wheat (ID: `flora:Wheat`); Kor (ID: `realia:Kor`)
...
* **Associated ACAI Concepts:** أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); ٱلْفرَاتِ (ID: `place:Euphrates`); عَزْرَا (ID: `person:Ezra`); Talent (ID: `realia:Talent`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Wheat (ID: `flora:Wheat`); Anointing Oil (ID: `realia:AnointingOil`); Kor (ID: `realia:Kor`)
...
* **Associated ACAI Concepts:** عَثَلْيَا (ID: `person:Athaliah.3`); يونَاثَانَ (ID: `person:Jonathan.9`); عوبَدْيَا (ID: `person:Obadiah.10`); يَحِيئِيل (ID: `person:Jehiel.7`); شَكَنْيَا (ID: `person:Shecaniah.6`); عِيلَامَ (ID: `person:Elam`); حَطّوش (ID: `person:Hattush.2`); عَابِد (ID: `person:Ebed.2`); بِغْوَايَ (ID: `person:Bigvai.2`); يَحْزِيئِيل (ID: `person:Jahaziel.5`); أَدونِيقَامَ (ID: `person:Adonikam`); شَكَنْيَا (ID: `person:Shecaniah.5`); زَكَرِيَّا (ID: `person:Zechariah.19`); عوتَاي (ID: `person:Uthai.2`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); Gershom (ID: `person:Gershom.2`); شِمْعِيَا (ID: `person:Shemaiah.14`); زَكّور (ID: `person:Zaccur.5`); بَابَايَ (ID: `person:Bebai`); أَلِيفَلَط (ID: `person:Eliphelet.5`); يوآب (ID: `person:Joab.4`); زَكَرِيَّا (ID: `person:Zechariah.18`); هِقَّاطَانَ (ID: `person:Hakkatan`); يَعِيئِيل (ID: `person:Jeuel.3`); يوشَفْيَا (ID: `person:Josiphiah`); يِشْعِيَا (ID: `person:Jeshaiah.4`); Pahath-moab (ID: `person:Pahath-moab`); عَادِينَ (ID: `person:Adin`); عَرْجَدَ (ID: `person:Azgad`); زَبَدْيَا (ID: `person:Zebadiah.8`); بَابَايَ (ID: `person:Bebai.2`); مِيخَائِيلَ (ID: `person:Michael.10`); دَانِيآل (ID: `person:Daniel.2`); شَلومِيَةَ (ID: `person:Shelomith.4`); فَرْعوشَ (ID: `person:Parosh.2`); يوحَانَانَ (ID: `person:Johanan.8`); زَرَحْيَا (ID: `person:Zerahiah.2`); شَفَطْيَا (ID: `person:Shephatiah.6`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); بَابِلَ (ID: `place:Babylon`); دَاودَ (ID: `person:David`); فِينَحَاس (ID: `person:Phinehas`); إِيثَامَارَ (ID: `person:Ithamar`)
...
* **Associated ACAI Concepts:** نَاثَان (ID: `person:Nathan.5`); أَرِيئِيلَ (ID: `person:Ariel`); أَلِيعَزَرَ (ID: `person:Eliezer.8`); مَشلَّام (ID: `person:Meshullam.9`); زَكَرِيَّا (ID: `person:Zechariah.20`); ٱلْمسَمَّى (ID: `place:Casiphia`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); يَدّو (ID: `person:Iddo`); يَارِيبَ (ID: `person:Jarib.2`); يويَارِيبَ (ID: `person:Joiarib.2`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); شِمْعِيَا (ID: `person:Shemaiah.15`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); ٱلرَّبِّ (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); لَّاوِي (ID: `person:Levi.3`); ٱلرَّبِّ (ID: `deity:Lord`); مَحْلِي (ID: `person:Mahli`); Insight (ID: `keyterm:Insight`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); دَاودَ (ID: `person:David`); لَّاوِي (ID: `group:Levi`); Work (ID: `keyterm:Work`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); موآبَ (ID: `place:Moab`); لَّاوِي (ID: `person:Levi.3`); Egyptians (ID: `group:Egypt`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Amorites (ID: `group:Amorites`); Jebusites (ID: `group:Jebusites`); Canaanites (ID: `group:Canaan`); مِصْرَ (ID: `place:Egypt`); Be Unfaithful (ID: `keyterm:Unfaithful`); حِثًّا (ID: `person:Heth`); إِسْرَائِيلَ (ID: `person:Israel`); كَنْعَان (ID: `place:Canaan`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); عِيلَامَ (ID: `person:Elam`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Offering (ID: `keyterm:Offering`); Counsel (ID: `keyterm:Counsel`); بِيدْيَا (ID: `person:Bedeiah`); يَهوذَا (ID: `person:Judah.5`); يَرِيموت (ID: `person:Jeremoth.4`); مَتَّنْيَا (ID: `person:Mattaniah.5`); يوئِيل (ID: `person:Joel.12`); يِزِّيَّا (ID: `person:Izziah`); مَتَّنَاي (ID: `person:Mattenai`); شِمْعِي (ID: `person:Shimei.15`); زَابَادَ (ID: `person:Zabad.5`); عَدْنَا (ID: `person:Adna`); بَانِيَ (ID: `person:Bani.6`); ٱلْعَمْرَامِيِّينَ (ID: `person:Amram.2`); أَلِيفَلَط (ID: `person:Eliphelet.6`); زَابَادَ (ID: `person:Zabad.7`); إِيلِيَّا (ID: `person:Elijah.3`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); فَارِسَ (ID: `place:Persia`); Plea for Mercy (ID: `keyterm:Supplication`); Kindness (ID: `keyterm:Kindness`); Peace (ID: `keyterm:IntactState`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); Defilement (ID: `keyterm:Defilement`); To Cause to Possess (ID: `keyterm:Possess`); Dispossess (ID: `keyterm:Dispossess`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** يَحِيئِيل (ID: `person:Jehiel.8`); شَكَنْيَا (ID: `person:Shecaniah.7`); ٱلرَّبِّ (ID: `deity:Lord`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`)
...
* **Associated ACAI Concepts:** Swear (ID: `keyterm:Swear`); لَّاوِي (ID: `person:Levi.3`); عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `person:Benjamin`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَحْزِيَا (ID: `person:Jahzeiah`); يونَاثَانَ (ID: `person:Jonathan.10`); مَشلَّام (ID: `person:Meshullam.10`); عَسَائِيل (ID: `person:Asahel.4`); شَبْتَاي (ID: `person:Shabbethai`); تِقْوَةَ (ID: `person:Tikvah.2`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`)
