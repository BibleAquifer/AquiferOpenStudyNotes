...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); make a vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); Jope (ID: `place:Joppa`); Nínive (ID: `place:Nineveh`); Amittai (ID: `person:Amittai`); slaughtering (ID: `keyterm:Slaughtering`); kindness (ID: `keyterm:Kindness`); praise (ID: `keyterm:Praise`); Word of the Lord (ID: `keyterm:WordOfTheLord`); exempt (ID: `keyterm:Exempt`); salvation (ID: `keyterm:Salvation`); Hebrews (ID: `group:Hebrews`); lot (ID: `keyterm:Lot`); Társis (ID: `place:Tarshish`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** slaughtering (ID: `keyterm:Slaughtering`); SENHOR (ID: `deity:Lord`); make a vow (ID: `keyterm:Vow`); fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Hell (ID: `place:Hell`); kindness (ID: `keyterm:Kindness`); salvation (ID: `keyterm:Salvation`); Jonas (ID: `person:Jonah.2`); make a vow (ID: `keyterm:Vow`); praise (ID: `keyterm:Praise`); Cattails (ID: `flora:Cattails`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** kindness (ID: `keyterm:Kindness`); salvation (ID: `keyterm:Salvation`); SENHOR (ID: `deity:Lord`); make a vow (ID: `keyterm:Vow`); praise (ID: `keyterm:Praise`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Nínive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Sackcloth (ID: `realia:Sackcloth`); Cattle (ID: `fauna:Bull`); Word of the Lord (ID: `keyterm:WordOfTheLord`); kindness (ID: `keyterm:Kindness`); Believe In (ID: `keyterm:BelieveIn`); Compassionate (ID: `keyterm:Compassionate`); gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`); Goat (ID: `fauna:Goat`); Throne (ID: `realia:Throne`); Clothing (ID: `realia:Clothing`); Worm (ID: `fauna:Maggot`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Nínive (ID: `place:Nineveh`); Jonas (ID: `person:Jonah.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`); gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`); SENHOR (ID: `deity:Lord`); gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`)
