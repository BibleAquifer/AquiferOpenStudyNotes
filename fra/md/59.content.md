...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); béni (ID: `keyterm:Happy`); mis à l'essai (ID: `keyterm:PutToTheTest`); bien, aimé (ID: `keyterm:Beloved`); pur (ID: `keyterm:Clean`); approuvé (ID: `keyterm:Approved`); sans valeur (ID: `keyterm:Worthless`); le bien (ID: `keyterm:Good`); capacité (ID: `keyterm:Ability`); aimer (ID: `keyterm:Love`); pur (ID: `keyterm:Undefiled`); coeur (ID: `keyterm:Heart`); A Person (ID: `person:GenericPerson`); aide (ID: `keyterm:Salvation`); pur (ID: `keyterm:AboveCriticism`); promesse (ID: `keyterm:Promise`); vie (ID: `keyterm:Life`); incapable d'être tenté (ID: `keyterm:NotTempted`); loi (ID: `keyterm:Law`); pécher (ID: `keyterm:Sin`); être juste (ID: `keyterm:Just`); vérité (ID: `keyterm:Truth`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** pur (ID: `keyterm:Clean`); sans valeur (ID: `keyterm:Worthless`); pur (ID: `keyterm:AboveCriticism`); pur (ID: `keyterm:Undefiled`); coeur (ID: `keyterm:Heart`); Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); favoritisme (ID: `keyterm:Partiality`); croire (ID: `keyterm:Believe`); gloire (ID: `keyterm:Glory`); Jésus (ID: `person:Jesus.2`); évaluer (ID: `keyterm:Discern`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`); Footstool (ID: `realia:Footstool`)
...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); choisi (ID: `keyterm:Chosen`); croire (ID: `keyterm:Believe`); promesse (ID: `keyterm:Promise`); régne (ID: `keyterm:Kingdom`); bien, aimé (ID: `keyterm:Beloved`); Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** loi (ID: `keyterm:Law`); intrans. trébucher (ID: `keyterm:Stumble`); favoritisme (ID: `keyterm:Partiality`); jugement (ID: `keyterm:Judgment`); aimer (ID: `keyterm:Love`); pécher (ID: `keyterm:Sin`); pitié (ID: `keyterm:Mercy`); decider (ID: `keyterm:Decided`); fornication (ID: `keyterm:Fornication`); sans pitié (ID: `keyterm:Merciless`); tribunal (ID: `keyterm:CourtCase`); scripture (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** croire (ID: `keyterm:Believe`); être juste (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); corps (ID: `keyterm:Body.3`); Éternel (ID: `deity:Lord`); A Person (ID: `person:GenericPerson`); désoeuvré (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); Demons (ID: `deity:Demons`); Isaac (ID: `person:Isaac`); To Cause to Happen (ID: `keyterm:Happen`); An Angel (ID: `deity:Angel`); esprit (ID: `keyterm:Spirit.2`); faire la paix (ID: `keyterm:Peace`); vide (ID: `keyterm:Empty`); scripture (ID: `keyterm:Scripture`); aide (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** croire (ID: `keyterm:Believe`); être juste (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); désoeuvré (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); Isaac (ID: `person:Isaac`); To Cause to Happen (ID: `keyterm:Happen`); An Angel (ID: `deity:Angel`); esprit (ID: `keyterm:Spirit.2`); corps (ID: `keyterm:Body.3`); Éternel (ID: `deity:Lord`); vide (ID: `keyterm:Empty`); scripture (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** croire (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`); Abraham (ID: `person:Abraham`); Éternel (ID: `deity:Lord`); être juste (ID: `keyterm:Just`); scripture (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** méfaits (ID: `keyterm:UnjustDeed`); Hell (ID: `place:Hell`); corps (ID: `keyterm:Body.3`); enfer (ID: `keyterm:Gehenna`); capacité (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); amour (ID: `keyterm:Friendship`); être infidèle (ID: `keyterm:Unfaithful`); Cause of Joy (ID: `keyterm:CauseOfJoy`); sans saleté (ID: `keyterm:Pure`); grâce (ID: `keyterm:Favor`); esprit (ID: `keyterm:Spirit.2`); désirer ardemment (ID: `keyterm:LongFor`); purifier (ID: `keyterm:Cleanse.2`); coeur (ID: `keyterm:Heart`); Saint-Esprit (ID: `deity:HolySpirit`); capacité (ID: `keyterm:Ability`); scripture (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** esprit (ID: `keyterm:Spirit.2`); désirer ardemment (ID: `keyterm:LongFor`); Saint-Esprit (ID: `deity:HolySpirit`); scripture (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** purifier (ID: `keyterm:Cleanse.2`); coeur (ID: `keyterm:Heart`); sans saleté (ID: `keyterm:Pure`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** condamner (ID: `keyterm:Condemn`); corps (ID: `keyterm:Body.3`); coeur (ID: `keyterm:Heart`); témoigner (ID: `keyterm:BearWitness`); Éternel (ID: `deity:Lord`); être juste (ID: `keyterm:Just`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** nom (ID: `keyterm:Name`); prier (ID: `keyterm:Pray`); église (ID: `keyterm:Church`); Éternel (ID: `deity:Lord`); oint (ID: `keyterm:Anointed`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** pécher (ID: `keyterm:Sin`); croire (ID: `keyterm:Believe`); pardonner (ID: `keyterm:Forgive`); prier (ID: `keyterm:Pray`); Éternel (ID: `deity:Lord`); aide (ID: `keyterm:Salvation`)
