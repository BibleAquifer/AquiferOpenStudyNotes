...
* **Associated ACAI Concepts:** kebenaran (ID: `keyterm:Truth`); hidup (ID: `keyterm:Live.3`); kekasih (ID: `keyterm:Beloved`); Gayus (ID: `person:Gaius.4`); berdoa (ID: `keyterm:Pray`); bersaksi (ID: `keyterm:BearWitness`); kasihi (ID: `keyterm:Love`); Cause of Joy (ID: `keyterm:CauseOfJoy`)
...
* **Associated ACAI Concepts:** kebenaran (ID: `keyterm:Truth`); kesetiaan (ID: `keyterm:Faithfulness`); bersaksi (ID: `keyterm:BearWitness`); nama (ID: `keyterm:Name`); Tuhan (ID: `deity:Lord`); kasihi (ID: `keyterm:Love`); kekasih (ID: `keyterm:Beloved`); wajib (ID: `keyterm:Ought`); jemaat (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** kasihi (ID: `keyterm:Love`); jemaat (ID: `keyterm:Church`); bersaksi (ID: `keyterm:BearWitness`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** jemaat (ID: `keyterm:Church`); Diotrefes (ID: `person:Diotrephes`); Demetrius (ID: `person:Demetrius`); kebenaran (ID: `keyterm:Truth`); bersaksi (ID: `keyterm:BearWitness`); yang baik (ID: `keyterm:Good`); Tuhan (ID: `deity:Lord`); benar (ID: `keyterm:True`); kekasih (ID: `keyterm:Beloved`); lakukan baik (ID: `keyterm:DoGood`)
...
* **Associated ACAI Concepts:** Ink (ID: `realia:Ink`); Pen (ID: `realia:Pen`); harapan (ID: `keyterm:Hope`); nama (ID: `keyterm:Name`); memperdamaikan (ID: `keyterm:Peace`); Reed (ID: `flora:Reed`)
