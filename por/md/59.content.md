...
* **Associated ACAI Concepts:** aprovado (ID: `keyterm:Approved`); bem, aventurado (ID: `keyterm:Happy`); love (ID: `keyterm:Love`); promessa (ID: `keyterm:Promise`); Life (ID: `keyterm:Life`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); tentar (ID: `keyterm:PutToTheTest`); bem, aventurado (ID: `keyterm:Happy`); amado (ID: `keyterm:Beloved`); inútil (ID: `keyterm:Worthless`); limpo (ID: `keyterm:Clean`); aprovado (ID: `keyterm:Approved`); be (or show oneself) just (ID: `keyterm:Just`); Life (ID: `keyterm:Life`); sem mancha (ID: `keyterm:AboveCriticism`); Ability (ID: `keyterm:Ability`); que não pode ser tentado (ID: `keyterm:NotTempted`); A Person (ID: `person:GenericPerson`); Good (ID: `keyterm:Good`); salvation (ID: `keyterm:Salvation`); sem mancha (ID: `keyterm:Undefiled`); Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); coração (ID: `keyterm:Heart`); To Sin (ID: `keyterm:Sin`); promessa (ID: `keyterm:Promise`); lei (ID: `keyterm:Law`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** inútil (ID: `keyterm:Worthless`); limpo (ID: `keyterm:Clean`); coração (ID: `keyterm:Heart`); SENHOR (ID: `deity:Lord`); sem mancha (ID: `keyterm:Undefiled`); sem mancha (ID: `keyterm:AboveCriticism`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); favoritismo (ID: `keyterm:Partiality`); distinguir (ID: `keyterm:Discern`); Glory (ID: `keyterm:Glory`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Ability (ID: `keyterm:Ability`); promessa (ID: `keyterm:Promise`); SENHOR (ID: `deity:Lord`); reino (ID: `keyterm:Kingdom`); escolhido (ID: `keyterm:Chosen`); amado (ID: `keyterm:Beloved`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); favoritismo (ID: `keyterm:Partiality`); tropeçar (ID: `keyterm:Stumble`); juízo (ID: `keyterm:Judgment`); love (ID: `keyterm:Love`); escritura (ID: `keyterm:Scripture`); decidir (ID: `keyterm:Decided`); inclemente (ID: `keyterm:Merciless`); To Sin (ID: `keyterm:Sin`); misericórdia (ID: `keyterm:Mercy`); fornication (ID: `keyterm:Fornication`); tribunal de justiça (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); SENHOR (ID: `deity:Lord`); Abraão (ID: `person:Abraham`); A Person (ID: `person:GenericPerson`); corpo (ID: `keyterm:Body.3`); inútil (ID: `keyterm:Idle`); Raabe (ID: `person:Rahab`); An Angel (ID: `deity:Angel`); escritura (ID: `keyterm:Scripture`); Demons (ID: `deity:Demons`); vazio (ID: `keyterm:Empty`); fazer a paz (ID: `keyterm:Peace`); Spirit (ID: `keyterm:Spirit.2`); Isaque (ID: `person:Isaac`); salvation (ID: `keyterm:Salvation`); To Cause to Happen (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** be (or show oneself) just (ID: `keyterm:Just`); escritura (ID: `keyterm:Scripture`); SENHOR (ID: `deity:Lord`); Abraão (ID: `person:Abraham`); crer (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** injustiça (ID: `keyterm:UnjustDeed`); geena (ID: `keyterm:Gehenna`); Hell (ID: `place:Hell`); corpo (ID: `keyterm:Body.3`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); amizade (ID: `keyterm:Friendship`); be unfaithful (ID: `keyterm:Unfaithful`); Cause of Joy (ID: `keyterm:CauseOfJoy`); escritura (ID: `keyterm:Scripture`); desejar (ID: `keyterm:LongFor`); coração (ID: `keyterm:Heart`); To Cleanse (ID: `keyterm:Cleanse.2`); pure (ID: `keyterm:Pure`); Spirit (ID: `keyterm:Spirit.2`); Holy Spirit (ID: `deity:HolySpirit`); Ability (ID: `keyterm:Ability`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** be (or show oneself) just (ID: `keyterm:Just`); testemunhar (ID: `keyterm:BearWitness`); coração (ID: `keyterm:Heart`); condenar (ID: `keyterm:Condemn`); SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); anointed (ID: `keyterm:Anointed`); SENHOR (ID: `deity:Lord`); igreja (ID: `keyterm:Church`); Name (ID: `keyterm:Name`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); To Sin (ID: `keyterm:Sin`); SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); crer (ID: `keyterm:Believe`); forgive (ID: `keyterm:Forgive`)
