...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Chaldeans (ID: `group:Chaldea`); dispossess (ID: `keyterm:Dispossess`); fear (ID: `keyterm:Fear`); Believe In (ID: `keyterm:BelieveIn`); strength (ID: `keyterm:Strength`); Caldéia (ID: `place:Chaldea`); Horse (ID: `fauna:Horse`); Leopard (ID: `fauna:Leopard`); Vulture (ID: `fauna:Vulture`); Wolf (ID: `fauna:Wolf`)
...
* **Associated ACAI Concepts:** Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Casting Net (ID: `realia:CastingNet`); SENHOR (ID: `deity:Lord`); holy (ID: `keyterm:Holy`); pure (ID: `keyterm:Pure`); Fortification (ID: `realia:Fortification`); Lizard (ID: `fauna:Lizard`); Chameleon (ID: `fauna:Chameleon`); Monitor (ID: `fauna:Iguana`); Fish (ID: `fauna:Fish`); Harpoon (ID: `realia:Harpoon`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Hell (ID: `place:Hell`); Vine (ID: `flora:Vine`); Tablet (ID: `realia:Tablet`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); literally: nought (ID: `keyterm:Idol`); Be Disgraced (ID: `keyterm:Disgraced`); Libano (ID: `place:Lebanon`); Hell (ID: `place:Hell`); lean on (ID: `keyterm:LeanOn`); saying (ID: `keyterm:Saying`); Vine (ID: `flora:Vine`); Graven Image (ID: `realia:GravenImage`); Image (ID: `realia:Image`); Molten Image (ID: `realia:MoltenImage`); Money (ID: `realia:Money`); Tablet (ID: `realia:Tablet`); Beam (ID: `realia:Beam`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); Be Disgraced (ID: `keyterm:Disgraced`); Libano (ID: `place:Lebanon`); Woe (ID: `keyterm:Woe.2`)
...
* **Associated ACAI Concepts:** literally: nought (ID: `keyterm:Idol`); SENHOR (ID: `deity:Lord`); Woe (ID: `keyterm:Woe.2`); lean on (ID: `keyterm:LeanOn`); Graven Image (ID: `realia:GravenImage`); Image (ID: `realia:Image`); Molten Image (ID: `realia:MoltenImage`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); Monte Paran (ID: `place:ParanMount`); Temã (ID: `place:Teman`); Cusã (ID: `place:Cushan`); Habacuque (ID: `person:Habakkuk`); anointed (ID: `keyterm:Anointed`); majesty (ID: `keyterm:Majesty`); Oath (ID: `keyterm:Oath`); Midiã (ID: `place:Midian`); mischief (ID: `keyterm:Mischief`); fear (ID: `keyterm:Fear`); holy (ID: `keyterm:Holy`); arrow (ID: `keyterm:Arrow`); Deer (ID: `fauna:Deer`); Vine (ID: `flora:Vine`); Olive Tree (ID: `flora:OliveTree`); Sheepfold (ID: `realia:Sheepfold`); Flock (ID: `fauna:Flock`); Bow (ID: `realia:Bow`); Chariot (ID: `realia:Chariot`); Fig (ID: `flora:Fig`); Animal Pen (ID: `realia:AnimalPen`); Foundation (ID: `realia:Foundation`); Spear (ID: `realia:Spear`); Cattle (ID: `fauna:Bull`); Tent (ID: `realia:Tent`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); Temã (ID: `place:Teman`); Cusã (ID: `place:Cushan`); Monte Paran (ID: `place:ParanMount`); anointed (ID: `keyterm:Anointed`); majesty (ID: `keyterm:Majesty`); SENHOR (ID: `deity:Lord`); Oath (ID: `keyterm:Oath`); Midiã (ID: `place:Midian`); mischief (ID: `keyterm:Mischief`); holy (ID: `keyterm:Holy`); arrow (ID: `keyterm:Arrow`); Bow (ID: `realia:Bow`); Chariot (ID: `realia:Chariot`); Foundation (ID: `realia:Foundation`); Spear (ID: `realia:Spear`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); anointed (ID: `keyterm:Anointed`); SENHOR (ID: `deity:Lord`); Oath (ID: `keyterm:Oath`); arrow (ID: `keyterm:Arrow`); Chariot (ID: `realia:Chariot`); Foundation (ID: `realia:Foundation`); Bow (ID: `realia:Bow`); Spear (ID: `realia:Spear`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); salvation (ID: `keyterm:Salvation`); Vine (ID: `flora:Vine`); Flock (ID: `fauna:Flock`); Fig (ID: `flora:Fig`); Cattle (ID: `fauna:Bull`); Animal Pen (ID: `realia:AnimalPen`); Sheepfold (ID: `realia:Sheepfold`); Olive Tree (ID: `flora:OliveTree`); Goat (ID: `fauna:Goat`)
