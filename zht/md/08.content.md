...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); Ephrathites (ID: `group:Ephrathah`); Chilion (ID: `person:Chilion`); Ephrathah (ID: `person:Ephrathah`); Moab (ID: `place:Moab`); Elimelech (ID: `person:Elimelech`); Bethlehem (ID: `place:Bethlehem`); Tribe of Judah (ID: `group:Judah`); Mahlon (ID: `person:Mahlon`); Judah (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); Bethlehem (ID: `place:Bethlehem`); Ruth (ID: `person:Ruth`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Bless (ID: `keyterm:Bless`); Naomi (ID: `person:Naomi`); LORD (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); To Cause to Possess (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`); Boaz (ID: `person:Boaz`)
...
* **Associated ACAI Concepts:** Rachel (ID: `person:Rachel`); Leah (ID: `person:Leah`); Bethlehem (ID: `place:Bethlehem`); LORD (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Tamar (ID: `person:Tamar`); Tribe of Judah (ID: `group:Judah`); LORD (ID: `deity:Lord`); Perez (ID: `person:Perez`); Judah (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Bless (ID: `keyterm:Bless`); Naomi (ID: `person:Naomi`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Obed (ID: `person:Obed`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Nahshon (ID: `person:Nahshon`); David (ID: `person:David`); Boaz (ID: `person:Boaz`); Jesse (ID: `person:Jesse`); Perez (ID: `person:Perez`)
