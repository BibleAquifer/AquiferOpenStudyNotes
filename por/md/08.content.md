...
* **Associated ACAI Concepts:** Ephrathites (ID: `group:Ephrathah`); Efrata (ID: `person:Ephrathah`); Quiliom (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Judá (ID: `person:Judah.4`); Moabe (ID: `place:Moab`); Judá (ID: `group:Judah`); Malom (ID: `person:Mahlon`); Belém (ID: `place:Bethlehem`); Elimeleque (ID: `person:Elimelech`)
...
* **Associated ACAI Concepts:** Moabe (ID: `place:Moab`); Noemi (ID: `person:Naomi`); Rute (ID: `person:Ruth`); Belém (ID: `place:Bethlehem`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); Moabe (ID: `place:Moab`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Barley (ID: `flora:Barley`); Sickle (ID: `realia:Sickle`)
...
* **Associated ACAI Concepts:** bless (ID: `keyterm:Bless`); SENHOR (ID: `deity:Lord`); Noemi (ID: `person:Naomi`); kindness (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); to cause to possess (ID: `keyterm:Possess`); Moabe (ID: `place:Moab`); Boaz (ID: `person:Boaz`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Lia (ID: `person:Leah`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Elders (ID: `group:GenericElders`); Raquel (ID: `person:Rachel`); Belém (ID: `place:Bethlehem`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Perez (ID: `person:Perez`); Tamar (ID: `person:Tamar`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Noemi (ID: `person:Naomi`); bless (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Hezrom (ID: `person:Hezron.2`); Salmom (ID: `person:Salmon`); Aminadabe (ID: `person:Amminadab`); Obede (ID: `person:Obed`); Ram (ID: `person:Ram`); Boaz (ID: `person:Boaz`); Davi (ID: `person:David`); Perez (ID: `person:Perez`); Naassom (ID: `person:Nahshon`); Jessé (ID: `person:Jesse`)
