...
* **Associated ACAI Concepts:** Paulo (ID: `person:Paul`); salvador (ID: `keyterm:Savior`); hope (ID: `keyterm:Hope`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Timóteo (ID: `person:Timothy`); Paulo (ID: `person:Paul`); crer (ID: `keyterm:Believe`); salvador (ID: `keyterm:Savior`); misericórdia (ID: `keyterm:Mercy`); hope (ID: `keyterm:Hope`); favor (ID: `keyterm:Favor`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** Timóteo (ID: `person:Timothy`); crer (ID: `keyterm:Believe`); misericórdia (ID: `keyterm:Mercy`); favor (ID: `keyterm:Favor`); SENHOR (ID: `deity:Lord`); fazer a paz (ID: `keyterm:Peace`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); lei (ID: `keyterm:Law`); SENHOR (ID: `deity:Lord`); opposite of holy: profane (ID: `keyterm:Profane`); sem lei (ID: `keyterm:Lawless`); be (or show oneself) just (ID: `keyterm:Just`); boa notícia (ID: `keyterm:GoodNews`); Macedônia (ID: `place:Macedonia`); Éfeso (ID: `place:Ephesus`); rogar (ID: `keyterm:AskFor`); Glory (ID: `keyterm:Glory`); coração (ID: `keyterm:Heart`); bem, aventurado (ID: `keyterm:Happy`); sem hipocrisia (ID: `keyterm:Unhypocritical`); Good (ID: `keyterm:Good`); corretamente (ID: `keyterm:Lawfully`); palavreado vazio (ID: `keyterm:EmptyTalk`); consciência (ID: `keyterm:Conscience`); limpo (ID: `keyterm:Clean`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); consciência (ID: `keyterm:Conscience`); sem hipocrisia (ID: `keyterm:Unhypocritical`); limpo (ID: `keyterm:Clean`); love (ID: `keyterm:Love`); coração (ID: `keyterm:Heart`); Good (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); sem lei (ID: `keyterm:Lawless`); opposite of holy: profane (ID: `keyterm:Profane`); be (or show oneself) just (ID: `keyterm:Just`); crer (ID: `keyterm:Believe`); bem, aventurado (ID: `keyterm:Happy`); boa notícia (ID: `keyterm:GoodNews`); palavreado vazio (ID: `keyterm:EmptyTalk`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); corretamente (ID: `keyterm:Lawfully`)
...
* **Associated ACAI Concepts:** bem, aventurado (ID: `keyterm:Happy`); crer (ID: `keyterm:Believe`); boa notícia (ID: `keyterm:GoodNews`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); misericórdia (ID: `keyterm:Mercy`); favor (ID: `keyterm:Favor`); Ability (ID: `keyterm:Ability`); Faithfulness (ID: `keyterm:Faithfulness`); para a eternidade (ID: `keyterm:Always`); imortal (ID: `keyterm:Imperishable`); em cristo (ID: `keyterm:InChrist`); blasfemo (ID: `keyterm:Blasphemous`); não crer (ID: `keyterm:Disbelieve`); SENHOR (ID: `deity:Lord`); surely! (ID: `keyterm:Surely`); love (ID: `keyterm:Love`); Glory (ID: `keyterm:Glory`); servir (ID: `keyterm:Serve`); Life (ID: `keyterm:Life`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Alexandre (ID: `person:Alexander.4`); consciência (ID: `keyterm:Conscience`); Himeneu (ID: `person:Hymenaeus`); crer (ID: `keyterm:Believe`); blasfemar (ID: `keyterm:Blaspheme`); Satanás (ID: `deity:Satan`); Timóteo (ID: `person:Timothy`); Good (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); Daily Life (ID: `keyterm:DailyLife`); resgate (ID: `keyterm:Ransom`); crer (ID: `keyterm:Believe`); salvador (ID: `keyterm:Savior`); rogar (ID: `keyterm:AskFor`); tranquilo (ID: `keyterm:Tranquil`); Gentiles (ID: `group:Gentile`); Jesus (ID: `person:Jesus.2`); testemunhar (ID: `keyterm:BearWitness`); orar (ID: `keyterm:Pray`); Life (ID: `keyterm:Life`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); Adão (ID: `person:Adam`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); Daily Life (ID: `keyterm:DailyLife`); promessa (ID: `keyterm:Promise`); Eva (ID: `person:Eve`); consecration (ID: `keyterm:Consecration.2`); resgate (ID: `keyterm:Ransom`); holy (ID: `keyterm:Holy`); rogar (ID: `keyterm:AskFor`); tranquilo (ID: `keyterm:Tranquil`); Gentiles (ID: `group:Gentile`); piedade (ID: `keyterm:GodlyReverence`); Jesus (ID: `person:Jesus.2`); testemunhar (ID: `keyterm:BearWitness`); Life (ID: `keyterm:Life`); salvador (ID: `keyterm:Savior`); Good (ID: `keyterm:Good`); love (ID: `keyterm:Love`); autoridade (ID: `keyterm:Authority.2`); Gold Jewelry (ID: `realia:GoldJewelry`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); servir (ID: `keyterm:Serve`); orar (ID: `keyterm:Pray`); Faithfulness (ID: `keyterm:Faithfulness`); Jesus (ID: `person:Jesus.2`); testemunhar (ID: `keyterm:BearWitness`); salvation (ID: `keyterm:Salvation`); Adão (ID: `person:Adam`); Truth (ID: `keyterm:Truth`); compreensivo (ID: `keyterm:Gentle`); irrepreensível (ID: `keyterm:WithoutReproach`); Daily Life (ID: `keyterm:DailyLife`); em cristo (ID: `keyterm:InChrist`); promessa (ID: `keyterm:Promise`); Eva (ID: `person:Eve`); que não ama o dinheiro (ID: `keyterm:NotALoverOfMoney`); consecration (ID: `keyterm:Consecration.2`); ofício (ID: `keyterm:PositionOfResponsibility`); resgate (ID: `keyterm:Ransom`); holy (ID: `keyterm:Holy`); rogar (ID: `keyterm:AskFor`); tranquilo (ID: `keyterm:Tranquil`); Gentiles (ID: `group:Gentile`); piedade (ID: `keyterm:GodlyReverence`); (literalmente (ID: `keyterm:DoubleTongued`); Life (ID: `keyterm:Life`); salvador (ID: `keyterm:Savior`); irrepreensível (ID: `keyterm:BeyondReproach`); juízo (ID: `keyterm:Judgment`); Good (ID: `keyterm:Good`); igreja (ID: `keyterm:Church`); consciência (ID: `keyterm:Conscience`); discernir (ID: `keyterm:Interpret`); limpo (ID: `keyterm:Clean`); love (ID: `keyterm:Love`); autoridade (ID: `keyterm:Authority.2`); Gold Jewelry (ID: `realia:GoldJewelry`); Clothing (ID: `realia:Clothing`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** testemunhar (ID: `keyterm:BearWitness`); resgate (ID: `keyterm:Ransom`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Adão (ID: `person:Adam`); crer (ID: `keyterm:Believe`); Eva (ID: `person:Eve`); love (ID: `keyterm:Love`); autoridade (ID: `keyterm:Authority.2`); consecration (ID: `keyterm:Consecration.2`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** servir (ID: `keyterm:Serve`); crer (ID: `keyterm:Believe`); Faithfulness (ID: `keyterm:Faithfulness`); irrepreensível (ID: `keyterm:WithoutReproach`); compreensivo (ID: `keyterm:Gentle`); em cristo (ID: `keyterm:InChrist`); que não ama o dinheiro (ID: `keyterm:NotALoverOfMoney`); ofício (ID: `keyterm:PositionOfResponsibility`); Jesus (ID: `person:Jesus.2`); (literalmente (ID: `keyterm:DoubleTongued`); testemunhar (ID: `keyterm:BearWitness`); irrepreensível (ID: `keyterm:BeyondReproach`); juízo (ID: `keyterm:Judgment`); igreja (ID: `keyterm:Church`); consciência (ID: `keyterm:Conscience`); SENHOR (ID: `deity:Lord`); discernir (ID: `keyterm:Interpret`); limpo (ID: `keyterm:Clean`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Faithfulness (ID: `keyterm:Faithfulness`); Life (ID: `keyterm:Life`); hope (ID: `keyterm:Hope`); Holy Spirit (ID: `deity:HolySpirit`); Truth (ID: `keyterm:Truth`); conduta (ID: `keyterm:Behavior`); be (or show oneself) just (ID: `keyterm:Just`); promessa (ID: `keyterm:Promise`); consecration (ID: `keyterm:Consecration.2`); intercessão (ID: `keyterm:Intercession`); Spirit (ID: `keyterm:Spirit.2`); rogar (ID: `keyterm:AskFor`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); Jesus (ID: `person:Jesus.2`); opposite of holy: profane (ID: `keyterm:Profane`); salvador (ID: `keyterm:Savior`); corpo (ID: `keyterm:Body.3`); proclamar (ID: `keyterm:Proclaim`); pureza (ID: `keyterm:WithoutMoralDefect`); igreja (ID: `keyterm:Church`); salvation (ID: `keyterm:Salvation`); consciência (ID: `keyterm:Conscience`); favor (ID: `keyterm:Favor`); love (ID: `keyterm:Love`); Demons (ID: `deity:Demons`); An Angel (ID: `deity:Angel`); hipocrisia (ID: `keyterm:Hypocrisy`); Capital (ID: `realia:Capital`)
...
* **Associated ACAI Concepts:** Spirit (ID: `keyterm:Spirit.2`); be (or show oneself) just (ID: `keyterm:Just`); crer (ID: `keyterm:Believe`); corpo (ID: `keyterm:Body.3`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); proclamar (ID: `keyterm:Proclaim`); Holy Spirit (ID: `deity:HolySpirit`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); consciência (ID: `keyterm:Conscience`); Faithfulness (ID: `keyterm:Faithfulness`); Demons (ID: `deity:Demons`); consecration (ID: `keyterm:Consecration.2`); intercessão (ID: `keyterm:Intercession`); Holy Spirit (ID: `deity:HolySpirit`); hipocrisia (ID: `keyterm:Hypocrisy`); Truth (ID: `keyterm:Truth`)
...
* **Associated ACAI Concepts:** Faithfulness (ID: `keyterm:Faithfulness`); crer (ID: `keyterm:Believe`); Life (ID: `keyterm:Life`); salvador (ID: `keyterm:Savior`); rogar (ID: `keyterm:AskFor`); promessa (ID: `keyterm:Promise`); hope (ID: `keyterm:Hope`); favor (ID: `keyterm:Favor`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`); pureza (ID: `keyterm:WithoutMoralDefect`); opposite of holy: profane (ID: `keyterm:Profane`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Faithfulness (ID: `keyterm:Faithfulness`); Life (ID: `keyterm:Life`); promessa (ID: `keyterm:Promise`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); crer (ID: `keyterm:Believe`); rogar (ID: `keyterm:AskFor`); Faithfulness (ID: `keyterm:Faithfulness`); Jesus (ID: `person:Jesus.2`); juízo (ID: `keyterm:Judgment`); inútil (ID: `keyterm:Idle`); blasfemar (ID: `keyterm:Blaspheme`); orar (ID: `keyterm:Pray`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); escolhido (ID: `keyterm:Chosen`); holy (ID: `keyterm:Holy`); pure (ID: `keyterm:Pure`); compartilhar (ID: `keyterm:Share`); fear (ID: `keyterm:Fear`); escritura (ID: `keyterm:Scripture`); testemunhar (ID: `keyterm:BearWitness`); Satanás (ID: `deity:Satan`); Life (ID: `keyterm:Life`); irrepreensível (ID: `keyterm:BeyondReproach`); hope (ID: `keyterm:Hope`); be unfaithful (ID: `keyterm:Unfaithful`); witness (ID: `keyterm:Witness`); Good (ID: `keyterm:Good`); pureza (ID: `keyterm:WithoutMoralDefect`); igreja (ID: `keyterm:Church`); testemunhar solenemente (ID: `keyterm:Declare`); amado (ID: `keyterm:Beloved`); Name (ID: `keyterm:Name`); tribunal de justiça (ID: `keyterm:CourtCase`); preconceito (ID: `keyterm:Discrimination`); servir como escravo (ID: `keyterm:Serve.2`); An Angel (ID: `deity:Angel`); Grain (ID: `flora:Grain`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Wine (ID: `realia:Wine`); Yoke (ID: `realia:Yoke`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); inútil (ID: `keyterm:Idle`); holy (ID: `keyterm:Holy`); irrepreensível (ID: `keyterm:BeyondReproach`); juízo (ID: `keyterm:Judgment`); hope (ID: `keyterm:Hope`); Good (ID: `keyterm:Good`); Faithfulness (ID: `keyterm:Faithfulness`); be unfaithful (ID: `keyterm:Unfaithful`); Jesus (ID: `person:Jesus.2`); testemunhar (ID: `keyterm:BearWitness`); orar (ID: `keyterm:Pray`); Satanás (ID: `deity:Satan`); Life (ID: `keyterm:Life`); igreja (ID: `keyterm:Church`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** inútil (ID: `keyterm:Idle`); crer (ID: `keyterm:Believe`); juízo (ID: `keyterm:Judgment`); Jesus (ID: `person:Jesus.2`); Satanás (ID: `deity:Satan`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); escolhido (ID: `keyterm:Chosen`); pure (ID: `keyterm:Pure`); juízo (ID: `keyterm:Judgment`); testemunhar solenemente (ID: `keyterm:Declare`); tribunal de justiça (ID: `keyterm:CourtCase`); fear (ID: `keyterm:Fear`); compartilhar (ID: `keyterm:Share`); SENHOR (ID: `deity:Lord`); preconceito (ID: `keyterm:Discrimination`); Jesus (ID: `person:Jesus.2`); witness (ID: `keyterm:Witness`); escritura (ID: `keyterm:Scripture`); An Angel (ID: `deity:Angel`); Wine (ID: `realia:Wine`); Grain (ID: `flora:Grain`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); escolhido (ID: `keyterm:Chosen`); testemunhar solenemente (ID: `keyterm:Declare`); fear (ID: `keyterm:Fear`); SENHOR (ID: `deity:Lord`); preconceito (ID: `keyterm:Discrimination`); Jesus (ID: `person:Jesus.2`); witness (ID: `keyterm:Witness`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** escolhido (ID: `keyterm:Chosen`); testemunhar solenemente (ID: `keyterm:Declare`); SENHOR (ID: `deity:Lord`); preconceito (ID: `keyterm:Discrimination`); Jesus (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); rogar (ID: `keyterm:AskFor`); amado (ID: `keyterm:Beloved`); blasfemar (ID: `keyterm:Blaspheme`); amor ao dinheiro (ID: `keyterm:LoveOfMoney`); Faithfulness (ID: `keyterm:Faithfulness`); Jesus (ID: `person:Jesus.2`); Bring In (ID: `keyterm:BringIn`); Ability (ID: `keyterm:Ability`); servir como escravo (ID: `keyterm:Serve.2`); tentar (ID: `keyterm:PutToTheTest`); Truth (ID: `keyterm:Truth`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); Foolish (ID: `keyterm:Foolish`); Do Good (ID: `keyterm:DoGood`); Make Alive (ID: `keyterm:Alive`); be (or show oneself) just (ID: `keyterm:Just`); sem mancha (ID: `keyterm:AboveCriticism`); promessa (ID: `keyterm:Promise`); blasfemar (ID: `keyterm:Blaspheme`); amor ao dinheiro (ID: `keyterm:LoveOfMoney`); Bring In (ID: `keyterm:BringIn`); Timóteo (ID: `person:Timothy`); rogar (ID: `keyterm:AskFor`); Faithfulness (ID: `keyterm:Faithfulness`); opposite of holy: profane (ID: `keyterm:Profane`); testemunhar (ID: `keyterm:BearWitness`); bem, aventurado (ID: `keyterm:Happy`); Pilatos (ID: `person:Pilate`); irrepreensível (ID: `keyterm:BeyondReproach`); hope (ID: `keyterm:Hope`); Commandment (ID: `keyterm:Commandment`); witness (ID: `keyterm:Witness`); tentar (ID: `keyterm:PutToTheTest`); generoso (ID: `keyterm:WillingToShare`); amado (ID: `keyterm:Beloved`); favor (ID: `keyterm:Favor`); surely! (ID: `keyterm:Surely`); love (ID: `keyterm:Love`); servir como escravo (ID: `keyterm:Serve.2`); Truth (ID: `keyterm:Truth`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`); Make Alive (ID: `keyterm:Alive`); bem, aventurado (ID: `keyterm:Happy`); Pilatos (ID: `person:Pilate`); be (or show oneself) just (ID: `keyterm:Just`); sem mancha (ID: `keyterm:AboveCriticism`); irrepreensível (ID: `keyterm:BeyondReproach`); Commandment (ID: `keyterm:Commandment`); surely! (ID: `keyterm:Surely`); love (ID: `keyterm:Love`); witness (ID: `keyterm:Witness`); testemunhar (ID: `keyterm:BearWitness`); Life (ID: `keyterm:Life`)
...
* **Associated ACAI Concepts:** surely! (ID: `keyterm:Surely`); para a eternidade (ID: `keyterm:Always`); bem, aventurado (ID: `keyterm:Happy`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Do Good (ID: `keyterm:DoGood`); hope (ID: `keyterm:Hope`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); para a eternidade (ID: `keyterm:Always`); generoso (ID: `keyterm:WillingToShare`)
...
* **Associated ACAI Concepts:** Do Good (ID: `keyterm:DoGood`); hope (ID: `keyterm:Hope`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); para a eternidade (ID: `keyterm:Always`); generoso (ID: `keyterm:WillingToShare`); Life (ID: `keyterm:Life`)
...
* **Associated ACAI Concepts:** Foolish (ID: `keyterm:Foolish`); crer (ID: `keyterm:Believe`); promessa (ID: `keyterm:Promise`); favor (ID: `keyterm:Favor`); Timóteo (ID: `person:Timothy`); opposite of holy: profane (ID: `keyterm:Profane`)
