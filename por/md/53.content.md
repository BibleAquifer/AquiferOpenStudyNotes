...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Tessalônica (ID: `place:Thessalonica`); Thessalonians (ID: `group:Thessalonica`); Silas (ID: `person:Silas`); fazer a paz (ID: `keyterm:Peace`); Paulo (ID: `person:Paul`); igreja (ID: `keyterm:Church`); favor (ID: `keyterm:Favor`); Timóteo (ID: `person:Timothy`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); boa notícia (ID: `keyterm:GoodNews`); Ability (ID: `keyterm:Ability`); igreja (ID: `keyterm:Church`); testemunhar (ID: `keyterm:BearWitness`); ser glorificado (ID: `keyterm:Glorified`); para a eternidade (ID: `keyterm:Always`); Glory (ID: `keyterm:Glory`); holy (ID: `keyterm:Holy`); tribunal de justiça (ID: `keyterm:CourtCase`); reino (ID: `keyterm:Kingdom`); céu (ID: `keyterm:Heaven`); love (ID: `keyterm:Love`); juízo (ID: `keyterm:Judgment`); An Angel (ID: `deity:Angel`); fazer justiça (ID: `keyterm:GrantJustice`); dever (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** céu (ID: `keyterm:Heaven`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); ser glorificado (ID: `keyterm:Glorified`); holy (ID: `keyterm:Holy`); testemunhar (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** Good (ID: `keyterm:Good`); orar (ID: `keyterm:Pray`); Ability (ID: `keyterm:Ability`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ser glorificado (ID: `keyterm:Glorified`); Good (ID: `keyterm:Good`); orar (ID: `keyterm:Pray`); Ability (ID: `keyterm:Ability`); crer (ID: `keyterm:Believe`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); To Cause to Happen (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** ser glorificado (ID: `keyterm:Glorified`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); Spirit (ID: `keyterm:Spirit.2`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); injustiça (ID: `keyterm:UnjustDeed`); objeto de culto (ID: `keyterm:ObjectOfWorship`); love (ID: `keyterm:Love`); Ability (ID: `keyterm:Ability`); decidir (ID: `keyterm:Decided`); Satanás (ID: `deity:Satan`); example (ID: `keyterm:Example`); salvation (ID: `keyterm:Salvation`); wipe (out), destroy (ID: `keyterm:Destroy`); maravilha (ID: `keyterm:Portent`); rogar (ID: `keyterm:AskFor`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); hope (ID: `keyterm:Hope`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`); rogar (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); Glory (ID: `keyterm:Glory`); love (ID: `keyterm:Love`); orar (ID: `keyterm:Pray`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); Faithfulness (ID: `keyterm:Faithfulness`); persuadir (ID: `keyterm:Persuade`); livrar (ID: `keyterm:Deliver`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** tradição (ID: `keyterm:Teaching`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); andar (ID: `keyterm:Live.3`)
...
* **Associated ACAI Concepts:** andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); autoridade (ID: `keyterm:Authority.2`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); tradição (ID: `keyterm:Teaching`); Name (ID: `keyterm:Name`); rogar (ID: `keyterm:AskFor`)
