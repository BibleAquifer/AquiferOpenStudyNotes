...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); bem, aventurado (ID: `keyterm:Happy`); tentar (ID: `keyterm:PutToTheTest`); amado (ID: `keyterm:Beloved`); inútil (ID: `keyterm:Worthless`); limpo (ID: `keyterm:Clean`); aprovado (ID: `keyterm:Approved`); To Sin (ID: `keyterm:Sin`); A Person (ID: `person:GenericPerson`); Truth (ID: `keyterm:Truth`); coração (ID: `keyterm:Heart`); que não pode ser tentado (ID: `keyterm:NotTempted`); Good (ID: `keyterm:Good`); lei (ID: `keyterm:Law`); sem mancha (ID: `keyterm:Undefiled`); be (or show oneself) just (ID: `keyterm:Just`); Life (ID: `keyterm:Life`); sem mancha (ID: `keyterm:AboveCriticism`); promessa (ID: `keyterm:Promise`); Ability (ID: `keyterm:Ability`); love (ID: `keyterm:Love`); salvation (ID: `keyterm:Salvation`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** limpo (ID: `keyterm:Clean`); inútil (ID: `keyterm:Worthless`); coração (ID: `keyterm:Heart`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); sem mancha (ID: `keyterm:AboveCriticism`); sem mancha (ID: `keyterm:Undefiled`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); favoritismo (ID: `keyterm:Partiality`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); Glory (ID: `keyterm:Glory`); distinguir (ID: `keyterm:Discern`); Seal (ID: `realia:Seal`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** promessa (ID: `keyterm:Promise`); escolhido (ID: `keyterm:Chosen`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); reino (ID: `keyterm:Kingdom`); amado (ID: `keyterm:Beloved`); crer (ID: `keyterm:Believe`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); juízo (ID: `keyterm:Judgment`); tropeçar (ID: `keyterm:Stumble`); favoritismo (ID: `keyterm:Partiality`); To Sin (ID: `keyterm:Sin`); escritura (ID: `keyterm:Scripture`); inclemente (ID: `keyterm:Merciless`); misericórdia (ID: `keyterm:Mercy`); tribunal de justiça (ID: `keyterm:CourtCase`); love (ID: `keyterm:Love`); decidir (ID: `keyterm:Decided`); fornication (ID: `keyterm:Fornication`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); A Person (ID: `person:GenericPerson`); Abraão (ID: `person:Abraham`); Raabe (ID: `person:Rahab`); inútil (ID: `keyterm:Idle`); escritura (ID: `keyterm:Scripture`); To Cause to Happen (ID: `keyterm:Happen`); vazio (ID: `keyterm:Empty`); Spirit (ID: `keyterm:Spirit.2`); Demons (ID: `deity:Demons`); An Angel (ID: `deity:Angel`); Isaque (ID: `person:Isaac`); fazer a paz (ID: `keyterm:Peace`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); Abraão (ID: `person:Abraham`); Raabe (ID: `person:Rahab`); inútil (ID: `keyterm:Idle`); escritura (ID: `keyterm:Scripture`); SENHOR (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); vazio (ID: `keyterm:Empty`); corpo (ID: `keyterm:Body.3`); Spirit (ID: `keyterm:Spirit.2`); An Angel (ID: `deity:Angel`); Isaque (ID: `person:Isaac`)
...
* **Associated ACAI Concepts:** escritura (ID: `keyterm:Scripture`); SENHOR (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); crer (ID: `keyterm:Believe`); Abraão (ID: `person:Abraham`); be (or show oneself) just (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** geena (ID: `keyterm:Gehenna`); Ability (ID: `keyterm:Ability`); corpo (ID: `keyterm:Body.3`); injustiça (ID: `keyterm:UnjustDeed`); Hell (ID: `place:Hell`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); amizade (ID: `keyterm:Friendship`); be unfaithful (ID: `keyterm:Unfaithful`); escritura (ID: `keyterm:Scripture`); Ability (ID: `keyterm:Ability`); coração (ID: `keyterm:Heart`); Spirit (ID: `keyterm:Spirit.2`); desejar (ID: `keyterm:LongFor`); Cause of Joy (ID: `keyterm:CauseOfJoy`); pure (ID: `keyterm:Pure`); To Cleanse (ID: `keyterm:Cleanse.2`); favor (ID: `keyterm:Favor`); Holy Spirit (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** pure (ID: `keyterm:Pure`); To Cleanse (ID: `keyterm:Cleanse.2`); coração (ID: `keyterm:Heart`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** coração (ID: `keyterm:Heart`); SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); be (or show oneself) just (ID: `keyterm:Just`); condenar (ID: `keyterm:Condemn`); testemunhar (ID: `keyterm:BearWitness`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Jó (ID: `person:Job`); Compassionate (ID: `keyterm:Compassionate`); SENHOR (ID: `deity:Lord`); considerar feliz (ID: `keyterm:RegardAsHappy`); mui compassivo (ID: `keyterm:FullOfCompassion`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); SENHOR (ID: `deity:Lord`); igreja (ID: `keyterm:Church`); anointed (ID: `keyterm:Anointed`); orar (ID: `keyterm:Pray`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); SENHOR (ID: `deity:Lord`); forgive (ID: `keyterm:Forgive`); crer (ID: `keyterm:Believe`); orar (ID: `keyterm:Pray`); salvation (ID: `keyterm:Salvation`)
