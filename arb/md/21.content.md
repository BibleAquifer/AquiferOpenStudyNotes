...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); أورشَلِيمَ (ID: `place:Jerusalem`); Intention (ID: `keyterm:Intention`); ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vine (ID: `flora:Vine`); إِسْرَائِيلَ (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); أورشَلِيمَ (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`); Vine (ID: `flora:Vine`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vow (ID: `keyterm:Vow`); House (ID: `realia:House`); An Angel (ID: `deity:Angel`); Slaughtering (ID: `keyterm:Slaughtering`); Passion (ID: `keyterm:Ardour`); Strength (ID: `keyterm:Strength`); A Man (ID: `person:GenericMale`); Fear (ID: `keyterm:Fear`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Stupid (ID: `keyterm:Stupid`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); To Cause to Possess (ID: `keyterm:Possess`); To Act Wickedly (ID: `keyterm:ActWickedly`); Intention (ID: `keyterm:Intention`); Fear (ID: `keyterm:Fear`); To Sin (ID: `keyterm:Sin`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Cooking Pot (ID: `realia:CookingPot`); Anointing Oil (ID: `realia:AnointingOil`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Hell (ID: `place:Hell`); Ability (ID: `keyterm:Ability`); ٱلرَّبِّ (ID: `deity:Lord`); Strength (ID: `keyterm:Strength`); Intention (ID: `keyterm:Intention`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); ٱلرَّبِّ (ID: `deity:Lord`); Caper (ID: `flora:Caper`); Money (ID: `realia:Money`); Almond (ID: `flora:Almond`); Pit (ID: `realia:Pit`); Clay Jar (ID: `realia:ClayJar`); Locust (ID: `fauna:Locust`); Rope (ID: `realia:Rope`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Proverb (ID: `keyterm:Saying`); Truth (ID: `keyterm:Truth`); Straightness (ID: `keyterm:Straightness`); Intention (ID: `keyterm:Intention`); Fear (ID: `keyterm:Fear`); Goad (ID: `realia:Goad`); Nail (ID: `realia:Nail`); Flock (ID: `fauna:Flock`); Scroll (ID: `realia:Scroll`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
