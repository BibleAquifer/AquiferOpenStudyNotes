...
* **Associated ACAI Concepts:** dispossess (ID: `keyterm:Dispossess`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Chaldeans (ID: `group:Chaldea`); Caldéia (ID: `place:Chaldea`); Believe In (ID: `keyterm:BelieveIn`); strength (ID: `keyterm:Strength`); Leopard (ID: `fauna:Leopard`); Vulture (ID: `fauna:Vulture`); Horse (ID: `fauna:Horse`); Wolf (ID: `fauna:Wolf`)
...
* **Associated ACAI Concepts:** Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Casting Net (ID: `realia:CastingNet`); SENHOR (ID: `deity:Lord`); pure (ID: `keyterm:Pure`); holy (ID: `keyterm:Holy`); Fortification (ID: `realia:Fortification`); Harpoon (ID: `realia:Harpoon`); Chameleon (ID: `fauna:Chameleon`); Fish (ID: `fauna:Fish`); Monitor (ID: `fauna:Iguana`); Lizard (ID: `fauna:Lizard`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); literally: nought (ID: `keyterm:Idol`); lean on (ID: `keyterm:LeanOn`); Libano (ID: `place:Lebanon`); saying (ID: `keyterm:Saying`); Be Disgraced (ID: `keyterm:Disgraced`); Molten Image (ID: `realia:MoltenImage`); Graven Image (ID: `realia:GravenImage`); Image (ID: `realia:Image`); Money (ID: `realia:Money`); Beam (ID: `realia:Beam`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); Woe (ID: `keyterm:Woe.2`); SENHOR (ID: `deity:Lord`); Libano (ID: `place:Lebanon`); Be Disgraced (ID: `keyterm:Disgraced`)
...
* **Associated ACAI Concepts:** literally: nought (ID: `keyterm:Idol`); lean on (ID: `keyterm:LeanOn`); SENHOR (ID: `deity:Lord`); Woe (ID: `keyterm:Woe.2`); Molten Image (ID: `realia:MoltenImage`); Graven Image (ID: `realia:GravenImage`); Image (ID: `realia:Image`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); Temã (ID: `place:Teman`); Cusã (ID: `place:Cushan`); Habacuque (ID: `person:Habakkuk`); Monte Paran (ID: `place:ParanMount`); mischief (ID: `keyterm:Mischief`); fear (ID: `keyterm:Fear`); arrow (ID: `keyterm:Arrow`); Midiã (ID: `place:Midian`); holy (ID: `keyterm:Holy`); majesty (ID: `keyterm:Majesty`); anointed (ID: `keyterm:Anointed`); Oath (ID: `keyterm:Oath`); Deer (ID: `fauna:Deer`); Sheepfold (ID: `realia:Sheepfold`); Fig (ID: `flora:Fig`); Olive Tree (ID: `flora:OliveTree`); Chariot (ID: `realia:Chariot`); Foundation (ID: `realia:Foundation`); Goat (ID: `fauna:Goat`); Spear (ID: `realia:Spear`); Cattle (ID: `fauna:Bull`); Tent (ID: `realia:Tent`); Flock (ID: `fauna:Flock`); Vine (ID: `flora:Vine`); Bow (ID: `realia:Bow`); Animal Pen (ID: `realia:AnimalPen`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); Temã (ID: `place:Teman`); Cusã (ID: `place:Cushan`); Monte Paran (ID: `place:ParanMount`); mischief (ID: `keyterm:Mischief`); arrow (ID: `keyterm:Arrow`); Midiã (ID: `place:Midian`); holy (ID: `keyterm:Holy`); SENHOR (ID: `deity:Lord`); majesty (ID: `keyterm:Majesty`); anointed (ID: `keyterm:Anointed`); Oath (ID: `keyterm:Oath`); Chariot (ID: `realia:Chariot`); Foundation (ID: `realia:Foundation`); Spear (ID: `realia:Spear`); Tent (ID: `realia:Tent`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); SENHOR (ID: `deity:Lord`); arrow (ID: `keyterm:Arrow`); Oath (ID: `keyterm:Oath`); anointed (ID: `keyterm:Anointed`); Chariot (ID: `realia:Chariot`); Spear (ID: `realia:Spear`); Foundation (ID: `realia:Foundation`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); salvation (ID: `keyterm:Salvation`); Sheepfold (ID: `realia:Sheepfold`); Cattle (ID: `fauna:Bull`); Fig (ID: `flora:Fig`); Olive Tree (ID: `flora:OliveTree`); Flock (ID: `fauna:Flock`); Animal Pen (ID: `realia:AnimalPen`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`)
