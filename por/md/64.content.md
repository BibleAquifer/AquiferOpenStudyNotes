...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); andar (ID: `keyterm:Live.3`); amado (ID: `keyterm:Beloved`); Gaio (ID: `person:Gaius.4`); testemunhar (ID: `keyterm:BearWitness`); love (ID: `keyterm:Love`); Cause of Joy (ID: `keyterm:CauseOfJoy`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** testemunhar (ID: `keyterm:BearWitness`); SENHOR (ID: `deity:Lord`); amado (ID: `keyterm:Beloved`); Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); Faithfulness (ID: `keyterm:Faithfulness`); Name (ID: `keyterm:Name`); igreja (ID: `keyterm:Church`); dever (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** igreja (ID: `keyterm:Church`); Demétrio (ID: `person:Demetrius`); Diótrefes (ID: `person:Diotrephes`); testemunhar (ID: `keyterm:BearWitness`); SENHOR (ID: `deity:Lord`); amado (ID: `keyterm:Beloved`); Truth (ID: `keyterm:Truth`); verdadeiro (ID: `keyterm:True`); Do Good (ID: `keyterm:DoGood`); Good (ID: `keyterm:Good`)
