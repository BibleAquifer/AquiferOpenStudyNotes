...
* **Associated ACAI Concepts:** Éphrata (ID: `person:Ephrathah`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); Kiljon (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Machlon (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Bethléhem (ID: `place:Bethlehem`); Juda (ID: `group:Judah`); Élimélec (ID: `person:Elimelech`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Bethléhem (ID: `place:Bethlehem`); Naomi (ID: `person:Naomi`); Ruth (ID: `person:Ruth`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Machlon (ID: `person:Mahlon`); Moab (ID: `place:Moab`); laissiez en possession (ID: `keyterm:Possess`); Ruth (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Elders (ID: `group:GenericElders`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); Bethléhem (ID: `place:Bethlehem`); Rachel (ID: `person:Rachel`); Léa (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Perets (ID: `person:Perez`); Juda (ID: `group:Judah`); Tamar (ID: `person:Tamar`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Hetsron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Obed (ID: `person:Obed`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Isaï (ID: `person:Jesse`); David (ID: `person:David`); Perets (ID: `person:Perez`); Nahshon (ID: `person:Nahshon`); Boaz (ID: `person:Boaz`)
