...
* **Associated ACAI Concepts:** Efrata (ID: `person:Ephrathah`); Noemi (ID: `person:Naomi`); Ephrathites (ID: `group:Ephrathah`); Quiliom (ID: `person:Chilion`); Moabe (ID: `place:Moab`); Malom (ID: `person:Mahlon`); Belém (ID: `place:Bethlehem`); Elimeleque (ID: `person:Elimelech`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Moabe (ID: `place:Moab`); Rute (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); Belém (ID: `place:Bethlehem`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Moabe (ID: `place:Moab`); Rute (ID: `person:Ruth`); favor (ID: `keyterm:Favor`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elders (ID: `group:GenericElders`); SENHOR (ID: `deity:Lord`); Belém (ID: `place:Bethlehem`); Raquel (ID: `person:Rachel`); Lia (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Noemi (ID: `person:Naomi`); bless (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Hezrom (ID: `person:Hezron.2`); Salmom (ID: `person:Salmon`); Obede (ID: `person:Obed`); Aminadabe (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Davi (ID: `person:David`); Jessé (ID: `person:Jesse`); Perez (ID: `person:Perez`); Naassom (ID: `person:Nahshon`); Boaz (ID: `person:Boaz`)
