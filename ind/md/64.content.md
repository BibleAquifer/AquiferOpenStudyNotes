...
* **Associated ACAI Concepts:** kebenaran (ID: `keyterm:Truth`); hidup (ID: `keyterm:Live.3`); kekasih (ID: `keyterm:Beloved`); Gayus (ID: `person:Gaius.4`); berdoa (ID: `keyterm:Pray`); bersaksi (ID: `keyterm:BearWitness`); Cause of Joy (ID: `keyterm:CauseOfJoy`); kasihi (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** jemaat (ID: `keyterm:Church`); kekasih (ID: `keyterm:Beloved`); Tuhan (ID: `deity:Lord`); bersaksi (ID: `keyterm:BearWitness`); kesetiaan (ID: `keyterm:Faithfulness`); wajib (ID: `keyterm:Ought`); kebenaran (ID: `keyterm:Truth`); kasihi (ID: `keyterm:Love`); nama (ID: `keyterm:Name`)
...
* **Associated ACAI Concepts:** jemaat (ID: `keyterm:Church`); Diotrefes (ID: `person:Diotrephes`); Demetrius (ID: `person:Demetrius`); kekasih (ID: `keyterm:Beloved`); Tuhan (ID: `deity:Lord`); bersaksi (ID: `keyterm:BearWitness`); benar (ID: `keyterm:True`); kebenaran (ID: `keyterm:Truth`); yang baik (ID: `keyterm:Good`); lakukan baik (ID: `keyterm:DoGood`)
...
* **Associated ACAI Concepts:** Ink (ID: `realia:Ink`); Pen (ID: `realia:Pen`); harapan (ID: `keyterm:Hope`); memperdamaikan (ID: `keyterm:Peace`); nama (ID: `keyterm:Name`); Reed (ID: `flora:Reed`)
