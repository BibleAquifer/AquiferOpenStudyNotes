...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); Fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); Hell (ID: `place:Hell`); Vow (ID: `keyterm:Vow`); أَمِتَّايَ (ID: `person:Amittai`); يَافَا (ID: `place:Joppa`); نِينَوَى (ID: `place:Nineveh`); Slaughtering (ID: `keyterm:Slaughtering`); Kindness (ID: `keyterm:Kindness`); Salvation (ID: `keyterm:Salvation`); Praise (ID: `keyterm:Praise`); Hebrews (ID: `group:Hebrews`); Lot (ID: `keyterm:Lot`); تَرْشِيشَ (ID: `place:Tarshish`); Exempt (ID: `keyterm:Exempt`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Hell (ID: `place:Hell`); يونَانَ (ID: `person:Jonah.2`); Kindness (ID: `keyterm:Kindness`); Praise (ID: `keyterm:Praise`); Vow (ID: `keyterm:Vow`); Salvation (ID: `keyterm:Salvation`); Fish (ID: `fauna:Fish`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** Kindness (ID: `keyterm:Kindness`); Praise (ID: `keyterm:Praise`); Vow (ID: `keyterm:Vow`); ٱلرَّبِّ (ID: `deity:Lord`); Salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); نِينَوَى (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Generous (ID: `keyterm:Generous`); تَرْشِيشَ (ID: `place:Tarshish`); Kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`); Believe In (ID: `keyterm:BelieveIn`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Clothing (ID: `realia:Clothing`); Throne (ID: `realia:Throne`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); Generous (ID: `keyterm:Generous`); تَرْشِيشَ (ID: `place:Tarshish`); Kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Generous (ID: `keyterm:Generous`); تَرْشِيشَ (ID: `place:Tarshish`); Kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`); ٱلرَّبِّ (ID: `deity:Lord`)
