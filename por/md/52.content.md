...
* **Associated ACAI Concepts:** Macedônia (ID: `place:Macedonia`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Atenas (ID: `place:Athens`); boa notícia (ID: `keyterm:GoodNews`); rogar (ID: `keyterm:AskFor`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** exortar (ID: `keyterm:Encourage`); amor fraternal (ID: `keyterm:LoveForOnesFellowBeliever`); rogar (ID: `keyterm:AskFor`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** exortar (ID: `keyterm:Encourage`); amor fraternal (ID: `keyterm:LoveForOnesFellowBeliever`); Jesus (ID: `person:Jesus.2`)
