...
* **Associated ACAI Concepts:** Ephrathites (ID: `group:Ephrathah`); Ephrathah (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Chilion (ID: `person:Chilion`); Elimelech (ID: `person:Elimelech`); Judah (ID: `person:Judah.4`); Mahlon (ID: `person:Mahlon`); Bethlehem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Tribe of Judah (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); LORD (ID: `deity:Lord`); Bless (ID: `keyterm:Bless`); Kindness (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Boaz (ID: `person:Boaz`); To Cause to Possess (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Bethlehem (ID: `place:Bethlehem`); Rachel (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); LORD (ID: `deity:Lord`); Leah (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Bless (ID: `keyterm:Bless`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Salmon (ID: `person:Salmon`); Hezron (ID: `person:Hezron.2`); Amminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Boaz (ID: `person:Boaz`); David (ID: `person:David`); Jesse (ID: `person:Jesse`); Perez (ID: `person:Perez`); Nahshon (ID: `person:Nahshon`)
