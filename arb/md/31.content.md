...
* **Associated ACAI Concepts:** Peace (ID: `keyterm:IntactState`); أَدومَ (ID: `place:Edom`); Edomites (ID: `group:Edom`); Understanding (ID: `keyterm:Understanding`); Covenant (ID: `keyterm:Covenant`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** أَدومَ (ID: `place:Edom`); ٱلرَّبِّ (ID: `deity:Lord`); Understanding (ID: `keyterm:Understanding`); عِيسو (ID: `place:EsauMount`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Lot (ID: `keyterm:Lot`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); أَدومَ (ID: `place:Edom`); Edomites (ID: `group:Edom`); يوسف (ID: `person:Joseph.10`); أورشَلِيمَ (ID: `place:Jerusalem`); Dispossess (ID: `keyterm:Dispossess`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); Dispossess (ID: `keyterm:Dispossess`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); أَدومَ (ID: `place:Edom`); Edomites (ID: `group:Edom`); ٱلرَّبِّ (ID: `deity:Lord`); يوسف (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); ٱلْجَنوبِ (ID: `place:Negeb`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); بَنْيَامِينَ (ID: `group:Benjamin`); Canaanites (ID: `group:Canaan`); ٱلسَّهْلِ (ID: `place:Shephelah`); إِلَى (ID: `place:Zarephath`); كَنْعَان (ID: `place:Canaan`); فِلِشْتِيم (ID: `group:Philistine`); سَارْدِسَ (ID: `place:Sardis`); أَفْرَايِمَ (ID: `group:Ephraim`); جِلْعَادَ (ID: `place:Gilead`); عِيسو (ID: `place:EsauMount`); أَفْرَايِمَ (ID: `person:Ephraim`); ٱلسَّامِرَةِ (ID: `place:Samaria`); بَنْيَامِينَ (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); عِيسو (ID: `place:EsauMount`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); أَفْرَايِمَ (ID: `person:Ephraim`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); ٱلسَّهْلِ (ID: `place:Shephelah`); بَنْيَامِينَ (ID: `group:Benjamin`); سَارْدِسَ (ID: `place:Sardis`); كَنْعَان (ID: `place:Canaan`); فِلِشْتِيم (ID: `group:Philistine`); ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `person:Benjamin`); إِلَى (ID: `place:Zarephath`); أَفْرَايِمَ (ID: `group:Ephraim`); جِلْعَادَ (ID: `place:Gilead`); Canaanites (ID: `group:Canaan`); ٱلسَّامِرَةِ (ID: `place:Samaria`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); إِلَى (ID: `place:Zarephath`); سَارْدِسَ (ID: `place:Sardis`); ٱلْجَنوبِ (ID: `place:Negeb`); Canaanites (ID: `group:Canaan`); كَنْعَان (ID: `place:Canaan`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); عِيسو (ID: `place:EsauMount`)
