...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); دَارِيوسَ (ID: `person:Darius.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); حَجَّيِ (ID: `person:Haggai`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); حَجَّيِ (ID: `person:Haggai`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَشوع (ID: `person:Joshua.5`); دَارِيوسَ (ID: `person:Darius.2`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); An Angel (ID: `deity:Angel`); Fear (ID: `keyterm:Fear`); Olive Oil (ID: `realia:OliveOil`); Mule (ID: `fauna:Mule`); Bag (ID: `realia:Bag`); Grain (ID: `flora:Grain`); Must (ID: `realia:Must`); Vine (ID: `flora:Vine`); Olive Tree (ID: `flora:OliveTree`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); Fear (ID: `keyterm:Fear`); يَشوع (ID: `person:Joshua.5`); ٱلرَّبِّ (ID: `deity:Lord`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); حَجَّيِ (ID: `person:Haggai`); يَهوصَادِقَ (ID: `person:Jehozadak`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); حَجَّيِ (ID: `person:Haggai`); Peace (ID: `keyterm:IntactState`); مِصْرَ (ID: `place:Egypt`); Fear (ID: `keyterm:Fear`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `person:Judah.4`); حَجَّيِ (ID: `person:Haggai`); يَهوذَا (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Sword (ID: `realia:Sword`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`)
