...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); love (ID: `keyterm:Love`); Wine (ID: `realia:Wine`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Jerusalém (ID: `place:Jerusalem`); En-Gedi (ID: `place:Engedi`); Salomão (ID: `person:Solomon`); Quedar (ID: `person:Kedar`); fairness (ID: `keyterm:Fairness`); Faraó (ID: `person:Pharaoh.7`); Henna (ID: `flora:Henna`); Nard (ID: `flora:Nard`); Anointing Oil (ID: `realia:AnointingOil`); Chariot (ID: `realia:Chariot`); Tent (ID: `realia:Tent`); Horse (ID: `fauna:Horse`); Money (ID: `realia:Money`); Bag (ID: `realia:Bag`); Kid (ID: `fauna:Kid`); Goat Hair Strips (ID: `realia:GoatHairStrips`); Olive Oil (ID: `realia:OliveOil`); Linen Strips (ID: `realia:LinenStrips`); Myrrh (ID: `flora:Myrrh`)
...
* **Associated ACAI Concepts:** Quedar (ID: `person:Kedar`); Jerusalém (ID: `place:Jerusalem`); Salomão (ID: `person:Solomon`); Goat Hair Strips (ID: `realia:GoatHairStrips`); Linen Strips (ID: `realia:LinenStrips`); Tent (ID: `realia:Tent`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); love (ID: `keyterm:Love`); Quedar (ID: `person:Kedar`); Faraó (ID: `person:Pharaoh.7`); Jerusalém (ID: `place:Jerusalem`); Salomão (ID: `person:Solomon`); Kid (ID: `fauna:Kid`); Vine (ID: `flora:Vine`); Chariot (ID: `realia:Chariot`); Goat Hair Strips (ID: `realia:GoatHairStrips`); Linen Strips (ID: `realia:LinenStrips`); Horse (ID: `fauna:Horse`); Tent (ID: `realia:Tent`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Deer (ID: `fauna:Deer`); Gazelle (ID: `fauna:Gazelle`); Dove (ID: `fauna:Dove`); Beter (ID: `place:BetherMountain`); Window (ID: `realia:Window`); Jackal (ID: `fauna:Jackal`); Fig (ID: `flora:Fig`); Lily (ID: `flora:Lily`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Jerusalém (ID: `place:Jerusalem`); love (ID: `keyterm:Love`); Libano (ID: `place:Lebanon`); Israel (ID: `person:Israel`); Crown (ID: `realia:Crown`); Frankincense (ID: `flora:Frankincense`); Purple Cloth (ID: `realia:PurpleCloth`); Bier (ID: `realia:Bier`); Sword (ID: `realia:Sword`); Myrrh (ID: `flora:Myrrh`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Balsam Tree (ID: `flora:BalsamTree`); Libano (ID: `place:Lebanon`); Myrrh (ID: `flora:Myrrh`); Pomegranate (ID: `flora:Pomegranate`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Flock (ID: `fauna:Flock`); Frankincense (ID: `flora:Frankincense`); Nard (ID: `flora:Nard`); Goat (ID: `fauna:Goat`); Veil (ID: `realia:Veil`); Monte Amana (ID: `place:Amana`); Monte Hermom (ID: `place:HermonMount`); Davi (ID: `person:David`); Gileade (ID: `place:Gilead`); Calamus (ID: `flora:Calamus`); Henna (ID: `flora:Henna`); Saffron Plant (ID: `flora:SaffronPlant`); Anointing Oil (ID: `realia:AnointingOil`); Leopard (ID: `fauna:Leopard`); Lion (ID: `fauna:Lion`); Agarwood (ID: `flora:Agarwood`); Gazelle (ID: `fauna:Gazelle`); Lily (ID: `flora:Lily`); Small Shield (ID: `realia:SmallShield`); Dove (ID: `fauna:Dove`); Thread (ID: `realia:Thread`); Cloak (ID: `realia:Cloak`); Olive Oil (ID: `realia:OliveOil`); Tower (ID: `realia:Tower`); Cinnamon (ID: `flora:Cinnamon`)
...
* **Associated ACAI Concepts:** Libano (ID: `place:Lebanon`); Anointing Oil (ID: `realia:AnointingOil`); Cloak (ID: `realia:Cloak`); Olive Oil (ID: `realia:OliveOil`); Balsam Tree (ID: `flora:BalsamTree`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Libano (ID: `place:Lebanon`); Lily (ID: `flora:Lily`); Crow (ID: `fauna:Crow`); Cedar (ID: `flora:Cedar`); Balsam Tree (ID: `flora:BalsamTree`); Dove (ID: `fauna:Dove`); Myrrh (ID: `flora:Myrrh`)
...
* **Associated ACAI Concepts:** Libano (ID: `place:Lebanon`); Lily (ID: `flora:Lily`); Crow (ID: `fauna:Crow`); Cedar (ID: `flora:Cedar`); Balsam Tree (ID: `flora:BalsamTree`); Dove (ID: `fauna:Dove`); Myrrh (ID: `flora:Myrrh`)
...
* **Associated ACAI Concepts:** Standard (ID: `realia:Standard`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Tirza (ID: `place:Tirzah`); Jerusalém (ID: `place:Jerusalem`); Gileade (ID: `place:Gilead`); Pomegranate (ID: `flora:Pomegranate`); Veil (ID: `realia:Veil`); Dove (ID: `fauna:Dove`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Date Palm (ID: `flora:DatePalm`); Wine (ID: `realia:Wine`); Shulammites (ID: `group:Shulammites`); Bate-Rabim (ID: `place:Bath-rabbim`); love (ID: `keyterm:Love`); Libano (ID: `place:Lebanon`); Carmelo (ID: `place:Carmel`); fairness (ID: `keyterm:Fairness`); Hesbom (ID: `place:Heshbon`); Damasco (ID: `place:Damascus`); Apple (ID: `flora:AppleTree`); Purple Cloth (ID: `realia:PurpleCloth`); Wheat (ID: `flora:Wheat`); Gazelle (ID: `fauna:Gazelle`); Tower (ID: `realia:Tower`); Lily (ID: `flora:Lily`)
...
* **Associated ACAI Concepts:** Bate-Rabim (ID: `place:Bath-rabbim`); Libano (ID: `place:Lebanon`); Carmelo (ID: `place:Carmel`); Hesbom (ID: `place:Heshbon`); Damasco (ID: `place:Damascus`); Purple Cloth (ID: `realia:PurpleCloth`); Wheat (ID: `flora:Wheat`); Tower (ID: `realia:Tower`); Wine (ID: `realia:Wine`); Gazelle (ID: `fauna:Gazelle`); Lily (ID: `flora:Lily`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Jerusalém (ID: `place:Jerusalem`); swear (ID: `keyterm:Swear`); Must (ID: `realia:Must`); Pomegranate (ID: `flora:Pomegranate`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
