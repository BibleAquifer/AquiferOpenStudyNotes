...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); berbahagialah (ID: `keyterm:Happy`); mencobai (ID: `keyterm:PutToTheTest`); kekasih (ID: `keyterm:Beloved`); suci (ID: `keyterm:Clean`); sia, sia (ID: `keyterm:Worthless`); tahan uji (ID: `keyterm:Approved`); tidak dapat dicobai (ID: `keyterm:NotTempted`); keselamatan (ID: `keyterm:Salvation`); berbuat dosa (ID: `keyterm:Sin`); keahlian (ID: `keyterm:Ability`); kehidupan (ID: `keyterm:Life`); hati (ID: `keyterm:Heart`); tidak dicemarkan (ID: `keyterm:Undefiled`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); yang baik (ID: `keyterm:Good`); kasihi (ID: `keyterm:Love`); tak bernoda (ID: `keyterm:AboveCriticism`); A Person (ID: `person:GenericPerson`); hukum (ID: `keyterm:Law`); janji (ID: `keyterm:Promise`); kebenaran (ID: `keyterm:Truth`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** tonton bulu atau muka (ID: `keyterm:Partiality`); kemuliaan (ID: `keyterm:Glory`); percaya (ID: `keyterm:Believe`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); tonton bulu atau muka (ID: `keyterm:Partiality`); percaya (ID: `keyterm:Believe`); kemuliaan (ID: `keyterm:Glory`); Yesus (ID: `person:Jesus.2`); bimbang (ID: `keyterm:Discern`); Seal (ID: `realia:Seal`); Synagogue (ID: `realia:Synagogue`); Footstool (ID: `realia:Footstool`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); kerajaan (ID: `keyterm:Kingdom`); kekasih (ID: `keyterm:Beloved`); Tuhan (ID: `deity:Lord`); orang pilihan (ID: `keyterm:Chosen`); keahlian (ID: `keyterm:Ability`); janji (ID: `keyterm:Promise`); kasihi (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** kasihi (ID: `keyterm:Love`); kitab suci (ID: `keyterm:Scripture`); hukum (ID: `keyterm:Law`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); tonton bulu atau muka (ID: `keyterm:Partiality`); penghakiman (ID: `keyterm:Judgment`); tersandung (ID: `keyterm:Stumble`); pengadilan (ID: `keyterm:CourtCase`); kitab suci (ID: `keyterm:Scripture`); belas kasihan (ID: `keyterm:Mercy`); berbuat dosa (ID: `keyterm:Sin`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`); persundalan (ID: `keyterm:Fornication`); memutuskan (ID: `keyterm:Decided`); kasihi (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); A Person (ID: `person:GenericPerson`); Tuhan (ID: `deity:Lord`); tubuh (ID: `keyterm:Body.3`); Abraham (ID: `person:Abraham`); sia, sia (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); menggenapi (ID: `keyterm:Happen`); kitab suci (ID: `keyterm:Scripture`); roh (ID: `keyterm:Spirit.2`); Ishak (ID: `person:Isaac`); hampa (ID: `keyterm:Empty`); An Angel (ID: `deity:Angel`); keselamatan (ID: `keyterm:Salvation`); memperdamaikan (ID: `keyterm:Peace`); Demons (ID: `deity:Demons`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menggenapi (ID: `keyterm:Happen`); kitab suci (ID: `keyterm:Scripture`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Tuhan (ID: `deity:Lord`); Abraham (ID: `person:Abraham`)
...
* **Associated ACAI Concepts:** Hell (ID: `place:Hell`); keahlian (ID: `keyterm:Ability`); tubuh (ID: `keyterm:Body.3`); lalim (ID: `keyterm:UnjustDeed`); neraka (ID: `keyterm:Gehenna`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); tidak setia (ID: `keyterm:Unfaithful`); persahabatan (ID: `keyterm:Friendship`); murni (ID: `keyterm:Pure`); kitab suci (ID: `keyterm:Scripture`); hati (ID: `keyterm:Heart`); roh (ID: `keyterm:Spirit.2`); Cause of Joy (ID: `keyterm:CauseOfJoy`); keahlian (ID: `keyterm:Ability`); membersihkan (ID: `keyterm:Cleanse.2`); kebaikan (ID: `keyterm:Favor`); ingin (ID: `keyterm:LongFor`); Roh (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** ingin (ID: `keyterm:LongFor`); kitab suci (ID: `keyterm:Scripture`); Roh (ID: `deity:HolySpirit`); roh (ID: `keyterm:Spirit.2`)
...
* **Associated ACAI Concepts:** hati (ID: `keyterm:Heart`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Tuhan (ID: `deity:Lord`); bersaksi (ID: `keyterm:BearWitness`); tubuh (ID: `keyterm:Body.3`); menentang (ID: `keyterm:Condemn`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** jemaat (ID: `keyterm:Church`); berdoa (ID: `keyterm:Pray`); Tuhan (ID: `deity:Lord`); diurapi (ID: `keyterm:Anointed`); nama (ID: `keyterm:Name`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); berdoa (ID: `keyterm:Pray`); Tuhan (ID: `deity:Lord`); berbuat dosa (ID: `keyterm:Sin`); keselamatan (ID: `keyterm:Salvation`); mengampuni (ID: `keyterm:Forgive`)
