...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Ageu (ID: `person:Haggai`); Dario (ID: `person:Darius.2`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Ageu (ID: `person:Haggai`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Sealtiel (ID: `person:Shealtiel.2`); Josué (ID: `person:Joshua.5`); Dario (ID: `person:Darius.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); An Angel (ID: `deity:Angel`); fear (ID: `keyterm:Fear`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); Grain (ID: `flora:Grain`); Mule (ID: `fauna:Mule`); Bag (ID: `realia:Bag`); Must (ID: `realia:Must`); Olive Oil (ID: `realia:OliveOil`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Ageu (ID: `person:Haggai`); fear (ID: `keyterm:Fear`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Ageu (ID: `person:Haggai`); Judá (ID: `group:Judah`); Sealtiel (ID: `person:Shealtiel.2`); Judá (ID: `person:Judah.4`); Egito (ID: `place:Egypt`); fear (ID: `keyterm:Fear`); Word of the Lord (ID: `keyterm:WordOfTheLord`); peace (ID: `keyterm:IntactState`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ageu (ID: `person:Haggai`); defilement (ID: `keyterm:Defilement`); Vine (ID: `flora:Vine`); Word of the Lord (ID: `keyterm:WordOfTheLord`); holy (ID: `keyterm:Holy`); bless (ID: `keyterm:Bless`); Instruction (ID: `keyterm:Instruction`); Dario (ID: `person:Darius.2`); Anointing Oil (ID: `realia:AnointingOil`); Barley (ID: `flora:Barley`); Pomegranate (ID: `flora:Pomegranate`); Olive Tree (ID: `flora:OliveTree`); Fig (ID: `flora:Fig`); Grain (ID: `flora:Grain`); Wine (ID: `realia:Wine`); Stew (ID: `realia:Stew`); Coriander (ID: `flora:Coriander`); Olive Oil (ID: `realia:OliveOil`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Sealtiel (ID: `person:Shealtiel.2`); Ageu (ID: `person:Haggai`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Sword (ID: `realia:Sword`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`)
