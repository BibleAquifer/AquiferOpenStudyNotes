...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); zélé (ID: `keyterm:Zealous.3`); Carmel (ID: `place:Carmel`); chemin (ID: `keyterm:TheWay`); Liban (ID: `place:Lebanon`); force (ID: `keyterm:Strength`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Basan (ID: `place:Bashan`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); zélé (ID: `keyterm:Zealous.3`); méchanceté (ID: `keyterm:Wickedness`); se réfugier (ID: `keyterm:SeekfindRefuge`); Carmel (ID: `place:Carmel`); chemin (ID: `keyterm:TheWay`); Liban (ID: `place:Lebanon`); force (ID: `keyterm:Strength`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Basan (ID: `place:Bashan`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`); Strong Drink (ID: `realia:StrongDrink`)
...
* **Associated ACAI Concepts:** déclarer innocent (ID: `keyterm:PronounceInnocent`); force (ID: `keyterm:Strength`); chemin (ID: `keyterm:TheWay`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Juda (ID: `person:Judah.4`); état intact (ID: `keyterm:IntactState`); faire un voeu (ID: `keyterm:Vow`); méchanceté (ID: `keyterm:Wickedness`); Juda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); Éternel (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Flock (ID: `fauna:Flock`); Chariot (ID: `realia:Chariot`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); destin (ID: `keyterm:Lot`); Cush (ID: `place:Cush.2`); Libya (ID: `place:Libya`); Puth (ID: `place:Put`); Égypte (ID: `place:Egypt`)
