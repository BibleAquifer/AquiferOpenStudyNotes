...
* **Associated ACAI Concepts:** Moabe (ID: `place:Moab`); Belém (ID: `place:Bethlehem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Quiliom (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Efrata (ID: `person:Ephrathah`); Ephrathites (ID: `group:Ephrathah`); Belém (ID: `place:Bethlehem`); Judá (ID: `group:Judah`); Elimeleque (ID: `person:Elimelech`); Moabe (ID: `place:Moab`); Malom (ID: `person:Mahlon`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Belém (ID: `place:Bethlehem`); Noemi (ID: `person:Naomi`); Rute (ID: `person:Ruth`); Moabe (ID: `place:Moab`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); favor (ID: `keyterm:Favor`); Moabe (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** kindness (ID: `keyterm:Kindness`); Noemi (ID: `person:Naomi`); bless (ID: `keyterm:Bless`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); Boaz (ID: `person:Boaz`); to cause to possess (ID: `keyterm:Possess`); Moabe (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); Malom (ID: `person:Mahlon`); to cause to possess (ID: `keyterm:Possess`); Moabe (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Belém (ID: `place:Bethlehem`); Elders (ID: `group:GenericElders`); Raquel (ID: `person:Rachel`); Lia (ID: `person:Leah`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Perez (ID: `person:Perez`); Tamar (ID: `person:Tamar`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Noemi (ID: `person:Naomi`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); bless (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Hezrom (ID: `person:Hezron.2`); Salmom (ID: `person:Salmon`); Aminadabe (ID: `person:Amminadab`); Obede (ID: `person:Obed`); Ram (ID: `person:Ram`); Perez (ID: `person:Perez`); Naassom (ID: `person:Nahshon`); Boaz (ID: `person:Boaz`); Davi (ID: `person:David`); Jessé (ID: `person:Jesse`)
