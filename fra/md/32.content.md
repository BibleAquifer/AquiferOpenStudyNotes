...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); craindre (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); faire un voeu (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); Joppa (ID: `place:Joppa`); Ninive (ID: `place:Nineveh`); Amitthaï (ID: `person:Amittai`); tuerie (ID: `keyterm:Slaughtering`); bonté (ID: `keyterm:Kindness`); Hebrews (ID: `group:Hebrews`); louange (ID: `keyterm:Praise`); destin (ID: `keyterm:Lot`); parole du seigneur (ID: `keyterm:WordOfTheLord`); exempt (ID: `keyterm:Exempt`); Tarsis (ID: `place:Tarshish`); aide (ID: `keyterm:Salvation`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Hell (ID: `place:Hell`); louange (ID: `keyterm:Praise`); bonté (ID: `keyterm:Kindness`); faire un voeu (ID: `keyterm:Vow`); aide (ID: `keyterm:Salvation`); Jonas (ID: `person:Jonah.2`); Cattails (ID: `flora:Cattails`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** louange (ID: `keyterm:Praise`); Éternel (ID: `deity:Lord`); bonté (ID: `keyterm:Kindness`); faire un voeu (ID: `keyterm:Vow`); aide (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Ninive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); parole du seigneur (ID: `keyterm:WordOfTheLord`); fie (ID: `keyterm:BelieveIn`); Tarsis (ID: `place:Tarshish`); bonté (ID: `keyterm:Kindness`); bienveillant (ID: `keyterm:Generous`); miséricordieux (ID: `keyterm:Compassionate`); Goat (ID: `fauna:Goat`); Throne (ID: `realia:Throne`); Clothing (ID: `realia:Clothing`); Flock (ID: `fauna:Flock`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); Tarsis (ID: `place:Tarshish`); bonté (ID: `keyterm:Kindness`); bienveillant (ID: `keyterm:Generous`); miséricordieux (ID: `keyterm:Compassionate`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Tarsis (ID: `place:Tarshish`); bonté (ID: `keyterm:Kindness`); bienveillant (ID: `keyterm:Generous`); miséricordieux (ID: `keyterm:Compassionate`)
