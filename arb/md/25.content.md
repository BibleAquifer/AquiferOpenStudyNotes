...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); Rebel (ID: `keyterm:Rebel`); يَهوذَا (ID: `group:Judah`); Strength (ID: `keyterm:Strength`); يَهوذَا (ID: `person:Judah.4`); Love (ID: `keyterm:Love`); Deceit (ID: `keyterm:Deceit`); Appointed Feast (ID: `keyterm:AppointedFeast`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Defilement (ID: `keyterm:Defilement`); Mighty One (ID: `keyterm:MightyOne`); To Sin (ID: `keyterm:Sin`); Work (ID: `keyterm:Work`); إِسْرَائِيلَ (ID: `person:Israel`); Train (ID: `realia:Train`); Net (ID: `realia:Net`); Grass (ID: `flora:Grass`); Goat (ID: `fauna:Goat`); Yoke (ID: `realia:Yoke`); Casting Net (ID: `realia:CastingNet`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Deer (ID: `fauna:Deer`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Defilement (ID: `keyterm:Defilement`); To Sin (ID: `keyterm:Sin`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Appointed Feast (ID: `keyterm:AppointedFeast`); Horn (ID: `keyterm:Horn`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Sheep (ID: `fauna:Lamb`); Utterance (ID: `keyterm:Utterance`); Sabbath (ID: `keyterm:Sabbath`); Instruction (ID: `keyterm:Instruction`); Passion (ID: `keyterm:Ardour`); Gentiles (ID: `group:Gentile`); To Dishonor (ID: `keyterm:Dishonor`); Have a Vision (ID: `keyterm:HaveAVision`); Bow (ID: `realia:Bow`); Sackcloth (ID: `realia:Sackcloth`); Tent (ID: `realia:Tent`); Grain (ID: `flora:Grain`); Altar (ID: `realia:Altar`); Wine (ID: `realia:Wine`); Measuring Reed (ID: `realia:MeasuringReed`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Vine (ID: `flora:Vine`); House (ID: `realia:House`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); Horn (ID: `keyterm:Horn`); Tent (ID: `realia:Tent`); Bow (ID: `realia:Bow`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Sabbath (ID: `keyterm:Sabbath`); Appointed Feast (ID: `keyterm:AppointedFeast`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Wormwood (ID: `flora:Wormwood`); Arrow (ID: `realia:Arrow`); Arrow (ID: `keyterm:Arrow`); Peace (ID: `keyterm:IntactState`); Complete (ID: `keyterm:Complete`); Kindness (ID: `keyterm:Kindness`); Hewn Stone (ID: `realia:HewnStone`); Bow (ID: `realia:Bow`); Bear (ID: `fauna:Bear`); Lion (ID: `fauna:Lion`); Bitter Herbs (ID: `flora:Chicory`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Peace (ID: `keyterm:IntactState`); Salvation (ID: `keyterm:Salvation`); Redeem (ID: `keyterm:Redeem`); Arrow (ID: `keyterm:Arrow`); Fear (ID: `keyterm:Fear`); To Sin (ID: `keyterm:Sin`); Forgive (ID: `keyterm:Forgive`); Complete (ID: `keyterm:Complete`); Hope (ID: `keyterm:Hope`); Rebel (ID: `keyterm:Rebel`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Pit (ID: `realia:Pit`); Arrow (ID: `realia:Arrow`); Wormwood (ID: `flora:Wormwood`); Bow (ID: `realia:Bow`); Bitter Herbs (ID: `flora:Chicory`); Hewn Stone (ID: `realia:HewnStone`); Yoke (ID: `realia:Yoke`); Bear (ID: `fauna:Bear`); Lion (ID: `fauna:Lion`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); ٱلرَّبِّ (ID: `deity:Lord`); أَدومَ (ID: `place:Edom`); To Sin (ID: `keyterm:Sin`); Defile (ID: `keyterm:Stain`); عوصًا (ID: `place:Uz`); Punishment (ID: `keyterm:Punishment`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Anointed (ID: `keyterm:Anointed`); Appoint (ID: `keyterm:Appoint`); Defilement (ID: `keyterm:Defilement`); Believe In (ID: `keyterm:BelieveIn`); سَدومَ (ID: `place:Sodom`); Complete (ID: `keyterm:Complete`); Ostrich (ID: `fauna:Ostrich`); Jackal (ID: `fauna:Jackal`); Purple Cloth (ID: `realia:PurpleCloth`); Vulture (ID: `fauna:Vulture`); Clay Jar (ID: `realia:ClayJar`)
...
* **Associated ACAI Concepts:** أَدومَ (ID: `place:Edom`); عوصًا (ID: `place:Uz`); Passion (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`); أورشَلِيمَ (ID: `place:Jerusalem`); Complete (ID: `keyterm:Complete`); Appoint (ID: `keyterm:Appoint`)
...
* **Associated ACAI Concepts:** Passion (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`); أورشَلِيمَ (ID: `place:Jerusalem`); أَدومَ (ID: `place:Edom`); Complete (ID: `keyterm:Complete`); Appoint (ID: `keyterm:Appoint`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); مِصْرَ (ID: `place:Egypt`); Round Dance (ID: `keyterm:RoundDance`); To Cause to Possess (ID: `keyterm:Possess`); Woe (ID: `keyterm:Woe`); يَهوذَا (ID: `person:Judah.4`); Assyria (ID: `place:Assyria`); يَهوذَا (ID: `group:Judah`); Money (ID: `realia:Money`); Crown (ID: `realia:Crown`); Hand-Mill (ID: `realia:Hand-mill`); Jackal (ID: `fauna:Jackal`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Round Dance (ID: `keyterm:RoundDance`); To Sin (ID: `keyterm:Sin`); Woe (ID: `keyterm:Woe`); Crown (ID: `realia:Crown`); Hand-Mill (ID: `realia:Hand-mill`)
