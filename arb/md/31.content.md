...
* **Associated ACAI Concepts:** Understanding (ID: `keyterm:Understanding`); Edomites (ID: `group:Edom`); Peace (ID: `keyterm:IntactState`); أَدومَ (ID: `place:Edom`); Covenant (ID: `keyterm:Covenant`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); عِيسو (ID: `place:EsauMount`); أَدومَ (ID: `place:Edom`); Understanding (ID: `keyterm:Understanding`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Lot (ID: `keyterm:Lot`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Dispossess (ID: `keyterm:Dispossess`); Edomites (ID: `group:Edom`); أورشَلِيمَ (ID: `place:Jerusalem`); يوسف (ID: `person:Joseph.10`); أَدومَ (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); إِسْرَائِيلَ (ID: `person:Israel`); يوسف (ID: `person:Joseph.10`); ٱلرَّبِّ (ID: `deity:Lord`); أَدومَ (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); ٱلسَّهْلِ (ID: `place:Shephelah`); أَفْرَايِمَ (ID: `group:Ephraim`); فِلِشْتِيم (ID: `group:Philistine`); إِسْرَائِيلَ (ID: `person:Israel`); Canaanites (ID: `group:Canaan`); بَنْيَامِينَ (ID: `group:Benjamin`); أورشَلِيمَ (ID: `place:Jerusalem`); جِلْعَادَ (ID: `place:Gilead`); ٱلسَّامِرَةِ (ID: `place:Samaria`); بَنْيَامِينَ (ID: `person:Benjamin`); سَارْدِسَ (ID: `place:Sardis`); عِيسو (ID: `place:EsauMount`); كَنْعَان (ID: `place:Canaan`); إِلَى (ID: `place:Zarephath`); أَفْرَايِمَ (ID: `person:Ephraim`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`)
...
* **Associated ACAI Concepts:** ٱلْجَنوبِ (ID: `place:Negeb`); عِيسو (ID: `place:EsauMount`); Dispossess (ID: `keyterm:Dispossess`); أورشَلِيمَ (ID: `place:Jerusalem`); كَنْعَان (ID: `place:Canaan`); أَفْرَايِمَ (ID: `person:Ephraim`); أَفْرَايِمَ (ID: `group:Ephraim`); إِسْرَائِيلَ (ID: `person:Israel`); بَنْيَامِينَ (ID: `group:Benjamin`); بَنْيَامِينَ (ID: `person:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); ٱلسَّهْلِ (ID: `place:Shephelah`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); Canaanites (ID: `group:Canaan`); فِلِشْتِيم (ID: `group:Philistine`); جِلْعَادَ (ID: `place:Gilead`); ٱلسَّامِرَةِ (ID: `place:Samaria`); سَارْدِسَ (ID: `place:Sardis`); إِلَى (ID: `place:Zarephath`)
...
* **Associated ACAI Concepts:** ٱلْجَنوبِ (ID: `place:Negeb`); Canaanites (ID: `group:Canaan`); Dispossess (ID: `keyterm:Dispossess`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); سَارْدِسَ (ID: `place:Sardis`); كَنْعَان (ID: `place:Canaan`); إِلَى (ID: `place:Zarephath`)
