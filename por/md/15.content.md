...
* **Associated ACAI Concepts:** Pérsia (ID: `place:Persia`); Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Jeremias (ID: `person:Jeremiah.6`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); House (ID: `realia:House`); Israel (ID: `person:Israel`); Jeremias (ID: `person:Jeremiah.6`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `person:Benjamin`); Levi (ID: `group:Levi`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Benjamim (ID: `group:Benjamin`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Ciro (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Pérsia (ID: `place:Persia`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `person:Judah.4`); Ciro (ID: `person:Cyrus`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Jerusalém (ID: `place:Jerusalem`); Salomão (ID: `person:Solomon`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Gaar (ID: `person:Gahar`); Bebai (ID: `person:Bebai`); Gidel (ID: `person:Giddel.2`); Netofa (ID: `place:Netophah`); Hacoz (ID: `person:Hakkoz.2`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Harim (ID: `person:Harim.2`); Paseia (ID: `person:Paseah.2`); Harsa (ID: `person:Harsha`); Necoda (ID: `person:Nekoda.2`); Reum (ID: `person:Rehum`); Uza (ID: `person:Uzza.2`); Hatil (ID: `person:Hattil`); Seraias (ID: `person:Seraiah.6`); Mordecai (ID: `person:Mordecai`); Nephushesim (ID: `group:Nephushesim`); Zia (ID: `person:Ziha`); Jedaías (ID: `person:Jedaiah.4`); Bani (ID: `person:Bani`); Zatu (ID: `person:Zattu.2`); Tel-Harsa (ID: `place:Tel-harsha`); Querube (ID: `place:Cherub`); Harim (ID: `person:Harim`); Bilsã (ID: `person:Bilshan`)
...
* **Associated ACAI Concepts:** Reelaías (ID: `person:Reelaiah`); Neemias (ID: `person:Nehemiah`); Baana (ID: `person:Baanah.3`); Seraias (ID: `person:Seraiah.6`); Mispar (ID: `person:Mispar`); Mordecai (ID: `person:Mordecai`); Bigvai (ID: `person:Bigvai`); Reum (ID: `person:Rehum`); Bilsã (ID: `person:Bilshan`); Israel (ID: `person:Israel`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** Hasum (ID: `person:Hashum`); Adim (ID: `person:Adin`); Zacai (ID: `person:Zaccai.2`); Bebai (ID: `person:Bebai`); Bigvai (ID: `person:Bigvai.2`); Bezai (ID: `person:Bezai`); Ará (ID: `person:Arah.2`); Sephatias (ID: `person:Shephatiah.6`); Jesua (ID: `person:Jeshua.3`); Joabe (ID: `person:Joab.3`); Elam (ID: `person:Elam`); Jora (ID: `person:Jorah`); Paate-Moabe (ID: `person:Pahath-moab`); Adonicão (ID: `person:Adonikam`); Ater (ID: `person:Ater`); Parós (ID: `person:Parosh`); Asgade (ID: `person:Azgad`); Bani (ID: `person:Bani`); Zatu (ID: `person:Zattu.2`); Ezequias (ID: `person:Hezekiah.2`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Senaa (ID: `place:Senaah`); Netofa (ID: `place:Netophah`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Harim (ID: `person:Harim.2`); Hadide (ID: `place:Hadid`); Nebo (ID: `place:Nebo.2`); Magbis (ID: `place:Magbish`); Betel (ID: `place:Bethel`); Ai (ID: `place:Ai`); Geba (ID: `place:Geba`); Anatote (ID: `place:Anathoth`); Jericó (ID: `place:Jericho`); Quiriate-Jearim (ID: `place:Kiriath-jearim`); Elam (ID: `person:Elam`); Ono (ID: `place:Ono`); Ramah (ID: `place:Ramah.2`); Beerote (ID: `place:Beeroth`); Belém (ID: `place:Bethlehem`); Micmás (ID: `place:Michmash`); Lode (ID: `place:Lod`); Cefira (ID: `place:Chephirah`)
...
* **Associated ACAI Concepts:** Hatita (ID: `person:Hatita`); Ater (ID: `person:Ater.2`); Jesua (ID: `person:Jeshua`); Jesua (ID: `person:Jeshua.4`); Imer (ID: `person:Immer.2`); Talmom (ID: `person:Talmon`); Harim (ID: `person:Harim`); Jedaías (ID: `person:Jedaiah.4`); Hodavias (ID: `person:Hodaviah.4`); Sobai (ID: `person:Shobai`); Levi (ID: `person:Levi.3`); Pasur (ID: `person:Pashhur`); Levi (ID: `group:Levi`); Cadmiel (ID: `person:Kadmiel`); Acube (ID: `person:Akkub.2`); Salum (ID: `person:Shallum.8`); Asafe (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** Hatita (ID: `person:Hatita`); Ater (ID: `person:Ater.2`); Talmom (ID: `person:Talmon`); Sobai (ID: `person:Shobai`); Acube (ID: `person:Akkub.2`); Salum (ID: `person:Shallum.8`); Asafe (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** Lebana (ID: `person:Lebanah`); Gaar (ID: `person:Gahar`); Besai (ID: `person:Besai`); Necoda (ID: `person:Nekoda`); Tabaote (ID: `person:Tabbaoth`); Baquebuque (ID: `person:Bakbuk`); Temá (ID: `person:Temah`); Hagaba (ID: `person:Hagabah`); Sia (ID: `person:Siaha`); Gidel (ID: `person:Giddel`); Gazão (ID: `person:Gazzam`); Paseia (ID: `person:Paseah.2`); Reaías (ID: `person:Reaiah.3`); Barcos (ID: `person:Barkos`); Harsa (ID: `person:Harsha`); Queros (ID: `person:Keros`); Hasufa (ID: `person:Hasupha`); Uza (ID: `person:Uzza.2`); Harur (ID: `person:Harhur`); Acube (ID: `person:Akkub.3`); Rezim (ID: `person:Rezin.2`); Salmai (ID: `person:Shalmai`); Meunim (ID: `group:Meunim`); Hacufa (ID: `person:Hakupha`); Hagabe (ID: `person:Hagab`); Nephushesim (ID: `group:Nephushesim`); Sisera (ID: `person:Sisera.2`); Meída (ID: `person:Mehida`); Zia (ID: `person:Ziha`); Asná (ID: `person:Asnah`); Hatifa (ID: `person:Hatipha`); Nesias (ID: `person:Neziah`); Padom (ID: `person:Padon`); Bazlite (ID: `person:Bazluth`); Hanã (ID: `person:Hanan.4`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Sephatias (ID: `person:Shephatiah.7`); Jaala (ID: `person:Jaalah`); Darcom (ID: `person:Darkon`); Gidel (ID: `person:Giddel.2`); Sotai (ID: `person:Sotai`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Peruda (ID: `person:Peruda`); Soferete (ID: `person:Sophereth`); Hatil (ID: `person:Hattil`); Ami (ID: `person:Ami`)
...
* **Associated ACAI Concepts:** Tel-Melá (ID: `place:Tel-melah`); Adã (ID: `place:Addan`); Imer (ID: `place:Immer`); Necoda (ID: `person:Nekoda.2`); Tel-Harsa (ID: `place:Tel-harsha`); Querube (ID: `place:Cherub`); Tobias (ID: `person:Tobiah`); Delaías (ID: `person:Delaiah.3`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Barzillai (ID: `person:Barzillai.3`); Hacoz (ID: `person:Hakkoz.2`); Habaiah (ID: `person:Habaiah`); Barzillai (ID: `person:Barzillai`); priesthood (ID: `keyterm:Priesthood`); Gileade (ID: `place:Gilead`); Gileadites (ID: `group:Gilead`); stain (ID: `keyterm:Stain`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); Jerusalém (ID: `place:Jerusalem`); strength (ID: `keyterm:Strength`); SENHOR (ID: `deity:Lord`); Mina (ID: `realia:Mina`); Money (ID: `realia:Money`); Tunic (ID: `realia:Tunic`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Josué (ID: `person:Joshua.5`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Relatives (ID: `group:Relatives`); Cadmiel (ID: `person:Kadmiel`); Jesua (ID: `person:Jeshua.4`); Hodavias (ID: `person:Hodaviah.4`); Henadade (ID: `person:Henadad`); Esar-Hadom (ID: `person:Esarhaddon`); Tyrians (ID: `group:Tyre`); Hodias (ID: `person:Hodiah.2`); Sidom (ID: `place:Sidon`); Jope (ID: `place:Joppa`); Asafe (ID: `person:Asaph.2`); Dario (ID: `person:Darius.2`); holy (ID: `keyterm:Holy`); Sidonians (ID: `group:Sidon`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); Benjamim (ID: `group:Benjamin`); kindness (ID: `keyterm:Kindness`); appointed feast (ID: `keyterm:AppointedFeast`); terror (ID: `keyterm:Terror`); Tiro (ID: `place:Tyre`); Instruction (ID: `keyterm:Instruction`); Libano (ID: `place:Lebanon`); Moisés (ID: `person:Moses`); counsel (ID: `keyterm:Counsel`); Benjamim (ID: `person:Benjamin`); Assyria (ID: `place:Assyria`); Davi (ID: `person:David`); new moon festival (ID: `keyterm:NewMoonFestival`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`); Craftsman (ID: `realia:Craftsman`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); offering (ID: `keyterm:Offering`); Moisés (ID: `person:Moses`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); terror (ID: `keyterm:Terror`); offering (ID: `keyterm:Offering`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); holy (ID: `keyterm:Holy`); appointed feast (ID: `keyterm:AppointedFeast`); new moon festival (ID: `keyterm:NewMoonFestival`)
...
* **Associated ACAI Concepts:** Pérsia (ID: `place:Persia`); Tyrians (ID: `group:Tyre`); Sidonians (ID: `group:Sidon`); Sidom (ID: `place:Sidon`); Tiro (ID: `place:Tyre`); Jope (ID: `place:Joppa`); Libano (ID: `place:Lebanon`); Ciro (ID: `person:Cyrus`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Craftsman (ID: `realia:Craftsman`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `group:Levi`); Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); SENHOR (ID: `deity:Lord`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Davi (ID: `person:David`); kindness (ID: `keyterm:Kindness`); Asafe (ID: `person:Asaph.2`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `person:Benjamin`); Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`); Benjamim (ID: `group:Benjamin`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Pérsia (ID: `place:Persia`); Israel (ID: `person:Israel`); Zorobabel (ID: `person:Zerubbabel.2`); SENHOR (ID: `deity:Lord`); Ciro (ID: `person:Cyrus`); Josué (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Artaxerxes (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Pérsia (ID: `place:Persia`); Samaria (ID: `place:Samaria`); Ereque (ID: `place:Erech`); Mitredate (ID: `person:Mithredath.2`); Bislão (ID: `person:Bishlam`); Assuero (ID: `person:Ahasuerus`); Tabeel (ID: `person:Tabeel`); Dinaítas (ID: `person:Dinaite`); Babylonians (ID: `group:Babylon`); Osnapar (ID: `person:Osnappar`); Susã (ID: `place:Susa`); Persians (ID: `group:Persia`); Judá (ID: `group:Judah`); Elamites (ID: `group:Elam`); Elam (ID: `place:Elam`); Judá (ID: `person:Judah.4`); Babilônia (ID: `place:Babylon`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Dinaítas (ID: `person:Dinaite`); Babylonians (ID: `group:Babylon`); Ereque (ID: `place:Erech`); Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Pérsia (ID: `place:Persia`); Susã (ID: `place:Susa`); Elam (ID: `place:Elam`); Babilônia (ID: `place:Babylon`); Persians (ID: `group:Persia`); Elamites (ID: `group:Elam`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Sinsai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Samaria (ID: `place:Samaria`); Reum (ID: `person:Rehum.2`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Jerusalém (ID: `place:Jerusalem`); Artaxerxes (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Dario (ID: `person:Darius.2`); Jews (ID: `group:Jews`); Tattenai (ID: `person:Tattenai`); Ageu (ID: `person:Haggai`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Zacarias (ID: `person:Zechariah.17`); Ido (ID: `person:Iddo.6`); Pérsia (ID: `place:Persia`); Israel (ID: `person:Israel`); Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); Judá (ID: `person:Judah.4`); Rio Eufrates (ID: `place:Euphrates`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** Ageu (ID: `person:Haggai`); Zacarias (ID: `person:Zechariah.17`); Ido (ID: `person:Iddo.6`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Zorobabel (ID: `person:Zerubbabel.2`); Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Caldéia (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); Babilônia (ID: `place:Babylon`); Nabucodonozor (ID: `person:Nebuchadnezzar`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Babilônia (ID: `place:Babylon`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Ciro (ID: `person:Cyrus`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); passover (ID: `keyterm:Passover`); Levi (ID: `group:Levi`); pure (ID: `keyterm:Pure`)
...
* **Associated ACAI Concepts:** Azarias (ID: `person:Azariah.7`); Seraias (ID: `person:Seraiah.2`); Ezra (ID: `person:Ezra`); Pérsia (ID: `place:Persia`); Hilquias (ID: `person:Hilkiah.2`); Artaxerxes (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Azarias (ID: `person:Azariah.6`); Buqui (ID: `person:Bukki.2`); Meraiote (ID: `person:Meraioth`); Uzi (ID: `person:Uzzi`); Zadoque (ID: `person:Zadok.4`); Seraias (ID: `person:Seraiah.2`); Salum (ID: `person:Shallum.7`); Abisua (ID: `person:Abishua`); Azarias (ID: `person:Azariah.7`); Amarias (ID: `person:Amariah.2`); Zeraías (ID: `person:Zerahiah`); Aitube (ID: `person:Ahitub.3`); Artaxerxes (ID: `person:Artaxerxes`); Fineias (ID: `person:Phinehas`); Pérsia (ID: `place:Persia`); Arão (ID: `person:Aaron`); Eleazar (ID: `person:Eleazar.2`); Hilquias (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Babilônia (ID: `place:Babylon`); Instruction (ID: `keyterm:Instruction`); Moisés (ID: `person:Moses`)
...
* **Associated ACAI Concepts:** decree (ID: `keyterm:Decree`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Ezra (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); Ezra (ID: `person:Ezra`); Artaxerxes (ID: `person:Artaxerxes`); Israel (ID: `person:Israel`); Levi (ID: `group:Levi`); Rio Eufrates (ID: `place:Euphrates`); Levi (ID: `person:Levi.3`); decree (ID: `keyterm:Decree`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Babilônia (ID: `place:Babylon`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Sheep (ID: `fauna:Lamb`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Talent (ID: `realia:Talent`); Kor (ID: `realia:Kor`); Altar (ID: `realia:Altar`); Wheat (ID: `flora:Wheat`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Artaxerxes (ID: `person:Artaxerxes`); Rio Eufrates (ID: `place:Euphrates`); Ezra (ID: `person:Ezra`); Money (ID: `realia:Money`); Wheat (ID: `flora:Wheat`); Kor (ID: `realia:Kor`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** Joabe (ID: `person:Joab.4`); Adim (ID: `person:Adin`); Josifias (ID: `person:Josiphiah`); Secanias (ID: `person:Shecaniah.6`); Bebai (ID: `person:Bebai`); Hatus (ID: `person:Hattush.2`); Jeiel (ID: `person:Jehiel.7`); Bigvai (ID: `person:Bigvai.2`); Jônatas (ID: `person:Jonathan.9`); Zacur (ID: `person:Zaccur.5`); Secanias (ID: `person:Shecaniah.5`); Daniel (ID: `person:Daniel.2`); Zacarias (ID: `person:Zechariah.19`); Sephatias (ID: `person:Shephatiah.6`); Atalia (ID: `person:Athaliah.3`); Jesaías (ID: `person:Jeshaiah.4`); Miguel (ID: `person:Michael.10`); Elam (ID: `person:Elam`); Utai (ID: `person:Uthai.2`); Zabadias (ID: `person:Zebadiah.8`); Paate-Moabe (ID: `person:Pahath-moab`); Gérson (ID: `person:Gershom.2`); Joanã (ID: `person:Johanan.8`); Adonicão (ID: `person:Adonikam`); Zacarias (ID: `person:Zechariah.18`); Selomite (ID: `person:Shelomith.4`); Semaías (ID: `person:Shemaiah.14`); Obadias (ID: `person:Obadiah.10`); Jeuel (ID: `person:Jeuel.3`); Parós (ID: `person:Parosh.2`); Zeraías (ID: `person:Zerahiah.2`); Hacatã (ID: `person:Hakkatan`); Ebede (ID: `person:Ebed.2`); Asgade (ID: `person:Azgad`); Elifelete (ID: `person:Eliphelet.5`); Bebai (ID: `person:Bebai.2`); Elioenai (ID: `person:Eliehoenai.2`); Jaaziel (ID: `person:Jahaziel.5`); Artaxerxes (ID: `person:Artaxerxes`); Fineias (ID: `person:Phinehas`); Itamar (ID: `person:Ithamar`); Babilônia (ID: `place:Babylon`); Davi (ID: `person:David`)
...
* **Associated ACAI Concepts:** Ariel (ID: `person:Ariel`); Elnatã (ID: `person:Elnathan.4`); Jaribe (ID: `person:Jarib.2`); Semaías (ID: `person:Shemaiah.15`); Elnatã (ID: `person:Elnathan.2`); Joiaribe (ID: `person:Joiarib.2`); Natã (ID: `person:Nathan.5`); Ido (ID: `person:Iddo`); Eliezer (ID: `person:Eliezer.8`); Zacarias (ID: `person:Zechariah.20`); Elnatã (ID: `person:Elnathan.3`); Casifia (ID: `place:Casiphia`); Mesulão (ID: `person:Meshullam.9`); SENHOR (ID: `deity:Lord`); perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Insight (ID: `keyterm:Insight`); Mali (ID: `person:Mahli`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); Levi (ID: `person:Levi.3`); Canaã (ID: `place:Canaan`); Amorites (ID: `group:Amorites`); Levi (ID: `group:Levi`); Israel (ID: `person:Israel`); cananeu (ID: `group:Canaan`); Egyptians (ID: `group:Egypt`); Amom (ID: `place:Ammon`); be unfaithful (ID: `keyterm:Unfaithful`); Jebusites (ID: `group:Jebusites`); Ammonites (ID: `group:Ammon`); Hete (ID: `person:Heth`); Moabe (ID: `place:Moab`); Egito (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); House (ID: `realia:House`); Harim (ID: `person:Harim`); counsel (ID: `keyterm:Counsel`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Elam (ID: `person:Elam`); offering (ID: `keyterm:Offering`); Benjamim (ID: `person:Benjamin.3`); Eliezer (ID: `person:Eliezer.9`); Eliasibe (ID: `person:Eliashib.5`); Vanias (ID: `person:Vaniah`); Natanael (ID: `person:Nethanel.8`); Bedias (ID: `person:Bedeiah`); Semaías (ID: `person:Shemaiah.16`); Matitias (ID: `person:Mattithiah.3`); Jeiel (ID: `person:Jehiel.10`); Judá (ID: `person:Judah.5`); Manassés (ID: `person:Manasseh.4`); Matanias (ID: `person:Mattaniah.8`); Mesulão (ID: `person:Meshullam.11`); Seal (ID: `person:Sheal`); Jaasai (ID: `person:Jaasu`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); defilement (ID: `keyterm:Defilement`); Jerusalém (ID: `place:Jerusalem`); Pérsia (ID: `place:Persia`); kindness (ID: `keyterm:Kindness`); Israel (ID: `person:Israel`); supplication (ID: `keyterm:Supplication`); peace (ID: `keyterm:IntactState`); to cause to possess (ID: `keyterm:Possess`); dispossess (ID: `keyterm:Dispossess`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); Pérsia (ID: `place:Persia`); Jerusalém (ID: `place:Jerusalem`); kindness (ID: `keyterm:Kindness`); supplication (ID: `keyterm:Supplication`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jeiel (ID: `person:Jehiel.8`); Secanias (ID: `person:Shecaniah.7`); Elam (ID: `person:Elam`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); be unfaithful (ID: `keyterm:Unfaithful`); Ezra (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** Covenant (ID: `keyterm:Covenant`); SENHOR (ID: `deity:Lord`); counsel (ID: `keyterm:Counsel`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `person:Benjamin`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`); Benjamim (ID: `group:Benjamin`); Judá (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mesulão (ID: `person:Meshullam.10`); Jazeías (ID: `person:Jahzeiah`); Asael (ID: `person:Asahel.4`); Jônatas (ID: `person:Jonathan.10`); Sabetai (ID: `person:Shabbethai`); Ticva (ID: `person:Tikvah.2`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`)
