...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); House (ID: `realia:House`); Jeremias (ID: `person:Jeremiah.6`); Israel (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Judá (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Benjamim (ID: `person:Benjamin`); Levi (ID: `group:Levi`); Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `group:Benjamin`); Judá (ID: `group:Judah`); Levi (ID: `person:Levi.3`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Pérsia (ID: `place:Persia`); Ciro (ID: `person:Cyrus`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Levi (ID: `person:Levi.3`); Salomão (ID: `person:Solomon`); Levi (ID: `group:Levi`); Jerusalém (ID: `place:Jerusalem`); Harur (ID: `person:Harhur`); Sephatias (ID: `person:Shephatiah.6`); Ezequias (ID: `person:Hezekiah.2`); Harsa (ID: `person:Harsha`); Asgade (ID: `person:Azgad`); Hatita (ID: `person:Hatita`); Baana (ID: `person:Baanah.3`); Zacai (ID: `person:Zaccai.2`); Sisera (ID: `person:Sisera.2`); Hatifa (ID: `person:Hatipha`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Harim (ID: `person:Harim.2`); Nebo (ID: `place:Nebo.2`); Hadide (ID: `place:Hadid`); Nesias (ID: `person:Neziah`); Soferete (ID: `person:Sophereth`); Jesua (ID: `person:Jeshua.3`); Netofa (ID: `place:Netophah`); Meunim (ID: `group:Meunim`); Necoda (ID: `person:Nekoda`); Rezim (ID: `person:Rezin.2`); Imer (ID: `place:Immer`); Jora (ID: `person:Jorah`); Harim (ID: `person:Harim`)
...
* **Associated ACAI Concepts:** Baana (ID: `person:Baanah.3`); Bilsã (ID: `person:Bilshan`); Seraias (ID: `person:Seraiah.6`); Mispar (ID: `person:Mispar`); Bigvai (ID: `person:Bigvai`); Reum (ID: `person:Rehum`); Reelaías (ID: `person:Reelaiah`); Neemias (ID: `person:Nehemiah`); Mordecai (ID: `person:Mordecai`); Israel (ID: `person:Israel`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Ará (ID: `person:Arah.2`); Sephatias (ID: `person:Shephatiah.6`); Ezequias (ID: `person:Hezekiah.2`); Jora (ID: `person:Jorah`); Asgade (ID: `person:Azgad`); Zacai (ID: `person:Zaccai.2`); Bani (ID: `person:Bani`); Elam (ID: `person:Elam`); Zatu (ID: `person:Zattu.2`); Bezai (ID: `person:Bezai`); Hasum (ID: `person:Hashum`); Paate-Moabe (ID: `person:Pahath-moab`); Bigvai (ID: `person:Bigvai.2`); Ater (ID: `person:Ater`); Bebai (ID: `person:Bebai`); Adim (ID: `person:Adin`); Parós (ID: `person:Parosh`); Adonicão (ID: `person:Adonikam`); Jesua (ID: `person:Jeshua.3`); Joabe (ID: `person:Joab.3`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Magbis (ID: `place:Magbish`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Harim (ID: `person:Harim.2`); Nebo (ID: `place:Nebo.2`); Hadide (ID: `place:Hadid`); Senaa (ID: `place:Senaah`); Netofa (ID: `place:Netophah`); Ai (ID: `place:Ai`); Betel (ID: `place:Bethel`); Micmás (ID: `place:Michmash`); Beerote (ID: `place:Beeroth`); Cefira (ID: `place:Chephirah`); Ramah (ID: `place:Ramah.2`); Elam (ID: `person:Elam`); Belém (ID: `place:Bethlehem`); Anatote (ID: `place:Anathoth`); Ono (ID: `place:Ono`); Geba (ID: `place:Geba`); Jericó (ID: `place:Jericho`); Lode (ID: `place:Lod`); Quiriate-Jearim (ID: `place:Kiriath-jearim`)
...
* **Associated ACAI Concepts:** Hatita (ID: `person:Hatita`); Jedaías (ID: `person:Jedaiah.4`); Talmom (ID: `person:Talmon`); Sobai (ID: `person:Shobai`); Jesua (ID: `person:Jeshua`); Jesua (ID: `person:Jeshua.4`); Hodavias (ID: `person:Hodaviah.4`); Ater (ID: `person:Ater.2`); Imer (ID: `person:Immer.2`); Harim (ID: `person:Harim`); Acube (ID: `person:Akkub.2`); Cadmiel (ID: `person:Kadmiel`); Levi (ID: `group:Levi`); Pasur (ID: `person:Pashhur`); Levi (ID: `person:Levi.3`); Asafe (ID: `person:Asaph.2`); Salum (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** Hatita (ID: `person:Hatita`); Talmom (ID: `person:Talmon`); Ater (ID: `person:Ater.2`); Sobai (ID: `person:Shobai`); Acube (ID: `person:Akkub.2`); Asafe (ID: `person:Asaph.2`); Salum (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** Necoda (ID: `person:Nekoda`); Nephushesim (ID: `group:Nephushesim`); Acube (ID: `person:Akkub.3`); Harur (ID: `person:Harhur`); Barcos (ID: `person:Barkos`); Rezim (ID: `person:Rezin.2`); Uza (ID: `person:Uzza.2`); Baquebuque (ID: `person:Bakbuk`); Harsa (ID: `person:Harsha`); Salmai (ID: `person:Shalmai`); Hagabe (ID: `person:Hagab`); Hacufa (ID: `person:Hakupha`); Meída (ID: `person:Mehida`); Queros (ID: `person:Keros`); Gaar (ID: `person:Gahar`); Gazão (ID: `person:Gazzam`); Sisera (ID: `person:Sisera.2`); Asná (ID: `person:Asnah`); Hatifa (ID: `person:Hatipha`); Bazlite (ID: `person:Bazluth`); Sia (ID: `person:Siaha`); Hanã (ID: `person:Hanan.4`); Paseia (ID: `person:Paseah.2`); Padom (ID: `person:Padon`); Lebana (ID: `person:Lebanah`); Zia (ID: `person:Ziha`); Tabaote (ID: `person:Tabbaoth`); Reaías (ID: `person:Reaiah.3`); Nesias (ID: `person:Neziah`); Besai (ID: `person:Besai`); Gidel (ID: `person:Giddel`); Hagaba (ID: `person:Hagabah`); Temá (ID: `person:Temah`); Hasufa (ID: `person:Hasupha`); Meunim (ID: `group:Meunim`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Sephatias (ID: `person:Shephatiah.7`); Peruda (ID: `person:Peruda`); Hatil (ID: `person:Hattil`); Soferete (ID: `person:Sophereth`); Gidel (ID: `person:Giddel.2`); Jaala (ID: `person:Jaalah`); Ami (ID: `person:Ami`); Sotai (ID: `person:Sotai`); Darcom (ID: `person:Darkon`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`)
...
* **Associated ACAI Concepts:** Tel-Harsa (ID: `place:Tel-harsha`); Necoda (ID: `person:Nekoda.2`); Delaías (ID: `person:Delaiah.3`); Adã (ID: `place:Addan`); Tel-Melá (ID: `place:Tel-melah`); Imer (ID: `place:Immer`); Querube (ID: `place:Cherub`); Tobias (ID: `person:Tobiah`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Hacoz (ID: `person:Hakkoz.2`); Barzillai (ID: `person:Barzillai.3`); Habaiah (ID: `person:Habaiah`); Gileade (ID: `place:Gilead`); Barzillai (ID: `person:Barzillai`); priesthood (ID: `keyterm:Priesthood`); stain (ID: `keyterm:Stain`); Gileadites (ID: `group:Gilead`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Josué (ID: `person:Joshua.5`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Sealtiel (ID: `person:Shealtiel.2`); Jeozadaque (ID: `person:Jehozadak`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Hodavias (ID: `person:Hodaviah.4`); Henadade (ID: `person:Henadad`); Jesua (ID: `person:Jeshua.4`); Relatives (ID: `group:Relatives`); Esar-Hadom (ID: `person:Esarhaddon`); Cadmiel (ID: `person:Kadmiel`); Sidonians (ID: `group:Sidon`); kindness (ID: `keyterm:Kindness`); Benjamim (ID: `group:Benjamin`); Libano (ID: `place:Lebanon`); Instruction (ID: `keyterm:Instruction`); Hodias (ID: `person:Hodiah.2`); Moisés (ID: `person:Moses`); new moon festival (ID: `keyterm:NewMoonFestival`); Benjamim (ID: `person:Benjamin`); Assyria (ID: `place:Assyria`); terror (ID: `keyterm:Terror`); Sidom (ID: `place:Sidon`); Tiro (ID: `place:Tyre`); holy (ID: `keyterm:Holy`); counsel (ID: `keyterm:Counsel`); Asafe (ID: `person:Asaph.2`); Tyrians (ID: `group:Tyre`); Jope (ID: `place:Joppa`); appointed feast (ID: `keyterm:AppointedFeast`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); Dario (ID: `person:Darius.2`); Davi (ID: `person:David`); Money (ID: `realia:Money`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); Cedar (ID: `flora:Cedar`); Craftsman (ID: `realia:Craftsman`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); terror (ID: `keyterm:Terror`); offering (ID: `keyterm:Offering`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Tyrians (ID: `group:Tyre`); Jope (ID: `place:Joppa`); Sidonians (ID: `group:Sidon`); Sidom (ID: `place:Sidon`); Libano (ID: `place:Lebanon`); Pérsia (ID: `place:Persia`); Tiro (ID: `place:Tyre`); Ciro (ID: `person:Cyrus`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Sealtiel (ID: `person:Shealtiel.2`); SENHOR (ID: `deity:Lord`); Levi (ID: `group:Levi`); Jerusalém (ID: `place:Jerusalem`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `person:Levi.3`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); kindness (ID: `keyterm:Kindness`); Levi (ID: `group:Levi`); Davi (ID: `person:David`); Asafe (ID: `person:Asaph.2`); Levi (ID: `person:Levi.3`); House (ID: `realia:House`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Benjamim (ID: `person:Benjamin`); Benjamim (ID: `group:Benjamin`); Israel (ID: `person:Israel`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); SENHOR (ID: `deity:Lord`); Pérsia (ID: `place:Persia`); Israel (ID: `person:Israel`); Josué (ID: `person:Joshua.5`); Ciro (ID: `person:Cyrus`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Pérsia (ID: `place:Persia`); Samaria (ID: `place:Samaria`); Osnapar (ID: `person:Osnappar`); Babylonians (ID: `group:Babylon`); Dinaítas (ID: `person:Dinaite`); Assuero (ID: `person:Ahasuerus`); Tabeel (ID: `person:Tabeel`); Ereque (ID: `place:Erech`); Mitredate (ID: `person:Mithredath.2`); Bislão (ID: `person:Bishlam`); Persians (ID: `group:Persia`); Babilônia (ID: `place:Babylon`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Susã (ID: `place:Susa`); Elamites (ID: `group:Elam`); Elam (ID: `place:Elam`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Babylonians (ID: `group:Babylon`); Dinaítas (ID: `person:Dinaite`); Reum (ID: `person:Rehum.2`); Ereque (ID: `place:Erech`); Sinsai (ID: `person:Shimshai`); Susã (ID: `place:Susa`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); Babilônia (ID: `place:Babylon`); Pérsia (ID: `place:Persia`); Elam (ID: `place:Elam`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Artaxerxes (ID: `person:Artaxerxes.2`); Reum (ID: `person:Rehum.2`); Jews (ID: `group:Jews`); Sinsai (ID: `person:Shimshai`); Samaria (ID: `place:Samaria`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Dario (ID: `person:Darius.2`); Jews (ID: `group:Jews`); Zacarias (ID: `person:Zechariah.17`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Tattenai (ID: `person:Tattenai`); Ido (ID: `person:Iddo.6`); Ageu (ID: `person:Haggai`); Sealtiel (ID: `person:Shealtiel.2`); Rio Eufrates (ID: `place:Euphrates`); Judá (ID: `person:Judah.4`); Zorobabel (ID: `person:Zerubbabel.2`); Pérsia (ID: `place:Persia`); Israel (ID: `person:Israel`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`)
...
* **Associated ACAI Concepts:** Zacarias (ID: `person:Zechariah.17`); Ido (ID: `person:Iddo.6`); Ageu (ID: `person:Haggai`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Jews (ID: `group:Jews`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Sealtiel (ID: `person:Shealtiel.2`); Jerusalém (ID: `place:Jerusalem`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Jerusalém (ID: `place:Jerusalem`); Babilônia (ID: `place:Babylon`); Ciro (ID: `person:Cyrus`); Dario (ID: `person:Darius.2`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Zorobabel (ID: `person:Zerubbabel.2`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Tattenai (ID: `person:Tattenai`); Rio Eufrates (ID: `place:Euphrates`); Chaldeans (ID: `group:Chaldea`); Israel (ID: `person:Israel`); Caldéia (ID: `place:Chaldea`); Judá (ID: `person:Judah.4`); Money (ID: `realia:Money`); Foundation (ID: `realia:Foundation`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** Azarias (ID: `person:Azariah.7`); Seraias (ID: `person:Seraiah.2`); Ezra (ID: `person:Ezra`); Artaxerxes (ID: `person:Artaxerxes`); Pérsia (ID: `place:Persia`); Hilquias (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Zadoque (ID: `person:Zadok.4`); Azarias (ID: `person:Azariah.6`); Meraiote (ID: `person:Meraioth`); Uzi (ID: `person:Uzzi`); Zeraías (ID: `person:Zerahiah`); Seraias (ID: `person:Seraiah.2`); Amarias (ID: `person:Amariah.2`); Abisua (ID: `person:Abishua`); Aitube (ID: `person:Ahitub.3`); Salum (ID: `person:Shallum.7`); Azarias (ID: `person:Azariah.7`); Buqui (ID: `person:Bukki.2`); Arão (ID: `person:Aaron`); Artaxerxes (ID: `person:Artaxerxes`); Eleazar (ID: `person:Eleazar.2`); Hilquias (ID: `person:Hilkiah.2`); Pérsia (ID: `place:Persia`); Fineias (ID: `person:Phinehas`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`); Babilônia (ID: `place:Babylon`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Artaxerxes (ID: `person:Artaxerxes`); Ezra (ID: `person:Ezra`); Wheat (ID: `flora:Wheat`); Money (ID: `realia:Money`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`); Kor (ID: `realia:Kor`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Sephatias (ID: `person:Shephatiah.6`); Joanã (ID: `person:Johanan.8`); Jônatas (ID: `person:Jonathan.9`); Ebede (ID: `person:Ebed.2`); Bebai (ID: `person:Bebai.2`); Asgade (ID: `person:Azgad`); Miguel (ID: `person:Michael.10`); Hacatã (ID: `person:Hakkatan`); Zacarias (ID: `person:Zechariah.19`); Atalia (ID: `person:Athaliah.3`); Zacur (ID: `person:Zaccur.5`); Elam (ID: `person:Elam`); Elioenai (ID: `person:Eliehoenai.2`); Selomite (ID: `person:Shelomith.4`); Joabe (ID: `person:Joab.4`); Jesaías (ID: `person:Jeshaiah.4`); Paate-Moabe (ID: `person:Pahath-moab`); Gérson (ID: `person:Gershom.2`); Zeraías (ID: `person:Zerahiah.2`); Bigvai (ID: `person:Bigvai.2`); Hatus (ID: `person:Hattush.2`); Jeuel (ID: `person:Jeuel.3`); Josifias (ID: `person:Josiphiah`); Secanias (ID: `person:Shecaniah.5`); Zabadias (ID: `person:Zebadiah.8`); Jeiel (ID: `person:Jehiel.7`); Bebai (ID: `person:Bebai`); Obadias (ID: `person:Obadiah.10`); Adim (ID: `person:Adin`); Adonicão (ID: `person:Adonikam`); Parós (ID: `person:Parosh.2`); Utai (ID: `person:Uthai.2`); Jaaziel (ID: `person:Jahaziel.5`); Secanias (ID: `person:Shecaniah.6`); Semaías (ID: `person:Shemaiah.14`); Elifelete (ID: `person:Eliphelet.5`); Zacarias (ID: `person:Zechariah.18`); Daniel (ID: `person:Daniel.2`); Babilônia (ID: `place:Babylon`); Artaxerxes (ID: `person:Artaxerxes`); Itamar (ID: `person:Ithamar`); Davi (ID: `person:David`); Fineias (ID: `person:Phinehas`)
...
* **Associated ACAI Concepts:** Natã (ID: `person:Nathan.5`); Casifia (ID: `place:Casiphia`); Semaías (ID: `person:Shemaiah.15`); Elnatã (ID: `person:Elnathan.2`); Zacarias (ID: `person:Zechariah.20`); Elnatã (ID: `person:Elnathan.4`); Jaribe (ID: `person:Jarib.2`); Eliezer (ID: `person:Eliezer.8`); Joiaribe (ID: `person:Joiarib.2`); Elnatã (ID: `person:Elnathan.3`); Ido (ID: `person:Iddo`); Mesulão (ID: `person:Meshullam.9`); Ariel (ID: `person:Ariel`); SENHOR (ID: `deity:Lord`); perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); SENHOR (ID: `deity:Lord`); Insight (ID: `keyterm:Insight`); Mali (ID: `person:Mahli`); Levi (ID: `group:Levi`); Israel (ID: `person:Israel`); Levi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** work (ID: `keyterm:Work`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Davi (ID: `person:David`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); offering (ID: `keyterm:Offering`); Israel (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); Jebusites (ID: `group:Jebusites`); Egyptians (ID: `group:Egypt`); Canaã (ID: `place:Canaan`); Amorites (ID: `group:Amorites`); be unfaithful (ID: `keyterm:Unfaithful`); cananeu (ID: `group:Canaan`); Amom (ID: `place:Ammon`); Hete (ID: `person:Heth`); Levi (ID: `group:Levi`); Ammonites (ID: `group:Ammon`); Israel (ID: `person:Israel`); Moabe (ID: `place:Moab`); Egito (ID: `place:Egypt`); Levi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Harim (ID: `person:Harim`); Judá (ID: `person:Judah.4`); counsel (ID: `keyterm:Counsel`); offering (ID: `keyterm:Offering`); Judá (ID: `group:Judah`); Elam (ID: `person:Elam`); Josadaque (ID: `person:Jozadak.2`); Judeia (ID: `place:Judea`); Sabetai (ID: `person:Shabbethai`); Joel (ID: `person:Joel.12`); Salum (ID: `person:Shallum.11`); Elioenai (ID: `person:Elioenai.4`); Simeão (ID: `person:Shimeon`); Jeremai (ID: `person:Jeremai`); Ticva (ID: `person:Tikvah.2`); Malquias (ID: `person:Malchijah.5`); Semaías (ID: `person:Shemaiah.16`); Simei (ID: `person:Shimei.16`); Maluque (ID: `person:Malluch.2`); Manassés (ID: `person:Manasseh.4`); Jasube (ID: `person:Jashub.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); defilement (ID: `keyterm:Defilement`); to cause to possess (ID: `keyterm:Possess`); supplication (ID: `keyterm:Supplication`); peace (ID: `keyterm:IntactState`); kindness (ID: `keyterm:Kindness`); Jerusalém (ID: `place:Jerusalem`); dispossess (ID: `keyterm:Dispossess`); Pérsia (ID: `place:Persia`); Israel (ID: `person:Israel`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); supplication (ID: `keyterm:Supplication`); kindness (ID: `keyterm:Kindness`); Jerusalém (ID: `place:Jerusalem`); Pérsia (ID: `place:Persia`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); arrepender, se (ID: `keyterm:Repent`); Ezra (ID: `person:Ezra`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jeiel (ID: `person:Jehiel.8`); Secanias (ID: `person:Shecaniah.7`); SENHOR (ID: `deity:Lord`); Elam (ID: `person:Elam`); Israel (ID: `person:Israel`); be unfaithful (ID: `keyterm:Unfaithful`); Ezra (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); SENHOR (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); counsel (ID: `keyterm:Counsel`)
...
* **Associated ACAI Concepts:** swear (ID: `keyterm:Swear`); Levi (ID: `group:Levi`); Israel (ID: `person:Israel`); Levi (ID: `person:Levi.3`); Ezra (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Benjamim (ID: `person:Benjamin`); Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `group:Benjamin`); Judá (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Sabetai (ID: `person:Shabbethai`); Jônatas (ID: `person:Jonathan.10`); Mesulão (ID: `person:Meshullam.10`); Asael (ID: `person:Asahel.4`); Jazeías (ID: `person:Jahzeiah`); Ticva (ID: `person:Tikvah.2`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`)
