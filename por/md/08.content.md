...
* **Associated ACAI Concepts:** Noemi (ID: `person:Naomi`); Ephrathites (ID: `group:Ephrathah`); Quiliom (ID: `person:Chilion`); Efrata (ID: `person:Ephrathah`); Moabe (ID: `place:Moab`); Elimeleque (ID: `person:Elimelech`); Belém (ID: `place:Bethlehem`); Judá (ID: `group:Judah`); Malom (ID: `person:Mahlon`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** bless (ID: `keyterm:Bless`); Noemi (ID: `person:Naomi`); SENHOR (ID: `deity:Lord`); kindness (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); to cause to possess (ID: `keyterm:Possess`); Moabe (ID: `place:Moab`); Noemi (ID: `person:Naomi`); Boaz (ID: `person:Boaz`)
...
* **Associated ACAI Concepts:** Raquel (ID: `person:Rachel`); Lia (ID: `person:Leah`); Belém (ID: `place:Bethlehem`); SENHOR (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Tamar (ID: `person:Tamar`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Perez (ID: `person:Perez`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); bless (ID: `keyterm:Bless`); Noemi (ID: `person:Naomi`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Hezrom (ID: `person:Hezron.2`); Salmom (ID: `person:Salmon`); Obede (ID: `person:Obed`); Aminadabe (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Naassom (ID: `person:Nahshon`); Davi (ID: `person:David`); Boaz (ID: `person:Boaz`); Jessé (ID: `person:Jesse`); Perez (ID: `person:Perez`)
