...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); force (ID: `keyterm:Strength`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Basan (ID: `place:Bashan`); Carmel (ID: `place:Carmel`); chemin (ID: `keyterm:TheWay`); Liban (ID: `place:Lebanon`); zélé (ID: `keyterm:Zealous.3`)
...
* **Associated ACAI Concepts:** déclarer innocent (ID: `keyterm:PronounceInnocent`); force (ID: `keyterm:Strength`); Éternel (ID: `deity:Lord`); chemin (ID: `keyterm:TheWay`)
## Nahum 1.4 (id: 735747)
...
* **Associated ACAI Concepts:** Juda (ID: `person:Judah.4`); faire un voeu (ID: `keyterm:Vow`); état intact (ID: `keyterm:IntactState`); méchanceté (ID: `keyterm:Wickedness`); Juda (ID: `group:Judah`)
## Nahum 2.2 (id: 735757)
...
* **Associated ACAI Concepts:** Libya (ID: `place:Libya`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Cush (ID: `place:Cush.2`); Puth (ID: `place:Put`); destin (ID: `keyterm:Lot`); Égypte (ID: `place:Egypt`)
