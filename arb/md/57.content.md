...
* **Associated ACAI Concepts:** إِلَى (ID: `person:Philemon`); بولسَ (ID: `person:Paul`); Beloved (ID: `keyterm:Beloved`); يَسوع (ID: `person:Jesus.2`); تِيموثَاوس (ID: `person:Timothy`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); لِأَرْخِبّسَ (ID: `person:Archippus`); إِلَى (ID: `person:Apphia`); إِلَى (ID: `person:Philemon`); بولسَ (ID: `person:Paul`); Beloved (ID: `keyterm:Beloved`); ٱلرَّبِّ (ID: `deity:Lord`); Favor (ID: `keyterm:Favor`); Make Peace (ID: `keyterm:Peace`); تِيموثَاوس (ID: `person:Timothy`); Church (ID: `keyterm:Church`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); Holy (ID: `keyterm:Holy`); Love (ID: `keyterm:Love`); يَسوع (ID: `person:Jesus.2`); Ask for (ID: `keyterm:AskFor`); ٱلرَّبِّ (ID: `deity:Lord`); Fellowship (ID: `keyterm:Fellowship`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Affection (ID: `keyterm:Affection`); Pray (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); دِيمَاس (ID: `person:Demas`); أَبَفْرَاسَ (ID: `person:Epaphras`); لوقَا (ID: `person:Luke`); In Christ (ID: `keyterm:InChrist`); مَرْقسَ (ID: `person:Mark`); أَرِسْتَرْخسَ (ID: `person:Aristarchus`); Favor (ID: `keyterm:Favor`); Spirit (ID: `keyterm:Spirit.2`)
