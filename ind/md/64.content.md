...
* **Associated ACAI Concepts:** kebenaran (ID: `keyterm:Truth`); hidup (ID: `keyterm:Live.3`); kekasih (ID: `keyterm:Beloved`); Gayus (ID: `person:Gaius.4`); bersaksi (ID: `keyterm:BearWitness`); kasihi (ID: `keyterm:Love`); Cause of Joy (ID: `keyterm:CauseOfJoy`); berdoa (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** bersaksi (ID: `keyterm:BearWitness`); Tuhan (ID: `deity:Lord`); kekasih (ID: `keyterm:Beloved`); kebenaran (ID: `keyterm:Truth`); kasihi (ID: `keyterm:Love`); kesetiaan (ID: `keyterm:Faithfulness`); nama (ID: `keyterm:Name`); jemaat (ID: `keyterm:Church`); wajib (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** jemaat (ID: `keyterm:Church`); Demetrius (ID: `person:Demetrius`); Diotrefes (ID: `person:Diotrephes`); bersaksi (ID: `keyterm:BearWitness`); Tuhan (ID: `deity:Lord`); kekasih (ID: `keyterm:Beloved`); kebenaran (ID: `keyterm:Truth`); benar (ID: `keyterm:True`); lakukan baik (ID: `keyterm:DoGood`); yang baik (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** kekasih (ID: `keyterm:Beloved`); Tuhan (ID: `deity:Lord`); yang baik (ID: `keyterm:Good`); lakukan baik (ID: `keyterm:DoGood`)
