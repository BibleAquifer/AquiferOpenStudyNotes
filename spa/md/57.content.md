...
* **Associated ACAI Concepts:** Filemón (ID: `person:Philemon`); amado (ID: `keyterm:Beloved`); Timoteo (ID: `person:Timothy`); Jesús (ID: `person:Jesus.2`); Pablo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Filemón (ID: `person:Philemon`); Archîpo (ID: `person:Archippus`); Apphia (ID: `person:Apphia`); amado (ID: `keyterm:Beloved`); Timoteo (ID: `person:Timothy`); Jehová (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); iglesia (ID: `keyterm:Church`); Pablo (ID: `person:Paul`); hacer la paz (ID: `keyterm:Peace`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); creer (ID: `keyterm:Believe`); amar (ID: `keyterm:Love`); santo (ID: `keyterm:Holy`); Jehová (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); orar (ID: `keyterm:Pray`); rogar (ID: `keyterm:AskFor`); comunión (ID: `keyterm:Fellowship`); Good (ID: `keyterm:Good`); entrañas (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Pablo (ID: `person:Paul`); rogar (ID: `keyterm:AskFor`); amar (ID: `keyterm:Love`); cristo (ID: `keyterm:InChrist`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Epafras (ID: `person:Epaphras`); Demas (ID: `person:Demas`); Lucas (ID: `person:Luke`); favor (ID: `keyterm:Favor`); Marcos (ID: `person:Mark`); cristo (ID: `keyterm:InChrist`); espíritu (ID: `keyterm:Spirit.2`); Aristarco (ID: `person:Aristarchus`)
