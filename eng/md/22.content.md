...
* **Associated ACAI Concepts:** Bether (ID: `place:BetherMountain`); Love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Saffron Plant (ID: `flora:SaffronPlant`); Mount Amana (ID: `place:Amana`); Pomegranate (ID: `flora:Pomegranate`); Henna (ID: `flora:Henna`); Calamus (ID: `flora:Calamus`); Mount Hermon (ID: `place:HermonMount`)
...
* **Associated ACAI Concepts:** Mount Amana (ID: `place:Amana`); Mount Hermon (ID: `place:HermonMount`)
