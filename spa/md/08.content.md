...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Catah (ID: `place:Bethlehem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Chelión (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Ephrata (ID: `person:Ephrathah`); Efratita (ID: `group:Ephrathah`); Catah (ID: `place:Bethlehem`); Judá (ID: `group:Judah`); Elimelech (ID: `person:Elimelech`); Moab (ID: `place:Moab`); Mahalón (ID: `person:Mahlon`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Catah (ID: `place:Bethlehem`); Noemi (ID: `person:Naomi`); Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); favor (ID: `keyterm:Favor`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** bondad (ID: `keyterm:Kindness`); Noemi (ID: `person:Naomi`); bendecir (ID: `keyterm:Bless`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Catah (ID: `place:Bethlehem`); Elders (ID: `group:GenericElders`); Rachêl (ID: `person:Rachel`); Lea (ID: `person:Leah`); Israel (ID: `person:Israel`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Phares (ID: `person:Perez`); Thamar (ID: `person:Tamar`); Judá (ID: `group:Judah`); Jehová (ID: `deity:Lord`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Noemi (ID: `person:Naomi`); Jehová (ID: `deity:Lord`); Israel (ID: `person:Israel`); bendecir (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Hesrón (ID: `person:Hezron.2`); Salmón (ID: `person:Salmon`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Phares (ID: `person:Perez`); Nahasón (ID: `person:Nahshon`); Booz (ID: `person:Boaz`); David (ID: `person:David`); Isaí (ID: `person:Jesse`)
