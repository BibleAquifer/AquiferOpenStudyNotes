...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); craindre (ID: `keyterm:Fear`); alliance (ID: `keyterm:Covenant`); offrande (ID: `keyterm:Offering`); Priests (ID: `group:GenericPriests`); pleurer (ID: `keyterm:Curse`); état intact (ID: `keyterm:IntactState`); gloire (ID: `keyterm:Glory`); souiller (ID: `keyterm:Stain`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); niveau (ID: `keyterm:Fairness`); vérité (ID: `keyterm:Truth`); An Angel (ID: `deity:Angel`); prier (ID: `keyterm:AskFor`); sans saleté (ID: `keyterm:Pure`); benir (ID: `keyterm:Bless`); chemin (ID: `keyterm:TheWay`); nation; peuple (ID: `group:Gentile`); agir avec bonté (ID: `keyterm:KindlyDisposed`); la connaissance (ID: `keyterm:Intention`); profaner, déshonorer (ID: `keyterm:Dishonor`); ardeur (ID: `keyterm:Ardour`); faire un voeu (ID: `keyterm:Vow`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); faire un voeu (ID: `keyterm:Vow`); pleurer (ID: `keyterm:Curse`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); pleurer (ID: `keyterm:Curse`); gloire (ID: `keyterm:Glory`); benir (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); alliance (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); la connaissance (ID: `keyterm:Intention`); An Angel (ID: `deity:Angel`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); profaner, déshonorer (ID: `keyterm:Dishonor`); alliance (ID: `keyterm:Covenant`); offrande (ID: `keyterm:Offering`); Jérusalem (ID: `place:Jerusalem`); aimer (ID: `keyterm:Love`); Juda (ID: `person:Judah.4`); délice (ID: `keyterm:Delight`); Juda (ID: `group:Judah`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** profaner, déshonorer (ID: `keyterm:Dishonor`); Jérusalem (ID: `place:Jerusalem`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); aimer (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); offrande (ID: `keyterm:Offering`); Jérusalem (ID: `place:Jerusalem`); An Angel (ID: `deity:Angel`); alliance (ID: `keyterm:Covenant`); A Group of People (ID: `group:GenericGroup`); craindre (ID: `keyterm:Fear`); sans saleté (ID: `keyterm:Pure`); Juda (ID: `person:Judah.4`); jurer (ID: `keyterm:Swear`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`); Juda (ID: `group:Judah`); Soap (ID: `realia:Soap`); Hammada (ID: `flora:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); benir (ID: `keyterm:Bless`); pleurer (ID: `keyterm:Curse`); limite (ID: `keyterm:Decree`); offrande (ID: `keyterm:Offering`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Sorghum (ID: `flora:Sorghum`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** Élie (ID: `person:Elijah`); limite (ID: `keyterm:Decree`); objet qui doit être détruit (ID: `keyterm:SomethingDevotedToGod`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); Instruction (ID: `keyterm:Instruction`); montagne de Sinaï (ID: `place:SinaiMount`); Moïse (ID: `person:Moses`)
