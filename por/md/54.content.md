...
* **Associated ACAI Concepts:** Paulo (ID: `person:Paul`); hope (ID: `keyterm:Hope`); salvador (ID: `keyterm:Savior`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Timóteo (ID: `person:Timothy`); crer (ID: `keyterm:Believe`); Paulo (ID: `person:Paul`); hope (ID: `keyterm:Hope`); salvador (ID: `keyterm:Savior`); fazer a paz (ID: `keyterm:Peace`); misericórdia (ID: `keyterm:Mercy`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** Timóteo (ID: `person:Timothy`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); fazer a paz (ID: `keyterm:Peace`); misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); lei (ID: `keyterm:Law`); sem lei (ID: `keyterm:Lawless`); opposite of holy: profane (ID: `keyterm:Profane`); sem hipocrisia (ID: `keyterm:Unhypocritical`); Éfeso (ID: `place:Ephesus`); be (or show oneself) just (ID: `keyterm:Just`); Macedônia (ID: `place:Macedonia`); coração (ID: `keyterm:Heart`); Good (ID: `keyterm:Good`); palavreado vazio (ID: `keyterm:EmptyTalk`); corretamente (ID: `keyterm:Lawfully`); love (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`); Glory (ID: `keyterm:Glory`); boa notícia (ID: `keyterm:GoodNews`); limpo (ID: `keyterm:Clean`); bem, aventurado (ID: `keyterm:Happy`); consciência (ID: `keyterm:Conscience`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); opposite of holy: profane (ID: `keyterm:Profane`); sem lei (ID: `keyterm:Lawless`); crer (ID: `keyterm:Believe`); Glory (ID: `keyterm:Glory`); palavreado vazio (ID: `keyterm:EmptyTalk`); SENHOR (ID: `deity:Lord`); corretamente (ID: `keyterm:Lawfully`); be (or show oneself) just (ID: `keyterm:Just`); boa notícia (ID: `keyterm:GoodNews`); bem, aventurado (ID: `keyterm:Happy`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); para a eternidade (ID: `keyterm:Always`); Ability (ID: `keyterm:Ability`); misericórdia (ID: `keyterm:Mercy`); Faithfulness (ID: `keyterm:Faithfulness`); favor (ID: `keyterm:Favor`); imortal (ID: `keyterm:Imperishable`); blasfemo (ID: `keyterm:Blasphemous`); Glory (ID: `keyterm:Glory`); SENHOR (ID: `deity:Lord`); surely! (ID: `keyterm:Surely`); love (ID: `keyterm:Love`); salvation (ID: `keyterm:Salvation`); não crer (ID: `keyterm:Disbelieve`); Life (ID: `keyterm:Life`); em cristo (ID: `keyterm:InChrist`); servir (ID: `keyterm:Serve`)
...
* **Associated ACAI Concepts:** Alexandre (ID: `person:Alexander.4`); Himeneu (ID: `person:Hymenaeus`); consciência (ID: `keyterm:Conscience`); crer (ID: `keyterm:Believe`); Good (ID: `keyterm:Good`); Timóteo (ID: `person:Timothy`); Satanás (ID: `deity:Satan`); blasfemar (ID: `keyterm:Blaspheme`)
...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); SENHOR (ID: `deity:Lord`); Daily Life (ID: `keyterm:DailyLife`); crer (ID: `keyterm:Believe`); rogar (ID: `keyterm:AskFor`); salvador (ID: `keyterm:Savior`); testemunhar (ID: `keyterm:BearWitness`); Gentiles (ID: `group:Gentile`); tranquilo (ID: `keyterm:Tranquil`); Life (ID: `keyterm:Life`); Jesus (ID: `person:Jesus.2`); salvation (ID: `keyterm:Salvation`); resgate (ID: `keyterm:Ransom`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Adão (ID: `person:Adam`); Truth (ID: `keyterm:Truth`); salvation (ID: `keyterm:Salvation`); orar (ID: `keyterm:Pray`); crer (ID: `keyterm:Believe`); Daily Life (ID: `keyterm:DailyLife`); Gentiles (ID: `group:Gentile`); promessa (ID: `keyterm:Promise`); tranquilo (ID: `keyterm:Tranquil`); testemunhar (ID: `keyterm:BearWitness`); Jesus (ID: `person:Jesus.2`); Eva (ID: `person:Eve`); Good (ID: `keyterm:Good`); salvador (ID: `keyterm:Savior`); love (ID: `keyterm:Love`); Life (ID: `keyterm:Life`); rogar (ID: `keyterm:AskFor`); piedade (ID: `keyterm:GodlyReverence`); resgate (ID: `keyterm:Ransom`); consecration (ID: `keyterm:Consecration.2`); holy (ID: `keyterm:Holy`); autoridade (ID: `keyterm:Authority.2`); Gold Jewelry (ID: `realia:GoldJewelry`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); Adão (ID: `person:Adam`); Truth (ID: `keyterm:Truth`); testemunhar (ID: `keyterm:BearWitness`); Faithfulness (ID: `keyterm:Faithfulness`); salvation (ID: `keyterm:Salvation`); Jesus (ID: `person:Jesus.2`); orar (ID: `keyterm:Pray`); servir (ID: `keyterm:Serve`); irrepreensível (ID: `keyterm:WithoutReproach`); Daily Life (ID: `keyterm:DailyLife`); compreensivo (ID: `keyterm:Gentle`); que não ama o dinheiro (ID: `keyterm:NotALoverOfMoney`); Gentiles (ID: `group:Gentile`); promessa (ID: `keyterm:Promise`); irrepreensível (ID: `keyterm:BeyondReproach`); tranquilo (ID: `keyterm:Tranquil`); juízo (ID: `keyterm:Judgment`); em cristo (ID: `keyterm:InChrist`); Eva (ID: `person:Eve`); Good (ID: `keyterm:Good`); salvador (ID: `keyterm:Savior`); love (ID: `keyterm:Love`); discernir (ID: `keyterm:Interpret`); Life (ID: `keyterm:Life`); igreja (ID: `keyterm:Church`); consecration (ID: `keyterm:Consecration.2`); rogar (ID: `keyterm:AskFor`); (literalmente (ID: `keyterm:DoubleTongued`); piedade (ID: `keyterm:GodlyReverence`); ofício (ID: `keyterm:PositionOfResponsibility`); resgate (ID: `keyterm:Ransom`); limpo (ID: `keyterm:Clean`); holy (ID: `keyterm:Holy`); autoridade (ID: `keyterm:Authority.2`); consciência (ID: `keyterm:Conscience`); Wine (ID: `realia:Wine`); Gold Jewelry (ID: `realia:GoldJewelry`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Adão (ID: `person:Adam`); crer (ID: `keyterm:Believe`); love (ID: `keyterm:Love`); salvation (ID: `keyterm:Salvation`); consecration (ID: `keyterm:Consecration.2`); autoridade (ID: `keyterm:Authority.2`); Eva (ID: `person:Eve`)
...
* **Associated ACAI Concepts:** Faithfulness (ID: `keyterm:Faithfulness`); crer (ID: `keyterm:Believe`); servir (ID: `keyterm:Serve`); irrepreensível (ID: `keyterm:WithoutReproach`); compreensivo (ID: `keyterm:Gentle`); que não ama o dinheiro (ID: `keyterm:NotALoverOfMoney`); SENHOR (ID: `deity:Lord`); irrepreensível (ID: `keyterm:BeyondReproach`); juízo (ID: `keyterm:Judgment`); testemunhar (ID: `keyterm:BearWitness`); em cristo (ID: `keyterm:InChrist`); Jesus (ID: `person:Jesus.2`); discernir (ID: `keyterm:Interpret`); igreja (ID: `keyterm:Church`); (literalmente (ID: `keyterm:DoubleTongued`); ofício (ID: `keyterm:PositionOfResponsibility`); limpo (ID: `keyterm:Clean`); consciência (ID: `keyterm:Conscience`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); servir (ID: `keyterm:Serve`); irrepreensível (ID: `keyterm:WithoutReproach`); Faithfulness (ID: `keyterm:Faithfulness`); (literalmente (ID: `keyterm:DoubleTongued`); consciência (ID: `keyterm:Conscience`); discernir (ID: `keyterm:Interpret`); em cristo (ID: `keyterm:InChrist`); Jesus (ID: `person:Jesus.2`); limpo (ID: `keyterm:Clean`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Faithfulness (ID: `keyterm:Faithfulness`); crer (ID: `keyterm:Believe`); Life (ID: `keyterm:Life`); Truth (ID: `keyterm:Truth`); hope (ID: `keyterm:Hope`); Holy Spirit (ID: `deity:HolySpirit`); conduta (ID: `keyterm:Behavior`); proclamar (ID: `keyterm:Proclaim`); Ability (ID: `keyterm:Ability`); pureza (ID: `keyterm:WithoutMoralDefect`); be (or show oneself) just (ID: `keyterm:Just`); corpo (ID: `keyterm:Body.3`); promessa (ID: `keyterm:Promise`); Demons (ID: `deity:Demons`); salvation (ID: `keyterm:Salvation`); Jesus (ID: `person:Jesus.2`); hipocrisia (ID: `keyterm:Hypocrisy`); intercessão (ID: `keyterm:Intercession`); opposite of holy: profane (ID: `keyterm:Profane`); salvador (ID: `keyterm:Savior`); love (ID: `keyterm:Love`); Spirit (ID: `keyterm:Spirit.2`); igreja (ID: `keyterm:Church`); rogar (ID: `keyterm:AskFor`); Glory (ID: `keyterm:Glory`); An Angel (ID: `deity:Angel`); consecration (ID: `keyterm:Consecration.2`); favor (ID: `keyterm:Favor`); consciência (ID: `keyterm:Conscience`); Capital (ID: `realia:Capital`)
...
* **Associated ACAI Concepts:** Holy Spirit (ID: `deity:HolySpirit`); crer (ID: `keyterm:Believe`); Glory (ID: `keyterm:Glory`); proclamar (ID: `keyterm:Proclaim`); An Angel (ID: `deity:Angel`); Ability (ID: `keyterm:Ability`); be (or show oneself) just (ID: `keyterm:Just`); corpo (ID: `keyterm:Body.3`); Spirit (ID: `keyterm:Spirit.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Holy Spirit (ID: `deity:HolySpirit`); crer (ID: `keyterm:Believe`); Truth (ID: `keyterm:Truth`); Demons (ID: `deity:Demons`); Faithfulness (ID: `keyterm:Faithfulness`); consecration (ID: `keyterm:Consecration.2`); hipocrisia (ID: `keyterm:Hypocrisy`); intercessão (ID: `keyterm:Intercession`); consciência (ID: `keyterm:Conscience`)
...
* **Associated ACAI Concepts:** Faithfulness (ID: `keyterm:Faithfulness`); crer (ID: `keyterm:Believe`); Life (ID: `keyterm:Life`); opposite of holy: profane (ID: `keyterm:Profane`); rogar (ID: `keyterm:AskFor`); hope (ID: `keyterm:Hope`); salvador (ID: `keyterm:Savior`); promessa (ID: `keyterm:Promise`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); salvation (ID: `keyterm:Salvation`); pureza (ID: `keyterm:WithoutMoralDefect`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); juízo (ID: `keyterm:Judgment`); Jesus (ID: `person:Jesus.2`); Faithfulness (ID: `keyterm:Faithfulness`); crer (ID: `keyterm:Believe`); rogar (ID: `keyterm:AskFor`); inútil (ID: `keyterm:Idle`); fear (ID: `keyterm:Fear`); preconceito (ID: `keyterm:Discrimination`); pure (ID: `keyterm:Pure`); pureza (ID: `keyterm:WithoutMoralDefect`); irrepreensível (ID: `keyterm:BeyondReproach`); testemunhar solenemente (ID: `keyterm:Declare`); Name (ID: `keyterm:Name`); servir como escravo (ID: `keyterm:Serve.2`); hope (ID: `keyterm:Hope`); testemunhar (ID: `keyterm:BearWitness`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); Satanás (ID: `deity:Satan`); blasfemar (ID: `keyterm:Blaspheme`); escritura (ID: `keyterm:Scripture`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); amado (ID: `keyterm:Beloved`); tribunal de justiça (ID: `keyterm:CourtCase`); Life (ID: `keyterm:Life`); igreja (ID: `keyterm:Church`); compartilhar (ID: `keyterm:Share`); An Angel (ID: `deity:Angel`); be unfaithful (ID: `keyterm:Unfaithful`); escolhido (ID: `keyterm:Chosen`); witness (ID: `keyterm:Witness`); holy (ID: `keyterm:Holy`); Grain (ID: `flora:Grain`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Yoke (ID: `realia:Yoke`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); inútil (ID: `keyterm:Idle`); juízo (ID: `keyterm:Judgment`); hope (ID: `keyterm:Hope`); Good (ID: `keyterm:Good`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); testemunhar (ID: `keyterm:BearWitness`); Jesus (ID: `person:Jesus.2`); Satanás (ID: `deity:Satan`); Faithfulness (ID: `keyterm:Faithfulness`); irrepreensível (ID: `keyterm:BeyondReproach`); be unfaithful (ID: `keyterm:Unfaithful`); Life (ID: `keyterm:Life`); igreja (ID: `keyterm:Church`); orar (ID: `keyterm:Pray`); holy (ID: `keyterm:Holy`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** inútil (ID: `keyterm:Idle`); crer (ID: `keyterm:Believe`); juízo (ID: `keyterm:Judgment`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); Satanás (ID: `deity:Satan`); Jesus (ID: `person:Jesus.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); juízo (ID: `keyterm:Judgment`); compartilhar (ID: `keyterm:Share`); SENHOR (ID: `deity:Lord`); preconceito (ID: `keyterm:Discrimination`); pure (ID: `keyterm:Pure`); fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); tribunal de justiça (ID: `keyterm:CourtCase`); escritura (ID: `keyterm:Scripture`); Jesus (ID: `person:Jesus.2`); escolhido (ID: `keyterm:Chosen`); witness (ID: `keyterm:Witness`); testemunhar solenemente (ID: `keyterm:Declare`); Wine (ID: `realia:Wine`); Grain (ID: `flora:Grain`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); SENHOR (ID: `deity:Lord`); preconceito (ID: `keyterm:Discrimination`); fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Jesus (ID: `person:Jesus.2`); escolhido (ID: `keyterm:Chosen`); witness (ID: `keyterm:Witness`); testemunhar solenemente (ID: `keyterm:Declare`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); preconceito (ID: `keyterm:Discrimination`); An Angel (ID: `deity:Angel`); Jesus (ID: `person:Jesus.2`); escolhido (ID: `keyterm:Chosen`); testemunhar solenemente (ID: `keyterm:Declare`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); rogar (ID: `keyterm:AskFor`); servir como escravo (ID: `keyterm:Serve.2`); Truth (ID: `keyterm:Truth`); amado (ID: `keyterm:Beloved`); amor ao dinheiro (ID: `keyterm:LoveOfMoney`); blasfemar (ID: `keyterm:Blaspheme`); Bring In (ID: `keyterm:BringIn`); tentar (ID: `keyterm:PutToTheTest`); Ability (ID: `keyterm:Ability`); Faithfulness (ID: `keyterm:Faithfulness`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); Foolish (ID: `keyterm:Foolish`); Do Good (ID: `keyterm:DoGood`); Make Alive (ID: `keyterm:Alive`); Bring In (ID: `keyterm:BringIn`); tentar (ID: `keyterm:PutToTheTest`); be (or show oneself) just (ID: `keyterm:Just`); promessa (ID: `keyterm:Promise`); irrepreensível (ID: `keyterm:BeyondReproach`); servir como escravo (ID: `keyterm:Serve.2`); Truth (ID: `keyterm:Truth`); hope (ID: `keyterm:Hope`); surely! (ID: `keyterm:Surely`); testemunhar (ID: `keyterm:BearWitness`); blasfemar (ID: `keyterm:Blaspheme`); Pilatos (ID: `person:Pilate`); Faithfulness (ID: `keyterm:Faithfulness`); opposite of holy: profane (ID: `keyterm:Profane`); Timóteo (ID: `person:Timothy`); love (ID: `keyterm:Love`); amor ao dinheiro (ID: `keyterm:LoveOfMoney`); amado (ID: `keyterm:Beloved`); Commandment (ID: `keyterm:Commandment`); sem mancha (ID: `keyterm:AboveCriticism`); rogar (ID: `keyterm:AskFor`); generoso (ID: `keyterm:WillingToShare`); favor (ID: `keyterm:Favor`); witness (ID: `keyterm:Witness`); bem, aventurado (ID: `keyterm:Happy`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`); Make Alive (ID: `keyterm:Alive`); love (ID: `keyterm:Love`); surely! (ID: `keyterm:Surely`); Pilatos (ID: `person:Pilate`); testemunhar (ID: `keyterm:BearWitness`); irrepreensível (ID: `keyterm:BeyondReproach`); Commandment (ID: `keyterm:Commandment`); sem mancha (ID: `keyterm:AboveCriticism`); be (or show oneself) just (ID: `keyterm:Just`); Life (ID: `keyterm:Life`); witness (ID: `keyterm:Witness`); bem, aventurado (ID: `keyterm:Happy`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); surely! (ID: `keyterm:Surely`); para a eternidade (ID: `keyterm:Always`); bem, aventurado (ID: `keyterm:Happy`)
...
* **Associated ACAI Concepts:** Do Good (ID: `keyterm:DoGood`); hope (ID: `keyterm:Hope`); SENHOR (ID: `deity:Lord`); para a eternidade (ID: `keyterm:Always`); Ability (ID: `keyterm:Ability`); generoso (ID: `keyterm:WillingToShare`)
...
* **Associated ACAI Concepts:** Do Good (ID: `keyterm:DoGood`); hope (ID: `keyterm:Hope`); SENHOR (ID: `deity:Lord`); para a eternidade (ID: `keyterm:Always`); Ability (ID: `keyterm:Ability`); generoso (ID: `keyterm:WillingToShare`); Life (ID: `keyterm:Life`)
...
* **Associated ACAI Concepts:** Foolish (ID: `keyterm:Foolish`); crer (ID: `keyterm:Believe`); opposite of holy: profane (ID: `keyterm:Profane`); Timóteo (ID: `person:Timothy`); promessa (ID: `keyterm:Promise`); favor (ID: `keyterm:Favor`)
