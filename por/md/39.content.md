...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Israel (ID: `person:Israel`); Edomites (ID: `group:Edom`); SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`); offering (ID: `keyterm:Offering`); fear (ID: `keyterm:Fear`); utter a curse (ID: `keyterm:Curse`); peace (ID: `keyterm:IntactState`); Priests (ID: `group:GenericPriests`); Levi (ID: `group:Levi`); Glory (ID: `keyterm:Glory`); stain (ID: `keyterm:Stain`); Levi (ID: `person:Levi.3`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); fairness (ID: `keyterm:Fairness`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); make a vow (ID: `keyterm:Vow`); profane, dishonor (ID: `keyterm:Dishonor`); evil intention (ID: `keyterm:Intention`); The Way (ID: `keyterm:TheWay`); An Angel (ID: `deity:Angel`); bless (ID: `keyterm:Bless`); Truth (ID: `keyterm:Truth`); be kindly disposed (ID: `keyterm:KindlyDisposed`); Gentiles (ID: `group:Gentile`); ardour (ID: `keyterm:Ardour`); pure (ID: `keyterm:Pure`); rogar (ID: `keyterm:AskFor`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** stain (ID: `keyterm:Stain`); SENHOR (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** utter a curse (ID: `keyterm:Curse`); SENHOR (ID: `deity:Lord`); make a vow (ID: `keyterm:Vow`); fear (ID: `keyterm:Fear`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Covenant (ID: `keyterm:Covenant`); offering (ID: `keyterm:Offering`); profane, dishonor (ID: `keyterm:Dishonor`); love (ID: `keyterm:Love`); delight (ID: `keyterm:Delight`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Israel (ID: `person:Israel`); profane, dishonor (ID: `keyterm:Dishonor`); SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); swear (ID: `keyterm:Swear`); An Angel (ID: `deity:Angel`); A Group of People (ID: `group:GenericGroup`); Judá (ID: `group:Judah`); Levi (ID: `person:Levi.3`); pure (ID: `keyterm:Pure`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `group:Levi`); fear (ID: `keyterm:Fear`); Judá (ID: `person:Judah.4`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); utter a curse (ID: `keyterm:Curse`); offering (ID: `keyterm:Offering`); Israel (ID: `person:Israel`); bless (ID: `keyterm:Bless`); decree (ID: `keyterm:Decree`); Sorghum (ID: `flora:Sorghum`); Wheat (ID: `flora:Wheat`); Vine (ID: `flora:Vine`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Monte Sinai (ID: `place:SinaiMount`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); Moisés (ID: `person:Moses`); decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** Monte Sinai (ID: `place:SinaiMount`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); SENHOR (ID: `deity:Lord`); Moisés (ID: `person:Moses`); Elias (ID: `person:Elijah`); decree (ID: `keyterm:Decree`); fear (ID: `keyterm:Fear`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`)
