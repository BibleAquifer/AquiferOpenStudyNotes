...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); bem, aventurado (ID: `keyterm:Happy`); tentar (ID: `keyterm:PutToTheTest`); amado (ID: `keyterm:Beloved`); aprovado (ID: `keyterm:Approved`); limpo (ID: `keyterm:Clean`); inútil (ID: `keyterm:Worthless`); sem mancha (ID: `keyterm:AboveCriticism`); Truth (ID: `keyterm:Truth`); que não pode ser tentado (ID: `keyterm:NotTempted`); salvation (ID: `keyterm:Salvation`); be (or show oneself) just (ID: `keyterm:Just`); To Sin (ID: `keyterm:Sin`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); lei (ID: `keyterm:Law`); promessa (ID: `keyterm:Promise`); Good (ID: `keyterm:Good`); A Person (ID: `person:GenericPerson`); love (ID: `keyterm:Love`); sem mancha (ID: `keyterm:Undefiled`); coração (ID: `keyterm:Heart`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** limpo (ID: `keyterm:Clean`); inútil (ID: `keyterm:Worthless`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); sem mancha (ID: `keyterm:AboveCriticism`); sem mancha (ID: `keyterm:Undefiled`); coração (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** favoritismo (ID: `keyterm:Partiality`); Glory (ID: `keyterm:Glory`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); favoritismo (ID: `keyterm:Partiality`); crer (ID: `keyterm:Believe`); Glory (ID: `keyterm:Glory`); Jesus (ID: `person:Jesus.2`); distinguir (ID: `keyterm:Discern`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** escolhido (ID: `keyterm:Chosen`); crer (ID: `keyterm:Believe`); love (ID: `keyterm:Love`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); amado (ID: `keyterm:Beloved`); promessa (ID: `keyterm:Promise`); reino (ID: `keyterm:Kingdom`)
...
* **Associated ACAI Concepts:** escritura (ID: `keyterm:Scripture`); love (ID: `keyterm:Love`); lei (ID: `keyterm:Law`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); favoritismo (ID: `keyterm:Partiality`); tropeçar (ID: `keyterm:Stumble`); juízo (ID: `keyterm:Judgment`); misericórdia (ID: `keyterm:Mercy`); To Sin (ID: `keyterm:Sin`); inclemente (ID: `keyterm:Merciless`); love (ID: `keyterm:Love`); fornication (ID: `keyterm:Fornication`); decidir (ID: `keyterm:Decided`); tribunal de justiça (ID: `keyterm:CourtCase`); escritura (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); A Person (ID: `person:GenericPerson`); SENHOR (ID: `deity:Lord`); Abraão (ID: `person:Abraham`); corpo (ID: `keyterm:Body.3`); Raabe (ID: `person:Rahab`); inútil (ID: `keyterm:Idle`); An Angel (ID: `deity:Angel`); vazio (ID: `keyterm:Empty`); escritura (ID: `keyterm:Scripture`); To Cause to Happen (ID: `keyterm:Happen`); Demons (ID: `deity:Demons`); fazer a paz (ID: `keyterm:Peace`); Isaque (ID: `person:Isaac`); Spirit (ID: `keyterm:Spirit.2`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); To Cause to Happen (ID: `keyterm:Happen`); SENHOR (ID: `deity:Lord`); Abraão (ID: `person:Abraham`); escritura (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); be unfaithful (ID: `keyterm:Unfaithful`); amizade (ID: `keyterm:Friendship`); pure (ID: `keyterm:Pure`); Holy Spirit (ID: `deity:HolySpirit`); desejar (ID: `keyterm:LongFor`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Ability (ID: `keyterm:Ability`); Spirit (ID: `keyterm:Spirit.2`); To Cleanse (ID: `keyterm:Cleanse.2`); coração (ID: `keyterm:Heart`); favor (ID: `keyterm:Favor`); escritura (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** escritura (ID: `keyterm:Scripture`); Spirit (ID: `keyterm:Spirit.2`); Holy Spirit (ID: `deity:HolySpirit`); desejar (ID: `keyterm:LongFor`)
...
* **Associated ACAI Concepts:** be (or show oneself) just (ID: `keyterm:Just`); SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); condenar (ID: `keyterm:Condemn`); testemunhar (ID: `keyterm:BearWitness`); coração (ID: `keyterm:Heart`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** igreja (ID: `keyterm:Church`); SENHOR (ID: `deity:Lord`); Name (ID: `keyterm:Name`); anointed (ID: `keyterm:Anointed`); orar (ID: `keyterm:Pray`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); To Sin (ID: `keyterm:Sin`); SENHOR (ID: `deity:Lord`); forgive (ID: `keyterm:Forgive`); salvation (ID: `keyterm:Salvation`); orar (ID: `keyterm:Pray`)
