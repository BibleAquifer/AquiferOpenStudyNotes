...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); Jérusalem (ID: `place:Jerusalem`); la connaissance (ID: `keyterm:Intention`); Éternel (ID: `deity:Lord`); stupide (ID: `keyterm:Stupid`); Vine (ID: `flora:Vine`); pécher (ID: `keyterm:Sin`); Israël (ID: `person:Israel`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`); Wine (ID: `realia:Wine`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); capacité (ID: `keyterm:Ability`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`); Wine (ID: `realia:Wine`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); stupide (ID: `keyterm:Stupid`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`); agir par méchanceté (ID: `keyterm:ActWickedly`); pécher (ID: `keyterm:Sin`); laissiez en possession (ID: `keyterm:Possess`); la connaissance (ID: `keyterm:Intention`); craindre (ID: `keyterm:Fear`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Cooking Pot (ID: `realia:CookingPot`); Olive Oil (ID: `realia:OliveOil`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); pécher (ID: `keyterm:Sin`); Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Fishnet (ID: `realia:Fishnet`)
...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); pollution (ID: `keyterm:Defilement`); adjuration (ID: `keyterm:Oath`); jurer (ID: `keyterm:Swear`); ardeur (ID: `keyterm:Ardour`); pécher (ID: `keyterm:Sin`); la connaissance (ID: `keyterm:Intention`); securité (ID: `keyterm:Safety`); sans saleté (ID: `keyterm:Pure`); Hell (ID: `place:Hell`); percevoir (ID: `keyterm:Perceive`); grâce (ID: `keyterm:Favor`); force (ID: `keyterm:Strength`); Lion (ID: `fauna:Lion`); Wine (ID: `realia:Wine`); Olive Oil (ID: `realia:OliveOil`); Dog (ID: `fauna:Dog`); Trap (ID: `realia:Trap`); Fishnet (ID: `realia:Fishnet`); Anointing Oil (ID: `realia:AnointingOil`); Fish (ID: `fauna:Fish`); Net (ID: `realia:Net`); Bird (ID: `fauna:Bird`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** pollution (ID: `keyterm:Defilement`); sans saleté (ID: `keyterm:Pure`); adjuration (ID: `keyterm:Oath`); pécher (ID: `keyterm:Sin`); jurer (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Hell (ID: `place:Hell`); capacité (ID: `keyterm:Ability`); force (ID: `keyterm:Strength`); aimer (ID: `keyterm:Love`); la connaissance (ID: `keyterm:Intention`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); pécher (ID: `keyterm:Sin`); gloire (ID: `keyterm:Glory`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Fly (ID: `fauna:Fly`)
...
* **Associated ACAI Concepts:** stupide (ID: `keyterm:Stupid`); Money (ID: `realia:Money`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Bed (ID: `realia:Bed`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); Caper (ID: `flora:Caper`); Locust (ID: `fauna:Locust`); Money (ID: `realia:Money`); Almond (ID: `flora:Almond`); Bird (ID: `fauna:Bird`); Rope (ID: `realia:Rope`); Pit (ID: `realia:Pit`); Clay Jar (ID: `realia:ClayJar`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); droiture (ID: `keyterm:Straightness`); la connaissance (ID: `keyterm:Intention`); vérité (ID: `keyterm:Truth`); proverbe (ID: `keyterm:Saying`); craindre (ID: `keyterm:Fear`); Goad (ID: `realia:Goad`); Flock (ID: `fauna:Flock`); Scroll (ID: `realia:Scroll`); Nail (ID: `realia:Nail`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
