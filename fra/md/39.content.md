...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); Édom (ID: `place:Edom`); Édom (ID: `group:Edom`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Édom (ID: `place:Edom`); Éternel (ID: `deity:Lord`); Édom (ID: `group:Edom`); Israël (ID: `person:Israel`); aimer (ID: `keyterm:Love`); laissiez en possession (ID: `keyterm:Possess`); Jackal (ID: `fauna:Jackal`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); craindre (ID: `keyterm:Fear`); offrande (ID: `keyterm:Offering`); alliance (ID: `keyterm:Covenant`); Lévi (ID: `person:Levi.3`); état intact (ID: `keyterm:IntactState`); pleurer (ID: `keyterm:Curse`); Lévi (ID: `group:Levi`); Priests (ID: `group:GenericPriests`); gloire (ID: `keyterm:Glory`); souiller (ID: `keyterm:Stain`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); niveau (ID: `keyterm:Fairness`); chemin (ID: `keyterm:TheWay`); nation; peuple (ID: `group:Gentile`); sans saleté (ID: `keyterm:Pure`); faire un voeu (ID: `keyterm:Vow`); prier (ID: `keyterm:AskFor`); la connaissance (ID: `keyterm:Intention`); vérité (ID: `keyterm:Truth`); An Angel (ID: `deity:Angel`); ardeur (ID: `keyterm:Ardour`); benir (ID: `keyterm:Bless`); agir avec bonté (ID: `keyterm:KindlyDisposed`); profaner, déshonorer (ID: `keyterm:Dishonor`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** souiller (ID: `keyterm:Stain`); Éternel (ID: `deity:Lord`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** craindre (ID: `keyterm:Fear`); pleurer (ID: `keyterm:Curse`); Éternel (ID: `deity:Lord`); faire un voeu (ID: `keyterm:Vow`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** benir (ID: `keyterm:Bless`); gloire (ID: `keyterm:Glory`); Éternel (ID: `deity:Lord`); pleurer (ID: `keyterm:Curse`)
...
* **Associated ACAI Concepts:** la connaissance (ID: `keyterm:Intention`); An Angel (ID: `deity:Angel`); Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); profaner, déshonorer (ID: `keyterm:Dishonor`); alliance (ID: `keyterm:Covenant`); offrande (ID: `keyterm:Offering`); aimer (ID: `keyterm:Love`); Juda (ID: `group:Judah`); délice (ID: `keyterm:Delight`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `person:Judah.4`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** profaner, déshonorer (ID: `keyterm:Dishonor`); aimer (ID: `keyterm:Love`); Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); offrande (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); offrande (ID: `keyterm:Offering`); craindre (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); jurer (ID: `keyterm:Swear`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`); alliance (ID: `keyterm:Covenant`); Juda (ID: `group:Judah`); sans saleté (ID: `keyterm:Pure`); Jérusalem (ID: `place:Jerusalem`); A Group of People (ID: `group:GenericGroup`); Juda (ID: `person:Judah.4`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); benir (ID: `keyterm:Bless`); pleurer (ID: `keyterm:Curse`); offrande (ID: `keyterm:Offering`); limite (ID: `keyterm:Decree`); Israël (ID: `person:Israel`); Sorghum (ID: `flora:Sorghum`); Vine (ID: `flora:Vine`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); être attiré à servir (ID: `keyterm:EnticedToServe`); craindre (ID: `keyterm:Fear`); Molten Image (ID: `realia:MoltenImage`); Scroll (ID: `realia:Scroll`); Cattle (ID: `fauna:Bull`); Animal Pen (ID: `realia:AnimalPen`)
...
* **Associated ACAI Concepts:** craindre (ID: `keyterm:Fear`); Animal Pen (ID: `realia:AnimalPen`); Cattle (ID: `fauna:Bull`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); montagne de Sinaï (ID: `place:SinaiMount`); limite (ID: `keyterm:Decree`); Moïse (ID: `person:Moses`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** craindre (ID: `keyterm:Fear`); Instruction (ID: `keyterm:Instruction`); Élie (ID: `person:Elijah`); Éternel (ID: `deity:Lord`); objet qui doit être détruit (ID: `keyterm:SomethingDevotedToGod`); montagne de Sinaï (ID: `place:SinaiMount`); limite (ID: `keyterm:Decree`); Moïse (ID: `person:Moses`); Israël (ID: `person:Israel`)
