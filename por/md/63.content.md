...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); para a eternidade (ID: `keyterm:Always`); fazer a paz (ID: `keyterm:Peace`); SENHOR (ID: `deity:Lord`); misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`); escolhido (ID: `keyterm:Chosen`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); fazer a paz (ID: `keyterm:Peace`); SENHOR (ID: `deity:Lord`); misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`); Truth (ID: `keyterm:Truth`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); andar (ID: `keyterm:Live.3`); compartilhar (ID: `keyterm:Share`); Ability (ID: `keyterm:Ability`); rogar (ID: `keyterm:AskFor`); corpo (ID: `keyterm:Body.3`); Truth (ID: `keyterm:Truth`); House (ID: `realia:House`)
