...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Tessalônica (ID: `place:Thessalonica`); Thessalonians (ID: `group:Thessalonica`); fazer a paz (ID: `keyterm:Peace`); Timóteo (ID: `person:Timothy`); Silas (ID: `person:Silas`); favor (ID: `keyterm:Favor`); Paulo (ID: `person:Paul`); igreja (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); be (or show oneself) just (ID: `keyterm:Just`); para a eternidade (ID: `keyterm:Always`); ser glorificado (ID: `keyterm:Glorified`); Ability (ID: `keyterm:Ability`); Glory (ID: `keyterm:Glory`); testemunhar (ID: `keyterm:BearWitness`); reino (ID: `keyterm:Kingdom`); juízo (ID: `keyterm:Judgment`); holy (ID: `keyterm:Holy`); igreja (ID: `keyterm:Church`); love (ID: `keyterm:Love`); An Angel (ID: `deity:Angel`); boa notícia (ID: `keyterm:GoodNews`); tribunal de justiça (ID: `keyterm:CourtCase`); céu (ID: `keyterm:Heaven`); fazer justiça (ID: `keyterm:GrantJustice`); dever (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); be (or show oneself) just (ID: `keyterm:Just`); tribunal de justiça (ID: `keyterm:CourtCase`); reino (ID: `keyterm:Kingdom`); juízo (ID: `keyterm:Judgment`)
...
* **Associated ACAI Concepts:** céu (ID: `keyterm:Heaven`); Ability (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** testemunhar (ID: `keyterm:BearWitness`); crer (ID: `keyterm:Believe`); ser glorificado (ID: `keyterm:Glorified`); holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); To Cause to Happen (ID: `keyterm:Happen`); orar (ID: `keyterm:Pray`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Good (ID: `keyterm:Good`); ser glorificado (ID: `keyterm:Glorified`); Ability (ID: `keyterm:Ability`); To Cause to Happen (ID: `keyterm:Happen`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); favor (ID: `keyterm:Favor`); orar (ID: `keyterm:Pray`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ser glorificado (ID: `keyterm:Glorified`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Spirit (ID: `keyterm:Spirit.2`); crer (ID: `keyterm:Believe`); Truth (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); love (ID: `keyterm:Love`); salvation (ID: `keyterm:Salvation`); decidir (ID: `keyterm:Decided`); Satanás (ID: `deity:Satan`); wipe (out), destroy (ID: `keyterm:Destroy`); example (ID: `keyterm:Example`); rogar (ID: `keyterm:AskFor`); maravilha (ID: `keyterm:Portent`); injustiça (ID: `keyterm:UnjustDeed`); objeto de culto (ID: `keyterm:ObjectOfWorship`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** maravilha (ID: `keyterm:Portent`); Satanás (ID: `deity:Satan`); Ability (ID: `keyterm:Ability`); example (ID: `keyterm:Example`)
...
* **Associated ACAI Concepts:** para a eternidade (ID: `keyterm:Always`); SENHOR (ID: `deity:Lord`); Good (ID: `keyterm:Good`); love (ID: `keyterm:Love`); hope (ID: `keyterm:Hope`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); Glory (ID: `keyterm:Glory`); SENHOR (ID: `deity:Lord`); livrar (ID: `keyterm:Deliver`); persuadir (ID: `keyterm:Persuade`); love (ID: `keyterm:Love`); orar (ID: `keyterm:Pray`); Faithfulness (ID: `keyterm:Faithfulness`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); autoridade (ID: `keyterm:Authority.2`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); Name (ID: `keyterm:Name`); tradição (ID: `keyterm:Teaching`); rogar (ID: `keyterm:AskFor`)
