...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); misericórdia (ID: `keyterm:Mercy`); escolhido (ID: `keyterm:Chosen`); fazer a paz (ID: `keyterm:Peace`); para a eternidade (ID: `keyterm:Always`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); misericórdia (ID: `keyterm:Mercy`); fazer a paz (ID: `keyterm:Peace`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); andar (ID: `keyterm:Live.3`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); corpo (ID: `keyterm:Body.3`); Truth (ID: `keyterm:Truth`); compartilhar (ID: `keyterm:Share`); rogar (ID: `keyterm:AskFor`); Ability (ID: `keyterm:Ability`); House (ID: `realia:House`)
