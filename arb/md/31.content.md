...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); أَدومَ (ID: `place:Edom`); Understanding (ID: `keyterm:Understanding`); Peace (ID: `keyterm:IntactState`); Covenant (ID: `keyterm:Covenant`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); Lot (ID: `keyterm:Lot`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); يوسف (ID: `person:Joseph.10`); Edomites (ID: `group:Edom`); أَدومَ (ID: `place:Edom`); Dispossess (ID: `keyterm:Dispossess`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** يوسف (ID: `person:Joseph.10`); Edomites (ID: `group:Edom`); أَدومَ (ID: `place:Edom`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); كَنْعَان (ID: `place:Canaan`); جِلْعَادَ (ID: `place:Gilead`); عِيسو (ID: `place:EsauMount`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); أَفْرَايِمَ (ID: `group:Ephraim`); أَفْرَايِمَ (ID: `person:Ephraim`); ٱلسَّهْلِ (ID: `place:Shephelah`); إِلَى (ID: `place:Zarephath`); ٱلسَّامِرَةِ (ID: `place:Samaria`); سَارْدِسَ (ID: `place:Sardis`); بَنْيَامِينَ (ID: `person:Benjamin`); بَنْيَامِينَ (ID: `group:Benjamin`); فِلِشْتِيم (ID: `group:Philistine`); Canaanites (ID: `group:Canaan`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** ٱلْجَنوبِ (ID: `place:Negeb`); أورشَلِيمَ (ID: `place:Jerusalem`); عِيسو (ID: `place:EsauMount`); Dispossess (ID: `keyterm:Dispossess`); كَنْعَان (ID: `place:Canaan`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Canaanites (ID: `group:Canaan`); بَنْيَامِينَ (ID: `group:Benjamin`); سَارْدِسَ (ID: `place:Sardis`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); أَفْرَايِمَ (ID: `group:Ephraim`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلسَّهْلِ (ID: `place:Shephelah`); فِلِشْتِيم (ID: `group:Philistine`); جِلْعَادَ (ID: `place:Gilead`); أَفْرَايِمَ (ID: `person:Ephraim`); إِلَى (ID: `place:Zarephath`); بَنْيَامِينَ (ID: `person:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** كَنْعَان (ID: `place:Canaan`); ٱلْجَنوبِ (ID: `place:Negeb`); إِلَى (ID: `place:Zarephath`); إِسْرَائِيلَ (ID: `person:Israel`); Canaanites (ID: `group:Canaan`); Dispossess (ID: `keyterm:Dispossess`); أورشَلِيمَ (ID: `place:Jerusalem`); سَارْدِسَ (ID: `place:Sardis`)
