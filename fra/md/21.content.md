...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); Jérusalem (ID: `place:Jerusalem`); la connaissance (ID: `keyterm:Intention`); Éternel (ID: `deity:Lord`); stupide (ID: `keyterm:Stupid`); Vine (ID: `flora:Vine`); Israël (ID: `person:Israel`); pécher (ID: `keyterm:Sin`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); Jérusalem (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); Flock (ID: `fauna:Flock`); Vine (ID: `flora:Vine`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); stupide (ID: `keyterm:Stupid`); faire un voeu (ID: `keyterm:Vow`); House (ID: `realia:House`); An Angel (ID: `deity:Angel`); tuerie (ID: `keyterm:Slaughtering`); ardeur (ID: `keyterm:Ardour`); force (ID: `keyterm:Strength`); A Man (ID: `person:GenericMale`); craindre (ID: `keyterm:Fear`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); aimer (ID: `keyterm:Love`); capacité (ID: `keyterm:Ability`); Hell (ID: `place:Hell`); force (ID: `keyterm:Strength`); pécher (ID: `keyterm:Sin`); pollution (ID: `keyterm:Defilement`); securité (ID: `keyterm:Safety`); adjuration (ID: `keyterm:Oath`); jurer (ID: `keyterm:Swear`); grâce (ID: `keyterm:Favor`); percevoir (ID: `keyterm:Perceive`); sans saleté (ID: `keyterm:Pure`); ardeur (ID: `keyterm:Ardour`); la connaissance (ID: `keyterm:Intention`); Fish (ID: `fauna:Fish`); Net (ID: `realia:Net`); Dog (ID: `fauna:Dog`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Fishnet (ID: `realia:Fishnet`); Trap (ID: `realia:Trap`); Anointing Oil (ID: `realia:AnointingOil`); Lion (ID: `fauna:Lion`); Bird (ID: `fauna:Bird`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** pollution (ID: `keyterm:Defilement`); jurer (ID: `keyterm:Swear`); adjuration (ID: `keyterm:Oath`); sans saleté (ID: `keyterm:Pure`); pécher (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); Hell (ID: `place:Hell`); capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); force (ID: `keyterm:Strength`); la connaissance (ID: `keyterm:Intention`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** force (ID: `keyterm:Strength`); la connaissance (ID: `keyterm:Intention`); Hell (ID: `place:Hell`); capacité (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); gloire (ID: `keyterm:Glory`); pécher (ID: `keyterm:Sin`); Olive Oil (ID: `realia:OliveOil`); Fly (ID: `fauna:Fly`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); craindre (ID: `keyterm:Fear`); Éternel (ID: `deity:Lord`); Caper (ID: `flora:Caper`); Money (ID: `realia:Money`); Almond (ID: `flora:Almond`); Pit (ID: `realia:Pit`); Clay Jar (ID: `realia:ClayJar`); Locust (ID: `fauna:Locust`); Rope (ID: `realia:Rope`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); proverbe (ID: `keyterm:Saying`); vérité (ID: `keyterm:Truth`); droiture (ID: `keyterm:Straightness`); la connaissance (ID: `keyterm:Intention`); craindre (ID: `keyterm:Fear`); Goad (ID: `realia:Goad`); Nail (ID: `realia:Nail`); Flock (ID: `fauna:Flock`); Scroll (ID: `realia:Scroll`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
