...
* **Associated ACAI Concepts:** Efrata (ID: `person:Ephrathah`); Ephrathites (ID: `group:Ephrathah`); Quiliom (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Malom (ID: `person:Mahlon`); Moabe (ID: `place:Moab`); Belém (ID: `place:Bethlehem`); Judá (ID: `group:Judah`); Elimeleque (ID: `person:Elimelech`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); kindness (ID: `keyterm:Kindness`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Moabe (ID: `place:Moab`); Belém (ID: `place:Bethlehem`); Noemi (ID: `person:Naomi`); Rute (ID: `person:Ruth`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** bless (ID: `keyterm:Bless`); SENHOR (ID: `deity:Lord`); kindness (ID: `keyterm:Kindness`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Elimeleque (ID: `person:Elimelech`); Moabe (ID: `place:Moab`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); Moabe (ID: `place:Moab`); to cause to possess (ID: `keyterm:Possess`); Boaz (ID: `person:Boaz`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Malom (ID: `person:Mahlon`); Moabe (ID: `place:Moab`); to cause to possess (ID: `keyterm:Possess`); Rute (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Elders (ID: `group:GenericElders`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Belém (ID: `place:Bethlehem`); Raquel (ID: `person:Rachel`); Lia (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Perez (ID: `person:Perez`); Judá (ID: `group:Judah`); Tamar (ID: `person:Tamar`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Israel (ID: `person:Israel`); bless (ID: `keyterm:Bless`); SENHOR (ID: `deity:Lord`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Hezrom (ID: `person:Hezron.2`); Salmom (ID: `person:Salmon`); Obede (ID: `person:Obed`); Aminadabe (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Jessé (ID: `person:Jesse`); Davi (ID: `person:David`); Perez (ID: `person:Perez`); Naassom (ID: `person:Nahshon`); Boaz (ID: `person:Boaz`)
