...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); pronounce innocent (ID: `keyterm:PronounceInnocent`); The Way (ID: `keyterm:TheWay`); strength (ID: `keyterm:Strength`); Libano (ID: `place:Lebanon`); Carmelo (ID: `place:Carmel`); Basã (ID: `place:Bashan`); Zealous (ID: `keyterm:Zealous.3`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); pronounce innocent (ID: `keyterm:PronounceInnocent`); The Way (ID: `keyterm:TheWay`); Basã (ID: `place:Bashan`); strength (ID: `keyterm:Strength`); Libano (ID: `place:Lebanon`); wickedness (ID: `keyterm:Wickedness`); Carmelo (ID: `place:Carmel`); Zealous (ID: `keyterm:Zealous.3`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`); Strong Drink (ID: `realia:StrongDrink`)
...
* **Associated ACAI Concepts:** The Way (ID: `keyterm:TheWay`); pronounce innocent (ID: `keyterm:PronounceInnocent`); strength (ID: `keyterm:Strength`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); peace (ID: `keyterm:IntactState`); make a vow (ID: `keyterm:Vow`); wickedness (ID: `keyterm:Wickedness`)
...
* **Associated ACAI Concepts:** being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Líbia (ID: `place:Libya`); Cush (ID: `place:Cush.2`); Egito (ID: `place:Egypt`); Pute (ID: `place:Put`); lot (ID: `keyterm:Lot`)
