...
* **Associated ACAI Concepts:** Tecoa (ID: `place:Tekoa`); Amós (ID: `person:Amos.3`); have a vision (ID: `keyterm:HaveAVision`); Israel (ID: `person:Israel`); Joás (ID: `person:Joash.4`); Jeroboão (ID: `person:Jeroboam.2`); Judá (ID: `person:Judah.4`); Uzias (ID: `person:Uzziah`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Carmelo (ID: `place:Carmel`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Damasco (ID: `place:Damascus`); Vale de Áven (ID: `place:AvenValley`); Quir (ID: `place:Kir`); Hazael (ID: `person:Hazael`); Bete-Éden (ID: `place:Beth-eden`); Ben-Hadade (ID: `person:Ben-hadad.3`); Gileade (ID: `place:Gilead`); rebel (ID: `keyterm:Rebel`); House (ID: `realia:House`); Grain (ID: `flora:Grain`); Rod (ID: `realia:Rod`); Threshing-Sledge (ID: `realia:Threshing-sledge`); Staff (ID: `realia:Staff`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); rebel (ID: `keyterm:Rebel`); Edom (ID: `place:Edom`); Amom (ID: `place:Ammon`); Nazirites (ID: `group:Nazirite`); Israel (ID: `person:Israel`); Amorites (ID: `group:Amorites`); Moabe (ID: `place:Moab`); Judá (ID: `group:Judah`); Damasco (ID: `place:Damascus`); Gileade (ID: `place:Gilead`); Judá (ID: `person:Judah.4`); Gaza (ID: `place:Gaza`); Tiro (ID: `place:Tyre`); Vale de Áven (ID: `place:AvenValley`); Bete-Éden (ID: `place:Beth-eden`); Quir (ID: `place:Kir`); Hazael (ID: `person:Hazael`); Wine (ID: `realia:Wine`); Rod (ID: `realia:Rod`); Staff (ID: `realia:Staff`); Vine (ID: `flora:Vine`); House (ID: `realia:House`); Filisteu (ID: `group:Philistine`); Ammonites (ID: `group:Ammon`); Asdode (ID: `place:Ashdod`); Bozrah (ID: `place:Bozrah.2`); Covenant (ID: `keyterm:Covenant`); speak (ID: `keyterm:Speak`); dispossess (ID: `keyterm:Dispossess`); Temã (ID: `place:Teman`); Asquelom (ID: `place:Ashkelon`); Ecrom (ID: `place:Ekron`); Ben-Hadade (ID: `person:Ben-hadad.3`); Quiriataim (ID: `place:Kiriathaim`); poor (ID: `keyterm:Poor`); Egito (ID: `place:Egypt`); decree (ID: `keyterm:Decree`); Jerusalém (ID: `place:Jerusalem`); profane, dishonor (ID: `keyterm:Dishonor`); Instruction (ID: `keyterm:Instruction`); strength (ID: `keyterm:Strength`); Filístia (ID: `place:Philistine`); Rams Horn (ID: `realia:RamsHorn`); Oak (ID: `flora:Oak`); Money (ID: `realia:Money`); Wagon (ID: `realia:Wagon`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Sheaf (ID: `realia:Sheaf`); Threshing-Sledge (ID: `realia:Threshing-sledge`); Cedar (ID: `flora:Cedar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Bow (ID: `realia:Bow`); Grain (ID: `flora:Grain`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** Filisteu (ID: `group:Philistine`); SENHOR (ID: `deity:Lord`); Asdode (ID: `place:Ashdod`); Asquelom (ID: `place:Ashkelon`); Ecrom (ID: `place:Ekron`); Filístia (ID: `place:Philistine`); Rod (ID: `realia:Rod`); Staff (ID: `realia:Staff`)
...
* **Associated ACAI Concepts:** Covenant (ID: `keyterm:Covenant`); SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); Tiro (ID: `place:Tyre`); rebel (ID: `keyterm:Rebel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Judá (ID: `person:Judah.4`); rebel (ID: `keyterm:Rebel`); Judá (ID: `group:Judah`); decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); rebel (ID: `keyterm:Rebel`); decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Betel (ID: `place:Bethel`); rebel (ID: `keyterm:Rebel`); Samaria (ID: `place:Samaria`); Egito (ID: `place:Egypt`); José (ID: `person:Joseph.10`); Vine (ID: `flora:Vine`); Gilgal (ID: `place:Gilgal.2`); Appoint (ID: `keyterm:Appoint`); Lion (ID: `fauna:Lion`); love (ID: `keyterm:Love`); Harmom (ID: `place:Harmon`); lamentation (ID: `keyterm:Lamentation`); innocence (ID: `keyterm:Innocence`); mischief (ID: `keyterm:Mischief`); Berseba (ID: `place:Beersheba`); fear (ID: `keyterm:Fear`); Complete (ID: `keyterm:Complete`); Asdode (ID: `place:Ashdod`); Sodoma (ID: `place:Sodom`); swear (ID: `keyterm:Swear`); Basã (ID: `place:Bashan`); speak (ID: `keyterm:Speak`); Gomorra (ID: `place:Gomorrah`); have insight (ID: `keyterm:HaveInsight`); To Sin (ID: `keyterm:Sin`); be kindly disposed (ID: `keyterm:KindlyDisposed`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); ardour (ID: `keyterm:Ardour`); slaughtering (ID: `keyterm:Slaughtering`); praise (ID: `keyterm:Praise`); Horns of Altar (ID: `realia:HornsOfAltar`); Wine (ID: `realia:Wine`); Sheep (ID: `fauna:Lamb`); Bed (ID: `realia:Bed`); Fishhook (ID: `realia:Fishhook`); Rams Horn (ID: `realia:RamsHorn`); Trap (ID: `realia:Trap`); Bird (ID: `fauna:Bird`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Locust (ID: `fauna:Locust`); Temple Altar (ID: `realia:TempleAltar`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Altar (ID: `realia:Altar`); Grain (ID: `flora:Grain`); Cattle (ID: `fauna:Bull`); Hewn Stone (ID: `realia:HewnStone`); Horse (ID: `fauna:Horse`); Olive Tree (ID: `flora:OliveTree`); Wormwood (ID: `flora:Wormwood`); Sandalwood (ID: `flora:Sandalwood`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Trap (ID: `realia:Trap`); Bird (ID: `fauna:Bird`); Sandalwood (ID: `flora:Sandalwood`); Rams Horn (ID: `realia:RamsHorn`); Lion (ID: `fauna:Lion`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Samaria (ID: `place:Samaria`); Bed (ID: `realia:Bed`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Lion (ID: `fauna:Lion`)
...
* **Associated ACAI Concepts:** Horns of Altar (ID: `realia:HornsOfAltar`); Betel (ID: `place:Bethel`); Israel (ID: `person:Israel`); Appoint (ID: `keyterm:Appoint`); rebel (ID: `keyterm:Rebel`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Betel (ID: `place:Bethel`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Gilgal (ID: `place:Gilgal.2`); praise (ID: `keyterm:Praise`); love (ID: `keyterm:Love`); slaughtering (ID: `keyterm:Slaughtering`); rebel (ID: `keyterm:Rebel`); offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); praise (ID: `keyterm:Praise`); love (ID: `keyterm:Love`); offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); innocence (ID: `keyterm:Innocence`); Sodoma (ID: `place:Sodom`); Egito (ID: `place:Egypt`); Gomorra (ID: `place:Gomorrah`); Grain (ID: `flora:Grain`); Vine (ID: `flora:Vine`); Locust (ID: `fauna:Locust`); Horse (ID: `fauna:Horse`); Olive Tree (ID: `flora:OliveTree`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); House (ID: `realia:House`); Woe (ID: `keyterm:Woe.2`); Hamate (ID: `place:Hamath`); offering (ID: `keyterm:Offering`); Lyre (ID: `realia:Lyre`); Cattle (ID: `fauna:Bull`); Ribeiro de Arabá (ID: `place:BrookOfTheArabah`); Quium (ID: `deity:Kiyyun`); Lo-Debar (ID: `place:Lo-debar`); Calné (ID: `place:Calneh`); Sicute (ID: `deity:Sikkuth`); José (ID: `person:Joseph.10`); Filisteu (ID: `group:Philistine`); swear (ID: `keyterm:Swear`); Samaria (ID: `place:Samaria`); Damasco (ID: `place:Damascus`); Davi (ID: `person:David`); smear (ID: `keyterm:Smear`); lean on (ID: `keyterm:LeanOn`); Jerusalém (ID: `place:Jerusalem`); Gate (ID: `place:Gath`); slaughtering (ID: `keyterm:Slaughtering`); Asterote-Carnaim (ID: `place:Ashteroth-karnaim`); Filístia (ID: `place:Philistine`); Wine (ID: `realia:Wine`); Sheep (ID: `fauna:Lamb`); Bed (ID: `realia:Bed`); Anointing Oil (ID: `realia:AnointingOil`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Snake (ID: `fauna:Snake`); Vine (ID: `flora:Vine`); Animal Pen (ID: `realia:AnimalPen`); Olive Oil (ID: `realia:OliveOil`); Goat (ID: `fauna:Goat`); Bear (ID: `fauna:Bear`); Flock (ID: `fauna:Flock`); Mattock (ID: `realia:Mattock`); Image (ID: `realia:Image`); Horse (ID: `fauna:Horse`); Molten Image (ID: `realia:MoltenImage`); Wormwood (ID: `flora:Wormwood`); Lion (ID: `fauna:Lion`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Quium (ID: `deity:Kiyyun`); Sicute (ID: `deity:Sikkuth`); Israel (ID: `person:Israel`); slaughtering (ID: `keyterm:Slaughtering`); Damasco (ID: `place:Damascus`); Lyre (ID: `realia:Lyre`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** Quium (ID: `deity:Kiyyun`); Sicute (ID: `deity:Sikkuth`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); slaughtering (ID: `keyterm:Slaughtering`); offering (ID: `keyterm:Offering`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); lean on (ID: `keyterm:LeanOn`); Samaria (ID: `place:Samaria`)
...
* **Associated ACAI Concepts:** Calné (ID: `place:Calneh`); Hamate (ID: `place:Hamath`); Gate (ID: `place:Gath`); Filisteu (ID: `group:Philistine`); Filístia (ID: `place:Philistine`)
...
* **Associated ACAI Concepts:** José (ID: `person:Joseph.10`); smear (ID: `keyterm:Smear`); Davi (ID: `person:David`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Lyre (ID: `realia:Lyre`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Amós (ID: `person:Amos.3`); speak (ID: `keyterm:Speak`); Amazias (ID: `person:Amaziah.4`); Jeroboão (ID: `person:Jeroboam.2`); Egito (ID: `place:Egypt`); Isaque (ID: `person:Isaac`); swear (ID: `keyterm:Swear`); Betel (ID: `place:Bethel`); To Sin (ID: `keyterm:Sin`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Rio Nilo (ID: `place:Nile`); Plumb Line (ID: `realia:PlumbLine`); Basket (ID: `realia:Basket`); Hell (ID: `place:Hell`); Filisteu (ID: `group:Philistine`); Berseba (ID: `place:Beersheba`); Cushites (ID: `group:Cush`); Creta (ID: `place:Crete`); defilement (ID: `keyterm:Defilement`); sabbath (ID: `keyterm:Sabbath`); Judá (ID: `group:Judah`); Samaria (ID: `place:Samaria`); new moon festival (ID: `keyterm:NewMoonFestival`); Carmelo (ID: `place:Carmel`); Cush (ID: `place:Cush.2`); forgive (ID: `keyterm:Forgive`); Dã (ID: `group:Dan`); play the prostitute (ID: `keyterm:PlayTheProstitute`); Judá (ID: `person:Judah.4`); Syrians (ID: `group:Syria`); Deceit (ID: `keyterm:Deceit`); lamentation (ID: `keyterm:Lamentation`); Dã (ID: `place:Dan`); Quir (ID: `place:Kir`); Filístia (ID: `place:Philistine`); Floor (ID: `realia:Floor`); Sieve (ID: `realia:Sieve`); High Place (ID: `realia:HighPlace`); Rope (ID: `realia:Rope`); Sycomore Fig (ID: `flora:SycomoreFig`); Sackcloth (ID: `realia:Sackcloth`); Capital (ID: `realia:Capital`); Stone Pine (ID: `flora:Pine`); Grass (ID: `flora:Grass`); Snake (ID: `fauna:Snake`); Shekel (ID: `realia:Shekel`); Balance (ID: `realia:Balance`); Money (ID: `realia:Money`); Stone Altar (ID: `realia:StoneAltar`); Doorstep (ID: `realia:Doorstep`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Locust (ID: `fauna:Locust`); Temple Altar (ID: `realia:TempleAltar`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Altar (ID: `realia:Altar`); House (ID: `realia:House`); Ephah (ID: `realia:Ephah`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Amós (ID: `person:Amos.3`); speak (ID: `keyterm:Speak`); Amazias (ID: `person:Amaziah.4`); SENHOR (ID: `deity:Lord`); Jeroboão (ID: `person:Jeroboam.2`); Betel (ID: `place:Bethel`); Isaque (ID: `person:Isaac`); defilement (ID: `keyterm:Defilement`); Judá (ID: `group:Judah`); play the prostitute (ID: `keyterm:PlayTheProstitute`); Judá (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Rope (ID: `realia:Rope`); Sycomore Fig (ID: `flora:SycomoreFig`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** Amazias (ID: `person:Amaziah.4`); Amós (ID: `person:Amos.3`); speak (ID: `keyterm:Speak`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); speak (ID: `keyterm:Speak`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); swear (ID: `keyterm:Swear`); Israel (ID: `person:Israel`); Berseba (ID: `place:Beersheba`); sabbath (ID: `keyterm:Sabbath`); Samaria (ID: `place:Samaria`); new moon festival (ID: `keyterm:NewMoonFestival`); Dã (ID: `group:Dan`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Egito (ID: `place:Egypt`); Deceit (ID: `keyterm:Deceit`); lamentation (ID: `keyterm:Lamentation`); Dã (ID: `place:Dan`); Rio Nilo (ID: `place:Nile`); Sackcloth (ID: `realia:Sackcloth`); Shekel (ID: `realia:Shekel`); Money (ID: `realia:Money`); Balance (ID: `realia:Balance`); Ephah (ID: `realia:Ephah`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Dã (ID: `place:Dan`); Dã (ID: `group:Dan`); Berseba (ID: `place:Beersheba`); swear (ID: `keyterm:Swear`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Samaria (ID: `place:Samaria`)
...
* **Associated ACAI Concepts:** Dã (ID: `place:Dan`); SENHOR (ID: `deity:Lord`); Dã (ID: `group:Dan`); Berseba (ID: `place:Beersheba`); swear (ID: `keyterm:Swear`); Samaria (ID: `place:Samaria`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Doorstep (ID: `realia:Doorstep`); Altar (ID: `realia:Altar`); Capital (ID: `realia:Capital`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Cush (ID: `place:Cush.2`); Filisteu (ID: `group:Philistine`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Cushites (ID: `group:Cush`); Creta (ID: `place:Crete`); Quir (ID: `place:Kir`); Syrians (ID: `group:Syria`); Egito (ID: `place:Egypt`); Filístia (ID: `place:Philistine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); Davi (ID: `person:David`); dispossess (ID: `keyterm:Dispossess`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Vine (ID: `flora:Vine`); Israel (ID: `person:Israel`); Edom (ID: `place:Edom`); dispossess (ID: `keyterm:Dispossess`); Davi (ID: `person:David`); Coriander (ID: `flora:Coriander`); Wine (ID: `realia:Wine`); Must (ID: `realia:Must`); Barley (ID: `flora:Barley`); Mattock (ID: `realia:Mattock`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Coriander (ID: `flora:Coriander`); Must (ID: `realia:Must`); Vine (ID: `flora:Vine`); Barley (ID: `flora:Barley`); Mattock (ID: `realia:Mattock`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Vine (ID: `flora:Vine`); Israel (ID: `person:Israel`); Coriander (ID: `flora:Coriander`); Must (ID: `realia:Must`); Wine (ID: `realia:Wine`); Barley (ID: `flora:Barley`); Mattock (ID: `realia:Mattock`)
