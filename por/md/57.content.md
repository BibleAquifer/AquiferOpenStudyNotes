...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Filemom (ID: `person:Philemon`); Áfia (ID: `person:Apphia`); Arquipo (ID: `person:Archippus`); amado (ID: `keyterm:Beloved`); Timóteo (ID: `person:Timothy`); fazer a paz (ID: `keyterm:Peace`); igreja (ID: `keyterm:Church`); Paulo (ID: `person:Paul`); favor (ID: `keyterm:Favor`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`); holy (ID: `keyterm:Holy`); Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); compaixão (ID: `keyterm:Affection`); comunhão (ID: `keyterm:Fellowship`); orar (ID: `keyterm:Pray`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Paulo (ID: `person:Paul`); em cristo (ID: `keyterm:InChrist`); rogar (ID: `keyterm:AskFor`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Epafras (ID: `person:Epaphras`); Lucas (ID: `person:Luke`); Demas (ID: `person:Demas`); em cristo (ID: `keyterm:InChrist`); Aristarco (ID: `person:Aristarchus`); favor (ID: `keyterm:Favor`); Marcos (ID: `person:Mark`); Spirit (ID: `keyterm:Spirit.2`)
