...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); Hell (ID: `place:Hell`); make a vow (ID: `keyterm:Vow`); Jope (ID: `place:Joppa`); Nínive (ID: `place:Nineveh`); Amittai (ID: `person:Amittai`); kindness (ID: `keyterm:Kindness`); slaughtering (ID: `keyterm:Slaughtering`); lot (ID: `keyterm:Lot`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Társis (ID: `place:Tarshish`); salvation (ID: `keyterm:Salvation`); exempt (ID: `keyterm:Exempt`); praise (ID: `keyterm:Praise`); Hebrews (ID: `group:Hebrews`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** slaughtering (ID: `keyterm:Slaughtering`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); make a vow (ID: `keyterm:Vow`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Hell (ID: `place:Hell`); make a vow (ID: `keyterm:Vow`); kindness (ID: `keyterm:Kindness`); praise (ID: `keyterm:Praise`); Jonas (ID: `person:Jonah.2`); salvation (ID: `keyterm:Salvation`); Fish (ID: `fauna:Fish`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** make a vow (ID: `keyterm:Vow`); kindness (ID: `keyterm:Kindness`); praise (ID: `keyterm:Praise`); salvation (ID: `keyterm:Salvation`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Nínive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Sackcloth (ID: `realia:Sackcloth`); Cattle (ID: `fauna:Bull`); Word of the Lord (ID: `keyterm:WordOfTheLord`); kindness (ID: `keyterm:Kindness`); Believe In (ID: `keyterm:BelieveIn`); gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`); Compassionate (ID: `keyterm:Compassionate`); Worm (ID: `fauna:Maggot`); Flock (ID: `fauna:Flock`); Clothing (ID: `realia:Clothing`); Throne (ID: `realia:Throne`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Cattle (ID: `fauna:Bull`); Nínive (ID: `place:Nineveh`); SENHOR (ID: `deity:Lord`); Flock (ID: `fauna:Flock`); Sackcloth (ID: `realia:Sackcloth`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); kindness (ID: `keyterm:Kindness`); gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`); Compassionate (ID: `keyterm:Compassionate`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** kindness (ID: `keyterm:Kindness`); gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`); Compassionate (ID: `keyterm:Compassionate`); SENHOR (ID: `deity:Lord`)
