...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); fear (ID: `keyterm:Fear`); Fish (ID: `fauna:Fish`); Ship (ID: `realia:Ship`); make a vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); Nínive (ID: `place:Nineveh`); Jope (ID: `place:Joppa`); Amittai (ID: `person:Amittai`); praise (ID: `keyterm:Praise`); lot (ID: `keyterm:Lot`); exempt (ID: `keyterm:Exempt`); kindness (ID: `keyterm:Kindness`); Word of the Lord (ID: `keyterm:WordOfTheLord`); salvation (ID: `keyterm:Salvation`); slaughtering (ID: `keyterm:Slaughtering`); Társis (ID: `place:Tarshish`); Hebrews (ID: `group:Hebrews`); Cattails (ID: `flora:Cattails`)
## Jonas 1.2 (id: 741563)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Hell (ID: `place:Hell`); Jonas (ID: `person:Jonah.2`); praise (ID: `keyterm:Praise`); make a vow (ID: `keyterm:Vow`); kindness (ID: `keyterm:Kindness`); salvation (ID: `keyterm:Salvation`); Fish (ID: `fauna:Fish`); Cattails (ID: `flora:Cattails`)
## Jonas 2.2 (id: 741570)
...
* **Associated ACAI Concepts:** praise (ID: `keyterm:Praise`); SENHOR (ID: `deity:Lord`); make a vow (ID: `keyterm:Vow`); kindness (ID: `keyterm:Kindness`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Nínive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Sackcloth (ID: `realia:Sackcloth`); Cattle (ID: `fauna:Bull`); Word of the Lord (ID: `keyterm:WordOfTheLord`); gracious (ID: `keyterm:Generous`); Compassionate (ID: `keyterm:Compassionate`); Társis (ID: `place:Tarshish`); Believe In (ID: `keyterm:BelieveIn`); kindness (ID: `keyterm:Kindness`); Flock (ID: `fauna:Flock`); Clothing (ID: `realia:Clothing`); Throne (ID: `realia:Throne`); Worm (ID: `fauna:Maggot`); Goat (ID: `fauna:Goat`)
## Jonas 3.3 (id: 741578)
...
* **Associated ACAI Concepts:** Word of the Lord (ID: `keyterm:WordOfTheLord`); Jonas (ID: `person:Jonah.2`); Nínive (ID: `place:Nineveh`); SENHOR (ID: `deity:Lord`)
## Jonas 3.4 (id: 741579)
...
* **Associated ACAI Concepts:** Nínive (ID: `place:Nineveh`); Throne (ID: `realia:Throne`); Sackcloth (ID: `realia:Sackcloth`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); gracious (ID: `keyterm:Generous`); Compassionate (ID: `keyterm:Compassionate`); Társis (ID: `place:Tarshish`); kindness (ID: `keyterm:Kindness`); Worm (ID: `fauna:Maggot`)
## Jonas 4.2 (id: 741586)
...
* **Associated ACAI Concepts:** gracious (ID: `keyterm:Generous`); Compassionate (ID: `keyterm:Compassionate`); Társis (ID: `place:Tarshish`); SENHOR (ID: `deity:Lord`); kindness (ID: `keyterm:Kindness`)
