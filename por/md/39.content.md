...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); Israel (ID: `person:Israel`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`); fear (ID: `keyterm:Fear`); offering (ID: `keyterm:Offering`); stain (ID: `keyterm:Stain`); Glory (ID: `keyterm:Glory`); Levi (ID: `person:Levi.3`); Priests (ID: `group:GenericPriests`); utter a curse (ID: `keyterm:Curse`); Levi (ID: `group:Levi`); peace (ID: `keyterm:IntactState`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); fairness (ID: `keyterm:Fairness`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); make a vow (ID: `keyterm:Vow`); profane, dishonor (ID: `keyterm:Dishonor`); An Angel (ID: `deity:Angel`); ardour (ID: `keyterm:Ardour`); bless (ID: `keyterm:Bless`); be kindly disposed (ID: `keyterm:KindlyDisposed`); The Way (ID: `keyterm:TheWay`); evil intention (ID: `keyterm:Intention`); pure (ID: `keyterm:Pure`); rogar (ID: `keyterm:AskFor`); Gentiles (ID: `group:Gentile`); Truth (ID: `keyterm:Truth`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** stain (ID: `keyterm:Stain`); SENHOR (ID: `deity:Lord`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Covenant (ID: `keyterm:Covenant`); SENHOR (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); profane, dishonor (ID: `keyterm:Dishonor`); Covenant (ID: `keyterm:Covenant`); offering (ID: `keyterm:Offering`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); delight (ID: `keyterm:Delight`); Judá (ID: `group:Judah`); love (ID: `keyterm:Love`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); profane, dishonor (ID: `keyterm:Dishonor`); Judá (ID: `group:Judah`); Israel (ID: `person:Israel`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Levi (ID: `group:Levi`); pure (ID: `keyterm:Pure`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); swear (ID: `keyterm:Swear`); Judá (ID: `group:Judah`); An Angel (ID: `deity:Angel`); Levi (ID: `person:Levi.3`); fear (ID: `keyterm:Fear`); Covenant (ID: `keyterm:Covenant`); A Group of People (ID: `group:GenericGroup`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); decree (ID: `keyterm:Decree`); utter a curse (ID: `keyterm:Curse`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); bless (ID: `keyterm:Bless`); Wheat (ID: `flora:Wheat`); House (ID: `realia:House`); Sorghum (ID: `flora:Sorghum`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); be enticed to serve (ID: `keyterm:EnticedToServe`); fear (ID: `keyterm:Fear`); Scroll (ID: `realia:Scroll`); Animal Pen (ID: `realia:AnimalPen`); Cattle (ID: `fauna:Bull`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated ACAI Concepts:** Moisés (ID: `person:Moses`); decree (ID: `keyterm:Decree`); Monte Sinai (ID: `place:SinaiMount`); Instruction (ID: `keyterm:Instruction`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Moisés (ID: `person:Moses`); decree (ID: `keyterm:Decree`); Elias (ID: `person:Elijah`); SENHOR (ID: `deity:Lord`); Monte Sinai (ID: `place:SinaiMount`); Instruction (ID: `keyterm:Instruction`); Israel (ID: `person:Israel`); fear (ID: `keyterm:Fear`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`)
