...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Tessalônica (ID: `place:Thessalonica`); favor (ID: `keyterm:Favor`); Thessalonians (ID: `group:Thessalonica`); Paulo (ID: `person:Paul`); Timóteo (ID: `person:Timothy`); Silas (ID: `person:Silas`); igreja (ID: `keyterm:Church`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); dever (ID: `keyterm:Ought`); igreja (ID: `keyterm:Church`); fazer justiça (ID: `keyterm:GrantJustice`); juízo (ID: `keyterm:Judgment`); Ability (ID: `keyterm:Ability`); holy (ID: `keyterm:Holy`); testemunhar (ID: `keyterm:BearWitness`); para a eternidade (ID: `keyterm:Always`); tribunal de justiça (ID: `keyterm:CourtCase`); Glory (ID: `keyterm:Glory`); love (ID: `keyterm:Love`); ser glorificado (ID: `keyterm:Glorified`); boa notícia (ID: `keyterm:GoodNews`); reino (ID: `keyterm:Kingdom`); An Angel (ID: `deity:Angel`); céu (ID: `keyterm:Heaven`)
...
* **Associated ACAI Concepts:** reino (ID: `keyterm:Kingdom`); SENHOR (ID: `deity:Lord`); juízo (ID: `keyterm:Judgment`); be (or show oneself) just (ID: `keyterm:Just`); tribunal de justiça (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** To Cause to Happen (ID: `keyterm:Happen`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); favor (ID: `keyterm:Favor`); Name (ID: `keyterm:Name`); ser glorificado (ID: `keyterm:Glorified`); crer (ID: `keyterm:Believe`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** favor (ID: `keyterm:Favor`); Name (ID: `keyterm:Name`); ser glorificado (ID: `keyterm:Glorified`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); Spirit (ID: `keyterm:Spirit.2`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); Ability (ID: `keyterm:Ability`); wipe (out), destroy (ID: `keyterm:Destroy`); injustiça (ID: `keyterm:UnjustDeed`); maravilha (ID: `keyterm:Portent`); objeto de culto (ID: `keyterm:ObjectOfWorship`); Satanás (ID: `deity:Satan`); salvation (ID: `keyterm:Salvation`); rogar (ID: `keyterm:AskFor`); decidir (ID: `keyterm:Decided`); example (ID: `keyterm:Example`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); favor (ID: `keyterm:Favor`); rogar (ID: `keyterm:AskFor`); SENHOR (ID: `deity:Lord`); Good (ID: `keyterm:Good`); hope (ID: `keyterm:Hope`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); love (ID: `keyterm:Love`); livrar (ID: `keyterm:Deliver`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); persuadir (ID: `keyterm:Persuade`); Glory (ID: `keyterm:Glory`); Faithfulness (ID: `keyterm:Faithfulness`)
...
* **Associated ACAI Concepts:** andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); autoridade (ID: `keyterm:Authority.2`); Name (ID: `keyterm:Name`); rogar (ID: `keyterm:AskFor`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); tradição (ID: `keyterm:Teaching`); Ability (ID: `keyterm:Ability`)
