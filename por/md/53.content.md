...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Tessalônica (ID: `place:Thessalonica`); igreja (ID: `keyterm:Church`); favor (ID: `keyterm:Favor`); Silas (ID: `person:Silas`); Paulo (ID: `person:Paul`); fazer a paz (ID: `keyterm:Peace`); Timóteo (ID: `person:Timothy`); Thessalonians (ID: `group:Thessalonica`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); juízo (ID: `keyterm:Judgment`); céu (ID: `keyterm:Heaven`); dever (ID: `keyterm:Ought`); igreja (ID: `keyterm:Church`); fazer justiça (ID: `keyterm:GrantJustice`); boa notícia (ID: `keyterm:GoodNews`); para a eternidade (ID: `keyterm:Always`); Glory (ID: `keyterm:Glory`); testemunhar (ID: `keyterm:BearWitness`); Ability (ID: `keyterm:Ability`); reino (ID: `keyterm:Kingdom`); ser glorificado (ID: `keyterm:Glorified`); tribunal de justiça (ID: `keyterm:CourtCase`); holy (ID: `keyterm:Holy`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** tribunal de justiça (ID: `keyterm:CourtCase`); SENHOR (ID: `deity:Lord`); juízo (ID: `keyterm:Judgment`); reino (ID: `keyterm:Kingdom`); be (or show oneself) just (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** holy (ID: `keyterm:Holy`); crer (ID: `keyterm:Believe`); ser glorificado (ID: `keyterm:Glorified`); testemunhar (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Good (ID: `keyterm:Good`); To Cause to Happen (ID: `keyterm:Happen`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); crer (ID: `keyterm:Believe`); Good (ID: `keyterm:Good`); favor (ID: `keyterm:Favor`); Name (ID: `keyterm:Name`); To Cause to Happen (ID: `keyterm:Happen`); Jesus (ID: `person:Jesus.2`); orar (ID: `keyterm:Pray`); ser glorificado (ID: `keyterm:Glorified`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); Name (ID: `keyterm:Name`); Jesus (ID: `person:Jesus.2`); ser glorificado (ID: `keyterm:Glorified`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); Spirit (ID: `keyterm:Spirit.2`); Truth (ID: `keyterm:Truth`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); wipe (out), destroy (ID: `keyterm:Destroy`); rogar (ID: `keyterm:AskFor`); example (ID: `keyterm:Example`); Ability (ID: `keyterm:Ability`); objeto de culto (ID: `keyterm:ObjectOfWorship`); salvation (ID: `keyterm:Salvation`); decidir (ID: `keyterm:Decided`); Satanás (ID: `deity:Satan`); maravilha (ID: `keyterm:Portent`); injustiça (ID: `keyterm:UnjustDeed`); love (ID: `keyterm:Love`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** rogar (ID: `keyterm:AskFor`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); Good (ID: `keyterm:Good`); Jesus (ID: `person:Jesus.2`); hope (ID: `keyterm:Hope`); para a eternidade (ID: `keyterm:Always`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); livrar (ID: `keyterm:Deliver`); Faithfulness (ID: `keyterm:Faithfulness`); Glory (ID: `keyterm:Glory`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); persuadir (ID: `keyterm:Persuade`); orar (ID: `keyterm:Pray`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); Ability (ID: `keyterm:Ability`); autoridade (ID: `keyterm:Authority.2`); tradição (ID: `keyterm:Teaching`); Name (ID: `keyterm:Name`)
