...
* **Associated ACAI Concepts:** Loida (ID: `person:Lois`); Eunice (ID: `person:Eunice`)
...
* **Associated ACAI Concepts:** Figello (ID: `person:Phygelus`); Hermógenes (ID: `person:Hermogenes`)
...
* **Associated ACAI Concepts:** Figello (ID: `person:Phygelus`); Hermógenes (ID: `person:Hermogenes`); Onesíforo (ID: `person:Onesiphorus`)
...
* **Associated ACAI Concepts:** Fileto (ID: `person:Philetus`); Himeneo (ID: `person:Hymenaeus`); aprobado (ID: `keyterm:Approved`)
...
* **Associated ACAI Concepts:** Jambres (ID: `person:Jambres`); Jannes (ID: `person:Jannes`); Iconio (ID: `place:Iconium`); testificar solemnemente (ID: `keyterm:Declare`); escritura (ID: `keyterm:Scripture`); Jesús (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Crescente (ID: `person:Crescens`); Dalmacia (ID: `place:Dalmatia`); Demas (ID: `person:Demas`)
...
* **Associated ACAI Concepts:** casa (ID: `person:Carpus`); Parchment (ID: `realia:Parchment`)
...
* **Associated ACAI Concepts:** Alejandro (ID: `person:Alexander.4`)
...
* **Associated ACAI Concepts:** liberar (ID: `keyterm:Deliver`)
...
* **Associated ACAI Concepts:** Eubulo (ID: `person:Eubulus`); Lino (ID: `person:Linus`); Claudia (ID: `person:Claudia`); Pudente (ID: `person:Pudens`); Onesíforo (ID: `person:Onesiphorus`); Mileto (ID: `place:Miletus`); Trófimo (ID: `person:Trophimus`); Erasto (ID: `person:Erastus`); Priscila (ID: `person:Priscilla`)
