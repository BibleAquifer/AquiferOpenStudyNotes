...
* **Associated ACAI Concepts:** Efratita (ID: `group:Ephrathah`); Ephrata (ID: `person:Ephrathah`); Chelión (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Elimelech (ID: `person:Elimelech`); Judá (ID: `group:Judah`); Mahalón (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Catah (ID: `place:Bethlehem`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); Catah (ID: `place:Bethlehem`); Noemi (ID: `person:Naomi`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); bondad (ID: `keyterm:Kindness`); bendecir (ID: `keyterm:Bless`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Rachêl (ID: `person:Rachel`); Jehová (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); Israel (ID: `person:Israel`); Catah (ID: `place:Bethlehem`); Lea (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); Judá (ID: `group:Judah`); Thamar (ID: `person:Tamar`); Phares (ID: `person:Perez`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Jehová (ID: `deity:Lord`); bendecir (ID: `keyterm:Bless`); Israel (ID: `person:Israel`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Hesrón (ID: `person:Hezron.2`); Salmón (ID: `person:Salmon`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Isaí (ID: `person:Jesse`); Nahasón (ID: `person:Nahshon`); Booz (ID: `person:Boaz`); David (ID: `person:David`); Phares (ID: `person:Perez`)
