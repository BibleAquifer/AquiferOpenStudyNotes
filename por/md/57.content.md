...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Áfia (ID: `person:Apphia`); Arquipo (ID: `person:Archippus`); Filemom (ID: `person:Philemon`); SENHOR (ID: `deity:Lord`); fazer a paz (ID: `keyterm:Peace`); Timóteo (ID: `person:Timothy`); favor (ID: `keyterm:Favor`); Paulo (ID: `person:Paul`); amado (ID: `keyterm:Beloved`); igreja (ID: `keyterm:Church`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`); holy (ID: `keyterm:Holy`); crer (ID: `keyterm:Believe`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); compaixão (ID: `keyterm:Affection`); comunhão (ID: `keyterm:Fellowship`); orar (ID: `keyterm:Pray`); rogar (ID: `keyterm:AskFor`); Cause of Joy (ID: `keyterm:CauseOfJoy`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); em cristo (ID: `keyterm:InChrist`); Paulo (ID: `person:Paul`); rogar (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** boa notícia (ID: `keyterm:GoodNews`); Good (ID: `keyterm:Good`); servir (ID: `keyterm:Serve`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Lucas (ID: `person:Luke`); Epafras (ID: `person:Epaphras`); Demas (ID: `person:Demas`); Marcos (ID: `person:Mark`); Spirit (ID: `keyterm:Spirit.2`); favor (ID: `keyterm:Favor`); em cristo (ID: `keyterm:InChrist`); Aristarco (ID: `person:Aristarchus`)
