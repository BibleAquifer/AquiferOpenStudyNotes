...
* **Associated ACAI Concepts:** Tophel (ID: `place:Tophel`); Dizahab (ID: `place:Dizahab`); Suph (ID: `place:Suph`); Laban (ID: `place:Laban`); Hazeroth (ID: `place:Hazeroth`); Paran (ID: `place:Paran`); Moses (ID: `person:Moses`); Israel (ID: `person:Israel`); Jordan River (ID: `place:Jordan`); Arabah (ID: `place:Arabah`)
...
* **Associated ACAI Concepts:** Moses (ID: `person:Moses`); Israel (ID: `person:Israel`); Jordan River (ID: `place:Jordan`); Mount Sinai (ID: `place:SinaiMount`); Laban (ID: `place:Laban`); Tophel (ID: `place:Tophel`); Dizahab (ID: `place:Dizahab`); Hazeroth (ID: `place:Hazeroth`); Edrei (ID: `place:Edrei`); Mount Seir (ID: `place:SeirMount`); Suph (ID: `place:Suph`); Heshbon (ID: `place:Heshbon`); Paran (ID: `place:Paran`); LORD (ID: `deity:Lord`); Bashan (ID: `place:Bashan`); Arabah (ID: `place:Arabah`); Sihon (ID: `person:Sihon`); Og (ID: `person:Og`); Instruction (ID: `keyterm:Instruction`); Amorites (ID: `group:Amorites`); Ashtaroth (ID: `place:Ashtaroth`); Moab (ID: `place:Moab`); Kadesh-barnea (ID: `place:Kadesh-barnea`)
...
* **Associated Articles:** Deuteronomy 1:19 (ID: `10139@AquiferOpenStudyNotes`)
...
* **Associated Articles:** Amos 4:1 (ID: `9720@AquiferOpenStudyNotes`); Numbers 21:13 (ID: `22766@AquiferOpenStudyNotes`)

* **Associated ACAI Concepts:** Edrei (ID: `place:Edrei`); Amorites (ID: `group:Amorites`); Heshbon (ID: `place:Heshbon`); Sihon (ID: `person:Sihon`); Bashan (ID: `place:Bashan`); Og (ID: `person:Og`); Ashtaroth (ID: `place:Ashtaroth`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Dispossess (ID: `keyterm:Dispossess`); Jordan River (ID: `place:Jordan`); Fear (ID: `keyterm:Fear`); Amorites (ID: `group:Amorites`); To Cause to Possess (ID: `keyterm:Possess`); Bashan (ID: `place:Bashan`); Sihon (ID: `person:Sihon`); Seir (ID: `place:Seir`); Decree (ID: `keyterm:Decree`); Og (ID: `person:Og`); Edomites (ID: `group:Edom`); Edom (ID: `place:Edom`); Gilead (ID: `place:Gilead`); Swear (ID: `keyterm:Swear`); Arnon (ID: `place:Arnon`); Ammon (ID: `place:Ammon`); Israel (ID: `person:Israel`); Heshbon (ID: `place:Heshbon`); Egypt (ID: `place:Egypt`); Moab (ID: `place:Moab`); Rephaim (ID: `group:Rephaim`); Anak (ID: `person:Anak`); Mount Sinai (ID: `place:SinaiMount`); Anakim (ID: `group:Anak`); Kadesh-barnea (ID: `place:Kadesh-barnea`); Arabah (ID: `place:Arabah`); Argob (ID: `place:Argob`); Ar (ID: `place:Ar`); Covenant (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** Amorites (ID: `group:Amorites`); Canaan (ID: `place:Canaan`); Negev (ID: `place:Negeb`); Euphrates River (ID: `place:Euphrates`); Arabah (ID: `place:Arabah`); Lebanon (ID: `place:Lebanon`); Shephelah (ID: `place:Shephelah`); Canaanites (ID: `group:Canaan`)
...
* **Associated ACAI Concepts:** Isaac (ID: `person:Isaac`); Swear (ID: `keyterm:Swear`); Dispossess (ID: `keyterm:Dispossess`); Abraham (ID: `person:Abraham`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
Kadesh\-barnea was a large oasis with many wells and springs. It was about 80 kilometers (50 miles) south of Beersheba, which was the traditional southern point of Israel (see2 Samuel 3:10; 1 Chronicles 21:2).

* **Associated Passages:** Deuteronomy 1:19

* **Associated ACAI Concepts:** Amorites (ID: `group:Amorites`); LORD (ID: `deity:Lord`); Mount Sinai (ID: `place:SinaiMount`); Fear (ID: `keyterm:Fear`); Kadesh-barnea (ID: `place:Kadesh-barnea`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Amorites (ID: `group:Amorites`); Fear (ID: `keyterm:Fear`); Valley of Eshcol (ID: `place:EshcolValley`); Dispossess (ID: `keyterm:Dispossess`); Mount Sinai (ID: `place:SinaiMount`); Kadesh-barnea (ID: `place:Kadesh-barnea`); Wheat (ID: `flora:Wheat`); Sorghum (ID: `flora:Sorghum`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); Amorites (ID: `group:Amorites`); Swear (ID: `keyterm:Swear`); Egypt (ID: `place:Egypt`); Caleb (ID: `person:Caleb`); Anakim (ID: `group:Anak`); Nun (ID: `person:Nun`); Believe In (ID: `keyterm:BelieveIn`); Red Sea (ID: `place:RedSea`); Joshua (ID: `person:Joshua.2`); Fear (ID: `keyterm:Fear`); To Sin (ID: `keyterm:Sin`); Jephunneh (ID: `person:Jephunneh`); Zephath (ID: `place:Zephath`); Israel (ID: `person:Israel`); Anak (ID: `person:Anak`); Dispossess (ID: `keyterm:Dispossess`); Seir (ID: `place:Seir`); Kadesh-barnea (ID: `place:Kadesh-barnea`); Bee (ID: `fauna:Bee`); Tent (ID: `realia:Tent`); Cattails (ID: `flora:Cattails`)
...
* **Associated Articles:** Deuteronomy 1:1 (ID: `10140@AquiferOpenStudyNotes`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Edomites (ID: `group:Edom`); Edom (ID: `place:Edom`); Seir (ID: `place:Seir`); To Cause to Possess (ID: `keyterm:Possess`); Dispossess (ID: `keyterm:Dispossess`); Moab (ID: `place:Moab`); Complete (ID: `keyterm:Complete`); Anakim (ID: `group:Anak`); Anak (ID: `person:Anak`); Valley of Zered (ID: `place:Zered`); Emim (ID: `group:Emim`); Horites (ID: `group:Hori`); Rephaim (ID: `group:Rephaim`); Hori (ID: `person:Hori`); Ammon (ID: `place:Ammon`); Ar (ID: `place:Ar`); Fear (ID: `keyterm:Fear`); Lot (ID: `person:Lot`); Arabah (ID: `place:Arabah`); Avvim (ID: `group:Avvim`); Caphtorim (ID: `group:Caphtorim`); Hazerim (ID: `place:Hazerim`); Ezion-geber (ID: `place:Ezion-geber`); Gaza (ID: `place:Gaza`); Kadesh-barnea (ID: `place:Kadesh-barnea`); Heshbon (ID: `place:Heshbon`); Arnon (ID: `place:Arnon`); Elath (ID: `place:Elath`); Bless (ID: `keyterm:Bless`); Sihon (ID: `person:Sihon`); Crete (ID: `place:Crete`); Amorites (ID: `group:Amorites`); Swear (ID: `keyterm:Swear`); Israel (ID: `person:Israel`); Ammonites (ID: `group:Ammon`); Mount Seir (ID: `place:SeirMount`); Money (ID: `realia:Money`)
...
The Emites also lived at Shaveh\-kiriathaim (Genesis 14:5). This was 16 kilometers (about 10 miles) east of the Dead Sea’s north end.
...
The Rephaim lived near Ashteroth\-karnaim (Genesis 14:5), which might be modern Tell Ashtarah. This is directly east of the Sea of Galilee (see Deuteronomy 1:4).
...
* **Associated ACAI Concepts:** Horites (ID: `group:Hori`); Hori (ID: `person:Hori`); Seir (ID: `place:Seir`); Dispossess (ID: `keyterm:Dispossess`); To Cause to Possess (ID: `keyterm:Possess`); LORD (ID: `deity:Lord`); Edomites (ID: `group:Edom`); Israel (ID: `person:Israel`); Edom (ID: `place:Edom`)
...
* **Associated Articles:** Deuteronomy 2:9 (ID: `10280@AquiferOpenStudyNotes`)
...
* **Associated ACAI Concepts:** Rephaim (ID: `group:Rephaim`); Dispossess (ID: `keyterm:Dispossess`); Ammon (ID: `place:Ammon`); LORD (ID: `deity:Lord`); Ammonites (ID: `group:Ammon`); Anakim (ID: `group:Anak`); Anak (ID: `person:Anak`)
...
* **Associated Articles:** Genesis 21:32 (ID: `12441@AquiferOpenStudyNotes`); Joshua 13:2 (ID: `19382@AquiferOpenStudyNotes`); Judges 3:3 (ID: `19887@AquiferOpenStudyNotes`)

* **Associated ACAI Concepts:** Avvim (ID: `group:Avvim`); Hazerim (ID: `place:Hazerim`); Gaza (ID: `place:Gaza`); Caphtorim (ID: `group:Caphtorim`); Crete (ID: `place:Crete`)
...
* **Associated ACAI Concepts:** Amorites (ID: `group:Amorites`); Dispossess (ID: `keyterm:Dispossess`); Heshbon (ID: `place:Heshbon`); Sihon (ID: `person:Sihon`); Arnon (ID: `place:Arnon`)
...
* **Associated ACAI Concepts:** Heshbon (ID: `place:Heshbon`); Kedemoth (ID: `place:Kedemoth`); Peace (ID: `keyterm:IntactState`); Sihon (ID: `person:Sihon`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Sihon (ID: `person:Sihon`); Heshbon (ID: `place:Heshbon`); Aroer (ID: `place:Aroer.2`); Gilead (ID: `place:Gilead`); Arnon (ID: `place:Arnon`); Edomites (ID: `group:Edom`); Edom (ID: `place:Edom`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Kedemoth (ID: `place:Kedemoth`); Ammon (ID: `place:Ammon`); Peace (ID: `keyterm:IntactState`); Jahaz (ID: `place:Jahaz`); Jordan River (ID: `place:Jordan`); An Angel (ID: `deity:Angel`); Dispossess (ID: `keyterm:Dispossess`); Jabbok (ID: `place:Jabbok`); Moab (ID: `place:Moab`); Seir (ID: `place:Seir`); Ar (ID: `place:Ar`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`)
...
* The Jabbok River, a major tributary of the Jordan River, marked the border between Gilead to the north and the Amorite kingdom of Sihon to the south. The Ammonites lived east and south of the Jabbok (see 2:19). Jacob wrestled with a stranger at night somewhere at the Jabbok (see Genesis 32:22–32).
...
* **Associated ACAI Concepts:** Og (ID: `person:Og`); Bashan (ID: `place:Bashan`); Amorites (ID: `group:Amorites`); Mount Hermon (ID: `place:HermonMount`); Heshbon (ID: `place:Heshbon`); LORD (ID: `deity:Lord`); Sihon (ID: `person:Sihon`); Edrei (ID: `place:Edrei`); Arnon (ID: `place:Arnon`); Salecah (ID: `place:Salecah`); Sidonians (ID: `group:Sidon`); Gilead (ID: `place:Gilead`); Sidon (ID: `place:Sidon`); Fear (ID: `keyterm:Fear`); Rephaim (ID: `group:Rephaim`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Ammon (ID: `place:Ammon`); Jordan River (ID: `place:Jordan`); Ammonites (ID: `group:Ammon`); Argob (ID: `place:Argob`); Cubit (ID: `realia:Cubit`); Cattle (ID: `fauna:Bull`); Bed (ID: `realia:Bed`)
...
* **Associated Articles:** Deuteronomy 2:34 (ID: `10275@AquiferOpenStudyNotes`)
...
* **Associated Articles:** Deuteronomy 2:19 (ID: `10266@AquiferOpenStudyNotes`)
...
* **Associated Articles:** Deuteronomy 2:36 (ID: `10276@AquiferOpenStudyNotes`)

* **Associated ACAI Concepts:** Reuben (ID: `person:Reuben`); Dispossess (ID: `keyterm:Dispossess`); Tribe of Reuben (ID: `group:Reuben`); Gilead (ID: `place:Gilead`); Aroer (ID: `place:Aroer.2`); Arnon (ID: `place:Arnon`); Gad (ID: `person:Gad`)
...
* **Associated ACAI Concepts:** Gilead (ID: `place:Gilead`); Dispossess (ID: `keyterm:Dispossess`); Argob (ID: `place:Argob`); Tribe of Reuben (ID: `group:Reuben`); LORD (ID: `deity:Lord`); Bashan (ID: `place:Bashan`); Arnon (ID: `place:Arnon`); Manasseh (ID: `person:Manasseh`); Tribe of Manasseh (ID: `group:Manasseh`); Jordan River (ID: `place:Jordan`); Reuben (ID: `person:Reuben`); Gad (ID: `person:Gad`); Maacathites (ID: `group:Maacah`); Geshurites (ID: `group:Geshur`); Jair (ID: `person:Jair.2`); Jabbok (ID: `place:Jabbok`); Chinnereth (ID: `place:Chinnereth`); Dead Sea (ID: `place:SaltSea`); Maacah (ID: `place:Maacah`); Aroer (ID: `place:Aroer.2`); Pisgah (ID: `place:Pisgah`); Arabah (ID: `place:Arabah`); Havvoth-jair (ID: `place:Havvoth-jair`); Machir (ID: `person:Machir`); To Cause to Possess (ID: `keyterm:Possess`); Og (ID: `person:Og`); Rephaim (ID: `group:Rephaim`); Geshur (ID: `place:Geshur`); Ammon (ID: `place:Ammon`); Israel (ID: `person:Israel`); Ammonites (ID: `group:Ammon`)
...
* **Associated ACAI Concepts:** Argob (ID: `place:Argob`); Manasseh (ID: `person:Manasseh`); Gilead (ID: `place:Gilead`); Tribe of Manasseh (ID: `group:Manasseh`); Bashan (ID: `place:Bashan`); Og (ID: `person:Og`); Rephaim (ID: `group:Rephaim`)
...
* **Associated ACAI Concepts:** Maacathites (ID: `group:Maacah`); Geshurites (ID: `group:Geshur`); Jair (ID: `person:Jair.2`); Geshur (ID: `place:Geshur`); Manasseh (ID: `person:Manasseh`); Maacah (ID: `place:Maacah`); Tribe of Manasseh (ID: `group:Manasseh`); Bashan (ID: `place:Bashan`); Argob (ID: `place:Argob`); Havvoth-jair (ID: `place:Havvoth-jair`)
...
* **Associated Articles:** Deuteronomy 4:44 (ID: `10537@AquiferOpenStudyNotes`)
...
*scatter you:* One of the curses of the covenant warned that God would scatter Israel among the nations if they broke the covenant (28:64). This meant the people would be forced to leave their land and live far away, even to distant parts of the earth.
...
* **Associated Articles:** Deuteronomy 8:2 (ID: `10587@AquiferOpenStudyNotes`)
...
* **Associated ACAI Concepts:** Golan (ID: `place:Golan`); Tribe of Manasseh (ID: `group:Manasseh`); Ramoth-gilead (ID: `place:Ramoth-gilead`); Bezer (ID: `place:Bezer`); Reuben (ID: `person:Reuben`); Manasseh (ID: `person:Manasseh`); Tribe of Reuben (ID: `group:Reuben`); Gilead (ID: `place:Gilead`); Bashan (ID: `place:Bashan`); Moses (ID: `person:Moses`); Intention (ID: `keyterm:Intention`); Jordan River (ID: `place:Jordan`); Gad (ID: `person:Gad`)
...
* **Associated ACAI Concepts:** Moses (ID: `person:Moses`); Jordan River (ID: `place:Jordan`); Israel (ID: `person:Israel`); Bashan (ID: `place:Bashan`); Amorites (ID: `group:Amorites`); Egypt (ID: `place:Egypt`); Golan (ID: `place:Golan`); Aroer (ID: `place:Aroer.2`); Bezer (ID: `place:Bezer`); Tribe of Manasseh (ID: `group:Manasseh`); Ramoth-gilead (ID: `place:Ramoth-gilead`); Beth-peor (ID: `place:Beth-peor`); Heshbon (ID: `place:Heshbon`); Tribe of Reuben (ID: `group:Reuben`); Gilead (ID: `place:Gilead`); Precept (ID: `keyterm:Precept`); Arnon (ID: `place:Arnon`); Pisgah (ID: `place:Pisgah`); Arabah (ID: `place:Arabah`); Manasseh (ID: `person:Manasseh`); Sihon (ID: `person:Sihon`); Og (ID: `person:Og`); Instruction (ID: `keyterm:Instruction`); Decree (ID: `keyterm:Decree`); Reuben (ID: `person:Reuben`); Dispossess (ID: `keyterm:Dispossess`); Intention (ID: `keyterm:Intention`); Mount Hermon (ID: `place:HermonMount`); Dead Sea (ID: `place:SaltSea`); Gad (ID: `person:Gad`)
...
* **Associated ACAI Concepts:** Golan (ID: `place:Golan`); Tribe of Manasseh (ID: `group:Manasseh`); Ramoth-gilead (ID: `place:Ramoth-gilead`); Bezer (ID: `place:Bezer`); Reuben (ID: `person:Reuben`); Manasseh (ID: `person:Manasseh`); Tribe of Reuben (ID: `group:Reuben`); Gilead (ID: `place:Gilead`); Bashan (ID: `place:Bashan`); Gad (ID: `person:Gad`)
...
* **Associated Articles:** Deuteronomy 5:1-26.19 (ID: `10542@AquiferOpenStudyNotes`)
...
*the Arabah on the east side of the Jordan and as far as the Sea of the Arabah**:* The word *Arabah* can mean “wilderness” or “dry wasteland.” It usually refers to the Great Rift Valley south of the Dead Sea. In Deuteronomy, it can also refer to the lower Jordan Valley (see 1:1; 3:17).

* **Associated Passages:** Deuteronomy 4:49

* **Associated ACAI Concepts:** Pisgah (ID: `place:Pisgah`); Dead Sea (ID: `place:SaltSea`); Jordan River (ID: `place:Jordan`); Arabah (ID: `place:Arabah`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Sabbath (ID: `keyterm:Sabbath`); Covenant (ID: `keyterm:Covenant`); Fear (ID: `keyterm:Fear`); Decree (ID: `keyterm:Decree`); Egypt (ID: `place:Egypt`); Force to Serve (ID: `keyterm:EnticedToServe`); Mount Sinai (ID: `place:SinaiMount`); Cattle (ID: `fauna:Bull`); Donkey (ID: `fauna:Donkey`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Jealous (ID: `keyterm:Zealous.2`); Holy (ID: `keyterm:Holy`); Glory (ID: `keyterm:Glory`); Kindness (ID: `keyterm:Kindness`); Pronounce Innocent (ID: `keyterm:PronounceInnocent`); Moses (ID: `person:Moses`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Israel (ID: `person:Israel`); Love (ID: `keyterm:Love`); Dispossess (ID: `keyterm:Dispossess`); Appoint (ID: `keyterm:Appoint`); Passion (ID: `keyterm:Ardour`); Tent (ID: `realia:Tent`); Tablet (ID: `realia:Tablet`); Graven Image (ID: `realia:GravenImage`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Dispossess (ID: `keyterm:Dispossess`); Egypt (ID: `place:Egypt`); Israel (ID: `person:Israel`); Fear (ID: `keyterm:Fear`); Bless (ID: `keyterm:Bless`); Force to Serve (ID: `keyterm:EnticedToServe`); Levi (ID: `person:Levi.3`); Swear (ID: `keyterm:Swear`); Tribe of Levi (ID: `group:Levi`); Love (ID: `keyterm:Love`); To Cause to Possess (ID: `keyterm:Possess`); Decree (ID: `keyterm:Decree`); Covenant (ID: `keyterm:Covenant`); The Way (ID: `keyterm:TheWay`); Defilement (ID: `keyterm:Defilement`); Vow (ID: `keyterm:Vow`); Holy (ID: `keyterm:Holy`); Offering (ID: `keyterm:Offering`); Redeem (ID: `keyterm:Redeem`); Pure (ID: `keyterm:Pure`); Exempt (ID: `keyterm:Exempt`); Symbol (ID: `keyterm:Example`); Pharaoh (ID: `person:Pharaoh.6`); Rebel (ID: `keyterm:Rebel`); To Sin (ID: `keyterm:Sin`); Covenant Box (ID: `keyterm:CovenantBox`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Passover (ID: `keyterm:Passover`)
...
* **Associated Articles:** Revelation 1:10 (ID: `25170@AquiferOpenStudyNotes`)
...
* **Associated Articles:** Deuteronomy 10:12-13 (ID: `10156@AquiferOpenStudyNotes`); Deuteronomy 7:21 (ID: `10577@AquiferOpenStudyNotes`)
...
* The words *heart … soul … strength* represent the mind, will, emotions, spirituality, and physical being. In other words, they refer to all that a person is and can do for God. This commandment is central to God’s covenant with Israel (see Matthew 22:37; Mark 12:30; Luke 10:27).

* **Associated Passages:** Deuteronomy 6:5
* **Associated Articles:** Joshua 23:11 (ID: `19515@AquiferOpenStudyNotes`)
...
* **Associated ACAI Concepts:** Miraculous Sign (ID: `keyterm:MiraculousSign`); LORD (ID: `deity:Lord`); Symbol (ID: `keyterm:Example`); Egypt (ID: `place:Egypt`); Pharaoh (ID: `person:Pharaoh.6`)
...
* *Girgashites* were an otherwise unknown Canaanite group (Genesis 10:16–17).
...
* **Associated Articles:** Deuteronomy 1:4 (ID: `10151@AquiferOpenStudyNotes`); Deuteronomy 2:1 (ID: `10267@AquiferOpenStudyNotes`)

* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); Girgashites (ID: `group:Girgashites`); Amorites (ID: `group:Amorites`); Jebusites (ID: `group:Jebusites`); LORD (ID: `deity:Lord`); Canaan (ID: `place:Canaan`); Hittites (ID: `group:Hittite`); Hivites (ID: `group:Hivites`); Heth (ID: `person:Heth`); Perizzites (ID: `group:Perizzites`); Canaanites (ID: `group:Canaan`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); Fear (ID: `keyterm:Fear`); Swear (ID: `keyterm:Swear`); Egypt (ID: `place:Egypt`); Kindness (ID: `keyterm:Kindness`); Dispossess (ID: `keyterm:Dispossess`); Bless (ID: `keyterm:Bless`); Pharaoh (ID: `person:Pharaoh.6`); Love (ID: `keyterm:Love`); Force to Serve (ID: `keyterm:EnticedToServe`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Well-Established (ID: `keyterm:BeFirm`); Girgashites (ID: `group:Girgashites`); Graven Image (ID: `realia:GravenImage`); Trap (ID: `realia:Trap`); Cattle (ID: `fauna:Bull`); Holy (ID: `keyterm:Holy`); Symbol (ID: `keyterm:Example`); Perizzites (ID: `group:Perizzites`); Jebusites (ID: `group:Jebusites`); Hittites (ID: `group:Hittite`); Asherah (ID: `deity:Asherah`); Heth (ID: `person:Heth`); Redeem (ID: `keyterm:Redeem`); Amorites (ID: `group:Amorites`); Miraculous Sign (ID: `keyterm:MiraculousSign`); Canaan (ID: `place:Canaan`); Decree (ID: `keyterm:Decree`); Hivites (ID: `group:Hivites`); Canaanites (ID: `group:Canaan`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Oath (ID: `keyterm:Oath`); Hornet (ID: `fauna:Hornet`); Grain (ID: `flora:Grain`); Money (ID: `realia:Money`); Temple Altar (ID: `realia:TempleAltar`); Wheat (ID: `flora:Wheat`); Vine (ID: `flora:Vine`); Anointing Oil (ID: `realia:AnointingOil`); Sacred Pillar (ID: `realia:SacredPillar`); Sorghum (ID: `flora:Sorghum`); Flock (ID: `fauna:Flock`); Must (ID: `realia:Must`); Olive Tree (ID: `flora:OliveTree`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Sacred Pole (ID: `realia:SacredPole`); Olive Oil (ID: `realia:OliveOil`); Altar (ID: `realia:Altar`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`); Mule (ID: `fauna:Mule`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated Articles:** Deuteronomy 12:2 (ID: `10179@AquiferOpenStudyNotes`)

* **Associated ACAI Concepts:** Asherah (ID: `deity:Asherah`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Sacred Pillar (ID: `realia:SacredPillar`); Sacred Pole (ID: `realia:SacredPole`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Graven Image (ID: `realia:GravenImage`)
...
* **Associated ACAI Concepts:** Swear (ID: `keyterm:Swear`); Kindness (ID: `keyterm:Kindness`); Covenant (ID: `keyterm:Covenant`); LORD (ID: `deity:Lord`)
...
* **Associated Articles:** Deuteronomy 4:34 (ID: `10529@AquiferOpenStudyNotes`); Deuteronomy 8:2 (ID: `10587@AquiferOpenStudyNotes`)
...
* **Associated ACAI Concepts:** Isaac (ID: `person:Isaac`); Swear (ID: `keyterm:Swear`); Dispossess (ID: `keyterm:Dispossess`); Abraham (ID: `person:Abraham`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Straightness (ID: `keyterm:Straightness`)
...
* *the* *covenant:* Here, thisrefers to the promises God made with Israel about 40 years earlier at Sinai (see 4:13).
...
* **Associated Articles:** Deuteronomy 7:24 (ID: `10578@AquiferOpenStudyNotes`)
...
* **Associated ACAI Concepts:** Egypt (ID: `place:Egypt`); Redeem (ID: `keyterm:Redeem`); To Cause to Possess (ID: `keyterm:Possess`); LORD (ID: `deity:Lord`)
...
* **Associated Articles:** Deuteronomy 32:36 (ID: `10472@AquiferOpenStudyNotes`); Deuteronomy 8:2 (ID: `10587@AquiferOpenStudyNotes`)

* **Associated ACAI Concepts:** Isaac (ID: `person:Isaac`); Israel (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); Abraham (ID: `person:Abraham`)
...
* **Associated Articles:** Exodus 25:22 (ID: `11213@AquiferOpenStudyNotes`); Leviticus 16:2 (ID: `20161@AquiferOpenStudyNotes`)
...
* **Associated Articles:** Deuteronomy 7:21 (ID: `10577@AquiferOpenStudyNotes`); Proverbs 1:7 (ID: `23179@AquiferOpenStudyNotes`)

* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); The Way (ID: `keyterm:TheWay`); Israel (ID: `person:Israel`); Love (ID: `keyterm:Love`); Fear (ID: `keyterm:Fear`); Force to Serve (ID: `keyterm:EnticedToServe`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Dispossess (ID: `keyterm:Dispossess`); Bless (ID: `keyterm:Bless`); The Way (ID: `keyterm:TheWay`); Swear (ID: `keyterm:Swear`); Love (ID: `keyterm:Love`); Jordan River (ID: `place:Jordan`); Force to Serve (ID: `keyterm:EnticedToServe`); Gilgal (ID: `place:Gilgal.2`); Oak of Moreh (ID: `place:Moreh`); Land Flowing of Milk and Honey (ID: `keyterm:LandFlowingOfMilkAndHoney`); Euphrates River (ID: `place:Euphrates`); House (ID: `realia:House`); Mount Ebal (ID: `place:EbalMount`); Mount Gerizim (ID: `place:GerizimMount`); Arabah (ID: `place:Arabah`); Fear (ID: `keyterm:Fear`); Canaan (ID: `place:Canaan`); Decree (ID: `keyterm:Decree`); Egypt (ID: `place:Egypt`); Lebanon (ID: `place:Lebanon`); Canaanites (ID: `group:Canaan`); Oak (ID: `flora:Oak`); Grain (ID: `flora:Grain`); Barley (ID: `flora:Barley`); Vine (ID: `flora:Vine`); Anointing Oil (ID: `realia:AnointingOil`); Cattle (ID: `fauna:Bull`); Grass (ID: `flora:Grass`); Must (ID: `realia:Must`); Olive Tree (ID: `flora:OliveTree`); Olive Oil (ID: `realia:OliveOil`); Coriander (ID: `flora:Coriander`); Doorpost (ID: `realia:Doorpost`); Mule (ID: `fauna:Mule`)
...
* **Associated ACAI Concepts:** Mount Ebal (ID: `place:EbalMount`); Mount Gerizim (ID: `place:GerizimMount`); Dispossess (ID: `keyterm:Dispossess`); LORD (ID: `deity:Lord`); Bless (ID: `keyterm:Bless`)
...
* **Associated Articles:** Deuteronomy 7:24 (ID: `10578@AquiferOpenStudyNotes`); Deuteronomy 7:5 (ID: `10581@AquiferOpenStudyNotes`)
...
* **Associated Articles:** Deuteronomy 1:31 (ID: `10146@AquiferOpenStudyNotes`)
...
* **Associated Articles:** Leviticus 7:26-27 (ID: `20389@AquiferOpenStudyNotes`)
...
* **Associated Articles:** Leviticus 1:3-17 (ID: `20071@AquiferOpenStudyNotes`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Force to Serve (ID: `keyterm:EnticedToServe`); Symbol (ID: `keyterm:Example`); Egypt (ID: `place:Egypt`); Fear (ID: `keyterm:Fear`); Swear (ID: `keyterm:Swear`); Wickedness (ID: `keyterm:Wickedness`); The Way (ID: `keyterm:TheWay`); Truth (ID: `keyterm:Truth`); Israel (ID: `person:Israel`); Love (ID: `keyterm:Love`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Redeem (ID: `keyterm:Redeem`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Cattle (ID: `fauna:Bull`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** The Way (ID: `keyterm:TheWay`); Egypt (ID: `place:Egypt`); Redeem (ID: `keyterm:Redeem`); LORD (ID: `deity:Lord`)
...
* **Associated Articles:** Deuteronomy 12:31 (ID: `10180@AquiferOpenStudyNotes`); Deuteronomy 7:25-26 (ID: `10579@AquiferOpenStudyNotes`)
...
*split hoof … chews the cud:* These animals listed in in 14:4–5could be eaten, unlike those in 14:7–8. People gained health benefits from following these rules. But something was ceremonially clean or unclean only because God said so.
...
* **Associated Articles:** Deuteronomy 1:31 (ID: `10146@AquiferOpenStudyNotes`); Deuteronomy 12:6 (ID: `10183@AquiferOpenStudyNotes`)

* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`); Flock (ID: `fauna:Flock`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`); Bless (ID: `keyterm:Bless`); Tribe of Levi (ID: `group:Levi`); To Cause to Possess (ID: `keyterm:Possess`); Fear (ID: `keyterm:Fear`); Levi (ID: `person:Levi.3`); Grain (ID: `flora:Grain`); Barley (ID: `flora:Barley`); Anointing Oil (ID: `realia:AnointingOil`); Must (ID: `realia:Must`); Olive Tree (ID: `flora:OliveTree`); Olive Oil (ID: `realia:OliveOil`); Coriander (ID: `flora:Coriander`); Mule (ID: `fauna:Mule`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Anointing Oil (ID: `realia:AnointingOil`); Grain (ID: `flora:Grain`); Mule (ID: `fauna:Mule`); Flock (ID: `fauna:Flock`); Cattle (ID: `fauna:Bull`); Olive Oil (ID: `realia:OliveOil`); Must (ID: `realia:Must`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Cattle (ID: `fauna:Bull`); Wine (ID: `realia:Wine`); Money (ID: `realia:Money`)
...
* **Associated Articles:** Leviticus 27:30 (ID: `20322@AquiferOpenStudyNotes`)
...
The fact that some people will always be poor in an imperfect world is not an excuse to ignore their struggles. Instead, it emphasizes the need for wealthy individuals to help improve the lives of the poor (Matthew 26:6–13).
...
* **Associated ACAI Concepts:** Holy (ID: `keyterm:Holy`); LORD (ID: `deity:Lord`); Force to Serve (ID: `keyterm:EnticedToServe`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Passover (ID: `keyterm:Passover`); Egypt (ID: `place:Egypt`); Unleavened Bread (ID: `realia:UnleavenedBread`); Tent (ID: `realia:Tent`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Passover (ID: `keyterm:Passover`); LORD (ID: `deity:Lord`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); Truth (ID: `keyterm:Truth`); Levi (ID: `person:Levi.3`); Asherah (ID: `deity:Asherah`); Fear (ID: `keyterm:Fear`); Tribe of Levi (ID: `group:Levi`); Force to Serve (ID: `keyterm:EnticedToServe`); Covenant (ID: `keyterm:Covenant`); Sacred Pole (ID: `realia:SacredPole`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Sacred Pillar (ID: `realia:SacredPillar`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated Articles:** Deuteronomy 1:16-17 (ID: `10137@AquiferOpenStudyNotes`)
...
* **Associated Articles:** Deuteronomy 7:5 (ID: `10581@AquiferOpenStudyNotes`)

* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Sacred Pole (ID: `realia:SacredPole`); Asherah (ID: `deity:Asherah`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Sacred Pillar (ID: `realia:SacredPillar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated Articles:** 1 Corinthians 5:12-13 (ID: `13919@AquiferOpenStudyNotes`); Remove the Evil (ID: `500193@AquiferOpenStudyNotes`)
...
In ancient Israel, people considered the shoulder, cheeks, and stomach of oxen and sheep as the best cuts of meat. They honored God's priests by giving them these best parts (see Leviticus 7:28–34).
...
* *sorcery:* Thisinvolved performing unusual acts or signs to mislead people (Exodus 7:11; Malachi 3:5).
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Dispossess (ID: `keyterm:Dispossess`); Exempt (ID: `keyterm:Exempt`); Swear (ID: `keyterm:Swear`); To Cause to Possess (ID: `keyterm:Possess`); The Way (ID: `keyterm:TheWay`); Israel (ID: `person:Israel`); Intention (ID: `keyterm:Intention`); Love (ID: `keyterm:Love`); Axe (ID: `realia:Axe`); Sandalwood (ID: `flora:Sandalwood`); House (ID: `realia:House`)
...
* **Associated Articles:** 2 Corinthians 13:1-2 (ID: `14320@AquiferOpenStudyNotes`)
...
* **Associated Articles:** Deuteronomy 17:7 (ID: `10240@AquiferOpenStudyNotes`)
...
* **Associated Articles:** Deuteronomy 5:17 (ID: `10550@AquiferOpenStudyNotes`)
...
* **Associated ACAI Concepts:** Molten Image (ID: `realia:MoltenImage`); Cattle (ID: `fauna:Bull`); LORD (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); Israel (ID: `person:Israel`); Bless (ID: `keyterm:Bless`); Redeem (ID: `keyterm:Redeem`); Exempt (ID: `keyterm:Exempt`); Tribe of Levi (ID: `group:Levi`); Forgive (ID: `keyterm:Forgive`); Force to Serve (ID: `keyterm:EnticedToServe`); Yoke (ID: `realia:Yoke`)
...
* **Associated Articles:** Deuteronomy 2:19 (ID: `10266@AquiferOpenStudyNotes`); Deuteronomy 2:9 (ID: `10280@AquiferOpenStudyNotes`)

* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Ammonites (ID: `group:Ammon`); Ammon (ID: `place:Ammon`); LORD (ID: `deity:Lord`)
...
* **Associated Articles:** Numbers 22:5-6 (ID: `22802@AquiferOpenStudyNotes`)

* **Associated ACAI Concepts:** Pethor (ID: `place:Pethor`); Mesopotamia (ID: `place:Mesopotamia`); Beor (ID: `person:Beor.2`); Balaam (ID: `person:Balaam`); Egypt (ID: `place:Egypt`)
...
* **Associated Articles:** 2 Corinthians 11:23-24 (ID: `14292@AquiferOpenStudyNotes`)
...
* **Associated Articles:** Deuteronomy 19:21 (ID: `10257@AquiferOpenStudyNotes`)
...
* **Associated ACAI Concepts:** Amalek (ID: `place:Amalek`); Dispossess (ID: `keyterm:Dispossess`); To Cause to Possess (ID: `keyterm:Possess`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Tribe of Levi (ID: `group:Levi`); Egypt (ID: `place:Egypt`); Levi (ID: `person:Levi.3`); Swear (ID: `keyterm:Swear`); Land Flowing of Milk and Honey (ID: `keyterm:LandFlowingOfMilkAndHoney`); Wheat (ID: `flora:Wheat`); Sorghum (ID: `flora:Sorghum`); Basket (ID: `realia:Basket`); Symbol (ID: `keyterm:Example`); Bless (ID: `keyterm:Bless`); Arameans (ID: `group:Aramean`); To Cause to Possess (ID: `keyterm:Possess`); Fear (ID: `keyterm:Fear`); Egyptians (ID: `group:Egypt`); Miraculous Sign (ID: `keyterm:MiraculousSign`); Israel (ID: `person:Israel`); Paddan-aram (ID: `place:Paddan-aram`); Dispossess (ID: `keyterm:Dispossess`); Defilement (ID: `keyterm:Defilement`); Work (ID: `keyterm:Work`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** Arameans (ID: `group:Aramean`); Egypt (ID: `place:Egypt`); Paddan-aram (ID: `place:Paddan-aram`); LORD (ID: `deity:Lord`)
...
* **Associated Articles:** Deuteronomy 10:18 (ID: `10159@AquiferOpenStudyNotes`)
...
* **Associated Articles:** Deuteronomy 14:28 (ID: `10202@AquiferOpenStudyNotes`)
...
* **Associated Articles:** Deuteronomy 6:4-5 (ID: `10565@AquiferOpenStudyNotes`)
...
* **Associated ACAI Concepts:** Land Flowing of Milk and Honey (ID: `keyterm:LandFlowingOfMilkAndHoney`); Instruction (ID: `keyterm:Instruction`); LORD (ID: `deity:Lord`)
...
*an altar of stones. You must not use any iron tool on them**:* Archaeological research has found many Canaanite altars made of cut blocks. In contrast, the Israelites were to build their altars only with rough stones from the field (Exodus 20:22–26; see “Altars” Theme Note).

* **Associated Passages:** Deuteronomy 27:5
* **Associated Articles:** Altars (ID: `500161@AquiferOpenStudyNotes`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Moses (ID: `person:Moses`); Levi (ID: `person:Levi.3`); Israel (ID: `person:Israel`); Tribe of Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** To Curse (ID: `keyterm:Curse`); Surely! (ID: `keyterm:Surely`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Mount Ebal (ID: `place:EbalMount`); Mount Gerizim (ID: `place:GerizimMount`); Tribe of Naphtali (ID: `group:Naphtali`); Tribe of Reuben (ID: `group:Reuben`); LORD (ID: `deity:Lord`); Bless (ID: `keyterm:Bless`); Zebulun (ID: `person:Zebulun`); Benjamin (ID: `person:Benjamin`); Issachar (ID: `person:Issachar`); Tribe of Issachar (ID: `group:Issachar`); Tribe of Judah (ID: `group:Judah`); Tribe of Zebulun (ID: `group:Zebulun`); Exempt (ID: `keyterm:Exempt`); Instruction (ID: `keyterm:Instruction`); Tribe of Asher (ID: `group:Asher`); Simeon (ID: `person:Simeon.5`); Israel (ID: `person:Israel`); Dan (ID: `place:Dan`); Jordan River (ID: `place:Jordan`); Asher (ID: `person:Asher`); Judah (ID: `person:Judah.4`); Reuben (ID: `person:Reuben`); Tribe of Dan (ID: `group:Dan`); Joseph (ID: `person:Joseph.10`); Tribe of Benjamin (ID: `group:Benjamin`); Tribe of Simeon (ID: `group:Simeon`); Naphtali (ID: `person:Naphtali`); Gad (ID: `person:Gad`); Craftsman (ID: `realia:Craftsman`); Graven Image (ID: `realia:GravenImage`); Cattle (ID: `fauna:Bull`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated ACAI Concepts:** Mount Ebal (ID: `place:EbalMount`); Reuben (ID: `person:Reuben`); Tribe of Asher (ID: `group:Asher`); Tribe of Dan (ID: `group:Dan`); Tribe of Naphtali (ID: `group:Naphtali`); Tribe of Reuben (ID: `group:Reuben`); Tribe of Zebulun (ID: `group:Zebulun`); Dan (ID: `place:Dan`); Zebulun (ID: `person:Zebulun`); Asher (ID: `person:Asher`); Naphtali (ID: `person:Naphtali`); Gad (ID: `person:Gad`)
...
* **Associated Articles:** Deuteronomy 6:8 (ID: `10569@AquiferOpenStudyNotes`)
...
* **Associated Articles:** Deuteronomy 7:21 (ID: `10577@AquiferOpenStudyNotes`)
...
* **Associated ACAI Concepts:** Mount Sinai (ID: `place:SinaiMount`); LORD (ID: `deity:Lord`); Moses (ID: `person:Moses`); Israel (ID: `person:Israel`); Moab (ID: `place:Moab`); Covenant (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); Israel (ID: `person:Israel`); Bless (ID: `keyterm:Bless`); Instruction (ID: `keyterm:Instruction`); Egypt (ID: `place:Egypt`); Love (ID: `keyterm:Love`); Force to Serve (ID: `keyterm:EnticedToServe`); Dispossess (ID: `keyterm:Dispossess`); Oath (ID: `keyterm:Oath`); Scroll (ID: `realia:Scroll`); Abraham (ID: `person:Abraham`); Isaac (ID: `person:Isaac`); Swear (ID: `keyterm:Swear`); Admah (ID: `place:Admah`); Detested Thing (ID: `keyterm:DetestedThing`); Zeboiim (ID: `place:Zeboiim`); Sodom (ID: `place:Sodom`); Heshbon (ID: `place:Heshbon`); Tribe of Reuben (ID: `group:Reuben`); Symbol (ID: `keyterm:Example`); Bashan (ID: `place:Bashan`); Gomorrah (ID: `place:Gomorrah`); Pharaoh (ID: `person:Pharaoh.6`); Manasseh (ID: `person:Manasseh`); To Cause to Possess (ID: `keyterm:Possess`); Passion (ID: `keyterm:Ardour`); Tribe of Manasseh (ID: `group:Manasseh`); The Way (ID: `keyterm:TheWay`); Moses (ID: `person:Moses`); Sihon (ID: `person:Sihon`); Og (ID: `person:Og`); Miraculous Sign (ID: `keyterm:MiraculousSign`); Peace (ID: `keyterm:IntactState`); Have Insight (ID: `keyterm:HaveInsight`); Jordan River (ID: `place:Jordan`); Forgive (ID: `keyterm:Forgive`); Reuben (ID: `person:Reuben`); To Circumsize (ID: `keyterm:Circumsize.2`); Gad (ID: `person:Gad`); Wormwood (ID: `flora:Wormwood`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Money (ID: `realia:Money`); Wheat (ID: `flora:Wheat`); Vine (ID: `flora:Vine`); Cloak (ID: `realia:Cloak`); Sorghum (ID: `flora:Sorghum`); Cattle (ID: `fauna:Bull`); Image (ID: `realia:Image`); Grass (ID: `flora:Grass`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Bashan (ID: `place:Bashan`); Heshbon (ID: `place:Heshbon`); Og (ID: `person:Og`); Sihon (ID: `person:Sihon`)
...
* **Associated ACAI Concepts:** Reuben (ID: `person:Reuben`); Manasseh (ID: `person:Manasseh`); Tribe of Reuben (ID: `group:Reuben`); To Cause to Possess (ID: `keyterm:Possess`); Tribe of Manasseh (ID: `group:Manasseh`); Gad (ID: `person:Gad`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Dispossess (ID: `keyterm:Dispossess`); Bless (ID: `keyterm:Bless`); Love (ID: `keyterm:Love`); To Circumsize (ID: `keyterm:Circumsize.2`); Instruction (ID: `keyterm:Instruction`); Sorghum (ID: `flora:Sorghum`); Cattle (ID: `fauna:Bull`); Wheat (ID: `flora:Wheat`); Scroll (ID: `realia:Scroll`)

## Deuteronomy 30:2–3 (id: 10434)

*with all your heart and all your soul:* These words reflect the teaching found in the *Shema* (Israel’s great statement of covenant faith and commitment). The *Shema* calls Israel to love the Lord fully and faithfully (compare 6:4). 
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Dispossess (ID: `keyterm:Dispossess`); Bless (ID: `keyterm:Bless`); Love (ID: `keyterm:Love`); Isaac (ID: `person:Isaac`); Swear (ID: `keyterm:Swear`); Abraham (ID: `person:Abraham`); The Way (ID: `keyterm:TheWay`); Israel (ID: `person:Israel`); Jordan River (ID: `place:Jordan`); Force to Serve (ID: `keyterm:EnticedToServe`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); LORD (ID: `deity:Lord`); The Way (ID: `keyterm:TheWay`); Bless (ID: `keyterm:Bless`); Love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Isaac (ID: `person:Isaac`); Swear (ID: `keyterm:Swear`); Abraham (ID: `person:Abraham`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Love (ID: `keyterm:Love`)

## Deuteronomy 31:1 (id: 10445)

Based on the context, these instructions refers to all of Deuteronomy (see1:1).
...
* From the early days of wandering in Sinai until now, Joshua served as the assistant of Moses (Exodus 17:8). God now chose him to be the leader of Israel after Moses (see Deuteronomy 1:38; 3:23–29; Numbers 27:15–23).
...
* **Associated Articles:** Deuteronomy 2:24 (ID: `10271@AquiferOpenStudyNotes`)
...
* **Associated Articles:** Deuteronomy 10:1 (ID: `10160@AquiferOpenStudyNotes`)

* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Moses (ID: `person:Moses`); Levi (ID: `person:Levi.3`); Israel (ID: `person:Israel`); Covenant Box (ID: `keyterm:CovenantBox`); Tribe of Levi (ID: `group:Levi`); Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`)
...
Even foreigners living with the Israelites had to follow the covenant law. Even though they were in a weak and disadvantaged position, the Lord promised to care for them and meet their needs (see10:18).
...
*Tent of Meeting:* At first, the Tent of Meeting was a temporary place where God met with his people, especially Moses. Later, the term came to mean the tabernacle itself (see Exodus 28:43; 33:7–11; 40:2; Numbers 11:16, 24, 26; 12:4). See study note on Leviticus 1:1.
...
* **Associated ACAI Concepts:** Swear (ID: `keyterm:Swear`); Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Moses (ID: `person:Moses`); Force to Serve (ID: `keyterm:EnticedToServe`); Covenant (ID: `keyterm:Covenant`)
...
* **Associated Articles:** Deuteronomy 6:3 (ID: `10564@AquiferOpenStudyNotes`)
...
* **Associated ACAI Concepts:** Swear (ID: `keyterm:Swear`); Joshua (ID: `person:Joshua.2`); Israel (ID: `person:Israel`); Nun (ID: `person:Nun`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Covenant Box (ID: `keyterm:CovenantBox`); Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Scroll (ID: `realia:Scroll`)
...
* **Associated Articles:** Deuteronomy 1:4 (ID: `10151@AquiferOpenStudyNotes`)

* **Associated ACAI Concepts:** Bashan (ID: `place:Bashan`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Wine (ID: `realia:Wine`); Wheat (ID: `flora:Wheat`)
...
* **Associated Articles:** Deuteronomy 4:24 (ID: `10525@AquiferOpenStudyNotes`)
...
* **Associated ACAI Concepts:** Colocynth (ID: `flora:Colocynth`); Bitter Herbs (ID: `flora:Chicory`); Sodom (ID: `place:Sodom`); Gomorrah (ID: `place:Gomorrah`); Bitter (ID: `keyterm:Bitter`); Vine (ID: `flora:Vine`)
...
*you broke faith with Me:* During the journey in the wilderness, Moses dishonored the Lord by striking a rock to get water. This act of impatience and anger prevented Moses from entering the promised land (Numbers 20:1–13; see Deuteronomy 1:37; 3:26–27).

* **Associated Passages:** Deuteronomy 32:51

* **Associated ACAI Concepts:** Wilderness of Zin (ID: `place:Zin`); Holy (ID: `keyterm:Holy`); Meribah (ID: `place:Meribah.2`); Be Unfaithful (ID: `keyterm:Unfaithful`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Bless (ID: `keyterm:Bless`); Moses (ID: `person:Moses`); Instruction (ID: `keyterm:Instruction`); Delight (ID: `keyterm:Delight`); Joseph (ID: `person:Joseph.10`); Safety (ID: `keyterm:Safety`); Tribe of Naphtali (ID: `group:Naphtali`); Gad (ID: `person:Gad`); Zebulun (ID: `person:Zebulun`); Meribah (ID: `place:Meribah`); Benjamin (ID: `person:Benjamin`); Naphtali (ID: `person:Naphtali`); Asher (ID: `person:Asher`); Tribe of Dan (ID: `group:Dan`); Mount Paran (ID: `place:ParanMount`); Lion (ID: `fauna:Lion`); Holy (ID: `keyterm:Holy`); Tribe of Reuben (ID: `group:Reuben`); Bashan (ID: `place:Bashan`); Mount Sinai (ID: `place:SinaiMount`); Ephraim (ID: `person:Ephraim`); Horn (ID: `keyterm:Horn`); Slaughtering (ID: `keyterm:Slaughtering`); Tribe of Levi (ID: `group:Levi`); Covenant (ID: `keyterm:Covenant`); Manasseh (ID: `person:Manasseh`); Issachar (ID: `person:Issachar`); Tribe of Issachar (ID: `group:Issachar`); Tribe of Manasseh (ID: `group:Manasseh`); Tribe of Judah (ID: `group:Judah`); Tribe of Zebulun (ID: `group:Zebulun`); Tribe of Asher (ID: `group:Asher`); Tribe of Ephraim (ID: `group:Ephraim`); Dan (ID: `place:Dan`); Shield (ID: `keyterm:Shield`); Loyal Person (ID: `keyterm:LoyalPerson`); Judah (ID: `person:Judah.4`); Reuben (ID: `person:Reuben`); Dispossess (ID: `keyterm:Dispossess`); Levi (ID: `person:Levi.3`); Seir (ID: `place:Seir`); Tribe of Benjamin (ID: `group:Benjamin`); Massah (ID: `place:Massah`); Wild Ox (ID: `fauna:WildOx`); Bush (ID: `flora:Bush`); Grain (ID: `flora:Grain`); Sheep (ID: `fauna:Lamb`); Sword (ID: `realia:Sword`); Temple Altar (ID: `realia:TempleAltar`); Vine (ID: `flora:Vine`); Anointing Oil (ID: `realia:AnointingOil`); Cattle (ID: `fauna:Bull`); Must (ID: `realia:Must`); Small Shield (ID: `realia:SmallShield`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Olive Oil (ID: `realia:OliveOil`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated Articles:** Deuteronomy 6:16 (ID: `10558@AquiferOpenStudyNotes`); Exodus 28:30 (ID: `11243@AquiferOpenStudyNotes`)
...
*maintained Y**our covenant:* This verse refers to the sin of the gold calf at Mount Sinai and to what happened at Baal\-peor (Exodus 32:25–29; Numbers 25:6–9). At those times, the Levites chose to stand with the Lord.
...
* **Associated ACAI Concepts:** Benjamin (ID: `person:Benjamin`); Tribe of Benjamin (ID: `group:Benjamin`); Safety (ID: `keyterm:Safety`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Joseph (ID: `person:Joseph.10`); Manasseh (ID: `person:Manasseh`); LORD (ID: `deity:Lord`); Tribe of Ephraim (ID: `group:Ephraim`); Tribe of Manasseh (ID: `group:Manasseh`); Bless (ID: `keyterm:Bless`); Ephraim (ID: `person:Ephraim`); Horn (ID: `keyterm:Horn`); Delight (ID: `keyterm:Delight`); Wild Ox (ID: `fauna:WildOx`); Bush (ID: `flora:Bush`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`)
...
The Bible does not clearly say where Dan gathered its army before attacking Laish. However, the phrase *leaping out of Bashan* may suggest that the attack began from Bashan (see Genesis 49:16–17).
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Shield (ID: `keyterm:Shield`); Israel (ID: `person:Israel`); Sword (ID: `realia:Sword`); Small Shield (ID: `realia:SmallShield`)
...
* **Associated Articles:** Deuteronomy 3:17 (ID: `10417@AquiferOpenStudyNotes`)

* **Associated ACAI Concepts:** Jericho (ID: `place:Jericho`); Pisgah (ID: `place:Pisgah`); Mount Nebo (ID: `place:NeboMount`); Plains of Moab (ID: `place:MoabPlains`); Tribe of Dan (ID: `group:Dan`); Gilead (ID: `place:Gilead`); LORD (ID: `deity:Lord`); Moses (ID: `person:Moses`); Dan (ID: `place:Dan`)
...
* **Associated Articles:** Deuteronomy 32:51 (ID: `10481@AquiferOpenStudyNotes`)

* **Associated ACAI Concepts:** Moses (ID: `person:Moses`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Jericho (ID: `place:Jericho`); Plains of Moab (ID: `place:MoabPlains`); Moab (ID: `place:Moab`); Pisgah (ID: `place:Pisgah`); Nun (ID: `person:Nun`); Mount Nebo (ID: `place:NeboMount`); Valley of Jericho (ID: `place:JerichoValley`); Beth-peor (ID: `place:Beth-peor`); Complete (ID: `keyterm:Complete`); Tribe of Naphtali (ID: `group:Naphtali`); Abraham (ID: `person:Abraham`); Gilead (ID: `place:Gilead`); Symbol (ID: `keyterm:Example`); Ephraim (ID: `person:Ephraim`); Pharaoh (ID: `person:Pharaoh.6`); Manasseh (ID: `person:Manasseh`); Tribe of Manasseh (ID: `group:Manasseh`); Tribe of Judah (ID: `group:Judah`); Negev (ID: `place:Negeb`); Joshua (ID: `person:Joshua.2`); Fear (ID: `keyterm:Fear`); Isaac (ID: `person:Isaac`); Swear (ID: `keyterm:Swear`); Miraculous Sign (ID: `keyterm:MiraculousSign`); Tribe of Ephraim (ID: `group:Ephraim`); Ability (ID: `keyterm:Ability`); Dan (ID: `place:Dan`); Egypt (ID: `place:Egypt`); Judah (ID: `person:Judah.4`); Tribe of Dan (ID: `group:Dan`); Zoar (ID: `place:Zoar`); Naphtali (ID: `person:Naphtali`); Date Palm (ID: `flora:DatePalm`)
...
* **Associated ACAI Concepts:** Judah (ID: `person:Judah.4`); Tribe of Naphtali (ID: `group:Naphtali`); Manasseh (ID: `person:Manasseh`); Tribe of Ephraim (ID: `group:Ephraim`); Tribe of Manasseh (ID: `group:Manasseh`); Tribe of Judah (ID: `group:Judah`); Ephraim (ID: `person:Ephraim`); Naphtali (ID: `person:Naphtali`)
...
* **Associated ACAI Concepts:** Nun (ID: `person:Nun`); LORD (ID: `deity:Lord`); Moses (ID: `person:Moses`); Ability (ID: `keyterm:Ability`); Israel (ID: `person:Israel`); Joshua (ID: `person:Joshua.2`)
...
* **Associated Articles:** Deuteronomy 18:15 (ID: `10245@AquiferOpenStudyNotes`)
