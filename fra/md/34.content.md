...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Basan (ID: `place:Bashan`); Liban (ID: `place:Lebanon`); Carmel (ID: `place:Carmel`); force (ID: `keyterm:Strength`); déclarer innocent (ID: `keyterm:PronounceInnocent`); zélé (ID: `keyterm:Zealous.3`); chemin (ID: `keyterm:TheWay`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Basan (ID: `place:Bashan`); Liban (ID: `place:Lebanon`); se réfugier (ID: `keyterm:SeekfindRefuge`); Carmel (ID: `place:Carmel`); force (ID: `keyterm:Strength`); méchanceté (ID: `keyterm:Wickedness`); déclarer innocent (ID: `keyterm:PronounceInnocent`); zélé (ID: `keyterm:Zealous.3`); chemin (ID: `keyterm:TheWay`); Brier (ID: `flora:Brier`); Fortress (ID: `realia:Fortress`); Strong Drink (ID: `realia:StrongDrink`)
...
* **Associated ACAI Concepts:** état intact (ID: `keyterm:IntactState`); Juda (ID: `person:Judah.4`); méchanceté (ID: `keyterm:Wickedness`); Juda (ID: `group:Judah`); faire un voeu (ID: `keyterm:Vow`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); Éternel (ID: `deity:Lord`); Grass (ID: `flora:Grass`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Chariot (ID: `realia:Chariot`)
...
* **Associated ACAI Concepts:** se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Égypte (ID: `place:Egypt`); Libya (ID: `place:Libya`); Puth (ID: `place:Put`); destin (ID: `keyterm:Lot`); Cush (ID: `place:Cush.2`)
