...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); love (ID: `keyterm:Love`); para a eternidade (ID: `keyterm:Always`); SENHOR (ID: `deity:Lord`); fazer a paz (ID: `keyterm:Peace`); escolhido (ID: `keyterm:Chosen`); misericórdia (ID: `keyterm:Mercy`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); fazer a paz (ID: `keyterm:Peace`); love (ID: `keyterm:Love`); misericórdia (ID: `keyterm:Mercy`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); Truth (ID: `keyterm:Truth`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); SENHOR (ID: `deity:Lord`); andar (ID: `keyterm:Live.3`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`); corpo (ID: `keyterm:Body.3`); Ability (ID: `keyterm:Ability`); compartilhar (ID: `keyterm:Share`); rogar (ID: `keyterm:AskFor`); Truth (ID: `keyterm:Truth`); House (ID: `realia:House`)
