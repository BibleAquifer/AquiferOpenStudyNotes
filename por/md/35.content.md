...
* **Associated ACAI Concepts:** strength (ID: `keyterm:Strength`); SENHOR (ID: `deity:Lord`); Believe In (ID: `keyterm:BelieveIn`); Chaldeans (ID: `group:Chaldea`); Caldéia (ID: `place:Chaldea`); fear (ID: `keyterm:Fear`); dispossess (ID: `keyterm:Dispossess`); Horse (ID: `fauna:Horse`); Wolf (ID: `fauna:Wolf`); Leopard (ID: `fauna:Leopard`); Vulture (ID: `fauna:Vulture`)
...
* **Associated ACAI Concepts:** Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Casting Net (ID: `realia:CastingNet`); SENHOR (ID: `deity:Lord`); holy (ID: `keyterm:Holy`); pure (ID: `keyterm:Pure`); Fortification (ID: `realia:Fortification`); Fish (ID: `fauna:Fish`); Harpoon (ID: `realia:Harpoon`); Lizard (ID: `fauna:Lizard`); Monitor (ID: `fauna:Iguana`); Chameleon (ID: `fauna:Chameleon`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Hell (ID: `place:Hell`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Tablet (ID: `realia:Tablet`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); literally: nought (ID: `keyterm:Idol`); lean on (ID: `keyterm:LeanOn`); Libano (ID: `place:Lebanon`); saying (ID: `keyterm:Saying`); Be Disgraced (ID: `keyterm:Disgraced`); Hell (ID: `place:Hell`); Wine (ID: `realia:Wine`); Image (ID: `realia:Image`); Money (ID: `realia:Money`); Molten Image (ID: `realia:MoltenImage`); Beam (ID: `realia:Beam`); Vine (ID: `flora:Vine`); Tablet (ID: `realia:Tablet`); Graven Image (ID: `realia:GravenImage`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); literally: nought (ID: `keyterm:Idol`); lean on (ID: `keyterm:LeanOn`); Be Disgraced (ID: `keyterm:Disgraced`); Libano (ID: `place:Lebanon`); saying (ID: `keyterm:Saying`); Image (ID: `realia:Image`); Money (ID: `realia:Money`); Molten Image (ID: `realia:MoltenImage`); Beam (ID: `realia:Beam`); Graven Image (ID: `realia:GravenImage`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); Temã (ID: `place:Teman`); Cusã (ID: `place:Cushan`); Habacuque (ID: `person:Habakkuk`); Monte Paran (ID: `place:ParanMount`); arrow (ID: `keyterm:Arrow`); majesty (ID: `keyterm:Majesty`); holy (ID: `keyterm:Holy`); mischief (ID: `keyterm:Mischief`); anointed (ID: `keyterm:Anointed`); fear (ID: `keyterm:Fear`); Midiã (ID: `place:Midian`); Oath (ID: `keyterm:Oath`); Deer (ID: `fauna:Deer`); Goat (ID: `fauna:Goat`); Spear (ID: `realia:Spear`); Chariot (ID: `realia:Chariot`); Vine (ID: `flora:Vine`); Olive Tree (ID: `flora:OliveTree`); Fig (ID: `flora:Fig`); Foundation (ID: `realia:Foundation`); Bow (ID: `realia:Bow`); Sheepfold (ID: `realia:Sheepfold`); Cattle (ID: `fauna:Bull`); Animal Pen (ID: `realia:AnimalPen`); Tent (ID: `realia:Tent`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); Temã (ID: `place:Teman`); Cusã (ID: `place:Cushan`); Monte Paran (ID: `place:ParanMount`); arrow (ID: `keyterm:Arrow`); SENHOR (ID: `deity:Lord`); majesty (ID: `keyterm:Majesty`); mischief (ID: `keyterm:Mischief`); holy (ID: `keyterm:Holy`); anointed (ID: `keyterm:Anointed`); Midiã (ID: `place:Midian`); Oath (ID: `keyterm:Oath`); Spear (ID: `realia:Spear`); Chariot (ID: `realia:Chariot`); Foundation (ID: `realia:Foundation`); Bow (ID: `realia:Bow`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); arrow (ID: `keyterm:Arrow`); SENHOR (ID: `deity:Lord`); anointed (ID: `keyterm:Anointed`); Oath (ID: `keyterm:Oath`); Spear (ID: `realia:Spear`); Chariot (ID: `realia:Chariot`); Foundation (ID: `realia:Foundation`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); salvation (ID: `keyterm:Salvation`); Sheepfold (ID: `realia:Sheepfold`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); Animal Pen (ID: `realia:AnimalPen`); Vine (ID: `flora:Vine`); Olive Tree (ID: `flora:OliveTree`); Fig (ID: `flora:Fig`); Flock (ID: `fauna:Flock`)
