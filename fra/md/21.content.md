...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); Jérusalem (ID: `place:Jerusalem`); la connaissance (ID: `keyterm:Intention`); Éternel (ID: `deity:Lord`); stupide (ID: `keyterm:Stupid`); Vine (ID: `flora:Vine`); Israël (ID: `person:Israel`); pécher (ID: `keyterm:Sin`); Sandalwood (ID: `flora:Sandalwood`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); Jérusalem (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); Sandalwood (ID: `flora:Sandalwood`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Sandalwood (ID: `flora:Sandalwood`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); stupide (ID: `keyterm:Stupid`); faire un voeu (ID: `keyterm:Vow`); House (ID: `realia:House`); ardeur (ID: `keyterm:Ardour`); craindre (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); force (ID: `keyterm:Strength`); A Man (ID: `person:GenericMale`); tuerie (ID: `keyterm:Slaughtering`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); stupide (ID: `keyterm:Stupid`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`); agir par méchanceté (ID: `keyterm:ActWickedly`); pécher (ID: `keyterm:Sin`); craindre (ID: `keyterm:Fear`); laissiez en possession (ID: `keyterm:Possess`); la connaissance (ID: `keyterm:Intention`); Cooking Pot (ID: `realia:CookingPot`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); aimer (ID: `keyterm:Love`); capacité (ID: `keyterm:Ability`); sans saleté (ID: `keyterm:Pure`); adjuration (ID: `keyterm:Oath`); force (ID: `keyterm:Strength`); ardeur (ID: `keyterm:Ardour`); pécher (ID: `keyterm:Sin`); pollution (ID: `keyterm:Defilement`); jurer (ID: `keyterm:Swear`); percevoir (ID: `keyterm:Perceive`); securité (ID: `keyterm:Safety`); Hell (ID: `place:Hell`); la connaissance (ID: `keyterm:Intention`); grâce (ID: `keyterm:Favor`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`); Bird (ID: `fauna:Bird`); Dog (ID: `fauna:Dog`); Net (ID: `realia:Net`); Anointing Oil (ID: `realia:AnointingOil`); Fishnet (ID: `realia:Fishnet`); Vine (ID: `flora:Vine`); Fish (ID: `fauna:Fish`); Trap (ID: `realia:Trap`); Lion (ID: `fauna:Lion`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); aimer (ID: `keyterm:Love`); capacité (ID: `keyterm:Ability`); force (ID: `keyterm:Strength`); Hell (ID: `place:Hell`); la connaissance (ID: `keyterm:Intention`); Vine (ID: `flora:Vine`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); Hell (ID: `place:Hell`); la connaissance (ID: `keyterm:Intention`); force (ID: `keyterm:Strength`)
...
* **Associated ACAI Concepts:** stupide (ID: `keyterm:Stupid`); Bed (ID: `realia:Bed`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); Caper (ID: `flora:Caper`); Almond (ID: `flora:Almond`); Locust (ID: `fauna:Locust`); Pit (ID: `realia:Pit`); Bird (ID: `fauna:Bird`); Rope (ID: `realia:Rope`); Money (ID: `realia:Money`); Clay Jar (ID: `realia:ClayJar`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); vérité (ID: `keyterm:Truth`); la connaissance (ID: `keyterm:Intention`); craindre (ID: `keyterm:Fear`); droiture (ID: `keyterm:Straightness`); proverbe (ID: `keyterm:Saying`); Goad (ID: `realia:Goad`); Scroll (ID: `realia:Scroll`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Nail (ID: `realia:Nail`); Sheep (ID: `fauna:Lamb`)
