...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`); إِرْمِيَا (ID: `person:Jeremiah.6`); إِسْرَائِيلَ (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `group:Judah`); لَّاوِي (ID: `person:Levi.3`); بَنْيَامِينَ (ID: `person:Benjamin`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `group:Levi`); بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `person:Judah.4`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); كورَشَ (ID: `person:Cyrus`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `group:Judah`); كورَشَ (ID: `person:Cyrus`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); سلَيْمَانَ (ID: `person:Solomon`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); لِدَلَايَا (ID: `person:Delaiah.3`); أَدَّان (ID: `place:Addan`); سَلْمَايَ (ID: `person:Shalmai`); فَرْعوشَ (ID: `person:Parosh`); حَقوفَا (ID: `person:Hakupha`); بِغْوَايَ (ID: `person:Bigvai`); جَدِّيلَ (ID: `person:Giddel`); سِيعَهَا (ID: `person:Siaha`); جَزَّامَ (ID: `person:Gazzam`); جَاحَرَ (ID: `person:Gahar`); حَرْشَا (ID: `person:Harsha`); ثَامَحَ (ID: `person:Temah`); آطِيرَ (ID: `person:Ater`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); حَطِّيلَ (ID: `person:Hattil`); فِي (ID: `person:Uzza.2`); صِيحَا (ID: `person:Ziha`); نَحَمْيَا (ID: `person:Nehemiah`); حَبَايَا (ID: `person:Habaiah`); بِلْشَان (ID: `person:Bilshan`); يَشوعَ (ID: `person:Jeshua.3`); أَسْنَةَ (ID: `person:Asnah`); حَطِيطَا (ID: `person:Hatita`); حَرْحورَ (ID: `person:Harhur`)
...
* **Associated ACAI Concepts:** نَحَمْيَا (ID: `person:Nehemiah`); بِلْشَان (ID: `person:Bilshan`); مِسْفَار (ID: `person:Mispar`); سَرَايَا (ID: `person:Seraiah.6`); بِغْوَايَ (ID: `person:Bigvai`); رَحوم (ID: `person:Rehum`); رَعْلَايَا (ID: `person:Reelaiah`); بَعْنَةَ (ID: `person:Baanah.3`); مرْدَخَاي (ID: `person:Mordecai`); إِسْرَائِيلَ (ID: `person:Israel`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** فَرْعوشَ (ID: `person:Parosh`); أَدونِيقَامَ (ID: `person:Adonikam`); عِيلَامَ (ID: `person:Elam`); بَانِيَ (ID: `person:Bani`); زَكَّايَ (ID: `person:Zaccai.2`); يورَةَ (ID: `person:Jorah`); حَزَقِيَّا (ID: `person:Hezekiah.2`); آطِيرَ (ID: `person:Ater`); عَرْجَدَ (ID: `person:Azgad`); بِيصَايَ (ID: `person:Bezai`); آرَحَ (ID: `person:Arah.2`); زَتّو (ID: `person:Zattu.2`); حَشوم (ID: `person:Hashum`); بِغْوَايَ (ID: `person:Bigvai.2`); Pahath-moab (ID: `person:Pahath-moab`); يَشوعَ (ID: `person:Jeshua.3`); يوآب (ID: `person:Joab.3`); بَابَايَ (ID: `person:Bebai`); عَادِينَ (ID: `person:Adin`); شَفَطْيَا (ID: `person:Shephatiah.6`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Beth-azmaveth (ID: `place:Beth-azmaveth`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); مَغْبِيشَ (ID: `place:Magbish`); نَبو (ID: `place:Nebo.2`); حَارِيمَ (ID: `person:Harim.2`); حَادِيدَ (ID: `place:Hadid`); سَنَاءَةَ (ID: `place:Senaah`); مِخْمَاسَ (ID: `place:Michmash`); Ramah (ID: `place:Ramah.2`); بَئِيروت (ID: `place:Beeroth`); عِيلَامَ (ID: `person:Elam`); عَنَاثوثَ (ID: `place:Anathoth`); أَرِيحَا (ID: `place:Jericho`); مِنْ (ID: `place:Geba`); Bethel (ID: `place:Bethel`); ٱلْكَفِيرَة (ID: `place:Chephirah`); وَلودَ (ID: `place:Lod`); لَحْمٍ (ID: `place:Bethlehem`); Kiriath-jearim (ID: `place:Kiriath-jearim`); عَايٍ (ID: `place:Ai`); أونوَ (ID: `place:Ono`)
...
* **Associated ACAI Concepts:** يَشوعَ (ID: `person:Jeshua`); آطِيرَ (ID: `person:Ater.2`); شوبَايَ (ID: `person:Shobai`); طَلْمون (ID: `person:Talmon`); هودَوْيَا (ID: `person:Hodaviah.4`); يَشوعَ (ID: `person:Jeshua.4`); لِإِيمِيرَ (ID: `person:Immer.2`); يَدَايَا (ID: `person:Jedaiah.4`); حَطِيطَا (ID: `person:Hatita`); حَارِيمَ (ID: `person:Harim`); فَشْحور (ID: `person:Pashhur`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); لَّاوِي (ID: `person:Levi.3`); عَقّوب (ID: `person:Akkub.2`); شَلّوم (ID: `person:Shallum.8`); لَّاوِي (ID: `group:Levi`); آسَاف (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** آطِيرَ (ID: `person:Ater.2`); شوبَايَ (ID: `person:Shobai`); طَلْمون (ID: `person:Talmon`); حَطِيطَا (ID: `person:Hatita`); عَقّوب (ID: `person:Akkub.2`); شَلّوم (ID: `person:Shallum.8`); آسَاف (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** فَادونَ (ID: `person:Padon`); حَرْحورَ (ID: `person:Harhur`); سَلْمَايَ (ID: `person:Shalmai`); حَقوفَا (ID: `person:Hakupha`); جَدِّيلَ (ID: `person:Giddel`); حَاجَابَ (ID: `person:Hagab`); سِيعَهَا (ID: `person:Siaha`); جَزَّامَ (ID: `person:Gazzam`); بَصْلوتَ (ID: `person:Bazluth`); جَاحَرَ (ID: `person:Gahar`); حَسوفَا (ID: `person:Hasupha`); حَرْشَا (ID: `person:Harsha`); بِيسَايَ (ID: `person:Besai`); ثَامَحَ (ID: `person:Temah`); نَصِيحَ (ID: `person:Neziah`); عَقّوب (ID: `person:Akkub.3`); لَبَانَةَ (ID: `person:Lebanah`); Meunim (ID: `group:Meunim`); مَحِيدَا (ID: `person:Mehida`); حَطِيفَا (ID: `person:Hatipha`); حَانَان (ID: `person:Hanan.4`); طَبَاعوتَ (ID: `person:Tabbaoth`); حَجَابَةَ (ID: `person:Hagabah`); بَقْبوقَ (ID: `person:Bakbuk`); قِيروسَ (ID: `person:Keros`); فِي (ID: `person:Uzza.2`); فَاسِيحَ (ID: `person:Paseah.2`); نَقودَا (ID: `person:Nekoda`); بَرْقوسَ (ID: `person:Barkos`); صِيحَا (ID: `person:Ziha`); سِيسَرَا (ID: `person:Sisera.2`); أَسْنَةَ (ID: `person:Asnah`); Nephushesim (ID: `group:Nephushesim`); رَصِينَ (ID: `person:Rezin.2`); رَآيَا (ID: `person:Reaiah.3`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); حَطِّيلَ (ID: `person:Hattil`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); سوفَرَثَ (ID: `person:Sophereth`); سَوْطَايَ (ID: `person:Sotai`); شَفَطْيَا (ID: `person:Shephatiah.7`); دَرْقونَ (ID: `person:Darkon`); جَدِّيلَ (ID: `person:Giddel.2`); آمِي (ID: `person:Ami`); فَرودَا (ID: `person:Peruda`); يَعْلَةَ (ID: `person:Jaalah`)
...
* **Associated ACAI Concepts:** كَروب (ID: `place:Cherub`); لِدَلَايَا (ID: `person:Delaiah.3`); Tel-harsha (ID: `place:Tel-harsha`); Tel-melah (ID: `place:Tel-melah`); أَدَّان (ID: `place:Addan`); طوبِيَّا (ID: `person:Tobiah`); نَقودَا (ID: `person:Nekoda.2`); لِإِيمِيرَ (ID: `place:Immer`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** حَبَايَا (ID: `person:Habaiah`); بَرْزِلَّايَ (ID: `person:Barzillai.3`); هَقّوصَ (ID: `person:Hakkoz.2`); Defile (ID: `keyterm:Stain`); بَرْزِلَّايَ (ID: `person:Barzillai`); Priesthood (ID: `keyterm:Priesthood`); جِلْعَادَ (ID: `place:Gilead`); Gileadites (ID: `group:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); ٱلرَّبِّ (ID: `deity:Lord`); Strength (ID: `keyterm:Strength`); أورشَلِيمَ (ID: `place:Jerusalem`); Money (ID: `realia:Money`); Mina (ID: `realia:Mina`); House (ID: `realia:House`); Tunic (ID: `realia:Tunic`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); يَشوع (ID: `person:Joshua.5`); فَارِسَ (ID: `place:Persia`); كورَشَ (ID: `person:Cyrus`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); هودَوْيَا (ID: `person:Hodaviah.4`); Esarhaddon (ID: `person:Esarhaddon`); يَشوعَ (ID: `person:Jeshua.4`); Relatives (ID: `group:Relatives`); حِينَادَادَ (ID: `person:Henadad`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); Tyrians (ID: `group:Tyre`); Appointed Feast (ID: `keyterm:AppointedFeast`); دَاودَ (ID: `person:David`); بَنْيَامِينَ (ID: `person:Benjamin`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); صورَ (ID: `place:Tyre`); Terror (ID: `keyterm:Terror`); Counsel (ID: `keyterm:Counsel`); Instruction (ID: `keyterm:Instruction`); دَارِيوسَ (ID: `person:Darius.2`); يَافَا (ID: `place:Joppa`); Kindness (ID: `keyterm:Kindness`); Holy (ID: `keyterm:Holy`); موسَى (ID: `person:Moses`); Assyria (ID: `place:Assyria`); بَنْيَامِينَ (ID: `group:Benjamin`); هودِيَّا (ID: `person:Hodiah.2`); New Moon Festival (ID: `keyterm:NewMoonFestival`); صِيْدونَ (ID: `place:Sidon`); Sidonians (ID: `group:Sidon`); لبْنَانَ (ID: `place:Lebanon`); آسَاف (ID: `person:Asaph.2`); Cymbals (ID: `realia:Cymbals`); Craftsman (ID: `realia:Craftsman`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Cedar (ID: `flora:Cedar`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`); Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); ٱلرَّبِّ (ID: `deity:Lord`); موسَى (ID: `person:Moses`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); Terror (ID: `keyterm:Terror`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); Holy (ID: `keyterm:Holy`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Appointed Feast (ID: `keyterm:AppointedFeast`)
...
* **Associated ACAI Concepts:** Tyrians (ID: `group:Tyre`); يَافَا (ID: `place:Joppa`); فَارِسَ (ID: `place:Persia`); صِيْدونَ (ID: `place:Sidon`); كورَشَ (ID: `person:Cyrus`); Sidonians (ID: `group:Sidon`); صورَ (ID: `place:Tyre`); لبْنَانَ (ID: `place:Lebanon`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Craftsman (ID: `realia:Craftsman`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `person:Levi.3`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); يَشوع (ID: `person:Joshua.5`); لَّاوِي (ID: `group:Levi`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); دَاودَ (ID: `person:David`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); آسَاف (ID: `person:Asaph.2`); Trumpet (ID: `realia:Trumpet`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `person:Benjamin`); بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); إِسْرَائِيلَ (ID: `person:Israel`); فَارِسَ (ID: `place:Persia`); ٱلرَّبِّ (ID: `deity:Lord`); كورَشَ (ID: `person:Cyrus`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْفرَاتِ (ID: `place:Euphrates`); شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); فَارِسَ (ID: `place:Persia`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Jews (ID: `group:Jews`); Babylonians (ID: `group:Babylon`); أسْنَفَّر (ID: `person:Osnappar`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); مِثْرَدَاث (ID: `person:Mithredath.2`); بِشْلَام (ID: `person:Bishlam`); أَرَكَ (ID: `place:Erech`); طَبْئِيل (ID: `person:Tabeel`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); فِي (ID: `place:Susa`); عِيلَامَ (ID: `place:Elam`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); بَابِلَ (ID: `place:Babylon`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** شِمْشَاي (ID: `person:Shimshai`); Babylonians (ID: `group:Babylon`); رَحوم (ID: `person:Rehum.2`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); أَرَكَ (ID: `place:Erech`); فَارِسَ (ID: `place:Persia`); عِيلَامَ (ID: `place:Elam`); فِي (ID: `place:Susa`); بَابِلَ (ID: `place:Babylon`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); شِمْشَاي (ID: `person:Shimshai`); Jews (ID: `group:Jews`); ٱلسَّامِرَةِ (ID: `place:Samaria`); رَحوم (ID: `person:Rehum.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); دَارِيوسَ (ID: `person:Darius.2`); Shethar-bozenai (ID: `person:Shethar-bozenai`); حَجَّيِ (ID: `person:Haggai`); تَتْنَاي (ID: `person:Tattenai`); زَكَرِيَّا (ID: `person:Zechariah.17`); يَدّو (ID: `person:Iddo.6`); ٱلْفرَاتِ (ID: `place:Euphrates`); فَارِسَ (ID: `place:Persia`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** حَجَّيِ (ID: `person:Haggai`); يَدّو (ID: `person:Iddo.6`); زَكَرِيَّا (ID: `person:Zechariah.17`); إِسْرَائِيلَ (ID: `person:Israel`); Jews (ID: `group:Jews`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); يَشوع (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); بَابِلَ (ID: `place:Babylon`); أورشَلِيمَ (ID: `place:Jerusalem`); كورَشَ (ID: `person:Cyrus`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); زَربَّابِل (ID: `person:Zerubbabel.2`); دَارِيوسَ (ID: `person:Darius.2`); Shethar-bozenai (ID: `person:Shethar-bozenai`); تَتْنَاي (ID: `person:Tattenai`); ٱلْفرَاتِ (ID: `place:Euphrates`); Chaldeans (ID: `group:Chaldea`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); يَهوذَا (ID: `person:Judah.4`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); كورَشَ (ID: `person:Cyrus`); زَربَّابِل (ID: `person:Zerubbabel.2`); بَابِلَ (ID: `place:Babylon`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `group:Levi`); Pure (ID: `keyterm:Pure`); Passover (ID: `keyterm:Passover`); لَّاوِي (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Defilement (ID: `keyterm:Defilement`); ٱلرَّبِّ (ID: `deity:Lord`); Gentiles (ID: `group:Gentile`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Assyria (ID: `place:Assyria`); Unleavened Bread (ID: `realia:UnleavenedBread`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); سَرَايَا (ID: `person:Seraiah.2`); عَزَرْيَا (ID: `person:Azariah.7`); فَارِسَ (ID: `place:Persia`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); حِلْقِيَّا (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); بقِّي (ID: `person:Bukki.2`); سَرَايَا (ID: `person:Seraiah.2`); زَرَحْيَا (ID: `person:Zerahiah`); لِمَرَايوثَ (ID: `person:Meraioth`); صَادوق (ID: `person:Zadok.4`); شَلّوم (ID: `person:Shallum.7`); عَزَرْيَا (ID: `person:Azariah.7`); أَمَرْيَا (ID: `person:Amariah.2`); أَخِيطوبَ (ID: `person:Ahitub.3`); أَبِيشوعَ (ID: `person:Abishua`); عَزَرْيَا (ID: `person:Azariah.6`); عزِّي (ID: `person:Uzzi`); فَارِسَ (ID: `place:Persia`); فِينَحَاس (ID: `person:Phinehas`); حِلْقِيَّا (ID: `person:Hilkiah.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); هَارون (ID: `person:Aaron`); أَلِعَازَار (ID: `person:Eleazar.2`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); ٱلرَّبِّ (ID: `deity:Lord`); موسَى (ID: `person:Moses`); بَابِلَ (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); ٱلرَّبِّ (ID: `deity:Lord`); Decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); عَزْرَا (ID: `person:Ezra`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); Olive Oil (ID: `realia:OliveOil`); Talent (ID: `realia:Talent`); Money (ID: `realia:Money`); Kor (ID: `realia:Kor`); Anointing Oil (ID: `realia:AnointingOil`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** دَانِيآل (ID: `person:Daniel.2`); شَكَنْيَا (ID: `person:Shecaniah.5`); بَابَايَ (ID: `person:Bebai.2`); زَكَرِيَّا (ID: `person:Zechariah.18`); يَحِيئِيل (ID: `person:Jehiel.7`); أَدونِيقَامَ (ID: `person:Adonikam`); عِيلَامَ (ID: `person:Elam`); يَحْزِيئِيل (ID: `person:Jahaziel.5`); يونَاثَانَ (ID: `person:Jonathan.9`); مِيخَائِيلَ (ID: `person:Michael.10`); عَثَلْيَا (ID: `person:Athaliah.3`); عَابِد (ID: `person:Ebed.2`); شَكَنْيَا (ID: `person:Shecaniah.6`); زَكَرِيَّا (ID: `person:Zechariah.19`); هِقَّاطَانَ (ID: `person:Hakkatan`); عَرْجَدَ (ID: `person:Azgad`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); شَلومِيَةَ (ID: `person:Shelomith.4`); زَبَدْيَا (ID: `person:Zebadiah.8`); يوآب (ID: `person:Joab.4`); فَرْعوشَ (ID: `person:Parosh.2`); حَطّوش (ID: `person:Hattush.2`); يَعِيئِيل (ID: `person:Jeuel.3`); عوبَدْيَا (ID: `person:Obadiah.10`); يوشَفْيَا (ID: `person:Josiphiah`); Gershom (ID: `person:Gershom.2`); بِغْوَايَ (ID: `person:Bigvai.2`); Pahath-moab (ID: `person:Pahath-moab`); زَرَحْيَا (ID: `person:Zerahiah.2`); أَلِيفَلَط (ID: `person:Eliphelet.5`); عوتَاي (ID: `person:Uthai.2`); يِشْعِيَا (ID: `person:Jeshaiah.4`); يوحَانَانَ (ID: `person:Johanan.8`); بَابَايَ (ID: `person:Bebai`); زَكّور (ID: `person:Zaccur.5`); شِمْعِيَا (ID: `person:Shemaiah.14`); عَادِينَ (ID: `person:Adin`); شَفَطْيَا (ID: `person:Shephatiah.6`); دَاودَ (ID: `person:David`); فِينَحَاس (ID: `person:Phinehas`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); إِيثَامَارَ (ID: `person:Ithamar`); بَابِلَ (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** أَلْنَاثَانَ (ID: `person:Elnathan.4`); مَشلَّام (ID: `person:Meshullam.9`); زَكَرِيَّا (ID: `person:Zechariah.20`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); يويَارِيبَ (ID: `person:Joiarib.2`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); يَدّو (ID: `person:Iddo`); نَاثَان (ID: `person:Nathan.5`); يَارِيبَ (ID: `person:Jarib.2`); شِمْعِيَا (ID: `person:Shemaiah.15`); أَرِيئِيلَ (ID: `person:Ariel`); ٱلْمسَمَّى (ID: `place:Casiphia`); أَلِيعَزَرَ (ID: `person:Eliezer.8`); Perceive (ID: `keyterm:Perceive`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Insight (ID: `keyterm:Insight`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); مَحْلِي (ID: `person:Mahli`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); Egyptians (ID: `group:Egypt`); حِثًّا (ID: `person:Heth`); Be Unfaithful (ID: `keyterm:Unfaithful`); إِسْرَائِيلَ (ID: `person:Israel`); Ammonites (ID: `group:Ammon`); موآبَ (ID: `place:Moab`); Canaanites (ID: `group:Canaan`); لَّاوِي (ID: `person:Levi.3`); مِصْرَ (ID: `place:Egypt`); كَنْعَان (ID: `place:Canaan`); لَّاوِي (ID: `group:Levi`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); Jebusites (ID: `group:Jebusites`); Amorites (ID: `group:Amorites`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); Counsel (ID: `keyterm:Counsel`); Offering (ID: `keyterm:Offering`); عِيلَامَ (ID: `person:Elam`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); بَانِيَ (ID: `person:Bani.6`); أَلِيوعِينَاي (ID: `person:Elioenai.4`); يَرِيموت (ID: `person:Jeremoth.4`); بِيدْيَا (ID: `person:Bedeiah`); فَرْعوشَ (ID: `person:Parosh`); ومَتَّاثَا (ID: `person:Mattattah`); شَلّوم (ID: `person:Shallum.10`); شَبْتَاي (ID: `person:Shabbethai`); Perizzites (ID: `group:Perizzites`); عَدَايَا (ID: `person:Adaiah.6`); مَنَسَّى (ID: `person:Manasseh.3`); زَابَادَ (ID: `person:Zabad.6`); مَعْسِيَّا (ID: `person:Maaseiah.7`); بَصَلْئِيل (ID: `person:Bezalel.2`); مَلْكِيَّا (ID: `person:Malchijah.5`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); Defilement (ID: `keyterm:Defilement`); Kindness (ID: `keyterm:Kindness`); Dispossess (ID: `keyterm:Dispossess`); فَارِسَ (ID: `place:Persia`); إِسْرَائِيلَ (ID: `person:Israel`); To Cause to Possess (ID: `keyterm:Possess`); أورشَلِيمَ (ID: `place:Jerusalem`); Plea for Mercy (ID: `keyterm:Supplication`); Peace (ID: `keyterm:IntactState`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); Kindness (ID: `keyterm:Kindness`); فَارِسَ (ID: `place:Persia`); أورشَلِيمَ (ID: `place:Jerusalem`); Plea for Mercy (ID: `keyterm:Supplication`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** يَحِيئِيل (ID: `person:Jehiel.8`); شَكَنْيَا (ID: `person:Shecaniah.7`); Be Unfaithful (ID: `keyterm:Unfaithful`); عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); عِيلَامَ (ID: `person:Elam`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); Swear (ID: `keyterm:Swear`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `person:Benjamin`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** مَشلَّام (ID: `person:Meshullam.10`); عَسَائِيل (ID: `person:Asahel.4`); تِقْوَةَ (ID: `person:Tikvah.2`); يَحْزِيَا (ID: `person:Jahzeiah`); يونَاثَانَ (ID: `person:Jonathan.10`); شَبْتَاي (ID: `person:Shabbethai`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`)
