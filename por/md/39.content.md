...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); love (ID: `keyterm:Love`); Israel (ID: `person:Israel`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); SENHOR (ID: `deity:Lord`); Priests (ID: `group:GenericPriests`); Glory (ID: `keyterm:Glory`); fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); offering (ID: `keyterm:Offering`); fear (ID: `keyterm:Fear`); Covenant (ID: `keyterm:Covenant`); Glory (ID: `keyterm:Glory`); Levi (ID: `group:Levi`); peace (ID: `keyterm:IntactState`); Levi (ID: `person:Levi.3`); Priests (ID: `group:GenericPriests`); stain (ID: `keyterm:Stain`); utter a curse (ID: `keyterm:Curse`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); fairness (ID: `keyterm:Fairness`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); be kindly disposed (ID: `keyterm:KindlyDisposed`); An Angel (ID: `deity:Angel`); pure (ID: `keyterm:Pure`); bless (ID: `keyterm:Bless`); evil intention (ID: `keyterm:Intention`); make a vow (ID: `keyterm:Vow`); Truth (ID: `keyterm:Truth`); The Way (ID: `keyterm:TheWay`); Gentiles (ID: `group:Gentile`); ardour (ID: `keyterm:Ardour`); profane, dishonor (ID: `keyterm:Dishonor`); rogar (ID: `keyterm:AskFor`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Covenant (ID: `keyterm:Covenant`); offering (ID: `keyterm:Offering`); profane, dishonor (ID: `keyterm:Dishonor`); love (ID: `keyterm:Love`); delight (ID: `keyterm:Delight`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); love (ID: `keyterm:Love`); profane, dishonor (ID: `keyterm:Dishonor`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); swear (ID: `keyterm:Swear`); Covenant (ID: `keyterm:Covenant`); Judá (ID: `person:Judah.4`); A Group of People (ID: `group:GenericGroup`); Levi (ID: `group:Levi`); Jerusalém (ID: `place:Jerusalem`); fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Judá (ID: `group:Judah`); Levi (ID: `person:Levi.3`); pure (ID: `keyterm:Pure`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); bless (ID: `keyterm:Bless`); decree (ID: `keyterm:Decree`); offering (ID: `keyterm:Offering`); Israel (ID: `person:Israel`); utter a curse (ID: `keyterm:Curse`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Wheat (ID: `flora:Wheat`); Sorghum (ID: `flora:Sorghum`)
...
* **Associated ACAI Concepts:** Moisés (ID: `person:Moses`); Monte Sinai (ID: `place:SinaiMount`); Israel (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`); Monte Sinai (ID: `place:SinaiMount`); fear (ID: `keyterm:Fear`); Israel (ID: `person:Israel`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`); Elias (ID: `person:Elijah`); Instruction (ID: `keyterm:Instruction`); decree (ID: `keyterm:Decree`)
