...
* **Associated ACAI Concepts:** Abagtha (ID: `person:Abagtha`); Zethar (ID: `person:Zethar`); Mehuman (ID: `person:Mehuman`); Carkas (ID: `person:Carkas`); Bigtha (ID: `person:Bigtha`); Biztha (ID: `person:Biztha`); Harbona (ID: `person:Harbona`); Ahasuerus (ID: `person:Ahasuerus`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Vashti (ID: `person:Vashti`); Ahasuerus (ID: `person:Ahasuerus`); Persians (ID: `group:Persia`); Persia (ID: `place:Persia`); Medan (ID: `person:Medan`); Medes (ID: `group:Mede`)
...
* **Associated ACAI Concepts:** Jehoiachin (ID: `person:Jehoiachin`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Babylon (ID: `place:Babylon`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Ahasuerus (ID: `person:Ahasuerus`); Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Hammedatha (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Money (ID: `realia:Money`); Servants (ID: `group:GenericServants`); Lot (ID: `keyterm:Lot`); Susa (ID: `place:Susa`); Lot (ID: `realia:Lot`); Scroll (ID: `realia:Scroll`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** Zeresh (ID: `person:Zeresh`); A Group of People (ID: `group:GenericGroup`); Mordecai (ID: `person:Mordecai.2`); Love (ID: `keyterm:Love`); Haman (ID: `person:Haman`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Zeresh (ID: `person:Zeresh`); A Group of People (ID: `group:GenericGroup`); Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Love (ID: `keyterm:Love`); Haman (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Esther (ID: `person:Esther`); Ahasuerus (ID: `person:Ahasuerus`); Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Haman (ID: `person:Haman`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** To Beg for Mercy (ID: `keyterm:BegForMercy`); Agag (ID: `person:Agag.2`); Esther (ID: `person:Esther`); Jews (ID: `group:Jews`); Agagites (ID: `group:Agag`); Haman (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Agag (ID: `person:Agag.2`); Jews (ID: `group:Jews`); Favor (ID: `keyterm:Favor`); Agagites (ID: `group:Agag`); Haman (ID: `person:Haman`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Lot (ID: `realia:Lot`); Hammedatha (ID: `person:Hammedatha`); Agag (ID: `person:Agag.2`); Mordecai (ID: `person:Mordecai.2`); Lot (ID: `keyterm:Lot`); Agagites (ID: `group:Agag`); Haman (ID: `person:Haman`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Media (ID: `place:Media`); Ahasuerus (ID: `person:Ahasuerus`); Persia (ID: `place:Persia`)
