...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); Fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); Vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); أَمِتَّايَ (ID: `person:Amittai`); نِينَوَى (ID: `place:Nineveh`); يَافَا (ID: `place:Joppa`); Exempt (ID: `keyterm:Exempt`); Salvation (ID: `keyterm:Salvation`); Kindness (ID: `keyterm:Kindness`); Lot (ID: `keyterm:Lot`); Praise (ID: `keyterm:Praise`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Slaughtering (ID: `keyterm:Slaughtering`); تَرْشِيشَ (ID: `place:Tarshish`); Hebrews (ID: `group:Hebrews`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** Vow (ID: `keyterm:Vow`); ٱلرَّبِّ (ID: `deity:Lord`); Slaughtering (ID: `keyterm:Slaughtering`); Fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Hell (ID: `place:Hell`); Praise (ID: `keyterm:Praise`); Vow (ID: `keyterm:Vow`); يونَانَ (ID: `person:Jonah.2`); Kindness (ID: `keyterm:Kindness`); Salvation (ID: `keyterm:Salvation`); Cattails (ID: `flora:Cattails`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** Praise (ID: `keyterm:Praise`); Vow (ID: `keyterm:Vow`); ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); نِينَوَى (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Sackcloth (ID: `realia:Sackcloth`); Cattle (ID: `fauna:Bull`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Believe In (ID: `keyterm:BelieveIn`); تَرْشِيشَ (ID: `place:Tarshish`); Generous (ID: `keyterm:Generous`); Kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`); Worm (ID: `fauna:Maggot`); Flock (ID: `fauna:Flock`); Throne (ID: `realia:Throne`); Clothing (ID: `realia:Clothing`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); نِينَوَى (ID: `place:Nineveh`); Word of the Lord (ID: `keyterm:WordOfTheLord`); يونَانَ (ID: `person:Jonah.2`)
...
* **Associated ACAI Concepts:** تَرْشِيشَ (ID: `place:Tarshish`); ٱلرَّبِّ (ID: `deity:Lord`); Generous (ID: `keyterm:Generous`); Kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`)
