...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); Hell (ID: `place:Hell`); make a vow (ID: `keyterm:Vow`); Jope (ID: `place:Joppa`); Amittai (ID: `person:Amittai`); Nínive (ID: `place:Nineveh`); kindness (ID: `keyterm:Kindness`); exempt (ID: `keyterm:Exempt`); Hebrews (ID: `group:Hebrews`); Társis (ID: `place:Tarshish`); Word of the Lord (ID: `keyterm:WordOfTheLord`); praise (ID: `keyterm:Praise`); lot (ID: `keyterm:Lot`); slaughtering (ID: `keyterm:Slaughtering`); salvation (ID: `keyterm:Salvation`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Hell (ID: `place:Hell`); kindness (ID: `keyterm:Kindness`); Jonas (ID: `person:Jonah.2`); make a vow (ID: `keyterm:Vow`); praise (ID: `keyterm:Praise`); salvation (ID: `keyterm:Salvation`); Fish (ID: `fauna:Fish`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** kindness (ID: `keyterm:Kindness`); SENHOR (ID: `deity:Lord`); make a vow (ID: `keyterm:Vow`); praise (ID: `keyterm:Praise`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Nínive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); kindness (ID: `keyterm:Kindness`); gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`); Compassionate (ID: `keyterm:Compassionate`); Believe In (ID: `keyterm:BelieveIn`); Clothing (ID: `realia:Clothing`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Throne (ID: `realia:Throne`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Cattle (ID: `fauna:Bull`); Nínive (ID: `place:Nineveh`); SENHOR (ID: `deity:Lord`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** kindness (ID: `keyterm:Kindness`); gracious (ID: `keyterm:Generous`); SENHOR (ID: `deity:Lord`); Társis (ID: `place:Tarshish`); Compassionate (ID: `keyterm:Compassionate`)
