...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Salomão (ID: `person:Solomon`); Quedar (ID: `person:Kedar`); Goat Hair Strips (ID: `realia:GoatHairStrips`); Linen Strips (ID: `realia:LinenStrips`); Tent (ID: `realia:Tent`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Gazelle (ID: `fauna:Gazelle`); Vine (ID: `flora:Vine`); Deer (ID: `fauna:Deer`); Dove (ID: `fauna:Dove`); Beter (ID: `place:BetherMountain`); Jackal (ID: `fauna:Jackal`); Fig (ID: `flora:Fig`); Window (ID: `realia:Window`); Lily (ID: `flora:Lily`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); love (ID: `keyterm:Love`); Libano (ID: `place:Lebanon`); Frankincense (ID: `flora:Frankincense`); Money (ID: `realia:Money`); Crown (ID: `realia:Crown`); Myrrh (ID: `flora:Myrrh`); Sword (ID: `realia:Sword`); Purple Cloth (ID: `realia:PurpleCloth`); Bier (ID: `realia:Bier`)
...
* **Associated ACAI Concepts:** Balsam Tree (ID: `flora:BalsamTree`); Libano (ID: `place:Lebanon`); Myrrh (ID: `flora:Myrrh`); Pomegranate (ID: `flora:Pomegranate`); Nard (ID: `flora:Nard`); Flock (ID: `fauna:Flock`); Vine (ID: `flora:Vine`); Frankincense (ID: `flora:Frankincense`); Wine (ID: `realia:Wine`); Veil (ID: `realia:Veil`); Goat (ID: `fauna:Goat`); Monte Hermom (ID: `place:HermonMount`); Monte Amana (ID: `place:Amana`); Gileade (ID: `place:Gilead`); Davi (ID: `person:David`); Henna (ID: `flora:Henna`); Saffron Plant (ID: `flora:SaffronPlant`); Calamus (ID: `flora:Calamus`); Small Shield (ID: `realia:SmallShield`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Dove (ID: `fauna:Dove`); Agarwood (ID: `flora:Agarwood`); Lion (ID: `fauna:Lion`); Leopard (ID: `fauna:Leopard`); Lily (ID: `flora:Lily`); Gazelle (ID: `fauna:Gazelle`); Thread (ID: `realia:Thread`); Cloak (ID: `realia:Cloak`); Cinnamon (ID: `flora:Cinnamon`); Tower (ID: `realia:Tower`)
...
* **Associated ACAI Concepts:** Libano (ID: `place:Lebanon`); Balsam Tree (ID: `flora:BalsamTree`); Wine (ID: `realia:Wine`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Vine (ID: `flora:Vine`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Lily (ID: `flora:Lily`); Jerusalém (ID: `place:Jerusalem`); swear (ID: `keyterm:Swear`); Myrrh (ID: `flora:Myrrh`); Dove (ID: `fauna:Dove`); Balsam Tree (ID: `flora:BalsamTree`); love (ID: `keyterm:Love`); Libano (ID: `place:Lebanon`); Cedar (ID: `flora:Cedar`); Crow (ID: `fauna:Crow`); Veil (ID: `realia:Veil`); Tunic (ID: `realia:Tunic.2`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Libano (ID: `place:Lebanon`); Cedar (ID: `flora:Cedar`); Crow (ID: `fauna:Crow`); Lily (ID: `flora:Lily`); Myrrh (ID: `flora:Myrrh`); Dove (ID: `fauna:Dove`); Balsam Tree (ID: `flora:BalsamTree`)
...
* **Associated ACAI Concepts:** Libano (ID: `place:Lebanon`); Cedar (ID: `flora:Cedar`); Crow (ID: `fauna:Crow`); Lily (ID: `flora:Lily`); Myrrh (ID: `flora:Myrrh`); Dove (ID: `fauna:Dove`); Balsam Tree (ID: `flora:BalsamTree`)
...
* **Associated ACAI Concepts:** Flock (ID: `fauna:Flock`); Standard (ID: `realia:Standard`); Goat (ID: `fauna:Goat`); Jerusalém (ID: `place:Jerusalem`); Gileade (ID: `place:Gilead`); Tirza (ID: `place:Tirzah`); Pomegranate (ID: `flora:Pomegranate`); Veil (ID: `realia:Veil`); Sheep (ID: `fauna:Lamb`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Date Palm (ID: `flora:DatePalm`); Bate-Rabim (ID: `place:Bath-rabbim`); Shulammites (ID: `group:Shulammites`); fairness (ID: `keyterm:Fairness`); Carmelo (ID: `place:Carmel`); love (ID: `keyterm:Love`); Damasco (ID: `place:Damascus`); Hesbom (ID: `place:Heshbon`); Libano (ID: `place:Lebanon`); Apple (ID: `flora:AppleTree`); Tower (ID: `realia:Tower`); Wheat (ID: `flora:Wheat`); Gazelle (ID: `fauna:Gazelle`); Lily (ID: `flora:Lily`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** Bate-Rabim (ID: `place:Bath-rabbim`); Carmelo (ID: `place:Carmel`); Hesbom (ID: `place:Heshbon`); Damasco (ID: `place:Damascus`); Libano (ID: `place:Lebanon`); Tower (ID: `realia:Tower`); Wine (ID: `realia:Wine`); Wheat (ID: `flora:Wheat`); Gazelle (ID: `fauna:Gazelle`); Lily (ID: `flora:Lily`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); love (ID: `keyterm:Love`); swear (ID: `keyterm:Swear`); Wine (ID: `realia:Wine`); Pomegranate (ID: `flora:Pomegranate`); Vine (ID: `flora:Vine`); Must (ID: `realia:Must`); House (ID: `realia:House`)
