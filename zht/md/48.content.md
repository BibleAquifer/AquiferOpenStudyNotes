...
* **Associated ACAI Concepts:** James (ID: `person:James.3`); Barnabas (ID: `person:Barnabas`); Titus (ID: `person:Titus`); Rescue (ID: `keyterm:Rescue`); Hypocrisy (ID: `keyterm:Hypocrisy`); Galatia (ID: `place:Galatia`); Behavior (ID: `keyterm:Behavior`); Antioch (ID: `place:Antioch`); Arabia (ID: `place:Arabia`); Persuade (ID: `keyterm:Persuade`); Good News (ID: `keyterm:GoodNews`); Gentiles (ID: `group:Gentile`); Peter (ID: `person:Peter`); Favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); LORD (ID: `deity:Lord`)
## 加拉太書 1:2 (id: 671026)
...
* **Associated ACAI Concepts:** James (ID: `person:James.3`); Barnabas (ID: `person:Barnabas`); Titus (ID: `person:Titus`); Hypocrisy (ID: `keyterm:Hypocrisy`); Behavior (ID: `keyterm:Behavior`); Antioch (ID: `place:Antioch`); Arabia (ID: `place:Arabia`); Gentiles (ID: `group:Gentile`); Good News (ID: `keyterm:GoodNews`); Peter (ID: `person:Peter`); Jesus (ID: `person:Jesus.2`); LORD (ID: `deity:Lord`)
## 加拉太書 1:12 (id: 671014)
...
* **Associated ACAI Concepts:** James (ID: `person:James.3`); Arabia (ID: `place:Arabia`)
## 加拉太書 1:17 (id: 671019)
...
* **Associated ACAI Concepts:** Law (ID: `keyterm:Law`); Galatians (ID: `group:Galatia`); Be Enslaved (ID: `keyterm:Serve.2`); Enslavement (ID: `keyterm:Slavery`); In Christ (ID: `keyterm:InChrist`); Fundamental Principles (ID: `keyterm:FundamentalPrinciples`); Hagar (ID: `person:Hagar`); Mount Sinai (ID: `place:SinaiMount`); Circumcision (ID: `keyterm:Circumcision`); Promise (ID: `keyterm:Promise`); Believe (ID: `keyterm:Believe`); Abraham (ID: `person:Abraham`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Holy Spirit (ID: `deity:HolySpirit`); Body (ID: `keyterm:Body.3`); Jesus (ID: `person:Jesus.2`); LORD (ID: `deity:Lord`)
## 加拉太書 3:2 (id: 671092)
...
* **Associated ACAI Concepts:** In Christ (ID: `keyterm:InChrist`); Law (ID: `keyterm:Law`); Jesus (ID: `person:Jesus.2`)
## 加拉太書 3:24 (id: 671085)
...
* **Associated ACAI Concepts:** Enslavement (ID: `keyterm:Slavery`); Mount Sinai (ID: `place:SinaiMount`)
...
* **Associated ACAI Concepts:** Good (ID: `keyterm:Good`); Resentment (ID: `keyterm:Resentment`); Share (ID: `keyterm:Share`); Live (ID: `keyterm:Live.3`); Holy Spirit (ID: `deity:HolySpirit`); Body (ID: `keyterm:Body.3`)
## 加拉太書 5:14 (id: 671134)
...
* **Associated ACAI Concepts:** Resentment (ID: `keyterm:Resentment`); Live (ID: `keyterm:Live.3`); Good (ID: `keyterm:Good`); Holy Spirit (ID: `deity:HolySpirit`)
## 加拉太書 5:17 (id: 671137)
