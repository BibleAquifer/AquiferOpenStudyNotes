...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); إِلَى (ID: `person:Apphia`); إِلَى (ID: `person:Philemon`); لِأَرْخِبّسَ (ID: `person:Archippus`); Make Peace (ID: `keyterm:Peace`); Favor (ID: `keyterm:Favor`); بولسَ (ID: `person:Paul`); تِيموثَاوس (ID: `person:Timothy`); Church (ID: `keyterm:Church`); Beloved (ID: `keyterm:Beloved`); ٱلرَّبِّ (ID: `deity:Lord`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Holy (ID: `keyterm:Holy`); Believe (ID: `keyterm:Believe`); يَسوع (ID: `person:Jesus.2`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Fellowship (ID: `keyterm:Fellowship`); Ask for (ID: `keyterm:AskFor`); ٱلرَّبِّ (ID: `deity:Lord`); Pray (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); Affection (ID: `keyterm:Affection`)
