...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); berbahagialah (ID: `keyterm:Happy`); mencobai (ID: `keyterm:PutToTheTest`); kekasih (ID: `keyterm:Beloved`); sia, sia (ID: `keyterm:Worthless`); tahan uji (ID: `keyterm:Approved`); suci (ID: `keyterm:Clean`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); tak bernoda (ID: `keyterm:AboveCriticism`); janji (ID: `keyterm:Promise`); berbuat dosa (ID: `keyterm:Sin`); tidak dicemarkan (ID: `keyterm:Undefiled`); hati (ID: `keyterm:Heart`); keahlian (ID: `keyterm:Ability`); tidak dapat dicobai (ID: `keyterm:NotTempted`); kehidupan (ID: `keyterm:Life`); hukum (ID: `keyterm:Law`); yang baik (ID: `keyterm:Good`); keselamatan (ID: `keyterm:Salvation`); kasihi (ID: `keyterm:Love`); kebenaran (ID: `keyterm:Truth`); A Person (ID: `person:GenericPerson`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** suci (ID: `keyterm:Clean`); sia, sia (ID: `keyterm:Worthless`); tidak dicemarkan (ID: `keyterm:Undefiled`); tak bernoda (ID: `keyterm:AboveCriticism`); Tuhan (ID: `deity:Lord`); hati (ID: `keyterm:Heart`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); tonton bulu atau muka (ID: `keyterm:Partiality`); percaya (ID: `keyterm:Believe`); bimbang (ID: `keyterm:Discern`); kemuliaan (ID: `keyterm:Glory`); Yesus (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`); Footstool (ID: `realia:Footstool`)
...
* **Associated ACAI Concepts:** orang pilihan (ID: `keyterm:Chosen`); percaya (ID: `keyterm:Believe`); janji (ID: `keyterm:Promise`); kekasih (ID: `keyterm:Beloved`); kerajaan (ID: `keyterm:Kingdom`); Tuhan (ID: `deity:Lord`); kasihi (ID: `keyterm:Love`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); tonton bulu atau muka (ID: `keyterm:Partiality`); penghakiman (ID: `keyterm:Judgment`); tersandung (ID: `keyterm:Stumble`); berbuat dosa (ID: `keyterm:Sin`); persundalan (ID: `keyterm:Fornication`); belas kasihan (ID: `keyterm:Mercy`); pengadilan (ID: `keyterm:CourtCase`); kasihi (ID: `keyterm:Love`); kitab suci (ID: `keyterm:Scripture`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`); memutuskan (ID: `keyterm:Decided`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Tuhan (ID: `deity:Lord`); tubuh (ID: `keyterm:Body.3`); Abraham (ID: `person:Abraham`); A Person (ID: `person:GenericPerson`); sia, sia (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); menggenapi (ID: `keyterm:Happen`); Ishak (ID: `person:Isaac`); memperdamaikan (ID: `keyterm:Peace`); keselamatan (ID: `keyterm:Salvation`); hampa (ID: `keyterm:Empty`); kitab suci (ID: `keyterm:Scripture`); Demons (ID: `deity:Demons`); roh (ID: `keyterm:Spirit.2`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); sia, sia (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); menggenapi (ID: `keyterm:Happen`); Tuhan (ID: `deity:Lord`); Ishak (ID: `person:Isaac`); tubuh (ID: `keyterm:Body.3`); hampa (ID: `keyterm:Empty`); kitab suci (ID: `keyterm:Scripture`); roh (ID: `keyterm:Spirit.2`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); percaya (ID: `keyterm:Believe`); menggenapi (ID: `keyterm:Happen`); Tuhan (ID: `deity:Lord`); kitab suci (ID: `keyterm:Scripture`); Abraham (ID: `person:Abraham`)
...
* **Associated ACAI Concepts:** tubuh (ID: `keyterm:Body.3`); keahlian (ID: `keyterm:Ability`); neraka (ID: `keyterm:Gehenna`); Hell (ID: `place:Hell`); lalim (ID: `keyterm:UnjustDeed`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); tidak setia (ID: `keyterm:Unfaithful`); persahabatan (ID: `keyterm:Friendship`); murni (ID: `keyterm:Pure`); membersihkan (ID: `keyterm:Cleanse.2`); ingin (ID: `keyterm:LongFor`); kebaikan (ID: `keyterm:Favor`); keahlian (ID: `keyterm:Ability`); hati (ID: `keyterm:Heart`); kitab suci (ID: `keyterm:Scripture`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Roh (ID: `deity:HolySpirit`); roh (ID: `keyterm:Spirit.2`)
...
* **Associated ACAI Concepts:** menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Tuhan (ID: `deity:Lord`); menentang (ID: `keyterm:Condemn`); tubuh (ID: `keyterm:Body.3`); hati (ID: `keyterm:Heart`); bersaksi (ID: `keyterm:BearWitness`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** diurapi (ID: `keyterm:Anointed`); nama (ID: `keyterm:Name`); Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`); jemaat (ID: `keyterm:Church`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** berbuat dosa (ID: `keyterm:Sin`); percaya (ID: `keyterm:Believe`); mengampuni (ID: `keyterm:Forgive`); Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`); keselamatan (ID: `keyterm:Salvation`)
