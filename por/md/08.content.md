...
* **Associated ACAI Concepts:** Moabe (ID: `place:Moab`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Belém (ID: `place:Bethlehem`)
...
* **Associated ACAI Concepts:** Efrata (ID: `person:Ephrathah`); Ephrathites (ID: `group:Ephrathah`); Noemi (ID: `person:Naomi`); Quiliom (ID: `person:Chilion`); Judá (ID: `group:Judah`); Elimeleque (ID: `person:Elimelech`); Belém (ID: `place:Bethlehem`); Moabe (ID: `place:Moab`); Malom (ID: `person:Mahlon`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); to cause to possess (ID: `keyterm:Possess`); Boaz (ID: `person:Boaz`); Noemi (ID: `person:Naomi`); Moabe (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Moabe (ID: `place:Moab`); to cause to possess (ID: `keyterm:Possess`); Malom (ID: `person:Mahlon`); Rute (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); Lia (ID: `person:Leah`); Belém (ID: `place:Bethlehem`); Israel (ID: `person:Israel`); Raquel (ID: `person:Rachel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Tamar (ID: `person:Tamar`); Perez (ID: `person:Perez`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); bless (ID: `keyterm:Bless`); SENHOR (ID: `deity:Lord`); Noemi (ID: `person:Naomi`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Hezrom (ID: `person:Hezron.2`); Salmom (ID: `person:Salmon`); Obede (ID: `person:Obed`); Aminadabe (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Boaz (ID: `person:Boaz`); Naassom (ID: `person:Nahshon`); Perez (ID: `person:Perez`); Davi (ID: `person:David`); Jessé (ID: `person:Jesse`)
