...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); amado (ID: `keyterm:Beloved`); Truth (ID: `keyterm:Truth`); SENHOR (ID: `deity:Lord`); igreja (ID: `keyterm:Church`); Faithfulness (ID: `keyterm:Faithfulness`); dever (ID: `keyterm:Ought`); Name (ID: `keyterm:Name`); testemunhar (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** igreja (ID: `keyterm:Church`); Diótrefes (ID: `person:Diotrephes`); Demétrio (ID: `person:Demetrius`); Good (ID: `keyterm:Good`); amado (ID: `keyterm:Beloved`); verdadeiro (ID: `keyterm:True`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); Do Good (ID: `keyterm:DoGood`); testemunhar (ID: `keyterm:BearWitness`)
