...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Zealous (ID: `keyterm:Zealous.3`); strength (ID: `keyterm:Strength`); Libano (ID: `place:Lebanon`); Basã (ID: `place:Bashan`); Carmelo (ID: `place:Carmel`); pronounce innocent (ID: `keyterm:PronounceInnocent`); The Way (ID: `keyterm:TheWay`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Zealous (ID: `keyterm:Zealous.3`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); strength (ID: `keyterm:Strength`); Libano (ID: `place:Lebanon`); Basã (ID: `place:Bashan`); Carmelo (ID: `place:Carmel`); pronounce innocent (ID: `keyterm:PronounceInnocent`); wickedness (ID: `keyterm:Wickedness`); The Way (ID: `keyterm:TheWay`); Strong Drink (ID: `realia:StrongDrink`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); make a vow (ID: `keyterm:Vow`); peace (ID: `keyterm:IntactState`); wickedness (ID: `keyterm:Wickedness`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); SENHOR (ID: `deity:Lord`); Grass (ID: `flora:Grass`); Goat (ID: `fauna:Goat`); Chariot (ID: `realia:Chariot`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Cush (ID: `place:Cush.2`); Líbia (ID: `place:Libya`); Pute (ID: `place:Put`); lot (ID: `keyterm:Lot`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Egito (ID: `place:Egypt`)
