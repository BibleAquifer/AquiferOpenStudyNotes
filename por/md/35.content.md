...
* **Associated ACAI Concepts:** Chaldeans (ID: `group:Chaldea`); fear (ID: `keyterm:Fear`); dispossess (ID: `keyterm:Dispossess`); Caldéia (ID: `place:Chaldea`); strength (ID: `keyterm:Strength`); Believe In (ID: `keyterm:BelieveIn`); SENHOR (ID: `deity:Lord`); Wolf (ID: `fauna:Wolf`); Leopard (ID: `fauna:Leopard`); Horse (ID: `fauna:Horse`); Vulture (ID: `fauna:Vulture`)
...
* **Associated ACAI Concepts:** Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Casting Net (ID: `realia:CastingNet`); holy (ID: `keyterm:Holy`); pure (ID: `keyterm:Pure`); SENHOR (ID: `deity:Lord`); Fortification (ID: `realia:Fortification`); Lizard (ID: `fauna:Lizard`); Chameleon (ID: `fauna:Chameleon`); Harpoon (ID: `realia:Harpoon`); Monitor (ID: `fauna:Iguana`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** Hell (ID: `place:Hell`); SENHOR (ID: `deity:Lord`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Tablet (ID: `realia:Tablet`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); literally: nought (ID: `keyterm:Idol`); Be Disgraced (ID: `keyterm:Disgraced`); Hell (ID: `place:Hell`); saying (ID: `keyterm:Saying`); lean on (ID: `keyterm:LeanOn`); Libano (ID: `place:Lebanon`); Vine (ID: `flora:Vine`); Beam (ID: `realia:Beam`); Image (ID: `realia:Image`); Wine (ID: `realia:Wine`); Tablet (ID: `realia:Tablet`); Graven Image (ID: `realia:GravenImage`); Molten Image (ID: `realia:MoltenImage`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); Glory (ID: `keyterm:Glory`); Be Disgraced (ID: `keyterm:Disgraced`); Libano (ID: `place:Lebanon`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** literally: nought (ID: `keyterm:Idol`); Woe (ID: `keyterm:Woe.2`); lean on (ID: `keyterm:LeanOn`); SENHOR (ID: `deity:Lord`); Image (ID: `realia:Image`); Graven Image (ID: `realia:GravenImage`); Molten Image (ID: `realia:MoltenImage`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); Monte Paran (ID: `place:ParanMount`); Temã (ID: `place:Teman`); Cusã (ID: `place:Cushan`); Midiã (ID: `place:Midian`); arrow (ID: `keyterm:Arrow`); holy (ID: `keyterm:Holy`); mischief (ID: `keyterm:Mischief`); anointed (ID: `keyterm:Anointed`); Oath (ID: `keyterm:Oath`); majesty (ID: `keyterm:Majesty`); SENHOR (ID: `deity:Lord`); Tent (ID: `realia:Tent`); Spear (ID: `realia:Spear`); Bow (ID: `realia:Bow`); Foundation (ID: `realia:Foundation`); Chariot (ID: `realia:Chariot`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); arrow (ID: `keyterm:Arrow`); SENHOR (ID: `deity:Lord`); anointed (ID: `keyterm:Anointed`); Oath (ID: `keyterm:Oath`); Foundation (ID: `realia:Foundation`); Chariot (ID: `realia:Chariot`); Spear (ID: `realia:Spear`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); salvation (ID: `keyterm:Salvation`); Goat (ID: `fauna:Goat`); Fig (ID: `flora:Fig`); Vine (ID: `flora:Vine`); Cattle (ID: `fauna:Bull`); Sheepfold (ID: `realia:Sheepfold`); Flock (ID: `fauna:Flock`); Olive Tree (ID: `flora:OliveTree`); Animal Pen (ID: `realia:AnimalPen`)
