...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Jerusalém (ID: `place:Jerusalem`); evil intention (ID: `keyterm:Intention`); SENHOR (ID: `deity:Lord`); he who lacks heart (ID: `keyterm:Stupid`); Vine (ID: `flora:Vine`); Israel (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Cattle (ID: `fauna:Bull`); Flock (ID: `fauna:Flock`); Money (ID: `realia:Money`); Wine (ID: `realia:Wine`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); Vine (ID: `flora:Vine`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Flock (ID: `fauna:Flock`); Money (ID: `realia:Money`); Wine (ID: `realia:Wine`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Cattle (ID: `fauna:Bull`); Vine (ID: `flora:Vine`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Flock (ID: `fauna:Flock`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); he who lacks heart (ID: `keyterm:Stupid`); make a vow (ID: `keyterm:Vow`); House (ID: `realia:House`); A Man (ID: `person:GenericMale`); slaughtering (ID: `keyterm:Slaughtering`); An Angel (ID: `deity:Angel`); strength (ID: `keyterm:Strength`); ardour (ID: `keyterm:Ardour`); fear (ID: `keyterm:Fear`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** he who lacks heart (ID: `keyterm:Stupid`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); evil intention (ID: `keyterm:Intention`); to act wickedly (ID: `keyterm:ActWickedly`); to cause to possess (ID: `keyterm:Possess`); To Sin (ID: `keyterm:Sin`); fear (ID: `keyterm:Fear`); Anointing Oil (ID: `realia:AnointingOil`); Cooking Pot (ID: `realia:CookingPot`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); perceive (ID: `keyterm:Perceive`); favor (ID: `keyterm:Favor`); Oath (ID: `keyterm:Oath`); swear (ID: `keyterm:Swear`); To Sin (ID: `keyterm:Sin`); Safety (ID: `keyterm:Safety`); Hell (ID: `place:Hell`); pure (ID: `keyterm:Pure`); evil intention (ID: `keyterm:Intention`); defilement (ID: `keyterm:Defilement`); strength (ID: `keyterm:Strength`); ardour (ID: `keyterm:Ardour`); Wine (ID: `realia:Wine`); Lion (ID: `fauna:Lion`); Anointing Oil (ID: `realia:AnointingOil`); Vine (ID: `flora:Vine`); Fishnet (ID: `realia:Fishnet`); Net (ID: `realia:Net`); Fish (ID: `fauna:Fish`); Dog (ID: `fauna:Dog`); Olive Oil (ID: `realia:OliveOil`); Bird (ID: `fauna:Bird`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); strength (ID: `keyterm:Strength`); love (ID: `keyterm:Love`); evil intention (ID: `keyterm:Intention`); Hell (ID: `place:Hell`); Anointing Oil (ID: `realia:AnointingOil`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); evil intention (ID: `keyterm:Intention`); strength (ID: `keyterm:Strength`); Hell (ID: `place:Hell`)
...
* **Associated ACAI Concepts:** he who lacks heart (ID: `keyterm:Stupid`); Vine (ID: `flora:Vine`); House (ID: `realia:House`); Money (ID: `realia:Money`); Wine (ID: `realia:Wine`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Caper (ID: `flora:Caper`); Bird (ID: `fauna:Bird`); Pit (ID: `realia:Pit`); Money (ID: `realia:Money`); Rope (ID: `realia:Rope`); Almond (ID: `flora:Almond`); Clay Jar (ID: `realia:ClayJar`); Locust (ID: `fauna:Locust`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); fear (ID: `keyterm:Fear`); evil intention (ID: `keyterm:Intention`); saying (ID: `keyterm:Saying`); straightness (ID: `keyterm:Straightness`); Goad (ID: `realia:Goad`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Scroll (ID: `realia:Scroll`); Nail (ID: `realia:Nail`); Goat (ID: `fauna:Goat`)
