...
* **Associated ACAI Concepts:** Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); lot (ID: `keyterm:Lot`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); José (ID: `person:Joseph.10`); Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`); dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** José (ID: `person:Joseph.10`); Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** dispossess (ID: `keyterm:Dispossess`); Neguebe (ID: `place:Negeb`); Gileade (ID: `place:Gilead`); Efraim (ID: `person:Ephraim`); Sarepta (ID: `place:Zarephath`); Canaã (ID: `place:Canaan`); Jerusalém (ID: `place:Jerusalem`); Samaria (ID: `place:Samaria`); Efraim (ID: `group:Ephraim`); Sardes (ID: `place:Sardis`); cananeu (ID: `group:Canaan`); Monte de Esaú (ID: `place:EsauMount`); Benjamim (ID: `person:Benjamin`); Filisteu (ID: `group:Philistine`); Israel (ID: `person:Israel`); Sefalá (ID: `place:Shephelah`); Filístia (ID: `place:Philistine`); Benjamim (ID: `group:Benjamin`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Monte de Esaú (ID: `place:EsauMount`); Jerusalém (ID: `place:Jerusalem`); Efraim (ID: `person:Ephraim`); Sardes (ID: `place:Sardis`); Filisteu (ID: `group:Philistine`); Sefalá (ID: `place:Shephelah`); Benjamim (ID: `group:Benjamin`); Benjamim (ID: `person:Benjamin`); Efraim (ID: `group:Ephraim`); Samaria (ID: `place:Samaria`); Filístia (ID: `place:Philistine`); Israel (ID: `person:Israel`); Canaã (ID: `place:Canaan`); cananeu (ID: `group:Canaan`); Sarepta (ID: `place:Zarephath`); Gileade (ID: `place:Gilead`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Sarepta (ID: `place:Zarephath`); Canaã (ID: `place:Canaan`); Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Sardes (ID: `place:Sardis`); Israel (ID: `person:Israel`); cananeu (ID: `group:Canaan`); Jerusalém (ID: `place:Jerusalem`)
