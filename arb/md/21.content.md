...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Intention (ID: `keyterm:Intention`); أورشَلِيمَ (ID: `place:Jerusalem`); Stupid (ID: `keyterm:Stupid`); ٱلرَّبِّ (ID: `deity:Lord`); Vine (ID: `flora:Vine`); To Sin (ID: `keyterm:Sin`); إِسْرَائِيلَ (ID: `person:Israel`); Sandalwood (ID: `flora:Sandalwood`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); أورشَلِيمَ (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); Sandalwood (ID: `flora:Sandalwood`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Sandalwood (ID: `flora:Sandalwood`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); Ability (ID: `keyterm:Ability`); ٱلرَّبِّ (ID: `deity:Lord`); Intention (ID: `keyterm:Intention`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vow (ID: `keyterm:Vow`); House (ID: `realia:House`); A Man (ID: `person:GenericMale`); Slaughtering (ID: `keyterm:Slaughtering`); Passion (ID: `keyterm:Ardour`); Fear (ID: `keyterm:Fear`); Strength (ID: `keyterm:Strength`); An Angel (ID: `deity:Angel`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Stupid (ID: `keyterm:Stupid`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); To Act Wickedly (ID: `keyterm:ActWickedly`); Fear (ID: `keyterm:Fear`); To Cause to Possess (ID: `keyterm:Possess`); Intention (ID: `keyterm:Intention`); To Sin (ID: `keyterm:Sin`); Brier (ID: `flora:Brier`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Cooking Pot (ID: `realia:CookingPot`)
...
* **Associated ACAI Concepts:** Strength (ID: `keyterm:Strength`); Love (ID: `keyterm:Love`); Ability (ID: `keyterm:Ability`); Intention (ID: `keyterm:Intention`); ٱلرَّبِّ (ID: `deity:Lord`); Hell (ID: `place:Hell`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); ٱلرَّبِّ (ID: `deity:Lord`); Caper (ID: `flora:Caper`); Clay Jar (ID: `realia:ClayJar`); Money (ID: `realia:Money`); Pit (ID: `realia:Pit`); Locust (ID: `fauna:Locust`); Bird (ID: `fauna:Bird`); Almond (ID: `flora:Almond`); Rope (ID: `realia:Rope`)
