...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); فَارِسَ (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); Money (ID: `realia:Money`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `person:Benjamin`); لَّاوِي (ID: `person:Levi.3`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `group:Levi`); Money (ID: `realia:Money`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath`); كورَشَ (ID: `person:Cyrus`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); سلَيْمَانَ (ID: `person:Solomon`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Tel-melah (ID: `place:Tel-melah`); نَقودَا (ID: `person:Nekoda.2`); آطِيرَ (ID: `person:Ater.2`); لِإِيمِيرَ (ID: `person:Immer.2`); رَآيَا (ID: `person:Reaiah.3`); كَروب (ID: `place:Cherub`); جَدِّيلَ (ID: `person:Giddel.2`); بَعْنَةَ (ID: `person:Baanah.3`); لِدَلَايَا (ID: `person:Delaiah.3`); زَكَّايَ (ID: `person:Zaccai.2`); جَزَّامَ (ID: `person:Gazzam`); سَوْطَايَ (ID: `person:Sotai`); رَحوم (ID: `person:Rehum`); عَادِينَ (ID: `person:Adin`); ثَامَحَ (ID: `person:Temah`); حَبَايَا (ID: `person:Habaiah`); نَبو (ID: `place:Nebo.2`); آرَحَ (ID: `person:Arah.2`); مِسْفَار (ID: `person:Mispar`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); حَقوفَا (ID: `person:Hakupha`); لَبَانَةَ (ID: `person:Lebanah`); قِيروسَ (ID: `person:Keros`); حَزَقِيَّا (ID: `person:Hezekiah.2`)
...
* **Associated ACAI Concepts:** بِلْشَان (ID: `person:Bilshan`); مِسْفَار (ID: `person:Mispar`); رَعْلَايَا (ID: `person:Reelaiah`); سَرَايَا (ID: `person:Seraiah.6`); رَحوم (ID: `person:Rehum`); بِغْوَايَ (ID: `person:Bigvai`); بَعْنَةَ (ID: `person:Baanah.3`); نَحَمْيَا (ID: `person:Nehemiah`); مرْدَخَاي (ID: `person:Mordecai`); زَربَّابِل (ID: `person:Zerubbabel.2`); إِسْرَائِيلَ (ID: `person:Israel`); يَشوع (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** زَتّو (ID: `person:Zattu.2`); شَفَطْيَا (ID: `person:Shephatiah.6`); آطِيرَ (ID: `person:Ater`); يورَةَ (ID: `person:Jorah`); يوآب (ID: `person:Joab.3`); أَدونِيقَامَ (ID: `person:Adonikam`); بِغْوَايَ (ID: `person:Bigvai.2`); فَرْعوشَ (ID: `person:Parosh`); يَشوعَ (ID: `person:Jeshua.3`); زَكَّايَ (ID: `person:Zaccai.2`); بِيصَايَ (ID: `person:Bezai`); حَشوم (ID: `person:Hashum`); عَادِينَ (ID: `person:Adin`); بَانِيَ (ID: `person:Bani`); آرَحَ (ID: `person:Arah.2`); عَرْجَدَ (ID: `person:Azgad`); Pahath-moab (ID: `person:Pahath-moab`); عِيلَامَ (ID: `person:Elam`); حَزَقِيَّا (ID: `person:Hezekiah.2`); بَابَايَ (ID: `person:Bebai`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** مَغْبِيشَ (ID: `place:Magbish`); Beth-azmaveth (ID: `place:Beth-azmaveth`); سَنَاءَةَ (ID: `place:Senaah`); حَارِيمَ (ID: `person:Harim.2`); حَادِيدَ (ID: `place:Hadid`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); نَبو (ID: `place:Nebo.2`); ٱلْكَفِيرَة (ID: `place:Chephirah`); مِنْ (ID: `place:Geba`); عَنَاثوثَ (ID: `place:Anathoth`); عَايٍ (ID: `place:Ai`); لَحْمٍ (ID: `place:Bethlehem`); Kiriath-jearim (ID: `place:Kiriath-jearim`); أَرِيحَا (ID: `place:Jericho`); وَلودَ (ID: `place:Lod`); Bethel (ID: `place:Bethel`); عِيلَامَ (ID: `person:Elam`); مِخْمَاسَ (ID: `place:Michmash`); بَئِيروت (ID: `place:Beeroth`); أونوَ (ID: `place:Ono`); Ramah (ID: `place:Ramah.2`)
...
* **Associated ACAI Concepts:** حَارِيمَ (ID: `person:Harim`); يَشوعَ (ID: `person:Jeshua`); يَدَايَا (ID: `person:Jedaiah.4`); شوبَايَ (ID: `person:Shobai`); يَشوعَ (ID: `person:Jeshua.4`); آطِيرَ (ID: `person:Ater.2`); لِإِيمِيرَ (ID: `person:Immer.2`); حَطِيطَا (ID: `person:Hatita`); طَلْمون (ID: `person:Talmon`); هودَوْيَا (ID: `person:Hodaviah.4`); عَقّوب (ID: `person:Akkub.2`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); آسَاف (ID: `person:Asaph.2`); لَّاوِي (ID: `person:Levi.3`); شَلّوم (ID: `person:Shallum.8`); فَشْحور (ID: `person:Pashhur`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** شوبَايَ (ID: `person:Shobai`); آطِيرَ (ID: `person:Ater.2`); حَطِيطَا (ID: `person:Hatita`); طَلْمون (ID: `person:Talmon`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`); شَلّوم (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** حَطِيفَا (ID: `person:Hatipha`); حَرْحورَ (ID: `person:Harhur`); أَسْنَةَ (ID: `person:Asnah`); نَصِيحَ (ID: `person:Neziah`); رَآيَا (ID: `person:Reaiah.3`); طَبَاعوتَ (ID: `person:Tabbaoth`); جَاحَرَ (ID: `person:Gahar`); فِي (ID: `person:Uzza.2`); سِيسَرَا (ID: `person:Sisera.2`); سِيعَهَا (ID: `person:Siaha`); حَسوفَا (ID: `person:Hasupha`); رَصِينَ (ID: `person:Rezin.2`); بَرْقوسَ (ID: `person:Barkos`); حَجَابَةَ (ID: `person:Hagabah`); صِيحَا (ID: `person:Ziha`); بَقْبوقَ (ID: `person:Bakbuk`); مَحِيدَا (ID: `person:Mehida`); جَزَّامَ (ID: `person:Gazzam`); حَرْشَا (ID: `person:Harsha`); سَلْمَايَ (ID: `person:Shalmai`); حَانَان (ID: `person:Hanan.4`); Meunim (ID: `group:Meunim`); ثَامَحَ (ID: `person:Temah`); Nephushesim (ID: `group:Nephushesim`); حَقوفَا (ID: `person:Hakupha`); فَاسِيحَ (ID: `person:Paseah.2`); لَبَانَةَ (ID: `person:Lebanah`); حَاجَابَ (ID: `person:Hagab`); قِيروسَ (ID: `person:Keros`); نَقودَا (ID: `person:Nekoda`); بَصْلوتَ (ID: `person:Bazluth`); بِيسَايَ (ID: `person:Besai`); جَدِّيلَ (ID: `person:Giddel`); فَادونَ (ID: `person:Padon`); عَقّوب (ID: `person:Akkub.3`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); سَوْطَايَ (ID: `person:Sotai`); آمِي (ID: `person:Ami`); جَدِّيلَ (ID: `person:Giddel.2`); حَطِّيلَ (ID: `person:Hattil`); سوفَرَثَ (ID: `person:Sophereth`); شَفَطْيَا (ID: `person:Shephatiah.7`); يَعْلَةَ (ID: `person:Jaalah`); فَرودَا (ID: `person:Peruda`); دَرْقونَ (ID: `person:Darkon`)
...
* **Associated ACAI Concepts:** كَروب (ID: `place:Cherub`); لِدَلَايَا (ID: `person:Delaiah.3`); أَدَّان (ID: `place:Addan`); Tel-melah (ID: `place:Tel-melah`); نَقودَا (ID: `person:Nekoda.2`); لِإِيمِيرَ (ID: `place:Immer`); Tel-harsha (ID: `place:Tel-harsha`); طوبِيَّا (ID: `person:Tobiah`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** هَقّوصَ (ID: `person:Hakkoz.2`); حَبَايَا (ID: `person:Habaiah`); بَرْزِلَّايَ (ID: `person:Barzillai.3`); بَرْزِلَّايَ (ID: `person:Barzillai`); Defile (ID: `keyterm:Stain`); Priesthood (ID: `keyterm:Priesthood`); جِلْعَادَ (ID: `place:Gilead`); Gileadites (ID: `group:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); أورشَلِيمَ (ID: `place:Jerusalem`); Strength (ID: `keyterm:Strength`); ٱلرَّبِّ (ID: `deity:Lord`); Tunic (ID: `realia:Tunic`); House (ID: `realia:House`); Money (ID: `realia:Money`); Mina (ID: `realia:Mina`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); يَشوع (ID: `person:Joshua.5`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); حِينَادَادَ (ID: `person:Henadad`); يَشوعَ (ID: `person:Jeshua.4`); Esarhaddon (ID: `person:Esarhaddon`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); Relatives (ID: `group:Relatives`); هودَوْيَا (ID: `person:Hodaviah.4`); New Moon Festival (ID: `keyterm:NewMoonFestival`); يَافَا (ID: `place:Joppa`); Sidonians (ID: `group:Sidon`); آسَاف (ID: `person:Asaph.2`); Assyria (ID: `place:Assyria`); Terror (ID: `keyterm:Terror`); Counsel (ID: `keyterm:Counsel`); صِيْدونَ (ID: `place:Sidon`); بَنْيَامِينَ (ID: `group:Benjamin`); بَنْيَامِينَ (ID: `person:Benjamin`); Instruction (ID: `keyterm:Instruction`); دَاودَ (ID: `person:David`); لبْنَانَ (ID: `place:Lebanon`); Tyrians (ID: `group:Tyre`); Kindness (ID: `keyterm:Kindness`); Holy (ID: `keyterm:Holy`); Appointed Feast (ID: `keyterm:AppointedFeast`); دَارِيوسَ (ID: `person:Darius.2`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); صورَ (ID: `place:Tyre`); هودِيَّا (ID: `person:Hodiah.2`); موسَى (ID: `person:Moses`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Cymbals (ID: `realia:Cymbals`); Trumpet (ID: `realia:Trumpet`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); إِسْرَائِيلَ (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); موسَى (ID: `person:Moses`); Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Terror (ID: `keyterm:Terror`); Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Holy (ID: `keyterm:Holy`); Appointed Feast (ID: `keyterm:AppointedFeast`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); Tyrians (ID: `group:Tyre`); صِيْدونَ (ID: `place:Sidon`); Sidonians (ID: `group:Sidon`); صورَ (ID: `place:Tyre`); يَافَا (ID: `place:Joppa`); فَارِسَ (ID: `place:Persia`); لبْنَانَ (ID: `place:Lebanon`); Cedar (ID: `flora:Cedar`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); يَشوع (ID: `person:Joshua.5`); لَّاوِي (ID: `person:Levi.3`); يَهوصَادِقَ (ID: `person:Jehozadak`); ٱلرَّبِّ (ID: `deity:Lord`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); لَّاوِي (ID: `group:Levi`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); آسَاف (ID: `person:Asaph.2`); لَّاوِي (ID: `person:Levi.3`); دَاودَ (ID: `person:David`); لَّاوِي (ID: `group:Levi`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `person:Benjamin`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); كورَشَ (ID: `person:Cyrus`); زَربَّابِل (ID: `person:Zerubbabel.2`); إِسْرَائِيلَ (ID: `person:Israel`); يَشوع (ID: `person:Joshua.5`); ٱلرَّبِّ (ID: `deity:Lord`); فَارِسَ (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); دَارِيوسَ (ID: `person:Darius.2`); Counsel (ID: `keyterm:Counsel`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); فَارِسَ (ID: `place:Persia`); Jews (ID: `group:Jews`); ٱلسَّامِرَةِ (ID: `place:Samaria`); أسْنَفَّر (ID: `person:Osnappar`); أَرَكَ (ID: `place:Erech`); بِشْلَام (ID: `person:Bishlam`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); مِثْرَدَاث (ID: `person:Mithredath.2`); طَبْئِيل (ID: `person:Tabeel`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); Babylonians (ID: `group:Babylon`); فِي (ID: `place:Susa`); Elamites (ID: `group:Elam`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); بَابِلَ (ID: `place:Babylon`); عِيلَامَ (ID: `place:Elam`); Persians (ID: `group:Persia`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** ٱلدِّينِيِّينَ (ID: `person:Dinaite`); شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); أَرَكَ (ID: `place:Erech`); Babylonians (ID: `group:Babylon`); فِي (ID: `place:Susa`); Persians (ID: `group:Persia`); بَابِلَ (ID: `place:Babylon`); Elamites (ID: `group:Elam`); فَارِسَ (ID: `place:Persia`); عِيلَامَ (ID: `place:Elam`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); ٱلسَّامِرَةِ (ID: `place:Samaria`); شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); أورشَلِيمَ (ID: `place:Jerusalem`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); دَارِيوسَ (ID: `person:Darius.2`); Jews (ID: `group:Jews`); Shethar-bozenai (ID: `person:Shethar-bozenai`); تَتْنَاي (ID: `person:Tattenai`); يَدّو (ID: `person:Iddo.6`); زَكَرِيَّا (ID: `person:Zechariah.17`); حَجَّيِ (ID: `person:Haggai`); ٱلْفرَاتِ (ID: `place:Euphrates`); زَربَّابِل (ID: `person:Zerubbabel.2`); إِسْرَائِيلَ (ID: `person:Israel`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَهوذَا (ID: `person:Judah.4`); فَارِسَ (ID: `place:Persia`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** يَدّو (ID: `person:Iddo.6`); زَكَرِيَّا (ID: `person:Zechariah.17`); حَجَّيِ (ID: `person:Haggai`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); Jews (ID: `group:Jews`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); أورشَلِيمَ (ID: `place:Jerusalem`); بَابِلَ (ID: `place:Babylon`); كورَشَ (ID: `person:Cyrus`); دَارِيوسَ (ID: `person:Darius.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); Shethar-bozenai (ID: `person:Shethar-bozenai`); تَتْنَاي (ID: `person:Tattenai`); ٱلْفرَاتِ (ID: `place:Euphrates`); Chaldeans (ID: `group:Chaldea`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); Foundation (ID: `realia:Foundation`); Hewn Stone (ID: `realia:HewnStone`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); كورَشَ (ID: `person:Cyrus`); زَربَّابِل (ID: `person:Zerubbabel.2`); بَابِلَ (ID: `place:Babylon`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); زَربَّابِل (ID: `person:Zerubbabel.2`); Foundation (ID: `realia:Foundation`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); Pure (ID: `keyterm:Pure`); Passover (ID: `keyterm:Passover`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Defilement (ID: `keyterm:Defilement`); Gentiles (ID: `group:Gentile`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); أَمَرْيَا (ID: `person:Amariah.2`); بقِّي (ID: `person:Bukki.2`); عَزَرْيَا (ID: `person:Azariah.6`); عَزَرْيَا (ID: `person:Azariah.7`); لِمَرَايوثَ (ID: `person:Meraioth`); شَلّوم (ID: `person:Shallum.7`); سَرَايَا (ID: `person:Seraiah.2`); زَرَحْيَا (ID: `person:Zerahiah`); أَبِيشوعَ (ID: `person:Abishua`); صَادوق (ID: `person:Zadok.4`); عزِّي (ID: `person:Uzzi`); أَخِيطوبَ (ID: `person:Ahitub.3`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); هَارون (ID: `person:Aaron`); فَارِسَ (ID: `place:Persia`); أَلِعَازَار (ID: `person:Eleazar.2`); حِلْقِيَّا (ID: `person:Hilkiah.2`); فِينَحَاس (ID: `person:Phinehas`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); بَابِلَ (ID: `place:Babylon`); Instruction (ID: `keyterm:Instruction`); موسَى (ID: `person:Moses`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); عَزْرَا (ID: `person:Ezra`); Wheat (ID: `flora:Wheat`); Kor (ID: `realia:Kor`); Olive Oil (ID: `realia:OliveOil`); Talent (ID: `realia:Talent`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** بَابَايَ (ID: `person:Bebai.2`); عَابِد (ID: `person:Ebed.2`); هِقَّاطَانَ (ID: `person:Hakkatan`); شَفَطْيَا (ID: `person:Shephatiah.6`); دَانِيآل (ID: `person:Daniel.2`); شِمْعِيَا (ID: `person:Shemaiah.14`); Gershom (ID: `person:Gershom.2`); يوشَفْيَا (ID: `person:Josiphiah`); أَدونِيقَامَ (ID: `person:Adonikam`); بِغْوَايَ (ID: `person:Bigvai.2`); زَكّور (ID: `person:Zaccur.5`); زَرَحْيَا (ID: `person:Zerahiah.2`); يوآب (ID: `person:Joab.4`); حَطّوش (ID: `person:Hattush.2`); فَرْعوشَ (ID: `person:Parosh.2`); زَبَدْيَا (ID: `person:Zebadiah.8`); عوبَدْيَا (ID: `person:Obadiah.10`); زَكَرِيَّا (ID: `person:Zechariah.18`); شَكَنْيَا (ID: `person:Shecaniah.6`); شَلومِيَةَ (ID: `person:Shelomith.4`); يَحْزِيئِيل (ID: `person:Jahaziel.5`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); يوحَانَانَ (ID: `person:Johanan.8`); يونَاثَانَ (ID: `person:Jonathan.9`); مِيخَائِيلَ (ID: `person:Michael.10`); يِشْعِيَا (ID: `person:Jeshaiah.4`); شَكَنْيَا (ID: `person:Shecaniah.5`); عَادِينَ (ID: `person:Adin`); زَكَرِيَّا (ID: `person:Zechariah.19`); يَحِيئِيل (ID: `person:Jehiel.7`); عَرْجَدَ (ID: `person:Azgad`); Pahath-moab (ID: `person:Pahath-moab`); عِيلَامَ (ID: `person:Elam`); عوتَاي (ID: `person:Uthai.2`); يَعِيئِيل (ID: `person:Jeuel.3`); أَلِيفَلَط (ID: `person:Eliphelet.5`); عَثَلْيَا (ID: `person:Athaliah.3`); بَابَايَ (ID: `person:Bebai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); بَابِلَ (ID: `place:Babylon`); دَاودَ (ID: `person:David`); إِيثَامَارَ (ID: `person:Ithamar`); فِينَحَاس (ID: `person:Phinehas`)
...
* **Associated ACAI Concepts:** أَرِيئِيلَ (ID: `person:Ariel`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); يَدّو (ID: `person:Iddo`); أَلِيعَزَرَ (ID: `person:Eliezer.8`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); نَاثَان (ID: `person:Nathan.5`); يويَارِيبَ (ID: `person:Joiarib.2`); شِمْعِيَا (ID: `person:Shemaiah.15`); زَكَرِيَّا (ID: `person:Zechariah.20`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); يَارِيبَ (ID: `person:Jarib.2`); ٱلْمسَمَّى (ID: `place:Casiphia`); مَشلَّام (ID: `person:Meshullam.9`); Perceive (ID: `keyterm:Perceive`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); مَحْلِي (ID: `person:Mahli`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `person:Levi.3`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `group:Levi`); Insight (ID: `keyterm:Insight`)
...
* **Associated ACAI Concepts:** دَاودَ (ID: `person:David`); لَّاوِي (ID: `person:Levi.3`); Work (ID: `keyterm:Work`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); Be Unfaithful (ID: `keyterm:Unfaithful`); مِصْرَ (ID: `place:Egypt`); Canaanites (ID: `group:Canaan`); Jebusites (ID: `group:Jebusites`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); Egyptians (ID: `group:Egypt`); لَّاوِي (ID: `person:Levi.3`); موآبَ (ID: `place:Moab`); Ammonites (ID: `group:Ammon`); كَنْعَان (ID: `place:Canaan`); حِثًّا (ID: `person:Heth`); لَّاوِي (ID: `group:Levi`); Amorites (ID: `group:Amorites`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Passion (ID: `keyterm:Ardour`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); Counsel (ID: `keyterm:Counsel`); عِيلَامَ (ID: `person:Elam`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Offering (ID: `keyterm:Offering`); أَمَرْيَا (ID: `person:Amariah.6`); يَهونَاثَان (ID: `person:Jehohanan.4`); أَلْيَاشِيب (ID: `person:Eliashib.4`); مَعْسِيَّا (ID: `person:Maaseiah.7`); شِمْعِيَا (ID: `person:Shemaiah.16`); جَدَلْيَا (ID: `person:Gedaliah`); إِيلِيَّا (ID: `person:Elijah.4`); أورِي (ID: `person:Uri.3`); عَبْدِي (ID: `person:Abdi.3`); شِمْعِيَا (ID: `person:Shemaiah.17`); مَكْنَدْبَاي (ID: `person:Machnadebai`); Kelaiah (ID: `person:Kelaiah`); عزِّيَّا (ID: `person:Uzziah.4`); يَعْسو (ID: `person:Jaasu`); شَلّوم (ID: `person:Shallum.11`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); Dispossess (ID: `keyterm:Dispossess`); إِسْرَائِيلَ (ID: `person:Israel`); Peace (ID: `keyterm:IntactState`); أورشَلِيمَ (ID: `place:Jerusalem`); Kindness (ID: `keyterm:Kindness`); Defilement (ID: `keyterm:Defilement`); فَارِسَ (ID: `place:Persia`); To Cause to Possess (ID: `keyterm:Possess`); Plea for Mercy (ID: `keyterm:Supplication`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); أورشَلِيمَ (ID: `place:Jerusalem`); Kindness (ID: `keyterm:Kindness`); فَارِسَ (ID: `place:Persia`); Plea for Mercy (ID: `keyterm:Supplication`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** يَحِيئِيل (ID: `person:Jehiel.8`); شَكَنْيَا (ID: `person:Shecaniah.7`); Be Unfaithful (ID: `keyterm:Unfaithful`); إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); عَزْرَا (ID: `person:Ezra`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Swear (ID: `keyterm:Swear`); لَّاوِي (ID: `person:Levi.3`); عَزْرَا (ID: `person:Ezra`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** تِقْوَةَ (ID: `person:Tikvah.2`); مَشلَّام (ID: `person:Meshullam.10`); يونَاثَانَ (ID: `person:Jonathan.10`); يَحْزِيَا (ID: `person:Jahzeiah`); عَسَائِيل (ID: `person:Asahel.4`); شَبْتَاي (ID: `person:Shabbethai`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`)
