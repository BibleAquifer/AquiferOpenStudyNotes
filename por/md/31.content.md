...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); lot (ID: `keyterm:Lot`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Edomites (ID: `group:Edom`); dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`); José (ID: `person:Joseph.10`); Edom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); José (ID: `person:Joseph.10`); SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Filisteu (ID: `group:Philistine`); Efraim (ID: `group:Ephraim`); Canaã (ID: `place:Canaan`); Samaria (ID: `place:Samaria`); Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `person:Benjamin`); Gileade (ID: `place:Gilead`); Sefalá (ID: `place:Shephelah`); Monte de Esaú (ID: `place:EsauMount`); Filístia (ID: `place:Philistine`); Benjamim (ID: `group:Benjamin`); Sarepta (ID: `place:Zarephath`); cananeu (ID: `group:Canaan`); Sardes (ID: `place:Sardis`); Efraim (ID: `person:Ephraim`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Monte de Esaú (ID: `place:EsauMount`); Samaria (ID: `place:Samaria`); Sefalá (ID: `place:Shephelah`); Benjamim (ID: `group:Benjamin`); Sarepta (ID: `place:Zarephath`); Sardes (ID: `place:Sardis`); Efraim (ID: `person:Ephraim`); Israel (ID: `person:Israel`); Canaã (ID: `place:Canaan`); Filisteu (ID: `group:Philistine`); Efraim (ID: `group:Ephraim`); Gileade (ID: `place:Gilead`); Filístia (ID: `place:Philistine`); SENHOR (ID: `deity:Lord`); cananeu (ID: `group:Canaan`); Benjamim (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** Canaã (ID: `place:Canaan`); Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`); Sarepta (ID: `place:Zarephath`); cananeu (ID: `group:Canaan`); Sardes (ID: `place:Sardis`); Israel (ID: `person:Israel`)
