...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); pronounce innocent (ID: `keyterm:PronounceInnocent`); The Way (ID: `keyterm:TheWay`); Zealous (ID: `keyterm:Zealous.3`); Libano (ID: `place:Lebanon`); Carmelo (ID: `place:Carmel`); Basã (ID: `place:Bashan`); strength (ID: `keyterm:Strength`)
...
* **Associated ACAI Concepts:** Pute (ID: `place:Put`); Cush (ID: `place:Cush.2`); lot (ID: `keyterm:Lot`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Líbia (ID: `place:Libya`); Egito (ID: `place:Egypt`)
