...
* **Associated ACAI Concepts:** Peace (ID: `keyterm:IntactState`); أَدومَ (ID: `place:Edom`); Covenant (ID: `keyterm:Covenant`); Understanding (ID: `keyterm:Understanding`); Edomites (ID: `group:Edom`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); Lot (ID: `keyterm:Lot`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); أَدومَ (ID: `place:Edom`); Dispossess (ID: `keyterm:Dispossess`); Edomites (ID: `group:Edom`); أورشَلِيمَ (ID: `place:Jerusalem`); يوسف (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** أَدومَ (ID: `place:Edom`); Edomites (ID: `group:Edom`); ٱلرَّبِّ (ID: `deity:Lord`); يوسف (ID: `person:Joseph.10`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); إِلَى (ID: `place:Zarephath`); عِيسو (ID: `place:EsauMount`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); ٱلسَّامِرَةِ (ID: `place:Samaria`); ٱلسَّهْلِ (ID: `place:Shephelah`); بَنْيَامِينَ (ID: `group:Benjamin`); كَنْعَان (ID: `place:Canaan`); أورشَلِيمَ (ID: `place:Jerusalem`); Canaanites (ID: `group:Canaan`); بَنْيَامِينَ (ID: `person:Benjamin`); فِلِشْتِيم (ID: `group:Philistine`); سَارْدِسَ (ID: `place:Sardis`); جِلْعَادَ (ID: `place:Gilead`); أَفْرَايِمَ (ID: `person:Ephraim`); أَفْرَايِمَ (ID: `group:Ephraim`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); عِيسو (ID: `place:EsauMount`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلسَّهْلِ (ID: `place:Shephelah`); فِلِشْتِيم (ID: `group:Philistine`); بَنْيَامِينَ (ID: `group:Benjamin`); كَنْعَان (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); بَنْيَامِينَ (ID: `person:Benjamin`); إِلَى (ID: `place:Zarephath`); جِلْعَادَ (ID: `place:Gilead`); أَفْرَايِمَ (ID: `person:Ephraim`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); سَارْدِسَ (ID: `place:Sardis`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); ٱلسَّامِرَةِ (ID: `place:Samaria`); أَفْرَايِمَ (ID: `group:Ephraim`)
...
* **Associated ACAI Concepts:** ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); كَنْعَان (ID: `place:Canaan`); أورشَلِيمَ (ID: `place:Jerusalem`); Canaanites (ID: `group:Canaan`); سَارْدِسَ (ID: `place:Sardis`); إِلَى (ID: `place:Zarephath`); إِسْرَائِيلَ (ID: `person:Israel`)
