...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); Hell (ID: `place:Hell`); make a vow (ID: `keyterm:Vow`); Amittai (ID: `person:Amittai`); Jope (ID: `place:Joppa`); Nínive (ID: `place:Nineveh`); slaughtering (ID: `keyterm:Slaughtering`); kindness (ID: `keyterm:Kindness`); salvation (ID: `keyterm:Salvation`); praise (ID: `keyterm:Praise`); Hebrews (ID: `group:Hebrews`); lot (ID: `keyterm:Lot`); Társis (ID: `place:Tarshish`); exempt (ID: `keyterm:Exempt`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Hell (ID: `place:Hell`); Jonas (ID: `person:Jonah.2`); kindness (ID: `keyterm:Kindness`); praise (ID: `keyterm:Praise`); make a vow (ID: `keyterm:Vow`); salvation (ID: `keyterm:Salvation`); Fish (ID: `fauna:Fish`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** kindness (ID: `keyterm:Kindness`); praise (ID: `keyterm:Praise`); make a vow (ID: `keyterm:Vow`); SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Nínive (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`); kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`); Believe In (ID: `keyterm:BelieveIn`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Clothing (ID: `realia:Clothing`); Throne (ID: `realia:Throne`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** gracious (ID: `keyterm:Generous`); Társis (ID: `place:Tarshish`); kindness (ID: `keyterm:Kindness`); Compassionate (ID: `keyterm:Compassionate`); SENHOR (ID: `deity:Lord`)
