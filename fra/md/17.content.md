...
* **Associated ACAI Concepts:** Cotton (ID: `flora:Cotton`); Linen (ID: `realia:Linen`); Bed (ID: `realia:Bed`); Purple Cloth (ID: `realia:PurpleCloth`); Money (ID: `realia:Money`); Rope (ID: `realia:Rope`)
...
* **Associated ACAI Concepts:** Biztha (ID: `person:Biztha`); Bigtha (ID: `person:Bigtha`); Mehuman (ID: `person:Mehuman`); Carcas (ID: `person:Carkas`); Zéthar (ID: `person:Zethar`); Abagtha (ID: `person:Abagtha`); Harbona (ID: `person:Harbona`); Assuérus (ID: `person:Ahasuerus`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Vasthi (ID: `person:Vashti`); Mède(s); Médie (ID: `group:Mede`); Perse (ID: `group:Persia`); Perse (ID: `place:Persia`); Assuérus (ID: `person:Ahasuerus`); Medan (ID: `person:Medan`)
...
* **Associated ACAI Concepts:** Nebucadnetsar (ID: `person:Nebuchadnezzar`); Babylone (ID: `place:Babylon`); Jojakin (ID: `person:Jehoiachin`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Esther (ID: `person:Esther`); aimer (ID: `keyterm:Love`); grâce (ID: `keyterm:Favor`); Vasthi (ID: `person:Vashti`); bonté (ID: `keyterm:Kindness`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Mardochée (ID: `person:Mordecai.2`); Zéresch (ID: `person:Zeresh`); aimer (ID: `keyterm:Love`); Esther (ID: `person:Esther`); gloire (ID: `keyterm:Glory`); Jews (ID: `group:Jews`); A Group of People (ID: `group:GenericGroup`); House (ID: `realia:House`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Zéresch (ID: `person:Zeresh`); aimer (ID: `keyterm:Love`); Mardochée (ID: `person:Mordecai.2`); A Group of People (ID: `group:GenericGroup`); Haman (ID: `person:Haman`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Zéresch (ID: `person:Zeresh`); aimer (ID: `keyterm:Love`); Mardochée (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); A Group of People (ID: `group:GenericGroup`); Haman (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Esther (ID: `person:Esther`); Haman (ID: `person:Haman`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Bed (ID: `realia:Bed`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Agag (ID: `person:Agag.2`); Esther (ID: `person:Esther`); Agaguite (ID: `group:Agag`); Jews (ID: `group:Jews`); prier pour la pitié (ID: `keyterm:BegForMercy`); Haman (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Agag (ID: `person:Agag.2`); Agaguite (ID: `group:Agag`); grâce (ID: `keyterm:Favor`); Jews (ID: `group:Jews`); Haman (ID: `person:Haman`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Parmaschtha (ID: `person:Parmashta`); Adalia (ID: `person:Adalia`); Vajezatha (ID: `person:Vaizatha`); Aridatha (ID: `person:Aridatha`); Aspatha (ID: `person:Aspatha`); Aridaï (ID: `person:Aridai`); Parschandatha (ID: `person:Parshandatha`); Arizaï (ID: `person:Arisai`); Poratha (ID: `person:Poratha`); Dalphon (ID: `person:Dalphon`); Hammedatha (ID: `person:Hammedatha`); Haman (ID: `person:Haman`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Lot (ID: `realia:Lot`); Hammedatha (ID: `person:Hammedatha`); Agag (ID: `person:Agag.2`); Mardochée (ID: `person:Mordecai.2`); Agaguite (ID: `group:Agag`); Haman (ID: `person:Haman`); destin (ID: `keyterm:Lot`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Esther (ID: `person:Esther`); Jews (ID: `group:Jews`); Mardochée (ID: `person:Mordecai.2`); Scroll (ID: `realia:Scroll`); Abichaïl (ID: `person:Abihail.5`); état intact (ID: `keyterm:IntactState`); Assuérus (ID: `person:Ahasuerus`); vérité (ID: `keyterm:Truth`)
