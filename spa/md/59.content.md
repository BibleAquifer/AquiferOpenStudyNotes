...
* **Associated ACAI Concepts:** aprobado (ID: `keyterm:Approved`); dichoso (ID: `keyterm:Happy`)
...
* **Associated ACAI Concepts:** tentar (ID: `keyterm:PutToTheTest`); dichoso (ID: `keyterm:Happy`); Mirror (ID: `realia:Mirror`); aprobado (ID: `keyterm:Approved`); inútil (ID: `keyterm:Worthless`); limpio (ID: `keyterm:Clean`)
...
* **Associated ACAI Concepts:** inútil (ID: `keyterm:Worthless`); limpio (ID: `keyterm:Clean`)
...
* **Associated ACAI Concepts:** favoritismo (ID: `keyterm:Partiality`); tropezar (ID: `keyterm:Stumble`); juicio (ID: `keyterm:Judgment`); ley (ID: `keyterm:Law`)
...
* **Associated ACAI Concepts:** amistad (ID: `keyterm:Friendship`); arriba (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** amistad (ID: `keyterm:Friendship`); arriba (ID: `keyterm:Unfaithful`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** misericordioso (ID: `keyterm:Compassionate`); Job (ID: `person:Job`)
