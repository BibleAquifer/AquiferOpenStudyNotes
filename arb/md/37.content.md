...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); دَارِيوسَ (ID: `person:Darius.2`); يَشوع (ID: `person:Joshua.5`); حَجَّيِ (ID: `person:Haggai`); يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); يَهوذَا (ID: `person:Judah.4`); زَربَّابِل (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); حَجَّيِ (ID: `person:Haggai`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); دَارِيوسَ (ID: `person:Darius.2`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Olive Tree (ID: `flora:OliveTree`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Must (ID: `realia:Must`); Grain (ID: `flora:Grain`); Bag (ID: `realia:Bag`); Vine (ID: `flora:Vine`); Mule (ID: `fauna:Mule`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَشوع (ID: `person:Joshua.5`); حَجَّيِ (ID: `person:Haggai`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَشوع (ID: `person:Joshua.5`); يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); زَربَّابِل (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); حَجَّيِ (ID: `person:Haggai`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); Peace (ID: `keyterm:IntactState`); مِصْرَ (ID: `place:Egypt`); Fear (ID: `keyterm:Fear`); Word of the Lord (ID: `keyterm:WordOfTheLord`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); حَجَّيِ (ID: `person:Haggai`); Word of the Lord (ID: `keyterm:WordOfTheLord`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Horse (ID: `fauna:Horse`); Chariot (ID: `realia:Chariot`); Sword (ID: `realia:Sword`)
