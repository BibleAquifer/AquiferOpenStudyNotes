...
* **Associated ACAI Concepts:** Ephrata (ID: `person:Ephrathah`); Efratita (ID: `group:Ephrathah`); Chelión (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Mahalón (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Catah (ID: `place:Bethlehem`); Judá (ID: `group:Judah`); Elimelech (ID: `person:Elimelech`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Catah (ID: `place:Bethlehem`); Noemi (ID: `person:Naomi`); Ruth (ID: `person:Ruth`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** bendecir (ID: `keyterm:Bless`); Jehová (ID: `deity:Lord`); bondad (ID: `keyterm:Kindness`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); dejar en herencia (ID: `keyterm:Possess`); Booz (ID: `person:Boaz`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Elders (ID: `group:GenericElders`); Israel (ID: `person:Israel`); Jehová (ID: `deity:Lord`); Catah (ID: `place:Bethlehem`); Rachêl (ID: `person:Rachel`); Lea (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); Phares (ID: `person:Perez`); Judá (ID: `group:Judah`); Thamar (ID: `person:Tamar`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Hesrón (ID: `person:Hezron.2`); Salmón (ID: `person:Salmon`); Obed (ID: `person:Obed`); Aminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Isaí (ID: `person:Jesse`); David (ID: `person:David`); Phares (ID: `person:Perez`); Nahasón (ID: `person:Nahshon`); Booz (ID: `person:Boaz`)
