...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); mencobai (ID: `keyterm:PutToTheTest`); berbahagialah (ID: `keyterm:Happy`); kekasih (ID: `keyterm:Beloved`); tahan uji (ID: `keyterm:Approved`); sia, sia (ID: `keyterm:Worthless`); suci (ID: `keyterm:Clean`); keahlian (ID: `keyterm:Ability`); janji (ID: `keyterm:Promise`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); berbuat dosa (ID: `keyterm:Sin`); kebenaran (ID: `keyterm:Truth`); hati (ID: `keyterm:Heart`); keselamatan (ID: `keyterm:Salvation`); yang baik (ID: `keyterm:Good`); kasihi (ID: `keyterm:Love`); tak bernoda (ID: `keyterm:AboveCriticism`); kehidupan (ID: `keyterm:Life`); tidak dapat dicobai (ID: `keyterm:NotTempted`); tidak dicemarkan (ID: `keyterm:Undefiled`); hukum (ID: `keyterm:Law`); A Person (ID: `person:GenericPerson`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** sia, sia (ID: `keyterm:Worthless`); suci (ID: `keyterm:Clean`); Tuhan (ID: `deity:Lord`); keahlian (ID: `keyterm:Ability`); hati (ID: `keyterm:Heart`); tak bernoda (ID: `keyterm:AboveCriticism`); tidak dicemarkan (ID: `keyterm:Undefiled`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); tonton bulu atau muka (ID: `keyterm:Partiality`); percaya (ID: `keyterm:Believe`); kemuliaan (ID: `keyterm:Glory`); bimbang (ID: `keyterm:Discern`); Yesus (ID: `person:Jesus.2`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); kasihi (ID: `keyterm:Love`); kekasih (ID: `keyterm:Beloved`); keahlian (ID: `keyterm:Ability`); kerajaan (ID: `keyterm:Kingdom`); janji (ID: `keyterm:Promise`); orang pilihan (ID: `keyterm:Chosen`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); penghakiman (ID: `keyterm:Judgment`); tonton bulu atau muka (ID: `keyterm:Partiality`); tersandung (ID: `keyterm:Stumble`); persundalan (ID: `keyterm:Fornication`); berbuat dosa (ID: `keyterm:Sin`); kasihi (ID: `keyterm:Love`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`); memutuskan (ID: `keyterm:Decided`); pengadilan (ID: `keyterm:CourtCase`); kitab suci (ID: `keyterm:Scripture`); belas kasihan (ID: `keyterm:Mercy`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Tuhan (ID: `deity:Lord`); Abraham (ID: `person:Abraham`); tubuh (ID: `keyterm:Body.3`); A Person (ID: `person:GenericPerson`); sia, sia (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); Demons (ID: `deity:Demons`); hampa (ID: `keyterm:Empty`); An Angel (ID: `deity:Angel`); keselamatan (ID: `keyterm:Salvation`); Ishak (ID: `person:Isaac`); memperdamaikan (ID: `keyterm:Peace`); kitab suci (ID: `keyterm:Scripture`); roh (ID: `keyterm:Spirit.2`); menggenapi (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); Abraham (ID: `person:Abraham`); kitab suci (ID: `keyterm:Scripture`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); menggenapi (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** neraka (ID: `keyterm:Gehenna`); lalim (ID: `keyterm:UnjustDeed`); keahlian (ID: `keyterm:Ability`); tubuh (ID: `keyterm:Body.3`); Hell (ID: `place:Hell`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); tidak setia (ID: `keyterm:Unfaithful`); persahabatan (ID: `keyterm:Friendship`); Roh (ID: `deity:HolySpirit`); membersihkan (ID: `keyterm:Cleanse.2`); murni (ID: `keyterm:Pure`); Cause of Joy (ID: `keyterm:CauseOfJoy`); keahlian (ID: `keyterm:Ability`); ingin (ID: `keyterm:LongFor`); hati (ID: `keyterm:Heart`); kitab suci (ID: `keyterm:Scripture`); roh (ID: `keyterm:Spirit.2`); kebaikan (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); murni (ID: `keyterm:Pure`); hati (ID: `keyterm:Heart`); membersihkan (ID: `keyterm:Cleanse.2`)
...
* **Associated ACAI Concepts:** menentang (ID: `keyterm:Condemn`); Tuhan (ID: `deity:Lord`); bersaksi (ID: `keyterm:BearWitness`); hati (ID: `keyterm:Heart`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); tubuh (ID: `keyterm:Body.3`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** nama (ID: `keyterm:Name`); Tuhan (ID: `deity:Lord`); diurapi (ID: `keyterm:Anointed`); jemaat (ID: `keyterm:Church`); berdoa (ID: `keyterm:Pray`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); berbuat dosa (ID: `keyterm:Sin`); Tuhan (ID: `deity:Lord`); keselamatan (ID: `keyterm:Salvation`); berdoa (ID: `keyterm:Pray`); mengampuni (ID: `keyterm:Forgive`)
