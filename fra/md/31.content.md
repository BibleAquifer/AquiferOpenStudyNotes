...
* **Associated ACAI Concepts:** Édom (ID: `group:Edom`); comprehension (ID: `keyterm:Understanding`); état intact (ID: `keyterm:IntactState`); Édom (ID: `place:Edom`); alliance (ID: `keyterm:Covenant`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** destin (ID: `keyterm:Lot`); Juda (ID: `person:Judah.4`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `group:Judah`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Édom (ID: `group:Edom`); Joseph (ID: `person:Joseph.10`); Jérusalem (ID: `place:Jerusalem`); Édom (ID: `place:Edom`); déposséder (ID: `keyterm:Dispossess`)
...
* **Associated ACAI Concepts:** Negev (ID: `place:Negeb`); déposséder (ID: `keyterm:Dispossess`); Canaan (ID: `place:Canaan`); Canaan (ID: `group:Canaan`); Benjamin (ID: `person:Benjamin`); Benjamin (ID: `group:Benjamin`); Éphraïm (ID: `person:Ephraim`); Galaad (ID: `place:Gilead`); Philistia (ID: `place:Philistine`); Shephelah (ID: `place:Shephelah`); Samarie (ID: `place:Samaria`); Éphraïm (ID: `group:Ephraim`); Philistins (ID: `group:Philistine`); Jérusalem (ID: `place:Jerusalem`); Sardes (ID: `place:Sardis`); Israël (ID: `person:Israel`); Sarepta (ID: `place:Zarephath`); montagne d'Ésaü (ID: `place:EsauMount`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Negev (ID: `place:Negeb`); montagne d'Ésaü (ID: `place:EsauMount`); déposséder (ID: `keyterm:Dispossess`); Canaan (ID: `place:Canaan`); Philistins (ID: `group:Philistine`); Shephelah (ID: `place:Shephelah`); Canaan (ID: `group:Canaan`); Israël (ID: `person:Israel`); Benjamin (ID: `group:Benjamin`); Éphraïm (ID: `person:Ephraim`); Galaad (ID: `place:Gilead`); Sarepta (ID: `place:Zarephath`); Benjamin (ID: `person:Benjamin`); Éternel (ID: `deity:Lord`); Philistia (ID: `place:Philistine`); Sardes (ID: `place:Sardis`); Samarie (ID: `place:Samaria`); Éphraïm (ID: `group:Ephraim`)
...
* **Associated ACAI Concepts:** Canaan (ID: `place:Canaan`); Jérusalem (ID: `place:Jerusalem`); Sardes (ID: `place:Sardis`); Canaan (ID: `group:Canaan`); Sarepta (ID: `place:Zarephath`); Israël (ID: `person:Israel`); Negev (ID: `place:Negeb`); déposséder (ID: `keyterm:Dispossess`)
