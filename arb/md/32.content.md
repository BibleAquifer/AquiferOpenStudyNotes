...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); Fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); Hell (ID: `place:Hell`); Vow (ID: `keyterm:Vow`); يَافَا (ID: `place:Joppa`); نِينَوَى (ID: `place:Nineveh`); أَمِتَّايَ (ID: `person:Amittai`); Exempt (ID: `keyterm:Exempt`); Hebrews (ID: `group:Hebrews`); Salvation (ID: `keyterm:Salvation`); Kindness (ID: `keyterm:Kindness`); Word of the Lord (ID: `keyterm:WordOfTheLord`); تَرْشِيشَ (ID: `place:Tarshish`); Lot (ID: `keyterm:Lot`); Slaughtering (ID: `keyterm:Slaughtering`); Praise (ID: `keyterm:Praise`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Hell (ID: `place:Hell`); Praise (ID: `keyterm:Praise`); Salvation (ID: `keyterm:Salvation`); Vow (ID: `keyterm:Vow`); يونَانَ (ID: `person:Jonah.2`); Kindness (ID: `keyterm:Kindness`); Fish (ID: `fauna:Fish`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Praise (ID: `keyterm:Praise`); Salvation (ID: `keyterm:Salvation`); Vow (ID: `keyterm:Vow`); Kindness (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); نِينَوَى (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Cattle (ID: `fauna:Bull`); Sackcloth (ID: `realia:Sackcloth`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Compassionate (ID: `keyterm:Compassionate`); Generous (ID: `keyterm:Generous`); تَرْشِيشَ (ID: `place:Tarshish`); Believe In (ID: `keyterm:BelieveIn`); Kindness (ID: `keyterm:Kindness`); Clothing (ID: `realia:Clothing`); Goat (ID: `fauna:Goat`); Worm (ID: `fauna:Maggot`); Flock (ID: `fauna:Flock`); Throne (ID: `realia:Throne`)
