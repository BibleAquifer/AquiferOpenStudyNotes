...
* **Associated ACAI Concepts:** libertar (ID: `keyterm:Rescue`); Galácia (ID: `place:Galatia`)
...
* **Associated ACAI Concepts:** Tiago (ID: `person:James.3`); Barnabé (ID: `person:Barnabas`); Tito (ID: `person:Titus`); libertar (ID: `keyterm:Rescue`); hipocrisia (ID: `keyterm:Hypocrisy`); Galácia (ID: `place:Galatia`); conduta (ID: `keyterm:Behavior`); Antioquia (ID: `place:Antioch`); Arabia (ID: `place:Arabia`); persuadir (ID: `keyterm:Persuade`); boa notícia (ID: `keyterm:GoodNews`); Gentiles (ID: `group:Gentile`); Pedro (ID: `person:Peter`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Tiago (ID: `person:James.3`); Barnabé (ID: `person:Barnabas`); Tito (ID: `person:Titus`); hipocrisia (ID: `keyterm:Hypocrisy`); conduta (ID: `keyterm:Behavior`); Antioquia (ID: `place:Antioch`); Arabia (ID: `place:Arabia`); Gentiles (ID: `group:Gentile`); boa notícia (ID: `keyterm:GoodNews`); Pedro (ID: `person:Peter`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Tiago (ID: `person:James.3`); Arabia (ID: `place:Arabia`)
...
* **Associated ACAI Concepts:** Galatians (ID: `group:Galatia`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); Galatians (ID: `group:Galatia`); servir como escravo (ID: `keyterm:Serve.2`); escravidão (ID: `keyterm:Slavery`); em cristo (ID: `keyterm:InChrist`); elementos (ID: `keyterm:FundamentalPrinciples`); Hagar (ID: `person:Hagar`); Monte Sinai (ID: `place:SinaiMount`); Circumcision (ID: `keyterm:Circumcision`); promessa (ID: `keyterm:Promise`); crer (ID: `keyterm:Believe`); Abraão (ID: `person:Abraham`); be (or show oneself) just (ID: `keyterm:Just`); Holy Spirit (ID: `deity:HolySpirit`); corpo (ID: `keyterm:Body.3`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** em cristo (ID: `keyterm:InChrist`); lei (ID: `keyterm:Law`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** escravidão (ID: `keyterm:Slavery`); Monte Sinai (ID: `place:SinaiMount`)
...
* **Associated ACAI Concepts:** Good (ID: `keyterm:Good`); zelo (ID: `keyterm:Resentment`); compartilhar (ID: `keyterm:Share`); andar (ID: `keyterm:Live.3`); Holy Spirit (ID: `deity:HolySpirit`); corpo (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** zelo (ID: `keyterm:Resentment`); andar (ID: `keyterm:Live.3`); Good (ID: `keyterm:Good`); Holy Spirit (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** zelo (ID: `keyterm:Resentment`); Good (ID: `keyterm:Good`)
