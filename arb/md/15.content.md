...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); فَارِسَ (ID: `place:Persia`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `group:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); بَنْيَامِينَ (ID: `person:Benjamin`); يَهوذَا (ID: `group:Judah`); لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `group:Levi`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath`); كورَشَ (ID: `person:Cyrus`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); فَارِسَ (ID: `place:Persia`); زَربَّابِل (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); لَّاوِي (ID: `person:Levi.3`); سلَيْمَانَ (ID: `person:Solomon`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `group:Levi`); عَادِينَ (ID: `person:Adin`); لَبَانَةَ (ID: `person:Lebanah`); عَرْجَدَ (ID: `person:Azgad`); رَعْلَايَا (ID: `person:Reelaiah`); سِيسَرَا (ID: `person:Sisera.2`); بِيسَايَ (ID: `person:Besai`); يورَةَ (ID: `person:Jorah`); حَشوم (ID: `person:Hashum`); صِيحَا (ID: `person:Ziha`); أَدونِيقَامَ (ID: `person:Adonikam`); سوفَرَثَ (ID: `person:Sophereth`); Meunim (ID: `group:Meunim`); لِإِيمِيرَ (ID: `person:Immer.2`); نَقودَا (ID: `person:Nekoda`); Tel-harsha (ID: `place:Tel-harsha`); حَطِّيلَ (ID: `person:Hattil`); حَارِيمَ (ID: `person:Harim.2`); حَارِيمَ (ID: `person:Harim`); رَآيَا (ID: `person:Reaiah.3`); حَاجَابَ (ID: `person:Hagab`); بَصْلوتَ (ID: `person:Bazluth`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); لِإِيمِيرَ (ID: `place:Immer`); نَقودَا (ID: `person:Nekoda.2`)
...
* **Associated ACAI Concepts:** مِسْفَار (ID: `person:Mispar`); بَعْنَةَ (ID: `person:Baanah.3`); مرْدَخَاي (ID: `person:Mordecai`); رَعْلَايَا (ID: `person:Reelaiah`); رَحوم (ID: `person:Rehum`); سَرَايَا (ID: `person:Seraiah.6`); بِلْشَان (ID: `person:Bilshan`); نَحَمْيَا (ID: `person:Nehemiah`); بِغْوَايَ (ID: `person:Bigvai`); إِسْرَائِيلَ (ID: `person:Israel`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** عِيلَامَ (ID: `person:Elam`); بَانِيَ (ID: `person:Bani`); عَادِينَ (ID: `person:Adin`); عَرْجَدَ (ID: `person:Azgad`); شَفَطْيَا (ID: `person:Shephatiah.6`); يورَةَ (ID: `person:Jorah`); حَشوم (ID: `person:Hashum`); حَزَقِيَّا (ID: `person:Hezekiah.2`); زَكَّايَ (ID: `person:Zaccai.2`); أَدونِيقَامَ (ID: `person:Adonikam`); بِغْوَايَ (ID: `person:Bigvai.2`); يَشوعَ (ID: `person:Jeshua.3`); آطِيرَ (ID: `person:Ater`); يوآب (ID: `person:Joab.3`); Pahath-moab (ID: `person:Pahath-moab`); فَرْعوشَ (ID: `person:Parosh`); بِيصَايَ (ID: `person:Bezai`); بَابَايَ (ID: `person:Bebai`); آرَحَ (ID: `person:Arah.2`); زَتّو (ID: `person:Zattu.2`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** مَغْبِيشَ (ID: `place:Magbish`); Beth-azmaveth (ID: `place:Beth-azmaveth`); سَنَاءَةَ (ID: `place:Senaah`); حَارِيمَ (ID: `person:Harim.2`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); نَبو (ID: `place:Nebo.2`); حَادِيدَ (ID: `place:Hadid`); Kiriath-jearim (ID: `place:Kiriath-jearim`); عِيلَامَ (ID: `person:Elam`); مِخْمَاسَ (ID: `place:Michmash`); أونوَ (ID: `place:Ono`); مِنْ (ID: `place:Geba`); بَئِيروت (ID: `place:Beeroth`); وَلودَ (ID: `place:Lod`); عَايٍ (ID: `place:Ai`); أَرِيحَا (ID: `place:Jericho`); عَنَاثوثَ (ID: `place:Anathoth`); Ramah (ID: `place:Ramah.2`); ٱلْكَفِيرَة (ID: `place:Chephirah`); لَحْمٍ (ID: `place:Bethlehem`); Bethel (ID: `place:Bethel`)
...
* **Associated ACAI Concepts:** حَارِيمَ (ID: `person:Harim`); شوبَايَ (ID: `person:Shobai`); لِإِيمِيرَ (ID: `person:Immer.2`); يَدَايَا (ID: `person:Jedaiah.4`); طَلْمون (ID: `person:Talmon`); حَطِيطَا (ID: `person:Hatita`); هودَوْيَا (ID: `person:Hodaviah.4`); يَشوعَ (ID: `person:Jeshua`); آطِيرَ (ID: `person:Ater.2`); يَشوعَ (ID: `person:Jeshua.4`); آسَاف (ID: `person:Asaph.2`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); عَقّوب (ID: `person:Akkub.2`); لَّاوِي (ID: `person:Levi.3`); فَشْحور (ID: `person:Pashhur`); لَّاوِي (ID: `group:Levi`); شَلّوم (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** شوبَايَ (ID: `person:Shobai`); طَلْمون (ID: `person:Talmon`); حَطِيطَا (ID: `person:Hatita`); آطِيرَ (ID: `person:Ater.2`); آسَاف (ID: `person:Asaph.2`); عَقّوب (ID: `person:Akkub.2`); شَلّوم (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** Nephushesim (ID: `group:Nephushesim`); لَبَانَةَ (ID: `person:Lebanah`); طَبَاعوتَ (ID: `person:Tabbaoth`); ثَامَحَ (ID: `person:Temah`); بِيسَايَ (ID: `person:Besai`); سِيسَرَا (ID: `person:Sisera.2`); بَرْقوسَ (ID: `person:Barkos`); حَانَان (ID: `person:Hanan.4`); جَاحَرَ (ID: `person:Gahar`); قِيروسَ (ID: `person:Keros`); صِيحَا (ID: `person:Ziha`); جَزَّامَ (ID: `person:Gazzam`); حَقوفَا (ID: `person:Hakupha`); فَادونَ (ID: `person:Padon`); Meunim (ID: `group:Meunim`); حَسوفَا (ID: `person:Hasupha`); مَحِيدَا (ID: `person:Mehida`); فَاسِيحَ (ID: `person:Paseah.2`); حَطِيفَا (ID: `person:Hatipha`); نَصِيحَ (ID: `person:Neziah`); عَقّوب (ID: `person:Akkub.3`); نَقودَا (ID: `person:Nekoda`); أَسْنَةَ (ID: `person:Asnah`); حَرْشَا (ID: `person:Harsha`); رَصِينَ (ID: `person:Rezin.2`); سِيعَهَا (ID: `person:Siaha`); رَآيَا (ID: `person:Reaiah.3`); حَجَابَةَ (ID: `person:Hagabah`); حَرْحورَ (ID: `person:Harhur`); حَاجَابَ (ID: `person:Hagab`); جَدِّيلَ (ID: `person:Giddel`); بَصْلوتَ (ID: `person:Bazluth`); سَلْمَايَ (ID: `person:Shalmai`); بَقْبوقَ (ID: `person:Bakbuk`); فِي (ID: `person:Uzza.2`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); سَوْطَايَ (ID: `person:Sotai`); فَرودَا (ID: `person:Peruda`); سوفَرَثَ (ID: `person:Sophereth`); شَفَطْيَا (ID: `person:Shephatiah.7`); آمِي (ID: `person:Ami`); يَعْلَةَ (ID: `person:Jaalah`); حَطِّيلَ (ID: `person:Hattil`); جَدِّيلَ (ID: `person:Giddel.2`); دَرْقونَ (ID: `person:Darkon`)
...
* **Associated ACAI Concepts:** طوبِيَّا (ID: `person:Tobiah`); لِدَلَايَا (ID: `person:Delaiah.3`); Tel-harsha (ID: `place:Tel-harsha`); أَدَّان (ID: `place:Addan`); Tel-melah (ID: `place:Tel-melah`); لِإِيمِيرَ (ID: `place:Immer`); كَروب (ID: `place:Cherub`); نَقودَا (ID: `person:Nekoda.2`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** بَرْزِلَّايَ (ID: `person:Barzillai.3`); حَبَايَا (ID: `person:Habaiah`); هَقّوصَ (ID: `person:Hakkoz.2`); Gileadites (ID: `group:Gilead`); جِلْعَادَ (ID: `place:Gilead`); Defile (ID: `keyterm:Stain`); بَرْزِلَّايَ (ID: `person:Barzillai`); Priesthood (ID: `keyterm:Priesthood`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); Strength (ID: `keyterm:Strength`); Mina (ID: `realia:Mina`); House (ID: `realia:House`); Tunic (ID: `realia:Tunic`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); يَشوع (ID: `person:Joshua.5`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); Relatives (ID: `group:Relatives`); حِينَادَادَ (ID: `person:Henadad`); Esarhaddon (ID: `person:Esarhaddon`); هودَوْيَا (ID: `person:Hodaviah.4`); يَشوعَ (ID: `person:Jeshua.4`); آسَاف (ID: `person:Asaph.2`); Assyria (ID: `place:Assyria`); Tyrians (ID: `group:Tyre`); Terror (ID: `keyterm:Terror`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Kindness (ID: `keyterm:Kindness`); Sidonians (ID: `group:Sidon`); Holy (ID: `keyterm:Holy`); موسَى (ID: `person:Moses`); هودِيَّا (ID: `person:Hodiah.2`); Appointed Feast (ID: `keyterm:AppointedFeast`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); لبْنَانَ (ID: `place:Lebanon`); بَنْيَامِينَ (ID: `person:Benjamin`); دَاودَ (ID: `person:David`); دَارِيوسَ (ID: `person:Darius.2`); Counsel (ID: `keyterm:Counsel`); بَنْيَامِينَ (ID: `group:Benjamin`); صورَ (ID: `place:Tyre`); يَافَا (ID: `place:Joppa`); صِيْدونَ (ID: `place:Sidon`); Instruction (ID: `keyterm:Instruction`); Trumpet (ID: `realia:Trumpet`); Cedar (ID: `flora:Cedar`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Craftsman (ID: `realia:Craftsman`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Terror (ID: `keyterm:Terror`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); صورَ (ID: `place:Tyre`); لبْنَانَ (ID: `place:Lebanon`); يَافَا (ID: `place:Joppa`); صِيْدونَ (ID: `place:Sidon`); فَارِسَ (ID: `place:Persia`); Tyrians (ID: `group:Tyre`); Sidonians (ID: `group:Sidon`); Anointing Oil (ID: `realia:AnointingOil`); Cedar (ID: `flora:Cedar`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `person:Levi.3`); زَربَّابِل (ID: `person:Zerubbabel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `group:Levi`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); آسَاف (ID: `person:Asaph.2`); Kindness (ID: `keyterm:Kindness`); دَاودَ (ID: `person:David`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `group:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); بَنْيَامِينَ (ID: `person:Benjamin`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْفرَاتِ (ID: `place:Euphrates`); شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); ٱلسَّامِرَةِ (ID: `place:Samaria`); فَارِسَ (ID: `place:Persia`); Jews (ID: `group:Jews`); أَرَكَ (ID: `place:Erech`); مِثْرَدَاث (ID: `person:Mithredath.2`); أسْنَفَّر (ID: `person:Osnappar`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); طَبْئِيل (ID: `person:Tabeel`); بِشْلَام (ID: `person:Bishlam`); Babylonians (ID: `group:Babylon`); بَابِلَ (ID: `place:Babylon`); Persians (ID: `group:Persia`); فِي (ID: `place:Susa`); يَهوذَا (ID: `group:Judah`); عِيلَامَ (ID: `place:Elam`); Elamites (ID: `group:Elam`); يَهوذَا (ID: `person:Judah.4`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** ٱلدِّينِيِّينَ (ID: `person:Dinaite`); أَرَكَ (ID: `place:Erech`); رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); Babylonians (ID: `group:Babylon`); Persians (ID: `group:Persia`); بَابِلَ (ID: `place:Babylon`); فِي (ID: `place:Susa`); عِيلَامَ (ID: `place:Elam`); فَارِسَ (ID: `place:Persia`); Elamites (ID: `group:Elam`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Jews (ID: `group:Jews`); رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); دَارِيوسَ (ID: `person:Darius.2`); حَجَّيِ (ID: `person:Haggai`); تَتْنَاي (ID: `person:Tattenai`); زَكَرِيَّا (ID: `person:Zechariah.17`); يَدّو (ID: `person:Iddo.6`); Shethar-bozenai (ID: `person:Shethar-bozenai`); ٱلْفرَاتِ (ID: `place:Euphrates`); يَهوذَا (ID: `person:Judah.4`); إِسْرَائِيلَ (ID: `person:Israel`); فَارِسَ (ID: `place:Persia`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** حَجَّيِ (ID: `person:Haggai`); زَكَرِيَّا (ID: `person:Zechariah.17`); يَدّو (ID: `person:Iddo.6`); يَهوذَا (ID: `person:Judah.4`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); بَابِلَ (ID: `place:Babylon`); أورشَلِيمَ (ID: `place:Jerusalem`); كورَشَ (ID: `person:Cyrus`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); دَارِيوسَ (ID: `person:Darius.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); تَتْنَاي (ID: `person:Tattenai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); يَهوذَا (ID: `person:Judah.4`); إِسْرَائِيلَ (ID: `person:Israel`); Chaldeans (ID: `group:Chaldea`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); ٱلْفرَاتِ (ID: `place:Euphrates`); Hewn Stone (ID: `realia:HewnStone`); Foundation (ID: `realia:Foundation`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** بَابِلَ (ID: `place:Babylon`); Chaldeans (ID: `group:Chaldea`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); كورَشَ (ID: `person:Cyrus`); بَابِلَ (ID: `place:Babylon`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); زَربَّابِل (ID: `person:Zerubbabel.2`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); أورشَلِيمَ (ID: `place:Jerusalem`); موسَى (ID: `person:Moses`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); عَزَرْيَا (ID: `person:Azariah.7`); لِمَرَايوثَ (ID: `person:Meraioth`); صَادوق (ID: `person:Zadok.4`); زَرَحْيَا (ID: `person:Zerahiah`); أَبِيشوعَ (ID: `person:Abishua`); سَرَايَا (ID: `person:Seraiah.2`); أَخِيطوبَ (ID: `person:Ahitub.3`); أَمَرْيَا (ID: `person:Amariah.2`); بقِّي (ID: `person:Bukki.2`); شَلّوم (ID: `person:Shallum.7`); عَزَرْيَا (ID: `person:Azariah.6`); عزِّي (ID: `person:Uzzi`); حِلْقِيَّا (ID: `person:Hilkiah.2`); أَلِعَازَار (ID: `person:Eleazar.2`); هَارون (ID: `person:Aaron`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فَارِسَ (ID: `place:Persia`); فِينَحَاس (ID: `person:Phinehas`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Decree (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); ٱلْفرَاتِ (ID: `place:Euphrates`); Anointing Oil (ID: `realia:AnointingOil`); Wheat (ID: `flora:Wheat`); Talent (ID: `realia:Talent`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Kor (ID: `realia:Kor`)
...
* **Associated ACAI Concepts:** عِيلَامَ (ID: `person:Elam`); حَطّوش (ID: `person:Hattush.2`); عَادِينَ (ID: `person:Adin`); يوحَانَانَ (ID: `person:Johanan.8`); عَرْجَدَ (ID: `person:Azgad`); زَكَرِيَّا (ID: `person:Zechariah.19`); شَفَطْيَا (ID: `person:Shephatiah.6`); شَكَنْيَا (ID: `person:Shecaniah.5`); عَابِد (ID: `person:Ebed.2`); زَبَدْيَا (ID: `person:Zebadiah.8`); يوآب (ID: `person:Joab.4`); يوشَفْيَا (ID: `person:Josiphiah`); عوبَدْيَا (ID: `person:Obadiah.10`); يَحِيئِيل (ID: `person:Jehiel.7`); هِقَّاطَانَ (ID: `person:Hakkatan`); يَحْزِيئِيل (ID: `person:Jahaziel.5`); شَلومِيَةَ (ID: `person:Shelomith.4`); يونَاثَانَ (ID: `person:Jonathan.9`); شِمْعِيَا (ID: `person:Shemaiah.14`); أَدونِيقَامَ (ID: `person:Adonikam`); عَثَلْيَا (ID: `person:Athaliah.3`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); بِغْوَايَ (ID: `person:Bigvai.2`); عوتَاي (ID: `person:Uthai.2`); يَعِيئِيل (ID: `person:Jeuel.3`); زَكَرِيَّا (ID: `person:Zechariah.18`); مِيخَائِيلَ (ID: `person:Michael.10`); دَانِيآل (ID: `person:Daniel.2`); فَرْعوشَ (ID: `person:Parosh.2`); Gershom (ID: `person:Gershom.2`); Pahath-moab (ID: `person:Pahath-moab`); بَابَايَ (ID: `person:Bebai.2`); بَابَايَ (ID: `person:Bebai`); زَرَحْيَا (ID: `person:Zerahiah.2`); يِشْعِيَا (ID: `person:Jeshaiah.4`); شَكَنْيَا (ID: `person:Shecaniah.6`); أَلِيفَلَط (ID: `person:Eliphelet.5`); زَكّور (ID: `person:Zaccur.5`); بَابِلَ (ID: `place:Babylon`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); دَاودَ (ID: `person:David`); إِيثَامَارَ (ID: `person:Ithamar`); فِينَحَاس (ID: `person:Phinehas`)
...
* **Associated ACAI Concepts:** زَكَرِيَّا (ID: `person:Zechariah.20`); شِمْعِيَا (ID: `person:Shemaiah.15`); أَرِيئِيلَ (ID: `person:Ariel`); يَدّو (ID: `person:Iddo`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); نَاثَان (ID: `person:Nathan.5`); أَلِيعَزَرَ (ID: `person:Eliezer.8`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); مَشلَّام (ID: `person:Meshullam.9`); يَارِيبَ (ID: `person:Jarib.2`); يويَارِيبَ (ID: `person:Joiarib.2`); ٱلْمسَمَّى (ID: `place:Casiphia`); ٱلرَّبِّ (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); ٱلرَّبِّ (ID: `deity:Lord`); مَحْلِي (ID: `person:Mahli`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Insight (ID: `keyterm:Insight`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Work (ID: `keyterm:Work`); دَاودَ (ID: `person:David`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); To Sin (ID: `keyterm:Sin`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); كَنْعَان (ID: `place:Canaan`); موآبَ (ID: `place:Moab`); Egyptians (ID: `group:Egypt`); مِصْرَ (ID: `place:Egypt`); إِسْرَائِيلَ (ID: `person:Israel`); Canaanites (ID: `group:Canaan`); لَّاوِي (ID: `person:Levi.3`); Ammonites (ID: `group:Ammon`); حِثًّا (ID: `person:Heth`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); لَّاوِي (ID: `group:Levi`); Be Unfaithful (ID: `keyterm:Unfaithful`); Jebusites (ID: `group:Jebusites`); Amorites (ID: `group:Amorites`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Offering (ID: `keyterm:Offering`); عِيلَامَ (ID: `person:Elam`); Counsel (ID: `keyterm:Counsel`); عَزِيزَا (ID: `person:Aziza`); Perizzites (ID: `group:Perizzites`); عَثْلَاي (ID: `person:Athlai`); يَارِيبَ (ID: `person:Jarib.3`); مَتَّنْيَا (ID: `person:Mattaniah.8`); أَلِيوعِينَاي (ID: `person:Elioenai.5`); أَلْيَاشِيب (ID: `person:Eliashib.5`); شَلّوم (ID: `person:Shallum.11`); يوزَابَاد (ID: `person:Jozabad.7`); حَشوم (ID: `person:Hashum`); يوزَابَاد (ID: `person:Jozabad.8`); شِمْعِي (ID: `person:Shimei.17`); طَالَم (ID: `person:Telem`); مَنَسَّى (ID: `person:Manasseh.3`); شَاشَاي (ID: `person:Shashai`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); Dispossess (ID: `keyterm:Dispossess`); Plea for Mercy (ID: `keyterm:Supplication`); Peace (ID: `keyterm:IntactState`); To Cause to Possess (ID: `keyterm:Possess`); إِسْرَائِيلَ (ID: `person:Israel`); Defilement (ID: `keyterm:Defilement`); Kindness (ID: `keyterm:Kindness`); فَارِسَ (ID: `place:Persia`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); Plea for Mercy (ID: `keyterm:Supplication`); Kindness (ID: `keyterm:Kindness`); فَارِسَ (ID: `place:Persia`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** يَحِيئِيل (ID: `person:Jehiel.8`); شَكَنْيَا (ID: `person:Shecaniah.7`); عَزْرَا (ID: `person:Ezra`); ٱلرَّبِّ (ID: `deity:Lord`); عِيلَامَ (ID: `person:Elam`); إِسْرَائِيلَ (ID: `person:Israel`); Be Unfaithful (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** Swear (ID: `keyterm:Swear`); عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `group:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); بَنْيَامِينَ (ID: `person:Benjamin`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** مَشلَّام (ID: `person:Meshullam.10`); تِقْوَةَ (ID: `person:Tikvah.2`); عَسَائِيل (ID: `person:Asahel.4`); يونَاثَانَ (ID: `person:Jonathan.10`); يَحْزِيَا (ID: `person:Jahzeiah`); شَبْتَاي (ID: `person:Shabbethai`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`)
