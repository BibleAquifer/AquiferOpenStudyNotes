...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); دَارِيوسَ (ID: `person:Darius.2`); حَجَّيِ (ID: `person:Haggai`); يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); Fear (ID: `keyterm:Fear`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); ٱلرَّبِّ (ID: `deity:Lord`); حَجَّيِ (ID: `person:Haggai`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `group:Judah`); ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); حَجَّيِ (ID: `person:Haggai`); Fear (ID: `keyterm:Fear`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); Peace (ID: `keyterm:IntactState`); يَهوذَا (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); مِصْرَ (ID: `place:Egypt`); يَهوذَا (ID: `person:Judah.4`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوصَادِقَ (ID: `person:Jehozadak`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); حَجَّيِ (ID: `person:Haggai`); يَهوذَا (ID: `person:Judah.4`); Sword (ID: `realia:Sword`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`)
