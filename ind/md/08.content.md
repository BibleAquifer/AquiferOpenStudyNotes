...
* **Associated ACAI Concepts:** Efrata (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Mahlon (ID: `person:Chilion`); Ephrathites (ID: `group:Ephrathah`); Yehuda (ID: `group:Judah`); Betlehem (ID: `place:Bethlehem`); Yehuda (ID: `person:Judah.4`); Elimelekh (ID: `person:Elimelech`); Moab (ID: `place:Moab`); Mahlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Rut (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); Betlehem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** kebaikan (ID: `keyterm:Favor`); Moab (ID: `place:Moab`); Rut (ID: `person:Ruth`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Tuhan (ID: `deity:Lord`); Betlehem (ID: `place:Bethlehem`); Lea (ID: `person:Leah`); Elders (ID: `group:GenericElders`); Rahel (ID: `person:Rachel`)
...
* **Associated ACAI Concepts:** Tamar (ID: `person:Tamar`); Tuhan (ID: `deity:Lord`); Yehuda (ID: `person:Judah.4`); Peres (ID: `person:Perez`); Yehuda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Naomi (ID: `person:Naomi`); Israel (ID: `person:Israel`); Tuhan (ID: `deity:Lord`); memberkati (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); memperanakkan (ID: `person:Salmon`); Obed (ID: `person:Obed`); Aminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Boas (ID: `person:Boaz`); Isai (ID: `person:Jesse`); Nahason (ID: `person:Nahshon`); Daud (ID: `person:David`); Peres (ID: `person:Perez`)
