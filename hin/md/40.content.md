...
* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Blood (ID: `keyterm:Blood`); Forgive (ID: `keyterm:Forgive`); यीशु (ID: `person:Jesus.2`); Kingdom (ID: `keyterm:Kingdom`); To Sin (ID: `keyterm:Sin`); Bless (ID: `keyterm:Bless`); Be a Disciple (ID: `keyterm:Disciple`); यहोवा (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); Vine (ID: `flora:Vine`)
