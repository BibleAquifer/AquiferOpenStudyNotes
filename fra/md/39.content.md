...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Édom (ID: `group:Edom`); Éternel (ID: `deity:Lord`); aimer (ID: `keyterm:Love`); Édom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); craindre (ID: `keyterm:Fear`); alliance (ID: `keyterm:Covenant`); offrande (ID: `keyterm:Offering`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); pleurer (ID: `keyterm:Curse`); souiller (ID: `keyterm:Stain`); état intact (ID: `keyterm:IntactState`); gloire (ID: `keyterm:Glory`); Priests (ID: `group:GenericPriests`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); niveau (ID: `keyterm:Fairness`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); benir (ID: `keyterm:Bless`); chemin (ID: `keyterm:TheWay`); nation; peuple (ID: `group:Gentile`); sans saleté (ID: `keyterm:Pure`); ardeur (ID: `keyterm:Ardour`); vérité (ID: `keyterm:Truth`); la connaissance (ID: `keyterm:Intention`); profaner, déshonorer (ID: `keyterm:Dishonor`); agir avec bonté (ID: `keyterm:KindlyDisposed`); prier (ID: `keyterm:AskFor`); faire un voeu (ID: `keyterm:Vow`); An Angel (ID: `deity:Angel`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Lévi (ID: `person:Levi.3`); Lévi (ID: `group:Levi`); alliance (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); alliance (ID: `keyterm:Covenant`); offrande (ID: `keyterm:Offering`); profaner, déshonorer (ID: `keyterm:Dishonor`); aimer (ID: `keyterm:Love`); Juda (ID: `person:Judah.4`); délice (ID: `keyterm:Delight`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `group:Judah`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); aimer (ID: `keyterm:Love`); Juda (ID: `person:Judah.4`); profaner, déshonorer (ID: `keyterm:Dishonor`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); offrande (ID: `keyterm:Offering`); jurer (ID: `keyterm:Swear`); alliance (ID: `keyterm:Covenant`); A Group of People (ID: `group:GenericGroup`); sans saleté (ID: `keyterm:Pure`); craindre (ID: `keyterm:Fear`); Lévi (ID: `group:Levi`); An Angel (ID: `deity:Angel`); Juda (ID: `person:Judah.4`); Lévi (ID: `person:Levi.3`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `group:Judah`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); limite (ID: `keyterm:Decree`); benir (ID: `keyterm:Bless`); offrande (ID: `keyterm:Offering`); pleurer (ID: `keyterm:Curse`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Sorghum (ID: `flora:Sorghum`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); être attiré à servir (ID: `keyterm:EnticedToServe`); craindre (ID: `keyterm:Fear`); Animal Pen (ID: `realia:AnimalPen`); Scroll (ID: `realia:Scroll`); Cattle (ID: `fauna:Bull`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); limite (ID: `keyterm:Decree`); Moïse (ID: `person:Moses`); montagne de Sinaï (ID: `place:SinaiMount`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); limite (ID: `keyterm:Decree`); Moïse (ID: `person:Moses`); Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); montagne de Sinaï (ID: `place:SinaiMount`); objet qui doit être détruit (ID: `keyterm:SomethingDevotedToGod`); Instruction (ID: `keyterm:Instruction`); Élie (ID: `person:Elijah`)
...
* **Associated ACAI Concepts:** objet qui doit être détruit (ID: `keyterm:SomethingDevotedToGod`); Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); Élie (ID: `person:Elijah`)
