...
* **Associated ACAI Concepts:** Éphrata (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Kiljon (ID: `person:Chilion`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); Juda (ID: `group:Judah`); Bethléhem (ID: `place:Bethlehem`); Juda (ID: `person:Judah.4`); Élimélec (ID: `person:Elimelech`); Moab (ID: `place:Moab`); Machlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); Bethléhem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** grâce (ID: `keyterm:Favor`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); laissiez en possession (ID: `keyterm:Possess`); Boaz (ID: `person:Boaz`); Naomi (ID: `person:Naomi`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); Bethléhem (ID: `place:Bethlehem`); Léa (ID: `person:Leah`); Elders (ID: `group:GenericElders`); Rachel (ID: `person:Rachel`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Naomi (ID: `person:Naomi`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); benir (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Hetsron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Obed (ID: `person:Obed`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Boaz (ID: `person:Boaz`); Isaï (ID: `person:Jesse`); Nahshon (ID: `person:Nahshon`); David (ID: `person:David`); Perets (ID: `person:Perez`)
