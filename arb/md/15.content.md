...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); ٱلرَّبِّ (ID: `deity:Lord`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`); Word of the Lord (ID: `keyterm:WordOfTheLord`); إِرْمِيَا (ID: `person:Jeremiah.6`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `group:Benjamin`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `person:Benjamin`); يَهوذَا (ID: `person:Judah.4`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); لَّاوِي (ID: `group:Levi`); سلَيْمَانَ (ID: `person:Solomon`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `person:Levi.3`); يَشوعَ (ID: `person:Jeshua.3`); نَحَمْيَا (ID: `person:Nehemiah`); رَصِينَ (ID: `person:Rezin.2`); Pahath-moab (ID: `person:Pahath-moab`); حَارِيمَ (ID: `person:Harim`); سَلْمَايَ (ID: `person:Shalmai`); فَاسِيحَ (ID: `person:Paseah.2`); جَدِّيلَ (ID: `person:Giddel`); حَرْشَا (ID: `person:Harsha`); Tel-harsha (ID: `place:Tel-harsha`); مَغْبِيشَ (ID: `place:Magbish`); سَنَاءَةَ (ID: `place:Senaah`); مَحِيدَا (ID: `person:Mehida`); حَطِيفَا (ID: `person:Hatipha`); فَادونَ (ID: `person:Padon`); رَحوم (ID: `person:Rehum`); جَزَّامَ (ID: `person:Gazzam`); صِيحَا (ID: `person:Ziha`); بَابَايَ (ID: `person:Bebai`); حَادِيدَ (ID: `place:Hadid`); حَرْحورَ (ID: `person:Harhur`); حَقوفَا (ID: `person:Hakupha`); يورَةَ (ID: `person:Jorah`); طوبِيَّا (ID: `person:Tobiah`)
...
* **Associated ACAI Concepts:** بِغْوَايَ (ID: `person:Bigvai`); نَحَمْيَا (ID: `person:Nehemiah`); سَرَايَا (ID: `person:Seraiah.6`); رَعْلَايَا (ID: `person:Reelaiah`); بَعْنَةَ (ID: `person:Baanah.3`); مِسْفَار (ID: `person:Mispar`); رَحوم (ID: `person:Rehum`); بِلْشَان (ID: `person:Bilshan`); مرْدَخَاي (ID: `person:Mordecai`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** يَشوعَ (ID: `person:Jeshua.3`); فَرْعوشَ (ID: `person:Parosh`); Pahath-moab (ID: `person:Pahath-moab`); عَادِينَ (ID: `person:Adin`); عِيلَامَ (ID: `person:Elam`); بَانِيَ (ID: `person:Bani`); حَشوم (ID: `person:Hashum`); يوآب (ID: `person:Joab.3`); آرَحَ (ID: `person:Arah.2`); زَتّو (ID: `person:Zattu.2`); زَكَّايَ (ID: `person:Zaccai.2`); بَابَايَ (ID: `person:Bebai`); آطِيرَ (ID: `person:Ater`); بِغْوَايَ (ID: `person:Bigvai.2`); عَرْجَدَ (ID: `person:Azgad`); يورَةَ (ID: `person:Jorah`); حَزَقِيَّا (ID: `person:Hezekiah.2`); أَدونِيقَامَ (ID: `person:Adonikam`); بِيصَايَ (ID: `person:Bezai`); شَفَطْيَا (ID: `person:Shephatiah.6`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Beth-azmaveth (ID: `place:Beth-azmaveth`); مَغْبِيشَ (ID: `place:Magbish`); سَنَاءَةَ (ID: `place:Senaah`); حَادِيدَ (ID: `place:Hadid`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); نَبو (ID: `place:Nebo.2`); حَارِيمَ (ID: `person:Harim.2`); Kiriath-jearim (ID: `place:Kiriath-jearim`); Bethel (ID: `place:Bethel`); عِيلَامَ (ID: `person:Elam`); مِنْ (ID: `place:Geba`); ٱلْكَفِيرَة (ID: `place:Chephirah`); وَلودَ (ID: `place:Lod`); عَايٍ (ID: `place:Ai`); مِخْمَاسَ (ID: `place:Michmash`); عَنَاثوثَ (ID: `place:Anathoth`); أَرِيحَا (ID: `place:Jericho`); لَحْمٍ (ID: `place:Bethlehem`); أونوَ (ID: `place:Ono`); بَئِيروت (ID: `place:Beeroth`); Ramah (ID: `place:Ramah.2`)
...
* **Associated ACAI Concepts:** لِإِيمِيرَ (ID: `person:Immer.2`); طَلْمون (ID: `person:Talmon`); آطِيرَ (ID: `person:Ater.2`); يَدَايَا (ID: `person:Jedaiah.4`); يَشوعَ (ID: `person:Jeshua.4`); حَارِيمَ (ID: `person:Harim`); حَطِيطَا (ID: `person:Hatita`); شوبَايَ (ID: `person:Shobai`); يَشوعَ (ID: `person:Jeshua`); هودَوْيَا (ID: `person:Hodaviah.4`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); شَلّوم (ID: `person:Shallum.8`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); فَشْحور (ID: `person:Pashhur`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** طَلْمون (ID: `person:Talmon`); آطِيرَ (ID: `person:Ater.2`); شوبَايَ (ID: `person:Shobai`); حَطِيطَا (ID: `person:Hatita`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`); شَلّوم (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** رَصِينَ (ID: `person:Rezin.2`); رَآيَا (ID: `person:Reaiah.3`); بَصْلوتَ (ID: `person:Bazluth`); سَلْمَايَ (ID: `person:Shalmai`); فَاسِيحَ (ID: `person:Paseah.2`); جَدِّيلَ (ID: `person:Giddel`); حَرْشَا (ID: `person:Harsha`); بِيسَايَ (ID: `person:Besai`); حَطِيفَا (ID: `person:Hatipha`); مَحِيدَا (ID: `person:Mehida`); أَسْنَةَ (ID: `person:Asnah`); فَادونَ (ID: `person:Padon`); عَقّوب (ID: `person:Akkub.3`); طَبَاعوتَ (ID: `person:Tabbaoth`); صِيحَا (ID: `person:Ziha`); جَزَّامَ (ID: `person:Gazzam`); حَانَان (ID: `person:Hanan.4`); حَجَابَةَ (ID: `person:Hagabah`); لَبَانَةَ (ID: `person:Lebanah`); بَقْبوقَ (ID: `person:Bakbuk`); حَرْحورَ (ID: `person:Harhur`); ثَامَحَ (ID: `person:Temah`); حَقوفَا (ID: `person:Hakupha`); حَاجَابَ (ID: `person:Hagab`); سِيسَرَا (ID: `person:Sisera.2`); Meunim (ID: `group:Meunim`); سِيعَهَا (ID: `person:Siaha`); بَرْقوسَ (ID: `person:Barkos`); قِيروسَ (ID: `person:Keros`); حَسوفَا (ID: `person:Hasupha`); نَصِيحَ (ID: `person:Neziah`); Nephushesim (ID: `group:Nephushesim`); فِي (ID: `person:Uzza.2`); نَقودَا (ID: `person:Nekoda`); جَاحَرَ (ID: `person:Gahar`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); يَعْلَةَ (ID: `person:Jaalah`); فَرودَا (ID: `person:Peruda`); جَدِّيلَ (ID: `person:Giddel.2`); حَطِّيلَ (ID: `person:Hattil`); شَفَطْيَا (ID: `person:Shephatiah.7`); دَرْقونَ (ID: `person:Darkon`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); سَوْطَايَ (ID: `person:Sotai`); سوفَرَثَ (ID: `person:Sophereth`); آمِي (ID: `person:Ami`)
...
* **Associated ACAI Concepts:** لِدَلَايَا (ID: `person:Delaiah.3`); لِإِيمِيرَ (ID: `place:Immer`); كَروب (ID: `place:Cherub`); أَدَّان (ID: `place:Addan`); طوبِيَّا (ID: `person:Tobiah`); نَقودَا (ID: `person:Nekoda.2`); Tel-melah (ID: `place:Tel-melah`); Tel-harsha (ID: `place:Tel-harsha`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** حَبَايَا (ID: `person:Habaiah`); هَقّوصَ (ID: `person:Hakkoz.2`); بَرْزِلَّايَ (ID: `person:Barzillai.3`); Gileadites (ID: `group:Gilead`); بَرْزِلَّايَ (ID: `person:Barzillai`); Priesthood (ID: `keyterm:Priesthood`); Defile (ID: `keyterm:Stain`); جِلْعَادَ (ID: `place:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); Strength (ID: `keyterm:Strength`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); Mina (ID: `realia:Mina`); Tunic (ID: `realia:Tunic`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); يَشوع (ID: `person:Joshua.5`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Esarhaddon (ID: `person:Esarhaddon`); حِينَادَادَ (ID: `person:Henadad`); يَشوعَ (ID: `person:Jeshua.4`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); Relatives (ID: `group:Relatives`); هودَوْيَا (ID: `person:Hodaviah.4`); Sidonians (ID: `group:Sidon`); صِيْدونَ (ID: `place:Sidon`); لبْنَانَ (ID: `place:Lebanon`); دَاودَ (ID: `person:David`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Kindness (ID: `keyterm:Kindness`); Terror (ID: `keyterm:Terror`); Holy (ID: `keyterm:Holy`); بَنْيَامِينَ (ID: `group:Benjamin`); دَارِيوسَ (ID: `person:Darius.2`); Appointed Feast (ID: `keyterm:AppointedFeast`); بَنْيَامِينَ (ID: `person:Benjamin`); Tyrians (ID: `group:Tyre`); موسَى (ID: `person:Moses`); صورَ (ID: `place:Tyre`); Assyria (ID: `place:Assyria`); Instruction (ID: `keyterm:Instruction`); يَافَا (ID: `place:Joppa`); آسَاف (ID: `person:Asaph.2`); Counsel (ID: `keyterm:Counsel`); هودِيَّا (ID: `person:Hodiah.2`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Cedar (ID: `flora:Cedar`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); Instruction (ID: `keyterm:Instruction`); ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); موسَى (ID: `person:Moses`); إِسْرَائِيلَ (ID: `person:Israel`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Terror (ID: `keyterm:Terror`); ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Sidonians (ID: `group:Sidon`); صِيْدونَ (ID: `place:Sidon`); صورَ (ID: `place:Tyre`); لبْنَانَ (ID: `place:Lebanon`); يَافَا (ID: `place:Joppa`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); Tyrians (ID: `group:Tyre`); Craftsman (ID: `realia:Craftsman`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Cedar (ID: `flora:Cedar`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); يَهوصَادِقَ (ID: `person:Jehozadak`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); دَاودَ (ID: `person:David`); آسَاف (ID: `person:Asaph.2`); Kindness (ID: `keyterm:Kindness`); Trumpet (ID: `realia:Trumpet`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `group:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `person:Benjamin`); يَهوذَا (ID: `person:Judah.4`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); يَشوع (ID: `person:Joshua.5`); كورَشَ (ID: `person:Cyrus`); ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); فَارِسَ (ID: `place:Persia`); إِسْرَائِيلَ (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** فَارِسَ (ID: `place:Persia`); دَارِيوسَ (ID: `person:Darius.2`); Counsel (ID: `keyterm:Counsel`); كورَشَ (ID: `person:Cyrus`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْفرَاتِ (ID: `place:Euphrates`); رَحوم (ID: `person:Rehum.2`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); فَارِسَ (ID: `place:Persia`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Jews (ID: `group:Jews`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); أَرَكَ (ID: `place:Erech`); مِثْرَدَاث (ID: `person:Mithredath.2`); طَبْئِيل (ID: `person:Tabeel`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); أسْنَفَّر (ID: `person:Osnappar`); بِشْلَام (ID: `person:Bishlam`); Babylonians (ID: `group:Babylon`); بَابِلَ (ID: `place:Babylon`); يَهوذَا (ID: `group:Judah`); فِي (ID: `place:Susa`); عِيلَامَ (ID: `place:Elam`); Persians (ID: `group:Persia`); Elamites (ID: `group:Elam`); يَهوذَا (ID: `person:Judah.4`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** أَرَكَ (ID: `place:Erech`); رَحوم (ID: `person:Rehum.2`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); شِمْشَاي (ID: `person:Shimshai`); Babylonians (ID: `group:Babylon`); عِيلَامَ (ID: `place:Elam`); Persians (ID: `group:Persia`); Elamites (ID: `group:Elam`); بَابِلَ (ID: `place:Babylon`); فَارِسَ (ID: `place:Persia`); فِي (ID: `place:Susa`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); رَحوم (ID: `person:Rehum.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); ٱلسَّامِرَةِ (ID: `place:Samaria`); شِمْشَاي (ID: `person:Shimshai`); Jews (ID: `group:Jews`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); دَارِيوسَ (ID: `person:Darius.2`); Jews (ID: `group:Jews`); تَتْنَاي (ID: `person:Tattenai`); يَدّو (ID: `person:Iddo.6`); حَجَّيِ (ID: `person:Haggai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); زَكَرِيَّا (ID: `person:Zechariah.17`); يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); ٱلْفرَاتِ (ID: `place:Euphrates`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `person:Judah.4`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** يَدّو (ID: `person:Iddo.6`); زَكَرِيَّا (ID: `person:Zechariah.17`); حَجَّيِ (ID: `person:Haggai`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Jews (ID: `group:Jews`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); أورشَلِيمَ (ID: `place:Jerusalem`); زَربَّابِل (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); بَابِلَ (ID: `place:Babylon`); أورشَلِيمَ (ID: `place:Jerusalem`); كورَشَ (ID: `person:Cyrus`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); دَارِيوسَ (ID: `person:Darius.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); تَتْنَاي (ID: `person:Tattenai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); ٱلْفرَاتِ (ID: `place:Euphrates`); يَهوذَا (ID: `person:Judah.4`); Chaldeans (ID: `group:Chaldea`); إِسْرَائِيلَ (ID: `person:Israel`); Foundation (ID: `realia:Foundation`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); كورَشَ (ID: `person:Cyrus`); بَابِلَ (ID: `place:Babylon`); زَربَّابِل (ID: `person:Zerubbabel.2`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** عَزَرْيَا (ID: `person:Azariah.7`); عَزْرَا (ID: `person:Ezra`); سَرَايَا (ID: `person:Seraiah.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فَارِسَ (ID: `place:Persia`); حِلْقِيَّا (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); لِمَرَايوثَ (ID: `person:Meraioth`); شَلّوم (ID: `person:Shallum.7`); عَزَرْيَا (ID: `person:Azariah.6`); أَمَرْيَا (ID: `person:Amariah.2`); بقِّي (ID: `person:Bukki.2`); صَادوق (ID: `person:Zadok.4`); زَرَحْيَا (ID: `person:Zerahiah`); عزِّي (ID: `person:Uzzi`); سَرَايَا (ID: `person:Seraiah.2`); أَبِيشوعَ (ID: `person:Abishua`); أَخِيطوبَ (ID: `person:Ahitub.3`); عَزَرْيَا (ID: `person:Azariah.7`); هَارون (ID: `person:Aaron`); فِينَحَاس (ID: `person:Phinehas`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فَارِسَ (ID: `place:Persia`); حِلْقِيَّا (ID: `person:Hilkiah.2`); أَلِعَازَار (ID: `person:Eleazar.2`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); عَزْرَا (ID: `person:Ezra`); ٱلرَّبِّ (ID: `deity:Lord`); Decree (ID: `keyterm:Decree`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); ٱلْفرَاتِ (ID: `place:Euphrates`); عَزْرَا (ID: `person:Ezra`); Kor (ID: `realia:Kor`); Money (ID: `realia:Money`); Talent (ID: `realia:Talent`); Olive Oil (ID: `realia:OliveOil`); Wheat (ID: `flora:Wheat`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** عوبَدْيَا (ID: `person:Obadiah.10`); عَثَلْيَا (ID: `person:Athaliah.3`); عوتَاي (ID: `person:Uthai.2`); حَطّوش (ID: `person:Hattush.2`); Pahath-moab (ID: `person:Pahath-moab`); عَادِينَ (ID: `person:Adin`); عِيلَامَ (ID: `person:Elam`); أَلِيفَلَط (ID: `person:Eliphelet.5`); يونَاثَانَ (ID: `person:Jonathan.9`); يوآب (ID: `person:Joab.4`); شِمْعِيَا (ID: `person:Shemaiah.14`); يوشَفْيَا (ID: `person:Josiphiah`); زَبَدْيَا (ID: `person:Zebadiah.8`); يَعِيئِيل (ID: `person:Jeuel.3`); بَابَايَ (ID: `person:Bebai.2`); Gershom (ID: `person:Gershom.2`); يَحِيئِيل (ID: `person:Jehiel.7`); بَابَايَ (ID: `person:Bebai`); يوحَانَانَ (ID: `person:Johanan.8`); عَابِد (ID: `person:Ebed.2`); شَكَنْيَا (ID: `person:Shecaniah.6`); يَحْزِيئِيل (ID: `person:Jahaziel.5`); زَكَرِيَّا (ID: `person:Zechariah.19`); فَرْعوشَ (ID: `person:Parosh.2`); بِغْوَايَ (ID: `person:Bigvai.2`); عَرْجَدَ (ID: `person:Azgad`); شَلومِيَةَ (ID: `person:Shelomith.4`); زَرَحْيَا (ID: `person:Zerahiah.2`); هِقَّاطَانَ (ID: `person:Hakkatan`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); مِيخَائِيلَ (ID: `person:Michael.10`); أَدونِيقَامَ (ID: `person:Adonikam`); دَانِيآل (ID: `person:Daniel.2`); زَكّور (ID: `person:Zaccur.5`); شَكَنْيَا (ID: `person:Shecaniah.5`); يِشْعِيَا (ID: `person:Jeshaiah.4`); زَكَرِيَّا (ID: `person:Zechariah.18`); شَفَطْيَا (ID: `person:Shephatiah.6`); بَابِلَ (ID: `place:Babylon`); دَاودَ (ID: `person:David`); فِينَحَاس (ID: `person:Phinehas`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); إِيثَامَارَ (ID: `person:Ithamar`)
...
* **Associated ACAI Concepts:** أَلِيعَزَرَ (ID: `person:Eliezer.8`); مَشلَّام (ID: `person:Meshullam.9`); زَكَرِيَّا (ID: `person:Zechariah.20`); أَرِيئِيلَ (ID: `person:Ariel`); يَارِيبَ (ID: `person:Jarib.2`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); يَدّو (ID: `person:Iddo`); يويَارِيبَ (ID: `person:Joiarib.2`); نَاثَان (ID: `person:Nathan.5`); شِمْعِيَا (ID: `person:Shemaiah.15`); ٱلْمسَمَّى (ID: `place:Casiphia`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); Perceive (ID: `keyterm:Perceive`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Insight (ID: `keyterm:Insight`); ٱلرَّبِّ (ID: `deity:Lord`); مَحْلِي (ID: `person:Mahli`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); Ammonites (ID: `group:Ammon`); لَّاوِي (ID: `person:Levi.3`); حِثًّا (ID: `person:Heth`); موآبَ (ID: `place:Moab`); لَّاوِي (ID: `group:Levi`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); كَنْعَان (ID: `place:Canaan`); Jebusites (ID: `group:Jebusites`); Canaanites (ID: `group:Canaan`); Egyptians (ID: `group:Egypt`); Be Unfaithful (ID: `keyterm:Unfaithful`); مِصْرَ (ID: `place:Egypt`); Amorites (ID: `group:Amorites`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); Passion (ID: `keyterm:Ardour`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); يَهوذَا (ID: `person:Judah.4`); عِيلَامَ (ID: `person:Elam`); Counsel (ID: `keyterm:Counsel`); يَهوذَا (ID: `group:Judah`); Offering (ID: `keyterm:Offering`); أَلِيوعِينَاي (ID: `person:Elioenai.5`); كَلَال (ID: `person:Chelal`); يَحِيئِيل (ID: `person:Jehiel.8`); عَثْلَاي (ID: `person:Athlai`); شِمْعِي (ID: `person:Shimei.17`); بَنَايَا (ID: `person:Benaiah.8`); ويَرِيمَاي (ID: `person:Jeremai`); مَنَسَّى (ID: `person:Manasseh.4`); أوئِيل (ID: `person:Uel`); مَلْكِيَّا (ID: `person:Malchijah.5`); شَكَنْيَا (ID: `person:Shecaniah.7`); مَعْسِيَّا (ID: `person:Maaseiah.9`); مَتَّنْيَا (ID: `person:Mattaniah.8`); يَحْزِيَا (ID: `person:Jahzeiah`); بَنّويَ (ID: `person:Binnui.3`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); Plea for Mercy (ID: `keyterm:Supplication`); To Cause to Possess (ID: `keyterm:Possess`); Peace (ID: `keyterm:IntactState`); Defilement (ID: `keyterm:Defilement`); Dispossess (ID: `keyterm:Dispossess`); أورشَلِيمَ (ID: `place:Jerusalem`); فَارِسَ (ID: `place:Persia`); Kindness (ID: `keyterm:Kindness`); إِسْرَائِيلَ (ID: `person:Israel`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); Plea for Mercy (ID: `keyterm:Supplication`); أورشَلِيمَ (ID: `place:Jerusalem`); فَارِسَ (ID: `place:Persia`); Kindness (ID: `keyterm:Kindness`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَكَنْيَا (ID: `person:Shecaniah.7`); يَحِيئِيل (ID: `person:Jehiel.8`); عَزْرَا (ID: `person:Ezra`); ٱلرَّبِّ (ID: `deity:Lord`); عِيلَامَ (ID: `person:Elam`); Be Unfaithful (ID: `keyterm:Unfaithful`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `group:Benjamin`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `person:Benjamin`); يَهوذَا (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يونَاثَانَ (ID: `person:Jonathan.10`); عَسَائِيل (ID: `person:Asahel.4`); مَشلَّام (ID: `person:Meshullam.10`); يَحْزِيَا (ID: `person:Jahzeiah`); شَبْتَاي (ID: `person:Shabbethai`); تِقْوَةَ (ID: `person:Tikvah.2`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`)
