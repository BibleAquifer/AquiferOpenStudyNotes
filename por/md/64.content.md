...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); andar (ID: `keyterm:Live.3`); amado (ID: `keyterm:Beloved`); Gaio (ID: `person:Gaius.4`); testemunhar (ID: `keyterm:BearWitness`); love (ID: `keyterm:Love`); orar (ID: `keyterm:Pray`); Cause of Joy (ID: `keyterm:CauseOfJoy`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); testemunhar (ID: `keyterm:BearWitness`); love (ID: `keyterm:Love`); Name (ID: `keyterm:Name`); dever (ID: `keyterm:Ought`); amado (ID: `keyterm:Beloved`); Faithfulness (ID: `keyterm:Faithfulness`); igreja (ID: `keyterm:Church`); Truth (ID: `keyterm:Truth`)
...
* **Associated ACAI Concepts:** igreja (ID: `keyterm:Church`); Demétrio (ID: `person:Demetrius`); Diótrefes (ID: `person:Diotrephes`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); testemunhar (ID: `keyterm:BearWitness`); verdadeiro (ID: `keyterm:True`); Do Good (ID: `keyterm:DoGood`); amado (ID: `keyterm:Beloved`); Truth (ID: `keyterm:Truth`)
