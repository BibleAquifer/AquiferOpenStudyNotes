...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); Édom (ID: `group:Edom`); Éternel (ID: `deity:Lord`); Édom (ID: `place:Edom`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); alliance (ID: `keyterm:Covenant`); offrande (ID: `keyterm:Offering`); craindre (ID: `keyterm:Fear`); Lévi (ID: `group:Levi`); gloire (ID: `keyterm:Glory`); état intact (ID: `keyterm:IntactState`); Lévi (ID: `person:Levi.3`); Priests (ID: `group:GenericPriests`); pleurer (ID: `keyterm:Curse`); souiller (ID: `keyterm:Stain`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); niveau (ID: `keyterm:Fairness`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); sans saleté (ID: `keyterm:Pure`); faire un voeu (ID: `keyterm:Vow`); vérité (ID: `keyterm:Truth`); agir avec bonté (ID: `keyterm:KindlyDisposed`); la connaissance (ID: `keyterm:Intention`); nation; peuple (ID: `group:Gentile`); profaner, déshonorer (ID: `keyterm:Dishonor`); benir (ID: `keyterm:Bless`); prier (ID: `keyterm:AskFor`); ardeur (ID: `keyterm:Ardour`); chemin (ID: `keyterm:TheWay`); An Angel (ID: `deity:Angel`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); la connaissance (ID: `keyterm:Intention`); Instruction (ID: `keyterm:Instruction`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); alliance (ID: `keyterm:Covenant`); offrande (ID: `keyterm:Offering`); profaner, déshonorer (ID: `keyterm:Dishonor`); aimer (ID: `keyterm:Love`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); délice (ID: `keyterm:Delight`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`); profaner, déshonorer (ID: `keyterm:Dishonor`); Juda (ID: `person:Judah.4`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); offrande (ID: `keyterm:Offering`); alliance (ID: `keyterm:Covenant`); Lévi (ID: `person:Levi.3`); An Angel (ID: `deity:Angel`); Juda (ID: `group:Judah`); Jérusalem (ID: `place:Jerusalem`); sans saleté (ID: `keyterm:Pure`); craindre (ID: `keyterm:Fear`); Juda (ID: `person:Judah.4`); jurer (ID: `keyterm:Swear`); A Group of People (ID: `group:GenericGroup`); Lévi (ID: `group:Levi`); Soap (ID: `realia:Soap`); Hammada (ID: `flora:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); limite (ID: `keyterm:Decree`); offrande (ID: `keyterm:Offering`); benir (ID: `keyterm:Bless`); pleurer (ID: `keyterm:Curse`); Israël (ID: `person:Israel`); Vine (ID: `flora:Vine`); Sorghum (ID: `flora:Sorghum`); Wheat (ID: `flora:Wheat`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** limite (ID: `keyterm:Decree`); Moïse (ID: `person:Moses`); montagne de Sinaï (ID: `place:SinaiMount`); Instruction (ID: `keyterm:Instruction`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** limite (ID: `keyterm:Decree`); Moïse (ID: `person:Moses`); montagne de Sinaï (ID: `place:SinaiMount`); craindre (ID: `keyterm:Fear`); objet qui doit être détruit (ID: `keyterm:SomethingDevotedToGod`); Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Élie (ID: `person:Elijah`); Israël (ID: `person:Israel`)
