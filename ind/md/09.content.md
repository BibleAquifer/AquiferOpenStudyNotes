...
* **Associated ACAI Concepts:** Paran (ID: `place:Paran`); Rama (ID: `place:Ramah`); Israel (ID: `person:Israel`); Samuel (ID: `person:Samuel`); Daud (ID: `person:David`); House (ID: `realia:House`)
