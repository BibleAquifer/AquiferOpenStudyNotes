...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); Judas (ID: `person:Jude`); Tiago (ID: `person:James.3`); SENHOR (ID: `deity:Lord`); misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** rogar (ID: `keyterm:AskFor`); holy (ID: `keyterm:Holy`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); amado (ID: `keyterm:Beloved`); comum (ID: `keyterm:InCommon`); empenho (ID: `keyterm:Eagerness`)
...
* **Associated ACAI Concepts:** rogar (ID: `keyterm:AskFor`); holy (ID: `keyterm:Holy`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); juízo (ID: `keyterm:Judgment`); amado (ID: `keyterm:Beloved`); Jesus (ID: `person:Jesus.2`); comum (ID: `keyterm:InCommon`); empenho (ID: `keyterm:Eagerness`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); favor (ID: `keyterm:Favor`); juízo (ID: `keyterm:Judgment`)
...
* **Associated ACAI Concepts:** juízo (ID: `keyterm:Judgment`); para a eternidade (ID: `keyterm:Always`); blasfemar (ID: `keyterm:Blaspheme`); corpo (ID: `keyterm:Body.3`); tribunal de justiça (ID: `keyterm:CourtCase`); SENHOR (ID: `deity:Lord`); Corá (ID: `person:Korah.3`); An Angel (ID: `deity:Angel`); defilement (ID: `keyterm:Defilement`); salvation (ID: `keyterm:Salvation`); Sodoma (ID: `place:Sodom`); Miguel (ID: `person:Michael.11`); ágape (ID: `keyterm:FellowshipMeal`); speak (ID: `keyterm:Speak`); distinguir (ID: `keyterm:Discern`); Gomorra (ID: `place:Gomorrah`); Moisés (ID: `person:Moses`); Balaão (ID: `person:Balaam`); Ability (ID: `keyterm:Ability`); Jesus (ID: `person:Jesus.2`); Disaster (ID: `keyterm:Disaster`); Egito (ID: `place:Egypt`); To Command (ID: `keyterm:Command`); fogo eterno (ID: `keyterm:EternalFire`); holy (ID: `keyterm:Holy`); crer (ID: `keyterm:Believe`); Caim (ID: `person:Cain`); Enoque (ID: `person:Enoch.2`); Adão (ID: `person:Adam`); Chain (ID: `realia:Chain`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** fogo eterno (ID: `keyterm:EternalFire`); Sodoma (ID: `place:Sodom`); corpo (ID: `keyterm:Body.3`); Gomorra (ID: `place:Gomorrah`); para a eternidade (ID: `keyterm:Always`)
...
* **Associated ACAI Concepts:** To Command (ID: `keyterm:Command`); blasfemar (ID: `keyterm:Blaspheme`); tribunal de justiça (ID: `keyterm:CourtCase`); SENHOR (ID: `deity:Lord`); juízo (ID: `keyterm:Judgment`); distinguir (ID: `keyterm:Discern`); corpo (ID: `keyterm:Body.3`); Moisés (ID: `person:Moses`); Miguel (ID: `person:Michael.11`)
...
* **Associated ACAI Concepts:** tribunal de justiça (ID: `keyterm:CourtCase`); holy (ID: `keyterm:Holy`); SENHOR (ID: `deity:Lord`); speak (ID: `keyterm:Speak`); juízo (ID: `keyterm:Judgment`); Enoque (ID: `person:Enoch.2`); Adão (ID: `person:Adam`)
...
* **Associated ACAI Concepts:** misericórdia (ID: `keyterm:Mercy`); amado (ID: `keyterm:Beloved`); Jesus (ID: `person:Jesus.2`); Holy Spirit (ID: `deity:HolySpirit`); fear (ID: `keyterm:Fear`); salvation (ID: `keyterm:Salvation`); palavra (ID: `keyterm:Word`); orar (ID: `keyterm:Pray`); distinguir (ID: `keyterm:Discern`); para a eternidade (ID: `keyterm:Always`); causar divisões (ID: `keyterm:CreatingDivisions`); corpo (ID: `keyterm:Body.3`); holy (ID: `keyterm:Holy`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); natural (ID: `keyterm:Natural`); Life (ID: `keyterm:Life`); love (ID: `keyterm:Love`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** holy (ID: `keyterm:Holy`); crer (ID: `keyterm:Believe`); Holy Spirit (ID: `deity:HolySpirit`); amado (ID: `keyterm:Beloved`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** misericórdia (ID: `keyterm:Mercy`); fear (ID: `keyterm:Fear`); salvation (ID: `keyterm:Salvation`); distinguir (ID: `keyterm:Discern`); corpo (ID: `keyterm:Body.3`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); surely! (ID: `keyterm:Surely`); autoridade (ID: `keyterm:Authority.2`); salvador (ID: `keyterm:Savior`); Jesus (ID: `person:Jesus.2`); irrepreensível (ID: `keyterm:Unblemished`); para a eternidade (ID: `keyterm:Always`)
