...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Israel (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Jeremias (ID: `person:Jeremiah.6`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Levi (ID: `group:Levi`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `person:Benjamin`); SENHOR (ID: `deity:Lord`); Benjamim (ID: `group:Benjamin`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Nabucodonozor (ID: `person:Nebuchadnezzar`); Jerusalém (ID: `place:Jerusalem`); Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Pérsia (ID: `place:Persia`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Ciro (ID: `person:Cyrus`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Salomão (ID: `person:Solomon`); Jerusalém (ID: `place:Jerusalem`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Netofa (ID: `place:Netophah`); Tel-Melá (ID: `place:Tel-melah`); Hagaba (ID: `person:Hagabah`); Jora (ID: `person:Jorah`); Neemias (ID: `person:Nehemiah`); Acube (ID: `person:Akkub.3`); Zatu (ID: `person:Zattu.2`); Uza (ID: `person:Uzza.2`); Mordecai (ID: `person:Mordecai`); Hasufa (ID: `person:Hasupha`); Hatita (ID: `person:Hatita`); Tel-Harsa (ID: `place:Tel-harsha`); Senaa (ID: `place:Senaah`); Tabaote (ID: `person:Tabbaoth`); Reelaías (ID: `person:Reelaiah`); Joabe (ID: `person:Joab.3`); Gidel (ID: `person:Giddel.2`); Soferete (ID: `person:Sophereth`); Ater (ID: `person:Ater.2`); Temá (ID: `person:Temah`); Ami (ID: `person:Ami`); Harim (ID: `person:Harim`); Hanã (ID: `person:Hanan.4`)
...
* **Associated ACAI Concepts:** Mispar (ID: `person:Mispar`); Bilsã (ID: `person:Bilshan`); Mordecai (ID: `person:Mordecai`); Neemias (ID: `person:Nehemiah`); Seraias (ID: `person:Seraiah.6`); Bigvai (ID: `person:Bigvai`); Reelaías (ID: `person:Reelaiah`); Baana (ID: `person:Baanah.3`); Reum (ID: `person:Rehum`); Josué (ID: `person:Joshua.5`); Israel (ID: `person:Israel`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Adim (ID: `person:Adin`); Jora (ID: `person:Jorah`); Hasum (ID: `person:Hashum`); Bigvai (ID: `person:Bigvai.2`); Zatu (ID: `person:Zattu.2`); Bebai (ID: `person:Bebai`); Jesua (ID: `person:Jeshua.3`); Asgade (ID: `person:Azgad`); Ezequias (ID: `person:Hezekiah.2`); Ará (ID: `person:Arah.2`); Bani (ID: `person:Bani`); Ater (ID: `person:Ater`); Parós (ID: `person:Parosh`); Adonicão (ID: `person:Adonikam`); Bezai (ID: `person:Bezai`); Sephatias (ID: `person:Shephatiah.6`); Zacai (ID: `person:Zaccai.2`); Paate-Moabe (ID: `person:Pahath-moab`); Elam (ID: `person:Elam`); Joabe (ID: `person:Joab.3`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Beth-azmaveth (ID: `place:Beth-azmaveth`); Netofa (ID: `place:Netophah`); Hadide (ID: `place:Hadid`); Nebo (ID: `place:Nebo.2`); Harim (ID: `person:Harim.2`); Senaa (ID: `place:Senaah`); Magbis (ID: `place:Magbish`); Ai (ID: `place:Ai`); Betel (ID: `place:Bethel`); Anatote (ID: `place:Anathoth`); Beerote (ID: `place:Beeroth`); Micmás (ID: `place:Michmash`); Quiriate-Jearim (ID: `place:Kiriath-jearim`); Ramah (ID: `place:Ramah.2`); Cefira (ID: `place:Chephirah`); Jericó (ID: `place:Jericho`); Belém (ID: `place:Bethlehem`); Geba (ID: `place:Geba`); Ono (ID: `place:Ono`); Elam (ID: `person:Elam`); Lode (ID: `place:Lod`)
...
* **Associated ACAI Concepts:** Jedaías (ID: `person:Jedaiah.4`); Hatita (ID: `person:Hatita`); Jesua (ID: `person:Jeshua.4`); Imer (ID: `person:Immer.2`); Jesua (ID: `person:Jeshua`); Hodavias (ID: `person:Hodaviah.4`); Ater (ID: `person:Ater.2`); Sobai (ID: `person:Shobai`); Harim (ID: `person:Harim`); Talmom (ID: `person:Talmon`); Levi (ID: `group:Levi`); Asafe (ID: `person:Asaph.2`); Cadmiel (ID: `person:Kadmiel`); Salum (ID: `person:Shallum.8`); Levi (ID: `person:Levi.3`); Acube (ID: `person:Akkub.2`); Pasur (ID: `person:Pashhur`)
...
* **Associated ACAI Concepts:** Hatita (ID: `person:Hatita`); Ater (ID: `person:Ater.2`); Sobai (ID: `person:Shobai`); Talmom (ID: `person:Talmon`); Asafe (ID: `person:Asaph.2`); Salum (ID: `person:Shallum.8`); Acube (ID: `person:Akkub.2`)
...
* **Associated ACAI Concepts:** Harsa (ID: `person:Harsha`); Hagaba (ID: `person:Hagabah`); Rezim (ID: `person:Rezin.2`); Meunim (ID: `group:Meunim`); Temá (ID: `person:Temah`); Acube (ID: `person:Akkub.3`); Besai (ID: `person:Besai`); Hanã (ID: `person:Hanan.4`); Uza (ID: `person:Uzza.2`); Meída (ID: `person:Mehida`); Nesias (ID: `person:Neziah`); Padom (ID: `person:Padon`); Reaías (ID: `person:Reaiah.3`); Harur (ID: `person:Harhur`); Hasufa (ID: `person:Hasupha`); Sisera (ID: `person:Sisera.2`); Queros (ID: `person:Keros`); Hagabe (ID: `person:Hagab`); Gazão (ID: `person:Gazzam`); Salmai (ID: `person:Shalmai`); Nephushesim (ID: `group:Nephushesim`); Gaar (ID: `person:Gahar`); Sia (ID: `person:Siaha`); Hatifa (ID: `person:Hatipha`); Lebana (ID: `person:Lebanah`); Barcos (ID: `person:Barkos`); Asná (ID: `person:Asnah`); Necoda (ID: `person:Nekoda`); Paseia (ID: `person:Paseah.2`); Baquebuque (ID: `person:Bakbuk`); Tabaote (ID: `person:Tabbaoth`); Zia (ID: `person:Ziha`); Gidel (ID: `person:Giddel`); Bazlite (ID: `person:Bazluth`); Hacufa (ID: `person:Hakupha`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Darcom (ID: `person:Darkon`); Peruda (ID: `person:Peruda`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Soferete (ID: `person:Sophereth`); Hatil (ID: `person:Hattil`); Gidel (ID: `person:Giddel.2`); Ami (ID: `person:Ami`); Sotai (ID: `person:Sotai`); Jaala (ID: `person:Jaalah`); Sephatias (ID: `person:Shephatiah.7`)
...
* **Associated ACAI Concepts:** Delaías (ID: `person:Delaiah.3`); Necoda (ID: `person:Nekoda.2`); Tel-Melá (ID: `place:Tel-melah`); Imer (ID: `place:Immer`); Tel-Harsa (ID: `place:Tel-harsha`); Adã (ID: `place:Addan`); Querube (ID: `place:Cherub`); Tobias (ID: `person:Tobiah`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Barzillai (ID: `person:Barzillai.3`); Hacoz (ID: `person:Hakkoz.2`); Habaiah (ID: `person:Habaiah`); priesthood (ID: `keyterm:Priesthood`); Gileade (ID: `place:Gilead`); Barzillai (ID: `person:Barzillai`); Gileadites (ID: `group:Gilead`); stain (ID: `keyterm:Stain`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Josué (ID: `person:Joshua.5`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Cadmiel (ID: `person:Kadmiel`); Hodavias (ID: `person:Hodaviah.4`); Henadade (ID: `person:Henadad`); Relatives (ID: `group:Relatives`); Esar-Hadom (ID: `person:Esarhaddon`); Jesua (ID: `person:Jeshua.4`); Instruction (ID: `keyterm:Instruction`); Davi (ID: `person:David`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); Benjamim (ID: `person:Benjamin`); Tiro (ID: `place:Tyre`); kindness (ID: `keyterm:Kindness`); Asafe (ID: `person:Asaph.2`); Jope (ID: `place:Joppa`); appointed feast (ID: `keyterm:AppointedFeast`); Libano (ID: `place:Lebanon`); holy (ID: `keyterm:Holy`); Hodias (ID: `person:Hodiah.2`); new moon festival (ID: `keyterm:NewMoonFestival`); Benjamim (ID: `group:Benjamin`); Moisés (ID: `person:Moses`); terror (ID: `keyterm:Terror`); Assyria (ID: `place:Assyria`); Sidonians (ID: `group:Sidon`); Dario (ID: `person:Darius.2`); Tyrians (ID: `group:Tyre`); Sidom (ID: `place:Sidon`); counsel (ID: `keyterm:Counsel`); Trumpet (ID: `realia:Trumpet`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`); Cymbals (ID: `realia:Cymbals`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Sealtiel (ID: `person:Shealtiel.2`); Moisés (ID: `person:Moses`); Instruction (ID: `keyterm:Instruction`); offering (ID: `keyterm:Offering`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** terror (ID: `keyterm:Terror`); offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Pérsia (ID: `place:Persia`); Jope (ID: `place:Joppa`); Libano (ID: `place:Lebanon`); Sidonians (ID: `group:Sidon`); Ciro (ID: `person:Cyrus`); Tyrians (ID: `group:Tyre`); Tiro (ID: `place:Tyre`); Sidom (ID: `place:Sidon`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Levi (ID: `group:Levi`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Sealtiel (ID: `person:Shealtiel.2`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Levi (ID: `group:Levi`); Asafe (ID: `person:Asaph.2`); Davi (ID: `person:David`); Levi (ID: `person:Levi.3`); kindness (ID: `keyterm:Kindness`); Cymbals (ID: `realia:Cymbals`); House (ID: `realia:House`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Benjamim (ID: `person:Benjamin`); SENHOR (ID: `deity:Lord`); Benjamim (ID: `group:Benjamin`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Pérsia (ID: `place:Persia`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Ciro (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Rio Eufrates (ID: `place:Euphrates`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Samaria (ID: `place:Samaria`); Pérsia (ID: `place:Persia`); Jews (ID: `group:Jews`); Mitredate (ID: `person:Mithredath.2`); Tabeel (ID: `person:Tabeel`); Ereque (ID: `place:Erech`); Dinaítas (ID: `person:Dinaite`); Babylonians (ID: `group:Babylon`); Assuero (ID: `person:Ahasuerus`); Osnapar (ID: `person:Osnappar`); Bislão (ID: `person:Bishlam`); Judá (ID: `person:Judah.4`); Susã (ID: `place:Susa`); Judá (ID: `group:Judah`); Elam (ID: `place:Elam`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); Babilônia (ID: `place:Babylon`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Reum (ID: `person:Rehum.2`); Ereque (ID: `place:Erech`); Babylonians (ID: `group:Babylon`); Dinaítas (ID: `person:Dinaite`); Sinsai (ID: `person:Shimshai`); Persians (ID: `group:Persia`); Pérsia (ID: `place:Persia`); Susã (ID: `place:Susa`); Babilônia (ID: `place:Babylon`); Elam (ID: `place:Elam`); Elamites (ID: `group:Elam`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Artaxerxes (ID: `person:Artaxerxes.2`); Samaria (ID: `place:Samaria`); Reum (ID: `person:Rehum.2`); Jews (ID: `group:Jews`); Sinsai (ID: `person:Shimshai`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); Dario (ID: `person:Darius.2`); Ageu (ID: `person:Haggai`); Tattenai (ID: `person:Tattenai`); Zacarias (ID: `person:Zechariah.17`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Ido (ID: `person:Iddo.6`); Jeozadaque (ID: `person:Jehozadak`); Pérsia (ID: `place:Persia`); Josué (ID: `person:Joshua.5`); Israel (ID: `person:Israel`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `person:Judah.4`); Sealtiel (ID: `person:Shealtiel.2`); Rio Eufrates (ID: `place:Euphrates`)
...
* **Associated ACAI Concepts:** Ageu (ID: `person:Haggai`); Zacarias (ID: `person:Zechariah.17`); Ido (ID: `person:Iddo.6`); Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); Jews (ID: `group:Jews`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Sealtiel (ID: `person:Shealtiel.2`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Levi (ID: `group:Levi`); Moisés (ID: `person:Moses`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `person:Levi.3`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** passover (ID: `keyterm:Passover`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); pure (ID: `keyterm:Pure`)
...
* **Associated ACAI Concepts:** defilement (ID: `keyterm:Defilement`); Gentiles (ID: `group:Gentile`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Azarias (ID: `person:Azariah.7`); Ezra (ID: `person:Ezra`); Seraias (ID: `person:Seraiah.2`); Pérsia (ID: `place:Persia`); Hilquias (ID: `person:Hilkiah.2`); Artaxerxes (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Aitube (ID: `person:Ahitub.3`); Amarias (ID: `person:Amariah.2`); Seraias (ID: `person:Seraiah.2`); Uzi (ID: `person:Uzzi`); Azarias (ID: `person:Azariah.7`); Azarias (ID: `person:Azariah.6`); Meraiote (ID: `person:Meraioth`); Buqui (ID: `person:Bukki.2`); Zadoque (ID: `person:Zadok.4`); Zeraías (ID: `person:Zerahiah`); Salum (ID: `person:Shallum.7`); Abisua (ID: `person:Abishua`); Pérsia (ID: `place:Persia`); Hilquias (ID: `person:Hilkiah.2`); Artaxerxes (ID: `person:Artaxerxes`); Eleazar (ID: `person:Eleazar.2`); Fineias (ID: `person:Phinehas`); Arão (ID: `person:Aaron`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Moisés (ID: `person:Moses`); Instruction (ID: `keyterm:Instruction`); Babilônia (ID: `place:Babylon`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** decree (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Artaxerxes (ID: `person:Artaxerxes`); Ezra (ID: `person:Ezra`); Rio Eufrates (ID: `place:Euphrates`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Talent (ID: `realia:Talent`); Wheat (ID: `flora:Wheat`); Money (ID: `realia:Money`); Kor (ID: `realia:Kor`)
...
* **Associated ACAI Concepts:** Zacur (ID: `person:Zaccur.5`); Adim (ID: `person:Adin`); Secanias (ID: `person:Shecaniah.6`); Atalia (ID: `person:Athaliah.3`); Jônatas (ID: `person:Jonathan.9`); Utai (ID: `person:Uthai.2`); Bigvai (ID: `person:Bigvai.2`); Obadias (ID: `person:Obadiah.10`); Bebai (ID: `person:Bebai`); Asgade (ID: `person:Azgad`); Selomite (ID: `person:Shelomith.4`); Elifelete (ID: `person:Eliphelet.5`); Gérson (ID: `person:Gershom.2`); Joanã (ID: `person:Johanan.8`); Zeraías (ID: `person:Zerahiah.2`); Jaaziel (ID: `person:Jahaziel.5`); Ebede (ID: `person:Ebed.2`); Parós (ID: `person:Parosh.2`); Jeiel (ID: `person:Jehiel.7`); Joabe (ID: `person:Joab.4`); Hatus (ID: `person:Hattush.2`); Zacarias (ID: `person:Zechariah.19`); Adonicão (ID: `person:Adonikam`); Bebai (ID: `person:Bebai.2`); Sephatias (ID: `person:Shephatiah.6`); Daniel (ID: `person:Daniel.2`); Secanias (ID: `person:Shecaniah.5`); Semaías (ID: `person:Shemaiah.14`); Jeuel (ID: `person:Jeuel.3`); Hacatã (ID: `person:Hakkatan`); Elioenai (ID: `person:Eliehoenai.2`); Zabadias (ID: `person:Zebadiah.8`); Jesaías (ID: `person:Jeshaiah.4`); Miguel (ID: `person:Michael.10`); Zacarias (ID: `person:Zechariah.18`); Josifias (ID: `person:Josiphiah`); Elam (ID: `person:Elam`); Paate-Moabe (ID: `person:Pahath-moab`); Davi (ID: `person:David`); Itamar (ID: `person:Ithamar`); Artaxerxes (ID: `person:Artaxerxes`); Fineias (ID: `person:Phinehas`); Babilônia (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** Jaribe (ID: `person:Jarib.2`); Semaías (ID: `person:Shemaiah.15`); Joiaribe (ID: `person:Joiarib.2`); Eliezer (ID: `person:Eliezer.8`); Zacarias (ID: `person:Zechariah.20`); Ido (ID: `person:Iddo`); Mesulão (ID: `person:Meshullam.9`); Elnatã (ID: `person:Elnathan.4`); Elnatã (ID: `person:Elnathan.2`); Casifia (ID: `place:Casiphia`); Natã (ID: `person:Nathan.5`); Ariel (ID: `person:Ariel`); Elnatã (ID: `person:Elnathan.3`); SENHOR (ID: `deity:Lord`); perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); Amom (ID: `place:Ammon`); Egito (ID: `place:Egypt`); Jebusites (ID: `group:Jebusites`); Ammonites (ID: `group:Ammon`); Levi (ID: `group:Levi`); Hete (ID: `person:Heth`); Canaã (ID: `place:Canaan`); Israel (ID: `person:Israel`); cananeu (ID: `group:Canaan`); Egyptians (ID: `group:Egypt`); Moabe (ID: `place:Moab`); Levi (ID: `person:Levi.3`); Amorites (ID: `group:Amorites`); be unfaithful (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Harim (ID: `person:Harim`); Judá (ID: `group:Judah`); Elam (ID: `person:Elam`); offering (ID: `keyterm:Offering`); counsel (ID: `keyterm:Counsel`); Judá (ID: `person:Judah.4`); Jasube (ID: `person:Jashub.2`); Jeiel (ID: `person:Jehiel.8`); Uzias (ID: `person:Uzziah.4`); Jeremote (ID: `person:Jeremoth.3`); Natã (ID: `person:Nathan.6`); Maaséias (ID: `person:Maaseiah.6`); Semaías (ID: `person:Shemaiah.17`); Hananias (ID: `person:Hananiah.5`); Telem (ID: `person:Telem`); Adna (ID: `person:Adna`); Zabai (ID: `person:Zabbai`); Judeia (ID: `place:Judea`); Jozabade (ID: `person:Jozabad.8`); Jeiel (ID: `person:Jehiel.9`); Jaasai (ID: `person:Jaasu`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); defilement (ID: `keyterm:Defilement`); Pérsia (ID: `place:Persia`); Israel (ID: `person:Israel`); peace (ID: `keyterm:IntactState`); supplication (ID: `keyterm:Supplication`); dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`); to cause to possess (ID: `keyterm:Possess`); kindness (ID: `keyterm:Kindness`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); Pérsia (ID: `place:Persia`); supplication (ID: `keyterm:Supplication`); Jerusalém (ID: `place:Jerusalem`); kindness (ID: `keyterm:Kindness`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** Jeiel (ID: `person:Jehiel.8`); Secanias (ID: `person:Shecaniah.7`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); SENHOR (ID: `deity:Lord`); Elam (ID: `person:Elam`); be unfaithful (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** Levi (ID: `group:Levi`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); Levi (ID: `person:Levi.3`); swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `person:Benjamin`); SENHOR (ID: `deity:Lord`); Benjamim (ID: `group:Benjamin`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ticva (ID: `person:Tikvah.2`); Jônatas (ID: `person:Jonathan.10`); Sabetai (ID: `person:Shabbethai`); Asael (ID: `person:Asahel.4`); Jazeías (ID: `person:Jahzeiah`); Mesulão (ID: `person:Meshullam.10`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`)
