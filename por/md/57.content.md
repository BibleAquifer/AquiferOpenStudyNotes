...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Filemom (ID: `person:Philemon`); Áfia (ID: `person:Apphia`); Arquipo (ID: `person:Archippus`); Paulo (ID: `person:Paul`); Timóteo (ID: `person:Timothy`); SENHOR (ID: `deity:Lord`); igreja (ID: `keyterm:Church`); amado (ID: `keyterm:Beloved`); favor (ID: `keyterm:Favor`); fazer a paz (ID: `keyterm:Peace`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** holy (ID: `keyterm:Holy`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Good (ID: `keyterm:Good`); rogar (ID: `keyterm:AskFor`); comunhão (ID: `keyterm:Fellowship`); orar (ID: `keyterm:Pray`); compaixão (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); em cristo (ID: `keyterm:InChrist`); love (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`); Paulo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** boa notícia (ID: `keyterm:GoodNews`); servir (ID: `keyterm:Serve`); Good (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Lucas (ID: `person:Luke`); Demas (ID: `person:Demas`); Epafras (ID: `person:Epaphras`); Spirit (ID: `keyterm:Spirit.2`); Marcos (ID: `person:Mark`); em cristo (ID: `keyterm:InChrist`); favor (ID: `keyterm:Favor`); Aristarco (ID: `person:Aristarchus`)
