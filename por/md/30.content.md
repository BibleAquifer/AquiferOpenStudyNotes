...
* **Associated ACAI Concepts:** have a vision (ID: `keyterm:HaveAVision`); Tecoa (ID: `place:Tekoa`); Amós (ID: `person:Amos.3`); Jeroboão (ID: `person:Jeroboam.2`); Uzias (ID: `person:Uzziah`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Israel (ID: `person:Israel`); Joás (ID: `person:Joash.4`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Carmelo (ID: `place:Carmel`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Gileade (ID: `place:Gilead`); Damasco (ID: `place:Damascus`); rebel (ID: `keyterm:Rebel`); Grain (ID: `flora:Grain`); Threshing-Sledge (ID: `realia:Threshing-sledge`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); rebel (ID: `keyterm:Rebel`); Edom (ID: `place:Edom`); Judá (ID: `person:Judah.4`); Nazirites (ID: `group:Nazirite`); Damasco (ID: `place:Damascus`); Moabe (ID: `place:Moab`); Israel (ID: `person:Israel`); Amorites (ID: `group:Amorites`); Amom (ID: `place:Ammon`); Gileade (ID: `place:Gilead`); Tiro (ID: `place:Tyre`); Gaza (ID: `place:Gaza`); Judá (ID: `group:Judah`); Bete-Éden (ID: `place:Beth-eden`); Quir (ID: `place:Kir`); Hazael (ID: `person:Hazael`); Vale de Áven (ID: `place:AvenValley`); Wine (ID: `realia:Wine`); Rod (ID: `realia:Rod`); House (ID: `realia:House`); Staff (ID: `realia:Staff`); Vine (ID: `flora:Vine`); Jerusalém (ID: `place:Jerusalem`); profane, dishonor (ID: `keyterm:Dishonor`); Asquelom (ID: `place:Ashkelon`); Egito (ID: `place:Egypt`); Covenant (ID: `keyterm:Covenant`); Filisteu (ID: `group:Philistine`); Bozrah (ID: `place:Bozrah.2`); speak (ID: `keyterm:Speak`); Ecrom (ID: `place:Ekron`); decree (ID: `keyterm:Decree`); Asdode (ID: `place:Ashdod`); Ammonites (ID: `group:Ammon`); Ben-Hadade (ID: `person:Ben-hadad.3`); Instruction (ID: `keyterm:Instruction`); poor (ID: `keyterm:Poor`); Quiriataim (ID: `place:Kiriathaim`); Filístia (ID: `place:Philistine`); Temã (ID: `place:Teman`); strength (ID: `keyterm:Strength`); dispossess (ID: `keyterm:Dispossess`); Temple Altar (ID: `realia:TempleAltar`); Cedar (ID: `flora:Cedar`); Wagon (ID: `realia:Wagon`); Rams Horn (ID: `realia:RamsHorn`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Oak (ID: `flora:Oak`); Money (ID: `realia:Money`); Bow (ID: `realia:Bow`); Altar (ID: `realia:Altar`); Sheaf (ID: `realia:Sheaf`); Stone Altar (ID: `realia:StoneAltar`); Grain (ID: `flora:Grain`); Threshing-Sledge (ID: `realia:Threshing-sledge`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** rebel (ID: `keyterm:Rebel`); SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); Gaza (ID: `place:Gaza`)
...
* **Associated ACAI Concepts:** Asdode (ID: `place:Ashdod`); SENHOR (ID: `deity:Lord`); Filisteu (ID: `group:Philistine`); Filístia (ID: `place:Philistine`); Asquelom (ID: `place:Ashkelon`); Ecrom (ID: `place:Ekron`); Rod (ID: `realia:Rod`); Staff (ID: `realia:Staff`)
...
* **Associated ACAI Concepts:** Amom (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); SENHOR (ID: `deity:Lord`); Gileade (ID: `place:Gilead`); rebel (ID: `keyterm:Rebel`)
...
* **Associated ACAI Concepts:** decree (ID: `keyterm:Decree`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); rebel (ID: `keyterm:Rebel`)
...
* **Associated ACAI Concepts:** Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); decree (ID: `keyterm:Decree`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Jerusalém (ID: `place:Jerusalem`); rebel (ID: `keyterm:Rebel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Wine (ID: `realia:Wine`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); House (ID: `realia:House`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Appoint (ID: `keyterm:Appoint`); SENHOR (ID: `deity:Lord`); Egito (ID: `place:Egypt`); Israel (ID: `person:Israel`); ardour (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Betel (ID: `place:Bethel`); Egito (ID: `place:Egypt`); rebel (ID: `keyterm:Rebel`); Samaria (ID: `place:Samaria`); Lion (ID: `fauna:Lion`); Appoint (ID: `keyterm:Appoint`); José (ID: `person:Joseph.10`); Gilgal (ID: `place:Gilgal.2`); love (ID: `keyterm:Love`); Vine (ID: `flora:Vine`); lamentation (ID: `keyterm:Lamentation`); Harmom (ID: `place:Harmon`); swear (ID: `keyterm:Swear`); ardour (ID: `keyterm:Ardour`); be kindly disposed (ID: `keyterm:KindlyDisposed`); innocence (ID: `keyterm:Innocence`); To Sin (ID: `keyterm:Sin`); speak (ID: `keyterm:Speak`); mischief (ID: `keyterm:Mischief`); Asdode (ID: `place:Ashdod`); praise (ID: `keyterm:Praise`); have insight (ID: `keyterm:HaveInsight`); Gomorra (ID: `place:Gomorrah`); Sodoma (ID: `place:Sodom`); House (ID: `realia:House`); fear (ID: `keyterm:Fear`); offering (ID: `keyterm:Offering`); Complete (ID: `keyterm:Complete`); slaughtering (ID: `keyterm:Slaughtering`); Basã (ID: `place:Bashan`); Berseba (ID: `place:Beersheba`); Horns of Altar (ID: `realia:HornsOfAltar`); Temple Altar (ID: `realia:TempleAltar`); Fig (ID: `flora:Fig`); Wormwood (ID: `flora:Wormwood`); Wine (ID: `realia:Wine`); Bed (ID: `realia:Bed`); Flock (ID: `fauna:Flock`); Rams Horn (ID: `realia:RamsHorn`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Trap (ID: `realia:Trap`); Locust (ID: `fauna:Locust`); Fishhook (ID: `realia:Fishhook`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Grain (ID: `flora:Grain`); Hewn Stone (ID: `realia:HewnStone`); Bird (ID: `fauna:Bird`); Sandalwood (ID: `flora:Sandalwood`); Olive Tree (ID: `flora:OliveTree`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Horse (ID: `fauna:Horse`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** speak (ID: `keyterm:Speak`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Lion (ID: `fauna:Lion`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Samaria (ID: `place:Samaria`); Israel (ID: `person:Israel`); Flock (ID: `fauna:Flock`); Lion (ID: `fauna:Lion`); Sheep (ID: `fauna:Lamb`); Bed (ID: `realia:Bed`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Horns of Altar (ID: `realia:HornsOfAltar`); Appoint (ID: `keyterm:Appoint`); Israel (ID: `person:Israel`); rebel (ID: `keyterm:Rebel`); Betel (ID: `place:Bethel`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Harmom (ID: `place:Harmon`); Basã (ID: `place:Bashan`); swear (ID: `keyterm:Swear`); Samaria (ID: `place:Samaria`); Fishhook (ID: `realia:Fishhook`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Betel (ID: `place:Bethel`); rebel (ID: `keyterm:Rebel`); slaughtering (ID: `keyterm:Slaughtering`); Gilgal (ID: `place:Gilgal.2`)
...
* **Associated ACAI Concepts:** slaughtering (ID: `keyterm:Slaughtering`); praise (ID: `keyterm:Praise`); Betel (ID: `place:Bethel`); Gilgal (ID: `place:Gilgal.2`); SENHOR (ID: `deity:Lord`); rebel (ID: `keyterm:Rebel`); Israel (ID: `person:Israel`); love (ID: `keyterm:Love`); offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** praise (ID: `keyterm:Praise`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); love (ID: `keyterm:Love`); offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); innocence (ID: `keyterm:Innocence`); Gomorra (ID: `place:Gomorrah`); Sodoma (ID: `place:Sodom`); Egito (ID: `place:Egypt`); Locust (ID: `fauna:Locust`); Grain (ID: `flora:Grain`); Fig (ID: `flora:Fig`); Olive Tree (ID: `flora:OliveTree`); Horse (ID: `fauna:Horse`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** mischief (ID: `keyterm:Mischief`); Betel (ID: `place:Bethel`); Gilgal (ID: `place:Gilgal.2`); Berseba (ID: `place:Beersheba`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); be kindly disposed (ID: `keyterm:KindlyDisposed`); José (ID: `person:Joseph.10`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); House (ID: `realia:House`); Woe (ID: `keyterm:Woe.2`); Hamate (ID: `place:Hamath`); offering (ID: `keyterm:Offering`); Lyre (ID: `realia:Lyre`); Cattle (ID: `fauna:Bull`); Quium (ID: `deity:Kiyyun`); Sicute (ID: `deity:Sikkuth`); Calné (ID: `place:Calneh`); Ribeiro de Arabá (ID: `place:BrookOfTheArabah`); Lo-Debar (ID: `place:Lo-debar`); Davi (ID: `person:David`); swear (ID: `keyterm:Swear`); Jerusalém (ID: `place:Jerusalem`); Damasco (ID: `place:Damascus`); Filisteu (ID: `group:Philistine`); smear (ID: `keyterm:Smear`); Gate (ID: `place:Gath`); José (ID: `person:Joseph.10`); Asterote-Carnaim (ID: `place:Ashteroth-karnaim`); slaughtering (ID: `keyterm:Slaughtering`); Filístia (ID: `place:Philistine`); Samaria (ID: `place:Samaria`); lean on (ID: `keyterm:LeanOn`); Wormwood (ID: `flora:Wormwood`); Image (ID: `realia:Image`); Lion (ID: `fauna:Lion`); Wine (ID: `realia:Wine`); Mattock (ID: `realia:Mattock`); Flock (ID: `fauna:Flock`); Olive Oil (ID: `realia:OliveOil`); Animal Pen (ID: `realia:AnimalPen`); Snake (ID: `fauna:Snake`); Bear (ID: `fauna:Bear`); Anointing Oil (ID: `realia:AnointingOil`); Vine (ID: `flora:Vine`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Sheep (ID: `fauna:Lamb`); Horse (ID: `fauna:Horse`); Molten Image (ID: `realia:MoltenImage`); Bed (ID: `realia:Bed`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Quium (ID: `deity:Kiyyun`); Sicute (ID: `deity:Sikkuth`); slaughtering (ID: `keyterm:Slaughtering`); Damasco (ID: `place:Damascus`); Israel (ID: `person:Israel`); Image (ID: `realia:Image`); Lyre (ID: `realia:Lyre`)
...
* **Associated ACAI Concepts:** Quium (ID: `deity:Kiyyun`); Sicute (ID: `deity:Sikkuth`); slaughtering (ID: `keyterm:Slaughtering`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Samaria (ID: `place:Samaria`); Israel (ID: `person:Israel`); lean on (ID: `keyterm:LeanOn`); Woe (ID: `keyterm:Woe.2`)
...
* **Associated ACAI Concepts:** José (ID: `person:Joseph.10`); Davi (ID: `person:David`); smear (ID: `keyterm:Smear`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`); Lyre (ID: `realia:Lyre`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Amós (ID: `person:Amos.3`); speak (ID: `keyterm:Speak`); Amazias (ID: `person:Amaziah.4`); Jeroboão (ID: `person:Jeroboam.2`); Egito (ID: `place:Egypt`); Rio Nilo (ID: `place:Nile`); swear (ID: `keyterm:Swear`); Betel (ID: `place:Bethel`); Isaque (ID: `person:Isaac`); To Sin (ID: `keyterm:Sin`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Plumb Line (ID: `realia:PlumbLine`); Basket (ID: `realia:Basket`); Deceit (ID: `keyterm:Deceit`); defilement (ID: `keyterm:Defilement`); Creta (ID: `place:Crete`); Judá (ID: `person:Judah.4`); new moon festival (ID: `keyterm:NewMoonFestival`); Quir (ID: `place:Kir`); Cushites (ID: `group:Cush`); forgive (ID: `keyterm:Forgive`); Filisteu (ID: `group:Philistine`); Syrians (ID: `group:Syria`); Dã (ID: `group:Dan`); play the prostitute (ID: `keyterm:PlayTheProstitute`); Dã (ID: `place:Dan`); Hell (ID: `place:Hell`); Cush (ID: `place:Cush.2`); Carmelo (ID: `place:Carmel`); Judá (ID: `group:Judah`); lamentation (ID: `keyterm:Lamentation`); sabbath (ID: `keyterm:Sabbath`); Filístia (ID: `place:Philistine`); Samaria (ID: `place:Samaria`); Berseba (ID: `place:Beersheba`); Floor (ID: `realia:Floor`); Sieve (ID: `realia:Sieve`); Temple Altar (ID: `realia:TempleAltar`); Fig (ID: `flora:Fig`); Stone Pine (ID: `flora:Pine`); Sycomore Fig (ID: `flora:SycomoreFig`); Ephah (ID: `realia:Ephah`); Flock (ID: `fauna:Flock`); Shekel (ID: `realia:Shekel`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Snake (ID: `fauna:Snake`); Doorstep (ID: `realia:Doorstep`); Locust (ID: `fauna:Locust`); Money (ID: `realia:Money`); Sackcloth (ID: `realia:Sackcloth`); Grass (ID: `flora:Grass`); High Place (ID: `realia:HighPlace`); Altar (ID: `realia:Altar`); Capital (ID: `realia:Capital`); House (ID: `realia:House`); Stone Altar (ID: `realia:StoneAltar`); Balance (ID: `realia:Balance`); Rope (ID: `realia:Rope`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Jeroboão (ID: `person:Jeroboam.2`); Isaque (ID: `person:Isaac`); Israel (ID: `person:Israel`); Stone Pine (ID: `flora:Pine`); High Place (ID: `realia:HighPlace`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Amós (ID: `person:Amos.3`); speak (ID: `keyterm:Speak`); Amazias (ID: `person:Amaziah.4`); SENHOR (ID: `deity:Lord`); Jeroboão (ID: `person:Jeroboam.2`); Betel (ID: `place:Bethel`); defilement (ID: `keyterm:Defilement`); Judá (ID: `person:Judah.4`); Isaque (ID: `person:Isaac`); play the prostitute (ID: `keyterm:PlayTheProstitute`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `group:Judah`); Fig (ID: `flora:Fig`); Sycomore Fig (ID: `flora:SycomoreFig`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Rope (ID: `realia:Rope`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Amazias (ID: `person:Amaziah.4`); Judá (ID: `person:Judah.4`); speak (ID: `keyterm:Speak`); Judá (ID: `group:Judah`); Amós (ID: `person:Amos.3`)
...
* **Associated ACAI Concepts:** Isaque (ID: `person:Isaac`); SENHOR (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); speak (ID: `keyterm:Speak`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** defilement (ID: `keyterm:Defilement`); SENHOR (ID: `deity:Lord`); play the prostitute (ID: `keyterm:PlayTheProstitute`); Israel (ID: `person:Israel`); Rope (ID: `realia:Rope`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); swear (ID: `keyterm:Swear`); Deceit (ID: `keyterm:Deceit`); Rio Nilo (ID: `place:Nile`); new moon festival (ID: `keyterm:NewMoonFestival`); Egito (ID: `place:Egypt`); Dã (ID: `group:Dan`); Israel (ID: `person:Israel`); Dã (ID: `place:Dan`); Word of the Lord (ID: `keyterm:WordOfTheLord`); lamentation (ID: `keyterm:Lamentation`); sabbath (ID: `keyterm:Sabbath`); Samaria (ID: `place:Samaria`); Berseba (ID: `place:Beersheba`); Ephah (ID: `realia:Ephah`); Shekel (ID: `realia:Shekel`); Money (ID: `realia:Money`); Sackcloth (ID: `realia:Sackcloth`); Balance (ID: `realia:Balance`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); swear (ID: `keyterm:Swear`); Samaria (ID: `place:Samaria`); Dã (ID: `group:Dan`); Dã (ID: `place:Dan`); Berseba (ID: `place:Beersheba`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); swear (ID: `keyterm:Swear`); Samaria (ID: `place:Samaria`); Dã (ID: `group:Dan`); Dã (ID: `place:Dan`); Berseba (ID: `place:Beersheba`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Doorstep (ID: `realia:Doorstep`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Capital (ID: `realia:Capital`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Filisteu (ID: `group:Philistine`); Creta (ID: `place:Crete`); Filístia (ID: `place:Philistine`); Syrians (ID: `group:Syria`); Cush (ID: `place:Cush.2`); Egito (ID: `place:Egypt`); Israel (ID: `person:Israel`); Quir (ID: `place:Kir`); Cushites (ID: `group:Cush`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Vine (ID: `flora:Vine`); Davi (ID: `person:David`); Edom (ID: `place:Edom`); Israel (ID: `person:Israel`); dispossess (ID: `keyterm:Dispossess`); Must (ID: `realia:Must`); Wine (ID: `realia:Wine`); Barley (ID: `flora:Barley`); Coriander (ID: `flora:Coriander`); Mattock (ID: `realia:Mattock`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Must (ID: `realia:Must`); Barley (ID: `flora:Barley`); Coriander (ID: `flora:Coriander`); Mattock (ID: `realia:Mattock`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Vine (ID: `flora:Vine`); Israel (ID: `person:Israel`); Must (ID: `realia:Must`); Wine (ID: `realia:Wine`); Barley (ID: `flora:Barley`); Coriander (ID: `flora:Coriander`); Mattock (ID: `realia:Mattock`)
