...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); Jérusalem (ID: `place:Jerusalem`); la connaissance (ID: `keyterm:Intention`); Éternel (ID: `deity:Lord`); stupide (ID: `keyterm:Stupid`); Vine (ID: `flora:Vine`); pécher (ID: `keyterm:Sin`); Israël (ID: `person:Israel`); Sandalwood (ID: `flora:Sandalwood`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Flock (ID: `fauna:Flock`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); Jérusalem (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Flock (ID: `fauna:Flock`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Flock (ID: `fauna:Flock`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); stupide (ID: `keyterm:Stupid`); faire un voeu (ID: `keyterm:Vow`); House (ID: `realia:House`); tuerie (ID: `keyterm:Slaughtering`); An Angel (ID: `deity:Angel`); force (ID: `keyterm:Strength`); craindre (ID: `keyterm:Fear`); A Man (ID: `person:GenericMale`); ardeur (ID: `keyterm:Ardour`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); stupide (ID: `keyterm:Stupid`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`); pécher (ID: `keyterm:Sin`); laissiez en possession (ID: `keyterm:Possess`); craindre (ID: `keyterm:Fear`); agir par méchanceté (ID: `keyterm:ActWickedly`); la connaissance (ID: `keyterm:Intention`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Cooking Pot (ID: `realia:CookingPot`); Brier (ID: `flora:Brier`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); pécher (ID: `keyterm:Sin`); sans saleté (ID: `keyterm:Pure`); la connaissance (ID: `keyterm:Intention`); grâce (ID: `keyterm:Favor`); force (ID: `keyterm:Strength`); ardeur (ID: `keyterm:Ardour`); jurer (ID: `keyterm:Swear`); securité (ID: `keyterm:Safety`); pollution (ID: `keyterm:Defilement`); percevoir (ID: `keyterm:Perceive`); Hell (ID: `place:Hell`); adjuration (ID: `keyterm:Oath`); Anointing Oil (ID: `realia:AnointingOil`); Vine (ID: `flora:Vine`); Dog (ID: `fauna:Dog`); Fishnet (ID: `realia:Fishnet`); Lion (ID: `fauna:Lion`); Wine (ID: `realia:Wine`); Net (ID: `realia:Net`); Trap (ID: `realia:Trap`); Olive Oil (ID: `realia:OliveOil`); Bird (ID: `fauna:Bird`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** pécher (ID: `keyterm:Sin`); pollution (ID: `keyterm:Defilement`); sans saleté (ID: `keyterm:Pure`); jurer (ID: `keyterm:Swear`); adjuration (ID: `keyterm:Oath`)
...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); capacité (ID: `keyterm:Ability`); force (ID: `keyterm:Strength`); Éternel (ID: `deity:Lord`); Hell (ID: `place:Hell`); la connaissance (ID: `keyterm:Intention`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** stupide (ID: `keyterm:Stupid`); Bed (ID: `realia:Bed`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); craindre (ID: `keyterm:Fear`); Éternel (ID: `deity:Lord`); Caper (ID: `flora:Caper`); Clay Jar (ID: `realia:ClayJar`); Pit (ID: `realia:Pit`); Rope (ID: `realia:Rope`); Bird (ID: `fauna:Bird`); Almond (ID: `flora:Almond`); Locust (ID: `fauna:Locust`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); proverbe (ID: `keyterm:Saying`); craindre (ID: `keyterm:Fear`); droiture (ID: `keyterm:Straightness`); vérité (ID: `keyterm:Truth`); la connaissance (ID: `keyterm:Intention`); Goad (ID: `realia:Goad`); Scroll (ID: `realia:Scroll`); Nail (ID: `realia:Nail`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`)
