...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Pérsia (ID: `place:Persia`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`); Jeremias (ID: `person:Jeremiah.6`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Pérsia (ID: `place:Persia`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `person:Benjamin`); Benjamim (ID: `group:Benjamin`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`); Levi (ID: `group:Levi`); Money (ID: `realia:Money`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Ciro (ID: `person:Cyrus`); Judá (ID: `group:Judah`); Pérsia (ID: `place:Persia`); Judá (ID: `person:Judah.4`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); Salomão (ID: `person:Solomon`); Levi (ID: `group:Levi`); Hasum (ID: `person:Hashum`); Sia (ID: `person:Siaha`); Adã (ID: `place:Addan`); Meunim (ID: `group:Meunim`); Jesua (ID: `person:Jeshua.3`); Joabe (ID: `person:Joab.3`); Mordecai (ID: `person:Mordecai`); Nebo (ID: `place:Nebo.2`); Ezequias (ID: `person:Hezekiah.2`); Neemias (ID: `person:Nehemiah`); Ará (ID: `person:Arah.2`); Nesias (ID: `person:Neziah`); Jesua (ID: `person:Jeshua`); Uza (ID: `person:Uzza.2`); Habaiah (ID: `person:Habaiah`); Talmom (ID: `person:Talmon`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Salmai (ID: `person:Shalmai`); Mispar (ID: `person:Mispar`); Delaías (ID: `person:Delaiah.3`); Darcom (ID: `person:Darkon`); Asná (ID: `person:Asnah`); Adim (ID: `person:Adin`); Bilsã (ID: `person:Bilshan`)
...
* **Associated ACAI Concepts:** Baana (ID: `person:Baanah.3`); Neemias (ID: `person:Nehemiah`); Bigvai (ID: `person:Bigvai`); Reum (ID: `person:Rehum`); Seraias (ID: `person:Seraiah.6`); Reelaías (ID: `person:Reelaiah`); Bilsã (ID: `person:Bilshan`); Mispar (ID: `person:Mispar`); Mordecai (ID: `person:Mordecai`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Bani (ID: `person:Bani`); Asgade (ID: `person:Azgad`); Zacai (ID: `person:Zaccai.2`); Hasum (ID: `person:Hashum`); Elam (ID: `person:Elam`); Bebai (ID: `person:Bebai`); Jesua (ID: `person:Jeshua.3`); Bigvai (ID: `person:Bigvai.2`); Joabe (ID: `person:Joab.3`); Ezequias (ID: `person:Hezekiah.2`); Ater (ID: `person:Ater`); Ará (ID: `person:Arah.2`); Sephatias (ID: `person:Shephatiah.6`); Adonicão (ID: `person:Adonikam`); Bezai (ID: `person:Bezai`); Jora (ID: `person:Jorah`); Parós (ID: `person:Parosh`); Zatu (ID: `person:Zattu.2`); Paate-Moabe (ID: `person:Pahath-moab`); Adim (ID: `person:Adin`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Netofa (ID: `place:Netophah`); Senaa (ID: `place:Senaah`); Nebo (ID: `place:Nebo.2`); Hadide (ID: `place:Hadid`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Harim (ID: `person:Harim.2`); Magbis (ID: `place:Magbish`); Lode (ID: `place:Lod`); Anatote (ID: `place:Anathoth`); Ramah (ID: `place:Ramah.2`); Elam (ID: `person:Elam`); Belém (ID: `place:Bethlehem`); Quiriate-Jearim (ID: `place:Kiriath-jearim`); Betel (ID: `place:Bethel`); Geba (ID: `place:Geba`); Micmás (ID: `place:Michmash`); Cefira (ID: `place:Chephirah`); Beerote (ID: `place:Beeroth`); Jericó (ID: `place:Jericho`); Ono (ID: `place:Ono`); Ai (ID: `place:Ai`)
...
* **Associated ACAI Concepts:** Imer (ID: `person:Immer.2`); Hatita (ID: `person:Hatita`); Harim (ID: `person:Harim`); Talmom (ID: `person:Talmon`); Jedaías (ID: `person:Jedaiah.4`); Jesua (ID: `person:Jeshua.4`); Jesua (ID: `person:Jeshua`); Ater (ID: `person:Ater.2`); Hodavias (ID: `person:Hodaviah.4`); Sobai (ID: `person:Shobai`); Cadmiel (ID: `person:Kadmiel`); Levi (ID: `person:Levi.3`); Salum (ID: `person:Shallum.8`); Pasur (ID: `person:Pashhur`); Acube (ID: `person:Akkub.2`); Asafe (ID: `person:Asaph.2`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Hatita (ID: `person:Hatita`); Talmom (ID: `person:Talmon`); Ater (ID: `person:Ater.2`); Sobai (ID: `person:Shobai`); Salum (ID: `person:Shallum.8`); Acube (ID: `person:Akkub.2`); Asafe (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** Hagaba (ID: `person:Hagabah`); Hagabe (ID: `person:Hagab`); Bazlite (ID: `person:Bazluth`); Sia (ID: `person:Siaha`); Zia (ID: `person:Ziha`); Lebana (ID: `person:Lebanah`); Meunim (ID: `group:Meunim`); Besai (ID: `person:Besai`); Temá (ID: `person:Temah`); Paseia (ID: `person:Paseah.2`); Hanã (ID: `person:Hanan.4`); Baquebuque (ID: `person:Bakbuk`); Hacufa (ID: `person:Hakupha`); Hatifa (ID: `person:Hatipha`); Nesias (ID: `person:Neziah`); Gaar (ID: `person:Gahar`); Reaías (ID: `person:Reaiah.3`); Harsa (ID: `person:Harsha`); Uza (ID: `person:Uzza.2`); Queros (ID: `person:Keros`); Gidel (ID: `person:Giddel`); Gazão (ID: `person:Gazzam`); Hasufa (ID: `person:Hasupha`); Nephushesim (ID: `group:Nephushesim`); Acube (ID: `person:Akkub.3`); Barcos (ID: `person:Barkos`); Salmai (ID: `person:Shalmai`); Harur (ID: `person:Harhur`); Rezim (ID: `person:Rezin.2`); Tabaote (ID: `person:Tabbaoth`); Meída (ID: `person:Mehida`); Padom (ID: `person:Padon`); Sisera (ID: `person:Sisera.2`); Asná (ID: `person:Asnah`); Necoda (ID: `person:Nekoda`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Sephatias (ID: `person:Shephatiah.7`); Hatil (ID: `person:Hattil`); Darcom (ID: `person:Darkon`); Sotai (ID: `person:Sotai`); Peruda (ID: `person:Peruda`); Jaala (ID: `person:Jaalah`); Ami (ID: `person:Ami`); Gidel (ID: `person:Giddel.2`); Soferete (ID: `person:Sophereth`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`)
...
* **Associated ACAI Concepts:** Tobias (ID: `person:Tobiah`); Tel-Melá (ID: `place:Tel-melah`); Delaías (ID: `person:Delaiah.3`); Necoda (ID: `person:Nekoda.2`); Adã (ID: `place:Addan`); Querube (ID: `place:Cherub`); Tel-Harsa (ID: `place:Tel-harsha`); Imer (ID: `place:Immer`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Habaiah (ID: `person:Habaiah`); Hacoz (ID: `person:Hakkoz.2`); Barzillai (ID: `person:Barzillai.3`); Gileade (ID: `place:Gilead`); priesthood (ID: `keyterm:Priesthood`); stain (ID: `keyterm:Stain`); Gileadites (ID: `group:Gilead`); Barzillai (ID: `person:Barzillai`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); strength (ID: `keyterm:Strength`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Tunic (ID: `realia:Tunic`); House (ID: `realia:House`); Mina (ID: `realia:Mina`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Josué (ID: `person:Joshua.5`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Jesua (ID: `person:Jeshua.4`); Esar-Hadom (ID: `person:Esarhaddon`); Hodavias (ID: `person:Hodaviah.4`); Henadade (ID: `person:Henadad`); Relatives (ID: `group:Relatives`); Cadmiel (ID: `person:Kadmiel`); kindness (ID: `keyterm:Kindness`); Libano (ID: `place:Lebanon`); Sidonians (ID: `group:Sidon`); Benjamim (ID: `group:Benjamin`); Tyrians (ID: `group:Tyre`); holy (ID: `keyterm:Holy`); Hodias (ID: `person:Hodiah.2`); Moisés (ID: `person:Moses`); new moon festival (ID: `keyterm:NewMoonFestival`); Tiro (ID: `place:Tyre`); terror (ID: `keyterm:Terror`); Davi (ID: `person:David`); Assyria (ID: `place:Assyria`); Jope (ID: `place:Joppa`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); Instruction (ID: `keyterm:Instruction`); appointed feast (ID: `keyterm:AppointedFeast`); counsel (ID: `keyterm:Counsel`); Benjamim (ID: `person:Benjamin`); Sidom (ID: `place:Sidon`); Dario (ID: `person:Darius.2`); Asafe (ID: `person:Asaph.2`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Trumpet (ID: `realia:Trumpet`); Money (ID: `realia:Money`); Cedar (ID: `flora:Cedar`); Olive Oil (ID: `realia:OliveOil`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); terror (ID: `keyterm:Terror`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Jope (ID: `place:Joppa`); Ciro (ID: `person:Cyrus`); Libano (ID: `place:Lebanon`); Sidonians (ID: `group:Sidon`); Sidom (ID: `place:Sidon`); Pérsia (ID: `place:Persia`); Tiro (ID: `place:Tyre`); Tyrians (ID: `group:Tyre`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Cedar (ID: `flora:Cedar`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `group:Levi`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); kindness (ID: `keyterm:Kindness`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Asafe (ID: `person:Asaph.2`); Davi (ID: `person:David`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Josué (ID: `person:Joshua.5`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Rio Eufrates (ID: `place:Euphrates`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Samaria (ID: `place:Samaria`); Pérsia (ID: `place:Persia`); Jews (ID: `group:Jews`); Ereque (ID: `place:Erech`); Mitredate (ID: `person:Mithredath.2`); Osnapar (ID: `person:Osnappar`); Assuero (ID: `person:Ahasuerus`); Bislão (ID: `person:Bishlam`); Dinaítas (ID: `person:Dinaite`); Babylonians (ID: `group:Babylon`); Tabeel (ID: `person:Tabeel`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); Judá (ID: `person:Judah.4`); Elam (ID: `place:Elam`); Babilônia (ID: `place:Babylon`); Judá (ID: `group:Judah`); Susã (ID: `place:Susa`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Babylonians (ID: `group:Babylon`); Reum (ID: `person:Rehum.2`); Dinaítas (ID: `person:Dinaite`); Sinsai (ID: `person:Shimshai`); Ereque (ID: `place:Erech`); Babilônia (ID: `place:Babylon`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); Pérsia (ID: `place:Persia`); Susã (ID: `place:Susa`); Elam (ID: `place:Elam`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Samaria (ID: `place:Samaria`); Jews (ID: `group:Jews`); Reum (ID: `person:Rehum.2`); Artaxerxes (ID: `person:Artaxerxes.2`); Sinsai (ID: `person:Shimshai`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); Dario (ID: `person:Darius.2`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Zacarias (ID: `person:Zechariah.17`); Ido (ID: `person:Iddo.6`); Ageu (ID: `person:Haggai`); Tattenai (ID: `person:Tattenai`); Josué (ID: `person:Joshua.5`); Rio Eufrates (ID: `place:Euphrates`); Sealtiel (ID: `person:Shealtiel.2`); Jeozadaque (ID: `person:Jehozadak`); Judá (ID: `person:Judah.4`); Pérsia (ID: `place:Persia`); Zorobabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Zacarias (ID: `person:Zechariah.17`); Ido (ID: `person:Iddo.6`); Ageu (ID: `person:Haggai`); Jerusalém (ID: `place:Jerusalem`); Jews (ID: `group:Jews`); Judá (ID: `person:Judah.4`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Jerusalém (ID: `place:Jerusalem`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Babilônia (ID: `place:Babylon`); Caldéia (ID: `place:Chaldea`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Chaldeans (ID: `group:Chaldea`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Babilônia (ID: `place:Babylon`); Ciro (ID: `person:Cyrus`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Zorobabel (ID: `person:Zerubbabel.2`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Gentiles (ID: `group:Gentile`); SENHOR (ID: `deity:Lord`); defilement (ID: `keyterm:Defilement`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Azarias (ID: `person:Azariah.7`); Meraiote (ID: `person:Meraioth`); Aitube (ID: `person:Ahitub.3`); Azarias (ID: `person:Azariah.6`); Buqui (ID: `person:Bukki.2`); Salum (ID: `person:Shallum.7`); Amarias (ID: `person:Amariah.2`); Zeraías (ID: `person:Zerahiah`); Zadoque (ID: `person:Zadok.4`); Seraias (ID: `person:Seraiah.2`); Abisua (ID: `person:Abishua`); Uzi (ID: `person:Uzzi`); Artaxerxes (ID: `person:Artaxerxes`); Fineias (ID: `person:Phinehas`); Arão (ID: `person:Aaron`); Pérsia (ID: `place:Persia`); Hilquias (ID: `person:Hilkiah.2`); Eleazar (ID: `person:Eleazar.2`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Babilônia (ID: `place:Babylon`); Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** decree (ID: `keyterm:Decree`); Ezra (ID: `person:Ezra`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Artaxerxes (ID: `person:Artaxerxes`); Ezra (ID: `person:Ezra`); Anointing Oil (ID: `realia:AnointingOil`); Talent (ID: `realia:Talent`); Olive Oil (ID: `realia:OliveOil`); Wheat (ID: `flora:Wheat`); Money (ID: `realia:Money`); Kor (ID: `realia:Kor`)
...
* **Associated ACAI Concepts:** Joanã (ID: `person:Johanan.8`); Asgade (ID: `person:Azgad`); Josifias (ID: `person:Josiphiah`); Gérson (ID: `person:Gershom.2`); Elam (ID: `person:Elam`); Semaías (ID: `person:Shemaiah.14`); Bebai (ID: `person:Bebai`); Ebede (ID: `person:Ebed.2`); Zacarias (ID: `person:Zechariah.19`); Bigvai (ID: `person:Bigvai.2`); Secanias (ID: `person:Shecaniah.6`); Secanias (ID: `person:Shecaniah.5`); Elioenai (ID: `person:Eliehoenai.2`); Utai (ID: `person:Uthai.2`); Obadias (ID: `person:Obadiah.10`); Miguel (ID: `person:Michael.10`); Parós (ID: `person:Parosh.2`); Daniel (ID: `person:Daniel.2`); Adonicão (ID: `person:Adonikam`); Jônatas (ID: `person:Jonathan.9`); Sephatias (ID: `person:Shephatiah.6`); Atalia (ID: `person:Athaliah.3`); Jeiel (ID: `person:Jehiel.7`); Hatus (ID: `person:Hattush.2`); Zacarias (ID: `person:Zechariah.18`); Zacur (ID: `person:Zaccur.5`); Elifelete (ID: `person:Eliphelet.5`); Paate-Moabe (ID: `person:Pahath-moab`); Jesaías (ID: `person:Jeshaiah.4`); Jeuel (ID: `person:Jeuel.3`); Hacatã (ID: `person:Hakkatan`); Joabe (ID: `person:Joab.4`); Jaaziel (ID: `person:Jahaziel.5`); Zabadias (ID: `person:Zebadiah.8`); Bebai (ID: `person:Bebai.2`); Adim (ID: `person:Adin`); Zeraías (ID: `person:Zerahiah.2`); Selomite (ID: `person:Shelomith.4`); Artaxerxes (ID: `person:Artaxerxes`); Fineias (ID: `person:Phinehas`); Davi (ID: `person:David`); Babilônia (ID: `place:Babylon`); Itamar (ID: `person:Ithamar`)
...
* **Associated ACAI Concepts:** Zacarias (ID: `person:Zechariah.20`); Elnatã (ID: `person:Elnathan.3`); Jaribe (ID: `person:Jarib.2`); Joiaribe (ID: `person:Joiarib.2`); Semaías (ID: `person:Shemaiah.15`); Ido (ID: `person:Iddo`); Eliezer (ID: `person:Eliezer.8`); Casifia (ID: `place:Casiphia`); Ariel (ID: `person:Ariel`); Elnatã (ID: `person:Elnathan.2`); Mesulão (ID: `person:Meshullam.9`); Elnatã (ID: `person:Elnathan.4`); Natã (ID: `person:Nathan.5`); SENHOR (ID: `deity:Lord`); perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); Levi (ID: `person:Levi.3`); Israel (ID: `person:Israel`); Insight (ID: `keyterm:Insight`); SENHOR (ID: `deity:Lord`); Mali (ID: `person:Mahli`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Davi (ID: `person:David`); work (ID: `keyterm:Work`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); Canaã (ID: `place:Canaan`); Moabe (ID: `place:Moab`); Jebusites (ID: `group:Jebusites`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); be unfaithful (ID: `keyterm:Unfaithful`); Egyptians (ID: `group:Egypt`); Egito (ID: `place:Egypt`); Hete (ID: `person:Heth`); cananeu (ID: `group:Canaan`); Ammonites (ID: `group:Ammon`); Amom (ID: `place:Ammon`); Amorites (ID: `group:Amorites`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Harim (ID: `person:Harim`); offering (ID: `keyterm:Offering`); Elam (ID: `person:Elam`); counsel (ID: `keyterm:Counsel`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Hasum (ID: `person:Hashum`); Benaia (ID: `person:Benaiah.10`); Uzias (ID: `person:Uzziah.4`); Elias (ID: `person:Elijah.3`); Issias (ID: `person:Isshijah`); Eliasibe (ID: `person:Eliashib.5`); Vanias (ID: `person:Vaniah`); Zabai (ID: `person:Zabbai`); Uri (ID: `person:Uri.3`); Zacarias (ID: `person:Zechariah.21`); Elifelete (ID: `person:Eliphelet.6`); Joanã (ID: `person:Jehohanan.4`); Amrão (ID: `person:Amram.2`); Eliezer (ID: `person:Eliezer.10`); Zabadias (ID: `person:Zebadiah.9`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); kindness (ID: `keyterm:Kindness`); defilement (ID: `keyterm:Defilement`); dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`); to cause to possess (ID: `keyterm:Possess`); Pérsia (ID: `place:Persia`); peace (ID: `keyterm:IntactState`); supplication (ID: `keyterm:Supplication`); Israel (ID: `person:Israel`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); kindness (ID: `keyterm:Kindness`); Jerusalém (ID: `place:Jerusalem`); Pérsia (ID: `place:Persia`); supplication (ID: `keyterm:Supplication`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jeiel (ID: `person:Jehiel.8`); Secanias (ID: `person:Shecaniah.7`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Elam (ID: `person:Elam`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); swear (ID: `keyterm:Swear`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Benjamim (ID: `person:Benjamin`); Benjamim (ID: `group:Benjamin`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jônatas (ID: `person:Jonathan.10`); Jazeías (ID: `person:Jahzeiah`); Mesulão (ID: `person:Meshullam.10`); Asael (ID: `person:Asahel.4`); Sabetai (ID: `person:Shabbethai`); Ticva (ID: `person:Tikvah.2`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`)
