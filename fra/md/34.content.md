...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); zélé (ID: `keyterm:Zealous.3`); force (ID: `keyterm:Strength`); Carmel (ID: `place:Carmel`); Basan (ID: `place:Bashan`); Liban (ID: `place:Lebanon`); déclarer innocent (ID: `keyterm:PronounceInnocent`); chemin (ID: `keyterm:TheWay`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); zélé (ID: `keyterm:Zealous.3`); force (ID: `keyterm:Strength`); Carmel (ID: `place:Carmel`); Basan (ID: `place:Bashan`); se réfugier (ID: `keyterm:SeekfindRefuge`); Liban (ID: `place:Lebanon`); déclarer innocent (ID: `keyterm:PronounceInnocent`); méchanceté (ID: `keyterm:Wickedness`); chemin (ID: `keyterm:TheWay`); Strong Drink (ID: `realia:StrongDrink`); Brier (ID: `flora:Brier`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); chemin (ID: `keyterm:TheWay`); force (ID: `keyterm:Strength`); déclarer innocent (ID: `keyterm:PronounceInnocent`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); se réfugier (ID: `keyterm:SeekfindRefuge`); méchanceté (ID: `keyterm:Wickedness`); Strong Drink (ID: `realia:StrongDrink`); Brier (ID: `flora:Brier`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** faire un voeu (ID: `keyterm:Vow`); Juda (ID: `group:Judah`); état intact (ID: `keyterm:IntactState`); méchanceté (ID: `keyterm:Wickedness`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); Éternel (ID: `deity:Lord`); Grass (ID: `flora:Grass`); Flock (ID: `fauna:Flock`); Chariot (ID: `realia:Chariot`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Libya (ID: `place:Libya`); Puth (ID: `place:Put`); Égypte (ID: `place:Egypt`); Cush (ID: `place:Cush.2`); destin (ID: `keyterm:Lot`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`)
