...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); The Way (ID: `keyterm:TheWay`); Basã (ID: `place:Bashan`); Libano (ID: `place:Lebanon`); Carmelo (ID: `place:Carmel`); strength (ID: `keyterm:Strength`); Zealous (ID: `keyterm:Zealous.3`); pronounce innocent (ID: `keyterm:PronounceInnocent`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); The Way (ID: `keyterm:TheWay`); wickedness (ID: `keyterm:Wickedness`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Basã (ID: `place:Bashan`); Libano (ID: `place:Lebanon`); Carmelo (ID: `place:Carmel`); strength (ID: `keyterm:Strength`); Zealous (ID: `keyterm:Zealous.3`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Strong Drink (ID: `realia:StrongDrink`); Brier (ID: `flora:Brier`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** wickedness (ID: `keyterm:Wickedness`); make a vow (ID: `keyterm:Vow`); peace (ID: `keyterm:IntactState`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Pute (ID: `place:Put`); lot (ID: `keyterm:Lot`); Líbia (ID: `place:Libya`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Cush (ID: `place:Cush.2`); Egito (ID: `place:Egypt`)
