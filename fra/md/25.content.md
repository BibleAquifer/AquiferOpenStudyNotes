...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); se rebeller (ID: `keyterm:Rebel`); Jérusalem (ID: `place:Jerusalem`); force (ID: `keyterm:Strength`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); aimer (ID: `keyterm:Love`); tromperie (ID: `keyterm:Deceit`); travil (ID: `keyterm:Work`); indomptables (ID: `keyterm:MightyOne`); pollution (ID: `keyterm:Defilement`); pécher (ID: `keyterm:Sin`); Israël (ID: `person:Israel`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); fête déterminée (ID: `keyterm:AppointedFeast`); Train (ID: `realia:Train`); Winepress (ID: `realia:Winepress`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Deer (ID: `fauna:Deer`); House (ID: `realia:House`); Yoke (ID: `realia:Yoke`); Net (ID: `realia:Net`); Grass (ID: `flora:Grass`); Casting Net (ID: `realia:CastingNet`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); pollution (ID: `keyterm:Defilement`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); pécher (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** se rebeller (ID: `keyterm:Rebel`); Éternel (ID: `deity:Lord`); force (ID: `keyterm:Strength`); Yoke (ID: `realia:Yoke`)
...
* **Associated ACAI Concepts:** Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Éternel (ID: `deity:Lord`); indomptables (ID: `keyterm:MightyOne`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); Israël (ID: `person:Israel`); fête déterminée (ID: `keyterm:AppointedFeast`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); colline (ID: `keyterm:Horn`); Sheep (ID: `fauna:Lamb`); nation; peuple (ID: `group:Gentile`); profaner, déshonorer (ID: `keyterm:Dishonor`); voir (ID: `keyterm:HaveAVision`); Utterance (ID: `keyterm:Utterance`); Instruction (ID: `keyterm:Instruction`); sabbat (ID: `keyterm:Sabbath`); ardeur (ID: `keyterm:Ardour`); Tent (ID: `realia:Tent`); Measuring Reed (ID: `realia:MeasuringReed`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Sackcloth (ID: `realia:Sackcloth`); Stone Altar (ID: `realia:StoneAltar`); Grain (ID: `flora:Grain`); Bow (ID: `realia:Bow`); Vine (ID: `flora:Vine`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); colline (ID: `keyterm:Horn`); Israël (ID: `person:Israel`); Tent (ID: `realia:Tent`); Bow (ID: `realia:Bow`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** fête déterminée (ID: `keyterm:AppointedFeast`); Éternel (ID: `deity:Lord`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Wormwood (ID: `flora:Wormwood`); Arrow (ID: `realia:Arrow`); bonté (ID: `keyterm:Kindness`); flèche (ID: `keyterm:Arrow`); état intact (ID: `keyterm:IntactState`); juste (ID: `keyterm:Complete`); Lion (ID: `fauna:Lion`); Bear (ID: `fauna:Bear`); Bow (ID: `realia:Bow`); Hewn Stone (ID: `realia:HewnStone`); Bitter Herbs (ID: `flora:Chicory`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); bonté (ID: `keyterm:Kindness`); se rebeller (ID: `keyterm:Rebel`); pardonner (ID: `keyterm:Forgive`); état intact (ID: `keyterm:IntactState`); juste (ID: `keyterm:Complete`); pécher (ID: `keyterm:Sin`); espoir (ID: `keyterm:Hope`); flèche (ID: `keyterm:Arrow`); acheter (ID: `keyterm:Redeem`); craindre (ID: `keyterm:Fear`); aide (ID: `keyterm:Salvation`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Pit (ID: `realia:Pit`); Wormwood (ID: `flora:Wormwood`); Arrow (ID: `realia:Arrow`); Lion (ID: `fauna:Lion`); Hewn Stone (ID: `realia:HewnStone`); Bow (ID: `realia:Bow`); Yoke (ID: `realia:Yoke`); Bitter Herbs (ID: `flora:Chicory`); Bird (ID: `fauna:Bird`); Bear (ID: `fauna:Bear`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); ardeur (ID: `keyterm:Ardour`); Édom (ID: `place:Edom`); pécher (ID: `keyterm:Sin`); Uts (ID: `place:Uz`); souiller (ID: `keyterm:Stain`); punition (ID: `keyterm:Punishment`); juste (ID: `keyterm:Complete`); fie (ID: `keyterm:BelieveIn`); agir avec bonté (ID: `keyterm:KindlyDisposed`); Sodome (ID: `place:Sodom`); pollution (ID: `keyterm:Defilement`); oint (ID: `keyterm:Anointed`); charger (ID: `keyterm:Appoint`); Ostrich (ID: `fauna:Ostrich`); Jackal (ID: `fauna:Jackal`); Vulture (ID: `fauna:Vulture`); Clay Jar (ID: `realia:ClayJar`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** Édom (ID: `place:Edom`); Uts (ID: `place:Uz`); ardeur (ID: `keyterm:Ardour`); Jérusalem (ID: `place:Jerusalem`); juste (ID: `keyterm:Complete`); pécher (ID: `keyterm:Sin`); charger (ID: `keyterm:Appoint`)
...
* **Associated ACAI Concepts:** ardeur (ID: `keyterm:Ardour`); Jérusalem (ID: `place:Jerusalem`); Édom (ID: `place:Edom`); juste (ID: `keyterm:Complete`); pécher (ID: `keyterm:Sin`); charger (ID: `keyterm:Appoint`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); pécher (ID: `keyterm:Sin`); Égypte (ID: `place:Egypt`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Assyria (ID: `place:Assyria`); ardeur (ID: `keyterm:Ardour`); danse en rond (ID: `keyterm:RoundDance`); laissiez en possession (ID: `keyterm:Possess`); Woe (ID: `keyterm:Woe`); Crown (ID: `realia:Crown`); Jackal (ID: `fauna:Jackal`); Hand-Mill (ID: `realia:Hand-mill`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** danse en rond (ID: `keyterm:RoundDance`); pécher (ID: `keyterm:Sin`); Woe (ID: `keyterm:Woe`); Crown (ID: `realia:Crown`); Hand-Mill (ID: `realia:Hand-mill`)
