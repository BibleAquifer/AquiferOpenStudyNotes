...
* **Associated ACAI Concepts:** Covenant (ID: `keyterm:Covenant`); Edomites (ID: `group:Edom`); Peace (ID: `keyterm:IntactState`); أَدومَ (ID: `place:Edom`); Understanding (ID: `keyterm:Understanding`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); يَهوذَا (ID: `person:Judah.4`); Lot (ID: `keyterm:Lot`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Edomites (ID: `group:Edom`); ٱلرَّبِّ (ID: `deity:Lord`); يوسف (ID: `person:Joseph.10`); أَدومَ (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); إِسْرَائِيلَ (ID: `person:Israel`); سَارْدِسَ (ID: `place:Sardis`); كَنْعَان (ID: `place:Canaan`); أَفْرَايِمَ (ID: `group:Ephraim`); ٱلسَّهْلِ (ID: `place:Shephelah`); أَفْرَايِمَ (ID: `person:Ephraim`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); جِلْعَادَ (ID: `place:Gilead`); بَنْيَامِينَ (ID: `group:Benjamin`); ٱلسَّامِرَةِ (ID: `place:Samaria`); فِلِشْتِيم (ID: `group:Philistine`); عِيسو (ID: `place:EsauMount`); بَنْيَامِينَ (ID: `person:Benjamin`); Canaanites (ID: `group:Canaan`); أورشَلِيمَ (ID: `place:Jerusalem`); إِلَى (ID: `place:Zarephath`)
...
* **Associated ACAI Concepts:** عِيسو (ID: `place:EsauMount`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْجَنوبِ (ID: `place:Negeb`); Dispossess (ID: `keyterm:Dispossess`); إِسْرَائِيلَ (ID: `person:Israel`); كَنْعَان (ID: `place:Canaan`); أَفْرَايِمَ (ID: `group:Ephraim`); ٱلرَّبِّ (ID: `deity:Lord`); أَفْرَايِمَ (ID: `person:Ephraim`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); سَارْدِسَ (ID: `place:Sardis`); فِلِشْتِيم (ID: `group:Philistine`); بَنْيَامِينَ (ID: `person:Benjamin`); ٱلسَّامِرَةِ (ID: `place:Samaria`); ٱلسَّهْلِ (ID: `place:Shephelah`); بَنْيَامِينَ (ID: `group:Benjamin`); إِلَى (ID: `place:Zarephath`); جِلْعَادَ (ID: `place:Gilead`); Canaanites (ID: `group:Canaan`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); سَارْدِسَ (ID: `place:Sardis`); كَنْعَان (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); ٱلْجَنوبِ (ID: `place:Negeb`); أورشَلِيمَ (ID: `place:Jerusalem`); Dispossess (ID: `keyterm:Dispossess`); إِلَى (ID: `place:Zarephath`)
