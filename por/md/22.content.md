...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); love (ID: `keyterm:Love`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Wine (ID: `realia:Wine`); Flock (ID: `fauna:Flock`); Faraó (ID: `person:Pharaoh.7`); Jerusalém (ID: `place:Jerusalem`); En-Gedi (ID: `place:Engedi`); fairness (ID: `keyterm:Fairness`); Quedar (ID: `person:Kedar`); Salomão (ID: `person:Solomon`); Henna (ID: `flora:Henna`); Nard (ID: `flora:Nard`); Chariot (ID: `realia:Chariot`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Myrrh (ID: `flora:Myrrh`); Goat Hair Strips (ID: `realia:GoatHairStrips`); Horse (ID: `fauna:Horse`); Linen Strips (ID: `realia:LinenStrips`); Kid (ID: `fauna:Kid`); Olive Oil (ID: `realia:OliveOil`); Bag (ID: `realia:Bag`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Quedar (ID: `person:Kedar`); Jerusalém (ID: `place:Jerusalem`); Goat Hair Strips (ID: `realia:GoatHairStrips`); Linen Strips (ID: `realia:LinenStrips`); Tent (ID: `realia:Tent`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Gazelle (ID: `fauna:Gazelle`); Deer (ID: `fauna:Deer`); Vine (ID: `flora:Vine`); Dove (ID: `fauna:Dove`); Beter (ID: `place:BetherMountain`); Lily (ID: `flora:Lily`); Window (ID: `realia:Window`); Jackal (ID: `fauna:Jackal`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); love (ID: `keyterm:Love`); Libano (ID: `place:Lebanon`); Jerusalém (ID: `place:Jerusalem`); Money (ID: `realia:Money`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** Balsam Tree (ID: `flora:BalsamTree`); Libano (ID: `place:Lebanon`); Myrrh (ID: `flora:Myrrh`); Pomegranate (ID: `flora:Pomegranate`); Goat (ID: `fauna:Goat`); Vine (ID: `flora:Vine`); Frankincense (ID: `flora:Frankincense`); Nard (ID: `flora:Nard`); Wine (ID: `realia:Wine`); Veil (ID: `realia:Veil`); Flock (ID: `fauna:Flock`); Monte Hermom (ID: `place:HermonMount`); Monte Amana (ID: `place:Amana`); Davi (ID: `person:David`); Gileade (ID: `place:Gilead`); Henna (ID: `flora:Henna`); Saffron Plant (ID: `flora:SaffronPlant`); Calamus (ID: `flora:Calamus`); Gazelle (ID: `fauna:Gazelle`); Cloak (ID: `realia:Cloak`); Small Shield (ID: `realia:SmallShield`); Cinnamon (ID: `flora:Cinnamon`); Tower (ID: `realia:Tower`); Lily (ID: `flora:Lily`); Anointing Oil (ID: `realia:AnointingOil`); Leopard (ID: `fauna:Leopard`); Olive Oil (ID: `realia:OliveOil`); Thread (ID: `realia:Thread`); Dove (ID: `fauna:Dove`); Lion (ID: `fauna:Lion`); Agarwood (ID: `flora:Agarwood`)
...
* **Associated ACAI Concepts:** Libano (ID: `place:Lebanon`); Wine (ID: `realia:Wine`); Cloak (ID: `realia:Cloak`); Vine (ID: `flora:Vine`); Balsam Tree (ID: `flora:BalsamTree`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Lily (ID: `flora:Lily`); swear (ID: `keyterm:Swear`); Jerusalém (ID: `place:Jerusalem`); Balsam Tree (ID: `flora:BalsamTree`); Dove (ID: `fauna:Dove`); Myrrh (ID: `flora:Myrrh`); love (ID: `keyterm:Love`); Libano (ID: `place:Lebanon`); Tunic (ID: `realia:Tunic.2`); Veil (ID: `realia:Veil`); Cedar (ID: `flora:Cedar`); Crow (ID: `fauna:Crow`)
...
* **Associated ACAI Concepts:** Libano (ID: `place:Lebanon`); Jerusalém (ID: `place:Jerusalem`); Lily (ID: `flora:Lily`); Balsam Tree (ID: `flora:BalsamTree`); Dove (ID: `fauna:Dove`); Cedar (ID: `flora:Cedar`); Crow (ID: `fauna:Crow`); Myrrh (ID: `flora:Myrrh`)
...
* **Associated ACAI Concepts:** Libano (ID: `place:Lebanon`); Lily (ID: `flora:Lily`); Balsam Tree (ID: `flora:BalsamTree`); Dove (ID: `fauna:Dove`); Cedar (ID: `flora:Cedar`); Crow (ID: `fauna:Crow`); Myrrh (ID: `flora:Myrrh`)
...
* **Associated ACAI Concepts:** Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Standard (ID: `realia:Standard`); Tirza (ID: `place:Tirzah`); Jerusalém (ID: `place:Jerusalem`); Gileade (ID: `place:Gilead`); Veil (ID: `realia:Veil`); Pomegranate (ID: `flora:Pomegranate`); Dove (ID: `fauna:Dove`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Date Palm (ID: `flora:DatePalm`); Shulammites (ID: `group:Shulammites`); Bate-Rabim (ID: `place:Bath-rabbim`); fairness (ID: `keyterm:Fairness`); love (ID: `keyterm:Love`); Libano (ID: `place:Lebanon`); Hesbom (ID: `place:Heshbon`); Carmelo (ID: `place:Carmel`); Damasco (ID: `place:Damascus`); Gazelle (ID: `fauna:Gazelle`); Lily (ID: `flora:Lily`); Apple (ID: `flora:AppleTree`); Purple Cloth (ID: `realia:PurpleCloth`); Wheat (ID: `flora:Wheat`); Tower (ID: `realia:Tower`)
...
* **Associated ACAI Concepts:** Bate-Rabim (ID: `place:Bath-rabbim`); Libano (ID: `place:Lebanon`); Hesbom (ID: `place:Heshbon`); Carmelo (ID: `place:Carmel`); Damasco (ID: `place:Damascus`); Wine (ID: `realia:Wine`); Gazelle (ID: `fauna:Gazelle`); Lily (ID: `flora:Lily`); Purple Cloth (ID: `realia:PurpleCloth`); Wheat (ID: `flora:Wheat`); Tower (ID: `realia:Tower`)
...
* **Associated ACAI Concepts:** swear (ID: `keyterm:Swear`); love (ID: `keyterm:Love`); Jerusalém (ID: `place:Jerusalem`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Pomegranate (ID: `flora:Pomegranate`); Must (ID: `realia:Must`)
