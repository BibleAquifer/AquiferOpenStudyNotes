...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Arquipo (ID: `person:Archippus`); Filemom (ID: `person:Philemon`); Áfia (ID: `person:Apphia`); igreja (ID: `keyterm:Church`); SENHOR (ID: `deity:Lord`); amado (ID: `keyterm:Beloved`); Timóteo (ID: `person:Timothy`); fazer a paz (ID: `keyterm:Peace`); favor (ID: `keyterm:Favor`); Paulo (ID: `person:Paul`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); holy (ID: `keyterm:Holy`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`); Good (ID: `keyterm:Good`); comunhão (ID: `keyterm:Fellowship`); Cause of Joy (ID: `keyterm:CauseOfJoy`); SENHOR (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); orar (ID: `keyterm:Pray`); compaixão (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); em cristo (ID: `keyterm:InChrist`); rogar (ID: `keyterm:AskFor`); Paulo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Lucas (ID: `person:Luke`); Demas (ID: `person:Demas`); Epafras (ID: `person:Epaphras`); Aristarco (ID: `person:Aristarchus`); em cristo (ID: `keyterm:InChrist`); Marcos (ID: `person:Mark`); favor (ID: `keyterm:Favor`); Spirit (ID: `keyterm:Spirit.2`)
