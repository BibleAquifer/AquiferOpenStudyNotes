...
* **Associated ACAI Concepts:** Efrata (ID: `person:Ephrathah`); Noemi (ID: `person:Naomi`); Quiliom (ID: `person:Chilion`); Ephrathites (ID: `group:Ephrathah`); Judá (ID: `group:Judah`); Belém (ID: `place:Bethlehem`); Judá (ID: `person:Judah.4`); Elimeleque (ID: `person:Elimelech`); Moabe (ID: `place:Moab`); Malom (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Rute (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); Belém (ID: `place:Bethlehem`); Moabe (ID: `place:Moab`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** favor (ID: `keyterm:Favor`); Moabe (ID: `place:Moab`); Rute (ID: `person:Ruth`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); kindness (ID: `keyterm:Kindness`); Noemi (ID: `person:Naomi`); bless (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Belém (ID: `place:Bethlehem`); Lia (ID: `person:Leah`); Elders (ID: `group:GenericElders`); Raquel (ID: `person:Rachel`)
...
* **Associated ACAI Concepts:** Tamar (ID: `person:Tamar`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Perez (ID: `person:Perez`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Noemi (ID: `person:Naomi`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); bless (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Hezrom (ID: `person:Hezron.2`); Salmom (ID: `person:Salmon`); Obede (ID: `person:Obed`); Aminadabe (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Boaz (ID: `person:Boaz`); Jessé (ID: `person:Jesse`); Naassom (ID: `person:Nahshon`); Davi (ID: `person:David`); Perez (ID: `person:Perez`)
