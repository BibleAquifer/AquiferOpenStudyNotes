...
* **Associated ACAI Concepts:** Efratita (ID: `group:Ephrathah`); Ephrata (ID: `person:Ephrathah`); Noemi (ID: `person:Naomi`); Chelión (ID: `person:Chilion`); Elimelech (ID: `person:Elimelech`); Judá (ID: `person:Judah.4`); Mahalón (ID: `person:Mahlon`); Catah (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Noemi (ID: `person:Naomi`); Jehová (ID: `deity:Lord`); bendecir (ID: `keyterm:Bless`); bondad (ID: `keyterm:Kindness`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Booz (ID: `person:Boaz`); dejar en herencia (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Catah (ID: `place:Bethlehem`); Rachêl (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); Jehová (ID: `deity:Lord`); Lea (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Judá (ID: `person:Judah.4`); Thamar (ID: `person:Tamar`); Jehová (ID: `deity:Lord`); Judá (ID: `group:Judah`); Phares (ID: `person:Perez`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); Booz (ID: `person:Boaz`); Ruth (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Israel (ID: `person:Israel`); Jehová (ID: `deity:Lord`); bendecir (ID: `keyterm:Bless`); Noemi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Salmón (ID: `person:Salmon`); Hesrón (ID: `person:Hezron.2`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Booz (ID: `person:Boaz`); David (ID: `person:David`); Isaí (ID: `person:Jesse`); Phares (ID: `person:Perez`); Nahasón (ID: `person:Nahshon`)
