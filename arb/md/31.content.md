...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); أَدومَ (ID: `place:Edom`); Understanding (ID: `keyterm:Understanding`); Covenant (ID: `keyterm:Covenant`); Peace (ID: `keyterm:IntactState`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** Understanding (ID: `keyterm:Understanding`); أَدومَ (ID: `place:Edom`); ٱلرَّبِّ (ID: `deity:Lord`); عِيسو (ID: `place:EsauMount`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Lot (ID: `keyterm:Lot`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Edomites (ID: `group:Edom`); أورشَلِيمَ (ID: `place:Jerusalem`); Dispossess (ID: `keyterm:Dispossess`); أَدومَ (ID: `place:Edom`); يوسف (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); أَدومَ (ID: `place:Edom`); ٱلرَّبِّ (ID: `deity:Lord`); يوسف (ID: `person:Joseph.10`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); ٱلْجَنوبِ (ID: `place:Negeb`); جِلْعَادَ (ID: `place:Gilead`); بَنْيَامِينَ (ID: `group:Benjamin`); بَنْيَامِينَ (ID: `person:Benjamin`); أورشَلِيمَ (ID: `place:Jerusalem`); إِلَى (ID: `place:Zarephath`); Canaanites (ID: `group:Canaan`); ٱلسَّامِرَةِ (ID: `place:Samaria`); ٱلسَّهْلِ (ID: `place:Shephelah`); إِسْرَائِيلَ (ID: `person:Israel`); كَنْعَان (ID: `place:Canaan`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); أَفْرَايِمَ (ID: `group:Ephraim`); أَفْرَايِمَ (ID: `person:Ephraim`); عِيسو (ID: `place:EsauMount`); فِلِشْتِيم (ID: `group:Philistine`); سَارْدِسَ (ID: `place:Sardis`)
...
* **Associated ACAI Concepts:** ٱلْجَنوبِ (ID: `place:Negeb`); أورشَلِيمَ (ID: `place:Jerusalem`); Dispossess (ID: `keyterm:Dispossess`); عِيسو (ID: `place:EsauMount`); Canaanites (ID: `group:Canaan`); أَفْرَايِمَ (ID: `person:Ephraim`); سَارْدِسَ (ID: `place:Sardis`); جِلْعَادَ (ID: `place:Gilead`); بَنْيَامِينَ (ID: `person:Benjamin`); ٱلسَّامِرَةِ (ID: `place:Samaria`); ٱلرَّبِّ (ID: `deity:Lord`); كَنْعَان (ID: `place:Canaan`); فِلِشْتِيم (ID: `group:Philistine`); إِلَى (ID: `place:Zarephath`); إِسْرَائِيلَ (ID: `person:Israel`); بَنْيَامِينَ (ID: `group:Benjamin`); ٱلسَّهْلِ (ID: `place:Shephelah`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); أَفْرَايِمَ (ID: `group:Ephraim`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); إِلَى (ID: `place:Zarephath`); Dispossess (ID: `keyterm:Dispossess`); ٱلْجَنوبِ (ID: `place:Negeb`); Canaanites (ID: `group:Canaan`); إِسْرَائِيلَ (ID: `person:Israel`); كَنْعَان (ID: `place:Canaan`); سَارْدِسَ (ID: `place:Sardis`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); عِيسو (ID: `place:EsauMount`); ٱلرَّبِّ (ID: `deity:Lord`)
