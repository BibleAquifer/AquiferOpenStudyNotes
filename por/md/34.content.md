...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); strength (ID: `keyterm:Strength`); Libano (ID: `place:Lebanon`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Basã (ID: `place:Bashan`); The Way (ID: `keyterm:TheWay`); Zealous (ID: `keyterm:Zealous.3`); Carmelo (ID: `place:Carmel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Carmelo (ID: `place:Carmel`); strength (ID: `keyterm:Strength`); Libano (ID: `place:Lebanon`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Basã (ID: `place:Bashan`); wickedness (ID: `keyterm:Wickedness`); The Way (ID: `keyterm:TheWay`); Zealous (ID: `keyterm:Zealous.3`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`); Strong Drink (ID: `realia:StrongDrink`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); wickedness (ID: `keyterm:Wickedness`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`); Strong Drink (ID: `realia:StrongDrink`)
...
* **Associated ACAI Concepts:** make a vow (ID: `keyterm:Vow`); peace (ID: `keyterm:IntactState`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); wickedness (ID: `keyterm:Wickedness`)
...
* **Associated ACAI Concepts:** being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); lot (ID: `keyterm:Lot`); Pute (ID: `place:Put`); Egito (ID: `place:Egypt`); Líbia (ID: `place:Libya`); Cush (ID: `place:Cush.2`)
