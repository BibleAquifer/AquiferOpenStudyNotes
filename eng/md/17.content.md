...
* **Associated ACAI Concepts:** Carkas (ID: `person:Carkas`); Harbona (ID: `person:Harbona`); Mehuman (ID: `person:Mehuman`); Bigtha (ID: `person:Bigtha`); Abagtha (ID: `person:Abagtha`); Biztha (ID: `person:Biztha`); Zethar (ID: `person:Zethar`); Ahasuerus (ID: `person:Ahasuerus`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Vashti (ID: `person:Vashti`); Persians (ID: `group:Persia`); Persia (ID: `place:Persia`); Medes (ID: `group:Mede`); Medan (ID: `person:Medan`); Ahasuerus (ID: `person:Ahasuerus`)
...
* **Associated ACAI Concepts:** Jehoiachin (ID: `person:Jehoiachin`); Judah (ID: `person:Judah.4`); Babylon (ID: `place:Babylon`); Tribe of Judah (ID: `group:Judah`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Ahasuerus (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); Hammedatha (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Money (ID: `realia:Money`); Servants (ID: `group:GenericServants`); Susa (ID: `place:Susa`); Lot (ID: `keyterm:Lot`); Lot (ID: `realia:Lot`); Talent (ID: `realia:Talent`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Ahasuerus (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Zeresh (ID: `person:Zeresh`); Love (ID: `keyterm:Love`); Esther (ID: `person:Esther`); Glory (ID: `keyterm:Glory`); A Group of People (ID: `group:GenericGroup`); Jews (ID: `group:Jews`); House (ID: `realia:House`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Esther (ID: `person:Esther`); Agag (ID: `person:Agag.2`); Haman (ID: `person:Haman`); Agagites (ID: `group:Agag`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Agag (ID: `person:Agag.2`); Haman (ID: `person:Haman`); Agagites (ID: `group:Agag`); Favor (ID: `keyterm:Favor`); Jews (ID: `group:Jews`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Lot (ID: `realia:Lot`); Hammedatha (ID: `person:Hammedatha`); Mordecai (ID: `person:Mordecai.2`); Agag (ID: `person:Agag.2`); Haman (ID: `person:Haman`); Agagites (ID: `group:Agag`); Lot (ID: `keyterm:Lot`); Scroll (ID: `realia:Scroll`)
