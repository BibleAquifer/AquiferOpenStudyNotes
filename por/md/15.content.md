...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Pérsia (ID: `place:Persia`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`); Israel (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Jeremias (ID: `person:Jeremiah.6`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Jerusalém (ID: `place:Jerusalem`); Pérsia (ID: `place:Persia`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `person:Benjamin`); Benjamim (ID: `group:Benjamin`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Levi (ID: `group:Levi`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Levi (ID: `person:Levi.3`); House (ID: `realia:House`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Levi (ID: `group:Levi`); Jerusalém (ID: `place:Jerusalem`); Salomão (ID: `person:Solomon`); Levi (ID: `person:Levi.3`); Jora (ID: `person:Jorah`); Zacai (ID: `person:Zaccai.2`); Jedaías (ID: `person:Jedaiah.4`); Gidel (ID: `person:Giddel.2`); Padom (ID: `person:Padon`); Hagaba (ID: `person:Hagabah`); Sobai (ID: `person:Shobai`); Zia (ID: `person:Ziha`); Mispar (ID: `person:Mispar`); Reaías (ID: `person:Reaiah.3`); Adã (ID: `place:Addan`); Hadide (ID: `place:Hadid`); Harur (ID: `person:Harhur`); Darcom (ID: `person:Darkon`); Sephatias (ID: `person:Shephatiah.6`); Jesua (ID: `person:Jeshua.3`); Netofa (ID: `place:Netophah`); Tel-Melá (ID: `place:Tel-melah`); Ezequias (ID: `person:Hezekiah.2`); Baana (ID: `person:Baanah.3`); Reum (ID: `person:Rehum`); Lebana (ID: `person:Lebanah`); Bebai (ID: `person:Bebai`); Temá (ID: `person:Temah`)
...
* **Associated ACAI Concepts:** Bigvai (ID: `person:Bigvai`); Mordecai (ID: `person:Mordecai`); Mispar (ID: `person:Mispar`); Neemias (ID: `person:Nehemiah`); Reum (ID: `person:Rehum`); Seraias (ID: `person:Seraiah.6`); Reelaías (ID: `person:Reelaiah`); Bilsã (ID: `person:Bilshan`); Baana (ID: `person:Baanah.3`); Israel (ID: `person:Israel`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Jora (ID: `person:Jorah`); Zacai (ID: `person:Zaccai.2`); Elam (ID: `person:Elam`); Ater (ID: `person:Ater`); Bigvai (ID: `person:Bigvai.2`); Adonicão (ID: `person:Adonikam`); Joabe (ID: `person:Joab.3`); Asgade (ID: `person:Azgad`); Sephatias (ID: `person:Shephatiah.6`); Bezai (ID: `person:Bezai`); Jesua (ID: `person:Jeshua.3`); Bani (ID: `person:Bani`); Parós (ID: `person:Parosh`); Ezequias (ID: `person:Hezekiah.2`); Zatu (ID: `person:Zattu.2`); Hasum (ID: `person:Hashum`); Bebai (ID: `person:Bebai`); Paate-Moabe (ID: `person:Pahath-moab`); Ará (ID: `person:Arah.2`); Adim (ID: `person:Adin`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Beth-azmaveth (ID: `place:Beth-azmaveth`); Harim (ID: `person:Harim.2`); Hadide (ID: `place:Hadid`); Netofa (ID: `place:Netophah`); Nebo (ID: `place:Nebo.2`); Magbis (ID: `place:Magbish`); Senaa (ID: `place:Senaah`); Elam (ID: `person:Elam`); Lode (ID: `place:Lod`); Ai (ID: `place:Ai`); Anatote (ID: `place:Anathoth`); Micmás (ID: `place:Michmash`); Betel (ID: `place:Bethel`); Ono (ID: `place:Ono`); Jericó (ID: `place:Jericho`); Cefira (ID: `place:Chephirah`); Beerote (ID: `place:Beeroth`); Geba (ID: `place:Geba`); Quiriate-Jearim (ID: `place:Kiriath-jearim`); Belém (ID: `place:Bethlehem`); Ramah (ID: `place:Ramah.2`)
...
* **Associated ACAI Concepts:** Sobai (ID: `person:Shobai`); Jesua (ID: `person:Jeshua.4`); Harim (ID: `person:Harim`); Jedaías (ID: `person:Jedaiah.4`); Jesua (ID: `person:Jeshua`); Hatita (ID: `person:Hatita`); Talmom (ID: `person:Talmon`); Ater (ID: `person:Ater.2`); Hodavias (ID: `person:Hodaviah.4`); Imer (ID: `person:Immer.2`); Acube (ID: `person:Akkub.2`); Asafe (ID: `person:Asaph.2`); Levi (ID: `group:Levi`); Cadmiel (ID: `person:Kadmiel`); Salum (ID: `person:Shallum.8`); Pasur (ID: `person:Pashhur`); Levi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Sobai (ID: `person:Shobai`); Hatita (ID: `person:Hatita`); Talmom (ID: `person:Talmon`); Ater (ID: `person:Ater.2`); Acube (ID: `person:Akkub.2`); Asafe (ID: `person:Asaph.2`); Salum (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** Paseia (ID: `person:Paseah.2`); Acube (ID: `person:Akkub.3`); Necoda (ID: `person:Nekoda`); Nesias (ID: `person:Neziah`); Queros (ID: `person:Keros`); Sisera (ID: `person:Sisera.2`); Padom (ID: `person:Padon`); Hagaba (ID: `person:Hagabah`); Zia (ID: `person:Ziha`); Hagabe (ID: `person:Hagab`); Hatifa (ID: `person:Hatipha`); Sia (ID: `person:Siaha`); Uza (ID: `person:Uzza.2`); Reaías (ID: `person:Reaiah.3`); Gaar (ID: `person:Gahar`); Gazão (ID: `person:Gazzam`); Harur (ID: `person:Harhur`); Hanã (ID: `person:Hanan.4`); Besai (ID: `person:Besai`); Hasufa (ID: `person:Hasupha`); Baquebuque (ID: `person:Bakbuk`); Meída (ID: `person:Mehida`); Harsa (ID: `person:Harsha`); Salmai (ID: `person:Shalmai`); Meunim (ID: `group:Meunim`); Nephushesim (ID: `group:Nephushesim`); Lebana (ID: `person:Lebanah`); Gidel (ID: `person:Giddel`); Asná (ID: `person:Asnah`); Barcos (ID: `person:Barkos`); Temá (ID: `person:Temah`); Tabaote (ID: `person:Tabbaoth`); Hacufa (ID: `person:Hakupha`); Rezim (ID: `person:Rezin.2`); Bazlite (ID: `person:Bazluth`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Peruda (ID: `person:Peruda`); Ami (ID: `person:Ami`); Darcom (ID: `person:Darkon`); Sephatias (ID: `person:Shephatiah.7`); Soferete (ID: `person:Sophereth`); Gidel (ID: `person:Giddel.2`); Hatil (ID: `person:Hattil`); Jaala (ID: `person:Jaalah`); Sotai (ID: `person:Sotai`)
...
* **Associated ACAI Concepts:** Tobias (ID: `person:Tobiah`); Querube (ID: `place:Cherub`); Adã (ID: `place:Addan`); Tel-Melá (ID: `place:Tel-melah`); Tel-Harsa (ID: `place:Tel-harsha`); Necoda (ID: `person:Nekoda.2`); Delaías (ID: `person:Delaiah.3`); Imer (ID: `place:Immer`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Habaiah (ID: `person:Habaiah`); Barzillai (ID: `person:Barzillai.3`); Hacoz (ID: `person:Hakkoz.2`); stain (ID: `keyterm:Stain`); Gileade (ID: `place:Gilead`); Barzillai (ID: `person:Barzillai`); Gileadites (ID: `group:Gilead`); priesthood (ID: `keyterm:Priesthood`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); Jerusalém (ID: `place:Jerusalem`); strength (ID: `keyterm:Strength`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Mina (ID: `realia:Mina`); Tunic (ID: `realia:Tunic`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Josué (ID: `person:Joshua.5`); Pérsia (ID: `place:Persia`); Ciro (ID: `person:Cyrus`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Esar-Hadom (ID: `person:Esarhaddon`); Cadmiel (ID: `person:Kadmiel`); Relatives (ID: `group:Relatives`); Hodavias (ID: `person:Hodaviah.4`); Jesua (ID: `person:Jeshua.4`); Henadade (ID: `person:Henadad`); Moisés (ID: `person:Moses`); Libano (ID: `place:Lebanon`); Sidonians (ID: `group:Sidon`); Benjamim (ID: `group:Benjamin`); kindness (ID: `keyterm:Kindness`); Dario (ID: `person:Darius.2`); Tiro (ID: `place:Tyre`); Instruction (ID: `keyterm:Instruction`); appointed feast (ID: `keyterm:AppointedFeast`); Benjamim (ID: `person:Benjamin`); counsel (ID: `keyterm:Counsel`); terror (ID: `keyterm:Terror`); new moon festival (ID: `keyterm:NewMoonFestival`); Hodias (ID: `person:Hodiah.2`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); Jope (ID: `place:Joppa`); Sidom (ID: `place:Sidon`); holy (ID: `keyterm:Holy`); Assyria (ID: `place:Assyria`); Asafe (ID: `person:Asaph.2`); Tyrians (ID: `group:Tyre`); Davi (ID: `person:David`); Cymbals (ID: `realia:Cymbals`); Cedar (ID: `flora:Cedar`); Craftsman (ID: `realia:Craftsman`); Money (ID: `realia:Money`); Trumpet (ID: `realia:Trumpet`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); terror (ID: `keyterm:Terror`); SENHOR (ID: `deity:Lord`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); new moon festival (ID: `keyterm:NewMoonFestival`); appointed feast (ID: `keyterm:AppointedFeast`); holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Libano (ID: `place:Lebanon`); Tyrians (ID: `group:Tyre`); Tiro (ID: `place:Tyre`); Jope (ID: `place:Joppa`); Sidom (ID: `place:Sidon`); Sidonians (ID: `group:Sidon`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Money (ID: `realia:Money`); Cedar (ID: `flora:Cedar`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Jerusalém (ID: `place:Jerusalem`); Josué (ID: `person:Joshua.5`); Levi (ID: `group:Levi`); SENHOR (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); kindness (ID: `keyterm:Kindness`); Asafe (ID: `person:Asaph.2`); Levi (ID: `group:Levi`); Davi (ID: `person:David`); Levi (ID: `person:Levi.3`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `person:Benjamin`); Benjamim (ID: `group:Benjamin`); Israel (ID: `person:Israel`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Ciro (ID: `person:Cyrus`); Israel (ID: `person:Israel`); Pérsia (ID: `place:Persia`); Josué (ID: `person:Joshua.5`); SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Rio Eufrates (ID: `place:Euphrates`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Pérsia (ID: `place:Persia`); Samaria (ID: `place:Samaria`); Assuero (ID: `person:Ahasuerus`); Tabeel (ID: `person:Tabeel`); Dinaítas (ID: `person:Dinaite`); Mitredate (ID: `person:Mithredath.2`); Bislão (ID: `person:Bishlam`); Osnapar (ID: `person:Osnappar`); Babylonians (ID: `group:Babylon`); Ereque (ID: `place:Erech`); Elam (ID: `place:Elam`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Elamites (ID: `group:Elam`); Susã (ID: `place:Susa`); Persians (ID: `group:Persia`); Babilônia (ID: `place:Babylon`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Dinaítas (ID: `person:Dinaite`); Babylonians (ID: `group:Babylon`); Ereque (ID: `place:Erech`); Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Elam (ID: `place:Elam`); Susã (ID: `place:Susa`); Pérsia (ID: `place:Persia`); Persians (ID: `group:Persia`); Babilônia (ID: `place:Babylon`); Elamites (ID: `group:Elam`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Jews (ID: `group:Jews`); Artaxerxes (ID: `person:Artaxerxes.2`); Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Samaria (ID: `place:Samaria`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); Dario (ID: `person:Darius.2`); Tattenai (ID: `person:Tattenai`); Ageu (ID: `person:Haggai`); Ido (ID: `person:Iddo.6`); Zacarias (ID: `person:Zechariah.17`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Jeozadaque (ID: `person:Jehozadak`); Israel (ID: `person:Israel`); Sealtiel (ID: `person:Shealtiel.2`); Josué (ID: `person:Joshua.5`); Pérsia (ID: `place:Persia`); Judá (ID: `person:Judah.4`); Rio Eufrates (ID: `place:Euphrates`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Jerusalém (ID: `place:Jerusalem`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Aitube (ID: `person:Ahitub.3`); Amarias (ID: `person:Amariah.2`); Uzi (ID: `person:Uzzi`); Zadoque (ID: `person:Zadok.4`); Zeraías (ID: `person:Zerahiah`); Salum (ID: `person:Shallum.7`); Abisua (ID: `person:Abishua`); Meraiote (ID: `person:Meraioth`); Seraias (ID: `person:Seraiah.2`); Buqui (ID: `person:Bukki.2`); Azarias (ID: `person:Azariah.7`); Azarias (ID: `person:Azariah.6`); Pérsia (ID: `place:Persia`); Arão (ID: `person:Aaron`); Artaxerxes (ID: `person:Artaxerxes`); Fineias (ID: `person:Phinehas`); Hilquias (ID: `person:Hilkiah.2`); Eleazar (ID: `person:Eleazar.2`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Moisés (ID: `person:Moses`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Babilônia (ID: `place:Babylon`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Artaxerxes (ID: `person:Artaxerxes`); Ezra (ID: `person:Ezra`); Rio Eufrates (ID: `place:Euphrates`); Olive Oil (ID: `realia:OliveOil`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Kor (ID: `realia:Kor`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** Zacarias (ID: `person:Zechariah.18`); Daniel (ID: `person:Daniel.2`); Semaías (ID: `person:Shemaiah.14`); Zacarias (ID: `person:Zechariah.19`); Elam (ID: `person:Elam`); Hacatã (ID: `person:Hakkatan`); Miguel (ID: `person:Michael.10`); Elioenai (ID: `person:Eliehoenai.2`); Bigvai (ID: `person:Bigvai.2`); Elifelete (ID: `person:Eliphelet.5`); Joabe (ID: `person:Joab.4`); Parós (ID: `person:Parosh.2`); Gérson (ID: `person:Gershom.2`); Utai (ID: `person:Uthai.2`); Secanias (ID: `person:Shecaniah.6`); Zeraías (ID: `person:Zerahiah.2`); Adonicão (ID: `person:Adonikam`); Asgade (ID: `person:Azgad`); Jeuel (ID: `person:Jeuel.3`); Zabadias (ID: `person:Zebadiah.8`); Jaaziel (ID: `person:Jahaziel.5`); Sephatias (ID: `person:Shephatiah.6`); Bebai (ID: `person:Bebai.2`); Atalia (ID: `person:Athaliah.3`); Jesaías (ID: `person:Jeshaiah.4`); Josifias (ID: `person:Josiphiah`); Jeiel (ID: `person:Jehiel.7`); Hatus (ID: `person:Hattush.2`); Secanias (ID: `person:Shecaniah.5`); Bebai (ID: `person:Bebai`); Paate-Moabe (ID: `person:Pahath-moab`); Zacur (ID: `person:Zaccur.5`); Jônatas (ID: `person:Jonathan.9`); Selomite (ID: `person:Shelomith.4`); Joanã (ID: `person:Johanan.8`); Obadias (ID: `person:Obadiah.10`); Ebede (ID: `person:Ebed.2`); Adim (ID: `person:Adin`); Artaxerxes (ID: `person:Artaxerxes`); Fineias (ID: `person:Phinehas`); Babilônia (ID: `place:Babylon`); Davi (ID: `person:David`); Itamar (ID: `person:Ithamar`)
...
* **Associated ACAI Concepts:** Ariel (ID: `person:Ariel`); Eliezer (ID: `person:Eliezer.8`); Mesulão (ID: `person:Meshullam.9`); Casifia (ID: `place:Casiphia`); Ido (ID: `person:Iddo`); Semaías (ID: `person:Shemaiah.15`); Joiaribe (ID: `person:Joiarib.2`); Natã (ID: `person:Nathan.5`); Elnatã (ID: `person:Elnathan.2`); Jaribe (ID: `person:Jarib.2`); Zacarias (ID: `person:Zechariah.20`); Elnatã (ID: `person:Elnathan.3`); Elnatã (ID: `person:Elnathan.4`); SENHOR (ID: `deity:Lord`); perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); Insight (ID: `keyterm:Insight`); Israel (ID: `person:Israel`); Levi (ID: `group:Levi`); SENHOR (ID: `deity:Lord`); Mali (ID: `person:Mahli`); Levi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); Canaã (ID: `place:Canaan`); be unfaithful (ID: `keyterm:Unfaithful`); Israel (ID: `person:Israel`); Ammonites (ID: `group:Ammon`); Jebusites (ID: `group:Jebusites`); Levi (ID: `group:Levi`); Egito (ID: `place:Egypt`); Moabe (ID: `place:Moab`); cananeu (ID: `group:Canaan`); Egyptians (ID: `group:Egypt`); Amom (ID: `place:Ammon`); Amorites (ID: `group:Amorites`); Levi (ID: `person:Levi.3`); Hete (ID: `person:Heth`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); House (ID: `realia:House`); Harim (ID: `person:Harim`); Elam (ID: `person:Elam`); Judá (ID: `group:Judah`); offering (ID: `keyterm:Offering`); Judá (ID: `person:Judah.4`); counsel (ID: `keyterm:Counsel`); Joel (ID: `person:Joel.12`); Hittites (ID: `group:Hittite`); Jeremote (ID: `person:Jeremoth.3`); Atlai (ID: `person:Athlai`); Zabai (ID: `person:Zabbai`); Elioenai (ID: `person:Elioenai.4`); Joanã (ID: `person:Jehohanan.4`); Bani (ID: `person:Bani.5`); Manassés (ID: `person:Manasseh.3`); Elioenai (ID: `person:Elioenai.5`); Mesulão (ID: `person:Meshullam.11`); Amrão (ID: `person:Amram.2`); Abdi (ID: `person:Abdi.3`); Simei (ID: `person:Shimei.17`); Josadaque (ID: `person:Jozadak.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); to cause to possess (ID: `keyterm:Possess`); peace (ID: `keyterm:IntactState`); kindness (ID: `keyterm:Kindness`); Pérsia (ID: `place:Persia`); dispossess (ID: `keyterm:Dispossess`); supplication (ID: `keyterm:Supplication`); defilement (ID: `keyterm:Defilement`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); Jerusalém (ID: `place:Jerusalem`); kindness (ID: `keyterm:Kindness`); Pérsia (ID: `place:Persia`); supplication (ID: `keyterm:Supplication`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** Jeiel (ID: `person:Jehiel.8`); Secanias (ID: `person:Shecaniah.7`); be unfaithful (ID: `keyterm:Unfaithful`); Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); SENHOR (ID: `deity:Lord`); Ezra (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); counsel (ID: `keyterm:Counsel`); Covenant (ID: `keyterm:Covenant`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Levi (ID: `group:Levi`); Ezra (ID: `person:Ezra`); Levi (ID: `person:Levi.3`); swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `person:Benjamin`); Benjamim (ID: `group:Benjamin`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jazeías (ID: `person:Jahzeiah`); Jônatas (ID: `person:Jonathan.10`); Asael (ID: `person:Asahel.4`); Ticva (ID: `person:Tikvah.2`); Sabetai (ID: `person:Shabbethai`); Mesulão (ID: `person:Meshullam.10`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`)
