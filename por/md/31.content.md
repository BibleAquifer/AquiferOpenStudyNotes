...
* **Associated ACAI Concepts:** Judá (ID: `person:Judah.4`); lot (ID: `keyterm:Lot`); Jerusalém (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Edom (ID: `place:Edom`); José (ID: `person:Joseph.10`); dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); José (ID: `person:Joseph.10`); Israel (ID: `person:Israel`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** dispossess (ID: `keyterm:Dispossess`); Neguebe (ID: `place:Negeb`); Canaã (ID: `place:Canaan`); Gileade (ID: `place:Gilead`); Benjamim (ID: `person:Benjamin`); Monte de Esaú (ID: `place:EsauMount`); Filístia (ID: `place:Philistine`); Filisteu (ID: `group:Philistine`); Sarepta (ID: `place:Zarephath`); Jerusalém (ID: `place:Jerusalem`); Efraim (ID: `person:Ephraim`); Benjamim (ID: `group:Benjamin`); Efraim (ID: `group:Ephraim`); Sardes (ID: `place:Sardis`); Sefalá (ID: `place:Shephelah`); Israel (ID: `person:Israel`); Samaria (ID: `place:Samaria`); cananeu (ID: `group:Canaan`)
...
* **Associated ACAI Concepts:** dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`); Neguebe (ID: `place:Negeb`); Monte de Esaú (ID: `place:EsauMount`); SENHOR (ID: `deity:Lord`); Filístia (ID: `place:Philistine`); Filisteu (ID: `group:Philistine`); Efraim (ID: `person:Ephraim`); Benjamim (ID: `group:Benjamin`); Benjamim (ID: `person:Benjamin`); Gileade (ID: `place:Gilead`); Sarepta (ID: `place:Zarephath`); Efraim (ID: `group:Ephraim`); Israel (ID: `person:Israel`); Canaã (ID: `place:Canaan`); Sardes (ID: `place:Sardis`); Sefalá (ID: `place:Shephelah`); Samaria (ID: `place:Samaria`); cananeu (ID: `group:Canaan`)
...
* **Associated ACAI Concepts:** Canaã (ID: `place:Canaan`); Sarepta (ID: `place:Zarephath`); Jerusalém (ID: `place:Jerusalem`); dispossess (ID: `keyterm:Dispossess`); Sardes (ID: `place:Sardis`); Israel (ID: `person:Israel`); Neguebe (ID: `place:Negeb`); cananeu (ID: `group:Canaan`)
