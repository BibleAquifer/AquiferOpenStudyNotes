...
* **Associated ACAI Concepts:** Ephrathites (ID: `group:Ephrathah`); Ephrathah (ID: `person:Ephrathah`); Chilion (ID: `person:Chilion`); Naomi (ID: `person:Naomi`); Tribe of Judah (ID: `group:Judah`); Mahlon (ID: `person:Mahlon`); Elimelech (ID: `person:Elimelech`); Bethlehem (ID: `place:Bethlehem`); Judah (ID: `person:Judah.4`); Moab (ID: `place:Moab`)
...
* **Associated ACAI Concepts:** Bethlehem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Boaz (ID: `person:Boaz`); Moab (ID: `place:Moab`); To Cause to Possess (ID: `keyterm:Possess`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Mahlon (ID: `person:Mahlon`); To Cause to Possess (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Leah (ID: `person:Leah`); Bethlehem (ID: `place:Bethlehem`); Rachel (ID: `person:Rachel`); LORD (ID: `deity:Lord`); Elders (ID: `group:GenericElders`)
...
* **Associated ACAI Concepts:** Tamar (ID: `person:Tamar`); Tribe of Judah (ID: `group:Judah`); Perez (ID: `person:Perez`); Judah (ID: `person:Judah.4`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Bless (ID: `keyterm:Bless`); Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Naomi (ID: `person:Naomi`)
...
* **Associated ACAI Concepts:** Hezron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Amminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Boaz (ID: `person:Boaz`); Jesse (ID: `person:Jesse`); Perez (ID: `person:Perez`); Nahshon (ID: `person:Nahshon`); David (ID: `person:David`)
