...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); berbahagialah (ID: `keyterm:Happy`); mencobai (ID: `keyterm:PutToTheTest`); kekasih (ID: `keyterm:Beloved`); sia, sia (ID: `keyterm:Worthless`); suci (ID: `keyterm:Clean`); tahan uji (ID: `keyterm:Approved`); berbuat dosa (ID: `keyterm:Sin`); A Person (ID: `person:GenericPerson`); kebenaran (ID: `keyterm:Truth`); hati (ID: `keyterm:Heart`); tidak dapat dicobai (ID: `keyterm:NotTempted`); yang baik (ID: `keyterm:Good`); hukum (ID: `keyterm:Law`); tidak dicemarkan (ID: `keyterm:Undefiled`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kehidupan (ID: `keyterm:Life`); tak bernoda (ID: `keyterm:AboveCriticism`); janji (ID: `keyterm:Promise`); keahlian (ID: `keyterm:Ability`); kasihi (ID: `keyterm:Love`); keselamatan (ID: `keyterm:Salvation`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** suci (ID: `keyterm:Clean`); sia, sia (ID: `keyterm:Worthless`); hati (ID: `keyterm:Heart`); keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`); tak bernoda (ID: `keyterm:AboveCriticism`); tidak dicemarkan (ID: `keyterm:Undefiled`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); tonton bulu atau muka (ID: `keyterm:Partiality`); Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); kemuliaan (ID: `keyterm:Glory`); bimbang (ID: `keyterm:Discern`); Seal (ID: `realia:Seal`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** janji (ID: `keyterm:Promise`); orang pilihan (ID: `keyterm:Chosen`); keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`); kerajaan (ID: `keyterm:Kingdom`); kekasih (ID: `keyterm:Beloved`); percaya (ID: `keyterm:Believe`); kasihi (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); penghakiman (ID: `keyterm:Judgment`); tersandung (ID: `keyterm:Stumble`); tonton bulu atau muka (ID: `keyterm:Partiality`); berbuat dosa (ID: `keyterm:Sin`); kitab suci (ID: `keyterm:Scripture`); tidak mengenal belas kasihan (ID: `keyterm:Merciless`); belas kasihan (ID: `keyterm:Mercy`); pengadilan (ID: `keyterm:CourtCase`); kasihi (ID: `keyterm:Love`); memutuskan (ID: `keyterm:Decided`); persundalan (ID: `keyterm:Fornication`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); Rahab (ID: `person:Rahab`); sia, sia (ID: `keyterm:Idle`); kitab suci (ID: `keyterm:Scripture`); Tuhan (ID: `deity:Lord`); menggenapi (ID: `keyterm:Happen`); hampa (ID: `keyterm:Empty`); tubuh (ID: `keyterm:Body.3`); roh (ID: `keyterm:Spirit.2`); An Angel (ID: `deity:Angel`); Ishak (ID: `person:Isaac`)
...
* **Associated ACAI Concepts:** kitab suci (ID: `keyterm:Scripture`); Tuhan (ID: `deity:Lord`); menggenapi (ID: `keyterm:Happen`); percaya (ID: `keyterm:Believe`); Abraham (ID: `person:Abraham`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** neraka (ID: `keyterm:Gehenna`); keahlian (ID: `keyterm:Ability`); tubuh (ID: `keyterm:Body.3`); lalim (ID: `keyterm:UnjustDeed`); Hell (ID: `place:Hell`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); persahabatan (ID: `keyterm:Friendship`); tidak setia (ID: `keyterm:Unfaithful`); kitab suci (ID: `keyterm:Scripture`); keahlian (ID: `keyterm:Ability`); hati (ID: `keyterm:Heart`); roh (ID: `keyterm:Spirit.2`); ingin (ID: `keyterm:LongFor`); Cause of Joy (ID: `keyterm:CauseOfJoy`); murni (ID: `keyterm:Pure`); membersihkan (ID: `keyterm:Cleanse.2`); kebaikan (ID: `keyterm:Favor`); Roh (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** murni (ID: `keyterm:Pure`); membersihkan (ID: `keyterm:Cleanse.2`); hati (ID: `keyterm:Heart`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** hati (ID: `keyterm:Heart`); Tuhan (ID: `deity:Lord`); tubuh (ID: `keyterm:Body.3`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); menentang (ID: `keyterm:Condemn`); bersaksi (ID: `keyterm:BearWitness`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** nama (ID: `keyterm:Name`); Tuhan (ID: `deity:Lord`); jemaat (ID: `keyterm:Church`); diurapi (ID: `keyterm:Anointed`); berdoa (ID: `keyterm:Pray`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** berbuat dosa (ID: `keyterm:Sin`); Tuhan (ID: `deity:Lord`); mengampuni (ID: `keyterm:Forgive`); percaya (ID: `keyterm:Believe`); berdoa (ID: `keyterm:Pray`); keselamatan (ID: `keyterm:Salvation`)
