...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); bem, aventurado (ID: `keyterm:Happy`); tentar (ID: `keyterm:PutToTheTest`); amado (ID: `keyterm:Beloved`); limpo (ID: `keyterm:Clean`); inútil (ID: `keyterm:Worthless`); aprovado (ID: `keyterm:Approved`); que não pode ser tentado (ID: `keyterm:NotTempted`); salvation (ID: `keyterm:Salvation`); To Sin (ID: `keyterm:Sin`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); coração (ID: `keyterm:Heart`); sem mancha (ID: `keyterm:Undefiled`); be (or show oneself) just (ID: `keyterm:Just`); Good (ID: `keyterm:Good`); love (ID: `keyterm:Love`); sem mancha (ID: `keyterm:AboveCriticism`); A Person (ID: `person:GenericPerson`); lei (ID: `keyterm:Law`); promessa (ID: `keyterm:Promise`); Truth (ID: `keyterm:Truth`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** limpo (ID: `keyterm:Clean`); inútil (ID: `keyterm:Worthless`); sem mancha (ID: `keyterm:AboveCriticism`); coração (ID: `keyterm:Heart`); sem mancha (ID: `keyterm:Undefiled`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); favoritismo (ID: `keyterm:Partiality`); crer (ID: `keyterm:Believe`); Glory (ID: `keyterm:Glory`); Jesus (ID: `person:Jesus.2`); distinguir (ID: `keyterm:Discern`); Seal (ID: `realia:Seal`); Synagogue (ID: `realia:Synagogue`); Footstool (ID: `realia:Footstool`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); reino (ID: `keyterm:Kingdom`); amado (ID: `keyterm:Beloved`); SENHOR (ID: `deity:Lord`); escolhido (ID: `keyterm:Chosen`); Ability (ID: `keyterm:Ability`); promessa (ID: `keyterm:Promise`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); favoritismo (ID: `keyterm:Partiality`); juízo (ID: `keyterm:Judgment`); tropeçar (ID: `keyterm:Stumble`); tribunal de justiça (ID: `keyterm:CourtCase`); escritura (ID: `keyterm:Scripture`); misericórdia (ID: `keyterm:Mercy`); To Sin (ID: `keyterm:Sin`); inclemente (ID: `keyterm:Merciless`); fornication (ID: `keyterm:Fornication`); decidir (ID: `keyterm:Decided`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); A Person (ID: `person:GenericPerson`); SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); Abraão (ID: `person:Abraham`); inútil (ID: `keyterm:Idle`); Raabe (ID: `person:Rahab`); To Cause to Happen (ID: `keyterm:Happen`); escritura (ID: `keyterm:Scripture`); Spirit (ID: `keyterm:Spirit.2`); Isaque (ID: `person:Isaac`); vazio (ID: `keyterm:Empty`); An Angel (ID: `deity:Angel`); salvation (ID: `keyterm:Salvation`); fazer a paz (ID: `keyterm:Peace`); Demons (ID: `deity:Demons`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`); escritura (ID: `keyterm:Scripture`); be (or show oneself) just (ID: `keyterm:Just`); SENHOR (ID: `deity:Lord`); Abraão (ID: `person:Abraham`)
...
* **Associated ACAI Concepts:** Hell (ID: `place:Hell`); Ability (ID: `keyterm:Ability`); corpo (ID: `keyterm:Body.3`); injustiça (ID: `keyterm:UnjustDeed`); geena (ID: `keyterm:Gehenna`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); be unfaithful (ID: `keyterm:Unfaithful`); amizade (ID: `keyterm:Friendship`); pure (ID: `keyterm:Pure`); escritura (ID: `keyterm:Scripture`); coração (ID: `keyterm:Heart`); Spirit (ID: `keyterm:Spirit.2`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Ability (ID: `keyterm:Ability`); To Cleanse (ID: `keyterm:Cleanse.2`); favor (ID: `keyterm:Favor`); desejar (ID: `keyterm:LongFor`); Holy Spirit (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** desejar (ID: `keyterm:LongFor`); escritura (ID: `keyterm:Scripture`); Holy Spirit (ID: `deity:HolySpirit`); Spirit (ID: `keyterm:Spirit.2`)
...
* **Associated ACAI Concepts:** To Cleanse (ID: `keyterm:Cleanse.2`); SENHOR (ID: `deity:Lord`); pure (ID: `keyterm:Pure`); coração (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** coração (ID: `keyterm:Heart`); be (or show oneself) just (ID: `keyterm:Just`); SENHOR (ID: `deity:Lord`); testemunhar (ID: `keyterm:BearWitness`); corpo (ID: `keyterm:Body.3`); condenar (ID: `keyterm:Condemn`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** igreja (ID: `keyterm:Church`); orar (ID: `keyterm:Pray`); SENHOR (ID: `deity:Lord`); anointed (ID: `keyterm:Anointed`); Name (ID: `keyterm:Name`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); orar (ID: `keyterm:Pray`); SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); salvation (ID: `keyterm:Salvation`); forgive (ID: `keyterm:Forgive`)
