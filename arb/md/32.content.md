...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); Fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); Vow (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); أَمِتَّايَ (ID: `person:Amittai`); يَافَا (ID: `place:Joppa`); نِينَوَى (ID: `place:Nineveh`); Slaughtering (ID: `keyterm:Slaughtering`); Hebrews (ID: `group:Hebrews`); Kindness (ID: `keyterm:Kindness`); Lot (ID: `keyterm:Lot`); Salvation (ID: `keyterm:Salvation`); Exempt (ID: `keyterm:Exempt`); Praise (ID: `keyterm:Praise`); تَرْشِيشَ (ID: `place:Tarshish`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Hell (ID: `place:Hell`); Vow (ID: `keyterm:Vow`); يونَانَ (ID: `person:Jonah.2`); Praise (ID: `keyterm:Praise`); Kindness (ID: `keyterm:Kindness`); Salvation (ID: `keyterm:Salvation`); Fish (ID: `fauna:Fish`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** Vow (ID: `keyterm:Vow`); Praise (ID: `keyterm:Praise`); ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`); Salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); نِينَوَى (ID: `place:Nineveh`); Castor Oil (ID: `flora:CastorOil`); Sackcloth (ID: `realia:Sackcloth`); Cattle (ID: `fauna:Bull`); Word of the Lord (ID: `keyterm:WordOfTheLord`); تَرْشِيشَ (ID: `place:Tarshish`); Generous (ID: `keyterm:Generous`); Compassionate (ID: `keyterm:Compassionate`); Believe In (ID: `keyterm:BelieveIn`); Kindness (ID: `keyterm:Kindness`); Throne (ID: `realia:Throne`); Worm (ID: `fauna:Maggot`); Flock (ID: `fauna:Flock`); Clothing (ID: `realia:Clothing`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** نِينَوَى (ID: `place:Nineveh`); Throne (ID: `realia:Throne`); Clothing (ID: `realia:Clothing`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يونَانَ (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); تَرْشِيشَ (ID: `place:Tarshish`); Generous (ID: `keyterm:Generous`); Compassionate (ID: `keyterm:Compassionate`); Kindness (ID: `keyterm:Kindness`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** تَرْشِيشَ (ID: `place:Tarshish`); Generous (ID: `keyterm:Generous`); Compassionate (ID: `keyterm:Compassionate`); ٱلرَّبِّ (ID: `deity:Lord`); Kindness (ID: `keyterm:Kindness`)
