...
* **Associated ACAI Concepts:** Édom (ID: `group:Edom`); comprehension (ID: `keyterm:Understanding`); alliance (ID: `keyterm:Covenant`); Édom (ID: `place:Edom`); état intact (ID: `keyterm:IntactState`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** comprehension (ID: `keyterm:Understanding`); alliance (ID: `keyterm:Covenant`); état intact (ID: `keyterm:IntactState`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** destin (ID: `keyterm:Lot`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Jérusalem (ID: `place:Jerusalem`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Édom (ID: `group:Edom`); Israël (ID: `person:Israel`); Édom (ID: `place:Edom`); Joseph (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** déposséder (ID: `keyterm:Dispossess`); Negev (ID: `place:Negeb`); Canaan (ID: `group:Canaan`); Sardes (ID: `place:Sardis`); Galaad (ID: `place:Gilead`); Canaan (ID: `place:Canaan`); Shephelah (ID: `place:Shephelah`); Jérusalem (ID: `place:Jerusalem`); Sarepta (ID: `place:Zarephath`); Benjamin (ID: `group:Benjamin`); Philistia (ID: `place:Philistine`); Samarie (ID: `place:Samaria`); Philistins (ID: `group:Philistine`); Israël (ID: `person:Israel`); Éphraïm (ID: `group:Ephraim`); Éphraïm (ID: `person:Ephraim`); montagne d'Ésaü (ID: `place:EsauMount`); Benjamin (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); déposséder (ID: `keyterm:Dispossess`); Negev (ID: `place:Negeb`); montagne d'Ésaü (ID: `place:EsauMount`); Benjamin (ID: `group:Benjamin`); Samarie (ID: `place:Samaria`); Canaan (ID: `place:Canaan`); Éphraïm (ID: `group:Ephraim`); Canaan (ID: `group:Canaan`); Éternel (ID: `deity:Lord`); Galaad (ID: `place:Gilead`); Shephelah (ID: `place:Shephelah`); Sarepta (ID: `place:Zarephath`); Éphraïm (ID: `person:Ephraim`); Philistia (ID: `place:Philistine`); Philistins (ID: `group:Philistine`); Israël (ID: `person:Israel`); Benjamin (ID: `person:Benjamin`); Sardes (ID: `place:Sardis`)
...
* **Associated ACAI Concepts:** Canaan (ID: `group:Canaan`); Sardes (ID: `place:Sardis`); Jérusalem (ID: `place:Jerusalem`); Sarepta (ID: `place:Zarephath`); déposséder (ID: `keyterm:Dispossess`); Israël (ID: `person:Israel`); Canaan (ID: `place:Canaan`); Negev (ID: `place:Negeb`)
