...
* **Associated ACAI Concepts:** Filemom (ID: `person:Philemon`); amado (ID: `keyterm:Beloved`); Paulo (ID: `person:Paul`); Jesus (ID: `person:Jesus.2`); Timóteo (ID: `person:Timothy`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Filemom (ID: `person:Philemon`); Arquipo (ID: `person:Archippus`); Áfia (ID: `person:Apphia`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); fazer a paz (ID: `keyterm:Peace`); amado (ID: `keyterm:Beloved`); Paulo (ID: `person:Paul`); igreja (ID: `keyterm:Church`); Timóteo (ID: `person:Timothy`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** holy (ID: `keyterm:Holy`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`); Good (ID: `keyterm:Good`); SENHOR (ID: `deity:Lord`); compaixão (ID: `keyterm:Affection`); orar (ID: `keyterm:Pray`); Cause of Joy (ID: `keyterm:CauseOfJoy`); comunhão (ID: `keyterm:Fellowship`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); Paulo (ID: `person:Paul`); em cristo (ID: `keyterm:InChrist`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Lucas (ID: `person:Luke`); Epafras (ID: `person:Epaphras`); Demas (ID: `person:Demas`); Spirit (ID: `keyterm:Spirit.2`); Aristarco (ID: `person:Aristarchus`); favor (ID: `keyterm:Favor`); Marcos (ID: `person:Mark`); em cristo (ID: `keyterm:InChrist`)
