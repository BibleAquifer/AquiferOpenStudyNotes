...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `group:Benjamin`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `person:Benjamin`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); كورَشَ (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath`); زَربَّابِل (ID: `person:Zerubbabel.2`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `person:Judah.4`); كورَشَ (ID: `person:Cyrus`); يَهوذَا (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); لَّاوِي (ID: `group:Levi`); سلَيْمَانَ (ID: `person:Solomon`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `person:Levi.3`); دَرْقونَ (ID: `person:Darkon`); سَرَايَا (ID: `person:Seraiah.6`); بَرْقوسَ (ID: `person:Barkos`); حَزَقِيَّا (ID: `person:Hezekiah.2`); بَابَايَ (ID: `person:Bebai`); آطِيرَ (ID: `person:Ater`); بَانِيَ (ID: `person:Bani`); أَسْنَةَ (ID: `person:Asnah`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); Tel-harsha (ID: `place:Tel-harsha`); يوآب (ID: `person:Joab.3`); بِيصَايَ (ID: `person:Bezai`); سَلْمَايَ (ID: `person:Shalmai`); حَانَان (ID: `person:Hanan.4`); شَفَطْيَا (ID: `person:Shephatiah.6`); شوبَايَ (ID: `person:Shobai`); Tel-melah (ID: `place:Tel-melah`); فَادونَ (ID: `person:Padon`); عَقّوب (ID: `person:Akkub.3`); لِإِيمِيرَ (ID: `person:Immer.2`); أَدَّان (ID: `place:Addan`); عَرْجَدَ (ID: `person:Azgad`); فِي (ID: `person:Uzza.2`); كَروب (ID: `place:Cherub`)
...
* **Associated ACAI Concepts:** بِغْوَايَ (ID: `person:Bigvai`); مرْدَخَاي (ID: `person:Mordecai`); نَحَمْيَا (ID: `person:Nehemiah`); رَحوم (ID: `person:Rehum`); رَعْلَايَا (ID: `person:Reelaiah`); بِلْشَان (ID: `person:Bilshan`); سَرَايَا (ID: `person:Seraiah.6`); بَعْنَةَ (ID: `person:Baanah.3`); مِسْفَار (ID: `person:Mispar`); إِسْرَائِيلَ (ID: `person:Israel`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** عَرْجَدَ (ID: `person:Azgad`); يورَةَ (ID: `person:Jorah`); عِيلَامَ (ID: `person:Elam`); حَزَقِيَّا (ID: `person:Hezekiah.2`); بَابَايَ (ID: `person:Bebai`); بِغْوَايَ (ID: `person:Bigvai.2`); عَادِينَ (ID: `person:Adin`); آطِيرَ (ID: `person:Ater`); آرَحَ (ID: `person:Arah.2`); بَانِيَ (ID: `person:Bani`); يَشوعَ (ID: `person:Jeshua.3`); زَكَّايَ (ID: `person:Zaccai.2`); Pahath-moab (ID: `person:Pahath-moab`); حَشوم (ID: `person:Hashum`); يوآب (ID: `person:Joab.3`); فَرْعوشَ (ID: `person:Parosh`); أَدونِيقَامَ (ID: `person:Adonikam`); زَتّو (ID: `person:Zattu.2`); بِيصَايَ (ID: `person:Bezai`); شَفَطْيَا (ID: `person:Shephatiah.6`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** حَارِيمَ (ID: `person:Harim.2`); حَادِيدَ (ID: `place:Hadid`); Beth-azmaveth (ID: `place:Beth-azmaveth`); سَنَاءَةَ (ID: `place:Senaah`); نَبو (ID: `place:Nebo.2`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); مَغْبِيشَ (ID: `place:Magbish`); أونوَ (ID: `place:Ono`); لَحْمٍ (ID: `place:Bethlehem`); عِيلَامَ (ID: `person:Elam`); وَلودَ (ID: `place:Lod`); Kiriath-jearim (ID: `place:Kiriath-jearim`); Bethel (ID: `place:Bethel`); مِنْ (ID: `place:Geba`); عَايٍ (ID: `place:Ai`); بَئِيروت (ID: `place:Beeroth`); ٱلْكَفِيرَة (ID: `place:Chephirah`); عَنَاثوثَ (ID: `place:Anathoth`); Ramah (ID: `place:Ramah.2`); أَرِيحَا (ID: `place:Jericho`); مِخْمَاسَ (ID: `place:Michmash`)
...
* **Associated ACAI Concepts:** لِإِيمِيرَ (ID: `person:Immer.2`); يَدَايَا (ID: `person:Jedaiah.4`); حَطِيطَا (ID: `person:Hatita`); حَارِيمَ (ID: `person:Harim`); يَشوعَ (ID: `person:Jeshua.4`); يَشوعَ (ID: `person:Jeshua`); طَلْمون (ID: `person:Talmon`); هودَوْيَا (ID: `person:Hodaviah.4`); آطِيرَ (ID: `person:Ater.2`); شوبَايَ (ID: `person:Shobai`); آسَاف (ID: `person:Asaph.2`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); فَشْحور (ID: `person:Pashhur`); شَلّوم (ID: `person:Shallum.8`); عَقّوب (ID: `person:Akkub.2`); قَدْمِيئِيلَ (ID: `person:Kadmiel`)
...
* **Associated ACAI Concepts:** حَطِيطَا (ID: `person:Hatita`); طَلْمون (ID: `person:Talmon`); آطِيرَ (ID: `person:Ater.2`); شوبَايَ (ID: `person:Shobai`); آسَاف (ID: `person:Asaph.2`); شَلّوم (ID: `person:Shallum.8`); عَقّوب (ID: `person:Akkub.2`)
...
* **Associated ACAI Concepts:** ثَامَحَ (ID: `person:Temah`); فَادونَ (ID: `person:Padon`); عَقّوب (ID: `person:Akkub.3`); حَرْحورَ (ID: `person:Harhur`); سِيسَرَا (ID: `person:Sisera.2`); فِي (ID: `person:Uzza.2`); جَدِّيلَ (ID: `person:Giddel`); Meunim (ID: `group:Meunim`); قِيروسَ (ID: `person:Keros`); بَرْقوسَ (ID: `person:Barkos`); نَقودَا (ID: `person:Nekoda`); رَآيَا (ID: `person:Reaiah.3`); طَبَاعوتَ (ID: `person:Tabbaoth`); حَرْشَا (ID: `person:Harsha`); رَصِينَ (ID: `person:Rezin.2`); حَسوفَا (ID: `person:Hasupha`); Nephushesim (ID: `group:Nephushesim`); نَصِيحَ (ID: `person:Neziah`); سِيعَهَا (ID: `person:Siaha`); حَاجَابَ (ID: `person:Hagab`); جَاحَرَ (ID: `person:Gahar`); مَحِيدَا (ID: `person:Mehida`); حَطِيفَا (ID: `person:Hatipha`); أَسْنَةَ (ID: `person:Asnah`); صِيحَا (ID: `person:Ziha`); بَصْلوتَ (ID: `person:Bazluth`); حَقوفَا (ID: `person:Hakupha`); جَزَّامَ (ID: `person:Gazzam`); لَبَانَةَ (ID: `person:Lebanah`); سَلْمَايَ (ID: `person:Shalmai`); حَجَابَةَ (ID: `person:Hagabah`); حَانَان (ID: `person:Hanan.4`); بِيسَايَ (ID: `person:Besai`); بَقْبوقَ (ID: `person:Bakbuk`); فَاسِيحَ (ID: `person:Paseah.2`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); فَرودَا (ID: `person:Peruda`); جَدِّيلَ (ID: `person:Giddel.2`); يَعْلَةَ (ID: `person:Jaalah`); دَرْقونَ (ID: `person:Darkon`); سَوْطَايَ (ID: `person:Sotai`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); سوفَرَثَ (ID: `person:Sophereth`); حَطِّيلَ (ID: `person:Hattil`); آمِي (ID: `person:Ami`); شَفَطْيَا (ID: `person:Shephatiah.7`)
...
* **Associated ACAI Concepts:** Tel-melah (ID: `place:Tel-melah`); طوبِيَّا (ID: `person:Tobiah`); Tel-harsha (ID: `place:Tel-harsha`); أَدَّان (ID: `place:Addan`); لِدَلَايَا (ID: `person:Delaiah.3`); نَقودَا (ID: `person:Nekoda.2`); كَروب (ID: `place:Cherub`); لِإِيمِيرَ (ID: `place:Immer`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** بَرْزِلَّايَ (ID: `person:Barzillai.3`); هَقّوصَ (ID: `person:Hakkoz.2`); حَبَايَا (ID: `person:Habaiah`); جِلْعَادَ (ID: `place:Gilead`); Gileadites (ID: `group:Gilead`); Defile (ID: `keyterm:Stain`); بَرْزِلَّايَ (ID: `person:Barzillai`); Priesthood (ID: `keyterm:Priesthood`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); Strength (ID: `keyterm:Strength`); Money (ID: `realia:Money`); House (ID: `realia:House`); Tunic (ID: `realia:Tunic`); Mina (ID: `realia:Mina`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); يَشوع (ID: `person:Joshua.5`); فَارِسَ (ID: `place:Persia`); كورَشَ (ID: `person:Cyrus`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); حِينَادَادَ (ID: `person:Henadad`); يَشوعَ (ID: `person:Jeshua.4`); Esarhaddon (ID: `person:Esarhaddon`); Relatives (ID: `group:Relatives`); هودَوْيَا (ID: `person:Hodaviah.4`); هودِيَّا (ID: `person:Hodiah.2`); لبْنَانَ (ID: `place:Lebanon`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); موسَى (ID: `person:Moses`); Appointed Feast (ID: `keyterm:AppointedFeast`); Assyria (ID: `place:Assyria`); Kindness (ID: `keyterm:Kindness`); Instruction (ID: `keyterm:Instruction`); صورَ (ID: `place:Tyre`); بَنْيَامِينَ (ID: `person:Benjamin`); آسَاف (ID: `person:Asaph.2`); دَاودَ (ID: `person:David`); Holy (ID: `keyterm:Holy`); Sidonians (ID: `group:Sidon`); دَارِيوسَ (ID: `person:Darius.2`); يَافَا (ID: `place:Joppa`); Tyrians (ID: `group:Tyre`); Counsel (ID: `keyterm:Counsel`); صِيْدونَ (ID: `place:Sidon`); بَنْيَامِينَ (ID: `group:Benjamin`); Terror (ID: `keyterm:Terror`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Olive Oil (ID: `realia:OliveOil`); Cedar (ID: `flora:Cedar`); Craftsman (ID: `realia:Craftsman`); Cymbals (ID: `realia:Cymbals`); Trumpet (ID: `realia:Trumpet`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); موسَى (ID: `person:Moses`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); Terror (ID: `keyterm:Terror`); ٱلرَّبِّ (ID: `deity:Lord`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Holy (ID: `keyterm:Holy`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Appointed Feast (ID: `keyterm:AppointedFeast`)
...
* **Associated ACAI Concepts:** صِيْدونَ (ID: `place:Sidon`); لبْنَانَ (ID: `place:Lebanon`); Sidonians (ID: `group:Sidon`); صورَ (ID: `place:Tyre`); يَافَا (ID: `place:Joppa`); Tyrians (ID: `group:Tyre`); فَارِسَ (ID: `place:Persia`); كورَشَ (ID: `person:Cyrus`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Craftsman (ID: `realia:Craftsman`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); يَشوع (ID: `person:Joshua.5`); ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); دَاودَ (ID: `person:David`); آسَاف (ID: `person:Asaph.2`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); Kindness (ID: `keyterm:Kindness`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `group:Benjamin`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); بَنْيَامِينَ (ID: `person:Benjamin`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); إِسْرَائِيلَ (ID: `person:Israel`); يَشوع (ID: `person:Joshua.5`); ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); فَارِسَ (ID: `place:Persia`); كورَشَ (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); Counsel (ID: `keyterm:Counsel`); دَارِيوسَ (ID: `person:Darius.2`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْفرَاتِ (ID: `place:Euphrates`); شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Jews (ID: `group:Jews`); فَارِسَ (ID: `place:Persia`); أَرَكَ (ID: `place:Erech`); Babylonians (ID: `group:Babylon`); بِشْلَام (ID: `person:Bishlam`); مِثْرَدَاث (ID: `person:Mithredath.2`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); طَبْئِيل (ID: `person:Tabeel`); أسْنَفَّر (ID: `person:Osnappar`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); Elamites (ID: `group:Elam`); عِيلَامَ (ID: `place:Elam`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); بَابِلَ (ID: `place:Babylon`); فِي (ID: `place:Susa`); Persians (ID: `group:Persia`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); أَرَكَ (ID: `place:Erech`); Babylonians (ID: `group:Babylon`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); Elamites (ID: `group:Elam`); بَابِلَ (ID: `place:Babylon`); فَارِسَ (ID: `place:Persia`); عِيلَامَ (ID: `place:Elam`); فِي (ID: `place:Susa`); Persians (ID: `group:Persia`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Jews (ID: `group:Jews`); شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); دَارِيوسَ (ID: `person:Darius.2`); Shethar-bozenai (ID: `person:Shethar-bozenai`); تَتْنَاي (ID: `person:Tattenai`); زَكَرِيَّا (ID: `person:Zechariah.17`); حَجَّيِ (ID: `person:Haggai`); يَدّو (ID: `person:Iddo.6`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلْفرَاتِ (ID: `place:Euphrates`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `person:Judah.4`); فَارِسَ (ID: `place:Persia`); يَهوصَادِقَ (ID: `person:Jehozadak`)
...
* **Associated ACAI Concepts:** زَكَرِيَّا (ID: `person:Zechariah.17`); حَجَّيِ (ID: `person:Haggai`); يَدّو (ID: `person:Iddo.6`); إِسْرَائِيلَ (ID: `person:Israel`); Jews (ID: `group:Jews`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); أورشَلِيمَ (ID: `place:Jerusalem`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); بَابِلَ (ID: `place:Babylon`); أورشَلِيمَ (ID: `place:Jerusalem`); كورَشَ (ID: `person:Cyrus`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); زَربَّابِل (ID: `person:Zerubbabel.2`); دَارِيوسَ (ID: `person:Darius.2`); Shethar-bozenai (ID: `person:Shethar-bozenai`); تَتْنَاي (ID: `person:Tattenai`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); ٱلْفرَاتِ (ID: `place:Euphrates`); Chaldeans (ID: `group:Chaldea`); يَهوذَا (ID: `person:Judah.4`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); موسَى (ID: `person:Moses`); أورشَلِيمَ (ID: `place:Jerusalem`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** سَرَايَا (ID: `person:Seraiah.2`); عَزْرَا (ID: `person:Ezra`); عَزَرْيَا (ID: `person:Azariah.7`); حِلْقِيَّا (ID: `person:Hilkiah.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); أَخِيطوبَ (ID: `person:Ahitub.3`); أَبِيشوعَ (ID: `person:Abishua`); عَزَرْيَا (ID: `person:Azariah.7`); لِمَرَايوثَ (ID: `person:Meraioth`); زَرَحْيَا (ID: `person:Zerahiah`); أَمَرْيَا (ID: `person:Amariah.2`); سَرَايَا (ID: `person:Seraiah.2`); عزِّي (ID: `person:Uzzi`); صَادوق (ID: `person:Zadok.4`); بقِّي (ID: `person:Bukki.2`); عَزَرْيَا (ID: `person:Azariah.6`); شَلّوم (ID: `person:Shallum.7`); أَلِعَازَار (ID: `person:Eleazar.2`); حِلْقِيَّا (ID: `person:Hilkiah.2`); هَارون (ID: `person:Aaron`); فِينَحَاس (ID: `person:Phinehas`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); بَابِلَ (ID: `place:Babylon`); موسَى (ID: `person:Moses`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); ٱلرَّبِّ (ID: `deity:Lord`); عَزْرَا (ID: `person:Ezra`); Decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); عَزْرَا (ID: `person:Ezra`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Wheat (ID: `flora:Wheat`); Kor (ID: `realia:Kor`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** يِشْعِيَا (ID: `person:Jeshaiah.4`); مِيخَائِيلَ (ID: `person:Michael.10`); عَرْجَدَ (ID: `person:Azgad`); يوآب (ID: `person:Joab.4`); زَبَدْيَا (ID: `person:Zebadiah.8`); يَعِيئِيل (ID: `person:Jeuel.3`); عِيلَامَ (ID: `person:Elam`); Gershom (ID: `person:Gershom.2`); عوتَاي (ID: `person:Uthai.2`); شَكَنْيَا (ID: `person:Shecaniah.5`); عَابِد (ID: `person:Ebed.2`); بَابَايَ (ID: `person:Bebai.2`); بَابَايَ (ID: `person:Bebai`); يَحِيئِيل (ID: `person:Jehiel.7`); فَرْعوشَ (ID: `person:Parosh.2`); يَحْزِيئِيل (ID: `person:Jahaziel.5`); بِغْوَايَ (ID: `person:Bigvai.2`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); زَكّور (ID: `person:Zaccur.5`); حَطّوش (ID: `person:Hattush.2`); زَكَرِيَّا (ID: `person:Zechariah.18`); أَلِيفَلَط (ID: `person:Eliphelet.5`); عَادِينَ (ID: `person:Adin`); عوبَدْيَا (ID: `person:Obadiah.10`); زَكَرِيَّا (ID: `person:Zechariah.19`); يوحَانَانَ (ID: `person:Johanan.8`); شَلومِيَةَ (ID: `person:Shelomith.4`); شَكَنْيَا (ID: `person:Shecaniah.6`); هِقَّاطَانَ (ID: `person:Hakkatan`); Pahath-moab (ID: `person:Pahath-moab`); عَثَلْيَا (ID: `person:Athaliah.3`); أَدونِيقَامَ (ID: `person:Adonikam`); يوشَفْيَا (ID: `person:Josiphiah`); دَانِيآل (ID: `person:Daniel.2`); يونَاثَانَ (ID: `person:Jonathan.9`); شَفَطْيَا (ID: `person:Shephatiah.6`); شِمْعِيَا (ID: `person:Shemaiah.14`); زَرَحْيَا (ID: `person:Zerahiah.2`); إِيثَامَارَ (ID: `person:Ithamar`); دَاودَ (ID: `person:David`); بَابِلَ (ID: `place:Babylon`); فِينَحَاس (ID: `person:Phinehas`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** أَلْنَاثَانَ (ID: `person:Elnathan.3`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); مَشلَّام (ID: `person:Meshullam.9`); نَاثَان (ID: `person:Nathan.5`); يَدّو (ID: `person:Iddo`); يويَارِيبَ (ID: `person:Joiarib.2`); شِمْعِيَا (ID: `person:Shemaiah.15`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); أَرِيئِيلَ (ID: `person:Ariel`); ٱلْمسَمَّى (ID: `place:Casiphia`); يَارِيبَ (ID: `person:Jarib.2`); زَكَرِيَّا (ID: `person:Zechariah.20`); أَلِيعَزَرَ (ID: `person:Eliezer.8`); ٱلرَّبِّ (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); ٱلرَّبِّ (ID: `deity:Lord`); مَحْلِي (ID: `person:Mahli`); Insight (ID: `keyterm:Insight`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); Work (ID: `keyterm:Work`); دَاودَ (ID: `person:David`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); موآبَ (ID: `place:Moab`); Canaanites (ID: `group:Canaan`); Be Unfaithful (ID: `keyterm:Unfaithful`); إِسْرَائِيلَ (ID: `person:Israel`); مِصْرَ (ID: `place:Egypt`); Ammonites (ID: `group:Ammon`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); كَنْعَان (ID: `place:Canaan`); Jebusites (ID: `group:Jebusites`); Amorites (ID: `group:Amorites`); حِثًّا (ID: `person:Heth`); Egyptians (ID: `group:Egypt`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); Counsel (ID: `keyterm:Counsel`); عِيلَامَ (ID: `person:Elam`); يَهوذَا (ID: `person:Judah.4`); Offering (ID: `keyterm:Offering`); يَهوذَا (ID: `group:Judah`); شَلّوم (ID: `person:Shallum.11`); يَحِيئِيل (ID: `person:Jehiel.8`); عَبْدِي (ID: `person:Abdi.3`); بَصَلْئِيل (ID: `person:Bezalel.2`); أَلِيوعِينَاي (ID: `person:Elioenai.5`); زَابَادَ (ID: `person:Zabad.5`); بَنَايَا (ID: `person:Benaiah.10`); نَثَنْئِيل (ID: `person:Nethanel.8`); زَبَاي (ID: `person:Zabbai`); مَعْسِيَّا (ID: `person:Maaseiah.7`); مَرِيموث (ID: `person:Meremoth.2`); شَآل (ID: `person:Sheal`); مَلْكِيَّا (ID: `person:Malchijah.5`); مَتَّنَاي (ID: `person:Mattenai.2`); شِمْعِيَا (ID: `person:Shemaiah.17`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); Peace (ID: `keyterm:IntactState`); إِسْرَائِيلَ (ID: `person:Israel`); Defilement (ID: `keyterm:Defilement`); Dispossess (ID: `keyterm:Dispossess`); أورشَلِيمَ (ID: `place:Jerusalem`); To Cause to Possess (ID: `keyterm:Possess`); فَارِسَ (ID: `place:Persia`); Plea for Mercy (ID: `keyterm:Supplication`); Kindness (ID: `keyterm:Kindness`); Peg (ID: `realia:Peg`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); أورشَلِيمَ (ID: `place:Jerusalem`); فَارِسَ (ID: `place:Persia`); Plea for Mercy (ID: `keyterm:Supplication`); Kindness (ID: `keyterm:Kindness`); Peg (ID: `realia:Peg`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); عَزْرَا (ID: `person:Ezra`); Repent (ID: `keyterm:Repent`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَحِيئِيل (ID: `person:Jehiel.8`); شَكَنْيَا (ID: `person:Shecaniah.7`); إِسْرَائِيلَ (ID: `person:Israel`); Be Unfaithful (ID: `keyterm:Unfaithful`); ٱلرَّبِّ (ID: `deity:Lord`); عَزْرَا (ID: `person:Ezra`); عِيلَامَ (ID: `person:Elam`)
...
* **Associated ACAI Concepts:** Covenant (ID: `keyterm:Covenant`); Instruction (ID: `keyterm:Instruction`); ٱلرَّبِّ (ID: `deity:Lord`); Counsel (ID: `keyterm:Counsel`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); لَّاوِي (ID: `group:Levi`); Swear (ID: `keyterm:Swear`); لَّاوِي (ID: `person:Levi.3`); عَزْرَا (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** بَنْيَامِينَ (ID: `group:Benjamin`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `person:Benjamin`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَحْزِيَا (ID: `person:Jahzeiah`); تِقْوَةَ (ID: `person:Tikvah.2`); عَسَائِيل (ID: `person:Asahel.4`); يونَاثَانَ (ID: `person:Jonathan.10`); شَبْتَاي (ID: `person:Shabbethai`); مَشلَّام (ID: `person:Meshullam.10`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`)
