...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Edomites (ID: `group:Edom`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); Edom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); Israel (ID: `person:Israel`); Edomites (ID: `group:Edom`); love (ID: `keyterm:Love`); to cause to possess (ID: `keyterm:Possess`); Jackal (ID: `fauna:Jackal`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); fear (ID: `keyterm:Fear`); Covenant (ID: `keyterm:Covenant`); offering (ID: `keyterm:Offering`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); utter a curse (ID: `keyterm:Curse`); stain (ID: `keyterm:Stain`); peace (ID: `keyterm:IntactState`); Glory (ID: `keyterm:Glory`); Priests (ID: `group:GenericPriests`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); fairness (ID: `keyterm:Fairness`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); bless (ID: `keyterm:Bless`); The Way (ID: `keyterm:TheWay`); Gentiles (ID: `group:Gentile`); pure (ID: `keyterm:Pure`); ardour (ID: `keyterm:Ardour`); Truth (ID: `keyterm:Truth`); evil intention (ID: `keyterm:Intention`); profane, dishonor (ID: `keyterm:Dishonor`); be kindly disposed (ID: `keyterm:KindlyDisposed`); rogar (ID: `keyterm:AskFor`); make a vow (ID: `keyterm:Vow`); An Angel (ID: `deity:Angel`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** make a vow (ID: `keyterm:Vow`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); utter a curse (ID: `keyterm:Curse`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Covenant (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); evil intention (ID: `keyterm:Intention`); Instruction (ID: `keyterm:Instruction`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Covenant (ID: `keyterm:Covenant`); offering (ID: `keyterm:Offering`); profane, dishonor (ID: `keyterm:Dishonor`); love (ID: `keyterm:Love`); Judá (ID: `person:Judah.4`); delight (ID: `keyterm:Delight`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); Judá (ID: `person:Judah.4`); profane, dishonor (ID: `keyterm:Dishonor`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); swear (ID: `keyterm:Swear`); Covenant (ID: `keyterm:Covenant`); A Group of People (ID: `group:GenericGroup`); pure (ID: `keyterm:Pure`); fear (ID: `keyterm:Fear`); Levi (ID: `group:Levi`); An Angel (ID: `deity:Angel`); Judá (ID: `person:Judah.4`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); decree (ID: `keyterm:Decree`); bless (ID: `keyterm:Bless`); offering (ID: `keyterm:Offering`); utter a curse (ID: `keyterm:Curse`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Sorghum (ID: `flora:Sorghum`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); be enticed to serve (ID: `keyterm:EnticedToServe`); fear (ID: `keyterm:Fear`); Animal Pen (ID: `realia:AnimalPen`); Scroll (ID: `realia:Scroll`); Cattle (ID: `fauna:Bull`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); decree (ID: `keyterm:Decree`); Moisés (ID: `person:Moses`); Monte Sinai (ID: `place:SinaiMount`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); decree (ID: `keyterm:Decree`); Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Monte Sinai (ID: `place:SinaiMount`); something devoted to god (ID: `keyterm:SomethingDevotedToGod`); Instruction (ID: `keyterm:Instruction`); Elias (ID: `person:Elijah`)
...
* **Associated ACAI Concepts:** something devoted to god (ID: `keyterm:SomethingDevotedToGod`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Elias (ID: `person:Elijah`)
