...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); pronounce innocent (ID: `keyterm:PronounceInnocent`); The Way (ID: `keyterm:TheWay`); Zealous (ID: `keyterm:Zealous.3`); Libano (ID: `place:Lebanon`); strength (ID: `keyterm:Strength`); Basã (ID: `place:Bashan`); Carmelo (ID: `place:Carmel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); pronounce innocent (ID: `keyterm:PronounceInnocent`); The Way (ID: `keyterm:TheWay`); Zealous (ID: `keyterm:Zealous.3`); Libano (ID: `place:Lebanon`); strength (ID: `keyterm:Strength`); wickedness (ID: `keyterm:Wickedness`); Basã (ID: `place:Bashan`); Carmelo (ID: `place:Carmel`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Brier (ID: `flora:Brier`); Strong Drink (ID: `realia:StrongDrink`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** The Way (ID: `keyterm:TheWay`); SENHOR (ID: `deity:Lord`); pronounce innocent (ID: `keyterm:PronounceInnocent`); strength (ID: `keyterm:Strength`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); wickedness (ID: `keyterm:Wickedness`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Brier (ID: `flora:Brier`); Strong Drink (ID: `realia:StrongDrink`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** peace (ID: `keyterm:IntactState`); Judá (ID: `group:Judah`); wickedness (ID: `keyterm:Wickedness`); make a vow (ID: `keyterm:Vow`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); SENHOR (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Líbia (ID: `place:Libya`); Pute (ID: `place:Put`); Cush (ID: `place:Cush.2`); lot (ID: `keyterm:Lot`); Egito (ID: `place:Egypt`)
