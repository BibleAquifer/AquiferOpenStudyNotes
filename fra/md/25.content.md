...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); se rebeller (ID: `keyterm:Rebel`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); force (ID: `keyterm:Strength`); aimer (ID: `keyterm:Love`); Israël (ID: `person:Israel`); tromperie (ID: `keyterm:Deceit`); pollution (ID: `keyterm:Defilement`); fête déterminée (ID: `keyterm:AppointedFeast`); indomptables (ID: `keyterm:MightyOne`); travil (ID: `keyterm:Work`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); pécher (ID: `keyterm:Sin`); Train (ID: `realia:Train`); Deer (ID: `fauna:Deer`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Net (ID: `realia:Net`); Yoke (ID: `realia:Yoke`); Casting Net (ID: `realia:CastingNet`); Grass (ID: `flora:Grass`); Winepress (ID: `realia:Winepress`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Juda (ID: `group:Judah`); travil (ID: `keyterm:Work`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Jérusalem (ID: `place:Jerusalem`); pécher (ID: `keyterm:Sin`); Éternel (ID: `deity:Lord`); pollution (ID: `keyterm:Defilement`)
...
* **Associated ACAI Concepts:** indomptables (ID: `keyterm:MightyOne`); Juda (ID: `group:Judah`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); Israël (ID: `person:Israel`); fête déterminée (ID: `keyterm:AppointedFeast`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); colline (ID: `keyterm:Horn`); Sheep (ID: `fauna:Lamb`); profaner, déshonorer (ID: `keyterm:Dishonor`); ardeur (ID: `keyterm:Ardour`); voir (ID: `keyterm:HaveAVision`); sabbat (ID: `keyterm:Sabbath`); Instruction (ID: `keyterm:Instruction`); Utterance (ID: `keyterm:Utterance`); nation; peuple (ID: `group:Gentile`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Wine (ID: `realia:Wine`); Sackcloth (ID: `realia:Sackcloth`); Tent (ID: `realia:Tent`); Measuring Reed (ID: `realia:MeasuringReed`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Bow (ID: `realia:Bow`); Grain (ID: `flora:Grain`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); sabbat (ID: `keyterm:Sabbath`); fête déterminée (ID: `keyterm:AppointedFeast`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); fête déterminée (ID: `keyterm:AppointedFeast`); House (ID: `realia:House`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Arrow (ID: `realia:Arrow`); Wormwood (ID: `flora:Wormwood`); flèche (ID: `keyterm:Arrow`); juste (ID: `keyterm:Complete`); état intact (ID: `keyterm:IntactState`); bonté (ID: `keyterm:Kindness`); Lion (ID: `fauna:Lion`); Bow (ID: `realia:Bow`); Bear (ID: `fauna:Bear`); Bitter Herbs (ID: `flora:Chicory`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); bonté (ID: `keyterm:Kindness`); espoir (ID: `keyterm:Hope`); craindre (ID: `keyterm:Fear`); acheter (ID: `keyterm:Redeem`); se rebeller (ID: `keyterm:Rebel`); pardonner (ID: `keyterm:Forgive`); aide (ID: `keyterm:Salvation`); flèche (ID: `keyterm:Arrow`); juste (ID: `keyterm:Complete`); pécher (ID: `keyterm:Sin`); état intact (ID: `keyterm:IntactState`); Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Wormwood (ID: `flora:Wormwood`); Arrow (ID: `realia:Arrow`); Pit (ID: `realia:Pit`); Bear (ID: `fauna:Bear`); Yoke (ID: `realia:Yoke`); Hewn Stone (ID: `realia:HewnStone`); Bird (ID: `fauna:Bird`); Lion (ID: `fauna:Lion`); Bow (ID: `realia:Bow`); Bitter Herbs (ID: `flora:Chicory`)
...
* **Associated ACAI Concepts:** bonté (ID: `keyterm:Kindness`); Éternel (ID: `deity:Lord`); juste (ID: `keyterm:Complete`)
...
L'Éternel est mon partage (ou selon les versions : « ma part », « ma portion », « mon bien », « mon lot », « mon trésor »). Ces mots désignent souvent le pays de Canaan en tant qu'héritage d'Israël depuis l'époque de Moïse ([Ex 15\.17](https://ref.ly/Exod15:17); [Jos 21\.19](https://ref.ly/Josh21:19);[1Ch 28\.8](https://ref.ly/1Chr28:8); [Ps 47\.5\).](https://ref.ly/Ps47:4) Ces mots désignent cepenant également Dieu lui\-même en tant que véritable partage ou héritage de son peuple (voir [Ps 16\.5–6](https://ref.ly/Ps16:5-Ps16:6); [Ep 1\.11](https://ref.ly/Eph1:11); [Hé 9\.15](https://ref.ly/Heb9:15); [1P 1\.3–4](https://ref.ly/1Pet1:3-1Pet1:4)).
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); ardeur (ID: `keyterm:Ardour`); Éternel (ID: `deity:Lord`); Édom (ID: `place:Edom`); pécher (ID: `keyterm:Sin`); souiller (ID: `keyterm:Stain`); Uts (ID: `place:Uz`); charger (ID: `keyterm:Appoint`); pollution (ID: `keyterm:Defilement`); agir avec bonté (ID: `keyterm:KindlyDisposed`); Sodome (ID: `place:Sodom`); juste (ID: `keyterm:Complete`); punition (ID: `keyterm:Punishment`); oint (ID: `keyterm:Anointed`); fie (ID: `keyterm:BelieveIn`); Jackal (ID: `fauna:Jackal`); Ostrich (ID: `fauna:Ostrich`); Purple Cloth (ID: `realia:PurpleCloth`); Clay Jar (ID: `realia:ClayJar`); Vulture (ID: `fauna:Vulture`)
...
* **Associated ACAI Concepts:** Édom (ID: `place:Edom`); Uts (ID: `place:Uz`); Jérusalem (ID: `place:Jerusalem`); juste (ID: `keyterm:Complete`); pécher (ID: `keyterm:Sin`); charger (ID: `keyterm:Appoint`); ardeur (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); juste (ID: `keyterm:Complete`); pécher (ID: `keyterm:Sin`); charger (ID: `keyterm:Appoint`); Édom (ID: `place:Edom`); ardeur (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); pécher (ID: `keyterm:Sin`); Woe (ID: `keyterm:Woe`); laissiez en possession (ID: `keyterm:Possess`); Assyria (ID: `place:Assyria`); danse en rond (ID: `keyterm:RoundDance`); Juda (ID: `group:Judah`); Égypte (ID: `place:Egypt`); ardeur (ID: `keyterm:Ardour`); Juda (ID: `person:Judah.4`); House (ID: `realia:House`); Jackal (ID: `fauna:Jackal`); Hand-Mill (ID: `realia:Hand-mill`); Crown (ID: `realia:Crown`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe`); pécher (ID: `keyterm:Sin`); danse en rond (ID: `keyterm:RoundDance`); Hand-Mill (ID: `realia:Hand-mill`); Crown (ID: `realia:Crown`)
