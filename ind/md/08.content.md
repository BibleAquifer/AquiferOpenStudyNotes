...
* **Associated ACAI Concepts:** Ephrathites (ID: `group:Ephrathah`); Efrata (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Mahlon (ID: `person:Chilion`); Moab (ID: `place:Moab`); Yehuda (ID: `group:Judah`); Elimelekh (ID: `person:Elimelech`); Yehuda (ID: `person:Judah.4`); Betlehem (ID: `place:Bethlehem`); Mahlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); Rut (ID: `person:Ruth`); Betlehem (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** kebaikan (ID: `keyterm:Kindness`); Tuhan (ID: `deity:Lord`); Naomi (ID: `person:Naomi`); memberkati (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); menyebabkan memiliki (ID: `keyterm:Possess`); Rut (ID: `person:Ruth`); Mahlon (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Rahel (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); Tuhan (ID: `deity:Lord`); Lea (ID: `person:Leah`); Betlehem (ID: `place:Bethlehem`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Peres (ID: `person:Perez`); Tamar (ID: `person:Tamar`); Yehuda (ID: `group:Judah`); Yehuda (ID: `person:Judah.4`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Naomi (ID: `person:Naomi`); memberkati (ID: `keyterm:Bless`); Tuhan (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** memperanakkan (ID: `person:Salmon`); Hezron (ID: `person:Hezron.2`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Peres (ID: `person:Perez`); Boas (ID: `person:Boaz`); Isai (ID: `person:Jesse`); Daud (ID: `person:David`); Nahason (ID: `person:Nahshon`)
