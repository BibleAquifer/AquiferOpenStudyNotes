...
* **Associated ACAI Concepts:** Cotton (ID: `flora:Cotton`); Linen (ID: `realia:Linen`); Money (ID: `realia:Money`); Bed (ID: `realia:Bed`); Purple Cloth (ID: `realia:PurpleCloth`); Rope (ID: `realia:Rope`)
...
* **Associated ACAI Concepts:** Bigtha (ID: `person:Bigtha`); Carcas (ID: `person:Carkas`); Mehuman (ID: `person:Mehuman`); Zéthar (ID: `person:Zethar`); Abagtha (ID: `person:Abagtha`); Biztha (ID: `person:Biztha`); Harbona (ID: `person:Harbona`); Assuérus (ID: `person:Ahasuerus`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Vasthi (ID: `person:Vashti`); Perse (ID: `place:Persia`); Perse (ID: `group:Persia`); Medan (ID: `person:Medan`); Mède(s); Médie (ID: `group:Mede`); Assuérus (ID: `person:Ahasuerus`)
...
* **Associated ACAI Concepts:** Nebucadnetsar (ID: `person:Nebuchadnezzar`); Jojakin (ID: `person:Jehoiachin`); Juda (ID: `group:Judah`); Babylone (ID: `place:Babylon`); Juda (ID: `person:Judah.4`); Jérusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Agag (ID: `person:Agag.2`); Agaguite (ID: `group:Agag`); Jews (ID: `group:Jews`); Hammedatha (ID: `person:Hammedatha`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Mardochée (ID: `person:Mordecai.2`); Zéresch (ID: `person:Zeresh`); aimer (ID: `keyterm:Love`); A Group of People (ID: `group:GenericGroup`); Esther (ID: `person:Esther`); Jews (ID: `group:Jews`); gloire (ID: `keyterm:Glory`); House (ID: `realia:House`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Zéresch (ID: `person:Zeresh`); A Group of People (ID: `group:GenericGroup`); Jews (ID: `group:Jews`); Mardochée (ID: `person:Mordecai.2`); aimer (ID: `keyterm:Love`); Haman (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Esther (ID: `person:Esther`); Jews (ID: `group:Jews`); Mardochée (ID: `person:Mordecai.2`); Assuérus (ID: `person:Ahasuerus`); Haman (ID: `person:Haman`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Agaguite (ID: `group:Agag`); Esther (ID: `person:Esther`); Haman (ID: `person:Haman`); Jews (ID: `group:Jews`); Agag (ID: `person:Agag.2`); prier pour la pitié (ID: `keyterm:BegForMercy`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Agaguite (ID: `group:Agag`); Haman (ID: `person:Haman`); Jews (ID: `group:Jews`); grâce (ID: `keyterm:Favor`); Agag (ID: `person:Agag.2`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Poratha (ID: `person:Poratha`); Aridatha (ID: `person:Aridatha`); Vajezatha (ID: `person:Vaizatha`); Adalia (ID: `person:Adalia`); Parschandatha (ID: `person:Parshandatha`); Arizaï (ID: `person:Arisai`); Dalphon (ID: `person:Dalphon`); Aspatha (ID: `person:Aspatha`); Aridaï (ID: `person:Aridai`); Parmaschtha (ID: `person:Parmashta`); Jews (ID: `group:Jews`); Hammedatha (ID: `person:Hammedatha`); Haman (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Jews (ID: `group:Jews`); Esther (ID: `person:Esther`); Suse (ID: `place:Susa`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Lot (ID: `realia:Lot`); Hammedatha (ID: `person:Hammedatha`); Haman (ID: `person:Haman`); Agaguite (ID: `group:Agag`); Mardochée (ID: `person:Mordecai.2`); destin (ID: `keyterm:Lot`); Agag (ID: `person:Agag.2`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Assuérus (ID: `person:Ahasuerus`); Perse (ID: `place:Persia`); Mardochée (ID: `person:Mordecai.2`); Médie (ID: `place:Media`)
