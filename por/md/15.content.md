...
* **Associated ACAI Concepts:** Pérsia (ID: `place:Persia`); Ciro (ID: `person:Cyrus`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Jeremias (ID: `person:Jeremiah.6`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Jeremias (ID: `person:Jeremiah.6`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Judá (ID: `group:Judah`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Pérsia (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); Benjamim (ID: `person:Benjamin`); Judá (ID: `group:Judah`); Benjamim (ID: `group:Benjamin`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Levi (ID: `group:Levi`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Nabucodonozor (ID: `person:Nebuchadnezzar`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Ciro (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mitredate (ID: `person:Mithredath`); Judá (ID: `group:Judah`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `person:Judah.4`); Pérsia (ID: `place:Persia`); Ciro (ID: `person:Cyrus`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Salomão (ID: `person:Solomon`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Bebai (ID: `person:Bebai`); Hacoz (ID: `person:Hakkoz.2`); Parós (ID: `person:Parosh`); Baquebuque (ID: `person:Bakbuk`); Nephushesim (ID: `group:Nephushesim`); Necoda (ID: `person:Nekoda.2`); Queros (ID: `person:Keros`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Salmai (ID: `person:Shalmai`); Sia (ID: `person:Siaha`); Jesua (ID: `person:Jeshua.3`); Tel-Melá (ID: `place:Tel-melah`); Bilsã (ID: `person:Bilshan`); Bazlite (ID: `person:Bazluth`); Netofa (ID: `place:Netophah`); Jaala (ID: `person:Jaalah`); Reum (ID: `person:Rehum`); Bigvai (ID: `person:Bigvai`); Mispar (ID: `person:Mispar`); Bigvai (ID: `person:Bigvai.2`); Sephatias (ID: `person:Shephatiah.7`); Harim (ID: `person:Harim`); Hanã (ID: `person:Hanan.4`); Reelaías (ID: `person:Reelaiah`)
...
* **Associated ACAI Concepts:** Reum (ID: `person:Rehum`); Bilsã (ID: `person:Bilshan`); Reelaías (ID: `person:Reelaiah`); Mordecai (ID: `person:Mordecai`); Bigvai (ID: `person:Bigvai`); Mispar (ID: `person:Mispar`); Seraias (ID: `person:Seraiah.6`); Neemias (ID: `person:Nehemiah`); Baana (ID: `person:Baanah.3`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Hasum (ID: `person:Hashum`); Bebai (ID: `person:Bebai`); Parós (ID: `person:Parosh`); Zatu (ID: `person:Zattu.2`); Ará (ID: `person:Arah.2`); Ezequias (ID: `person:Hezekiah.2`); Elam (ID: `person:Elam`); Adim (ID: `person:Adin`); Joabe (ID: `person:Joab.3`); Jesua (ID: `person:Jeshua.3`); Bani (ID: `person:Bani`); Zacai (ID: `person:Zaccai.2`); Ater (ID: `person:Ater`); Jora (ID: `person:Jorah`); Sephatias (ID: `person:Shephatiah.6`); Asgade (ID: `person:Azgad`); Adonicão (ID: `person:Adonikam`); Bigvai (ID: `person:Bigvai.2`); Bezai (ID: `person:Bezai`); Paate-Moabe (ID: `person:Pahath-moab`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Beth-azmaveth (ID: `place:Beth-azmaveth`); Hadide (ID: `place:Hadid`); Magbis (ID: `place:Magbish`); Nebo (ID: `place:Nebo.2`); Netofa (ID: `place:Netophah`); Harim (ID: `person:Harim.2`); Senaa (ID: `place:Senaah`); Lode (ID: `place:Lod`); Geba (ID: `place:Geba`); Ono (ID: `place:Ono`); Elam (ID: `person:Elam`); Quiriate-Jearim (ID: `place:Kiriath-jearim`); Jericó (ID: `place:Jericho`); Cefira (ID: `place:Chephirah`); Micmás (ID: `place:Michmash`); Beerote (ID: `place:Beeroth`); Ai (ID: `place:Ai`); Anatote (ID: `place:Anathoth`); Ramah (ID: `place:Ramah.2`); Belém (ID: `place:Bethlehem`); Betel (ID: `place:Bethel`)
...
* **Associated ACAI Concepts:** Imer (ID: `person:Immer.2`); Talmom (ID: `person:Talmon`); Harim (ID: `person:Harim`); Hodavias (ID: `person:Hodaviah.4`); Jesua (ID: `person:Jeshua`); Sobai (ID: `person:Shobai`); Jesua (ID: `person:Jeshua.4`); Ater (ID: `person:Ater.2`); Hatita (ID: `person:Hatita`); Jedaías (ID: `person:Jedaiah.4`); Pasur (ID: `person:Pashhur`); Levi (ID: `person:Levi.3`); Cadmiel (ID: `person:Kadmiel`); Levi (ID: `group:Levi`); Salum (ID: `person:Shallum.8`); Acube (ID: `person:Akkub.2`); Asafe (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** Talmom (ID: `person:Talmon`); Sobai (ID: `person:Shobai`); Ater (ID: `person:Ater.2`); Hatita (ID: `person:Hatita`); Asafe (ID: `person:Asaph.2`); Acube (ID: `person:Akkub.2`); Salum (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** Tabaote (ID: `person:Tabbaoth`); Rezim (ID: `person:Rezin.2`); Lebana (ID: `person:Lebanah`); Necoda (ID: `person:Nekoda`); Baquebuque (ID: `person:Bakbuk`); Meunim (ID: `group:Meunim`); Sisera (ID: `person:Sisera.2`); Nephushesim (ID: `group:Nephushesim`); Barcos (ID: `person:Barkos`); Padom (ID: `person:Padon`); Besai (ID: `person:Besai`); Queros (ID: `person:Keros`); Harur (ID: `person:Harhur`); Gaar (ID: `person:Gahar`); Reaías (ID: `person:Reaiah.3`); Zia (ID: `person:Ziha`); Meída (ID: `person:Mehida`); Salmai (ID: `person:Shalmai`); Sia (ID: `person:Siaha`); Hasufa (ID: `person:Hasupha`); Gidel (ID: `person:Giddel`); Harsa (ID: `person:Harsha`); Nesias (ID: `person:Neziah`); Hatifa (ID: `person:Hatipha`); Hacufa (ID: `person:Hakupha`); Bazlite (ID: `person:Bazluth`); Gazão (ID: `person:Gazzam`); Hagaba (ID: `person:Hagabah`); Asná (ID: `person:Asnah`); Temá (ID: `person:Temah`); Paseia (ID: `person:Paseah.2`); Acube (ID: `person:Akkub.3`); Uza (ID: `person:Uzza.2`); Hagabe (ID: `person:Hagab`); Hanã (ID: `person:Hanan.4`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Sotai (ID: `person:Sotai`); Hatil (ID: `person:Hattil`); Peruda (ID: `person:Peruda`); Sephatias (ID: `person:Shephatiah.7`); Ami (ID: `person:Ami`); Soferete (ID: `person:Sophereth`); Darcom (ID: `person:Darkon`); Gidel (ID: `person:Giddel.2`); Jaala (ID: `person:Jaalah`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`)
...
* **Associated ACAI Concepts:** Tel-Melá (ID: `place:Tel-melah`); Adã (ID: `place:Addan`); Delaías (ID: `person:Delaiah.3`); Tobias (ID: `person:Tobiah`); Querube (ID: `place:Cherub`); Necoda (ID: `person:Nekoda.2`); Tel-Harsa (ID: `place:Tel-harsha`); Imer (ID: `place:Immer`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Habaiah (ID: `person:Habaiah`); Hacoz (ID: `person:Hakkoz.2`); Barzillai (ID: `person:Barzillai.3`); Barzillai (ID: `person:Barzillai`); Gileade (ID: `place:Gilead`); stain (ID: `keyterm:Stain`); priesthood (ID: `keyterm:Priesthood`); Gileadites (ID: `group:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); strength (ID: `keyterm:Strength`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Mina (ID: `realia:Mina`); House (ID: `realia:House`); Tunic (ID: `realia:Tunic`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); Josué (ID: `person:Joshua.5`); Pérsia (ID: `place:Persia`); Ciro (ID: `person:Cyrus`); Sealtiel (ID: `person:Shealtiel.2`); Jeozadaque (ID: `person:Jehozadak`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Relatives (ID: `group:Relatives`); Hodavias (ID: `person:Hodaviah.4`); Esar-Hadom (ID: `person:Esarhaddon`); Cadmiel (ID: `person:Kadmiel`); Jesua (ID: `person:Jeshua.4`); Henadade (ID: `person:Henadad`); Jope (ID: `place:Joppa`); Tiro (ID: `place:Tyre`); kindness (ID: `keyterm:Kindness`); appointed feast (ID: `keyterm:AppointedFeast`); Libano (ID: `place:Lebanon`); new moon festival (ID: `keyterm:NewMoonFestival`); Assyria (ID: `place:Assyria`); Instruction (ID: `keyterm:Instruction`); Sidonians (ID: `group:Sidon`); counsel (ID: `keyterm:Counsel`); Sidom (ID: `place:Sidon`); Dario (ID: `person:Darius.2`); terror (ID: `keyterm:Terror`); Asafe (ID: `person:Asaph.2`); Moisés (ID: `person:Moses`); Davi (ID: `person:David`); Hodias (ID: `person:Hodiah.2`); holy (ID: `keyterm:Holy`); Benjamim (ID: `person:Benjamin`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); Tyrians (ID: `group:Tyre`); Benjamim (ID: `group:Benjamin`); Trumpet (ID: `realia:Trumpet`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Cymbals (ID: `realia:Cymbals`); Craftsman (ID: `realia:Craftsman`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); offering (ID: `keyterm:Offering`); Moisés (ID: `person:Moses`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** terror (ID: `keyterm:Terror`); offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** Sidonians (ID: `group:Sidon`); Jope (ID: `place:Joppa`); Tiro (ID: `place:Tyre`); Libano (ID: `place:Lebanon`); Tyrians (ID: `group:Tyre`); Pérsia (ID: `place:Persia`); Sidom (ID: `place:Sidon`); Ciro (ID: `person:Cyrus`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Craftsman (ID: `realia:Craftsman`); Cedar (ID: `flora:Cedar`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); Levi (ID: `person:Levi.3`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Levi (ID: `group:Levi`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); kindness (ID: `keyterm:Kindness`); Levi (ID: `group:Levi`); Davi (ID: `person:David`); Asafe (ID: `person:Asaph.2`); Trumpet (ID: `realia:Trumpet`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `person:Benjamin`); Judá (ID: `group:Judah`); Israel (ID: `person:Israel`); Benjamim (ID: `group:Benjamin`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Esar-Hadom (ID: `person:Esarhaddon`); Assyria (ID: `place:Assyria`); Zorobabel (ID: `person:Zerubbabel.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Pérsia (ID: `place:Persia`); Ciro (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** counsel (ID: `keyterm:Counsel`); Pérsia (ID: `place:Persia`); Dario (ID: `person:Darius.2`); Ciro (ID: `person:Cyrus`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Sinsai (ID: `person:Shimshai`); Reum (ID: `person:Rehum.2`); Artaxerxes (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Pérsia (ID: `place:Persia`); Samaria (ID: `place:Samaria`); Bislão (ID: `person:Bishlam`); Babylonians (ID: `group:Babylon`); Assuero (ID: `person:Ahasuerus`); Osnapar (ID: `person:Osnappar`); Mitredate (ID: `person:Mithredath.2`); Tabeel (ID: `person:Tabeel`); Dinaítas (ID: `person:Dinaite`); Ereque (ID: `place:Erech`); Elamites (ID: `group:Elam`); Elam (ID: `place:Elam`); Persians (ID: `group:Persia`); Susã (ID: `place:Susa`); Judá (ID: `group:Judah`); Babilônia (ID: `place:Babylon`); Judá (ID: `person:Judah.4`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Bislão (ID: `person:Bishlam`); Mitredate (ID: `person:Mithredath.2`); Tabeel (ID: `person:Tabeel`); Pérsia (ID: `place:Persia`); Artaxerxes (ID: `person:Artaxerxes.2`)
...
* **Associated ACAI Concepts:** Babylonians (ID: `group:Babylon`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Dinaítas (ID: `person:Dinaite`); Ereque (ID: `place:Erech`); Elamites (ID: `group:Elam`); Babilônia (ID: `place:Babylon`); Susã (ID: `place:Susa`); Persians (ID: `group:Persia`); Pérsia (ID: `place:Persia`); Elam (ID: `place:Elam`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Samaria (ID: `place:Samaria`); Reum (ID: `person:Rehum.2`); Jews (ID: `group:Jews`); Sinsai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Jews (ID: `group:Jews`); Jerusalém (ID: `place:Jerusalem`); Artaxerxes (ID: `person:Artaxerxes.2`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); Dario (ID: `person:Darius.2`); Ido (ID: `person:Iddo.6`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Zacarias (ID: `person:Zechariah.17`); Ageu (ID: `person:Haggai`); Tattenai (ID: `person:Tattenai`); Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Rio Eufrates (ID: `place:Euphrates`); Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); Pérsia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Ido (ID: `person:Iddo.6`); Zacarias (ID: `person:Zechariah.17`); Ageu (ID: `person:Haggai`); Jews (ID: `group:Jews`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Sealtiel (ID: `person:Shealtiel.2`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Babilônia (ID: `place:Babylon`); Jerusalém (ID: `place:Jerusalem`); Ciro (ID: `person:Cyrus`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Zorobabel (ID: `person:Zerubbabel.2`); Dario (ID: `person:Darius.2`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Tattenai (ID: `person:Tattenai`); Caldéia (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); Israel (ID: `person:Israel`); Rio Eufrates (ID: `place:Euphrates`); Judá (ID: `person:Judah.4`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Babilônia (ID: `place:Babylon`); Ciro (ID: `person:Cyrus`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Assyria (ID: `place:Assyria`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Unleavened Bread (ID: `realia:UnleavenedBread`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Aitube (ID: `person:Ahitub.3`); Azarias (ID: `person:Azariah.7`); Meraiote (ID: `person:Meraioth`); Seraias (ID: `person:Seraiah.2`); Buqui (ID: `person:Bukki.2`); Uzi (ID: `person:Uzzi`); Abisua (ID: `person:Abishua`); Azarias (ID: `person:Azariah.6`); Salum (ID: `person:Shallum.7`); Amarias (ID: `person:Amariah.2`); Zeraías (ID: `person:Zerahiah`); Zadoque (ID: `person:Zadok.4`); Fineias (ID: `person:Phinehas`); Hilquias (ID: `person:Hilkiah.2`); Arão (ID: `person:Aaron`); Pérsia (ID: `place:Persia`); Artaxerxes (ID: `person:Artaxerxes`); Eleazar (ID: `person:Eleazar.2`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Moisés (ID: `person:Moses`); Babilônia (ID: `place:Babylon`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); decree (ID: `keyterm:Decree`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); Artaxerxes (ID: `person:Artaxerxes`); Rio Eufrates (ID: `place:Euphrates`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); decree (ID: `keyterm:Decree`); Babilônia (ID: `place:Babylon`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Wheat (ID: `flora:Wheat`); Altar (ID: `realia:Altar`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Talent (ID: `realia:Talent`); Kor (ID: `realia:Kor`); Stone Altar (ID: `realia:StoneAltar`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Artaxerxes (ID: `person:Artaxerxes`); Ezra (ID: `person:Ezra`); Rio Eufrates (ID: `place:Euphrates`); Money (ID: `realia:Money`); Kor (ID: `realia:Kor`); Wheat (ID: `flora:Wheat`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Hacatã (ID: `person:Hakkatan`); Atalia (ID: `person:Athaliah.3`); Bebai (ID: `person:Bebai`); Utai (ID: `person:Uthai.2`); Miguel (ID: `person:Michael.10`); Elioenai (ID: `person:Eliehoenai.2`); Jeiel (ID: `person:Jehiel.7`); Daniel (ID: `person:Daniel.2`); Jeuel (ID: `person:Jeuel.3`); Joabe (ID: `person:Joab.4`); Jônatas (ID: `person:Jonathan.9`); Obadias (ID: `person:Obadiah.10`); Elam (ID: `person:Elam`); Secanias (ID: `person:Shecaniah.5`); Adim (ID: `person:Adin`); Bebai (ID: `person:Bebai.2`); Joanã (ID: `person:Johanan.8`); Zeraías (ID: `person:Zerahiah.2`); Josifias (ID: `person:Josiphiah`); Zacur (ID: `person:Zaccur.5`); Secanias (ID: `person:Shecaniah.6`); Zacarias (ID: `person:Zechariah.18`); Ebede (ID: `person:Ebed.2`); Zabadias (ID: `person:Zebadiah.8`); Jaaziel (ID: `person:Jahaziel.5`); Jesaías (ID: `person:Jeshaiah.4`); Zacarias (ID: `person:Zechariah.19`); Sephatias (ID: `person:Shephatiah.6`); Parós (ID: `person:Parosh.2`); Asgade (ID: `person:Azgad`); Selomite (ID: `person:Shelomith.4`); Adonicão (ID: `person:Adonikam`); Gérson (ID: `person:Gershom.2`); Bigvai (ID: `person:Bigvai.2`); Hatus (ID: `person:Hattush.2`); Paate-Moabe (ID: `person:Pahath-moab`); Semaías (ID: `person:Shemaiah.14`); Elifelete (ID: `person:Eliphelet.5`); Fineias (ID: `person:Phinehas`); Itamar (ID: `person:Ithamar`); Artaxerxes (ID: `person:Artaxerxes`); Davi (ID: `person:David`); Babilônia (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** Jaribe (ID: `person:Jarib.2`); Zacarias (ID: `person:Zechariah.20`); Semaías (ID: `person:Shemaiah.15`); Joiaribe (ID: `person:Joiarib.2`); Elnatã (ID: `person:Elnathan.2`); Casifia (ID: `place:Casiphia`); Mesulão (ID: `person:Meshullam.9`); Natã (ID: `person:Nathan.5`); Ariel (ID: `person:Ariel`); Ido (ID: `person:Iddo`); Elnatã (ID: `person:Elnathan.4`); Eliezer (ID: `person:Eliezer.8`); Elnatã (ID: `person:Elnathan.3`); perceive (ID: `keyterm:Perceive`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); Levi (ID: `person:Levi.3`); Insight (ID: `keyterm:Insight`); Israel (ID: `person:Israel`); Mali (ID: `person:Mahli`); SENHOR (ID: `deity:Lord`); Levi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); To Sin (ID: `keyterm:Sin`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); Levi (ID: `person:Levi.3`); Amom (ID: `place:Ammon`); Egito (ID: `place:Egypt`); Levi (ID: `group:Levi`); Canaã (ID: `place:Canaan`); Ammonites (ID: `group:Ammon`); Israel (ID: `person:Israel`); Hete (ID: `person:Heth`); Moabe (ID: `place:Moab`); Amorites (ID: `group:Amorites`); be unfaithful (ID: `keyterm:Unfaithful`); Jebusites (ID: `group:Jebusites`); cananeu (ID: `group:Canaan`); Egyptians (ID: `group:Egypt`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`); ardour (ID: `keyterm:Ardour`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Harim (ID: `person:Harim`); Elam (ID: `person:Elam`); offering (ID: `keyterm:Offering`); Judá (ID: `group:Judah`); counsel (ID: `keyterm:Counsel`); Judá (ID: `person:Judah.4`); Benaia (ID: `person:Benaiah.8`); Jadai (ID: `person:Jaddai`); Joel (ID: `person:Joel.12`); Parós (ID: `person:Parosh`); Simei (ID: `person:Shimei.15`); Jozabade (ID: `person:Jozabad.7`); Eliasibe (ID: `person:Eliashib.5`); Joanã (ID: `person:Jehohanan.4`); Matatá (ID: `person:Mattattah`); Macnadbai (ID: `person:Machnadebai`); Ismael (ID: `person:Ishmael.6`); Salum (ID: `person:Shallum.10`); Aziza (ID: `person:Aziza`); Maluque (ID: `person:Malluch.3`); Semarias (ID: `person:Shemariah.4`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); kindness (ID: `keyterm:Kindness`); to cause to possess (ID: `keyterm:Possess`); peace (ID: `keyterm:IntactState`); defilement (ID: `keyterm:Defilement`); supplication (ID: `keyterm:Supplication`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Pérsia (ID: `place:Persia`); dispossess (ID: `keyterm:Dispossess`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); Pérsia (ID: `place:Persia`); kindness (ID: `keyterm:Kindness`); supplication (ID: `keyterm:Supplication`); Jerusalém (ID: `place:Jerusalem`); Peg (ID: `realia:Peg.2`); House (ID: `realia:House`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** Secanias (ID: `person:Shecaniah.7`); Jeiel (ID: `person:Jehiel.8`); Elam (ID: `person:Elam`); Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); be unfaithful (ID: `keyterm:Unfaithful`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** counsel (ID: `keyterm:Counsel`); SENHOR (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Levi (ID: `person:Levi.3`); Ezra (ID: `person:Ezra`); Levi (ID: `group:Levi`); Israel (ID: `person:Israel`); swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** Benjamim (ID: `person:Benjamin`); Judá (ID: `group:Judah`); Benjamim (ID: `group:Benjamin`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ticva (ID: `person:Tikvah.2`); Asael (ID: `person:Asahel.4`); Sabetai (ID: `person:Shabbethai`); Mesulão (ID: `person:Meshullam.10`); Jazeías (ID: `person:Jahzeiah`); Jônatas (ID: `person:Jonathan.10`); Levi (ID: `person:Levi.3`); Levi (ID: `group:Levi`)
