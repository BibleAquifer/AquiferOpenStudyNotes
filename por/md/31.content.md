...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); Understanding (ID: `keyterm:Understanding`); Monte de Esaú (ID: `place:EsauMount`)
...
* **Associated ACAI Concepts:** lot (ID: `keyterm:Lot`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Edomites (ID: `group:Edom`); José (ID: `person:Joseph.10`); Jerusalém (ID: `place:Jerusalem`); Edom (ID: `place:Edom`); dispossess (ID: `keyterm:Dispossess`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Canaã (ID: `place:Canaan`); cananeu (ID: `group:Canaan`); Benjamim (ID: `person:Benjamin`); Benjamim (ID: `group:Benjamin`); Efraim (ID: `person:Ephraim`); Gileade (ID: `place:Gilead`); Filístia (ID: `place:Philistine`); Sefalá (ID: `place:Shephelah`); Samaria (ID: `place:Samaria`); Efraim (ID: `group:Ephraim`); Filisteu (ID: `group:Philistine`); Jerusalém (ID: `place:Jerusalem`); Sardes (ID: `place:Sardis`); Israel (ID: `person:Israel`); Sarepta (ID: `place:Zarephath`); Monte de Esaú (ID: `place:EsauMount`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Neguebe (ID: `place:Negeb`); Monte de Esaú (ID: `place:EsauMount`); dispossess (ID: `keyterm:Dispossess`); Canaã (ID: `place:Canaan`); Filisteu (ID: `group:Philistine`); Sefalá (ID: `place:Shephelah`); cananeu (ID: `group:Canaan`); Israel (ID: `person:Israel`); Benjamim (ID: `group:Benjamin`); Efraim (ID: `person:Ephraim`); Gileade (ID: `place:Gilead`); Sarepta (ID: `place:Zarephath`); Benjamim (ID: `person:Benjamin`); SENHOR (ID: `deity:Lord`); Filístia (ID: `place:Philistine`); Sardes (ID: `place:Sardis`); Samaria (ID: `place:Samaria`); Efraim (ID: `group:Ephraim`)
...
* **Associated ACAI Concepts:** Canaã (ID: `place:Canaan`); Jerusalém (ID: `place:Jerusalem`); Sardes (ID: `place:Sardis`); cananeu (ID: `group:Canaan`); Sarepta (ID: `place:Zarephath`); Israel (ID: `person:Israel`); Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`)
