...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Judá (ID: `group:Judah`); lot (ID: `keyterm:Lot`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); dispossess (ID: `keyterm:Dispossess`); Edomites (ID: `group:Edom`); Edom (ID: `place:Edom`); Jerusalém (ID: `place:Jerusalem`); José (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Edomites (ID: `group:Edom`); SENHOR (ID: `deity:Lord`); Edom (ID: `place:Edom`); José (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Filisteu (ID: `group:Philistine`); Sardes (ID: `place:Sardis`); Filístia (ID: `place:Philistine`); Sefalá (ID: `place:Shephelah`); Sarepta (ID: `place:Zarephath`); Gileade (ID: `place:Gilead`); Israel (ID: `person:Israel`); cananeu (ID: `group:Canaan`); Samaria (ID: `place:Samaria`); Jerusalém (ID: `place:Jerusalem`); Efraim (ID: `person:Ephraim`); Benjamim (ID: `person:Benjamin`); Monte de Esaú (ID: `place:EsauMount`); Canaã (ID: `place:Canaan`); Efraim (ID: `group:Ephraim`); Benjamim (ID: `group:Benjamin`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Jerusalém (ID: `place:Jerusalem`); Monte de Esaú (ID: `place:EsauMount`); Filisteu (ID: `group:Philistine`); Filístia (ID: `place:Philistine`); Israel (ID: `person:Israel`); Samaria (ID: `place:Samaria`); Benjamim (ID: `person:Benjamin`); Sardes (ID: `place:Sardis`); Sarepta (ID: `place:Zarephath`); Gileade (ID: `place:Gilead`); SENHOR (ID: `deity:Lord`); Efraim (ID: `person:Ephraim`); Efraim (ID: `group:Ephraim`); Benjamim (ID: `group:Benjamin`); Sefalá (ID: `place:Shephelah`); cananeu (ID: `group:Canaan`); Canaã (ID: `place:Canaan`)
...
* **Associated ACAI Concepts:** Sardes (ID: `place:Sardis`); Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Sarepta (ID: `place:Zarephath`); Israel (ID: `person:Israel`); cananeu (ID: `group:Canaan`); Canaã (ID: `place:Canaan`); Jerusalém (ID: `place:Jerusalem`)
