...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Intention (ID: `keyterm:Intention`); أورشَلِيمَ (ID: `place:Jerusalem`); Stupid (ID: `keyterm:Stupid`); ٱلرَّبِّ (ID: `deity:Lord`); Vine (ID: `flora:Vine`); إِسْرَائِيلَ (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); Cattle (ID: `fauna:Bull`); Wine (ID: `realia:Wine`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); أورشَلِيمَ (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); Cattle (ID: `fauna:Bull`); Wine (ID: `realia:Wine`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Cattle (ID: `fauna:Bull`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Sandalwood (ID: `flora:Sandalwood`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vow (ID: `keyterm:Vow`); House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Passion (ID: `keyterm:Ardour`); A Man (ID: `person:GenericMale`); Slaughtering (ID: `keyterm:Slaughtering`); Strength (ID: `keyterm:Strength`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** Stupid (ID: `keyterm:Stupid`); Ability (ID: `keyterm:Ability`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); To Cause to Possess (ID: `keyterm:Possess`); Fear (ID: `keyterm:Fear`); Intention (ID: `keyterm:Intention`); To Sin (ID: `keyterm:Sin`); To Act Wickedly (ID: `keyterm:ActWickedly`); Anointing Oil (ID: `realia:AnointingOil`); Cooking Pot (ID: `realia:CookingPot`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Net (ID: `realia:Net`); Dragnet (ID: `realia:Dragnet`); Fishnet (ID: `realia:Fishnet`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Hell (ID: `place:Hell`); Ability (ID: `keyterm:Ability`); Love (ID: `keyterm:Love`); Intention (ID: `keyterm:Intention`); Strength (ID: `keyterm:Strength`); Anointing Oil (ID: `realia:AnointingOil`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); ٱلرَّبِّ (ID: `deity:Lord`); Caper (ID: `flora:Caper`); Rope (ID: `realia:Rope`); Bird (ID: `fauna:Bird`); Pit (ID: `realia:Pit`); Locust (ID: `fauna:Locust`); Money (ID: `realia:Money`); Almond (ID: `flora:Almond`); Clay Jar (ID: `realia:ClayJar`)
