...
* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Blood (ID: `keyterm:Blood`); Bless (ID: `keyterm:Bless`); यहोवा (ID: `deity:Lord`); Be a Disciple (ID: `keyterm:Disciple`); यीशु (ID: `person:Jesus.2`); Covenant (ID: `keyterm:Covenant`); To Sin (ID: `keyterm:Sin`); Forgive (ID: `keyterm:Forgive`); Kingdom (ID: `keyterm:Kingdom`); Vine (ID: `flora:Vine`)
