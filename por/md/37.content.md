...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Ageu (ID: `person:Haggai`); Sealtiel (ID: `person:Shealtiel.2`); Dario (ID: `person:Darius.2`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); Ageu (ID: `person:Haggai`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Dario (ID: `person:Darius.2`); Judá (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judá (ID: `person:Judah.4`); An Angel (ID: `deity:Angel`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); fear (ID: `keyterm:Fear`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Mule (ID: `fauna:Mule`); Olive Tree (ID: `flora:OliveTree`); Must (ID: `realia:Must`); Bag (ID: `realia:Bag`); Grain (ID: `flora:Grain`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Zorobabel (ID: `person:Zerubbabel.2`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Ageu (ID: `person:Haggai`); Sealtiel (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** Jeozadaque (ID: `person:Jehozadak`); Josué (ID: `person:Joshua.5`); Judá (ID: `person:Judah.4`); SENHOR (ID: `deity:Lord`); Judá (ID: `group:Judah`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Zorobabel (ID: `person:Zerubbabel.2`); Ageu (ID: `person:Haggai`); peace (ID: `keyterm:IntactState`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Egito (ID: `place:Egypt`); fear (ID: `keyterm:Fear`); Sealtiel (ID: `person:Shealtiel.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`); SENHOR (ID: `deity:Lord`); Jeozadaque (ID: `person:Jehozadak`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ageu (ID: `person:Haggai`); defilement (ID: `keyterm:Defilement`); Vine (ID: `flora:Vine`); holy (ID: `keyterm:Holy`); Instruction (ID: `keyterm:Instruction`); bless (ID: `keyterm:Bless`); Dario (ID: `person:Darius.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Winepress (ID: `realia:Winepress`); Stew (ID: `realia:Stew`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Fig (ID: `flora:Fig`); Barley (ID: `flora:Barley`); Olive Tree (ID: `flora:OliveTree`); Pomegranate (ID: `flora:Pomegranate`); Grain (ID: `flora:Grain`); Wine (ID: `realia:Wine`); Coriander (ID: `flora:Coriander`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Judá (ID: `person:Judah.4`); Ageu (ID: `person:Haggai`); Judá (ID: `group:Judah`); Sealtiel (ID: `person:Shealtiel.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Sword (ID: `realia:Sword`); Horse (ID: `fauna:Horse`); Chariot (ID: `realia:Chariot`)
