...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); أورشَلِيمَ (ID: `place:Jerusalem`); Intention (ID: `keyterm:Intention`); Stupid (ID: `keyterm:Stupid`); ٱلرَّبِّ (ID: `deity:Lord`); Vine (ID: `flora:Vine`); To Sin (ID: `keyterm:Sin`); إِسْرَائِيلَ (ID: `person:Israel`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); Vine (ID: `flora:Vine`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Wine (ID: `realia:Wine`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Flock (ID: `fauna:Flock`); Sandalwood (ID: `flora:Sandalwood`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); Intention (ID: `keyterm:Intention`); ٱلرَّبِّ (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vow (ID: `keyterm:Vow`); House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Strength (ID: `keyterm:Strength`); Slaughtering (ID: `keyterm:Slaughtering`); A Man (ID: `person:GenericMale`); Passion (ID: `keyterm:Ardour`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** Stupid (ID: `keyterm:Stupid`); Ability (ID: `keyterm:Ability`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); To Sin (ID: `keyterm:Sin`); Fear (ID: `keyterm:Fear`); To Act Wickedly (ID: `keyterm:ActWickedly`); Intention (ID: `keyterm:Intention`); To Cause to Possess (ID: `keyterm:Possess`); Cooking Pot (ID: `realia:CookingPot`); Olive Oil (ID: `realia:OliveOil`); Brier (ID: `flora:Brier`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Strength (ID: `keyterm:Strength`); Hell (ID: `place:Hell`); Intention (ID: `keyterm:Intention`); ٱلرَّبِّ (ID: `deity:Lord`); Love (ID: `keyterm:Love`); Ability (ID: `keyterm:Ability`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); ٱلرَّبِّ (ID: `deity:Lord`); Caper (ID: `flora:Caper`); Locust (ID: `fauna:Locust`); Clay Jar (ID: `realia:ClayJar`); Bird (ID: `fauna:Bird`); Pit (ID: `realia:Pit`); Almond (ID: `flora:Almond`); Rope (ID: `realia:Rope`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Straightness (ID: `keyterm:Straightness`); Fear (ID: `keyterm:Fear`); Truth (ID: `keyterm:Truth`); Proverb (ID: `keyterm:Saying`); Intention (ID: `keyterm:Intention`); Goad (ID: `realia:Goad`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Scroll (ID: `realia:Scroll`); Goat (ID: `fauna:Goat`); Nail (ID: `realia:Nail`)
