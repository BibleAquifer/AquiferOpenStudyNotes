...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); amado (ID: `keyterm:Beloved`); andar (ID: `keyterm:Live.3`); Gaio (ID: `person:Gaius.4`); Cause of Joy (ID: `keyterm:CauseOfJoy`); love (ID: `keyterm:Love`); orar (ID: `keyterm:Pray`); testemunhar (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); Faithfulness (ID: `keyterm:Faithfulness`); SENHOR (ID: `deity:Lord`); igreja (ID: `keyterm:Church`); amado (ID: `keyterm:Beloved`); dever (ID: `keyterm:Ought`); love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); testemunhar (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** igreja (ID: `keyterm:Church`); Demétrio (ID: `person:Demetrius`); Diótrefes (ID: `person:Diotrephes`); SENHOR (ID: `deity:Lord`); verdadeiro (ID: `keyterm:True`); amado (ID: `keyterm:Beloved`); Do Good (ID: `keyterm:DoGood`); Good (ID: `keyterm:Good`); Truth (ID: `keyterm:Truth`); testemunhar (ID: `keyterm:BearWitness`)
