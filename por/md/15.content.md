...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Pérsia (ID: `place:Persia`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); House (ID: `realia:House`); Israel (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Jeremias (ID: `person:Jeremiah.6`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Pérsia (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Benjamim (ID: `group:Benjamin`); Levi (ID: `group:Levi`); Judá (ID: `person:Judah.4`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Benjamim (ID: `person:Benjamin`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); Levi (ID: `group:Levi`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `person:Levi.3`); Salomão (ID: `person:Solomon`); Sotai (ID: `person:Sotai`); Nebo (ID: `place:Nebo.2`); Hagabe (ID: `person:Hagab`); Gaar (ID: `person:Gahar`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Acube (ID: `person:Akkub.3`); Harsa (ID: `person:Harsha`); Harim (ID: `person:Harim.2`); Sobai (ID: `person:Shobai`); Neemias (ID: `person:Nehemiah`); Bilsã (ID: `person:Bilshan`); Besai (ID: `person:Besai`); Nephushesim (ID: `group:Nephushesim`); Bezai (ID: `person:Bezai`); Hasum (ID: `person:Hashum`); Senaa (ID: `place:Senaah`); Delaías (ID: `person:Delaiah.3`); Sephatias (ID: `person:Shephatiah.6`); Mispar (ID: `person:Mispar`); Bebai (ID: `person:Bebai`); Hagaba (ID: `person:Hagabah`); Zacai (ID: `person:Zaccai.2`); Harim (ID: `person:Harim`); Queros (ID: `person:Keros`)
...
* **Associated ACAI Concepts:** Baana (ID: `person:Baanah.3`); Bigvai (ID: `person:Bigvai`); Mordecai (ID: `person:Mordecai`); Seraias (ID: `person:Seraiah.6`); Mispar (ID: `person:Mispar`); Neemias (ID: `person:Nehemiah`); Bilsã (ID: `person:Bilshan`); Reum (ID: `person:Rehum`); Reelaías (ID: `person:Reelaiah`); Israel (ID: `person:Israel`); Josué (ID: `person:Joshua.5`); Zorobabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Paate-Moabe (ID: `person:Pahath-moab`); Adonicão (ID: `person:Adonikam`); Bani (ID: `person:Bani`); Jesua (ID: `person:Jeshua.3`); Zatu (ID: `person:Zattu.2`); Bezai (ID: `person:Bezai`); Hasum (ID: `person:Hashum`); Jora (ID: `person:Jorah`); Parós (ID: `person:Parosh`); Sephatias (ID: `person:Shephatiah.6`); Asgade (ID: `person:Azgad`); Adim (ID: `person:Adin`); Ará (ID: `person:Arah.2`); Bigvai (ID: `person:Bigvai.2`); Ezequias (ID: `person:Hezekiah.2`); Elam (ID: `person:Elam`); Bebai (ID: `person:Bebai`); Zacai (ID: `person:Zaccai.2`); Joabe (ID: `person:Joab.3`); Ater (ID: `person:Ater`); Gibeão (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Nebo (ID: `place:Nebo.2`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Harim (ID: `person:Harim.2`); Hadide (ID: `place:Hadid`); Senaa (ID: `place:Senaah`); Magbis (ID: `place:Magbish`); Netofa (ID: `place:Netophah`); Ai (ID: `place:Ai`); Belém (ID: `place:Bethlehem`); Cefira (ID: `place:Chephirah`); Beerote (ID: `place:Beeroth`); Quiriate-Jearim (ID: `place:Kiriath-jearim`); Ono (ID: `place:Ono`); Lode (ID: `place:Lod`); Geba (ID: `place:Geba`); Elam (ID: `person:Elam`); Anatote (ID: `place:Anathoth`); Jericó (ID: `place:Jericho`); Micmás (ID: `place:Michmash`); Betel (ID: `place:Bethel`); Ramah (ID: `place:Ramah.2`)
...
* **Associated ACAI Concepts:** Ater (ID: `person:Ater.2`); Harim (ID: `person:Harim`); Jedaías (ID: `person:Jedaiah.4`); Imer (ID: `person:Immer.2`); Sobai (ID: `person:Shobai`); Hodavias (ID: `person:Hodaviah.4`); Jesua (ID: `person:Jeshua`); Jesua (ID: `person:Jeshua.4`); Talmom (ID: `person:Talmon`); Hatita (ID: `person:Hatita`); Cadmiel (ID: `person:Kadmiel`); Pasur (ID: `person:Pashhur`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Acube (ID: `person:Akkub.2`); Asafe (ID: `person:Asaph.2`); Salum (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** Ater (ID: `person:Ater.2`); Sobai (ID: `person:Shobai`); Talmom (ID: `person:Talmon`); Hatita (ID: `person:Hatita`); Acube (ID: `person:Akkub.2`); Asafe (ID: `person:Asaph.2`); Salum (ID: `person:Shallum.8`)
...
* **Associated ACAI Concepts:** Lebana (ID: `person:Lebanah`); Harur (ID: `person:Harhur`); Padom (ID: `person:Padon`); Reaías (ID: `person:Reaiah.3`); Queros (ID: `person:Keros`); Bazlite (ID: `person:Bazluth`); Hagabe (ID: `person:Hagab`); Gidel (ID: `person:Giddel`); Salmai (ID: `person:Shalmai`); Gaar (ID: `person:Gahar`); Necoda (ID: `person:Nekoda`); Baquebuque (ID: `person:Bakbuk`); Uza (ID: `person:Uzza.2`); Harsa (ID: `person:Harsha`); Acube (ID: `person:Akkub.3`); Meunim (ID: `group:Meunim`); Sia (ID: `person:Siaha`); Hasufa (ID: `person:Hasupha`); Rezim (ID: `person:Rezin.2`); Besai (ID: `person:Besai`); Nephushesim (ID: `group:Nephushesim`); Gazão (ID: `person:Gazzam`); Barcos (ID: `person:Barkos`); Zia (ID: `person:Ziha`); Meída (ID: `person:Mehida`); Nesias (ID: `person:Neziah`); Sisera (ID: `person:Sisera.2`); Paseia (ID: `person:Paseah.2`); Hatifa (ID: `person:Hatipha`); Temá (ID: `person:Temah`); Hagaba (ID: `person:Hagabah`); Tabaote (ID: `person:Tabbaoth`); Asná (ID: `person:Asnah`); Hacufa (ID: `person:Hakupha`); Hanã (ID: `person:Hanan.4`)
...
* **Associated ACAI Concepts:** Salomão (ID: `person:Solomon`); Ami (ID: `person:Ami`); Soferete (ID: `person:Sophereth`); Sotai (ID: `person:Sotai`); Poquerete-Hazebaim (ID: `person:Pochereth-hazzebaim`); Darcom (ID: `person:Darkon`); Gidel (ID: `person:Giddel.2`); Sephatias (ID: `person:Shephatiah.7`); Hatil (ID: `person:Hattil`); Peruda (ID: `person:Peruda`); Jaala (ID: `person:Jaalah`)
...
* **Associated ACAI Concepts:** Tobias (ID: `person:Tobiah`); Tel-Melá (ID: `place:Tel-melah`); Imer (ID: `place:Immer`); Necoda (ID: `person:Nekoda.2`); Delaías (ID: `person:Delaiah.3`); Querube (ID: `place:Cherub`); Adã (ID: `place:Addan`); Tel-Harsa (ID: `place:Tel-harsha`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Barzillai (ID: `person:Barzillai.3`); Habaiah (ID: `person:Habaiah`); Hacoz (ID: `person:Hakkoz.2`); Barzillai (ID: `person:Barzillai`); Gileadites (ID: `group:Gilead`); Gileade (ID: `place:Gilead`); stain (ID: `keyterm:Stain`); priesthood (ID: `keyterm:Priesthood`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); SENHOR (ID: `deity:Lord`); strength (ID: `keyterm:Strength`); Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Mina (ID: `realia:Mina`); Money (ID: `realia:Money`); Tunic (ID: `realia:Tunic`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); offering (ID: `keyterm:Offering`); House (ID: `realia:House`); Zorobabel (ID: `person:Zerubbabel.2`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Josué (ID: `person:Joshua.5`); Ciro (ID: `person:Cyrus`); Pérsia (ID: `place:Persia`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Esar-Hadom (ID: `person:Esarhaddon`); Henadade (ID: `person:Henadad`); Hodavias (ID: `person:Hodaviah.4`); Cadmiel (ID: `person:Kadmiel`); Jesua (ID: `person:Jeshua.4`); Relatives (ID: `group:Relatives`); Tiro (ID: `place:Tyre`); new moon festival (ID: `keyterm:NewMoonFestival`); Sidom (ID: `place:Sidon`); kindness (ID: `keyterm:Kindness`); Instruction (ID: `keyterm:Instruction`); Benjamim (ID: `person:Benjamin`); feast of tabernacles (ID: `keyterm:FeastOfTabernacles`); Jope (ID: `place:Joppa`); Sidonians (ID: `group:Sidon`); Libano (ID: `place:Lebanon`); Tyrians (ID: `group:Tyre`); Hodias (ID: `person:Hodiah.2`); Davi (ID: `person:David`); Moisés (ID: `person:Moses`); Benjamim (ID: `group:Benjamin`); appointed feast (ID: `keyterm:AppointedFeast`); terror (ID: `keyterm:Terror`); Assyria (ID: `place:Assyria`); Dario (ID: `person:Darius.2`); Asafe (ID: `person:Asaph.2`); holy (ID: `keyterm:Holy`); counsel (ID: `keyterm:Counsel`); Cedar (ID: `flora:Cedar`); Cymbals (ID: `realia:Cymbals`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Craftsman (ID: `realia:Craftsman`); Trumpet (ID: `realia:Trumpet`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** terror (ID: `keyterm:Terror`); SENHOR (ID: `deity:Lord`); offering (ID: `keyterm:Offering`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Ciro (ID: `person:Cyrus`); Tiro (ID: `place:Tyre`); Jope (ID: `place:Joppa`); Sidonians (ID: `group:Sidon`); Libano (ID: `place:Lebanon`); Sidom (ID: `place:Sidon`); Tyrians (ID: `group:Tyre`); Pérsia (ID: `place:Persia`); Craftsman (ID: `realia:Craftsman`); Cedar (ID: `flora:Cedar`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); SENHOR (ID: `deity:Lord`); Jeozadaque (ID: `person:Jehozadak`); Levi (ID: `group:Levi`); Sealtiel (ID: `person:Shealtiel.2`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Davi (ID: `person:David`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); kindness (ID: `keyterm:Kindness`); Asafe (ID: `person:Asaph.2`); House (ID: `realia:House`); Cymbals (ID: `realia:Cymbals`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Benjamim (ID: `group:Benjamin`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Benjamim (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); Israel (ID: `person:Israel`); Josué (ID: `person:Joshua.5`); Ciro (ID: `person:Cyrus`); SENHOR (ID: `deity:Lord`); Zorobabel (ID: `person:Zerubbabel.2`); Pérsia (ID: `place:Persia`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); Samaria (ID: `place:Samaria`); Pérsia (ID: `place:Persia`); Ereque (ID: `place:Erech`); Dinaítas (ID: `person:Dinaite`); Osnapar (ID: `person:Osnappar`); Assuero (ID: `person:Ahasuerus`); Mitredate (ID: `person:Mithredath.2`); Tabeel (ID: `person:Tabeel`); Bislão (ID: `person:Bishlam`); Babylonians (ID: `group:Babylon`); Susã (ID: `place:Susa`); Judá (ID: `group:Judah`); Babilônia (ID: `place:Babylon`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); Judá (ID: `person:Judah.4`); Elam (ID: `place:Elam`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Ereque (ID: `place:Erech`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Dinaítas (ID: `person:Dinaite`); Babylonians (ID: `group:Babylon`); Susã (ID: `place:Susa`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); Elam (ID: `place:Elam`); Pérsia (ID: `place:Persia`); Babilônia (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Jerusalém (ID: `place:Jerusalem`); Reum (ID: `person:Rehum.2`); Sinsai (ID: `person:Shimshai`); Jews (ID: `group:Jews`); Artaxerxes (ID: `person:Artaxerxes.2`); Samaria (ID: `place:Samaria`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Jews (ID: `group:Jews`); Dario (ID: `person:Darius.2`); Zacarias (ID: `person:Zechariah.17`); Ageu (ID: `person:Haggai`); Setar-Bozenai (ID: `person:Shethar-bozenai`); Tattenai (ID: `person:Tattenai`); Ido (ID: `person:Iddo.6`); Israel (ID: `person:Israel`); Josué (ID: `person:Joshua.5`); Rio Eufrates (ID: `place:Euphrates`); Jeozadaque (ID: `person:Jehozadak`); Judá (ID: `person:Judah.4`); Sealtiel (ID: `person:Shealtiel.2`); Zorobabel (ID: `person:Zerubbabel.2`); Pérsia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Zacarias (ID: `person:Zechariah.17`); Ageu (ID: `person:Haggai`); Ido (ID: `person:Iddo.6`); Israel (ID: `person:Israel`); Jews (ID: `group:Jews`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Josué (ID: `person:Joshua.5`); Jeozadaque (ID: `person:Jehozadak`); Sealtiel (ID: `person:Shealtiel.2`); Jerusalém (ID: `place:Jerusalem`); Zorobabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); House (ID: `realia:House`); Ciro (ID: `person:Cyrus`); Nabucodonozor (ID: `person:Nebuchadnezzar`); Zorobabel (ID: `person:Zerubbabel.2`); Babilônia (ID: `place:Babylon`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Moisés (ID: `person:Moses`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Azarias (ID: `person:Azariah.7`); Seraias (ID: `person:Seraiah.2`); Ezra (ID: `person:Ezra`); Artaxerxes (ID: `person:Artaxerxes`); Hilquias (ID: `person:Hilkiah.2`); Pérsia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Aitube (ID: `person:Ahitub.3`); Salum (ID: `person:Shallum.7`); Meraiote (ID: `person:Meraioth`); Zadoque (ID: `person:Zadok.4`); Seraias (ID: `person:Seraiah.2`); Abisua (ID: `person:Abishua`); Azarias (ID: `person:Azariah.7`); Buqui (ID: `person:Bukki.2`); Amarias (ID: `person:Amariah.2`); Azarias (ID: `person:Azariah.6`); Uzi (ID: `person:Uzzi`); Zeraías (ID: `person:Zerahiah`); Fineias (ID: `person:Phinehas`); Hilquias (ID: `person:Hilkiah.2`); Pérsia (ID: `place:Persia`); Arão (ID: `person:Aaron`); Eleazar (ID: `person:Eleazar.2`); Artaxerxes (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); Israel (ID: `person:Israel`); Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Babilônia (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); decree (ID: `keyterm:Decree`); SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Ezra (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** Rio Eufrates (ID: `place:Euphrates`); Artaxerxes (ID: `person:Artaxerxes`); Ezra (ID: `person:Ezra`); Talent (ID: `realia:Talent`); Kor (ID: `realia:Kor`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** Jesaías (ID: `person:Jeshaiah.4`); Paate-Moabe (ID: `person:Pahath-moab`); Secanias (ID: `person:Shecaniah.5`); Zacarias (ID: `person:Zechariah.18`); Zacur (ID: `person:Zaccur.5`); Joabe (ID: `person:Joab.4`); Gérson (ID: `person:Gershom.2`); Adonicão (ID: `person:Adonikam`); Zeraías (ID: `person:Zerahiah.2`); Joanã (ID: `person:Johanan.8`); Atalia (ID: `person:Athaliah.3`); Jeiel (ID: `person:Jehiel.7`); Jaaziel (ID: `person:Jahaziel.5`); Josifias (ID: `person:Josiphiah`); Utai (ID: `person:Uthai.2`); Miguel (ID: `person:Michael.10`); Jeuel (ID: `person:Jeuel.3`); Obadias (ID: `person:Obadiah.10`); Selomite (ID: `person:Shelomith.4`); Daniel (ID: `person:Daniel.2`); Elioenai (ID: `person:Eliehoenai.2`); Sephatias (ID: `person:Shephatiah.6`); Adim (ID: `person:Adin`); Asgade (ID: `person:Azgad`); Semaías (ID: `person:Shemaiah.14`); Elifelete (ID: `person:Eliphelet.5`); Zabadias (ID: `person:Zebadiah.8`); Zacarias (ID: `person:Zechariah.19`); Ebede (ID: `person:Ebed.2`); Secanias (ID: `person:Shecaniah.6`); Elam (ID: `person:Elam`); Jônatas (ID: `person:Jonathan.9`); Hatus (ID: `person:Hattush.2`); Bebai (ID: `person:Bebai.2`); Bebai (ID: `person:Bebai`); Bigvai (ID: `person:Bigvai.2`); Parós (ID: `person:Parosh.2`); Hacatã (ID: `person:Hakkatan`); Fineias (ID: `person:Phinehas`); Itamar (ID: `person:Ithamar`); Babilônia (ID: `place:Babylon`); Davi (ID: `person:David`); Artaxerxes (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** Semaías (ID: `person:Shemaiah.15`); Mesulão (ID: `person:Meshullam.9`); Casifia (ID: `place:Casiphia`); Jaribe (ID: `person:Jarib.2`); Ariel (ID: `person:Ariel`); Elnatã (ID: `person:Elnathan.2`); Joiaribe (ID: `person:Joiarib.2`); Natã (ID: `person:Nathan.5`); Ido (ID: `person:Iddo`); Elnatã (ID: `person:Elnathan.4`); Zacarias (ID: `person:Zechariah.20`); Elnatã (ID: `person:Elnathan.3`); Eliezer (ID: `person:Eliezer.8`); SENHOR (ID: `deity:Lord`); perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Serebias (ID: `person:Sherebiah`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Levi (ID: `group:Levi`); Insight (ID: `keyterm:Insight`); Levi (ID: `person:Levi.3`); Mali (ID: `person:Mahli`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); Israel (ID: `person:Israel`); Egyptians (ID: `group:Egypt`); Moabe (ID: `place:Moab`); Canaã (ID: `place:Canaan`); Ammonites (ID: `group:Ammon`); Hete (ID: `person:Heth`); Levi (ID: `group:Levi`); Amom (ID: `place:Ammon`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `person:Levi.3`); Amorites (ID: `group:Amorites`); cananeu (ID: `group:Canaan`); Jebusites (ID: `group:Jebusites`); Egito (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); be unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); House (ID: `realia:House`); Harim (ID: `person:Harim`); offering (ID: `keyterm:Offering`); Judá (ID: `person:Judah.4`); Elam (ID: `person:Elam`); counsel (ID: `keyterm:Counsel`); Judá (ID: `group:Judah`); Matanias (ID: `person:Mattaniah.7`); Quelal (ID: `person:Chelal`); Natã (ID: `person:Nathan.6`); Elasa (ID: `person:Elasah`); Jezias (ID: `person:Izziah`); Jeiel (ID: `person:Jeiel.8`); Asael (ID: `person:Asahel.4`); Jaasai (ID: `person:Jaasu`); Maaséias (ID: `person:Maaseiah.7`); Selemias (ID: `person:Shelemiah.3`); Jozabade (ID: `person:Jozabad.7`); Petaías (ID: `person:Pethahiah.2`); Simei (ID: `person:Shimei.15`); Simeão (ID: `person:Shimeon`); Sabetai (ID: `person:Shabbethai`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); ardour (ID: `keyterm:Ardour`); Judeia (ID: `place:Judea`); Israel (ID: `person:Israel`); supplication (ID: `keyterm:Supplication`); defilement (ID: `keyterm:Defilement`); peace (ID: `keyterm:IntactState`); to cause to possess (ID: `keyterm:Possess`); dispossess (ID: `keyterm:Dispossess`); kindness (ID: `keyterm:Kindness`); Jerusalém (ID: `place:Jerusalem`); Pérsia (ID: `place:Persia`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** Jeiel (ID: `person:Jehiel.8`); Secanias (ID: `person:Shecaniah.7`); Israel (ID: `person:Israel`); Elam (ID: `person:Elam`); SENHOR (ID: `deity:Lord`); be unfaithful (ID: `keyterm:Unfaithful`); Ezra (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`); counsel (ID: `keyterm:Counsel`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); swear (ID: `keyterm:Swear`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Ezra (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Benjamim (ID: `group:Benjamin`); Judá (ID: `person:Judah.4`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`); Benjamim (ID: `person:Benjamin`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jazeías (ID: `person:Jahzeiah`); Mesulão (ID: `person:Meshullam.10`); Sabetai (ID: `person:Shabbethai`); Ticva (ID: `person:Tikvah.2`); Asael (ID: `person:Asahel.4`); Jônatas (ID: `person:Jonathan.10`); Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`)
