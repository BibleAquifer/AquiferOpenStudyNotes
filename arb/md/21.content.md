...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); أورشَلِيمَ (ID: `place:Jerusalem`); Intention (ID: `keyterm:Intention`); Stupid (ID: `keyterm:Stupid`); ٱلرَّبِّ (ID: `deity:Lord`); Vine (ID: `flora:Vine`); To Sin (ID: `keyterm:Sin`); إِسْرَائِيلَ (ID: `person:Israel`); Wine (ID: `realia:Wine`); Cattle (ID: `fauna:Bull`); Sandalwood (ID: `flora:Sandalwood`); Flock (ID: `fauna:Flock`); Money (ID: `realia:Money`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Cattle (ID: `fauna:Bull`); Sandalwood (ID: `flora:Sandalwood`); Flock (ID: `fauna:Flock`); Money (ID: `realia:Money`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); Cattle (ID: `fauna:Bull`); Sandalwood (ID: `flora:Sandalwood`); Flock (ID: `fauna:Flock`); Money (ID: `realia:Money`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Intention (ID: `keyterm:Intention`); ٱلرَّبِّ (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); To Sin (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Vow (ID: `keyterm:Vow`); House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Passion (ID: `keyterm:Ardour`); Slaughtering (ID: `keyterm:Slaughtering`); Strength (ID: `keyterm:Strength`); A Man (ID: `person:GenericMale`); Thread (ID: `realia:Thread`)
...
* **Associated ACAI Concepts:** Stupid (ID: `keyterm:Stupid`); Ability (ID: `keyterm:Ability`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); To Cause to Possess (ID: `keyterm:Possess`); To Sin (ID: `keyterm:Sin`); Intention (ID: `keyterm:Intention`); To Act Wickedly (ID: `keyterm:ActWickedly`); Brier (ID: `flora:Brier`); Cooking Pot (ID: `realia:CookingPot`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Strength (ID: `keyterm:Strength`); ٱلرَّبِّ (ID: `deity:Lord`); Hell (ID: `place:Hell`); Intention (ID: `keyterm:Intention`); Ability (ID: `keyterm:Ability`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); ٱلرَّبِّ (ID: `deity:Lord`); Caper (ID: `flora:Caper`); Locust (ID: `fauna:Locust`); Pit (ID: `realia:Pit`); Bird (ID: `fauna:Bird`); Rope (ID: `realia:Rope`); Money (ID: `realia:Money`); Almond (ID: `flora:Almond`); Clay Jar (ID: `realia:ClayJar`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Proverb (ID: `keyterm:Saying`); Straightness (ID: `keyterm:Straightness`); Intention (ID: `keyterm:Intention`); Truth (ID: `keyterm:Truth`); Goad (ID: `realia:Goad`); Sheep (ID: `fauna:Lamb`); Scroll (ID: `realia:Scroll`); Flock (ID: `fauna:Flock`); Nail (ID: `realia:Nail`); Goat (ID: `fauna:Goat`)
