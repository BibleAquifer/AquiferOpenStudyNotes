...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); tentar (ID: `keyterm:PutToTheTest`); bem, aventurado (ID: `keyterm:Happy`); amado (ID: `keyterm:Beloved`); inútil (ID: `keyterm:Worthless`); limpo (ID: `keyterm:Clean`); aprovado (ID: `keyterm:Approved`); Good (ID: `keyterm:Good`); coração (ID: `keyterm:Heart`); promessa (ID: `keyterm:Promise`); Ability (ID: `keyterm:Ability`); A Person (ID: `person:GenericPerson`); be (or show oneself) just (ID: `keyterm:Just`); Truth (ID: `keyterm:Truth`); To Sin (ID: `keyterm:Sin`); love (ID: `keyterm:Love`); lei (ID: `keyterm:Law`); Life (ID: `keyterm:Life`); sem mancha (ID: `keyterm:AboveCriticism`); salvation (ID: `keyterm:Salvation`); que não pode ser tentado (ID: `keyterm:NotTempted`); sem mancha (ID: `keyterm:Undefiled`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** inútil (ID: `keyterm:Worthless`); limpo (ID: `keyterm:Clean`); SENHOR (ID: `deity:Lord`); coração (ID: `keyterm:Heart`); sem mancha (ID: `keyterm:Undefiled`); Ability (ID: `keyterm:Ability`); sem mancha (ID: `keyterm:AboveCriticism`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); favoritismo (ID: `keyterm:Partiality`); Glory (ID: `keyterm:Glory`); Jesus (ID: `person:Jesus.2`); distinguir (ID: `keyterm:Discern`); crer (ID: `keyterm:Believe`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); promessa (ID: `keyterm:Promise`); escolhido (ID: `keyterm:Chosen`); Ability (ID: `keyterm:Ability`); love (ID: `keyterm:Love`); reino (ID: `keyterm:Kingdom`); amado (ID: `keyterm:Beloved`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); favoritismo (ID: `keyterm:Partiality`); tropeçar (ID: `keyterm:Stumble`); juízo (ID: `keyterm:Judgment`); inclemente (ID: `keyterm:Merciless`); love (ID: `keyterm:Love`); fornication (ID: `keyterm:Fornication`); decidir (ID: `keyterm:Decided`); escritura (ID: `keyterm:Scripture`); tribunal de justiça (ID: `keyterm:CourtCase`); misericórdia (ID: `keyterm:Mercy`); To Sin (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** juízo (ID: `keyterm:Judgment`); inclemente (ID: `keyterm:Merciless`); misericórdia (ID: `keyterm:Mercy`); tribunal de justiça (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); A Person (ID: `person:GenericPerson`); Abraão (ID: `person:Abraham`); Raabe (ID: `person:Rahab`); inútil (ID: `keyterm:Idle`); Spirit (ID: `keyterm:Spirit.2`); Demons (ID: `deity:Demons`); fazer a paz (ID: `keyterm:Peace`); salvation (ID: `keyterm:Salvation`); An Angel (ID: `deity:Angel`); To Cause to Happen (ID: `keyterm:Happen`); escritura (ID: `keyterm:Scripture`); Isaque (ID: `person:Isaac`); vazio (ID: `keyterm:Empty`)
...
* **Associated ACAI Concepts:** A Person (ID: `person:GenericPerson`); corpo (ID: `keyterm:Body.3`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); Abraão (ID: `person:Abraham`); Raabe (ID: `person:Rahab`); inútil (ID: `keyterm:Idle`); SENHOR (ID: `deity:Lord`); Spirit (ID: `keyterm:Spirit.2`); corpo (ID: `keyterm:Body.3`); An Angel (ID: `deity:Angel`); To Cause to Happen (ID: `keyterm:Happen`); escritura (ID: `keyterm:Scripture`); Isaque (ID: `person:Isaac`); vazio (ID: `keyterm:Empty`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); escritura (ID: `keyterm:Scripture`); be (or show oneself) just (ID: `keyterm:Just`); Abraão (ID: `person:Abraham`); crer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** geena (ID: `keyterm:Gehenna`); Hell (ID: `place:Hell`); Ability (ID: `keyterm:Ability`); corpo (ID: `keyterm:Body.3`); injustiça (ID: `keyterm:UnjustDeed`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); amizade (ID: `keyterm:Friendship`); be unfaithful (ID: `keyterm:Unfaithful`); Holy Spirit (ID: `deity:HolySpirit`); Spirit (ID: `keyterm:Spirit.2`); coração (ID: `keyterm:Heart`); pure (ID: `keyterm:Pure`); Ability (ID: `keyterm:Ability`); desejar (ID: `keyterm:LongFor`); escritura (ID: `keyterm:Scripture`); favor (ID: `keyterm:Favor`); To Cleanse (ID: `keyterm:Cleanse.2`); Cause of Joy (ID: `keyterm:CauseOfJoy`)
...
* **Associated ACAI Concepts:** coração (ID: `keyterm:Heart`); pure (ID: `keyterm:Pure`); SENHOR (ID: `deity:Lord`); To Cleanse (ID: `keyterm:Cleanse.2`)
...
* **Associated ACAI Concepts:** coração (ID: `keyterm:Heart`); testemunhar (ID: `keyterm:BearWitness`); SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); condenar (ID: `keyterm:Condemn`); be (or show oneself) just (ID: `keyterm:Just`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); anointed (ID: `keyterm:Anointed`); Name (ID: `keyterm:Name`); orar (ID: `keyterm:Pray`); igreja (ID: `keyterm:Church`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); orar (ID: `keyterm:Pray`); salvation (ID: `keyterm:Salvation`); crer (ID: `keyterm:Believe`)
