...
* **Associated ACAI Concepts:** فَارِسَ (ID: `place:Persia`); كورَشَ (ID: `person:Cyrus`); إِرْمِيَا (ID: `person:Jeremiah.6`); ٱلرَّبِّ (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); ٱلرَّبِّ (ID: `deity:Lord`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); إِرْمِيَا (ID: `person:Jeremiah.6`); Word of the Lord (ID: `keyterm:WordOfTheLord`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `person:Benjamin`); بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `person:Judah.4`); لَّاوِي (ID: `group:Levi`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `person:Levi.3`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); كورَشَ (ID: `person:Cyrus`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath`); فَارِسَ (ID: `place:Persia`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `group:Judah`); كورَشَ (ID: `person:Cyrus`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Money (ID: `realia:Money`); بَابِلَ (ID: `place:Babylon`); أورشَلِيمَ (ID: `place:Jerusalem`); زَربَّابِل (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); سلَيْمَانَ (ID: `person:Solomon`); لَّاوِي (ID: `person:Levi.3`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `group:Levi`); أَسْنَةَ (ID: `person:Asnah`); نَقودَا (ID: `person:Nekoda`); نَحَمْيَا (ID: `person:Nehemiah`); دَرْقونَ (ID: `person:Darkon`); رَعْلَايَا (ID: `person:Reelaiah`); نَصِيحَ (ID: `person:Neziah`); لِدَلَايَا (ID: `person:Delaiah.3`); حَاجَابَ (ID: `person:Hagab`); كَروب (ID: `place:Cherub`); Meunim (ID: `group:Meunim`); يَشوعَ (ID: `person:Jeshua.3`); يورَةَ (ID: `person:Jorah`); حَرْشَا (ID: `person:Harsha`); بَرْقوسَ (ID: `person:Barkos`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); حَطِيطَا (ID: `person:Hatita`); فِي (ID: `person:Uzza.2`); لِإِيمِيرَ (ID: `person:Immer.2`); يَشوعَ (ID: `person:Jeshua`); حَشوم (ID: `person:Hashum`); لَبَانَةَ (ID: `person:Lebanah`); بَابَايَ (ID: `person:Bebai`); مَغْبِيشَ (ID: `place:Magbish`); سوفَرَثَ (ID: `person:Sophereth`)
...
* **Associated ACAI Concepts:** رَعْلَايَا (ID: `person:Reelaiah`); بِغْوَايَ (ID: `person:Bigvai`); سَرَايَا (ID: `person:Seraiah.6`); بَعْنَةَ (ID: `person:Baanah.3`); رَحوم (ID: `person:Rehum`); مِسْفَار (ID: `person:Mispar`); مرْدَخَاي (ID: `person:Mordecai`); بِلْشَان (ID: `person:Bilshan`); نَحَمْيَا (ID: `person:Nehemiah`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** عَادِينَ (ID: `person:Adin`); زَتّو (ID: `person:Zattu.2`); عِيلَامَ (ID: `person:Elam`); حَزَقِيَّا (ID: `person:Hezekiah.2`); يَشوعَ (ID: `person:Jeshua.3`); يورَةَ (ID: `person:Jorah`); بِيصَايَ (ID: `person:Bezai`); زَكَّايَ (ID: `person:Zaccai.2`); أَدونِيقَامَ (ID: `person:Adonikam`); شَفَطْيَا (ID: `person:Shephatiah.6`); آرَحَ (ID: `person:Arah.2`); يوآب (ID: `person:Joab.3`); فَرْعوشَ (ID: `person:Parosh`); آطِيرَ (ID: `person:Ater`); حَشوم (ID: `person:Hashum`); Pahath-moab (ID: `person:Pahath-moab`); بَابَايَ (ID: `person:Bebai`); بَانِيَ (ID: `person:Bani`); عَرْجَدَ (ID: `person:Azgad`); بِغْوَايَ (ID: `person:Bigvai.2`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** حَارِيمَ (ID: `person:Harim.2`); Beth-azmaveth (ID: `place:Beth-azmaveth`); حَادِيدَ (ID: `place:Hadid`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); مَغْبِيشَ (ID: `place:Magbish`); سَنَاءَةَ (ID: `place:Senaah`); نَبو (ID: `place:Nebo.2`); وَلودَ (ID: `place:Lod`); ٱلْكَفِيرَة (ID: `place:Chephirah`); عِيلَامَ (ID: `person:Elam`); أونوَ (ID: `place:Ono`); مِخْمَاسَ (ID: `place:Michmash`); أَرِيحَا (ID: `place:Jericho`); عَايٍ (ID: `place:Ai`); Bethel (ID: `place:Bethel`); بَئِيروت (ID: `place:Beeroth`); عَنَاثوثَ (ID: `place:Anathoth`); مِنْ (ID: `place:Geba`); Ramah (ID: `place:Ramah.2`); Kiriath-jearim (ID: `place:Kiriath-jearim`); لَحْمٍ (ID: `place:Bethlehem`)
...
* **Associated ACAI Concepts:** يَشوعَ (ID: `person:Jeshua`); طَلْمون (ID: `person:Talmon`); حَطِيطَا (ID: `person:Hatita`); آطِيرَ (ID: `person:Ater.2`); لِإِيمِيرَ (ID: `person:Immer.2`); شوبَايَ (ID: `person:Shobai`); يَشوعَ (ID: `person:Jeshua.4`); يَدَايَا (ID: `person:Jedaiah.4`); هودَوْيَا (ID: `person:Hodaviah.4`); حَارِيمَ (ID: `person:Harim`); شَلّوم (ID: `person:Shallum.8`); عَقّوب (ID: `person:Akkub.2`); فَشْحور (ID: `person:Pashhur`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); آسَاف (ID: `person:Asaph.2`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** طَلْمون (ID: `person:Talmon`); حَطِيطَا (ID: `person:Hatita`); آطِيرَ (ID: `person:Ater.2`); شوبَايَ (ID: `person:Shobai`); شَلّوم (ID: `person:Shallum.8`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** جَدِّيلَ (ID: `person:Giddel`); أَسْنَةَ (ID: `person:Asnah`); مَحِيدَا (ID: `person:Mehida`); قِيروسَ (ID: `person:Keros`); فَادونَ (ID: `person:Padon`); حَطِيفَا (ID: `person:Hatipha`); نَقودَا (ID: `person:Nekoda`); سِيسَرَا (ID: `person:Sisera.2`); حَانَان (ID: `person:Hanan.4`); طَبَاعوتَ (ID: `person:Tabbaoth`); جَزَّامَ (ID: `person:Gazzam`); نَصِيحَ (ID: `person:Neziah`); حَسوفَا (ID: `person:Hasupha`); سَلْمَايَ (ID: `person:Shalmai`); رَصِينَ (ID: `person:Rezin.2`); حَاجَابَ (ID: `person:Hagab`); Meunim (ID: `group:Meunim`); حَقوفَا (ID: `person:Hakupha`); فَاسِيحَ (ID: `person:Paseah.2`); بِيسَايَ (ID: `person:Besai`); حَرْشَا (ID: `person:Harsha`); بَرْقوسَ (ID: `person:Barkos`); فِي (ID: `person:Uzza.2`); بَصْلوتَ (ID: `person:Bazluth`); ثَامَحَ (ID: `person:Temah`); Nephushesim (ID: `group:Nephushesim`); بَقْبوقَ (ID: `person:Bakbuk`); سِيعَهَا (ID: `person:Siaha`); صِيحَا (ID: `person:Ziha`); لَبَانَةَ (ID: `person:Lebanah`); حَرْحورَ (ID: `person:Harhur`); رَآيَا (ID: `person:Reaiah.3`); حَجَابَةَ (ID: `person:Hagabah`); عَقّوب (ID: `person:Akkub.3`); جَاحَرَ (ID: `person:Gahar`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); شَفَطْيَا (ID: `person:Shephatiah.7`); سوفَرَثَ (ID: `person:Sophereth`); فَرودَا (ID: `person:Peruda`); حَطِّيلَ (ID: `person:Hattil`); آمِي (ID: `person:Ami`); سَوْطَايَ (ID: `person:Sotai`); جَدِّيلَ (ID: `person:Giddel.2`); دَرْقونَ (ID: `person:Darkon`); يَعْلَةَ (ID: `person:Jaalah`)
...
* **Associated ACAI Concepts:** Tel-harsha (ID: `place:Tel-harsha`); لِدَلَايَا (ID: `person:Delaiah.3`); نَقودَا (ID: `person:Nekoda.2`); طوبِيَّا (ID: `person:Tobiah`); كَروب (ID: `place:Cherub`); أَدَّان (ID: `place:Addan`); لِإِيمِيرَ (ID: `place:Immer`); Tel-melah (ID: `place:Tel-melah`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** بَرْزِلَّايَ (ID: `person:Barzillai.3`); حَبَايَا (ID: `person:Habaiah`); هَقّوصَ (ID: `person:Hakkoz.2`); Defile (ID: `keyterm:Stain`); جِلْعَادَ (ID: `place:Gilead`); بَرْزِلَّايَ (ID: `person:Barzillai`); Priesthood (ID: `keyterm:Priesthood`); Gileadites (ID: `group:Gilead`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); Strength (ID: `keyterm:Strength`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); Mina (ID: `realia:Mina`); Money (ID: `realia:Money`); Tunic (ID: `realia:Tunic`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); يَشوع (ID: `person:Joshua.5`); فَارِسَ (ID: `place:Persia`); كورَشَ (ID: `person:Cyrus`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); يَشوعَ (ID: `person:Jeshua.4`); Relatives (ID: `group:Relatives`); Esarhaddon (ID: `person:Esarhaddon`); حِينَادَادَ (ID: `person:Henadad`); هودَوْيَا (ID: `person:Hodaviah.4`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); Instruction (ID: `keyterm:Instruction`); دَارِيوسَ (ID: `person:Darius.2`); Terror (ID: `keyterm:Terror`); Tyrians (ID: `group:Tyre`); صِيْدونَ (ID: `place:Sidon`); Kindness (ID: `keyterm:Kindness`); New Moon Festival (ID: `keyterm:NewMoonFestival`); بَنْيَامِينَ (ID: `group:Benjamin`); هودِيَّا (ID: `person:Hodiah.2`); Assyria (ID: `place:Assyria`); لبْنَانَ (ID: `place:Lebanon`); دَاودَ (ID: `person:David`); Counsel (ID: `keyterm:Counsel`); Appointed Feast (ID: `keyterm:AppointedFeast`); يَافَا (ID: `place:Joppa`); آسَاف (ID: `person:Asaph.2`); صورَ (ID: `place:Tyre`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); موسَى (ID: `person:Moses`); Holy (ID: `keyterm:Holy`); بَنْيَامِينَ (ID: `person:Benjamin`); Sidonians (ID: `group:Sidon`); Anointing Oil (ID: `realia:AnointingOil`); Cedar (ID: `flora:Cedar`); Cymbals (ID: `realia:Cymbals`); Olive Oil (ID: `realia:OliveOil`); Craftsman (ID: `realia:Craftsman`); Trumpet (ID: `realia:Trumpet`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَشوع (ID: `person:Joshua.5`); Instruction (ID: `keyterm:Instruction`); موسَى (ID: `person:Moses`); ٱلرَّبِّ (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Terror (ID: `keyterm:Terror`); Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** فَارِسَ (ID: `place:Persia`); لبْنَانَ (ID: `place:Lebanon`); Tyrians (ID: `group:Tyre`); يَافَا (ID: `place:Joppa`); صِيْدونَ (ID: `place:Sidon`); كورَشَ (ID: `person:Cyrus`); Sidonians (ID: `group:Sidon`); صورَ (ID: `place:Tyre`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Cedar (ID: `flora:Cedar`); Craftsman (ID: `realia:Craftsman`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `group:Levi`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); يَشوع (ID: `person:Joshua.5`); لَّاوِي (ID: `person:Levi.3`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Kindness (ID: `keyterm:Kindness`); آسَاف (ID: `person:Asaph.2`); لَّاوِي (ID: `group:Levi`); دَاودَ (ID: `person:David`); لَّاوِي (ID: `person:Levi.3`); House (ID: `realia:House`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `person:Benjamin`); بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); فَارِسَ (ID: `place:Persia`); زَربَّابِل (ID: `person:Zerubbabel.2`); ٱلرَّبِّ (ID: `deity:Lord`); كورَشَ (ID: `person:Cyrus`); يَشوع (ID: `person:Joshua.5`); إِسْرَائِيلَ (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** فَارِسَ (ID: `place:Persia`); كورَشَ (ID: `person:Cyrus`); Counsel (ID: `keyterm:Counsel`); دَارِيوسَ (ID: `person:Darius.2`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); ٱلْفرَاتِ (ID: `place:Euphrates`); شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); فَارِسَ (ID: `place:Persia`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Jews (ID: `group:Jews`); أَرَكَ (ID: `place:Erech`); طَبْئِيل (ID: `person:Tabeel`); Babylonians (ID: `group:Babylon`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); أسْنَفَّر (ID: `person:Osnappar`); بِشْلَام (ID: `person:Bishlam`); مِثْرَدَاث (ID: `person:Mithredath.2`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); Persians (ID: `group:Persia`); Elamites (ID: `group:Elam`); بَابِلَ (ID: `place:Babylon`); عِيلَامَ (ID: `place:Elam`); فِي (ID: `place:Susa`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** طَبْئِيل (ID: `person:Tabeel`); بِشْلَام (ID: `person:Bishlam`); مِثْرَدَاث (ID: `person:Mithredath.2`); فَارِسَ (ID: `place:Persia`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`)
...
* **Associated ACAI Concepts:** أَرَكَ (ID: `place:Erech`); Babylonians (ID: `group:Babylon`); شِمْشَاي (ID: `person:Shimshai`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); رَحوم (ID: `person:Rehum.2`); فَارِسَ (ID: `place:Persia`); Persians (ID: `group:Persia`); فِي (ID: `place:Susa`); Elamites (ID: `group:Elam`); بَابِلَ (ID: `place:Babylon`); عِيلَامَ (ID: `place:Elam`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); Jews (ID: `group:Jews`); ٱلسَّامِرَةِ (ID: `place:Samaria`); شِمْشَاي (ID: `person:Shimshai`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); رَحوم (ID: `person:Rehum.2`); Scroll (ID: `realia:Scroll`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); دَارِيوسَ (ID: `person:Darius.2`); Jews (ID: `group:Jews`); تَتْنَاي (ID: `person:Tattenai`); زَكَرِيَّا (ID: `person:Zechariah.17`); حَجَّيِ (ID: `person:Haggai`); يَدّو (ID: `person:Iddo.6`); Shethar-bozenai (ID: `person:Shethar-bozenai`); فَارِسَ (ID: `place:Persia`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); ٱلْفرَاتِ (ID: `place:Euphrates`); يَهوذَا (ID: `person:Judah.4`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَشوع (ID: `person:Joshua.5`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** زَكَرِيَّا (ID: `person:Zechariah.17`); حَجَّيِ (ID: `person:Haggai`); يَدّو (ID: `person:Iddo.6`); Jews (ID: `group:Jews`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); يَشوع (ID: `person:Joshua.5`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); بَابِلَ (ID: `place:Babylon`); أورشَلِيمَ (ID: `place:Jerusalem`); كورَشَ (ID: `person:Cyrus`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); دَارِيوسَ (ID: `person:Darius.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); تَتْنَاي (ID: `person:Tattenai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Chaldeans (ID: `group:Chaldea`); ٱلْفرَاتِ (ID: `place:Euphrates`); يَهوذَا (ID: `person:Judah.4`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); إِسْرَائِيلَ (ID: `person:Israel`); Foundation (ID: `realia:Foundation`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); بَابِلَ (ID: `place:Babylon`); Chaldeans (ID: `group:Chaldea`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); زَربَّابِل (ID: `person:Zerubbabel.2`); كورَشَ (ID: `person:Cyrus`); بَابِلَ (ID: `place:Babylon`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** موسَى (ID: `person:Moses`); لَّاوِي (ID: `group:Levi`); أورشَلِيمَ (ID: `place:Jerusalem`); لَّاوِي (ID: `person:Levi.3`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Defilement (ID: `keyterm:Defilement`); ٱلرَّبِّ (ID: `deity:Lord`); Gentiles (ID: `group:Gentile`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** عَزَرْيَا (ID: `person:Azariah.7`); عَزْرَا (ID: `person:Ezra`); سَرَايَا (ID: `person:Seraiah.2`); فَارِسَ (ID: `place:Persia`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); حِلْقِيَّا (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); أَخِيطوبَ (ID: `person:Ahitub.3`); صَادوق (ID: `person:Zadok.4`); عَزَرْيَا (ID: `person:Azariah.7`); أَبِيشوعَ (ID: `person:Abishua`); لِمَرَايوثَ (ID: `person:Meraioth`); شَلّوم (ID: `person:Shallum.7`); عَزَرْيَا (ID: `person:Azariah.6`); أَمَرْيَا (ID: `person:Amariah.2`); بقِّي (ID: `person:Bukki.2`); زَرَحْيَا (ID: `person:Zerahiah`); عزِّي (ID: `person:Uzzi`); سَرَايَا (ID: `person:Seraiah.2`); فَارِسَ (ID: `place:Persia`); فِينَحَاس (ID: `person:Phinehas`); أَلِعَازَار (ID: `person:Eleazar.2`); هَارون (ID: `person:Aaron`); حِلْقِيَّا (ID: `person:Hilkiah.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); Instruction (ID: `keyterm:Instruction`); موسَى (ID: `person:Moses`); بَابِلَ (ID: `place:Babylon`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); عَزْرَا (ID: `person:Ezra`); Decree (ID: `keyterm:Decree`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); عَزْرَا (ID: `person:Ezra`); ٱلْفرَاتِ (ID: `place:Euphrates`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Talent (ID: `realia:Talent`); Anointing Oil (ID: `realia:AnointingOil`); Kor (ID: `realia:Kor`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** شَلومِيَةَ (ID: `person:Shelomith.4`); زَكَرِيَّا (ID: `person:Zechariah.19`); زَكَرِيَّا (ID: `person:Zechariah.18`); عوبَدْيَا (ID: `person:Obadiah.10`); زَرَحْيَا (ID: `person:Zerahiah.2`); يوشَفْيَا (ID: `person:Josiphiah`); شِمْعِيَا (ID: `person:Shemaiah.14`); عَادِينَ (ID: `person:Adin`); يِشْعِيَا (ID: `person:Jeshaiah.4`); عَثَلْيَا (ID: `person:Athaliah.3`); عِيلَامَ (ID: `person:Elam`); يوآب (ID: `person:Joab.4`); Gershom (ID: `person:Gershom.2`); عَابِد (ID: `person:Ebed.2`); حَطّوش (ID: `person:Hattush.2`); شَكَنْيَا (ID: `person:Shecaniah.5`); يَعِيئِيل (ID: `person:Jeuel.3`); زَكّور (ID: `person:Zaccur.5`); أَدونِيقَامَ (ID: `person:Adonikam`); شَفَطْيَا (ID: `person:Shephatiah.6`); فَرْعوشَ (ID: `person:Parosh.2`); يَحِيئِيل (ID: `person:Jehiel.7`); أَلِيفَلَط (ID: `person:Eliphelet.5`); شَكَنْيَا (ID: `person:Shecaniah.6`); زَبَدْيَا (ID: `person:Zebadiah.8`); هِقَّاطَانَ (ID: `person:Hakkatan`); مِيخَائِيلَ (ID: `person:Michael.10`); بَابَايَ (ID: `person:Bebai.2`); عوتَاي (ID: `person:Uthai.2`); يوحَانَانَ (ID: `person:Johanan.8`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); يونَاثَانَ (ID: `person:Jonathan.9`); بَابَايَ (ID: `person:Bebai`); Pahath-moab (ID: `person:Pahath-moab`); دَانِيآل (ID: `person:Daniel.2`); عَرْجَدَ (ID: `person:Azgad`); يَحْزِيئِيل (ID: `person:Jahaziel.5`); بِغْوَايَ (ID: `person:Bigvai.2`); فِينَحَاس (ID: `person:Phinehas`); بَابِلَ (ID: `place:Babylon`); دَاودَ (ID: `person:David`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); إِيثَامَارَ (ID: `person:Ithamar`)
...
* **Associated ACAI Concepts:** أَلْنَاثَانَ (ID: `person:Elnathan.2`); يَدّو (ID: `person:Iddo`); زَكَرِيَّا (ID: `person:Zechariah.20`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); ٱلْمسَمَّى (ID: `place:Casiphia`); أَلِيعَزَرَ (ID: `person:Eliezer.8`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); شِمْعِيَا (ID: `person:Shemaiah.15`); يويَارِيبَ (ID: `person:Joiarib.2`); أَرِيئِيلَ (ID: `person:Ariel`); يَارِيبَ (ID: `person:Jarib.2`); نَاثَان (ID: `person:Nathan.5`); مَشلَّام (ID: `person:Meshullam.9`); ٱلرَّبِّ (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); مَحْلِي (ID: `person:Mahli`); Insight (ID: `keyterm:Insight`); لَّاوِي (ID: `group:Levi`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `person:Levi.3`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `group:Levi`); دَاودَ (ID: `person:David`); لَّاوِي (ID: `person:Levi.3`); Work (ID: `keyterm:Work`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); كَنْعَان (ID: `place:Canaan`); Ammonites (ID: `group:Ammon`); Amorites (ID: `group:Amorites`); Egyptians (ID: `group:Egypt`); مِصْرَ (ID: `place:Egypt`); Be Unfaithful (ID: `keyterm:Unfaithful`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); Canaanites (ID: `group:Canaan`); حِثًّا (ID: `person:Heth`); لَّاوِي (ID: `group:Levi`); موآبَ (ID: `place:Moab`); Jebusites (ID: `group:Jebusites`); لَّاوِي (ID: `person:Levi.3`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Passion (ID: `keyterm:Ardour`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); Offering (ID: `keyterm:Offering`); يَهوذَا (ID: `group:Judah`); عِيلَامَ (ID: `person:Elam`); Counsel (ID: `keyterm:Counsel`); يَهوذَا (ID: `person:Judah.4`); يَاشوب (ID: `person:Jashub.2`); زَبَدْيَا (ID: `person:Zebadiah.9`); ويَرِيمَاي (ID: `person:Jeremai`); أَلِيعَزَرَ (ID: `person:Eliezer.10`); أَلِيعَزَرَ (ID: `person:Eliezer.9`); يوزَابَاد (ID: `person:Jozabad.8`); يِشِّيَّا (ID: `person:Isshijah`); شَلّوم (ID: `person:Shallum.10`); مَتَّثْيَا (ID: `person:Mattithiah.3`); Kelaiah (ID: `person:Kelaiah`); شَلَمْيَا (ID: `person:Shelemiah.2`); شِمْعِي (ID: `person:Shimei.15`); يوزَابَاد (ID: `person:Jozabad.7`); عَزَرْئِيل (ID: `person:Azarel.4`); شَكَنْيَا (ID: `person:Shecaniah.7`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); فَارِسَ (ID: `place:Persia`); Plea for Mercy (ID: `keyterm:Supplication`); Kindness (ID: `keyterm:Kindness`); Peace (ID: `keyterm:IntactState`); Defilement (ID: `keyterm:Defilement`); Dispossess (ID: `keyterm:Dispossess`); To Cause to Possess (ID: `keyterm:Possess`); أورشَلِيمَ (ID: `place:Jerusalem`); إِسْرَائِيلَ (ID: `person:Israel`); Peg (ID: `realia:Peg`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); فَارِسَ (ID: `place:Persia`); Plea for Mercy (ID: `keyterm:Supplication`); Kindness (ID: `keyterm:Kindness`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Peg (ID: `realia:Peg.2`); Peg (ID: `realia:Peg`)
...
* **Associated ACAI Concepts:** يَحِيئِيل (ID: `person:Jehiel.8`); شَكَنْيَا (ID: `person:Shecaniah.7`); عِيلَامَ (ID: `person:Elam`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Counsel (ID: `keyterm:Counsel`); Instruction (ID: `keyterm:Instruction`); ٱلرَّبِّ (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** Swear (ID: `keyterm:Swear`); عَزْرَا (ID: `person:Ezra`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `person:Benjamin`); بَنْيَامِينَ (ID: `group:Benjamin`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** عَسَائِيل (ID: `person:Asahel.4`); مَشلَّام (ID: `person:Meshullam.10`); يَحْزِيَا (ID: `person:Jahzeiah`); يونَاثَانَ (ID: `person:Jonathan.10`); تِقْوَةَ (ID: `person:Tikvah.2`); شَبْتَاي (ID: `person:Shabbethai`); لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`)
