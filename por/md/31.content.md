...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Judá (ID: `person:Judah.4`); lot (ID: `keyterm:Lot`); Jerusalém (ID: `place:Jerusalem`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`); Edomites (ID: `group:Edom`); José (ID: `person:Joseph.10`); Edom (ID: `place:Edom`); Jerusalém (ID: `place:Jerusalem`); dispossess (ID: `keyterm:Dispossess`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Edomites (ID: `group:Edom`); SENHOR (ID: `deity:Lord`); José (ID: `person:Joseph.10`); Edom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Israel (ID: `person:Israel`); Sardes (ID: `place:Sardis`); Canaã (ID: `place:Canaan`); Efraim (ID: `group:Ephraim`); Sefalá (ID: `place:Shephelah`); Efraim (ID: `person:Ephraim`); Filístia (ID: `place:Philistine`); Gileade (ID: `place:Gilead`); Benjamim (ID: `group:Benjamin`); Samaria (ID: `place:Samaria`); Filisteu (ID: `group:Philistine`); Monte de Esaú (ID: `place:EsauMount`); Benjamim (ID: `person:Benjamin`); cananeu (ID: `group:Canaan`); Jerusalém (ID: `place:Jerusalem`); Sarepta (ID: `place:Zarephath`)
...
* **Associated ACAI Concepts:** Monte de Esaú (ID: `place:EsauMount`); Jerusalém (ID: `place:Jerusalem`); Neguebe (ID: `place:Negeb`); dispossess (ID: `keyterm:Dispossess`); Israel (ID: `person:Israel`); Canaã (ID: `place:Canaan`); Efraim (ID: `group:Ephraim`); SENHOR (ID: `deity:Lord`); Efraim (ID: `person:Ephraim`); Filístia (ID: `place:Philistine`); Sardes (ID: `place:Sardis`); Filisteu (ID: `group:Philistine`); Benjamim (ID: `person:Benjamin`); Samaria (ID: `place:Samaria`); Sefalá (ID: `place:Shephelah`); Benjamim (ID: `group:Benjamin`); Sarepta (ID: `place:Zarephath`); Gileade (ID: `place:Gilead`); cananeu (ID: `group:Canaan`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Sardes (ID: `place:Sardis`); Canaã (ID: `place:Canaan`); cananeu (ID: `group:Canaan`); Neguebe (ID: `place:Negeb`); Jerusalém (ID: `place:Jerusalem`); dispossess (ID: `keyterm:Dispossess`); Sarepta (ID: `place:Zarephath`)
