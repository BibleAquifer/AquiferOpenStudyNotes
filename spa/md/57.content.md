...
* **Associated ACAI Concepts:** Filemón (ID: `person:Philemon`); amado (ID: `keyterm:Beloved`); Timoteo (ID: `person:Timothy`); Pablo (ID: `person:Paul`); Jesús (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Archîpo (ID: `person:Archippus`); Filemón (ID: `person:Philemon`); Apphia (ID: `person:Apphia`); iglesia (ID: `keyterm:Church`); Jehová (ID: `deity:Lord`); amado (ID: `keyterm:Beloved`); Timoteo (ID: `person:Timothy`); hacer la paz (ID: `keyterm:Peace`); favor (ID: `keyterm:Favor`); Pablo (ID: `person:Paul`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** creer (ID: `keyterm:Believe`); santo (ID: `keyterm:Holy`); amar (ID: `keyterm:Love`); Jesús (ID: `person:Jesus.2`); Good (ID: `keyterm:Good`); comunión (ID: `keyterm:Fellowship`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Jehová (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); orar (ID: `keyterm:Pray`); entrañas (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Lucas (ID: `person:Luke`); Demas (ID: `person:Demas`); Epafras (ID: `person:Epaphras`); Aristarco (ID: `person:Aristarchus`); cristo (ID: `keyterm:InChrist`); Marcos (ID: `person:Mark`); favor (ID: `keyterm:Favor`); espíritu (ID: `keyterm:Spirit.2`)
