...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Carmelo (ID: `place:Carmel`); Zealous (ID: `keyterm:Zealous.3`); strength (ID: `keyterm:Strength`); Basã (ID: `place:Bashan`); Libano (ID: `place:Lebanon`); pronounce innocent (ID: `keyterm:PronounceInnocent`); The Way (ID: `keyterm:TheWay`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Carmelo (ID: `place:Carmel`); wickedness (ID: `keyterm:Wickedness`); Zealous (ID: `keyterm:Zealous.3`); strength (ID: `keyterm:Strength`); Basã (ID: `place:Bashan`); Libano (ID: `place:Lebanon`); pronounce innocent (ID: `keyterm:PronounceInnocent`); The Way (ID: `keyterm:TheWay`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Fortress (ID: `realia:Fortress`); Strong Drink (ID: `realia:StrongDrink`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** wickedness (ID: `keyterm:Wickedness`); peace (ID: `keyterm:IntactState`); Judá (ID: `person:Judah.4`); make a vow (ID: `keyterm:Vow`); Judá (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Líbia (ID: `place:Libya`); Egito (ID: `place:Egypt`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Pute (ID: `place:Put`); Cush (ID: `place:Cush.2`); lot (ID: `keyterm:Lot`)
