...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Carmelo (ID: `place:Carmel`); Basã (ID: `place:Bashan`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Zealous (ID: `keyterm:Zealous.3`); The Way (ID: `keyterm:TheWay`); strength (ID: `keyterm:Strength`); Libano (ID: `place:Lebanon`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Carmelo (ID: `place:Carmel`); Basã (ID: `place:Bashan`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Zealous (ID: `keyterm:Zealous.3`); The Way (ID: `keyterm:TheWay`); strength (ID: `keyterm:Strength`); Libano (ID: `place:Lebanon`); wickedness (ID: `keyterm:Wickedness`); Strong Drink (ID: `realia:StrongDrink`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** strength (ID: `keyterm:Strength`); SENHOR (ID: `deity:Lord`); pronounce innocent (ID: `keyterm:PronounceInnocent`); The Way (ID: `keyterm:TheWay`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); wickedness (ID: `keyterm:Wickedness`); Strong Drink (ID: `realia:StrongDrink`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** peace (ID: `keyterm:IntactState`); Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); make a vow (ID: `keyterm:Vow`); wickedness (ID: `keyterm:Wickedness`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); SENHOR (ID: `deity:Lord`); Flock (ID: `fauna:Flock`); Chariot (ID: `realia:Chariot`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Egito (ID: `place:Egypt`); Pute (ID: `place:Put`); Líbia (ID: `place:Libya`); Cush (ID: `place:Cush.2`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); lot (ID: `keyterm:Lot`)
