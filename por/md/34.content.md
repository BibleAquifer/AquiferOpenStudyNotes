...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Libano (ID: `place:Lebanon`); Basã (ID: `place:Bashan`); Carmelo (ID: `place:Carmel`); strength (ID: `keyterm:Strength`); The Way (ID: `keyterm:TheWay`); pronounce innocent (ID: `keyterm:PronounceInnocent`); Zealous (ID: `keyterm:Zealous.3`)
...
* **Associated ACAI Concepts:** Judá (ID: `group:Judah`); Judá (ID: `person:Judah.4`); make a vow (ID: `keyterm:Vow`); wickedness (ID: `keyterm:Wickedness`); peace (ID: `keyterm:IntactState`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); SENHOR (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Flock (ID: `fauna:Flock`); Grass (ID: `flora:Grass`); Chariot (ID: `realia:Chariot`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** lot (ID: `keyterm:Lot`); Líbia (ID: `place:Libya`); Pute (ID: `place:Put`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Egito (ID: `place:Egypt`); Cush (ID: `place:Cush.2`)
