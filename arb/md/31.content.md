...
* **Associated ACAI Concepts:** Peace (ID: `keyterm:IntactState`); أَدومَ (ID: `place:Edom`); Edomites (ID: `group:Edom`); Covenant (ID: `keyterm:Covenant`); Understanding (ID: `keyterm:Understanding`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); Lot (ID: `keyterm:Lot`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); أَدومَ (ID: `place:Edom`); Edomites (ID: `group:Edom`); Dispossess (ID: `keyterm:Dispossess`); يوسف (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); أَدومَ (ID: `place:Edom`); Edomites (ID: `group:Edom`); يوسف (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); ٱلْجَنوبِ (ID: `place:Negeb`); بَنْيَامِينَ (ID: `person:Benjamin`); كَنْعَان (ID: `place:Canaan`); عِيسو (ID: `place:EsauMount`); بَنْيَامِينَ (ID: `group:Benjamin`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); سَارْدِسَ (ID: `place:Sardis`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); جِلْعَادَ (ID: `place:Gilead`); ٱلسَّهْلِ (ID: `place:Shephelah`); إِلَى (ID: `place:Zarephath`); أَفْرَايِمَ (ID: `person:Ephraim`); فِلِشْتِيم (ID: `group:Philistine`); Canaanites (ID: `group:Canaan`); أَفْرَايِمَ (ID: `group:Ephraim`); ٱلسَّامِرَةِ (ID: `place:Samaria`)
...
* **Associated ACAI Concepts:** عِيسو (ID: `place:EsauMount`); أورشَلِيمَ (ID: `place:Jerusalem`); Dispossess (ID: `keyterm:Dispossess`); ٱلْجَنوبِ (ID: `place:Negeb`); كَنْعَان (ID: `place:Canaan`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلسَّهْلِ (ID: `place:Shephelah`); بَنْيَامِينَ (ID: `group:Benjamin`); إِلَى (ID: `place:Zarephath`); فِلِشْتِيم (ID: `group:Philistine`); Canaanites (ID: `group:Canaan`); بَنْيَامِينَ (ID: `person:Benjamin`); ٱلْفِلِسْطِينِيِّينَ (ID: `place:Philistine`); ٱلرَّبِّ (ID: `deity:Lord`); ٱلسَّامِرَةِ (ID: `place:Samaria`); سَارْدِسَ (ID: `place:Sardis`); جِلْعَادَ (ID: `place:Gilead`); أَفْرَايِمَ (ID: `person:Ephraim`); أَفْرَايِمَ (ID: `group:Ephraim`)
...
* **Associated ACAI Concepts:** كَنْعَان (ID: `place:Canaan`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); سَارْدِسَ (ID: `place:Sardis`); إِلَى (ID: `place:Zarephath`); Canaanites (ID: `group:Canaan`); Dispossess (ID: `keyterm:Dispossess`); ٱلْجَنوبِ (ID: `place:Negeb`)
