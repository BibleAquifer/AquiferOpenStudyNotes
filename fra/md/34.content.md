...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); déclarer innocent (ID: `keyterm:PronounceInnocent`); chemin (ID: `keyterm:TheWay`); Liban (ID: `place:Lebanon`); force (ID: `keyterm:Strength`); zélé (ID: `keyterm:Zealous.3`); Basan (ID: `place:Bashan`); Carmel (ID: `place:Carmel`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); se réfugier (ID: `keyterm:SeekfindRefuge`); déclarer innocent (ID: `keyterm:PronounceInnocent`); chemin (ID: `keyterm:TheWay`); Liban (ID: `place:Lebanon`); méchanceté (ID: `keyterm:Wickedness`); force (ID: `keyterm:Strength`); zélé (ID: `keyterm:Zealous.3`); Basan (ID: `place:Bashan`); Carmel (ID: `place:Carmel`); Fortress (ID: `realia:Fortress`); Strong Drink (ID: `realia:StrongDrink`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Graven Image (ID: `realia:GravenImage`); House (ID: `realia:House`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated ACAI Concepts:** état intact (ID: `keyterm:IntactState`); Juda (ID: `person:Judah.4`); faire un voeu (ID: `keyterm:Vow`); méchanceté (ID: `keyterm:Wickedness`); Juda (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); An Angel (ID: `deity:Angel`); Éternel (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Cush (ID: `place:Cush.2`); Libya (ID: `place:Libya`); destin (ID: `keyterm:Lot`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Puth (ID: `place:Put`); Égypte (ID: `place:Egypt`)
