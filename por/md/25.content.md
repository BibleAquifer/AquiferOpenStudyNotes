...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); rebel (ID: `keyterm:Rebel`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); love (ID: `keyterm:Love`); strength (ID: `keyterm:Strength`); Deceit (ID: `keyterm:Deceit`); defilement (ID: `keyterm:Defilement`); To Sin (ID: `keyterm:Sin`); appointed feast (ID: `keyterm:AppointedFeast`); Mighty One (ID: `keyterm:MightyOne`); Israel (ID: `person:Israel`); work (ID: `keyterm:Work`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Train (ID: `realia:Train`); Flock (ID: `fauna:Flock`); Casting Net (ID: `realia:CastingNet`); Yoke (ID: `realia:Yoke`); Grass (ID: `flora:Grass`); Net (ID: `realia:Net`); Winepress (ID: `realia:Winepress`); House (ID: `realia:House`); Deer (ID: `fauna:Deer`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); defilement (ID: `keyterm:Defilement`); SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); being honor and glory on oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); sabbath (ID: `keyterm:Sabbath`); Jerusalém (ID: `place:Jerusalem`); appointed feast (ID: `keyterm:AppointedFeast`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); appointed feast (ID: `keyterm:AppointedFeast`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); ardour (ID: `keyterm:Ardour`); SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Edom (ID: `place:Edom`); stain (ID: `keyterm:Stain`); Uz (ID: `place:Uz`); defilement (ID: `keyterm:Defilement`); anointed (ID: `keyterm:Anointed`); be kindly disposed (ID: `keyterm:KindlyDisposed`); Punishment (ID: `keyterm:Punishment`); Appoint (ID: `keyterm:Appoint`); Believe In (ID: `keyterm:BelieveIn`); Sodoma (ID: `place:Sodom`); Complete (ID: `keyterm:Complete`); Ostrich (ID: `fauna:Ostrich`); Jackal (ID: `fauna:Jackal`); Vulture (ID: `fauna:Vulture`); Purple Cloth (ID: `realia:PurpleCloth`); Clay Jar (ID: `realia:ClayJar`)
...
* **Associated ACAI Concepts:** Appoint (ID: `keyterm:Appoint`); Complete (ID: `keyterm:Complete`); To Sin (ID: `keyterm:Sin`); Jerusalém (ID: `place:Jerusalem`); Edom (ID: `place:Edom`); ardour (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Jerusalém (ID: `place:Jerusalem`); Assyria (ID: `place:Assyria`); round dance (ID: `keyterm:RoundDance`); Woe (ID: `keyterm:Woe`); Judá (ID: `person:Judah.4`); Egito (ID: `place:Egypt`); to cause to possess (ID: `keyterm:Possess`); Judá (ID: `group:Judah`); ardour (ID: `keyterm:Ardour`); Hand-Mill (ID: `realia:Hand-mill`); Money (ID: `realia:Money`); House (ID: `realia:House`); Crown (ID: `realia:Crown`); Jackal (ID: `fauna:Jackal`)
