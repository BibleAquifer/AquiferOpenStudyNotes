...
* **Associated ACAI Concepts:** Chaldeans (ID: `group:Chaldea`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Believe In (ID: `keyterm:BelieveIn`); Strength (ID: `keyterm:Strength`); Dispossess (ID: `keyterm:Dispossess`); Vulture (ID: `fauna:Vulture`); Wolf (ID: `fauna:Wolf`); Leopard (ID: `fauna:Leopard`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Casting Net (ID: `realia:CastingNet`); Pure (ID: `keyterm:Pure`); ٱلرَّبِّ (ID: `deity:Lord`); Holy (ID: `keyterm:Holy`); Fortification (ID: `realia:Fortification`); Harpoon (ID: `realia:Harpoon`); Fish (ID: `fauna:Fish`); Monitor (ID: `fauna:Iguana`); Chameleon (ID: `fauna:Chameleon`); Lizard (ID: `fauna:Lizard`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Hell (ID: `place:Hell`); Vine (ID: `flora:Vine`); Tablet (ID: `realia:Tablet`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); ٱلرَّبِّ (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); Idol (ID: `keyterm:Idol`); Trust (ID: `keyterm:LeanOn`); Proverb (ID: `keyterm:Saying`); لبْنَانَ (ID: `place:Lebanon`); Be Disgraced (ID: `keyterm:Disgraced`); Hell (ID: `place:Hell`); Wine (ID: `realia:Wine`); Beam (ID: `realia:Beam`); Graven Image (ID: `realia:GravenImage`); Vine (ID: `flora:Vine`); Image (ID: `realia:Image`); Tablet (ID: `realia:Tablet`); Money (ID: `realia:Money`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); ٱلرَّبِّ (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); Idol (ID: `keyterm:Idol`); Trust (ID: `keyterm:LeanOn`); لبْنَانَ (ID: `place:Lebanon`); Be Disgraced (ID: `keyterm:Disgraced`); Proverb (ID: `keyterm:Saying`); Beam (ID: `realia:Beam`); Graven Image (ID: `realia:GravenImage`); Image (ID: `realia:Image`); Molten Image (ID: `realia:MoltenImage`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Idol (ID: `keyterm:Idol`); Woe (ID: `keyterm:Woe.2`); ٱلرَّبِّ (ID: `deity:Lord`); Trust (ID: `keyterm:LeanOn`); Graven Image (ID: `realia:GravenImage`); Image (ID: `realia:Image`); Money (ID: `realia:Money`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated ACAI Concepts:** Salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); فَارَانَ (ID: `place:ParanMount`); كوشَانَ (ID: `place:Cushan`); تَيْمَانَ (ID: `place:Teman`); Mischief (ID: `keyterm:Mischief`); ٱلرَّبِّ (ID: `deity:Lord`); Oath (ID: `keyterm:Oath`); مِدْيَانَ (ID: `place:Midian`); Arrow (ID: `keyterm:Arrow`); Anointed (ID: `keyterm:Anointed`); Holy (ID: `keyterm:Holy`); Majesty (ID: `keyterm:Majesty`); Chariot (ID: `realia:Chariot`); Foundation (ID: `realia:Foundation`); Spear (ID: `realia:Spear`); Tent (ID: `realia:Tent`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** Salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); ٱلرَّبِّ (ID: `deity:Lord`); Arrow (ID: `keyterm:Arrow`); Anointed (ID: `keyterm:Anointed`); Oath (ID: `keyterm:Oath`); Bow (ID: `realia:Bow`); Foundation (ID: `realia:Foundation`); Chariot (ID: `realia:Chariot`); Spear (ID: `realia:Spear`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Deer (ID: `fauna:Deer`); Salvation (ID: `keyterm:Salvation`); Animal Pen (ID: `realia:AnimalPen`); Vine (ID: `flora:Vine`); Flock (ID: `fauna:Flock`); Sheepfold (ID: `realia:Sheepfold`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); Fig (ID: `flora:Fig`); Olive Tree (ID: `flora:OliveTree`)
