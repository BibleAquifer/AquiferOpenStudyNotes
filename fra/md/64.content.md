...
* **Associated ACAI Concepts:** vérité (ID: `keyterm:Truth`); bien, aimé (ID: `keyterm:Beloved`); marcher (ID: `keyterm:Live.3`); Gaïus (ID: `person:Gaius.4`); aimer (ID: `keyterm:Love`); prier (ID: `keyterm:Pray`); Cause of Joy (ID: `keyterm:CauseOfJoy`); témoigner (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** bien, aimé (ID: `keyterm:Beloved`); nom (ID: `keyterm:Name`); vérité (ID: `keyterm:Truth`); église (ID: `keyterm:Church`); aimer (ID: `keyterm:Love`); sois obligé (ID: `keyterm:Ought`); fidelité (ID: `keyterm:Faithfulness`); témoigner (ID: `keyterm:BearWitness`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** église (ID: `keyterm:Church`); Démétrius (ID: `person:Demetrius`); Diotrèphe (ID: `person:Diotrephes`); faire du bien (ID: `keyterm:DoGood`); bien, aimé (ID: `keyterm:Beloved`); vrai (ID: `keyterm:True`); vérité (ID: `keyterm:Truth`); le bien (ID: `keyterm:Good`); témoigner (ID: `keyterm:BearWitness`); Éternel (ID: `deity:Lord`)
