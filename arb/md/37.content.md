...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); حَجَّيِ (ID: `person:Haggai`); دَارِيوسَ (ID: `person:Darius.2`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); زَربَّابِل (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); حَجَّيِ (ID: `person:Haggai`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَشوع (ID: `person:Joshua.5`); دَارِيوسَ (ID: `person:Darius.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); An Angel (ID: `deity:Angel`); Fear (ID: `keyterm:Fear`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); Grain (ID: `flora:Grain`); Mule (ID: `fauna:Mule`); Bag (ID: `realia:Bag`); Must (ID: `realia:Must`); Olive Oil (ID: `realia:OliveOil`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); حَجَّيِ (ID: `person:Haggai`); Fear (ID: `keyterm:Fear`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** يَهوصَادِقَ (ID: `person:Jehozadak`); يَشوع (ID: `person:Joshua.5`); يَهوذَا (ID: `group:Judah`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `person:Judah.4`); ٱلرَّبِّ (ID: `deity:Lord`); زَربَّابِل (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); حَجَّيِ (ID: `person:Haggai`); يَهوذَا (ID: `group:Judah`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `person:Judah.4`); مِصْرَ (ID: `place:Egypt`); Fear (ID: `keyterm:Fear`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Peace (ID: `keyterm:IntactState`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); يَهوصَادِقَ (ID: `person:Jehozadak`); زَربَّابِل (ID: `person:Zerubbabel.2`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); حَجَّيِ (ID: `person:Haggai`); Defilement (ID: `keyterm:Defilement`); Vine (ID: `flora:Vine`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Holy (ID: `keyterm:Holy`); Bless (ID: `keyterm:Bless`); Instruction (ID: `keyterm:Instruction`); دَارِيوسَ (ID: `person:Darius.2`); Anointing Oil (ID: `realia:AnointingOil`); Barley (ID: `flora:Barley`); Pomegranate (ID: `flora:Pomegranate`); Olive Tree (ID: `flora:OliveTree`); Fig (ID: `flora:Fig`); Grain (ID: `flora:Grain`); Wine (ID: `realia:Wine`); Stew (ID: `realia:Stew`); Coriander (ID: `flora:Coriander`); Olive Oil (ID: `realia:OliveOil`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** زَربَّابِل (ID: `person:Zerubbabel.2`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `group:Judah`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); حَجَّيِ (ID: `person:Haggai`); يَهوذَا (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Sword (ID: `realia:Sword`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`)
