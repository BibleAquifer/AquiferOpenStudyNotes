...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); إِلَى (ID: `person:Apphia`); لِأَرْخِبّسَ (ID: `person:Archippus`); إِلَى (ID: `person:Philemon`); تِيموثَاوس (ID: `person:Timothy`); Church (ID: `keyterm:Church`); Make Peace (ID: `keyterm:Peace`); بولسَ (ID: `person:Paul`); ٱلرَّبِّ (ID: `deity:Lord`); Beloved (ID: `keyterm:Beloved`); Favor (ID: `keyterm:Favor`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Holy (ID: `keyterm:Holy`); يَسوع (ID: `person:Jesus.2`); Believe (ID: `keyterm:Believe`); Fellowship (ID: `keyterm:Fellowship`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Pray (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`); Affection (ID: `keyterm:Affection`); ٱلرَّبِّ (ID: `deity:Lord`); Ask for (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Love (ID: `keyterm:Love`); بولسَ (ID: `person:Paul`); Ask for (ID: `keyterm:AskFor`); In Christ (ID: `keyterm:InChrist`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); لوقَا (ID: `person:Luke`); دِيمَاس (ID: `person:Demas`); أَبَفْرَاسَ (ID: `person:Epaphras`); أَرِسْتَرْخسَ (ID: `person:Aristarchus`); مَرْقسَ (ID: `person:Mark`); Spirit (ID: `keyterm:Spirit.2`); In Christ (ID: `keyterm:InChrist`); Favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** لوقَا (ID: `person:Luke`); دِيمَاس (ID: `person:Demas`); أَرِسْتَرْخسَ (ID: `person:Aristarchus`); مَرْقسَ (ID: `person:Mark`)
