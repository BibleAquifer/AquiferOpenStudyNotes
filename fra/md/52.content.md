...
* **Associated ACAI Concepts:** Macédoine (ID: `place:Macedonia`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Athènes (ID: `place:Athens`); bonnes nouvelles (ID: `keyterm:GoodNews`); prier (ID: `keyterm:AskFor`); croire (ID: `keyterm:Believe`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** prier (ID: `keyterm:Encourage`); amour fraternel (ID: `keyterm:LoveForOnesFellowBeliever`); prier (ID: `keyterm:AskFor`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** prier (ID: `keyterm:Encourage`); amour fraternel (ID: `keyterm:LoveForOnesFellowBeliever`); Jésus (ID: `person:Jesus.2`)
