...
* **Associated ACAI Concepts:** Édom (ID: `group:Edom`); aimer (ID: `keyterm:Love`); Édom (ID: `place:Edom`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Priests (ID: `group:GenericPriests`); Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); gloire (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); craindre (ID: `keyterm:Fear`); alliance (ID: `keyterm:Covenant`); offrande (ID: `keyterm:Offering`); Priests (ID: `group:GenericPriests`); pleurer (ID: `keyterm:Curse`); gloire (ID: `keyterm:Glory`); Lévi (ID: `person:Levi.3`); état intact (ID: `keyterm:IntactState`); Lévi (ID: `group:Levi`); souiller (ID: `keyterm:Stain`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); niveau (ID: `keyterm:Fairness`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); sans saleté (ID: `keyterm:Pure`); la connaissance (ID: `keyterm:Intention`); prier (ID: `keyterm:AskFor`); ardeur (ID: `keyterm:Ardour`); benir (ID: `keyterm:Bless`); faire un voeu (ID: `keyterm:Vow`); agir avec bonté (ID: `keyterm:KindlyDisposed`); profaner, déshonorer (ID: `keyterm:Dishonor`); vérité (ID: `keyterm:Truth`); An Angel (ID: `deity:Angel`); nation; peuple (ID: `group:Gentile`); chemin (ID: `keyterm:TheWay`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** faire un voeu (ID: `keyterm:Vow`); pleurer (ID: `keyterm:Curse`); Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); gloire (ID: `keyterm:Glory`); pleurer (ID: `keyterm:Curse`); benir (ID: `keyterm:Bless`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Lévi (ID: `person:Levi.3`); alliance (ID: `keyterm:Covenant`); Lévi (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); offrande (ID: `keyterm:Offering`); alliance (ID: `keyterm:Covenant`); profaner, déshonorer (ID: `keyterm:Dishonor`); Juda (ID: `group:Judah`); aimer (ID: `keyterm:Love`); délice (ID: `keyterm:Delight`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `person:Judah.4`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** Juda (ID: `group:Judah`); aimer (ID: `keyterm:Love`); profaner, déshonorer (ID: `keyterm:Dishonor`); Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); offrande (ID: `keyterm:Offering`); Jérusalem (ID: `place:Jerusalem`); A Group of People (ID: `group:GenericGroup`); alliance (ID: `keyterm:Covenant`); Lévi (ID: `person:Levi.3`); craindre (ID: `keyterm:Fear`); Juda (ID: `group:Judah`); sans saleté (ID: `keyterm:Pure`); Juda (ID: `person:Judah.4`); jurer (ID: `keyterm:Swear`); An Angel (ID: `deity:Angel`); Lévi (ID: `group:Levi`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); offrande (ID: `keyterm:Offering`); limite (ID: `keyterm:Decree`); pleurer (ID: `keyterm:Curse`); benir (ID: `keyterm:Bless`); Israël (ID: `person:Israel`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Vine (ID: `flora:Vine`); Sorghum (ID: `flora:Sorghum`)
...
* **Associated ACAI Concepts:** montagne de Sinaï (ID: `place:SinaiMount`); Moïse (ID: `person:Moses`); limite (ID: `keyterm:Decree`); Israël (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** montagne de Sinaï (ID: `place:SinaiMount`); Moïse (ID: `person:Moses`); Élie (ID: `person:Elijah`); limite (ID: `keyterm:Decree`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); Instruction (ID: `keyterm:Instruction`); objet qui doit être détruit (ID: `keyterm:SomethingDevotedToGod`)
