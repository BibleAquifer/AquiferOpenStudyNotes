...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); chemin (ID: `keyterm:TheWay`); Basan (ID: `place:Bashan`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Carmel (ID: `place:Carmel`); Liban (ID: `place:Lebanon`); zélé (ID: `keyterm:Zealous.3`); force (ID: `keyterm:Strength`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); chemin (ID: `keyterm:TheWay`); méchanceté (ID: `keyterm:Wickedness`); Basan (ID: `place:Bashan`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Carmel (ID: `place:Carmel`); se réfugier (ID: `keyterm:SeekfindRefuge`); Liban (ID: `place:Lebanon`); zélé (ID: `keyterm:Zealous.3`); force (ID: `keyterm:Strength`); Fortress (ID: `realia:Fortress`); Brier (ID: `flora:Brier`); Strong Drink (ID: `realia:StrongDrink`)
...
* **Associated ACAI Concepts:** méchanceté (ID: `keyterm:Wickedness`); état intact (ID: `keyterm:IntactState`); Juda (ID: `group:Judah`); faire un voeu (ID: `keyterm:Vow`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Égypte (ID: `place:Egypt`); Libya (ID: `place:Libya`); destin (ID: `keyterm:Lot`); Puth (ID: `place:Put`); Cush (ID: `place:Cush.2`)
