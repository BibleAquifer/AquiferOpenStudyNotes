...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Tessalônica (ID: `place:Thessalonica`); Paulo (ID: `person:Paul`); favor (ID: `keyterm:Favor`); Silas (ID: `person:Silas`); fazer a paz (ID: `keyterm:Peace`); Thessalonians (ID: `group:Thessalonica`); Timóteo (ID: `person:Timothy`); igreja (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`); dever (ID: `keyterm:Ought`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); be (or show oneself) just (ID: `keyterm:Just`); boa notícia (ID: `keyterm:GoodNews`); ser glorificado (ID: `keyterm:Glorified`); holy (ID: `keyterm:Holy`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); testemunhar (ID: `keyterm:BearWitness`); para a eternidade (ID: `keyterm:Always`); juízo (ID: `keyterm:Judgment`); reino (ID: `keyterm:Kingdom`); igreja (ID: `keyterm:Church`); fazer justiça (ID: `keyterm:GrantJustice`); céu (ID: `keyterm:Heaven`); dever (ID: `keyterm:Ought`); tribunal de justiça (ID: `keyterm:CourtCase`); love (ID: `keyterm:Love`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** be (or show oneself) just (ID: `keyterm:Just`); juízo (ID: `keyterm:Judgment`); reino (ID: `keyterm:Kingdom`); tribunal de justiça (ID: `keyterm:CourtCase`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); To Cause to Happen (ID: `keyterm:Happen`); ser glorificado (ID: `keyterm:Glorified`); Name (ID: `keyterm:Name`); favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); orar (ID: `keyterm:Pray`); Good (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** ser glorificado (ID: `keyterm:Glorified`); Name (ID: `keyterm:Name`); favor (ID: `keyterm:Favor`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); Spirit (ID: `keyterm:Spirit.2`); Truth (ID: `keyterm:Truth`); wipe (out), destroy (ID: `keyterm:Destroy`); maravilha (ID: `keyterm:Portent`); rogar (ID: `keyterm:AskFor`); injustiça (ID: `keyterm:UnjustDeed`); example (ID: `keyterm:Example`); objeto de culto (ID: `keyterm:ObjectOfWorship`); love (ID: `keyterm:Love`); salvation (ID: `keyterm:Salvation`); Ability (ID: `keyterm:Ability`); Satanás (ID: `deity:Satan`); decidir (ID: `keyterm:Decided`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** example (ID: `keyterm:Example`); Satanás (ID: `deity:Satan`); Ability (ID: `keyterm:Ability`); maravilha (ID: `keyterm:Portent`)
...
* **Associated ACAI Concepts:** rogar (ID: `keyterm:AskFor`); hope (ID: `keyterm:Hope`); SENHOR (ID: `deity:Lord`); favor (ID: `keyterm:Favor`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`); Good (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); crer (ID: `keyterm:Believe`); persuadir (ID: `keyterm:Persuade`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); Faithfulness (ID: `keyterm:Faithfulness`); livrar (ID: `keyterm:Deliver`); Glory (ID: `keyterm:Glory`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); coração (ID: `keyterm:Heart`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** andar (ID: `keyterm:Live.3`); Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); Name (ID: `keyterm:Name`); tradição (ID: `keyterm:Teaching`); Ability (ID: `keyterm:Ability`); autoridade (ID: `keyterm:Authority.2`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`)
