...
* **Associated ACAI Concepts:** kasihi (ID: `keyterm:Love`); wajib (ID: `keyterm:Ought`); nama (ID: `keyterm:Name`); jemaat (ID: `keyterm:Church`); kekasih (ID: `keyterm:Beloved`); Tuhan (ID: `deity:Lord`); bersaksi (ID: `keyterm:BearWitness`); kebenaran (ID: `keyterm:Truth`); kesetiaan (ID: `keyterm:Faithfulness`)
...
* **Associated ACAI Concepts:** jemaat (ID: `keyterm:Church`); Demetrius (ID: `person:Demetrius`); Diotrefes (ID: `person:Diotrephes`); lakukan baik (ID: `keyterm:DoGood`); kekasih (ID: `keyterm:Beloved`); Tuhan (ID: `deity:Lord`); yang baik (ID: `keyterm:Good`); bersaksi (ID: `keyterm:BearWitness`); benar (ID: `keyterm:True`); kebenaran (ID: `keyterm:Truth`)
...
* **Associated ACAI Concepts:** Ink (ID: `realia:Ink`); Pen (ID: `realia:Pen`); nama (ID: `keyterm:Name`); harapan (ID: `keyterm:Hope`); memperdamaikan (ID: `keyterm:Peace`); Reed (ID: `flora:Reed`)
