...
* **Associated ACAI Concepts:** Kiljon (ID: `person:Chilion`); Éphrata (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); Bethléhem (ID: `place:Bethlehem`); Juda (ID: `group:Judah`); Machlon (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Juda (ID: `person:Judah.4`); Élimélec (ID: `person:Elimelech`)
...
* **Associated ACAI Concepts:** Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); grâce (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Naomi (ID: `person:Naomi`); laissiez en possession (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Boaz (ID: `person:Boaz`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Bethléhem (ID: `place:Bethlehem`); Elders (ID: `group:GenericElders`); Éternel (ID: `deity:Lord`); Rachel (ID: `person:Rachel`); Léa (ID: `person:Leah`)
...
* **Associated ACAI Concepts:** Perets (ID: `person:Perez`); Tamar (ID: `person:Tamar`); Juda (ID: `group:Judah`); Éternel (ID: `deity:Lord`); Juda (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Hetsron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Amminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Ram (ID: `person:Ram`); Nahshon (ID: `person:Nahshon`); Perets (ID: `person:Perez`); David (ID: `person:David`); Boaz (ID: `person:Boaz`); Isaï (ID: `person:Jesse`)
