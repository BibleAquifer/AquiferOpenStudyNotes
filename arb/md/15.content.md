...
* **Associated ACAI Concepts:** فَارِسَ (ID: `place:Persia`); كورَشَ (ID: `person:Cyrus`); إِرْمِيَا (ID: `person:Jeremiah.6`); Word of the Lord (ID: `keyterm:WordOfTheLord`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); ٱلرَّبِّ (ID: `deity:Lord`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); إِرْمِيَا (ID: `person:Jeremiah.6`); Word of the Lord (ID: `keyterm:WordOfTheLord`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); لَّاوِي (ID: `group:Levi`); يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `person:Benjamin`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `group:Benjamin`); House (ID: `realia:House`); Money (ID: `realia:Money`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `person:Judah.4`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوذَا (ID: `group:Judah`); كورَشَ (ID: `person:Cyrus`)
...
* **Associated ACAI Concepts:** Money (ID: `realia:Money`); زَربَّابِل (ID: `person:Zerubbabel.2`); أورشَلِيمَ (ID: `place:Jerusalem`); بَابِلَ (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); عِيلَامَ (ID: `person:Elam`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); سلَيْمَانَ (ID: `person:Solomon`); أورشَلِيمَ (ID: `place:Jerusalem`); جَزَّامَ (ID: `person:Gazzam`); حَبَايَا (ID: `person:Habaiah`); Tel-melah (ID: `place:Tel-melah`); آطِيرَ (ID: `person:Ater`); فَادونَ (ID: `person:Padon`); مرْدَخَاي (ID: `person:Mordecai`); بَرْقوسَ (ID: `person:Barkos`); أَدَّان (ID: `place:Addan`); آرَحَ (ID: `person:Arah.2`); حَزَقِيَّا (ID: `person:Hezekiah.2`); جَاحَرَ (ID: `person:Gahar`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); بَقْبوقَ (ID: `person:Bakbuk`); سِيعَهَا (ID: `person:Siaha`); حَقوفَا (ID: `person:Hakupha`); حَانَان (ID: `person:Hanan.4`); Tel-harsha (ID: `place:Tel-harsha`); مَغْبِيشَ (ID: `place:Magbish`); عَقّوب (ID: `person:Akkub.3`); ثَامَحَ (ID: `person:Temah`); حَطِيفَا (ID: `person:Hatipha`); بِلْشَان (ID: `person:Bilshan`); حَطِّيلَ (ID: `person:Hattil`); نَقودَا (ID: `person:Nekoda`)
...
* **Associated ACAI Concepts:** بِلْشَان (ID: `person:Bilshan`); رَعْلَايَا (ID: `person:Reelaiah`); رَحوم (ID: `person:Rehum`); سَرَايَا (ID: `person:Seraiah.6`); مِسْفَار (ID: `person:Mispar`); بِغْوَايَ (ID: `person:Bigvai`); نَحَمْيَا (ID: `person:Nehemiah`); مرْدَخَاي (ID: `person:Mordecai`); بَعْنَةَ (ID: `person:Baanah.3`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** عَادِينَ (ID: `person:Adin`); بِيصَايَ (ID: `person:Bezai`); فَرْعوشَ (ID: `person:Parosh`); آطِيرَ (ID: `person:Ater`); عِيلَامَ (ID: `person:Elam`); زَكَّايَ (ID: `person:Zaccai.2`); آرَحَ (ID: `person:Arah.2`); حَزَقِيَّا (ID: `person:Hezekiah.2`); يوآب (ID: `person:Joab.3`); يَشوعَ (ID: `person:Jeshua.3`); بَابَايَ (ID: `person:Bebai`); Pahath-moab (ID: `person:Pahath-moab`); بَانِيَ (ID: `person:Bani`); حَشوم (ID: `person:Hashum`); يورَةَ (ID: `person:Jorah`); شَفَطْيَا (ID: `person:Shephatiah.6`); عَرْجَدَ (ID: `person:Azgad`); زَتّو (ID: `person:Zattu.2`); أَدونِيقَامَ (ID: `person:Adonikam`); بِغْوَايَ (ID: `person:Bigvai.2`); جِبْعونَ (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Beth-azmaveth (ID: `place:Beth-azmaveth`); ٱلنَّطوفَاتِيّ (ID: `place:Netophah`); نَبو (ID: `place:Nebo.2`); سَنَاءَةَ (ID: `place:Senaah`); حَادِيدَ (ID: `place:Hadid`); مَغْبِيشَ (ID: `place:Magbish`); حَارِيمَ (ID: `person:Harim.2`); Ramah (ID: `place:Ramah.2`); بَئِيروت (ID: `place:Beeroth`); مِخْمَاسَ (ID: `place:Michmash`); عِيلَامَ (ID: `person:Elam`); وَلودَ (ID: `place:Lod`); عَايٍ (ID: `place:Ai`); أونوَ (ID: `place:Ono`); Kiriath-jearim (ID: `place:Kiriath-jearim`); ٱلْكَفِيرَة (ID: `place:Chephirah`); لَحْمٍ (ID: `place:Bethlehem`); Bethel (ID: `place:Bethel`); مِنْ (ID: `place:Geba`); أَرِيحَا (ID: `place:Jericho`); عَنَاثوثَ (ID: `place:Anathoth`)
...
* **Associated ACAI Concepts:** هودَوْيَا (ID: `person:Hodaviah.4`); يَدَايَا (ID: `person:Jedaiah.4`); يَشوعَ (ID: `person:Jeshua.4`); شوبَايَ (ID: `person:Shobai`); حَارِيمَ (ID: `person:Harim`); آطِيرَ (ID: `person:Ater.2`); حَطِيطَا (ID: `person:Hatita`); لِإِيمِيرَ (ID: `person:Immer.2`); يَشوعَ (ID: `person:Jeshua`); طَلْمون (ID: `person:Talmon`); لَّاوِي (ID: `person:Levi.3`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); فَشْحور (ID: `person:Pashhur`); شَلّوم (ID: `person:Shallum.8`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`); لَّاوِي (ID: `group:Levi`)
...
* **Associated ACAI Concepts:** شوبَايَ (ID: `person:Shobai`); آطِيرَ (ID: `person:Ater.2`); حَطِيطَا (ID: `person:Hatita`); طَلْمون (ID: `person:Talmon`); شَلّوم (ID: `person:Shallum.8`); عَقّوب (ID: `person:Akkub.2`); آسَاف (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** جَزَّامَ (ID: `person:Gazzam`); مَحِيدَا (ID: `person:Mehida`); فَاسِيحَ (ID: `person:Paseah.2`); فَادونَ (ID: `person:Padon`); قِيروسَ (ID: `person:Keros`); حَجَابَةَ (ID: `person:Hagabah`); حَرْشَا (ID: `person:Harsha`); بَرْقوسَ (ID: `person:Barkos`); سِيسَرَا (ID: `person:Sisera.2`); جَاحَرَ (ID: `person:Gahar`); لَبَانَةَ (ID: `person:Lebanah`); بَقْبوقَ (ID: `person:Bakbuk`); سِيعَهَا (ID: `person:Siaha`); جَدِّيلَ (ID: `person:Giddel`); Meunim (ID: `group:Meunim`); حَقوفَا (ID: `person:Hakupha`); حَانَان (ID: `person:Hanan.4`); صِيحَا (ID: `person:Ziha`); حَاجَابَ (ID: `person:Hagab`); أَسْنَةَ (ID: `person:Asnah`); حَسوفَا (ID: `person:Hasupha`); Nephushesim (ID: `group:Nephushesim`); عَقّوب (ID: `person:Akkub.3`); ثَامَحَ (ID: `person:Temah`); حَطِيفَا (ID: `person:Hatipha`); بَصْلوتَ (ID: `person:Bazluth`); بِيسَايَ (ID: `person:Besai`); طَبَاعوتَ (ID: `person:Tabbaoth`); نَقودَا (ID: `person:Nekoda`); رَآيَا (ID: `person:Reaiah.3`); حَرْحورَ (ID: `person:Harhur`); فِي (ID: `person:Uzza.2`); نَصِيحَ (ID: `person:Neziah`); سَلْمَايَ (ID: `person:Shalmai`); رَصِينَ (ID: `person:Rezin.2`)
...
* **Associated ACAI Concepts:** سلَيْمَانَ (ID: `person:Solomon`); حَطِّيلَ (ID: `person:Hattil`); آمِي (ID: `person:Ami`); يَعْلَةَ (ID: `person:Jaalah`); دَرْقونَ (ID: `person:Darkon`); جَدِّيلَ (ID: `person:Giddel.2`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); سَوْطَايَ (ID: `person:Sotai`); شَفَطْيَا (ID: `person:Shephatiah.7`); سوفَرَثَ (ID: `person:Sophereth`); فَرودَا (ID: `person:Peruda`)
...
* **Associated ACAI Concepts:** أَدَّان (ID: `place:Addan`); Tel-harsha (ID: `place:Tel-harsha`); لِدَلَايَا (ID: `person:Delaiah.3`); نَقودَا (ID: `person:Nekoda.2`); طوبِيَّا (ID: `person:Tobiah`); كَروب (ID: `place:Cherub`); Tel-melah (ID: `place:Tel-melah`); لِإِيمِيرَ (ID: `place:Immer`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** حَبَايَا (ID: `person:Habaiah`); هَقّوصَ (ID: `person:Hakkoz.2`); بَرْزِلَّايَ (ID: `person:Barzillai.3`); Priesthood (ID: `keyterm:Priesthood`); Gileadites (ID: `group:Gilead`); Defile (ID: `keyterm:Stain`); جِلْعَادَ (ID: `place:Gilead`); بَرْزِلَّايَ (ID: `person:Barzillai`)
...
* **Associated ACAI Concepts:** Daric (ID: `realia:Daric`); أورشَلِيمَ (ID: `place:Jerusalem`); Strength (ID: `keyterm:Strength`); ٱلرَّبِّ (ID: `deity:Lord`); Tunic (ID: `realia:Tunic`); House (ID: `realia:House`); Mina (ID: `realia:Mina`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); House (ID: `realia:House`); زَربَّابِل (ID: `person:Zerubbabel.2`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); يَشوع (ID: `person:Joshua.5`); فَارِسَ (ID: `place:Persia`); كورَشَ (ID: `person:Cyrus`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); أورشَلِيمَ (ID: `place:Jerusalem`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); هودَوْيَا (ID: `person:Hodaviah.4`); Esarhaddon (ID: `person:Esarhaddon`); حِينَادَادَ (ID: `person:Henadad`); Relatives (ID: `group:Relatives`); يَشوعَ (ID: `person:Jeshua.4`); قَدْمِيئِيلَ (ID: `person:Kadmiel`); دَارِيوسَ (ID: `person:Darius.2`); صورَ (ID: `place:Tyre`); Appointed Feast (ID: `keyterm:AppointedFeast`); آسَاف (ID: `person:Asaph.2`); موسَى (ID: `person:Moses`); بَنْيَامِينَ (ID: `group:Benjamin`); Kindness (ID: `keyterm:Kindness`); صِيْدونَ (ID: `place:Sidon`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Holy (ID: `keyterm:Holy`); هودِيَّا (ID: `person:Hodiah.2`); Terror (ID: `keyterm:Terror`); Sidonians (ID: `group:Sidon`); يَافَا (ID: `place:Joppa`); Tyrians (ID: `group:Tyre`); Counsel (ID: `keyterm:Counsel`); دَاودَ (ID: `person:David`); Instruction (ID: `keyterm:Instruction`); لبْنَانَ (ID: `place:Lebanon`); Assyria (ID: `place:Assyria`); New Moon Festival (ID: `keyterm:NewMoonFestival`); بَنْيَامِينَ (ID: `person:Benjamin`); Trumpet (ID: `realia:Trumpet`); Craftsman (ID: `realia:Craftsman`); Cedar (ID: `flora:Cedar`); Cymbals (ID: `realia:Cymbals`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); Offering (ID: `keyterm:Offering`); موسَى (ID: `person:Moses`); إِسْرَائِيلَ (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); ٱلرَّبِّ (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Terror (ID: `keyterm:Terror`); Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`); Appointed Feast (ID: `keyterm:AppointedFeast`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** Sidonians (ID: `group:Sidon`); صورَ (ID: `place:Tyre`); يَافَا (ID: `place:Joppa`); فَارِسَ (ID: `place:Persia`); صِيْدونَ (ID: `place:Sidon`); Tyrians (ID: `group:Tyre`); كورَشَ (ID: `person:Cyrus`); لبْنَانَ (ID: `place:Lebanon`); Craftsman (ID: `realia:Craftsman`); Olive Oil (ID: `realia:OliveOil`); Cedar (ID: `flora:Cedar`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); لَّاوِي (ID: `group:Levi`); أورشَلِيمَ (ID: `place:Jerusalem`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); لَّاوِي (ID: `person:Levi.3`); Kindness (ID: `keyterm:Kindness`); آسَاف (ID: `person:Asaph.2`); دَاودَ (ID: `person:David`); لَّاوِي (ID: `group:Levi`); House (ID: `realia:House`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `person:Benjamin`); إِسْرَائِيلَ (ID: `person:Israel`); بَنْيَامِينَ (ID: `group:Benjamin`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); يَشوع (ID: `person:Joshua.5`); فَارِسَ (ID: `place:Persia`); زَربَّابِل (ID: `person:Zerubbabel.2`); كورَشَ (ID: `person:Cyrus`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Counsel (ID: `keyterm:Counsel`); دَارِيوسَ (ID: `person:Darius.2`); كورَشَ (ID: `person:Cyrus`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); ٱلسَّامِرَةِ (ID: `place:Samaria`); فَارِسَ (ID: `place:Persia`); أَحَشْوِيروشَ (ID: `person:Ahasuerus`); مِثْرَدَاث (ID: `person:Mithredath.2`); أسْنَفَّر (ID: `person:Osnappar`); Babylonians (ID: `group:Babylon`); طَبْئِيل (ID: `person:Tabeel`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); أَرَكَ (ID: `place:Erech`); بِشْلَام (ID: `person:Bishlam`); عِيلَامَ (ID: `place:Elam`); Persians (ID: `group:Persia`); يَهوذَا (ID: `person:Judah.4`); بَابِلَ (ID: `place:Babylon`); Elamites (ID: `group:Elam`); يَهوذَا (ID: `group:Judah`); فِي (ID: `place:Susa`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** مِثْرَدَاث (ID: `person:Mithredath.2`); طَبْئِيل (ID: `person:Tabeel`); بِشْلَام (ID: `person:Bishlam`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); فَارِسَ (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Babylonians (ID: `group:Babylon`); شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); ٱلدِّينِيِّينَ (ID: `person:Dinaite`); أَرَكَ (ID: `place:Erech`); Elamites (ID: `group:Elam`); Persians (ID: `group:Persia`); عِيلَامَ (ID: `place:Elam`); فَارِسَ (ID: `place:Persia`); بَابِلَ (ID: `place:Babylon`); فِي (ID: `place:Susa`)
...
* **Associated ACAI Concepts:** ٱلْفرَاتِ (ID: `place:Euphrates`); أورشَلِيمَ (ID: `place:Jerusalem`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); شِمْشَاي (ID: `person:Shimshai`); ٱلسَّامِرَةِ (ID: `place:Samaria`); رَحوم (ID: `person:Rehum.2`); Foundation (ID: `realia:Foundation`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** شِمْشَاي (ID: `person:Shimshai`); رَحوم (ID: `person:Rehum.2`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes.2`); Jews (ID: `group:Jews`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); دَارِيوسَ (ID: `person:Darius.2`); Jews (ID: `group:Jews`); حَجَّيِ (ID: `person:Haggai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); تَتْنَاي (ID: `person:Tattenai`); زَكَرِيَّا (ID: `person:Zechariah.17`); يَدّو (ID: `person:Iddo.6`); يَشوع (ID: `person:Joshua.5`); ٱلْفرَاتِ (ID: `place:Euphrates`); فَارِسَ (ID: `place:Persia`); يَهوذَا (ID: `person:Judah.4`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); إِسْرَائِيلَ (ID: `person:Israel`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`)
...
* **Associated ACAI Concepts:** حَجَّيِ (ID: `person:Haggai`); زَكَرِيَّا (ID: `person:Zechariah.17`); يَدّو (ID: `person:Iddo.6`); Jews (ID: `group:Jews`); يَهوذَا (ID: `person:Judah.4`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** يَشوع (ID: `person:Joshua.5`); زَربَّابِل (ID: `person:Zerubbabel.2`); يَهوصَادِقَ (ID: `person:Jehozadak`); أورشَلِيمَ (ID: `place:Jerusalem`); شَأَلْتِيئِيل (ID: `person:Shealtiel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); بَابِلَ (ID: `place:Babylon`); أورشَلِيمَ (ID: `place:Jerusalem`); كورَشَ (ID: `person:Cyrus`); دَارِيوسَ (ID: `person:Darius.2`); زَربَّابِل (ID: `person:Zerubbabel.2`); نَبوخَذْنَاصَّر (ID: `person:Nebuchadnezzar`); Shethar-bozenai (ID: `person:Shethar-bozenai`); تَتْنَاي (ID: `person:Tattenai`); Chaldeans (ID: `group:Chaldea`); ٱلْفرَاتِ (ID: `place:Euphrates`); يَهوذَا (ID: `person:Judah.4`); ٱلْكَلْدَانِيِّينَ (ID: `place:Chaldea`); إِسْرَائِيلَ (ID: `person:Israel`); Foundation (ID: `realia:Foundation`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** كورَشَ (ID: `person:Cyrus`); أورشَلِيمَ (ID: `place:Jerusalem`); Foundation (ID: `realia:Foundation`); Cubit (ID: `realia:Cubit`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); موسَى (ID: `person:Moses`); لَّاوِي (ID: `group:Levi`); أورشَلِيمَ (ID: `place:Jerusalem`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Defilement (ID: `keyterm:Defilement`); إِسْرَائِيلَ (ID: `person:Israel`); Gentiles (ID: `group:Gentile`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Assyria (ID: `place:Assyria`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Unleavened Bread (ID: `realia:UnleavenedBread`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); عَزَرْيَا (ID: `person:Azariah.7`); سَرَايَا (ID: `person:Seraiah.2`); فَارِسَ (ID: `place:Persia`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); حِلْقِيَّا (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); أَمَرْيَا (ID: `person:Amariah.2`); عَزَرْيَا (ID: `person:Azariah.6`); أَخِيطوبَ (ID: `person:Ahitub.3`); عزِّي (ID: `person:Uzzi`); بقِّي (ID: `person:Bukki.2`); سَرَايَا (ID: `person:Seraiah.2`); زَرَحْيَا (ID: `person:Zerahiah`); شَلّوم (ID: `person:Shallum.7`); لِمَرَايوثَ (ID: `person:Meraioth`); أَبِيشوعَ (ID: `person:Abishua`); عَزَرْيَا (ID: `person:Azariah.7`); صَادوق (ID: `person:Zadok.4`); هَارون (ID: `person:Aaron`); فِينَحَاس (ID: `person:Phinehas`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); فَارِسَ (ID: `place:Persia`); أَلِعَازَار (ID: `person:Eleazar.2`); حِلْقِيَّا (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); موسَى (ID: `person:Moses`); بَابِلَ (ID: `place:Babylon`); إِسْرَائِيلَ (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); Decree (ID: `keyterm:Decree`); إِسْرَائِيلَ (ID: `person:Israel`); Instruction (ID: `keyterm:Instruction`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); عَزْرَا (ID: `person:Ezra`); إِسْرَائِيلَ (ID: `person:Israel`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); لَّاوِي (ID: `person:Levi.3`); ٱلْفرَاتِ (ID: `place:Euphrates`); لَّاوِي (ID: `group:Levi`); Decree (ID: `keyterm:Decree`); يَهوذَا (ID: `person:Judah.4`); بَابِلَ (ID: `place:Babylon`); ٱلرَّبِّ (ID: `deity:Lord`); Wheat (ID: `flora:Wheat`); Talent (ID: `realia:Talent`); Stone Altar (ID: `realia:StoneAltar`); Anointing Oil (ID: `realia:AnointingOil`); Temple Altar (ID: `realia:TempleAltar`); Olive Oil (ID: `realia:OliveOil`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Kor (ID: `realia:Kor`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); ٱلْفرَاتِ (ID: `place:Euphrates`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); Olive Oil (ID: `realia:OliveOil`); Wheat (ID: `flora:Wheat`); Kor (ID: `realia:Kor`); Talent (ID: `realia:Talent`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** بَابَايَ (ID: `person:Bebai.2`); عَادِينَ (ID: `person:Adin`); فَرْعوشَ (ID: `person:Parosh.2`); يَعِيئِيل (ID: `person:Jeuel.3`); عَثَلْيَا (ID: `person:Athaliah.3`); شَلومِيَةَ (ID: `person:Shelomith.4`); شَكَنْيَا (ID: `person:Shecaniah.6`); عِيلَامَ (ID: `person:Elam`); شِمْعِيَا (ID: `person:Shemaiah.14`); حَطّوش (ID: `person:Hattush.2`); أَلِيفَلَط (ID: `person:Eliphelet.5`); يَحِيئِيل (ID: `person:Jehiel.7`); بَابَايَ (ID: `person:Bebai`); أَلِيهوعِينَاي (ID: `person:Eliehoenai.2`); مِيخَائِيلَ (ID: `person:Michael.10`); دَانِيآل (ID: `person:Daniel.2`); Pahath-moab (ID: `person:Pahath-moab`); يوحَانَانَ (ID: `person:Johanan.8`); عوتَاي (ID: `person:Uthai.2`); يوشَفْيَا (ID: `person:Josiphiah`); عَابِد (ID: `person:Ebed.2`); يوآب (ID: `person:Joab.4`); زَبَدْيَا (ID: `person:Zebadiah.8`); زَكّور (ID: `person:Zaccur.5`); زَكَرِيَّا (ID: `person:Zechariah.19`); زَرَحْيَا (ID: `person:Zerahiah.2`); شَفَطْيَا (ID: `person:Shephatiah.6`); Gershom (ID: `person:Gershom.2`); عَرْجَدَ (ID: `person:Azgad`); يَحْزِيئِيل (ID: `person:Jahaziel.5`); عوبَدْيَا (ID: `person:Obadiah.10`); يونَاثَانَ (ID: `person:Jonathan.9`); شَكَنْيَا (ID: `person:Shecaniah.5`); هِقَّاطَانَ (ID: `person:Hakkatan`); أَدونِيقَامَ (ID: `person:Adonikam`); يِشْعِيَا (ID: `person:Jeshaiah.4`); زَكَرِيَّا (ID: `person:Zechariah.18`); بِغْوَايَ (ID: `person:Bigvai.2`); إِيثَامَارَ (ID: `person:Ithamar`); فِينَحَاس (ID: `person:Phinehas`); أَرْتَحْشَشْتَا (ID: `person:Artaxerxes`); بَابِلَ (ID: `place:Babylon`); دَاودَ (ID: `person:David`)
...
* **Associated ACAI Concepts:** نَاثَان (ID: `person:Nathan.5`); أَرِيئِيلَ (ID: `person:Ariel`); أَلْنَاثَانَ (ID: `person:Elnathan.4`); أَلْنَاثَانَ (ID: `person:Elnathan.3`); زَكَرِيَّا (ID: `person:Zechariah.20`); أَلْنَاثَانَ (ID: `person:Elnathan.2`); شِمْعِيَا (ID: `person:Shemaiah.15`); يَارِيبَ (ID: `person:Jarib.2`); مَشلَّام (ID: `person:Meshullam.9`); يَدّو (ID: `person:Iddo`); أَلِيعَزَرَ (ID: `person:Eliezer.8`); يويَارِيبَ (ID: `person:Joiarib.2`); ٱلْمسَمَّى (ID: `place:Casiphia`); ٱلرَّبِّ (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** شَرَبْيَا (ID: `person:Sherebiah`); لَّاوِي (ID: `person:Levi.3`); Insight (ID: `keyterm:Insight`); مَحْلِي (ID: `person:Mahli`); لَّاوِي (ID: `group:Levi`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `group:Levi`); لَّاوِي (ID: `person:Levi.3`); Work (ID: `keyterm:Work`); دَاودَ (ID: `person:David`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Perizzites (ID: `group:Perizzites`); Hittites (ID: `group:Hittite`); لَّاوِي (ID: `person:Levi.3`); Egyptians (ID: `group:Egypt`); Jebusites (ID: `group:Jebusites`); مِصْرَ (ID: `place:Egypt`); ٱلْعَمّونِيِّينَ (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Amorites (ID: `group:Amorites`); Canaanites (ID: `group:Canaan`); Be Unfaithful (ID: `keyterm:Unfaithful`); حِثًّا (ID: `person:Heth`); لَّاوِي (ID: `group:Levi`); إِسْرَائِيلَ (ID: `person:Israel`); موآبَ (ID: `place:Moab`); كَنْعَان (ID: `place:Canaan`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); إِسْرَائِيلَ (ID: `person:Israel`); عَزْرَا (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`); Passion (ID: `keyterm:Ardour`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); حَارِيمَ (ID: `person:Harim`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); Counsel (ID: `keyterm:Counsel`); عِيلَامَ (ID: `person:Elam`); Offering (ID: `keyterm:Offering`); Kelaiah (ID: `person:Kelaiah`); شَارَاي (ID: `person:Sharai`); مَعَدَاي (ID: `person:Maadai`); زَابَادَ (ID: `person:Zabad.6`); جَدَلْيَا (ID: `person:Gedaliah`); شَآل (ID: `person:Sheal`); عَدْنَا (ID: `person:Adna`); طَالَم (ID: `person:Telem`); زَابَادَ (ID: `person:Zabad.7`); كَلَال (ID: `person:Chelal`); بَنّويَ (ID: `person:Binnui.3`); يَهوذَا (ID: `place:Judea`); مَتَّنْيَا (ID: `person:Mattaniah.5`); شَبْتَاي (ID: `person:Shabbethai`); يَحِيئِيل (ID: `person:Jehiel.9`)
...
* **Associated ACAI Concepts:** Be Unfaithful (ID: `keyterm:Unfaithful`); إِسْرَائِيلَ (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); يَهوذَا (ID: `place:Judea`); Peace (ID: `keyterm:IntactState`); Defilement (ID: `keyterm:Defilement`); Plea for Mercy (ID: `keyterm:Supplication`); فَارِسَ (ID: `place:Persia`); Dispossess (ID: `keyterm:Dispossess`); Kindness (ID: `keyterm:Kindness`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); To Cause to Possess (ID: `keyterm:Possess`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); Plea for Mercy (ID: `keyterm:Supplication`); فَارِسَ (ID: `place:Persia`); Kindness (ID: `keyterm:Kindness`); أورشَلِيمَ (ID: `place:Jerusalem`); House (ID: `realia:House`); Peg (ID: `realia:Peg`); Peg (ID: `realia:Peg.2`)
...
* **Associated ACAI Concepts:** عَزْرَا (ID: `person:Ezra`); Repent (ID: `keyterm:Repent`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَحِيئِيل (ID: `person:Jehiel.8`); شَكَنْيَا (ID: `person:Shecaniah.7`); عَزْرَا (ID: `person:Ezra`); عِيلَامَ (ID: `person:Elam`); Be Unfaithful (ID: `keyterm:Unfaithful`); إِسْرَائِيلَ (ID: `person:Israel`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** لَّاوِي (ID: `person:Levi.3`); عَزْرَا (ID: `person:Ezra`); Swear (ID: `keyterm:Swear`); لَّاوِي (ID: `group:Levi`); إِسْرَائِيلَ (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `person:Judah.4`); يَهوذَا (ID: `group:Judah`); بَنْيَامِينَ (ID: `person:Benjamin`); أورشَلِيمَ (ID: `place:Jerusalem`); بَنْيَامِينَ (ID: `group:Benjamin`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَحْزِيَا (ID: `person:Jahzeiah`); شَبْتَاي (ID: `person:Shabbethai`); يونَاثَانَ (ID: `person:Jonathan.10`); تِقْوَةَ (ID: `person:Tikvah.2`); عَسَائِيل (ID: `person:Asahel.4`); مَشلَّام (ID: `person:Meshullam.10`); لَّاوِي (ID: `person:Levi.3`); لَّاوِي (ID: `group:Levi`)
