...
* **Associated ACAI Concepts:** Ephrata (ID: `person:Ephrathah`); Efratita (ID: `group:Ephrathah`); Chelión (ID: `person:Chilion`); Noemi (ID: `person:Naomi`); Elimelech (ID: `person:Elimelech`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Catah (ID: `place:Bethlehem`); Moab (ID: `place:Moab`); Mahalón (ID: `person:Mahlon`)
...
* **Associated ACAI Concepts:** Noemi (ID: `person:Naomi`); bondad (ID: `keyterm:Kindness`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); Moab (ID: `place:Moab`); Catah (ID: `place:Bethlehem`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Noemi (ID: `person:Naomi`); bondad (ID: `keyterm:Kindness`); bendecir (ID: `keyterm:Bless`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Noemi (ID: `person:Naomi`); Moab (ID: `place:Moab`); Booz (ID: `person:Boaz`); dejar en herencia (ID: `keyterm:Possess`)
...
* **Associated ACAI Concepts:** Rachêl (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); Lea (ID: `person:Leah`); Catah (ID: `place:Bethlehem`); Israel (ID: `person:Israel`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Phares (ID: `person:Perez`); Judá (ID: `person:Judah.4`); Judá (ID: `group:Judah`); Thamar (ID: `person:Tamar`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Ruth (ID: `person:Ruth`); Booz (ID: `person:Boaz`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Women (ID: `group:GenericFemales`); Noemi (ID: `person:Naomi`); Israel (ID: `person:Israel`); bendecir (ID: `keyterm:Bless`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Salmón (ID: `person:Salmon`); Hesrón (ID: `person:Hezron.2`); Obed (ID: `person:Obed`); Aminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Phares (ID: `person:Perez`); David (ID: `person:David`); Isaí (ID: `person:Jesse`); Booz (ID: `person:Boaz`); Nahasón (ID: `person:Nahshon`)
